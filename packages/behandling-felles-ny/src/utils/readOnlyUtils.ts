...
export const erReadOnly = (behandling: Behandling, aksjonspunkterForPunkt: Aksjonspunkt[], vilkarlisteForPunkt: Vilkar[],
  rettigheter: AksessRettigheter, hasFetchError: boolean) => {
