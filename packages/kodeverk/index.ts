...
export { OppholdArsakType, OppholdArsakKontoNavn, OppholdArsakMapper } from './src/oppholdArsakType';
...
export { UttakPeriodeType, UttakPeriodeNavn } from './src/uttakPeriodeType';
...
export { VurderPaNyttArsakType } from './src/vurderPaNyttArsakType';
