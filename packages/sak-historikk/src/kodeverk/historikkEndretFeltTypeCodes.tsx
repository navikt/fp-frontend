...
const historikkEndretFeltTypeCodes = {
  ...
  OMSORGSVILKAR: {
    kode: 'OMSORGSVILKAR',
    feltId: 'HistorikkEndretFelt.Omsorgsvilkår.ApplicationInformation',
  },
  OPPHOLDSRETT_EOS: {
  ...
  ANNEN_FORELDER_RETT_EØS: {
    kode: 'ANNEN_FORELDER_RETT_EØS',
    feltId: 'HistorikkEndretFelt.AnnenForelderRettEØS',
  },
  UTTAK_TREKKDAGER: {
