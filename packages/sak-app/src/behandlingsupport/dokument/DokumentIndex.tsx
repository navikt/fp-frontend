...
const selectDocument = (saksNr: string) => (_e, _id, document: Dokument): void => {
...
export const DokumentIndex: FunctionComponent<OwnProps> = ({
  ...
  const { data: alleDokumenter = EMPTY_ARRAY } = restApiHooks.useRestApi<Dokument[]>(FpsakApiKeys.ALL_DOCUMENTS, { saksnummer }, {
