...
export const alleKodeverk: AlleKodeverk = {
  ...
  PeriodeResultatÅrsak: [
    ...
    {
      kode: '4108',
      navn: '§ 14-10 sjette ledd, artikkel 5 i Forordning (EF) 883/2004: Annen part har overlappende uttak i EØS, det er ikke søkt/innvilget samtidig uttak',
    },
    {
      kode: '4110',
  ...
  VilkårType: [
    ...
    {
      kode: 'FP_VK_6',
      navn: 'Adopsjon og foreldreansvar',
    },
    {
      kode: 'FP_VK_2',
  ...
  MedlemskapDekningType: [
    ...
    {
      kode: 'FTL_2_7_a',
      navn: 'Folketrygdloven § 2-7 tredje ledd bokstav a',
    },
    {
      kode: 'FTL_2_7_b',
      navn: 'Folketrygdloven § 2-7 tredje ledd bokstav b',
    },
    {
      kode: 'FTL_2_9_1_a',
      navn: 'Folketrygdloven § 2-9 første ledd bokstav a',
    },
    {
      kode: 'FTL_2_9_1_b',
      navn: 'Folketrygdloven § 2-9 første ledd bokstav b',
    },
    {
      kode: 'FTL_2_9_1_c',
      navn: 'Folketrygdloven § 2-9 første ledd bokstav c',
    },
    {
      kode: 'FTL_2_9_2_a',
      navn: 'Folketrygdloven § 2-9 andre ledd, jf. § 2-9 første ledd bokstav a',
    },
    {
      kode: 'FTL_2_9_2_c',
      navn: 'Folketrygdloven § 2-9 andre ledd, jf. § 2-9 første ledd bokstav c',
    },
    {
      kode: 'FULL',
      navn: 'Full',
  ...
  BehandlingÅrsakType: [
    ...
    {
      kode: 'FEIL_PRAKSIS_BG_AAP_KOMBI',
      navn: 'Feil praksis AAP og annen aktivitet',
    },
    {
      kode: 'KLAGE_TILBAKE',
  ...
  SkjermlenkeType: [
    ...
    },
    {
      ...
      navn: 'Fakta om omsorgsovertakelse',
    },
    {
    ...
    },
    {
      ...
      navn: 'Fakta om aleneomsorg og annenpart rett',
    },
    {
      kode: 'FAKTA_OM_VERGE',
