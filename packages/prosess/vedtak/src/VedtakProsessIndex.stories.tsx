...
const meta = {
  ...
  render: function Render(args) {
    ...
    const mellomlagreBrev = (redigert?: string) => {
      setRedigertHtml(redigert ?? null);
...
export const GodkjentForeldrepengerMedManueltBrevForSaksbehandlerMedOverstyring: Story = {
  args: {
    behandling: {
      ...defaultBehandling,
      status: 'AVSLU',
      links: [{ href: '/fpsak/api/brev/hent-vedtaksbrev?uuid=test', rel: 'vedtaksbrev-dokument', type: 'GET' }],
      behandlingsresultat: {
