...
describe('<faktaUtils>', () => {
  ...
  it('skal lagre aksjonspunkt', async () => {
    ...
    const callback = getBekreftAksjonspunktCallback(fagsak, behandling as Behandling, oppdaterProsessStegOgFaktaPanelIUrl,
      overstyringApCodes, lagreAksjonspunkter);
