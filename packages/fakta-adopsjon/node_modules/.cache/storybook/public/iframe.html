<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Webpack App</title><meta name="viewport" content="width=device-width,initial-scale=1"><base target="_parent"><style>/* While we aren't showing the main block yet, but still preparing, we want everything the user
  ...
  };</script><link href="stylemain.css" rel="stylesheet"><style>#root[hidden],
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src","files":"**/*.stories.@(ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:src(?:[\\\\/](?!\\.)(?:(?:(?!(?:^|[\\\\/])\\.).)*?)[\\\\/]|[\\\\/]|$)(?!\\.)(?=.)[^\\\\/]*?\\.stories\\.(ts|tsx))$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:7001/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-node_modules_navikt_ft-form-hooks_dist_index_js-node_modules_navikt_ft-form-validator-94bd36.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>