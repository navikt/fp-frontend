...
export const SkalInnhenteInntektsmeldingOgIkkeHaInntekterFraAAregisteret = Template.bind({});
SkalInnhenteInntektsmeldingOgIkkeHaInntekterFraAAregisteret.args = {
  aksjonspunkter: [{
    definisjon: {
      kode: '9998',
      kodeverk: '',
