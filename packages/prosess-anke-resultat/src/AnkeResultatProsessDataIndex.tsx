...
export class ProsessDataAnkeResultat extends ProsessData {
...
interface OwnProps {
  prosessData: ProsessDataAnkeResultat;
  isReadOnly: boolean;
...
const AnkeResultatProsessDataIndex: FunctionComponent<OwnProps> = ({
  prosessData,
  formData,
  setFormData,
  ...props
...
export default AnkeResultatProsessDataIndex;
