export const tilrettelegging = {
  ...
  arbeidsforholdListe: [{
    ...
    tilretteleggingDatoer: [{
      fom: '2020-03-17', type: { kode: 'INGEN_TILRETTELEGGING', kodeverk: 'SVP_TILRETTELEGGING_TYPE' },
    }, {
      fom: '2020-10-15', type: { kode: 'HEL_TILRETTELEGGING', kodeverk: 'SVP_TILRETTELEGGING_TYPE' },
    }],
