...
export type foreldrepenger_behandlingslager_behandling_BehandlingResultatType = 'IKKE_FASTSATT' | 'INNVILGET' | 'AVSLÅTT' | 'OPPHØR' | 'HENLAGT_SØKNAD_TRUKKET' | 'HENLAGT_FEILOPPRETTET' | 'HENLAGT_BRUKER_DØD' | 'MERGET_OG_HENLAGT' | 'HENLAGT_SØKNAD_MANGLER' | 'FORELDREPENGER_ENDRET' | 'FORELDREPENGER_SENERE' | 'INGEN_ENDRING' | 'MANGLER_BEREGNINGSREGLER' | 'KLAGE_AVVIST' | 'KLAGE_MEDHOLD' | 'KLAGE_DELVIS_MEDHOLD' | 'KLAGE_OMGJORT_UGUNST' | 'KLAGE_YTELSESVEDTAK_OPPHEVET' | 'KLAGE_YTELSESVEDTAK_STADFESTET' | 'KLAGE_TILBAKEKREVING_VEDTAK_STADFESTET' | 'HENLAGT_KLAGE_TRUKKET' | 'HJEMSENDE_UTEN_OPPHEVE' | 'ANKE_AVVIST' | 'ANKE_MEDHOLD' | 'ANKE_DELVIS_MEDHOLD' | 'ANKE_OMGJORT_UGUNST' | 'ANKE_OPPHEVE_OG_HJEMSENDE' | 'ANKE_HJEMSENDE_UTEN_OPPHEV' | 'ANKE_YTELSESVEDTAK_STADFESTET' | 'HENLAGT_ANKE_TRUKKET' | 'INNSYN_INNVILGET' | 'INNSYN_DELVIS_INNVILGET' | 'INNSYN_AVVIST' | 'HENLAGT_INNSYN_TRUKKET';

export type foreldrepenger_behandlingslager_behandling_BehandlingStatus = 'AVSLU' | 'FVED' | 'IVED' | 'OPPRE' | 'UTRED';

export type foreldrepenger_behandlingslager_behandling_BehandlingType = 'BT-002' | 'BT-003' | 'BT-004' | 'BT-008' | 'BT-006' | 'BT-007' | 'BT-009' | '-';

export type foreldrepenger_behandlingslager_behandling_BehandlingÅrsakType = 'RE-LOV' | 'RE-RGLF' | 'RE-FEFAKTA' | 'RE-PRSSL' | 'RE-ANNET' | 'RE-MDL' | 'RE-OPTJ' | 'RE-FRDLING' | 'RE-INNTK' | 'RE-FØDSEL' | 'RE-DØD' | 'RE-SRTB' | 'RE-FRIST' | 'RE-BER-GRUN' | 'RE-KLAG-U-INNTK' | 'RE-KLAG-M-INNTK' | 'ETTER_KLAGE' | 'RE-MF' | 'RE-MFIP' | 'RE-AVAB' | 'RE-END-FRA-BRUKER' | 'RE-END-INNTEKTSMELD' | 'BERØRT-BEHANDLING' | 'REBEREGN-FERIEPENGER' | 'RE-UTSATT-START' | 'RE-SATS-REGULERING' | 'ENDRE-DEKNINGSGRAD' | 'INFOBREV_BEHANDLING' | 'INFOBREV_OPPHOLD' | 'INFOBREV_PÅMINNELSE' | 'OPPHØR-NYTT-BARN' | 'RE-HENDELSE-FØDSEL' | 'RE-HENDELSE-DØD-F' | 'RE-HENDELSE-DØD-B' | 'RE-HENDELSE-DØDFØD' | 'RE-HENDELSE-UTFLYTTING' | 'RE-VEDTAK-PSB' | 'FEIL_PRAKSIS_UTSETTELSE' | 'FEIL_PRAKSIS_IVERKS_UTSET' | 'FEIL_PRAKSIS_BG_AAP_KOMBI' | 'KLAGE_TILBAKE' | 'RE-YTELSE' | 'RE-REGISTEROPPL' | 'KØET-BEHANDLING' | 'RE-TILST-YT-INNVIL' | 'RE-TILST-YT-OPPH' | '-';

export type foreldrepenger_behandlingslager_behandling_KonsekvensForYtelsen = 'FORELDREPENGER_OPPHØRER' | 'ENDRING_I_BEREGNING' | 'ENDRING_I_UTTAK' | 'ENDRING_I_FORDELING_AV_YTELSEN' | 'INGEN_ENDRING';

export type foreldrepenger_behandlingslager_behandling_RettenTil = 'HAR_RETT_TIL_FP' | 'HAR_IKKE_RETT_TIL_FP' | '-';

export type foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktDefinisjon = '5001' | '5027' | '5018' | '5007' | '5012' | '5015' | '5016' | '5002' | '5026' | '5028' | '5030' | '5031' | '5033' | '5034' | '5003' | '5035' | '5037' | '5038' | '5039' | '5040' | '5043' | '5046' | '5047' | '5049' | '5051' | '5052' | '5055' | '5057' | '5058' | '5059' | '5060' | '5061' | '5068' | '5064' | '5065' | '5063' | '5066' | '5071' | '5072' | '5073' | '5076' | '5077' | '5085' | '5082' | '5084' | '5029' | '5086' | '5089' | '5041' | '5062' | '5091' | '5092' | '5095' | '5096' | '5074' | '5101' | '5102' | '5103' | '6002' | '6003' | '6005' | '6006' | '6008' | '6009' | '6011' | '6065' | '6014' | '6015' | '6045' | '6016' | '6018' | '6019' | '6017' | '6103' | '7001' | '7002' | '7003' | '7005' | '7007' | '7008' | '7011' | '7013' | '7014' | '7020' | '7030' | '7033' | '7037' | '7039' | '7040' | 'UNDEFINED' | '5004' | '5005' | '5006' | '5008' | '5009' | '5011' | '5013' | '5014' | '5017' | '5019' | '5020' | '5021' | '5022' | '5023' | '5024' | '5025' | '5032' | '5036' | '5042' | '5044' | '5045' | '5048' | '5050' | '5053' | '5054' | '5056' | '5067' | '5069' | '5070' | '5075' | '5078' | '5079' | '5080' | '5081' | '5083' | '5087' | '5088' | '5090' | '5093' | '5094' | '5097' | '5098' | '5099' | '6004' | '6007' | '6010' | '6012' | '6013' | '6068' | '6070' | '7004' | '7006' | '7009' | '7015' | '7016' | '7017' | '7018' | '7019' | '7021' | '7022' | '7023' | '7024' | '7025' | '7026' | '7027' | '7028' | '7029' | '7032' | '7034' | '7035' | '7036' | '7038' | '7041';

export type foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktStatus = 'AVBR' | 'OPPR' | 'UTFO';

export type foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktType = 'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-';

export type foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak = 'FEIL_FAKTA' | 'FEIL_LOV' | 'SKJØNN' | 'UTREDNING' | 'SAKSFLYT' | 'BEGRUNNELSE' | '-' | 'ANNET' | 'FEIL_REGEL';

export type foreldrepenger_behandlingslager_behandling_vedtak_Vedtaksbrev = 'AUTOMATISK' | 'FRITEKST' | 'INGEN' | '-';

export type foreldrepenger_behandlingslager_behandling_vilkår_Avslagsårsak = '1001' | '1002' | '1003' | '1004' | '1005' | '1006' | '1007' | '1008' | '1009' | '1010' | '1011' | '1012' | '1014' | '1015' | '1016' | '1017' | '1018' | '1019' | '1020' | '1021' | '1023' | '1024' | '1025' | '1026' | '1027' | '1028' | '1029' | '1031' | '1032' | '1033' | '1034' | '1035' | '1041' | '1051' | '1052' | '1060' | '1061' | '1062' | '1063' | '1064' | '1065' | '1066' | '1099' | '-';

export type foreldrepenger_behandlingslager_behandling_vilkår_VilkårType = 'FP_VK_1' | 'FP_VK_11' | 'FP_VK_6' | 'FP_VK_2' | 'FP_VK_2_F' | 'FP_VK_2_L' | 'FP_VK_3' | 'FP_VK_34' | 'FP_VK_21' | 'FP_VK_23' | 'FP_VK_41' | 'SVP_VK_1' | '-';

export type foreldrepenger_behandlingslager_behandling_vilkår_VilkårUtfallType = 'OPPFYLT' | 'IKKE_OPPFYLT' | 'IKKE_VURDERT' | '-';

export type foreldrepenger_behandlingslager_geografisk_Språkkode = 'NB' | 'NN' | 'EN' | '-';

export type foreldrepenger_domene_vedtak_intern_VedtaksbrevStatus = 'VEDTAKSBREV_PRODUSERES' | 'INGEN_VEDTAKSBREV' | 'INGEN_VEDTAKSBREV_ANKE' | 'INGEN_VEDTAKSBREV_KLAGEBEHANDLING' | 'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE' | 'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER' | 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE';
...
export type tjenester_behandling_dto_AsyncPollingStatus_Status = 'PENDING' | 'COMPLETE' | 'DELAYED' | 'CANCELLED' | 'HALTED';
...
export type foreldrepenger_behandlingslager_behandling_aktivitetskrav_AktivitetskravPermisjonType = '-' | 'UTDANNING' | 'FORELDREPENGER' | 'PERMITTERING' | 'ANNEN_PERMISJON';

export type foreldrepenger_behandlingslager_behandling_familiehendelse_FamilieHendelseType = 'ADPSJN' | 'OMSRGO' | 'FODSL' | 'TERM' | '-';

export type foreldrepenger_behandlingslager_behandling_innsyn_InnsynResultatType = 'INNV' | 'DELV' | 'AVVIST' | '-';

export type foreldrepenger_behandlingslager_behandling_klage_KlageHjemmel = '14-02' | '14-04' | '14-05' | '14-06' | '14-07' | '14-09' | '14-10' | '14-11' | '14-12' | '14-13' | '14-14' | '14-15' | '14-16' | '14-17' | '8-2' | '21-3' | '22-13' | '22-15' | '883-5' | '883-6' | '-';

export type foreldrepenger_behandlingslager_behandling_klage_KlageMedholdÅrsak = 'NYE_OPPLYSNINGER' | 'ULIK_REGELVERKSTOLKNING' | 'ULIK_VURDERING' | 'PROSESSUELL_FEIL' | '-';

export type foreldrepenger_behandlingslager_behandling_klage_KlageVurdering = 'OPPHEVE_YTELSESVEDTAK' | 'STADFESTE_YTELSESVEDTAK' | 'MEDHOLD_I_KLAGE' | 'AVVIS_KLAGE' | 'HJEMSENDE_UTEN_Å_OPPHEVE' | '-';

export type foreldrepenger_behandlingslager_behandling_klage_KlageVurderingOmgjør = 'GUNST_MEDHOLD_I_KLAGE' | 'DELVIS_MEDHOLD_I_KLAGE' | 'UGUNST_MEDHOLD_I_KLAGE' | '-';

export type foreldrepenger_behandlingslager_behandling_søknad_ForeldreType = 'MOR' | 'FAR' | 'MEDMOR' | 'ANDRE' | '-';

export type foreldrepenger_behandlingslager_behandling_tilbakekreving_TilbakekrevingVidereBehandling = '-' | 'TILBAKEKR_OPPRETT' | 'TILBAKEKR_IGNORER' | 'TILBAKEKR_INNTREKK' | 'TILBAKEKR_OPPDATER';

export type foreldrepenger_behandlingslager_behandling_tilrettelegging_SvpOppholdÅrsak = 'SYKEPENGER' | 'FERIE';

export type foreldrepenger_behandlingslager_behandling_tilrettelegging_SvpTilretteleggingFomKilde = 'ENDRET_AV_SAKSBEHANDLER' | 'REGISTRERT_AV_SAKSBEHANDLER' | 'TIDLIGERE_VEDTAK' | 'SØKNAD';

export type foreldrepenger_behandlingslager_behandling_tilrettelegging_TilretteleggingType = 'HEL_TILRETTELEGGING' | 'DELVIS_TILRETTELEGGING' | 'INGEN_TILRETTELEGGING';

export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_MorsAktivitet = '-' | 'ARBEID' | 'UTDANNING' | 'KVALPROG' | 'INTROPROG' | 'TRENGER_HJELP' | 'INNLAGT' | 'ARBEID_OG_UTDANNING' | 'UFØRE' | 'IKKE_OPPGITT';

export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_periode_FordelingPeriodeKilde = 'SØKNAD' | 'TIDLIGERE_VEDTAK' | 'ANDRE_NAV_VEDTAK' | 'SAKSBEHANDLER';

export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_periode_UttakPeriodeType = 'FELLESPERIODE' | 'MØDREKVOTE' | 'FEDREKVOTE' | 'FORELDREPENGER' | 'FORELDREPENGER_FØR_FØDSEL' | '-';

export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_årsak_OppholdÅrsak = '-' | 'UTTAK_MØDREKVOTE_ANNEN_FORELDER' | 'UTTAK_FEDREKVOTE_ANNEN_FORELDER' | 'UTTAK_FELLESP_ANNEN_FORELDER' | 'UTTAK_FORELDREPENGER_ANNEN_FORELDER';

export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_årsak_OverføringÅrsak = 'INSTITUSJONSOPPHOLD_ANNEN_FORELDER' | 'SYKDOM_ANNEN_FORELDER' | 'IKKE_RETT_ANNEN_FORELDER' | 'ALENEOMSORG' | '-';

export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_årsak_UtsettelseÅrsak = 'ARBEID' | 'LOVBESTEMT_FERIE' | 'SYKDOM' | 'INSTITUSJONSOPPHOLD_SØKER' | 'INSTITUSJONSOPPHOLD_BARNET' | 'HV_OVELSE' | 'NAV_TILTAK' | 'FRI' | '-';

export type foreldrepenger_behandlingslager_fagsak_FagsakYtelseType = 'ES' | 'FP' | 'SVP' | '-';

export type foreldrepenger_behandlingslager_risikoklassifisering_FaresignalVurdering = 'INNVIRKNING' | 'INNVILGET_REDUSERT' | 'INNVILGET_UENDRET' | 'AVSLAG_FARESIGNAL' | 'AVSLAG_ANNET' | 'INGEN_INNVIRKNING' | '-';

export type foreldrepenger_behandlingslager_uttak_PeriodeResultatType = 'INNVILGET' | 'AVSLÅTT' | 'MANUELL_BEHANDLING';

export type foreldrepenger_behandlingslager_uttak_UttakArbeidType = 'ORDINÆRT_ARBEID' | 'SELVSTENDIG_NÆRINGSDRIVENDE' | 'FRILANS' | 'ANNET';

export type foreldrepenger_behandlingslager_uttak_fp_GraderingAvslagÅrsak = '-' | '4504' | '4501' | '4502' | '4503' | '4523';

export type foreldrepenger_behandlingslager_uttak_fp_PeriodeResultatÅrsak = '-' | '2002' | '2003' | '2004' | '2005' | '2006' | '2007' | '2010' | '2011' | '2012' | '2013' | '2014' | '2015' | '2016' | '2017' | '2018' | '2019' | '2020' | '2021' | '2022' | '2023' | '2024' | '2025' | '2026' | '2027' | '2028' | '2030' | '2031' | '2032' | '2033' | '2034' | '2035' | '2036' | '2037' | '2038' | '2039' | '4002' | '4003' | '4005' | '4007' | '4008' | '4012' | '4013' | '4020' | '4022' | '4023' | '4025' | '4030' | '4031' | '4032' | '4033' | '4034' | '4035' | '4037' | '4038' | '4039' | '4040' | '4041' | '4050' | '4051' | '4052' | '4053' | '4054' | '4055' | '4056' | '4057' | '4058' | '4059' | '4060' | '4061' | '4062' | '4063' | '4064' | '4065' | '4066' | '4067' | '4068' | '4069' | '4070' | '4071' | '4072' | '4073' | '4074' | '4075' | '4076' | '4077' | '4081' | '4082' | '4084' | '4085' | '4086' | '4087' | '4088' | '4089' | '4092' | '4093' | '4095' | '4096' | '4097' | '4098' | '4099' | '4100' | '4102' | '4103' | '4104' | '4105' | '4106' | '4107' | '4108' | '4110' | '4111' | '4112' | '4115' | '4116' | '4117';

export type foreldrepenger_behandlingslager_uttak_fp_Trekkdager = {
    [key: string]: unknown;
};

export type foreldrepenger_behandlingslager_uttak_fp_UttakUtsettelseType = 'ARBEID' | 'FERIE' | 'SYKDOM_SKADE' | 'SØKER_INNLAGT' | 'BARN_INNLAGT' | 'HV_OVELSE' | 'NAV_TILTAK' | 'FRI' | '-';

export type foreldrepenger_behandlingslager_virksomhet_ArbeidType = 'ETTERLØNN_SLUTTPAKKE' | 'FORENKLET_OPPGJØRSORDNING' | 'FRILANSER' | 'FRILANSER_OPPDRAGSTAKER' | 'LØNN_UNDER_UTDANNING' | 'MARITIMT_ARBEIDSFORHOLD' | 'MILITÆR_ELLER_SIVILTJENESTE' | 'ORDINÆRT_ARBEIDSFORHOLD' | 'PENSJON_OG_ANDRE_TYPER_YTELSER_UTEN_ANSETTELSESFORHOLD' | 'NÆRING' | 'UTENLANDSK_ARBEIDSFORHOLD' | 'VENTELØNN_VARTPENGER' | 'VANLIG' | '-';
...
export type foreldrepenger_domene_iay_modell_kodeverk_PermisjonsbeskrivelseType = '-' | 'PERMISJON' | 'UTDANNINGSPERMISJON' | 'UTDANNINGSPERMISJON_IKKE_LOVFESTET' | 'UTDANNINGSPERMISJON_LOVFESTET' | 'VELFERDSPERMISJON' | 'ANNEN_PERMISJON_IKKE_LOVFESTET' | 'ANNEN_PERMISJON_LOVFESTET' | 'PERMISJON_MED_FORELDREPENGER' | 'PERMITTERING' | 'PERMISJON_VED_MILITÆRTJENESTE';
...
export type foreldrepenger_domene_uttak_fakta_uttak_DokumentasjonVurderingBehov_Behov_Type = 'UTSETTELSE' | 'OVERFØRING' | 'UTTAK';

export type foreldrepenger_domene_uttak_fakta_uttak_DokumentasjonVurderingBehov_Behov_Årsak = 'INNLEGGELSE_SØKER' | 'INNLEGGELSE_BARN' | 'HV_ØVELSE' | 'NAV_TILTAK' | 'SYKDOM_SØKER' | 'INNLEGGELSE_ANNEN_FORELDER' | 'SYKDOM_ANNEN_FORELDER' | 'BARE_SØKER_RETT' | 'ALENEOMSORG' | 'AKTIVITETSKRAV_ARBEID' | 'AKTIVITETSKRAV_UTDANNING' | 'AKTIVITETSKRAV_KVALPROG' | 'AKTIVITETSKRAV_INTROPROG' | 'AKTIVITETSKRAV_TRENGER_HJELP' | 'AKTIVITETSKRAV_INNLAGT' | 'AKTIVITETSKRAV_ARBEID_OG_UTDANNING' | 'AKTIVITETSKRAV_IKKE_OPPGITT' | 'TIDLIG_OPPSTART_FAR';
...
export type tjenester_behandling_svp_SvpAvklartOppholdPeriodeDto_SvpOppholdKilde = 'SØKNAD' | 'INNTEKTSMELDING' | 'REGISTRERT_AV_SAKSBEHANDLER' | 'TIDLIGERE_VEDTAK';
...
export type tjenester_behandling_uttak_dokumentasjon_DokumentasjonVurderingBehovDto_Vurdering = 'GODKJENT' | 'GODKJENT_AUTOMATISK' | 'IKKE_GODKJENT' | 'IKKE_DOKUMENTERT';
...
export type tjenester_registrering_dto_RettigheterDto = 'ANNEN_FORELDER_DOED' | 'OVERTA_FORELDREANSVARET_ALENE' | 'MANN_ADOPTERER_ALENE';
...
export type tjenester_registrering_svp_SvpTilretteleggingTypeDto = 'HEL_TILRETTELEGGING' | 'DELVIS_TILRETTELEGGING' | 'INGEN_TILRETTELEGGING';
...
export type foreldrepenger_behandlingslager_behandling_ytelsefordeling_Rettighetstype = 'ALENEOMSORG' | 'BEGGE_RETT' | 'BEGGE_RETT_EØS' | 'BARE_MOR_RETT' | 'BARE_FAR_RETT' | 'BARE_FAR_RETT_MOR_UFØR';
...
export type foreldrepenger_behandlingslager_behandling_anke_AnkeOmgjørÅrsak = 'NYE_OPPLYSNINGER' | 'ULIK_REGELVERKSTOLKNING' | 'ULIK_VURDERING' | 'PROSESSUELL_FEIL' | '-';

export type foreldrepenger_behandlingslager_behandling_anke_AnkeVurdering = 'ANKE_STADFESTE_YTELSESVEDTAK' | 'ANKE_HJEMSENDE_UTEN_OPPHEV' | 'ANKE_OPPHEVE_OG_HJEMSENDE' | 'ANKE_OMGJOER' | 'ANKE_AVVIS' | '-';

export type foreldrepenger_behandlingslager_behandling_anke_AnkeVurderingOmgjør = 'ANKE_TIL_GUNST' | 'ANKE_DELVIS_OMGJOERING_TIL_GUNST' | 'ANKE_TIL_UGUNST' | '-';
...
export type foreldrepenger_behandlingslager_behandling_arbeidsforhold_ArbeidsforholdKomplettVurderingType = 'KONTAKT_ARBEIDSGIVER_VED_MANGLENDE_INNTEKTSMELDING' | 'FORTSETT_UTEN_INNTEKTSMELDING' | 'MELDING_TIL_ARBEIDSGIVER_NAV_NO' | 'KONTAKT_ARBEIDSGIVER_VED_MANGLENDE_ARBEIDSFORHOLD' | 'IKKE_OPPRETT_BASERT_PÅ_INNTEKTSMELDING' | 'OPPRETT_BASERT_PÅ_INNTEKTSMELDING' | 'MANUELT_OPPRETTET_AV_SAKSBEHANDLER' | 'FJERN_FRA_BEHANDLINGEN' | 'SLÅTT_SAMMEN_MED_ANNET' | 'BRUK_MED_OVERSTYRT_PERIODE' | 'INNTEKT_IKKE_MED_I_BG' | 'BRUK' | 'NYTT_ARBEIDSFORHOLD' | '-';
...
export type foreldrepenger_domene_arbeidsforhold_impl_AksjonspunktÅrsak = 'PERMISJON' | 'MANGLENDE_INNTEKTSMELDING' | 'INNTEKTSMELDING_UTEN_ARBEIDSFORHOLD' | 'ENDRING_I_ARBEIDSFORHOLDS_ID' | 'PERMISJON_UTEN_SLUTTDATO';
...
export type foreldrepenger_domene_iay_modell_kodeverk_BekreftetPermisjonStatus = '-' | 'BRUK_PERMISJON' | 'IKKE_BRUK_PERMISJON' | 'UGYLDIGE_PERIODER';

export type foreldrepenger_domene_iay_modell_kodeverk_InntektspostType = '-' | 'LØNN' | 'YTELSE' | 'VANLIG' | 'SELVSTENDIG_NÆRINGSDRIVENDE' | 'NÆRING_FISKE_FANGST_FAMBARNEHAGE';
...
export type folketrygdloven_kalkulus_kodeverk_AktivitetStatus = 'MIDL_INAKTIV' | 'AAP' | 'AT' | 'DP' | 'SP_AV_DP' | 'PSB_AV_DP' | 'FL' | 'MS' | 'SN' | 'AT_FL' | 'AT_SN' | 'FL_SN' | 'AT_FL_SN' | 'BA' | 'KUN_YTELSE' | 'TY' | 'VENTELØNN_VARTPENGER' | '-';

export type folketrygdloven_kalkulus_kodeverk_AndelKilde = 'SAKSBEHANDLER_KOFAKBER' | 'PROSESS_BESTEBEREGNING' | 'SAKSBEHANDLER_FORDELING' | 'PROSESS_PERIODISERING' | 'PROSESS_OMFORDELING' | 'PROSESS_START' | 'PROSESS_PERIODISERING_TILKOMMET_INNTEKT';

export type folketrygdloven_kalkulus_kodeverk_AvklaringsbehovDefinisjon = 'FASTSETT_BG_AT_FL' | 'VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN' | 'VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV' | 'FORDEL_BG' | 'FASTSETT_BG_TB_ARB' | 'VURDER_NYTT_INNTKTSFRHLD' | 'VURDER_REPRSNTR_STORTNGT' | 'FASTSETT_BG_SN_NY_I_ARB_LIVT' | 'AVKLAR_AKTIVITETER' | 'VURDER_FAKTA_ATFL_SN' | 'VURDER_REFUSJONSKRAV' | 'OVST_BEREGNINGSAKTIVITETER' | 'OVST_INNTEKT' | 'AUTO_VENT_PAA_INNTKT_RAP_FRST' | 'AUTO_VENT_PAA_SISTE_AAP_DP_MELDKRT' | 'AUTO_VENT_FRISINN' | 'INGEN_AKTIVITETER';

export type folketrygdloven_kalkulus_kodeverk_AvklaringsbehovStatus = 'OPPR' | 'UTFO' | 'AVBR';

export type folketrygdloven_kalkulus_kodeverk_FaktaOmBeregningTilfelle = 'VURDER_TIDSBEGRENSET_ARBEIDSFORHOLD' | 'VURDER_SN_NY_I_ARBEIDSLIVET' | 'VURDER_NYOPPSTARTET_FL' | 'FASTSETT_MAANEDSINNTEKT_FL' | 'FASTSETT_BG_ARBEIDSTAKER_UTEN_INNTEKTSMELDING' | 'VURDER_LØNNSENDRING' | 'FASTSETT_MÅNEDSLØNN_ARBEIDSTAKER_UTEN_INNTEKTSMELDING' | 'VURDER_AT_OG_FL_I_SAMME_ORGANISASJON' | 'FASTSETT_BESTEBEREGNING_FØDENDE_KVINNE' | 'VURDER_ETTERLØNN_SLUTTPAKKE' | 'FASTSETT_ETTERLØNN_SLUTTPAKKE' | 'VURDER_MOTTAR_YTELSE' | 'VURDER_BESTEBEREGNING' | 'VURDER_MILITÆR_SIVILTJENESTE' | 'VURDER_REFUSJONSKRAV_SOM_HAR_KOMMET_FOR_SENT' | 'FASTSETT_BG_KUN_YTELSE' | 'TILSTØTENDE_YTELSE' | 'FASTSETT_ENDRET_BEREGNINGSGRUNNLAG' | '-';

export type folketrygdloven_kalkulus_kodeverk_Hjemmel = 'F_9_9' | 'F_9_8_8_28' | 'F_9_9_8_28_8_30' | 'F_9_9_8_35' | 'F_9_9_8_38' | 'F_9_9_8_40' | 'F_9_9_8_41' | 'F_9_9_8_42' | 'F_9_9_8_43' | 'F_9_9_8_47' | 'F_9_9_8_49' | 'F_14_7' | 'F_14_7_8_30' | 'F_14_7_8_28_8_30' | 'F_14_7_8_35' | 'F_14_7_8_38' | 'F_14_7_8_40' | 'F_14_7_8_41' | 'F_14_7_8_42' | 'F_14_7_8_43' | 'F_14_7_8_47' | 'F_14_7_8_49' | 'F_22_13_6' | 'COV_1_5' | 'KORONALOVEN_3' | '-';

export type folketrygdloven_kalkulus_kodeverk_InntektAktivitetType = 'ARBEIDSTAKERINNTEKT' | 'FRILANSINNTEKT' | 'YTELSEINNTEKT' | '-';

export type folketrygdloven_kalkulus_kodeverk_Inntektskategori = 'ARBEIDSTAKER' | 'FRILANSER' | 'SELVSTENDIG_NÆRINGSDRIVENDE' | 'DAGPENGER' | 'ARBEIDSAVKLARINGSPENGER' | 'SJØMANN' | 'DAGMAMMA' | 'JORDBRUKER' | 'FISKER' | 'ARBEIDSTAKER_UTEN_FERIEPENGER' | '-';

export type folketrygdloven_kalkulus_kodeverk_LønnsendringScenario = 'MANUELT_BEHANDLET' | 'DELVIS_MÅNEDSINNTEKT_SISTE_MND' | 'FULL_MÅNEDSINNTEKT_EN_MND' | 'FULL_MÅNEDSINNTEKT_TO_MND';
...
export type folketrygdloven_kalkulus_kodeverk_PeriodeÅrsak = 'NATURALYTELSE_BORTFALT' | 'ARBEIDSFORHOLD_AVSLUTTET' | 'NATURALYTELSE_TILKOMMER' | 'ENDRING_I_REFUSJONSKRAV' | 'REFUSJON_OPPHØRER' | 'GRADERING' | 'GRADERING_OPPHØRER' | 'ENDRING_I_AKTIVITETER_SØKT_FOR' | 'TILKOMMET_INNTEKT' | 'TILKOMMET_INNTEKT_MANUELT' | 'TILKOMMET_INNTEKT_AVSLUTTET' | 'REFUSJON_AVSLÅTT' | 'REPRESENTERER_STORTINGET' | 'REPRESENTERER_STORTINGET_AVSLUTTET' | '-';

export type folketrygdloven_kalkulus_kodeverk_SammenligningsgrunnlagType = 'SAMMENLIGNING_AT' | 'SAMMENLIGNING_FL' | 'SAMMENLIGNING_AT_FL' | 'SAMMENLIGNING_SN' | 'SAMMENLIGNING_ATFL_SN' | 'SAMMENLIGNING_MIDL_INAKTIV';

export type folketrygdloven_kalkulus_kodeverk_VirksomhetType = 'DAGMAMMA' | 'FISKE' | 'FRILANSER' | 'JORDBRUK_SKOGBRUK' | 'ANNEN' | '-';
...
export type folketrygdloven_kalkulus_response_v1_beregningsgrunnlag_frisinn_Avslagsårsak = 'FOR_LAVT_BG' | 'INGEN_FRILANS_I_PERIODE_UTEN_YTELSE' | 'AVKORTET_GRUNNET_LØPENDE_INNTEKT' | 'AVKORTET_GRUNNET_ANNEN_INNTEKT';
...
export type foreldrepenger_behandlingslager_behandling_beregning_AktivitetStatus = 'AAP' | 'AT' | 'DP' | 'FL' | 'MS' | 'SN' | 'AT_FL' | 'AT_SN' | 'FL_SN' | 'AT_FL_SN' | 'BA' | 'KUN_YTELSE' | 'TY' | 'VENTELØNN_VARTPENGER' | '-';

export type foreldrepenger_behandlingslager_behandling_opptjening_OpptjeningAktivitetType = 'AAP' | 'ARBEID' | 'DAGPENGER' | 'FORELDREPENGER' | 'FRILANS' | 'FRILOPP' | 'MILITÆR_ELLER_SIVILTJENESTE' | 'NÆRING' | 'OMSORGSPENGER' | 'OPPLÆRINGSPENGER' | 'PLEIEPENGER' | 'FRISINN' | 'ETTERLØNN_SLUTTPAKKE' | 'SVANGERSKAPSPENGER' | 'SYKEPENGER' | 'VENTELØNN_VARTPENGER' | 'VIDERE_ETTERUTDANNING' | 'UTENLANDSK_ARBEIDSFORHOLD' | 'UTDANNINGSPERMISJON' | '-';
...
export type tjenester_behandling_fødsel_dto_FødselDto_Gjeldende_FødselDokumetasjonStatus = 'DOKUMENTERT' | 'IKKE_DOKUMENTERT' | 'IKKE_VURDERT';
...
export type foreldrepenger_behandlingslager_behandling_familiehendelse_OmsorgsovertakelseVilkårType = 'FP_VK_4' | 'FP_VK_8' | 'FP_VK_5' | 'FP_VK_33' | 'FP_VK_16' | 'FP_VK_8F' | 'FP_VK_16S' | '-';
...
export type foreldrepenger_behandlingslager_behandling_klage_KlageAvvistÅrsak = 'KLAGET_FOR_SENT' | 'KLAGE_UGYLDIG' | 'IKKE_PAKLAGD_VEDTAK' | 'KLAGER_IKKE_PART' | 'IKKE_KONKRET' | 'IKKE_SIGNERT' | '-';
...
export type foreldrepenger_behandlingslager_fagsak_egenskaper_UtlandDokumentasjonStatus = 'DOKUMENTASJON_ER_INNHENTET' | 'DOKUMENTASJON_VIL_BLI_INNHENTET' | 'DOKUMENTASJON_VIL_IKKE_BLI_INNHENTET';
...
export type foreldrepenger_behandlingslager_behandling_opptjening_OpptjeningAktivitetKlassifisering = 'BEKREFTET_GODKJENT' | 'BEKREFTET_AVVIST' | 'ANTATT_GODKJENT' | 'MELLOMLIGGENDE_PERIODE' | '-';
...
export type foreldrepenger_behandlingslager_aktør_AdresseType = 'BOSTEDSADRESSE' | 'BOSTEDSADRESSE_UTLAND' | 'POSTADRESSE' | 'POSTADRESSE_UTLAND' | 'MIDLERTIDIG_POSTADRESSE_NORGE' | 'MIDLERTIDIG_POSTADRESSE_UTLAND' | 'UKJENT_ADRESSE';
...
export type foreldrepenger_behandlingslager_behandling_personopplysning_SivilstandType = 'ENKE' | 'GIFT' | 'GJPA' | 'GLAD' | 'NULL' | 'REPA' | 'SAMB' | 'SEPA' | 'SEPR' | 'SKIL' | 'SKPA' | 'UGIF';
...
export type foreldrepenger_behandlingslager_aktør_PersonstatusType = 'ADNR' | 'BOSA' | 'DØD' | 'FOSV' | 'FØDR' | 'UREG' | 'UTPE' | 'UTVA' | '-';

export type foreldrepenger_behandlingslager_behandling_medlemskap_MedlemskapDekningType = 'FTL_2_6' | 'FTL_2_7_a' | 'FTL_2_7_b' | 'FTL_2_9_1_a' | 'FTL_2_9_1_b' | 'FTL_2_9_1_c' | 'FTL_2_9_2_a' | 'FTL_2_9_2_c' | 'FULL' | 'IHT_AVTALE' | 'OPPHOR' | 'UNNTATT' | '-';

export type foreldrepenger_behandlingslager_behandling_medlemskap_MedlemskapManuellVurderingType = '-' | 'MEDLEM' | 'UNNTAK' | 'IKKE_RELEVANT' | 'OPPHOR_PGA_ENDRING_I_TPS';

export type foreldrepenger_behandlingslager_behandling_medlemskap_MedlemskapType = 'ENDELIG' | 'FORELOPIG' | 'AVKLARES' | '-';

export type foreldrepenger_behandlingslager_geografisk_Landkoder = '???' | 'ABW' | 'AFG' | 'AGO' | 'AIA' | 'ALA' | 'ALB' | 'AND' | 'ANT' | 'ARE' | 'ARG' | 'ARM' | 'ASM' | 'ATG' | 'AUS' | 'AUT' | 'AZE' | 'BDI' | 'BEL' | 'BEN' | 'BES' | 'BFA' | 'BGD' | 'BGR' | 'BHR' | 'BHS' | 'BIH' | 'BLM' | 'BLR' | 'BLZ' | 'BMU' | 'BOL' | 'BRA' | 'BRB' | 'BRN' | 'BTN' | 'BVT' | 'BWA' | 'CAF' | 'CAN' | 'CCK' | 'CHE' | 'CHL' | 'CHN' | 'CIV' | 'CMR' | 'COD' | 'COG' | 'COK' | 'COL' | 'COM' | 'CPV' | 'CRI' | 'CSK' | 'CUB' | 'CUW' | 'CXR' | 'CYM' | 'CYP' | 'CZE' | 'DDR' | 'DEU' | 'DJI' | 'DMA' | 'DNK' | 'DOM' | 'DZA' | 'ECU' | 'EGY' | 'ERI' | 'ESH' | 'ESP' | 'EST' | 'ETH' | 'FIN' | 'FJI' | 'FLK' | 'FRA' | 'FRO' | 'FSM' | 'GAB' | 'GBR' | 'GEO' | 'GGY' | 'GHA' | 'GIB' | 'GIN' | 'GLP' | 'GMB' | 'GNB' | 'GNQ' | 'GRC' | 'GRD' | 'GRL' | 'GTM' | 'GUF' | 'GUM' | 'GUY' | 'HKG' | 'HMD' | 'HND' | 'HRV' | 'HTI' | 'HUN' | 'IDN' | 'IMN' | 'IND' | 'IOT' | 'IRL' | 'IRN' | 'IRQ' | 'ISL' | 'ISR' | 'ITA' | 'JAM' | 'JEY' | 'JOR' | 'JPN' | 'KAZ' | 'KEN' | 'KGZ' | 'KHM' | 'KIR' | 'KNA' | 'KOR' | 'KWT' | 'LAO' | 'LBN' | 'LBR' | 'LBY' | 'LCA' | 'LIE' | 'LKA' | 'LSO' | 'LTU' | 'LUX' | 'LVA' | 'MAC' | 'MAF' | 'MAR' | 'MCO' | 'MDA' | 'MDG' | 'MDV' | 'MEX' | 'MHL' | 'MKD' | 'MLI' | 'MLT' | 'MMR' | 'MNE' | 'MNG' | 'MNP' | 'MOZ' | 'MRT' | 'MSR' | 'MTQ' | 'MUS' | 'MWI' | 'MYS' | 'MYT' | 'NAM' | 'NCL' | 'NER' | 'NFK' | 'NGA' | 'NIC' | 'NIU' | 'NLD' | 'NOR' | 'NPL' | 'NRU' | 'NZL' | 'OMN' | 'PAK' | 'PAN' | 'PCN' | 'PER' | 'PHL' | 'PLW' | 'PNG' | 'POL' | 'PRI' | 'PRK' | 'PRT' | 'PRY' | 'PSE' | 'PYF' | 'QAT' | 'REU' | 'ROU' | 'RUS' | 'RWA' | 'SAU' | 'SCG' | 'SDN' | 'SEN' | 'SGP' | 'SGS' | 'SHN' | 'SJM' | 'SLB' | 'SLE' | 'SLV' | 'SMR' | 'SOM' | 'SPM' | 'SRB' | 'SSD' | 'STP' | 'SUN' | 'SUR' | 'SVK' | 'SVN' | 'SWE' | 'SWZ' | 'SXM' | 'SYC' | 'SYR' | 'TCA' | 'TCD' | 'TGO' | 'THA' | 'TJK' | 'TKL' | 'TKM' | 'TLS' | 'TON' | 'TTO' | 'TUN' | 'TUR' | 'TUV' | 'TWN' | 'TZA' | 'UGA' | 'UKR' | 'UMI' | 'URY' | 'USA' | 'UZB' | 'VAT' | 'VCT' | 'VEN' | 'VGB' | 'VIR' | 'VNM' | 'VUT' | 'WLF' | 'WSM' | 'XUK' | 'XXK' | 'XXX' | 'YEM' | 'YUG' | 'ZAF' | 'ZMB' | 'ZWE' | '-';

export type foreldrepenger_behandlingslager_geografisk_Region = 'NORDEN' | 'EOS' | 'ANNET' | '-';

export type foreldrepenger_inngangsvilkaar_medlemskap_MedlemskapAvvik = 'BOSATT_UTENLANDSOPPHOLD' | 'BOSATT_MANGLENDE_BOSTEDSADRESSE' | 'BOSATT_UTENLANDSADRESSE' | 'BOSATT_UGYLDIG_PERSONSTATUS' | 'TREDJELAND_MANGLENDE_LOVLIG_OPPHOLD' | 'EØS_MANGLENDE_ANSETTELSE_MED_INNTEKT' | 'MEDL_PERIODER';
...
export type foreldrepenger_behandlingslager_behandling_søknad_FarSøkerType = 'ADOPTERER_ALENE' | 'ANDRE_FORELDER_DØD' | 'OVERTATT_OMSORG' | 'OVERTATT_OMSORG_F' | 'ANDRE_FORELD_DØD_F' | '-';
...
export type foreldrepenger_kontrakter_simulering_resultat_kodeverk_Fagområde = 'REFUTG' | 'FP' | 'FPREF' | 'SP' | 'SPREF' | 'SVP' | 'SVPREF' | 'PB' | 'PBREF' | 'PN' | 'PNREF' | 'OM' | 'OMREF' | 'OPP' | 'OPPREF' | 'OOP' | 'OOPREF' | 'UNG';

export type foreldrepenger_kontrakter_simulering_resultat_kodeverk_MottakerType = 'BRUKER' | 'ARBG_ORG' | 'ARBG_PRIV';

export type foreldrepenger_kontrakter_simulering_resultat_kodeverk_RadId = 'nyttBeløp' | 'tidligereUtbetalt' | 'differanse' | 'resultatEtterMotregning' | 'inntrekkNesteMåned' | 'resultat';
...
export type tjenester_behandling_uttak_dto_SaldoerDto_SaldoVisningStønadskontoType = 'MØDREKVOTE' | 'FEDREKVOTE' | 'FELLESPERIODE' | 'FORELDREPENGER' | 'FORELDREPENGER_FØR_FØDSEL' | 'FLERBARNSDAGER' | 'UTEN_AKTIVITETSKRAV' | 'MINSTERETT_NESTE_STØNADSPERIODE' | 'MINSTERETT';
...
export type foreldrepenger_behandlingslager_uttak_svp_ArbeidsforholdIkkeOppfyltÅrsak = '-' | '8301' | '8302' | '8303' | '8312';

export type foreldrepenger_behandlingslager_uttak_svp_PeriodeIkkeOppfyltÅrsak = '-' | '8304' | '8305' | '8306' | '8308' | '8309' | '8310' | '8311' | '8313' | '8314' | '8315' | '8316' | '8317';
...
export type foreldrepenger_behandlingslager_uttak_fp_ManuellBehandlingÅrsak = '-' | '5001' | '5002' | '5003' | '5004' | '5005' | '5006' | '5007' | '5009' | '5010' | '5011' | '5012' | '5014' | '5016' | '5018' | '5019' | '5024' | '5025' | '5026' | '5027' | '5028' | '5029' | '5030' | '5031' | '5032';
...
export type foreldrepenger_behandlingslager_behandling_verge_VergeType = 'BARN' | 'FBARN' | 'VOKSEN' | 'ADVOKAT' | 'ANNEN_F';
...
export type foreldrepenger_behandlingslager_behandling_personopplysning_RelasjonsRolleType = 'EKTE' | 'BARN' | 'FARA' | 'MORA' | 'REPA' | 'MMOR' | 'ANPA' | '-';
...
export type foreldrepenger_behandlingslager_behandling_RevurderingVarslingÅrsak = 'BARNIKKEREG' | 'JOBBFULLTID' | 'IKKEOPPTJENT' | 'UTVANDRET' | 'JOBBUTLAND' | 'IKKEOPPHOLD' | 'JOBB6MND' | 'AKTIVITET' | 'ANNET';

export type foreldrepenger_dokumentbestiller_DokumentMalType = 'FRITEK' | 'FRIHTM' | 'INNVES' | 'AVSLES' | 'INVFOR' | 'AVSFOR' | 'OPPFOR' | 'ANUFOR' | 'INVSVP' | 'OPPSVP' | 'AVSSVP' | 'INFOAF' | 'INNOPP' | 'VARREV' | 'IOHENL' | 'INNSYN' | 'IKKESO' | 'INGEND' | 'FORSAK' | 'FORMED' | 'FORMEF' | 'FORTID' | 'KGEAVV' | 'KGEOMG' | 'KGEOVE' | 'ELYSIM' | 'ENDUTB' | 'INFOPU' | 'FORPUS' | 'KLAGAV' | 'KAVVIS' | 'KLAGNY' | 'KHJEMS' | 'VEDMED' | 'KOMGJO' | 'KLAGOV' | 'KOVKLA' | 'KLAGVE' | 'KSTADF' | 'VEDOGA' | 'ANKEBO' | 'ANKOMG' | 'ANKOPP' | 'KGESTA' | 'KGEHJE';
...
export type foreldrepenger_behandlingslager_fagsak_egenskaper_FagsakMarkering = 'EØS_BOSATT_NORGE' | 'BOSATT_UTLAND' | 'SAMMENSATT_KONTROLL' | 'DØD_DØDFØDSEL' | 'PRAKSIS_UTSETTELSE' | 'BARE_FAR_RETT' | 'SELVSTENDIG_NÆRING' | 'HASTER';
...
export type foreldrepenger_behandlingslager_behandling_historikk_HistorikkAktør = 'BESL' | 'SBH' | 'SOKER' | 'ARBEIDSGIVER' | 'VL' | '-';

export type foreldrepenger_behandlingslager_behandling_skjermlenke_SkjermlenkeType = 'ANKE_MERKNADER' | 'ANKE_VURDERING' | 'BEREGNING_ENGANGSSTOENAD' | 'BEREGNING_FORELDREPENGER' | 'BESTEBEREGNING' | 'FAKTA_FOR_OMSORG' | 'FAKTA_FOR_OPPTJENING' | 'FAKTA_OM_ARBEIDSFORHOLD' | 'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING' | 'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON' | 'FAKTA_OM_BEREGNING' | 'FAKTA_OM_FOEDSEL' | 'FAKTA_OM_OMSORGSOVERTAKELSE' | 'FAKTA_OM_FORDELING' | 'FAKTA_OM_MEDLEMSKAP' | 'FAKTA_OM_OPPTJENING' | 'FAKTA_OM_SIMULERING' | 'FAKTA_OM_UTTAK' | 'FAKTA_OM_AKTIVITETSKRAV' | 'FAKTA_OMSORG_OG_RETT' | 'FAKTA_OM_VERGE' | 'FORMKRAV_KLAGE_KA' | 'FORMKRAV_KLAGE_NFP' | 'KLAGE_BEH_NFP' | 'KLAGE_BEH_NK' | 'KONTROLL_AV_SAKSOPPLYSNINGER' | 'OPPLYSNINGSPLIKT' | 'PUNKT_FOR_FOEDSEL' | 'PUNKT_FOR_MEDLEMSKAP' | 'PUNKT_FOR_MEDLEMSKAP_LØPENDE' | 'PUNKT_FOR_OPPTJENING' | 'PUNKT_FOR_SVANGERSKAPSPENGER' | 'PUNKT_FOR_SVP_INNGANG' | 'SOEKNADSFRIST' | 'TILKJENT_YTELSE' | '-' | 'UTLAND' | 'UTTAK' | 'VEDTAK' | 'VURDER_FARESIGNALER' | 'FAKTA_OM_UTTAK_DOKUMENTASJON' | 'FAKTA_UTTAK' | 'FAKTA_UTTAK_EØS';

export type foreldrepenger_behandlingslager_risikoklassifisering_Kontrollresultat = 'HOY' | 'IKKE_HOY' | 'IKKE_KLASSIFISERT' | '-';

export type foreldrepenger_domene_modell_kodeverk_FaktaOmBeregningTilfelle = 'VURDER_TIDSBEGRENSET_ARBEIDSFORHOLD' | 'VURDER_SN_NY_I_ARBEIDSLIVET' | 'VURDER_NYOPPSTARTET_FL' | 'FASTSETT_MAANEDSINNTEKT_FL' | 'FASTSETT_BG_ARBEIDSTAKER_UTEN_INNTEKTSMELDING' | 'VURDER_LØNNSENDRING' | 'FASTSETT_MÅNEDSLØNN_ARBEIDSTAKER_UTEN_INNTEKTSMELDING' | 'VURDER_AT_OG_FL_I_SAMME_ORGANISASJON' | 'FASTSETT_BESTEBEREGNING_FØDENDE_KVINNE' | 'VURDER_ETTERLØNN_SLUTTPAKKE' | 'FASTSETT_ETTERLØNN_SLUTTPAKKE' | 'VURDER_MOTTAR_YTELSE' | 'VURDER_BESTEBEREGNING' | 'VURDER_MILITÆR_SIVILTJENESTE' | 'VURDER_REFUSJONSKRAV_SOM_HAR_KOMMET_FOR_SENT' | 'FASTSETT_BG_KUN_YTELSE' | 'TILSTØTENDE_YTELSE' | 'FASTSETT_ENDRET_BEREGNINGSGRUNNLAG' | '-';
...
export type foreldrepenger_kontrakter_fordel_SakInfoV2Dto_FagsakStatusDto = 'UNDER_BEHANDLING' | 'LØPENDE' | 'AVSLUTTET';

export type foreldrepenger_kontrakter_fordel_SakInfoV2Dto_FamilieHendelseTypeDto = 'FØDSEL' | 'TERMIN' | 'ADOPSJON' | 'OMSORG';
...
export type tjenester_fordeling_FordelRestTjeneste_SakInntektsmeldingDto_YtelseType = 'FORELDREPENGER' | 'SVANGERSKAPSPENGER';
...
export type foreldrepenger_behandlingslager_behandling_beregning_BeregningSatsType = 'ENGANG' | 'GRUNNBELØP' | 'GSNITT' | '-';
...
export type abakus_iaygrunnlag_kodeverk_ArbeidType = 'ETTERLØNN_SLUTTPAKKE' | 'FORENKLET_OPPGJØRSORDNING' | 'FRILANSER' | 'FRILANSER_OPPDRAGSTAKER' | 'LØNN_UNDER_UTDANNING' | 'MARITIMT_ARBEIDSFORHOLD' | 'MILITÆR_ELLER_SIVILTJENESTE' | 'ORDINÆRT_ARBEIDSFORHOLD' | 'PENSJON_OG_ANDRE_TYPER_YTELSER_UTEN_ANSETTELSESFORHOLD' | 'NÆRING' | 'UTENLANDSK_ARBEIDSFORHOLD' | 'VENTELØNN_VARTPENGER' | 'VANLIG' | '-';
...
export type foreldrepenger_datavarehus_domene_VilkårIkkeOppfylt = 'MEDLEMSKAP' | 'SØKNADSFRIST' | 'OPPLYSNINGSPLIKT' | 'SVANGERSKAPSPENGER' | 'ENGANGSSTØNAD' | 'FORELDREPENGER_GENERELL' | 'FORELDREPENGER_OPPTJENING' | 'FORELDREPENGER_BEREGNING' | 'FORELDREPENGER_UTTAK';
...
export type foreldrepenger_datavarehus_v2_StønadsstatistikkUtbetalingPeriode_Inntektskategori = 'ARBEIDSTAKER' | 'ARBEIDSTAKER_UTEN_FERIEPENGER' | 'SJØMANN' | 'FRILANSER' | 'DAGPENGER' | 'ARBEIDSAVKLARINGSPENGER' | 'SELVSTENDIG_NÆRINGSDRIVENDE' | 'DAGMAMMA' | 'JORDBRUKER' | 'FISKER';
...
export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_AndelType = 'ARBEIDSAVKLARINGSPENGER' | 'ARBEIDSTAKER' | 'DAGPENGER' | 'FRILANSER' | 'MILITÆR_SIVILTJENESTE' | 'SELVSTENDIG_NÆRINGSDRIVENDE' | 'YTELSE';
...
export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_BeregningHjemmel = 'ARBEID' | 'NÆRING' | 'FRILANS' | 'ARBEID_FRILANS' | 'ARBEID_NÆRING' | 'NÆRING_FRILANS' | 'ARBEID_NÆRING_FRILANS' | 'DAGPENGER' | 'ARBEIDSAVKLARINGSPENGER' | 'BESTEBEREGNING' | 'MILITÆR_SIVIL' | 'ANNEN';
...
export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_HendelseType = 'FØDSEL' | 'ADOPSJON' | 'STEBARNSADOPSJON' | 'OMSORGSOVERTAKELSE';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_LovVersjon = 'FORELDREPENGER_2019_01_01' | 'FORELDREPENGER_FRI_2021_10_01' | 'FORELDREPENGER_MINSTERETT_2022_08_02' | 'FORELDREPENGER_UTJEVNE80_2024_07_01' | 'FORELDREPENGER_MINSTERETT_2024_08_02' | 'ENGANGSSTØNAD_2019_01_01' | 'ENGANGSSTØNAD_MEDLEM_2024_10_01' | 'SVANGERSKAPSPENGER_2019_01_01';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_RettighetType = 'ALENEOMSORG' | 'BARE_SØKER_RETT' | 'BEGGE_RETT' | 'BEGGE_RETT_EØS';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_RevurderingÅrsak = 'MANUELL' | 'UTTAKMANUELL' | 'KLAGE' | 'ETTERKONTROLL' | 'SØKNAD' | 'INNTEKTSMELDING' | 'FOLKEREGISTER' | 'PLEIEPENGER' | 'NYSAK' | 'ANNENFORELDER' | 'REGULERING' | 'PRAKSIS_UTSETTELSE';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_Saksrolle = 'MOR' | 'FAR' | 'MEDMOR' | 'UKJENT';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_StønadUtvidetType = 'FLERBARNSDAGER' | 'PREMATURDAGER';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_StønadskontoType = 'FORELDREPENGER' | 'FORELDREPENGER_FØR_FØDSEL' | 'MØDREKVOTE' | 'FELLESPERIODE' | 'FEDREKVOTE';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_UtlandsTilsnitt = 'NASJONAL' | 'EØS_BOSATT_NORGE' | 'BOSATT_UTLAND';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_VedtakResultat = 'INNVILGET' | 'AVSLAG' | 'OPPHØR';

export type foreldrepenger_datavarehus_v2_StønadsstatistikkVedtak_YtelseType = 'FORELDREPENGER' | 'SVANGERSKAPSPENGER' | 'ENGANGSSTØNAD';
...
export type tjenester_fpoversikt_FpSak_Uttaksperiode_Resultat_Årsak = 'ANNET' | 'AVSLAG_HULL_I_UTTAKSPLAN' | 'AVSLAG_UTSETTELSE_TILBAKE_I_TID' | 'INNVILGET_UTTAK_AVSLÅTT_GRADERING_TILBAKE_I_TID' | 'AVSLAG_FRATREKK_PLEIEPENGER';
...
export type tjenester_fpoversikt_Konto = 'FORELDREPENGER' | 'MØDREKVOTE' | 'FEDREKVOTE' | 'FELLESPERIODE' | 'FORELDREPENGER_FØR_FØDSEL';

export type tjenester_fpoversikt_MorsAktivitet = 'ARBEID' | 'UTDANNING' | 'KVALPROG' | 'INTROPROG' | 'TRENGER_HJELP' | 'INNLAGT' | 'ARBEID_OG_UTDANNING' | 'UFØRE' | 'IKKE_OPPGITT';

export type tjenester_fpoversikt_OppholdÅrsak = 'MØDREKVOTE_ANNEN_FORELDER' | 'FEDREKVOTE_ANNEN_FORELDER' | 'FELLESPERIODE_ANNEN_FORELDER' | 'FORELDREPENGER_ANNEN_FORELDER';

export type tjenester_fpoversikt_OverføringÅrsak = 'INSTITUSJONSOPPHOLD_ANNEN_FORELDER' | 'SYKDOM_ANNEN_FORELDER' | 'IKKE_RETT_ANNEN_FORELDER' | 'ALENEOMSORG';
...
export type tjenester_fpoversikt_Sak_Aksjonspunkt_Type = 'VENT_MANUELT_SATT' | 'VENT_FØDSEL' | 'VENT_KOMPLETT_SØKNAD' | 'VENT_REVURDERING' | 'VENT_TIDLIG_SØKNAD' | 'VENT_KØET_BEHANDLING' | 'VENT_SØKNAD' | 'VENT_INNTEKT_RAPPORTERINGSFRIST' | 'VENT_SISTE_AAP_ELLER_DP_MELDEKORT' | 'VENT_ETTERLYST_INNTEKTSMELDING' | 'VENT_ANKE_OVERSENDT_TIL_TRYGDERETTEN' | 'VENT_SYKEMELDING' | 'VENT_KABAL_KLAGE' | 'VENT_PÅ_KABAL_ANKE' | 'ANNET';

export type tjenester_fpoversikt_Sak_Aksjonspunkt_Venteårsak = 'ANKE_VENTER_PÅ_MERKNADER_FRA_BRUKER' | 'AVVENT_DOKUMTANSJON' | 'AVVENT_FØDSEL' | 'AVVENT_RESPONS_REVURDERING' | 'BRUKERTILBAKEMELDING' | 'UTLAND_TRYGD' | 'FOR_TIDLIG_SOKNAD' | 'UTVIDET_FRIST' | 'INNTEKT_RAPPORTERINGSFRIST' | 'MANGLENDE_SYKEMELDING' | 'MANGLENDE_INNTEKTSMELDING' | 'OPPTJENING_OPPLYSNINGER' | 'SISTE_AAP_ELLER_DP_MELDEKORT' | 'SENDT_INFORMASJONSBREV' | 'ÅPEN_BEHANDLING';
...
export type tjenester_fpoversikt_SvpSak_Vedtak_ArbeidsforholdUttak_ArbeidsforholdIkkeOppfyltÅrsak = 'ARBEIDSGIVER_KAN_TILRETTELEGGE' | 'ARBEIDSGIVER_KAN_TILRETTELEGGE_FREM_TIL_3_UKER_FØR_TERMIN' | 'ANNET';
...
export type tjenester_fpoversikt_SvpSak_Vedtak_ArbeidsforholdUttak_SvpPeriode_ResultatÅrsak = 'INNVILGET' | 'AVSLAG_SØKNADSFRIST' | 'AVSLAG_ANNET' | 'AVSLAG_INNGANGSVILKÅR' | 'OPPHØR_OVERGANG_FORELDREPENGER' | 'OPPHØR_FØDSEL' | 'OPPHØR_TIDSPERIODE_FØR_TERMIN' | 'OPPHØR_OPPHOLD_I_YTELSEN' | 'OPPHØR_ANNET';

export type tjenester_fpoversikt_SvpSak_Vedtak_AvslagÅrsak = 'ARBEIDSGIVER_KAN_TILRETTELEGGE' | 'SØKER_ER_INNVILGET_SYKEPENGER' | 'MANGLENDE_DOKUMENTASJON' | 'ANNET';

export type tjenester_fpoversikt_SøknadStatus = 'MOTTATT' | 'BEHANDLET';

export type tjenester_fpoversikt_UtsettelseÅrsak = 'HV_ØVELSE' | 'ARBEID' | 'LOVBESTEMT_FERIE' | 'SØKER_SYKDOM' | 'SØKER_INNLAGT' | 'BARN_INNLAGT' | 'NAV_TILTAK' | 'FRI';
...
export type tjenester_fpoversikt_UttakAktivitet_Type = 'ORDINÆRT_ARBEID' | 'SELVSTENDIG_NÆRINGSDRIVENDE' | 'FRILANS' | 'ANNET';

export type tjenester_fpoversikt_DokumentTyperDto = 'I000007' | 'I000023' | 'I000032' | 'I000036' | 'I000037' | 'I000038' | 'I000039' | 'I000041' | 'I000042' | 'I000044' | 'I000045' | 'I000051' | 'I000060' | 'I000061' | 'I000062' | 'I000063' | 'I000065' | 'I000066' | 'I000109' | 'I000110' | 'I000111' | 'I000112' | 'I000114' | 'I000116' | 'I000117' | 'I000118' | 'I000119' | 'I000120' | 'I000121' | 'I000122' | 'I000123' | 'I000124' | 'I000130' | 'I000131' | 'I000132' | 'I000133' | 'I000140' | 'I000141';
...
export type vedtak_hendelser_behandling_Behandlingsstatus = 'OPPRETTET' | 'UTREDES' | 'FATTER_VEDTAK' | 'IVERKSETTER_VEDTAK' | 'AVSLUTTET';

export type vedtak_hendelser_behandling_Behandlingstype = 'FØRSTEGANGS' | 'REVURDERING' | 'TILBAKEBETALING' | 'TILBAKEBETALING_REVURDERING' | 'KLAGE' | 'ANKE' | 'INNSYN';

export type vedtak_hendelser_behandling_Behandlingsårsak = 'SØKNAD' | 'INNTEKTSMELDING' | 'FOLKEREGISTER' | 'PLEIEPENGER' | 'ETTERKONTROLL' | 'MANUELL' | 'BERØRT' | 'UTSATT_START' | 'OPPHØR_NY_SAK' | 'REGULERING' | 'KLAGE_OMGJØRING' | 'KLAGE_TILBAKEBETALING' | 'ANNET';
...
export type foreldrepenger_behandlingslager_behandling_nøkkeltallbehandling_BehandlingVenteStatus = 'PÅ_VENT' | 'IKKE_PÅ_VENT';
...
export type vedtak_felles_prosesstask_rest_dto_IkkeFerdigProsessTaskStatusEnum = 'FEILET' | 'VENTER_SVAR' | 'SUSPENDERT' | 'VETO' | 'KLAR';
...
export type HentBehandlingMidlertidigStatusError = HentBehandlingMidlertidigStatusErrors[keyof HentBehandlingMidlertidigStatusErrors];
...
export type HentBehandlingMidlertidigStatusResponse = HentBehandlingMidlertidigStatusResponses[keyof HentBehandlingMidlertidigStatusResponses];
...
export type GetAlleInntektsmeldingerResponse = GetAlleInntektsmeldingerResponses[keyof GetAlleInntektsmeldingerResponses];
...
export type GetArbeidOgInntektsmeldingerResponse = GetArbeidOgInntektsmeldingerResponses[keyof GetArbeidOgInntektsmeldingerResponses];
...
export type GetArbeidsgiverOpplysningerResponse = GetArbeidsgiverOpplysningerResponses[keyof GetArbeidsgiverOpplysningerResponses];
...
export type HentBeregningsresultatDagytelseResponse = HentBeregningsresultatDagytelseResponses[keyof HentBeregningsresultatDagytelseResponses];
...
export type HentBeregningsresultatEngangsstønadResponse = HentBeregningsresultatEngangsstønadResponses[keyof HentBeregningsresultatEngangsstønadResponses];
...
export type GetStonadskontoerGittUttaksperioderResponse = GetStonadskontoerGittUttaksperioderResponses[keyof GetStonadskontoerGittUttaksperioderResponses];
...
export type HentAnnenpartPerioderIEøsResponse = HentAnnenpartPerioderIEøsResponses[keyof HentAnnenpartPerioderIEøsResponses];
...
export type HentDokumentasjonVurderingBehovResponse = HentDokumentasjonVurderingBehovResponses[keyof HentDokumentasjonVurderingBehovResponses];
...
export type HentSvangerskapspengerUttakResultatResponse = HentSvangerskapspengerUttakResultatResponses[keyof HentSvangerskapspengerUttakResultatResponses];
...
export type HentUttakResultatPerioderResponse = HentUttakResultatPerioderResponses[keyof HentUttakResultatPerioderResponses];
...
export type HentAlleDokumenterForSakResponse = HentAlleDokumenterForSakResponses[keyof HentAlleDokumenterForSakResponses];
...
export type HentFagsakMidlertidigStatusError = HentFagsakMidlertidigStatusErrors[keyof HentFagsakMidlertidigStatusErrors];
...
export type HentFagsakMidlertidigStatusResponse = HentFagsakMidlertidigStatusResponses[keyof HentFagsakMidlertidigStatusResponses];
...
export type FinnAlleSakerForBrukerV2Response = FinnAlleSakerForBrukerV2Responses[keyof FinnAlleSakerForBrukerV2Responses];
...
export type FjernOverstyrtGrunnlagSvpBehandlingResponse = FjernOverstyrtGrunnlagSvpBehandlingResponses[keyof FjernOverstyrtGrunnlagSvpBehandlingResponses];
...
export type HenleggBehandlingTekniskResponse = HenleggBehandlingTekniskResponses[keyof HenleggBehandlingTekniskResponses];
...
export type HenleggVentendeBehandlingResponse = HenleggVentendeBehandlingResponses[keyof HenleggVentendeBehandlingResponses];
...
export type HenleggÅpenFørstegangsbehandlingOgOpprettNyResponse = HenleggÅpenFørstegangsbehandlingOgOpprettNyResponses[keyof HenleggÅpenFørstegangsbehandlingOgOpprettNyResponses];
...
export type OppdaterBehandlingresultatMedVedtaksbrevTypeResponse = OppdaterBehandlingresultatMedVedtaksbrevTypeResponses[keyof OppdaterBehandlingresultatMedVedtaksbrevTypeResponses];
...
export type OpprettNyRevurderingBerørtBehandlingResponse = OpprettNyRevurderingBerørtBehandlingResponses[keyof OpprettNyRevurderingBerørtBehandlingResponses];
...
export type ReInnsendInntektsmeldingResponse = ReInnsendInntektsmeldingResponses[keyof ReInnsendInntektsmeldingResponses];
...
export type OpprettGreguleringEnkeltSakResponse = OpprettGreguleringEnkeltSakResponses[keyof OpprettGreguleringEnkeltSakResponses];
...
export type AvsluttFagsakUtenBehandlingResponse = AvsluttFagsakUtenBehandlingResponses[keyof AvsluttFagsakUtenBehandlingResponses];
...
export type OppdaterPersongalleriForTilgangResponse = OppdaterPersongalleriForTilgangResponses[keyof OppdaterPersongalleriForTilgangResponses];
...
export type SettFagsakFraAvsluttetTilUnderBehandlingResponse = SettFagsakFraAvsluttetTilUnderBehandlingResponses[keyof SettFagsakFraAvsluttetTilUnderBehandlingResponses];
...
export type ListFagsakUtenBehandlingResponse = ListFagsakUtenBehandlingResponses[keyof ListFagsakUtenBehandlingResponses];
...
export type HentBehandlingResultatForBackendResponse = HentBehandlingResultatForBackendResponses[keyof HentBehandlingResultatForBackendResponses];
...
export type NøkkeltallFørsteUttakPrMånedResponse = NøkkeltallFørsteUttakPrMånedResponses[keyof NøkkeltallFørsteUttakPrMånedResponses];
...
export type HentAktørIdListeTilknyttetSakResponse = HentAktørIdListeTilknyttetSakResponses[keyof HentAktørIdListeTilknyttetSakResponses];
...
export type HentSaksnummerTilknyttetBehandlingResponse = HentSaksnummerTilknyttetBehandlingResponses[keyof HentSaksnummerTilknyttetBehandlingResponses];
