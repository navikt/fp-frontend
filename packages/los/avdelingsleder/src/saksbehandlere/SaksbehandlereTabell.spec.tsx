...
describe('SaksbehandlereTabell', () => {
  it(
    'skal vise to saksbehandlere i tabell',
  ...
  it(
    'skal fjerne en saksbehandler ved å trykk på fjern-knappen',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(Default.parameters['msw']);
      render(<Default />);
  ...
  it(
    'skal sortere saksbehandlere etter ansattAvdeling og navn',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(Default.parameters['msw']);
      render(<Default />);
  ...
  it(
    'skal sortere saksbehandlere med ansattAvdeling null sist',
    mswWrapper(async ({ setHandlers }) => {
