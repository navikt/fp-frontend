...
describe('SorteringVelger', () => {
  it(
    'skal vise tre sorteringsvalg når mange behandlingstyper er valgt',
  ...
  it(
    'skal vise datovelger der dynamisk periode ikke er valgt',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(SorteringsvelgerNårMangeBehandlingstyperErValgt.parameters['msw']);
      render(<SorteringsvelgerNårMangeBehandlingstyperErValgt />);
      expect(await screen.findByText('Dato for behandlingsfrist')).toBeInTheDocument();
  ...
  it(
    'skal vise datovelger der dynamisk periode er valgt',
    mswWrapper(async ({ setHandlers }) => {
  ...
  it(
    'skal vise vis beløpvelger når Feilutbetalt beløp er valgt',
    mswWrapper(async ({ setHandlers }) => {
  ...
  it(
    'skal vise feilmelding når en skriver inn bokstaver i fra-beløpfelt',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(SorteringsvelgerNårKunTilbakekrevingErValgt.parameters['msw']);
      render(<SorteringsvelgerNårKunTilbakekrevingErValgt />);
      expect(await screen.findByText('Dato for behandlingsfrist')).toBeInTheDocument();
  ...
  it(
    'skal vise feilmelding når en skriver inn bokstaver i til-beløpfelt',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(SorteringsvelgerNårKunTilbakekrevingErValgt.parameters['msw']);
      render(<SorteringsvelgerNårKunTilbakekrevingErValgt />);
      expect(await screen.findByText('Dato for behandlingsfrist')).toBeInTheDocument();
  ...
  it(
    'skal vise fem sorteringsvalg når kun tilbakekreving er valgt',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(SorteringsvelgerNårKunTilbakekrevingErValgt.parameters['msw']);
      render(<SorteringsvelgerNårKunTilbakekrevingErValgt />);
      expect(await screen.findByText('Dato for behandlingsfrist')).toBeInTheDocument();
