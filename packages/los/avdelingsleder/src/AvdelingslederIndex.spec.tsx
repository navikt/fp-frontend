...
describe('AvdelingslederIndex', () => {
  it.skip('skal vise lasteikon før valgt avdeling er satt', async () => {
    applyRequestHandlers(LasteIkonFørValgtAvdelingErSatt.parameters['msw'] as MswParameters['msw']);
  ...
  it('skal vise at en ikke har tilgang til avdelingsleder-siden', async () => {
    applyRequestHandlers(HarIkkeTilgang.parameters['msw'] as MswParameters['msw']);
  ...
  it('skal filtere bort avdelinger som krever kode 6 når avdelingsleder ikke har tilgang til dette', async () => {
    applyRequestHandlers(SkalFiltrereBortAvdelingerSomKreverKode6.parameters['msw'] as MswParameters['msw']);
