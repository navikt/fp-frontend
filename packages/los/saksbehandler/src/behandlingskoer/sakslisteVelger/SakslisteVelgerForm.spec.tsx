...
describe('SakslisteVelgerForm', () => {
  it(
    'skal vise dropdown med en saksliste',
  ...
  it(
    'skal vise dropdown med to saksliste og så bytte valgt liste',
    mswWrapper(async ({ setHandlers }) => {
  ...
  it(
    'skal i utgangspunktet kun vise tre saksbehandlere og så klikke for å vise alle',
    mswWrapper(async ({ setHandlers }) => {
