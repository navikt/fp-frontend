...
import { vilkarUtfall, getKodeverknavnFn, KodeverkType } from '@navikt/fp-kodeverk';
...
const getAvslagArsak = (
  ...
  const avslatteVilkar = vilkar.filter(v => v.vilkarStatus === vilkarUtfall.IKKE_OPPFYLT);
