...
export const AksjonspunktGodkjenningFieldArray: FunctionComponent<OwnProps> = ({
  ...
  <>
    {fields.map((id, index) => {
      ...
      const aksjonspunkt = aksjonspunkter[index];
      ...
      const skjermlenke = createLocationForSkjermlenke(location, context.skjermlenkeType);
      const skjermlenkeNavn = skjermlenkeTypeKodeverk.navn;
