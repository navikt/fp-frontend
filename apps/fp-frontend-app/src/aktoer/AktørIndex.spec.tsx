...
describe('AktørIndex', () => {
  mswTest('skal vise lister med fagsaker', async ({ setHandlers }) => {
  ...
  mswTest('skal ikke ha noen fagsaker i fpsak', async ({ setHandlers }) => {
  ...
  mswTest.skip('skal feile på api-kall', async ({ setHandlers }) => {
