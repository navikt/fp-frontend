...
describe('FagsakIndex', () => {
  it(
    'skal vise fagsak-delen av app og vente på at behandling skal vises',
  ...
  it(
    'skal vise åpning og lukking av sidepanel ved storskjerm',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(Default.parameters['msw']);
      render(
  ...
  it(
    'skal skjule knapp for åpning eller lukking av sidepanel ved småskjerm',
    mswWrapper(async ({ setHandlers }) => {
      setHandlers(Default.parameters['msw']);
      render(
