...
export const behandlingFellesEndepunkter = new RestApiConfigBuilder()
  ...
  .withRel('lagre-overstyr-aksjonspunkter', BehandlingFellesApiKeys.SAVE_OVERSTYRT_AKSJONSPUNKT)
  .withRel('opprett-verge', BehandlingFellesApiKeys.VERGE_OPPRETT)
  .withRel('fjern-verge', BehandlingFellesApiKeys.VERGE_FJERN)
  .withRel(
    'arbeidsforhold-inntektsmelding-registrer',
  ...
  /* FPTILBAKE */
  .withPost('/fptilbake/api/dokument/forhandsvis-varselbrev', BehandlingFellesApiKeys.PREVIEW_TILBAKEKREVING_MESSAGE, {
    isResponseBlob: true,
  })
