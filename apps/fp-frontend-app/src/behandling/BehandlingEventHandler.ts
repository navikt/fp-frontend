...
class BehandlingEventHandler {
  ...
  henleggBehandling = (params: { årsakKode: string; begrunnelse: string }) =>
  ...
  lagreRisikoklassifiseringAksjonspunkt = (params: { saksnummer: string; bekreftedeAksjonspunktDtoer: any[] }) =>
