...
describe('Dekorator', () => {
  ...
  it('skal vise feilmeldinger som ligger i URL', async () => {
    applyRequestHandlers(VisFeilmeldingSomLiggIUrl.parameters['msw']);
  ...
  it('skal vise feilmeldinger som oppstår ved kodefeil', async () => {
    applyRequestHandlers(VisTekniskFeilmelding.parameters['msw']);
  ...
  it('skal ikke vise feilmelding når den er skjult manuelt', async () => {
    applyRequestHandlers(SkjulFeilmelding.parameters['msw']);
