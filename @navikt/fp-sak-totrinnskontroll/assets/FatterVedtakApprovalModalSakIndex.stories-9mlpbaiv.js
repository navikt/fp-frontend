...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Zn={title:"sak/sak-totrinnskontroll-fatter-vedtak-modal",component:W},K=({closeEvent:e,behandling:n,allAksjonspunktApproved:r})=>u.jsx(W,{behandling:n,closeEvent:e,allAksjonspunktApproved:r}),M=K.bind({});M.args={closeEvent:I("button-click"),behandling:{uuid:"1",status:B.FATTER_VEDTAK,type:v.FORSTEGANGSSOKNAD},allAksjonspunktApproved:!0};const x=K.bind({});x.args={closeEvent:I("button-click"),behandling:{uuid:"1",status:B.FATTER_VEDTAK,type:v.FORSTEGANGSSOKNAD,behandlingsresultat:{type:N.OPPHOR}},allAksjonspunktApproved:!0};const S=K.bind({});S.args={closeEvent:I("button-click"),behandling:{uuid:"1",status:B.FATTER_VEDTAK,type:v.KLAGE,behandlingsresultat:{type:N.OPPHOR}},allAksjonspunktApproved:!0};const D=K.bind({});D.args={closeEvent:I("button-click"),behandling:{uuid:"1",status:B.FATTER_VEDTAK,type:v.FORSTEGANGSSOKNAD,behandlingsresultat:{type:N.OPPHOR}},allAksjonspunktApproved:!1};var ue,ge,ce;M.parameters={...M.parameters,docs:{...(ue=M.parameters)==null?void 0:ue.docs,source:{originalSource:`({
  closeEvent,
  behandling,
