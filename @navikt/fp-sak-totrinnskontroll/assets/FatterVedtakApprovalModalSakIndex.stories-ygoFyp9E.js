...
| 'BT-007'
| 'BT-009'
| '-'`,elements:[{name:"literal",value:"'BT-002'"},{name:"literal",value:"'BT-003'"},{name:"literal",value:"'BT-004'"},{name:"literal",value:"'BT-008'"},{name:"literal",value:"'BT-006'"},{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"},{name:"literal",value:"'-'"}]},description:""},harSammeResultatSomOriginalBehandling:{required:!1,tsType:{name:"boolean"},description:""}}};const Fa=Ge($e),ke=({behandling:e,closeEvent:a,allAksjonspunktApproved:l})=>g.jsx(Ve,{value:Fa,children:g.jsx(Re,{closeEvent:a,allAksjonspunktApproved:l,behandlingsresultat:e.behandlingsresultat??void 0,behandlingStatusKode:e.status,behandlingTypeKode:e.type,harSammeResultatSomOriginalBehandling:ze(e)?!1:e.behandlingsresultat?.erRevurderingMedUendretUtfall})});ke.__docgenInfo={description:"",methods:[],displayName:"FatterVedtakTotrinnskontrollModalSakIndex",props:{behandling:{required:!0,tsType:{name:"union",raw:"FagsakBehandlingDtoFpSak | FagsakBehandlingDtoFpTilbake",elements:[{name:"signature",type:"object",raw:`{
