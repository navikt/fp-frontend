...
}`,signature:{properties:[{key:"aktivitetType",value:{name:"string",required:!0}},{key:"erEndring",value:{name:"boolean",required:!0}},{key:"godkjent",value:{name:"boolean",required:!0}},{key:"arbeidsgiverReferanse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"arbeidsgiverNavn",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"orgnr",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"privatpersonFødselsdato",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},description:""}}};const nt=e=>e?.fastsattVarigEndringNaering?v.jsx(H,{id:"ToTrinnsForm.Beregning.VarigEndring"}):v.jsx(H,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),Ka=e=>e.uttakPerioder?e.uttakPerioder.map(r=>{const n=Ea(r.fom),a=Ea(r.tom);let l;return r.erSlettet?l="ToTrinnsForm.AvklarUttak.PeriodeSlettet":r.erLagtTil?l="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":r.erEndret&&(e.aksjonspunktKode===f.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===f.TILKNYTTET_STORTINGET)?l="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":r.erEndret&&e.aksjonspunktKode===f.OVERSTYRING_AV_UTTAKPERIODER||r.erEndret&&e.aksjonspunktKode===f.OVERSTYR_FAKTA_UTTAK?l="ToTrinnsForm.OverstyrUttak.PeriodeEndret":r.erEndret?l="ToTrinnsForm.AvklarUttak.PeriodeEndret":l="ToTrinnsForm.AvklarUttak.PeriodeAvklart",v.jsx(H,{id:l,values:{a:n,b:a}},l)}):[],at=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(r=>v.jsx(ur,{aktivitet:r},r.aktivitetType)):[],rt=e=>{const r=Wl[e.aksjonspunktKode];return r?[v.jsx(H,{id:r},r)]:[]},lt=e=>{const r=Zl[e.aksjonspunktKode];return r?[v.jsx(H,{id:r},r)]:[]},tt=e=>{const r=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[v.jsx(H,{id:r},r)]},it=(e,r)=>r?.faktaOmBeregningTilfeller?r.faktaOmBeregningTilfeller.flatMap(n=>{const a=e.find(l=>l.kode===n);return a?[v.jsx("div",{children:a.navn},a.navn)]:[]}):[],Et=e=>{let r="";switch(e?.type){case Fe.KLAGE_YTELSESVEDTAK_STADFESTET:r="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case Fe.KLAGE_YTELSESVEDTAK_OPPHEVET:r="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case Fe.KLAGE_AVVIST:r="ToTrinnsForm.Klage.Avvist";break;case Fe.HJEMSENDE_UTEN_OPPHEVE:r="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case Fe.KLAGE_DELVIS_MEDHOLD:r="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case Fe.KLAGE_OMGJORT_UGUNST:r="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case Fe.KLAGE_MEDHOLD:r="ToTrinnsForm.Klage.OmgjortTilGunst";break}return v.jsx(H,{id:r})},ot=(e,r)=>e===Ln.FATTER_VEDTAK?[Et(r)]:[],st=()=>v.jsx(H,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),ut=()=>v.jsx(H,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),dt=e=>e.aksjonspunktKode===f.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===f.VURDERING_AV_FORMKRAV_KLAGE_NFP,dr=(e,r,n,a,l,t)=>l.aksjonspunktKode===f.VURDER_PERIODER_MED_OPPTJENING?at(l):l.aksjonspunktKode===f.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[nt(l.beregningDto)]:l.aksjonspunktKode===f.VURDER_FAKTA_FOR_ATFL_SN?it(n,l.beregningDto):Yr(l.aksjonspunktKode)&&l.uttakPerioder&&l.uttakPerioder.length>0||qr(l.aksjonspunktKode)&&l.uttakPerioder&&l.uttakPerioder.length>0?Ka(l):l.aksjonspunktKode===f.AVKLAR_ANNEN_FORELDER_RETT?[st()]:l.aksjonspunktKode===f.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?tt(e):l.aksjonspunktKode===f.OVERSTYRING_AV_RETT_OG_OMSORG?[ut()]:dt(l)?ot(r,t):a?lt(l):rt(l);function Tt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Da={exports:{}},We={};/**
 * @license React
 ...
 */var Ia;function kt(){if(Ia)return We;Ia=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var o in l)o!=="key"&&(t[o]=l[o])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return We.Fragment=r,We.jsx=n,We.jsxs=n,We}var Fa;function vt(){return Fa||(Fa=1,Da.exports=kt()),Da.exports}var Ke=vt();const _t=({children:e})=>{const r=h.Children.toArray(e);return r.length===0?null:Ke.jsx(il,{variant:"warning",size:"small",children:Ke.jsx(_e,{gap:"space-8","data-testid":"aksjonspunkt-text-container",children:r.map(n=>Ke.jsx(ne,{size:"small",children:n},Rt(n)))})})},Rt=e=>{if(h.isValidElement(e))return e.key;if(typeof e=="string"||typeof e=="number")return`tekst-${e}`},rn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};je(rn);const gn="var(--ax-bg-neutral-strong)",Tr=4,mt=(e,r,n)=>`
  .arrowBoxTop${e} {
...
`,Nt=(e,r,n,a)=>r?At(e,n,a):mt(e,n,a),gt=(e,r,n)=>n?"":r?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,St=({children:e,alignOffset:r=0,alignLeft:n=!1,marginTop:a=0,marginLeft:l=0,hideBorder:t=!1})=>Ke.jsxs(Ke.Fragment,{children:[Ke.jsx("style",{dangerouslySetInnerHTML:{__html:Nt(r,n,a,l)}}),Ke.jsx("div",{className:gt(r,n,t),children:e})]});var ya={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Oa;function Lt(){return Oa||(Oa=1,(function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var o=arguments[E];o&&(t=l(t,a.call(this,o)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return this&&this[t]||t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(this,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var o in t)r.call(t,o)&&t[o]&&(E=l(E,this&&this[o]||o));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(ya)),ya.exports}var Kt=Lt();const ra=Tt(Kt),Dt="_borderbox_1a0x6_1",It="_error_1a0x6_5",Ft="_warning_1a0x6_8",yt={borderbox:Dt,error:It,warning:Ft};ra.bind(yt);const Ot="_aksjonspunkt_11wjs_1",pt="_erAksjonspunktApent_11wjs_4",ft="_erIkkeGodkjentAvBeslutter_11wjs_8",Vt={aksjonspunkt:Ot,erAksjonspunktApent:pt,erIkkeGodkjentAvBeslutter:ft};ra.bind(Vt);je(rn);je(rn);const Gt="_divider_1jpov_1",Pt="_dividerParagraf_1jpov_8",bt="_leftPanel_1jpov_11",ct="_rightPanel_1jpov_14",Ut={divider:Gt,dividerParagraf:Pt,leftPanel:bt,rightPanel:ct};ra.bind(Ut);const kr=()=>Ke.jsx("span",{"data-testid":"editedIcon",children:Ke.jsx(Qr,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});je(rn);je(rn);var wn={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var pa;function Mt(){return pa||(pa=1,(function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var o=arguments[E];o&&(t=l(t,a(o)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(null,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var o in t)r.call(t,o)&&t[o]&&(E=l(E,o));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(wn)),wn.exports}var Bt=Mt();const ht=Dr(Bt);function jt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var fa={exports:{}},Ze={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Va;function Ht(){if(Va)return Ze;Va=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var o in l)o!=="key"&&(t[o]=l[o])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return Ze.Fragment=r,Ze.jsx=n,Ze.jsxs=n,Ze}var Ga;function wt(){return Ga||(Ga=1,fa.exports=Ht()),fa.exports}var Q=wt();const la=e=>e.reduce((r,n,a)=>({...r,[a]:l=>n(l)||!0}),{}),Sn=(e,r)=>r.split(".").reduce((n,a)=>n!==void 0?n[a]:n,e)?.message,Me=({label:e,validate:r=[],readOnly:n=!1,onChange:a,onClick:l,className:t,size:E="small",...o})=>{const{name:m,control:_,disabled:T}=o,{formState:{errors:A}}=Ae(),{field:k}=ea({name:m,control:_,rules:{validate:h.useMemo(()=>la(r),[r])}}),F=Sn(A,m);return Q.jsxs(Q.Fragment,{children:[Q.jsx(Nl,{size:E,disabled:T||n,checked:k.value===!0,className:t,error:!!F,...k,onChange:O=>{k.onChange(O),a&&a(O.currentTarget.checked)},onClick:()=>{l&&l()},children:e}),F&&Q.jsx(In,{children:Sn(A,m)})]})};var zn={exports:{}},Yt=zn.exports,Pa;function qt(){return Pa||(Pa=1,(function(e,r){(function(n,a){e.exports=a()})(Yt,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},a=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,l=/\d/,t=/\d\d/,E=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,m={},_=function(g){return(g=+g)+(g>68?1900:2e3)},T=function(g){return function(P){this[g]=+P}},A=[/[+-]\d\d:?(\d\d)?|Z/,function(g){(this.zone||(this.zone={})).offset=(function(P){if(!P||P==="Z")return 0;var N=P.match(/([+-]|\d\d)/g),p=60*N[1]+(+N[2]||0);return p===0?0:N[0]==="+"?-p:p})(g)}],k=function(g){var P=m[g];return P&&(P.indexOf?P:P.s.concat(P.f))},F=function(g,P){var N,p=m.meridiem;if(p){for(var G=1;G<=24;G+=1)if(g.indexOf(p(G,0,P))>-1){N=G>12;break}}else N=g===(P?"pm":"PM");return N},O={A:[o,function(g){this.afternoon=F(g,!1)}],a:[o,function(g){this.afternoon=F(g,!0)}],Q:[l,function(g){this.month=3*(g-1)+1}],S:[l,function(g){this.milliseconds=100*+g}],SS:[t,function(g){this.milliseconds=10*+g}],SSS:[/\d{3}/,function(g){this.milliseconds=+g}],s:[E,T("seconds")],ss:[E,T("seconds")],m:[E,T("minutes")],mm:[E,T("minutes")],H:[E,T("hours")],h:[E,T("hours")],HH:[E,T("hours")],hh:[E,T("hours")],D:[E,T("day")],DD:[t,T("day")],Do:[o,function(g){var P=m.ordinal,N=g.match(/\d+/);if(this.day=N[0],P)for(var p=1;p<=31;p+=1)P(p).replace(/\[|\]/g,"")===g&&(this.day=p)}],w:[E,T("week")],ww:[t,T("week")],M:[E,T("month")],MM:[t,T("month")],MMM:[o,function(g){var P=k("months"),N=(k("monthsShort")||P.map(function(p){return p.slice(0,3)})).indexOf(g)+1;if(N<1)throw new Error;this.month=N%12||N}],MMMM:[o,function(g){var P=k("months").indexOf(g)+1;if(P<1)throw new Error;this.month=P%12||P}],Y:[/[+-]?\d+/,T("year")],YY:[t,function(g){this.year=_(g)}],YYYY:[/\d{4}/,T("year")],Z:A,ZZ:A};function V(g){var P,N;P=g,N=m&&m.formats;for(var p=(g=P.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,b){var U=b&&b.toUpperCase();return x||N[b]||n[b]||N[U].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(j,q,Y){return q||Y.slice(1)})})).match(a),G=p.length,R=0;R<G;R+=1){var D=p[R],I=O[D],M=I&&I[0],B=I&&I[1];p[R]=B?{regex:M,parser:B}:D.replace(/^\[|\]$/g,"")}return function(w){for(var x={},b=0,U=0;b<G;b+=1){var j=p[b];if(typeof j=="string")U+=j.length;else{var q=j.regex,Y=j.parser,ee=w.slice(U),Ee=q.exec(ee)[0];Y.call(x,Ee),w=w.replace(Ee,"")}}return(function(oe){var Ne=oe.afternoon;if(Ne!==void 0){var ae=oe.hours;Ne?ae<12&&(oe.hours+=12):ae===12&&(oe.hours=0),delete oe.afternoon}})(x),x}}return function(g,P,N){N.p.customParseFormat=!0,g&&g.parseTwoDigitYear&&(_=g.parseTwoDigitYear);var p=P.prototype,G=p.parse;p.parse=function(R){var D=R.date,I=R.utc,M=R.args;this.$u=I;var B=M[1];if(typeof B=="string"){var w=M[2]===!0,x=M[3]===!0,b=w||x,U=M[2];x&&(U=M[2]),m=this.$locale(),!w&&U&&(m=N.Ls[U]),this.$d=(function(ee,Ee,oe,Ne){try{if(["x","X"].indexOf(Ee)>-1)return new Date((Ee==="X"?1e3:1)*ee);var ae=V(Ee)(ee),we=ae.year,ye=ae.month,pn=ae.day,ln=ae.hours,fn=ae.minutes,Ye=ae.seconds,tn=ae.milliseconds,Ge=ae.zone,Pe=ae.week,qe=new Date,be=pn||(we||ye?1:qe.getDate()),xe=we||qe.getFullYear(),Oe=0;we&&!ye||(Oe=ye>0?ye-1:qe.getMonth());var pe,Je=ln||0,Ce=fn||0,En=Ye||0,ce=tn||0;return Ge?new Date(Date.UTC(xe,Oe,be,Je,Ce,En,ce+60*Ge.offset*1e3)):oe?new Date(Date.UTC(xe,Oe,be,Je,Ce,En,ce)):(pe=new Date(xe,Oe,be,Je,Ce,En,ce),Pe&&(pe=Ne(pe).week(Pe).toDate()),pe)}catch{return new Date("")}})(D,B,I,N),this.init(),U&&U!==!0&&(this.$L=this.locale(U).$L),b&&D!=this.format(B)&&(this.$d=new Date("")),m={}}else if(B instanceof Array)for(var j=B.length,q=1;q<=j;q+=1){M[1]=B[q-1];var Y=N.apply(this,M);if(Y.isValid()){this.$d=Y.$d,this.$L=Y.$L,this.init();break}q===j&&(this.$d=new Date(""))}else G.call(this,R)}}})})(zn)),zn.exports}var xt=qt();const Jt=jt(xt),Ct="_textarea_14c7r_1",$t="_readOnlyField_14c7r_7",ba={textarea:Ct,readOnlyField:$t},zt=e=>e!=null&&e!=="",Wt=({label:e,value:r,isEdited:n=!1,type:a,hideLabel:l,size:t})=>zt(r)?Q.jsxs(_e,{gap:"space-4",children:[e&&!l&&Q.jsx(Dn,{size:t,children:e}),Q.jsxs(Ve,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(qa,{className:a==="textarea"?ba.textarea:ba.readOnlyField,size:t,children:r}),n&&Q.jsx(kr,{})]})]}):null;Ir.extend(Jt);const Zt="_noReadOnlyIcon_11vhl_2",Xt={noReadOnlyIcon:Zt},Qt=({label:e,description:r,validate:n=[],onChange:a,children:l,className:t,isReadOnly:E=!1,size:o="small",isEdited:m=!1,hideLegend:_=!1,...T})=>{const{name:A,control:k}=T,{formState:{errors:F}}=Ae(),{field:O}=ea({name:A,control:k,rules:{validate:la(n)}});return Q.jsx(Sl,{name:A,value:O.value!==void 0?O.value:null,legend:Q.jsxs(Ve,{justify:"center",gap:"space-8",children:[e,E&&m&&Q.jsx(kr,{})]}),hideLegend:_,"aria-readonly":E,readOnly:E,description:r,size:o,error:Sn(F,A),onChange:V=>{a&&a(V),O.onChange(V)},className:ht(t,Xt.noReadOnlyIcon),children:l})},ei="_textAreaFieldWithBadges_bdz0b_1",ni="_etikettWrapper_bdz0b_4",ca={textAreaFieldWithBadges:ei,etikettWrapper:ni},ai=({name:e,control:r,label:n,readOnly:a,maxLength:l,badges:t,validate:E=[],parse:o=F=>F,className:m,description:_,isEdited:T,size:A="small",...k})=>{const{formState:{errors:F}}=Ae(),{field:O}=ea({name:e,control:r,rules:{validate:h.useMemo(()=>la(E),[E])}});return a?Q.jsx(Wt,{size:A,label:n,value:O.value,type:"textarea",isEdited:T,hideLabel:k.hideLabel}):Q.jsxs("div",{className:t?ca.textAreaFieldWithBadges:null,children:[t&&Q.jsx("div",{className:ca.etikettWrapper,children:t.map(({type:V,titleText:g})=>Q.jsx(Tl,{variant:V,size:"small",children:g},g))}),Q.jsx(Ol,{size:A,label:n,description:_,className:m,autoComplete:"off",...O,onChange:V=>O.onChange(V.currentTarget.value!==""?o(V.currentTarget.value):null),value:O.value?O.value:"",error:Sn(F,e),maxLength:l,...k})]})},ri=({formMethods:e,onSubmit:r,children:n,className:a,setDataOnUnmount:l})=>{const{handleSubmit:t,getValues:E}=e;return h.useEffect(()=>()=>{l&&l(E())},[]),Q.jsx(Vl,{...e,children:Q.jsx("form",{className:a,onSubmit:r?t(o=>r(o)):void 0,children:n})})},li=(e,r)=>{const{setError:n,clearErrors:a,formState:l}=Ae(),t=!!r;return h.useEffect(()=>{t&&n(`${e}.notRegisteredInput`,{type:"custom",message:r}),t||a(`${e}.notRegisteredInput`)},[r]),l.isSubmitted?e.split(".").reduce((E,o)=>E[o]||{},l.errors)?.notRegisteredInput?.message:void 0},ti=Or(3),ii=pr(2e3),le="aksjonspunktGodkjenning",Ei=(e,r)=>!e(`${le}.${r}.feilFakta`)&&!e(`${le}.${r}.feilLov`)&&!e(`${le}.${r}.feilSkjønn`)&&!e(`${le}.${r}.feilUtredning`)&&!e(`${le}.${r}.feilSaksflyt`)&&!e(`${le}.${r}.feilBegrunnelse`),vr=({index:e,totrinnskontrollSkjermlenkeContext:r,readOnly:n})=>{const{watch:a,getValues:l,control:t}=Ae(),E=a("aksjonspunktGodkjenning"),{aksjonspunktKode:o,totrinnskontrollGodkjent:m}=E[e],_=r.find(F=>F.totrinnskontrollAksjonspunkter.some(O=>O.aksjonspunktKode===o)),T=_?.totrinnskontrollAksjonspunkter.find(F=>F.aksjonspunktKode===o),A=!m&&Ei(l,e)?Fr():void 0,k=li(`${le}.${e}.faktagruppe`,A);return!_||!T?null:v.jsxs(_e,{gap:"space-12",children:[v.jsx(Qt,{name:`${le}.${e}.totrinnskontrollGodkjent`,control:t,isReadOnly:n,hideLegend:!0,children:v.jsxs(Ve,{gap:"space-16",children:[v.jsx(sa,{value:!0,size:"small",children:v.jsx(H,{id:"ApprovalField.Godkjent"})}),v.jsx(sa,{value:!1,size:"small",children:v.jsx(H,{id:"ApprovalField.Vurder"})})]})}),m===!1&&v.jsx(St,{alignOffset:m?1:110,children:v.jsxs(_e,{gap:"space-8",children:[v.jsx(Dn,{size:"small",children:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),v.jsx(ne,{size:"small",children:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),v.jsxs(_e,{gap:"space-16",children:[v.jsx(_e,{gap:"space-4",children:v.jsxs(Ve,{justify:"space-between",style:{width:"300px"},children:[v.jsxs(_e,{gap:"space-4",children:[v.jsx(Me,{name:`${le}.${e}.feilFakta`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilSkjønn`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilLov`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),v.jsxs(_e,{gap:"space-4",children:[v.jsx(Me,{name:`${le}.${e}.feilUtredning`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilSaksflyt`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilBegrunnelse`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),k&&v.jsx(In,{size:"small",children:k}),v.jsx(ai,{name:`${le}.${e}.besluttersBegrunnelse`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[yr,ti,ii,fr],readOnly:n})]})]})})]})};vr.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"erSlettet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erEndret",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erLagtTil",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}}],raw:"Array<foreldrepenger_domene_uttak_UttakPeriodeEndringDto>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const oi="_aksjonspunktTextContainer_1pwmv_5",si="_lenke_1pwmv_10",Ua={aksjonspunktTextContainer:oi,lenke:si},ui="aksjonspunktGodkjenning",_r=({behandling:e,totrinnskontrollSkjermlenkeContext:r,readOnly:n,erForeldrepengerFagsak:a,erTilbakekreving:l,skjemalenkeTyper:t,faktaOmBeregningTilfeller:E,lagLenke:o})=>{const{control:m,watch:_}=Ae(),{fields:T}=$l({control:m,name:ui}),A=_("aksjonspunktGodkjenning");return v.jsx(_e,{gap:"space-24",children:T.map((k,F)=>{const{aksjonspunktKode:O}=A[F],V=r.find(G=>G.totrinnskontrollAksjonspunkter.some(R=>R.aksjonspunktKode===O)),g=V?.totrinnskontrollAksjonspunkter.find(G=>G.aksjonspunktKode===O);if(!V||!g)return null;const P=dr(a,e.status,E,l,g,e.behandlingsresultat),N=t.find(G=>G.kode===V.skjermlenkeType),p=o(V.skjermlenkeType);return v.jsxs("div",{children:[p&&N&&v.jsx(Ha,{to:p,onClick:()=>window.scroll(0,0),className:Ua.lenke,children:N.navn}),P.map((G,R)=>v.jsx("div",{className:Ua.aksjonspunktTextContainer,children:v.jsx(ne,{size:"small",children:G})},O.concat("_".concat(R.toString())))),v.jsx(vr,{index:F,totrinnskontrollSkjermlenkeContext:r,readOnly:n})]},k.id)})})};_r.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  skjermlenkeType: string;
  totrinnskontrollAksjonspunkter: Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>;
}`,signature:{properties:[{key:"skjermlenkeType",value:{name:"string",required:!0}},{key:"totrinnskontrollAksjonspunkter",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aksjonspunktKode: string;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Ma=(e=[])=>e.every(r=>r.totrinnskontrollGodkjent),Ba=(e=[])=>e.every(r=>r.totrinnskontrollGodkjent!==void 0&&r.totrinnskontrollGodkjent!==null),di=(e,r)=>{if(!r)return!0;const{konsekvenserForYtelsen:n}=r;return!Array.isArray(n)||n.length!==1?!0:!e.some(a=>a===n[0])},Ti=e=>e.reduce((r,n)=>n===te.FEIL_FAKTA?{...r,feilFakta:!0}:n===te.FEIL_LOV?{...r,feilLov:!0}:n===te.FEIL_REGEL?{...r,feilSkjønn:!0}:n===te.SKJØNN?{...r,feilSkjønn:!0}:n===te.UTREDNING?{...r,feilUtredning:!0}:n===te.SAKSFLYT||n===te.ANNET?{...r,feilSaksflyt:!0}:n===te.BEGRUNNELSE?{...r,feilBegrunnelse:!0}:{},{}),ki=e=>({aksjonspunktGodkjenning:e.map(r=>r.totrinnskontrollAksjonspunkter).flat().map(r=>({aksjonspunktKode:r.aksjonspunktKode,totrinnskontrollGodkjent:r.totrinnskontrollGodkjent,besluttersBegrunnelse:wa(r.besluttersBegrunnelse??void 0),...Ti(r.vurderPaNyttArsaker?r.vurderPaNyttArsaker:[])}))}),Rr=({behandling:e,onSubmit:r,forhandsvisVedtaksbrev:n,readOnly:a,erBehandlingEtterKlage:l,erForeldrepengerFagsak:t,skjemalenkeTyper:E,erTilbakekreving:o,totrinnskontrollSkjermlenkeContext:m,faktaOmBeregningTilfeller:_,lagLenke:T,beslutterFormData:A,setBeslutterFormData:k})=>{const F=e&&e.type===Xe.KLAGE,O=e&&e.type===Xe.ANKE,V=di([xn.ENDRING_I_FORDELING_AV_YTELSEN,xn.INGEN_ENDRING],e.behandlingsresultat),g=ki(m),P=zl({defaultValues:A||g}),N=P.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?v.jsx(ri,{formMethods:P,onSubmit:r,setDataOnUnmount:k,children:v.jsxs(_e,{gap:"space-24",children:[!a&&v.jsx(_t,{children:v.jsx(H,{id:"HelpText.ToTrinnsKontroll"})}),v.jsx(_r,{behandling:e,erForeldrepengerFagsak:t,erTilbakekreving:o,readOnly:a,totrinnskontrollSkjermlenkeContext:m,skjemalenkeTyper:E,faktaOmBeregningTilfeller:_,lagLenke:T}),v.jsxs(Ve,{gap:"space-16",style:{marginBottom:"50px"},children:[v.jsx(Yn,{variant:"primary",size:"small",disabled:!Ma(N)||!Ba(N)||P.formState.isSubmitting,loading:P.formState.isSubmitting,children:v.jsx(H,{id:"ToTrinnsForm.Godkjenn"})}),v.jsx(Yn,{variant:"primary",size:"small",disabled:Ma(N)||!Ba(N)||P.formState.isSubmitting,loading:P.formState.isSubmitting,children:v.jsx(H,{id:"ToTrinnsForm.SendTilbake"})}),!F&&!l&&!O&&!o&&V&&v.jsx(sl,{href:"#",onClick:n,children:v.jsx(H,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};Rr.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const vi="_approvalItem_xqu47_1",_i="_approvalItemContainer_xqu47_7",Ri="_aksjonspunktTextContainer_xqu47_11",mi="_resultatFraGodkjenningTextContainer_xqu47_16",Ai="_lenke_xqu47_20",Ni="_checkmarkIcon_xqu47_24",gi="_xmark_xqu47_30",Se={approvalItem:vi,approvalItemContainer:_i,aksjonspunktTextContainer:Ri,resultatFraGodkjenningTextContainer:mi,lenke:Ai,checkmarkIcon:Ni,xmark:gi},Si=({vurderPaNyttArsaker:e,vurderArsaker:r})=>v.jsx("div",{className:Se.approvalItem,children:e?.map(n=>v.jsxs(Ve,{gap:"space-8",children:[v.jsx(nl,{className:Se.xmark}),v.jsx("div",{children:r.find(a=>n===a.kode)?.navn})]},n))}),mr=({behandling:e,totrinnskontrollSkjermlenkeContext:r,erForeldrepengerFagsak:n,erTilbakekreving:a,skjemalenkeTyper:l,vurderArsaker:t,faktaOmBeregningTilfeller:E,lagLenke:o})=>{const m=Vr();return v.jsxs(v.Fragment,{children:[v.jsx("div",{className:Se.resultatFraGodkjenningTextContainer,children:v.jsx(H,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Gr}})}),r.map(_=>{const T=_.totrinnskontrollAksjonspunkter,A=l.find(k=>k.kode===_.skjermlenkeType);if(T.length>0){const k=o(_.skjermlenkeType);return v.jsxs(u.Fragment,{children:[k&&A&&v.jsx(Ha,{to:k,onClick:()=>window.scroll(0,0),className:Se.lenke,children:A.navn}),T.map(F=>{const O=dr(n,e.status,E,a,F,e.behandlingsresultat);return v.jsxs("div",{className:Se.approvalItemContainer,children:[O.map((V,g)=>v.jsx("div",{className:Se.aksjonspunktTextContainer,children:v.jsx(ne,{size:"small",children:V})},F.aksjonspunktKode.concat("_".concat(g.toString())))),v.jsx("div",{className:Se.approvalItem,children:F.totrinnskontrollGodkjent?v.jsxs(Ve,{gap:"space-8",children:[v.jsx(Cr,{title:m.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:Se.checkmarkIcon}),v.jsx(H,{id:"ToTrinnsForm.Godkjent"})]}):v.jsx(Si,{vurderPaNyttArsaker:F?.vurderPaNyttArsaker,vurderArsaker:t})}),v.jsx("pre",{className:Se.approvalItem,children:wa(F.besluttersBegrunnelse??void 0)})]},F.aksjonspunktKode)})]},_.skjermlenkeType)}return null})]})};mr.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Li=je(jr),Ki=[sn.FAKTA_OM_FEILUTBETALING,sn.FORELDELSE,sn.TILBAKEKREVING,sn.VEDTAK],Di=e=>{const r=[];return e.feilFakta&&r.push(te.FEIL_FAKTA),e.feilLov&&r.push(te.FEIL_LOV),e.feilSkjønn&&r.push(te.SKJØNN),e.feilUtredning&&r.push(te.UTREDNING),e.feilSaksflyt&&r.push(te.SAKSFLYT),e.feilBegrunnelse&&r.push(te.BEGRUNNELSE),r},Ii=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Ar=({behandling:e,location:r,fagsakYtelseType:n,readOnly:a,onSubmit:l,forhandsvisVedtaksbrev:t,alleKodeverk:E,createLocationForSkjermlenke:o,beslutterFormData:m,setBeslutterFormData:_})=>{const T=Xe.TILBAKEKREVING===e.type||Xe.TILBAKEKREVING_REVURDERING===e.type,A=p=>{const G=p.aksjonspunktGodkjenning.map(I=>({aksjonspunktKode:I.aksjonspunktKode,godkjent:!!I.totrinnskontrollGodkjent,begrunnelse:I.besluttersBegrunnelse,arsaker:Di(I)})),R=T?Ca.FATTER_VEDTAK:f.FATTER_VEDTAK;return l({fatterVedtakAksjonspunktDto:{"@type":R,kode:R,begrunnelse:void 0,aksjonspunktGodkjenningDtos:G},erAlleAksjonspunktGodkjent:p.aksjonspunktGodkjenning.every(I=>I.totrinnskontrollGodkjent)})},k=e?e.behandlingÅrsaker.map(({behandlingArsakType:p})=>p).some(p=>p===kn.ETTER_KLAGE||p===kn.KLAGE_U_INNTK||p===kn.KLAGE_M_INNTK):!1,F=T?Ki.flatMap(p=>{const G=e.totrinnskontrollÅrsaker?.find(R=>R.skjermlenkeType===p.kode);return G?[G]:[]}):e.totrinnskontrollÅrsaker,O=p=>o(r,p),V=e.status===Ln.FATTER_VEDTAK,g=E.SkjermlenkeType,P=E.VurderÅrsak,N=Ii(E);return v.jsxs(Pr,{value:Li,children:[V&&v.jsx(Rr,{behandling:e,totrinnskontrollSkjermlenkeContext:F,readOnly:a,onSubmit:A,forhandsvisVedtaksbrev:t,erForeldrepengerFagsak:n==="FP",skjemalenkeTyper:g,erBehandlingEtterKlage:k,faktaOmBeregningTilfeller:N,erTilbakekreving:T,lagLenke:O,beslutterFormData:m,setBeslutterFormData:_}),!V&&v.jsx(mr,{behandling:e,totrinnskontrollSkjermlenkeContext:F,erForeldrepengerFagsak:n==="FP",erTilbakekreving:T,skjemalenkeTyper:g,lagLenke:O,vurderArsaker:P,faktaOmBeregningTilfeller:N})]})};Ar.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},location:{required:!0,tsType:{name:"Location"},description:""},fagsakYtelseType:{required:!0,tsType:{name:"union",raw:"'ES' | 'FP' | 'SVP' | '-'",elements:[{name:"literal",value:"'ES'"},{name:"literal",value:"'FP'"},{name:"literal",value:"'SVP'"},{name:"literal",value:"'-'"}]},description:""},alleKodeverk:{required:!0,tsType:{name:"union",raw:"AlleKodeverk | AlleKodeverkTilbakekreving",elements:[{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
>[]`}}]}}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ApData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const{action:ha}=__STORYBOOK_MODULE_ACTIONS__,ja={key:"1",pathname:"",search:"",state:{},hash:""},Nr={uuid:"1",versjon:2,status:Ln.FATTER_VEDTAK,type:Xe.FORSTEGANGSSOKNAD,behandlingÅrsaker:[],toTrinnsBehandling:!0,behandlingsresultat:{type:Fe.KLAGE_YTELSESVEDTAK_STADFESTET}},Fi=e=>v.jsx("div",{style:{width:"600px",margin:"50px",padding:"20px",backgroundColor:"var(--ax-bg-default)"},children:v.jsx(e,{})}),Vi={title:"sak/sak-totrinnskontroll",component:Ar,args:{onSubmit:ha("button-click"),location:ja,forhandsvisVedtaksbrev:ha("button-click"),fagsakYtelseType:"FP",alleKodeverk:xr,createLocationForSkjermlenke:()=>ja,setBeslutterFormData:()=>{}},decorators:[br,Fi]},dn={args:{behandling:{...Nr,totrinnskontrollÅrsaker:[{skjermlenkeType:Qe.FORMKRAV_KLAGE_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5082",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:["-"]},vurderPaNyttArsaker:[],uttakPerioder:[],besluttersBegrunnelse:null,totrinnskontrollGodkjent:!1}]},{skjermlenkeType:Qe.KLAGE_BEH_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5035",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:["-"]},vurderPaNyttArsaker:[],uttakPerioder:[],besluttersBegrunnelse:null,totrinnskontrollGodkjent:!1}]}]},readOnly:!1}},Tn={args:{behandling:{...Nr,status:Ln.BEHANDLING_UTREDES,totrinnskontrollÅrsaker:[{skjermlenkeType:Qe.FORMKRAV_KLAGE_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5082",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:["-"]},besluttersBegrunnelse:"Denne er ikke godkjent fordi...",totrinnskontrollGodkjent:!1,vurderPaNyttArsaker:["FEIL_LOV","FEIL_FAKTA"],uttakPerioder:[]}]},{skjermlenkeType:Qe.KLAGE_BEH_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5035",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:["-"]},totrinnskontrollGodkjent:!0,uttakPerioder:[],besluttersBegrunnelse:null,vurderPaNyttArsaker:[]}]}]},readOnly:!0}};dn.parameters={...dn.parameters,docs:{...dn.parameters?.docs,source:{originalSource:`{
  args: {
    behandling: {
      ...DEFAULT_BEHANDLING,
...
}`,...dn.parameters?.docs?.source}}};Tn.parameters={...Tn.parameters,docs:{...Tn.parameters?.docs,source:{originalSource:`{
  args: {
    behandling: {
      ...DEFAULT_BEHANDLING,
...
}`,...Tn.parameters?.docs?.source}}};const Gi=["ForBeslutter","ForSaksbehandler"];export{dn as ForBeslutter,Tn as ForSaksbehandler,Gi as __namedExportsOrder,Vi as default};
