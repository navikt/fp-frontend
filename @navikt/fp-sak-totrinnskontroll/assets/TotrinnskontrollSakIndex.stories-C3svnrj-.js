 ...
 */var Dr;function Mo(){if(Dr)return Xe;Dr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,o){var i=null;if(o!==void 0&&(i=""+o),t.key!==void 0&&(i=""+t.key),"key"in t){o={};for(var s in t)s!=="key"&&(o[s]=t[s])}else o=t;return t=o.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:o}}return Xe.Fragment=a,Xe.jsx=n,Xe.jsxs=n,Xe}var br;function ho(){return br||(br=1,Or.exports=Mo()),Or.exports}var z=ho();const rr=e=>e.reduce((a,n,r)=>({...a,[r]:t=>n(t)||!0}),{}),_n=(e,a)=>a.split(".").reduce((n,r)=>n!==void 0?n[r]:n,e)?.message,Me=({label:e,validate:a=[],readOnly:n=!1,onChange:r,onClick:t,className:o,...i})=>{const{name:s,control:m,disabled:g}=i,{formState:{errors:v}}=Re(),{field:_}=Xn({name:s,control:m,rules:{validate:P.useMemo(()=>rr(a),[a])}}),T=_n(v,s);return z.jsxs(z.Fragment,{children:[z.jsx(mt,{size:"small",disabled:g||n,checked:_.value===!0,className:o,error:!!T,..._,onChange:K=>{_.onChange(K),r&&r(K.currentTarget.checked)},onClick:()=>{t&&t()},children:e}),T&&z.jsx(Kn,{children:_n(v,s)})]})};var Jn={exports:{}},Uo=Jn.exports,Fr;function Bo(){return Fr||(Fr=1,function(e,a){(function(n,r){e.exports=r()})(Uo,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,t=/\d/,o=/\d\d/,i=/\d\d?/,s=/\d*[^-_:/,()\s\d]+/,m={},g=function(N){return(N=+N)+(N>68?1900:2e3)},v=function(N){return function(V){this[N]=+V}},_=[/[+-]\d\d:?(\d\d)?|Z/,function(N){(this.zone||(this.zone={})).offset=function(V){if(!V||V==="Z")return 0;var A=V.match(/([+-]|\d\d)/g),f=60*A[1]+(+A[2]||0);return f===0?0:A[0]==="+"?-f:f}(N)}],T=function(N){var V=m[N];return V&&(V.indexOf?V:V.s.concat(V.f))},K=function(N,V){var A,f=m.meridiem;if(f){for(var F=1;F<=24;F+=1)if(N.indexOf(f(F,0,V))>-1){A=F>12;break}}else A=N===(V?"pm":"PM");return A},G={A:[s,function(N){this.afternoon=K(N,!1)}],a:[s,function(N){this.afternoon=K(N,!0)}],Q:[t,function(N){this.month=3*(N-1)+1}],S:[t,function(N){this.milliseconds=100*+N}],SS:[o,function(N){this.milliseconds=10*+N}],SSS:[/\d{3}/,function(N){this.milliseconds=+N}],s:[i,v("seconds")],ss:[i,v("seconds")],m:[i,v("minutes")],mm:[i,v("minutes")],H:[i,v("hours")],h:[i,v("hours")],HH:[i,v("hours")],hh:[i,v("hours")],D:[i,v("day")],DD:[o,v("day")],Do:[s,function(N){var V=m.ordinal,A=N.match(/\d+/);if(this.day=A[0],V)for(var f=1;f<=31;f+=1)V(f).replace(/\[|\]/g,"")===N&&(this.day=f)}],w:[i,v("week")],ww:[o,v("week")],M:[i,v("month")],MM:[o,v("month")],MMM:[s,function(N){var V=T("months"),A=(T("monthsShort")||V.map(function(f){return f.slice(0,3)})).indexOf(N)+1;if(A<1)throw new Error;this.month=A%12||A}],MMMM:[s,function(N){var V=T("months").indexOf(N)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,v("year")],YY:[o,function(N){this.year=g(N)}],YYYY:[/\d{4}/,v("year")],Z:_,ZZ:_};function I(N){var V,A;V=N,A=m&&m.formats;for(var f=(N=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,c){var M=c&&c.toUpperCase();return x||A[c]||n[c]||A[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(B,Y,H){return Y||H.slice(1)})})).match(r),F=f.length,E=0;E<F;E+=1){var O=f[E],L=G[O],h=L&&L[0],U=L&&L[1];f[E]=U?{regex:h,parser:U}:O.replace(/^\[|\]$/g,"")}return function(w){for(var x={},c=0,M=0;c<F;c+=1){var B=f[c];if(typeof B=="string")M+=B.length;else{var Y=B.regex,H=B.parser,ee=w.slice(M),le=Y.exec(ee)[0];H.call(x,le),w=w.replace(le,"")}}return function(se){var me=se.afternoon;if(me!==void 0){var ne=se.hours;me?ne<12&&(se.hours+=12):ne===12&&(se.hours=0),delete se.afternoon}}(x),x}}return function(N,V,A){A.p.customParseFormat=!0,N&&N.parseTwoDigitYear&&(g=N.parseTwoDigitYear);var f=V.prototype,F=f.parse;f.parse=function(E){var O=E.date,L=E.utc,h=E.args;this.$u=L;var U=h[1];if(typeof U=="string"){var w=h[2]===!0,x=h[3]===!0,c=w||x,M=h[2];x&&(M=h[2]),m=this.$locale(),!w&&M&&(m=A.Ls[M]),this.$d=function(ee,le,se,me){try{if(["x","X"].indexOf(le)>-1)return new Date((le==="X"?1e3:1)*ee);var ne=I(le)(ee),He=ne.year,Oe=ne.month,Dn=ne.day,an=ne.hours,bn=ne.minutes,Ye=ne.seconds,tn=ne.milliseconds,Ve=ne.zone,ce=ne.week,xe=new Date,Ge=Dn||(He||Oe?1:xe.getDate()),Ce=He||xe.getFullYear(),De=0;He&&!Oe||(De=Oe>0?Oe-1:xe.getMonth());var be,Je=an||0,$e=bn||0,on=Ye||0,Pe=tn||0;return Ve?new Date(Date.UTC(Ce,De,Ge,Je,$e,on,Pe+60*Ve.offset*1e3)):se?new Date(Date.UTC(Ce,De,Ge,Je,$e,on,Pe)):(be=new Date(Ce,De,Ge,Je,$e,on,Pe),ce&&(be=me(be).week(ce).toDate()),be)}catch{return new Date("")}}(O,U,L,A),this.init(),M&&M!==!0&&(this.$L=this.locale(M).$L),c&&O!=this.format(U)&&(this.$d=new Date("")),m={}}else if(U instanceof Array)for(var B=U.length,Y=1;Y<=B;Y+=1){h[1]=U[Y-1];var H=A.apply(this,h);if(H.isValid()){this.$d=H.$d,this.$L=H.$L,this.init();break}Y===B&&(this.$d=new Date(""))}else F.call(this,E)}}})}(Jn)),Jn.exports}var qo=Bo();const wo=jo(qo),Ho="_textarea_14c7r_1",Yo="_readOnlyField_14c7r_7",Ir={textarea:Ho,readOnlyField:Yo},xo=e=>e!=null&&e!=="",Co=({label:e,value:a,isEdited:n=!1,type:r,hideLabel:t,size:o})=>xo(a)?z.jsxs(Te,{gap:"space-4",children:[e&&!t&&z.jsx(pn,{size:o,children:e}),z.jsxs(Ie,{gap:"space-8",align:"center",wrap:!1,children:[z.jsx(qr,{className:r==="textarea"?Ir.textarea:Ir.readOnlyField,size:o,children:a}),n&&z.jsx(Ea,{})]})]}):null;Ka.extend(wo);const Jo="_hideRadioLabels_1u3xf_1",$o={hideRadioLabels:Jo},zo=({label:e,description:a,validate:n=[],radios:r,onChange:t,isReadOnly:o=!1,isHorizontal:i=!1,parse:s=G=>G,isTrueOrFalseSelection:m=!1,hideLegend:g=!1,hideRadioLabels:v=!1,isEdited:_=!1,size:T="small",...K})=>{const{name:G,control:I,disabled:N}=K,{formState:{errors:V}}=Re(),{field:A}=Xn({name:G,control:I,rules:{validate:P.useMemo(()=>rr(n),[n])}}),f=m?E=>E==="true":s,F=z.jsxs(Ie,{justify:"center",gap:"space-8",children:[e,o&&_&&z.jsx(Ea,{})]});return z.jsxs(_t,{name:G,value:A.value!==void 0?A.value:null,onChange:E=>{t&&t(E),A.onChange(E)},size:T,legend:F,description:a,error:_n(V,G),className:v?$o.hideRadioLabels:"",hideLegend:g,children:[!i&&r.map(E=>z.jsxs(P.Fragment,{children:[z.jsx(sr,{size:T,value:f(E.value),disabled:E.disabled||N||o,children:E.label}),A.value===f(E.value)&&E.element]},E.value)),i&&z.jsxs(z.Fragment,{children:[z.jsx(Ie,{gap:"space-16",children:r.map(E=>z.jsx(sr,{size:T,value:f(E.value),disabled:E.disabled||N||o,children:E.label},E.value))}),r.filter(E=>A.value===f(E.value)).map(E=>z.jsx(P.Fragment,{children:E.element},E.value))]})]})},Wo="_textAreaFieldWithBadges_bdz0b_1",Zo="_etikettWrapper_bdz0b_4",Vr={textAreaFieldWithBadges:Wo,etikettWrapper:Zo},Xo=({name:e,control:a,label:n,readOnly:r,maxLength:t,badges:o,validate:i=[],parse:s=K=>K,className:m,description:g,isEdited:v,size:_="small",...T})=>{const{formState:{errors:K}}=Re(),{field:G}=Xn({name:e,control:a,rules:{validate:P.useMemo(()=>rr(i),[i])}});return r?z.jsx(Co,{size:_,label:n,value:G.value,type:"textarea",isEdited:v,hideLabel:T.hideLabel}):z.jsxs("div",{className:o?Vr.textAreaFieldWithBadges:null,children:[o&&z.jsx("div",{className:Vr.etikettWrapper,children:o.map(({type:I,titleText:N})=>z.jsx(Et,{variant:I,size:"small",children:N},N))}),z.jsx(Ot,{size:_,label:n,description:g,className:m,autoComplete:"off",...G,onChange:I=>G.onChange(I.currentTarget.value!==""?s(I.currentTarget.value):null),value:G.value?G.value:"",error:_n(K,e),maxLength:t,...T})]})},Qo=({formMethods:e,onSubmit:a,children:n,className:r,setDataOnUnmount:t})=>{const{handleSubmit:o,getValues:i}=e;return P.useEffect(()=>()=>{t&&t(i())},[]),z.jsx(Ft,{...e,children:z.jsx("form",{className:r,onSubmit:a?o(s=>a(s)):void 0,children:n})})},el=(e,a)=>{const{setError:n,clearErrors:r,formState:t}=Re(),o=!!a;return P.useEffect(()=>{o&&n(`${e}.notRegisteredInput`,{type:"custom",message:a}),o||r(`${e}.notRegisteredInput`)},[a]),t.isSubmitted?e.split(".").reduce((i,s)=>i[s]||{},t.errors)?.notRegisteredInput?.message:void 0},nl=Oa(3),rl=Da(2e3),ae="aksjonspunktGodkjenning",al=(e,a)=>!e(`${ae}.${a}.feilFakta`)&&!e(`${ae}.${a}.feilLov`)&&!e(`${ae}.${a}.feilSkjønn`)&&!e(`${ae}.${a}.feilUtredning`)&&!e(`${ae}.${a}.feilSaksflyt`)&&!e(`${ae}.${a}.feilBegrunnelse`),ua=({index:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n})=>{const{watch:r,getValues:t,control:o}=Re(),i=r("aksjonspunktGodkjenning"),{aksjonspunktKode:s,totrinnskontrollGodkjent:m}=i[e],g=a.find(K=>K.totrinnskontrollAksjonspunkter.some(G=>G.aksjonspunktKode===s)),v=g?.totrinnskontrollAksjonspunkter.find(K=>K.aksjonspunktKode===s),_=!m&&al(t,e)?fa():void 0,T=el(`${ae}.${e}.faktagruppe`,_);return!g||!v?null:R.jsxs(Te,{gap:"space-12",children:[R.jsx(zo,{name:`${ae}.${e}.totrinnskontrollGodkjent`,control:o,isReadOnly:n,isHorizontal:!0,isTrueOrFalseSelection:!0,hideLegend:!0,radios:[{value:"true",label:R.jsx(q,{id:"ApprovalField.Godkjent"})},{value:"false",label:R.jsx(q,{id:"ApprovalField.Vurder"})}]}),m===!1&&R.jsx(_o,{alignOffset:m?1:110,children:R.jsxs(Te,{gap:"space-8",children:[R.jsx(pn,{size:"small",children:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),R.jsx(ue,{size:"small",children:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),R.jsxs(Te,{gap:"space-16",children:[R.jsx(Te,{gap:"space-4",children:R.jsxs(Ie,{justify:"space-between",style:{width:"300px"},children:[R.jsxs(Te,{gap:"space-4",children:[R.jsx(Me,{name:`${ae}.${e}.feilFakta`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilSkjønn`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilLov`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),R.jsxs(Te,{gap:"space-4",children:[R.jsx(Me,{name:`${ae}.${e}.feilUtredning`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilSaksflyt`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilBegrunnelse`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),T&&R.jsx(Kn,{size:"small",children:T}),R.jsx(Xo,{name:`${ae}.${e}.besluttersBegrunnelse`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[La,nl,rl,ba],readOnly:n})]})]})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  skjermlenkeType: SkjermlenkeType;
  totrinnskontrollAksjonspunkter: TotrinnskontrollAksjonspunkt[];
}>`}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const tl="_aksjonspunktTextContainer_1pwmv_5",ol="_lenke_1pwmv_10",cr={aksjonspunktTextContainer:tl,lenke:ol},ll="aksjonspunktGodkjenning",va=({behandling:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n,erForeldrepengerFagsak:r,erTilbakekreving:t,skjemalenkeTyper:o,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const{control:m,watch:g}=Re(),{fields:v}=Jt({control:m,name:ll}),_=g("aksjonspunktGodkjenning");return R.jsx(Te,{gap:"space-24",children:v.map((T,K)=>{const{aksjonspunktKode:G}=_[K],I=a.find(F=>F.totrinnskontrollAksjonspunkter.some(E=>E.aksjonspunktKode===G)),N=I?.totrinnskontrollAksjonspunkter.find(F=>F.aksjonspunktKode===G);if(!I||!N)return null;const V=da(r,e.status,i,t,N,e.behandlingsresultat),A=o.find(F=>F.kode===I.skjermlenkeType),f=s(I.skjermlenkeType);return R.jsxs("div",{children:[f&&A&&R.jsx(hr,{to:f,onClick:()=>window.scroll(0,0),className:cr.lenke,children:A.navn}),V.map((F,E)=>R.jsx("div",{className:cr.aksjonspunktTextContainer,children:R.jsx(ue,{size:"small",children:F})},G.concat("_".concat(E.toString())))),R.jsx(ua,{index:K,totrinnskontrollSkjermlenkeContext:a,readOnly:n})]},T.id)})})};va.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
