...
`,dt=(e,l,a,n)=>l?_t(e,a,n):st(e,a,n),At=(e,l,a)=>a?"":l?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,Nt=({children:e,alignOffset:l=0,alignLeft:a=!1,marginTop:n=0,marginLeft:r=0,hideBorder:t=!1})=>Ke.jsxs(Ke.Fragment,{children:[Ke.jsx("style",{dangerouslySetInnerHTML:{__html:dt(l,a,n,r)}}),Ke.jsx("div",{className:At(l,a,t),children:e})]});var mn={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Kn;function Mt(){if(Kn)return We;Kn=1;var e=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function a(n,r,t){var i=null;if(t!==void 0&&(i=""+t),r.key!==void 0&&(i=""+r.key),"key"in r){t={};for(var u in r)u!=="key"&&(t[u]=r[u])}else t=r;return r=t.ref,{$$typeof:e,type:n,key:i,ref:r!==void 0?r:null,props:t}}return We.Fragment=l,We.jsx=a,We.jsxs=a,We}var In;function bt(){return In||(In=1,Ln.exports=Mt()),Ln.exports}var Q=bt();const $a=e=>e.reduce((l,a,n)=>({...l,[n]:r=>a(r)||!0}),{}),Ra=(e,l)=>l.split(".").reduce((a,n)=>a!==void 0?a[n]:a,e)?.message,Ut="_noReadOnlyIcon_6dero_1",tl={noReadOnlyIcon:Ut},be=({label:e,validate:l=[],onChange:a,onClick:n,size:r="small",name:t,control:i,className:u,...k})=>{const{formState:{errors:A}}=Ne(),{field:R}=wa({name:t,control:i,rules:{validate:B.useMemo(()=>$a(l),[l])}}),_=Ra(A,t);return Q.jsxs(Q.Fragment,{children:[Q.jsx(Rr,{size:r,checked:R.value===!0,error:!!_,...R,onChange:m=>{R.onChange(m),a&&a(m.currentTarget.checked)},onClick:()=>{n&&n()},className:nl(u,tl.noReadOnlyIcon),...k,children:e}),_&&Q.jsx(da,{children:Ra(A,t)})]})};var ha={exports:{}},Bt=ha.exports,gn;function ct(){return gn||(gn=1,(function(e,l){(function(a,n){e.exports=n()})(Bt,function(){var a={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},n=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,r=/\d/,t=/\d\d/,i=/\d\d?/,u=/\d*[^-_:/,()\s\d]+/,k={},A=function(L){return(L=+L)+(L>68?1900:2e3)},R=function(L){return function(V){this[L]=+V}},_=[/[+-]\d\d:?(\d\d)?|Z/,function(L){(this.zone||(this.zone={})).offset=(function(V){if(!V||V==="Z")return 0;var K=V.match(/([+-]|\d\d)/g),D=60*K[1]+(+K[2]||0);return D===0?0:K[0]==="+"?-D:D})(L)}],m=function(L){var V=k[L];return V&&(V.indexOf?V:V.s.concat(V.f))},O=function(L,V){var K,D=k.meridiem;if(D){for(var s=1;s<=24;s+=1)if(L.indexOf(D(s,0,V))>-1){K=s>12;break}}else K=L===(V?"pm":"PM");return K},y={A:[u,function(L){this.afternoon=O(L,!1)}],a:[u,function(L){this.afternoon=O(L,!0)}],Q:[r,function(L){this.month=3*(L-1)+1}],S:[r,function(L){this.milliseconds=100*+L}],SS:[t,function(L){this.milliseconds=10*+L}],SSS:[/\d{3}/,function(L){this.milliseconds=+L}],s:[i,R("seconds")],ss:[i,R("seconds")],m:[i,R("minutes")],mm:[i,R("minutes")],H:[i,R("hours")],h:[i,R("hours")],HH:[i,R("hours")],hh:[i,R("hours")],D:[i,R("day")],DD:[t,R("day")],Do:[u,function(L){var V=k.ordinal,K=L.match(/\d+/);if(this.day=K[0],V)for(var D=1;D<=31;D+=1)V(D).replace(/\[|\]/g,"")===L&&(this.day=D)}],w:[i,R("week")],ww:[t,R("week")],M:[i,R("month")],MM:[t,R("month")],MMM:[u,function(L){var V=m("months"),K=(m("monthsShort")||V.map(function(D){return D.slice(0,3)})).indexOf(L)+1;if(K<1)throw new Error;this.month=K%12||K}],MMMM:[u,function(L){var V=m("months").indexOf(L)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,R("year")],YY:[t,function(L){this.year=A(L)}],YYYY:[/\d{4}/,R("year")],Z:_,ZZ:_};function M(L){var V,K;V=L,K=k&&k.formats;for(var D=(L=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(x,w,f){var U=f&&f.toUpperCase();return w||K[f]||a[f]||K[U].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(h,Y,q){return Y||q.slice(1)})})).match(n),s=D.length,d=0;d<s;d+=1){var p=D[d],P=y[p],j=P&&P[0],c=P&&P[1];D[d]=c?{regex:j,parser:c}:p.replace(/^\[|\]$/g,"")}return function(x){for(var w={},f=0,U=0;f<s;f+=1){var h=D[f];if(typeof h=="string")U+=h.length;else{var Y=h.regex,q=h.parser,ee=x.slice(U),te=Y.exec(ee)[0];q.call(w,te),x=x.replace(te,"")}}return(function(Ee){var ke=Ee.afternoon;if(ke!==void 0){var ne=Ee.hours;ke?ne<12&&(Ee.hours+=12):ne===12&&(Ee.hours=0),delete Ee.afternoon}})(w),w}}return function(L,V,K){K.p.customParseFormat=!0,L&&L.parseTwoDigitYear&&(A=L.parseTwoDigitYear);var D=V.prototype,s=D.parse;D.parse=function(d){var p=d.date,P=d.utc,j=d.args;this.$u=P;var c=j[1];if(typeof c=="string"){var x=j[2]===!0,w=j[3]===!0,f=x||w,U=j[2];w&&(U=j[2]),k=this.$locale(),!x&&U&&(k=K.Ls[U]),this.$d=(function(ee,te,Ee,ke){try{if(["x","X"].indexOf(te)>-1)return new Date((te==="X"?1e3:1)*ee);var ne=M(te)(ee),je=ne.year,De=ne.month,ma=ne.day,ea=ne.hours,Sa=ne.minutes,qe=ne.seconds,aa=ne.milliseconds,Pe=ne.zone,ye=ne.week,Ye=new Date,pe=ma||(je||De?1:Ye.getDate()),we=je||Ye.getFullYear(),Oe=0;je&&!De||(Oe=De>0?De-1:Ye.getMonth());var Fe,Je=ea||0,xe=Sa||0,na=qe||0,fe=aa||0;return Pe?new Date(Date.UTC(we,Oe,pe,Je,xe,na,fe+60*Pe.offset*1e3)):Ee?new Date(Date.UTC(we,Oe,pe,Je,xe,na,fe)):(Fe=new Date(we,Oe,pe,Je,xe,na,fe),ye&&(Fe=ke(Fe).week(ye).toDate()),Fe)}catch{return new Date("")}})(p,c,P,K),this.init(),U&&U!==!0&&(this.$L=this.locale(U).$L),f&&p!=this.format(c)&&(this.$d=new Date("")),k={}}else if(c instanceof Array)for(var h=c.length,Y=1;Y<=h;Y+=1){j[1]=c[Y-1];var q=K.apply(this,j);if(q.isValid()){this.$d=q.$d,this.$L=q.$L,this.init();break}Y===h&&(this.$d=new Date(""))}else s.call(this,d)}}})})(ha)),ha.exports}var ht=ct();const Ht=ft(ht),jt="_textarea_14c7r_1",qt="_readOnlyField_14c7r_7",Dn={textarea:jt,readOnlyField:qt},Yt=e=>e!=null&&e!=="",wt=({label:e,value:l,isEdited:a=!1,type:n,hideLabel:r,size:t})=>Yt(l)?Q.jsxs(de,{gap:"space-4",children:[e&&!r&&Q.jsx(_a,{size:t,children:e}),Q.jsxs(Ve,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(bn,{className:n==="textarea"?Dn.textarea:Dn.readOnlyField,size:t,children:l}),a&&Q.jsx(rl,{})]})]}):null;Nl.extend(Ht);const Jt=({legend:e,validate:l=[],onChange:a,children:n,className:r,readOnly:t,size:i="small",isEdited:u,name:k,control:A,...R})=>{const{formState:{errors:_}}=Ne(),{field:m}=wa({name:k,control:A,rules:{validate:$a(l)}});return Q.jsx(_r,{name:k,value:m.value!==void 0?m.value:null,legend:Q.jsxs(Ve,{justify:"center",gap:"space-8",children:[e,t&&u&&Q.jsx(rl,{})]}),"aria-readonly":t,readOnly:t,size:i,error:Ra(_,k),onChange:O=>{a&&a(O),m.onChange(O)},className:nl(r,tl.noReadOnlyIcon),...R,children:n})},xt="_textAreaFieldWithBadges_bdz0b_1",Ct="_etikettWrapper_bdz0b_4",On={textAreaFieldWithBadges:xt,etikettWrapper:Ct},$t=({name:e,control:l,label:a,hideLabel:n,readOnly:r,badges:t,validate:i=[],parse:u=m=>m,isEdited:k,autoComplete:A="off",size:R="small",..._})=>{const{formState:{errors:m}}=Ne(),{field:O}=wa({name:e,control:l,rules:{validate:B.useMemo(()=>$a(i),[i])}});return r?Q.jsx(wt,{size:R,label:a,value:O.value,type:"textarea",isEdited:k,hideLabel:n}):Q.jsxs("div",{className:t?On.textAreaFieldWithBadges:null,children:[t&&Q.jsx("div",{className:On.etikettWrapper,children:t.map(({type:y,titleText:M})=>Q.jsx(tr,{variant:y,size:"small",children:M},M))}),Q.jsx(Lr,{size:R,label:a,hideLabel:n,autoComplete:A,...O,onChange:y=>O.onChange(y.currentTarget.value!==""?u(y.currentTarget.value):null),value:O.value?O.value:"",error:Ra(m,e),..._})]})},Wt=({formMethods:e,onSubmit:l,children:a,className:n,setDataOnUnmount:r})=>{const{handleSubmit:t,getValues:i}=e;return B.useEffect(()=>()=>{r&&r(i())},[]),Q.jsx(gr,{...e,children:Q.jsx("form",{className:n,onSubmit:l?t(u=>l(u)):void 0,children:a})})},Zt=(e,l)=>{const{setError:a,clearErrors:n,formState:r}=Ne(),t=!!l;return B.useEffect(()=>{t&&a(`${e}.notRegisteredInput`,{type:"custom",message:l}),t||n(`${e}.notRegisteredInput`)},[l]),r.isSubmitted?e.split(".").reduce((i,u)=>i[u]||{},r.errors)?.notRegisteredInput?.message:void 0},zt=Sl(3),Xt=Ll(2e3),re="aksjonspunktGodkjenning",Qt=(e,l)=>!e(`${re}.${l}.feilFakta`)&&!e(`${re}.${l}.feilLov`)&&!e(`${re}.${l}.feilSkjønn`)&&!e(`${re}.${l}.feilUtredning`)&&!e(`${re}.${l}.feilSaksflyt`)&&!e(`${re}.${l}.feilBegrunnelse`),El=({index:e,totrinnskontrollSkjermlenkeContext:l,readOnly:a})=>{const{watch:n,getValues:r,control:t}=Ne(),i=n("aksjonspunktGodkjenning"),{aksjonspunktKode:u,totrinnskontrollGodkjent:k}=i[e],A=l.find(O=>O.totrinnskontrollAksjonspunkter.some(y=>y.aksjonspunktKode===u)),R=A?.totrinnskontrollAksjonspunkter.find(O=>O.aksjonspunktKode===u),_=!k&&Qt(r,e)?kl():void 0,m=Zt(`${re}.${e}.faktagruppe`,_);return!A||!R?null:N.jsxs(de,{gap:"space-12",children:[N.jsx(Jt,{name:`${re}.${e}.totrinnskontrollGodkjent`,control:t,readOnly:a,legend:"",hideLegend:!0,children:N.jsxs(Ve,{gap:"space-16",children:[N.jsx(Qa,{value:!0,size:"small",children:N.jsx(H,{id:"ApprovalField.Godkjent"})}),N.jsx(Qa,{value:!1,size:"small",children:N.jsx(H,{id:"ApprovalField.Vurder"})})]})}),k===!1&&N.jsx(Nt,{alignOffset:110,children:N.jsxs(de,{gap:"space-8",children:[N.jsx(_a,{size:"small",children:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),N.jsx(ae,{size:"small",children:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),N.jsxs(de,{gap:"space-16",children:[N.jsx(de,{gap:"space-4",children:N.jsxs(Ve,{justify:"space-between",style:{width:"300px"},children:[N.jsxs(de,{gap:"space-4",children:[N.jsx(be,{name:`${re}.${e}.feilFakta`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:a}),N.jsx(be,{name:`${re}.${e}.feilSkjønn`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:a}),N.jsx(be,{name:`${re}.${e}.feilLov`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:a})]}),N.jsxs(de,{gap:"space-4",children:[N.jsx(be,{name:`${re}.${e}.feilUtredning`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:a}),N.jsx(be,{name:`${re}.${e}.feilSaksflyt`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:a}),N.jsx(be,{name:`${re}.${e}.feilBegrunnelse`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:a})]})]})}),m&&N.jsx(da,{size:"small",children:m}),N.jsx($t,{name:`${re}.${e}.besluttersBegrunnelse`,control:t,label:N.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[ml,zt,Xt,Kl],readOnly:a})]})]})})]})};El.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"unknown"}],raw:`(
  | TotrinnskontrollSkjermlenkeContext
  | TotrinnskontrollSkjermlenkeContextDtoFpTilbake
)[]`},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const eE="_aksjonspunktTextContainer_1pwmv_5",aE="_lenke_1pwmv_10",Fn={aksjonspunktTextContainer:eE,lenke:aE},nE="aksjonspunktGodkjenning",il=({behandling:e,totrinnskontrollSkjermlenkeContext:l,readOnly:a,erForeldrepengerFagsak:n,erTilbakekreving:r,skjemalenkeTyper:t,faktaOmBeregningTilfeller:i,lagLenke:u})=>{const{control:k,watch:A}=Ne(),{fields:R}=qr({control:k,name:nE}),_=A("aksjonspunktGodkjenning");return N.jsx(de,{gap:"space-24",children:R.map((m,O)=>{const{aksjonspunktKode:y}=_[O],M=l.find(s=>s.totrinnskontrollAksjonspunkter.some(d=>d.aksjonspunktKode===y)),L=M?.totrinnskontrollAksjonspunkter.find(s=>s.aksjonspunktKode===y);if(!M||!L)return null;const V=al(n,e.status,i,r,L,e.behandlingsresultat),K=t.find(s=>s.kode===M.skjermlenkeType),D=u(M.skjermlenkeType);return N.jsxs("div",{children:[D&&K&&N.jsx(pn,{to:D,onClick:()=>globalThis.scroll(0,0),className:Fn.lenke,children:K.navn}),V.map((s,d)=>N.jsx("div",{className:Fn.aksjonspunktTextContainer,children:N.jsx(ae,{size:"small",children:s})},y.concat("_".concat(d.toString())))),N.jsx(El,{index:O,totrinnskontrollSkjermlenkeContext:l,readOnly:a})]},m.id)})})};il.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"union",raw:"FagsakBehandlingDtoFpSak | FagsakBehandlingDtoFpTilbake",elements:[{name:"signature",type:"object",raw:`{
...
| 'FAKTA_OM_UTTAK_DOKUMENTASJON'
| 'FAKTA_UTTAK'
| 'FAKTA_UTTAK_EØS'`,elements:[{name:"literal",value:"'ANKE_MERKNADER'"},{name:"literal",value:"'ANKE_VURDERING'"},{name:"literal",value:"'BEREGNING_ENGANGSSTOENAD'"},{name:"literal",value:"'BEREGNING_FORELDREPENGER'"},{name:"literal",value:"'BESTEBEREGNING'"},{name:"literal",value:"'FAKTA_FOR_OMSORG'"},{name:"literal",value:"'FAKTA_FOR_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_ADOPSJON'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON'"},{name:"literal",value:"'FAKTA_OM_BEREGNING'"},{name:"literal",value:"'FAKTA_OM_FOEDSEL'"},{name:"literal",value:"'FAKTA_OM_OMSORGSOVERTAKELSE'"},{name:"literal",value:"'FAKTA_OM_FORDELING'"},{name:"literal",value:"'FAKTA_OM_MEDLEMSKAP'"},{name:"literal",value:"'FAKTA_OM_OMSORG_OG_FORELDREANSVAR'"},{name:"literal",value:"'FAKTA_OM_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_SIMULERING'"},{name:"literal",value:"'FAKTA_OM_UTTAK'"},{name:"literal",value:"'FAKTA_OM_AKTIVITETSKRAV'"},{name:"literal",value:"'FAKTA_OMSORG_OG_RETT'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'FORMKRAV_KLAGE_KA'"},{name:"literal",value:"'FORMKRAV_KLAGE_NFP'"},{name:"literal",value:"'KLAGE_BEH_NFP'"},{name:"literal",value:"'KLAGE_BEH_NK'"},{name:"literal",value:"'KONTROLL_AV_SAKSOPPLYSNINGER'"},{name:"literal",value:"'OPPLYSNINGSPLIKT'"},{name:"literal",value:"'PUNKT_FOR_ADOPSJON'"},{name:"literal",value:"'PUNKT_FOR_FOEDSEL'"},{name:"literal",value:"'PUNKT_FOR_FORELDREANSVAR'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP_LØPENDE'"},{name:"literal",value:"'PUNKT_FOR_OMSORG'"},{name:"literal",value:"'PUNKT_FOR_OPPTJENING'"},{name:"literal",value:"'PUNKT_FOR_SVANGERSKAPSPENGER'"},{name:"literal",value:"'PUNKT_FOR_SVP_INNGANG'"},{name:"literal",value:"'SOEKNADSFRIST'"},{name:"literal",value:"'TILKJENT_YTELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'UTLAND'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'VURDER_FARESIGNALER'"},{name:"literal",value:"'FAKTA_OM_UTTAK_DOKUMENTASJON'"},{name:"literal",value:"'FAKTA_UTTAK'"},{name:"literal",value:"'FAKTA_UTTAK_EØS'"}]},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const _E=he(fl),dE=["FAKTA_OM_FEILUTBETALING","FORELDELSE","TILBAKEKREVING","VEDTAK"],AE=e=>{const l=new Array;return e.feilFakta&&l.push("FEIL_FAKTA"),e.feilLov&&l.push("FEIL_LOV"),e.feilSkjønn&&l.push("SKJØNN"),e.feilUtredning&&l.push("UTREDNING"),e.feilSaksflyt&&l.push("SAKSFLYT"),e.feilBegrunnelse&&l.push("BEGRUNNELSE"),l},NE=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Tl=({behandling:e,location:l,fagsakYtelseType:a,readOnly:n,onSubmit:r,forhandsvisVedtaksbrev:t,alleKodeverk:i,createLocationForSkjermlenke:u,beslutterFormData:k,setBeslutterFormData:A})=>{const R=e.type==="BT-007"||e.type==="BT-009",_=D=>{const s=D.aksjonspunktGodkjenning.map(P=>({aksjonspunktKode:P.aksjonspunktKode,godkjent:!!P.totrinnskontrollGodkjent,begrunnelse:P.besluttersBegrunnelse,arsaker:AE(P)})),d=R?"5005":G.FATTER_VEDTAK;return r({fatterVedtakAksjonspunktDto:{"@type":d,kode:d,begrunnelse:void 0,aksjonspunktGodkjenningDtos:s},erAlleAksjonspunktGodkjent:D.aksjonspunktGodkjenning.every(P=>P.totrinnskontrollGodkjent)})},m=e.behandlingÅrsaker.map(({behandlingArsakType:D})=>D).some(D=>D==="ETTER_KLAGE"||D==="RE-KLAG-U-INNTK"||D==="RE-KLAG-M-INNTK"),O=R?dE.flatMap(D=>{const s=e.totrinnskontrollÅrsaker.find(d=>d.skjermlenkeType===D);return s?[s]:[]}):e.totrinnskontrollÅrsaker,y=D=>u(l,D),M=e.status==="FVED",L=i.SkjermlenkeType,V=i.VurderÅrsak,K=NE(i);return N.jsxs(Dl,{value:_E,children:[M&&N.jsx(ul,{behandling:e,totrinnskontrollSkjermlenkeContext:O,readOnly:n,onSubmit:_,forhandsvisVedtaksbrev:t,erForeldrepengerFagsak:a==="FP",skjemalenkeTyper:L,erBehandlingEtterKlage:m,faktaOmBeregningTilfeller:K,erTilbakekreving:R,lagLenke:y,beslutterFormData:k,setBeslutterFormData:A}),!M&&N.jsx(ol,{behandling:e,totrinnskontrollSkjermlenkeContext:O,erForeldrepengerFagsak:a==="FP",erTilbakekreving:R,skjemalenkeTyper:L,lagLenke:y,vurderArsaker:V,faktaOmBeregningTilfeller:K})]})};Tl.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"union",raw:"FagsakBehandlingDtoFpSak | FagsakBehandlingDtoFpTilbake",elements:[{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
