...
`&&(w.value+=" ");const x=U.boxSizing,P=sn(U.paddingBottom)+sn(U.paddingTop),M=sn(U.borderBottomWidth)+sn(U.borderTopWidth),B=w.scrollHeight-P;w.value="x";const Y=w.scrollHeight-P;let H=B;s&&(H=Math.max(Number(s)*Y,H)),i&&(H=Math.min(Number(i)*Y,H)),H=Math.max(H,Y);const ee=H+(x==="border-box"?P+M:0),oe=Math.abs(H-B)<=1;return{outerHeightStyle:ee,overflow:oe}},[i,s,S.placeholder]),I=()=>{const f=D();dr(f)||m(h=>ir(h,f,_))};lr(()=>{const f=()=>{const P=D();dr(P)||Ma.flushSync(()=>{m(M=>ir(M,P,_))})},h=Cr(()=>{var P,M,B;if(_.current=0,!((P=K.current)===null||P===void 0)&&P.style.height||!((M=K.current)===null||M===void 0)&&M.style.width){((B=K.current)===null||B===void 0?void 0:B.style.overflow)==="hidden"&&m(Y=>Object.assign(Object.assign({},Y),{overflow:!1}));return}f()},166,!0),U=K.current,w=sr(U);w.addEventListener("resize",h);let x;return typeof ResizeObserver<"u"&&(x=new ResizeObserver(h),x.observe(U)),()=>{h.clear(),w.removeEventListener("resize",h),x&&x.disconnect()}},[D]),lr(()=>{I()}),G.useEffect(()=>{_.current=0},[v]);const A=f=>{_.current=0,u||I(),l&&l(f)},L=Object.assign({"--__ac-textarea-height":V.outerHeightStyle+"px","--__axc-textarea-height":V.outerHeightStyle+"px",overflow:V.overflow&&!R&&!(!((n=K.current)===null||n===void 0)&&n.style.height)&&!(!((r=K.current)===null||r===void 0)&&r.style.width)?"hidden":void 0},T);return E.createElement(E.Fragment,null,E.createElement("textarea",Object.assign({value:v,onChange:A,ref:c,rows:s,style:L},S,{className:t})),E.createElement("textarea",{"aria-hidden":!0,className:t,readOnly:!0,ref:b,tabIndex:-1,style:Object.assign({visibility:"hidden",position:"absolute",overflow:"hidden",height:0,top:0,left:0,transform:"translateZ(0)"},T)}))});function dr(e){return e==null||Object.keys(e).length===0||e.outerHeightStyle===0&&!e.overflow}const ft=({maxLengthId:e,maxLength:a,currentLength:n,size:r,i18n:t})=>{const{cn:l}=Ae(),i=Ur("Textarea",{charsLeft:t?.counterLeft?`{chars} ${t.counterLeft}`:void 0,charsTooMany:t?.counterTooMuch?`{chars} ${t.counterTooMuch}`:void 0}),s=a-n,[R,T]=G.useState(s);return G.useEffect(()=>{const v=Cr(()=>{T(s)},2e3);return v(),()=>{v.clear()}},[s]),E.createElement(E.Fragment,null,E.createElement("span",{id:e,className:l("navds-sr-only")},i("maxLength",{maxLength:a})),s<20&&E.createElement("span",{role:"status",className:l("navds-textarea__sr-counter navds-sr-only")},kr(R,i)),E.createElement(ue,{className:l("navds-textarea__counter",{"navds-textarea__counter--error":s<0}),size:r},kr(s,i)))},kr=(e,a)=>e<0?a("charsTooMany",{chars:Math.abs(e)}):a("charsLeft",{chars:e});var Lt=function(e,a){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&a.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var t=0,r=Object.getOwnPropertySymbols(e);t<r.length;t++)a.indexOf(r[t])<0&&Object.prototype.propertyIsEnumerable.call(e,r[t])&&(n[r[t]]=e[r[t]]);return n};const Ot=G.forwardRef((e,a)=>{var n,r,t;const{inputProps:l,errorId:i,showErrorMsg:s,hasError:R,size:T,inputDescriptionId:v}=Sn(e,"textarea"),{label:S,className:u,description:K,maxLength:c,hideLabel:b=!1,resize:_,UNSAFE_autoScrollbar:V,i18n:m,readOnly:D}=e,I=Lt(e,["label","className","description","maxLength","hideLabel","resize","UNSAFE_autoScrollbar","i18n","readOnly"]),{cn:A}=Ae(),L=Hr(),f=c!==void 0&&c>0,[h,U]=G.useState((n=e?.defaultValue)!==null&&n!==void 0?n:""),w=()=>{let P=I?.minRows?I?.minRows:3;return T==="small"&&(P=I?.minRows?I?.minRows:2),P},x=Jn(l["aria-describedby"],{[L??""]:f});return E.createElement("div",{className:A(u,"navds-form-field",`navds-form-field--${T}`,{"navds-form-field--disabled":!!l.disabled,"navds-form-field--readonly":D,"navds-textarea--readonly":D,"navds-textarea--error":R,"navds-textarea--autoscrollbar":V,[`navds-textarea--resize-${_===!0?"both":_}`]:_})},E.createElement(yn,{htmlFor:l.id,size:T,className:A("navds-form-field__label",{"navds-sr-only":b})},D&&E.createElement(qr,null),S),!!K&&E.createElement(ue,{className:A("navds-form-field__description",{"navds-sr-only":b}),id:v,size:T,as:"div"},K),E.createElement(Kt,Object.assign({},Le(I,["error","errorId","size"]),l,{onChange:ha(e.onChange,e.value===void 0?P=>U(P.target.value):void 0),minRows:w(),autoScrollbar:V,ref:a,readOnly:D,className:A("navds-textarea__input","navds-body-short",`navds-body-short--${T??"medium"}`)},x?{"aria-describedby":x}:{})),f&&!D&&!l.disabled&&E.createElement(ft,{maxLengthId:L,maxLength:c,currentLength:(t=(r=e.value)===null||r===void 0?void 0:r.length)!==null&&t!==void 0?t:h.length,size:T,i18n:m}),E.createElement("div",{className:A("navds-form-field__error"),id:i,"aria-relevant":"additions removals","aria-live":"polite"},s&&E.createElement(pn,{size:T,showIcon:!0},e.error)))});var en=e=>e.type==="checkbox",be=e=>e instanceof Date,le=e=>e==null;const Wr=e=>typeof e=="object";var X=e=>!le(e)&&!Array.isArray(e)&&Wr(e)&&!be(e),Zr=e=>X(e)&&e.target?en(e.target)?e.target.checked:e.target.value:e,Dt=e=>e.substring(0,e.search(/\.\d+(\.|$)/))||e,Xr=(e,a)=>e.has(Dt(a)),Ft=e=>{const a=e.constructor&&e.constructor.prototype;return X(a)&&a.hasOwnProperty("isPrototypeOf")},$n=typeof window<"u"&&typeof window.HTMLElement<"u"&&typeof document<"u";function z(e){let a;const n=Array.isArray(e),r=typeof FileList<"u"?e instanceof FileList:!1;if(e instanceof Date)a=new Date(e);else if(!($n&&(e instanceof Blob||r))&&(n||X(e)))if(a=n?[]:Object.create(Object.getPrototypeOf(e)),!n&&!Ft(e))a=e;else for(const t in e)e.hasOwnProperty(t)&&(a[t]=z(e[t]));else return e;return a}var Kn=e=>/^\w*$/.test(e),W=e=>e===void 0,fn=e=>Array.isArray(e)?e.filter(Boolean):[],zn=e=>fn(e.replace(/["|']|\]/g,"").split(/\.|\[/)),y=(e,a,n)=>{if(!a||!X(e))return n;const r=(Kn(a)?[a]:zn(a)).reduce((t,l)=>le(t)?t:t[l],e);return W(r)||r===e?W(e[a])?n:e[a]:r},de=e=>typeof e=="boolean",J=(e,a,n)=>{let r=-1;const t=Kn(a)?[a]:zn(a),l=t.length,i=l-1;for(;++r<l;){const s=t[r];let R=n;if(r!==i){const T=e[s];R=X(T)||Array.isArray(T)?T:isNaN(+t[r+1])?{}:[]}if(s==="__proto__"||s==="constructor"||s==="prototype")return;e[s]=R,e=e[s]}};const Tn={BLUR:"blur",FOCUS_OUT:"focusout",CHANGE:"change"},Ee={onBlur:"onBlur",onChange:"onChange",onSubmit:"onSubmit",onTouched:"onTouched",all:"all"},_e={max:"max",min:"min",maxLength:"maxLength",minLength:"minLength",pattern:"pattern",required:"required",validate:"validate"},Wn=E.createContext(null);Wn.displayName="HookFormContext";const Re=()=>E.useContext(Wn),bt=e=>{const{children:a,...n}=e;return E.createElement(Wn.Provider,{value:n},a)};var Qr=(e,a,n,r=!0)=>{const t={defaultValues:a._defaultValues};for(const l in e)Object.defineProperty(t,l,{get:()=>{const i=l;return a._proxyFormState[i]!==Ee.all&&(a._proxyFormState[i]=!r||Ee.all),n&&(n[i]=!0),e[i]}});return t};const Ln=typeof window<"u"?E.useLayoutEffect:E.useEffect;function It(e){const a=Re(),{control:n=a.control,disabled:r,name:t,exact:l}=e||{},[i,s]=E.useState(n._formState),R=E.useRef({isDirty:!1,isLoading:!1,dirtyFields:!1,touchedFields:!1,validatingFields:!1,isValidating:!1,isValid:!1,errors:!1});return Ln(()=>n._subscribe({name:t,formState:R.current,exact:l,callback:T=>{!r&&s({...n._formState,...T})}}),[t,r,l]),E.useEffect(()=>{R.current.isValid&&n._setValid(!0)},[n]),E.useMemo(()=>Qr(i,n,R.current,!1),[i,n])}var ge=e=>typeof e=="string",ea=(e,a,n,r,t)=>ge(e)?(r&&a.watch.add(e),y(n,e,t)):Array.isArray(e)?e.map(l=>(r&&a.watch.add(l),y(n,l))):(r&&(a.watchAll=!0),n),Hn=e=>le(e)||!Wr(e);function Se(e,a,n=new WeakSet){if(Hn(e)||Hn(a))return e===a;if(be(e)&&be(a))return e.getTime()===a.getTime();const r=Object.keys(e),t=Object.keys(a);if(r.length!==t.length)return!1;if(n.has(e)||n.has(a))return!0;n.add(e),n.add(a);for(const l of r){const i=e[l];if(!t.includes(l))return!1;if(l!=="ref"){const s=a[l];if(be(i)&&be(s)||X(i)&&X(s)||Array.isArray(i)&&Array.isArray(s)?!Se(i,s,n):i!==s)return!1}}return!0}function Vt(e){const a=Re(),{control:n=a.control,name:r,defaultValue:t,disabled:l,exact:i,compute:s}=e||{},R=E.useRef(t),T=E.useRef(s),v=E.useRef(void 0);T.current=s;const S=E.useMemo(()=>n._getWatch(r,R.current),[n,r]),[u,K]=E.useState(T.current?T.current(S):S);return Ln(()=>n._subscribe({name:r,formState:{values:!0},exact:i,callback:c=>{if(!l){const b=ea(r,n._names,c.values||n._formValues,!1,R.current);if(T.current){const _=T.current(b);Se(_,v.current)||(K(_),v.current=_)}else K(b)}}}),[n,l,r,i]),E.useEffect(()=>n._removeUnmounted()),u}function Zn(e){const a=Re(),{name:n,disabled:r,control:t=a.control,shouldUnregister:l,defaultValue:i}=e,s=Xr(t._names.array,n),R=E.useMemo(()=>y(t._formValues,n,y(t._defaultValues,n,i)),[t,n,i]),T=Vt({control:t,name:n,defaultValue:R,exact:!0}),v=It({control:t,name:n,exact:!0}),S=E.useRef(e),u=E.useRef(t.register(n,{...e.rules,value:T,...de(e.disabled)?{disabled:e.disabled}:{}}));S.current=e;const K=E.useMemo(()=>Object.defineProperties({},{invalid:{enumerable:!0,get:()=>!!y(v.errors,n)},isDirty:{enumerable:!0,get:()=>!!y(v.dirtyFields,n)},isTouched:{enumerable:!0,get:()=>!!y(v.touchedFields,n)},isValidating:{enumerable:!0,get:()=>!!y(v.validatingFields,n)},error:{enumerable:!0,get:()=>y(v.errors,n)}}),[v,n]),c=E.useCallback(m=>u.current.onChange({target:{value:Zr(m),name:n},type:Tn.CHANGE}),[n]),b=E.useCallback(()=>u.current.onBlur({target:{value:y(t._formValues,n),name:n},type:Tn.BLUR}),[n,t._formValues]),_=E.useCallback(m=>{const D=y(t._fields,n);D&&m&&(D._f.ref={focus:()=>m.focus&&m.focus(),select:()=>m.select&&m.select(),setCustomValidity:I=>m.setCustomValidity(I),reportValidity:()=>m.reportValidity()})},[t._fields,n]),V=E.useMemo(()=>({name:n,value:T,...de(r)||v.disabled?{disabled:v.disabled||r}:{},onChange:c,onBlur:b,ref:_}),[n,r,v.disabled,c,b,_,T]);return E.useEffect(()=>{const m=t._options.shouldUnregister||l;t.register(n,{...S.current.rules,...de(S.current.disabled)?{disabled:S.current.disabled}:{}});const D=(I,A)=>{const L=y(t._fields,I);L&&L._f&&(L._f.mount=A)};if(D(n,!0),m){const I=z(y(t._options.defaultValues,n));J(t._defaultValues,n,I),W(y(t._formValues,n))&&J(t._formValues,n,I)}return!s&&t.register(n),()=>{(s?m&&!t._state.action:m)?t.unregister(n):D(n,!1)}},[n,t,s,l]),E.useEffect(()=>{t._setDisabledField({disabled:r,name:n})},[r,n,t]),E.useMemo(()=>({field:V,formState:v,fieldState:K}),[V,v,K])}var ct=(e,a,n,r,t)=>a?{...n[e],types:{...n[e]&&n[e].types?n[e].types:{},[r]:t||!0}}:{},se=e=>Array.isArray(e)?e:[e],Er=()=>{let e=[];return{get observers(){return e},next:t=>{for(const l of e)l.next&&l.next(t)},subscribe:t=>(e.push(t),{unsubscribe:()=>{e=e.filter(l=>l!==t)}}),unsubscribe:()=>{e=[]}}},re=e=>X(e)&&!Object.keys(e).length,Xn=e=>e.type==="file",ve=e=>typeof e=="function",gn=e=>{if(!$n)return!1;const a=e?e.ownerDocument:0;return e instanceof(a&&a.defaultView?a.defaultView.HTMLElement:HTMLElement)},na=e=>e.type==="select-multiple",Qn=e=>e.type==="radio",Pt=e=>Qn(e)||en(e),In=e=>gn(e)&&e.isConnected;function Gt(e,a){const n=a.slice(0,-1).length;let r=0;for(;r<n;)e=W(e)?r++:e[a[r++]];return e}function jt(e){for(const a in e)if(e.hasOwnProperty(a)&&!W(e[a]))return!1;return!0}function Z(e,a){const n=Array.isArray(a)?a:Kn(a)?[a]:zn(a),r=n.length===1?e:Gt(e,n),t=n.length-1,l=n[t];return r&&delete r[l],t!==0&&(X(r)&&re(r)||Array.isArray(r)&&jt(r))&&Z(e,n.slice(0,-1)),e}var ra=e=>{for(const a in e)if(ve(e[a]))return!0;return!1};function An(e,a={}){const n=Array.isArray(e);if(X(e)||n)for(const r in e)Array.isArray(e[r])||X(e[r])&&!ra(e[r])?(a[r]=Array.isArray(e[r])?[]:{},An(e[r],a[r])):le(e[r])||(a[r]=!0);return a}function aa(e,a,n){const r=Array.isArray(e);if(X(e)||r)for(const t in e)Array.isArray(e[t])||X(e[t])&&!ra(e[t])?W(a)||Hn(n[t])?n[t]=Array.isArray(e[t])?An(e[t],[]):{...An(e[t])}:aa(e[t],le(a)?{}:a[t],n[t]):n[t]=!Se(e[t],a[t]);return n}var $e=(e,a)=>aa(e,a,An(a));const ur={value:!1,isValid:!1},vr={value:!0,isValid:!0};var ta=e=>{if(Array.isArray(e)){if(e.length>1){const a=e.filter(n=>n&&n.checked&&!n.disabled).map(n=>n.value);return{value:a,isValid:!!a.length}}return e[0].checked&&!e[0].disabled?e[0].attributes&&!W(e[0].attributes.value)?W(e[0].value)||e[0].value===""?vr:{value:e[0].value,isValid:!0}:vr:ur}return ur},la=(e,{valueAsNumber:a,valueAsDate:n,setValueAs:r})=>W(e)?e:a?e===""?NaN:e&&+e:n&&ge(e)?new Date(e):r?r(e):e;const Tr={isValid:!1,value:null};var oa=e=>Array.isArray(e)?e.reduce((a,n)=>n&&n.checked&&!n.disabled?{isValid:!0,value:n.value}:a,Tr):Tr;function gr(e){const a=e.ref;return Xn(a)?a.files:Qn(a)?oa(e.refs).value:na(a)?[...a.selectedOptions].map(({value:n})=>n):en(a)?ta(e.refs).value:la(W(a.value)?e.ref.value:a.value,e)}var Mt=(e,a,n,r)=>{const t={};for(const l of e){const i=y(a,l);i&&J(t,l,i._f)}return{criteriaMode:n,names:[...e],fields:t,shouldUseNativeValidation:r}},Rn=e=>e instanceof RegExp,ze=e=>W(e)?e:Rn(e)?e.source:X(e)?Rn(e.value)?e.value.source:e.value:e,he=e=>({isOnSubmit:!e||e===Ee.onSubmit,isOnBlur:e===Ee.onBlur,isOnChange:e===Ee.onChange,isOnAll:e===Ee.all,isOnTouch:e===Ee.onTouched});const Ar="AsyncFunction";var ht=e=>!!e&&!!e.validate&&!!(ve(e.validate)&&e.validate.constructor.name===Ar||X(e.validate)&&Object.values(e.validate).find(a=>a.constructor.name===Ar)),Ut=e=>e.mount&&(e.required||e.min||e.max||e.maxLength||e.minLength||e.pattern||e.validate),Yn=(e,a,n)=>!n&&(a.watchAll||a.watch.has(e)||[...a.watch].some(r=>e.startsWith(r)&&/^\.\w+/.test(e.slice(r.length))));const Ue=(e,a,n,r)=>{for(const t of n||Object.keys(e)){const l=y(e,t);if(l){const{_f:i,...s}=l;if(i){if(i.refs&&i.refs[0]&&a(i.refs[0],t)&&!r)return!0;if(i.ref&&a(i.ref,i.name)&&!r)return!0;if(Ue(s,a))break}else if(X(s)&&Ue(s,a))break}}};function Rr(e,a,n){const r=y(e,n);if(r||Kn(n))return{error:r,name:n};const t=n.split(".");for(;t.length;){const l=t.join("."),i=y(a,l),s=y(e,l);if(i&&!Array.isArray(i)&&n!==l)return{name:n};if(s&&s.type)return{name:l,error:s};if(s&&s.root&&s.root.type)return{name:`${l}.root`,error:s.root};t.pop()}return{name:n}}var Bt=(e,a,n,r)=>{n(e);const{name:t,...l}=e;return re(l)||Object.keys(l).length>=Object.keys(a).length||Object.keys(l).find(i=>a[i]===(!r||Ee.all))},qt=(e,a,n)=>!e||!a||e===a||se(e).some(r=>r&&(n?r===a:r.startsWith(a)||a.startsWith(r))),wt=(e,a,n,r,t)=>t.isOnAll?!1:!n&&t.isOnTouch?!(a||e):(n?r.isOnBlur:t.isOnBlur)?!e:(n?r.isOnChange:t.isOnChange)?e:!0,Ht=(e,a)=>!fn(y(e,a)).length&&Z(e,a),ia=(e,a,n)=>{const r=se(y(e,n));return J(r,"root",a[n]),J(e,n,r),e},un=e=>ge(e);function mr(e,a,n="validate"){if(un(e)||Array.isArray(e)&&e.every(un)||de(e)&&!e)return{type:n,message:un(e)?e:"",ref:a}}var je=e=>X(e)&&!Rn(e)?e:{value:e,message:""},xn=async(e,a,n,r,t,l)=>{const{ref:i,refs:s,required:R,maxLength:T,minLength:v,min:S,max:u,pattern:K,validate:c,name:b,valueAsNumber:_,mount:V}=e._f,m=y(n,b);if(!V||a.has(b))return{};const D=s?s[0]:i,I=P=>{t&&D.reportValidity&&(D.setCustomValidity(de(P)?"":P||""),D.reportValidity())},A={},L=Qn(i),f=en(i),h=L||f,U=(_||Xn(i))&&W(i.value)&&W(m)||gn(i)&&i.value===""||m===""||Array.isArray(m)&&!m.length,w=ct.bind(null,b,r,A),x=(P,M,B,Y=_e.maxLength,H=_e.minLength)=>{const ee=P?M:B;A[b]={type:P?Y:H,message:ee,ref:i,...w(P?Y:H,ee)}};if(l?!Array.isArray(m)||!m.length:R&&(!h&&(U||le(m))||de(m)&&!m||f&&!ta(s).isValid||L&&!oa(s).isValid)){const{value:P,message:M}=un(R)?{value:!!R,message:R}:je(R);if(P&&(A[b]={type:_e.required,message:M,ref:D,...w(_e.required,M)},!r))return I(M),A}if(!U&&(!le(S)||!le(u))){let P,M;const B=je(u),Y=je(S);if(!le(m)&&!isNaN(m)){const H=i.valueAsNumber||m&&+m;le(B.value)||(P=H>B.value),le(Y.value)||(M=H<Y.value)}else{const H=i.valueAsDate||new Date(m),ee=me=>new Date(new Date().toDateString()+" "+me),oe=i.type=="time",ie=i.type=="week";ge(B.value)&&m&&(P=oe?ee(m)>ee(B.value):ie?m>B.value:H>new Date(B.value)),ge(Y.value)&&m&&(M=oe?ee(m)<ee(Y.value):ie?m<Y.value:H<new Date(Y.value))}if((P||M)&&(x(!!P,B.message,Y.message,_e.max,_e.min),!r))return I(A[b].message),A}if((T||v)&&!U&&(ge(m)||l&&Array.isArray(m))){const P=je(T),M=je(v),B=!le(P.value)&&m.length>+P.value,Y=!le(M.value)&&m.length<+M.value;if((B||Y)&&(x(B,P.message,M.message),!r))return I(A[b].message),A}if(K&&!U&&ge(m)){const{value:P,message:M}=je(K);if(Rn(P)&&!m.match(P)&&(A[b]={type:_e.pattern,message:M,ref:i,...w(_e.pattern,M)},!r))return I(M),A}if(c){if(ve(c)){const P=await c(m,n),M=mr(P,D);if(M&&(A[b]={...M,...w(_e.validate,M.message)},!r))return I(M.message),A}else if(X(c)){let P={};for(const M in c){if(!re(P)&&!r)break;const B=mr(await c[M](m,n),D,M);B&&(P={...B,...w(M,B.message)},I(B.message),r&&(A[b]=P))}if(!re(P)&&(A[b]={ref:D,...P},!r))return A}}return I(!0),A};const Yt={mode:Ee.onSubmit,reValidateMode:Ee.onChange,shouldFocusError:!0};function xt(e={}){let a={...Yt,...e},n={submitCount:0,isDirty:!1,isReady:!1,isLoading:ve(a.defaultValues),isValidating:!1,isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,touchedFields:{},dirtyFields:{},validatingFields:{},errors:a.errors||{},disabled:a.disabled||!1},r={},t=X(a.defaultValues)||X(a.values)?z(a.defaultValues||a.values)||{}:{},l=a.shouldUnregister?{}:z(t),i={action:!1,mount:!1,watch:!1},s={mount:new Set,disabled:new Set,unMount:new Set,array:new Set,watch:new Set},R,T=0;const v={isDirty:!1,dirtyFields:!1,validatingFields:!1,touchedFields:!1,isValidating:!1,isValid:!1,errors:!1};let S={...v};const u={array:Er(),state:Er()},K=a.criteriaMode===Ee.all,c=o=>d=>{clearTimeout(T),T=setTimeout(o,d)},b=async o=>{if(!a.disabled&&(v.isValid||S.isValid||o)){const d=a.resolver?re((await f()).errors):await U(r,!0);d!==n.isValid&&u.state.next({isValid:d})}},_=(o,d)=>{!a.disabled&&(v.isValidating||v.validatingFields||S.isValidating||S.validatingFields)&&((o||Array.from(s.mount)).forEach(k=>{k&&(d?J(n.validatingFields,k,d):Z(n.validatingFields,k))}),u.state.next({validatingFields:n.validatingFields,isValidating:!re(n.validatingFields)}))},V=(o,d=[],k,O,p=!0,N=!0)=>{if(O&&k&&!a.disabled){if(i.action=!0,N&&Array.isArray(y(r,o))){const j=k(y(r,o),O.argA,O.argB);p&&J(r,o,j)}if(N&&Array.isArray(y(n.errors,o))){const j=k(y(n.errors,o),O.argA,O.argB);p&&J(n.errors,o,j),Ht(n.errors,o)}if((v.touchedFields||S.touchedFields)&&N&&Array.isArray(y(n.touchedFields,o))){const j=k(y(n.touchedFields,o),O.argA,O.argB);p&&J(n.touchedFields,o,j)}(v.dirtyFields||S.dirtyFields)&&(n.dirtyFields=$e(t,l)),u.state.next({name:o,isDirty:x(o,d),dirtyFields:n.dirtyFields,errors:n.errors,isValid:n.isValid})}else J(l,o,d)},m=(o,d)=>{J(n.errors,o,d),u.state.next({errors:n.errors})},D=o=>{n.errors=o,u.state.next({errors:n.errors,isValid:!1})},I=(o,d,k,O)=>{const p=y(r,o);if(p){const N=y(l,o,W(k)?y(t,o):k);W(N)||O&&O.defaultChecked||d?J(l,o,d?N:gr(p._f)):B(o,N),i.mount&&b()}},A=(o,d,k,O,p)=>{let N=!1,j=!1;const C={name:o};if(!a.disabled){if(!k||O){(v.isDirty||S.isDirty)&&(j=n.isDirty,n.isDirty=C.isDirty=x(),N=j!==C.isDirty);const $=Se(y(t,o),d);j=!!y(n.dirtyFields,o),$?Z(n.dirtyFields,o):J(n.dirtyFields,o,!0),C.dirtyFields=n.dirtyFields,N=N||(v.dirtyFields||S.dirtyFields)&&j!==!$}if(k){const $=y(n.touchedFields,o);$||(J(n.touchedFields,o,k),C.touchedFields=n.touchedFields,N=N||(v.touchedFields||S.touchedFields)&&$!==k)}N&&p&&u.state.next(C)}return N?C:{}},L=(o,d,k,O)=>{const p=y(n.errors,o),N=(v.isValid||S.isValid)&&de(d)&&n.isValid!==d;if(a.delayError&&k?(R=c(()=>m(o,k)),R(a.delayError)):(clearTimeout(T),R=null,k?J(n.errors,o,k):Z(n.errors,o)),(k?!Se(p,k):p)||!re(O)||N){const j={...O,...N&&de(d)?{isValid:d}:{},errors:n.errors,name:o};n={...n,...j},u.state.next(j)}},f=async o=>{_(o,!0);const d=await a.resolver(l,a.context,Mt(o||s.mount,r,a.criteriaMode,a.shouldUseNativeValidation));return _(o),d},h=async o=>{const{errors:d}=await f(o);if(o)for(const k of o){const O=y(d,k);O?J(n.errors,k,O):Z(n.errors,k)}else n.errors=d;return d},U=async(o,d,k={valid:!0})=>{for(const O in o){const p=o[O];if(p){const{_f:N,...j}=p;if(N){const C=s.array.has(N.name),$=p._f&&ht(p._f);$&&v.validatingFields&&_([O],!0);const ke=await xn(p,s.disabled,l,K,a.shouldUseNativeValidation&&!d,C);if($&&v.validatingFields&&_([O]),ke[N.name]&&(k.valid=!1,d))break;!d&&(y(ke,N.name)?C?ia(n.errors,ke,N.name):J(n.errors,N.name,ke[N.name]):Z(n.errors,N.name))}!re(j)&&await U(j,d,k)}}return k.valid},w=()=>{for(const o of s.unMount){const d=y(r,o);d&&(d._f.refs?d._f.refs.every(k=>!In(k)):!In(d._f.ref))&&He(o)}s.unMount=new Set},x=(o,d)=>!a.disabled&&(o&&d&&J(l,o,d),!Se(me(),t)),P=(o,d,k)=>ea(o,s,{...i.mount?l:W(d)?t:ge(o)?{[o]:d}:d},k,d),M=o=>fn(y(i.mount?l:t,o,a.shouldUnregister?y(t,o,[]):[])),B=(o,d,k={})=>{const O=y(r,o);let p=d;if(O){const N=O._f;N&&(!N.disabled&&J(l,o,la(d,N)),p=gn(N.ref)&&le(d)?"":d,na(N.ref)?[...N.ref.options].forEach(j=>j.selected=p.includes(j.value)):N.refs?en(N.ref)?N.refs.forEach(j=>{(!j.defaultChecked||!j.disabled)&&(Array.isArray(p)?j.checked=!!p.find(C=>C===j.value):j.checked=p===j.value||!!p)}):N.refs.forEach(j=>j.checked=j.value===p):Xn(N.ref)?N.ref.value="":(N.ref.value=p,N.ref.type||u.state.next({name:o,values:z(l)})))}(k.shouldDirty||k.shouldTouch)&&A(o,p,k.shouldTouch,k.shouldDirty,!0),k.shouldValidate&&ie(o)},Y=(o,d,k)=>{for(const O in d){if(!d.hasOwnProperty(O))return;const p=d[O],N=o+"."+O,j=y(r,N);(s.array.has(o)||X(p)||j&&!j._f)&&!be(p)?Y(N,p,k):B(N,p,k)}},H=(o,d,k={})=>{const O=y(r,o),p=s.array.has(o),N=z(d);J(l,o,N),p?(u.array.next({name:o,values:z(l)}),(v.isDirty||v.dirtyFields||S.isDirty||S.dirtyFields)&&k.shouldDirty&&u.state.next({name:o,dirtyFields:$e(t,l),isDirty:x(o,N)})):O&&!O._f&&!le(N)?Y(o,N,k):B(o,N,k),Yn(o,s)&&u.state.next({...n,name:o}),u.state.next({name:i.mount?o:void 0,values:z(l)})},ee=async o=>{i.mount=!0;const d=o.target;let k=d.name,O=!0;const p=y(r,k),N=$=>{O=Number.isNaN($)||be($)&&isNaN($.getTime())||Se($,y(l,k,$))},j=he(a.mode),C=he(a.reValidateMode);if(p){let $,ke;const ln=d.type?gr(p._f):Zr(o),pe=o.type===Tn.BLUR||o.type===Tn.FOCUS_OUT,ma=!Ut(p._f)&&!a.resolver&&!y(n.errors,k)&&!p._f.deps||wt(pe,y(n.touchedFields,k),n.isSubmitted,C,j),Fn=Yn(k,s,pe);J(l,k,ln),pe?(!d||!d.readOnly)&&(p._f.onBlur&&p._f.onBlur(o),R&&R(0)):p._f.onChange&&p._f.onChange(o);const bn=A(k,ln,pe),_a=!re(bn)||Fn;if(!pe&&u.state.next({name:k,type:o.type,values:z(l)}),ma)return(v.isValid||S.isValid)&&(a.mode==="onBlur"?pe&&b():pe||b()),_a&&u.state.next({name:k,...Fn?{}:bn});if(!pe&&Fn&&u.state.next({...n}),a.resolver){const{errors:rr}=await f([k]);if(N(ln),O){const Na=Rr(n.errors,r,k),ar=Rr(rr,r,Na.name||k);$=ar.error,k=ar.name,ke=re(rr)}}else _([k],!0),$=(await xn(p,s.disabled,l,K,a.shouldUseNativeValidation))[k],_([k]),N(ln),O&&($?ke=!1:(v.isValid||S.isValid)&&(ke=await U(r,!0)));O&&(p._f.deps&&ie(p._f.deps),L(k,ke,$,bn))}},oe=(o,d)=>{if(y(n.errors,d)&&o.focus)return o.focus(),1},ie=async(o,d={})=>{let k,O;const p=se(o);if(a.resolver){const N=await h(W(o)?o:p);k=re(N),O=o?!p.some(j=>y(N,j)):k}else o?(O=(await Promise.all(p.map(async N=>{const j=y(r,N);return await U(j&&j._f?{[N]:j}:j)}))).every(Boolean),!(!O&&!n.isValid)&&b()):O=k=await U(r);return u.state.next({...!ge(o)||(v.isValid||S.isValid)&&k!==n.isValid?{}:{name:o},...a.resolver||!o?{isValid:k}:{},errors:n.errors}),d.shouldFocus&&!O&&Ue(r,oe,o?p:s.mount),O},me=o=>{const d={...i.mount?l:t};return W(o)?d:ge(o)?y(d,o):o.map(k=>y(d,k))},ne=(o,d)=>({invalid:!!y((d||n).errors,o),isDirty:!!y((d||n).dirtyFields,o),error:y((d||n).errors,o),isValidating:!!y(n.validatingFields,o),isTouched:!!y((d||n).touchedFields,o)}),we=o=>{o&&se(o).forEach(d=>Z(n.errors,d)),u.state.next({errors:o?n.errors:{}})},Oe=(o,d,k)=>{const O=(y(r,o,{_f:{}})._f||{}).ref,p=y(n.errors,o)||{},{ref:N,message:j,type:C,...$}=p;J(n.errors,o,{...$,...d,ref:O}),u.state.next({name:o,errors:n.errors,isValid:!1}),k&&k.shouldFocus&&O&&O.focus&&O.focus()},On=(o,d)=>ve(o)?u.state.subscribe({next:k=>"values"in k&&o(P(void 0,d),k)}):P(o,d,!0),rn=o=>u.state.subscribe({next:d=>{qt(o.name,d.name,o.exact)&&Bt(d,o.formState||v,Je,o.reRenderRoot)&&o.callback({values:{...l},...n,...d,defaultValues:t})}}).unsubscribe,Dn=o=>(i.mount=!0,S={...S,...o.formState},rn({...o,formState:S})),He=(o,d={})=>{for(const k of o?se(o):s.mount)s.mount.delete(k),s.array.delete(k),d.keepValue||(Z(r,k),Z(l,k)),!d.keepError&&Z(n.errors,k),!d.keepDirty&&Z(n.dirtyFields,k),!d.keepTouched&&Z(n.touchedFields,k),!d.keepIsValidating&&Z(n.validatingFields,k),!a.shouldUnregister&&!d.keepDefaultValue&&Z(t,k);u.state.next({values:z(l)}),u.state.next({...n,...d.keepDirty?{isDirty:x()}:{}}),!d.keepIsValid&&b()},an=({disabled:o,name:d})=>{(de(o)&&i.mount||o||s.disabled.has(d))&&(o?s.disabled.add(d):s.disabled.delete(d))},Ve=(o,d={})=>{let k=y(r,o);const O=de(d.disabled)||de(a.disabled);return J(r,o,{...k||{},_f:{...k&&k._f?k._f:{ref:{name:o}},name:o,mount:!0,...d}}),s.mount.add(o),k?an({disabled:de(d.disabled)?d.disabled:a.disabled,name:o}):I(o,!0,d.value),{...O?{disabled:d.disabled||a.disabled}:{},...a.progressive?{required:!!d.required,min:ze(d.min),max:ze(d.max),minLength:ze(d.minLength),maxLength:ze(d.maxLength),pattern:ze(d.pattern)}:{},name:o,onChange:ee,onBlur:ee,ref:p=>{if(p){Ve(o,d),k=y(r,o);const N=W(p.value)&&p.querySelectorAll&&p.querySelectorAll("input,select,textarea")[0]||p,j=Pt(N),C=k._f.refs||[];if(j?C.find($=>$===N):N===k._f.ref)return;J(r,o,{_f:{...k._f,...j?{refs:[...C.filter(In),N,...Array.isArray(y(t,o))?[{}]:[]],ref:{type:N.type,name:o}}:{ref:N}}}),I(o,!1,void 0,N)}else k=y(r,o,{}),k._f&&(k._f.mount=!1),(a.shouldUnregister||d.shouldUnregister)&&!(Xr(s.array,o)&&i.action)&&s.unMount.add(o)}}},ce=()=>a.shouldFocusError&&Ue(r,oe,s.mount),Ye=o=>{de(o)&&(u.state.next({disabled:o}),Ue(r,(d,k)=>{const O=y(r,k);O&&(d.disabled=O._f.disabled||o,Array.isArray(O._f.refs)&&O._f.refs.forEach(p=>{p.disabled=O._f.disabled||o}))},0,!1))},Pe=(o,d)=>async k=>{let O;k&&(k.preventDefault&&k.preventDefault(),k.persist&&k.persist());let p=z(l);if(u.state.next({isSubmitting:!0}),a.resolver){const{errors:N,values:j}=await f();n.errors=N,p=z(j)}else await U(r);if(s.disabled.size)for(const N of s.disabled)Z(p,N);if(Z(n.errors,"root"),re(n.errors)){u.state.next({errors:{}});try{await o(p,k)}catch(N){O=N}}else d&&await d({...n.errors},k),ce(),setTimeout(ce);if(u.state.next({isSubmitted:!0,isSubmitting:!1,isSubmitSuccessful:re(n.errors)&&!O,submitCount:n.submitCount+1,errors:n.errors}),O)throw O},xe=(o,d={})=>{y(r,o)&&(W(d.defaultValue)?H(o,z(y(t,o))):(H(o,d.defaultValue),J(t,o,z(d.defaultValue))),d.keepTouched||Z(n.touchedFields,o),d.keepDirty||(Z(n.dirtyFields,o),n.isDirty=d.defaultValue?x(o,z(y(t,o))):x()),d.keepError||(Z(n.errors,o),v.isValid&&b()),u.state.next({...n}))},De=(o,d={})=>{const k=o?z(o):t,O=z(k),p=re(o),N=p?t:O;if(d.keepDefaultValues||(t=k),!d.keepValues){if(d.keepDirtyValues){const j=new Set([...s.mount,...Object.keys($e(t,l))]);for(const C of Array.from(j))y(n.dirtyFields,C)?J(N,C,y(l,C)):H(C,y(N,C))}else{if($n&&W(o))for(const j of s.mount){const C=y(r,j);if(C&&C._f){const $=Array.isArray(C._f.refs)?C._f.refs[0]:C._f.ref;if(gn($)){const ke=$.closest("form");if(ke){ke.reset();break}}}}if(d.keepFieldsRef)for(const j of s.mount)H(j,y(N,j));else r={}}l=a.shouldUnregister?d.keepDefaultValues?z(t):{}:z(N),u.array.next({values:{...N}}),u.state.next({values:{...N}})}s={mount:d.keepDirtyValues?s.mount:new Set,unMount:new Set,array:new Set,disabled:new Set,watch:new Set,watchAll:!1,focus:""},i.mount=!v.isValid||!!d.keepIsValid||!!d.keepDirtyValues,i.watch=!!a.shouldUnregister,u.state.next({submitCount:d.keepSubmitCount?n.submitCount:0,isDirty:p?!1:d.keepDirty?n.isDirty:!!(d.keepDefaultValues&&!Se(o,t)),isSubmitted:d.keepIsSubmitted?n.isSubmitted:!1,dirtyFields:p?{}:d.keepDirtyValues?d.keepDefaultValues&&l?$e(t,l):n.dirtyFields:d.keepDefaultValues&&o?$e(t,o):d.keepDirty?n.dirtyFields:{},touchedFields:d.keepTouched?n.touchedFields:{},errors:d.keepErrors?n.errors:{},isSubmitSuccessful:d.keepIsSubmitSuccessful?n.isSubmitSuccessful:!1,isSubmitting:!1,defaultValues:t})},Fe=(o,d)=>De(ve(o)?o(l):o,d),Ce=(o,d={})=>{const k=y(r,o),O=k&&k._f;if(O){const p=O.refs?O.refs[0]:O.ref;p.focus&&(p.focus(),d.shouldSelect&&ve(p.select)&&p.select())}},Je=o=>{n={...n,...o}},Ge={control:{register:Ve,unregister:He,getFieldState:ne,handleSubmit:Pe,setError:Oe,_subscribe:rn,_runSchema:f,_focusError:ce,_getWatch:P,_getDirty:x,_setValid:b,_setFieldArray:V,_setDisabledField:an,_setErrors:D,_getFieldArray:M,_reset:De,_resetDefaultValues:()=>ve(a.defaultValues)&&a.defaultValues().then(o=>{Fe(o,a.resetOptions),u.state.next({isLoading:!1})}),_removeUnmounted:w,_disableForm:Ye,_subjects:u,_proxyFormState:v,get _fields(){return r},get _formValues(){return l},get _state(){return i},set _state(o){i=o},get _defaultValues(){return t},get _names(){return s},set _names(o){s=o},get _formState(){return n},get _options(){return a},set _options(o){a={...a,...o}}},subscribe:Dn,trigger:ie,register:Ve,handleSubmit:Pe,watch:On,setValue:H,getValues:me,reset:Fe,resetField:xe,clearErrors:we,unregister:He,setError:Oe,setFocus:Ce,getFieldState:ne};return{...Ge,formControl:Ge}}var Ke=()=>{if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID();const e=typeof performance>"u"?Date.now():performance.now()*1e3;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{const n=(Math.random()*16+e)%16|0;return(a=="x"?n:n&3|8).toString(16)})},Vn=(e,a,n={})=>n.shouldFocus||W(n.shouldFocus)?n.focusName||`${e}.${W(n.focusIndex)?a:n.focusIndex}.`:"",cn=(e,a)=>[...e,...se(a)],Pn=e=>Array.isArray(e)?e.map(()=>{}):void 0;function Gn(e,a,n){return[...e.slice(0,a),...se(n),...e.slice(a)]}var jn=(e,a,n)=>Array.isArray(e)?(W(e[n])&&(e[n]=void 0),e.splice(n,0,e.splice(a,1)[0]),e):[],Mn=(e,a)=>[...se(a),...se(e)];function Ct(e,a){let n=0;const r=[...e];for(const t of a)r.splice(t-n,1),n++;return fn(r).length?r:[]}var hn=(e,a)=>W(a)?[]:Ct(e,se(a).sort((n,r)=>n-r)),Un=(e,a,n)=>{[e[a],e[n]]=[e[n],e[a]]},_r=(e,a,n)=>(e[a]=n,e);function Jt(e){const a=Re(),{control:n=a.control,name:r,keyName:t="id",shouldUnregister:l,rules:i}=e,[s,R]=E.useState(n._getFieldArray(r)),T=E.useRef(n._getFieldArray(r).map(Ke)),v=E.useRef(s),S=E.useRef(!1);v.current=s,n._names.array.add(r),E.useMemo(()=>i&&n.register(r,i),[n,i,r]),Ln(()=>n._subjects.array.subscribe({next:({values:A,name:L})=>{if(L===r||!L){const f=y(A,r);Array.isArray(f)&&(R(f),T.current=f.map(Ke))}}}).unsubscribe,[n,r]);const u=E.useCallback(A=>{S.current=!0,n._setFieldArray(r,A)},[n,r]),K=(A,L)=>{const f=se(z(A)),h=cn(n._getFieldArray(r),f);n._names.focus=Vn(r,h.length-1,L),T.current=cn(T.current,f.map(Ke)),u(h),R(h),n._setFieldArray(r,h,cn,{argA:Pn(A)})},c=(A,L)=>{const f=se(z(A)),h=Mn(n._getFieldArray(r),f);n._names.focus=Vn(r,0,L),T.current=Mn(T.current,f.map(Ke)),u(h),R(h),n._setFieldArray(r,h,Mn,{argA:Pn(A)})},b=A=>{const L=hn(n._getFieldArray(r),A);T.current=hn(T.current,A),u(L),R(L),!Array.isArray(y(n._fields,r))&&J(n._fields,r,void 0),n._setFieldArray(r,L,hn,{argA:A})},_=(A,L,f)=>{const h=se(z(L)),U=Gn(n._getFieldArray(r),A,h);n._names.focus=Vn(r,A,f),T.current=Gn(T.current,A,h.map(Ke)),u(U),R(U),n._setFieldArray(r,U,Gn,{argA:A,argB:Pn(L)})},V=(A,L)=>{const f=n._getFieldArray(r);Un(f,A,L),Un(T.current,A,L),u(f),R(f),n._setFieldArray(r,f,Un,{argA:A,argB:L},!1)},m=(A,L)=>{const f=n._getFieldArray(r);jn(f,A,L),jn(T.current,A,L),u(f),R(f),n._setFieldArray(r,f,jn,{argA:A,argB:L},!1)},D=(A,L)=>{const f=z(L),h=_r(n._getFieldArray(r),A,f);T.current=[...h].map((U,w)=>!U||w===A?Ke():T.current[w]),u(h),R([...h]),n._setFieldArray(r,h,_r,{argA:A,argB:f},!0,!1)},I=A=>{const L=se(z(A));T.current=L.map(Ke),u([...L]),R([...L]),n._setFieldArray(r,[...L],f=>f,{},!0,!1)};return E.useEffect(()=>{if(n._state.action=!1,Yn(r,n._names)&&n._subjects.state.next({...n._formState}),S.current&&(!he(n._options.mode).isOnSubmit||n._formState.isSubmitted)&&!he(n._options.reValidateMode).isOnSubmit)if(n._options.resolver)n._runSchema([r]).then(A=>{const L=y(A.errors,r),f=y(n._formState.errors,r);(f?!L&&f.type||L&&(f.type!==L.type||f.message!==L.message):L&&L.type)&&(L?J(n._formState.errors,r,L):Z(n._formState.errors,r),n._subjects.state.next({errors:n._formState.errors}))});else{const A=y(n._fields,r);A&&A._f&&!(he(n._options.reValidateMode).isOnSubmit&&he(n._options.mode).isOnSubmit)&&xn(A,n._names.disabled,n._formValues,n._options.criteriaMode===Ee.all,n._options.shouldUseNativeValidation,!0).then(L=>!re(L)&&n._subjects.state.next({errors:ia(n._formState.errors,L,r)}))}n._subjects.state.next({name:r,values:z(n._formValues)}),n._names.focus&&Ue(n._fields,(A,L)=>{if(n._names.focus&&L.startsWith(n._names.focus)&&A.focus)return A.focus(),1}),n._names.focus="",n._setValid(),S.current=!1},[s,r,n]),E.useEffect(()=>(!y(n._formValues,r)&&n._setFieldArray(r),()=>{const A=(L,f)=>{const h=y(n._fields,L);h&&h._f&&(h._f.mount=f)};n._options.shouldUnregister||l?n.unregister(r):A(r,!1)}),[r,n,t,l]),{swap:E.useCallback(V,[u,r,n]),move:E.useCallback(m,[u,r,n]),prepend:E.useCallback(c,[u,r,n]),append:E.useCallback(K,[u,r,n]),remove:E.useCallback(b,[u,r,n]),insert:E.useCallback(_,[u,r,n]),update:E.useCallback(D,[u,r,n]),replace:E.useCallback(I,[u,r,n]),fields:E.useMemo(()=>s.map((A,L)=>({...A,[t]:T.current[L]||Ke()})),[s,t])}}function $t(e={}){const a=E.useRef(void 0),n=E.useRef(void 0),[r,t]=E.useState({isDirty:!1,isValidating:!1,isLoading:ve(e.defaultValues),isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,submitCount:0,dirtyFields:{},touchedFields:{},validatingFields:{},errors:e.errors||{},disabled:e.disabled||!1,isReady:!1,defaultValues:ve(e.defaultValues)?void 0:e.defaultValues});if(!a.current)if(e.formControl)a.current={...e.formControl,formState:r},e.defaultValues&&!ve(e.defaultValues)&&e.formControl.reset(e.defaultValues,e.resetOptions);else{const{formControl:i,...s}=xt(e);a.current={...s,formState:r}}const l=a.current.control;return l._options=e,Ln(()=>{const i=l._subscribe({formState:l._proxyFormState,callback:()=>t({...l._formState}),reRenderRoot:!0});return t(s=>({...s,isReady:!0})),l._formState.isReady=!0,i},[l]),E.useEffect(()=>l._disableForm(e.disabled),[l,e.disabled]),E.useEffect(()=>{e.mode&&(l._options.mode=e.mode),e.reValidateMode&&(l._options.reValidateMode=e.reValidateMode)},[l,e.mode,e.reValidateMode]),E.useEffect(()=>{e.errors&&(l._setErrors(e.errors),l._focusError())},[l,e.errors]),E.useEffect(()=>{e.shouldUnregister&&l._subjects.state.next({values:l._getWatch()})},[l,e.shouldUnregister]),E.useEffect(()=>{if(l._proxyFormState.isDirty){const i=l._getDirty();i!==r.isDirty&&l._subjects.state.next({isDirty:i})}},[l,r.isDirty]),E.useEffect(()=>{e.values&&!Se(e.values,n.current)?(l._reset(e.values,{keepFieldsRef:!0,...l._options.resetOptions}),n.current=e.values,t(i=>({...i}))):l._resetDefaultValues()},[l,e.values]),E.useEffect(()=>{l._state.mount||(l._setValid(),l._state.mount=!0),l._state.watch&&(l._state.watch=!1,l._subjects.state.next({...l._formState})),l._removeUnmounted()}),a.current.formState=Qr(r,l),a.current}const zt={[F.ADOPSJONSDOKUMENTAJON]:"ToTrinnsForm.Adopsjon.KontrollerOpplysninger",[F.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN]:"ToTrinnsForm.Adopsjon.VurderEktefellesBarn",[F.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE]:"ToTrinnsForm.Adopsjon.VurderMannAdoptererAlene",[F.OVERSTYR_ADOPSJONSVILKAR]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[F.OVERSTYRING_AV_ADOPSJONSVILKÅRET_FP]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[F.OMSORGSOVERTAKELSE]:"ToTrinnsForm.Omsorgovertagelse.KontrollerOpplysninger",[F.MANUELL_VURDERING_AV_OMSORGSVILKARET]:"ToTrinnsForm.Omsorgovertagelse.VurderVilkarForeldreansvarTredjeLedd",[F.AUTO_VENT_PÅ_FODSELREGISTRERING]:"ToTrinnsForm.Fødsel.VurderSokersRelasjon",[F.SJEKK_TERMINBEKREFTELSE]:"ToTrinnsForm.Fødsel.SjekkTerminbekreftelse",[F.SJEKK_MANGLENDE_FØDSEL]:"ToTrinnsForm.Fødsel.SjekkManglendeFødsel",[F.OVERSTYR_FODSELSVILKAR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[F.OVERSTYR_FODSELSVILKAR_FAR_MEDMOR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[F.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD]:"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarFjerdeLedd",[F.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN]:"ToTrinnsForm.Foreldreansvar.VurderTidligereUtbetaling",[F.AVKLAR_AKTIVITETER]:"ToTrinnsForm.Beregning.AvklarAktiviteter",[F.OVERSTYRING_AV_BEREGNINGSAKTIVITETER]:"ToTrinnsForm.Beregning.OverstyrtBeregningsaktiviteter",[F.OVERSTYRING_AV_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.OverstyrtBeregningsgrunnlag",[F.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS]:"ToTrinnsForm.Beregning.InntektFastsatt",[F.FASTSETT_BRUTTO_BEREGNINGSGRUNNLAG_SELVSTENDIG_NAERINGSDRIVENDE]:"ToTrinnsForm.Beregning.InntektFastsatt",[F.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD]:"ToTrinnsForm.Beregning.InntektFastsatt",[F.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET]:"ToTrinnsForm.Beregning.InntektFastsatt",[F.VURDER_GRADERING_UTEN_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.GraderingUtenBG",[F.FORDEL_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.FastsettFordeltBeregningsgrunnlag",[F.SOKNADSFRISTVILKARET]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[F.VURDER_SOKNADSFRIST_FORELDREPENGER]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[F.OVERSTYR_SOKNADSFRISTVILKAR]:"ToTrinnsForm.Soknadsfrist.VilkarOverstyrt",[F.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE]:"ToTrinnsForm.Medlemskap.VurderGyldigMedlemskap",[F.AVKLAR_LOVLIG_OPPHOLD]:"ToTrinnsForm.Medlemskap.AvklarLovligOpphold",[F.AVKLAR_OM_BRUKER_ER_BOSATT]:"ToTrinnsForm.Medlemskap.VurderSokerBosatt",[F.AVKLAR_OPPHOLDSRETT]:"ToTrinnsForm.Medlemskap.AvklarOppholdsrett",[F.OVERSTYR_MEDLEMSKAPSVILKAR]:"ToTrinnsForm.Medlemskap.VilkarOverstyrt",[F.OVERSTYR_AVKLAR_STARTDATO]:"ToTrinnsForm.Medlemskap.OverstyrtStartdato",[F.AVKLAR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.AvklartDekningsgrad",[F.OVERSTYR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.OverstyrtDekningsgrad",[F.FORESLA_VEDTAK]:"ToTrinnsForm.Vedtak.Fritekstbrev",[F.FORESLA_VEDTAK_MANUELT]:"ToTrinnsForm.Vedtak.Fritekstbrev",[F.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_OMSORG]:"ToTrinnsForm.Omsorg.VurderOmsorg",[F.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_ALENEOMSORG]:"ToTrinnsForm.Aleneomsorg.VurderAleneomsorg",[F.KONTROLLER_OPPLYSNINGER_OM_DØD]:"ToTrinnsForm.Uttak.Dod",[F.KONTROLLER_OPPLYSNINGER_OM_SØKNADSFRIST]:"ToTrinnsForm.Uttak.Soknadsfrist",[F.KONTROLLER_REALITETSBEHANDLING_ELLER_KLAGE]:"ToTrinnsForm.Uttak.Klage",[F.ANNENPART_EØS]:"ToTrinnsForm.Uttak.AnnenpartEØS",[F.TETTE_SAKER]:"ToTrinnsForm.Uttak.TetteStønadsperioder",[F.KONTROLLER_OPPLYSNINGER_OM_FORDELING_AV_STØNADSPERIODEN]:"ToTrinnsForm.Uttak.FordelingStonadsperioder",[F.KONTROLLER_TILSTØTENDE_YTELSER_INNVILGET]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Innvilget",[F.KONTROLLER_TILSTØTENDE_YTELSER_OPPHØRT]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Opphort",[F.TILKNYTTET_STORTINGET]:"ToTrinnsForm.Uttak.Stortinget",[F.VURDER_TILBAKETREKK]:"ToTrinnsForm.TilkjentYtelse.Tilbaketrekk",[F.VURDER_FARESIGNALER]:"ToTrinnsForm.Faresignaler.Vurder",[F.VURDER_OPPTJENINGSVILKARET]:"ToTrinnsForm.Opptjening.VurderOpptjeningsvilkåret",[F.VURDER_REFUSJON_BERGRUNN]:"ToTrinnsForm.Beregningsgrunnlag.Refusjonsstart",[F.VURDER_ARBEIDSFORHOLD_INNTEKTSMELDING]:"ToTrinnsForm.ArbeidOgInntekt.ManueltOpprettet"},Wt={},Zt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidMedNavn",values:{a:e,b:a,c:n}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidUtenNavn",values:{a:e,b:n}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringAktivitet",values:{a:e}}),Xt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidMedNavn",values:{a:e,bb:a,c:n,b:r=>g.jsx("b",{children:r})}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidUtenNavn",values:{a:e,bb:n,b:r=>g.jsx("b",{children:r})}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningAktivitet",values:{a:e,b:r=>g.jsx("b",{children:r})}}),Qt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidMedNavn",values:{a:e,b:a,c:n}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidUtenNavn",values:{a:e,b:n}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningAktivitet",values:{a:e}}),sa=({aktivitet:e})=>e.erEndring?Zt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):e.godkjent?Qt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):Xt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr);sa.__docgenInfo={description:"",methods:[],displayName:"OpptjeningTotrinnText",props:{aktivitet:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  godkjent: boolean;
  privatpersonFødselsdato?: string;
}>`},description:""}}};const el=e=>e?.fastsattVarigEndringNaering?g.jsx(q,{id:"ToTrinnsForm.Beregning.VarigEndring"}):g.jsx(q,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),Nr=e=>e.uttakPerioder?e.uttakPerioder.map(a=>{const n=tr(a.fom),r=tr(a.tom);let t;return a.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":a.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":a.erEndret&&(e.aksjonspunktKode===F.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===F.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":a.erEndret&&e.aksjonspunktKode===F.OVERSTYRING_AV_UTTAKPERIODER||a.erEndret&&e.aksjonspunktKode===F.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":a.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",g.jsx(q,{id:t,values:{a:n,b:r}},t)}):[],nl=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(a=>g.jsx(sa,{aktivitet:a},a.aktivitetType)):[],rl=e=>{const a=zt[e.aksjonspunktKode];return a?[g.jsx(q,{id:a},a)]:[]},al=e=>{const a=Wt[e.aksjonspunktKode];return a?[g.jsx(q,{id:a},a)]:[]},tl=e=>{const a=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[g.jsx(q,{id:a},a)]},ll=(e,a)=>a?.faktaOmBeregningTilfeller?a.faktaOmBeregningTilfeller.flatMap(n=>{const r=e.find(t=>t.kode===n);return r?[g.jsx("div",{children:r.navn},r.navn)]:[]}):[],ol=e=>{let a="";switch(e?.type){case fe.KLAGE_YTELSESVEDTAK_STADFESTET:a="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case fe.KLAGE_YTELSESVEDTAK_OPPHEVET:a="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case fe.KLAGE_AVVIST:a="ToTrinnsForm.Klage.Avvist";break;case fe.HJEMSENDE_UTEN_OPPHEVE:a="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case fe.KLAGE_DELVIS_MEDHOLD:a="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case fe.KLAGE_OMGJORT_UGUNST:a="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case fe.KLAGE_MEDHOLD:a="ToTrinnsForm.Klage.OmgjortTilGunst";break}return g.jsx(q,{id:a})},il=(e,a)=>e===Nn.FATTER_VEDTAK?[ol(a)]:[],sl=()=>g.jsx(q,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),dl=()=>g.jsx(q,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),kl=e=>e.aksjonspunktKode===F.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===F.VURDERING_AV_FORMKRAV_KLAGE_NFP,da=(e,a,n,r,t,l)=>t.aksjonspunktKode===F.VURDER_PERIODER_MED_OPPTJENING?nl(t):t.aksjonspunktKode===F.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[el(t.beregningDto)]:t.aksjonspunktKode===F.VURDER_FAKTA_FOR_ATFL_SN?ll(n,t.beregningDto):wa(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0||Ha(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0?Nr(t):t.aksjonspunktKode===F.AVKLAR_ANNEN_FORELDER_RETT?[sl()]:t.aksjonspunktKode===F.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?tl(e):t.aksjonspunktKode===F.OVERSTYRING_AV_RETT_OG_OMSORG?[dl()]:kl(t)?il(a,l):r?al(t):rl(t);function El(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Sr={exports:{}},We={};/**
 * @license React
 ...
 */var yr;function ul(){if(yr)return We;yr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,l){var i=null;if(l!==void 0&&(i=""+l),t.key!==void 0&&(i=""+t.key),"key"in t){l={};for(var s in t)s!=="key"&&(l[s]=t[s])}else l=t;return t=l.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:l}}return We.Fragment=a,We.jsx=n,We.jsxs=n,We}var pr;function vl(){return pr||(pr=1,Sr.exports=ul()),Sr.exports}var ye=vl();const Tl=({children:e})=>{const a=G.Children.toArray(e);return a.length===0?null:ye.jsx(lt,{variant:"warning",size:"small",children:ye.jsx(Te,{gap:"space-8","data-testid":"aksjonspunkt-text-container",children:a.map(n=>ye.jsx(ue,{size:"small",children:n},gl(n)))})})},gl=e=>{if(G.isValidElement(e))return e.key;if(typeof e=="string"||typeof e=="number")return`tekst-${e}`},nn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};Be(nn);const mn="var(--ax-bg-neutral-strong)",ka=4,Al=(e,a,n)=>`
  .arrowBoxTop${e} {
...
`,ml=(e,a,n,r)=>a?Rl(e,n,r):Al(e,n,r),_l=(e,a,n)=>n?"":a?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,Nl=({children:e,alignOffset:a=0,alignLeft:n=!1,marginTop:r=0,marginLeft:t=0,hideBorder:l=!1})=>ye.jsxs(ye.Fragment,{children:[ye.jsx("style",{dangerouslySetInnerHTML:{__html:ml(a,n,r,t)}}),ye.jsx("div",{className:_l(a,n,l),children:e})]});var Kr={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var fr;function Sl(){return fr||(fr=1,function(e){(function(){var a={}.hasOwnProperty;function n(){for(var l="",i=0;i<arguments.length;i++){var s=arguments[i];s&&(l=t(l,r.call(this,s)))}return l}function r(l){if(typeof l=="string"||typeof l=="number")return this&&this[l]||l;if(typeof l!="object")return"";if(Array.isArray(l))return n.apply(this,l);if(l.toString!==Object.prototype.toString&&!l.toString.toString().includes("[native code]"))return l.toString();var i="";for(var s in l)a.call(l,s)&&l[s]&&(i=t(i,this&&this[s]||s));return i}function t(l,i){return i?l?l+" "+i:l+i:l}e.exports?(n.default=n,e.exports=n):window.classNames=n})()}(Kr)),Kr.exports}var yl=Sl();const er=El(yl),pl="_borderbox_1a0x6_1",Kl="_error_1a0x6_5",fl="_warning_1a0x6_8",Ll={borderbox:pl,error:Kl,warning:fl};er.bind(Ll);const Ol="_aksjonspunkt_11wjs_1",Dl="_erAksjonspunktApent_11wjs_4",Fl="_erIkkeGodkjentAvBeslutter_11wjs_8",bl={aksjonspunkt:Ol,erAksjonspunktApent:Dl,erIkkeGodkjentAvBeslutter:Fl};er.bind(bl);Be(nn);Be(nn);const Il="_divider_1jpov_1",Vl="_dividerParagraf_1jpov_8",cl="_leftPanel_1jpov_11",Pl="_rightPanel_1jpov_14",Gl={divider:Il,dividerParagraf:Vl,leftPanel:cl,rightPanel:Pl};er.bind(Gl);const Ea=()=>ye.jsx("span",{"data-testid":"editedIcon",children:ye.jsx(Xa,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});Be(nn);Be(nn);function jl(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Lr={exports:{}},Ze={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Or;function Ml(){if(Or)return Ze;Or=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,l){var i=null;if(l!==void 0&&(i=""+l),t.key!==void 0&&(i=""+t.key),"key"in t){l={};for(var s in t)s!=="key"&&(l[s]=t[s])}else l=t;return t=l.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:l}}return Ze.Fragment=a,Ze.jsx=n,Ze.jsxs=n,Ze}var Dr;function hl(){return Dr||(Dr=1,Lr.exports=Ml()),Lr.exports}var Q=hl();const nr=e=>e.reduce((a,n,r)=>({...a,[r]:t=>n(t)||!0}),{}),_n=(e,a)=>a.split(".").reduce((n,r)=>n!==void 0?n[r]:n,e)?.message,Me=({label:e,validate:a=[],readOnly:n=!1,onChange:r,onClick:t,className:l,size:i="small",...s})=>{const{name:R,control:T,disabled:v}=s,{formState:{errors:S}}=Re(),{field:u}=Zn({name:R,control:T,rules:{validate:G.useMemo(()=>nr(a),[a])}}),K=_n(S,R);return Q.jsxs(Q.Fragment,{children:[Q.jsx(mt,{size:i,disabled:v||n,checked:u.value===!0,className:l,error:!!K,...u,onChange:c=>{u.onChange(c),r&&r(c.currentTarget.checked)},onClick:()=>{t&&t()},children:e}),K&&Q.jsx(pn,{children:_n(S,R)})]})};var Cn={exports:{}},Ul=Cn.exports,Fr;function Bl(){return Fr||(Fr=1,function(e,a){(function(n,r){e.exports=r()})(Ul,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,t=/\d/,l=/\d\d/,i=/\d\d?/,s=/\d*[^-_:/,()\s\d]+/,R={},T=function(_){return(_=+_)+(_>68?1900:2e3)},v=function(_){return function(V){this[_]=+V}},S=[/[+-]\d\d:?(\d\d)?|Z/,function(_){(this.zone||(this.zone={})).offset=function(V){if(!V||V==="Z")return 0;var m=V.match(/([+-]|\d\d)/g),D=60*m[1]+(+m[2]||0);return D===0?0:m[0]==="+"?-D:D}(_)}],u=function(_){var V=R[_];return V&&(V.indexOf?V:V.s.concat(V.f))},K=function(_,V){var m,D=R.meridiem;if(D){for(var I=1;I<=24;I+=1)if(_.indexOf(D(I,0,V))>-1){m=I>12;break}}else m=_===(V?"pm":"PM");return m},c={A:[s,function(_){this.afternoon=K(_,!1)}],a:[s,function(_){this.afternoon=K(_,!0)}],Q:[t,function(_){this.month=3*(_-1)+1}],S:[t,function(_){this.milliseconds=100*+_}],SS:[l,function(_){this.milliseconds=10*+_}],SSS:[/\d{3}/,function(_){this.milliseconds=+_}],s:[i,v("seconds")],ss:[i,v("seconds")],m:[i,v("minutes")],mm:[i,v("minutes")],H:[i,v("hours")],h:[i,v("hours")],HH:[i,v("hours")],hh:[i,v("hours")],D:[i,v("day")],DD:[l,v("day")],Do:[s,function(_){var V=R.ordinal,m=_.match(/\d+/);if(this.day=m[0],V)for(var D=1;D<=31;D+=1)V(D).replace(/\[|\]/g,"")===_&&(this.day=D)}],w:[i,v("week")],ww:[l,v("week")],M:[i,v("month")],MM:[l,v("month")],MMM:[s,function(_){var V=u("months"),m=(u("monthsShort")||V.map(function(D){return D.slice(0,3)})).indexOf(_)+1;if(m<1)throw new Error;this.month=m%12||m}],MMMM:[s,function(_){var V=u("months").indexOf(_)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,v("year")],YY:[l,function(_){this.year=T(_)}],YYYY:[/\d{4}/,v("year")],Z:S,ZZ:S};function b(_){var V,m;V=_,m=R&&R.formats;for(var D=(_=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,P){var M=P&&P.toUpperCase();return x||m[P]||n[P]||m[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(B,Y,H){return Y||H.slice(1)})})).match(r),I=D.length,A=0;A<I;A+=1){var L=D[A],f=c[L],h=f&&f[0],U=f&&f[1];D[A]=U?{regex:h,parser:U}:L.replace(/^\[|\]$/g,"")}return function(w){for(var x={},P=0,M=0;P<I;P+=1){var B=D[P];if(typeof B=="string")M+=B.length;else{var Y=B.regex,H=B.parser,ee=w.slice(M),oe=Y.exec(ee)[0];H.call(x,oe),w=w.replace(oe,"")}}return function(ie){var me=ie.afternoon;if(me!==void 0){var ne=ie.hours;me?ne<12&&(ie.hours+=12):ne===12&&(ie.hours=0),delete ie.afternoon}}(x),x}}return function(_,V,m){m.p.customParseFormat=!0,_&&_.parseTwoDigitYear&&(T=_.parseTwoDigitYear);var D=V.prototype,I=D.parse;D.parse=function(A){var L=A.date,f=A.utc,h=A.args;this.$u=f;var U=h[1];if(typeof U=="string"){var w=h[2]===!0,x=h[3]===!0,P=w||x,M=h[2];x&&(M=h[2]),R=this.$locale(),!w&&M&&(R=m.Ls[M]),this.$d=function(ee,oe,ie,me){try{if(["x","X"].indexOf(oe)>-1)return new Date((oe==="X"?1e3:1)*ee);var ne=b(oe)(ee),we=ne.year,Oe=ne.month,On=ne.day,rn=ne.hours,Dn=ne.minutes,He=ne.seconds,an=ne.milliseconds,Ve=ne.zone,ce=ne.week,Ye=new Date,Pe=On||(we||Oe?1:Ye.getDate()),xe=we||Ye.getFullYear(),De=0;we&&!Oe||(De=Oe>0?Oe-1:Ye.getMonth());var Fe,Ce=rn||0,Je=Dn||0,tn=He||0,Ge=an||0;return Ve?new Date(Date.UTC(xe,De,Pe,Ce,Je,tn,Ge+60*Ve.offset*1e3)):ie?new Date(Date.UTC(xe,De,Pe,Ce,Je,tn,Ge)):(Fe=new Date(xe,De,Pe,Ce,Je,tn,Ge),ce&&(Fe=me(Fe).week(ce).toDate()),Fe)}catch{return new Date("")}}(L,U,f,m),this.init(),M&&M!==!0&&(this.$L=this.locale(M).$L),P&&L!=this.format(U)&&(this.$d=new Date("")),R={}}else if(U instanceof Array)for(var B=U.length,Y=1;Y<=B;Y+=1){h[1]=U[Y-1];var H=m.apply(this,h);if(H.isValid()){this.$d=H.$d,this.$L=H.$L,this.init();break}Y===B&&(this.$d=new Date(""))}else I.call(this,A)}}})}(Cn)),Cn.exports}var ql=Bl();const wl=jl(ql),Hl="_textarea_14c7r_1",Yl="_readOnlyField_14c7r_7",br={textarea:Hl,readOnlyField:Yl},xl=e=>e!=null&&e!=="",Cl=({label:e,value:a,isEdited:n=!1,type:r,hideLabel:t,size:l})=>xl(a)?Q.jsxs(Te,{gap:"space-4",children:[e&&!t&&Q.jsx(yn,{size:l,children:e}),Q.jsxs(Ie,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(Br,{className:r==="textarea"?br.textarea:br.readOnlyField,size:l,children:a}),n&&Q.jsx(Ea,{})]})]}):null;pa.extend(wl);const Jl=({label:e,description:a,validate:n=[],onChange:r,children:t,className:l,isReadOnly:i=!1,size:s="small",isEdited:R=!1,hideLegend:T=!1,...v})=>{const{name:S,control:u}=v,{formState:{errors:K}}=Re(),{field:c}=Zn({name:S,control:u,rules:{validate:nr(n)}});return Q.jsx(Nt,{name:S,value:c.value!==void 0?c.value:null,legend:Q.jsxs(Ie,{justify:"center",gap:"space-8",children:[e,i&&R&&Q.jsx(Ea,{})]}),hideLegend:T,disabled:i,description:a,size:s,error:_n(K,S),onChange:b=>{r&&r(b),c.onChange(b)},className:l,children:t})},$l="_textAreaFieldWithBadges_bdz0b_1",zl="_etikettWrapper_bdz0b_4",Ir={textAreaFieldWithBadges:$l,etikettWrapper:zl},Wl=({name:e,control:a,label:n,readOnly:r,maxLength:t,badges:l,validate:i=[],parse:s=K=>K,className:R,description:T,isEdited:v,size:S="small",...u})=>{const{formState:{errors:K}}=Re(),{field:c}=Zn({name:e,control:a,rules:{validate:G.useMemo(()=>nr(i),[i])}});return r?Q.jsx(Cl,{size:S,label:n,value:c.value,type:"textarea",isEdited:v,hideLabel:u.hideLabel}):Q.jsxs("div",{className:l?Ir.textAreaFieldWithBadges:null,children:[l&&Q.jsx("div",{className:Ir.etikettWrapper,children:l.map(({type:b,titleText:_})=>Q.jsx(Et,{variant:b,size:"small",children:_},_))}),Q.jsx(Ot,{size:S,label:n,description:T,className:R,autoComplete:"off",...c,onChange:b=>c.onChange(b.currentTarget.value!==""?s(b.currentTarget.value):null),value:c.value?c.value:"",error:_n(K,e),maxLength:t,...u})]})},Zl=({formMethods:e,onSubmit:a,children:n,className:r,setDataOnUnmount:t})=>{const{handleSubmit:l,getValues:i}=e;return G.useEffect(()=>()=>{t&&t(i())},[]),Q.jsx(bt,{...e,children:Q.jsx("form",{className:r,onSubmit:a?l(s=>a(s)):void 0,children:n})})},Xl=(e,a)=>{const{setError:n,clearErrors:r,formState:t}=Re(),l=!!a;return G.useEffect(()=>{l&&n(`${e}.notRegisteredInput`,{type:"custom",message:a}),l||r(`${e}.notRegisteredInput`)},[a]),t.isSubmitted?e.split(".").reduce((i,s)=>i[s]||{},t.errors)?.notRegisteredInput?.message:void 0},Ql=La(3),eo=Oa(2e3),ae="aksjonspunktGodkjenning",no=(e,a)=>!e(`${ae}.${a}.feilFakta`)&&!e(`${ae}.${a}.feilLov`)&&!e(`${ae}.${a}.feilSkjønn`)&&!e(`${ae}.${a}.feilUtredning`)&&!e(`${ae}.${a}.feilSaksflyt`)&&!e(`${ae}.${a}.feilBegrunnelse`),ua=({index:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n})=>{const{watch:r,getValues:t,control:l}=Re(),i=r("aksjonspunktGodkjenning"),{aksjonspunktKode:s,totrinnskontrollGodkjent:R}=i[e],T=a.find(K=>K.totrinnskontrollAksjonspunkter.some(c=>c.aksjonspunktKode===s)),v=T?.totrinnskontrollAksjonspunkter.find(K=>K.aksjonspunktKode===s),S=!R&&no(t,e)?Ka():void 0,u=Xl(`${ae}.${e}.faktagruppe`,S);return!T||!v?null:g.jsxs(Te,{gap:"space-12",children:[g.jsx(Jl,{name:`${ae}.${e}.totrinnskontrollGodkjent`,control:l,isReadOnly:n,hideLegend:!0,children:g.jsxs(Ie,{gap:"space-16",children:[g.jsx(or,{value:!0,size:"small",children:g.jsx(q,{id:"ApprovalField.Godkjent"})}),g.jsx(or,{value:!1,size:"small",children:g.jsx(q,{id:"ApprovalField.Vurder"})})]})}),R===!1&&g.jsx(Nl,{alignOffset:R?1:110,children:g.jsxs(Te,{gap:"space-8",children:[g.jsx(yn,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),g.jsx(ue,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),g.jsxs(Te,{gap:"space-16",children:[g.jsx(Te,{gap:"space-4",children:g.jsxs(Ie,{justify:"space-between",style:{width:"300px"},children:[g.jsxs(Te,{gap:"space-4",children:[g.jsx(Me,{name:`${ae}.${e}.feilFakta`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilSkjønn`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilLov`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),g.jsxs(Te,{gap:"space-4",children:[g.jsx(Me,{name:`${ae}.${e}.feilUtredning`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilSaksflyt`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilBegrunnelse`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),u&&g.jsx(pn,{size:"small",children:u}),g.jsx(Wl,{name:`${ae}.${e}.besluttersBegrunnelse`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[fa,Ql,eo,Da],readOnly:n})]})]})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  skjermlenkeType: SkjermlenkeType;
  totrinnskontrollAksjonspunkter: TotrinnskontrollAksjonspunkt[];
}>`}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ro="_aksjonspunktTextContainer_1pwmv_5",ao="_lenke_1pwmv_10",Vr={aksjonspunktTextContainer:ro,lenke:ao},to="aksjonspunktGodkjenning",va=({behandling:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n,erForeldrepengerFagsak:r,erTilbakekreving:t,skjemalenkeTyper:l,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const{control:R,watch:T}=Re(),{fields:v}=Jt({control:R,name:to}),S=T("aksjonspunktGodkjenning");return g.jsx(Te,{gap:"space-24",children:v.map((u,K)=>{const{aksjonspunktKode:c}=S[K],b=a.find(I=>I.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===c)),_=b?.totrinnskontrollAksjonspunkter.find(I=>I.aksjonspunktKode===c);if(!b||!_)return null;const V=da(r,e.status,i,t,_,e.behandlingsresultat),m=l.find(I=>I.kode===b.skjermlenkeType),D=s(b.skjermlenkeType);return g.jsxs("div",{children:[D&&m&&g.jsx(Mr,{to:D,onClick:()=>window.scroll(0,0),className:Vr.lenke,children:m.navn}),V.map((I,A)=>g.jsx("div",{className:Vr.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:I})},c.concat("_".concat(A.toString())))),g.jsx(ua,{index:K,totrinnskontrollSkjermlenkeContext:a,readOnly:n})]},u.id)})})};va.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
...
| '-'`,elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const so="_approvalItem_xqu47_1",ko="_approvalItemContainer_xqu47_7",Eo="_aksjonspunktTextContainer_xqu47_11",uo="_resultatFraGodkjenningTextContainer_xqu47_16",vo="_lenke_xqu47_20",To="_checkmarkIcon_xqu47_24",go="_xmark_xqu47_30",Ne={approvalItem:so,approvalItemContainer:ko,aksjonspunktTextContainer:Eo,resultatFraGodkjenningTextContainer:uo,lenke:vo,checkmarkIcon:To,xmark:go},Ao=({vurderPaNyttArsaker:e,vurderArsaker:a})=>g.jsx("div",{className:Ne.approvalItem,children:e?.map(n=>g.jsxs(Ie,{gap:"space-8",children:[g.jsx(et,{className:Ne.xmark}),g.jsx("div",{children:a.find(r=>n===r.kode)?.navn})]},n))}),ga=({behandling:e,totrinnskontrollSkjermlenkeContext:a,erForeldrepengerFagsak:n,erTilbakekreving:r,skjemalenkeTyper:t,vurderArsaker:l,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const R=ba();return g.jsxs(g.Fragment,{children:[g.jsx("div",{className:Ne.resultatFraGodkjenningTextContainer,children:g.jsx(q,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Ia}})}),a.map(T=>{const v=T.totrinnskontrollAksjonspunkter,S=t.find(u=>u.kode===T.skjermlenkeType);if(v.length>0){const u=s(T.skjermlenkeType);return g.jsxs(E.Fragment,{children:[u&&S&&g.jsx(Mr,{to:u,onClick:()=>window.scroll(0,0),className:Ne.lenke,children:S.navn}),v.map(K=>{const c=da(n,e.status,i,r,K,e.behandlingsresultat);return g.jsxs("div",{className:Ne.approvalItemContainer,children:[c.map((b,_)=>g.jsx("div",{className:Ne.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:b})},K.aksjonspunktKode.concat("_".concat(_.toString())))),g.jsx("div",{className:Ne.approvalItem,children:K.totrinnskontrollGodkjent?g.jsxs(Ie,{gap:"space-8",children:[g.jsx(Ca,{title:R.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:Ne.checkmarkIcon}),g.jsx(q,{id:"ToTrinnsForm.Godkjent"})]}):g.jsx(Ao,{vurderPaNyttArsaker:K?.vurderPaNyttArsaker,vurderArsaker:l})}),g.jsx("pre",{className:Ne.approvalItem,children:hr(K.besluttersBegrunnelse)})]},K.aksjonspunktKode)})]},T.skjermlenkeType)}return null})]})};ga.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
| '-'`,elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Ro=Be(Ua),mo=[on.FAKTA_OM_FEILUTBETALING,on.FORELDELSE,on.TILBAKEKREVING,on.VEDTAK],_o=e=>{const a=[];return e.feilFakta&&a.push(te.FEIL_FAKTA),e.feilLov&&a.push(te.FEIL_LOV),e.feilSkjønn&&a.push(te.SKJØNN),e.feilUtredning&&a.push(te.UTREDNING),e.feilSaksflyt&&a.push(te.SAKSFLYT),e.feilBegrunnelse&&a.push(te.BEGRUNNELSE),a},No=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Aa=({behandling:e,location:a,fagsakYtelseType:n,readOnly:r,onSubmit:t,forhandsvisVedtaksbrev:l,alleKodeverk:i,createLocationForSkjermlenke:s,beslutterFormData:R,setBeslutterFormData:T})=>{const v=Xe.TILBAKEKREVING===e.type||Xe.TILBAKEKREVING_REVURDERING===e.type,S=D=>{const I=D.aksjonspunktGodkjenning.map(f=>({aksjonspunktKode:f.aksjonspunktKode,godkjent:!!f.totrinnskontrollGodkjent,begrunnelse:f.besluttersBegrunnelse,arsaker:_o(f)})),A=v?xr.FATTER_VEDTAK:F.FATTER_VEDTAK;return t({fatterVedtakAksjonspunktDto:{"@type":A,kode:A,begrunnelse:void 0,aksjonspunktGodkjenningDtos:I},erAlleAksjonspunktGodkjent:D.aksjonspunktGodkjenning.every(f=>f.totrinnskontrollGodkjent)})},u=e?e.behandlingÅrsaker.map(({behandlingArsakType:D})=>D).some(D=>D===En.ETTER_KLAGE||D===En.KLAGE_U_INNTK||D===En.KLAGE_M_INNTK):!1,K=v?mo.flatMap(D=>{const I=e.totrinnskontrollÅrsaker.find(A=>A.skjermlenkeType===D.kode);return I?[I]:[]}):e.totrinnskontrollÅrsaker,c=D=>s(a,D),b=e.status===Nn.FATTER_VEDTAK,_=i.SkjermlenkeType,V=i.VurderÅrsak,m=No(i);return g.jsxs(Va,{value:Ro,children:[b&&g.jsx(Ta,{behandling:e,totrinnskontrollSkjermlenkeContext:K,readOnly:r,onSubmit:S,forhandsvisVedtaksbrev:l,erForeldrepengerFagsak:n===Bn.FORELDREPENGER,skjemalenkeTyper:_,erBehandlingEtterKlage:u,faktaOmBeregningTilfeller:m,erTilbakekreving:v,lagLenke:c,beslutterFormData:R,setBeslutterFormData:T}),!b&&g.jsx(ga,{behandling:e,totrinnskontrollSkjermlenkeContext:K,erForeldrepengerFagsak:n===Bn.FORELDREPENGER,erTilbakekreving:v,skjemalenkeTyper:_,lagLenke:c,vurderArsaker:V,faktaOmBeregningTilfeller:m})]})};Aa.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
}`,...kn.parameters?.docs?.source}}};const Oo=["ForBeslutter","ForSaksbehandler"];export{dn as ForBeslutter,kn as ForSaksbehandler,Oo as __namedExportsOrder,Lo as default};
