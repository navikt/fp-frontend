...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const zn={title:"sak/sak-totrinnskontroll-fatter-vedtak-modal",component:qe,args:{closeEvent:Qe("button-click")}},P={args:{behandling:{uuid:"1",status:M.FATTER_VEDTAK,type:k.FORSTEGANGSSOKNAD},allAksjonspunktApproved:!0}},N={args:{behandling:{uuid:"1",status:M.FATTER_VEDTAK,type:k.FORSTEGANGSSOKNAD,behandlingsresultat:{type:S.OPPHOR}},allAksjonspunktApproved:!0}},F={args:{behandling:{uuid:"1",status:M.FATTER_VEDTAK,type:k.KLAGE,behandlingsresultat:{type:S.OPPHOR}},allAksjonspunktApproved:!0}},V={args:{behandling:{uuid:"1",status:M.FATTER_VEDTAK,type:k.FORSTEGANGSSOKNAD,behandlingsresultat:{type:S.OPPHOR}},allAksjonspunktApproved:!1}};var ie,se,le;P.parameters={...P.parameters,docs:{...(ie=P.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    behandling: {
      uuid: '1',
...
}`,...(me=(pe=F.parameters)==null?void 0:pe.docs)==null?void 0:me.source}}};var fe,ke,be;V.parameters={...V.parameters,docs:{...(fe=V.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  args: {
    behandling: {
      uuid: '1',
      status: BehandlingStatus.FATTER_VEDTAK,
...
}`,...(be=(ke=V.parameters)==null?void 0:ke.docs)==null?void 0:be.source}}};const Un=["EtterFatterVedtakOgGodkjent","EtterGodkjenning","EtterGodkjenningAvKlage","EtterTilbakesendingTilSaksbehandler"];export{P as EtterFatterVedtakOgGodkjent,N as EtterGodkjenning,F as EtterGodkjenningAvKlage,V as EtterTilbakesendingTilSaksbehandler,Un as __namedExportsOrder,zn as default};
