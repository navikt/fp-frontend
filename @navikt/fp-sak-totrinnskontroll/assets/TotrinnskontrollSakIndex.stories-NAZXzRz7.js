...
| 'FAKTA_OM_UTTAK_DOKUMENTASJON'
| 'FAKTA_UTTAK'
| 'FAKTA_UTTAK_EØS'`,elements:[{name:"literal",value:"'ANKE_MERKNADER'"},{name:"literal",value:"'ANKE_VURDERING'"},{name:"literal",value:"'BEREGNING_ENGANGSSTOENAD'"},{name:"literal",value:"'BEREGNING_FORELDREPENGER'"},{name:"literal",value:"'BESTEBEREGNING'"},{name:"literal",value:"'FAKTA_FOR_OMSORG'"},{name:"literal",value:"'FAKTA_FOR_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_ADOPSJON'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON'"},{name:"literal",value:"'FAKTA_OM_BEREGNING'"},{name:"literal",value:"'FAKTA_OM_FOEDSEL'"},{name:"literal",value:"'FAKTA_OM_FORDELING'"},{name:"literal",value:"'FAKTA_OM_MEDLEMSKAP'"},{name:"literal",value:"'FAKTA_OM_OMSORG_OG_FORELDREANSVAR'"},{name:"literal",value:"'FAKTA_OM_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_SIMULERING'"},{name:"literal",value:"'FAKTA_OM_UTTAK'"},{name:"literal",value:"'FAKTA_OM_AKTIVITETSKRAV'"},{name:"literal",value:"'FAKTA_OMSORG_OG_RETT'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'FORMKRAV_KLAGE_KA'"},{name:"literal",value:"'FORMKRAV_KLAGE_NFP'"},{name:"literal",value:"'KLAGE_BEH_NFP'"},{name:"literal",value:"'KLAGE_BEH_NK'"},{name:"literal",value:"'KONTROLL_AV_SAKSOPPLYSNINGER'"},{name:"literal",value:"'OPPLYSNINGSPLIKT'"},{name:"literal",value:"'PUNKT_FOR_ADOPSJON'"},{name:"literal",value:"'PUNKT_FOR_FOEDSEL'"},{name:"literal",value:"'PUNKT_FOR_FORELDREANSVAR'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP_LØPENDE'"},{name:"literal",value:"'PUNKT_FOR_OMSORG'"},{name:"literal",value:"'PUNKT_FOR_OPPTJENING'"},{name:"literal",value:"'PUNKT_FOR_SVANGERSKAPSPENGER'"},{name:"literal",value:"'PUNKT_FOR_SVP_INNGANG'"},{name:"literal",value:"'SOEKNADSFRIST'"},{name:"literal",value:"'TILKJENT_YTELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'UTLAND'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'VURDER_FARESIGNALER'"},{name:"literal",value:"'FAKTA_OM_UTTAK_DOKUMENTASJON'"},{name:"literal",value:"'FAKTA_UTTAK'"},{name:"literal",value:"'FAKTA_UTTAK_EØS'"}]},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const _E=he(yl),NE=[ra.FAKTA_OM_FEILUTBETALING,ra.FORELDELSE,ra.TILBAKEKREVING,ra.VEDTAK],AE=e=>{const l=new Array;return e.feilFakta&&l.push("FEIL_FAKTA"),e.feilLov&&l.push("FEIL_LOV"),e.feilSkjønn&&l.push("SKJØNN"),e.feilUtredning&&l.push("UTREDNING"),e.feilSaksflyt&&l.push("SAKSFLYT"),e.feilBegrunnelse&&l.push("BEGRUNNELSE"),l},dE=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Tl=({behandling:e,location:l,fagsakYtelseType:a,readOnly:n,onSubmit:r,forhandsvisVedtaksbrev:t,alleKodeverk:i,createLocationForSkjermlenke:o,beslutterFormData:d,setBeslutterFormData:A})=>{const R=e.type==="BT-007"||e.type==="BT-009",m=D=>{const f=D.aksjonspunktGodkjenning.map(g=>({aksjonspunktKode:g.aksjonspunktKode,godkjent:!!g.totrinnskontrollGodkjent,begrunnelse:g.besluttersBegrunnelse,arsaker:AE(g)})),_=R?"5005":V.FATTER_VEDTAK;return r({fatterVedtakAksjonspunktDto:{"@type":_,kode:_,begrunnelse:void 0,aksjonspunktGodkjenningDtos:f},erAlleAksjonspunktGodkjent:D.aksjonspunktGodkjenning.every(g=>g.totrinnskontrollGodkjent)})},s=e.behandlingÅrsaker.map(({behandlingArsakType:D})=>D).some(D=>D==="ETTER_KLAGE"||D==="RE-KLAG-U-INNTK"||D==="RE-KLAG-M-INNTK"),F=R?NE.flatMap(D=>{const f=e.totrinnskontrollÅrsaker.find(_=>_.skjermlenkeType===D?.kode);return f?[f]:[]}):e.totrinnskontrollÅrsaker,P=D=>o(l,D),y=e.status==="FVED",k=i.SkjermlenkeType,p=i.VurderÅrsak,K=dE(i);return N.jsxs(Dl,{value:_E,children:[y&&N.jsx(il,{behandling:e,totrinnskontrollSkjermlenkeContext:F,readOnly:n,onSubmit:m,forhandsvisVedtaksbrev:t,erForeldrepengerFagsak:a==="FP",skjemalenkeTyper:k,erBehandlingEtterKlage:s,faktaOmBeregningTilfeller:K,erTilbakekreving:R,lagLenke:P,beslutterFormData:d,setBeslutterFormData:A}),!y&&N.jsx(ol,{behandling:e,totrinnskontrollSkjermlenkeContext:F,erForeldrepengerFagsak:a==="FP",erTilbakekreving:R,skjemalenkeTyper:k,lagLenke:P,vurderArsaker:p,faktaOmBeregningTilfeller:K})]})};Tl.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
