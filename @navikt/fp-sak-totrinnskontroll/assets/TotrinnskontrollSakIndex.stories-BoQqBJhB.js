...
`&&(w.value+=" ");const x=U.boxSizing,c=dn(U.paddingBottom)+dn(U.paddingTop),M=dn(U.borderBottomWidth)+dn(U.borderTopWidth),B=w.scrollHeight-c;w.value="x";const Y=w.scrollHeight-c;let H=B;s&&(H=Math.max(Number(s)*Y,H)),i&&(H=Math.min(Number(i)*Y,H)),H=Math.max(H,Y);const ee=H+(x==="border-box"?c+M:0),le=Math.abs(H-B)<=1;return{outerHeightStyle:ee,overflow:le}},[i,s,N.placeholder]),F=()=>{const L=f();kr(L)||A(h=>ir(h,L,_))};lr(()=>{const L=()=>{const c=f();kr(c)||Ma.flushSync(()=>{A(M=>ir(M,c,_))})},h=Cr(()=>{var c,M,B;if(_.current=0,!((c=K.current)===null||c===void 0)&&c.style.height||!((M=K.current)===null||M===void 0)&&M.style.width){((B=K.current)===null||B===void 0?void 0:B.style.overflow)==="hidden"&&A(Y=>Object.assign(Object.assign({},Y),{overflow:!1}));return}L()},166,!0),U=K.current,w=dr(U);w.addEventListener("resize",h);let x;return typeof ResizeObserver<"u"&&(x=new ResizeObserver(h),x.observe(U)),()=>{h.clear(),w.removeEventListener("resize",h),x&&x.disconnect()}},[f]),lr(()=>{F()}),P.useEffect(()=>{_.current=0},[v]);const E=L=>{_.current=0,T||F(),o&&o(L)},O=Object.assign({"--__ac-textarea-height":V.outerHeightStyle+"px","--__axc-textarea-height":V.outerHeightStyle+"px",overflow:V.overflow&&!m&&!(!((n=K.current)===null||n===void 0)&&n.style.height)&&!(!((r=K.current)===null||r===void 0)&&r.style.width)?"hidden":void 0},g);return u.createElement(u.Fragment,null,u.createElement("textarea",Object.assign({value:v,onChange:E,ref:G,rows:s,style:O},N,{className:t})),u.createElement("textarea",{"aria-hidden":!0,className:t,readOnly:!0,ref:I,tabIndex:-1,style:Object.assign({visibility:"hidden",position:"absolute",overflow:"hidden",height:0,top:0,left:0,transform:"translateZ(0)"},g)}))});function kr(e){return e==null||Object.keys(e).length===0||e.outerHeightStyle===0&&!e.overflow}const ft=({maxLengthId:e,maxLength:a,currentLength:n,size:r,i18n:t})=>{const{cn:o}=Ae(),i=Br("Textarea",{charsLeft:t?.counterLeft?`{chars} ${t.counterLeft}`:void 0,charsTooMany:t?.counterTooMuch?`{chars} ${t.counterTooMuch}`:void 0}),s=a-n,[m,g]=P.useState(s);return P.useEffect(()=>{const v=Cr(()=>{g(s)},2e3);return v(),()=>{v.clear()}},[s]),u.createElement(u.Fragment,null,u.createElement("span",{id:e,className:o("navds-sr-only")},i("maxLength",{maxLength:a})),s<20&&u.createElement("span",{role:"status",className:o("navds-textarea__sr-counter navds-sr-only")},Er(m,i)),u.createElement(ue,{className:o("navds-textarea__counter",{"navds-textarea__counter--error":s<0}),size:r},Er(s,i)))},Er=(e,a)=>e<0?a("charsTooMany",{chars:Math.abs(e)}):a("charsLeft",{chars:e});var Lt=function(e,a){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&a.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var t=0,r=Object.getOwnPropertySymbols(e);t<r.length;t++)a.indexOf(r[t])<0&&Object.prototype.propertyIsEnumerable.call(e,r[t])&&(n[r[t]]=e[r[t]]);return n};const Ot=P.forwardRef((e,a)=>{var n,r,t;const{inputProps:o,errorId:i,showErrorMsg:s,hasError:m,size:g,inputDescriptionId:v}=Sn(e,"textarea"),{label:N,className:T,description:K,maxLength:G,hideLabel:I=!1,resize:_,UNSAFE_autoScrollbar:V,i18n:A,readOnly:f}=e,F=Lt(e,["label","className","description","maxLength","hideLabel","resize","UNSAFE_autoScrollbar","i18n","readOnly"]),{cn:E}=Ae(),O=Be(),L=G!==void 0&&G>0,[h,U]=P.useState((n=e?.defaultValue)!==null&&n!==void 0?n:""),w=()=>{let c=F?.minRows?F?.minRows:3;return g==="small"&&(c=F?.minRows?F?.minRows:2),c},x=$n(o["aria-describedby"],{[O??""]:L});return u.createElement("div",{className:E(T,"navds-form-field",`navds-form-field--${g}`,{"navds-form-field--disabled":!!o.disabled,"navds-form-field--readonly":f,"navds-textarea--readonly":f,"navds-textarea--error":m,"navds-textarea--autoscrollbar":V,[`navds-textarea--resize-${_===!0?"both":_}`]:_})},u.createElement(pn,{htmlFor:o.id,size:g,className:E("navds-form-field__label",{"navds-sr-only":I})},f&&u.createElement(wr,null),N),!!K&&u.createElement(ue,{className:E("navds-form-field__description",{"navds-sr-only":I}),id:v,size:g,as:"div"},K),u.createElement(Kt,Object.assign({},pe(F,["error","errorId","size"]),o,{onChange:ha(e.onChange,e.value===void 0?c=>U(c.target.value):void 0),minRows:w(),autoScrollbar:V,ref:a,readOnly:f,className:E("navds-textarea__input","navds-body-short",`navds-body-short--${g??"medium"}`)},x?{"aria-describedby":x}:{})),L&&!f&&!o.disabled&&u.createElement(ft,{maxLengthId:O,maxLength:G,currentLength:(t=(r=e.value)===null||r===void 0?void 0:r.length)!==null&&t!==void 0?t:h.length,size:g,i18n:A}),u.createElement("div",{className:E("navds-form-field__error"),id:i,"aria-relevant":"additions removals","aria-live":"polite"},s&&u.createElement(Kn,{size:g,showIcon:!0},e.error)))});var nn=e=>e.type==="checkbox",Fe=e=>e instanceof Date,oe=e=>e==null;const Wr=e=>typeof e=="object";var Q=e=>!oe(e)&&!Array.isArray(e)&&Wr(e)&&!Fe(e),Zr=e=>Q(e)&&e.target?nn(e.target)?e.target.checked:e.target.value:e,Dt=e=>e.substring(0,e.search(/\.\d+(\.|$)/))||e,Xr=(e,a)=>e.has(Dt(a)),bt=e=>{const a=e.constructor&&e.constructor.prototype;return Q(a)&&a.hasOwnProperty("isPrototypeOf")},zn=typeof window<"u"&&typeof window.HTMLElement<"u"&&typeof document<"u";function W(e){let a;const n=Array.isArray(e),r=typeof FileList<"u"?e instanceof FileList:!1;if(e instanceof Date)a=new Date(e);else if(!(zn&&(e instanceof Blob||r))&&(n||Q(e)))if(a=n?[]:{},!n&&!bt(e))a=e;else for(const t in e)e.hasOwnProperty(t)&&(a[t]=W(e[t]));else return e;return a}var fn=e=>/^\w*$/.test(e),Z=e=>e===void 0,Ln=e=>Array.isArray(e)?e.filter(Boolean):[],Wn=e=>Ln(e.replace(/["|']|\]/g,"").split(/\.|\[/)),S=(e,a,n)=>{if(!a||!Q(e))return n;const r=(fn(a)?[a]:Wn(a)).reduce((t,o)=>oe(t)?t:t[o],e);return Z(r)||r===e?Z(e[a])?n:e[a]:r},de=e=>typeof e=="boolean",J=(e,a,n)=>{let r=-1;const t=fn(a)?[a]:Wn(a),o=t.length,i=o-1;for(;++r<o;){const s=t[r];let m=n;if(r!==i){const g=e[s];m=Q(g)||Array.isArray(g)?g:isNaN(+t[r+1])?{}:[]}if(s==="__proto__"||s==="constructor"||s==="prototype")return;e[s]=m,e=e[s]}};const gn={BLUR:"blur",FOCUS_OUT:"focusout",CHANGE:"change"},Ee={onBlur:"onBlur",onChange:"onChange",onSubmit:"onSubmit",onTouched:"onTouched",all:"all"},_e={max:"max",min:"min",maxLength:"maxLength",minLength:"minLength",pattern:"pattern",required:"required",validate:"validate"},Zn=u.createContext(null);Zn.displayName="HookFormContext";const Re=()=>u.useContext(Zn),Ft=e=>{const{children:a,...n}=e;return u.createElement(Zn.Provider,{value:n},a)};var Qr=(e,a,n,r=!0)=>{const t={defaultValues:a._defaultValues};for(const o in e)Object.defineProperty(t,o,{get:()=>{const i=o;return a._proxyFormState[i]!==Ee.all&&(a._proxyFormState[i]=!r||Ee.all),n&&(n[i]=!0),e[i]}});return t};const On=typeof window<"u"?u.useLayoutEffect:u.useEffect;function It(e){const a=Re(),{control:n=a.control,disabled:r,name:t,exact:o}=e||{},[i,s]=u.useState(n._formState),m=u.useRef({isDirty:!1,isLoading:!1,dirtyFields:!1,touchedFields:!1,validatingFields:!1,isValidating:!1,isValid:!1,errors:!1});return On(()=>n._subscribe({name:t,formState:m.current,exact:o,callback:g=>{!r&&s({...n._formState,...g})}}),[t,r,o]),u.useEffect(()=>{m.current.isValid&&n._setValid(!0)},[n]),u.useMemo(()=>Qr(i,n,m.current,!1),[i,n])}var ge=e=>typeof e=="string",ea=(e,a,n,r,t)=>ge(e)?(r&&a.watch.add(e),S(n,e,t)):Array.isArray(e)?e.map(o=>(r&&a.watch.add(o),S(n,o))):(r&&(a.watchAll=!0),n),Yn=e=>oe(e)||!Wr(e);function ye(e,a,n=new WeakSet){if(Yn(e)||Yn(a))return e===a;if(Fe(e)&&Fe(a))return e.getTime()===a.getTime();const r=Object.keys(e),t=Object.keys(a);if(r.length!==t.length)return!1;if(n.has(e)||n.has(a))return!0;n.add(e),n.add(a);for(const o of r){const i=e[o];if(!t.includes(o))return!1;if(o!=="ref"){const s=a[o];if(Fe(i)&&Fe(s)||Q(i)&&Q(s)||Array.isArray(i)&&Array.isArray(s)?!ye(i,s,n):i!==s)return!1}}return!0}function Vt(e){const a=Re(),{control:n=a.control,name:r,defaultValue:t,disabled:o,exact:i,compute:s}=e||{},m=u.useRef(t),g=u.useRef(s),v=u.useRef(void 0);g.current=s;const N=u.useMemo(()=>n._getWatch(r,m.current),[n,r]),[T,K]=u.useState(g.current?g.current(N):N);return On(()=>n._subscribe({name:r,formState:{values:!0},exact:i,callback:G=>{if(!o){const I=ea(r,n._names,G.values||n._formValues,!1,m.current);if(g.current){const _=g.current(I);ye(_,v.current)||(K(_),v.current=_)}else K(I)}}}),[n,o,r,i]),u.useEffect(()=>n._removeUnmounted()),T}function Xn(e){const a=Re(),{name:n,disabled:r,control:t=a.control,shouldUnregister:o,defaultValue:i}=e,s=Xr(t._names.array,n),m=u.useMemo(()=>S(t._formValues,n,S(t._defaultValues,n,i)),[t,n,i]),g=Vt({control:t,name:n,defaultValue:m,exact:!0}),v=It({control:t,name:n,exact:!0}),N=u.useRef(e),T=u.useRef(t.register(n,{...e.rules,value:g,...de(e.disabled)?{disabled:e.disabled}:{}}));N.current=e;const K=u.useMemo(()=>Object.defineProperties({},{invalid:{enumerable:!0,get:()=>!!S(v.errors,n)},isDirty:{enumerable:!0,get:()=>!!S(v.dirtyFields,n)},isTouched:{enumerable:!0,get:()=>!!S(v.touchedFields,n)},isValidating:{enumerable:!0,get:()=>!!S(v.validatingFields,n)},error:{enumerable:!0,get:()=>S(v.errors,n)}}),[v,n]),G=u.useCallback(A=>T.current.onChange({target:{value:Zr(A),name:n},type:gn.CHANGE}),[n]),I=u.useCallback(()=>T.current.onBlur({target:{value:S(t._formValues,n),name:n},type:gn.BLUR}),[n,t._formValues]),_=u.useCallback(A=>{const f=S(t._fields,n);f&&A&&(f._f.ref={focus:()=>A.focus&&A.focus(),select:()=>A.select&&A.select(),setCustomValidity:F=>A.setCustomValidity(F),reportValidity:()=>A.reportValidity()})},[t._fields,n]),V=u.useMemo(()=>({name:n,value:g,...de(r)||v.disabled?{disabled:v.disabled||r}:{},onChange:G,onBlur:I,ref:_}),[n,r,v.disabled,G,I,_,g]);return u.useEffect(()=>{const A=t._options.shouldUnregister||o;t.register(n,{...N.current.rules,...de(N.current.disabled)?{disabled:N.current.disabled}:{}});const f=(F,E)=>{const O=S(t._fields,F);O&&O._f&&(O._f.mount=E)};if(f(n,!0),A){const F=W(S(t._options.defaultValues,n));J(t._defaultValues,n,F),Z(S(t._formValues,n))&&J(t._formValues,n,F)}return!s&&t.register(n),()=>{(s?A&&!t._state.action:A)?t.unregister(n):f(n,!1)}},[n,t,s,o]),u.useEffect(()=>{t._setDisabledField({disabled:r,name:n})},[r,n,t]),u.useMemo(()=>({field:V,formState:v,fieldState:K}),[V,v,K])}var ct=(e,a,n,r,t)=>a?{...n[e],types:{...n[e]&&n[e].types?n[e].types:{},[r]:t||!0}}:{},ie=e=>Array.isArray(e)?e:[e],ur=()=>{let e=[];return{get observers(){return e},next:t=>{for(const o of e)o.next&&o.next(t)},subscribe:t=>(e.push(t),{unsubscribe:()=>{e=e.filter(o=>o!==t)}}),unsubscribe:()=>{e=[]}}},re=e=>Q(e)&&!Object.keys(e).length,Qn=e=>e.type==="file",ve=e=>typeof e=="function",An=e=>{if(!zn)return!1;const a=e?e.ownerDocument:0;return e instanceof(a&&a.defaultView?a.defaultView.HTMLElement:HTMLElement)},na=e=>e.type==="select-multiple",er=e=>e.type==="radio",Gt=e=>er(e)||nn(e),Vn=e=>An(e)&&e.isConnected;function Pt(e,a){const n=a.slice(0,-1).length;let r=0;for(;r<n;)e=Z(e)?r++:e[a[r++]];return e}function jt(e){for(const a in e)if(e.hasOwnProperty(a)&&!Z(e[a]))return!1;return!0}function X(e,a){const n=Array.isArray(a)?a:fn(a)?[a]:Wn(a),r=n.length===1?e:Pt(e,n),t=n.length-1,o=n[t];return r&&delete r[o],t!==0&&(Q(r)&&re(r)||Array.isArray(r)&&jt(r))&&X(e,n.slice(0,-1)),e}var ra=e=>{for(const a in e)if(ve(e[a]))return!0;return!1};function Rn(e,a={}){const n=Array.isArray(e);if(Q(e)||n)for(const r in e)Array.isArray(e[r])||Q(e[r])&&!ra(e[r])?(a[r]=Array.isArray(e[r])?[]:{},Rn(e[r],a[r])):oe(e[r])||(a[r]=!0);return a}function aa(e,a,n){const r=Array.isArray(e);if(Q(e)||r)for(const t in e)Array.isArray(e[t])||Q(e[t])&&!ra(e[t])?Z(a)||Yn(n[t])?n[t]=Array.isArray(e[t])?Rn(e[t],[]):{...Rn(e[t])}:aa(e[t],oe(a)?{}:a[t],n[t]):n[t]=!ye(e[t],a[t]);return n}var ze=(e,a)=>aa(e,a,Rn(a));const vr={value:!1,isValid:!1},Tr={value:!0,isValid:!0};var ta=e=>{if(Array.isArray(e)){if(e.length>1){const a=e.filter(n=>n&&n.checked&&!n.disabled).map(n=>n.value);return{value:a,isValid:!!a.length}}return e[0].checked&&!e[0].disabled?e[0].attributes&&!Z(e[0].attributes.value)?Z(e[0].value)||e[0].value===""?Tr:{value:e[0].value,isValid:!0}:Tr:vr}return vr},oa=(e,{valueAsNumber:a,valueAsDate:n,setValueAs:r})=>Z(e)?e:a?e===""?NaN:e&&+e:n&&ge(e)?new Date(e):r?r(e):e;const gr={isValid:!1,value:null};var la=e=>Array.isArray(e)?e.reduce((a,n)=>n&&n.checked&&!n.disabled?{isValid:!0,value:n.value}:a,gr):gr;function Ar(e){const a=e.ref;return Qn(a)?a.files:er(a)?la(e.refs).value:na(a)?[...a.selectedOptions].map(({value:n})=>n):nn(a)?ta(e.refs).value:oa(Z(a.value)?e.ref.value:a.value,e)}var Mt=(e,a,n,r)=>{const t={};for(const o of e){const i=S(a,o);i&&J(t,o,i._f)}return{criteriaMode:n,names:[...e],fields:t,shouldUseNativeValidation:r}},mn=e=>e instanceof RegExp,We=e=>Z(e)?e:mn(e)?e.source:Q(e)?mn(e.value)?e.value.source:e.value:e,he=e=>({isOnSubmit:!e||e===Ee.onSubmit,isOnBlur:e===Ee.onBlur,isOnChange:e===Ee.onChange,isOnAll:e===Ee.all,isOnTouch:e===Ee.onTouched});const Rr="AsyncFunction";var ht=e=>!!e&&!!e.validate&&!!(ve(e.validate)&&e.validate.constructor.name===Rr||Q(e.validate)&&Object.values(e.validate).find(a=>a.constructor.name===Rr)),Ut=e=>e.mount&&(e.required||e.min||e.max||e.maxLength||e.minLength||e.pattern||e.validate),xn=(e,a,n)=>!n&&(a.watchAll||a.watch.has(e)||[...a.watch].some(r=>e.startsWith(r)&&/^\.\w+/.test(e.slice(r.length))));const Ue=(e,a,n,r)=>{for(const t of n||Object.keys(e)){const o=S(e,t);if(o){const{_f:i,...s}=o;if(i){if(i.refs&&i.refs[0]&&a(i.refs[0],t)&&!r)return!0;if(i.ref&&a(i.ref,i.name)&&!r)return!0;if(Ue(s,a))break}else if(Q(s)&&Ue(s,a))break}}};function mr(e,a,n){const r=S(e,n);if(r||fn(n))return{error:r,name:n};const t=n.split(".");for(;t.length;){const o=t.join("."),i=S(a,o),s=S(e,o);if(i&&!Array.isArray(i)&&n!==o)return{name:n};if(s&&s.type)return{name:o,error:s};if(s&&s.root&&s.root.type)return{name:`${o}.root`,error:s.root};t.pop()}return{name:n}}var Bt=(e,a,n,r)=>{n(e);const{name:t,...o}=e;return re(o)||Object.keys(o).length>=Object.keys(a).length||Object.keys(o).find(i=>a[i]===(!r||Ee.all))},qt=(e,a,n)=>!e||!a||e===a||ie(e).some(r=>r&&(n?r===a:r.startsWith(a)||a.startsWith(r))),wt=(e,a,n,r,t)=>t.isOnAll?!1:!n&&t.isOnTouch?!(a||e):(n?r.isOnBlur:t.isOnBlur)?!e:(n?r.isOnChange:t.isOnChange)?e:!0,Ht=(e,a)=>!Ln(S(e,a)).length&&X(e,a),sa=(e,a,n)=>{const r=ie(S(e,n));return J(r,"root",a[n]),J(e,n,r),e},vn=e=>ge(e);function _r(e,a,n="validate"){if(vn(e)||Array.isArray(e)&&e.every(vn)||de(e)&&!e)return{type:n,message:vn(e)?e:"",ref:a}}var je=e=>Q(e)&&!mn(e)?e:{value:e,message:""},Cn=async(e,a,n,r,t,o)=>{const{ref:i,refs:s,required:m,maxLength:g,minLength:v,min:N,max:T,pattern:K,validate:G,name:I,valueAsNumber:_,mount:V}=e._f,A=S(n,I);if(!V||a.has(I))return{};const f=s?s[0]:i,F=c=>{t&&f.reportValidity&&(f.setCustomValidity(de(c)?"":c||""),f.reportValidity())},E={},O=er(i),L=nn(i),h=O||L,U=(_||Qn(i))&&Z(i.value)&&Z(A)||An(i)&&i.value===""||A===""||Array.isArray(A)&&!A.length,w=ct.bind(null,I,r,E),x=(c,M,B,Y=_e.maxLength,H=_e.minLength)=>{const ee=c?M:B;E[I]={type:c?Y:H,message:ee,ref:i,...w(c?Y:H,ee)}};if(o?!Array.isArray(A)||!A.length:m&&(!h&&(U||oe(A))||de(A)&&!A||L&&!ta(s).isValid||O&&!la(s).isValid)){const{value:c,message:M}=vn(m)?{value:!!m,message:m}:je(m);if(c&&(E[I]={type:_e.required,message:M,ref:f,...w(_e.required,M)},!r))return F(M),E}if(!U&&(!oe(N)||!oe(T))){let c,M;const B=je(T),Y=je(N);if(!oe(A)&&!isNaN(A)){const H=i.valueAsNumber||A&&+A;oe(B.value)||(c=H>B.value),oe(Y.value)||(M=H<Y.value)}else{const H=i.valueAsDate||new Date(A),ee=me=>new Date(new Date().toDateString()+" "+me),le=i.type=="time",se=i.type=="week";ge(B.value)&&A&&(c=le?ee(A)>ee(B.value):se?A>B.value:H>new Date(B.value)),ge(Y.value)&&A&&(M=le?ee(A)<ee(Y.value):se?A<Y.value:H<new Date(Y.value))}if((c||M)&&(x(!!c,B.message,Y.message,_e.max,_e.min),!r))return F(E[I].message),E}if((g||v)&&!U&&(ge(A)||o&&Array.isArray(A))){const c=je(g),M=je(v),B=!oe(c.value)&&A.length>+c.value,Y=!oe(M.value)&&A.length<+M.value;if((B||Y)&&(x(B,c.message,M.message),!r))return F(E[I].message),E}if(K&&!U&&ge(A)){const{value:c,message:M}=je(K);if(mn(c)&&!A.match(c)&&(E[I]={type:_e.pattern,message:M,ref:i,...w(_e.pattern,M)},!r))return F(M),E}if(G){if(ve(G)){const c=await G(A,n),M=_r(c,f);if(M&&(E[I]={...M,...w(_e.validate,M.message)},!r))return F(M.message),E}else if(Q(G)){let c={};for(const M in G){if(!re(c)&&!r)break;const B=_r(await G[M](A,n),f,M);B&&(c={...B,...w(M,B.message)},F(B.message),r&&(E[I]=c))}if(!re(c)&&(E[I]={ref:f,...c},!r))return E}}return F(!0),E};const Yt={mode:Ee.onSubmit,reValidateMode:Ee.onChange,shouldFocusError:!0};function xt(e={}){let a={...Yt,...e},n={submitCount:0,isDirty:!1,isReady:!1,isLoading:ve(a.defaultValues),isValidating:!1,isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,touchedFields:{},dirtyFields:{},validatingFields:{},errors:a.errors||{},disabled:a.disabled||!1},r={},t=Q(a.defaultValues)||Q(a.values)?W(a.defaultValues||a.values)||{}:{},o=a.shouldUnregister?{}:W(t),i={action:!1,mount:!1,watch:!1},s={mount:new Set,disabled:new Set,unMount:new Set,array:new Set,watch:new Set},m,g=0;const v={isDirty:!1,dirtyFields:!1,validatingFields:!1,touchedFields:!1,isValidating:!1,isValid:!1,errors:!1};let N={...v};const T={array:ur(),state:ur()},K=a.criteriaMode===Ee.all,G=l=>d=>{clearTimeout(g),g=setTimeout(l,d)},I=async l=>{if(!a.disabled&&(v.isValid||N.isValid||l)){const d=a.resolver?re((await L()).errors):await U(r,!0);d!==n.isValid&&T.state.next({isValid:d})}},_=(l,d)=>{!a.disabled&&(v.isValidating||v.validatingFields||N.isValidating||N.validatingFields)&&((l||Array.from(s.mount)).forEach(k=>{k&&(d?J(n.validatingFields,k,d):X(n.validatingFields,k))}),T.state.next({validatingFields:n.validatingFields,isValidating:!re(n.validatingFields)}))},V=(l,d=[],k,D,p=!0,y=!0)=>{if(D&&k&&!a.disabled){if(i.action=!0,y&&Array.isArray(S(r,l))){const j=k(S(r,l),D.argA,D.argB);p&&J(r,l,j)}if(y&&Array.isArray(S(n.errors,l))){const j=k(S(n.errors,l),D.argA,D.argB);p&&J(n.errors,l,j),Ht(n.errors,l)}if((v.touchedFields||N.touchedFields)&&y&&Array.isArray(S(n.touchedFields,l))){const j=k(S(n.touchedFields,l),D.argA,D.argB);p&&J(n.touchedFields,l,j)}(v.dirtyFields||N.dirtyFields)&&(n.dirtyFields=ze(t,o)),T.state.next({name:l,isDirty:x(l,d),dirtyFields:n.dirtyFields,errors:n.errors,isValid:n.isValid})}else J(o,l,d)},A=(l,d)=>{J(n.errors,l,d),T.state.next({errors:n.errors})},f=l=>{n.errors=l,T.state.next({errors:n.errors,isValid:!1})},F=(l,d,k,D)=>{const p=S(r,l);if(p){const y=S(o,l,Z(k)?S(t,l):k);Z(y)||D&&D.defaultChecked||d?J(o,l,d?y:Ar(p._f)):B(l,y),i.mount&&I()}},E=(l,d,k,D,p)=>{let y=!1,j=!1;const C={name:l};if(!a.disabled){if(!k||D){(v.isDirty||N.isDirty)&&(j=n.isDirty,n.isDirty=C.isDirty=x(),y=j!==C.isDirty);const $=ye(S(t,l),d);j=!!S(n.dirtyFields,l),$?X(n.dirtyFields,l):J(n.dirtyFields,l,!0),C.dirtyFields=n.dirtyFields,y=y||(v.dirtyFields||N.dirtyFields)&&j!==!$}if(k){const $=S(n.touchedFields,l);$||(J(n.touchedFields,l,k),C.touchedFields=n.touchedFields,y=y||(v.touchedFields||N.touchedFields)&&$!==k)}y&&p&&T.state.next(C)}return y?C:{}},O=(l,d,k,D)=>{const p=S(n.errors,l),y=(v.isValid||N.isValid)&&de(d)&&n.isValid!==d;if(a.delayError&&k?(m=G(()=>A(l,k)),m(a.delayError)):(clearTimeout(g),m=null,k?J(n.errors,l,k):X(n.errors,l)),(k?!ye(p,k):p)||!re(D)||y){const j={...D,...y&&de(d)?{isValid:d}:{},errors:n.errors,name:l};n={...n,...j},T.state.next(j)}},L=async l=>{_(l,!0);const d=await a.resolver(o,a.context,Mt(l||s.mount,r,a.criteriaMode,a.shouldUseNativeValidation));return _(l),d},h=async l=>{const{errors:d}=await L(l);if(l)for(const k of l){const D=S(d,k);D?J(n.errors,k,D):X(n.errors,k)}else n.errors=d;return d},U=async(l,d,k={valid:!0})=>{for(const D in l){const p=l[D];if(p){const{_f:y,...j}=p;if(y){const C=s.array.has(y.name),$=p._f&&ht(p._f);$&&v.validatingFields&&_([D],!0);const ke=await Cn(p,s.disabled,o,K,a.shouldUseNativeValidation&&!d,C);if($&&v.validatingFields&&_([D]),ke[y.name]&&(k.valid=!1,d))break;!d&&(S(ke,y.name)?C?sa(n.errors,ke,y.name):J(n.errors,y.name,ke[y.name]):X(n.errors,y.name))}!re(j)&&await U(j,d,k)}}return k.valid},w=()=>{for(const l of s.unMount){const d=S(r,l);d&&(d._f.refs?d._f.refs.every(k=>!Vn(k)):!Vn(d._f.ref))&&Ye(l)}s.unMount=new Set},x=(l,d)=>!a.disabled&&(l&&d&&J(o,l,d),!ye(me(),t)),c=(l,d,k)=>ea(l,s,{...i.mount?o:Z(d)?t:ge(l)?{[l]:d}:d},k,d),M=l=>Ln(S(i.mount?o:t,l,a.shouldUnregister?S(t,l,[]):[])),B=(l,d,k={})=>{const D=S(r,l);let p=d;if(D){const y=D._f;y&&(!y.disabled&&J(o,l,oa(d,y)),p=An(y.ref)&&oe(d)?"":d,na(y.ref)?[...y.ref.options].forEach(j=>j.selected=p.includes(j.value)):y.refs?nn(y.ref)?y.refs.forEach(j=>{(!j.defaultChecked||!j.disabled)&&(Array.isArray(p)?j.checked=!!p.find(C=>C===j.value):j.checked=p===j.value||!!p)}):y.refs.forEach(j=>j.checked=j.value===p):Qn(y.ref)?y.ref.value="":(y.ref.value=p,y.ref.type||T.state.next({name:l,values:W(o)})))}(k.shouldDirty||k.shouldTouch)&&E(l,p,k.shouldTouch,k.shouldDirty,!0),k.shouldValidate&&se(l)},Y=(l,d,k)=>{for(const D in d){if(!d.hasOwnProperty(D))return;const p=d[D],y=l+"."+D,j=S(r,y);(s.array.has(l)||Q(p)||j&&!j._f)&&!Fe(p)?Y(y,p,k):B(y,p,k)}},H=(l,d,k={})=>{const D=S(r,l),p=s.array.has(l),y=W(d);J(o,l,y),p?(T.array.next({name:l,values:W(o)}),(v.isDirty||v.dirtyFields||N.isDirty||N.dirtyFields)&&k.shouldDirty&&T.state.next({name:l,dirtyFields:ze(t,o),isDirty:x(l,y)})):D&&!D._f&&!oe(y)?Y(l,y,k):B(l,y,k),xn(l,s)&&T.state.next({...n,name:l}),T.state.next({name:i.mount?l:void 0,values:W(o)})},ee=async l=>{i.mount=!0;const d=l.target;let k=d.name,D=!0;const p=S(r,k),y=$=>{D=Number.isNaN($)||Fe($)&&isNaN($.getTime())||ye($,S(o,k,$))},j=he(a.mode),C=he(a.reValidateMode);if(p){let $,ke;const ln=d.type?Ar(p._f):Zr(l),Ke=l.type===gn.BLUR||l.type===gn.FOCUS_OUT,ma=!Ut(p._f)&&!a.resolver&&!S(n.errors,k)&&!p._f.deps||wt(Ke,S(n.touchedFields,k),n.isSubmitted,C,j),Fn=xn(k,s,Ke);J(o,k,ln),Ke?(p._f.onBlur&&p._f.onBlur(l),m&&m(0)):p._f.onChange&&p._f.onChange(l);const In=E(k,ln,Ke),_a=!re(In)||Fn;if(!Ke&&T.state.next({name:k,type:l.type,values:W(o)}),ma)return(v.isValid||N.isValid)&&(a.mode==="onBlur"?Ke&&I():Ke||I()),_a&&T.state.next({name:k,...Fn?{}:In});if(!Ke&&Fn&&T.state.next({...n}),a.resolver){const{errors:ar}=await L([k]);if(y(ln),D){const Na=mr(n.errors,r,k),tr=mr(ar,r,Na.name||k);$=tr.error,k=tr.name,ke=re(ar)}}else _([k],!0),$=(await Cn(p,s.disabled,o,K,a.shouldUseNativeValidation))[k],_([k]),y(ln),D&&($?ke=!1:(v.isValid||N.isValid)&&(ke=await U(r,!0)));D&&(p._f.deps&&se(p._f.deps),O(k,ke,$,In))}},le=(l,d)=>{if(S(n.errors,d)&&l.focus)return l.focus(),1},se=async(l,d={})=>{let k,D;const p=ie(l);if(a.resolver){const y=await h(Z(l)?l:p);k=re(y),D=l?!p.some(j=>S(y,j)):k}else l?(D=(await Promise.all(p.map(async y=>{const j=S(r,y);return await U(j&&j._f?{[y]:j}:j)}))).every(Boolean),!(!D&&!n.isValid)&&I()):D=k=await U(r);return T.state.next({...!ge(l)||(v.isValid||N.isValid)&&k!==n.isValid?{}:{name:l},...a.resolver||!l?{isValid:k}:{},errors:n.errors}),d.shouldFocus&&!D&&Ue(r,le,l?p:s.mount),D},me=l=>{const d={...i.mount?o:t};return Z(l)?d:ge(l)?S(d,l):l.map(k=>S(d,k))},ne=(l,d)=>({invalid:!!S((d||n).errors,l),isDirty:!!S((d||n).dirtyFields,l),error:S((d||n).errors,l),isValidating:!!S(n.validatingFields,l),isTouched:!!S((d||n).touchedFields,l)}),He=l=>{l&&ie(l).forEach(d=>X(n.errors,d)),T.state.next({errors:l?n.errors:{}})},Oe=(l,d,k)=>{const D=(S(r,l,{_f:{}})._f||{}).ref,p=S(n.errors,l)||{},{ref:y,message:j,type:C,...$}=p;J(n.errors,l,{...$,...d,ref:D}),T.state.next({name:l,errors:n.errors,isValid:!1}),k&&k.shouldFocus&&D&&D.focus&&D.focus()},Dn=(l,d)=>ve(l)?T.state.subscribe({next:k=>"values"in k&&l(c(void 0,d),k)}):c(l,d,!0),an=l=>T.state.subscribe({next:d=>{qt(l.name,d.name,l.exact)&&Bt(d,l.formState||v,$e,l.reRenderRoot)&&l.callback({values:{...o},...n,...d,defaultValues:t})}}).unsubscribe,bn=l=>(i.mount=!0,N={...N,...l.formState},an({...l,formState:N})),Ye=(l,d={})=>{for(const k of l?ie(l):s.mount)s.mount.delete(k),s.array.delete(k),d.keepValue||(X(r,k),X(o,k)),!d.keepError&&X(n.errors,k),!d.keepDirty&&X(n.dirtyFields,k),!d.keepTouched&&X(n.touchedFields,k),!d.keepIsValidating&&X(n.validatingFields,k),!a.shouldUnregister&&!d.keepDefaultValue&&X(t,k);T.state.next({values:W(o)}),T.state.next({...n,...d.keepDirty?{isDirty:x()}:{}}),!d.keepIsValid&&I()},tn=({disabled:l,name:d})=>{(de(l)&&i.mount||l||s.disabled.has(d))&&(l?s.disabled.add(d):s.disabled.delete(d))},Ve=(l,d={})=>{let k=S(r,l);const D=de(d.disabled)||de(a.disabled);return J(r,l,{...k||{},_f:{...k&&k._f?k._f:{ref:{name:l}},name:l,mount:!0,...d}}),s.mount.add(l),k?tn({disabled:de(d.disabled)?d.disabled:a.disabled,name:l}):F(l,!0,d.value),{...D?{disabled:d.disabled||a.disabled}:{},...a.progressive?{required:!!d.required,min:We(d.min),max:We(d.max),minLength:We(d.minLength),maxLength:We(d.maxLength),pattern:We(d.pattern)}:{},name:l,onChange:ee,onBlur:ee,ref:p=>{if(p){Ve(l,d),k=S(r,l);const y=Z(p.value)&&p.querySelectorAll&&p.querySelectorAll("input,select,textarea")[0]||p,j=Gt(y),C=k._f.refs||[];if(j?C.find($=>$===y):y===k._f.ref)return;J(r,l,{_f:{...k._f,...j?{refs:[...C.filter(Vn),y,...Array.isArray(S(t,l))?[{}]:[]],ref:{type:y.type,name:l}}:{ref:y}}}),F(l,!1,void 0,y)}else k=S(r,l,{}),k._f&&(k._f.mount=!1),(a.shouldUnregister||d.shouldUnregister)&&!(Xr(s.array,l)&&i.action)&&s.unMount.add(l)}}},ce=()=>a.shouldFocusError&&Ue(r,le,s.mount),xe=l=>{de(l)&&(T.state.next({disabled:l}),Ue(r,(d,k)=>{const D=S(r,k);D&&(d.disabled=D._f.disabled||l,Array.isArray(D._f.refs)&&D._f.refs.forEach(p=>{p.disabled=D._f.disabled||l}))},0,!1))},Ge=(l,d)=>async k=>{let D;k&&(k.preventDefault&&k.preventDefault(),k.persist&&k.persist());let p=W(o);if(T.state.next({isSubmitting:!0}),a.resolver){const{errors:y,values:j}=await L();n.errors=y,p=W(j)}else await U(r);if(s.disabled.size)for(const y of s.disabled)X(p,y);if(X(n.errors,"root"),re(n.errors)){T.state.next({errors:{}});try{await l(p,k)}catch(y){D=y}}else d&&await d({...n.errors},k),ce(),setTimeout(ce);if(T.state.next({isSubmitted:!0,isSubmitting:!1,isSubmitSuccessful:re(n.errors)&&!D,submitCount:n.submitCount+1,errors:n.errors}),D)throw D},Ce=(l,d={})=>{S(r,l)&&(Z(d.defaultValue)?H(l,W(S(t,l))):(H(l,d.defaultValue),J(t,l,W(d.defaultValue))),d.keepTouched||X(n.touchedFields,l),d.keepDirty||(X(n.dirtyFields,l),n.isDirty=d.defaultValue?x(l,W(S(t,l))):x()),d.keepError||(X(n.errors,l),v.isValid&&I()),T.state.next({...n}))},De=(l,d={})=>{const k=l?W(l):t,D=W(k),p=re(l),y=p?t:D;if(d.keepDefaultValues||(t=k),!d.keepValues){if(d.keepDirtyValues){const j=new Set([...s.mount,...Object.keys(ze(t,o))]);for(const C of Array.from(j))S(n.dirtyFields,C)?J(y,C,S(o,C)):H(C,S(y,C))}else{if(zn&&Z(l))for(const j of s.mount){const C=S(r,j);if(C&&C._f){const $=Array.isArray(C._f.refs)?C._f.refs[0]:C._f.ref;if(An($)){const ke=$.closest("form");if(ke){ke.reset();break}}}}if(d.keepFieldsRef)for(const j of s.mount)H(j,S(y,j));else r={}}o=a.shouldUnregister?d.keepDefaultValues?W(t):{}:W(y),T.array.next({values:{...y}}),T.state.next({values:{...y}})}s={mount:d.keepDirtyValues?s.mount:new Set,unMount:new Set,array:new Set,disabled:new Set,watch:new Set,watchAll:!1,focus:""},i.mount=!v.isValid||!!d.keepIsValid||!!d.keepDirtyValues,i.watch=!!a.shouldUnregister,T.state.next({submitCount:d.keepSubmitCount?n.submitCount:0,isDirty:p?!1:d.keepDirty?n.isDirty:!!(d.keepDefaultValues&&!ye(l,t)),isSubmitted:d.keepIsSubmitted?n.isSubmitted:!1,dirtyFields:p?{}:d.keepDirtyValues?d.keepDefaultValues&&o?ze(t,o):n.dirtyFields:d.keepDefaultValues&&l?ze(t,l):d.keepDirty?n.dirtyFields:{},touchedFields:d.keepTouched?n.touchedFields:{},errors:d.keepErrors?n.errors:{},isSubmitSuccessful:d.keepIsSubmitSuccessful?n.isSubmitSuccessful:!1,isSubmitting:!1})},be=(l,d)=>De(ve(l)?l(o):l,d),Je=(l,d={})=>{const k=S(r,l),D=k&&k._f;if(D){const p=D.refs?D.refs[0]:D.ref;p.focus&&(p.focus(),d.shouldSelect&&ve(p.select)&&p.select())}},$e=l=>{n={...n,...l}},Pe={control:{register:Ve,unregister:Ye,getFieldState:ne,handleSubmit:Ge,setError:Oe,_subscribe:an,_runSchema:L,_focusError:ce,_getWatch:c,_getDirty:x,_setValid:I,_setFieldArray:V,_setDisabledField:tn,_setErrors:f,_getFieldArray:M,_reset:De,_resetDefaultValues:()=>ve(a.defaultValues)&&a.defaultValues().then(l=>{be(l,a.resetOptions),T.state.next({isLoading:!1})}),_removeUnmounted:w,_disableForm:xe,_subjects:T,_proxyFormState:v,get _fields(){return r},get _formValues(){return o},get _state(){return i},set _state(l){i=l},get _defaultValues(){return t},get _names(){return s},set _names(l){s=l},get _formState(){return n},get _options(){return a},set _options(l){a={...a,...l}}},subscribe:bn,trigger:se,register:Ve,handleSubmit:Ge,watch:Dn,setValue:H,getValues:me,reset:be,resetField:Ce,clearErrors:He,unregister:Ye,setError:Oe,setFocus:Je,getFieldState:ne};return{...Pe,formControl:Pe}}var fe=()=>{if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID();const e=typeof performance>"u"?Date.now():performance.now()*1e3;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{const n=(Math.random()*16+e)%16|0;return(a=="x"?n:n&3|8).toString(16)})},cn=(e,a,n={})=>n.shouldFocus||Z(n.shouldFocus)?n.focusName||`${e}.${Z(n.focusIndex)?a:n.focusIndex}.`:"",Gn=(e,a)=>[...e,...ie(a)],Pn=e=>Array.isArray(e)?e.map(()=>{}):void 0;function jn(e,a,n){return[...e.slice(0,a),...ie(n),...e.slice(a)]}var Mn=(e,a,n)=>Array.isArray(e)?(Z(e[n])&&(e[n]=void 0),e.splice(n,0,e.splice(a,1)[0]),e):[],hn=(e,a)=>[...ie(a),...ie(e)];function Ct(e,a){let n=0;const r=[...e];for(const t of a)r.splice(t-n,1),n++;return Ln(r).length?r:[]}var Un=(e,a)=>Z(a)?[]:Ct(e,ie(a).sort((n,r)=>n-r)),Bn=(e,a,n)=>{[e[a],e[n]]=[e[n],e[a]]},Nr=(e,a,n)=>(e[a]=n,e);function Jt(e){const a=Re(),{control:n=a.control,name:r,keyName:t="id",shouldUnregister:o,rules:i}=e,[s,m]=u.useState(n._getFieldArray(r)),g=u.useRef(n._getFieldArray(r).map(fe)),v=u.useRef(s),N=u.useRef(!1);v.current=s,n._names.array.add(r),u.useMemo(()=>i&&n.register(r,i),[n,i,r]),On(()=>n._subjects.array.subscribe({next:({values:E,name:O})=>{if(O===r||!O){const L=S(E,r);Array.isArray(L)&&(m(L),g.current=L.map(fe))}}}).unsubscribe,[n,r]);const T=u.useCallback(E=>{N.current=!0,n._setFieldArray(r,E)},[n,r]),K=(E,O)=>{const L=ie(W(E)),h=Gn(n._getFieldArray(r),L);n._names.focus=cn(r,h.length-1,O),g.current=Gn(g.current,L.map(fe)),T(h),m(h),n._setFieldArray(r,h,Gn,{argA:Pn(E)})},G=(E,O)=>{const L=ie(W(E)),h=hn(n._getFieldArray(r),L);n._names.focus=cn(r,0,O),g.current=hn(g.current,L.map(fe)),T(h),m(h),n._setFieldArray(r,h,hn,{argA:Pn(E)})},I=E=>{const O=Un(n._getFieldArray(r),E);g.current=Un(g.current,E),T(O),m(O),!Array.isArray(S(n._fields,r))&&J(n._fields,r,void 0),n._setFieldArray(r,O,Un,{argA:E})},_=(E,O,L)=>{const h=ie(W(O)),U=jn(n._getFieldArray(r),E,h);n._names.focus=cn(r,E,L),g.current=jn(g.current,E,h.map(fe)),T(U),m(U),n._setFieldArray(r,U,jn,{argA:E,argB:Pn(O)})},V=(E,O)=>{const L=n._getFieldArray(r);Bn(L,E,O),Bn(g.current,E,O),T(L),m(L),n._setFieldArray(r,L,Bn,{argA:E,argB:O},!1)},A=(E,O)=>{const L=n._getFieldArray(r);Mn(L,E,O),Mn(g.current,E,O),T(L),m(L),n._setFieldArray(r,L,Mn,{argA:E,argB:O},!1)},f=(E,O)=>{const L=W(O),h=Nr(n._getFieldArray(r),E,L);g.current=[...h].map((U,w)=>!U||w===E?fe():g.current[w]),T(h),m([...h]),n._setFieldArray(r,h,Nr,{argA:E,argB:L},!0,!1)},F=E=>{const O=ie(W(E));g.current=O.map(fe),T([...O]),m([...O]),n._setFieldArray(r,[...O],L=>L,{},!0,!1)};return u.useEffect(()=>{if(n._state.action=!1,xn(r,n._names)&&n._subjects.state.next({...n._formState}),N.current&&(!he(n._options.mode).isOnSubmit||n._formState.isSubmitted)&&!he(n._options.reValidateMode).isOnSubmit)if(n._options.resolver)n._runSchema([r]).then(E=>{const O=S(E.errors,r),L=S(n._formState.errors,r);(L?!O&&L.type||O&&(L.type!==O.type||L.message!==O.message):O&&O.type)&&(O?J(n._formState.errors,r,O):X(n._formState.errors,r),n._subjects.state.next({errors:n._formState.errors}))});else{const E=S(n._fields,r);E&&E._f&&!(he(n._options.reValidateMode).isOnSubmit&&he(n._options.mode).isOnSubmit)&&Cn(E,n._names.disabled,n._formValues,n._options.criteriaMode===Ee.all,n._options.shouldUseNativeValidation,!0).then(O=>!re(O)&&n._subjects.state.next({errors:sa(n._formState.errors,O,r)}))}n._subjects.state.next({name:r,values:W(n._formValues)}),n._names.focus&&Ue(n._fields,(E,O)=>{if(n._names.focus&&O.startsWith(n._names.focus)&&E.focus)return E.focus(),1}),n._names.focus="",n._setValid(),N.current=!1},[s,r,n]),u.useEffect(()=>(!S(n._formValues,r)&&n._setFieldArray(r),()=>{const E=(O,L)=>{const h=S(n._fields,O);h&&h._f&&(h._f.mount=L)};n._options.shouldUnregister||o?n.unregister(r):E(r,!1)}),[r,n,t,o]),{swap:u.useCallback(V,[T,r,n]),move:u.useCallback(A,[T,r,n]),prepend:u.useCallback(G,[T,r,n]),append:u.useCallback(K,[T,r,n]),remove:u.useCallback(I,[T,r,n]),insert:u.useCallback(_,[T,r,n]),update:u.useCallback(f,[T,r,n]),replace:u.useCallback(F,[T,r,n]),fields:u.useMemo(()=>s.map((E,O)=>({...E,[t]:g.current[O]||fe()})),[s,t])}}function $t(e={}){const a=u.useRef(void 0),n=u.useRef(void 0),[r,t]=u.useState({isDirty:!1,isValidating:!1,isLoading:ve(e.defaultValues),isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,submitCount:0,dirtyFields:{},touchedFields:{},validatingFields:{},errors:e.errors||{},disabled:e.disabled||!1,isReady:!1,defaultValues:ve(e.defaultValues)?void 0:e.defaultValues});if(!a.current)if(e.formControl)a.current={...e.formControl,formState:r},e.defaultValues&&!ve(e.defaultValues)&&e.formControl.reset(e.defaultValues,e.resetOptions);else{const{formControl:i,...s}=xt(e);a.current={...s,formState:r}}const o=a.current.control;return o._options=e,On(()=>{const i=o._subscribe({formState:o._proxyFormState,callback:()=>t({...o._formState}),reRenderRoot:!0});return t(s=>({...s,isReady:!0})),o._formState.isReady=!0,i},[o]),u.useEffect(()=>o._disableForm(e.disabled),[o,e.disabled]),u.useEffect(()=>{e.mode&&(o._options.mode=e.mode),e.reValidateMode&&(o._options.reValidateMode=e.reValidateMode)},[o,e.mode,e.reValidateMode]),u.useEffect(()=>{e.errors&&(o._setErrors(e.errors),o._focusError())},[o,e.errors]),u.useEffect(()=>{e.shouldUnregister&&o._subjects.state.next({values:o._getWatch()})},[o,e.shouldUnregister]),u.useEffect(()=>{if(o._proxyFormState.isDirty){const i=o._getDirty();i!==r.isDirty&&o._subjects.state.next({isDirty:i})}},[o,r.isDirty]),u.useEffect(()=>{e.values&&!ye(e.values,n.current)?(o._reset(e.values,{keepFieldsRef:!0,...o._options.resetOptions}),n.current=e.values,t(i=>({...i}))):o._resetDefaultValues()},[o,e.values]),u.useEffect(()=>{o._state.mount||(o._setValid(),o._state.mount=!0),o._state.watch&&(o._state.watch=!1,o._subjects.state.next({...o._formState})),o._removeUnmounted()}),a.current.formState=Qr(r,o),a.current}const zt={[b.ADOPSJONSDOKUMENTAJON]:"ToTrinnsForm.Adopsjon.KontrollerOpplysninger",[b.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN]:"ToTrinnsForm.Adopsjon.VurderEktefellesBarn",[b.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE]:"ToTrinnsForm.Adopsjon.VurderMannAdoptererAlene",[b.OVERSTYR_ADOPSJONSVILKAR]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[b.OVERSTYRING_AV_ADOPSJONSVILKÅRET_FP]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[b.OMSORGSOVERTAKELSE]:"ToTrinnsForm.Omsorgovertagelse.KontrollerOpplysninger",[b.MANUELL_VURDERING_AV_OMSORGSVILKARET]:"ToTrinnsForm.Omsorgovertagelse.VurderVilkarForeldreansvarTredjeLedd",[b.AUTO_VENT_PÅ_FODSELREGISTRERING]:"ToTrinnsForm.Fødsel.VurderSokersRelasjon",[b.SJEKK_TERMINBEKREFTELSE]:"ToTrinnsForm.Fødsel.SjekkTerminbekreftelse",[b.SJEKK_MANGLENDE_FØDSEL]:"ToTrinnsForm.Fødsel.SjekkManglendeFødsel",[b.OVERSTYR_FODSELSVILKAR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[b.OVERSTYR_FODSELSVILKAR_FAR_MEDMOR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[b.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD]:"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarFjerdeLedd",[b.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN]:"ToTrinnsForm.Foreldreansvar.VurderTidligereUtbetaling",[b.AVKLAR_AKTIVITETER]:"ToTrinnsForm.Beregning.AvklarAktiviteter",[b.OVERSTYRING_AV_BEREGNINGSAKTIVITETER]:"ToTrinnsForm.Beregning.OverstyrtBeregningsaktiviteter",[b.OVERSTYRING_AV_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.OverstyrtBeregningsgrunnlag",[b.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.FASTSETT_BRUTTO_BEREGNINGSGRUNNLAG_SELVSTENDIG_NAERINGSDRIVENDE]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.VURDER_GRADERING_UTEN_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.GraderingUtenBG",[b.FORDEL_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.FastsettFordeltBeregningsgrunnlag",[b.SOKNADSFRISTVILKARET]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[b.VURDER_SOKNADSFRIST_FORELDREPENGER]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[b.OVERSTYR_SOKNADSFRISTVILKAR]:"ToTrinnsForm.Soknadsfrist.VilkarOverstyrt",[b.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE]:"ToTrinnsForm.Medlemskap.VurderGyldigMedlemskap",[b.AVKLAR_LOVLIG_OPPHOLD]:"ToTrinnsForm.Medlemskap.AvklarLovligOpphold",[b.AVKLAR_OM_BRUKER_ER_BOSATT]:"ToTrinnsForm.Medlemskap.VurderSokerBosatt",[b.AVKLAR_OPPHOLDSRETT]:"ToTrinnsForm.Medlemskap.AvklarOppholdsrett",[b.OVERSTYR_MEDLEMSKAPSVILKAR]:"ToTrinnsForm.Medlemskap.VilkarOverstyrt",[b.OVERSTYR_AVKLAR_STARTDATO]:"ToTrinnsForm.Medlemskap.OverstyrtStartdato",[b.AVKLAR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.AvklartDekningsgrad",[b.OVERSTYR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.OverstyrtDekningsgrad",[b.FORESLA_VEDTAK]:"ToTrinnsForm.Vedtak.Fritekstbrev",[b.FORESLA_VEDTAK_MANUELT]:"ToTrinnsForm.Vedtak.Fritekstbrev",[b.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_OMSORG]:"ToTrinnsForm.Omsorg.VurderOmsorg",[b.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_ALENEOMSORG]:"ToTrinnsForm.Aleneomsorg.VurderAleneomsorg",[b.KONTROLLER_OPPLYSNINGER_OM_DØD]:"ToTrinnsForm.Uttak.Dod",[b.KONTROLLER_OPPLYSNINGER_OM_SØKNADSFRIST]:"ToTrinnsForm.Uttak.Soknadsfrist",[b.KONTROLLER_REALITETSBEHANDLING_ELLER_KLAGE]:"ToTrinnsForm.Uttak.Klage",[b.ANNENPART_EØS]:"ToTrinnsForm.Uttak.AnnenpartEØS",[b.TETTE_SAKER]:"ToTrinnsForm.Uttak.TetteStønadsperioder",[b.KONTROLLER_OPPLYSNINGER_OM_FORDELING_AV_STØNADSPERIODEN]:"ToTrinnsForm.Uttak.FordelingStonadsperioder",[b.KONTROLLER_TILSTØTENDE_YTELSER_INNVILGET]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Innvilget",[b.KONTROLLER_TILSTØTENDE_YTELSER_OPPHØRT]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Opphort",[b.TILKNYTTET_STORTINGET]:"ToTrinnsForm.Uttak.Stortinget",[b.VURDER_TILBAKETREKK]:"ToTrinnsForm.TilkjentYtelse.Tilbaketrekk",[b.VURDER_FARESIGNALER]:"ToTrinnsForm.Faresignaler.Vurder",[b.VURDER_OPPTJENINGSVILKARET]:"ToTrinnsForm.Opptjening.VurderOpptjeningsvilkåret",[b.VURDER_REFUSJON_BERGRUNN]:"ToTrinnsForm.Beregningsgrunnlag.Refusjonsstart",[b.VURDER_ARBEIDSFORHOLD_INNTEKTSMELDING]:"ToTrinnsForm.ArbeidOgInntekt.ManueltOpprettet"},Wt={},Zt=(e,a,n)=>a&&n?R.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidMedNavn",values:{a:e,b:a,c:n}}):n?R.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidUtenNavn",values:{a:e,b:n}}):R.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringAktivitet",values:{a:e}}),Xt=(e,a,n)=>a&&n?R.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidMedNavn",values:{a:e,bb:a,c:n,b:r=>R.jsx("b",{children:r})}}):n?R.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidUtenNavn",values:{a:e,bb:n,b:r=>R.jsx("b",{children:r})}}):R.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningAktivitet",values:{a:e,b:r=>R.jsx("b",{children:r})}}),Qt=(e,a,n)=>a&&n?R.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidMedNavn",values:{a:e,b:a,c:n}}):n?R.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidUtenNavn",values:{a:e,b:n}}):R.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningAktivitet",values:{a:e}}),ia=({aktivitet:e})=>e.erEndring?Zt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):e.godkjent?Qt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):Xt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr);ia.__docgenInfo={description:"",methods:[],displayName:"OpptjeningTotrinnText",props:{aktivitet:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  godkjent: boolean;
  privatpersonFødselsdato?: string;
}>`},description:""}}};const eo=e=>e?.fastsattVarigEndringNaering?R.jsx(q,{id:"ToTrinnsForm.Beregning.VarigEndring"}):R.jsx(q,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),yr=e=>e.uttakPerioder?e.uttakPerioder.map(a=>{const n=or(a.fom),r=or(a.tom);let t;return a.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":a.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":a.erEndret&&(e.aksjonspunktKode===b.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===b.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":a.erEndret&&e.aksjonspunktKode===b.OVERSTYRING_AV_UTTAKPERIODER||a.erEndret&&e.aksjonspunktKode===b.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":a.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",R.jsx(q,{id:t,values:{a:n,b:r}},t)}):[],no=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(a=>R.jsx(ia,{aktivitet:a},a.aktivitetType)):[],ro=e=>{const a=zt[e.aksjonspunktKode];return a?[R.jsx(q,{id:a},a)]:[]},ao=e=>{const a=Wt[e.aksjonspunktKode];return a?[R.jsx(q,{id:a},a)]:[]},to=e=>{const a=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[R.jsx(q,{id:a},a)]},oo=(e,a)=>a?.faktaOmBeregningTilfeller?a.faktaOmBeregningTilfeller.flatMap(n=>{const r=e.find(t=>t.kode===n);return r?[R.jsx("div",{children:r.navn},r.navn)]:[]}):[],lo=e=>{let a="";switch(e?.type){case Le.KLAGE_YTELSESVEDTAK_STADFESTET:a="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case Le.KLAGE_YTELSESVEDTAK_OPPHEVET:a="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case Le.KLAGE_AVVIST:a="ToTrinnsForm.Klage.Avvist";break;case Le.HJEMSENDE_UTEN_OPPHEVE:a="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case Le.KLAGE_DELVIS_MEDHOLD:a="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case Le.KLAGE_OMGJORT_UGUNST:a="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case Le.KLAGE_MEDHOLD:a="ToTrinnsForm.Klage.OmgjortTilGunst";break}return R.jsx(q,{id:a})},so=(e,a)=>e===yn.FATTER_VEDTAK?[lo(a)]:[],io=()=>R.jsx(q,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),ko=()=>R.jsx(q,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),Eo=e=>e.aksjonspunktKode===b.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===b.VURDERING_AV_FORMKRAV_KLAGE_NFP,da=(e,a,n,r,t,o)=>t.aksjonspunktKode===b.VURDER_PERIODER_MED_OPPTJENING?no(t):t.aksjonspunktKode===b.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[eo(t.beregningDto)]:t.aksjonspunktKode===b.VURDER_FAKTA_FOR_ATFL_SN?oo(n,t.beregningDto):wa(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0||Ha(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0?yr(t):t.aksjonspunktKode===b.AVKLAR_ANNEN_FORELDER_RETT?[io()]:t.aksjonspunktKode===b.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?to(e):t.aksjonspunktKode===b.OVERSTYRING_AV_RETT_OG_OMSORG?[ko()]:Eo(t)?so(a,o):r?ao(t):ro(t);function uo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Sr={exports:{}},Ze={};/**
 * @license React
 ...
 */var pr;function vo(){if(pr)return Ze;pr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,o){var i=null;if(o!==void 0&&(i=""+o),t.key!==void 0&&(i=""+t.key),"key"in t){o={};for(var s in t)s!=="key"&&(o[s]=t[s])}else o=t;return t=o.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:o}}return Ze.Fragment=a,Ze.jsx=n,Ze.jsxs=n,Ze}var Kr;function To(){return Kr||(Kr=1,Sr.exports=vo()),Sr.exports}var Se=To();const go=({children:e})=>!e||Array.isArray(e)&&e.length===0?null:Se.jsx(ot,{variant:"warning",size:"small",children:Se.jsx(Te,{gap:"2",children:u.Children.map(e,a=>Se.jsx(ue,{size:"small",children:a},pa(a)?a.key:a))})}),rn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};qe(rn);const _n="#B7B1A9",ka=4,Ao=(e,a,n)=>`
  .arrowBoxTop${e} {
    background: #ffffff;
    border: 1px solid ${_n};
    border-radius: ${ka}px;
...
`,mo=(e,a,n,r)=>a?Ro(e,n,r):Ao(e,n,r),_o=(e,a,n)=>n?"":a?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,No=({children:e,alignOffset:a=0,alignLeft:n=!1,marginTop:r=0,marginLeft:t=0,hideBorder:o=!1})=>Se.jsxs(Se.Fragment,{children:[Se.jsx("style",{dangerouslySetInnerHTML:{__html:mo(a,n,r,t)}}),Se.jsx("div",{className:_o(a,n,o),children:e})]});var fr={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Lr;function yo(){return Lr||(Lr=1,function(e){(function(){var a={}.hasOwnProperty;function n(){for(var o="",i=0;i<arguments.length;i++){var s=arguments[i];s&&(o=t(o,r.call(this,s)))}return o}function r(o){if(typeof o=="string"||typeof o=="number")return this&&this[o]||o;if(typeof o!="object")return"";if(Array.isArray(o))return n.apply(this,o);if(o.toString!==Object.prototype.toString&&!o.toString.toString().includes("[native code]"))return o.toString();var i="";for(var s in o)a.call(o,s)&&o[s]&&(i=t(i,this&&this[s]||s));return i}function t(o,i){return i?o?o+" "+i:o+i:o}e.exports?(n.default=n,e.exports=n):window.classNames=n})()}(fr)),fr.exports}var So=yo();const nr=uo(So),po="_borderbox_1vkvn_1",Ko="_error_1vkvn_5",fo="_warning_1vkvn_8",Lo={borderbox:po,error:Ko,warning:fo};nr.bind(Lo);const Oo="_aksjonspunkt_kn1hn_1",Do="_erAksjonspunktApent_kn1hn_4",bo="_erIkkeGodkjentAvBeslutter_kn1hn_8",Fo={aksjonspunkt:Oo,erAksjonspunktApent:Do,erIkkeGodkjentAvBeslutter:bo};nr.bind(Fo);qe(rn);qe(rn);const Io="_divider_1t980_1",Vo="_dividerParagraf_1t980_8",co="_leftPanel_1t980_11",Go="_rightPanel_1t980_14",Po={divider:Io,dividerParagraf:Vo,leftPanel:co,rightPanel:Go};nr.bind(Po);const Ea=()=>Se.jsx("span",{"data-testid":"editedIcon",children:Se.jsx(Xa,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--a-icon-warning)"})});qe(rn);qe(rn);function jo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Or={exports:{}},Xe={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Dr;function Mo(){if(Dr)return Xe;Dr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,o){var i=null;if(o!==void 0&&(i=""+o),t.key!==void 0&&(i=""+t.key),"key"in t){o={};for(var s in t)s!=="key"&&(o[s]=t[s])}else o=t;return t=o.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:o}}return Xe.Fragment=a,Xe.jsx=n,Xe.jsxs=n,Xe}var br;function ho(){return br||(br=1,Or.exports=Mo()),Or.exports}var z=ho();const rr=e=>e.reduce((a,n,r)=>({...a,[r]:t=>n(t)||!0}),{}),Nn=(e,a)=>a.split(".").reduce((n,r)=>n!==void 0?n[r]:n,e)?.message,Me=({label:e,validate:a=[],readOnly:n=!1,onChange:r,onClick:t,className:o,...i})=>{const{name:s,control:m,disabled:g}=i,{formState:{errors:v}}=Re(),{field:N}=Xn({name:s,control:m,rules:{validate:P.useMemo(()=>rr(a),[a])}}),T=Nn(v,s);return z.jsxs(z.Fragment,{children:[z.jsx(mt,{size:"small",disabled:g||n,checked:N.value===!0,className:o,error:!!T,...N,onChange:K=>{N.onChange(K),r&&r(K.currentTarget.checked)},onClick:()=>{t&&t()},children:e}),T&&z.jsx(Kn,{children:Nn(v,s)})]})};var Jn={exports:{}},Uo=Jn.exports,Fr;function Bo(){return Fr||(Fr=1,function(e,a){(function(n,r){e.exports=r()})(Uo,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,t=/\d/,o=/\d\d/,i=/\d\d?/,s=/\d*[^-_:/,()\s\d]+/,m={},g=function(_){return(_=+_)+(_>68?1900:2e3)},v=function(_){return function(V){this[_]=+V}},N=[/[+-]\d\d:?(\d\d)?|Z/,function(_){(this.zone||(this.zone={})).offset=function(V){if(!V||V==="Z")return 0;var A=V.match(/([+-]|\d\d)/g),f=60*A[1]+(+A[2]||0);return f===0?0:A[0]==="+"?-f:f}(_)}],T=function(_){var V=m[_];return V&&(V.indexOf?V:V.s.concat(V.f))},K=function(_,V){var A,f=m.meridiem;if(f){for(var F=1;F<=24;F+=1)if(_.indexOf(f(F,0,V))>-1){A=F>12;break}}else A=_===(V?"pm":"PM");return A},G={A:[s,function(_){this.afternoon=K(_,!1)}],a:[s,function(_){this.afternoon=K(_,!0)}],Q:[t,function(_){this.month=3*(_-1)+1}],S:[t,function(_){this.milliseconds=100*+_}],SS:[o,function(_){this.milliseconds=10*+_}],SSS:[/\d{3}/,function(_){this.milliseconds=+_}],s:[i,v("seconds")],ss:[i,v("seconds")],m:[i,v("minutes")],mm:[i,v("minutes")],H:[i,v("hours")],h:[i,v("hours")],HH:[i,v("hours")],hh:[i,v("hours")],D:[i,v("day")],DD:[o,v("day")],Do:[s,function(_){var V=m.ordinal,A=_.match(/\d+/);if(this.day=A[0],V)for(var f=1;f<=31;f+=1)V(f).replace(/\[|\]/g,"")===_&&(this.day=f)}],w:[i,v("week")],ww:[o,v("week")],M:[i,v("month")],MM:[o,v("month")],MMM:[s,function(_){var V=T("months"),A=(T("monthsShort")||V.map(function(f){return f.slice(0,3)})).indexOf(_)+1;if(A<1)throw new Error;this.month=A%12||A}],MMMM:[s,function(_){var V=T("months").indexOf(_)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,v("year")],YY:[o,function(_){this.year=g(_)}],YYYY:[/\d{4}/,v("year")],Z:N,ZZ:N};function I(_){var V,A;V=_,A=m&&m.formats;for(var f=(_=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,c){var M=c&&c.toUpperCase();return x||A[c]||n[c]||A[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(B,Y,H){return Y||H.slice(1)})})).match(r),F=f.length,E=0;E<F;E+=1){var O=f[E],L=G[O],h=L&&L[0],U=L&&L[1];f[E]=U?{regex:h,parser:U}:O.replace(/^\[|\]$/g,"")}return function(w){for(var x={},c=0,M=0;c<F;c+=1){var B=f[c];if(typeof B=="string")M+=B.length;else{var Y=B.regex,H=B.parser,ee=w.slice(M),le=Y.exec(ee)[0];H.call(x,le),w=w.replace(le,"")}}return function(se){var me=se.afternoon;if(me!==void 0){var ne=se.hours;me?ne<12&&(se.hours+=12):ne===12&&(se.hours=0),delete se.afternoon}}(x),x}}return function(_,V,A){A.p.customParseFormat=!0,_&&_.parseTwoDigitYear&&(g=_.parseTwoDigitYear);var f=V.prototype,F=f.parse;f.parse=function(E){var O=E.date,L=E.utc,h=E.args;this.$u=L;var U=h[1];if(typeof U=="string"){var w=h[2]===!0,x=h[3]===!0,c=w||x,M=h[2];x&&(M=h[2]),m=this.$locale(),!w&&M&&(m=A.Ls[M]),this.$d=function(ee,le,se,me){try{if(["x","X"].indexOf(le)>-1)return new Date((le==="X"?1e3:1)*ee);var ne=I(le)(ee),He=ne.year,Oe=ne.month,Dn=ne.day,an=ne.hours,bn=ne.minutes,Ye=ne.seconds,tn=ne.milliseconds,Ve=ne.zone,ce=ne.week,xe=new Date,Ge=Dn||(He||Oe?1:xe.getDate()),Ce=He||xe.getFullYear(),De=0;He&&!Oe||(De=Oe>0?Oe-1:xe.getMonth());var be,Je=an||0,$e=bn||0,on=Ye||0,Pe=tn||0;return Ve?new Date(Date.UTC(Ce,De,Ge,Je,$e,on,Pe+60*Ve.offset*1e3)):se?new Date(Date.UTC(Ce,De,Ge,Je,$e,on,Pe)):(be=new Date(Ce,De,Ge,Je,$e,on,Pe),ce&&(be=me(be).week(ce).toDate()),be)}catch{return new Date("")}}(O,U,L,A),this.init(),M&&M!==!0&&(this.$L=this.locale(M).$L),c&&O!=this.format(U)&&(this.$d=new Date("")),m={}}else if(U instanceof Array)for(var B=U.length,Y=1;Y<=B;Y+=1){h[1]=U[Y-1];var H=A.apply(this,h);if(H.isValid()){this.$d=H.$d,this.$L=H.$L,this.init();break}Y===B&&(this.$d=new Date(""))}else F.call(this,E)}}})}(Jn)),Jn.exports}var qo=Bo();const wo=jo(qo),Ho="_textarea_1snk6_1",Yo="_readOnlyField_1snk6_7",Ir={textarea:Ho,readOnlyField:Yo},xo=e=>e!=null&&e!=="",Co=({label:e,value:a,isEdited:n=!1,type:r,hideLabel:t,size:o})=>xo(a)?z.jsxs(Te,{gap:"1",children:[e&&!t&&z.jsx(pn,{size:o,children:e}),z.jsxs(Ie,{gap:"2",align:"center",wrap:!1,children:[z.jsx(qr,{className:r==="textarea"?Ir.textarea:Ir.readOnlyField,size:o,children:a}),n&&z.jsx(Ea,{})]})]}):null;Ka.extend(wo);const Jo="_hideRadioLabels_1u3xf_1",$o={hideRadioLabels:Jo},zo=({label:e,description:a,validate:n=[],radios:r,onChange:t,isReadOnly:o=!1,isHorizontal:i=!1,parse:s=G=>G,isTrueOrFalseSelection:m=!1,hideLegend:g=!1,hideRadioLabels:v=!1,isEdited:N=!1,size:T="small",...K})=>{const{name:G,control:I,disabled:_}=K,{formState:{errors:V}}=Re(),{field:A}=Xn({name:G,control:I,rules:{validate:P.useMemo(()=>rr(n),[n])}}),f=m?E=>E==="true":s,F=z.jsxs(Ie,{justify:"center",gap:"2",children:[e,o&&N&&z.jsx(Ea,{})]});return z.jsxs(Nt,{name:G,value:A.value!==void 0?A.value:null,onChange:E=>{t&&t(E),A.onChange(E)},size:T,legend:F,description:a,error:Nn(V,G),className:v?$o.hideRadioLabels:"",hideLegend:g,children:[!i&&r.map(E=>z.jsxs(P.Fragment,{children:[z.jsx(sr,{size:T,value:f(E.value),disabled:E.disabled||_||o,children:E.label}),A.value===f(E.value)&&E.element]},E.value)),i&&z.jsxs(z.Fragment,{children:[z.jsx(Ie,{gap:"4",children:r.map(E=>z.jsx(sr,{size:T,value:f(E.value),disabled:E.disabled||_||o,children:E.label},E.value))}),r.filter(E=>A.value===f(E.value)).map(E=>z.jsx(P.Fragment,{children:E.element},E.value))]})]})},Wo="_textAreaFieldWithBadges_bdz0b_1",Zo="_etikettWrapper_bdz0b_4",Vr={textAreaFieldWithBadges:Wo,etikettWrapper:Zo},Xo=({name:e,control:a,label:n,readOnly:r,maxLength:t,badges:o,validate:i=[],parse:s=K=>K,className:m,description:g,isEdited:v,size:N="small",...T})=>{const{formState:{errors:K}}=Re(),{field:G}=Xn({name:e,control:a,rules:{validate:P.useMemo(()=>rr(i),[i])}});return r?z.jsx(Co,{size:N,label:n,value:G.value,type:"textarea",isEdited:v,hideLabel:T.hideLabel}):z.jsxs("div",{className:o?Vr.textAreaFieldWithBadges:null,children:[o&&z.jsx("div",{className:Vr.etikettWrapper,children:o.map(({type:I,titleText:_})=>z.jsx(Et,{variant:I,size:"small",children:_},_))}),z.jsx(Ot,{size:N,label:n,description:g,className:m,autoComplete:"off",...G,onChange:I=>G.onChange(I.currentTarget.value!==""?s(I.currentTarget.value):null),value:G.value?G.value:"",error:Nn(K,e),maxLength:t,...T})]})},Qo=({formMethods:e,onSubmit:a,children:n,className:r,setDataOnUnmount:t})=>{const{handleSubmit:o,getValues:i}=e;return P.useEffect(()=>()=>{t&&t(i())},[]),z.jsx(Ft,{...e,children:z.jsx("form",{className:r,onSubmit:a?o(s=>a(s)):void 0,children:n})})},el=(e,a)=>{const{setError:n,clearErrors:r,formState:t}=Re(),o=!!a;return P.useEffect(()=>{o&&n(`${e}.notRegisteredInput`,{type:"custom",message:a}),o||r(`${e}.notRegisteredInput`)},[a]),t.isSubmitted?e.split(".").reduce((i,s)=>i[s]||{},t.errors)?.notRegisteredInput?.message:void 0},nl=Oa(3),rl=Da(2e3),ae="aksjonspunktGodkjenning",al=(e,a)=>!e(`${ae}.${a}.feilFakta`)&&!e(`${ae}.${a}.feilLov`)&&!e(`${ae}.${a}.feilSkjønn`)&&!e(`${ae}.${a}.feilUtredning`)&&!e(`${ae}.${a}.feilSaksflyt`)&&!e(`${ae}.${a}.feilBegrunnelse`),ua=({index:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n})=>{const{watch:r,getValues:t,control:o}=Re(),i=r("aksjonspunktGodkjenning"),{aksjonspunktKode:s,totrinnskontrollGodkjent:m}=i[e],g=a.find(K=>K.totrinnskontrollAksjonspunkter.some(G=>G.aksjonspunktKode===s)),v=g?.totrinnskontrollAksjonspunkter.find(K=>K.aksjonspunktKode===s),N=!m&&al(t,e)?fa():void 0,T=el(`${ae}.${e}.faktagruppe`,N);return!g||!v?null:R.jsxs(Te,{gap:"3",children:[R.jsx(zo,{name:`${ae}.${e}.totrinnskontrollGodkjent`,control:o,isReadOnly:n,isHorizontal:!0,isTrueOrFalseSelection:!0,hideLegend:!0,radios:[{value:"true",label:R.jsx(q,{id:"ApprovalField.Godkjent"})},{value:"false",label:R.jsx(q,{id:"ApprovalField.Vurder"})}]}),m===!1&&R.jsx(No,{alignOffset:m?1:110,children:R.jsxs(Te,{gap:"2",children:[R.jsx(pn,{size:"small",children:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),R.jsx(ue,{size:"small",children:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),R.jsxs(Te,{gap:"4",children:[R.jsx(Te,{gap:"1",children:R.jsxs(Ie,{justify:"space-between",style:{width:"300px"},children:[R.jsxs(Te,{gap:"1",children:[R.jsx(Me,{name:`${ae}.${e}.feilFakta`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilSkjønn`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilLov`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),R.jsxs(Te,{gap:"1",children:[R.jsx(Me,{name:`${ae}.${e}.feilUtredning`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilSaksflyt`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),R.jsx(Me,{name:`${ae}.${e}.feilBegrunnelse`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),T&&R.jsx(Kn,{size:"small",children:T}),R.jsx(Xo,{name:`${ae}.${e}.besluttersBegrunnelse`,control:o,label:R.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[La,nl,rl,ba],readOnly:n})]})]})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  skjermlenkeType: SkjermlenkeType;
  totrinnskontrollAksjonspunkter: TotrinnskontrollAksjonspunkt[];
}>`}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const tl="_aksjonspunktTextContainer_1th9i_5",ol="_lenke_1th9i_10",cr={aksjonspunktTextContainer:tl,lenke:ol},ll="aksjonspunktGodkjenning",va=({behandling:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n,erForeldrepengerFagsak:r,erTilbakekreving:t,skjemalenkeTyper:o,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const{control:m,watch:g}=Re(),{fields:v}=Jt({control:m,name:ll}),N=g("aksjonspunktGodkjenning");return R.jsx(Te,{gap:"6",children:v.map((T,K)=>{const{aksjonspunktKode:G}=N[K],I=a.find(F=>F.totrinnskontrollAksjonspunkter.some(E=>E.aksjonspunktKode===G)),_=I?.totrinnskontrollAksjonspunkter.find(F=>F.aksjonspunktKode===G);if(!I||!_)return null;const V=da(r,e.status,i,t,_,e.behandlingsresultat),A=o.find(F=>F.kode===I.skjermlenkeType),f=s(I.skjermlenkeType);return R.jsxs("div",{children:[f&&A&&R.jsx(hr,{to:f,onClick:()=>window.scroll(0,0),className:cr.lenke,children:A.navn}),V.map((F,E)=>R.jsx("div",{className:cr.aksjonspunktTextContainer,children:R.jsx(ue,{size:"small",children:F})},G.concat("_".concat(E.toString())))),R.jsx(ua,{index:K,totrinnskontrollSkjermlenkeContext:a,readOnly:n})]},T.id)})})};va.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Gr=(e=[])=>e.every(a=>a.totrinnskontrollGodkjent),Pr=(e=[])=>e.every(a=>a.totrinnskontrollGodkjent!==void 0&&a.totrinnskontrollGodkjent!==null),sl=(e,a)=>{if(!a)return!0;const{konsekvenserForYtelsen:n}=a;return!Array.isArray(n)||n.length!==1?!0:!e.some(r=>r===n[0])},il=e=>e.reduce((a,n)=>n===te.FEIL_FAKTA?{...a,feilFakta:!0}:n===te.FEIL_LOV?{...a,feilLov:!0}:n===te.FEIL_REGEL?{...a,feilSkjønn:!0}:n===te.SKJØNN?{...a,feilSkjønn:!0}:n===te.UTREDNING?{...a,feilUtredning:!0}:n===te.SAKSFLYT||n===te.ANNET?{...a,feilSaksflyt:!0}:n===te.BEGRUNNELSE?{...a,feilBegrunnelse:!0}:{},{}),dl=e=>({aksjonspunktGodkjenning:e.map(a=>a.totrinnskontrollAksjonspunkter).flat().map(a=>({aksjonspunktKode:a.aksjonspunktKode,totrinnskontrollGodkjent:a.totrinnskontrollGodkjent,besluttersBegrunnelse:Ur(a.besluttersBegrunnelse),...il(a.vurderPaNyttArsaker?a.vurderPaNyttArsaker:[])}))}),Ta=({behandling:e,onSubmit:a,forhandsvisVedtaksbrev:n,readOnly:r,erBehandlingEtterKlage:t,erForeldrepengerFagsak:o,skjemalenkeTyper:i,erTilbakekreving:s,totrinnskontrollSkjermlenkeContext:m,faktaOmBeregningTilfeller:g,lagLenke:v,beslutterFormData:N,setBeslutterFormData:T})=>{const K=e&&e.type===Qe.KLAGE,G=e&&e.type===Qe.ANKE,I=sl([Hn.ENDRING_I_FORDELING_AV_YTELSEN,Hn.INGEN_ENDRING],e.behandlingsresultat),_=dl(m),V=$t({defaultValues:N||_}),A=V.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?R.jsx(Qo,{formMethods:V,onSubmit:a,setDataOnUnmount:T,children:R.jsxs(Te,{gap:"6",children:[!r&&R.jsx(go,{children:[R.jsx(q,{id:"HelpText.ToTrinnsKontroll"},1)]}),R.jsx(va,{behandling:e,erForeldrepengerFagsak:o,erTilbakekreving:s,readOnly:r,totrinnskontrollSkjermlenkeContext:m,skjemalenkeTyper:i,faktaOmBeregningTilfeller:g,lagLenke:v}),R.jsxs(Ie,{gap:"4",children:[R.jsx(wn,{variant:"primary",size:"small",disabled:!Gr(A)||!Pr(A)||V.formState.isSubmitting,loading:V.formState.isSubmitting,children:R.jsx(q,{id:"ToTrinnsForm.Godkjenn"})}),R.jsx(wn,{variant:"primary",size:"small",disabled:Gr(A)||!Pr(A)||V.formState.isSubmitting,loading:V.formState.isSubmitting,onClick:Fa,children:R.jsx(q,{id:"ToTrinnsForm.SendTilbake"})}),!K&&!t&&!G&&!s&&I&&R.jsx(it,{href:"#",onClick:n,children:R.jsx(q,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};Ta.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const kl="_approvalItem_1cx8u_1",El="_approvalItemContainer_1cx8u_7",ul="_aksjonspunktTextContainer_1cx8u_11",vl="_resultatFraGodkjenningTextContainer_1cx8u_16",Tl="_lenke_1cx8u_20",gl="_checkmarkIcon_1cx8u_24",Al="_xmark_1cx8u_30",Ne={approvalItem:kl,approvalItemContainer:El,aksjonspunktTextContainer:ul,resultatFraGodkjenningTextContainer:vl,lenke:Tl,checkmarkIcon:gl,xmark:Al},Rl=({vurderPaNyttArsaker:e,vurderArsaker:a})=>R.jsx("div",{className:Ne.approvalItem,children:e?.map(n=>R.jsxs(Ie,{gap:"2",children:[R.jsx(et,{className:Ne.xmark}),R.jsx("div",{children:a.find(r=>n===r.kode)?.navn})]},n))}),ga=({behandling:e,totrinnskontrollSkjermlenkeContext:a,erForeldrepengerFagsak:n,erTilbakekreving:r,skjemalenkeTyper:t,vurderArsaker:o,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const m=Ia();return R.jsxs(R.Fragment,{children:[R.jsx("div",{className:Ne.resultatFraGodkjenningTextContainer,children:R.jsx(q,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Va}})}),a.map(g=>{const v=g.totrinnskontrollAksjonspunkter,N=t.find(T=>T.kode===g.skjermlenkeType);if(v.length>0){const T=s(g.skjermlenkeType);return R.jsxs(u.Fragment,{children:[T&&N&&R.jsx(hr,{to:T,onClick:()=>window.scroll(0,0),className:Ne.lenke,children:N.navn}),v.map(K=>{const G=da(n,e.status,i,r,K,e.behandlingsresultat);return R.jsxs("div",{className:Ne.approvalItemContainer,children:[G.map((I,_)=>R.jsx("div",{className:Ne.aksjonspunktTextContainer,children:R.jsx(ue,{size:"small",children:I})},K.aksjonspunktKode.concat("_".concat(_.toString())))),R.jsx("div",{className:Ne.approvalItem,children:K.totrinnskontrollGodkjent?R.jsxs(Ie,{gap:"2",children:[R.jsx(Ca,{title:m.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:Ne.checkmarkIcon}),R.jsx(q,{id:"ToTrinnsForm.Godkjent"})]}):R.jsx(Rl,{vurderPaNyttArsaker:K?.vurderPaNyttArsaker,vurderArsaker:o})}),R.jsx("pre",{className:Ne.approvalItem,children:Ur(K.besluttersBegrunnelse)})]},K.aksjonspunktKode)})]},g.skjermlenkeType)}return null})]})};ga.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const ml=qe(Ua),_l=[sn.FAKTA_OM_FEILUTBETALING,sn.FORELDELSE,sn.TILBAKEKREVING,sn.VEDTAK],Nl=e=>{const a=[];return e.feilFakta&&a.push(te.FEIL_FAKTA),e.feilLov&&a.push(te.FEIL_LOV),e.feilSkjønn&&a.push(te.SKJØNN),e.feilUtredning&&a.push(te.UTREDNING),e.feilSaksflyt&&a.push(te.SAKSFLYT),e.feilBegrunnelse&&a.push(te.BEGRUNNELSE),a},yl=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Aa=({behandling:e,location:a,fagsakYtelseType:n,readOnly:r,onSubmit:t,forhandsvisVedtaksbrev:o,alleKodeverk:i,createLocationForSkjermlenke:s,beslutterFormData:m,setBeslutterFormData:g})=>{const v=Qe.TILBAKEKREVING===e.type||Qe.TILBAKEKREVING_REVURDERING===e.type,N=f=>{const F=f.aksjonspunktGodkjenning.map(L=>({aksjonspunktKode:L.aksjonspunktKode,godkjent:L.totrinnskontrollGodkjent,begrunnelse:L.besluttersBegrunnelse,arsaker:Nl(L)})),O={"@type":v?xr.FATTER_VEDTAK:b.FATTER_VEDTAK,begrunnelse:null,aksjonspunktGodkjenningDtos:F};return t({fatterVedtakAksjonspunktDto:O,erAlleAksjonspunktGodkjent:f.aksjonspunktGodkjenning.every(L=>L.totrinnskontrollGodkjent)})},T=e?e.behandlingÅrsaker.map(({behandlingArsakType:f})=>f).some(f=>f===un.ETTER_KLAGE||f===un.KLAGE_U_INNTK||f===un.KLAGE_M_INNTK):!1,K=v?_l.flatMap(f=>{const F=e.totrinnskontrollÅrsaker.find(E=>E.skjermlenkeType===f.kode);return F?[F]:[]}):e.totrinnskontrollÅrsaker,G=f=>s(a,f),I=e.status===yn.FATTER_VEDTAK,_=i.SkjermlenkeType,V=i.VurderÅrsak,A=yl(i);return R.jsxs(ca,{value:ml,children:[I&&R.jsx(Ta,{behandling:e,totrinnskontrollSkjermlenkeContext:K,readOnly:r,onSubmit:N,forhandsvisVedtaksbrev:o,erForeldrepengerFagsak:n===qn.FORELDREPENGER,skjemalenkeTyper:_,erBehandlingEtterKlage:T,faktaOmBeregningTilfeller:A,erTilbakekreving:v,lagLenke:G,beslutterFormData:m,setBeslutterFormData:g}),!I&&R.jsx(ga,{behandling:e,totrinnskontrollSkjermlenkeContext:K,erForeldrepengerFagsak:n===qn.FORELDREPENGER,erTilbakekreving:v,skjemalenkeTyper:_,lagLenke:G,vurderArsaker:V,faktaOmBeregningTilfeller:A})]})};Aa.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
}`,...En.parameters?.docs?.source}}};const Ol=["ForBeslutter","ForSaksbehandler"];export{kn as ForBeslutter,En as ForSaksbehandler,Ol as __namedExportsOrder,Ll as default};
