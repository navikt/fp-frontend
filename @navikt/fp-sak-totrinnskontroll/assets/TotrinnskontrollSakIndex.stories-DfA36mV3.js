 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gn;function pt(){if(gn)return We;gn=1;var e=Symbol.for("react.transitional.element"),l=Symbol.for("react.fragment");function a(n,r,t){var i=null;if(t!==void 0&&(i=""+t),r.key!==void 0&&(i=""+r.key),"key"in r){t={};for(var o in r)o!=="key"&&(t[o]=r[o])}else t=r;return r=t.ref,{$$typeof:e,type:n,key:i,ref:r!==void 0?r:null,props:t}}return We.Fragment=l,We.jsx=a,We.jsxs=a,We}var In;function Mt(){return In||(In=1,Ln.exports=pt()),Ln.exports}var Q=Mt();const Wa=e=>e.reduce((l,a,n)=>({...l,[n]:r=>a(r)||!0}),{}),Ra=(e,l)=>l.split(".").reduce((a,n)=>a!==void 0?a[n]:a,e)?.message,Ue=({label:e,validate:l=[],readOnly:a=!1,onChange:n,onClick:r,className:t,size:i="small",...o})=>{const{name:N,control:d,disabled:s}=o,{formState:{errors:k}}=Ne(),{field:R}=Ja({name:N,control:d,rules:{validate:h.useMemo(()=>Wa(l),[l])}}),F=Ra(k,N);return Q.jsxs(Q.Fragment,{children:[Q.jsx(Tr,{size:i,disabled:s||a,checked:R.value===!0,className:t,error:!!F,...R,onChange:P=>{R.onChange(P),n&&n(P.currentTarget.checked)},onClick:()=>{r&&r()},children:e}),F&&Q.jsx(da,{children:Ra(k,N)})]})};var Ha={exports:{}},Ut=Ha.exports,Dn;function bt(){return Dn||(Dn=1,(function(e,l){(function(a,n){e.exports=n()})(Ut,function(){var a={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},n=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,r=/\d/,t=/\d\d/,i=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,N={},d=function(m){return(m=+m)+(m>68?1900:2e3)},s=function(m){return function(p){this[m]=+p}},k=[/[+-]\d\d:?(\d\d)?|Z/,function(m){(this.zone||(this.zone={})).offset=(function(p){if(!p||p==="Z")return 0;var K=p.match(/([+-]|\d\d)/g),I=60*K[1]+(+K[2]||0);return I===0?0:K[0]==="+"?-I:I})(m)}],R=function(m){var p=N[m];return p&&(p.indexOf?p:p.s.concat(p.f))},F=function(m,p){var K,I=N.meridiem;if(I){for(var f=1;f<=24;f+=1)if(m.indexOf(I(f,0,p))>-1){K=f>12;break}}else K=m===(p?"pm":"PM");return K},P={A:[o,function(m){this.afternoon=F(m,!1)}],a:[o,function(m){this.afternoon=F(m,!0)}],Q:[r,function(m){this.month=3*(m-1)+1}],S:[r,function(m){this.milliseconds=100*+m}],SS:[t,function(m){this.milliseconds=10*+m}],SSS:[/\d{3}/,function(m){this.milliseconds=+m}],s:[i,s("seconds")],ss:[i,s("seconds")],m:[i,s("minutes")],mm:[i,s("minutes")],H:[i,s("hours")],h:[i,s("hours")],HH:[i,s("hours")],hh:[i,s("hours")],D:[i,s("day")],DD:[t,s("day")],Do:[o,function(m){var p=N.ordinal,K=m.match(/\d+/);if(this.day=K[0],p)for(var I=1;I<=31;I+=1)p(I).replace(/\[|\]/g,"")===m&&(this.day=I)}],w:[i,s("week")],ww:[t,s("week")],M:[i,s("month")],MM:[t,s("month")],MMM:[o,function(m){var p=R("months"),K=(R("monthsShort")||p.map(function(I){return I.slice(0,3)})).indexOf(m)+1;if(K<1)throw new Error;this.month=K%12||K}],MMMM:[o,function(m){var p=R("months").indexOf(m)+1;if(p<1)throw new Error;this.month=p%12||p}],Y:[/[+-]?\d+/,s("year")],YY:[t,function(m){this.year=d(m)}],YYYY:[/\d{4}/,s("year")],Z:k,ZZ:k};function y(m){var p,K;p=m,K=N&&N.formats;for(var I=(m=p.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(Y,J,M){var B=M&&M.toUpperCase();return J||K[M]||a[M]||K[B].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(H,w,q){return w||q.slice(1)})})).match(n),f=I.length,_=0;_<f;_+=1){var O=I[_],D=P[O],b=D&&D[0],c=D&&D[1];I[_]=c?{regex:b,parser:c}:O.replace(/^\[|\]$/g,"")}return function(Y){for(var J={},M=0,B=0;M<f;M+=1){var H=I[M];if(typeof H=="string")B+=H.length;else{var w=H.regex,q=H.parser,ee=Y.slice(B),Ee=w.exec(ee)[0];q.call(J,Ee),Y=Y.replace(Ee,"")}}return(function(ie){var ke=ie.afternoon;if(ke!==void 0){var ne=ie.hours;ke?ne<12&&(ie.hours+=12):ne===12&&(ie.hours=0),delete ie.afternoon}})(J),J}}return function(m,p,K){K.p.customParseFormat=!0,m&&m.parseTwoDigitYear&&(d=m.parseTwoDigitYear);var I=p.prototype,f=I.parse;I.parse=function(_){var O=_.date,D=_.utc,b=_.args;this.$u=D;var c=b[1];if(typeof c=="string"){var Y=b[2]===!0,J=b[3]===!0,M=Y||J,B=b[2];J&&(B=b[2]),N=this.$locale(),!Y&&B&&(N=K.Ls[B]),this.$d=(function(ee,Ee,ie,ke){try{if(["x","X"].indexOf(Ee)>-1)return new Date((Ee==="X"?1e3:1)*ee);var ne=y(Ee)(ee),je=ne.year,De=ne.month,Sa=ne.day,ea=ne.hours,Ka=ne.minutes,Ye=ne.seconds,aa=ne.milliseconds,Ve=ne.zone,ye=ne.week,qe=new Date,fe=Sa||(je||De?1:qe.getDate()),we=je||qe.getFullYear(),Oe=0;je&&!De||(Oe=De>0?De-1:qe.getMonth());var Fe,Je=ea||0,xe=Ka||0,na=Ye||0,pe=aa||0;return Ve?new Date(Date.UTC(we,Oe,fe,Je,xe,na,pe+60*Ve.offset*1e3)):ie?new Date(Date.UTC(we,Oe,fe,Je,xe,na,pe)):(Fe=new Date(we,Oe,fe,Je,xe,na,pe),ye&&(Fe=ke(Fe).week(ye).toDate()),Fe)}catch{return new Date("")}})(O,c,D,K),this.init(),B&&B!==!0&&(this.$L=this.locale(B).$L),M&&O!=this.format(c)&&(this.$d=new Date("")),N={}}else if(c instanceof Array)for(var H=c.length,w=1;w<=H;w+=1){b[1]=c[w-1];var q=K.apply(this,b);if(q.isValid()){this.$d=q.$d,this.$L=q.$L,this.init();break}w===H&&(this.$d=new Date(""))}else f.call(this,_)}}})})(Ha)),Ha.exports}var Bt=bt();const ct=ft(Bt),ht="_textarea_14c7r_1",Ht="_readOnlyField_14c7r_7",On={textarea:ht,readOnlyField:Ht},jt=e=>e!=null&&e!=="",Yt=({label:e,value:l,isEdited:a=!1,type:n,hideLabel:r,size:t})=>jt(l)?Q.jsxs(Ae,{gap:"space-4",children:[e&&!r&&Q.jsx(Aa,{size:t,children:e}),Q.jsxs(Pe,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(bn,{className:n==="textarea"?On.textarea:On.readOnlyField,size:t,children:l}),a&&Q.jsx(rl,{})]})]}):null;dl.extend(ct);const qt="_noReadOnlyIcon_11vhl_2",wt={noReadOnlyIcon:qt},Jt=({label:e,description:l,validate:a=[],onChange:n,children:r,className:t,isReadOnly:i=!1,size:o="small",isEdited:N=!1,hideLegend:d=!1,...s})=>{const{name:k,control:R}=s,{formState:{errors:F}}=Ne(),{field:P}=Ja({name:k,control:R,rules:{validate:Wa(a)}});return Q.jsx(sr,{name:k,value:P.value!==void 0?P.value:null,legend:Q.jsxs(Pe,{justify:"center",gap:"space-8",children:[e,i&&N&&Q.jsx(rl,{})]}),hideLegend:d,"aria-readonly":i,readOnly:i,description:l,size:o,error:Ra(F,k),onChange:y=>{n&&n(y),P.onChange(y)},className:yt(t,wt.noReadOnlyIcon),children:r})},xt="_textAreaFieldWithBadges_bdz0b_1",Ct="_etikettWrapper_bdz0b_4",Fn={textAreaFieldWithBadges:xt,etikettWrapper:Ct},$t=({name:e,control:l,label:a,readOnly:n,maxLength:r,badges:t,validate:i=[],parse:o=F=>F,className:N,description:d,isEdited:s,size:k="small",...R})=>{const{formState:{errors:F}}=Ne(),{field:P}=Ja({name:e,control:l,rules:{validate:h.useMemo(()=>Wa(i),[i])}});return n?Q.jsx(Yt,{size:k,label:a,value:P.value,type:"textarea",isEdited:s,hideLabel:R.hideLabel}):Q.jsxs("div",{className:t?Fn.textAreaFieldWithBadges:null,children:[t&&Q.jsx("div",{className:Fn.etikettWrapper,children:t.map(({type:y,titleText:m})=>Q.jsx(lr,{variant:y,size:"small",children:m},m))}),Q.jsx(mr,{size:k,label:a,description:d,className:N,autoComplete:"off",...P,onChange:y=>P.onChange(y.currentTarget.value!==""?o(y.currentTarget.value):null),value:P.value?P.value:"",error:Ra(F,e),maxLength:r,...R})]})},Wt=({formMethods:e,onSubmit:l,children:a,className:n,setDataOnUnmount:r})=>{const{handleSubmit:t,getValues:i}=e;return h.useEffect(()=>()=>{r&&r(i())},[]),Q.jsx(Lr,{...e,children:Q.jsx("form",{className:n,onSubmit:l?t(o=>l(o)):void 0,children:a})})},Zt=(e,l)=>{const{setError:a,clearErrors:n,formState:r}=Ne(),t=!!l;return h.useEffect(()=>{t&&a(`${e}.notRegisteredInput`,{type:"custom",message:l}),t||n(`${e}.notRegisteredInput`)},[l]),r.isSubmitted?e.split(".").reduce((i,o)=>i[o]||{},r.errors)?.notRegisteredInput?.message:void 0},zt=ml(3),Xt=Sl(2e3),re="aksjonspunktGodkjenning",Qt=(e,l)=>!e(`${re}.${l}.feilFakta`)&&!e(`${re}.${l}.feilLov`)&&!e(`${re}.${l}.feilSkjønn`)&&!e(`${re}.${l}.feilUtredning`)&&!e(`${re}.${l}.feilSaksflyt`)&&!e(`${re}.${l}.feilBegrunnelse`),tl=({index:e,totrinnskontrollSkjermlenkeContext:l,readOnly:a})=>{const{watch:n,getValues:r,control:t}=Ne(),i=n("aksjonspunktGodkjenning"),{aksjonspunktKode:o,totrinnskontrollGodkjent:N}=i[e],d=l.find(F=>F.totrinnskontrollAksjonspunkter.some(P=>P.aksjonspunktKode===o)),s=d?.totrinnskontrollAksjonspunkter.find(F=>F.aksjonspunktKode===o),k=!N&&Qt(r,e)?Nl():void 0,R=Zt(`${re}.${e}.faktagruppe`,k);return!d||!s?null:A.jsxs(Ae,{gap:"space-12",children:[A.jsx(Jt,{name:`${re}.${e}.totrinnskontrollGodkjent`,control:t,isReadOnly:a,hideLegend:!0,children:A.jsxs(Pe,{gap:"space-16",children:[A.jsx(en,{value:!0,size:"small",children:A.jsx(j,{id:"ApprovalField.Godkjent"})}),A.jsx(en,{value:!1,size:"small",children:A.jsx(j,{id:"ApprovalField.Vurder"})})]})}),N===!1&&A.jsx(Rt,{alignOffset:110,children:A.jsxs(Ae,{gap:"space-8",children:[A.jsx(Aa,{size:"small",children:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),A.jsx(ae,{size:"small",children:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),A.jsxs(Ae,{gap:"space-16",children:[A.jsx(Ae,{gap:"space-4",children:A.jsxs(Pe,{justify:"space-between",style:{width:"300px"},children:[A.jsxs(Ae,{gap:"space-4",children:[A.jsx(Ue,{name:`${re}.${e}.feilFakta`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:a}),A.jsx(Ue,{name:`${re}.${e}.feilSkjønn`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:a}),A.jsx(Ue,{name:`${re}.${e}.feilLov`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:a})]}),A.jsxs(Ae,{gap:"space-4",children:[A.jsx(Ue,{name:`${re}.${e}.feilUtredning`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:a}),A.jsx(Ue,{name:`${re}.${e}.feilSaksflyt`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:a}),A.jsx(Ue,{name:`${re}.${e}.feilBegrunnelse`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:a})]})]})}),R&&A.jsx(da,{size:"small",children:R}),A.jsx($t,{name:`${re}.${e}.besluttersBegrunnelse`,control:t,label:A.jsx(j,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[kl,zt,Xt,Kl],readOnly:a})]})]})})]})};tl.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| 'FAKTA_OM_UTTAK_DOKUMENTASJON'
| 'FAKTA_UTTAK'
| 'FAKTA_UTTAK_EØS'`,elements:[{name:"literal",value:"'ANKE_MERKNADER'"},{name:"literal",value:"'ANKE_VURDERING'"},{name:"literal",value:"'BEREGNING_ENGANGSSTOENAD'"},{name:"literal",value:"'BEREGNING_FORELDREPENGER'"},{name:"literal",value:"'BESTEBEREGNING'"},{name:"literal",value:"'FAKTA_FOR_OMSORG'"},{name:"literal",value:"'FAKTA_FOR_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_ADOPSJON'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON'"},{name:"literal",value:"'FAKTA_OM_BEREGNING'"},{name:"literal",value:"'FAKTA_OM_FOEDSEL'"},{name:"literal",value:"'FAKTA_OM_FORDELING'"},{name:"literal",value:"'FAKTA_OM_MEDLEMSKAP'"},{name:"literal",value:"'FAKTA_OM_OMSORG_OG_FORELDREANSVAR'"},{name:"literal",value:"'FAKTA_OM_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_SIMULERING'"},{name:"literal",value:"'FAKTA_OM_UTTAK'"},{name:"literal",value:"'FAKTA_OM_AKTIVITETSKRAV'"},{name:"literal",value:"'FAKTA_OMSORG_OG_RETT'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'FORMKRAV_KLAGE_KA'"},{name:"literal",value:"'FORMKRAV_KLAGE_NFP'"},{name:"literal",value:"'KLAGE_BEH_NFP'"},{name:"literal",value:"'KLAGE_BEH_NK'"},{name:"literal",value:"'KONTROLL_AV_SAKSOPPLYSNINGER'"},{name:"literal",value:"'OPPLYSNINGSPLIKT'"},{name:"literal",value:"'PUNKT_FOR_ADOPSJON'"},{name:"literal",value:"'PUNKT_FOR_FOEDSEL'"},{name:"literal",value:"'PUNKT_FOR_FORELDREANSVAR'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP_LØPENDE'"},{name:"literal",value:"'PUNKT_FOR_OMSORG'"},{name:"literal",value:"'PUNKT_FOR_OPPTJENING'"},{name:"literal",value:"'PUNKT_FOR_SVANGERSKAPSPENGER'"},{name:"literal",value:"'PUNKT_FOR_SVP_INNGANG'"},{name:"literal",value:"'SOEKNADSFRIST'"},{name:"literal",value:"'TILKJENT_YTELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'UTLAND'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'VURDER_FARESIGNALER'"},{name:"literal",value:"'FAKTA_OM_UTTAK_DOKUMENTASJON'"},{name:"literal",value:"'FAKTA_UTTAK'"},{name:"literal",value:"'FAKTA_UTTAK_EØS'"}]},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const _E=he(yl),AE=[ra.FAKTA_OM_FEILUTBETALING,ra.FORELDELSE,ra.TILBAKEKREVING,ra.VEDTAK],dE=e=>{const l=new Array;return e.feilFakta&&l.push("FEIL_FAKTA"),e.feilLov&&l.push("FEIL_LOV"),e.feilSkjønn&&l.push("SKJØNN"),e.feilUtredning&&l.push("UTREDNING"),e.feilSaksflyt&&l.push("SAKSFLYT"),e.feilBegrunnelse&&l.push("BEGRUNNELSE"),l},NE=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],ul=({behandling:e,location:l,fagsakYtelseType:a,readOnly:n,onSubmit:r,forhandsvisVedtaksbrev:t,alleKodeverk:i,createLocationForSkjermlenke:o,beslutterFormData:N,setBeslutterFormData:d})=>{const s=e.type==="BT-007"||e.type==="BT-009",k=I=>{const f=I.aksjonspunktGodkjenning.map(D=>({aksjonspunktKode:D.aksjonspunktKode,godkjent:!!D.totrinnskontrollGodkjent,begrunnelse:D.besluttersBegrunnelse,arsaker:dE(D)})),_=s?"5005":V.FATTER_VEDTAK;return r({fatterVedtakAksjonspunktDto:{"@type":_,kode:_,begrunnelse:void 0,aksjonspunktGodkjenningDtos:f},erAlleAksjonspunktGodkjent:I.aksjonspunktGodkjenning.every(D=>D.totrinnskontrollGodkjent)})},R=e.behandlingÅrsaker.map(({behandlingArsakType:I})=>I).some(I=>I==="ETTER_KLAGE"||I==="RE-KLAG-U-INNTK"||I==="RE-KLAG-M-INNTK"),F=s?AE.flatMap(I=>{const f=e.totrinnskontrollÅrsaker.find(_=>_.skjermlenkeType===I?.kode);return f?[f]:[]}):e.totrinnskontrollÅrsaker,P=I=>o(l,I),y=e.status==="FVED",m=i.SkjermlenkeType,p=i.VurderÅrsak,K=NE(i);return A.jsxs(Il,{value:_E,children:[y&&A.jsx(il,{behandling:e,totrinnskontrollSkjermlenkeContext:F,readOnly:n,onSubmit:k,forhandsvisVedtaksbrev:t,erForeldrepengerFagsak:a==="FP",skjemalenkeTyper:m,erBehandlingEtterKlage:R,faktaOmBeregningTilfeller:K,erTilbakekreving:s,lagLenke:P,beslutterFormData:N,setBeslutterFormData:d}),!y&&A.jsx(ol,{behandling:e,totrinnskontrollSkjermlenkeContext:F,erForeldrepengerFagsak:a==="FP",erTilbakekreving:s,skjemalenkeTyper:m,lagLenke:P,vurderArsaker:p,faktaOmBeregningTilfeller:K})]})};ul.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
