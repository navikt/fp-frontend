 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fr;function jl(){if(Fr)return Ze;Fr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,l){var i=null;if(l!==void 0&&(i=""+l),t.key!==void 0&&(i=""+t.key),"key"in t){l={};for(var s in t)s!=="key"&&(l[s]=t[s])}else l=t;return t=l.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:l}}return Ze.Fragment=a,Ze.jsx=n,Ze.jsxs=n,Ze}var Or;function hl(){return Or||(Or=1,fr.exports=jl()),fr.exports}var Q=hl();const nr=e=>e.reduce((a,n,r)=>({...a,[r]:t=>n(t)||!0}),{}),_n=(e,a)=>a.split(".").reduce((n,r)=>n!==void 0?n[r]:n,e)?.message,je=({label:e,validate:a=[],readOnly:n=!1,onChange:r,onClick:t,className:l,size:i="small",...s})=>{const{name:R,control:T,disabled:v}=s,{formState:{errors:S}}=Re(),{field:u}=Zn({name:R,control:T,rules:{validate:G.useMemo(()=>nr(a),[a])}}),p=_n(S,R);return Q.jsxs(Q.Fragment,{children:[Q.jsx(mt,{size:i,disabled:v||n,checked:u.value===!0,className:l,error:!!p,...u,onChange:c=>{u.onChange(c),r&&r(c.currentTarget.checked)},onClick:()=>{t&&t()},children:e}),p&&Q.jsx(Kn,{children:_n(S,R)})]})};var Cn={exports:{}},Ul=Cn.exports,Dr;function Bl(){return Dr||(Dr=1,function(e,a){(function(n,r){e.exports=r()})(Ul,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,t=/\d/,l=/\d\d/,i=/\d\d?/,s=/\d*[^-_:/,()\s\d]+/,R={},T=function(_){return(_=+_)+(_>68?1900:2e3)},v=function(_){return function(V){this[_]=+V}},S=[/[+-]\d\d:?(\d\d)?|Z/,function(_){(this.zone||(this.zone={})).offset=function(V){if(!V||V==="Z")return 0;var m=V.match(/([+-]|\d\d)/g),O=60*m[1]+(+m[2]||0);return O===0?0:m[0]==="+"?-O:O}(_)}],u=function(_){var V=R[_];return V&&(V.indexOf?V:V.s.concat(V.f))},p=function(_,V){var m,O=R.meridiem;if(O){for(var b=1;b<=24;b+=1)if(_.indexOf(O(b,0,V))>-1){m=b>12;break}}else m=_===(V?"pm":"PM");return m},c={A:[s,function(_){this.afternoon=p(_,!1)}],a:[s,function(_){this.afternoon=p(_,!0)}],Q:[t,function(_){this.month=3*(_-1)+1}],S:[t,function(_){this.milliseconds=100*+_}],SS:[l,function(_){this.milliseconds=10*+_}],SSS:[/\d{3}/,function(_){this.milliseconds=+_}],s:[i,v("seconds")],ss:[i,v("seconds")],m:[i,v("minutes")],mm:[i,v("minutes")],H:[i,v("hours")],h:[i,v("hours")],HH:[i,v("hours")],hh:[i,v("hours")],D:[i,v("day")],DD:[l,v("day")],Do:[s,function(_){var V=R.ordinal,m=_.match(/\d+/);if(this.day=m[0],V)for(var O=1;O<=31;O+=1)V(O).replace(/\[|\]/g,"")===_&&(this.day=O)}],w:[i,v("week")],ww:[l,v("week")],M:[i,v("month")],MM:[l,v("month")],MMM:[s,function(_){var V=u("months"),m=(u("monthsShort")||V.map(function(O){return O.slice(0,3)})).indexOf(_)+1;if(m<1)throw new Error;this.month=m%12||m}],MMMM:[s,function(_){var V=u("months").indexOf(_)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,v("year")],YY:[l,function(_){this.year=T(_)}],YYYY:[/\d{4}/,v("year")],Z:S,ZZ:S};function I(_){var V,m;V=_,m=R&&R.formats;for(var O=(_=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,P){var j=P&&P.toUpperCase();return x||m[P]||n[P]||m[j].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(B,Y,H){return Y||H.slice(1)})})).match(r),b=O.length,A=0;A<b;A+=1){var f=O[A],L=c[f],h=L&&L[0],U=L&&L[1];O[A]=U?{regex:h,parser:U}:f.replace(/^\[|\]$/g,"")}return function(w){for(var x={},P=0,j=0;P<b;P+=1){var B=O[P];if(typeof B=="string")j+=B.length;else{var Y=B.regex,H=B.parser,ee=w.slice(j),oe=Y.exec(ee)[0];H.call(x,oe),w=w.replace(oe,"")}}return function(ie){var me=ie.afternoon;if(me!==void 0){var ne=ie.hours;me?ne<12&&(ie.hours+=12):ne===12&&(ie.hours=0),delete ie.afternoon}}(x),x}}return function(_,V,m){m.p.customParseFormat=!0,_&&_.parseTwoDigitYear&&(T=_.parseTwoDigitYear);var O=V.prototype,b=O.parse;O.parse=function(A){var f=A.date,L=A.utc,h=A.args;this.$u=L;var U=h[1];if(typeof U=="string"){var w=h[2]===!0,x=h[3]===!0,P=w||x,j=h[2];x&&(j=h[2]),R=this.$locale(),!w&&j&&(R=m.Ls[j]),this.$d=function(ee,oe,ie,me){try{if(["x","X"].indexOf(oe)>-1)return new Date((oe==="X"?1e3:1)*ee);var ne=I(oe)(ee),we=ne.year,Fe=ne.month,Fn=ne.day,rn=ne.hours,On=ne.minutes,He=ne.seconds,an=ne.milliseconds,Ve=ne.zone,ce=ne.week,Ye=new Date,Pe=Fn||(we||Fe?1:Ye.getDate()),xe=we||Ye.getFullYear(),Oe=0;we&&!Fe||(Oe=Fe>0?Fe-1:Ye.getMonth());var De,Ce=rn||0,Je=On||0,tn=He||0,Ge=an||0;return Ve?new Date(Date.UTC(xe,Oe,Pe,Ce,Je,tn,Ge+60*Ve.offset*1e3)):ie?new Date(Date.UTC(xe,Oe,Pe,Ce,Je,tn,Ge)):(De=new Date(xe,Oe,Pe,Ce,Je,tn,Ge),ce&&(De=me(De).week(ce).toDate()),De)}catch{return new Date("")}}(f,U,L,m),this.init(),j&&j!==!0&&(this.$L=this.locale(j).$L),P&&f!=this.format(U)&&(this.$d=new Date("")),R={}}else if(U instanceof Array)for(var B=U.length,Y=1;Y<=B;Y+=1){h[1]=U[Y-1];var H=m.apply(this,h);if(H.isValid()){this.$d=H.$d,this.$L=H.$L,this.init();break}Y===B&&(this.$d=new Date(""))}else b.call(this,A)}}})}(Cn)),Cn.exports}var ql=Bl();const wl=Ml(ql),Hl="_textarea_14c7r_1",Yl="_readOnlyField_14c7r_7",Ir={textarea:Hl,readOnlyField:Yl},xl=e=>e!=null&&e!=="",Cl=({label:e,value:a,isEdited:n=!1,type:r,hideLabel:t,size:l})=>xl(a)?Q.jsxs(Te,{gap:"space-4",children:[e&&!t&&Q.jsx(yn,{size:l,children:e}),Q.jsxs(be,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(Br,{className:r==="textarea"?Ir.textarea:Ir.readOnlyField,size:l,children:a}),n&&Q.jsx(Ea,{})]})]}):null;Ka.extend(wl);const Jl=({label:e,description:a,validate:n=[],onChange:r,children:t,className:l,isReadOnly:i=!1,size:s="small",isEdited:R=!1,hideLegend:T=!1,...v})=>{const{name:S,control:u}=v,{formState:{errors:p}}=Re(),{field:c}=Zn({name:S,control:u,rules:{validate:nr(n)}});return Q.jsx(Nt,{name:S,value:c.value!==void 0?c.value:null,legend:Q.jsxs(be,{justify:"center",gap:"space-8",children:[e,i&&R&&Q.jsx(Ea,{})]}),hideLegend:T,disabled:i,description:a,size:s,error:_n(p,S),onChange:I=>{r&&r(I),c.onChange(I)},className:l,children:t})},$l="_textAreaFieldWithBadges_bdz0b_1",zl="_etikettWrapper_bdz0b_4",br={textAreaFieldWithBadges:$l,etikettWrapper:zl},Wl=({name:e,control:a,label:n,readOnly:r,maxLength:t,badges:l,validate:i=[],parse:s=p=>p,className:R,description:T,isEdited:v,size:S="small",...u})=>{const{formState:{errors:p}}=Re(),{field:c}=Zn({name:e,control:a,rules:{validate:G.useMemo(()=>nr(i),[i])}});return r?Q.jsx(Cl,{size:S,label:n,value:c.value,type:"textarea",isEdited:v,hideLabel:u.hideLabel}):Q.jsxs("div",{className:l?br.textAreaFieldWithBadges:null,children:[l&&Q.jsx("div",{className:br.etikettWrapper,children:l.map(({type:I,titleText:_})=>Q.jsx(Et,{variant:I,size:"small",children:_},_))}),Q.jsx(Ft,{size:S,label:n,description:T,className:R,autoComplete:"off",...c,onChange:I=>c.onChange(I.currentTarget.value!==""?s(I.currentTarget.value):null),value:c.value?c.value:"",error:_n(p,e),maxLength:t,...u})]})},Zl=({formMethods:e,onSubmit:a,children:n,className:r,setDataOnUnmount:t})=>{const{handleSubmit:l,getValues:i}=e;return G.useEffect(()=>()=>{t&&t(i())},[]),Q.jsx(It,{...e,children:Q.jsx("form",{className:r,onSubmit:a?l(s=>a(s)):void 0,children:n})})},Xl=(e,a)=>{const{setError:n,clearErrors:r,formState:t}=Re(),l=!!a;return G.useEffect(()=>{l&&n(`${e}.notRegisteredInput`,{type:"custom",message:a}),l||r(`${e}.notRegisteredInput`)},[a]),t.isSubmitted?e.split(".").reduce((i,s)=>i[s]||{},t.errors)?.notRegisteredInput?.message:void 0},Ql=fa(3),eo=Fa(2e3),ae="aksjonspunktGodkjenning",no=(e,a)=>!e(`${ae}.${a}.feilFakta`)&&!e(`${ae}.${a}.feilLov`)&&!e(`${ae}.${a}.feilSkjønn`)&&!e(`${ae}.${a}.feilUtredning`)&&!e(`${ae}.${a}.feilSaksflyt`)&&!e(`${ae}.${a}.feilBegrunnelse`),ua=({index:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n})=>{const{watch:r,getValues:t,control:l}=Re(),i=r("aksjonspunktGodkjenning"),{aksjonspunktKode:s,totrinnskontrollGodkjent:R}=i[e],T=a.find(p=>p.totrinnskontrollAksjonspunkter.some(c=>c.aksjonspunktKode===s)),v=T?.totrinnskontrollAksjonspunkter.find(p=>p.aksjonspunktKode===s),S=!R&&no(t,e)?pa():void 0,u=Xl(`${ae}.${e}.faktagruppe`,S);return!T||!v?null:g.jsxs(Te,{gap:"space-12",children:[g.jsx(Jl,{name:`${ae}.${e}.totrinnskontrollGodkjent`,control:l,isReadOnly:n,hideLegend:!0,children:g.jsxs(be,{gap:"space-16",children:[g.jsx(or,{value:!0,size:"small",children:g.jsx(q,{id:"ApprovalField.Godkjent"})}),g.jsx(or,{value:!1,size:"small",children:g.jsx(q,{id:"ApprovalField.Vurder"})})]})}),R===!1&&g.jsx(Nl,{alignOffset:R?1:110,children:g.jsxs(Te,{gap:"space-8",children:[g.jsx(yn,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),g.jsx(ue,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),g.jsxs(Te,{gap:"space-16",children:[g.jsx(Te,{gap:"space-4",children:g.jsxs(be,{justify:"space-between",style:{width:"300px"},children:[g.jsxs(Te,{gap:"space-4",children:[g.jsx(je,{name:`${ae}.${e}.feilFakta`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilSkjønn`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilLov`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),g.jsxs(Te,{gap:"space-4",children:[g.jsx(je,{name:`${ae}.${e}.feilUtredning`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilSaksflyt`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilBegrunnelse`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),u&&g.jsx(Kn,{size:"small",children:u}),g.jsx(Wl,{name:`${ae}.${e}.besluttersBegrunnelse`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[La,Ql,eo,Oa],readOnly:n})]})]})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  skjermlenkeType: SkjermlenkeType;
  totrinnskontrollAksjonspunkter: TotrinnskontrollAksjonspunkt[];
}>`}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ro="_aksjonspunktTextContainer_1pwmv_5",ao="_lenke_1pwmv_10",Vr={aksjonspunktTextContainer:ro,lenke:ao},to="aksjonspunktGodkjenning",va=({behandling:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n,erForeldrepengerFagsak:r,erTilbakekreving:t,skjemalenkeTyper:l,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const{control:R,watch:T}=Re(),{fields:v}=Jt({control:R,name:to}),S=T("aksjonspunktGodkjenning");return g.jsx(Te,{gap:"space-24",children:v.map((u,p)=>{const{aksjonspunktKode:c}=S[p],I=a.find(b=>b.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===c)),_=I?.totrinnskontrollAksjonspunkter.find(b=>b.aksjonspunktKode===c);if(!I||!_)return null;const V=da(r,e.status,i,t,_,e.behandlingsresultat),m=l.find(b=>b.kode===I.skjermlenkeType),O=s(I.skjermlenkeType);return g.jsxs("div",{children:[O&&m&&g.jsx(jr,{to:O,onClick:()=>window.scroll(0,0),className:Vr.lenke,children:m.navn}),V.map((b,A)=>g.jsx("div",{className:Vr.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:b})},c.concat("_".concat(A.toString())))),g.jsx(ua,{index:p,totrinnskontrollSkjermlenkeContext:a,readOnly:n})]},u.id)})})};va.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const so="_approvalItem_xqu47_1",ko="_approvalItemContainer_xqu47_7",Eo="_aksjonspunktTextContainer_xqu47_11",uo="_resultatFraGodkjenningTextContainer_xqu47_16",vo="_lenke_xqu47_20",To="_checkmarkIcon_xqu47_24",go="_xmark_xqu47_30",Ne={approvalItem:so,approvalItemContainer:ko,aksjonspunktTextContainer:Eo,resultatFraGodkjenningTextContainer:uo,lenke:vo,checkmarkIcon:To,xmark:go},Ao=({vurderPaNyttArsaker:e,vurderArsaker:a})=>g.jsx("div",{className:Ne.approvalItem,children:e?.map(n=>g.jsxs(be,{gap:"space-8",children:[g.jsx(et,{className:Ne.xmark}),g.jsx("div",{children:a.find(r=>n===r.kode)?.navn})]},n))}),ga=({behandling:e,totrinnskontrollSkjermlenkeContext:a,erForeldrepengerFagsak:n,erTilbakekreving:r,skjemalenkeTyper:t,vurderArsaker:l,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const R=Ia();return g.jsxs(g.Fragment,{children:[g.jsx("div",{className:Ne.resultatFraGodkjenningTextContainer,children:g.jsx(q,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:ba}})}),a.map(T=>{const v=T.totrinnskontrollAksjonspunkter,S=t.find(u=>u.kode===T.skjermlenkeType);if(v.length>0){const u=s(T.skjermlenkeType);return g.jsxs(E.Fragment,{children:[u&&S&&g.jsx(jr,{to:u,onClick:()=>window.scroll(0,0),className:Ne.lenke,children:S.navn}),v.map(p=>{const c=da(n,e.status,i,r,p,e.behandlingsresultat);return g.jsxs("div",{className:Ne.approvalItemContainer,children:[c.map((I,_)=>g.jsx("div",{className:Ne.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:I})},p.aksjonspunktKode.concat("_".concat(_.toString())))),g.jsx("div",{className:Ne.approvalItem,children:p.totrinnskontrollGodkjent?g.jsxs(be,{gap:"space-8",children:[g.jsx(Ca,{title:R.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:Ne.checkmarkIcon}),g.jsx(q,{id:"ToTrinnsForm.Godkjent"})]}):g.jsx(Ao,{vurderPaNyttArsaker:p?.vurderPaNyttArsaker,vurderArsaker:l})}),g.jsx("pre",{className:Ne.approvalItem,children:hr(p.besluttersBegrunnelse)})]},p.aksjonspunktKode)})]},T.skjermlenkeType)}return null})]})};ga.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
