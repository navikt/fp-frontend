...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean | null;
}>`}]},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:xn}=__STORYBOOK_MODULE_ACTIONS__,Hn={title:"sak/sak-totrinnskontroll-fatter-vedtak-modal",component:Ae,args:{closeEvent:xn("button-click")}},x={args:{behandling:{uuid:"1",status:V.FATTER_VEDTAK,type:v.FORSTEGANGSSOKNAD},allAksjonspunktApproved:!0}},F={args:{behandling:{uuid:"1",status:V.FATTER_VEDTAK,type:v.FORSTEGANGSSOKNAD,behandlingsresultat:{type:B.OPPHOR}},allAksjonspunktApproved:!0}},P={args:{behandling:{uuid:"1",status:V.FATTER_VEDTAK,type:v.KLAGE,behandlingsresultat:{type:B.OPPHOR}},allAksjonspunktApproved:!0}},G={args:{behandling:{uuid:"1",status:V.FATTER_VEDTAK,type:v.FORSTEGANGSSOKNAD,behandlingsresultat:{type:B.OPPHOR}},allAksjonspunktApproved:!1}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    behandling: {
      uuid: '1',
