...
`&&(w.value+=" ");const x=U.boxSizing,c=sn(U.paddingBottom)+sn(U.paddingTop),j=sn(U.borderBottomWidth)+sn(U.borderTopWidth),B=w.scrollHeight-c;w.value="x";const Y=w.scrollHeight-c;let H=B;s&&(H=Math.max(Number(s)*Y,H)),i&&(H=Math.min(Number(i)*Y,H)),H=Math.max(H,Y);const ee=H+(x==="border-box"?c+j:0),oe=Math.abs(H-B)<=1;return{outerHeightStyle:ee,overflow:oe}},[i,s,S.placeholder]),b=()=>{const L=O();dr(L)||R(h=>ir(h,L,_))};lr(()=>{const L=()=>{const c=O();dr(c)||ha.flushSync(()=>{R(j=>ir(j,c,_))})},h=Cr(()=>{var c,j,B;if(_.current=0,!((c=p.current)===null||c===void 0)&&c.style.height||!((j=p.current)===null||j===void 0)&&j.style.width){((B=p.current)===null||B===void 0?void 0:B.style.overflow)==="hidden"&&R(Y=>Object.assign(Object.assign({},Y),{overflow:!1}));return}L()},166,!0),U=p.current,w=sr(U);w.addEventListener("resize",h);let x;return typeof ResizeObserver<"u"&&(x=new ResizeObserver(h),x.observe(U)),()=>{h.clear(),w.removeEventListener("resize",h),x&&x.disconnect()}},[O]),lr(()=>{b()}),G.useEffect(()=>{_.current=0},[u]);const A=L=>{_.current=0,v||b(),l&&l(L)},f=Object.assign({"--__ac-textarea-height":V.outerHeightStyle+"px","--__axc-textarea-height":V.outerHeightStyle+"px",overflow:V.overflow&&!m&&!(!((n=p.current)===null||n===void 0)&&n.style.height)&&!(!((r=p.current)===null||r===void 0)&&r.style.width)?"hidden":void 0},T);return E.createElement(E.Fragment,null,E.createElement("textarea",Object.assign({value:u,onChange:A,ref:P,rows:s,style:f},S,{className:t})),E.createElement("textarea",{"aria-hidden":!0,className:t,readOnly:!0,ref:I,tabIndex:-1,style:Object.assign({visibility:"hidden",position:"absolute",overflow:"hidden",height:0,top:0,left:0,transform:"translateZ(0)"},T)}))});function dr(e){return e==null||Object.keys(e).length===0||e.outerHeightStyle===0&&!e.overflow}const ft=({maxLengthId:e,maxLength:a,currentLength:n,size:r,i18n:t})=>{const{cn:l}=Ae(),i=Ur("Textarea",{charsLeft:t?.counterLeft?`{chars} ${t.counterLeft}`:void 0,charsTooMany:t?.counterTooMuch?`{chars} ${t.counterTooMuch}`:void 0}),s=a-n,[m,T]=G.useState(s);return G.useEffect(()=>{const u=Cr(()=>{T(s)},2e3);return u(),()=>{u.clear()}},[s]),E.createElement(E.Fragment,null,E.createElement("span",{id:e,className:l("navds-sr-only")},i("maxLength",{maxLength:a})),s<20&&E.createElement("span",{role:"status",className:l("navds-textarea__sr-counter navds-sr-only")},kr(m,i)),E.createElement(ue,{className:l("navds-textarea__counter",{"navds-textarea__counter--error":s<0}),size:r},kr(s,i)))},kr=(e,a)=>e<0?a("charsTooMany",{chars:Math.abs(e)}):a("charsLeft",{chars:e});var Ft=function(e,a){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&a.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var t=0,r=Object.getOwnPropertySymbols(e);t<r.length;t++)a.indexOf(r[t])<0&&Object.prototype.propertyIsEnumerable.call(e,r[t])&&(n[r[t]]=e[r[t]]);return n};const Ot=G.forwardRef((e,a)=>{var n,r,t;const{inputProps:l,errorId:i,showErrorMsg:s,hasError:m,size:T,inputDescriptionId:u}=Sn(e,"textarea"),{label:S,className:v,description:p,maxLength:P,hideLabel:I=!1,resize:_,UNSAFE_autoScrollbar:V,i18n:R,readOnly:O}=e,b=Ft(e,["label","className","description","maxLength","hideLabel","resize","UNSAFE_autoScrollbar","i18n","readOnly"]),{cn:A}=Ae(),f=Hr(),L=P!==void 0&&P>0,[h,U]=G.useState((n=e?.defaultValue)!==null&&n!==void 0?n:""),w=()=>{let c=b?.minRows?b?.minRows:3;return T==="small"&&(c=b?.minRows?b?.minRows:2),c},x=Jn(l["aria-describedby"],{[f??""]:L});return E.createElement("div",{className:A(v,"navds-form-field",`navds-form-field--${T}`,{"navds-form-field--disabled":!!l.disabled,"navds-form-field--readonly":O,"navds-textarea--readonly":O,"navds-textarea--error":m,"navds-textarea--autoscrollbar":V,[`navds-textarea--resize-${_===!0?"both":_}`]:_})},E.createElement(yn,{htmlFor:l.id,size:T,className:A("navds-form-field__label",{"navds-sr-only":I})},O&&E.createElement(qr,null),S),!!p&&E.createElement(ue,{className:A("navds-form-field__description",{"navds-sr-only":I}),id:u,size:T,as:"div"},p),E.createElement(Lt,Object.assign({},fe(b,["error","errorId","size"]),l,{onChange:Ua(e.onChange,e.value===void 0?c=>U(c.target.value):void 0),minRows:w(),autoScrollbar:V,ref:a,readOnly:O,className:A("navds-textarea__input","navds-body-short",`navds-body-short--${T??"medium"}`)},x?{"aria-describedby":x}:{})),L&&!O&&!l.disabled&&E.createElement(ft,{maxLengthId:f,maxLength:P,currentLength:(t=(r=e.value)===null||r===void 0?void 0:r.length)!==null&&t!==void 0?t:h.length,size:T,i18n:R}),E.createElement("div",{className:A("navds-form-field__error"),id:i,"aria-relevant":"additions removals","aria-live":"polite"},s&&E.createElement(Kn,{size:T,showIcon:!0},e.error)))});var en=e=>e.type==="checkbox",Ie=e=>e instanceof Date,le=e=>e==null;const Wr=e=>typeof e=="object";var X=e=>!le(e)&&!Array.isArray(e)&&Wr(e)&&!Ie(e),Zr=e=>X(e)&&e.target?en(e.target)?e.target.checked:e.target.value:e,Dt=e=>e.substring(0,e.search(/\.\d+(\.|$)/))||e,Xr=(e,a)=>e.has(Dt(a)),It=e=>{const a=e.constructor&&e.constructor.prototype;return X(a)&&a.hasOwnProperty("isPrototypeOf")},$n=typeof window<"u"&&typeof window.HTMLElement<"u"&&typeof document<"u";function z(e){let a;const n=Array.isArray(e),r=typeof FileList<"u"?e instanceof FileList:!1;if(e instanceof Date)a=new Date(e);else if(!($n&&(e instanceof Blob||r))&&(n||X(e)))if(a=n?[]:Object.create(Object.getPrototypeOf(e)),!n&&!It(e))a=e;else for(const t in e)e.hasOwnProperty(t)&&(a[t]=z(e[t]));else return e;return a}var pn=e=>/^\w*$/.test(e),W=e=>e===void 0,Ln=e=>Array.isArray(e)?e.filter(Boolean):[],zn=e=>Ln(e.replace(/["|']|\]/g,"").split(/\.|\[/)),y=(e,a,n)=>{if(!a||!X(e))return n;const r=(pn(a)?[a]:zn(a)).reduce((t,l)=>le(t)?t:t[l],e);return W(r)||r===e?W(e[a])?n:e[a]:r},de=e=>typeof e=="boolean",J=(e,a,n)=>{let r=-1;const t=pn(a)?[a]:zn(a),l=t.length,i=l-1;for(;++r<l;){const s=t[r];let m=n;if(r!==i){const T=e[s];m=X(T)||Array.isArray(T)?T:isNaN(+t[r+1])?{}:[]}if(s==="__proto__"||s==="constructor"||s==="prototype")return;e[s]=m,e=e[s]}};const Tn={BLUR:"blur",FOCUS_OUT:"focusout",CHANGE:"change"},Ee={onBlur:"onBlur",onChange:"onChange",onSubmit:"onSubmit",onTouched:"onTouched",all:"all"},_e={max:"max",min:"min",maxLength:"maxLength",minLength:"minLength",pattern:"pattern",required:"required",validate:"validate"},Wn=E.createContext(null);Wn.displayName="HookFormContext";const Re=()=>E.useContext(Wn),bt=e=>{const{children:a,...n}=e;return E.createElement(Wn.Provider,{value:n},a)};var Qr=(e,a,n,r=!0)=>{const t={defaultValues:a._defaultValues};for(const l in e)Object.defineProperty(t,l,{get:()=>{const i=l;return a._proxyFormState[i]!==Ee.all&&(a._proxyFormState[i]=!r||Ee.all),n&&(n[i]=!0),e[i]}});return t};const fn=typeof window<"u"?E.useLayoutEffect:E.useEffect;function Vt(e){const a=Re(),{control:n=a.control,disabled:r,name:t,exact:l}=e||{},[i,s]=E.useState(n._formState),m=E.useRef({isDirty:!1,isLoading:!1,dirtyFields:!1,touchedFields:!1,validatingFields:!1,isValidating:!1,isValid:!1,errors:!1});return fn(()=>n._subscribe({name:t,formState:m.current,exact:l,callback:T=>{!r&&s({...n._formState,...T})}}),[t,r,l]),E.useEffect(()=>{m.current.isValid&&n._setValid(!0)},[n]),E.useMemo(()=>Qr(i,n,m.current,!1),[i,n])}var ge=e=>typeof e=="string",ea=(e,a,n,r,t)=>ge(e)?(r&&a.watch.add(e),y(n,e,t)):Array.isArray(e)?e.map(l=>(r&&a.watch.add(l),y(n,l))):(r&&(a.watchAll=!0),n),Hn=e=>le(e)||!Wr(e);function Se(e,a,n=new WeakSet){if(Hn(e)||Hn(a))return e===a;if(Ie(e)&&Ie(a))return e.getTime()===a.getTime();const r=Object.keys(e),t=Object.keys(a);if(r.length!==t.length)return!1;if(n.has(e)||n.has(a))return!0;n.add(e),n.add(a);for(const l of r){const i=e[l];if(!t.includes(l))return!1;if(l!=="ref"){const s=a[l];if(Ie(i)&&Ie(s)||X(i)&&X(s)||Array.isArray(i)&&Array.isArray(s)?!Se(i,s,n):i!==s)return!1}}return!0}function ct(e){const a=Re(),{control:n=a.control,name:r,defaultValue:t,disabled:l,exact:i,compute:s}=e||{},m=E.useRef(t),T=E.useRef(s),u=E.useRef(void 0);T.current=s;const S=E.useMemo(()=>n._getWatch(r,m.current),[n,r]),[v,p]=E.useState(T.current?T.current(S):S);return fn(()=>n._subscribe({name:r,formState:{values:!0},exact:i,callback:P=>{if(!l){const I=ea(r,n._names,P.values||n._formValues,!1,m.current);if(T.current){const _=T.current(I);Se(_,u.current)||(p(_),u.current=_)}else p(I)}}}),[n,l,r,i]),E.useEffect(()=>n._removeUnmounted()),v}function Zn(e){const a=Re(),{name:n,disabled:r,control:t=a.control,shouldUnregister:l,defaultValue:i}=e,s=Xr(t._names.array,n),m=E.useMemo(()=>y(t._formValues,n,y(t._defaultValues,n,i)),[t,n,i]),T=ct({control:t,name:n,defaultValue:m,exact:!0}),u=Vt({control:t,name:n,exact:!0}),S=E.useRef(e),v=E.useRef(t.register(n,{...e.rules,value:T,...de(e.disabled)?{disabled:e.disabled}:{}}));S.current=e;const p=E.useMemo(()=>Object.defineProperties({},{invalid:{enumerable:!0,get:()=>!!y(u.errors,n)},isDirty:{enumerable:!0,get:()=>!!y(u.dirtyFields,n)},isTouched:{enumerable:!0,get:()=>!!y(u.touchedFields,n)},isValidating:{enumerable:!0,get:()=>!!y(u.validatingFields,n)},error:{enumerable:!0,get:()=>y(u.errors,n)}}),[u,n]),P=E.useCallback(R=>v.current.onChange({target:{value:Zr(R),name:n},type:Tn.CHANGE}),[n]),I=E.useCallback(()=>v.current.onBlur({target:{value:y(t._formValues,n),name:n},type:Tn.BLUR}),[n,t._formValues]),_=E.useCallback(R=>{const O=y(t._fields,n);O&&R&&(O._f.ref={focus:()=>R.focus&&R.focus(),select:()=>R.select&&R.select(),setCustomValidity:b=>R.setCustomValidity(b),reportValidity:()=>R.reportValidity()})},[t._fields,n]),V=E.useMemo(()=>({name:n,value:T,...de(r)||u.disabled?{disabled:u.disabled||r}:{},onChange:P,onBlur:I,ref:_}),[n,r,u.disabled,P,I,_,T]);return E.useEffect(()=>{const R=t._options.shouldUnregister||l;t.register(n,{...S.current.rules,...de(S.current.disabled)?{disabled:S.current.disabled}:{}});const O=(b,A)=>{const f=y(t._fields,b);f&&f._f&&(f._f.mount=A)};if(O(n,!0),R){const b=z(y(t._options.defaultValues,n));J(t._defaultValues,n,b),W(y(t._formValues,n))&&J(t._formValues,n,b)}return!s&&t.register(n),()=>{(s?R&&!t._state.action:R)?t.unregister(n):O(n,!1)}},[n,t,s,l]),E.useEffect(()=>{t._setDisabledField({disabled:r,name:n})},[r,n,t]),E.useMemo(()=>({field:V,formState:u,fieldState:p}),[V,u,p])}var Pt=(e,a,n,r,t)=>a?{...n[e],types:{...n[e]&&n[e].types?n[e].types:{},[r]:t||!0}}:{},se=e=>Array.isArray(e)?e:[e],Er=()=>{let e=[];return{get observers(){return e},next:t=>{for(const l of e)l.next&&l.next(t)},subscribe:t=>(e.push(t),{unsubscribe:()=>{e=e.filter(l=>l!==t)}}),unsubscribe:()=>{e=[]}}},re=e=>X(e)&&!Object.keys(e).length,Xn=e=>e.type==="file",ve=e=>typeof e=="function",gn=e=>{if(!$n)return!1;const a=e?e.ownerDocument:0;return e instanceof(a&&a.defaultView?a.defaultView.HTMLElement:HTMLElement)},na=e=>e.type==="select-multiple",Qn=e=>e.type==="radio",Gt=e=>Qn(e)||en(e),bn=e=>gn(e)&&e.isConnected;function Mt(e,a){const n=a.slice(0,-1).length;let r=0;for(;r<n;)e=W(e)?r++:e[a[r++]];return e}function jt(e){for(const a in e)if(e.hasOwnProperty(a)&&!W(e[a]))return!1;return!0}function Z(e,a){const n=Array.isArray(a)?a:pn(a)?[a]:zn(a),r=n.length===1?e:Mt(e,n),t=n.length-1,l=n[t];return r&&delete r[l],t!==0&&(X(r)&&re(r)||Array.isArray(r)&&jt(r))&&Z(e,n.slice(0,-1)),e}var ra=e=>{for(const a in e)if(ve(e[a]))return!0;return!1};function An(e,a={}){const n=Array.isArray(e);if(X(e)||n)for(const r in e)Array.isArray(e[r])||X(e[r])&&!ra(e[r])?(a[r]=Array.isArray(e[r])?[]:{},An(e[r],a[r])):le(e[r])||(a[r]=!0);return a}function aa(e,a,n){const r=Array.isArray(e);if(X(e)||r)for(const t in e)Array.isArray(e[t])||X(e[t])&&!ra(e[t])?W(a)||Hn(n[t])?n[t]=Array.isArray(e[t])?An(e[t],[]):{...An(e[t])}:aa(e[t],le(a)?{}:a[t],n[t]):n[t]=!Se(e[t],a[t]);return n}var $e=(e,a)=>aa(e,a,An(a));const ur={value:!1,isValid:!1},vr={value:!0,isValid:!0};var ta=e=>{if(Array.isArray(e)){if(e.length>1){const a=e.filter(n=>n&&n.checked&&!n.disabled).map(n=>n.value);return{value:a,isValid:!!a.length}}return e[0].checked&&!e[0].disabled?e[0].attributes&&!W(e[0].attributes.value)?W(e[0].value)||e[0].value===""?vr:{value:e[0].value,isValid:!0}:vr:ur}return ur},la=(e,{valueAsNumber:a,valueAsDate:n,setValueAs:r})=>W(e)?e:a?e===""?NaN:e&&+e:n&&ge(e)?new Date(e):r?r(e):e;const Tr={isValid:!1,value:null};var oa=e=>Array.isArray(e)?e.reduce((a,n)=>n&&n.checked&&!n.disabled?{isValid:!0,value:n.value}:a,Tr):Tr;function gr(e){const a=e.ref;return Xn(a)?a.files:Qn(a)?oa(e.refs).value:na(a)?[...a.selectedOptions].map(({value:n})=>n):en(a)?ta(e.refs).value:la(W(a.value)?e.ref.value:a.value,e)}var ht=(e,a,n,r)=>{const t={};for(const l of e){const i=y(a,l);i&&J(t,l,i._f)}return{criteriaMode:n,names:[...e],fields:t,shouldUseNativeValidation:r}},Rn=e=>e instanceof RegExp,ze=e=>W(e)?e:Rn(e)?e.source:X(e)?Rn(e.value)?e.value.source:e.value:e,he=e=>({isOnSubmit:!e||e===Ee.onSubmit,isOnBlur:e===Ee.onBlur,isOnChange:e===Ee.onChange,isOnAll:e===Ee.all,isOnTouch:e===Ee.onTouched});const Ar="AsyncFunction";var Ut=e=>!!e&&!!e.validate&&!!(ve(e.validate)&&e.validate.constructor.name===Ar||X(e.validate)&&Object.values(e.validate).find(a=>a.constructor.name===Ar)),Bt=e=>e.mount&&(e.required||e.min||e.max||e.maxLength||e.minLength||e.pattern||e.validate),Yn=(e,a,n)=>!n&&(a.watchAll||a.watch.has(e)||[...a.watch].some(r=>e.startsWith(r)&&/^\.\w+/.test(e.slice(r.length))));const Ue=(e,a,n,r)=>{for(const t of n||Object.keys(e)){const l=y(e,t);if(l){const{_f:i,...s}=l;if(i){if(i.refs&&i.refs[0]&&a(i.refs[0],t)&&!r)return!0;if(i.ref&&a(i.ref,i.name)&&!r)return!0;if(Ue(s,a))break}else if(X(s)&&Ue(s,a))break}}};function Rr(e,a,n){const r=y(e,n);if(r||pn(n))return{error:r,name:n};const t=n.split(".");for(;t.length;){const l=t.join("."),i=y(a,l),s=y(e,l);if(i&&!Array.isArray(i)&&n!==l)return{name:n};if(s&&s.type)return{name:l,error:s};if(s&&s.root&&s.root.type)return{name:`${l}.root`,error:s.root};t.pop()}return{name:n}}var qt=(e,a,n,r)=>{n(e);const{name:t,...l}=e;return re(l)||Object.keys(l).length>=Object.keys(a).length||Object.keys(l).find(i=>a[i]===(!r||Ee.all))},wt=(e,a,n)=>!e||!a||e===a||se(e).some(r=>r&&(n?r===a:r.startsWith(a)||a.startsWith(r))),Ht=(e,a,n,r,t)=>t.isOnAll?!1:!n&&t.isOnTouch?!(a||e):(n?r.isOnBlur:t.isOnBlur)?!e:(n?r.isOnChange:t.isOnChange)?e:!0,Yt=(e,a)=>!Ln(y(e,a)).length&&Z(e,a),ia=(e,a,n)=>{const r=se(y(e,n));return J(r,"root",a[n]),J(e,n,r),e},un=e=>ge(e);function mr(e,a,n="validate"){if(un(e)||Array.isArray(e)&&e.every(un)||de(e)&&!e)return{type:n,message:un(e)?e:"",ref:a}}var Me=e=>X(e)&&!Rn(e)?e:{value:e,message:""},xn=async(e,a,n,r,t,l)=>{const{ref:i,refs:s,required:m,maxLength:T,minLength:u,min:S,max:v,pattern:p,validate:P,name:I,valueAsNumber:_,mount:V}=e._f,R=y(n,I);if(!V||a.has(I))return{};const O=s?s[0]:i,b=c=>{t&&O.reportValidity&&(O.setCustomValidity(de(c)?"":c||""),O.reportValidity())},A={},f=Qn(i),L=en(i),h=f||L,U=(_||Xn(i))&&W(i.value)&&W(R)||gn(i)&&i.value===""||R===""||Array.isArray(R)&&!R.length,w=Pt.bind(null,I,r,A),x=(c,j,B,Y=_e.maxLength,H=_e.minLength)=>{const ee=c?j:B;A[I]={type:c?Y:H,message:ee,ref:i,...w(c?Y:H,ee)}};if(l?!Array.isArray(R)||!R.length:m&&(!h&&(U||le(R))||de(R)&&!R||L&&!ta(s).isValid||f&&!oa(s).isValid)){const{value:c,message:j}=un(m)?{value:!!m,message:m}:Me(m);if(c&&(A[I]={type:_e.required,message:j,ref:O,...w(_e.required,j)},!r))return b(j),A}if(!U&&(!le(S)||!le(v))){let c,j;const B=Me(v),Y=Me(S);if(!le(R)&&!isNaN(R)){const H=i.valueAsNumber||R&&+R;le(B.value)||(c=H>B.value),le(Y.value)||(j=H<Y.value)}else{const H=i.valueAsDate||new Date(R),ee=me=>new Date(new Date().toDateString()+" "+me),oe=i.type=="time",ie=i.type=="week";ge(B.value)&&R&&(c=oe?ee(R)>ee(B.value):ie?R>B.value:H>new Date(B.value)),ge(Y.value)&&R&&(j=oe?ee(R)<ee(Y.value):ie?R<Y.value:H<new Date(Y.value))}if((c||j)&&(x(!!c,B.message,Y.message,_e.max,_e.min),!r))return b(A[I].message),A}if((T||u)&&!U&&(ge(R)||l&&Array.isArray(R))){const c=Me(T),j=Me(u),B=!le(c.value)&&R.length>+c.value,Y=!le(j.value)&&R.length<+j.value;if((B||Y)&&(x(B,c.message,j.message),!r))return b(A[I].message),A}if(p&&!U&&ge(R)){const{value:c,message:j}=Me(p);if(Rn(c)&&!R.match(c)&&(A[I]={type:_e.pattern,message:j,ref:i,...w(_e.pattern,j)},!r))return b(j),A}if(P){if(ve(P)){const c=await P(R,n),j=mr(c,O);if(j&&(A[I]={...j,...w(_e.validate,j.message)},!r))return b(j.message),A}else if(X(P)){let c={};for(const j in P){if(!re(c)&&!r)break;const B=mr(await P[j](R,n),O,j);B&&(c={...B,...w(j,B.message)},b(B.message),r&&(A[I]=c))}if(!re(c)&&(A[I]={ref:O,...c},!r))return A}}return b(!0),A};const xt={mode:Ee.onSubmit,reValidateMode:Ee.onChange,shouldFocusError:!0};function Ct(e={}){let a={...xt,...e},n={submitCount:0,isDirty:!1,isReady:!1,isLoading:ve(a.defaultValues),isValidating:!1,isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,touchedFields:{},dirtyFields:{},validatingFields:{},errors:a.errors||{},disabled:a.disabled||!1},r={},t=X(a.defaultValues)||X(a.values)?z(a.defaultValues||a.values)||{}:{},l=a.shouldUnregister?{}:z(t),i={action:!1,mount:!1,watch:!1},s={mount:new Set,disabled:new Set,unMount:new Set,array:new Set,watch:new Set},m,T=0;const u={isDirty:!1,dirtyFields:!1,validatingFields:!1,touchedFields:!1,isValidating:!1,isValid:!1,errors:!1};let S={...u};const v={array:Er(),state:Er()},p=a.criteriaMode===Ee.all,P=o=>d=>{clearTimeout(T),T=setTimeout(o,d)},I=async o=>{if(!a.disabled&&(u.isValid||S.isValid||o)){const d=a.resolver?re((await L()).errors):await U(r,!0);d!==n.isValid&&v.state.next({isValid:d})}},_=(o,d)=>{!a.disabled&&(u.isValidating||u.validatingFields||S.isValidating||S.validatingFields)&&((o||Array.from(s.mount)).forEach(k=>{k&&(d?J(n.validatingFields,k,d):Z(n.validatingFields,k))}),v.state.next({validatingFields:n.validatingFields,isValidating:!re(n.validatingFields)}))},V=(o,d=[],k,F,K=!0,N=!0)=>{if(F&&k&&!a.disabled){if(i.action=!0,N&&Array.isArray(y(r,o))){const M=k(y(r,o),F.argA,F.argB);K&&J(r,o,M)}if(N&&Array.isArray(y(n.errors,o))){const M=k(y(n.errors,o),F.argA,F.argB);K&&J(n.errors,o,M),Yt(n.errors,o)}if((u.touchedFields||S.touchedFields)&&N&&Array.isArray(y(n.touchedFields,o))){const M=k(y(n.touchedFields,o),F.argA,F.argB);K&&J(n.touchedFields,o,M)}(u.dirtyFields||S.dirtyFields)&&(n.dirtyFields=$e(t,l)),v.state.next({name:o,isDirty:x(o,d),dirtyFields:n.dirtyFields,errors:n.errors,isValid:n.isValid})}else J(l,o,d)},R=(o,d)=>{J(n.errors,o,d),v.state.next({errors:n.errors})},O=o=>{n.errors=o,v.state.next({errors:n.errors,isValid:!1})},b=(o,d,k,F)=>{const K=y(r,o);if(K){const N=y(l,o,W(k)?y(t,o):k);W(N)||F&&F.defaultChecked||d?J(l,o,d?N:gr(K._f)):B(o,N),i.mount&&I()}},A=(o,d,k,F,K)=>{let N=!1,M=!1;const C={name:o};if(!a.disabled){if(!k||F){(u.isDirty||S.isDirty)&&(M=n.isDirty,n.isDirty=C.isDirty=x(),N=M!==C.isDirty);const $=Se(y(t,o),d);M=!!y(n.dirtyFields,o),$?Z(n.dirtyFields,o):J(n.dirtyFields,o,!0),C.dirtyFields=n.dirtyFields,N=N||(u.dirtyFields||S.dirtyFields)&&M!==!$}if(k){const $=y(n.touchedFields,o);$||(J(n.touchedFields,o,k),C.touchedFields=n.touchedFields,N=N||(u.touchedFields||S.touchedFields)&&$!==k)}N&&K&&v.state.next(C)}return N?C:{}},f=(o,d,k,F)=>{const K=y(n.errors,o),N=(u.isValid||S.isValid)&&de(d)&&n.isValid!==d;if(a.delayError&&k?(m=P(()=>R(o,k)),m(a.delayError)):(clearTimeout(T),m=null,k?J(n.errors,o,k):Z(n.errors,o)),(k?!Se(K,k):K)||!re(F)||N){const M={...F,...N&&de(d)?{isValid:d}:{},errors:n.errors,name:o};n={...n,...M},v.state.next(M)}},L=async o=>{_(o,!0);const d=await a.resolver(l,a.context,ht(o||s.mount,r,a.criteriaMode,a.shouldUseNativeValidation));return _(o),d},h=async o=>{const{errors:d}=await L(o);if(o)for(const k of o){const F=y(d,k);F?J(n.errors,k,F):Z(n.errors,k)}else n.errors=d;return d},U=async(o,d,k={valid:!0})=>{for(const F in o){const K=o[F];if(K){const{_f:N,...M}=K;if(N){const C=s.array.has(N.name),$=K._f&&Ut(K._f);$&&u.validatingFields&&_([F],!0);const ke=await xn(K,s.disabled,l,p,a.shouldUseNativeValidation&&!d,C);if($&&u.validatingFields&&_([F]),ke[N.name]&&(k.valid=!1,d))break;!d&&(y(ke,N.name)?C?ia(n.errors,ke,N.name):J(n.errors,N.name,ke[N.name]):Z(n.errors,N.name))}!re(M)&&await U(M,d,k)}}return k.valid},w=()=>{for(const o of s.unMount){const d=y(r,o);d&&(d._f.refs?d._f.refs.every(k=>!bn(k)):!bn(d._f.ref))&&He(o)}s.unMount=new Set},x=(o,d)=>!a.disabled&&(o&&d&&J(l,o,d),!Se(me(),t)),c=(o,d,k)=>ea(o,s,{...i.mount?l:W(d)?t:ge(o)?{[o]:d}:d},k,d),j=o=>Ln(y(i.mount?l:t,o,a.shouldUnregister?y(t,o,[]):[])),B=(o,d,k={})=>{const F=y(r,o);let K=d;if(F){const N=F._f;N&&(!N.disabled&&J(l,o,la(d,N)),K=gn(N.ref)&&le(d)?"":d,na(N.ref)?[...N.ref.options].forEach(M=>M.selected=K.includes(M.value)):N.refs?en(N.ref)?N.refs.forEach(M=>{(!M.defaultChecked||!M.disabled)&&(Array.isArray(K)?M.checked=!!K.find(C=>C===M.value):M.checked=K===M.value||!!K)}):N.refs.forEach(M=>M.checked=M.value===K):Xn(N.ref)?N.ref.value="":(N.ref.value=K,N.ref.type||v.state.next({name:o,values:z(l)})))}(k.shouldDirty||k.shouldTouch)&&A(o,K,k.shouldTouch,k.shouldDirty,!0),k.shouldValidate&&ie(o)},Y=(o,d,k)=>{for(const F in d){if(!d.hasOwnProperty(F))return;const K=d[F],N=o+"."+F,M=y(r,N);(s.array.has(o)||X(K)||M&&!M._f)&&!Ie(K)?Y(N,K,k):B(N,K,k)}},H=(o,d,k={})=>{const F=y(r,o),K=s.array.has(o),N=z(d);J(l,o,N),K?(v.array.next({name:o,values:z(l)}),(u.isDirty||u.dirtyFields||S.isDirty||S.dirtyFields)&&k.shouldDirty&&v.state.next({name:o,dirtyFields:$e(t,l),isDirty:x(o,N)})):F&&!F._f&&!le(N)?Y(o,N,k):B(o,N,k),Yn(o,s)&&v.state.next({...n,name:o}),v.state.next({name:i.mount?o:void 0,values:z(l)})},ee=async o=>{i.mount=!0;const d=o.target;let k=d.name,F=!0;const K=y(r,k),N=$=>{F=Number.isNaN($)||Ie($)&&isNaN($.getTime())||Se($,y(l,k,$))},M=he(a.mode),C=he(a.reValidateMode);if(K){let $,ke;const ln=d.type?gr(K._f):Zr(o),Ke=o.type===Tn.BLUR||o.type===Tn.FOCUS_OUT,ma=!Bt(K._f)&&!a.resolver&&!y(n.errors,k)&&!K._f.deps||Ht(Ke,y(n.touchedFields,k),n.isSubmitted,C,M),Dn=Yn(k,s,Ke);J(l,k,ln),Ke?(!d||!d.readOnly)&&(K._f.onBlur&&K._f.onBlur(o),m&&m(0)):K._f.onChange&&K._f.onChange(o);const In=A(k,ln,Ke),_a=!re(In)||Dn;if(!Ke&&v.state.next({name:k,type:o.type,values:z(l)}),ma)return(u.isValid||S.isValid)&&(a.mode==="onBlur"?Ke&&I():Ke||I()),_a&&v.state.next({name:k,...Dn?{}:In});if(!Ke&&Dn&&v.state.next({...n}),a.resolver){const{errors:rr}=await L([k]);if(N(ln),F){const Na=Rr(n.errors,r,k),ar=Rr(rr,r,Na.name||k);$=ar.error,k=ar.name,ke=re(rr)}}else _([k],!0),$=(await xn(K,s.disabled,l,p,a.shouldUseNativeValidation))[k],_([k]),N(ln),F&&($?ke=!1:(u.isValid||S.isValid)&&(ke=await U(r,!0)));F&&(K._f.deps&&ie(K._f.deps),f(k,ke,$,In))}},oe=(o,d)=>{if(y(n.errors,d)&&o.focus)return o.focus(),1},ie=async(o,d={})=>{let k,F;const K=se(o);if(a.resolver){const N=await h(W(o)?o:K);k=re(N),F=o?!K.some(M=>y(N,M)):k}else o?(F=(await Promise.all(K.map(async N=>{const M=y(r,N);return await U(M&&M._f?{[N]:M}:M)}))).every(Boolean),!(!F&&!n.isValid)&&I()):F=k=await U(r);return v.state.next({...!ge(o)||(u.isValid||S.isValid)&&k!==n.isValid?{}:{name:o},...a.resolver||!o?{isValid:k}:{},errors:n.errors}),d.shouldFocus&&!F&&Ue(r,oe,o?K:s.mount),F},me=o=>{const d={...i.mount?l:t};return W(o)?d:ge(o)?y(d,o):o.map(k=>y(d,k))},ne=(o,d)=>({invalid:!!y((d||n).errors,o),isDirty:!!y((d||n).dirtyFields,o),error:y((d||n).errors,o),isValidating:!!y(n.validatingFields,o),isTouched:!!y((d||n).touchedFields,o)}),we=o=>{o&&se(o).forEach(d=>Z(n.errors,d)),v.state.next({errors:o?n.errors:{}})},Fe=(o,d,k)=>{const F=(y(r,o,{_f:{}})._f||{}).ref,K=y(n.errors,o)||{},{ref:N,message:M,type:C,...$}=K;J(n.errors,o,{...$,...d,ref:F}),v.state.next({name:o,errors:n.errors,isValid:!1}),k&&k.shouldFocus&&F&&F.focus&&F.focus()},Fn=(o,d)=>ve(o)?v.state.subscribe({next:k=>"values"in k&&o(c(void 0,d),k)}):c(o,d,!0),rn=o=>v.state.subscribe({next:d=>{wt(o.name,d.name,o.exact)&&qt(d,o.formState||u,Je,o.reRenderRoot)&&o.callback({values:{...l},...n,...d,defaultValues:t})}}).unsubscribe,On=o=>(i.mount=!0,S={...S,...o.formState},rn({...o,formState:S})),He=(o,d={})=>{for(const k of o?se(o):s.mount)s.mount.delete(k),s.array.delete(k),d.keepValue||(Z(r,k),Z(l,k)),!d.keepError&&Z(n.errors,k),!d.keepDirty&&Z(n.dirtyFields,k),!d.keepTouched&&Z(n.touchedFields,k),!d.keepIsValidating&&Z(n.validatingFields,k),!a.shouldUnregister&&!d.keepDefaultValue&&Z(t,k);v.state.next({values:z(l)}),v.state.next({...n,...d.keepDirty?{isDirty:x()}:{}}),!d.keepIsValid&&I()},an=({disabled:o,name:d})=>{(de(o)&&i.mount||o||s.disabled.has(d))&&(o?s.disabled.add(d):s.disabled.delete(d))},Ve=(o,d={})=>{let k=y(r,o);const F=de(d.disabled)||de(a.disabled);return J(r,o,{...k||{},_f:{...k&&k._f?k._f:{ref:{name:o}},name:o,mount:!0,...d}}),s.mount.add(o),k?an({disabled:de(d.disabled)?d.disabled:a.disabled,name:o}):b(o,!0,d.value),{...F?{disabled:d.disabled||a.disabled}:{},...a.progressive?{required:!!d.required,min:ze(d.min),max:ze(d.max),minLength:ze(d.minLength),maxLength:ze(d.maxLength),pattern:ze(d.pattern)}:{},name:o,onChange:ee,onBlur:ee,ref:K=>{if(K){Ve(o,d),k=y(r,o);const N=W(K.value)&&K.querySelectorAll&&K.querySelectorAll("input,select,textarea")[0]||K,M=Gt(N),C=k._f.refs||[];if(M?C.find($=>$===N):N===k._f.ref)return;J(r,o,{_f:{...k._f,...M?{refs:[...C.filter(bn),N,...Array.isArray(y(t,o))?[{}]:[]],ref:{type:N.type,name:o}}:{ref:N}}}),b(o,!1,void 0,N)}else k=y(r,o,{}),k._f&&(k._f.mount=!1),(a.shouldUnregister||d.shouldUnregister)&&!(Xr(s.array,o)&&i.action)&&s.unMount.add(o)}}},ce=()=>a.shouldFocusError&&Ue(r,oe,s.mount),Ye=o=>{de(o)&&(v.state.next({disabled:o}),Ue(r,(d,k)=>{const F=y(r,k);F&&(d.disabled=F._f.disabled||o,Array.isArray(F._f.refs)&&F._f.refs.forEach(K=>{K.disabled=F._f.disabled||o}))},0,!1))},Pe=(o,d)=>async k=>{let F;k&&(k.preventDefault&&k.preventDefault(),k.persist&&k.persist());let K=z(l);if(v.state.next({isSubmitting:!0}),a.resolver){const{errors:N,values:M}=await L();n.errors=N,K=z(M)}else await U(r);if(s.disabled.size)for(const N of s.disabled)Z(K,N);if(Z(n.errors,"root"),re(n.errors)){v.state.next({errors:{}});try{await o(K,k)}catch(N){F=N}}else d&&await d({...n.errors},k),ce(),setTimeout(ce);if(v.state.next({isSubmitted:!0,isSubmitting:!1,isSubmitSuccessful:re(n.errors)&&!F,submitCount:n.submitCount+1,errors:n.errors}),F)throw F},xe=(o,d={})=>{y(r,o)&&(W(d.defaultValue)?H(o,z(y(t,o))):(H(o,d.defaultValue),J(t,o,z(d.defaultValue))),d.keepTouched||Z(n.touchedFields,o),d.keepDirty||(Z(n.dirtyFields,o),n.isDirty=d.defaultValue?x(o,z(y(t,o))):x()),d.keepError||(Z(n.errors,o),u.isValid&&I()),v.state.next({...n}))},Oe=(o,d={})=>{const k=o?z(o):t,F=z(k),K=re(o),N=K?t:F;if(d.keepDefaultValues||(t=k),!d.keepValues){if(d.keepDirtyValues){const M=new Set([...s.mount,...Object.keys($e(t,l))]);for(const C of Array.from(M))y(n.dirtyFields,C)?J(N,C,y(l,C)):H(C,y(N,C))}else{if($n&&W(o))for(const M of s.mount){const C=y(r,M);if(C&&C._f){const $=Array.isArray(C._f.refs)?C._f.refs[0]:C._f.ref;if(gn($)){const ke=$.closest("form");if(ke){ke.reset();break}}}}if(d.keepFieldsRef)for(const M of s.mount)H(M,y(N,M));else r={}}l=a.shouldUnregister?d.keepDefaultValues?z(t):{}:z(N),v.array.next({values:{...N}}),v.state.next({values:{...N}})}s={mount:d.keepDirtyValues?s.mount:new Set,unMount:new Set,array:new Set,disabled:new Set,watch:new Set,watchAll:!1,focus:""},i.mount=!u.isValid||!!d.keepIsValid||!!d.keepDirtyValues,i.watch=!!a.shouldUnregister,v.state.next({submitCount:d.keepSubmitCount?n.submitCount:0,isDirty:K?!1:d.keepDirty?n.isDirty:!!(d.keepDefaultValues&&!Se(o,t)),isSubmitted:d.keepIsSubmitted?n.isSubmitted:!1,dirtyFields:K?{}:d.keepDirtyValues?d.keepDefaultValues&&l?$e(t,l):n.dirtyFields:d.keepDefaultValues&&o?$e(t,o):d.keepDirty?n.dirtyFields:{},touchedFields:d.keepTouched?n.touchedFields:{},errors:d.keepErrors?n.errors:{},isSubmitSuccessful:d.keepIsSubmitSuccessful?n.isSubmitSuccessful:!1,isSubmitting:!1,defaultValues:t})},De=(o,d)=>Oe(ve(o)?o(l):o,d),Ce=(o,d={})=>{const k=y(r,o),F=k&&k._f;if(F){const K=F.refs?F.refs[0]:F.ref;K.focus&&(K.focus(),d.shouldSelect&&ve(K.select)&&K.select())}},Je=o=>{n={...n,...o}},Ge={control:{register:Ve,unregister:He,getFieldState:ne,handleSubmit:Pe,setError:Fe,_subscribe:rn,_runSchema:L,_focusError:ce,_getWatch:c,_getDirty:x,_setValid:I,_setFieldArray:V,_setDisabledField:an,_setErrors:O,_getFieldArray:j,_reset:Oe,_resetDefaultValues:()=>ve(a.defaultValues)&&a.defaultValues().then(o=>{De(o,a.resetOptions),v.state.next({isLoading:!1})}),_removeUnmounted:w,_disableForm:Ye,_subjects:v,_proxyFormState:u,get _fields(){return r},get _formValues(){return l},get _state(){return i},set _state(o){i=o},get _defaultValues(){return t},get _names(){return s},set _names(o){s=o},get _formState(){return n},get _options(){return a},set _options(o){a={...a,...o}}},subscribe:On,trigger:ie,register:Ve,handleSubmit:Pe,watch:Fn,setValue:H,getValues:me,reset:De,resetField:xe,clearErrors:we,unregister:He,setError:Fe,setFocus:Ce,getFieldState:ne};return{...Ge,formControl:Ge}}var pe=()=>{if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID();const e=typeof performance>"u"?Date.now():performance.now()*1e3;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{const n=(Math.random()*16+e)%16|0;return(a=="x"?n:n&3|8).toString(16)})},Vn=(e,a,n={})=>n.shouldFocus||W(n.shouldFocus)?n.focusName||`${e}.${W(n.focusIndex)?a:n.focusIndex}.`:"",cn=(e,a)=>[...e,...se(a)],Pn=e=>Array.isArray(e)?e.map(()=>{}):void 0;function Gn(e,a,n){return[...e.slice(0,a),...se(n),...e.slice(a)]}var Mn=(e,a,n)=>Array.isArray(e)?(W(e[n])&&(e[n]=void 0),e.splice(n,0,e.splice(a,1)[0]),e):[],jn=(e,a)=>[...se(a),...se(e)];function Jt(e,a){let n=0;const r=[...e];for(const t of a)r.splice(t-n,1),n++;return Ln(r).length?r:[]}var hn=(e,a)=>W(a)?[]:Jt(e,se(a).sort((n,r)=>n-r)),Un=(e,a,n)=>{[e[a],e[n]]=[e[n],e[a]]},_r=(e,a,n)=>(e[a]=n,e);function $t(e){const a=Re(),{control:n=a.control,name:r,keyName:t="id",shouldUnregister:l,rules:i}=e,[s,m]=E.useState(n._getFieldArray(r)),T=E.useRef(n._getFieldArray(r).map(pe)),u=E.useRef(s),S=E.useRef(!1);u.current=s,n._names.array.add(r),E.useMemo(()=>i&&n.register(r,i),[n,i,r]),fn(()=>n._subjects.array.subscribe({next:({values:A,name:f})=>{if(f===r||!f){const L=y(A,r);Array.isArray(L)&&(m(L),T.current=L.map(pe))}}}).unsubscribe,[n,r]);const v=E.useCallback(A=>{S.current=!0,n._setFieldArray(r,A)},[n,r]),p=(A,f)=>{const L=se(z(A)),h=cn(n._getFieldArray(r),L);n._names.focus=Vn(r,h.length-1,f),T.current=cn(T.current,L.map(pe)),v(h),m(h),n._setFieldArray(r,h,cn,{argA:Pn(A)})},P=(A,f)=>{const L=se(z(A)),h=jn(n._getFieldArray(r),L);n._names.focus=Vn(r,0,f),T.current=jn(T.current,L.map(pe)),v(h),m(h),n._setFieldArray(r,h,jn,{argA:Pn(A)})},I=A=>{const f=hn(n._getFieldArray(r),A);T.current=hn(T.current,A),v(f),m(f),!Array.isArray(y(n._fields,r))&&J(n._fields,r,void 0),n._setFieldArray(r,f,hn,{argA:A})},_=(A,f,L)=>{const h=se(z(f)),U=Gn(n._getFieldArray(r),A,h);n._names.focus=Vn(r,A,L),T.current=Gn(T.current,A,h.map(pe)),v(U),m(U),n._setFieldArray(r,U,Gn,{argA:A,argB:Pn(f)})},V=(A,f)=>{const L=n._getFieldArray(r);Un(L,A,f),Un(T.current,A,f),v(L),m(L),n._setFieldArray(r,L,Un,{argA:A,argB:f},!1)},R=(A,f)=>{const L=n._getFieldArray(r);Mn(L,A,f),Mn(T.current,A,f),v(L),m(L),n._setFieldArray(r,L,Mn,{argA:A,argB:f},!1)},O=(A,f)=>{const L=z(f),h=_r(n._getFieldArray(r),A,L);T.current=[...h].map((U,w)=>!U||w===A?pe():T.current[w]),v(h),m([...h]),n._setFieldArray(r,h,_r,{argA:A,argB:L},!0,!1)},b=A=>{const f=se(z(A));T.current=f.map(pe),v([...f]),m([...f]),n._setFieldArray(r,[...f],L=>L,{},!0,!1)};return E.useEffect(()=>{if(n._state.action=!1,Yn(r,n._names)&&n._subjects.state.next({...n._formState}),S.current&&(!he(n._options.mode).isOnSubmit||n._formState.isSubmitted)&&!he(n._options.reValidateMode).isOnSubmit)if(n._options.resolver)n._runSchema([r]).then(A=>{const f=y(A.errors,r),L=y(n._formState.errors,r);(L?!f&&L.type||f&&(L.type!==f.type||L.message!==f.message):f&&f.type)&&(f?J(n._formState.errors,r,f):Z(n._formState.errors,r),n._subjects.state.next({errors:n._formState.errors}))});else{const A=y(n._fields,r);A&&A._f&&!(he(n._options.reValidateMode).isOnSubmit&&he(n._options.mode).isOnSubmit)&&xn(A,n._names.disabled,n._formValues,n._options.criteriaMode===Ee.all,n._options.shouldUseNativeValidation,!0).then(f=>!re(f)&&n._subjects.state.next({errors:ia(n._formState.errors,f,r)}))}n._subjects.state.next({name:r,values:z(n._formValues)}),n._names.focus&&Ue(n._fields,(A,f)=>{if(n._names.focus&&f.startsWith(n._names.focus)&&A.focus)return A.focus(),1}),n._names.focus="",n._setValid(),S.current=!1},[s,r,n]),E.useEffect(()=>(!y(n._formValues,r)&&n._setFieldArray(r),()=>{const A=(f,L)=>{const h=y(n._fields,f);h&&h._f&&(h._f.mount=L)};n._options.shouldUnregister||l?n.unregister(r):A(r,!1)}),[r,n,t,l]),{swap:E.useCallback(V,[v,r,n]),move:E.useCallback(R,[v,r,n]),prepend:E.useCallback(P,[v,r,n]),append:E.useCallback(p,[v,r,n]),remove:E.useCallback(I,[v,r,n]),insert:E.useCallback(_,[v,r,n]),update:E.useCallback(O,[v,r,n]),replace:E.useCallback(b,[v,r,n]),fields:E.useMemo(()=>s.map((A,f)=>({...A,[t]:T.current[f]||pe()})),[s,t])}}function zt(e={}){const a=E.useRef(void 0),n=E.useRef(void 0),[r,t]=E.useState({isDirty:!1,isValidating:!1,isLoading:ve(e.defaultValues),isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,submitCount:0,dirtyFields:{},touchedFields:{},validatingFields:{},errors:e.errors||{},disabled:e.disabled||!1,isReady:!1,defaultValues:ve(e.defaultValues)?void 0:e.defaultValues});if(!a.current)if(e.formControl)a.current={...e.formControl,formState:r},e.defaultValues&&!ve(e.defaultValues)&&e.formControl.reset(e.defaultValues,e.resetOptions);else{const{formControl:i,...s}=Ct(e);a.current={...s,formState:r}}const l=a.current.control;return l._options=e,fn(()=>{const i=l._subscribe({formState:l._proxyFormState,callback:()=>t({...l._formState}),reRenderRoot:!0});return t(s=>({...s,isReady:!0})),l._formState.isReady=!0,i},[l]),E.useEffect(()=>l._disableForm(e.disabled),[l,e.disabled]),E.useEffect(()=>{e.mode&&(l._options.mode=e.mode),e.reValidateMode&&(l._options.reValidateMode=e.reValidateMode)},[l,e.mode,e.reValidateMode]),E.useEffect(()=>{e.errors&&(l._setErrors(e.errors),l._focusError())},[l,e.errors]),E.useEffect(()=>{e.shouldUnregister&&l._subjects.state.next({values:l._getWatch()})},[l,e.shouldUnregister]),E.useEffect(()=>{if(l._proxyFormState.isDirty){const i=l._getDirty();i!==r.isDirty&&l._subjects.state.next({isDirty:i})}},[l,r.isDirty]),E.useEffect(()=>{e.values&&!Se(e.values,n.current)?(l._reset(e.values,{keepFieldsRef:!0,...l._options.resetOptions}),n.current=e.values,t(i=>({...i}))):l._resetDefaultValues()},[l,e.values]),E.useEffect(()=>{l._state.mount||(l._setValid(),l._state.mount=!0),l._state.watch&&(l._state.watch=!1,l._subjects.state.next({...l._formState})),l._removeUnmounted()}),a.current.formState=Qr(r,l),a.current}const Wt={[D.ADOPSJONSDOKUMENTAJON]:"ToTrinnsForm.Adopsjon.KontrollerOpplysninger",[D.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN]:"ToTrinnsForm.Adopsjon.VurderEktefellesBarn",[D.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE]:"ToTrinnsForm.Adopsjon.VurderMannAdoptererAlene",[D.OVERSTYR_ADOPSJONSVILKAR]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[D.OVERSTYRING_AV_ADOPSJONSVILKÅRET_FP]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[D.OMSORGSOVERTAKELSE]:"ToTrinnsForm.Omsorgovertagelse.KontrollerOpplysninger",[D.MANUELL_VURDERING_AV_OMSORGSVILKARET]:"ToTrinnsForm.Omsorgovertagelse.VurderVilkarForeldreansvarTredjeLedd",[D.AUTO_VENT_PÅ_FODSELREGISTRERING]:"ToTrinnsForm.Fødsel.VurderSokersRelasjon",[D.SJEKK_TERMINBEKREFTELSE]:"ToTrinnsForm.Fødsel.SjekkTerminbekreftelse",[D.SJEKK_MANGLENDE_FØDSEL]:"ToTrinnsForm.Fødsel.SjekkManglendeFødsel",[D.OVERSTYR_FODSELSVILKAR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[D.OVERSTYR_FODSELSVILKAR_FAR_MEDMOR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[D.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD]:"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarFjerdeLedd",[D.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN]:"ToTrinnsForm.Foreldreansvar.VurderTidligereUtbetaling",[D.AVKLAR_AKTIVITETER]:"ToTrinnsForm.Beregning.AvklarAktiviteter",[D.OVERSTYRING_AV_BEREGNINGSAKTIVITETER]:"ToTrinnsForm.Beregning.OverstyrtBeregningsaktiviteter",[D.OVERSTYRING_AV_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.OverstyrtBeregningsgrunnlag",[D.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS]:"ToTrinnsForm.Beregning.InntektFastsatt",[D.FASTSETT_BRUTTO_BEREGNINGSGRUNNLAG_SELVSTENDIG_NAERINGSDRIVENDE]:"ToTrinnsForm.Beregning.InntektFastsatt",[D.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD]:"ToTrinnsForm.Beregning.InntektFastsatt",[D.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET]:"ToTrinnsForm.Beregning.InntektFastsatt",[D.VURDER_GRADERING_UTEN_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.GraderingUtenBG",[D.FORDEL_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.FastsettFordeltBeregningsgrunnlag",[D.SOKNADSFRISTVILKARET]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[D.VURDER_SOKNADSFRIST_FORELDREPENGER]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[D.OVERSTYR_SOKNADSFRISTVILKAR]:"ToTrinnsForm.Soknadsfrist.VilkarOverstyrt",[D.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE]:"ToTrinnsForm.Medlemskap.VurderGyldigMedlemskap",[D.AVKLAR_LOVLIG_OPPHOLD]:"ToTrinnsForm.Medlemskap.AvklarLovligOpphold",[D.AVKLAR_OM_BRUKER_ER_BOSATT]:"ToTrinnsForm.Medlemskap.VurderSokerBosatt",[D.AVKLAR_OPPHOLDSRETT]:"ToTrinnsForm.Medlemskap.AvklarOppholdsrett",[D.OVERSTYR_MEDLEMSKAPSVILKAR]:"ToTrinnsForm.Medlemskap.VilkarOverstyrt",[D.OVERSTYR_AVKLAR_STARTDATO]:"ToTrinnsForm.Medlemskap.OverstyrtStartdato",[D.AVKLAR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.AvklartDekningsgrad",[D.OVERSTYR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.OverstyrtDekningsgrad",[D.FORESLA_VEDTAK]:"ToTrinnsForm.Vedtak.Fritekstbrev",[D.FORESLA_VEDTAK_MANUELT]:"ToTrinnsForm.Vedtak.Fritekstbrev",[D.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_OMSORG]:"ToTrinnsForm.Omsorg.VurderOmsorg",[D.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_ALENEOMSORG]:"ToTrinnsForm.Aleneomsorg.VurderAleneomsorg",[D.KONTROLLER_OPPLYSNINGER_OM_DØD]:"ToTrinnsForm.Uttak.Dod",[D.KONTROLLER_OPPLYSNINGER_OM_SØKNADSFRIST]:"ToTrinnsForm.Uttak.Soknadsfrist",[D.KONTROLLER_REALITETSBEHANDLING_ELLER_KLAGE]:"ToTrinnsForm.Uttak.Klage",[D.ANNENPART_EØS]:"ToTrinnsForm.Uttak.AnnenpartEØS",[D.TETTE_SAKER]:"ToTrinnsForm.Uttak.TetteStønadsperioder",[D.KONTROLLER_OPPLYSNINGER_OM_FORDELING_AV_STØNADSPERIODEN]:"ToTrinnsForm.Uttak.FordelingStonadsperioder",[D.KONTROLLER_TILSTØTENDE_YTELSER_INNVILGET]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Innvilget",[D.KONTROLLER_TILSTØTENDE_YTELSER_OPPHØRT]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Opphort",[D.TILKNYTTET_STORTINGET]:"ToTrinnsForm.Uttak.Stortinget",[D.VURDER_TILBAKETREKK]:"ToTrinnsForm.TilkjentYtelse.Tilbaketrekk",[D.VURDER_FARESIGNALER]:"ToTrinnsForm.Faresignaler.Vurder",[D.VURDER_OPPTJENINGSVILKARET]:"ToTrinnsForm.Opptjening.VurderOpptjeningsvilkåret",[D.VURDER_REFUSJON_BERGRUNN]:"ToTrinnsForm.Beregningsgrunnlag.Refusjonsstart",[D.VURDER_ARBEIDSFORHOLD_INNTEKTSMELDING]:"ToTrinnsForm.ArbeidOgInntekt.ManueltOpprettet"},Zt={},Xt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidMedNavn",values:{a:e,b:a,c:n}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidUtenNavn",values:{a:e,b:n}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringAktivitet",values:{a:e}}),Qt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidMedNavn",values:{a:e,bb:a,c:n,b:r=>g.jsx("b",{children:r})}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidUtenNavn",values:{a:e,bb:n,b:r=>g.jsx("b",{children:r})}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningAktivitet",values:{a:e,b:r=>g.jsx("b",{children:r})}}),el=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidMedNavn",values:{a:e,b:a,c:n}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidUtenNavn",values:{a:e,b:n}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningAktivitet",values:{a:e}}),sa=({aktivitet:e})=>e.erEndring?Xt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):e.godkjent?el(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):Qt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr);sa.__docgenInfo={description:"",methods:[],displayName:"OpptjeningTotrinnText",props:{aktivitet:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  godkjent: boolean;
  privatpersonFødselsdato?: string;
}>`},description:""}}};const nl=e=>e?.fastsattVarigEndringNaering?g.jsx(q,{id:"ToTrinnsForm.Beregning.VarigEndring"}):g.jsx(q,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),Nr=e=>e.uttakPerioder?e.uttakPerioder.map(a=>{const n=tr(a.fom),r=tr(a.tom);let t;return a.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":a.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":a.erEndret&&(e.aksjonspunktKode===D.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===D.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":a.erEndret&&e.aksjonspunktKode===D.OVERSTYRING_AV_UTTAKPERIODER||a.erEndret&&e.aksjonspunktKode===D.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":a.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",g.jsx(q,{id:t,values:{a:n,b:r}},t)}):[],rl=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(a=>g.jsx(sa,{aktivitet:a},a.aktivitetType)):[],al=e=>{const a=Wt[e.aksjonspunktKode];return a?[g.jsx(q,{id:a},a)]:[]},tl=e=>{const a=Zt[e.aksjonspunktKode];return a?[g.jsx(q,{id:a},a)]:[]},ll=e=>{const a=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[g.jsx(q,{id:a},a)]},ol=(e,a)=>a?.faktaOmBeregningTilfeller?a.faktaOmBeregningTilfeller.flatMap(n=>{const r=e.find(t=>t.kode===n);return r?[g.jsx("div",{children:r.navn},r.navn)]:[]}):[],il=e=>{let a="";switch(e?.type){case Le.KLAGE_YTELSESVEDTAK_STADFESTET:a="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case Le.KLAGE_YTELSESVEDTAK_OPPHEVET:a="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case Le.KLAGE_AVVIST:a="ToTrinnsForm.Klage.Avvist";break;case Le.HJEMSENDE_UTEN_OPPHEVE:a="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case Le.KLAGE_DELVIS_MEDHOLD:a="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case Le.KLAGE_OMGJORT_UGUNST:a="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case Le.KLAGE_MEDHOLD:a="ToTrinnsForm.Klage.OmgjortTilGunst";break}return g.jsx(q,{id:a})},sl=(e,a)=>e===Nn.FATTER_VEDTAK?[il(a)]:[],dl=()=>g.jsx(q,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),kl=()=>g.jsx(q,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),El=e=>e.aksjonspunktKode===D.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===D.VURDERING_AV_FORMKRAV_KLAGE_NFP,da=(e,a,n,r,t,l)=>t.aksjonspunktKode===D.VURDER_PERIODER_MED_OPPTJENING?rl(t):t.aksjonspunktKode===D.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[nl(t.beregningDto)]:t.aksjonspunktKode===D.VURDER_FAKTA_FOR_ATFL_SN?ol(n,t.beregningDto):Ha(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0||Ya(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0?Nr(t):t.aksjonspunktKode===D.AVKLAR_ANNEN_FORELDER_RETT?[dl()]:t.aksjonspunktKode===D.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?ll(e):t.aksjonspunktKode===D.OVERSTYRING_AV_RETT_OG_OMSORG?[kl()]:El(t)?sl(a,l):r?tl(t):al(t);function ul(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Sr={exports:{}},We={};/**
 * @license React
 ...
 */var yr;function vl(){if(yr)return We;yr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,l){var i=null;if(l!==void 0&&(i=""+l),t.key!==void 0&&(i=""+t.key),"key"in t){l={};for(var s in t)s!=="key"&&(l[s]=t[s])}else l=t;return t=l.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:l}}return We.Fragment=a,We.jsx=n,We.jsxs=n,We}var Kr;function Tl(){return Kr||(Kr=1,Sr.exports=vl()),Sr.exports}var ye=Tl();const gl=({children:e})=>!e||Array.isArray(e)&&e.length===0?null:ye.jsx(ot,{variant:"warning",size:"small",children:ye.jsx(Te,{gap:"space-8",children:E.Children.map(e,a=>ye.jsx(ue,{size:"small",children:a},Ka(a)?a.key:a))})}),nn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};Be(nn);const mn="var(--ax-bg-neutral-strong)",ka=4,Al=(e,a,n)=>`
  .arrowBoxTop${e} {
...
`,ml=(e,a,n,r)=>a?Rl(e,n,r):Al(e,n,r),_l=(e,a,n)=>n?"":a?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,Nl=({children:e,alignOffset:a=0,alignLeft:n=!1,marginTop:r=0,marginLeft:t=0,hideBorder:l=!1})=>ye.jsxs(ye.Fragment,{children:[ye.jsx("style",{dangerouslySetInnerHTML:{__html:ml(a,n,r,t)}}),ye.jsx("div",{className:_l(a,n,l),children:e})]});var pr={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Lr;function Sl(){return Lr||(Lr=1,function(e){(function(){var a={}.hasOwnProperty;function n(){for(var l="",i=0;i<arguments.length;i++){var s=arguments[i];s&&(l=t(l,r.call(this,s)))}return l}function r(l){if(typeof l=="string"||typeof l=="number")return this&&this[l]||l;if(typeof l!="object")return"";if(Array.isArray(l))return n.apply(this,l);if(l.toString!==Object.prototype.toString&&!l.toString.toString().includes("[native code]"))return l.toString();var i="";for(var s in l)a.call(l,s)&&l[s]&&(i=t(i,this&&this[s]||s));return i}function t(l,i){return i?l?l+" "+i:l+i:l}e.exports?(n.default=n,e.exports=n):window.classNames=n})()}(pr)),pr.exports}var yl=Sl();const er=ul(yl),Kl="_borderbox_1a0x6_1",pl="_error_1a0x6_5",Ll="_warning_1a0x6_8",fl={borderbox:Kl,error:pl,warning:Ll};er.bind(fl);const Fl="_aksjonspunkt_11wjs_1",Ol="_erAksjonspunktApent_11wjs_4",Dl="_erIkkeGodkjentAvBeslutter_11wjs_8",Il={aksjonspunkt:Fl,erAksjonspunktApent:Ol,erIkkeGodkjentAvBeslutter:Dl};er.bind(Il);Be(nn);Be(nn);const bl="_divider_1jpov_1",Vl="_dividerParagraf_1jpov_8",cl="_leftPanel_1jpov_11",Pl="_rightPanel_1jpov_14",Gl={divider:bl,dividerParagraf:Vl,leftPanel:cl,rightPanel:Pl};er.bind(Gl);const Ea=()=>ye.jsx("span",{"data-testid":"editedIcon",children:ye.jsx(Qa,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});Be(nn);Be(nn);function Ml(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var fr={exports:{}},Ze={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fr;function jl(){if(Fr)return Ze;Fr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,l){var i=null;if(l!==void 0&&(i=""+l),t.key!==void 0&&(i=""+t.key),"key"in t){l={};for(var s in t)s!=="key"&&(l[s]=t[s])}else l=t;return t=l.ref,{$$typeof:e,type:r,key:i,ref:t!==void 0?t:null,props:l}}return Ze.Fragment=a,Ze.jsx=n,Ze.jsxs=n,Ze}var Or;function hl(){return Or||(Or=1,fr.exports=jl()),fr.exports}var Q=hl();const nr=e=>e.reduce((a,n,r)=>({...a,[r]:t=>n(t)||!0}),{}),_n=(e,a)=>a.split(".").reduce((n,r)=>n!==void 0?n[r]:n,e)?.message,je=({label:e,validate:a=[],readOnly:n=!1,onChange:r,onClick:t,className:l,...i})=>{const{name:s,control:m,disabled:T}=i,{formState:{errors:u}}=Re(),{field:S}=Zn({name:s,control:m,rules:{validate:G.useMemo(()=>nr(a),[a])}}),v=_n(u,s);return Q.jsxs(Q.Fragment,{children:[Q.jsx(_t,{size:"small",disabled:T||n,checked:S.value===!0,className:l,error:!!v,...S,onChange:p=>{S.onChange(p),r&&r(p.currentTarget.checked)},onClick:()=>{t&&t()},children:e}),v&&Q.jsx(Kn,{children:_n(u,s)})]})};var Cn={exports:{}},Ul=Cn.exports,Dr;function Bl(){return Dr||(Dr=1,function(e,a){(function(n,r){e.exports=r()})(Ul,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,t=/\d/,l=/\d\d/,i=/\d\d?/,s=/\d*[^-_:/,()\s\d]+/,m={},T=function(_){return(_=+_)+(_>68?1900:2e3)},u=function(_){return function(V){this[_]=+V}},S=[/[+-]\d\d:?(\d\d)?|Z/,function(_){(this.zone||(this.zone={})).offset=function(V){if(!V||V==="Z")return 0;var R=V.match(/([+-]|\d\d)/g),O=60*R[1]+(+R[2]||0);return O===0?0:R[0]==="+"?-O:O}(_)}],v=function(_){var V=m[_];return V&&(V.indexOf?V:V.s.concat(V.f))},p=function(_,V){var R,O=m.meridiem;if(O){for(var b=1;b<=24;b+=1)if(_.indexOf(O(b,0,V))>-1){R=b>12;break}}else R=_===(V?"pm":"PM");return R},P={A:[s,function(_){this.afternoon=p(_,!1)}],a:[s,function(_){this.afternoon=p(_,!0)}],Q:[t,function(_){this.month=3*(_-1)+1}],S:[t,function(_){this.milliseconds=100*+_}],SS:[l,function(_){this.milliseconds=10*+_}],SSS:[/\d{3}/,function(_){this.milliseconds=+_}],s:[i,u("seconds")],ss:[i,u("seconds")],m:[i,u("minutes")],mm:[i,u("minutes")],H:[i,u("hours")],h:[i,u("hours")],HH:[i,u("hours")],hh:[i,u("hours")],D:[i,u("day")],DD:[l,u("day")],Do:[s,function(_){var V=m.ordinal,R=_.match(/\d+/);if(this.day=R[0],V)for(var O=1;O<=31;O+=1)V(O).replace(/\[|\]/g,"")===_&&(this.day=O)}],w:[i,u("week")],ww:[l,u("week")],M:[i,u("month")],MM:[l,u("month")],MMM:[s,function(_){var V=v("months"),R=(v("monthsShort")||V.map(function(O){return O.slice(0,3)})).indexOf(_)+1;if(R<1)throw new Error;this.month=R%12||R}],MMMM:[s,function(_){var V=v("months").indexOf(_)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,u("year")],YY:[l,function(_){this.year=T(_)}],YYYY:[/\d{4}/,u("year")],Z:S,ZZ:S};function I(_){var V,R;V=_,R=m&&m.formats;for(var O=(_=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,c){var j=c&&c.toUpperCase();return x||R[c]||n[c]||R[j].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(B,Y,H){return Y||H.slice(1)})})).match(r),b=O.length,A=0;A<b;A+=1){var f=O[A],L=P[f],h=L&&L[0],U=L&&L[1];O[A]=U?{regex:h,parser:U}:f.replace(/^\[|\]$/g,"")}return function(w){for(var x={},c=0,j=0;c<b;c+=1){var B=O[c];if(typeof B=="string")j+=B.length;else{var Y=B.regex,H=B.parser,ee=w.slice(j),oe=Y.exec(ee)[0];H.call(x,oe),w=w.replace(oe,"")}}return function(ie){var me=ie.afternoon;if(me!==void 0){var ne=ie.hours;me?ne<12&&(ie.hours+=12):ne===12&&(ie.hours=0),delete ie.afternoon}}(x),x}}return function(_,V,R){R.p.customParseFormat=!0,_&&_.parseTwoDigitYear&&(T=_.parseTwoDigitYear);var O=V.prototype,b=O.parse;O.parse=function(A){var f=A.date,L=A.utc,h=A.args;this.$u=L;var U=h[1];if(typeof U=="string"){var w=h[2]===!0,x=h[3]===!0,c=w||x,j=h[2];x&&(j=h[2]),m=this.$locale(),!w&&j&&(m=R.Ls[j]),this.$d=function(ee,oe,ie,me){try{if(["x","X"].indexOf(oe)>-1)return new Date((oe==="X"?1e3:1)*ee);var ne=I(oe)(ee),we=ne.year,Fe=ne.month,Fn=ne.day,rn=ne.hours,On=ne.minutes,He=ne.seconds,an=ne.milliseconds,Ve=ne.zone,ce=ne.week,Ye=new Date,Pe=Fn||(we||Fe?1:Ye.getDate()),xe=we||Ye.getFullYear(),Oe=0;we&&!Fe||(Oe=Fe>0?Fe-1:Ye.getMonth());var De,Ce=rn||0,Je=On||0,tn=He||0,Ge=an||0;return Ve?new Date(Date.UTC(xe,Oe,Pe,Ce,Je,tn,Ge+60*Ve.offset*1e3)):ie?new Date(Date.UTC(xe,Oe,Pe,Ce,Je,tn,Ge)):(De=new Date(xe,Oe,Pe,Ce,Je,tn,Ge),ce&&(De=me(De).week(ce).toDate()),De)}catch{return new Date("")}}(f,U,L,R),this.init(),j&&j!==!0&&(this.$L=this.locale(j).$L),c&&f!=this.format(U)&&(this.$d=new Date("")),m={}}else if(U instanceof Array)for(var B=U.length,Y=1;Y<=B;Y+=1){h[1]=U[Y-1];var H=R.apply(this,h);if(H.isValid()){this.$d=H.$d,this.$L=H.$L,this.init();break}Y===B&&(this.$d=new Date(""))}else b.call(this,A)}}})}(Cn)),Cn.exports}var ql=Bl();const wl=Ml(ql),Hl="_textarea_14c7r_1",Yl="_readOnlyField_14c7r_7",Ir={textarea:Hl,readOnlyField:Yl},xl=e=>e!=null&&e!=="",Cl=({label:e,value:a,isEdited:n=!1,type:r,hideLabel:t,size:l})=>xl(a)?Q.jsxs(Te,{gap:"space-4",children:[e&&!t&&Q.jsx(yn,{size:l,children:e}),Q.jsxs(be,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(Br,{className:r==="textarea"?Ir.textarea:Ir.readOnlyField,size:l,children:a}),n&&Q.jsx(Ea,{})]})]}):null;pa.extend(wl);const Jl=({label:e,description:a,validate:n=[],onChange:r,children:t,className:l,isReadOnly:i=!1,size:s="small",isEdited:m=!1,hideLegend:T=!1,...u})=>{const{name:S,control:v}=u,{formState:{errors:p}}=Re(),{field:P}=Zn({name:S,control:v,rules:{validate:nr(n)}});return Q.jsx(St,{name:S,value:P.value!==void 0?P.value:null,legend:Q.jsxs(be,{justify:"center",gap:"space-8",children:[e,i&&m&&Q.jsx(Ea,{})]}),hideLegend:T,disabled:i,description:a,size:s,error:_n(p,S),onChange:I=>{r&&r(I),P.onChange(I)},className:l,children:t})},$l="_textAreaFieldWithBadges_bdz0b_1",zl="_etikettWrapper_bdz0b_4",br={textAreaFieldWithBadges:$l,etikettWrapper:zl},Wl=({name:e,control:a,label:n,readOnly:r,maxLength:t,badges:l,validate:i=[],parse:s=p=>p,className:m,description:T,isEdited:u,size:S="small",...v})=>{const{formState:{errors:p}}=Re(),{field:P}=Zn({name:e,control:a,rules:{validate:G.useMemo(()=>nr(i),[i])}});return r?Q.jsx(Cl,{size:S,label:n,value:P.value,type:"textarea",isEdited:u,hideLabel:v.hideLabel}):Q.jsxs("div",{className:l?br.textAreaFieldWithBadges:null,children:[l&&Q.jsx("div",{className:br.etikettWrapper,children:l.map(({type:I,titleText:_})=>Q.jsx(ut,{variant:I,size:"small",children:_},_))}),Q.jsx(Ot,{size:S,label:n,description:T,className:m,autoComplete:"off",...P,onChange:I=>P.onChange(I.currentTarget.value!==""?s(I.currentTarget.value):null),value:P.value?P.value:"",error:_n(p,e),maxLength:t,...v})]})},Zl=({formMethods:e,onSubmit:a,children:n,className:r,setDataOnUnmount:t})=>{const{handleSubmit:l,getValues:i}=e;return G.useEffect(()=>()=>{t&&t(i())},[]),Q.jsx(bt,{...e,children:Q.jsx("form",{className:r,onSubmit:a?l(s=>a(s)):void 0,children:n})})},Xl=(e,a)=>{const{setError:n,clearErrors:r,formState:t}=Re(),l=!!a;return G.useEffect(()=>{l&&n(`${e}.notRegisteredInput`,{type:"custom",message:a}),l||r(`${e}.notRegisteredInput`)},[a]),t.isSubmitted?e.split(".").reduce((i,s)=>i[s]||{},t.errors)?.notRegisteredInput?.message:void 0},Ql=Fa(3),eo=Oa(2e3),ae="aksjonspunktGodkjenning",no=(e,a)=>!e(`${ae}.${a}.feilFakta`)&&!e(`${ae}.${a}.feilLov`)&&!e(`${ae}.${a}.feilSkjønn`)&&!e(`${ae}.${a}.feilUtredning`)&&!e(`${ae}.${a}.feilSaksflyt`)&&!e(`${ae}.${a}.feilBegrunnelse`),ua=({index:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n})=>{const{watch:r,getValues:t,control:l}=Re(),i=r("aksjonspunktGodkjenning"),{aksjonspunktKode:s,totrinnskontrollGodkjent:m}=i[e],T=a.find(p=>p.totrinnskontrollAksjonspunkter.some(P=>P.aksjonspunktKode===s)),u=T?.totrinnskontrollAksjonspunkter.find(p=>p.aksjonspunktKode===s),S=!m&&no(t,e)?La():void 0,v=Xl(`${ae}.${e}.faktagruppe`,S);return!T||!u?null:g.jsxs(Te,{gap:"space-12",children:[g.jsx(Jl,{name:`${ae}.${e}.totrinnskontrollGodkjent`,control:l,isReadOnly:n,hideLegend:!0,children:g.jsxs(be,{gap:"space-16",children:[g.jsx(or,{value:!0,size:"small",children:g.jsx(q,{id:"ApprovalField.Godkjent"})}),g.jsx(or,{value:!1,size:"small",children:g.jsx(q,{id:"ApprovalField.Vurder"})})]})}),m===!1&&g.jsx(Nl,{alignOffset:m?1:110,children:g.jsxs(Te,{gap:"space-8",children:[g.jsx(yn,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),g.jsx(ue,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),g.jsxs(Te,{gap:"space-16",children:[g.jsx(Te,{gap:"space-4",children:g.jsxs(be,{justify:"space-between",style:{width:"300px"},children:[g.jsxs(Te,{gap:"space-4",children:[g.jsx(je,{name:`${ae}.${e}.feilFakta`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilSkjønn`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilLov`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),g.jsxs(Te,{gap:"space-4",children:[g.jsx(je,{name:`${ae}.${e}.feilUtredning`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilSaksflyt`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),g.jsx(je,{name:`${ae}.${e}.feilBegrunnelse`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),v&&g.jsx(Kn,{size:"small",children:v}),g.jsx(Wl,{name:`${ae}.${e}.besluttersBegrunnelse`,control:l,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[fa,Ql,eo,Da],readOnly:n})]})]})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  skjermlenkeType: SkjermlenkeType;
  totrinnskontrollAksjonspunkter: TotrinnskontrollAksjonspunkt[];
}>`}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ro="_aksjonspunktTextContainer_1pwmv_5",ao="_lenke_1pwmv_10",Vr={aksjonspunktTextContainer:ro,lenke:ao},to="aksjonspunktGodkjenning",va=({behandling:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n,erForeldrepengerFagsak:r,erTilbakekreving:t,skjemalenkeTyper:l,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const{control:m,watch:T}=Re(),{fields:u}=$t({control:m,name:to}),S=T("aksjonspunktGodkjenning");return g.jsx(Te,{gap:"space-24",children:u.map((v,p)=>{const{aksjonspunktKode:P}=S[p],I=a.find(b=>b.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===P)),_=I?.totrinnskontrollAksjonspunkter.find(b=>b.aksjonspunktKode===P);if(!I||!_)return null;const V=da(r,e.status,i,t,_,e.behandlingsresultat),R=l.find(b=>b.kode===I.skjermlenkeType),O=s(I.skjermlenkeType);return g.jsxs("div",{children:[O&&R&&g.jsx(jr,{to:O,onClick:()=>window.scroll(0,0),className:Vr.lenke,children:R.navn}),V.map((b,A)=>g.jsx("div",{className:Vr.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:b})},P.concat("_".concat(A.toString())))),g.jsx(ua,{index:p,totrinnskontrollSkjermlenkeContext:a,readOnly:n})]},v.id)})})};va.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const cr=(e=[])=>e.every(a=>a.totrinnskontrollGodkjent),Pr=(e=[])=>e.every(a=>a.totrinnskontrollGodkjent!==void 0&&a.totrinnskontrollGodkjent!==null),lo=(e,a)=>{if(!a)return!0;const{konsekvenserForYtelsen:n}=a;return!Array.isArray(n)||n.length!==1?!0:!e.some(r=>r===n[0])},oo=e=>e.reduce((a,n)=>n===te.FEIL_FAKTA?{...a,feilFakta:!0}:n===te.FEIL_LOV?{...a,feilLov:!0}:n===te.FEIL_REGEL?{...a,feilSkjønn:!0}:n===te.SKJØNN?{...a,feilSkjønn:!0}:n===te.UTREDNING?{...a,feilUtredning:!0}:n===te.SAKSFLYT||n===te.ANNET?{...a,feilSaksflyt:!0}:n===te.BEGRUNNELSE?{...a,feilBegrunnelse:!0}:{},{}),io=e=>({aksjonspunktGodkjenning:e.map(a=>a.totrinnskontrollAksjonspunkter).flat().map(a=>({aksjonspunktKode:a.aksjonspunktKode,totrinnskontrollGodkjent:a.totrinnskontrollGodkjent,besluttersBegrunnelse:hr(a.besluttersBegrunnelse),...oo(a.vurderPaNyttArsaker?a.vurderPaNyttArsaker:[])}))}),Ta=({behandling:e,onSubmit:a,forhandsvisVedtaksbrev:n,readOnly:r,erBehandlingEtterKlage:t,erForeldrepengerFagsak:l,skjemalenkeTyper:i,erTilbakekreving:s,totrinnskontrollSkjermlenkeContext:m,faktaOmBeregningTilfeller:T,lagLenke:u,beslutterFormData:S,setBeslutterFormData:v})=>{const p=e&&e.type===Xe.KLAGE,P=e&&e.type===Xe.ANKE,I=lo([wn.ENDRING_I_FORDELING_AV_YTELSEN,wn.INGEN_ENDRING],e.behandlingsresultat),_=io(m),V=zt({defaultValues:S||_}),R=V.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?g.jsx(Zl,{formMethods:V,onSubmit:a,setDataOnUnmount:v,children:g.jsxs(Te,{gap:"space-24",children:[!r&&g.jsx(gl,{children:[g.jsx(q,{id:"HelpText.ToTrinnsKontroll"},1)]}),g.jsx(va,{behandling:e,erForeldrepengerFagsak:l,erTilbakekreving:s,readOnly:r,totrinnskontrollSkjermlenkeContext:m,skjemalenkeTyper:i,faktaOmBeregningTilfeller:T,lagLenke:u}),g.jsxs(be,{gap:"space-16",style:{marginBottom:"50px"},children:[g.jsx(qn,{variant:"primary",size:"small",disabled:!cr(R)||!Pr(R)||V.formState.isSubmitting,loading:V.formState.isSubmitting,children:g.jsx(q,{id:"ToTrinnsForm.Godkjenn"})}),g.jsx(qn,{variant:"primary",size:"small",disabled:cr(R)||!Pr(R)||V.formState.isSubmitting,loading:V.formState.isSubmitting,onClick:Ia,children:g.jsx(q,{id:"ToTrinnsForm.SendTilbake"})}),!p&&!t&&!P&&!s&&I&&g.jsx(dt,{href:"#",onClick:n,children:g.jsx(q,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};Ta.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const so="_approvalItem_xqu47_1",ko="_approvalItemContainer_xqu47_7",Eo="_aksjonspunktTextContainer_xqu47_11",uo="_resultatFraGodkjenningTextContainer_xqu47_16",vo="_lenke_xqu47_20",To="_checkmarkIcon_xqu47_24",go="_xmark_xqu47_30",Ne={approvalItem:so,approvalItemContainer:ko,aksjonspunktTextContainer:Eo,resultatFraGodkjenningTextContainer:uo,lenke:vo,checkmarkIcon:To,xmark:go},Ao=({vurderPaNyttArsaker:e,vurderArsaker:a})=>g.jsx("div",{className:Ne.approvalItem,children:e?.map(n=>g.jsxs(be,{gap:"space-8",children:[g.jsx(nt,{className:Ne.xmark}),g.jsx("div",{children:a.find(r=>n===r.kode)?.navn})]},n))}),ga=({behandling:e,totrinnskontrollSkjermlenkeContext:a,erForeldrepengerFagsak:n,erTilbakekreving:r,skjemalenkeTyper:t,vurderArsaker:l,faktaOmBeregningTilfeller:i,lagLenke:s})=>{const m=ba();return g.jsxs(g.Fragment,{children:[g.jsx("div",{className:Ne.resultatFraGodkjenningTextContainer,children:g.jsx(q,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Va}})}),a.map(T=>{const u=T.totrinnskontrollAksjonspunkter,S=t.find(v=>v.kode===T.skjermlenkeType);if(u.length>0){const v=s(T.skjermlenkeType);return g.jsxs(E.Fragment,{children:[v&&S&&g.jsx(jr,{to:v,onClick:()=>window.scroll(0,0),className:Ne.lenke,children:S.navn}),u.map(p=>{const P=da(n,e.status,i,r,p,e.behandlingsresultat);return g.jsxs("div",{className:Ne.approvalItemContainer,children:[P.map((I,_)=>g.jsx("div",{className:Ne.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:I})},p.aksjonspunktKode.concat("_".concat(_.toString())))),g.jsx("div",{className:Ne.approvalItem,children:p.totrinnskontrollGodkjent?g.jsxs(be,{gap:"space-8",children:[g.jsx(Ja,{title:m.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:Ne.checkmarkIcon}),g.jsx(q,{id:"ToTrinnsForm.Godkjent"})]}):g.jsx(Ao,{vurderPaNyttArsaker:p?.vurderPaNyttArsaker,vurderArsaker:l})}),g.jsx("pre",{className:Ne.approvalItem,children:hr(p.besluttersBegrunnelse)})]},p.aksjonspunktKode)})]},T.skjermlenkeType)}return null})]})};ga.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Ro=Be(Ba),mo=[on.FAKTA_OM_FEILUTBETALING,on.FORELDELSE,on.TILBAKEKREVING,on.VEDTAK],_o=e=>{const a=[];return e.feilFakta&&a.push(te.FEIL_FAKTA),e.feilLov&&a.push(te.FEIL_LOV),e.feilSkjønn&&a.push(te.SKJØNN),e.feilUtredning&&a.push(te.UTREDNING),e.feilSaksflyt&&a.push(te.SAKSFLYT),e.feilBegrunnelse&&a.push(te.BEGRUNNELSE),a},No=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Aa=({behandling:e,location:a,fagsakYtelseType:n,readOnly:r,onSubmit:t,forhandsvisVedtaksbrev:l,alleKodeverk:i,createLocationForSkjermlenke:s,beslutterFormData:m,setBeslutterFormData:T})=>{const u=Xe.TILBAKEKREVING===e.type||Xe.TILBAKEKREVING_REVURDERING===e.type,S=O=>{const b=O.aksjonspunktGodkjenning.map(L=>({aksjonspunktKode:L.aksjonspunktKode,godkjent:!!L.totrinnskontrollGodkjent,begrunnelse:L.besluttersBegrunnelse,arsaker:_o(L)})),A=u?xr.FATTER_VEDTAK:D.FATTER_VEDTAK;return t({fatterVedtakAksjonspunktDto:{"@type":A,kode:A,begrunnelse:void 0,aksjonspunktGodkjenningDtos:b},erAlleAksjonspunktGodkjent:O.aksjonspunktGodkjenning.every(L=>L.totrinnskontrollGodkjent)})},v=e?e.behandlingÅrsaker.map(({behandlingArsakType:O})=>O).some(O=>O===En.ETTER_KLAGE||O===En.KLAGE_U_INNTK||O===En.KLAGE_M_INNTK):!1,p=u?mo.flatMap(O=>{const b=e.totrinnskontrollÅrsaker.find(A=>A.skjermlenkeType===O.kode);return b?[b]:[]}):e.totrinnskontrollÅrsaker,P=O=>s(a,O),I=e.status===Nn.FATTER_VEDTAK,_=i.SkjermlenkeType,V=i.VurderÅrsak,R=No(i);return g.jsxs(ca,{value:Ro,children:[I&&g.jsx(Ta,{behandling:e,totrinnskontrollSkjermlenkeContext:p,readOnly:r,onSubmit:S,forhandsvisVedtaksbrev:l,erForeldrepengerFagsak:n===Bn.FORELDREPENGER,skjemalenkeTyper:_,erBehandlingEtterKlage:v,faktaOmBeregningTilfeller:R,erTilbakekreving:u,lagLenke:P,beslutterFormData:m,setBeslutterFormData:T}),!I&&g.jsx(ga,{behandling:e,totrinnskontrollSkjermlenkeContext:p,erForeldrepengerFagsak:n===Bn.FORELDREPENGER,erTilbakekreving:u,skjemalenkeTyper:_,lagLenke:P,vurderArsaker:V,faktaOmBeregningTilfeller:R})]})};Aa.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
>[]`}}]}}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ApData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const{action:Gr}=__STORYBOOK_MODULE_ACTIONS__,Mr={key:"1",pathname:"",search:"",state:{},hash:""},Ra={uuid:"1",versjon:2,status:Nn.FATTER_VEDTAK,type:Xe.FORSTEGANGSSOKNAD,behandlingÅrsaker:[],toTrinnsBehandling:!0,behandlingsresultat:{type:Le.KLAGE_YTELSESVEDTAK_STADFESTET}},So=e=>g.jsx("div",{style:{width:"600px",margin:"50px",padding:"20px",backgroundColor:"var(--ax-bg-default)"},children:g.jsx(e,{})}),fo={title:"sak/sak-totrinnskontroll",component:Aa,args:{onSubmit:Gr("button-click"),location:Mr,forhandsvisVedtaksbrev:Gr("button-click"),fagsakYtelseType:Bn.FORELDREPENGER,alleKodeverk:xa,createLocationForSkjermlenke:()=>Mr,setBeslutterFormData:()=>{}},decorators:[Pa,So]},dn={args:{behandling:{...Ra,totrinnskontrollÅrsaker:[{skjermlenkeType:Qe.FORMKRAV_KLAGE_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5082",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:[""]},vurderPaNyttArsaker:[],uttakPerioder:[]}]},{skjermlenkeType:Qe.KLAGE_BEH_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5035",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:[""]},vurderPaNyttArsaker:[],uttakPerioder:[],arbeidforholdDtos:[]}]}]},readOnly:!1}},kn={args:{behandling:{...Ra,status:Nn.BEHANDLING_UTREDES,totrinnskontrollÅrsaker:[{skjermlenkeType:Qe.FORMKRAV_KLAGE_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5082",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:[""]},besluttersBegrunnelse:"Denne er ikke godkjent fordi...",totrinnskontrollGodkjent:!1,vurderPaNyttArsaker:["FEIL_LOV","FEIL_FAKTA"],uttakPerioder:[],arbeidforholdDtos:[]}]},{skjermlenkeType:Qe.KLAGE_BEH_NFP,totrinnskontrollAksjonspunkter:[{aksjonspunktKode:"5035",opptjeningAktiviteter:[],beregningDto:{fastsattVarigEndringNaering:!1,faktaOmBeregningTilfeller:[""]},totrinnskontrollGodkjent:!0,uttakPerioder:[]}]}]},readOnly:!0}};dn.parameters={...dn.parameters,docs:{...dn.parameters?.docs,source:{originalSource:`{
  args: {
    behandling: {
      ...DEFAULT_BEHANDLING,
...
}`,...kn.parameters?.docs?.source}}};const Fo=["ForBeslutter","ForSaksbehandler"];export{dn as ForBeslutter,kn as ForSaksbehandler,Fo as __namedExportsOrder,fo as default};
