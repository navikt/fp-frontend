...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean | null;
}>`}]},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Mn}=__STORYBOOK_MODULE_ACTIONS__,Un={title:"sak/sak-totrinnskontroll-fatter-vedtak-modal",component:_e,args:{closeEvent:Mn("button-click")}},M={args:{behandling:{uuid:"1",status:F.FATTER_VEDTAK,type:k.FORSTEGANGSSOKNAD},allAksjonspunktApproved:!0}},q={args:{behandling:{uuid:"1",status:F.FATTER_VEDTAK,type:k.FORSTEGANGSSOKNAD,behandlingsresultat:{type:O.OPPHOR}},allAksjonspunktApproved:!0}},L={args:{behandling:{uuid:"1",status:F.FATTER_VEDTAK,type:k.KLAGE,behandlingsresultat:{type:O.OPPHOR}},allAksjonspunktApproved:!0}},G={args:{behandling:{uuid:"1",status:F.FATTER_VEDTAK,type:k.FORSTEGANGSSOKNAD,behandlingsresultat:{type:O.OPPHOR}},allAksjonspunktApproved:!1}};M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  args: {
    behandling: {
      uuid: '1',
