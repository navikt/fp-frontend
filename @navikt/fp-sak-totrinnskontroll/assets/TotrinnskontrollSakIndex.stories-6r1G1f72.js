...
`,mt=(e,r,n,a)=>r?Nt(e,n,a):At(e,n,a),gt=(e,r,n)=>n?"":r?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,St=({children:e,alignOffset:r=0,alignLeft:n=!1,marginTop:a=0,marginLeft:l=0,hideBorder:t=!1})=>Ke.jsxs(Ke.Fragment,{children:[Ke.jsx("style",{dangerouslySetInnerHTML:{__html:mt(r,n,a,l)}}),Ke.jsx("div",{className:gt(r,n,t),children:e})]});var ya={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var fa;function Lt(){return fa||(fa=1,(function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var o=arguments[E];o&&(t=l(t,a.call(this,o)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return this&&this[t]||t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(this,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var o in t)r.call(t,o)&&t[o]&&(E=l(E,this&&this[o]||o));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(ya)),ya.exports}var Kt=Lt();const ra=kt(Kt),Dt="_borderbox_1a0x6_1",It="_error_1a0x6_5",Ft="_warning_1a0x6_8",yt={borderbox:Dt,error:It,warning:Ft};ra.bind(yt);const ft="_aksjonspunkt_11wjs_1",Ot="_erAksjonspunktApent_11wjs_4",pt="_erIkkeGodkjentAvBeslutter_11wjs_8",Vt={aksjonspunkt:ft,erAksjonspunktApent:Ot,erIkkeGodkjentAvBeslutter:pt};ra.bind(Vt);je(rn);je(rn);const Gt="_divider_1jpov_1",Pt="_dividerParagraf_1jpov_8",bt="_leftPanel_1jpov_11",ct="_rightPanel_1jpov_14",Ut={divider:Gt,dividerParagraf:Pt,leftPanel:bt,rightPanel:ct};ra.bind(Ut);const Tr=()=>Ke.jsx("span",{"data-testid":"editedIcon",children:Ke.jsx(Qr,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});je(rn);je(rn);var Yn={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Oa;function Mt(){return Oa||(Oa=1,(function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var o=arguments[E];o&&(t=l(t,a(o)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(null,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var o in t)r.call(t,o)&&t[o]&&(E=l(E,o));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(Yn)),Yn.exports}var Bt=Mt();const ht=Dr(Bt);function jt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var pa={exports:{}},Ze={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Va;function Ht(){if(Va)return Ze;Va=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var o in l)o!=="key"&&(t[o]=l[o])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return Ze.Fragment=r,Ze.jsx=n,Ze.jsxs=n,Ze}var Ga;function Yt(){return Ga||(Ga=1,pa.exports=Ht()),pa.exports}var Q=Yt();const la=e=>e.reduce((r,n,a)=>({...r,[a]:l=>n(l)||!0}),{}),Sn=(e,r)=>r.split(".").reduce((n,a)=>n!==void 0?n[a]:n,e)?.message,Me=({label:e,validate:r=[],readOnly:n=!1,onChange:a,onClick:l,className:t,size:E="small",...o})=>{const{name:A,control:R,disabled:k}=o,{formState:{errors:N}}=Ne(),{field:T}=ea({name:A,control:R,rules:{validate:h.useMemo(()=>la(r),[r])}}),F=Sn(N,A);return Q.jsxs(Q.Fragment,{children:[Q.jsx(ml,{size:E,disabled:k||n,checked:T.value===!0,className:t,error:!!F,...T,onChange:f=>{T.onChange(f),a&&a(f.currentTarget.checked)},onClick:()=>{l&&l()},children:e}),F&&Q.jsx(In,{children:Sn(N,A)})]})};var zn={exports:{}},qt=zn.exports,Pa;function wt(){return Pa||(Pa=1,(function(e,r){(function(n,a){e.exports=a()})(qt,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},a=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,l=/\d/,t=/\d\d/,E=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,A={},R=function(g){return(g=+g)+(g>68?1900:2e3)},k=function(g){return function(P){this[g]=+P}},N=[/[+-]\d\d:?(\d\d)?|Z/,function(g){(this.zone||(this.zone={})).offset=(function(P){if(!P||P==="Z")return 0;var m=P.match(/([+-]|\d\d)/g),O=60*m[1]+(+m[2]||0);return O===0?0:m[0]==="+"?-O:O})(g)}],T=function(g){var P=A[g];return P&&(P.indexOf?P:P.s.concat(P.f))},F=function(g,P){var m,O=A.meridiem;if(O){for(var G=1;G<=24;G+=1)if(g.indexOf(O(G,0,P))>-1){m=G>12;break}}else m=g===(P?"pm":"PM");return m},f={A:[o,function(g){this.afternoon=F(g,!1)}],a:[o,function(g){this.afternoon=F(g,!0)}],Q:[l,function(g){this.month=3*(g-1)+1}],S:[l,function(g){this.milliseconds=100*+g}],SS:[t,function(g){this.milliseconds=10*+g}],SSS:[/\d{3}/,function(g){this.milliseconds=+g}],s:[E,k("seconds")],ss:[E,k("seconds")],m:[E,k("minutes")],mm:[E,k("minutes")],H:[E,k("hours")],h:[E,k("hours")],HH:[E,k("hours")],hh:[E,k("hours")],D:[E,k("day")],DD:[t,k("day")],Do:[o,function(g){var P=A.ordinal,m=g.match(/\d+/);if(this.day=m[0],P)for(var O=1;O<=31;O+=1)P(O).replace(/\[|\]/g,"")===g&&(this.day=O)}],w:[E,k("week")],ww:[t,k("week")],M:[E,k("month")],MM:[t,k("month")],MMM:[o,function(g){var P=T("months"),m=(T("monthsShort")||P.map(function(O){return O.slice(0,3)})).indexOf(g)+1;if(m<1)throw new Error;this.month=m%12||m}],MMMM:[o,function(g){var P=T("months").indexOf(g)+1;if(P<1)throw new Error;this.month=P%12||P}],Y:[/[+-]?\d+/,k("year")],YY:[t,function(g){this.year=R(g)}],YYYY:[/\d{4}/,k("year")],Z:N,ZZ:N};function V(g){var P,m;P=g,m=A&&A.formats;for(var O=(g=P.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(Y,x,b){var U=b&&b.toUpperCase();return x||m[b]||n[b]||m[U].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(j,w,q){return w||q.slice(1)})})).match(a),G=O.length,_=0;_<G;_+=1){var D=O[_],I=f[D],M=I&&I[0],B=I&&I[1];O[_]=B?{regex:M,parser:B}:D.replace(/^\[|\]$/g,"")}return function(Y){for(var x={},b=0,U=0;b<G;b+=1){var j=O[b];if(typeof j=="string")U+=j.length;else{var w=j.regex,q=j.parser,ee=Y.slice(U),Ee=w.exec(ee)[0];q.call(x,Ee),Y=Y.replace(Ee,"")}}return(function(oe){var me=oe.afternoon;if(me!==void 0){var ae=oe.hours;me?ae<12&&(oe.hours+=12):ae===12&&(oe.hours=0),delete oe.afternoon}})(x),x}}return function(g,P,m){m.p.customParseFormat=!0,g&&g.parseTwoDigitYear&&(R=g.parseTwoDigitYear);var O=P.prototype,G=O.parse;O.parse=function(_){var D=_.date,I=_.utc,M=_.args;this.$u=I;var B=M[1];if(typeof B=="string"){var Y=M[2]===!0,x=M[3]===!0,b=Y||x,U=M[2];x&&(U=M[2]),A=this.$locale(),!Y&&U&&(A=m.Ls[U]),this.$d=(function(ee,Ee,oe,me){try{if(["x","X"].indexOf(Ee)>-1)return new Date((Ee==="X"?1e3:1)*ee);var ae=V(Ee)(ee),Ye=ae.year,ye=ae.month,On=ae.day,ln=ae.hours,pn=ae.minutes,qe=ae.seconds,tn=ae.milliseconds,Ge=ae.zone,Pe=ae.week,we=new Date,be=On||(Ye||ye?1:we.getDate()),xe=Ye||we.getFullYear(),fe=0;Ye&&!ye||(fe=ye>0?ye-1:we.getMonth());var Oe,Je=ln||0,Ce=pn||0,En=qe||0,ce=tn||0;return Ge?new Date(Date.UTC(xe,fe,be,Je,Ce,En,ce+60*Ge.offset*1e3)):oe?new Date(Date.UTC(xe,fe,be,Je,Ce,En,ce)):(Oe=new Date(xe,fe,be,Je,Ce,En,ce),Pe&&(Oe=me(Oe).week(Pe).toDate()),Oe)}catch{return new Date("")}})(D,B,I,m),this.init(),U&&U!==!0&&(this.$L=this.locale(U).$L),b&&D!=this.format(B)&&(this.$d=new Date("")),A={}}else if(B instanceof Array)for(var j=B.length,w=1;w<=j;w+=1){M[1]=B[w-1];var q=m.apply(this,M);if(q.isValid()){this.$d=q.$d,this.$L=q.$L,this.init();break}w===j&&(this.$d=new Date(""))}else G.call(this,_)}}})})(zn)),zn.exports}var xt=wt();const Jt=jt(xt),Ct="_textarea_14c7r_1",$t="_readOnlyField_14c7r_7",ba={textarea:Ct,readOnlyField:$t},zt=e=>e!=null&&e!=="",Wt=({label:e,value:r,isEdited:n=!1,type:a,hideLabel:l,size:t})=>zt(r)?Q.jsxs(Re,{gap:"space-4",children:[e&&!l&&Q.jsx(Dn,{size:t,children:e}),Q.jsxs(Ve,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(wa,{className:a==="textarea"?ba.textarea:ba.readOnlyField,size:t,children:r}),n&&Q.jsx(Tr,{})]})]}):null;Ir.extend(Jt);const Zt="_noReadOnlyIcon_11vhl_2",Xt={noReadOnlyIcon:Zt},Qt=({label:e,description:r,validate:n=[],onChange:a,children:l,className:t,isReadOnly:E=!1,size:o="small",isEdited:A=!1,hideLegend:R=!1,...k})=>{const{name:N,control:T}=k,{formState:{errors:F}}=Ne(),{field:f}=ea({name:N,control:T,rules:{validate:la(n)}});return Q.jsx(Sl,{name:N,value:f.value!==void 0?f.value:null,legend:Q.jsxs(Ve,{justify:"center",gap:"space-8",children:[e,E&&A&&Q.jsx(Tr,{})]}),hideLegend:R,"aria-readonly":E,readOnly:E,description:r,size:o,error:Sn(F,N),onChange:V=>{a&&a(V),f.onChange(V)},className:ht(t,Xt.noReadOnlyIcon),children:l})},ei="_textAreaFieldWithBadges_bdz0b_1",ni="_etikettWrapper_bdz0b_4",ca={textAreaFieldWithBadges:ei,etikettWrapper:ni},ai=({name:e,control:r,label:n,readOnly:a,maxLength:l,badges:t,validate:E=[],parse:o=F=>F,className:A,description:R,isEdited:k,size:N="small",...T})=>{const{formState:{errors:F}}=Ne(),{field:f}=ea({name:e,control:r,rules:{validate:h.useMemo(()=>la(E),[E])}});return a?Q.jsx(Wt,{size:N,label:n,value:f.value,type:"textarea",isEdited:k,hideLabel:T.hideLabel}):Q.jsxs("div",{className:t?ca.textAreaFieldWithBadges:null,children:[t&&Q.jsx("div",{className:ca.etikettWrapper,children:t.map(({type:V,titleText:g})=>Q.jsx(kl,{variant:V,size:"small",children:g},g))}),Q.jsx(fl,{size:N,label:n,description:R,className:A,autoComplete:"off",...f,onChange:V=>f.onChange(V.currentTarget.value!==""?o(V.currentTarget.value):null),value:f.value?f.value:"",error:Sn(F,e),maxLength:l,...T})]})},ri=({formMethods:e,onSubmit:r,children:n,className:a,setDataOnUnmount:l})=>{const{handleSubmit:t,getValues:E}=e;return h.useEffect(()=>()=>{l&&l(E())},[]),Q.jsx(Vl,{...e,children:Q.jsx("form",{className:a,onSubmit:r?t(o=>r(o)):void 0,children:n})})},li=(e,r)=>{const{setError:n,clearErrors:a,formState:l}=Ne(),t=!!r;return h.useEffect(()=>{t&&n(`${e}.notRegisteredInput`,{type:"custom",message:r}),t||a(`${e}.notRegisteredInput`)},[r]),l.isSubmitted?e.split(".").reduce((E,o)=>E[o]||{},l.errors)?.notRegisteredInput?.message:void 0},ti=fr(3),ii=Or(2e3),le="aksjonspunktGodkjenning",Ei=(e,r)=>!e(`${le}.${r}.feilFakta`)&&!e(`${le}.${r}.feilLov`)&&!e(`${le}.${r}.feilSkjønn`)&&!e(`${le}.${r}.feilUtredning`)&&!e(`${le}.${r}.feilSaksflyt`)&&!e(`${le}.${r}.feilBegrunnelse`),vr=({index:e,totrinnskontrollSkjermlenkeContext:r,readOnly:n})=>{const{watch:a,getValues:l,control:t}=Ne(),E=a("aksjonspunktGodkjenning"),{aksjonspunktKode:o,totrinnskontrollGodkjent:A}=E[e],R=r.find(F=>F.totrinnskontrollAksjonspunkter.some(f=>f.aksjonspunktKode===o)),k=R?.totrinnskontrollAksjonspunkter.find(F=>F.aksjonspunktKode===o),N=!A&&Ei(l,e)?Fr():void 0,T=li(`${le}.${e}.faktagruppe`,N);return!R||!k?null:v.jsxs(Re,{gap:"space-12",children:[v.jsx(Qt,{name:`${le}.${e}.totrinnskontrollGodkjent`,control:t,isReadOnly:n,hideLegend:!0,children:v.jsxs(Ve,{gap:"space-16",children:[v.jsx(sa,{value:!0,size:"small",children:v.jsx(H,{id:"ApprovalField.Godkjent"})}),v.jsx(sa,{value:!1,size:"small",children:v.jsx(H,{id:"ApprovalField.Vurder"})})]})}),A===!1&&v.jsx(St,{alignOffset:110,children:v.jsxs(Re,{gap:"space-8",children:[v.jsx(Dn,{size:"small",children:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),v.jsx(ne,{size:"small",children:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),v.jsxs(Re,{gap:"space-16",children:[v.jsx(Re,{gap:"space-4",children:v.jsxs(Ve,{justify:"space-between",style:{width:"300px"},children:[v.jsxs(Re,{gap:"space-4",children:[v.jsx(Me,{name:`${le}.${e}.feilFakta`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilSkjønn`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilLov`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),v.jsxs(Re,{gap:"space-4",children:[v.jsx(Me,{name:`${le}.${e}.feilUtredning`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilSaksflyt`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),v.jsx(Me,{name:`${le}.${e}.feilBegrunnelse`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),T&&v.jsx(In,{size:"small",children:T}),v.jsx(ai,{name:`${le}.${e}.besluttersBegrunnelse`,control:t,label:v.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[yr,ti,ii,pr],readOnly:n})]})]})})]})};vr.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  erEndret?: boolean;
  erLagtTil?: boolean;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"erSlettet",value:{name:"boolean",required:!1}},{key:"erEndret",value:{name:"boolean",required:!1}},{key:"erLagtTil",value:{name:"boolean",required:!1}}]}}],raw:"Array<foreldrepenger_domene_uttak_UttakPeriodeEndringDto>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const oi="_aksjonspunktTextContainer_1pwmv_5",si="_lenke_1pwmv_10",Ua={aksjonspunktTextContainer:oi,lenke:si},di="aksjonspunktGodkjenning",Rr=({behandling:e,totrinnskontrollSkjermlenkeContext:r,readOnly:n,erForeldrepengerFagsak:a,erTilbakekreving:l,skjemalenkeTyper:t,faktaOmBeregningTilfeller:E,lagLenke:o})=>{const{control:A,watch:R}=Ne(),{fields:k}=$l({control:A,name:di}),N=R("aksjonspunktGodkjenning");return v.jsx(Re,{gap:"space-24",children:k.map((T,F)=>{const{aksjonspunktKode:f}=N[F],V=r.find(G=>G.totrinnskontrollAksjonspunkter.some(_=>_.aksjonspunktKode===f)),g=V?.totrinnskontrollAksjonspunkter.find(G=>G.aksjonspunktKode===f);if(!V||!g)return null;const P=ur(a,e.status,E,l,g,e.behandlingsresultat),m=t.find(G=>G.kode===V.skjermlenkeType),O=o(V.skjermlenkeType);return v.jsxs("div",{children:[O&&m&&v.jsx(Ha,{to:O,onClick:()=>globalThis.scroll(0,0),className:Ua.lenke,children:m.navn}),P.map((G,_)=>v.jsx("div",{className:Ua.aksjonspunktTextContainer,children:v.jsx(ne,{size:"small",children:G})},f.concat("_".concat(_.toString())))),v.jsx(vr,{index:F,totrinnskontrollSkjermlenkeContext:r,readOnly:n})]},T.id)})})};Rr.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id?: number;
  uuid: string;
  versjon: number;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Ma=(e=[])=>e.every(r=>r.totrinnskontrollGodkjent),Ba=(e=[])=>e.every(r=>r.totrinnskontrollGodkjent!==void 0),ui=(e,r)=>{if(!r)return!0;const{konsekvenserForYtelsen:n}=r;return!Array.isArray(n)||n.length!==1?!0:!e.some(a=>a===n[0])},ki=e=>e.reduce((r,n)=>n===te.FEIL_FAKTA?{...r,feilFakta:!0}:n===te.FEIL_LOV?{...r,feilLov:!0}:n===te.FEIL_REGEL?{...r,feilSkjønn:!0}:n===te.SKJØNN?{...r,feilSkjønn:!0}:n===te.UTREDNING?{...r,feilUtredning:!0}:n===te.SAKSFLYT||n===te.ANNET?{...r,feilSaksflyt:!0}:n===te.BEGRUNNELSE?{...r,feilBegrunnelse:!0}:{},{}),Ti=e=>({aksjonspunktGodkjenning:e.map(r=>r.totrinnskontrollAksjonspunkter).flat().map(r=>({aksjonspunktKode:r.aksjonspunktKode,totrinnskontrollGodkjent:r.totrinnskontrollGodkjent,besluttersBegrunnelse:Ya(r.besluttersBegrunnelse??void 0),...ki(r.vurderPaNyttArsaker)}))}),_r=({behandling:e,onSubmit:r,forhandsvisVedtaksbrev:n,readOnly:a,erBehandlingEtterKlage:l,erForeldrepengerFagsak:t,skjemalenkeTyper:E,erTilbakekreving:o,totrinnskontrollSkjermlenkeContext:A,faktaOmBeregningTilfeller:R,lagLenke:k,beslutterFormData:N,setBeslutterFormData:T})=>{const F=e.type===Xe.KLAGE,f=e.type===Xe.ANKE,V=ui([xn.ENDRING_I_FORDELING_AV_YTELSEN,xn.INGEN_ENDRING],e.behandlingsresultat),g=Ti(A),P=zl({defaultValues:N||g}),m=P.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?v.jsx(ri,{formMethods:P,onSubmit:r,setDataOnUnmount:T,children:v.jsxs(Re,{gap:"space-24",children:[!a&&v.jsx(Rt,{children:v.jsx(H,{id:"HelpText.ToTrinnsKontroll"})}),v.jsx(Rr,{behandling:e,erForeldrepengerFagsak:t,erTilbakekreving:o,readOnly:a,totrinnskontrollSkjermlenkeContext:A,skjemalenkeTyper:E,faktaOmBeregningTilfeller:R,lagLenke:k}),v.jsxs(Ve,{gap:"space-16",style:{marginBottom:"50px"},children:[v.jsx(qn,{variant:"primary",size:"small",disabled:!Ma(m)||!Ba(m)||P.formState.isSubmitting,loading:P.formState.isSubmitting,children:v.jsx(H,{id:"ToTrinnsForm.Godkjenn"})}),v.jsx(qn,{variant:"primary",size:"small",disabled:Ma(m)||!Ba(m)||P.formState.isSubmitting,loading:P.formState.isSubmitting,children:v.jsx(H,{id:"ToTrinnsForm.SendTilbake"})}),!F&&!l&&!f&&!o&&V&&v.jsx(sl,{href:"#",onClick:n,children:v.jsx(H,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};_r.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id?: number;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const vi="_approvalItem_xqu47_1",Ri="_approvalItemContainer_xqu47_7",_i="_aksjonspunktTextContainer_xqu47_11",Ai="_resultatFraGodkjenningTextContainer_xqu47_16",Ni="_lenke_xqu47_20",mi="_checkmarkIcon_xqu47_24",gi="_xmark_xqu47_30",Se={approvalItem:vi,approvalItemContainer:Ri,aksjonspunktTextContainer:_i,resultatFraGodkjenningTextContainer:Ai,lenke:Ni,checkmarkIcon:mi,xmark:gi},Si=({vurderPaNyttArsaker:e,vurderArsaker:r})=>v.jsx("div",{className:Se.approvalItem,children:e.map(n=>v.jsxs(Ve,{gap:"space-8",children:[v.jsx(nl,{className:Se.xmark}),v.jsx("div",{children:r.find(a=>n===a.kode)?.navn})]},n))}),Ar=({behandling:e,totrinnskontrollSkjermlenkeContext:r,erForeldrepengerFagsak:n,erTilbakekreving:a,skjemalenkeTyper:l,vurderArsaker:t,faktaOmBeregningTilfeller:E,lagLenke:o})=>{const A=Vr();return v.jsxs(v.Fragment,{children:[v.jsx("div",{className:Se.resultatFraGodkjenningTextContainer,children:v.jsx(H,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Gr}})}),r.map(R=>{const k=R.totrinnskontrollAksjonspunkter,N=l.find(T=>T.kode===R.skjermlenkeType);if(k.length>0){const T=o(R.skjermlenkeType);return v.jsxs(d.Fragment,{children:[T&&N&&v.jsx(Ha,{to:T,onClick:()=>globalThis.scroll(0,0),className:Se.lenke,children:N.navn}),k.map(F=>{const f=ur(n,e.status,E,a,F,e.behandlingsresultat);return v.jsxs("div",{className:Se.approvalItemContainer,children:[f.map((V,g)=>v.jsx("div",{className:Se.aksjonspunktTextContainer,children:v.jsx(ne,{size:"small",children:V})},F.aksjonspunktKode.concat("_".concat(g.toString())))),v.jsx("div",{className:Se.approvalItem,children:F.totrinnskontrollGodkjent?v.jsxs(Ve,{gap:"space-8",children:[v.jsx(Cr,{title:A.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:Se.checkmarkIcon}),v.jsx(H,{id:"ToTrinnsForm.Godkjent"})]}):v.jsx(Si,{vurderPaNyttArsaker:F.vurderPaNyttArsaker,vurderArsaker:t})}),v.jsx("pre",{className:Se.approvalItem,children:Ya(F.besluttersBegrunnelse??void 0)})]},F.aksjonspunktKode)})]},R.skjermlenkeType)}return null})]})};Ar.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id?: number;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Li=je(jr),Ki=[sn.FAKTA_OM_FEILUTBETALING,sn.FORELDELSE,sn.TILBAKEKREVING,sn.VEDTAK],Di=e=>{const r=[];return e.feilFakta&&r.push(te.FEIL_FAKTA),e.feilLov&&r.push(te.FEIL_LOV),e.feilSkjønn&&r.push(te.SKJØNN),e.feilUtredning&&r.push(te.UTREDNING),e.feilSaksflyt&&r.push(te.SAKSFLYT),e.feilBegrunnelse&&r.push(te.BEGRUNNELSE),r},Ii=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],Nr=({behandling:e,location:r,fagsakYtelseType:n,readOnly:a,onSubmit:l,forhandsvisVedtaksbrev:t,alleKodeverk:E,createLocationForSkjermlenke:o,beslutterFormData:A,setBeslutterFormData:R})=>{const k=Xe.TILBAKEKREVING===e.type||Xe.TILBAKEKREVING_REVURDERING===e.type,N=O=>{const G=O.aksjonspunktGodkjenning.map(I=>({aksjonspunktKode:I.aksjonspunktKode,godkjent:!!I.totrinnskontrollGodkjent,begrunnelse:I.besluttersBegrunnelse,arsaker:Di(I)})),_=k?Ca.FATTER_VEDTAK:p.FATTER_VEDTAK;return l({fatterVedtakAksjonspunktDto:{"@type":_,kode:_,begrunnelse:void 0,aksjonspunktGodkjenningDtos:G},erAlleAksjonspunktGodkjent:O.aksjonspunktGodkjenning.every(I=>I.totrinnskontrollGodkjent)})},T=e.behandlingÅrsaker.map(({behandlingArsakType:O})=>O).some(O=>O===Tn.ETTER_KLAGE||O===Tn.KLAGE_U_INNTK||O===Tn.KLAGE_M_INNTK),F=k?Ki.flatMap(O=>{const G=e.totrinnskontrollÅrsaker.find(_=>_.skjermlenkeType===O.kode);return G?[G]:[]}):e.totrinnskontrollÅrsaker,f=O=>o(r,O),V=e.status===Ln.FATTER_VEDTAK,g=E.SkjermlenkeType,P=E.VurderÅrsak,m=Ii(E);return v.jsxs(Pr,{value:Li,children:[V&&v.jsx(_r,{behandling:e,totrinnskontrollSkjermlenkeContext:F,readOnly:a,onSubmit:N,forhandsvisVedtaksbrev:t,erForeldrepengerFagsak:n==="FP",skjemalenkeTyper:g,erBehandlingEtterKlage:T,faktaOmBeregningTilfeller:m,erTilbakekreving:k,lagLenke:f,beslutterFormData:A,setBeslutterFormData:R}),!V&&v.jsx(Ar,{behandling:e,totrinnskontrollSkjermlenkeContext:F,erForeldrepengerFagsak:n==="FP",erTilbakekreving:k,skjemalenkeTyper:g,lagLenke:f,vurderArsaker:P,faktaOmBeregningTilfeller:m})]})};Nr.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id?: number;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
