...
`&&(w.value+=" ");const x=U.boxSizing,c=sn(U.paddingBottom)+sn(U.paddingTop),M=sn(U.borderBottomWidth)+sn(U.borderTopWidth),B=w.scrollHeight-c;w.value="x";const Y=w.scrollHeight-c;let H=B;i&&(H=Math.max(Number(i)*Y,H)),s&&(H=Math.min(Number(s)*Y,H)),H=Math.max(H,Y);const ee=H+(x==="border-box"?c+M:0),le=Math.abs(H-B)<=1;return{outerHeightStyle:ee,overflow:le}},[s,i,y.placeholder]),I=()=>{const f=D();dr(f)||R(h=>sr(h,f,N))};or(()=>{const f=()=>{const c=D();dr(c)||ha.flushSync(()=>{R(M=>sr(M,c,N))})},h=Cr(()=>{var c,M,B;if(N.current=0,!((c=K.current)===null||c===void 0)&&c.style.height||!((M=K.current)===null||M===void 0)&&M.style.width){((B=K.current)===null||B===void 0?void 0:B.style.overflow)==="hidden"&&R(Y=>Object.assign(Object.assign({},Y),{overflow:!1}));return}f()},166,!0),U=K.current,w=ir(U);w.addEventListener("resize",h);let x;return typeof ResizeObserver<"u"&&(x=new ResizeObserver(h),x.observe(U)),()=>{h.clear(),w.removeEventListener("resize",h),x&&x.disconnect()}},[D]),or(()=>{I()}),P.useEffect(()=>{N.current=0},[u]);const A=f=>{N.current=0,v||I(),o&&o(f)},L=Object.assign({"--__ac-textarea-height":V.outerHeightStyle+"px","--__axc-textarea-height":V.outerHeightStyle+"px",overflow:V.overflow&&!m&&!(!((n=K.current)===null||n===void 0)&&n.style.height)&&!(!((r=K.current)===null||r===void 0)&&r.style.width)?"hidden":void 0},T);return E.createElement(E.Fragment,null,E.createElement("textarea",Object.assign({value:u,onChange:A,ref:G,rows:i,style:L},y,{className:t})),E.createElement("textarea",{"aria-hidden":!0,className:t,readOnly:!0,ref:F,tabIndex:-1,style:Object.assign({visibility:"hidden",position:"absolute",overflow:"hidden",height:0,top:0,left:0,transform:"translateZ(0)"},T)}))});function dr(e){return e==null||Object.keys(e).length===0||e.outerHeightStyle===0&&!e.overflow}const Lt=({maxLengthId:e,maxLength:a,currentLength:n,size:r,i18n:t})=>{const{cn:o}=Ae(),s=Ur("Textarea",{charsLeft:t?.counterLeft?`{chars} ${t.counterLeft}`:void 0,charsTooMany:t?.counterTooMuch?`{chars} ${t.counterTooMuch}`:void 0}),i=a-n,[m,T]=P.useState(i);return P.useEffect(()=>{const u=Cr(()=>{T(i)},2e3);return u(),()=>{u.clear()}},[i]),E.createElement(E.Fragment,null,E.createElement("span",{id:e,className:o("navds-sr-only")},s("maxLength",{maxLength:a})),i<20&&E.createElement("span",{role:"status",className:o("navds-textarea__sr-counter navds-sr-only")},kr(m,s)),E.createElement(ue,{className:o("navds-textarea__counter",{"navds-textarea__counter--error":i<0}),size:r},kr(i,s)))},kr=(e,a)=>e<0?a("charsTooMany",{chars:Math.abs(e)}):a("charsLeft",{chars:e});var Ot=function(e,a){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&a.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var t=0,r=Object.getOwnPropertySymbols(e);t<r.length;t++)a.indexOf(r[t])<0&&Object.prototype.propertyIsEnumerable.call(e,r[t])&&(n[r[t]]=e[r[t]]);return n};const Dt=P.forwardRef((e,a)=>{var n,r,t;const{inputProps:o,errorId:s,showErrorMsg:i,hasError:m,size:T,inputDescriptionId:u}=yn(e,"textarea"),{label:y,className:v,description:K,maxLength:G,hideLabel:F=!1,resize:N,UNSAFE_autoScrollbar:V,i18n:R,readOnly:D}=e,I=Ot(e,["label","className","description","maxLength","hideLabel","resize","UNSAFE_autoScrollbar","i18n","readOnly"]),{cn:A}=Ae(),L=Hr(),f=G!==void 0&&G>0,[h,U]=P.useState((n=e?.defaultValue)!==null&&n!==void 0?n:""),w=()=>{let c=I?.minRows?I?.minRows:3;return T==="small"&&(c=I?.minRows?I?.minRows:2),c},x=Jn(o["aria-describedby"],{[L??""]:f});return E.createElement("div",{className:A(v,"navds-form-field",`navds-form-field--${T}`,{"navds-form-field--disabled":!!o.disabled,"navds-form-field--readonly":D,"navds-textarea--readonly":D,"navds-textarea--error":m,"navds-textarea--autoscrollbar":V,[`navds-textarea--resize-${N===!0?"both":N}`]:N})},E.createElement(Sn,{htmlFor:o.id,size:T,className:A("navds-form-field__label",{"navds-sr-only":F})},D&&E.createElement(qr,null),y),!!K&&E.createElement(ue,{className:A("navds-form-field__description",{"navds-sr-only":F}),id:u,size:T,as:"div"},K),E.createElement(ft,Object.assign({},Le(I,["error","errorId","size"]),o,{onChange:Ua(e.onChange,e.value===void 0?c=>U(c.target.value):void 0),minRows:w(),autoScrollbar:V,ref:a,readOnly:D,className:A("navds-textarea__input","navds-body-short",`navds-body-short--${T??"medium"}`)},x?{"aria-describedby":x}:{})),f&&!D&&!o.disabled&&E.createElement(Lt,{maxLengthId:L,maxLength:G,currentLength:(t=(r=e.value)===null||r===void 0?void 0:r.length)!==null&&t!==void 0?t:h.length,size:T,i18n:R}),E.createElement("div",{className:A("navds-form-field__error"),id:s,"aria-relevant":"additions removals","aria-live":"polite"},i&&E.createElement(pn,{size:T,showIcon:!0},e.error)))});var en=e=>e.type==="checkbox",Fe=e=>e instanceof Date,oe=e=>e==null;const Wr=e=>typeof e=="object";var X=e=>!oe(e)&&!Array.isArray(e)&&Wr(e)&&!Fe(e),Zr=e=>X(e)&&e.target?en(e.target)?e.target.checked:e.target.value:e,bt=e=>e.substring(0,e.search(/\.\d+(\.|$)/))||e,Xr=(e,a)=>e.has(bt(a)),Ft=e=>{const a=e.constructor&&e.constructor.prototype;return X(a)&&a.hasOwnProperty("isPrototypeOf")},$n=typeof window<"u"&&typeof window.HTMLElement<"u"&&typeof document<"u";function z(e){let a;const n=Array.isArray(e),r=typeof FileList<"u"?e instanceof FileList:!1;if(e instanceof Date)a=new Date(e);else if(!($n&&(e instanceof Blob||r))&&(n||X(e)))if(a=n?[]:Object.create(Object.getPrototypeOf(e)),!n&&!Ft(e))a=e;else for(const t in e)e.hasOwnProperty(t)&&(a[t]=z(e[t]));else return e;return a}var Kn=e=>/^\w*$/.test(e),W=e=>e===void 0,fn=e=>Array.isArray(e)?e.filter(Boolean):[],zn=e=>fn(e.replace(/["|']|\]/g,"").split(/\.|\[/)),S=(e,a,n)=>{if(!a||!X(e))return n;const r=(Kn(a)?[a]:zn(a)).reduce((t,o)=>oe(t)?t:t[o],e);return W(r)||r===e?W(e[a])?n:e[a]:r},de=e=>typeof e=="boolean",J=(e,a,n)=>{let r=-1;const t=Kn(a)?[a]:zn(a),o=t.length,s=o-1;for(;++r<o;){const i=t[r];let m=n;if(r!==s){const T=e[i];m=X(T)||Array.isArray(T)?T:isNaN(+t[r+1])?{}:[]}if(i==="__proto__"||i==="constructor"||i==="prototype")return;e[i]=m,e=e[i]}};const Tn={BLUR:"blur",FOCUS_OUT:"focusout",CHANGE:"change"},Ee={onBlur:"onBlur",onChange:"onChange",onSubmit:"onSubmit",onTouched:"onTouched",all:"all"},Ne={max:"max",min:"min",maxLength:"maxLength",minLength:"minLength",pattern:"pattern",required:"required",validate:"validate"},Wn=E.createContext(null);Wn.displayName="HookFormContext";const Re=()=>E.useContext(Wn),It=e=>{const{children:a,...n}=e;return E.createElement(Wn.Provider,{value:n},a)};var Qr=(e,a,n,r=!0)=>{const t={defaultValues:a._defaultValues};for(const o in e)Object.defineProperty(t,o,{get:()=>{const s=o;return a._proxyFormState[s]!==Ee.all&&(a._proxyFormState[s]=!r||Ee.all),n&&(n[s]=!0),e[s]}});return t};const Ln=typeof window<"u"?E.useLayoutEffect:E.useEffect;function Vt(e){const a=Re(),{control:n=a.control,disabled:r,name:t,exact:o}=e||{},[s,i]=E.useState(n._formState),m=E.useRef({isDirty:!1,isLoading:!1,dirtyFields:!1,touchedFields:!1,validatingFields:!1,isValidating:!1,isValid:!1,errors:!1});return Ln(()=>n._subscribe({name:t,formState:m.current,exact:o,callback:T=>{!r&&i({...n._formState,...T})}}),[t,r,o]),E.useEffect(()=>{m.current.isValid&&n._setValid(!0)},[n]),E.useMemo(()=>Qr(s,n,m.current,!1),[s,n])}var ge=e=>typeof e=="string",ea=(e,a,n,r,t)=>ge(e)?(r&&a.watch.add(e),S(n,e,t)):Array.isArray(e)?e.map(o=>(r&&a.watch.add(o),S(n,o))):(r&&(a.watchAll=!0),n),Hn=e=>oe(e)||!Wr(e);function ye(e,a,n=new WeakSet){if(Hn(e)||Hn(a))return e===a;if(Fe(e)&&Fe(a))return e.getTime()===a.getTime();const r=Object.keys(e),t=Object.keys(a);if(r.length!==t.length)return!1;if(n.has(e)||n.has(a))return!0;n.add(e),n.add(a);for(const o of r){const s=e[o];if(!t.includes(o))return!1;if(o!=="ref"){const i=a[o];if(Fe(s)&&Fe(i)||X(s)&&X(i)||Array.isArray(s)&&Array.isArray(i)?!ye(s,i,n):s!==i)return!1}}return!0}function ct(e){const a=Re(),{control:n=a.control,name:r,defaultValue:t,disabled:o,exact:s,compute:i}=e||{},m=E.useRef(t),T=E.useRef(i),u=E.useRef(void 0);T.current=i;const y=E.useMemo(()=>n._getWatch(r,m.current),[n,r]),[v,K]=E.useState(T.current?T.current(y):y);return Ln(()=>n._subscribe({name:r,formState:{values:!0},exact:s,callback:G=>{if(!o){const F=ea(r,n._names,G.values||n._formValues,!1,m.current);if(T.current){const N=T.current(F);ye(N,u.current)||(K(N),u.current=N)}else K(F)}}}),[n,o,r,s]),E.useEffect(()=>n._removeUnmounted()),v}function Zn(e){const a=Re(),{name:n,disabled:r,control:t=a.control,shouldUnregister:o,defaultValue:s}=e,i=Xr(t._names.array,n),m=E.useMemo(()=>S(t._formValues,n,S(t._defaultValues,n,s)),[t,n,s]),T=ct({control:t,name:n,defaultValue:m,exact:!0}),u=Vt({control:t,name:n,exact:!0}),y=E.useRef(e),v=E.useRef(t.register(n,{...e.rules,value:T,...de(e.disabled)?{disabled:e.disabled}:{}}));y.current=e;const K=E.useMemo(()=>Object.defineProperties({},{invalid:{enumerable:!0,get:()=>!!S(u.errors,n)},isDirty:{enumerable:!0,get:()=>!!S(u.dirtyFields,n)},isTouched:{enumerable:!0,get:()=>!!S(u.touchedFields,n)},isValidating:{enumerable:!0,get:()=>!!S(u.validatingFields,n)},error:{enumerable:!0,get:()=>S(u.errors,n)}}),[u,n]),G=E.useCallback(R=>v.current.onChange({target:{value:Zr(R),name:n},type:Tn.CHANGE}),[n]),F=E.useCallback(()=>v.current.onBlur({target:{value:S(t._formValues,n),name:n},type:Tn.BLUR}),[n,t._formValues]),N=E.useCallback(R=>{const D=S(t._fields,n);D&&R&&(D._f.ref={focus:()=>R.focus&&R.focus(),select:()=>R.select&&R.select(),setCustomValidity:I=>R.setCustomValidity(I),reportValidity:()=>R.reportValidity()})},[t._fields,n]),V=E.useMemo(()=>({name:n,value:T,...de(r)||u.disabled?{disabled:u.disabled||r}:{},onChange:G,onBlur:F,ref:N}),[n,r,u.disabled,G,F,N,T]);return E.useEffect(()=>{const R=t._options.shouldUnregister||o;t.register(n,{...y.current.rules,...de(y.current.disabled)?{disabled:y.current.disabled}:{}});const D=(I,A)=>{const L=S(t._fields,I);L&&L._f&&(L._f.mount=A)};if(D(n,!0),R){const I=z(S(t._options.defaultValues,n));J(t._defaultValues,n,I),W(S(t._formValues,n))&&J(t._formValues,n,I)}return!i&&t.register(n),()=>{(i?R&&!t._state.action:R)?t.unregister(n):D(n,!1)}},[n,t,i,o]),E.useEffect(()=>{t._setDisabledField({disabled:r,name:n})},[r,n,t]),E.useMemo(()=>({field:V,formState:u,fieldState:K}),[V,u,K])}var Gt=(e,a,n,r,t)=>a?{...n[e],types:{...n[e]&&n[e].types?n[e].types:{},[r]:t||!0}}:{},ie=e=>Array.isArray(e)?e:[e],Er=()=>{let e=[];return{get observers(){return e},next:t=>{for(const o of e)o.next&&o.next(t)},subscribe:t=>(e.push(t),{unsubscribe:()=>{e=e.filter(o=>o!==t)}}),unsubscribe:()=>{e=[]}}},re=e=>X(e)&&!Object.keys(e).length,Xn=e=>e.type==="file",ve=e=>typeof e=="function",gn=e=>{if(!$n)return!1;const a=e?e.ownerDocument:0;return e instanceof(a&&a.defaultView?a.defaultView.HTMLElement:HTMLElement)},na=e=>e.type==="select-multiple",Qn=e=>e.type==="radio",Pt=e=>Qn(e)||en(e),In=e=>gn(e)&&e.isConnected;function jt(e,a){const n=a.slice(0,-1).length;let r=0;for(;r<n;)e=W(e)?r++:e[a[r++]];return e}function Mt(e){for(const a in e)if(e.hasOwnProperty(a)&&!W(e[a]))return!1;return!0}function Z(e,a){const n=Array.isArray(a)?a:Kn(a)?[a]:zn(a),r=n.length===1?e:jt(e,n),t=n.length-1,o=n[t];return r&&delete r[o],t!==0&&(X(r)&&re(r)||Array.isArray(r)&&Mt(r))&&Z(e,n.slice(0,-1)),e}var ra=e=>{for(const a in e)if(ve(e[a]))return!0;return!1};function An(e,a={}){const n=Array.isArray(e);if(X(e)||n)for(const r in e)Array.isArray(e[r])||X(e[r])&&!ra(e[r])?(a[r]=Array.isArray(e[r])?[]:{},An(e[r],a[r])):oe(e[r])||(a[r]=!0);return a}function aa(e,a,n){const r=Array.isArray(e);if(X(e)||r)for(const t in e)Array.isArray(e[t])||X(e[t])&&!ra(e[t])?W(a)||Hn(n[t])?n[t]=Array.isArray(e[t])?An(e[t],[]):{...An(e[t])}:aa(e[t],oe(a)?{}:a[t],n[t]):n[t]=!ye(e[t],a[t]);return n}var $e=(e,a)=>aa(e,a,An(a));const ur={value:!1,isValid:!1},vr={value:!0,isValid:!0};var ta=e=>{if(Array.isArray(e)){if(e.length>1){const a=e.filter(n=>n&&n.checked&&!n.disabled).map(n=>n.value);return{value:a,isValid:!!a.length}}return e[0].checked&&!e[0].disabled?e[0].attributes&&!W(e[0].attributes.value)?W(e[0].value)||e[0].value===""?vr:{value:e[0].value,isValid:!0}:vr:ur}return ur},oa=(e,{valueAsNumber:a,valueAsDate:n,setValueAs:r})=>W(e)?e:a?e===""?NaN:e&&+e:n&&ge(e)?new Date(e):r?r(e):e;const Tr={isValid:!1,value:null};var la=e=>Array.isArray(e)?e.reduce((a,n)=>n&&n.checked&&!n.disabled?{isValid:!0,value:n.value}:a,Tr):Tr;function gr(e){const a=e.ref;return Xn(a)?a.files:Qn(a)?la(e.refs).value:na(a)?[...a.selectedOptions].map(({value:n})=>n):en(a)?ta(e.refs).value:oa(W(a.value)?e.ref.value:a.value,e)}var ht=(e,a,n,r)=>{const t={};for(const o of e){const s=S(a,o);s&&J(t,o,s._f)}return{criteriaMode:n,names:[...e],fields:t,shouldUseNativeValidation:r}},Rn=e=>e instanceof RegExp,ze=e=>W(e)?e:Rn(e)?e.source:X(e)?Rn(e.value)?e.value.source:e.value:e,he=e=>({isOnSubmit:!e||e===Ee.onSubmit,isOnBlur:e===Ee.onBlur,isOnChange:e===Ee.onChange,isOnAll:e===Ee.all,isOnTouch:e===Ee.onTouched});const Ar="AsyncFunction";var Ut=e=>!!e&&!!e.validate&&!!(ve(e.validate)&&e.validate.constructor.name===Ar||X(e.validate)&&Object.values(e.validate).find(a=>a.constructor.name===Ar)),Bt=e=>e.mount&&(e.required||e.min||e.max||e.maxLength||e.minLength||e.pattern||e.validate),Yn=(e,a,n)=>!n&&(a.watchAll||a.watch.has(e)||[...a.watch].some(r=>e.startsWith(r)&&/^\.\w+/.test(e.slice(r.length))));const Ue=(e,a,n,r)=>{for(const t of n||Object.keys(e)){const o=S(e,t);if(o){const{_f:s,...i}=o;if(s){if(s.refs&&s.refs[0]&&a(s.refs[0],t)&&!r)return!0;if(s.ref&&a(s.ref,s.name)&&!r)return!0;if(Ue(i,a))break}else if(X(i)&&Ue(i,a))break}}};function Rr(e,a,n){const r=S(e,n);if(r||Kn(n))return{error:r,name:n};const t=n.split(".");for(;t.length;){const o=t.join("."),s=S(a,o),i=S(e,o);if(s&&!Array.isArray(s)&&n!==o)return{name:n};if(i&&i.type)return{name:o,error:i};if(i&&i.root&&i.root.type)return{name:`${o}.root`,error:i.root};t.pop()}return{name:n}}var qt=(e,a,n,r)=>{n(e);const{name:t,...o}=e;return re(o)||Object.keys(o).length>=Object.keys(a).length||Object.keys(o).find(s=>a[s]===(!r||Ee.all))},wt=(e,a,n)=>!e||!a||e===a||ie(e).some(r=>r&&(n?r===a:r.startsWith(a)||a.startsWith(r))),Ht=(e,a,n,r,t)=>t.isOnAll?!1:!n&&t.isOnTouch?!(a||e):(n?r.isOnBlur:t.isOnBlur)?!e:(n?r.isOnChange:t.isOnChange)?e:!0,Yt=(e,a)=>!fn(S(e,a)).length&&Z(e,a),sa=(e,a,n)=>{const r=ie(S(e,n));return J(r,"root",a[n]),J(e,n,r),e},un=e=>ge(e);function mr(e,a,n="validate"){if(un(e)||Array.isArray(e)&&e.every(un)||de(e)&&!e)return{type:n,message:un(e)?e:"",ref:a}}var je=e=>X(e)&&!Rn(e)?e:{value:e,message:""},xn=async(e,a,n,r,t,o)=>{const{ref:s,refs:i,required:m,maxLength:T,minLength:u,min:y,max:v,pattern:K,validate:G,name:F,valueAsNumber:N,mount:V}=e._f,R=S(n,F);if(!V||a.has(F))return{};const D=i?i[0]:s,I=c=>{t&&D.reportValidity&&(D.setCustomValidity(de(c)?"":c||""),D.reportValidity())},A={},L=Qn(s),f=en(s),h=L||f,U=(N||Xn(s))&&W(s.value)&&W(R)||gn(s)&&s.value===""||R===""||Array.isArray(R)&&!R.length,w=Gt.bind(null,F,r,A),x=(c,M,B,Y=Ne.maxLength,H=Ne.minLength)=>{const ee=c?M:B;A[F]={type:c?Y:H,message:ee,ref:s,...w(c?Y:H,ee)}};if(o?!Array.isArray(R)||!R.length:m&&(!h&&(U||oe(R))||de(R)&&!R||f&&!ta(i).isValid||L&&!la(i).isValid)){const{value:c,message:M}=un(m)?{value:!!m,message:m}:je(m);if(c&&(A[F]={type:Ne.required,message:M,ref:D,...w(Ne.required,M)},!r))return I(M),A}if(!U&&(!oe(y)||!oe(v))){let c,M;const B=je(v),Y=je(y);if(!oe(R)&&!isNaN(R)){const H=s.valueAsNumber||R&&+R;oe(B.value)||(c=H>B.value),oe(Y.value)||(M=H<Y.value)}else{const H=s.valueAsDate||new Date(R),ee=me=>new Date(new Date().toDateString()+" "+me),le=s.type=="time",se=s.type=="week";ge(B.value)&&R&&(c=le?ee(R)>ee(B.value):se?R>B.value:H>new Date(B.value)),ge(Y.value)&&R&&(M=le?ee(R)<ee(Y.value):se?R<Y.value:H<new Date(Y.value))}if((c||M)&&(x(!!c,B.message,Y.message,Ne.max,Ne.min),!r))return I(A[F].message),A}if((T||u)&&!U&&(ge(R)||o&&Array.isArray(R))){const c=je(T),M=je(u),B=!oe(c.value)&&R.length>+c.value,Y=!oe(M.value)&&R.length<+M.value;if((B||Y)&&(x(B,c.message,M.message),!r))return I(A[F].message),A}if(K&&!U&&ge(R)){const{value:c,message:M}=je(K);if(Rn(c)&&!R.match(c)&&(A[F]={type:Ne.pattern,message:M,ref:s,...w(Ne.pattern,M)},!r))return I(M),A}if(G){if(ve(G)){const c=await G(R,n),M=mr(c,D);if(M&&(A[F]={...M,...w(Ne.validate,M.message)},!r))return I(M.message),A}else if(X(G)){let c={};for(const M in G){if(!re(c)&&!r)break;const B=mr(await G[M](R,n),D,M);B&&(c={...B,...w(M,B.message)},I(B.message),r&&(A[F]=c))}if(!re(c)&&(A[F]={ref:D,...c},!r))return A}}return I(!0),A};const xt={mode:Ee.onSubmit,reValidateMode:Ee.onChange,shouldFocusError:!0};function Ct(e={}){let a={...xt,...e},n={submitCount:0,isDirty:!1,isReady:!1,isLoading:ve(a.defaultValues),isValidating:!1,isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,touchedFields:{},dirtyFields:{},validatingFields:{},errors:a.errors||{},disabled:a.disabled||!1},r={},t=X(a.defaultValues)||X(a.values)?z(a.defaultValues||a.values)||{}:{},o=a.shouldUnregister?{}:z(t),s={action:!1,mount:!1,watch:!1},i={mount:new Set,disabled:new Set,unMount:new Set,array:new Set,watch:new Set},m,T=0;const u={isDirty:!1,dirtyFields:!1,validatingFields:!1,touchedFields:!1,isValidating:!1,isValid:!1,errors:!1};let y={...u};const v={array:Er(),state:Er()},K=a.criteriaMode===Ee.all,G=l=>d=>{clearTimeout(T),T=setTimeout(l,d)},F=async l=>{if(!a.disabled&&(u.isValid||y.isValid||l)){const d=a.resolver?re((await f()).errors):await U(r,!0);d!==n.isValid&&v.state.next({isValid:d})}},N=(l,d)=>{!a.disabled&&(u.isValidating||u.validatingFields||y.isValidating||y.validatingFields)&&((l||Array.from(i.mount)).forEach(k=>{k&&(d?J(n.validatingFields,k,d):Z(n.validatingFields,k))}),v.state.next({validatingFields:n.validatingFields,isValidating:!re(n.validatingFields)}))},V=(l,d=[],k,O,p=!0,_=!0)=>{if(O&&k&&!a.disabled){if(s.action=!0,_&&Array.isArray(S(r,l))){const j=k(S(r,l),O.argA,O.argB);p&&J(r,l,j)}if(_&&Array.isArray(S(n.errors,l))){const j=k(S(n.errors,l),O.argA,O.argB);p&&J(n.errors,l,j),Yt(n.errors,l)}if((u.touchedFields||y.touchedFields)&&_&&Array.isArray(S(n.touchedFields,l))){const j=k(S(n.touchedFields,l),O.argA,O.argB);p&&J(n.touchedFields,l,j)}(u.dirtyFields||y.dirtyFields)&&(n.dirtyFields=$e(t,o)),v.state.next({name:l,isDirty:x(l,d),dirtyFields:n.dirtyFields,errors:n.errors,isValid:n.isValid})}else J(o,l,d)},R=(l,d)=>{J(n.errors,l,d),v.state.next({errors:n.errors})},D=l=>{n.errors=l,v.state.next({errors:n.errors,isValid:!1})},I=(l,d,k,O)=>{const p=S(r,l);if(p){const _=S(o,l,W(k)?S(t,l):k);W(_)||O&&O.defaultChecked||d?J(o,l,d?_:gr(p._f)):B(l,_),s.mount&&F()}},A=(l,d,k,O,p)=>{let _=!1,j=!1;const C={name:l};if(!a.disabled){if(!k||O){(u.isDirty||y.isDirty)&&(j=n.isDirty,n.isDirty=C.isDirty=x(),_=j!==C.isDirty);const $=ye(S(t,l),d);j=!!S(n.dirtyFields,l),$?Z(n.dirtyFields,l):J(n.dirtyFields,l,!0),C.dirtyFields=n.dirtyFields,_=_||(u.dirtyFields||y.dirtyFields)&&j!==!$}if(k){const $=S(n.touchedFields,l);$||(J(n.touchedFields,l,k),C.touchedFields=n.touchedFields,_=_||(u.touchedFields||y.touchedFields)&&$!==k)}_&&p&&v.state.next(C)}return _?C:{}},L=(l,d,k,O)=>{const p=S(n.errors,l),_=(u.isValid||y.isValid)&&de(d)&&n.isValid!==d;if(a.delayError&&k?(m=G(()=>R(l,k)),m(a.delayError)):(clearTimeout(T),m=null,k?J(n.errors,l,k):Z(n.errors,l)),(k?!ye(p,k):p)||!re(O)||_){const j={...O,..._&&de(d)?{isValid:d}:{},errors:n.errors,name:l};n={...n,...j},v.state.next(j)}},f=async l=>{N(l,!0);const d=await a.resolver(o,a.context,ht(l||i.mount,r,a.criteriaMode,a.shouldUseNativeValidation));return N(l),d},h=async l=>{const{errors:d}=await f(l);if(l)for(const k of l){const O=S(d,k);O?J(n.errors,k,O):Z(n.errors,k)}else n.errors=d;return d},U=async(l,d,k={valid:!0})=>{for(const O in l){const p=l[O];if(p){const{_f:_,...j}=p;if(_){const C=i.array.has(_.name),$=p._f&&Ut(p._f);$&&u.validatingFields&&N([O],!0);const ke=await xn(p,i.disabled,o,K,a.shouldUseNativeValidation&&!d,C);if($&&u.validatingFields&&N([O]),ke[_.name]&&(k.valid=!1,d))break;!d&&(S(ke,_.name)?C?sa(n.errors,ke,_.name):J(n.errors,_.name,ke[_.name]):Z(n.errors,_.name))}!re(j)&&await U(j,d,k)}}return k.valid},w=()=>{for(const l of i.unMount){const d=S(r,l);d&&(d._f.refs?d._f.refs.every(k=>!In(k)):!In(d._f.ref))&&He(l)}i.unMount=new Set},x=(l,d)=>!a.disabled&&(l&&d&&J(o,l,d),!ye(me(),t)),c=(l,d,k)=>ea(l,i,{...s.mount?o:W(d)?t:ge(l)?{[l]:d}:d},k,d),M=l=>fn(S(s.mount?o:t,l,a.shouldUnregister?S(t,l,[]):[])),B=(l,d,k={})=>{const O=S(r,l);let p=d;if(O){const _=O._f;_&&(!_.disabled&&J(o,l,oa(d,_)),p=gn(_.ref)&&oe(d)?"":d,na(_.ref)?[..._.ref.options].forEach(j=>j.selected=p.includes(j.value)):_.refs?en(_.ref)?_.refs.forEach(j=>{(!j.defaultChecked||!j.disabled)&&(Array.isArray(p)?j.checked=!!p.find(C=>C===j.value):j.checked=p===j.value||!!p)}):_.refs.forEach(j=>j.checked=j.value===p):Xn(_.ref)?_.ref.value="":(_.ref.value=p,_.ref.type||v.state.next({name:l,values:z(o)})))}(k.shouldDirty||k.shouldTouch)&&A(l,p,k.shouldTouch,k.shouldDirty,!0),k.shouldValidate&&se(l)},Y=(l,d,k)=>{for(const O in d){if(!d.hasOwnProperty(O))return;const p=d[O],_=l+"."+O,j=S(r,_);(i.array.has(l)||X(p)||j&&!j._f)&&!Fe(p)?Y(_,p,k):B(_,p,k)}},H=(l,d,k={})=>{const O=S(r,l),p=i.array.has(l),_=z(d);J(o,l,_),p?(v.array.next({name:l,values:z(o)}),(u.isDirty||u.dirtyFields||y.isDirty||y.dirtyFields)&&k.shouldDirty&&v.state.next({name:l,dirtyFields:$e(t,o),isDirty:x(l,_)})):O&&!O._f&&!oe(_)?Y(l,_,k):B(l,_,k),Yn(l,i)&&v.state.next({...n,name:l}),v.state.next({name:s.mount?l:void 0,values:z(o)})},ee=async l=>{s.mount=!0;const d=l.target;let k=d.name,O=!0;const p=S(r,k),_=$=>{O=Number.isNaN($)||Fe($)&&isNaN($.getTime())||ye($,S(o,k,$))},j=he(a.mode),C=he(a.reValidateMode);if(p){let $,ke;const on=d.type?gr(p._f):Zr(l),pe=l.type===Tn.BLUR||l.type===Tn.FOCUS_OUT,ma=!Bt(p._f)&&!a.resolver&&!S(n.errors,k)&&!p._f.deps||Ht(pe,S(n.touchedFields,k),n.isSubmitted,C,j),bn=Yn(k,i,pe);J(o,k,on),pe?(!d||!d.readOnly)&&(p._f.onBlur&&p._f.onBlur(l),m&&m(0)):p._f.onChange&&p._f.onChange(l);const Fn=A(k,on,pe),Na=!re(Fn)||bn;if(!pe&&v.state.next({name:k,type:l.type,values:z(o)}),ma)return(u.isValid||y.isValid)&&(a.mode==="onBlur"?pe&&F():pe||F()),Na&&v.state.next({name:k,...bn?{}:Fn});if(!pe&&bn&&v.state.next({...n}),a.resolver){const{errors:rr}=await f([k]);if(_(on),O){const _a=Rr(n.errors,r,k),ar=Rr(rr,r,_a.name||k);$=ar.error,k=ar.name,ke=re(rr)}}else N([k],!0),$=(await xn(p,i.disabled,o,K,a.shouldUseNativeValidation))[k],N([k]),_(on),O&&($?ke=!1:(u.isValid||y.isValid)&&(ke=await U(r,!0)));O&&(p._f.deps&&se(p._f.deps),L(k,ke,$,Fn))}},le=(l,d)=>{if(S(n.errors,d)&&l.focus)return l.focus(),1},se=async(l,d={})=>{let k,O;const p=ie(l);if(a.resolver){const _=await h(W(l)?l:p);k=re(_),O=l?!p.some(j=>S(_,j)):k}else l?(O=(await Promise.all(p.map(async _=>{const j=S(r,_);return await U(j&&j._f?{[_]:j}:j)}))).every(Boolean),!(!O&&!n.isValid)&&F()):O=k=await U(r);return v.state.next({...!ge(l)||(u.isValid||y.isValid)&&k!==n.isValid?{}:{name:l},...a.resolver||!l?{isValid:k}:{},errors:n.errors}),d.shouldFocus&&!O&&Ue(r,le,l?p:i.mount),O},me=l=>{const d={...s.mount?o:t};return W(l)?d:ge(l)?S(d,l):l.map(k=>S(d,k))},ne=(l,d)=>({invalid:!!S((d||n).errors,l),isDirty:!!S((d||n).dirtyFields,l),error:S((d||n).errors,l),isValidating:!!S(n.validatingFields,l),isTouched:!!S((d||n).touchedFields,l)}),we=l=>{l&&ie(l).forEach(d=>Z(n.errors,d)),v.state.next({errors:l?n.errors:{}})},Oe=(l,d,k)=>{const O=(S(r,l,{_f:{}})._f||{}).ref,p=S(n.errors,l)||{},{ref:_,message:j,type:C,...$}=p;J(n.errors,l,{...$,...d,ref:O}),v.state.next({name:l,errors:n.errors,isValid:!1}),k&&k.shouldFocus&&O&&O.focus&&O.focus()},On=(l,d)=>ve(l)?v.state.subscribe({next:k=>"values"in k&&l(c(void 0,d),k)}):c(l,d,!0),rn=l=>v.state.subscribe({next:d=>{wt(l.name,d.name,l.exact)&&qt(d,l.formState||u,Je,l.reRenderRoot)&&l.callback({values:{...o},...n,...d,defaultValues:t})}}).unsubscribe,Dn=l=>(s.mount=!0,y={...y,...l.formState},rn({...l,formState:y})),He=(l,d={})=>{for(const k of l?ie(l):i.mount)i.mount.delete(k),i.array.delete(k),d.keepValue||(Z(r,k),Z(o,k)),!d.keepError&&Z(n.errors,k),!d.keepDirty&&Z(n.dirtyFields,k),!d.keepTouched&&Z(n.touchedFields,k),!d.keepIsValidating&&Z(n.validatingFields,k),!a.shouldUnregister&&!d.keepDefaultValue&&Z(t,k);v.state.next({values:z(o)}),v.state.next({...n,...d.keepDirty?{isDirty:x()}:{}}),!d.keepIsValid&&F()},an=({disabled:l,name:d})=>{(de(l)&&s.mount||l||i.disabled.has(d))&&(l?i.disabled.add(d):i.disabled.delete(d))},Ve=(l,d={})=>{let k=S(r,l);const O=de(d.disabled)||de(a.disabled);return J(r,l,{...k||{},_f:{...k&&k._f?k._f:{ref:{name:l}},name:l,mount:!0,...d}}),i.mount.add(l),k?an({disabled:de(d.disabled)?d.disabled:a.disabled,name:l}):I(l,!0,d.value),{...O?{disabled:d.disabled||a.disabled}:{},...a.progressive?{required:!!d.required,min:ze(d.min),max:ze(d.max),minLength:ze(d.minLength),maxLength:ze(d.maxLength),pattern:ze(d.pattern)}:{},name:l,onChange:ee,onBlur:ee,ref:p=>{if(p){Ve(l,d),k=S(r,l);const _=W(p.value)&&p.querySelectorAll&&p.querySelectorAll("input,select,textarea")[0]||p,j=Pt(_),C=k._f.refs||[];if(j?C.find($=>$===_):_===k._f.ref)return;J(r,l,{_f:{...k._f,...j?{refs:[...C.filter(In),_,...Array.isArray(S(t,l))?[{}]:[]],ref:{type:_.type,name:l}}:{ref:_}}}),I(l,!1,void 0,_)}else k=S(r,l,{}),k._f&&(k._f.mount=!1),(a.shouldUnregister||d.shouldUnregister)&&!(Xr(i.array,l)&&s.action)&&i.unMount.add(l)}}},ce=()=>a.shouldFocusError&&Ue(r,le,i.mount),Ye=l=>{de(l)&&(v.state.next({disabled:l}),Ue(r,(d,k)=>{const O=S(r,k);O&&(d.disabled=O._f.disabled||l,Array.isArray(O._f.refs)&&O._f.refs.forEach(p=>{p.disabled=O._f.disabled||l}))},0,!1))},Ge=(l,d)=>async k=>{let O;k&&(k.preventDefault&&k.preventDefault(),k.persist&&k.persist());let p=z(o);if(v.state.next({isSubmitting:!0}),a.resolver){const{errors:_,values:j}=await f();n.errors=_,p=z(j)}else await U(r);if(i.disabled.size)for(const _ of i.disabled)Z(p,_);if(Z(n.errors,"root"),re(n.errors)){v.state.next({errors:{}});try{await l(p,k)}catch(_){O=_}}else d&&await d({...n.errors},k),ce(),setTimeout(ce);if(v.state.next({isSubmitted:!0,isSubmitting:!1,isSubmitSuccessful:re(n.errors)&&!O,submitCount:n.submitCount+1,errors:n.errors}),O)throw O},xe=(l,d={})=>{S(r,l)&&(W(d.defaultValue)?H(l,z(S(t,l))):(H(l,d.defaultValue),J(t,l,z(d.defaultValue))),d.keepTouched||Z(n.touchedFields,l),d.keepDirty||(Z(n.dirtyFields,l),n.isDirty=d.defaultValue?x(l,z(S(t,l))):x()),d.keepError||(Z(n.errors,l),u.isValid&&F()),v.state.next({...n}))},De=(l,d={})=>{const k=l?z(l):t,O=z(k),p=re(l),_=p?t:O;if(d.keepDefaultValues||(t=k),!d.keepValues){if(d.keepDirtyValues){const j=new Set([...i.mount,...Object.keys($e(t,o))]);for(const C of Array.from(j))S(n.dirtyFields,C)?J(_,C,S(o,C)):H(C,S(_,C))}else{if($n&&W(l))for(const j of i.mount){const C=S(r,j);if(C&&C._f){const $=Array.isArray(C._f.refs)?C._f.refs[0]:C._f.ref;if(gn($)){const ke=$.closest("form");if(ke){ke.reset();break}}}}if(d.keepFieldsRef)for(const j of i.mount)H(j,S(_,j));else r={}}o=a.shouldUnregister?d.keepDefaultValues?z(t):{}:z(_),v.array.next({values:{..._}}),v.state.next({values:{..._}})}i={mount:d.keepDirtyValues?i.mount:new Set,unMount:new Set,array:new Set,disabled:new Set,watch:new Set,watchAll:!1,focus:""},s.mount=!u.isValid||!!d.keepIsValid||!!d.keepDirtyValues,s.watch=!!a.shouldUnregister,v.state.next({submitCount:d.keepSubmitCount?n.submitCount:0,isDirty:p?!1:d.keepDirty?n.isDirty:!!(d.keepDefaultValues&&!ye(l,t)),isSubmitted:d.keepIsSubmitted?n.isSubmitted:!1,dirtyFields:p?{}:d.keepDirtyValues?d.keepDefaultValues&&o?$e(t,o):n.dirtyFields:d.keepDefaultValues&&l?$e(t,l):d.keepDirty?n.dirtyFields:{},touchedFields:d.keepTouched?n.touchedFields:{},errors:d.keepErrors?n.errors:{},isSubmitSuccessful:d.keepIsSubmitSuccessful?n.isSubmitSuccessful:!1,isSubmitting:!1,defaultValues:t})},be=(l,d)=>De(ve(l)?l(o):l,d),Ce=(l,d={})=>{const k=S(r,l),O=k&&k._f;if(O){const p=O.refs?O.refs[0]:O.ref;p.focus&&(p.focus(),d.shouldSelect&&ve(p.select)&&p.select())}},Je=l=>{n={...n,...l}},Pe={control:{register:Ve,unregister:He,getFieldState:ne,handleSubmit:Ge,setError:Oe,_subscribe:rn,_runSchema:f,_focusError:ce,_getWatch:c,_getDirty:x,_setValid:F,_setFieldArray:V,_setDisabledField:an,_setErrors:D,_getFieldArray:M,_reset:De,_resetDefaultValues:()=>ve(a.defaultValues)&&a.defaultValues().then(l=>{be(l,a.resetOptions),v.state.next({isLoading:!1})}),_removeUnmounted:w,_disableForm:Ye,_subjects:v,_proxyFormState:u,get _fields(){return r},get _formValues(){return o},get _state(){return s},set _state(l){s=l},get _defaultValues(){return t},get _names(){return i},set _names(l){i=l},get _formState(){return n},get _options(){return a},set _options(l){a={...a,...l}}},subscribe:Dn,trigger:se,register:Ve,handleSubmit:Ge,watch:On,setValue:H,getValues:me,reset:be,resetField:xe,clearErrors:we,unregister:He,setError:Oe,setFocus:Ce,getFieldState:ne};return{...Pe,formControl:Pe}}var Ke=()=>{if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID();const e=typeof performance>"u"?Date.now():performance.now()*1e3;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{const n=(Math.random()*16+e)%16|0;return(a=="x"?n:n&3|8).toString(16)})},Vn=(e,a,n={})=>n.shouldFocus||W(n.shouldFocus)?n.focusName||`${e}.${W(n.focusIndex)?a:n.focusIndex}.`:"",cn=(e,a)=>[...e,...ie(a)],Gn=e=>Array.isArray(e)?e.map(()=>{}):void 0;function Pn(e,a,n){return[...e.slice(0,a),...ie(n),...e.slice(a)]}var jn=(e,a,n)=>Array.isArray(e)?(W(e[n])&&(e[n]=void 0),e.splice(n,0,e.splice(a,1)[0]),e):[],Mn=(e,a)=>[...ie(a),...ie(e)];function Jt(e,a){let n=0;const r=[...e];for(const t of a)r.splice(t-n,1),n++;return fn(r).length?r:[]}var hn=(e,a)=>W(a)?[]:Jt(e,ie(a).sort((n,r)=>n-r)),Un=(e,a,n)=>{[e[a],e[n]]=[e[n],e[a]]},Nr=(e,a,n)=>(e[a]=n,e);function $t(e){const a=Re(),{control:n=a.control,name:r,keyName:t="id",shouldUnregister:o,rules:s}=e,[i,m]=E.useState(n._getFieldArray(r)),T=E.useRef(n._getFieldArray(r).map(Ke)),u=E.useRef(i),y=E.useRef(!1);u.current=i,n._names.array.add(r),E.useMemo(()=>s&&n.register(r,s),[n,s,r]),Ln(()=>n._subjects.array.subscribe({next:({values:A,name:L})=>{if(L===r||!L){const f=S(A,r);Array.isArray(f)&&(m(f),T.current=f.map(Ke))}}}).unsubscribe,[n,r]);const v=E.useCallback(A=>{y.current=!0,n._setFieldArray(r,A)},[n,r]),K=(A,L)=>{const f=ie(z(A)),h=cn(n._getFieldArray(r),f);n._names.focus=Vn(r,h.length-1,L),T.current=cn(T.current,f.map(Ke)),v(h),m(h),n._setFieldArray(r,h,cn,{argA:Gn(A)})},G=(A,L)=>{const f=ie(z(A)),h=Mn(n._getFieldArray(r),f);n._names.focus=Vn(r,0,L),T.current=Mn(T.current,f.map(Ke)),v(h),m(h),n._setFieldArray(r,h,Mn,{argA:Gn(A)})},F=A=>{const L=hn(n._getFieldArray(r),A);T.current=hn(T.current,A),v(L),m(L),!Array.isArray(S(n._fields,r))&&J(n._fields,r,void 0),n._setFieldArray(r,L,hn,{argA:A})},N=(A,L,f)=>{const h=ie(z(L)),U=Pn(n._getFieldArray(r),A,h);n._names.focus=Vn(r,A,f),T.current=Pn(T.current,A,h.map(Ke)),v(U),m(U),n._setFieldArray(r,U,Pn,{argA:A,argB:Gn(L)})},V=(A,L)=>{const f=n._getFieldArray(r);Un(f,A,L),Un(T.current,A,L),v(f),m(f),n._setFieldArray(r,f,Un,{argA:A,argB:L},!1)},R=(A,L)=>{const f=n._getFieldArray(r);jn(f,A,L),jn(T.current,A,L),v(f),m(f),n._setFieldArray(r,f,jn,{argA:A,argB:L},!1)},D=(A,L)=>{const f=z(L),h=Nr(n._getFieldArray(r),A,f);T.current=[...h].map((U,w)=>!U||w===A?Ke():T.current[w]),v(h),m([...h]),n._setFieldArray(r,h,Nr,{argA:A,argB:f},!0,!1)},I=A=>{const L=ie(z(A));T.current=L.map(Ke),v([...L]),m([...L]),n._setFieldArray(r,[...L],f=>f,{},!0,!1)};return E.useEffect(()=>{if(n._state.action=!1,Yn(r,n._names)&&n._subjects.state.next({...n._formState}),y.current&&(!he(n._options.mode).isOnSubmit||n._formState.isSubmitted)&&!he(n._options.reValidateMode).isOnSubmit)if(n._options.resolver)n._runSchema([r]).then(A=>{const L=S(A.errors,r),f=S(n._formState.errors,r);(f?!L&&f.type||L&&(f.type!==L.type||f.message!==L.message):L&&L.type)&&(L?J(n._formState.errors,r,L):Z(n._formState.errors,r),n._subjects.state.next({errors:n._formState.errors}))});else{const A=S(n._fields,r);A&&A._f&&!(he(n._options.reValidateMode).isOnSubmit&&he(n._options.mode).isOnSubmit)&&xn(A,n._names.disabled,n._formValues,n._options.criteriaMode===Ee.all,n._options.shouldUseNativeValidation,!0).then(L=>!re(L)&&n._subjects.state.next({errors:sa(n._formState.errors,L,r)}))}n._subjects.state.next({name:r,values:z(n._formValues)}),n._names.focus&&Ue(n._fields,(A,L)=>{if(n._names.focus&&L.startsWith(n._names.focus)&&A.focus)return A.focus(),1}),n._names.focus="",n._setValid(),y.current=!1},[i,r,n]),E.useEffect(()=>(!S(n._formValues,r)&&n._setFieldArray(r),()=>{const A=(L,f)=>{const h=S(n._fields,L);h&&h._f&&(h._f.mount=f)};n._options.shouldUnregister||o?n.unregister(r):A(r,!1)}),[r,n,t,o]),{swap:E.useCallback(V,[v,r,n]),move:E.useCallback(R,[v,r,n]),prepend:E.useCallback(G,[v,r,n]),append:E.useCallback(K,[v,r,n]),remove:E.useCallback(F,[v,r,n]),insert:E.useCallback(N,[v,r,n]),update:E.useCallback(D,[v,r,n]),replace:E.useCallback(I,[v,r,n]),fields:E.useMemo(()=>i.map((A,L)=>({...A,[t]:T.current[L]||Ke()})),[i,t])}}function zt(e={}){const a=E.useRef(void 0),n=E.useRef(void 0),[r,t]=E.useState({isDirty:!1,isValidating:!1,isLoading:ve(e.defaultValues),isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,submitCount:0,dirtyFields:{},touchedFields:{},validatingFields:{},errors:e.errors||{},disabled:e.disabled||!1,isReady:!1,defaultValues:ve(e.defaultValues)?void 0:e.defaultValues});if(!a.current)if(e.formControl)a.current={...e.formControl,formState:r},e.defaultValues&&!ve(e.defaultValues)&&e.formControl.reset(e.defaultValues,e.resetOptions);else{const{formControl:s,...i}=Ct(e);a.current={...i,formState:r}}const o=a.current.control;return o._options=e,Ln(()=>{const s=o._subscribe({formState:o._proxyFormState,callback:()=>t({...o._formState}),reRenderRoot:!0});return t(i=>({...i,isReady:!0})),o._formState.isReady=!0,s},[o]),E.useEffect(()=>o._disableForm(e.disabled),[o,e.disabled]),E.useEffect(()=>{e.mode&&(o._options.mode=e.mode),e.reValidateMode&&(o._options.reValidateMode=e.reValidateMode)},[o,e.mode,e.reValidateMode]),E.useEffect(()=>{e.errors&&(o._setErrors(e.errors),o._focusError())},[o,e.errors]),E.useEffect(()=>{e.shouldUnregister&&o._subjects.state.next({values:o._getWatch()})},[o,e.shouldUnregister]),E.useEffect(()=>{if(o._proxyFormState.isDirty){const s=o._getDirty();s!==r.isDirty&&o._subjects.state.next({isDirty:s})}},[o,r.isDirty]),E.useEffect(()=>{e.values&&!ye(e.values,n.current)?(o._reset(e.values,{keepFieldsRef:!0,...o._options.resetOptions}),n.current=e.values,t(s=>({...s}))):o._resetDefaultValues()},[o,e.values]),E.useEffect(()=>{o._state.mount||(o._setValid(),o._state.mount=!0),o._state.watch&&(o._state.watch=!1,o._subjects.state.next({...o._formState})),o._removeUnmounted()}),a.current.formState=Qr(r,o),a.current}const Wt={[b.ADOPSJONSDOKUMENTAJON]:"ToTrinnsForm.Adopsjon.KontrollerOpplysninger",[b.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN]:"ToTrinnsForm.Adopsjon.VurderEktefellesBarn",[b.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE]:"ToTrinnsForm.Adopsjon.VurderMannAdoptererAlene",[b.OVERSTYR_ADOPSJONSVILKAR]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[b.OVERSTYRING_AV_ADOPSJONSVILKÅRET_FP]:"ToTrinnsForm.Adopsjon.VilkarOverstyrt",[b.OMSORGSOVERTAKELSE]:"ToTrinnsForm.Omsorgovertagelse.KontrollerOpplysninger",[b.MANUELL_VURDERING_AV_OMSORGSVILKARET]:"ToTrinnsForm.Omsorgovertagelse.VurderVilkarForeldreansvarTredjeLedd",[b.AUTO_VENT_PÅ_FODSELREGISTRERING]:"ToTrinnsForm.Fødsel.VurderSokersRelasjon",[b.SJEKK_TERMINBEKREFTELSE]:"ToTrinnsForm.Fødsel.SjekkTerminbekreftelse",[b.SJEKK_MANGLENDE_FØDSEL]:"ToTrinnsForm.Fødsel.SjekkManglendeFødsel",[b.OVERSTYR_FODSELSVILKAR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[b.OVERSTYR_FODSELSVILKAR_FAR_MEDMOR]:"ToTrinnsForm.Fødsel.VilkarOverstyrt",[b.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD]:"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarFjerdeLedd",[b.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN]:"ToTrinnsForm.Foreldreansvar.VurderTidligereUtbetaling",[b.AVKLAR_AKTIVITETER]:"ToTrinnsForm.Beregning.AvklarAktiviteter",[b.OVERSTYRING_AV_BEREGNINGSAKTIVITETER]:"ToTrinnsForm.Beregning.OverstyrtBeregningsaktiviteter",[b.OVERSTYRING_AV_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.OverstyrtBeregningsgrunnlag",[b.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.FASTSETT_BRUTTO_BEREGNINGSGRUNNLAG_SELVSTENDIG_NAERINGSDRIVENDE]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET]:"ToTrinnsForm.Beregning.InntektFastsatt",[b.VURDER_GRADERING_UTEN_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.GraderingUtenBG",[b.FORDEL_BEREGNINGSGRUNNLAG]:"ToTrinnsForm.Beregning.FastsettFordeltBeregningsgrunnlag",[b.SOKNADSFRISTVILKARET]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[b.VURDER_SOKNADSFRIST_FORELDREPENGER]:"ToTrinnsForm.Soknadsfrist.ManueltVurdert",[b.OVERSTYR_SOKNADSFRISTVILKAR]:"ToTrinnsForm.Soknadsfrist.VilkarOverstyrt",[b.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE]:"ToTrinnsForm.Medlemskap.VurderGyldigMedlemskap",[b.AVKLAR_LOVLIG_OPPHOLD]:"ToTrinnsForm.Medlemskap.AvklarLovligOpphold",[b.AVKLAR_OM_BRUKER_ER_BOSATT]:"ToTrinnsForm.Medlemskap.VurderSokerBosatt",[b.AVKLAR_OPPHOLDSRETT]:"ToTrinnsForm.Medlemskap.AvklarOppholdsrett",[b.OVERSTYR_MEDLEMSKAPSVILKAR]:"ToTrinnsForm.Medlemskap.VilkarOverstyrt",[b.OVERSTYR_AVKLAR_STARTDATO]:"ToTrinnsForm.Medlemskap.OverstyrtStartdato",[b.AVKLAR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.AvklartDekningsgrad",[b.OVERSTYR_DEKNINGSGRAD]:"ToTrinnsForm.Medlemskap.OverstyrtDekningsgrad",[b.FORESLA_VEDTAK]:"ToTrinnsForm.Vedtak.Fritekstbrev",[b.FORESLA_VEDTAK_MANUELT]:"ToTrinnsForm.Vedtak.Fritekstbrev",[b.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_OMSORG]:"ToTrinnsForm.Omsorg.VurderOmsorg",[b.MANUELL_KONTROLL_AV_OM_BRUKER_HAR_ALENEOMSORG]:"ToTrinnsForm.Aleneomsorg.VurderAleneomsorg",[b.KONTROLLER_OPPLYSNINGER_OM_DØD]:"ToTrinnsForm.Uttak.Dod",[b.KONTROLLER_OPPLYSNINGER_OM_SØKNADSFRIST]:"ToTrinnsForm.Uttak.Soknadsfrist",[b.KONTROLLER_REALITETSBEHANDLING_ELLER_KLAGE]:"ToTrinnsForm.Uttak.Klage",[b.ANNENPART_EØS]:"ToTrinnsForm.Uttak.AnnenpartEØS",[b.TETTE_SAKER]:"ToTrinnsForm.Uttak.TetteStønadsperioder",[b.KONTROLLER_OPPLYSNINGER_OM_FORDELING_AV_STØNADSPERIODEN]:"ToTrinnsForm.Uttak.FordelingStonadsperioder",[b.KONTROLLER_TILSTØTENDE_YTELSER_INNVILGET]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Innvilget",[b.KONTROLLER_TILSTØTENDE_YTELSER_OPPHØRT]:"ToTrinnsForm.Uttak.TilstotendeYtelser.Opphort",[b.TILKNYTTET_STORTINGET]:"ToTrinnsForm.Uttak.Stortinget",[b.VURDER_TILBAKETREKK]:"ToTrinnsForm.TilkjentYtelse.Tilbaketrekk",[b.VURDER_FARESIGNALER]:"ToTrinnsForm.Faresignaler.Vurder",[b.VURDER_OPPTJENINGSVILKARET]:"ToTrinnsForm.Opptjening.VurderOpptjeningsvilkåret",[b.VURDER_REFUSJON_BERGRUNN]:"ToTrinnsForm.Beregningsgrunnlag.Refusjonsstart",[b.VURDER_ARBEIDSFORHOLD_INNTEKTSMELDING]:"ToTrinnsForm.ArbeidOgInntekt.ManueltOpprettet"},Zt={},Xt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidMedNavn",values:{a:e,b:a,c:n}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringArbeidUtenNavn",values:{a:e,b:n}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.EndringAktivitet",values:{a:e}}),Qt=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidMedNavn",values:{a:e,bb:a,c:n,b:r=>g.jsx("b",{children:r})}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningArbeidUtenNavn",values:{a:e,bb:n,b:r=>g.jsx("b",{children:r})}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.UnderkjenningAktivitet",values:{a:e,b:r=>g.jsx("b",{children:r})}}),eo=(e,a,n)=>a&&n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidMedNavn",values:{a:e,b:a,c:n}}):n?g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningArbeidUtenNavn",values:{a:e,b:n}}):g.jsx(q,{id:"ToTrinnsForm.Opptjening.GodkjenningAktivitet",values:{a:e}}),ia=({aktivitet:e})=>e.erEndring?Xt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):e.godkjent?eo(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr):Qt(e.aktivitetType?e.aktivitetType.toLowerCase():void 0,e.arbeidsgiverNavn,e.orgnr);ia.__docgenInfo={description:"",methods:[],displayName:"OpptjeningTotrinnText",props:{aktivitet:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  godkjent: boolean;
  privatpersonFødselsdato?: string;
}>`},description:""}}};const no=e=>e?.fastsattVarigEndringNaering?g.jsx(q,{id:"ToTrinnsForm.Beregning.VarigEndring"}):g.jsx(q,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),_r=e=>e.uttakPerioder?e.uttakPerioder.map(a=>{const n=tr(a.fom),r=tr(a.tom);let t;return a.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":a.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":a.erEndret&&(e.aksjonspunktKode===b.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===b.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":a.erEndret&&e.aksjonspunktKode===b.OVERSTYRING_AV_UTTAKPERIODER||a.erEndret&&e.aksjonspunktKode===b.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":a.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",g.jsx(q,{id:t,values:{a:n,b:r}},t)}):[],ro=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(a=>g.jsx(ia,{aktivitet:a},a.aktivitetType)):[],ao=e=>{const a=Wt[e.aksjonspunktKode];return a?[g.jsx(q,{id:a},a)]:[]},to=e=>{const a=Zt[e.aksjonspunktKode];return a?[g.jsx(q,{id:a},a)]:[]},oo=e=>{const a=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[g.jsx(q,{id:a},a)]},lo=(e,a)=>a?.faktaOmBeregningTilfeller?a.faktaOmBeregningTilfeller.flatMap(n=>{const r=e.find(t=>t.kode===n);return r?[g.jsx("div",{children:r.navn},r.navn)]:[]}):[],so=e=>{let a="";switch(e?.type){case fe.KLAGE_YTELSESVEDTAK_STADFESTET:a="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case fe.KLAGE_YTELSESVEDTAK_OPPHEVET:a="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case fe.KLAGE_AVVIST:a="ToTrinnsForm.Klage.Avvist";break;case fe.HJEMSENDE_UTEN_OPPHEVE:a="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case fe.KLAGE_DELVIS_MEDHOLD:a="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case fe.KLAGE_OMGJORT_UGUNST:a="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case fe.KLAGE_MEDHOLD:a="ToTrinnsForm.Klage.OmgjortTilGunst";break}return g.jsx(q,{id:a})},io=(e,a)=>e===_n.FATTER_VEDTAK?[so(a)]:[],ko=()=>g.jsx(q,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),Eo=()=>g.jsx(q,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),uo=e=>e.aksjonspunktKode===b.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===b.VURDERING_AV_FORMKRAV_KLAGE_NFP,da=(e,a,n,r,t,o)=>t.aksjonspunktKode===b.VURDER_PERIODER_MED_OPPTJENING?ro(t):t.aksjonspunktKode===b.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[no(t.beregningDto)]:t.aksjonspunktKode===b.VURDER_FAKTA_FOR_ATFL_SN?lo(n,t.beregningDto):Ha(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0||Ya(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0?_r(t):t.aksjonspunktKode===b.AVKLAR_ANNEN_FORELDER_RETT?[ko()]:t.aksjonspunktKode===b.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?oo(e):t.aksjonspunktKode===b.OVERSTYRING_AV_RETT_OG_OMSORG?[Eo()]:uo(t)?io(a,o):r?to(t):ao(t);function vo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var yr={exports:{}},We={};/**
 * @license React
 ...
 */var Sr;function To(){if(Sr)return We;Sr=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,o){var s=null;if(o!==void 0&&(s=""+o),t.key!==void 0&&(s=""+t.key),"key"in t){o={};for(var i in t)i!=="key"&&(o[i]=t[i])}else o=t;return t=o.ref,{$$typeof:e,type:r,key:s,ref:t!==void 0?t:null,props:o}}return We.Fragment=a,We.jsx=n,We.jsxs=n,We}var pr;function go(){return pr||(pr=1,yr.exports=To()),yr.exports}var Se=go();const Ao=({children:e})=>!e||Array.isArray(e)&&e.length===0?null:Se.jsx(lt,{variant:"warning",size:"small",children:Se.jsx(Te,{gap:"space-8",children:E.Children.map(e,a=>Se.jsx(ue,{size:"small",children:a},pa(a)?a.key:a))})}),nn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};Be(nn);const mn="var(--ax-bg-neutral-strong)",ka=4,Ro=(e,a,n)=>`
  .arrowBoxTop${e} {
...
`,No=(e,a,n,r)=>a?mo(e,n,r):Ro(e,n,r),_o=(e,a,n)=>n?"":a?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,yo=({children:e,alignOffset:a=0,alignLeft:n=!1,marginTop:r=0,marginLeft:t=0,hideBorder:o=!1})=>Se.jsxs(Se.Fragment,{children:[Se.jsx("style",{dangerouslySetInnerHTML:{__html:No(a,n,r,t)}}),Se.jsx("div",{className:_o(a,n,o),children:e})]});var Kr={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var fr;function So(){return fr||(fr=1,function(e){(function(){var a={}.hasOwnProperty;function n(){for(var o="",s=0;s<arguments.length;s++){var i=arguments[s];i&&(o=t(o,r.call(this,i)))}return o}function r(o){if(typeof o=="string"||typeof o=="number")return this&&this[o]||o;if(typeof o!="object")return"";if(Array.isArray(o))return n.apply(this,o);if(o.toString!==Object.prototype.toString&&!o.toString.toString().includes("[native code]"))return o.toString();var s="";for(var i in o)a.call(o,i)&&o[i]&&(s=t(s,this&&this[i]||i));return s}function t(o,s){return s?o?o+" "+s:o+s:o}e.exports?(n.default=n,e.exports=n):window.classNames=n})()}(Kr)),Kr.exports}var po=So();const er=vo(po),Ko="_borderbox_1a0x6_1",fo="_error_1a0x6_5",Lo="_warning_1a0x6_8",Oo={borderbox:Ko,error:fo,warning:Lo};er.bind(Oo);const Do="_aksjonspunkt_11wjs_1",bo="_erAksjonspunktApent_11wjs_4",Fo="_erIkkeGodkjentAvBeslutter_11wjs_8",Io={aksjonspunkt:Do,erAksjonspunktApent:bo,erIkkeGodkjentAvBeslutter:Fo};er.bind(Io);Be(nn);Be(nn);const Vo="_divider_1jpov_1",co="_dividerParagraf_1jpov_8",Go="_leftPanel_1jpov_11",Po="_rightPanel_1jpov_14",jo={divider:Vo,dividerParagraf:co,leftPanel:Go,rightPanel:Po};er.bind(jo);const Ea=()=>Se.jsx("span",{"data-testid":"editedIcon",children:Se.jsx(Qa,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});Be(nn);Be(nn);function Mo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Lr={exports:{}},Ze={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Or;function ho(){if(Or)return Ze;Or=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function n(r,t,o){var s=null;if(o!==void 0&&(s=""+o),t.key!==void 0&&(s=""+t.key),"key"in t){o={};for(var i in t)i!=="key"&&(o[i]=t[i])}else o=t;return t=o.ref,{$$typeof:e,type:r,key:s,ref:t!==void 0?t:null,props:o}}return Ze.Fragment=a,Ze.jsx=n,Ze.jsxs=n,Ze}var Dr;function Uo(){return Dr||(Dr=1,Lr.exports=ho()),Lr.exports}var Q=Uo();const nr=e=>e.reduce((a,n,r)=>({...a,[r]:t=>n(t)||!0}),{}),Nn=(e,a)=>a.split(".").reduce((n,r)=>n!==void 0?n[r]:n,e)?.message,Me=({label:e,validate:a=[],readOnly:n=!1,onChange:r,onClick:t,className:o,...s})=>{const{name:i,control:m,disabled:T}=s,{formState:{errors:u}}=Re(),{field:y}=Zn({name:i,control:m,rules:{validate:P.useMemo(()=>nr(a),[a])}}),v=Nn(u,i);return Q.jsxs(Q.Fragment,{children:[Q.jsx(Nt,{size:"small",disabled:T||n,checked:y.value===!0,className:o,error:!!v,...y,onChange:K=>{y.onChange(K),r&&r(K.currentTarget.checked)},onClick:()=>{t&&t()},children:e}),v&&Q.jsx(pn,{children:Nn(u,i)})]})};var Cn={exports:{}},Bo=Cn.exports,br;function qo(){return br||(br=1,function(e,a){(function(n,r){e.exports=r()})(Bo,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,t=/\d/,o=/\d\d/,s=/\d\d?/,i=/\d*[^-_:/,()\s\d]+/,m={},T=function(N){return(N=+N)+(N>68?1900:2e3)},u=function(N){return function(V){this[N]=+V}},y=[/[+-]\d\d:?(\d\d)?|Z/,function(N){(this.zone||(this.zone={})).offset=function(V){if(!V||V==="Z")return 0;var R=V.match(/([+-]|\d\d)/g),D=60*R[1]+(+R[2]||0);return D===0?0:R[0]==="+"?-D:D}(N)}],v=function(N){var V=m[N];return V&&(V.indexOf?V:V.s.concat(V.f))},K=function(N,V){var R,D=m.meridiem;if(D){for(var I=1;I<=24;I+=1)if(N.indexOf(D(I,0,V))>-1){R=I>12;break}}else R=N===(V?"pm":"PM");return R},G={A:[i,function(N){this.afternoon=K(N,!1)}],a:[i,function(N){this.afternoon=K(N,!0)}],Q:[t,function(N){this.month=3*(N-1)+1}],S:[t,function(N){this.milliseconds=100*+N}],SS:[o,function(N){this.milliseconds=10*+N}],SSS:[/\d{3}/,function(N){this.milliseconds=+N}],s:[s,u("seconds")],ss:[s,u("seconds")],m:[s,u("minutes")],mm:[s,u("minutes")],H:[s,u("hours")],h:[s,u("hours")],HH:[s,u("hours")],hh:[s,u("hours")],D:[s,u("day")],DD:[o,u("day")],Do:[i,function(N){var V=m.ordinal,R=N.match(/\d+/);if(this.day=R[0],V)for(var D=1;D<=31;D+=1)V(D).replace(/\[|\]/g,"")===N&&(this.day=D)}],w:[s,u("week")],ww:[o,u("week")],M:[s,u("month")],MM:[o,u("month")],MMM:[i,function(N){var V=v("months"),R=(v("monthsShort")||V.map(function(D){return D.slice(0,3)})).indexOf(N)+1;if(R<1)throw new Error;this.month=R%12||R}],MMMM:[i,function(N){var V=v("months").indexOf(N)+1;if(V<1)throw new Error;this.month=V%12||V}],Y:[/[+-]?\d+/,u("year")],YY:[o,function(N){this.year=T(N)}],YYYY:[/\d{4}/,u("year")],Z:y,ZZ:y};function F(N){var V,R;V=N,R=m&&m.formats;for(var D=(N=V.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,c){var M=c&&c.toUpperCase();return x||R[c]||n[c]||R[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(B,Y,H){return Y||H.slice(1)})})).match(r),I=D.length,A=0;A<I;A+=1){var L=D[A],f=G[L],h=f&&f[0],U=f&&f[1];D[A]=U?{regex:h,parser:U}:L.replace(/^\[|\]$/g,"")}return function(w){for(var x={},c=0,M=0;c<I;c+=1){var B=D[c];if(typeof B=="string")M+=B.length;else{var Y=B.regex,H=B.parser,ee=w.slice(M),le=Y.exec(ee)[0];H.call(x,le),w=w.replace(le,"")}}return function(se){var me=se.afternoon;if(me!==void 0){var ne=se.hours;me?ne<12&&(se.hours+=12):ne===12&&(se.hours=0),delete se.afternoon}}(x),x}}return function(N,V,R){R.p.customParseFormat=!0,N&&N.parseTwoDigitYear&&(T=N.parseTwoDigitYear);var D=V.prototype,I=D.parse;D.parse=function(A){var L=A.date,f=A.utc,h=A.args;this.$u=f;var U=h[1];if(typeof U=="string"){var w=h[2]===!0,x=h[3]===!0,c=w||x,M=h[2];x&&(M=h[2]),m=this.$locale(),!w&&M&&(m=R.Ls[M]),this.$d=function(ee,le,se,me){try{if(["x","X"].indexOf(le)>-1)return new Date((le==="X"?1e3:1)*ee);var ne=F(le)(ee),we=ne.year,Oe=ne.month,On=ne.day,rn=ne.hours,Dn=ne.minutes,He=ne.seconds,an=ne.milliseconds,Ve=ne.zone,ce=ne.week,Ye=new Date,Ge=On||(we||Oe?1:Ye.getDate()),xe=we||Ye.getFullYear(),De=0;we&&!Oe||(De=Oe>0?Oe-1:Ye.getMonth());var be,Ce=rn||0,Je=Dn||0,tn=He||0,Pe=an||0;return Ve?new Date(Date.UTC(xe,De,Ge,Ce,Je,tn,Pe+60*Ve.offset*1e3)):se?new Date(Date.UTC(xe,De,Ge,Ce,Je,tn,Pe)):(be=new Date(xe,De,Ge,Ce,Je,tn,Pe),ce&&(be=me(be).week(ce).toDate()),be)}catch{return new Date("")}}(L,U,f,R),this.init(),M&&M!==!0&&(this.$L=this.locale(M).$L),c&&L!=this.format(U)&&(this.$d=new Date("")),m={}}else if(U instanceof Array)for(var B=U.length,Y=1;Y<=B;Y+=1){h[1]=U[Y-1];var H=R.apply(this,h);if(H.isValid()){this.$d=H.$d,this.$L=H.$L,this.init();break}Y===B&&(this.$d=new Date(""))}else I.call(this,A)}}})}(Cn)),Cn.exports}var wo=qo();const Ho=Mo(wo),Yo="_textarea_14c7r_1",xo="_readOnlyField_14c7r_7",Fr={textarea:Yo,readOnlyField:xo},Co=e=>e!=null&&e!=="",Jo=({label:e,value:a,isEdited:n=!1,type:r,hideLabel:t,size:o})=>Co(a)?Q.jsxs(Te,{gap:"space-4",children:[e&&!t&&Q.jsx(Sn,{size:o,children:e}),Q.jsxs(Ie,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(Br,{className:r==="textarea"?Fr.textarea:Fr.readOnlyField,size:o,children:a}),n&&Q.jsx(Ea,{})]})]}):null;Ka.extend(Ho);const $o=({label:e,description:a,validate:n=[],onChange:r,children:t,className:o,isReadOnly:s=!1,size:i="small",isEdited:m=!1,hideLegend:T=!1,...u})=>{const{name:y,control:v}=u,{formState:{errors:K}}=Re(),{field:G}=Zn({name:y,control:v,rules:{validate:nr(n)}});return Q.jsx(yt,{name:y,value:G.value!==void 0?G.value:null,legend:Q.jsxs(Ie,{justify:"center",gap:"space-8",children:[e,s&&m&&Q.jsx(Ea,{})]}),hideLegend:T,disabled:s,description:a,size:i,error:Nn(K,y),onChange:F=>{r&&r(F),G.onChange(F)},className:o,children:t})},zo="_textAreaFieldWithBadges_bdz0b_1",Wo="_etikettWrapper_bdz0b_4",Ir={textAreaFieldWithBadges:zo,etikettWrapper:Wo},Zo=({name:e,control:a,label:n,readOnly:r,maxLength:t,badges:o,validate:s=[],parse:i=K=>K,className:m,description:T,isEdited:u,size:y="small",...v})=>{const{formState:{errors:K}}=Re(),{field:G}=Zn({name:e,control:a,rules:{validate:P.useMemo(()=>nr(s),[s])}});return r?Q.jsx(Jo,{size:y,label:n,value:G.value,type:"textarea",isEdited:u,hideLabel:v.hideLabel}):Q.jsxs("div",{className:o?Ir.textAreaFieldWithBadges:null,children:[o&&Q.jsx("div",{className:Ir.etikettWrapper,children:o.map(({type:F,titleText:N})=>Q.jsx(ut,{variant:F,size:"small",children:N},N))}),Q.jsx(Dt,{size:y,label:n,description:T,className:m,autoComplete:"off",...G,onChange:F=>G.onChange(F.currentTarget.value!==""?i(F.currentTarget.value):null),value:G.value?G.value:"",error:Nn(K,e),maxLength:t,...v})]})},Xo=({formMethods:e,onSubmit:a,children:n,className:r,setDataOnUnmount:t})=>{const{handleSubmit:o,getValues:s}=e;return P.useEffect(()=>()=>{t&&t(s())},[]),Q.jsx(It,{...e,children:Q.jsx("form",{className:r,onSubmit:a?o(i=>a(i)):void 0,children:n})})},Qo=(e,a)=>{const{setError:n,clearErrors:r,formState:t}=Re(),o=!!a;return P.useEffect(()=>{o&&n(`${e}.notRegisteredInput`,{type:"custom",message:a}),o||r(`${e}.notRegisteredInput`)},[a]),t.isSubmitted?e.split(".").reduce((s,i)=>s[i]||{},t.errors)?.notRegisteredInput?.message:void 0},el=Oa(3),nl=Da(2e3),ae="aksjonspunktGodkjenning",rl=(e,a)=>!e(`${ae}.${a}.feilFakta`)&&!e(`${ae}.${a}.feilLov`)&&!e(`${ae}.${a}.feilSkjønn`)&&!e(`${ae}.${a}.feilUtredning`)&&!e(`${ae}.${a}.feilSaksflyt`)&&!e(`${ae}.${a}.feilBegrunnelse`),ua=({index:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n})=>{const{watch:r,getValues:t,control:o}=Re(),s=r("aksjonspunktGodkjenning"),{aksjonspunktKode:i,totrinnskontrollGodkjent:m}=s[e],T=a.find(K=>K.totrinnskontrollAksjonspunkter.some(G=>G.aksjonspunktKode===i)),u=T?.totrinnskontrollAksjonspunkter.find(K=>K.aksjonspunktKode===i),y=!m&&rl(t,e)?fa():void 0,v=Qo(`${ae}.${e}.faktagruppe`,y);return!T||!u?null:g.jsxs(Te,{gap:"space-12",children:[g.jsx($o,{name:`${ae}.${e}.totrinnskontrollGodkjent`,control:o,isReadOnly:n,hideLegend:!0,children:g.jsxs(Ie,{gap:"space-16",children:[g.jsx(lr,{value:!0,size:"small",children:g.jsx(q,{id:"ApprovalField.Godkjent"})}),g.jsx(lr,{value:!1,size:"small",children:g.jsx(q,{id:"ApprovalField.Vurder"})})]})}),m===!1&&g.jsx(yo,{alignOffset:m?1:110,children:g.jsxs(Te,{gap:"space-8",children:[g.jsx(Sn,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),g.jsx(ue,{size:"small",children:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),g.jsxs(Te,{gap:"space-16",children:[g.jsx(Te,{gap:"space-4",children:g.jsxs(Ie,{justify:"space-between",style:{width:"300px"},children:[g.jsxs(Te,{gap:"space-4",children:[g.jsx(Me,{name:`${ae}.${e}.feilFakta`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilSkjønn`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilLov`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),g.jsxs(Te,{gap:"space-4",children:[g.jsx(Me,{name:`${ae}.${e}.feilUtredning`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilSaksflyt`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),g.jsx(Me,{name:`${ae}.${e}.feilBegrunnelse`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),v&&g.jsx(pn,{size:"small",children:v}),g.jsx(Zo,{name:`${ae}.${e}.besluttersBegrunnelse`,control:o,label:g.jsx(q,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[La,el,nl,ba],readOnly:n})]})]})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  skjermlenkeType: SkjermlenkeType;
  totrinnskontrollAksjonspunkter: TotrinnskontrollAksjonspunkt[];
}>`}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const al="_aksjonspunktTextContainer_1pwmv_5",tl="_lenke_1pwmv_10",Vr={aksjonspunktTextContainer:al,lenke:tl},ol="aksjonspunktGodkjenning",va=({behandling:e,totrinnskontrollSkjermlenkeContext:a,readOnly:n,erForeldrepengerFagsak:r,erTilbakekreving:t,skjemalenkeTyper:o,faktaOmBeregningTilfeller:s,lagLenke:i})=>{const{control:m,watch:T}=Re(),{fields:u}=$t({control:m,name:ol}),y=T("aksjonspunktGodkjenning");return g.jsx(Te,{gap:"space-24",children:u.map((v,K)=>{const{aksjonspunktKode:G}=y[K],F=a.find(I=>I.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===G)),N=F?.totrinnskontrollAksjonspunkter.find(I=>I.aksjonspunktKode===G);if(!F||!N)return null;const V=da(r,e.status,s,t,N,e.behandlingsresultat),R=o.find(I=>I.kode===F.skjermlenkeType),D=i(F.skjermlenkeType);return g.jsxs("div",{children:[D&&R&&g.jsx(Mr,{to:D,onClick:()=>window.scroll(0,0),className:Vr.lenke,children:R.navn}),V.map((I,A)=>g.jsx("div",{className:Vr.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:I})},G.concat("_".concat(A.toString())))),g.jsx(ua,{index:K,totrinnskontrollSkjermlenkeContext:a,readOnly:n})]},v.id)})})};va.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const cr=(e=[])=>e.every(a=>a.totrinnskontrollGodkjent),Gr=(e=[])=>e.every(a=>a.totrinnskontrollGodkjent!==void 0&&a.totrinnskontrollGodkjent!==null),ll=(e,a)=>{if(!a)return!0;const{konsekvenserForYtelsen:n}=a;return!Array.isArray(n)||n.length!==1?!0:!e.some(r=>r===n[0])},sl=e=>e.reduce((a,n)=>n===te.FEIL_FAKTA?{...a,feilFakta:!0}:n===te.FEIL_LOV?{...a,feilLov:!0}:n===te.FEIL_REGEL?{...a,feilSkjønn:!0}:n===te.SKJØNN?{...a,feilSkjønn:!0}:n===te.UTREDNING?{...a,feilUtredning:!0}:n===te.SAKSFLYT||n===te.ANNET?{...a,feilSaksflyt:!0}:n===te.BEGRUNNELSE?{...a,feilBegrunnelse:!0}:{},{}),il=e=>({aksjonspunktGodkjenning:e.map(a=>a.totrinnskontrollAksjonspunkter).flat().map(a=>({aksjonspunktKode:a.aksjonspunktKode,totrinnskontrollGodkjent:a.totrinnskontrollGodkjent,besluttersBegrunnelse:hr(a.besluttersBegrunnelse),...sl(a.vurderPaNyttArsaker?a.vurderPaNyttArsaker:[])}))}),Ta=({behandling:e,onSubmit:a,forhandsvisVedtaksbrev:n,readOnly:r,erBehandlingEtterKlage:t,erForeldrepengerFagsak:o,skjemalenkeTyper:s,erTilbakekreving:i,totrinnskontrollSkjermlenkeContext:m,faktaOmBeregningTilfeller:T,lagLenke:u,beslutterFormData:y,setBeslutterFormData:v})=>{const K=e&&e.type===Xe.KLAGE,G=e&&e.type===Xe.ANKE,F=ll([wn.ENDRING_I_FORDELING_AV_YTELSEN,wn.INGEN_ENDRING],e.behandlingsresultat),N=il(m),V=zt({defaultValues:y||N}),R=V.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?g.jsx(Xo,{formMethods:V,onSubmit:a,setDataOnUnmount:v,children:g.jsxs(Te,{gap:"space-24",children:[!r&&g.jsx(Ao,{children:[g.jsx(q,{id:"HelpText.ToTrinnsKontroll"},1)]}),g.jsx(va,{behandling:e,erForeldrepengerFagsak:o,erTilbakekreving:i,readOnly:r,totrinnskontrollSkjermlenkeContext:m,skjemalenkeTyper:s,faktaOmBeregningTilfeller:T,lagLenke:u}),g.jsxs(Ie,{gap:"space-16",children:[g.jsx(qn,{variant:"primary",size:"small",disabled:!cr(R)||!Gr(R)||V.formState.isSubmitting,loading:V.formState.isSubmitting,children:g.jsx(q,{id:"ToTrinnsForm.Godkjenn"})}),g.jsx(qn,{variant:"primary",size:"small",disabled:cr(R)||!Gr(R)||V.formState.isSubmitting,loading:V.formState.isSubmitting,onClick:Fa,children:g.jsx(q,{id:"ToTrinnsForm.SendTilbake"})}),!K&&!t&&!G&&!i&&F&&g.jsx(dt,{href:"#",onClick:n,children:g.jsx(q,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};Ta.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const dl="_approvalItem_xqu47_1",kl="_approvalItemContainer_xqu47_7",El="_aksjonspunktTextContainer_xqu47_11",ul="_resultatFraGodkjenningTextContainer_xqu47_16",vl="_lenke_xqu47_20",Tl="_checkmarkIcon_xqu47_24",gl="_xmark_xqu47_30",_e={approvalItem:dl,approvalItemContainer:kl,aksjonspunktTextContainer:El,resultatFraGodkjenningTextContainer:ul,lenke:vl,checkmarkIcon:Tl,xmark:gl},Al=({vurderPaNyttArsaker:e,vurderArsaker:a})=>g.jsx("div",{className:_e.approvalItem,children:e?.map(n=>g.jsxs(Ie,{gap:"space-8",children:[g.jsx(nt,{className:_e.xmark}),g.jsx("div",{children:a.find(r=>n===r.kode)?.navn})]},n))}),ga=({behandling:e,totrinnskontrollSkjermlenkeContext:a,erForeldrepengerFagsak:n,erTilbakekreving:r,skjemalenkeTyper:t,vurderArsaker:o,faktaOmBeregningTilfeller:s,lagLenke:i})=>{const m=Ia();return g.jsxs(g.Fragment,{children:[g.jsx("div",{className:_e.resultatFraGodkjenningTextContainer,children:g.jsx(q,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Va}})}),a.map(T=>{const u=T.totrinnskontrollAksjonspunkter,y=t.find(v=>v.kode===T.skjermlenkeType);if(u.length>0){const v=i(T.skjermlenkeType);return g.jsxs(E.Fragment,{children:[v&&y&&g.jsx(Mr,{to:v,onClick:()=>window.scroll(0,0),className:_e.lenke,children:y.navn}),u.map(K=>{const G=da(n,e.status,s,r,K,e.behandlingsresultat);return g.jsxs("div",{className:_e.approvalItemContainer,children:[G.map((F,N)=>g.jsx("div",{className:_e.aksjonspunktTextContainer,children:g.jsx(ue,{size:"small",children:F})},K.aksjonspunktKode.concat("_".concat(N.toString())))),g.jsx("div",{className:_e.approvalItem,children:K.totrinnskontrollGodkjent?g.jsxs(Ie,{gap:"space-8",children:[g.jsx(Ja,{title:m.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:_e.checkmarkIcon}),g.jsx(q,{id:"ToTrinnsForm.Godkjent"})]}):g.jsx(Al,{vurderPaNyttArsaker:K?.vurderPaNyttArsaker,vurderArsaker:o})}),g.jsx("pre",{className:_e.approvalItem,children:hr(K.besluttersBegrunnelse)})]},K.aksjonspunktKode)})]},T.skjermlenkeType)}return null})]})};ga.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
}`,...kn.parameters?.docs?.source}}};const Ol=["ForBeslutter","ForSaksbehandler"];export{dn as ForBeslutter,kn as ForSaksbehandler,Ol as __namedExportsOrder,Ll as default};
