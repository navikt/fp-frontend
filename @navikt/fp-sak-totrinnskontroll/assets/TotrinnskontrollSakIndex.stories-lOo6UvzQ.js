...
}`,signature:{properties:[{key:"aktivitetType",value:{name:"string",required:!0}},{key:"erEndring",value:{name:"boolean",required:!0}},{key:"godkjent",value:{name:"boolean",required:!0}},{key:"arbeidsgiverReferanse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"arbeidsgiverNavn",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"orgnr",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"privatpersonFødselsdato",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},description:""}}};const Ql=e=>e?.fastsattVarigEndringNaering?_.jsx(H,{id:"ToTrinnsForm.Beregning.VarigEndring"}):_.jsx(H,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),Na=e=>e.uttakPerioder?e.uttakPerioder.map(r=>{const n=ra(r.fom),a=ra(r.tom);let l;return r.erSlettet?l="ToTrinnsForm.AvklarUttak.PeriodeSlettet":r.erLagtTil?l="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":r.erEndret&&(e.aksjonspunktKode===p.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===p.TILKNYTTET_STORTINGET)?l="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":r.erEndret&&e.aksjonspunktKode===p.OVERSTYRING_AV_UTTAKPERIODER||r.erEndret&&e.aksjonspunktKode===p.OVERSTYR_FAKTA_UTTAK?l="ToTrinnsForm.OverstyrUttak.PeriodeEndret":r.erEndret?l="ToTrinnsForm.AvklarUttak.PeriodeEndret":l="ToTrinnsForm.AvklarUttak.PeriodeAvklart",_.jsx(H,{id:l,values:{a:n,b:a}},l)}):[],et=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(r=>_.jsx(Er,{aktivitet:r},r.aktivitetType)):[],nt=e=>{const r=$l[e.aksjonspunktKode];return r?[_.jsx(H,{id:r},r)]:[]},at=e=>{const r=zl[e.aksjonspunktKode];return r?[_.jsx(H,{id:r},r)]:[]},rt=e=>{const r=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[_.jsx(H,{id:r},r)]},lt=(e,r)=>r?.faktaOmBeregningTilfeller?r.faktaOmBeregningTilfeller.flatMap(n=>{const a=e.find(l=>l.kode===n);return a?[_.jsx("div",{children:a.navn},a.navn)]:[]}):[],tt=e=>{let r="";switch(e?.type){case Ie.KLAGE_YTELSESVEDTAK_STADFESTET:r="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case Ie.KLAGE_YTELSESVEDTAK_OPPHEVET:r="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case Ie.KLAGE_AVVIST:r="ToTrinnsForm.Klage.Avvist";break;case Ie.HJEMSENDE_UTEN_OPPHEVE:r="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case Ie.KLAGE_DELVIS_MEDHOLD:r="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case Ie.KLAGE_OMGJORT_UGUNST:r="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case Ie.KLAGE_MEDHOLD:r="ToTrinnsForm.Klage.OmgjortTilGunst";break}return _.jsx(H,{id:r})},it=(e,r)=>e===gn.FATTER_VEDTAK?[tt(r)]:[],Et=()=>_.jsx(H,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),ot=()=>_.jsx(H,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),st=e=>e.aksjonspunktKode===p.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===p.VURDERING_AV_FORMKRAV_KLAGE_NFP,or=(e,r,n,a,l,t)=>l.aksjonspunktKode===p.VURDER_PERIODER_MED_OPPTJENING?et(l):l.aksjonspunktKode===p.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[Ql(l.beregningDto)]:l.aksjonspunktKode===p.VURDER_FAKTA_FOR_ATFL_SN?lt(n,l.beregningDto):Hr(l.aksjonspunktKode)&&l.uttakPerioder&&l.uttakPerioder.length>0||wr(l.aksjonspunktKode)&&l.uttakPerioder&&l.uttakPerioder.length>0?Na(l):l.aksjonspunktKode===p.AVKLAR_ANNEN_FORELDER_RETT?[Et()]:l.aksjonspunktKode===p.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?rt(e):l.aksjonspunktKode===p.OVERSTYRING_AV_RETT_OG_OMSORG?[ot()]:st(l)?it(r,t):a?at(l):nt(l);function ut(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ga={exports:{}},We={};/**
 * @license React
 ...
 */var Sa;function dt(){if(Sa)return We;Sa=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var o in l)o!=="key"&&(t[o]=l[o])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return We.Fragment=r,We.jsx=n,We.jsxs=n,We}var La;function Tt(){return La||(La=1,ga.exports=dt()),ga.exports}var Le=Tt();const kt=({children:e})=>{const r=c.Children.toArray(e);return r.length===0?null:Le.jsx(ll,{variant:"warning",size:"small",children:Le.jsx(ve,{gap:"space-8","data-testid":"aksjonspunkt-text-container",children:r.map(n=>Le.jsx(Te,{size:"small",children:n},vt(n)))})})},vt=e=>{if(c.isValidElement(e))return e.key;if(typeof e=="string"||typeof e=="number")return`tekst-${e}`},nn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};je(nn);const mn="var(--ax-bg-neutral-strong)",sr=4,_t=(e,r,n)=>`
  .arrowBoxTop${e} {
...
`,At=(e,r,n,a)=>r?Rt(e,n,a):_t(e,n,a),mt=(e,r,n)=>n?"":r?`arrowBoxLeft${e}`:`arrowBoxTop${e}`,Nt=({children:e,alignOffset:r=0,alignLeft:n=!1,marginTop:a=0,marginLeft:l=0,hideBorder:t=!1})=>Le.jsxs(Le.Fragment,{children:[Le.jsx("style",{dangerouslySetInnerHTML:{__html:At(r,n,a,l)}}),Le.jsx("div",{className:mt(r,n,t),children:e})]});var Ka={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Da;function gt(){return Da||(Da=1,function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var o=arguments[E];o&&(t=l(t,a.call(this,o)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return this&&this[t]||t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(this,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var o in t)r.call(t,o)&&t[o]&&(E=l(E,this&&this[o]||o));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()}(Ka)),Ka.exports}var St=gt();const Qn=ut(St),Lt="_borderbox_1a0x6_1",Kt="_error_1a0x6_5",Dt="_warning_1a0x6_8",It={borderbox:Lt,error:Kt,warning:Dt};Qn.bind(It);const Ft="_aksjonspunkt_11wjs_1",yt="_erAksjonspunktApent_11wjs_4",Ot="_erIkkeGodkjentAvBeslutter_11wjs_8",pt={aksjonspunkt:Ft,erAksjonspunktApent:yt,erIkkeGodkjentAvBeslutter:Ot};Qn.bind(pt);je(nn);je(nn);const ft="_divider_1jpov_1",Vt="_dividerParagraf_1jpov_8",Gt="_leftPanel_1jpov_11",Pt="_rightPanel_1jpov_14",bt={divider:ft,dividerParagraf:Vt,leftPanel:Gt,rightPanel:Pt};Qn.bind(bt);const ur=()=>Le.jsx("span",{"data-testid":"editedIcon",children:Le.jsx(Zr,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});je(nn);je(nn);function ct(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ia={exports:{}},Ze={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fa;function Ut(){if(Fa)return Ze;Fa=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var o in l)o!=="key"&&(t[o]=l[o])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return Ze.Fragment=r,Ze.jsx=n,Ze.jsxs=n,Ze}var ya;function Mt(){return ya||(ya=1,Ia.exports=Ut()),Ia.exports}var Q=Mt();const ea=e=>e.reduce((r,n,a)=>({...r,[a]:l=>n(l)||!0}),{}),Nn=(e,r)=>r.split(".").reduce((n,a)=>n!==void 0?n[a]:n,e)?.message,Me=({label:e,validate:r=[],readOnly:n=!1,onChange:a,onClick:l,className:t,size:E="small",...o})=>{const{name:A,control:v,disabled:k}=o,{formState:{errors:S}}=Ae(),{field:T}=Wn({name:A,control:v,rules:{validate:c.useMemo(()=>ea(r),[r])}}),D=Nn(S,A);return Q.jsxs(Q.Fragment,{children:[Q.jsx(Al,{size:E,disabled:k||n,checked:T.value===!0,className:t,error:!!D,...T,onChange:P=>{T.onChange(P),a&&a(P.currentTarget.checked)},onClick:()=>{l&&l()},children:e}),D&&Q.jsx(Kn,{children:Nn(S,A)})]})};var xn={exports:{}},Bt=xn.exports,Oa;function ht(){return Oa||(Oa=1,function(e,r){(function(n,a){e.exports=a()})(Bt,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},a=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,l=/\d/,t=/\d\d/,E=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,A={},v=function(N){return(N=+N)+(N>68?1900:2e3)},k=function(N){return function(G){this[N]=+G}},S=[/[+-]\d\d:?(\d\d)?|Z/,function(N){(this.zone||(this.zone={})).offset=function(G){if(!G||G==="Z")return 0;var m=G.match(/([+-]|\d\d)/g),O=60*m[1]+(+m[2]||0);return O===0?0:m[0]==="+"?-O:O}(N)}],T=function(N){var G=A[N];return G&&(G.indexOf?G:G.s.concat(G.f))},D=function(N,G){var m,O=A.meridiem;if(O){for(var V=1;V<=24;V+=1)if(N.indexOf(O(V,0,G))>-1){m=V>12;break}}else m=N===(G?"pm":"PM");return m},P={A:[o,function(N){this.afternoon=D(N,!1)}],a:[o,function(N){this.afternoon=D(N,!0)}],Q:[l,function(N){this.month=3*(N-1)+1}],S:[l,function(N){this.milliseconds=100*+N}],SS:[t,function(N){this.milliseconds=10*+N}],SSS:[/\d{3}/,function(N){this.milliseconds=+N}],s:[E,k("seconds")],ss:[E,k("seconds")],m:[E,k("minutes")],mm:[E,k("minutes")],H:[E,k("hours")],h:[E,k("hours")],HH:[E,k("hours")],hh:[E,k("hours")],D:[E,k("day")],DD:[t,k("day")],Do:[o,function(N){var G=A.ordinal,m=N.match(/\d+/);if(this.day=m[0],G)for(var O=1;O<=31;O+=1)G(O).replace(/\[|\]/g,"")===N&&(this.day=O)}],w:[E,k("week")],ww:[t,k("week")],M:[E,k("month")],MM:[t,k("month")],MMM:[o,function(N){var G=T("months"),m=(T("monthsShort")||G.map(function(O){return O.slice(0,3)})).indexOf(N)+1;if(m<1)throw new Error;this.month=m%12||m}],MMMM:[o,function(N){var G=T("months").indexOf(N)+1;if(G<1)throw new Error;this.month=G%12||G}],Y:[/[+-]?\d+/,k("year")],YY:[t,function(N){this.year=v(N)}],YYYY:[/\d{4}/,k("year")],Z:S,ZZ:S};function f(N){var G,m;G=N,m=A&&A.formats;for(var O=(N=G.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(w,x,b){var M=b&&b.toUpperCase();return x||m[b]||n[b]||m[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(j,q,Y){return q||Y.slice(1)})})).match(a),V=O.length,R=0;R<V;R+=1){var F=O[R],I=P[F],B=I&&I[0],h=I&&I[1];O[R]=h?{regex:B,parser:h}:F.replace(/^\[|\]$/g,"")}return function(w){for(var x={},b=0,M=0;b<V;b+=1){var j=O[b];if(typeof j=="string")M+=j.length;else{var q=j.regex,Y=j.parser,ee=w.slice(M),ie=q.exec(ee)[0];Y.call(x,ie),w=w.replace(ie,"")}}return function(Ee){var me=Ee.afternoon;if(me!==void 0){var ne=Ee.hours;me?ne<12&&(Ee.hours+=12):ne===12&&(Ee.hours=0),delete Ee.afternoon}}(x),x}}return function(N,G,m){m.p.customParseFormat=!0,N&&N.parseTwoDigitYear&&(v=N.parseTwoDigitYear);var O=G.prototype,V=O.parse;O.parse=function(R){var F=R.date,I=R.utc,B=R.args;this.$u=I;var h=B[1];if(typeof h=="string"){var w=B[2]===!0,x=B[3]===!0,b=w||x,M=B[2];x&&(M=B[2]),A=this.$locale(),!w&&M&&(A=m.Ls[M]),this.$d=function(ee,ie,Ee,me){try{if(["x","X"].indexOf(ie)>-1)return new Date((ie==="X"?1e3:1)*ee);var ne=f(ie)(ee),we=ne.year,ye=ne.month,yn=ne.day,an=ne.hours,On=ne.minutes,Ye=ne.seconds,rn=ne.milliseconds,Ge=ne.zone,Pe=ne.week,qe=new Date,be=yn||(we||ye?1:qe.getDate()),xe=we||qe.getFullYear(),Oe=0;we&&!ye||(Oe=ye>0?ye-1:qe.getMonth());var pe,Je=an||0,Ce=On||0,ln=Ye||0,ce=rn||0;return Ge?new Date(Date.UTC(xe,Oe,be,Je,Ce,ln,ce+60*Ge.offset*1e3)):Ee?new Date(Date.UTC(xe,Oe,be,Je,Ce,ln,ce)):(pe=new Date(xe,Oe,be,Je,Ce,ln,ce),Pe&&(pe=me(pe).week(Pe).toDate()),pe)}catch{return new Date("")}}(F,h,I,m),this.init(),M&&M!==!0&&(this.$L=this.locale(M).$L),b&&F!=this.format(h)&&(this.$d=new Date("")),A={}}else if(h instanceof Array)for(var j=h.length,q=1;q<=j;q+=1){B[1]=h[q-1];var Y=m.apply(this,B);if(Y.isValid()){this.$d=Y.$d,this.$L=Y.$L,this.init();break}q===j&&(this.$d=new Date(""))}else V.call(this,R)}}})}(xn)),xn.exports}var jt=ht();const Ht=ct(jt),wt="_textarea_14c7r_1",Yt="_readOnlyField_14c7r_7",pa={textarea:wt,readOnlyField:Yt},qt=e=>e!=null&&e!=="",xt=({label:e,value:r,isEdited:n=!1,type:a,hideLabel:l,size:t})=>qt(r)?Q.jsxs(ve,{gap:"space-4",children:[e&&!l&&Q.jsx(Ln,{size:t,children:e}),Q.jsxs(Ve,{gap:"space-8",align:"center",wrap:!1,children:[Q.jsx(ha,{className:a==="textarea"?pa.textarea:pa.readOnlyField,size:t,children:r}),n&&Q.jsx(ur,{})]})]}):null;Lr.extend(Ht);const Jt=({label:e,description:r,validate:n=[],onChange:a,children:l,className:t,isReadOnly:E=!1,size:o="small",isEdited:A=!1,hideLegend:v=!1,...k})=>{const{name:S,control:T}=k,{formState:{errors:D}}=Ae(),{field:P}=Wn({name:S,control:T,rules:{validate:ea(n)}});return Q.jsx(Nl,{name:S,value:P.value!==void 0?P.value:null,legend:Q.jsxs(Ve,{justify:"center",gap:"space-8",children:[e,E&&A&&Q.jsx(ur,{})]}),hideLegend:v,disabled:E,description:r,size:o,error:Nn(D,S),onChange:f=>{a&&a(f),P.onChange(f)},className:t,children:l})},Ct="_textAreaFieldWithBadges_bdz0b_1",$t="_etikettWrapper_bdz0b_4",fa={textAreaFieldWithBadges:Ct,etikettWrapper:$t},zt=({name:e,control:r,label:n,readOnly:a,maxLength:l,badges:t,validate:E=[],parse:o=D=>D,className:A,description:v,isEdited:k,size:S="small",...T})=>{const{formState:{errors:D}}=Ae(),{field:P}=Wn({name:e,control:r,rules:{validate:c.useMemo(()=>ea(E),[E])}});return a?Q.jsx(xt,{size:S,label:n,value:P.value,type:"textarea",isEdited:k,hideLabel:T.hideLabel}):Q.jsxs("div",{className:t?fa.textAreaFieldWithBadges:null,children:[t&&Q.jsx("div",{className:fa.etikettWrapper,children:t.map(({type:f,titleText:N})=>Q.jsx(ul,{variant:f,size:"small",children:N},N))}),Q.jsx(Fl,{size:S,label:n,description:v,className:A,autoComplete:"off",...P,onChange:f=>P.onChange(f.currentTarget.value!==""?o(f.currentTarget.value):null),value:P.value?P.value:"",error:Nn(D,e),maxLength:l,...T})]})},Wt=({formMethods:e,onSubmit:r,children:n,className:a,setDataOnUnmount:l})=>{const{handleSubmit:t,getValues:E}=e;return c.useEffect(()=>()=>{l&&l(E())},[]),Q.jsx(pl,{...e,children:Q.jsx("form",{className:a,onSubmit:r?t(o=>r(o)):void 0,children:n})})},Zt=(e,r)=>{const{setError:n,clearErrors:a,formState:l}=Ae(),t=!!r;return c.useEffect(()=>{t&&n(`${e}.notRegisteredInput`,{type:"custom",message:r}),t||a(`${e}.notRegisteredInput`)},[r]),l.isSubmitted?e.split(".").reduce((E,o)=>E[o]||{},l.errors)?.notRegisteredInput?.message:void 0},Xt=Ir(3),Qt=Fr(2e3),re="aksjonspunktGodkjenning",ei=(e,r)=>!e(`${re}.${r}.feilFakta`)&&!e(`${re}.${r}.feilLov`)&&!e(`${re}.${r}.feilSkjønn`)&&!e(`${re}.${r}.feilUtredning`)&&!e(`${re}.${r}.feilSaksflyt`)&&!e(`${re}.${r}.feilBegrunnelse`),dr=({index:e,totrinnskontrollSkjermlenkeContext:r,readOnly:n})=>{const{watch:a,getValues:l,control:t}=Ae(),E=a("aksjonspunktGodkjenning"),{aksjonspunktKode:o,totrinnskontrollGodkjent:A}=E[e],v=r.find(D=>D.totrinnskontrollAksjonspunkter.some(P=>P.aksjonspunktKode===o)),k=v?.totrinnskontrollAksjonspunkter.find(D=>D.aksjonspunktKode===o),S=!A&&ei(l,e)?Kr():void 0,T=Zt(`${re}.${e}.faktagruppe`,S);return!v||!k?null:_.jsxs(ve,{gap:"space-12",children:[_.jsx(Jt,{name:`${re}.${e}.totrinnskontrollGodkjent`,control:t,isReadOnly:n,hideLegend:!0,children:_.jsxs(Ve,{gap:"space-16",children:[_.jsx(ta,{value:!0,size:"small",children:_.jsx(H,{id:"ApprovalField.Godkjent"})}),_.jsx(ta,{value:!1,size:"small",children:_.jsx(H,{id:"ApprovalField.Vurder"})})]})}),A===!1&&_.jsx(Nt,{alignOffset:A?1:110,children:_.jsxs(ve,{gap:"space-8",children:[_.jsx(Ln,{size:"small",children:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),_.jsx(Te,{size:"small",children:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),_.jsxs(ve,{gap:"space-16",children:[_.jsx(ve,{gap:"space-4",children:_.jsxs(Ve,{justify:"space-between",style:{width:"300px"},children:[_.jsxs(ve,{gap:"space-4",children:[_.jsx(Me,{name:`${re}.${e}.feilFakta`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:n}),_.jsx(Me,{name:`${re}.${e}.feilSkjønn`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:n}),_.jsx(Me,{name:`${re}.${e}.feilLov`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:n})]}),_.jsxs(ve,{gap:"space-4",children:[_.jsx(Me,{name:`${re}.${e}.feilUtredning`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:n}),_.jsx(Me,{name:`${re}.${e}.feilSaksflyt`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:n}),_.jsx(Me,{name:`${re}.${e}.feilBegrunnelse`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:n})]})]})}),T&&_.jsx(Kn,{size:"small",children:T}),_.jsx(zt,{name:`${re}.${e}.besluttersBegrunnelse`,control:t,label:_.jsx(H,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[Dr,Xt,Qt,yr],readOnly:n})]})]})})]})};dr.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"erSlettet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erEndret",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erLagtTil",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}}],raw:"Array<foreldrepenger_domene_uttak_UttakPeriodeEndringDto>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ni="_aksjonspunktTextContainer_1pwmv_5",ai="_lenke_1pwmv_10",Va={aksjonspunktTextContainer:ni,lenke:ai},ri="aksjonspunktGodkjenning",Tr=({behandling:e,totrinnskontrollSkjermlenkeContext:r,readOnly:n,erForeldrepengerFagsak:a,erTilbakekreving:l,skjemalenkeTyper:t,faktaOmBeregningTilfeller:E,lagLenke:o})=>{const{control:A,watch:v}=Ae(),{fields:k}=Jl({control:A,name:ri}),S=v("aksjonspunktGodkjenning");return _.jsx(ve,{gap:"space-24",children:k.map((T,D)=>{const{aksjonspunktKode:P}=S[D],f=r.find(V=>V.totrinnskontrollAksjonspunkter.some(R=>R.aksjonspunktKode===P)),N=f?.totrinnskontrollAksjonspunkter.find(V=>V.aksjonspunktKode===P);if(!f||!N)return null;const G=or(a,e.status,E,l,N,e.behandlingsresultat),m=t.find(V=>V.kode===f.skjermlenkeType),O=o(f.skjermlenkeType);return _.jsxs("div",{children:[O&&m&&_.jsx(Ua,{to:O,onClick:()=>window.scroll(0,0),className:Va.lenke,children:m.navn}),G.map((V,R)=>_.jsx("div",{className:Va.aksjonspunktTextContainer,children:_.jsx(Te,{size:"small",children:V})},P.concat("_".concat(R.toString())))),_.jsx(dr,{index:D,totrinnskontrollSkjermlenkeContext:r,readOnly:n})]},T.id)})})};Tr.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Ga=(e=[])=>e.every(r=>r.totrinnskontrollGodkjent),Pa=(e=[])=>e.every(r=>r.totrinnskontrollGodkjent!==void 0&&r.totrinnskontrollGodkjent!==null),li=(e,r)=>{if(!r)return!0;const{konsekvenserForYtelsen:n}=r;return!Array.isArray(n)||n.length!==1?!0:!e.some(a=>a===n[0])},ti=e=>e.reduce((r,n)=>n===le.FEIL_FAKTA?{...r,feilFakta:!0}:n===le.FEIL_LOV?{...r,feilLov:!0}:n===le.FEIL_REGEL?{...r,feilSkjønn:!0}:n===le.SKJØNN?{...r,feilSkjønn:!0}:n===le.UTREDNING?{...r,feilUtredning:!0}:n===le.SAKSFLYT||n===le.ANNET?{...r,feilSaksflyt:!0}:n===le.BEGRUNNELSE?{...r,feilBegrunnelse:!0}:{},{}),ii=e=>({aksjonspunktGodkjenning:e.map(r=>r.totrinnskontrollAksjonspunkter).flat().map(r=>({aksjonspunktKode:r.aksjonspunktKode,totrinnskontrollGodkjent:r.totrinnskontrollGodkjent,besluttersBegrunnelse:Ma(r.besluttersBegrunnelse??void 0),...ti(r.vurderPaNyttArsaker?r.vurderPaNyttArsaker:[])}))}),kr=({behandling:e,onSubmit:r,forhandsvisVedtaksbrev:n,readOnly:a,erBehandlingEtterKlage:l,erForeldrepengerFagsak:t,skjemalenkeTyper:E,erTilbakekreving:o,totrinnskontrollSkjermlenkeContext:A,faktaOmBeregningTilfeller:v,lagLenke:k,beslutterFormData:S,setBeslutterFormData:T})=>{const D=e&&e.type===Xe.KLAGE,P=e&&e.type===Xe.ANKE,f=li([Hn.ENDRING_I_FORDELING_AV_YTELSEN,Hn.INGEN_ENDRING],e.behandlingsresultat),N=ii(A),G=Cl({defaultValues:S||N}),m=G.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?_.jsx(Wt,{formMethods:G,onSubmit:r,setDataOnUnmount:T,children:_.jsxs(ve,{gap:"space-24",children:[!a&&_.jsx(kt,{children:_.jsx(H,{id:"HelpText.ToTrinnsKontroll"})}),_.jsx(Tr,{behandling:e,erForeldrepengerFagsak:t,erTilbakekreving:o,readOnly:a,totrinnskontrollSkjermlenkeContext:A,skjemalenkeTyper:E,faktaOmBeregningTilfeller:v,lagLenke:k}),_.jsxs(Ve,{gap:"space-16",style:{marginBottom:"50px"},children:[_.jsx(jn,{variant:"primary",size:"small",disabled:!Ga(m)||!Pa(m)||G.formState.isSubmitting,loading:G.formState.isSubmitting,children:_.jsx(H,{id:"ToTrinnsForm.Godkjenn"})}),_.jsx(jn,{variant:"primary",size:"small",disabled:Ga(m)||!Pa(m)||G.formState.isSubmitting,loading:G.formState.isSubmitting,onClick:Or,children:_.jsx(H,{id:"ToTrinnsForm.SendTilbake"})}),!D&&!l&&!P&&!o&&f&&_.jsx(El,{href:"#",onClick:n,children:_.jsx(H,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};kr.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Ei="_approvalItem_xqu47_1",oi="_approvalItemContainer_xqu47_7",si="_aksjonspunktTextContainer_xqu47_11",ui="_resultatFraGodkjenningTextContainer_xqu47_16",di="_lenke_xqu47_20",Ti="_checkmarkIcon_xqu47_24",ki="_xmark_xqu47_30",ge={approvalItem:Ei,approvalItemContainer:oi,aksjonspunktTextContainer:si,resultatFraGodkjenningTextContainer:ui,lenke:di,checkmarkIcon:Ti,xmark:ki},vi=({vurderPaNyttArsaker:e,vurderArsaker:r})=>_.jsx("div",{className:ge.approvalItem,children:e?.map(n=>_.jsxs(Ve,{gap:"space-8",children:[_.jsx(Qr,{className:ge.xmark}),_.jsx("div",{children:r.find(a=>n===a.kode)?.navn})]},n))}),vr=({behandling:e,totrinnskontrollSkjermlenkeContext:r,erForeldrepengerFagsak:n,erTilbakekreving:a,skjemalenkeTyper:l,vurderArsaker:t,faktaOmBeregningTilfeller:E,lagLenke:o})=>{const A=pr();return _.jsxs(_.Fragment,{children:[_.jsx("div",{className:ge.resultatFraGodkjenningTextContainer,children:_.jsx(H,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:fr}})}),r.map(v=>{const k=v.totrinnskontrollAksjonspunkter,S=l.find(T=>T.kode===v.skjermlenkeType);if(k.length>0){const T=o(v.skjermlenkeType);return _.jsxs(d.Fragment,{children:[T&&S&&_.jsx(Ua,{to:T,onClick:()=>window.scroll(0,0),className:ge.lenke,children:S.navn}),k.map(D=>{const P=or(n,e.status,E,a,D,e.behandlingsresultat);return _.jsxs("div",{className:ge.approvalItemContainer,children:[P.map((f,N)=>_.jsx("div",{className:ge.aksjonspunktTextContainer,children:_.jsx(Te,{size:"small",children:f})},D.aksjonspunktKode.concat("_".concat(N.toString())))),_.jsx("div",{className:ge.approvalItem,children:D.totrinnskontrollGodkjent?_.jsxs(Ve,{gap:"space-8",children:[_.jsx(xr,{title:A.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:ge.checkmarkIcon}),_.jsx(H,{id:"ToTrinnsForm.Godkjent"})]}):_.jsx(vi,{vurderPaNyttArsaker:D?.vurderPaNyttArsaker,vurderArsaker:t})}),_.jsx("pre",{className:ge.approvalItem,children:Ma(D.besluttersBegrunnelse??void 0)})]},D.aksjonspunktKode)})]},v.skjermlenkeType)}return null})]})};vr.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const _i=je(Br),Ri=[En.FAKTA_OM_FEILUTBETALING,En.FORELDELSE,En.TILBAKEKREVING,En.VEDTAK],Ai=e=>{const r=[];return e.feilFakta&&r.push(le.FEIL_FAKTA),e.feilLov&&r.push(le.FEIL_LOV),e.feilSkjønn&&r.push(le.SKJØNN),e.feilUtredning&&r.push(le.UTREDNING),e.feilSaksflyt&&r.push(le.SAKSFLYT),e.feilBegrunnelse&&r.push(le.BEGRUNNELSE),r},mi=e=>"FaktaOmBeregningTilfelle"in e?e.FaktaOmBeregningTilfelle:[],_r=({behandling:e,location:r,fagsakYtelseType:n,readOnly:a,onSubmit:l,forhandsvisVedtaksbrev:t,alleKodeverk:E,createLocationForSkjermlenke:o,beslutterFormData:A,setBeslutterFormData:v})=>{const k=Xe.TILBAKEKREVING===e.type||Xe.TILBAKEKREVING_REVURDERING===e.type,S=O=>{const V=O.aksjonspunktGodkjenning.map(I=>({aksjonspunktKode:I.aksjonspunktKode,godkjent:!!I.totrinnskontrollGodkjent,begrunnelse:I.besluttersBegrunnelse,arsaker:Ai(I)})),R=k?qa.FATTER_VEDTAK:p.FATTER_VEDTAK;return l({fatterVedtakAksjonspunktDto:{"@type":R,kode:R,begrunnelse:void 0,aksjonspunktGodkjenningDtos:V},erAlleAksjonspunktGodkjent:O.aksjonspunktGodkjenning.every(I=>I.totrinnskontrollGodkjent)})},T=e?e.behandlingÅrsaker.map(({behandlingArsakType:O})=>O).some(O=>O===dn.ETTER_KLAGE||O===dn.KLAGE_U_INNTK||O===dn.KLAGE_M_INNTK):!1,D=k?Ri.flatMap(O=>{const V=e.totrinnskontrollÅrsaker?.find(R=>R.skjermlenkeType===O.kode);return V?[V]:[]}):e.totrinnskontrollÅrsaker,P=O=>o(r,O),f=e.status===gn.FATTER_VEDTAK,N=E.SkjermlenkeType,G=E.VurderÅrsak,m=mi(E);return _.jsxs(Vr,{value:_i,children:[f&&_.jsx(kr,{behandling:e,totrinnskontrollSkjermlenkeContext:D,readOnly:a,onSubmit:S,forhandsvisVedtaksbrev:t,erForeldrepengerFagsak:n==="FP",skjemalenkeTyper:N,erBehandlingEtterKlage:T,faktaOmBeregningTilfeller:m,erTilbakekreving:k,lagLenke:P,beslutterFormData:A,setBeslutterFormData:v}),!f&&_.jsx(vr,{behandling:e,totrinnskontrollSkjermlenkeContext:D,erForeldrepengerFagsak:n==="FP",erTilbakekreving:k,skjemalenkeTyper:N,lagLenke:P,vurderArsaker:G,faktaOmBeregningTilfeller:m})]})};_r.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
}`,...sn.parameters?.docs?.source}}};un.parameters={...un.parameters,docs:{...un.parameters?.docs,source:{originalSource:`{
  args: {
    behandling: {
      ...DEFAULT_BEHANDLING,
...
}`,...un.parameters?.docs?.source}}};const Ii=["ForBeslutter","ForSaksbehandler"];export{sn as ForBeslutter,un as ForSaksbehandler,Ii as __namedExportsOrder,Di as default};
