import{r as m,u as I,_ as b,s as M,j as e,t as N,o as T,M as w,P as O,a as F}from"./iframe-BIwshamf.js";import{u as V,M as S,V as A,P as z,O as C}from"./index.es-VXehgKpd.js";import{M as v,H as D,B as f,m as $}from"./nb_NO-DdxXDaKC.js";import"./preload-helper-D9Z9MdNV.js";import"./index-Bul8MePL.js";function P(n,a){var l=n.values,s=b(n,["values"]),d=a.values,i=b(a,["values"]);return M(d,l)&&M(s,i)}function k(n){var a=I(),l=a.formatMessage,s=a.textComponent,d=s===void 0?m.Fragment:s,i=n.id,h=n.description,t=n.defaultMessage,r=n.values,o=n.children,c=n.tagName,u=c===void 0?d:c,y=n.ignoreTag,q={id:i,description:h,defaultMessage:t},g=l(q,r,{ignoreTag:y});return typeof o=="function"?o(Array.isArray(g)?g:[g]):u?m.createElement(u,null,g):m.createElement(m.Fragment,null,g)}k.displayName="FormattedMessage";var j=m.memo(k,P);j.displayName="MemoizedFormattedMessage";const W="_modal_tyvxs_1",H="_selectWidth_tyvxs_6",E={modal:W,selectWidth:H},L=T(400),B=({handleSubmit:n,lukkModal:a,behandlendeEnheter:l,gjeldendeBehandlendeEnhetId:s,gjeldendeBehandlendeEnhetNavn:d})=>{const i=l.map((u,y)=>e.jsx("option",{value:`${y}`,children:`${u.enhetId} ${u.enhetNavn}`},u.enhetId)),h=[e.jsx("option",{disabled:!0,children:`${s} ${d}`},s)].concat(i),t=I(),r=V(),o=r.watch("nyEnhet"),c=r.watch("begrunnelse");return e.jsx(S,{formMethods:r,onSubmit:n,children:e.jsxs(v,{className:E.modal,open:!0,"aria-label":t.formatMessage({id:"EndreBehandlendeEnhetModal.ModalDescription"}),onClose:a,children:[e.jsx(v.Header,{children:e.jsx(D,{size:"small",level:"2",children:e.jsx(j,{id:"EndreBehandlendeEnhetModal.EndreEnhet"})})}),e.jsx(v.Body,{children:e.jsxs(A,{gap:"space-16",children:[e.jsx(z,{name:"nyEnhet",control:r.control,label:t.formatMessage({id:"EndreBehandlendeEnhetModal.NyEnhetField"}),validate:[N],selectValues:h,className:E.selectWidth}),e.jsx(C,{name:"begrunnelse",control:r.control,label:t.formatMessage({id:"EndreBehandlendeEnhetModal.BegrunnelseField"}),validate:[N,L,w],maxLength:400})]})}),e.jsxs(v.Footer,{children:[e.jsx(f,{size:"small",variant:"primary",className:E.button,disabled:!(o&&c),children:t.formatMessage({id:"EndreBehandlendeEnhetModal.Ok"})}),e.jsx(f,{size:"small",variant:"secondary",onClick:a,type:"button",children:t.formatMessage({id:"EndreBehandlendeEnhetModal.Avbryt"})})]})]})})};B.__docgenInfo={description:`EndreBehandlendeEnhetModal
