import{r as m,u as I,_ as N,s as b,j as e,t as M,o as T,N as w,P as F,a as O}from"./iframe-CpN3MkEi.js";import{u as V,N as D,V as S,Y as A,D as z}from"./index.es-0McjVFEU.js";import{M as v,H as C,B as f,m as $}from"./nb_NO-wLJKFLvO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CZOPwZm7.js";function W(n,a){var l=n.values,s=N(n,["values"]),d=a.values,i=N(a,["values"]);return b(d,l)&&b(s,i)}function k(n){var a=I(),l=a.formatMessage,s=a.textComponent,d=s===void 0?m.Fragment:s,i=n.id,h=n.description,t=n.defaultMessage,r=n.values,o=n.children,c=n.tagName,u=c===void 0?d:c,y=n.ignoreTag,q={id:i,description:h,defaultMessage:t},g=l(q,r,{ignoreTag:y});return typeof o=="function"?o(Array.isArray(g)?g:[g]):u?m.createElement(u,null,g):m.createElement(m.Fragment,null,g)}k.displayName="FormattedMessage";var j=m.memo(k,W);j.displayName="MemoizedFormattedMessage";const H="_modal_tyvxs_1",L="_selectWidth_tyvxs_6",E={modal:H,selectWidth:L},Y=T(400),B=({handleSubmit:n,lukkModal:a,behandlendeEnheter:l,gjeldendeBehandlendeEnhetId:s,gjeldendeBehandlendeEnhetNavn:d})=>{const i=l.map((u,y)=>e.jsx("option",{value:`${y}`,children:`${u.enhetId} ${u.enhetNavn}`},u.enhetId)),h=[e.jsx("option",{disabled:!0,children:`${s} ${d}`},s)].concat(i),t=I(),r=V(),o=r.watch("nyEnhet"),c=r.watch("begrunnelse");return e.jsx(D,{formMethods:r,onSubmit:n,children:e.jsxs(v,{className:E.modal,open:!0,"aria-label":t.formatMessage({id:"EndreBehandlendeEnhetModal.ModalDescription"}),onClose:a,children:[e.jsx(v.Header,{children:e.jsx(C,{size:"small",level:"2",children:e.jsx(j,{id:"EndreBehandlendeEnhetModal.EndreEnhet"})})}),e.jsx(v.Body,{children:e.jsxs(S,{gap:"space-16",children:[e.jsx(A,{name:"nyEnhet",control:r.control,label:t.formatMessage({id:"EndreBehandlendeEnhetModal.NyEnhetField"}),validate:[M],selectValues:h,className:E.selectWidth}),e.jsx(z,{name:"begrunnelse",control:r.control,label:t.formatMessage({id:"EndreBehandlendeEnhetModal.BegrunnelseField"}),validate:[M,Y,w],maxLength:400})]})}),e.jsxs(v.Footer,{children:[e.jsx(f,{size:"small",variant:"primary",className:E.button,disabled:!(o&&c),children:t.formatMessage({id:"EndreBehandlendeEnhetModal.Ok"})}),e.jsx(f,{size:"small",variant:"secondary",onClick:a,type:"button",children:t.formatMessage({id:"EndreBehandlendeEnhetModal.Avbryt"})})]})]})})};B.__docgenInfo={description:`EndreBehandlendeEnhetModal
