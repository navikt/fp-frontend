import{r as m,u as B,_ as b,s as N,j as e,P as O,a as V}from"./iframe-CXjzWqN9.js";import{u as D,N as S,V as A,Y as z,t as M,D as C,o as $,a as W}from"./index.es-4kNHkuao.js";import{M as v,H,B as f,m as L}from"./nb_NO-Bo_kk0qw.js";import"./index-CnuWq1Bl.js";function Y(n,a){var l=n.values,s=b(n,["values"]),d=a.values,i=b(a,["values"]);return N(d,l)&&N(s,i)}function _(n){var a=B(),l=a.formatMessage,s=a.textComponent,d=s===void 0?m.Fragment:s,i=n.id,h=n.description,t=n.defaultMessage,r=n.values,o=n.children,c=n.tagName,u=c===void 0?d:c,y=n.ignoreTag,F={id:i,description:h,defaultMessage:t},g=l(F,r,{ignoreTag:y});return typeof o=="function"?o(Array.isArray(g)?g:[g]):u?m.createElement(u,null,g):m.createElement(m.Fragment,null,g)}_.displayName="FormattedMessage";var q=m.memo(_,Y);q.displayName="MemoizedFormattedMessage";const K="_modal_tyvxs_1",P="_selectWidth_tyvxs_6",E={modal:K,selectWidth:P},R=$(400),T=({handleSubmit:n,lukkModal:a,behandlendeEnheter:l,gjeldendeBehandlendeEnhetId:s,gjeldendeBehandlendeEnhetNavn:d})=>{const i=l.map((u,y)=>e.jsx("option",{value:`${y}`,children:`${u.enhetId} ${u.enhetNavn}`},u.enhetId)),h=[e.jsx("option",{disabled:!0,children:`${s} ${d}`},s)].concat(i),t=B(),r=D(),o=r.watch("nyEnhet"),c=r.watch("begrunnelse");return e.jsx(S,{formMethods:r,onSubmit:n,children:e.jsxs(v,{className:E.modal,open:!0,"aria-label":t.formatMessage({id:"EndreBehandlendeEnhetModal.ModalDescription"}),onClose:a,children:[e.jsx(v.Header,{children:e.jsx(H,{size:"small",children:e.jsx(q,{id:"EndreBehandlendeEnhetModal.EndreEnhet"})})}),e.jsx(v.Body,{children:e.jsxs(A,{gap:"4",children:[e.jsx(z,{name:"nyEnhet",control:r.control,label:t.formatMessage({id:"EndreBehandlendeEnhetModal.NyEnhetField"}),validate:[M],selectValues:h,className:E.selectWidth}),e.jsx(C,{name:"begrunnelse",control:r.control,label:t.formatMessage({id:"EndreBehandlendeEnhetModal.BegrunnelseField"}),validate:[M,R,W],maxLength:400})]})}),e.jsxs(v.Footer,{children:[e.jsx(f,{size:"small",variant:"primary",className:E.button,disabled:!(o&&c),children:t.formatMessage({id:"EndreBehandlendeEnhetModal.Ok"})}),e.jsx(f,{size:"small",variant:"secondary",onClick:a,type:"button",children:t.formatMessage({id:"EndreBehandlendeEnhetModal.Avbryt"})})]})]})})};T.__docgenInfo={description:`EndreBehandlendeEnhetModal
