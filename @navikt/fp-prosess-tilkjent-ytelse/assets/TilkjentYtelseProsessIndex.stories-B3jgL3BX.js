...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""},feriepengegrunnlag:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  andeler: FeriepengegrunnlagAndel[];
}>`},description:""}}};const ps={gjeldende:{avklartBarn:[{fodselsdato:"2019-01-01"}],omsorgsovertakelseDato:"2019-01-01",soknadType:Tn.FODSEL}},Pg={bruker:{kjønn:Wt.KVINNE}},xg={perioder:[{andeler:[{uttak:{stonadskontoType:kr.FELLESPERIODE},aktivitetStatus:we.ARBEIDSTAKER,arbeidsforholdType:zt.ARBEID}],fom:"2018-01-01",tom:"2019-01-10",dagsats:1e3},{andeler:[{uttak:{stonadskontoType:kr.FORELDREPENGER},aktivitetStatus:we.ARBEIDSTAKER,arbeidsforholdType:$t.NYTT_ARBEIDSFORHOLD}],fom:"2019-02-01",tom:"2019-06-10",dagsats:100}]},_g={mottattDato:"2019-01-10",soknadType:Tn.FODSEL,omsorgsovertakelseDato:"2019-01-10",fodselsdatoer:{1:"2019-01-01"},adopsjonFodelsedatoer:{1:"2019-01-01"},termindato:"2019-02-01"},Ng={1:{erPrivatPerson:!1,identifikator:"973861778",referanse:"973861778",navn:"EQUINOR ASA AVD STATOIL SOKKELVIRKSOMHET"}},Ig={title:"prosess/prosess-tilkjent-ytelse",component:Or,decorators:[Rs],args:{beregningresultat:xg,familiehendelse:ps,personoversikt:Pg,søknad:_g,arbeidsgiverOpplysningerPerId:Ng},render:e=>p.jsx(Or,{...e})},Pn={args:{aksjonspunkterForPanel:[]}},xn={args:{aksjonspunkterForPanel:[{begrunnelse:"Dette er en begrunnelse saksbehandler tidligere har gjort.",definisjon:zn.VURDER_TILBAKETREKK,status:Yt.UTFORT}]}},_n={args:{aksjonspunkterForPanel:[{definisjon:zn.VURDER_TILBAKETREKK,status:Yt.OPPRETTET}],feriepengegrunnlag:{andeler:[{aktivitetStatus:we.ARBEIDSTAKER,opptjeningsår:2,årsbeløp:5e5,erBrukerMottaker:!0}]}}},Nn={args:{aksjonspunkterForPanel:[],familiehendelse:{...ps,gjeldende:{avklartBarn:[{fodselsdato:"2017-01-01"}],soknadType:Tn.FODSEL}}}};Pn.parameters={...Pn.parameters,docs:{...Pn.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkterForPanel: []
  }
}`,...Pn.parameters?.docs?.source}}};xn.parameters={...xn.parameters,docs:{...xn.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkterForPanel: [{
...
}`,...xn.parameters?.docs?.source}}};_n.parameters={..._n.parameters,docs:{..._n.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkterForPanel: [{
      definisjon: AksjonspunktKode.VURDER_TILBAKETREKK,
...
}`,...Nn.parameters?.docs?.source}}};const Bg=["UtenAksjonspunkt","UtførtAksjonspunkt","MedFeriepengegrunnlag","MedBarnFodtLengeForForstePeriode"];export{Nn as MedBarnFodtLengeForForstePeriode,_n as MedFeriepengegrunnlag,Pn as UtenAksjonspunkt,xn as UtførtAksjonspunkt,Bg as __namedExportsOrder,Ig as default};
