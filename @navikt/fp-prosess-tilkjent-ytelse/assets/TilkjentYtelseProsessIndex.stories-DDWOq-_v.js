...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const oT={fagsakYtelseType:Ka.FORELDREPENGER,relasjonsRolleType:Hs.MOR},sT={uuid:"1",versjon:1},Is={gjeldende:{avklartBarn:[{fodselsdato:"2019-01-01"}],omsorgsovertakelseDato:"2019-01-01",soknadType:sr.FODSEL}},iT={bruker:{kjønn:qs.KVINNE}},lT={perioder:[{andeler:[{uttak:{stonadskontoType:Lr.FELLESPERIODE},aktivitetStatus:fe.ARBEIDSTAKER,arbeidsforholdType:At.NYTT_ARBEIDSFORHOLD}],fom:"2018-01-01",tom:"2019-01-10",dagsats:1e3},{andeler:[{uttak:{stonadskontoType:Lr.FORELDREPENGER},aktivitetStatus:fe.ARBEIDSTAKER,arbeidsforholdType:At.NYTT_ARBEIDSFORHOLD}],fom:"2019-02-01",tom:"2019-06-10",dagsats:100}]},dT={mottattDato:"2019-01-10",soknadType:sr.FODSEL,omsorgsovertakelseDato:"2019-01-10",fodselsdatoer:{1:"2019-01-01"},adopsjonFodelsedatoer:{1:"2019-01-01"},termindato:"2019-02-01"},uT={1:{erPrivatPerson:!1,identifikator:"973861778",navn:"EQUINOR ASA AVD STATOIL SOKKELVIRKSOMHET"}},TT={title:"prosess/prosess-tilkjent-ytelse",component:Rt},vr=({aksjonspunkter:e,feriepengegrunnlag:n,familiehendelse:t=Is})=>S.jsx(Rt,{submitCallback:js("button-click"),readOnlySubmitButton:!0,behandling:sT,alleKodeverk:Dm,aksjonspunkter:e,isReadOnly:!1,isAksjonspunktOpen:!0,status:"",vilkar:[],alleMerknaderFraBeslutter:{},setFormData:()=>{},beregningresultat:lT,familiehendelse:t,personoversikt:iT,soknad:dT,fagsak:oT,arbeidsgiverOpplysningerPerId:uT,feriepengegrunnlag:n}),Tn=vr.bind({});Tn.args={aksjonspunkter:[]};const fn=vr.bind({});fn.args={aksjonspunkter:[{begrunnelse:"Dette er en begrunnelse saksbehandler tidligere har gjort.",definisjon:ar.VURDER_TILBAKETREKK,status:Oa.UTFORT}]};const Rn=vr.bind({});Rn.args={aksjonspunkter:[{definisjon:ar.VURDER_TILBAKETREKK,status:Oa.OPPRETTET}],feriepengegrunnlag:{andeler:[{aktivitetStatus:fe.ARBEIDSTAKER,opptjeningsår:2,årsbeløp:5e5,erBrukerMottaker:!0}]}};const cn=vr.bind({});cn.args={aksjonspunkter:[],familiehendelse:{...Is,gjeldende:{avklartBarn:[{fodselsdato:"2017-01-01"}],soknadType:sr.FODSEL}}};var ma,Ta,fa;Tn.parameters={...Tn.parameters,docs:{...(ma=Tn.parameters)==null?void 0:ma.docs,source:{originalSource:`({
  aksjonspunkter,
  feriepengegrunnlag,
  ...
  feriepengegrunnlag,
  familiehendelse = defaultFamiliehendelse
}) => <TilkjentYtelseProsessIndex submitCallback={action('button-click') as (data: any) => Promise<any>} readOnlySubmitButton behandling={behandling} alleKodeverk={alleKodeverk as any} aksjonspunkter={aksjonspunkter} isReadOnly={false} isAksjonspunktOpen status="" vilkar={[]} alleMerknaderFraBeslutter={{}} setFormData={() => undefined} beregningresultat={beregningresultat} familiehendelse={familiehendelse} personoversikt={personoversikt} soknad={søknad} fagsak={fagsak} arbeidsgiverOpplysningerPerId={arbeidsgiverOpplysningerPerId} feriepengegrunnlag={feriepengegrunnlag} />`,...(Aa=(ca=fn.parameters)==null?void 0:ca.docs)==null?void 0:Aa.source}}};var ya,pa,_a;Rn.parameters={...Rn.parameters,docs:{...(ya=Rn.parameters)==null?void 0:ya.docs,source:{originalSource:`({
  aksjonspunkter,
  feriepengegrunnlag,
  familiehendelse = defaultFamiliehendelse
}) => <TilkjentYtelseProsessIndex submitCallback={action('button-click') as (data: any) => Promise<any>} readOnlySubmitButton behandling={behandling} alleKodeverk={alleKodeverk as any} aksjonspunkter={aksjonspunkter} isReadOnly={false} isAksjonspunktOpen status="" vilkar={[]} alleMerknaderFraBeslutter={{}} setFormData={() => undefined} beregningresultat={beregningresultat} familiehendelse={familiehendelse} personoversikt={personoversikt} soknad={søknad} fagsak={fagsak} arbeidsgiverOpplysningerPerId={arbeidsgiverOpplysningerPerId} feriepengegrunnlag={feriepengegrunnlag} />`,...(_a=(pa=Rn.parameters)==null?void 0:pa.docs)==null?void 0:_a.source}}};var Sa,Na,ba;cn.parameters={...cn.parameters,docs:{...(Sa=cn.parameters)==null?void 0:Sa.docs,source:{originalSource:`({
  aksjonspunkter,
  feriepengegrunnlag,
  familiehendelse = defaultFamiliehendelse
