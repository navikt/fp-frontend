...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""},feriepengegrunnlag:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  andeler: FeriepengegrunnlagAndel[];
}>`},description:""}}};const ps={gjeldende:{avklartBarn:[{fodselsdato:"2019-01-01"}],omsorgsovertakelseDato:"2019-01-01",soknadType:Tn.FODSEL}},Pg={bruker:{kjønn:Wt.KVINNE}},Ng={perioder:[{andeler:[{uttak:{stonadskontoType:kr.FELLESPERIODE},aktivitetStatus:Te.ARBEIDSTAKER,arbeidsforholdType:zt.ARBEID}],fom:"2018-01-01",tom:"2019-01-10",dagsats:1e3},{andeler:[{uttak:{stonadskontoType:kr.FORELDREPENGER},aktivitetStatus:Te.ARBEIDSTAKER,arbeidsforholdType:$t.NYTT_ARBEIDSFORHOLD}],fom:"2019-02-01",tom:"2019-06-10",dagsats:100}]},_g={mottattDato:"2019-01-10",soknadType:Tn.FODSEL,omsorgsovertakelseDato:"2019-01-10",fodselsdatoer:{1:"2019-01-01"},adopsjonFodelsedatoer:{1:"2019-01-01"},termindato:"2019-02-01"},xg={1:{erPrivatPerson:!1,identifikator:"973861778",referanse:"973861778",navn:"EQUINOR ASA AVD STATOIL SOKKELVIRKSOMHET"}},Ig={title:"prosess/prosess-tilkjent-ytelse",component:Ar,decorators:[Rs],args:{beregningresultat:Ng,familiehendelse:ps,personoversikt:Pg,søknad:_g,arbeidsgiverOpplysningerPerId:xg},render:e=>p.jsx(Ar,{...e})},Pn={args:{aksjonspunkterForPanel:[]}},Nn={args:{aksjonspunkterForPanel:[{begrunnelse:"Dette er en begrunnelse saksbehandler tidligere har gjort.",definisjon:zn.VURDER_TILBAKETREKK,status:Yt.UTFORT}]}},_n={args:{aksjonspunkterForPanel:[{definisjon:zn.VURDER_TILBAKETREKK,status:Yt.OPPRETTET}],feriepengegrunnlag:{andeler:[{aktivitetStatus:Te.ARBEIDSTAKER,opptjeningsår:2,årsbeløp:5e5,erBrukerMottaker:!0}]}}},xn={args:{aksjonspunkterForPanel:[],familiehendelse:{...ps,gjeldende:{avklartBarn:[{fodselsdato:"2017-01-01"}],soknadType:Tn.FODSEL}}}};Pn.parameters={...Pn.parameters,docs:{...Pn.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...xn.parameters?.docs?.source}}};const Bg=["UtenAksjonspunkt","UtførtAksjonspunkt","MedFeriepengegrunnlag","MedBarnFodtLengeForForstePeriode"];export{xn as MedBarnFodtLengeForForstePeriode,_n as MedFeriepengegrunnlag,Pn as UtenAksjonspunkt,Nn as UtførtAksjonspunkt,Bg as __namedExportsOrder,Ig as default};
