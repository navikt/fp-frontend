...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""},lukkPeriode:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const ks=({beregningsresultatPeriode:e,søknadsdato:r,familiehendelseSamling:t,hovedsøkerKjønnKode:n,alleKodeverk:a,arbeidsgiverOpplysningerPerId:s,fagsak:i})=>{const l=Ar(),[o,u]=g.useState(),d=Rg(e),m=()=>{u(null)},f=()=>{const N=d.findIndex(F=>F.id===o?.id)+1;N<d.length&&u(d[N])},c=()=>{const N=d.findIndex(F=>F.id===o?.id)-1;N>=0&&u(d[N])},k=N=>{u(d.find(F=>F.id===N))},v=sn(d[0].start),y=sn(d[d.length-1].end),[b,E]=g.useState(v),[T,q]=g.useState(y),x=()=>{b.subtract(1,"month").isBefore(v)||(E(b.subtract(1,"month")),q(T.subtract(1,"month")))},D=()=>{T.add(1,"month").isAfter(y)||(E(b.add(1,"month")),q(T.add(1,"month")))},I=()=>{b.add(3,"month").isAfter(T)||(E(b.add(1,"month")),q(T.subtract(1,"month")))},C=()=>{T.add(1,"month").diff(b.subtract(1,"month"),"months")<36&&(E(b.subtract(1,"month")),q(T.add(1,"month")))},V=wg(t);return p.jsxs(gn,{gap:"4",children:[p.jsxs(Pe,{startDate:b.toDate(),endDate:T.add(1,"days").toDate(),children:[p.jsxs(Pe.Pin,{date:Ag(r,b).toDate(),children:[p.jsx(de,{children:p.jsx(X,{id:"TilkjentYtelse.Soknadsdato"})}),p.jsx(de,{children:p.jsx(Kt,{dateString:r})})]}),V.dato&&p.jsxs(Pe.Pin,{date:Og(V.dato,b).toDate(),children:[p.jsx(de,{children:p.jsx(X,{id:V.textId})}),p.jsx(de,{children:p.jsx(Kt,{dateString:V.dato})})]}),p.jsx(Pe.Row,{label:Eg(i,a),icon:n===vg.KVINNE?p.jsx(zs,{width:20,height:20,color:"var(--a-red-200)"}):p.jsx(si,{width:20,height:20,color:"var(--a-blue-600)"}),children:d.map(N=>p.jsx(Pe.Period,{start:N.start,end:N.end,status:"success",onSelectPeriod:()=>k(N.id),isActive:o?.id===N.id,icon:N.erGradert?p.jsx(Zs,{"aria-hidden":!0}):p.jsx(Hs,{"aria-hidden":!0}),title:N.erGradert?l.formatMessage({id:"TilkjentYtelse.GradertPeriode"}):""},N.id))})]}),p.jsxs(rn,{gap:"2",justify:"end",children:[p.jsx(He,{size:"small",icon:p.jsx(ti,{"aria-hidden":!0}),onClick:I,variant:"primary-neutral",type:"button",title:l.formatMessage({id:"TilkjentYtelse.ZoomInn"})}),p.jsx(He,{size:"small",icon:p.jsx(Js,{"aria-hidden":!0}),onClick:C,variant:"primary-neutral",type:"button",title:l.formatMessage({id:"TilkjentYtelse.ZoomUt"})}),p.jsx(He,{size:"small",icon:p.jsx(Zt,{"aria-hidden":!0}),onClick:x,variant:"primary-neutral",type:"button",title:l.formatMessage({id:"TilkjentYtelse.ScrollTilVenstre"})}),p.jsx(He,{size:"small",icon:p.jsx(ea,{"aria-hidden":!0}),onClick:D,variant:"primary-neutral",type:"button",title:l.formatMessage({id:"TilkjentYtelse.ScrollTilHogre"})})]}),o&&p.jsx(fs,{alleKodeverk:a,valgtBeregningsresultatPeriode:o.periode,velgNestePeriode:f,velgForrigePeriode:c,erSøknadSvangerskapspenger:i.fagsakYtelseType===hs.SVANGERSKAPSPENGER,arbeidsgiverOpplysningerPerId:s,lukkPeriode:m})]})},Tg=e=>(e.andeler??[]).filter(t=>t.uttak&&t.uttak.gradering===!0).length>0,wg=e=>{const r=e.gjeldende??e.oppgitt;return r.soknadType===Tn.FODSEL?r.avklartBarn&&r.avklartBarn.length>0?{dato:r.avklartBarn[0].fodselsdato,textId:"TilkjentYtelse.Fodselsdato"}:{dato:r.termindato,textId:"TilkjentYtelse.Termindato"}:r.omsorgsovertakelseDato?{dato:r.omsorgsovertakelseDato,textId:"TilkjentYtelse.Omsorgsovertakelsesdato"}:{dato:r.adopsjonFodelsedatoer?r.adopsjonFodelsedatoer[0]:void 0,textId:"TilkjentYtelse.Fodselsdato"}},Rg=(e=[])=>e.filter(r=>r.andeler?.[0]&&r.dagsats).map((r,t)=>({erGradert:Tg(r),start:sn(r.fom).toDate(),end:sn(r.tom).add(1,"days").toDate(),id:t,periode:r})),Eg=(e,r)=>r.RelasjonsRolleType.find(n=>n.kode===e.relasjonsRolleType)?.navn??"",Og=(e,r)=>{const t=sn(e);return t.isBefore(r)?r.subtract(5,"days"):t},Ag=(e,r)=>{const t=sn(e);return t.isBefore(r)?r.subtract(15,"days"):t};ks.__docgenInfo={description:`TilkjentYtelse
...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""},feriepengegrunnlag:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  andeler: FeriepengegrunnlagAndel[];
}>`},description:""}}};const ps={gjeldende:{avklartBarn:[{fodselsdato:"2019-01-01"}],omsorgsovertakelseDato:"2019-01-01",soknadType:Tn.FODSEL}},Pg={bruker:{kjønn:Wt.KVINNE}},_g={perioder:[{andeler:[{uttak:{stonadskontoType:kr.FELLESPERIODE},aktivitetStatus:Te.ARBEIDSTAKER,arbeidsforholdType:zt.ARBEID}],fom:"2018-01-01",tom:"2019-01-10",dagsats:1e3},{andeler:[{uttak:{stonadskontoType:kr.FORELDREPENGER},aktivitetStatus:Te.ARBEIDSTAKER,arbeidsforholdType:$t.NYTT_ARBEIDSFORHOLD}],fom:"2019-02-01",tom:"2019-06-10",dagsats:100}]},xg={mottattDato:"2019-01-10",soknadType:Tn.FODSEL,omsorgsovertakelseDato:"2019-01-10",fodselsdatoer:{1:"2019-01-01"},adopsjonFodelsedatoer:{1:"2019-01-01"},termindato:"2019-02-01"},Ng={1:{erPrivatPerson:!1,identifikator:"973861778",referanse:"973861778",navn:"EQUINOR ASA AVD STATOIL SOKKELVIRKSOMHET"}},Ig={title:"prosess/prosess-tilkjent-ytelse",component:Or,decorators:[Rs],args:{beregningresultat:_g,familiehendelse:ps,personoversikt:Pg,søknad:xg,arbeidsgiverOpplysningerPerId:Ng},render:e=>p.jsx(Or,{...e})},Pn={args:{aksjonspunkterForPanel:[]}},_n={args:{aksjonspunkterForPanel:[{begrunnelse:"Dette er en begrunnelse saksbehandler tidligere har gjort.",definisjon:zn.VURDER_TILBAKETREKK,status:Yt.UTFORT}]}},xn={args:{aksjonspunkterForPanel:[{definisjon:zn.VURDER_TILBAKETREKK,status:Yt.OPPRETTET}],feriepengegrunnlag:{andeler:[{aktivitetStatus:Te.ARBEIDSTAKER,opptjeningsår:2,årsbeløp:5e5,erBrukerMottaker:!0}]}}},Nn={args:{aksjonspunkterForPanel:[],familiehendelse:{...ps,gjeldende:{avklartBarn:[{fodselsdato:"2017-01-01"}],soknadType:Tn.FODSEL}}}};Pn.parameters={...Pn.parameters,docs:{...Pn.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkterForPanel: []
  }
}`,...Pn.parameters?.docs?.source}}};_n.parameters={..._n.parameters,docs:{..._n.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkterForPanel: [{
...
}`,...xn.parameters?.docs?.source}}};Nn.parameters={...Nn.parameters,docs:{...Nn.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkterForPanel: [],
    familiehendelse: {
...
}`,...Nn.parameters?.docs?.source}}};const Bg=["UtenAksjonspunkt","UtførtAksjonspunkt","MedFeriepengegrunnlag","MedBarnFodtLengeForForstePeriode"];export{Nn as MedBarnFodtLengeForForstePeriode,xn as MedFeriepengegrunnlag,Pn as UtenAksjonspunkt,_n as UtførtAksjonspunkt,Bg as __namedExportsOrder,Ig as default};
