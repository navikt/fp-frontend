...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  notater: Saksnotat[];
}>`},description:""}}};const hT=e=>{var n;return e?(n=e.find(t=>t.definisjon===or.VURDER_TILBAKETREKK))==null?void 0:n.begrunnelse:void 0},Us=({beregningresultat:e,alleKodeverk:n,arbeidsgiverOpplysningerPerId:t,feriepengegrunnlag:r,familieHendelseSamling:a,personoversikt:o,soknad:s,aksjonspunkter:i,fagsak:l})=>{var k,v;const d=E.useMemo(()=>hT(i),[i]),u=(k=s.søknadsfrist)!=null&&k.mottattDato?(v=s.søknadsfrist)==null?void 0:v.mottattDato:s.mottattDato;return _.jsxs(_.Fragment,{children:[_.jsx(tt,{size:"small",children:_.jsx(ae,{id:"TilkjentYtelse.Title"})}),_.jsx(De,{thirtyTwoPx:!0}),e&&_.jsx(qs,{beregningsresultatPeriode:e.perioder,soknadDate:u,familieHendelseSamling:a,hovedsokerKjonnKode:o!=null&&o.bruker?o.bruker.kjønn:void 0,alleKodeverk:n,arbeidsgiverOpplysningerPerId:t,fagsak:l}),r&&_.jsxs(_.Fragment,{children:[_.jsx(De,{thirtyTwoPx:!0}),_.jsx(Bs,{feriepengegrunnlag:r,arbeidsgiverOpplysningerPerId:t,alleKodeverk:n}),_.jsx(De,{thirtyTwoPx:!0})]}),d&&_.jsxs(_.Fragment,{children:[_.jsx(bn,{children:_.jsx(ae,{id:"TilkjentYtelse.VurderTilbaketrekk.Beskrivelse"})}),_.jsx(De,{sixteenPx:!0}),_.jsxs(ke,{className:on.readOnlyBlokk,children:[d," ",_.jsx(tm,{})]})]})]})};Us.__docgenInfo={description:"",methods:[],displayName:"TilkjentYtelsePanel",props:{beregningresultat:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  opphoersdato?: string;
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const KT={fagsakYtelseType:Ha.FORELDREPENGER,relasjonsRolleType:si.MOR},DT={uuid:"1",versjon:1},Cs={gjeldende:{avklartBarn:[{fodselsdato:"2019-01-01"}],omsorgsovertakelseDato:"2019-01-01",soknadType:ir.FODSEL}},LT={bruker:{kjønn:oi.KVINNE}},PT={perioder:[{andeler:[{uttak:{stonadskontoType:Br.FELLESPERIODE},aktivitetStatus:pe.ARBEIDSTAKER,arbeidsforholdType:Kt.NYTT_ARBEIDSFORHOLD}],fom:"2018-01-01",tom:"2019-01-10",dagsats:1e3},{andeler:[{uttak:{stonadskontoType:Br.FORELDREPENGER},aktivitetStatus:pe.ARBEIDSTAKER,arbeidsforholdType:Kt.NYTT_ARBEIDSFORHOLD}],fom:"2019-02-01",tom:"2019-06-10",dagsats:100}]},FT={mottattDato:"2019-01-10",soknadType:ir.FODSEL,omsorgsovertakelseDato:"2019-01-10",fodselsdatoer:{1:"2019-01-01"},adopsjonFodelsedatoer:{1:"2019-01-01"},termindato:"2019-02-01"},MT={1:{erPrivatPerson:!1,identifikator:"973861778",navn:"EQUINOR ASA AVD STATOIL SOKKELVIRKSOMHET"}},BT={title:"prosess/prosess-tilkjent-ytelse",component:Ys},br=({aksjonspunkter:e,feriepengegrunnlag:n,familiehendelse:t=Cs})=>_.jsx(Ys,{submitCallback:ti("button-click"),readOnlySubmitButton:!0,behandling:DT,alleKodeverk:rT,aksjonspunkter:e,isReadOnly:!1,isAksjonspunktOpen:!0,status:"",vilkar:[],alleMerknaderFraBeslutter:{},setFormData:()=>{},beregningresultat:PT,familiehendelse:t,personoversikt:LT,soknad:FT,fagsak:KT,arbeidsgiverOpplysningerPerId:MT,feriepengegrunnlag:n}),cn=br.bind({});cn.args={aksjonspunkter:[]};const yn=br.bind({});yn.args={aksjonspunkter:[{begrunnelse:"Dette er en begrunnelse saksbehandler tidligere har gjort.",definisjon:or.VURDER_TILBAKETREKK,status:Ba.UTFORT}]};const pn=br.bind({});pn.args={aksjonspunkter:[{definisjon:or.VURDER_TILBAKETREKK,status:Ba.OPPRETTET}],feriepengegrunnlag:{andeler:[{aktivitetStatus:pe.ARBEIDSTAKER,opptjeningsår:2,årsbeløp:5e5,erBrukerMottaker:!0}]}};const An=br.bind({});An.args={aksjonspunkter:[],familiehendelse:{...Cs,gjeldende:{avklartBarn:[{fodselsdato:"2017-01-01"}],soknadType:ir.FODSEL}}};var Na,ha,Ia;cn.parameters={...cn.parameters,docs:{...(Na=cn.parameters)==null?void 0:Na.docs,source:{originalSource:`({
  aksjonspunkter,
  feriepengegrunnlag,
  ...
  feriepengegrunnlag,
  familiehendelse = defaultFamiliehendelse
}) => <TilkjentYtelseProsessIndex submitCallback={(action('button-click') as (data: any) => Promise<any>)} readOnlySubmitButton behandling={behandling} alleKodeverk={(alleKodeverk as any)} aksjonspunkter={aksjonspunkter} isReadOnly={false} isAksjonspunktOpen status="" vilkar={[]} alleMerknaderFraBeslutter={{}} setFormData={() => undefined} beregningresultat={beregningresultat} familiehendelse={familiehendelse} personoversikt={personoversikt} soknad={søknad} fagsak={fagsak} arbeidsgiverOpplysningerPerId={arbeidsgiverOpplysningerPerId} feriepengegrunnlag={feriepengegrunnlag} />`,...(Va=(Ga=An.parameters)==null?void 0:Ga.docs)==null?void 0:Va.source}}};const HT=["UtenAksjonspunkt","UtførtAksjonspunkt","MedFeriepengegrunnlag","MedBarnFodtLengeForForstePeriode"];export{An as MedBarnFodtLengeForForstePeriode,pn as MedFeriepengegrunnlag,cn as UtenAksjonspunkt,yn as UtførtAksjonspunkt,HT as __namedExportsOrder,BT as default};
