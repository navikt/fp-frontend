import{j as e}from"./dayjs.min-DKYhEbg2.js";import{a as o,d as r,e as d,M as m,B as s}from"./nb_NO-CRq88Yak.js";const g="_submitButton_cko9v_1",y="_cancelButton_cko9v_6",i={submitButton:g,cancelButton:y},l=({valgtSaksliste:a,cancel:t,submit:u})=>{const n=o();return e.jsxs(r,{width:"small",open:!0,"aria-label":n.formatMessage({id:"SletteSakslisteModal.SletteModal"}),onClose:t,children:[e.jsx(r.Header,{children:e.jsx(d,{size:"small",children:e.jsx(m,{id:"SletteSakslisteModal.SletteSaksliste",values:{sakslisteNavn:a.navn}})})}),e.jsxs(r.Footer,{children:[e.jsx(s,{className:i.submitButton,size:"small",variant:"primary",onClick:()=>u(a),autoFocus:!0,type:"button",children:n.formatMessage({id:"SletteSakslisteModal.Ja"})}),e.jsx(s,{className:i.cancelButton,size:"small",variant:"secondary",onClick:t,type:"button",children:n.formatMessage({id:"SletteSakslisteModal.Nei"})})]})]})},p=l;l.__docgenInfo={description:`SletteSakslisteModal
