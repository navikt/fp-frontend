import{j as a}from"./jsx-runtime-QvZ8i92b.js";import{u as R,L as x,M as v}from"./nb_NO-COD-RJQh.js";import{u as G,$ as F,k as S}from"./index.es-BEcJ7ulV.js";import{y as T}from"./useRestApiRunner-puvCxW7G.js";import"./aktivitetStatus-B1m96ipJ.js";import{F as o}from"./fagsakYtelseType-DI8GXtVr.js";import{K as k}from"./kodeverkTyper-CavWL6Ds.js";import{r as p}from"./index-uubelm5h.js";import{B as d}from"./behandlingType-BdbjGMJD.js";import{R as L}from"./FlyttReservasjonModal-0I9TiFOd.js";import{P as Y}from"./Panel-kMoRCghZ.js";import{S as P}from"./StoreValuesInLocalStorage-D6Hb4UHw.js";import{u as b}from"./useLosKodeverk-43wcDHc1.js";const h=[d.TILBAKEKREVING_REVURDERING,d.TILBAKEKREVING,d.DOKUMENTINNSYN,d.KLAGE,d.REVURDERING,d.FORSTEGANGSSOKNAD],A=s=>{const t=s.reduce((n,e)=>{const r=h.findIndex(i=>i===e.behandlingType)+1;return{...n,[r]:n[r]?n[r]+e.antall:e.antall}},{});return h.map((n,e)=>t[e+1])},B=({height:s,oppgaverForAvdeling:t,behandlingTyper:n})=>{const e=R(),r=e.formatMessage({id:"FordelingAvBehandlingstypeGraf.TilBehandling"}),i=e.formatMessage({id:"FordelingAvBehandlingstypeGraf.TilBeslutter"}),m=p.useMemo(()=>h.map(l=>{const f=n.find(N=>N.kode===l);return f?f.navn:""}),[n]),u=p.useMemo(()=>A(t.filter(l=>l.tilBehandling)),[t]),g=p.useMemo(()=>A(t.filter(l=>!l.tilBehandling)),[t]);return a.jsx(Y,{children:a.jsx(L,{height:s,option:{tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},toolbox:{feature:{saveAsImage:{title:"Lagre ",name:"Antall_åpne_behandlinger"}}},legend:{data:[r,i]},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:{type:"value"},yAxis:{type:"category",data:m},series:[{name:r,type:"bar",stack:"total",label:{show:!0},emphasis:{focus:"series"},data:u},{name:i,type:"bar",stack:"total",label:{show:!0},emphasis:{focus:"series"},data:g}],color:["#337c9b","#38a161"]}})})};B.__docgenInfo={description:"FordelingAvBehandlingstypeGraf.",methods:[],displayName:"FordelingAvBehandlingstypeGraf",props:{height:{required:!0,tsType:{name:"number"},description:""},behandlingTyper:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
