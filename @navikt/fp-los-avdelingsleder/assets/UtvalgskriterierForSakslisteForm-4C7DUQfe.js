import{i as f,h as k,j as r}from"./iframe-BbEdvI7d.js";import{u as h,N as j,A as T}from"./index.es-BI1p71Uu.js";import{e as x,r as I,a as D,N as v}from"./index.es-DH4WGIyY.js";import{u as q}from"./useQuery-D3nmzijI.js";import{u as K}from"./useMutation-D3Auq3dR.js";import{i as F,V as g,H as y,j as w,L as N}from"./fplosAvdelingslederApi-P0OxEwkG.js";import{A}from"./AndreKriterierVelger-CN4tgsXh.js";import{B as V}from"./BehandlingstypeVelger-BWccPHDw.js";import{F as B}from"./FagsakYtelseTypeVelger-BTXi9r5O.js";import{S as U}from"./SorteringVelger-BotVrTPJ.js";import{u as P}from"./useDebounce-Cuw4G6iW.js";import{B as p}from"./Box-CmXRWMDU.js";import{H as c,M as b,B as R}from"./nb_NO-CWsar5lz.js";const _="_bredde_grd8c_1",L={bredde:_},M=I(3),Y=D(100),z=(n,e)=>{var a,m;const u=e.behandlingTyper?e.behandlingTyper.reduce((i,s)=>({...i,[s]:!0}),{}):{},o=e.fagsakYtelseTyper?e.fagsakYtelseTyper.reduce((i,s)=>({...i,[s]:!0}),{}):{},d=e.andreKriterier?e.andreKriterier.reduce((i,s)=>({...i,[s.andreKriterierType]:!0}),{}):{},l=e.andreKriterier?e.andreKriterier.reduce((i,s)=>({...i,[`${s.andreKriterierType}_inkluder`]:s.inkluder}),{}):{};return{sakslisteId:e.sakslisteId,navn:e.navn??n.formatMessage({id:"UtvalgskriterierForSakslisteForm.NyListe"}),sortering:e.sortering?e.sortering.sorteringType:void 0,fomDato:e.sortering?e.sortering.fomDato:void 0,tomDato:e.sortering?e.sortering.tomDato:void 0,fra:e.sortering?(a=e.sortering.fra)==null?void 0:a.toString():void 0,til:e.sortering?(m=e.sortering.til)==null?void 0:m.toString():void 0,erDynamiskPeriode:e.sortering?e.sortering.erDynamiskPeriode:void 0,...d,...l,...u,...o}},C=({valgtSaksliste:n,valgtAvdelingEnhet:e})=>{const u=f(),o=k(),{data:d}=q(F(n.sakslisteId,e)),{mutate:l}=K({mutationFn:t=>w(t.sakslisteId,t.navn,t.avdelingEnhet),onSuccess:()=>{u.invalidateQueries({queryKey:[N.SAKSLISTER_FOR_AVDELING]})}}),a=h({defaultValues:z(o,n)}),m=a.watch(),s=P("navn",t=>{l({sakslisteId:n.sakslisteId,navn:t,avdelingEnhet:e})},a.trigger);return r.jsx(j,{formMethods:a,children:r.jsx(p,{padding:"5",borderColor:"border-divider",borderRadius:"0",borderWidth:"1",children:r.jsxs(g,{gap:"2",children:[r.jsx(c,{size:"small",children:r.jsx(b,{id:"UtvalgskriterierForSakslisteForm.Utvalgskriterier"})}),r.jsxs(g,{gap:"4",children:[r.jsxs(y,{justify:"space-between",children:[r.jsx(T,{name:"navn",label:o.formatMessage({id:"UtvalgskriterierForSakslisteForm.Navn"}),validate:[x,M,Y,v],onChange:s,className:L.bredde}),r.jsxs(p,{padding:"2",background:"bg-subtle",children:[r.jsx(R,{size:"small",children:r.jsx(b,{id:"UtvalgskriterierForSakslisteForm.AntallSaker"})}),r.jsx(c,{size:"small",children:d?`${d}`:"0"})]})]}),r.jsxs(y,{justify:"space-between",children:[r.jsxs("div",{children:[r.jsx(B,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e}),r.jsx(V,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})]}),r.jsx("div",{children:r.jsx(A,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})}),r.jsx("div",{children:r.jsx(U,{valgtSakslisteId:n.sakslisteId,valgteBehandlingtyper:n.behandlingTyper,valgtAvdelingEnhet:e,erDynamiskPeriode:!!m.erDynamiskPeriode})})]})]})]})})})};C.__docgenInfo={description:"",methods:[],displayName:"UtvalgskriterierForSakslisteForm",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn?: string;
