import{g as u,j as e}from"./iframe-gYF99bpJ.js";import{M as n,B as s}from"./Modal-CZ0fvY4N.js";import{H as d,M as r}from"./nb_NO-3HGCLywH.js";const m="_submitButton_cko9v_1",g="_cancelButton_cko9v_6",i={submitButton:m,cancelButton:g},y=({valgtSaksliste:t,cancel:a,submit:l})=>{const o=u();return e.jsxs(n,{width:"small",open:!0,"aria-label":o.formatMessage({id:"SletteSakslisteModal.SletteModal"}),onClose:a,children:[e.jsx(n.Header,{children:e.jsx(d,{size:"small",children:e.jsx(r,{id:"SletteSakslisteModal.SletteSaksliste",values:{sakslisteNavn:t.navn}})})}),e.jsxs(n.Footer,{children:[e.jsx(s,{className:i.submitButton,size:"small",variant:"primary",onClick:()=>l(t),autoFocus:!0,type:"button",children:e.jsx(r,{id:"SletteSakslisteModal.Ja"})}),e.jsx(s,{className:i.cancelButton,size:"small",variant:"secondary",onClick:a,type:"button",children:e.jsx(r,{id:"SletteSakslisteModal.Nei"})})]})]})};y.__docgenInfo={description:`SletteSakslisteModal
