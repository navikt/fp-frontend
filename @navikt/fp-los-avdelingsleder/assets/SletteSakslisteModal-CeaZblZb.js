import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{u,H as o,M as d}from"./nb_NO-COD-RJQh.js";import{M as r,B as s}from"./Modal-AsiqG6ll.js";const m="_submitButton_cko9v_1",g="_cancelButton_cko9v_6",i={submitButton:m,cancelButton:g},y=({valgtSaksliste:a,cancel:t,submit:l})=>{const n=u();return e.jsxs(r,{width:"small",open:!0,"aria-label":n.formatMessage({id:"SletteSakslisteModal.SletteModal"}),onClose:t,children:[e.jsx(r.Header,{children:e.jsx(o,{size:"small",children:e.jsx(d,{id:"SletteSakslisteModal.SletteSaksliste",values:{sakslisteNavn:a.navn}})})}),e.jsxs(r.Footer,{children:[e.jsx(s,{className:i.submitButton,size:"small",variant:"primary",onClick:()=>l(a),autoFocus:!0,type:"button",children:n.formatMessage({id:"SletteSakslisteModal.Ja"})}),e.jsx(s,{className:i.cancelButton,size:"small",variant:"secondary",onClick:t,type:"button",children:n.formatMessage({id:"SletteSakslisteModal.Nei"})})]})]})};y.__docgenInfo={description:`SletteSakslisteModal
