import{g as u,j as e}from"./iframe-DrTCGkYu.js";import{M as n,B as s}from"./Modal-D9AfVhOG.js";import{H as m,M as r}from"./nb_NO-tskf6aB_.js";const d="_submitButton_cko9v_1",g="_cancelButton_cko9v_6",i={submitButton:d,cancelButton:g},y=({valgtSaksliste:a,cancel:t,submit:l})=>{const o=u();return e.jsxs(n,{width:"small",open:!0,"aria-label":o.formatMessage({id:"SletteSakslisteModal.SletteModal"}),onClose:t,children:[e.jsx(n.Header,{children:e.jsx(m,{size:"small",children:e.jsx(r,{id:"SletteSakslisteModal.SletteSaksliste",values:{sakslisteNavn:a.navn}})})}),e.jsxs(n.Footer,{children:[e.jsx(s,{className:i.submitButton,size:"small",variant:"primary",onClick:()=>l(a),autoFocus:!0,type:"button",children:e.jsx(r,{id:"SletteSakslisteModal.Ja"})}),e.jsx(s,{className:i.cancelButton,size:"small",variant:"secondary",onClick:t,type:"button",children:e.jsx(r,{id:"SletteSakslisteModal.Nei"})})]})]})};y.__docgenInfo={description:`SletteSakslisteModal
