import{f as d,B as a,j as i}from"./iframe-gYF99bpJ.js";import{a as S,N}from"./index.es-Dx42xqqo.js";import{X as E}from"./index.es-Bru076JX.js";import{u}from"./useQuery-De1p-dGU.js";import{h as e,L as r,b as s,l as T}from"./fplosAvdelingslederApi-cGPzxlCw.js";import{K as c}from"./køSortering-BHrQm0Td.js";import{g as D}from"./withIntl-CQNxENlx.js";import{a as y}from"./useLosKodeverk-7Y30tkru.js";import{S as g}from"./SorteringVelger-CU9tDc10.js";import{m as I}from"./nb_NO-3HGCLywH.js";import"./Modal-CZ0fvY4N.js";import"./index-kWm9xkfC.js";import"./BasePrimitive-j7bUEsxy.js";import"./useMutation-edhUVvtQ.js";import"./index.es-B8bRcqOo.js";import"./useDebounce-DSLOUdC2.js";const K=D(I),j={title:"los/avdelingsleder/behandlingskoer/SorteringVelger",component:g,decorators:[K,d],parameters:{msw:{handlers:[e.get(r.KODEVERK_LOS,()=>s.json(y)),e.post(r.LAGRE_SAKSLISTE_SORTERING,()=>new s(null,{status:200})),e.post(r.LAGRE_SAKSLISTE_SORTERING_INTERVALL,()=>new s(null,{status:200})),e.post(r.LAGRE_SAKSLISTE_SORTERING_DYNAMISK_PERIDE,()=>new s(null,{status:200})),e.post(r.LAGRE_SAKSLISTE_SORTERING_TIDSINTERVALL_DATO,()=>new s(null,{status:200}))]}},args:{valgtSakslisteId:1,valgtAvdelingEnhet:"Nav Vikafossen"},render:l=>{const m=S({defaultValues:{sortering:c.BEHANDLINGSFRIST,fra:2,til:3,fomDato:"2020-01-10",tomDato:"2020-10-01",erDynamiskPeriode:l.erDynamiskPeriode}}),{data:p}=u(T());return p?i.jsx(N,{formMethods:m,children:i.jsx(g,{...l})}):i.jsx(E,{})}},t={args:{valgteBehandlingtyper:[a.FORSTEGANGSSOKNAD,a.DOKUMENTINNSYN],erDynamiskPeriode:!1}},n={args:{valgteBehandlingtyper:[a.FORSTEGANGSSOKNAD,a.DOKUMENTINNSYN],erDynamiskPeriode:!0}},o={args:{valgteBehandlingtyper:[a.TILBAKEKREVING],erDynamiskPeriode:!1}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
