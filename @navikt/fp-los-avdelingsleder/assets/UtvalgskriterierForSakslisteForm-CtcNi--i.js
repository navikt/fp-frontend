import{j as r}from"./jsx-runtime-QvZ8i92b.js";import{r as m}from"./index-uubelm5h.js";import{d as q,u as D,Y as F,f as k,M as b,y as h,V as K,H as j,O as w,g as A}from"./nb_NO-BDUDBxCz.js";import{r as P,G as _,k as R,I as B}from"./index.es-CU2WkXv2.js";import{b as x,a as T}from"./fplosRestApi-1yojVYCb.js";import{B as E}from"./BehandlingstypeVelger-ChYvVeEu.js";import{A as N}from"./AndreKriterierVelger-DR26B_gx.js";import{F as V}from"./FagsakYtelseTypeVelger-CH28oePq.js";import{S as U}from"./SorteringVelger-DvMsjGMx.js";import{u as Y}from"./useDebounce-Cv11krhf.js";import{P as z}from"./Panel--8iV_nPK.js";const L="_grayBox_zjuun_1",M="_panel_zjuun_6",O="_bredde_zjuun_11",y={grayBox:L,panel:M,bredde:O},G=R(3),H=B(100),C=(n,e)=>{var o,i;const t=e.behandlingTyper?e.behandlingTyper.reduce((a,s)=>({...a,[s]:!0}),{}):{},l=e.fagsakYtelseTyper?e.fagsakYtelseTyper.reduce((a,s)=>({...a,[s]:!0}),{}):{},d=e.andreKriterier?e.andreKriterier.reduce((a,s)=>({...a,[s.andreKriterierType]:!0}),{}):{},u=e.andreKriterier?e.andreKriterier.reduce((a,s)=>({...a,[`${s.andreKriterierType}_inkluder`]:s.inkluder}),{}):{};return{sakslisteId:e.sakslisteId,navn:e.navn?e.navn:n.formatMessage({id:"UtvalgskriterierForSakslisteForm.NyListe"}),sortering:e.sortering?e.sortering.sorteringType:void 0,fomDato:e.sortering?e.sortering.fomDato:void 0,tomDato:e.sortering?e.sortering.tomDato:void 0,fra:e.sortering?(o=e.sortering.fra)==null?void 0:o.toString():void 0,til:e.sortering?(i=e.sortering.til)==null?void 0:i.toString():void 0,erDynamiskPeriode:e.sortering?e.sortering.erDynamiskPeriode:void 0,...d,...u,...t,...l}},$=({valgtSaksliste:n,valgtAvdelingEnhet:e,hentAvdelingensSakslister:t,hentOppgaverForAvdelingAntall:l})=>{const d=q(),{data:u,startRequest:o}=x.useRestApiRunner(T.OPPGAVE_ANTALL);m.useEffect(()=>{o({sakslisteId:n.sakslisteId,avdelingEnhet:e})},[n.sakslisteId]);const i=m.useCallback((p,f)=>{o({sakslisteId:p,avdelingEnhet:f}),l({avdelingEnhet:f})},[]),{startRequest:a}=x.useRestApiRunner(T.LAGRE_SAKSLISTE_NAVN),s=m.useCallback(p=>{a({sakslisteId:n.sakslisteId,navn:p,avdelingEnhet:e}).then(()=>t({avdelingEnhet:e}))},[e,n]),I=m.useMemo(()=>C(d,n),[n]),g=D({defaultValues:I}),v=Y("navn",s,g.trigger),c=g.watch();return r.jsx(F,{formMethods:g,children:r.jsxs(z,{className:y.panel,children:[r.jsx(k,{size:"small",children:r.jsx(b,{id:"UtvalgskriterierForSakslisteForm.Utvalgskriterier"})}),r.jsx(h,{eightPx:!0}),r.jsxs(K,{gap:"4",children:[r.jsxs(j,{justify:"space-between",children:[r.jsx(w,{name:"navn",label:d.formatMessage({id:"UtvalgskriterierForSakslisteForm.Navn"}),validate:[P,G,H,_],onChange:v,className:y.bredde}),r.jsxs("div",{className:y.grayBox,children:[r.jsx(A,{size:"small",children:r.jsx(b,{id:"UtvalgskriterierForSakslisteForm.AntallSaker"})}),r.jsx(k,{size:"small",children:u?`${u}`:"0"})]})]}),r.jsxs(j,{justify:"space-between",children:[r.jsxs("div",{children:[r.jsx(V,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e,hentAvdelingensSakslister:t,hentAntallOppgaver:i}),r.jsx(E,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e,hentAvdelingensSakslister:t,hentAntallOppgaver:i})]}),r.jsx("div",{children:r.jsx(N,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e,values:c,hentAvdelingensSakslister:t,hentAntallOppgaver:i})}),r.jsx("div",{children:r.jsx(U,{valgtSakslisteId:n.sakslisteId,valgteBehandlingtyper:n.behandlingTyper,valgtAvdelingEnhet:e,erDynamiskPeriode:!!c.erDynamiskPeriode,hentAvdelingensSakslister:t,hentAntallOppgaver:i})})]})]}),r.jsx(h,{sixteenPx:!0})]})})};$.__docgenInfo={description:"UtvalgskriterierForSakslisteForm",methods:[],displayName:"UtvalgskriterierForSakslisteForm",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn?: string;
