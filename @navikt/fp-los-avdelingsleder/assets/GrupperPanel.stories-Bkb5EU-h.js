import{r as c,R as h}from"./index-BBkUAzwr.js";import{g as v,m}from"./nb_NO-ammWO68Y.js";import{R as I}from"./useRestApiRunner-BbKnLk0z.js";import{G as b}from"./GrupperPanel-Xxl6ovPw.js";import"./index-BfZ0jBbx.js";import"./dayjs.min-DXWWvErk.js";import"./index.es-Ddaq4f5b.js";import"./useDebounce-C319ZWDY.js";import"./Table-d_r6JuEn.js";const S=v(m),A=[{brukerIdent:"ident1",navn:"Anders Utvikler",avdelingsnavn:["NAV Oslo"]},{brukerIdent:"ident12",navn:"Espen Utvikler",avdelingsnavn:["NAV Oslo"]},{brukerIdent:"ident4",navn:"Olga Utvikler",avdelingsnavn:["NAV Oslo"]},{brukerIdent:"ident3",navn:"Klara Utvikler",avdelingsnavn:["NAV Oslo"]}],N=[{avdelingsnavn:["NAV Oslo"],brukerIdent:"ident1",navn:"Anders Utvikler"}],O={saksbehandlerGrupper:[{gruppeId:1,gruppeNavn:"Dette er navnet på en gruppe",saksbehandlere:N}]},f=(n,e,p)=>p?n.concat({avdelingsnavn:["Navn på avdeling"],brukerIdent:e,navn:"Placholder for navn i story"}):n.filter(u=>u.saksbehandlerDto.brukerIdent!==e),V=n=>n.reduce((e,p)=>p.gruppeId>e?p.gruppeId:e,0)+1,x={title:"los/avdelingsleder/grupper/GrupperPanel",component:b,decorators:[S]},T=()=>{const[n,e]=c.useState(O),p=()=>{e(r=>({saksbehandlerGrupper:r.saksbehandlerGrupper.concat({gruppeId:V(r.saksbehandlerGrupper),saksbehandlere:[]})}))},u=r=>{e(a=>({saksbehandlerGrupper:a.saksbehandlerGrupper.filter(t=>t.gruppeId!==r)}))},k=(r,a)=>{e(t=>({saksbehandlerGrupper:t.saksbehandlerGrupper.map(s=>s.gruppeId===r?{...s,gruppeNavn:a}:s)}))},i=(r,a,t)=>{e(s=>({saksbehandlerGrupper:s.saksbehandlerGrupper.map(l=>l.gruppeId===a?{...l,saksbehandlere:f(l.saksbehandlere,r,t)}:l)}))};return h.createElement(b,{grupper:n,avdelingensSaksbehandlere:A,opprettOgHentAlleGrupper:p,opprettNyGruppeState:I.NOT_STARTED,lagreValgtSaksbehandlar:i,endreGruppenavn:k,slettGruppe:u})},d=T.bind({});var o,g,G;d.parameters={...d.parameters,docs:{...(o=d.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
...
}`,...(G=(g=d.parameters)==null?void 0:g.docs)==null?void 0:G.source}}};const K=["Default"];export{d as Default,K as __namedExportsOrder,x as default};
