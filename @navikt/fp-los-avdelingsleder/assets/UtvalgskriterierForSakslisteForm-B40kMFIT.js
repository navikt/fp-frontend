import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{u as f,K as k,G as h}from"./index.es-3pYYvk_t.js";import{u as T,d as j,H as g,M as y,e as x}from"./nb_NO-BrHkmhfT.js";import{e as D,a as I,o as v,D as K}from"./index.es-nYXWDHCj.js";import{u as q}from"./useQuery-Clc1ZO_i.js";import{u as F}from"./useMutation-CwXaW8Rz.js";import{o as w,V as p,c,d as V,L as A}from"./fplosAvdelingslederApi-BnUjCvtO.js";import{A as B}from"./AndreKriterierVelger-D2NF2hd6.js";import{B as U}from"./BehandlingstypeVelger-DRudbqMN.js";import{F as N}from"./FagsakYtelseTypeVelger-CiZ6Pgih.js";import{S as P}from"./SorteringVelger-CZFlzwUV.js";import{u as R}from"./useDebounce-Cepu0gcl.js";import{B as b}from"./Box-DcFiniIA.js";import"./index-Dxs5m6lS.js";const _="_bredde_grd8c_1",L={bredde:_},M=I(3),Y=v(100),z=(n,e)=>{var a,m;const u=e.behandlingTyper?e.behandlingTyper.reduce((i,s)=>({...i,[s]:!0}),{}):{},o=e.fagsakYtelseTyper?e.fagsakYtelseTyper.reduce((i,s)=>({...i,[s]:!0}),{}):{},d=e.andreKriterier?e.andreKriterier.reduce((i,s)=>({...i,[s.andreKriterierType]:!0}),{}):{},l=e.andreKriterier?e.andreKriterier.reduce((i,s)=>({...i,[`${s.andreKriterierType}_inkluder`]:s.inkluder}),{}):{};return{sakslisteId:e.sakslisteId,navn:e.navn?e.navn:n.formatMessage({id:"UtvalgskriterierForSakslisteForm.NyListe"}),sortering:e.sortering?e.sortering.sorteringType:void 0,fomDato:e.sortering?e.sortering.fomDato:void 0,tomDato:e.sortering?e.sortering.tomDato:void 0,fra:e.sortering?(a=e.sortering.fra)==null?void 0:a.toString():void 0,til:e.sortering?(m=e.sortering.til)==null?void 0:m.toString():void 0,erDynamiskPeriode:e.sortering?e.sortering.erDynamiskPeriode:void 0,...d,...l,...u,...o}},C=({valgtSaksliste:n,valgtAvdelingEnhet:e})=>{const u=T(),o=j(),{data:d}=q(w(n.sakslisteId,e)),{mutate:l}=F({mutationFn:t=>V(t.sakslisteId,t.navn,t.avdelingEnhet),onSuccess:()=>{u.invalidateQueries({queryKey:[A.SAKSLISTER_FOR_AVDELING]})}}),a=f({defaultValues:z(o,n)}),m=a.watch(),s=R("navn",t=>{l({sakslisteId:n.sakslisteId,navn:t,avdelingEnhet:e})},a.trigger);return r.jsx(k,{formMethods:a,children:r.jsx(b,{padding:"5",borderColor:"border-divider",borderRadius:"0",borderWidth:"1",children:r.jsxs(p,{gap:"2",children:[r.jsx(g,{size:"small",children:r.jsx(y,{id:"UtvalgskriterierForSakslisteForm.Utvalgskriterier"})}),r.jsxs(p,{gap:"4",children:[r.jsxs(c,{justify:"space-between",children:[r.jsx(h,{name:"navn",label:o.formatMessage({id:"UtvalgskriterierForSakslisteForm.Navn"}),validate:[D,M,Y,K],onChange:s,className:L.bredde}),r.jsxs(b,{padding:"2",background:"bg-subtle",children:[r.jsx(x,{size:"small",children:r.jsx(y,{id:"UtvalgskriterierForSakslisteForm.AntallSaker"})}),r.jsx(g,{size:"small",children:d?`${d}`:"0"})]})]}),r.jsxs(c,{justify:"space-between",children:[r.jsxs("div",{children:[r.jsx(N,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e}),r.jsx(U,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})]}),r.jsx("div",{children:r.jsx(B,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})}),r.jsx("div",{children:r.jsx(P,{valgtSakslisteId:n.sakslisteId,valgteBehandlingtyper:n.behandlingTyper,valgtAvdelingEnhet:e,erDynamiskPeriode:!!m.erDynamiskPeriode})})]})]})]})})})};C.__docgenInfo={description:"",methods:[],displayName:"UtvalgskriterierForSakslisteForm",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn?: string;
