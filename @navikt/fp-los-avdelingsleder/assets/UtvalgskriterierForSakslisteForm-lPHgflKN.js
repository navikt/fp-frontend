import{i as g,g as y,j as r}from"./iframe-C40YJXcE.js";import{a as p,N as c,A as f}from"./index.es-DRYD0Am0.js";import{t as b,a as k,o as T,D as h}from"./index.es-DsnyeLDn.js";import{u as D}from"./useMutation-DvF0BgKi.js";import{V as u,H as I,j,L as v}from"./fplosAvdelingslederApi-CjK3nr-s.js";import{A as x}from"./AndreKriterierVelger-jqc3pCGl.js";import{B as K}from"./BehandlingstypeVelger-Dr_obgYg.js";import{F as q}from"./FagsakYtelseTypeVelger-Btx1LsZ-.js";import{S as F}from"./SorteringVelger-DpkmDo3v.js";import{u as w}from"./useDebounce-DTOEZuRm.js";import{B as N}from"./Box-BuLishK7.js";import{H as V,M as A}from"./nb_NO-DgDSjHBI.js";const P="_bredde_grd8c_1",R={bredde:P},U=k(3),_=T(100),L=(n,e)=>{const d=e.behandlingTyper?e.behandlingTyper.reduce((i,s)=>({...i,[s]:!0}),{}):{},o=e.fagsakYtelseTyper?e.fagsakYtelseTyper.reduce((i,s)=>({...i,[s]:!0}),{}):{},m=e.andreKriterier?e.andreKriterier.reduce((i,s)=>({...i,[s.andreKriterierType]:!0}),{}):{},a=e.andreKriterier?e.andreKriterier.reduce((i,s)=>({...i,[`${s.andreKriterierType}_inkluder`]:s.inkluder}),{}):{};return{sakslisteId:e.sakslisteId,navn:e.navn??n.formatMessage({id:"UtvalgskriterierForSakslisteForm.NyListe"}),sortering:e.sortering?e.sortering.sorteringType:void 0,fomDato:e.sortering?e.sortering.fomDato:void 0,tomDato:e.sortering?e.sortering.tomDato:void 0,fra:e.sortering?e.sortering.fra?.toString():void 0,til:e.sortering?e.sortering.til?.toString():void 0,erDynamiskPeriode:e.sortering?e.sortering.erDynamiskPeriode:void 0,...m,...a,...d,...o}},M=({valgtSaksliste:n,valgtAvdelingEnhet:e})=>{const d=g(),o=y(),{mutate:m}=D({mutationFn:t=>j(t.sakslisteId,t.navn,t.avdelingEnhet),onSuccess:()=>{d.invalidateQueries({queryKey:[v.SAKSLISTER_FOR_AVDELING]})}}),a=p({defaultValues:L(o,n)}),i=a.watch(),l=w("navn",t=>{m({sakslisteId:n.sakslisteId,navn:t,avdelingEnhet:e})},a.trigger);return r.jsx(c,{formMethods:a,children:r.jsx(N.New,{padding:"5",borderColor:"neutral-subtle",borderRadius:"0",borderWidth:"1",children:r.jsxs(u,{gap:"space-8",children:[r.jsx(V,{size:"small",level:"2",children:r.jsx(A,{id:"UtvalgskriterierForSakslisteForm.Utvalgskriterier"})}),r.jsxs(u,{gap:"space-16",children:[r.jsx(f,{name:"navn",control:a.control,label:o.formatMessage({id:"UtvalgskriterierForSakslisteForm.Navn"}),validate:[b,U,_,h],onChange:t=>l(t),className:R.bredde}),r.jsxs(I,{justify:"space-between",children:[r.jsxs("div",{children:[r.jsx(q,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e}),r.jsx(K,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})]}),r.jsx("div",{children:r.jsx(x,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})}),r.jsx("div",{children:r.jsx(F,{valgtSakslisteId:n.sakslisteId,valgteBehandlingtyper:n.behandlingTyper,valgtAvdelingEnhet:e,erDynamiskPeriode:!!i.erDynamiskPeriode})})]})]})]})})})};M.__docgenInfo={description:"",methods:[],displayName:"UtvalgskriterierForSakslisteForm",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn?: string;
