import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as o,H as d,M as n}from"./nb_NO-DldPmdYP.js";import{M as r,B as i}from"./Modal-DGrvUioF.js";const m="_submitButton_cko9v_1",g="_cancelButton_cko9v_6",s={submitButton:m,cancelButton:g},y=({valgtSaksliste:a,cancel:t,submit:l})=>{const u=o();return e.jsxs(r,{width:"small",open:!0,"aria-label":u.formatMessage({id:"SletteSakslisteModal.SletteModal"}),onClose:t,children:[e.jsx(r.Header,{children:e.jsx(d,{size:"small",children:e.jsx(n,{id:"SletteSakslisteModal.SletteSaksliste",values:{sakslisteNavn:a.navn}})})}),e.jsxs(r.Footer,{children:[e.jsx(i,{className:s.submitButton,size:"small",variant:"primary",onClick:()=>l(a),autoFocus:!0,type:"button",children:e.jsx(n,{id:"SletteSakslisteModal.Ja"})}),e.jsx(i,{className:s.cancelButton,size:"small",variant:"secondary",onClick:t,type:"button",children:e.jsx(n,{id:"SletteSakslisteModal.Nei"})})]})]})};y.__docgenInfo={description:`SletteSakslisteModal
