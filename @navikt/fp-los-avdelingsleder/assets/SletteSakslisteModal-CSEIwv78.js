import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{b as d,H as m,M as n}from"./nb_NO-CujjC0QR.js";import{M as r,B as i}from"./Modal-BAeoMgKv.js";const g="_submitButton_cko9v_1",y="_cancelButton_cko9v_6",s={submitButton:g,cancelButton:y},l=({valgtSaksliste:a,cancel:t,submit:u})=>{const o=d();return e.jsxs(r,{width:"small",open:!0,"aria-label":o.formatMessage({id:"SletteSakslisteModal.SletteModal"}),onClose:t,children:[e.jsx(r.Header,{children:e.jsx(m,{size:"small",children:e.jsx(n,{id:"SletteSakslisteModal.SletteSaksliste",values:{sakslisteNavn:a.navn}})})}),e.jsxs(r.Footer,{children:[e.jsx(i,{className:s.submitButton,size:"small",variant:"primary",onClick:()=>u(a),autoFocus:!0,type:"button",children:e.jsx(n,{id:"SletteSakslisteModal.Ja"})}),e.jsx(i,{className:s.cancelButton,size:"small",variant:"secondary",onClick:t,type:"button",children:e.jsx(n,{id:"SletteSakslisteModal.Nei"})})]})]})};l.__docgenInfo={description:`SletteSakslisteModal
...
Modal som lar en avdelingsleder fjerne sakslister.`,methods:[],displayName:"SletteSakslisteModal",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  saksbehandlerIdenter: string[];
  antallBehandlinger: number;
}>`},name:"saksliste"}],return:{name:"void"}}},description:""}}};l.__docgenInfo={description:`SletteSakslisteModal
...
Modal som lar en avdelingsleder fjerne sakslister.`,methods:[],displayName:"SletteSakslisteModal",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  saksbehandlerIdenter: string[];
  antallBehandlinger: number;
}>`},name:"saksliste"}],return:{name:"void"}}},description:""}}};export{l as S};
