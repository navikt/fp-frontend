 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Oo;function hh(){if(Oo)return Hr;Oo=1;var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.fragment");function t(r,s,a){var i=null;if(a!==void 0&&(i=""+a),s.key!==void 0&&(i=""+s.key),"key"in s){a={};for(var o in s)o!=="key"&&(a[o]=s[o])}else a=s;return s=a.ref,{$$typeof:e,type:r,key:i,ref:s!==void 0?s:null,props:a}}return Hr.Fragment=n,Hr.jsx=t,Hr.jsxs=t,Hr}var To;function Ih(){return To||(To=1,Eo.exports=hh()),Eo.exports}var ge=Ih();const It=e=>e.reduce((n,t,r)=>({...n,[r]:s=>t(s)||!0}),{}),wt=(e,n)=>n.split(".").reduce((t,r)=>t!==void 0?t[r]:t,e)?.message;var ha={exports:{}},wh=ha.exports,No;function Ah(){return No||(No=1,function(e,n){(function(t,r){e.exports=r()})(wh,function(){var t={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},r=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,s=/\d/,a=/\d\d/,i=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,l={},u=function(v){return(v=+v)+(v>68?1900:2e3)},d=function(v){return function(w){this[v]=+w}},g=[/[+-]\d\d:?(\d\d)?|Z/,function(v){(this.zone||(this.zone={})).offset=function(w){if(!w||w==="Z")return 0;var h=w.match(/([+-]|\d\d)/g),b=60*h[1]+(+h[2]||0);return b===0?0:h[0]==="+"?-b:b}(v)}],c=function(v){var w=l[v];return w&&(w.indexOf?w:w.s.concat(w.f))},f=function(v,w){var h,b=l.meridiem;if(b){for(var j=1;j<=24;j+=1)if(v.indexOf(b(j,0,w))>-1){h=j>12;break}}else h=v===(w?"pm":"PM");return h},y={A:[o,function(v){this.afternoon=f(v,!1)}],a:[o,function(v){this.afternoon=f(v,!0)}],Q:[s,function(v){this.month=3*(v-1)+1}],S:[s,function(v){this.milliseconds=100*+v}],SS:[a,function(v){this.milliseconds=10*+v}],SSS:[/\d{3}/,function(v){this.milliseconds=+v}],s:[i,d("seconds")],ss:[i,d("seconds")],m:[i,d("minutes")],mm:[i,d("minutes")],H:[i,d("hours")],h:[i,d("hours")],HH:[i,d("hours")],hh:[i,d("hours")],D:[i,d("day")],DD:[a,d("day")],Do:[o,function(v){var w=l.ordinal,h=v.match(/\d+/);if(this.day=h[0],w)for(var b=1;b<=31;b+=1)w(b).replace(/\[|\]/g,"")===v&&(this.day=b)}],w:[i,d("week")],ww:[a,d("week")],M:[i,d("month")],MM:[a,d("month")],MMM:[o,function(v){var w=c("months"),h=(c("monthsShort")||w.map(function(b){return b.slice(0,3)})).indexOf(v)+1;if(h<1)throw new Error;this.month=h%12||h}],MMMM:[o,function(v){var w=c("months").indexOf(v)+1;if(w<1)throw new Error;this.month=w%12||w}],Y:[/[+-]?\d+/,d("year")],YY:[a,function(v){this.year=u(v)}],YYYY:[/\d{4}/,d("year")],Z:g,ZZ:g};function I(v){var w,h;w=v,h=l&&l.formats;for(var b=(v=w.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(F,L,_){var O=_&&_.toUpperCase();return L||h[_]||t[_]||h[O].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(P,D,B){return D||B.slice(1)})})).match(r),j=b.length,A=0;A<j;A+=1){var T=b[A],N=y[T],x=N&&N[0],q=N&&N[1];b[A]=q?{regex:x,parser:q}:T.replace(/^\[|\]$/g,"")}return function(F){for(var L={},_=0,O=0;_<j;_+=1){var P=b[_];if(typeof P=="string")O+=P.length;else{var D=P.regex,B=P.parser,C=F.slice(O),V=D.exec(C)[0];B.call(L,V),F=F.replace(V,"")}}return function(S){var H=S.afternoon;if(H!==void 0){var J=S.hours;H?J<12&&(S.hours+=12):J===12&&(S.hours=0),delete S.afternoon}}(L),L}}return function(v,w,h){h.p.customParseFormat=!0,v&&v.parseTwoDigitYear&&(u=v.parseTwoDigitYear);var b=w.prototype,j=b.parse;b.parse=function(A){var T=A.date,N=A.utc,x=A.args;this.$u=N;var q=x[1];if(typeof q=="string"){var F=x[2]===!0,L=x[3]===!0,_=F||L,O=x[2];L&&(O=x[2]),l=this.$locale(),!F&&O&&(l=h.Ls[O]),this.$d=function(C,V,S,H){try{if(["x","X"].indexOf(V)>-1)return new Date((V==="X"?1e3:1)*C);var J=I(V)(C),z=J.year,se=J.month,xe=J.day,Z=J.hours,U=J.minutes,re=J.seconds,te=J.milliseconds,ue=J.zone,Le=J.week,Be=new Date,Ce=xe||(z||se?1:Be.getDate()),qn=z||Be.getFullYear(),on=0;z&&!se||(on=se>0?se-1:Be.getMonth());var fn,Zn=Z||0,er=U||0,fr=re||0,Hn=te||0;return ue?new Date(Date.UTC(qn,on,Ce,Zn,er,fr,Hn+60*ue.offset*1e3)):S?new Date(Date.UTC(qn,on,Ce,Zn,er,fr,Hn)):(fn=new Date(qn,on,Ce,Zn,er,fr,Hn),Le&&(fn=H(fn).week(Le).toDate()),fn)}catch{return new Date("")}}(T,q,N,h),this.init(),O&&O!==!0&&(this.$L=this.locale(O).$L),_&&T!=this.format(q)&&(this.$d=new Date("")),l={}}else if(q instanceof Array)for(var P=q.length,D=1;D<=P;D+=1){x[1]=q[D-1];var B=h.apply(this,x);if(B.isValid()){this.$d=B.$d,this.$L=B.$L,this.init();break}D===P&&(this.$d=new Date(""))}else j.call(this,A)}}})}(ha)),ha.exports}var jh=Ah();const Eh=bh(jh),Oh="_textarea_14c7r_1",Th="_readOnlyField_14c7r_7",Ro={textarea:Oh,readOnlyField:Th},Nh=e=>e!=null&&e!=="",Ss=({label:e,value:n,isEdited:t=!1,type:r,hideLabel:s,size:a})=>Nh(n)?ge.jsxs(Me,{gap:"space-4",children:[e&&!s&&ge.jsx(we,{size:a,children:e}),ge.jsxs(ye,{gap:"space-8",align:"center",wrap:!1,children:[ge.jsx(Ho,{className:r==="textarea"?Ro.textarea:Ro.readOnlyField,size:a,children:n}),t&&ge.jsx(Cd,{})]})]}):null;We.extend(Eh);const tt=({label:e,description:n,validate:t=[],hideLabel:r=!1,isReadOnly:s=!1,onChange:a,disabledDays:i,isEdited:o,defaultMonth:l,fromDate:u,toDate:d,size:g="small",...c})=>{const{name:f,control:y,disabled:I}=c,{formState:{errors:v}}=Qn(),{field:w}=bt({name:f,control:y,rules:{validate:m.useMemo(()=>It(t),[t])}}),h=w.value?We(w.value,Mn,!0).format(jt):"",[b,j]=m.useState(h),{datepickerProps:A,inputProps:T}=Cy({onDateChange:q=>{if(q!==void 0){const F=We(q).format(Mn);a&&a(F),w.onChange(F),j(We(F,Mn,!0).format(jt))}},defaultSelected:w.value?We(w.value,Mn,!0).toDate():void 0,defaultMonth:l||(!w.value&&d?d:void 0),disabled:i}),N=m.useCallback(q=>{const F=We(q.target.value,jt,!0).format(Mn),L=F!=="Invalid Date";j(q.target.value),a&&a(L?F:q.target.value),w.onChange(L?F:q.target.value)},[j,a,w]);if(s)return ge.jsx(Ss,{label:e,value:w.value?We(w.value,Mn,!0).format(jt):void 0,isEdited:o,hideLabel:r,size:g});const x={...A,fromDate:u,toDate:d,dropdownCaption:u&&d?!0:void 0};return ge.jsx(cs,{...x,children:ge.jsx(cs.Input,{...T,hideLabel:r,onChange:N,value:b,size:g,label:e,description:n,disabled:I,error:wt(v,f)})})},Ia=({name:e,control:n,label:t,validate:r=[],readOnly:s=!1,type:a,shouldValidateOnBlur:i=!1,onBlur:o,onChange:l,description:u,autoFocus:d,parse:g=A=>A,format:c=A=>A,normalizeOnBlur:f,isEdited:y,maxLength:I,autoComplete:v=!1,disabled:w,className:h,hideLabel:b,...j})=>{const{formState:{errors:A},trigger:T}=Qn(),{field:N}=bt({name:e,control:n,rules:{validate:m.useMemo(()=>It(r),[r])}});return s?ge.jsx(Ss,{label:t,value:N.value,isEdited:y,hideLabel:b,size:j.size}):ge.jsx(Pb,{size:"small",hideLabel:b,description:u,label:t,error:wt(A,e),...N,value:N.value?c(N.value):"",autoFocus:d,autoComplete:v?void 0:"off",maxLength:I,disabled:w,type:a,className:h,onChange:x=>{const q=x.currentTarget.value?g(x.currentTarget.value):null;return l&&l(q),N.onChange(q)},onBlur:async x=>{if(N.onBlur(),i){const q=await T();o&&q&&o(x?.target?.value)}else o&&o(x?.target?.value);f&&N.onChange(x?.target?.value?f(g(x?.target?.value)):null)},...j})},Kd=({label:e,description:n,validate:t=[],radios:r,onChange:s,isReadOnly:a=!1,isHorizontal:i=!1,parse:o=f=>f,isTrueOrFalseSelection:l=!1,hideLegend:u=!1,isEdited:d=!1,size:g="small",...c})=>{const{name:f,control:y,disabled:I}=c,{formState:{errors:v}}=Qn(),{field:w}=bt({name:f,control:y,rules:{validate:m.useMemo(()=>It(t),[t])}}),h=l?j=>j==="true":o,b=ge.jsxs(ye,{justify:"center",gap:"space-8",children:[e,a&&d&&ge.jsx(Cd,{})]});return ge.jsxs(Ib,{name:f,value:w.value!==void 0?w.value:null,onChange:j=>{s&&s(j),w.onChange(j)},size:g,legend:b,description:n,error:wt(v,f),hideLegend:u,children:[!i&&r.map(j=>ge.jsxs(m.Fragment,{children:[ge.jsx(Zi,{size:g,value:h(j.value),disabled:j.disabled||I||a,children:j.label}),w.value===h(j.value)&&j.element]},j.value)),i&&ge.jsxs(ge.Fragment,{children:[ge.jsx(ye,{gap:"space-16",children:r.map(j=>ge.jsx(Zi,{size:g,value:h(j.value),disabled:j.disabled||I||a,children:j.label},j.value))}),r.filter(j=>w.value===h(j.value)).map(j=>ge.jsx(m.Fragment,{children:j.element},j.value))]})]})},Rh=({label:e,selectValues:n,validate:t=[],readOnly:r=!1,description:s,hideValueOnDisable:a=!1,onChange:i,className:o,hideLabel:l,isEdited:u,size:d,...g})=>{const{name:c,control:f,disabled:y}=g,{formState:{errors:I}}=Qn(),{field:v}=bt({name:c,control:f,rules:{validate:m.useMemo(()=>It(t),[t])}});if(r){const b=n.map(A=>A.props).find(A=>A.value===v.value),j=b?b.children:void 0;return ge.jsx(Ss,{value:j,label:e,hideLabel:l,isEdited:u,size:d})}const w=v.value||"",h=!n.map(b=>b.props.value).includes(w)&&w!=="";return h&&console.warn(`No corresponding option found for value '${w}'`),ge.jsxs(pa,{size:"small",className:o,error:wt(I,c),label:e,description:s,value:a&&y||h?"":v.value,disabled:y,onChange:b=>{i&&i(b),v.onChange(b)},hideLabel:l,children:[ge.jsx("option",{style:{display:"none"}}),",",n]})},Ph="_textAreaFieldWithBadges_bdz0b_1",qh="_etikettWrapper_bdz0b_4",Po={textAreaFieldWithBadges:Ph,etikettWrapper:qh},si=({name:e,control:n,label:t,readOnly:r,maxLength:s,badges:a,validate:i=[],parse:o=f=>f,className:l,description:u,isEdited:d,size:g="small",...c})=>{const{formState:{errors:f}}=Qn(),{field:y}=bt({name:e,control:n,rules:{validate:m.useMemo(()=>It(i),[i])}});return r?ge.jsx(Ss,{size:g,label:t,value:y.value,type:"textarea",isEdited:d,hideLabel:c.hideLabel}):ge.jsxs("div",{className:a?Po.textAreaFieldWithBadges:null,children:[a&&ge.jsx("div",{className:Po.etikettWrapper,children:a.map(({type:I,titleText:v})=>ge.jsx(fb,{variant:I,size:"small",children:v},v))}),ge.jsx(Nb,{size:g,label:t,description:u,className:l,autoComplete:"off",...y,onChange:I=>y.onChange(I.currentTarget.value!==""?o(I.currentTarget.value):null),value:y.value?y.value:"",error:wt(f,e),maxLength:s,...c})]})},xs=({formMethods:e,onSubmit:n,children:t,className:r,setDataOnUnmount:s})=>{const{handleSubmit:a,getValues:i}=e;return m.useEffect(()=>()=>{s&&s(i())},[]),ge.jsx(Mb,{...e,children:ge.jsx("form",{className:r,onSubmit:n?a(o=>n(o)):void 0,children:t})})},Gd=({submitCallback:e,cancelEvent:n,showModal:t,ventearsaker:r,erTilbakekreving:s,frist:a,ventearsak:i,visBrevErBestilt:o=!1,hasManualPaVent:l,defaultVenteårsak:u=null})=>{const d=Xn(),g=Ds({defaultValues:Mh(l,a,i??u)}),c=g.watch("frist"),f=g.watch("ventearsak"),y=Vh(i,f),I=Lh(a,c),v=!(a===c&&!y),w=Fh(s,a,c,f);return k.jsx(xs,{formMethods:g,onSubmit:e,children:k.jsxs(yn,{width:"small",open:t,onClose:n,"aria-label":d.formatMessage({id:i?"SettPaVentModal.ErSettPaVent":"SettPaVentModal.SettesPaVent"}),children:[k.jsx(yn.Header,{children:k.jsx(lt,{size:"small",level:"2",children:k.jsx(W,{id:i?"SettPaVentModal.ErSettPaVent":"SettPaVentModal.SettesPaVent"})})}),k.jsx(yn.Body,{children:k.jsxs(Me,{gap:"space-16",children:[(l||c)&&k.jsx(tt,{name:"frist",control:g.control,label:k.jsx(W,{id:"SettPaVentModal.Frist"}),validate:[un,Zr,iu]}),k.jsx(Rh,{name:"ventearsak",control:g.control,label:k.jsx(W,{id:"SettPaVentModal.Arsak"}),validate:[un],selectValues:r.filter(h=>!l||(s?xh(h,f):Dh.some(b=>b===h.kode))).sort((h,b)=>h.navn.localeCompare(b.navn)).map(h=>k.jsx("option",{value:h.kode,children:h.navn},h.kode)),readOnly:!l}),o&&k.jsx(ne,{size:"small",children:k.jsx(W,{id:"SettPaVentModal.BrevBlirBestilt"})}),l&&k.jsx(ne,{size:"small",children:k.jsx(W,{id:"SettPaVentModal.EndreFrist"})}),!l&&w&&k.jsxs(k.Fragment,{children:[k.jsx(ne,{size:"small",children:k.jsx(W,{id:"SettPaVentModal.UtløptFrist"})}),k.jsx(ne,{size:"small",children:k.jsx(W,{id:"SettPaVentModal.HenleggeSaken"})})]})]})}),k.jsxs(yn.Footer,{children:[k.jsx(Ne,{size:"small",variant:"primary",style:{paddingInline:"36px"},onClick:v?ou:n,disabled:!y&&!I,children:k.jsx(W,{id:"SettPaVentModal.Ok"})}),(!l||v||!o)&&k.jsx(Ne,{size:"small",variant:"secondary",onClick:n,type:"button",children:k.jsx(W,{id:y||I?"SettPaVentModal.Avbryt":"SettPaVentModal.Lukk"})})]})]})})},_h=()=>{const e=We().toDate();return e.setDate(e.getDate()+28),We(e).format(Mn)},Mh=(e,n,t)=>({ventearsak:t??void 0,frist:n||e===!1?n??void 0:_h()}),Dh=[Ye.AVV_DOK,Ye.AVV_FODSEL,Ye.VENT_PÅ_BRUKERTILBAKEMELDING,Ye.UTV_FRIST,Ye.FOR_TIDLIG_SOKNAD,Ye.VENT_OPDT_INNTEKTSMELDING,Ye.VENT_UTLAND_TRYGD,Ye.UTVIDET_TILSVAR_FRIST,Ye.ENDRE_TILKJENT_YTELSE,Ye.VENT_PÅ_MULIG_MOTREGNING],Sh=[Ye.VENT_PÅ_BRUKERTILBAKEMELDING,Ye.VENT_PÅ_TILBAKEKREVINGSGRUNNLAG],xh=(e,n)=>Sh.some(t=>t===e.kode)?e.kode===n:!0,Fh=(e,n,t,r)=>{const s=e&&(!!t&&gi(t)===null||!!n&&gi(n)===null),a=r===Ye.VENT_PÅ_TILBAKEKREVINGSGRUNNLAG;return e&&s&&a},Vh=(e,n)=>!(e===n||!n&&!e),Lh=(e,n)=>!(e===n||!n&&!e);Gd.__docgenInfo={description:"",methods:[],displayName:"SettPaVentModal",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(formData: FormValues) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  frist?: string;
  ventearsak?: string;
...
| {
  ...
  arbeidsgiverIdent: string;
  arbeidsgiverNavn: string;
}`,signature:{properties:[{key:"erPrivatPerson",value:{name:"literal",value:"false",required:!0}},{key:"arbeidsgiverIdent",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}}]}}]}]},description:""}}};const u0="_bredde_gb3eb_1",g0="_inline_gb3eb_9",m0="_arrow_gb3eb_13",qt={bredde:u0,inline:g0,arrow:m0},wa=({saksnummer:e,skjæringstidspunkt:n,alleKodeverk:t,radData:r})=>{const[s,a]=m.useState(!1),{inntektsposter:i,arbeidsforholdForRad:o}=r,l=c0(n,i),u=o.length===1,d=i.length>0&&i.some(g=>g.beløp>0);return k.jsxs(Me,{gap:"space-32",children:[k.jsx(oi,{saksnummer:e,alleKodeverk:t,radData:r}),d&&k.jsxs(Me,{gap:"space-8",children:[k.jsx(we,{size:"small",children:k.jsx(W,{id:u?"ArbeidsforholdInformasjonPanel.Inntekter":"ArbeidsforholdInformasjonPanel.TotaltInntekter"})}),k.jsx(Me,{gap:"space-4",children:l.filter((g,c)=>s?!0:c<3).map(g=>k.jsxs(ye,{gap:"space-8",className:qt.bredde,children:[k.jsx(ne,{size:"small",children:k.jsx(W,{id:`ArbeidsforholdInformasjonPanel.${We(g.fom).month()+1}`})}),k.jsx(ne,{size:"small",children:We(g.fom).year()}),k.jsx(Er,{}),k.jsx(ne,{size:"small",children:k.jsx(ba,{beløp:g.beløp})})]},g.fom))}),k.jsxs(za,{onClick:g=>{g.preventDefault(),a(!s)},href:"",children:[k.jsx("span",{children:k.jsx(ne,{size:"small",className:qt.inline,children:k.jsx(W,{id:s?"ArbeidsforholdInformasjonPanel.FaerreManeder":"ArbeidsforholdInformasjonPanel.TidligereManeder"})})}),s?k.jsx($o,{className:qt.arrow}):k.jsx(Is,{className:qt.arrow})]})]}),!d&&k.jsx(we,{size:"small",children:k.jsx(W,{id:"ArbeidsforholdInformasjonPanel.IngenInntekt"})})]})},c0=(e,n)=>{const r=We(e).subtract(1,"month").startOf("month"),s=r.subtract(12,"month"),a=[];for(let i=r;i.isAfter(s);i=i.subtract(1,"month")){const o=i.format(Mn),l=n.find(u=>We(u.fom).startOf("month").format(Mn)===o);a.push({beløp:l?.beløp||0,fom:o})}return a};wa.__docgenInfo={description:"",methods:[],displayName:"ArbeidsforholdInformasjonPanel",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},skjæringstidspunkt:{required:!0,tsType:{name:"string"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
...
| {
  ...
  arbeidsgiverIdent: string;
  arbeidsgiverNavn: string;
}`,signature:{properties:[{key:"erPrivatPerson",value:{name:"literal",value:"false",required:!0}},{key:"arbeidsgiverIdent",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}}]}}]}]},description:""}}};const f0="_hjelpetekst_6zosx_1",k0="_alertStripe_6zosx_5",p0="_hjelpetekstInnhold_6zosx_9",v0="_svg_6zosx_14",_t={hjelpetekst:f0,alertStripe:k0,hjelpetekstInnhold:p0,svg:v0},y0=ja(3),b0=Ea(1500),h0=Co(1),I0=Ko(100),$d=({behandlingUuid:e,behandlingVersjon:n,radData:t,isReadOnly:r,registrerArbeidsforhold:s,lagreVurdering:a,lukkArbeidsforholdRad:i,oppdaterTabell:o})=>{const l=Xn(),u={saksbehandlersVurdering:t.avklaring?.saksbehandlersVurdering,begrunnelse:t.avklaring?.begrunnelse,fom:t.avklaring?.fom,tom:t.avklaring?.tom,stillingsprosent:t.avklaring?.stillingsprosent},d=Ds({defaultValues:u});ii(d.formState.isDirty);const g=d.watch("saksbehandlersVurdering"),c=()=>{i(),d.reset(u)},f=t.inntektsmeldingerForRad[0],y=b=>{const j=A0(o,t,f,b);return b.saksbehandlersVurdering===me.OPPRETT_BASERT_PÅ_INNTEKTSMELDING?s({behandlingUuid:e,behandlingVersjon:n,internArbeidsforholdRef:f.internArbeidsforholdId,arbeidsgiverNavn:t.arbeidsgiverNavn,arbeidsgiverIdent:f.arbeidsgiverIdent,vurdering:me.OPPRETT_BASERT_PÅ_INNTEKTSMELDING,begrunnelse:b.begrunnelse,fom:b.fom,tom:b.tom,stillingsprosent:b.stillingsprosent}).then(j).finally(()=>d.reset(b)):a({behandlingUuid:e,behandlingVersjon:n,vurdering:b.saksbehandlersVurdering,begrunnelse:b.begrunnelse,arbeidsgiverIdent:f.arbeidsgiverIdent,internArbeidsforholdRef:f.internArbeidsforholdId}).then(j).finally(()=>d.reset(b))},I=m.useRef(null),[v,w]=m.useState(!1),h=()=>w(b=>!b);return k.jsxs(Me,{gap:"space-32",children:[k.jsx("div",{className:_t.alertStripe,children:k.jsx(ct,{variant:"info",children:k.jsx(W,{id:"ManglendeOpplysningerForm.ErMottattMenIkkeReg"})})}),k.jsx(xs,{formMethods:d,onSubmit:y,children:k.jsxs(Me,{gap:"space-16",children:[k.jsx(Kd,{name:"saksbehandlersVurdering",control:d.control,label:k.jsxs(ye,{gap:"space-8",children:[k.jsx(W,{id:"ManglendeOpplysningerForm.SkalBrukeInntekstmelding"}),k.jsx(zo,{className:_t.svg,ref:I,onClick:h,title:l.formatMessage({id:"ManglendeOpplysningerForm.AltHjelpetekst"})}),k.jsx(qr,{open:v,onClose:h,anchorEl:I.current,className:_t.hjelpetekst,children:k.jsx(qr.Content,{className:_t.hjelpetekstInnhold,children:k.jsx(ne,{children:k.jsx(W,{id:"ManglendeOpplysningerForm.Hjelpetekst"})})})})]}),validate:[un],isReadOnly:r,radios:[{label:l.formatMessage({id:"ManglendeOpplysningerForm.TarKontakt"}),value:me.KONTAKT_ARBEIDSGIVER_VED_MANGLENDE_ARBEIDSFORHOLD},{label:l.formatMessage({id:"ManglendeOpplysningerForm.GåVidere"}),value:me.IKKE_OPPRETT_BASERT_PÅ_INNTEKTSMELDING},{label:l.formatMessage({id:"ManglendeOpplysningerForm.OpprettArbeidsforhold"}),value:me.OPPRETT_BASERT_PÅ_INNTEKTSMELDING}]}),g===me.OPPRETT_BASERT_PÅ_INNTEKTSMELDING&&k.jsxs(ye,{gap:"space-16",children:[k.jsx(tt,{name:"fom",control:d.control,label:k.jsx(W,{id:"ManglendeOpplysningerForm.PeriodeFra"}),validate:[un,Zr],isReadOnly:r}),k.jsx(tt,{name:"tom",control:d.control,label:k.jsx(W,{id:"ManglendeOpplysningerForm.PeriodeTil"}),validate:[Zr,w0(d.getValues)],isReadOnly:r}),k.jsx(Ia,{name:"stillingsprosent",control:d.control,label:k.jsx(W,{id:"ManglendeOpplysningerForm.Stillingsprosent"}),parse:b=>{const j=parseInt(b.toString(),10);return Number.isNaN(j)?b:j},validate:[un,Bo,h0,I0],readOnly:r,maxLength:3})]}),k.jsx(si,{name:"begrunnelse",control:d.control,label:k.jsx(W,{id:"ManglendeOpplysningerForm.Begrunn"}),validate:[un,y0,b0,Oa],maxLength:1500,readOnly:r}),!r&&k.jsxs(ye,{gap:"space-16",children:[k.jsx(Ne,{size:"small",variant:"secondary",loading:d.formState.isSubmitting,disabled:!d.formState.isDirty||d.formState.isSubmitting,children:k.jsx(W,{id:"ManglendeOpplysningerForm.Lagre"})}),k.jsx(Ne,{size:"small",variant:"tertiary",loading:!1,disabled:d.formState.isSubmitting,onClick:c,type:"button",children:k.jsx(W,{id:"ManglendeOpplysningerForm.Avbryt"})})]})]})})]})},w0=e=>n=>{const t=e("fom");return t&&n?Go(t)(n):null},A0=(e,n,t,r)=>()=>{e(s=>s.map(a=>{if(t.arbeidsgiverIdent===a.arbeidsgiverIdent){const o=r.saksbehandlersVurdering===me.OPPRETT_BASERT_PÅ_INNTEKTSMELDING?{arbeidsgiverIdent:t.arbeidsgiverIdent,fom:r.fom,tom:r.tom,stillingsprosent:r.stillingsprosent,begrunnelse:r.begrunnelse,saksbehandlersVurdering:r.saksbehandlersVurdering}:{begrunnelse:r.begrunnelse,saksbehandlersVurdering:r.saksbehandlersVurdering};return{...n,avklaring:o}}return a}))};$d.__docgenInfo={description:"",methods:[],displayName:"ManglendeArbeidsforholdForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},behandlingVersjon:{required:!0,tsType:{name:"number"},description:""},radData:{required:!0,tsType:{name:"intersection",raw:`{
  inntektsmeldingerForRad: Inntektsmelding[];
  arbeidsforholdForRad: AoIArbeidsforhold[];
  inntektsposter: Inntektspost[];
  årsak?: string;
...
| {
  ...
  arbeidsgiverIdent: string;
  arbeidsgiverNavn: string;
}`,signature:{properties:[{key:"erPrivatPerson",value:{name:"literal",value:"false",required:!0}},{key:"arbeidsgiverIdent",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}}]}}]}]}],raw:"ArbeidsforholdOgInntektRadData[]"}}},name:"data"}],return:{name:"void"}}},description:""}}};const j0="_alertStripe_i1zil_1",E0="_hjelpetekst_i1zil_5",O0="_hjelpetekstInnhold_i1zil_9",T0="_svg_i1zil_14",Mt={alertStripe:j0,hjelpetekst:E0,hjelpetekstInnhold:O0,svg:T0},N0=ja(3),R0=Ea(1500),Wd=({behandlingUuid:e,behandlingVersjon:n,radData:t,isReadOnly:r,lagreVurdering:s,lukkArbeidsforholdRad:a,oppdaterTabell:i})=>{const o=Xn(),{arbeidsforholdForRad:l,inntektsmeldingerForRad:u}=t,d={saksbehandlersVurdering:t.avklaring?.saksbehandlersVurdering,begrunnelse:t.avklaring?.begrunnelse},g=Ds({defaultValues:d});ii(g.formState.isDirty);const c=l.length===1,f=()=>{a(),g.reset(d)},y=j=>{const A={behandlingUuid:e,behandlingVersjon:n,vurdering:j.saksbehandlersVurdering,arbeidsgiverIdent:t.arbeidsgiverIdent,internArbeidsforholdRef:c?l[0].internArbeidsforholdId:void 0,begrunnelse:j.begrunnelse};return s(A).then(P0(i,t,j)).finally(()=>g.reset(j))},I=m.useRef(null),[v,w]=m.useState(!1),h=()=>w(j=>!j),b=[{label:o.formatMessage({id:"InntektsmeldingInnhentesForm.TarKontakt"}),value:me.KONTAKT_ARBEIDSGIVER_VED_MANGLENDE_INNTEKTSMELDING},{label:o.formatMessage({id:"InntektsmeldingInnhentesForm.GåVidere"}),value:me.FORTSETT_UTEN_INNTEKTSMELDING}];return t.erPrivatPerson||b.splice(1,0,{label:o.formatMessage({id:"InntektsmeldingInnhentesForm.MeldingArbeidsgiverNavNo"}),value:me.MELDING_TIL_ARBEIDSGIVER_NAV_NO}),k.jsx(xs,{formMethods:g,onSubmit:y,children:k.jsxs(Me,{gap:"space-16",children:[!c&&u.length>0&&k.jsx("div",{className:Mt.alertStripe,children:k.jsx(ct,{variant:"info",children:k.jsx(W,{id:"InntektsmeldingInnhentesForm.InnehentAlle"})})}),k.jsx(Kd,{name:"saksbehandlersVurdering",control:g.control,label:k.jsxs(ye,{gap:"space-8",children:[k.jsx(W,{id:"InntektsmeldingInnhentesForm.MåInnhentes"}),k.jsx(zo,{ref:I,onClick:h,className:Mt.svg,title:o.formatMessage({id:"InntektsmeldingInnhentesForm.AltHjelpetekst"})}),k.jsx(qr,{open:v,onClose:h,anchorEl:I.current,className:Mt.hjelpetekst,children:k.jsx(qr.Content,{className:Mt.hjelpetekstInnhold,children:k.jsxs(Me,{gap:"space-16",children:[k.jsx(ne,{children:k.jsx(W,{id:"InntektsmeldingInnhentesForm.HjelpetekstDel1"})}),k.jsx(ne,{children:k.jsx(W,{id:"InntektsmeldingInnhentesForm.HjelpetekstDel2"})}),k.jsx(ne,{children:k.jsx(W,{id:"InntektsmeldingInnhentesForm.HjelpetekstDel3"})})]})})})]}),validate:[un],isReadOnly:r,radios:b}),k.jsx(si,{name:"begrunnelse",control:g.control,label:k.jsx(W,{id:c?"InntektsmeldingInnhentesForm.Begrunn":"InntektsmeldingInnhentesForm.Kommentar"}),validate:[un,N0,R0,Oa],maxLength:1500,readOnly:r}),!r&&k.jsxs(ye,{gap:"space-16",children:[k.jsx(Ne,{size:"small",variant:"secondary",loading:g.formState.isSubmitting,disabled:!g.formState.isDirty||g.formState.isSubmitting,children:k.jsx(W,{id:"InntektsmeldingInnhentesForm.Lagre"})}),k.jsx(Ne,{size:"small",variant:"tertiary",loading:!1,disabled:g.formState.isSubmitting,onClick:f,type:"button",children:k.jsx(W,{id:"InntektsmeldingInnhentesForm.Avbryt"})})]})]})})},P0=(e,n,t)=>()=>{e(r=>r.map(s=>s.arbeidsgiverIdent===n.arbeidsgiverIdent?{...n,avklaring:{begrunnelse:t.begrunnelse,saksbehandlersVurdering:t.saksbehandlersVurdering}}:s))};Wd.__docgenInfo={description:"",methods:[],displayName:"ManglendeInntektsmeldingForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},behandlingVersjon:{required:!0,tsType:{name:"number"},description:""},radData:{required:!0,tsType:{name:"intersection",raw:`{
  inntektsmeldingerForRad: Inntektsmelding[];
  arbeidsforholdForRad: AoIArbeidsforhold[];
  inntektsposter: Inntektspost[];
  årsak?: string;
...
| {
  ...
  arbeidsgiverIdent: string;
  arbeidsgiverNavn: string;
}`,signature:{properties:[{key:"erPrivatPerson",value:{name:"literal",value:"false",required:!0}},{key:"arbeidsgiverIdent",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}}]}}]}]}],raw:"ArbeidsforholdOgInntektRadData[]"}}},name:"data"}],return:{name:"void"}}},description:""}}};const at="342352362",q0=ja(3),_0=Ea(1500),M0=Co(1),D0=Ko(100),li=({behandlingUuid:e,behandlingVersjon:n,isReadOnly:t,registrerArbeidsforhold:r,radData:s,lukkArbeidsforholdRad:a,erOverstyrt:i,oppdaterTabell:o,erNyttArbeidsforhold:l=!1})=>{const u=Xn(),[d,g]=m.useState(!1),c={fom:s?.avklaring?.fom,tom:s?.avklaring?.tom,stillingsprosent:s?.avklaring?.stillingsprosent,begrunnelse:s?.avklaring?.begrunnelse,arbeidsgiverNavn:s?.avklaring?.arbeidsgiverNavn},f=Ds({defaultValues:c});ii(f.formState.isDirty);const y=()=>{a(),f.reset(c)},I=w=>{const h=Do(me.MANUELT_OPPRETTET_AV_SAKSBEHANDLER,e,n,w);return r(h).then(()=>{o(x0(w)),f.reset(w),l&&a()})},v=()=>{const w=f.getValues(),h=Do(me.FJERN_FRA_BEHANDLINGEN,e,n,w);r(h).then(F0(o,a,l))};return k.jsxs(Me,{gap:"space-16",children:[!s&&k.jsx(lt,{size:"small",level:"3",children:k.jsx(W,{id:"LeggTilArbeidsforholdForm.LeggTilArbeidsforhold"})}),k.jsx(xs,{formMethods:f,onSubmit:I,children:k.jsxs(Me,{gap:"space-24",children:[k.jsxs(ye,{gap:"space-16",children:[i&&k.jsxs(k.Fragment,{children:[k.jsx(Ia,{name:"arbeidsgiverNavn",control:f.control,label:k.jsx(W,{id:"LeggTilArbeidsforholdForm.Arbeidsgiver"}),validate:[un],readOnly:t||!i}),k.jsx(tt,{name:"fom",control:f.control,label:k.jsx(W,{id:"LeggTilArbeidsforholdForm.PeriodeFra"}),validate:[un,Zr],isReadOnly:t||!i}),k.jsx(tt,{name:"tom",control:f.control,label:k.jsx(W,{id:"LeggTilArbeidsforholdForm.PeriodeTil"}),validate:[Zr,S0(f.getValues)],isReadOnly:t||!i})]}),k.jsx(Ia,{name:"stillingsprosent",control:f.control,label:k.jsx(W,{id:"LeggTilArbeidsforholdForm.Stillingsprosent"}),parse:w=>{const h=parseInt(w.toString(),10);return Number.isNaN(h)?w:h},validate:[un,Bo,M0,D0],readOnly:t||!i,maxLength:3})]}),k.jsx(si,{name:"begrunnelse",control:f.control,label:k.jsx(W,{id:"LeggTilArbeidsforholdForm.Begrunn"}),validate:[un,q0,_0,Oa],maxLength:1500,readOnly:t||!i}),i&&k.jsxs(ye,{gap:"space-16",children:[k.jsx(Ne,{size:"small",variant:"secondary",loading:f.formState.isSubmitting,disabled:!f.formState.isDirty||f.formState.isSubmitting,children:k.jsx(W,{id:"LeggTilArbeidsforholdForm.Lagre"})}),k.jsx(Ne,{size:"small",variant:"tertiary",loading:!1,disabled:f.formState.isSubmitting,onClick:y,type:"button",children:k.jsx(W,{id:"LeggTilArbeidsforholdForm.Avbryt"})}),s&&k.jsxs(k.Fragment,{children:[k.jsx(Er,{}),k.jsx(Ne,{size:"small",variant:"tertiary",loading:!1,disabled:f.formState.isSubmitting,onClick:()=>g(!0),type:"button",icon:k.jsx(og,{"aria-hidden":!0}),children:k.jsx(W,{id:"LeggTilArbeidsforholdForm.Slett"})})]})]})]})}),d&&k.jsx(gh,{text:u.formatMessage({id:"NyttArbeidsforholdForm.VilDuSlette"}),submit:v,cancel:()=>g(!1),showModal:!0})]})},Do=(e,n,t,r)=>({vurdering:e,behandlingUuid:n,behandlingVersjon:t,arbeidsgiverIdent:at,begrunnelse:r.begrunnelse,arbeidsgiverNavn:r.arbeidsgiverNavn,fom:r.fom,tom:r.tom,stillingsprosent:r.stillingsprosent}),S0=e=>n=>{const t=e("fom");return n&&t?Go(t)(n):null},x0=e=>n=>{const t={erPrivatPerson:!1,arbeidsgiverIdent:at,arbeidsgiverNavn:e.arbeidsgiverNavn,avklaring:{fom:e.fom,tom:e.tom,stillingsprosent:e.stillingsprosent,arbeidsgiverNavn:e.arbeidsgiverNavn,begrunnelse:e.begrunnelse,saksbehandlersVurdering:me.MANUELT_OPPRETTET_AV_SAKSBEHANDLER},inntektsmeldingerForRad:[],inntektsposter:[],arbeidsforholdForRad:[]},r=n.findIndex(s=>s.arbeidsgiverIdent===at);return r===-1?n.concat(t):n.map((s,a)=>a===r?t:s)},F0=(e,n,t)=>()=>{e(r=>r.filter(s=>s.arbeidsgiverIdent!==at)),t&&n()};li.__docgenInfo={description:"",methods:[],displayName:"ManueltLagtTilArbeidsforholdForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},behandlingVersjon:{required:!0,tsType:{name:"number"},description:""},isReadOnly:{required:!0,tsType:{name:"boolean"},description:""},registrerArbeidsforhold:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: ManueltArbeidsforhold) => Promise<void>",signature:{arguments:[{type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  behandlingUuid: string;
  behandlingVersjon: number;
  begrunnelse: string;
  arbeidsgiverIdent: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},skjæringstidspunkt:{required:!0,tsType:{name:"string"},description:""}}};const W0="_alertStripe_mucgx_5",z0={alertStripe:W0},Jd=({behandling:e,aksjonspunkt:n,readOnly:t,arbeidOgInntekt:r,registrerArbeidsforhold:s,erOverstyrer:a,tabellData:i,settÅpneRadIndexer:o,setErOverstyrt:l,oppdaterTabell:u})=>{const d=Xn(),{arbeidsforhold:g,inntektsmeldinger:c}=r,[f,y]=m.useState(!1),[I,v]=m.useState(!1),w=()=>{l(!0),y(!0);const A=i.findIndex(T=>T.avklaring?.saksbehandlersVurdering===me.MANUELT_OPPRETTET_AV_SAKSBEHANDLER);A!==-1&&o([A])},h=J0(i,n),b=i.every(A=>A.arbeidsgiverIdent!==at),j=n?.status===He.OPPRETTET;return k.jsxs(Me,{gap:"space-32",children:[k.jsxs(ye,{gap:"space-16",children:[k.jsx(lt,{size:"small",level:"3",children:k.jsx(W,{id:"ArbeidOgInntektFaktaPanel.Overskrift"})}),a&&j&&!t&&k.jsx(eh,{onClick:w}),k.jsx(Er,{}),k.jsx(ne,{size:"small",children:k.jsx(W,{id:"ArbeidOgInntektFaktaPanel.Skjaringstidspunkt",values:{skjæringspunktDato:Vo(r.skjæringstidspunkt)}})})]}),k.jsxs(Me,{gap:"space-16",children:[h.length>0&&k.jsx(Zb,{children:h.map(A=>d.formatMessage({id:A})).join(" ")}),g.length===0&&c.length===0&&a&&k.jsx("div",{className:z0.alertStripe,children:k.jsx(ct,{variant:"info",children:k.jsx(W,{id:"ArbeidOgInntektFaktaPanel.IngenArbeidsforhold"})})}),f&&b&&!I&&k.jsx("div",{children:k.jsx(Ne,{size:"small",variant:"tertiary",icon:k.jsx(eg,{"aria-hidden":!0}),onClick:()=>v(!0),children:k.jsx(W,{id:"ArbeidOgInntektFaktaPanel.LeggTilArbeidsforhold"})})}),I&&k.jsx(li,{behandlingUuid:e.uuid,behandlingVersjon:e.versjon,isReadOnly:!1,registrerArbeidsforhold:s,lukkArbeidsforholdRad:()=>v(!1),oppdaterTabell:u,erOverstyrt:!0,erNyttArbeidsforhold:!0})]})]})},J0=(e,n)=>{const t=e.some(i=>i.årsak===Ve.MANGLENDE_INNTEKTSMELDING),r=e.some(i=>i.årsak===Ve.INNTEKTSMELDING_UTEN_ARBEIDSFORHOLD),s=n?.status===He.OPPRETTET,a=[];return s&&t&&a.push("ArbeidOgInntektFaktaPanel.InnhentManglendeInntektsmelding"),s&&r&&a.push("ArbeidOgInntektFaktaPanel.AvklarManglendeOpplysninger"),a};Jd.__docgenInfo={description:"",methods:[],displayName:"ArbeidsOgInntektOverstyrPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
