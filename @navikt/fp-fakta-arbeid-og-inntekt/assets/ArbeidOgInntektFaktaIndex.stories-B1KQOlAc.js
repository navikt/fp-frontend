...
| {
  ...
  arbeidsgiverIdent: string;
  arbeidsgiverNavn: string;
}`,signature:{properties:[{key:"erPrivatPerson",value:{name:"literal",value:"false",required:!0}},{key:"arbeidsgiverIdent",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}}]}}]}]},description:""}}};const mw="_bredde_gb3eb_1",fw="_inline_gb3eb_9",cw="_arrow_gb3eb_13",Tt={bredde:mw,inline:fw,arrow:cw},pa=({saksnummer:e,skjæringstidspunkt:t,alleKodeverk:r,radData:n})=>{const[s,a]=f.useState(!1),{inntektsposter:i,arbeidsforholdForRad:l}=n,o=kw(t,i),u=l.length===1,d=i.length>0&&i.some(g=>g.beløp>0);return c.jsxs(Se,{gap:"8",children:[c.jsx(ni,{saksnummer:e,alleKodeverk:r,radData:n}),d&&c.jsxs(Se,{gap:"2",children:[c.jsx(je,{size:"small",children:c.jsx(Y,{id:u?"ArbeidsforholdInformasjonPanel.Inntekter":"ArbeidsforholdInformasjonPanel.TotaltInntekter"})}),c.jsx(Se,{gap:"1",children:o.filter((g,k)=>s?!0:k<3).map(g=>c.jsxs(Ie,{gap:"2",className:Tt.bredde,children:[c.jsx(se,{size:"small",children:c.jsx(Y,{id:`ArbeidsforholdInformasjonPanel.${Te(g.fom).month()+1}`})}),c.jsx(se,{size:"small",children:Te(g.fom).year()}),c.jsx(Rr,{}),c.jsx(se,{size:"small",children:c.jsx(ma,{beløp:g.beløp})})]},g.fom))}),c.jsxs(Ca,{onClick:g=>{g.preventDefault(),a(!s)},href:"",children:[c.jsx("span",{children:c.jsx(se,{size:"small",className:Tt.inline,children:c.jsx(Y,{id:s?"ArbeidsforholdInformasjonPanel.FaerreManeder":"ArbeidsforholdInformasjonPanel.TidligereManeder"})})}),s?c.jsx(Uo,{className:Tt.arrow}):c.jsx(ys,{className:Tt.arrow})]})]}),!d&&c.jsx(je,{size:"small",children:c.jsx(Y,{id:"ArbeidsforholdInformasjonPanel.IngenInntekt"})})]})},kw=(e,t)=>{const n=Te(e).subtract(1,"month").startOf("month"),s=n.subtract(12,"month"),a=[];for(let i=n;i.isAfter(s);i=i.subtract(1,"month")){const l=i.format(Dn),o=t.find(u=>Te(u.fom).startOf("month").format(Dn)===l);a.push({beløp:(o==null?void 0:o.beløp)||0,fom:l})}return a};pa.__docgenInfo={description:"",methods:[],displayName:"ArbeidsforholdInformasjonPanel",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},skjæringstidspunkt:{required:!0,tsType:{name:"string"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},skjæringstidspunkt:{required:!0,tsType:{name:"string"},description:""}}};const Jw="_alertStripe_mucgx_5",Xw={alertStripe:Jw},Zu=({behandling:e,aksjonspunkt:t,readOnly:r,arbeidOgInntekt:n,registrerArbeidsforhold:s,erOverstyrer:a,tabellData:i,settÅpneRadIndexer:l,setErOverstyrt:o,oppdaterTabell:u})=>{const d=Qn(),{arbeidsforhold:g,inntektsmeldinger:k}=n,[m,y]=f.useState(!1),[h,b]=f.useState(!1),w=()=>{o(!0),y(!0);const j=i.findIndex(N=>{var O;return((O=N.avklaring)==null?void 0:O.saksbehandlersVurdering)===fe.MANUELT_OPPRETTET_AV_SAKSBEHANDLER});j!==-1&&l([j])},v=Qw(i,t),I=i.every(j=>j.arbeidsgiverIdent!==it),E=(t==null?void 0:t.status)===Ye.OPPRETTET;return c.jsxs(Se,{gap:"8",children:[c.jsxs(Ie,{gap:"4",children:[c.jsx(ps,{size:"small",children:c.jsx(Y,{id:"ArbeidOgInntektFaktaPanel.Overskrift"})}),a&&E&&!r&&c.jsx(zh,{onClick:w}),c.jsx(Rr,{}),c.jsx(se,{size:"small",children:c.jsx(Y,{id:"ArbeidOgInntektFaktaPanel.Skjaringstidspunkt",values:{skjæringspunktDato:Lo(n.skjæringstidspunkt)}})})]}),c.jsxs(Se,{gap:"4",children:[v.length>0&&c.jsx(Yh,{children:v.map(j=>d.formatMessage({id:j})).join(" ")}),g.length===0&&k.length===0&&a&&c.jsx("div",{className:Xw.alertStripe,children:c.jsx(ft,{variant:"info",children:c.jsx(Y,{id:"ArbeidOgInntektFaktaPanel.IngenArbeidsforhold"})})}),m&&I&&!h&&c.jsx("div",{children:c.jsx(De,{size:"small",variant:"tertiary",icon:c.jsx(tm,{"aria-hidden":!0}),onClick:()=>b(!0),children:c.jsx(Y,{id:"ArbeidOgInntektFaktaPanel.LeggTilArbeidsforhold"})})}),h&&c.jsx(ri,{behandlingUuid:e.uuid,behandlingVersjon:e.versjon,isReadOnly:!1,registrerArbeidsforhold:s,lukkArbeidsforholdRad:()=>b(!1),oppdaterTabell:u,erOverstyrt:!0,erNyttArbeidsforhold:!0})]})]})},Qw=(e,t)=>{const r=e.some(i=>i.årsak===Ve.MANGLENDE_INNTEKTSMELDING),n=e.some(i=>i.årsak===Ve.INNTEKTSMELDING_UTEN_ARBEIDSFORHOLD),s=(t==null?void 0:t.status)===Ye.OPPRETTET,a=[];return s&&r&&a.push("ArbeidOgInntektFaktaPanel.InnhentManglendeInntektsmelding"),s&&n&&a.push("ArbeidOgInntektFaktaPanel.AvklarManglendeOpplysninger"),a};Zu.__docgenInfo={description:"",methods:[],displayName:"ArbeidsOgInntektOverstyrPanel",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
