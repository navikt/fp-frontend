 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lr;function di(){if(Lr)return Ye;Lr=1;var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.fragment");function r(t,a,l){var i=null;if(l!==void 0&&(i=""+l),a.key!==void 0&&(i=""+a.key),"key"in a){l={};for(var o in a)o!=="key"&&(l[o]=a[o])}else l=a;return a=l.ref,{$$typeof:e,type:t,key:i,ref:a!==void 0?a:null,props:l}}return Ye.Fragment=n,Ye.jsx=r,Ye.jsxs=r,Ye}var Fr;function ci(){return Fr||(Fr=1,Ir.exports=di()),Ir.exports}var Z=ci();const Jt=e=>e.reduce((n,r,t)=>({...n,[t]:a=>r(a)||!0}),{}),Xt=(e,n)=>n.split(".").reduce((r,t)=>r!==void 0?r[t]:r,e)?.message;var Dt={exports:{}},mi=Dt.exports,xr;function fi(){return xr||(xr=1,function(e,n){(function(r,t){e.exports=t()})(mi,function(){var r={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},t=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,a=/\d/,l=/\d\d/,i=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,d={},m=function(E){return(E=+E)+(E>68?1900:2e3)},c=function(E){return function(T){this[E]=+T}},g=[/[+-]\d\d:?(\d\d)?|Z/,function(E){(this.zone||(this.zone={})).offset=function(T){if(!T||T==="Z")return 0;var _=T.match(/([+-]|\d\d)/g),A=60*_[1]+(+_[2]||0);return A===0?0:_[0]==="+"?-A:A}(E)}],y=function(E){var T=d[E];return T&&(T.indexOf?T:T.s.concat(T.f))},S=function(E,T){var _,A=d.meridiem;if(A){for(var P=1;P<=24;P+=1)if(E.indexOf(A(P,0,T))>-1){_=P>12;break}}else _=E===(T?"pm":"PM");return _},N={A:[o,function(E){this.afternoon=S(E,!1)}],a:[o,function(E){this.afternoon=S(E,!0)}],Q:[a,function(E){this.month=3*(E-1)+1}],S:[a,function(E){this.milliseconds=100*+E}],SS:[l,function(E){this.milliseconds=10*+E}],SSS:[/\d{3}/,function(E){this.milliseconds=+E}],s:[i,c("seconds")],ss:[i,c("seconds")],m:[i,c("minutes")],mm:[i,c("minutes")],H:[i,c("hours")],h:[i,c("hours")],HH:[i,c("hours")],hh:[i,c("hours")],D:[i,c("day")],DD:[l,c("day")],Do:[o,function(E){var T=d.ordinal,_=E.match(/\d+/);if(this.day=_[0],T)for(var A=1;A<=31;A+=1)T(A).replace(/\[|\]/g,"")===E&&(this.day=A)}],w:[i,c("week")],ww:[l,c("week")],M:[i,c("month")],MM:[l,c("month")],MMM:[o,function(E){var T=y("months"),_=(y("monthsShort")||T.map(function(A){return A.slice(0,3)})).indexOf(E)+1;if(_<1)throw new Error;this.month=_%12||_}],MMMM:[o,function(E){var T=y("months").indexOf(E)+1;if(T<1)throw new Error;this.month=T%12||T}],Y:[/[+-]?\d+/,c("year")],YY:[l,function(E){this.year=m(E)}],YYYY:[/\d{4}/,c("year")],Z:g,ZZ:g};function k(E){var T,_;T=E,_=d&&d.formats;for(var A=(E=T.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(j,G,w){var R=w&&w.toUpperCase();return G||_[w]||r[w]||_[R].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(x,B,M){return B||M.slice(1)})})).match(t),P=A.length,L=0;L<P;L+=1){var z=A[L],K=N[z],C=K&&K[0],D=K&&K[1];A[L]=D?{regex:C,parser:D}:z.replace(/^\[|\]$/g,"")}return function(j){for(var G={},w=0,R=0;w<P;w+=1){var x=A[w];if(typeof x=="string")R+=x.length;else{var B=x.regex,M=x.parser,Q=j.slice(R),ae=B.exec(Q)[0];M.call(G,ae),j=j.replace(ae,"")}}return function(ne){var ve=ne.afternoon;if(ve!==void 0){var te=ne.hours;ve?te<12&&(ne.hours+=12):te===12&&(ne.hours=0),delete ne.afternoon}}(G),G}}return function(E,T,_){_.p.customParseFormat=!0,E&&E.parseTwoDigitYear&&(m=E.parseTwoDigitYear);var A=T.prototype,P=A.parse;A.parse=function(L){var z=L.date,K=L.utc,C=L.args;this.$u=K;var D=C[1];if(typeof D=="string"){var j=C[2]===!0,G=C[3]===!0,w=j||G,R=C[2];G&&(R=C[2]),d=this.$locale(),!j&&R&&(d=_.Ls[R]),this.$d=function(Q,ae,ne,ve){try{if(["x","X"].indexOf(ae)>-1)return new Date((ae==="X"?1e3:1)*Q);var te=k(ae)(Q),De=te.year,he=te.month,St=te.day,nt=te.hours,Nt=te.minutes,Ke=te.seconds,lt=te.milliseconds,Ae=te.zone,Ve=te.week,je=new Date,ke=St||(De||he?1:je.getDate()),Ge=De||je.getFullYear(),Re=0;De&&!he||(Re=he>0?he-1:je.getMonth());var Oe,Me=nt||0,Be=Nt||0,it=Ke||0,we=lt||0;return Ae?new Date(Date.UTC(Ge,Re,ke,Me,Be,it,we+60*Ae.offset*1e3)):ne?new Date(Date.UTC(Ge,Re,ke,Me,Be,it,we)):(Oe=new Date(Ge,Re,ke,Me,Be,it,we),Ve&&(Oe=ve(Oe).week(Ve).toDate()),Oe)}catch{return new Date("")}}(z,D,K,_),this.init(),R&&R!==!0&&(this.$L=this.locale(R).$L),w&&z!=this.format(D)&&(this.$d=new Date("")),d={}}else if(D instanceof Array)for(var x=D.length,B=1;B<=x;B+=1){C[1]=D[B-1];var M=_.apply(this,C);if(M.isValid()){this.$d=M.$d,this.$L=M.$L,this.init();break}B===x&&(this.$d=new Date(""))}else P.call(this,L)}}})}(Dt)),Dt.exports}var vi=fi();const gi=ui(vi),yi="_textarea_14c7r_1",Ei="_readOnlyField_14c7r_7",Dr={textarea:yi,readOnlyField:Ei},_i=e=>e!=null&&e!=="",ca=({label:e,value:n,isEdited:r=!1,type:t,hideLabel:a,size:l})=>_i(n)?Z.jsxs(Ze,{gap:"space-4",children:[e&&!a&&Z.jsx(Ee,{size:l,children:e}),Z.jsxs(Xe,{gap:"space-8",align:"center",wrap:!1,children:[Z.jsx($r,{className:t==="textarea"?Dr.textarea:Dr.readOnlyField,size:l,children:n}),r&&Z.jsx(da,{})]})]}):null;Lt.extend(gi);const pi=({label:e,description:n,validate:r=[],onChange:t,children:a,className:l,isReadOnly:i=!1,size:o="small",isEdited:d=!1,hideLegend:m=!1,...c})=>{const{name:g,control:y}=c,{formState:{errors:S}}=be(),{field:N}=zt({name:g,control:y,rules:{validate:Jt(r)}});return Z.jsx(gl,{name:g,value:N.value!==void 0?N.value:null,legend:Z.jsxs(Xe,{justify:"center",gap:"space-8",children:[e,i&&d&&Z.jsx(da,{})]}),hideLegend:m,disabled:i,description:n,size:o,error:Xt(S,g),onChange:k=>{t&&t(k),N.onChange(k)},className:l,children:a})},bi=({label:e,selectValues:n,validate:r=[],readOnly:t=!1,description:a,hideValueOnDisable:l=!1,onChange:i,className:o,hideLabel:d,isEdited:m,size:c="small",...g})=>{const{name:y,control:S,disabled:N}=g,{formState:{errors:k}}=be(),{field:E}=zt({name:y,control:S,rules:{validate:b.useMemo(()=>Jt(r),[r])}});if(t){const A=n.map(L=>L.props).find(L=>L.value===E.value),P=A?A.children:void 0;return Z.jsx(ca,{value:P,label:e,hideLabel:d,isEdited:m,size:c})}const T=E.value||"",_=!n.map(A=>A.props.value).includes(T)&&T!=="";return _&&console.warn(`No corresponding option found for value '${T}'`),Z.jsxs(tl,{size:c,className:o,error:Xt(k,y),label:e,description:a,value:l&&N||_?"":E.value,disabled:N,onChange:A=>{i&&i(A),E.onChange(A)},hideLabel:d,children:[Z.jsx("option",{style:{display:"none"}}),",",n]})},hi="_textAreaFieldWithBadges_bdz0b_1",Ri="_etikettWrapper_bdz0b_4",Kr={textAreaFieldWithBadges:hi,etikettWrapper:Ri},Oi=({name:e,control:n,label:r,readOnly:t,maxLength:a,badges:l,validate:i=[],parse:o=S=>S,className:d,description:m,isEdited:c,size:g="small",...y})=>{const{formState:{errors:S}}=be(),{field:N}=zt({name:e,control:n,rules:{validate:b.useMemo(()=>Jt(i),[i])}});return t?Z.jsx(ca,{size:g,label:r,value:N.value,type:"textarea",isEdited:c,hideLabel:y.hideLabel}):Z.jsxs("div",{className:l?Kr.textAreaFieldWithBadges:null,children:[l&&Z.jsx("div",{className:Kr.etikettWrapper,children:l.map(({type:k,titleText:E})=>Z.jsx(ul,{variant:k,size:"small",children:E},E))}),Z.jsx(Rl,{size:g,label:r,description:m,className:d,autoComplete:"off",...N,onChange:k=>N.onChange(k.currentTarget.value!==""?o(k.currentTarget.value):null),value:N.value?N.value:"",error:Xt(S,e),maxLength:a,...y})]})},Ti=({formMethods:e,onSubmit:n,children:r,className:t,setDataOnUnmount:a})=>{const{handleSubmit:l,getValues:i}=e;return b.useEffect(()=>()=>{a&&a(i())},[]),Z.jsx(Sl,{...e,children:Z.jsx("form",{className:t,onSubmit:n?l(o=>n(o)):void 0,children:r})})},Si="_begrunnelseTextField_hw8s7_6",Ni={begrunnelseTextField:Si},at={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},Ai=ce(at),Vi=ha(3),ki=Ra(2e3),wi=e=>e?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",Pi=e=>n=>n!==void 0||e,Fe=({readOnly:e,text:n,useAllWidth:r=!1,notRequired:t=!1})=>{const{formState:{isDirty:a},control:l}=be(),i=t?()=>!1:Pi(a);return F.jsx("div",{className:r?"":Ni.begrunnelseTextField,children:F.jsx(Oi,{name:"begrunnelse",control:l,label:n??Ai.formatMessage({id:wi(e)}),validate:[Br(i),Vi,ki,Oa],maxLength:2e3,readOnly:e,parse:ba})})},Ii=e=>e.length>0&&e[0].begrunnelse?e[0].begrunnelse:"";Fe.buildInitialValues=e=>({begrunnelse:Ta(Ii(e))});Fe.transformValues=e=>({begrunnelse:e.begrunnelse});Fe.__docgenInfo={description:`ProsessStegBegrunnelseTextField
