...
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}]}]},description:""},behandlingLocation:{required:!0,tsType:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]},description:""},alleKodeverk:{required:!0,tsType:{name:"union",raw:"AlleKodeverkTilbakekreving | AlleKodeverk",elements:[{name:"signature",type:"object",raw:`{
...
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}]}]},name:"skjermlenkeKode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const gE={ARBEIDSGIVER:"info-moderate",BESL:"success-moderate",VL:"neutral-moderate",SBH:"meta-purple-moderate",SOKER:"warning-moderate","-":"info-moderate"},Ma=({behandlingLocation:e,createLocationForSkjermlenke:a,alleKodeverk:l,historikkInnslag:{aktør:n,opprettetTidspunkt:r,tittel:t,linjer:E,dokumenter:i,skjermlenke:o},saksnummer:T})=>{const R=kn(),d=`${l.HistorikkAktør.find(K=>K.kode===n.type)?.navn??""} ${n.ident??""}`,A=ja(r,{separator:"kl",month:"long",day:"numeric"}),_=E.length>3,[N,m]=u.useState(_),k=E.slice(0,N?3:E.length);return V.jsxs(Le,{"data-testid":"historikkinnslag",wrap:!1,gap:"space-20",justify:"end",align:"center",children:[V.jsx(We.New,{padding:"4",background:gE[n.type],children:V.jsxs(Fa,{gap:"space-8",children:[V.jsxs(Le,{gap:"space-8",children:[V.jsx(vn,{weight:"semibold",children:d}),V.jsx(vn,{children:A})]}),t&&V.jsx(ve,{size:"medium",children:t}),o&&V.jsx(Va,{skjermlenke:o,behandlingLocation:e,alleKodeverk:l,createLocationForSkjermlenke:a}),E.length>0&&V.jsxs("div",{children:[k.map((K,D)=>K.type==="TEKST"?V.jsx(la,{size:"medium",children:DE(K.tekst??"")},`${K.tekst}-${D}`):V.jsx("br",{},`${K.type}-${D}`)),_&&V.jsx(La,{variant:"tertiary",size:"small",onClick:()=>m(!N),children:N?R.formatMessage({id:"Historikkinnslag.VisMer"}):R.formatMessage({id:"Historikkinnslag.VisMindre"})})]}),i&&V.jsx("div",{children:i.map(K=>V.jsx(ca,{dokumentLenke:K,saksnummer:T},`${K.journalpostId}.${K.dokumentId}`))})]})}),V.jsx(We.New,{children:V.jsx(Ga,{aktørType:n.type})})]})};Ma.__docgenInfo={description:"",methods:[],displayName:"HistorikkInnslag",props:{behandlingLocation:{required:!1,tsType:{name:"Location"},description:""},createLocationForSkjermlenke:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  behandlingLocation: Location,
...
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}]}]},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""},alleKodeverk:{required:!0,tsType:{name:"union",raw:"AlleKodeverkTilbakekreving | AlleKodeverk",elements:[{name:"signature",type:"object",raw:`{
  [K in TilbakekrevingKodeverkType]: KodeverkMedNavnTilbakekreving<
    K extends TilbakekrevingKodeverkType ? K : unknown
  >[];
}`,signature:{properties:[{key:{name:"signature",type:"object",raw:`{
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}]},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]}]},description:""},historikkInnslag:{required:!0,tsType:{name:"union",raw:"Historikkinnslag | HistorikkinnslagDtoFpTilbake",elements:[{name:"signature",type:"object",raw:`{
...
| 'FAKTA_OM_UTTAK_DOKUMENTASJON'
| 'FAKTA_UTTAK'
| 'FAKTA_UTTAK_EØS'`,elements:[{name:"literal",value:"'ANKE_MERKNADER'"},{name:"literal",value:"'ANKE_VURDERING'"},{name:"literal",value:"'BEREGNING_ENGANGSSTOENAD'"},{name:"literal",value:"'BEREGNING_FORELDREPENGER'"},{name:"literal",value:"'BESTEBEREGNING'"},{name:"literal",value:"'FAKTA_FOR_OMSORG'"},{name:"literal",value:"'FAKTA_FOR_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_ADOPSJON'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON'"},{name:"literal",value:"'FAKTA_OM_BEREGNING'"},{name:"literal",value:"'FAKTA_OM_FOEDSEL'"},{name:"literal",value:"'FAKTA_OM_OMSORGSOVERTAKELSE'"},{name:"literal",value:"'FAKTA_OM_FORDELING'"},{name:"literal",value:"'FAKTA_OM_MEDLEMSKAP'"},{name:"literal",value:"'FAKTA_OM_OMSORG_OG_FORELDREANSVAR'"},{name:"literal",value:"'FAKTA_OM_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_SIMULERING'"},{name:"literal",value:"'FAKTA_OM_UTTAK'"},{name:"literal",value:"'FAKTA_OM_AKTIVITETSKRAV'"},{name:"literal",value:"'FAKTA_OMSORG_OG_RETT'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'FORMKRAV_KLAGE_KA'"},{name:"literal",value:"'FORMKRAV_KLAGE_NFP'"},{name:"literal",value:"'KLAGE_BEH_NFP'"},{name:"literal",value:"'KLAGE_BEH_NK'"},{name:"literal",value:"'KONTROLL_AV_SAKSOPPLYSNINGER'"},{name:"literal",value:"'OPPLYSNINGSPLIKT'"},{name:"literal",value:"'PUNKT_FOR_ADOPSJON'"},{name:"literal",value:"'PUNKT_FOR_FOEDSEL'"},{name:"literal",value:"'PUNKT_FOR_FORELDREANSVAR'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP_LØPENDE'"},{name:"literal",value:"'PUNKT_FOR_OMSORG'"},{name:"literal",value:"'PUNKT_FOR_OPPTJENING'"},{name:"literal",value:"'PUNKT_FOR_SVANGERSKAPSPENGER'"},{name:"literal",value:"'PUNKT_FOR_SVP_INNGANG'"},{name:"literal",value:"'SOEKNADSFRIST'"},{name:"literal",value:"'TILKJENT_YTELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'UTLAND'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'VURDER_FARESIGNALER'"},{name:"literal",value:"'FAKTA_OM_UTTAK_DOKUMENTASJON'"},{name:"literal",value:"'FAKTA_UTTAK'"},{name:"literal",value:"'FAKTA_UTTAK_EØS'"}],required:!1}},{key:"tittel",value:{name:"string",required:!1}}]}},{name:"signature",type:"object",raw:`{
  behandlingUuid?: string;
...
}`,signature:{properties:[{key:"ident",value:{name:"string",required:!1}},{key:"type",value:{name:"union",raw:"'BESL' | 'SBH' | 'SOKER' | 'ARBEIDSGIVER' | 'VL' | '-'",elements:[{name:"literal",value:"'BESL'"},{name:"literal",value:"'SBH'"},{name:"literal",value:"'SOKER'"},{name:"literal",value:"'ARBEIDSGIVER'"},{name:"literal",value:"'VL'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0}},{key:"skjermlenke",value:{name:"union",raw:`| 'FAKTA_OM_FEILUTBETALING'
| 'TILBAKEKREVING'
| 'FORELDELSE'
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}],required:!1}},{key:"opprettetTidspunkt",value:{name:"string",required:!0}},{key:"dokumenter",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  dokumentId: string;
  journalpostId: string;
  tag: string;
  utgått: boolean;
}`,signature:{properties:[{key:"dokumentId",value:{name:"string",required:!0}},{key:"journalpostId",value:{name:"string",required:!0}},{key:"tag",value:{name:"string",required:!0}},{key:"utgått",value:{name:"boolean",required:!0}}]}}],raw:"Array<HistorikkInnslagDokumentLinkDtoFpTilbake>",required:!1}},{key:"tittel",value:{name:"string",required:!1}},{key:"linjer",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  tekst?: string;
  type: TypeFpTilbake;
}`,signature:{properties:[{key:"tekst",value:{name:"string",required:!1}},{key:"type",value:{name:"union",raw:"'TEKST' | 'LINJESKIFT'",elements:[{name:"literal",value:"'TEKST'"},{name:"literal",value:"'LINJESKIFT'"}],required:!0}}]}}],raw:"Array<LinjeFpTilbake>",required:!0}}]}}]},description:""},saksnummer:{required:!0,tsType:{name:"string"},description:""}}};const GE="_circle_wfn61_1",PE="_overflow_wfn61_10",Qn={circle:GE,overflow:PE},pa=({valgtBehandlingUuid:e,historikkFpSak:a,historikkFpTilbake:l,alleKodeverkFpSak:n,alleKodeverkFpTilbake:r,saksnummer:t,getBehandlingLocation:E,createLocationForSkjermlenke:i,utvidEllerMinskBehandlingDetaljerKnapp:o})=>{const T=kn(),[R,v]=u.useState(!1),d=OE(a,l),A=e&&R?d.filter(k=>k.behandlingUuid===e):d,[_,N]=u.useState(),m=()=>N(0);return u.useEffect(()=>(globalThis.addEventListener("scroll",m),()=>{globalThis.removeEventListener("scroll",m)}),[]),V.jsxs(V.Fragment,{children:[V.jsx(We.New,{background:"neutral-moderate",borderColor:"neutral-subtleA",borderWidth:"0 0 2 0",padding:"5",children:V.jsxs(Le,{justify:"space-between",children:[V.jsxs(Le,{gap:"space-4",align:"center",children:[V.jsx(ll,{size:"small",level:"3",children:T.formatMessage({id:"History.Historikk"})}),o]}),V.jsxs(Le,{gap:"space-32",children:[e&&V.jsx(mE,{size:"small",onChange:()=>v(!R),children:T.formatMessage({id:"History.FiltrerPaBehandling"})}),V.jsx("div",{className:Qn.circle,children:A.length})]})]})}),V.jsx("div",{style:{height:`calc(100vh - ${_}px)`},className:Qn.overflow,ref:k=>{k&&N(k.getBoundingClientRect().top)},children:V.jsx(Fa,{gap:"space-8",padding:"4",children:A.map(k=>{const K=k.erTilbakekreving?r:n;return K?V.jsx(Ma,{saksnummer:t,historikkInnslag:k,createLocationForSkjermlenke:i,alleKodeverk:K,behandlingLocation:k.behandlingUuid?E(k.behandlingUuid):void 0},k.opprettetTidspunkt):null})})})]})};pa.__docgenInfo={description:`Historikk
...
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}],required:!1}},{key:"opprettetTidspunkt",value:{name:"string",required:!0}},{key:"dokumenter",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  tekst?: string;
  type: TypeFpTilbake;
}`,signature:{properties:[{key:"tekst",value:{name:"string",required:!1}},{key:"type",value:{name:"union",raw:"'TEKST' | 'LINJESKIFT'",elements:[{name:"literal",value:"'TEKST'"},{name:"literal",value:"'LINJESKIFT'"}],required:!0}}]}}],raw:"Array<LinjeFpTilbake>",required:!0}}]}}],raw:"HistorikkinnslagDtoFpTilbake[]"},description:""},alleKodeverkFpTilbake:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  [K in TilbakekrevingKodeverkType]: KodeverkMedNavnTilbakekreving<
    K extends TilbakekrevingKodeverkType ? K : unknown
  >[];
}`,signature:{properties:[{key:{name:"signature",type:"object",raw:`{
...
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}]}]},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""},utvidEllerMinskBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};const cE={"History.FiltrerPaBehandling":"Filtrer på behandling","History.Historikk":"Historikk","BubbleText.LukkeTekstfelt":"Lukke tekstfelt","BubbleText.ApneTekstfelt":"Åpne tekstfelt","BehandlingSupportIndex.Utvid":"Utvid","BehandlingSupportIndex.Minsk":"Minsk","Historikkinnslag.Soker":"Søker","Historikkinnslag.Saksbehandler":"Saksbehandler","Historikkinnslag.Beslutter":"Beslutter","Historikkinnslag.Vedtakslosninger":"Vedtaksløsningen","Historikkinnslag.Arbeidsgiver":"Arbeidsgiver","Historikkinnslag.VisMer":"Vis mer...","Historikkinnslag.VisMindre":"Vis mindre"},VE=xa(cE),fa=({historikkFpSak:e=[],historikkFpTilbake:a=[],alleKodeverkFpTilbake:l,alleKodeverkFpSak:n,saksnummer:r,getBehandlingLocation:t,createLocationForSkjermlenke:E,valgtBehandlingUuid:i,utvidEllerMinskBehandlingDetaljerKnapp:o})=>V.jsx(Ja,{value:VE,children:V.jsx(pa,{valgtBehandlingUuid:i,historikkFpSak:e,historikkFpTilbake:a,alleKodeverkFpTilbake:l,alleKodeverkFpSak:n,saksnummer:r,getBehandlingLocation:t,createLocationForSkjermlenke:E,utvidEllerMinskBehandlingDetaljerKnapp:o})});fa.__docgenInfo={description:"",methods:[],displayName:"HistorikkSakIndex",props:{historikkFpSak:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aktør: tjenester_behandling_historikk_HistorikkinnslagDto_HistorikkAktørDto;
  behandlingUuid?: string;
  dokumenter?: Array<tjenester_behandling_historikk_HistorikkInnslagDokumentLinkDto>;
  linjer: Array<tjenester_behandling_historikk_HistorikkinnslagDto_Linje>;
...
}`,...He.parameters?.docs?.source}}};const hE=["BehandlingIkkeErValgt","BehandlingErValgt"];export{He as BehandlingErValgt,he as BehandlingIkkeErValgt,hE as __namedExportsOrder,bE as default};
