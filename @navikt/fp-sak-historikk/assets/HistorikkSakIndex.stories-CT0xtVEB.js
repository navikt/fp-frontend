...
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}]}]},name:"skjermlenkeKode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const gE={ARBEIDSGIVER:"info-moderate",BESL:"success-moderate",VL:"neutral-moderate",SBH:"meta-purple-moderate",SOKER:"warning-moderate","-":"info-moderate"},Va=({behandlingLocation:e,createLocationForSkjermlenke:a,alleKodeverk:l,historikkInnslag:{aktør:n,opprettetTidspunkt:r,tittel:t,linjer:E,dokumenter:i,skjermlenke:o},saksnummer:T})=>{const R=sn(),d=`${l.HistorikkAktør.find(K=>K.kode===n.type)?.navn??""} ${n.ident??""}`,A=ja(r,{separator:"kl",month:"long",day:"numeric"}),_=E.length>3,[N,m]=u.useState(_),s=E.slice(0,N?3:E.length);return M.jsxs(Le,{"data-testid":"historikkinnslag",wrap:!1,gap:"space-20",justify:"end",align:"center",children:[M.jsx(We.New,{padding:"4",background:gE[n.type],children:M.jsxs(Fa,{gap:"space-8",children:[M.jsxs(Le,{gap:"space-8",children:[M.jsx(vn,{weight:"semibold",children:d}),M.jsx(vn,{children:A})]}),t&&M.jsx(ve,{size:"medium",children:t}),o&&M.jsx(Ma,{skjermlenke:o,behandlingLocation:e,alleKodeverk:l,createLocationForSkjermlenke:a}),E.length>0&&M.jsxs("div",{children:[s.map((K,D)=>K.type==="TEKST"?M.jsx(la,{size:"medium",children:DE(K.tekst??"")},`${K.tekst}-${D}`):M.jsx("br",{},`${K.type}-${D}`)),_&&M.jsx(La,{variant:"tertiary",size:"small",onClick:()=>m(!N),children:N?R.formatMessage({id:"Historikkinnslag.VisMer"}):R.formatMessage({id:"Historikkinnslag.VisMindre"})})]}),i&&M.jsx("div",{children:i.map(K=>M.jsx(ca,{dokumentLenke:K,saksnummer:T},`${K.journalpostId}.${K.dokumentId}`))})]})}),M.jsx(We.New,{children:M.jsx(Ga,{aktørType:n.type})})]})};Va.__docgenInfo={description:"",methods:[],displayName:"HistorikkInnslag",props:{behandlingLocation:{required:!1,tsType:{name:"Location"},description:""},createLocationForSkjermlenke:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  behandlingLocation: Location,
...
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}],required:!1}},{key:"opprettetTidspunkt",value:{name:"string",required:!0}},{key:"dokumenter",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  tekst?: string;
  type: TypeFpTilbake;
}`,signature:{properties:[{key:"tekst",value:{name:"string",required:!1}},{key:"type",value:{name:"union",raw:"'TEKST' | 'LINJESKIFT'",elements:[{name:"literal",value:"'TEKST'"},{name:"literal",value:"'LINJESKIFT'"}],required:!0}}]}}],raw:"Array<LinjeFpTilbake>",required:!0}}]}}]},description:""},saksnummer:{required:!0,tsType:{name:"string"},description:""}}};const GE="_circle_wfn61_1",PE="_overflow_wfn61_10",Qn={circle:GE,overflow:PE},fa=({valgtBehandlingUuid:e,historikkFpSak:a,historikkFpTilbake:l,alleKodeverkFpSak:n,alleKodeverkFpTilbake:r,saksnummer:t,getBehandlingLocation:E,createLocationForSkjermlenke:i,utvidEllerMinskBehandlingDetaljerKnapp:o})=>{const T=sn(),[R,v]=u.useState(!1),d=OE(a,l),A=e&&R?d.filter(s=>s.behandlingUuid===e):d,[_,N]=u.useState(),m=()=>N(0);return u.useEffect(()=>(globalThis.addEventListener("scroll",m),()=>{globalThis.removeEventListener("scroll",m)}),[]),M.jsxs(M.Fragment,{children:[M.jsx(We.New,{background:"neutral-moderate",borderColor:"neutral-subtleA",borderWidth:"0 0 2 0",padding:"5",children:M.jsxs(Le,{justify:"space-between",children:[M.jsxs(Le,{gap:"space-4",align:"center",children:[M.jsx(ll,{size:"small",level:"3",children:T.formatMessage({id:"History.Historikk"})}),o]}),M.jsxs(Le,{gap:"space-32",children:[e&&M.jsx(mE,{size:"small",onChange:()=>v(!R),children:T.formatMessage({id:"History.FiltrerPaBehandling"})}),M.jsx("div",{className:Qn.circle,children:A.length})]})]})}),M.jsx("div",{style:{height:`calc(100vh - ${_}px)`},className:Qn.overflow,ref:s=>{s&&N(s.getBoundingClientRect().top)},children:M.jsx(Fa,{gap:"space-8",padding:"4",children:A.map(s=>{const K=s.erTilbakekreving?r:n;return K?M.jsx(Va,{saksnummer:t,historikkInnslag:s,createLocationForSkjermlenke:i,alleKodeverk:K,behandlingLocation:s.behandlingUuid?E(s.behandlingUuid):void 0},s.opprettetTidspunkt):null})})})]})};fa.__docgenInfo={description:`Historikk
