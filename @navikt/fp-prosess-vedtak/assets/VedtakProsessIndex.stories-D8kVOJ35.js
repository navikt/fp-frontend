...
}>`},description:""},beregningErManueltFastsatt:{required:!0,tsType:{name:"boolean"},description:""},skalBrukeOverstyrendeFritekstBrev:{required:!0,tsType:{name:"boolean"},description:""}}};const Fb="_fritekstItem_1kqqb_1",Mb={fritekstItem:Fb},Vb=Da(1500),Gb=oi(3),wb=(e,n,r)=>{const t=n.filter(s=>s.vilkarStatus===aa.IKKE_OPPFYLT);if(t.length===0)return d.createElement(Ae,{id:"VedtakForm.UttaksperioderIkkeGyldig"});if(!(r!=null&&r.avslagsarsak))throw new Error("Ingen behandlingsresultat eller avslagsårsak finnes");return`${e(t[0].vilkarType,On.VILKAR_TYPE)}: ${e(r.avslagsarsak,On.AVSLAGSARSAK,t[0].vilkarType)}`},og=({vilkar:e,behandlingsresultat:n,språkKode:r,erReadOnly:t,alleKodeverk:a,skalBrukeOverstyrendeFritekstBrev:s})=>{const{formState:{isDirty:i}}=Rr(),o=kt(a),l=u=>u!==void 0||i,g=wb(o,e,n);return d.createElement(d.Fragment,null,g&&d.createElement(d.Fragment,null,d.createElement(Be,{size:"small"},d.createElement(Ae,{id:"VedtakForm.ArsakTilAvslag"})),d.createElement(ze,{size:"small"},g),d.createElement(ce,{sixteenPx:!0})),!s&&d.createElement(d.Fragment,null,d.createElement(ce,{sixteenPx:!0}),d.createElement(Zt,{name:"begrunnelse",label:d.createElement(Ae,{id:"VedtakForm.Fritekst"}),validate:[Qp(l),Gb,Vb,ta],maxLength:1500,readOnly:t,parse:u=>u.toString().replaceAll(new RegExp("\\p{Dash_Punctuation}","gu"),"-").replaceAll("	"," "),badges:[{type:"info",titleText:ws(r)}]})),t&&(n==null?void 0:n.avslagsarsakFritekst)&&d.createElement("span",null,d.createElement(ce,{twentyPx:!0}),d.createElement(Gn,null,d.createElement(Ae,{id:"VedtakForm.Fritekst"})),d.createElement(ce,{eightPx:!0}),d.createElement("div",{className:Mb.fritekstItem},zn(n.avslagsarsakFritekst))))};og.__docgenInfo={description:"",methods:[],displayName:"VedtakAvslagArsakOgBegrunnelsePanel",props:{vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkarType: string;
  vilkarStatus: string;
  avslagKode?: string;
  lovReferanse?: string;
...
}>`},description:""},beregningErManueltFastsatt:{required:!0,tsType:{name:"boolean"},description:""},skalBrukeOverstyrendeFritekstBrev:{required:!0,tsType:{name:"boolean"},description:""}}};const lo=(e,n,r,t,a)=>s=>{if(s.preventDefault(),!e||(e?!!t&&!!r:!!a)){const o={fritekst:e?t:a,dokumentMal:e?Fl.FRITEKST:void 0,tittel:e?r:void 0,gjelderVedtak:!0,automatiskVedtaksbrev:e?void 0:!0};n(o)}},Bb=(e=[])=>e.map(({behandlingArsakType:n})=>n).some(n=>n===hn.ETTER_KLAGE||n===hn.KLAGE_U_INNTK||n===hn.KLAGE_M_INNTK),Ub=(e,n)=>{if(e===void 0||e.length<1)return;const r=[],t=e.find(s=>s===hn.RE_ENDRING_FRA_BRUKER),a=e.filter(s=>s!==hn.RE_ENDRING_FRA_BRUKER).map(s=>n(s,On.BEHANDLING_AARSAK));return t!==void 0&&r.push(n(t,On.BEHANDLING_AARSAK)),r.push(...a),r.join(", ")},jb=(e,n)=>{const r=e?Fr.INNVILGET:Fr.AVSLAG;return(n?Fr.INNVILGET:Fr.AVSLAG)!==r},Hb=(e,n)=>!n||n.length<1?"":n.map(r=>e(r,On.KONSEKVENS_FOR_YTELSEN)).join(" og "),uo=(e,n,r)=>n?r?e&&"beregnetTilkjentYtelse"in n&&"beregnetTilkjentYtelse"in r?n.beregnetTilkjentYtelse!==r.beregnetTilkjentYtelse:"antallBarn"in n&&"antallBarn"in r?n.antallBarn!==r.antallBarn:!1:!0:!1,dg=(e,n,r)=>jb(n,r)?n?"VedtakForm.Resultat.EndretTilInnvilget":"VedtakForm.Resultat.EndretTilAvslag":e?uo(e,n,r)?"VedtakForm.Resultat.EndretTilkjentYtelse":"VedtakForm.Resultat.IngenEndring":uo(e,n,r)?"VedtakForm.Resultat.EndretAntallBarn":"VedtakForm.Resultat.IngenEndring",qb=(e,n,r,t,a,s,i)=>{if(n===W.ENGANGSSTONAD)return e.formatMessage({id:dg(!0,s,i)});const o=Hb(r,a);return`${o}${o!==""?t:". "}`},Yb=(e,n,r)=>e&&"opphoersdato"in e&&e.opphoersdato?e.opphoersdato:n||(r!=null&&r.skjæringstidspunkt?r.skjæringstidspunkt.dato:""),xb=e=>e.aksjonspunktKoder.map(n=>({kode:Qu(n,ue.FORESLA_VEDTAK,ue.FORESLA_VEDTAK_MANUELT,ue.VEDTAK_UTEN_TOTRINNSKONTROLL,ue.VURDERE_ANNEN_YTELSE,ue.VURDERE_DOKUMENT,ue.VURDERE_INNTEKTSMELDING_KLAGE,ue.KONTROLLER_REVURDERINGSBEHANDLING_VARSEL_VED_UGUNST,ue.KONTROLL_AV_MAUNELT_OPPRETTET_REVURDERINGSBEHANDLING),begrunnelse:e.begrunnelse,fritekstBrev:e.brødtekst,skalBrukeOverstyrendeFritekstBrev:!!e.brødtekst,overskrift:e.overskrift})),Cb=(e,n)=>{var r,t;return{aksjonspunktKoder:e.filter(a=>a.kanLoses).map(a=>a.definisjon),overskrift:zn((r=n.behandlingsresultat)==null?void 0:r.overskrift),brødtekst:zn((t=n.behandlingsresultat)==null?void 0:t.fritekstbrev)}},ug=({behandling:e,readOnly:n,aksjonspunkter:r,previewCallback:t,ytelseTypeKode:a,resultatstruktur:s,alleKodeverk:i,tilbakekrevingvalg:o,simuleringResultat:l,vilkar:g,beregningErManueltFastsatt:u,medlemskapFom:E,resultatstrukturOriginalBehandling:m,submitCallback:A,formData:c,setFormData:v})=>{const p=sn(),_=zl({defaultValues:c||Cb(r,e)}),R=_.watch("begrunnelse"),N=_.watch("overskrift"),B=_.watch("brødtekst"),{behandlingsresultat:P,sprakkode:F,behandlingÅrsaker:S}=e,b=T.useMemo(()=>Bb(e.behandlingÅrsaker),[e.behandlingÅrsaker]),G=T.useMemo(()=>Ub(S.map(j=>j.behandlingArsakType),kt(i)),[S]),U=T.useMemo(()=>eg(i,l,o),[l,o]);let H="";if(P&&ys(P.type)){const j=P!==void 0?P.konsekvenserForYtelsen:void 0;H=qb(p,a,kt(i),U,j,s,m)}P&&As(P.type)&&(H=p.formatMessage({id:dg(!1,s,m)})),P&&Pl(P.type)&&(H=p.formatMessage({id:a===W.SVANGERSKAPSPENGER?"VedtakForm.RevurderingSVP.SvangerskapspengerOpphoerer":"VedtakForm.RevurderingFP.ForeldrepengerOpphoerer"},{dato:L(Yb(s,E,P)).format(om)}));const O=lo(!0,t,N,B,R),M=lo(!1,t,N,B,R);return d.createElement(iu,{formMethods:_,onSubmit:j=>A(xb(j)),setDataOnUnmount:v},d.createElement(li,{behandling:e,vedtakstatusTekst:H,aksjonspunkter:r,readOnly:n,previewAutomatiskBrev:M,previewOverstyrtBrev:O,tilbakekrevingtekst:U,erBehandlingEtterKlage:b,renderPanel:(j,$,ae,le)=>$?d.createElement(ig,{ytelseTypeKode:a,revurderingsÅrsakString:G,isReadOnly:n,resultatstruktur:s,språkKode:F,behandlingsresultat:P,beregningErManueltFastsatt:u,skalBrukeOverstyrendeFritekstBrev:j}):ae?d.createElement(og,{vilkar:g,behandlingsresultat:P,språkKode:F,erReadOnly:n,alleKodeverk:i,skalBrukeOverstyrendeFritekstBrev:j}):le?d.createElement(lg,{revurderingsÅrsakString:G,isReadOnly:n,behandlingsresultat:P,språkKode:F,beregningErManueltFastsatt:u,skalBrukeOverstyrendeFritekstBrev:j}):null}))};ug.__docgenInfo={description:"",methods:[],displayName:"VedtakRevurderingForm",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  endretAv?: string;
  endretTidspunkt?: string;
}>`}],raw:"Aksjonspunkt[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const fe={uuid:"1",versjon:1,type:Ue.FORSTEGANGSSOKNAD,status:qe.BEHANDLING_UTREDES,sprakkode:"NO",behandlingsresultat:{type:J.INNVILGET},behandlingPaaVent:!1,behandlingHenlagt:!1,behandlingÅrsaker:[{behandlingArsakType:hn.ANNET}]},Zb=[{lovReferanse:"§§Dette er en lovreferanse",vilkarType:ps.FODSELSVILKARET_MOR,vilkarStatus:aa.OPPFYLT,overstyrbar:!0}],Eg=[{definisjon:ue.FORESLA_VEDTAK,kanLoses:!0}],Ie={antallBarn:1,beregnetTilkjentYtelse:1e4},sc={title:"prosess/prosess-vedtak",component:kg},Te=({behandling:e,beregningresultatDagytelse:n,beregningresultatEngangsstonad:r,ytelseTypeKode:t,isReadOnly:a,submitCallback:s,beregningsgrunnlag:i,aksjonspunkter:o,beregningsresultatOriginalBehandling:l,vilkar:g,previewCallback:u})=>d.createElement(kg,{behandling:e,aksjonspunkter:o||Eg,submitCallback:s,isReadOnly:a,isAksjonspunktOpen:!0,readOnlySubmitButton:!1,status:"",vilkar:g||Zb,alleMerknaderFraBeslutter:{},setFormData:()=>{},beregningresultatDagytelse:n,beregningresultatEngangsstonad:r,medlemskap:{fom:"2019-01-01"},previewCallback:u||ge("button-click"),ytelseTypeKode:t,alleKodeverk:CT,beregningsgrunnlag:i,beregningsresultatOriginalBehandling:l}),Mr=Te.bind({});Mr.args={behandling:fe,beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Vr=Te.bind({});Vr.args={behandling:{...fe,status:qe.AVSLUTTET},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const Gr=Te.bind({});Gr.args={behandling:{...fe,status:qe.AVSLUTTET,behandlingsresultat:{vedtaksbrev:"FRITEKST",overskrift:"Dette er en overskrift",fritekstbrev:"Dette er innholdet i brevet",type:J.INNVILGET}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const wr=Te.bind({});wr.args={behandling:{...fe,behandlingsresultat:{type:J.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Br=Te.bind({});Br.args={behandling:{...fe,status:qe.AVSLUTTET,behandlingsresultat:{type:J.AVSLATT}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const Ur=Te.bind({});Ur.args={behandling:fe,beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const jr=Te.bind({});jr.args={behandling:{...fe,behandlingsresultat:{type:J.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const Hr=Te.bind({});Hr.args={behandling:fe,beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},aksjonspunkter:[...Eg,{definisjon:ue.VURDERE_ANNEN_YTELSE,status:Pr.OPPRETTET,begrunnelse:void 0,kanLoses:!1,toTrinnsBehandling:!0},{definisjon:ue.VURDERE_DOKUMENT,status:Pr.OPPRETTET,begrunnelse:void 0,kanLoses:!1},{definisjon:ue.VURDERE_INNTEKTSMELDING_KLAGE,status:Pr.OPPRETTET,begrunnelse:void 0,kanLoses:!1},{definisjon:ue.KONTROLLER_REVURDERINGSBEHANDLING_VARSEL_VED_UGUNST,status:Pr.OPPRETTET,begrunnelse:void 0,kanLoses:!1,toTrinnsBehandling:!0}],isReadOnly:!1,submitCallback:ge("button-click")};const qr=Te.bind({});qr.args={behandling:fe,beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:W.ENGANGSSTONAD,isReadOnly:!1,submitCallback:ge("button-click")};const Yr=Te.bind({});Yr.args={behandling:{...fe,status:qe.AVSLUTTET},beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:W.ENGANGSSTONAD,isReadOnly:!0,submitCallback:ge("button-click")};const xr=Te.bind({});xr.args={behandling:fe,beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:W.ENGANGSSTONAD,isReadOnly:!1,submitCallback:ge("button-click")};const Cr=Te.bind({});Cr.args={behandling:fe,beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:W.ENGANGSSTONAD,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const $r=Te.bind({});$r.args={behandling:{...fe,behandlingsresultat:{type:J.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:W.ENGANGSSTONAD,isReadOnly:!1,submitCallback:ge("button-click")};const Jr=Te.bind({});Jr.args={behandling:fe,ytelseTypeKode:W.SVANGERSKAPSPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Wr=Te.bind({});Wr.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.INNVILGET,konsekvenserForYtelsen:[Ye.ENDRING_I_BEREGNING_OG_UTTAK,Ye.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const zr=Te.bind({});zr.args={behandling:{...fe,type:Ue.REVURDERING,status:qe.AVSLUTTET,behandlingsresultat:{type:J.INNVILGET,konsekvenserForYtelsen:[Ye.ENDRING_I_BEREGNING_OG_UTTAK,Ye.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Zr=Te.bind({});Zr.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.INNVILGET,konsekvenserForYtelsen:[Ye.ENDRING_I_BEREGNING_OG_UTTAK,Ye.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Xr=Te.bind({});Xr.args={behandling:{...fe,type:Ue.REVURDERING,status:qe.AVSLUTTET,behandlingsresultat:{type:J.INNVILGET,konsekvenserForYtelsen:[Ye.ENDRING_I_BEREGNING_OG_UTTAK,Ye.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const Qr=Te.bind({});Qr.args={behandling:{...fe,type:Ue.REVURDERING,status:qe.AVSLUTTET,behandlingsresultat:{vedtaksbrev:"FRITEKST",overskrift:"Dette er en overskrift",fritekstbrev:"Dette er innholdet i brevet",type:J.INNVILGET,konsekvenserForYtelsen:[Ye.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const et=Te.bind({});et.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningsresultatOriginalBehandling:{"beregningsresultat-foreldrepenger":{...Ie}},ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const nt=Te.bind({});nt.args={behandling:{...fe,type:Ue.REVURDERING,status:qe.AVSLUTTET,behandlingsresultat:{type:J.AVSLATT}},beregningsresultatOriginalBehandling:{"beregningsresultat-foreldrepenger":{...Ie}},ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const rt=Te.bind({});rt.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.OPPHOR}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const tt=Te.bind({});tt.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.INNVILGET,konsekvenserForYtelsen:[Ye.ENDRING_I_BEREGNING_OG_UTTAK]}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const at=Te.bind({});at.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.AVSLATT,konsekvenserForYtelsen:[Ye.ENDRING_I_BEREGNING_OG_UTTAK],avslagsarsak:"1007"}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},vilkar:[{lovReferanse:"§§Dette er en lovreferanse",vilkarType:ps.SOKNADFRISTVILKARET,vilkarStatus:aa.IKKE_OPPFYLT,overstyrbar:!0}],isReadOnly:!1,submitCallback:ge("button-click")};const st=Te.bind({});st.args={behandling:{...fe,type:Ue.REVURDERING,behandlingsresultat:{type:J.OPPHOR}},beregningresultatDagytelse:Ie,ytelseTypeKode:W.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};var go,ko,Eo;Mr.parameters={...Mr.parameters,docs:{...(go=Mr.parameters)==null?void 0:go.docs,source:{originalSource:`({
  behandling,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(fo=(mo=Vr.parameters)==null?void 0:mo.docs)==null?void 0:fo.source}}};var To,Ro,yo;Gr.parameters={...Gr.parameters,docs:{...(To=Gr.parameters)==null?void 0:To.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(yo=(Ro=Gr.parameters)==null?void 0:Ro.docs)==null?void 0:yo.source}}};var Ao,po,bo;wr.parameters={...wr.parameters,docs:{...(Ao=wr.parameters)==null?void 0:Ao.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(bo=(po=wr.parameters)==null?void 0:po.docs)==null?void 0:bo.source}}};var co,_o,ho;Br.parameters={...Br.parameters,docs:{...(co=Br.parameters)==null?void 0:co.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(ho=(_o=Br.parameters)==null?void 0:_o.docs)==null?void 0:ho.source}}};var So,No,Oo;Ur.parameters={...Ur.parameters,docs:{...(So=Ur.parameters)==null?void 0:So.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Oo=(No=Ur.parameters)==null?void 0:No.docs)==null?void 0:Oo.source}}};var Io,Ko,Do;jr.parameters={...jr.parameters,docs:{...(Io=jr.parameters)==null?void 0:Io.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Do=(Ko=jr.parameters)==null?void 0:Ko.docs)==null?void 0:Do.source}}};var Lo,Po,Fo;Hr.parameters={...Hr.parameters,docs:{...(Lo=Hr.parameters)==null?void 0:Lo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Fo=(Po=Hr.parameters)==null?void 0:Po.docs)==null?void 0:Fo.source}}};var Mo,Vo,Go;qr.parameters={...qr.parameters,docs:{...(Mo=qr.parameters)==null?void 0:Mo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Go=(Vo=qr.parameters)==null?void 0:Vo.docs)==null?void 0:Go.source}}};var wo,Bo,Uo;Yr.parameters={...Yr.parameters,docs:{...(wo=Yr.parameters)==null?void 0:wo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Uo=(Bo=Yr.parameters)==null?void 0:Bo.docs)==null?void 0:Uo.source}}};var jo,Ho,qo;xr.parameters={...xr.parameters,docs:{...(jo=xr.parameters)==null?void 0:jo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(qo=(Ho=xr.parameters)==null?void 0:Ho.docs)==null?void 0:qo.source}}};var Yo,xo,Co;Cr.parameters={...Cr.parameters,docs:{...(Yo=Cr.parameters)==null?void 0:Yo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Co=(xo=Cr.parameters)==null?void 0:xo.docs)==null?void 0:Co.source}}};var $o,Jo,Wo;$r.parameters={...$r.parameters,docs:{...($o=$r.parameters)==null?void 0:$o.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Wo=(Jo=$r.parameters)==null?void 0:Jo.docs)==null?void 0:Wo.source}}};var zo,Zo,Xo;Jr.parameters={...Jr.parameters,docs:{...(zo=Jr.parameters)==null?void 0:zo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Xo=(Zo=Jr.parameters)==null?void 0:Zo.docs)==null?void 0:Xo.source}}};var Qo,el,nl;Wr.parameters={...Wr.parameters,docs:{...(Qo=Wr.parameters)==null?void 0:Qo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(nl=(el=Wr.parameters)==null?void 0:el.docs)==null?void 0:nl.source}}};var rl,tl,al;zr.parameters={...zr.parameters,docs:{...(rl=zr.parameters)==null?void 0:rl.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(al=(tl=zr.parameters)==null?void 0:tl.docs)==null?void 0:al.source}}};var sl,il,ol;Zr.parameters={...Zr.parameters,docs:{...(sl=Zr.parameters)==null?void 0:sl.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(ol=(il=Zr.parameters)==null?void 0:il.docs)==null?void 0:ol.source}}};var ll,dl,ul;Xr.parameters={...Xr.parameters,docs:{...(ll=Xr.parameters)==null?void 0:ll.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(ul=(dl=Xr.parameters)==null?void 0:dl.docs)==null?void 0:ul.source}}};var gl,kl,El;Qr.parameters={...Qr.parameters,docs:{...(gl=Qr.parameters)==null?void 0:gl.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(El=(kl=Qr.parameters)==null?void 0:kl.docs)==null?void 0:El.source}}};var vl,ml,fl;et.parameters={...et.parameters,docs:{...(vl=et.parameters)==null?void 0:vl.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(yl=(Rl=nt.parameters)==null?void 0:Rl.docs)==null?void 0:yl.source}}};var Al,pl,bl;rt.parameters={...rt.parameters,docs:{...(Al=rt.parameters)==null?void 0:Al.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(bl=(pl=rt.parameters)==null?void 0:pl.docs)==null?void 0:bl.source}}};var cl,_l,hl;tt.parameters={...tt.parameters,docs:{...(cl=tt.parameters)==null?void 0:cl.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(hl=(_l=tt.parameters)==null?void 0:_l.docs)==null?void 0:hl.source}}};var Sl,Nl,Ol;at.parameters={...at.parameters,docs:{...(Sl=at.parameters)==null?void 0:Sl.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Ol=(Nl=at.parameters)==null?void 0:Nl.docs)==null?void 0:Ol.source}}};var Il,Kl,Dl;st.parameters={...st.parameters,docs:{...(Il=st.parameters)==null?void 0:Il.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
