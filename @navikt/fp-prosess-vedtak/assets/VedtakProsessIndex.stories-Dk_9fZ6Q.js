...
}>`},description:""},beregningErManueltFastsatt:{required:!0,tsType:{name:"boolean"},description:""},skalBrukeOverstyrendeFritekstBrev:{required:!0,tsType:{name:"boolean"},description:""}}};const ko=(e,r,n,t,a)=>s=>{if(s.preventDefault(),!e||(e?!!t&&!!n:!!a)){const o={fritekst:e?t:a,dokumentMal:e?Gl.FRITEKST:void 0,tittel:e?n:void 0,gjelderVedtak:!0,automatiskVedtaksbrev:e?void 0:!0};r(o)}},qb=(e=[])=>e.map(({behandlingArsakType:r})=>r).some(r=>r===Sr.ETTER_KLAGE||r===Sr.KLAGE_U_INNTK||r===Sr.KLAGE_M_INNTK),Yb=(e,r)=>{if(e===void 0||e.length<1)return;const n=[],t=e.find(s=>s===Sr.RE_ENDRING_FRA_BRUKER),a=e.filter(s=>s!==Sr.RE_ENDRING_FRA_BRUKER).map(s=>r(s,Ir.BEHANDLING_AARSAK));return t!==void 0&&n.push(r(t,Ir.BEHANDLING_AARSAK)),n.push(...a),n.join(", ")},xb=(e,r)=>{const n=e?Vn.INNVILGET:Vn.AVSLAG;return(r?Vn.INNVILGET:Vn.AVSLAG)!==n},Cb=(e,r)=>!r||r.length<1?"":r.map(n=>e(n,Ir.KONSEKVENS_FOR_YTELSEN)).join(" og "),Eo=(e,r,n)=>r?n?e&&"beregnetTilkjentYtelse"in r&&"beregnetTilkjentYtelse"in n?r.beregnetTilkjentYtelse!==n.beregnetTilkjentYtelse:"antallBarn"in r&&"antallBarn"in n?r.antallBarn!==n.antallBarn:!1:!0:!1,ug=(e,r,n)=>xb(r,n)?r?"VedtakForm.Resultat.EndretTilInnvilget":"VedtakForm.Resultat.EndretTilAvslag":e?Eo(e,r,n)?"VedtakForm.Resultat.EndretTilkjentYtelse":"VedtakForm.Resultat.IngenEndring":Eo(e,r,n)?"VedtakForm.Resultat.EndretAntallBarn":"VedtakForm.Resultat.IngenEndring",$b=(e,r,n,t,a,s,i)=>{if(r===z.ENGANGSSTONAD)return e.formatMessage({id:ug(!0,s,i)});const o=Cb(n,a);return`${o}${o!==""?t:". "}`},Jb=(e,r,n)=>e&&"opphoersdato"in e&&e.opphoersdato?e.opphoersdato:r||(n!=null&&n.skjæringstidspunkt?n.skjæringstidspunkt.dato:""),Wb=e=>e.aksjonspunktKoder.map(r=>({kode:eg(r,Ee.FORESLA_VEDTAK,Ee.FORESLA_VEDTAK_MANUELT,Ee.VURDERE_ANNEN_YTELSE,Ee.VURDERE_DOKUMENT,Ee.VURDERE_INNTEKTSMELDING_KLAGE,Ee.KONTROLLER_REVURDERINGSBEHANDLING_VARSEL_VED_UGUNST,Ee.KONTROLL_AV_MAUNELT_OPPRETTET_REVURDERINGSBEHANDLING),begrunnelse:e.begrunnelse,fritekstBrev:e.brødtekst,skalBrukeOverstyrendeFritekstBrev:!!e.brødtekst,overskrift:e.overskrift})),zb=(e,r)=>{var n,t;return{aksjonspunktKoder:e.filter(a=>a.kanLoses).map(a=>a.definisjon),overskrift:zr((n=r.behandlingsresultat)==null?void 0:n.overskrift),brødtekst:zr((t=r.behandlingsresultat)==null?void 0:t.fritekstbrev)}},gg=({behandling:e,readOnly:r,aksjonspunkter:n,previewCallback:t,ytelseTypeKode:a,resultatstruktur:s,alleKodeverk:i,tilbakekrevingvalg:o,simuleringResultat:l,vilkar:u,beregningErManueltFastsatt:d,medlemskapFom:k,resultatstrukturOriginalBehandling:m,submitCallback:y,formData:_,setFormData:v})=>{const A=ir(),h=Ql({defaultValues:_||zb(n,e)}),p=h.watch("begrunnelse"),b=h.watch("overskrift"),B=h.watch("brødtekst"),{behandlingsresultat:P,sprakkode:j,behandlingÅrsaker:N}=e,S=T.useMemo(()=>qb(e.behandlingÅrsaker),[e.behandlingÅrsaker]),G=T.useMemo(()=>Yb(N.map(q=>q.behandlingArsakType),vt(i)),[N]),U=T.useMemo(()=>rg(i,l,o),[l,o]);let H="";if(P&&ps(P.type)){const q=P!==void 0?P.konsekvenserForYtelsen:void 0;H=$b(A,a,vt(i),U,q,s,m)}P&&bs(P.type)&&(H=A.formatMessage({id:ug(!1,s,m)})),P&&Vl(P.type)&&(H=A.formatMessage({id:a===z.SVANGERSKAPSPENGER?"VedtakForm.RevurderingSVP.SvangerskapspengerOpphoerer":"VedtakForm.RevurderingFP.ForeldrepengerOpphoerer"},{dato:F(Jb(s,k,P)).format(om)}));const K=ko(!0,t,b,B,p),M=ko(!1,t,b,B,p);return E.jsx(ou,{formMethods:h,onSubmit:q=>y(Wb(q)),setDataOnUnmount:v,children:E.jsx(ui,{behandling:e,vedtakstatusTekst:H,aksjonspunkter:n,readOnly:r,previewAutomatiskBrev:M,previewOverstyrtBrev:K,tilbakekrevingtekst:U,erBehandlingEtterKlage:S,renderPanel:(q,$,se,de)=>$?E.jsx(og,{ytelseTypeKode:a,revurderingsÅrsakString:G,isReadOnly:r,resultatstruktur:s,språkKode:j,behandlingsresultat:P,beregningErManueltFastsatt:d,skalBrukeOverstyrendeFritekstBrev:q}):se?E.jsx(lg,{vilkar:u,behandlingsresultat:P,språkKode:j,erReadOnly:r,alleKodeverk:i,skalBrukeOverstyrendeFritekstBrev:q}):de?E.jsx(dg,{revurderingsÅrsakString:G,isReadOnly:r,behandlingsresultat:P,språkKode:j,beregningErManueltFastsatt:d,skalBrukeOverstyrendeFritekstBrev:q}):null})})};gg.__docgenInfo={description:"",methods:[],displayName:"VedtakRevurderingForm",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  endretAv?: string;
  endretTidspunkt?: string;
}>`}],raw:"Aksjonspunkt[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const Te={uuid:"1",versjon:1,type:Ue.FORSTEGANGSSOKNAD,status:Ye.BEHANDLING_UTREDES,sprakkode:"NO",behandlingsresultat:{type:W.INNVILGET},behandlingPaaVent:!1,behandlingHenlagt:!1,behandlingÅrsaker:[{behandlingArsakType:Sr.ANNET}]},rc=[{lovReferanse:"§§Dette er en lovreferanse",vilkarType:cs.FODSELSVILKARET_MOR,vilkarStatus:aa.OPPFYLT,overstyrbar:!0}],vg=[{definisjon:Ee.FORESLA_VEDTAK,kanLoses:!0}],De={antallBarn:1,beregnetTilkjentYtelse:1e4},lc={title:"prosess/prosess-vedtak",component:Eg},Re=({behandling:e,beregningresultatDagytelse:r,beregningresultatEngangsstonad:n,ytelseTypeKode:t,isReadOnly:a,submitCallback:s,beregningsgrunnlag:i,aksjonspunkter:o,beregningsresultatOriginalBehandling:l,vilkar:u,previewCallback:d})=>E.jsx(Eg,{behandling:e,aksjonspunkter:o||vg,submitCallback:s,isReadOnly:a,isAksjonspunktOpen:!0,readOnlySubmitButton:!1,status:"",vilkar:u||rc,alleMerknaderFraBeslutter:{},setFormData:()=>{},beregningresultatDagytelse:r,beregningresultatEngangsstonad:n,medlemskap:{fom:"2019-01-01"},previewCallback:d||ge("button-click"),ytelseTypeKode:t,alleKodeverk:zT,beregningsgrunnlag:i,beregningsresultatOriginalBehandling:l}),Gn=Re.bind({});Gn.args={behandling:Te,beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const wn=Re.bind({});wn.args={behandling:{...Te,status:Ye.AVSLUTTET},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const Bn=Re.bind({});Bn.args={behandling:{...Te,status:Ye.AVSLUTTET,behandlingsresultat:{vedtaksbrev:"FRITEKST",overskrift:"Dette er en overskrift",fritekstbrev:"Dette er innholdet i brevet",type:W.INNVILGET}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const jn=Re.bind({});jn.args={behandling:{...Te,behandlingsresultat:{type:W.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Un=Re.bind({});Un.args={behandling:{...Te,status:Ye.AVSLUTTET,behandlingsresultat:{type:W.AVSLATT}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const Hn=Re.bind({});Hn.args={behandling:Te,beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const qn=Re.bind({});qn.args={behandling:{...Te,behandlingsresultat:{type:W.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const Yn=Re.bind({});Yn.args={behandling:Te,beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},aksjonspunkter:[...vg,{definisjon:Ee.VURDERE_ANNEN_YTELSE,status:Mn.OPPRETTET,begrunnelse:void 0,kanLoses:!1,toTrinnsBehandling:!0},{definisjon:Ee.VURDERE_DOKUMENT,status:Mn.OPPRETTET,begrunnelse:void 0,kanLoses:!1},{definisjon:Ee.VURDERE_INNTEKTSMELDING_KLAGE,status:Mn.OPPRETTET,begrunnelse:void 0,kanLoses:!1},{definisjon:Ee.KONTROLLER_REVURDERINGSBEHANDLING_VARSEL_VED_UGUNST,status:Mn.OPPRETTET,begrunnelse:void 0,kanLoses:!1,toTrinnsBehandling:!0}],isReadOnly:!1,submitCallback:ge("button-click")};const xn=Re.bind({});xn.args={behandling:Te,beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:z.ENGANGSSTONAD,isReadOnly:!1,submitCallback:ge("button-click")};const Cn=Re.bind({});Cn.args={behandling:{...Te,status:Ye.AVSLUTTET},beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:z.ENGANGSSTONAD,isReadOnly:!0,submitCallback:ge("button-click")};const $n=Re.bind({});$n.args={behandling:Te,beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:z.ENGANGSSTONAD,isReadOnly:!1,submitCallback:ge("button-click")};const Jn=Re.bind({});Jn.args={behandling:Te,beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:z.ENGANGSSTONAD,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const Wn=Re.bind({});Wn.args={behandling:{...Te,behandlingsresultat:{type:W.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningresultatEngangsstonad:{antallBarn:2,beregnetTilkjentYtelse:1e4},ytelseTypeKode:z.ENGANGSSTONAD,isReadOnly:!1,submitCallback:ge("button-click")};const zn=Re.bind({});zn.args={behandling:Te,ytelseTypeKode:z.SVANGERSKAPSPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Zn=Re.bind({});Zn.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.INNVILGET,konsekvenserForYtelsen:[xe.ENDRING_I_BEREGNING_OG_UTTAK,xe.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Xn=Re.bind({});Xn.args={behandling:{...Te,type:Ue.REVURDERING,status:Ye.AVSLUTTET,behandlingsresultat:{type:W.INNVILGET,konsekvenserForYtelsen:[xe.ENDRING_I_BEREGNING_OG_UTTAK,xe.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const Qn=Re.bind({});Qn.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.INNVILGET,konsekvenserForYtelsen:[xe.ENDRING_I_BEREGNING_OG_UTTAK,xe.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const et=Re.bind({});et.args={behandling:{...Te,type:Ue.REVURDERING,status:Ye.AVSLUTTET,behandlingsresultat:{type:W.INNVILGET,konsekvenserForYtelsen:[xe.ENDRING_I_BEREGNING_OG_UTTAK,xe.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const rt=Re.bind({});rt.args={behandling:{...Te,type:Ue.REVURDERING,status:Ye.AVSLUTTET,behandlingsresultat:{vedtaksbrev:"FRITEKST",overskrift:"Dette er en overskrift",fritekstbrev:"Dette er innholdet i brevet",type:W.INNVILGET,konsekvenserForYtelsen:[xe.FORELDREPENGER_OPPHORER]}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const nt=Re.bind({});nt.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.AVSLATT,avslagsarsakFritekst:"Dette er ein fritekst"}},beregningsresultatOriginalBehandling:{"beregningsresultat-foreldrepenger":{...De}},ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!1,submitCallback:ge("button-click")};const tt=Re.bind({});tt.args={behandling:{...Te,type:Ue.REVURDERING,status:Ye.AVSLUTTET,behandlingsresultat:{type:W.AVSLATT}},beregningsresultatOriginalBehandling:{"beregningsresultat-foreldrepenger":{...De}},ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const at=Re.bind({});at.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.OPPHOR}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,isReadOnly:!0,submitCallback:ge("button-click")};const st=Re.bind({});st.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.INNVILGET,konsekvenserForYtelsen:[xe.ENDRING_I_BEREGNING_OG_UTTAK]}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};const it=Re.bind({});it.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.AVSLATT,konsekvenserForYtelsen:[xe.ENDRING_I_BEREGNING_OG_UTTAK],avslagsarsak:"1007"}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},vilkar:[{lovReferanse:"§§Dette er en lovreferanse",vilkarType:cs.SOKNADFRISTVILKARET,vilkarStatus:aa.IKKE_OPPFYLT,overstyrbar:!0}],isReadOnly:!1,submitCallback:ge("button-click")};const ot=Re.bind({});ot.args={behandling:{...Te,type:Ue.REVURDERING,behandlingsresultat:{type:W.OPPHOR}},beregningresultatDagytelse:De,ytelseTypeKode:z.FORELDREPENGER,beregningsgrunnlag:{beregningsgrunnlagPeriode:[{beregningsgrunnlagPrStatusOgAndel:[{overstyrtPrAar:0}]}]},isReadOnly:!1,submitCallback:ge("button-click")};var vo,mo,fo;Gn.parameters={...Gn.parameters,docs:{...(vo=Gn.parameters)==null?void 0:vo.docs,source:{originalSource:`({
  behandling,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Oo=(No=Un.parameters)==null?void 0:No.docs)==null?void 0:Oo.source}}};var Io,Ko,Do;Hn.parameters={...Hn.parameters,docs:{...(Io=Hn.parameters)==null?void 0:Io.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Do=(Ko=Hn.parameters)==null?void 0:Ko.docs)==null?void 0:Do.source}}};var Lo,Po,Fo;qn.parameters={...qn.parameters,docs:{...(Lo=qn.parameters)==null?void 0:Lo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(Fo=(Po=qn.parameters)==null?void 0:Po.docs)==null?void 0:Fo.source}}};var Mo,Vo,Go;Yn.parameters={...Yn.parameters,docs:{...(Mo=Yn.parameters)==null?void 0:Mo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(jo=(Bo=xn.parameters)==null?void 0:Bo.docs)==null?void 0:jo.source}}};var Uo,Ho,qo;Cn.parameters={...Cn.parameters,docs:{...(Uo=Cn.parameters)==null?void 0:Uo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
  ...
  fom: '2019-01-01'
} as Medlemskap)} previewCallback={previewCallback || (action('button-click') as any)} ytelseTypeKode={ytelseTypeKode} alleKodeverk={(alleKodeverk as any)} beregningsgrunnlag={beregningsgrunnlag} beregningsresultatOriginalBehandling={beregningsresultatOriginalBehandling} />`,...(qo=(Ho=Cn.parameters)==null?void 0:Ho.docs)==null?void 0:qo.source}}};var Yo,xo,Co;$n.parameters={...$n.parameters,docs:{...(Yo=$n.parameters)==null?void 0:Yo.docs,source:{originalSource:`({
  behandling,
  beregningresultatDagytelse,
  beregningresultatEngangsstonad,
  ytelseTypeKode,
