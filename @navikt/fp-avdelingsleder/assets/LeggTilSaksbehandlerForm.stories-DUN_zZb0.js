import{V as b,H as E,I as N,J as j,L as a,h as t,b as l}from"./fplosAvdelingslederApi-FmGpUzRG.js";import{c as w,u as y,r as f,j as e,t as H,w as F}from"./iframe-BLyRts3h.js";import{L as K,M as i,B as D,g as P,m as O}from"./nb_NO-C77tIkhS.js";import{a as C,P as M,T as U}from"./index.es-BVKqoiUL.js";import{u as L}from"./useMutation-DzXNa3Ty.js";import{B as S}from"./Modal-Bba27sDe.js";import"./BasePrimitive-DJPsNKbV.js";import"./preload-helper-PPVm8Dsz.js";import"./index.es-CpwAqXbi.js";import"./index-BVuHI-tD.js";const q="_button_1e008_1",z={button:q},A=({valgtAvdelingEnhet:v,avdelingensSaksbehandlere:T})=>{const R=w(),g=y(),r=C(),{mutate:_,data:s,status:c,reset:h}=L({mutationFn:n=>N(n.brukerIdent)}),{mutate:I,isPending:o}=L({mutationFn:n=>j(n.brukerIdent,n.avdelingEnhet),onSuccess:()=>{h(),r.reset(),R.invalidateQueries({queryKey:[a.SAKSBEHANDLERE_FOR_AVDELING]})}}),k=T.some(n=>s&&n.brukerIdent.toLowerCase()===s.brukerIdent.toLowerCase()),x=()=>{s&&I({brukerIdent:s.brukerIdent,avdelingEnhet:v})},B=f.useMemo(()=>c==="success"&&!s?g.formatMessage({id:"LeggTilSaksbehandlerForm.FinnesIkke"}):s?k?`${s.navn} (${g.formatMessage({id:"LeggTilSaksbehandlerForm.FinnesAllerede"})})`:s.navn:"",[c,s,k]);return e.jsx(M,{formMethods:r,onSubmit:n=>_({brukerIdent:n.brukerIdent}),children:e.jsxs(b,{gap:"space-16",children:[e.jsx(K,{size:"small",children:e.jsx(i,{id:"LeggTilSaksbehandlerForm.LeggTil"})}),e.jsxs(E,{gap:"space-16",children:[e.jsx(U,{name:"brukerIdent",control:r.control,label:g.formatMessage({id:"LeggTilSaksbehandlerForm.Brukerident"}),validate:[H]}),e.jsx("div",{className:z.button,children:e.jsx(S,{size:"small",variant:"secondary",loading:r.formState.isSubmitting,disabled:r.formState.isSubmitting||o,tabIndex:0,children:e.jsx(i,{id:"LeggTilSaksbehandlerForm.Sok"})})})]}),c==="success"&&e.jsxs(b,{gap:"space-8",children:[e.jsx(D,{size:"small",children:B}),e.jsxs(E,{gap:"space-16",children:[e.jsx(S,{size:"small",variant:"primary",autoFocus:!0,onClick:()=>x(),loading:o,disabled:o||k||!s,type:"button",children:e.jsx(i,{id:"LeggTilSaksbehandlerForm.LeggTilIListen"})}),e.jsx(S,{size:"small",variant:"secondary",tabIndex:0,disabled:o,onClick:()=>{h(),r.reset()},type:"button",children:e.jsx(i,{id:"LeggTilSaksbehandlerForm.Nullstill"})})]})]})]})})};A.__docgenInfo={description:"",methods:[],displayName:"LeggTilSaksbehandlerForm",props:{valgtAvdelingEnhet:{required:!0,tsType:{name:"string"},description:""},avdelingensSaksbehandlere:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  brukerIdent: string;
  navn: string;
