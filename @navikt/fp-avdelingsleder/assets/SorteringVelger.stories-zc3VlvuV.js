import{w as p,j as n}from"./iframe-CCFQyhPp.js";import{a as d,C as S}from"./index.es-C8ZP6_50.js";import{Q as u}from"./index.es-B2qjYdPO.js";import{u as c}from"./useQuery-DZ0O7Bbz.js";import{h as e,L as r,b as s,l as E}from"./fplosAvdelingslederApi-ChUQrZEV.js";import{S as l,K as T}from"./SorteringVelger-DvhK1KyI.js";import{g as v,m as k}from"./nb_NO-D_fTjNdm.js";import{a as y}from"./useLosKodeverk-TGpUCdNF.js";import"./preload-helper-PPVm8Dsz.js";import"./Modal-J1YK6MK1.js";import"./index-B1FjtvL8.js";import"./BasePrimitive-D9tFULlc.js";import"./useMutation-B_UX37KR.js";import"./useDebounce-BGK8vvuL.js";const B=v(k),w={title:"los/avdelingsleder/behandlingskoer/SorteringVelger",component:l,decorators:[B,p],parameters:{msw:{handlers:[e.get(r.KODEVERK_LOS,()=>s.json(y)),e.post(r.LAGRE_SAKSLISTE_SORTERING,()=>new s(null,{status:200})),e.post(r.LAGRE_SAKSLISTE_SORTERING_INTERVALL,()=>new s(null,{status:200})),e.post(r.LAGRE_SAKSLISTE_SORTERING_DYNAMISK_PERIDE,()=>new s(null,{status:200})),e.post(r.LAGRE_SAKSLISTE_SORTERING_TIDSINTERVALL_DATO,()=>new s(null,{status:200}))]}},args:{valgtSakslisteId:1,valgtAvdelingEnhet:"Nav Vikafossen"},render:i=>{const g=d({defaultValues:{sortering:T.BEHANDLINGSFRIST,fra:2,til:3,fomDato:"2020-01-10",tomDato:"2020-10-01",erDynamiskPeriode:i.erDynamiskPeriode}}),{data:m}=c(E());return m?n.jsx(S,{formMethods:g,children:n.jsx(l,{...i})}):n.jsx(u,{})}},a={args:{valgteBehandlingtyper:["BT-002","BT-006"],erDynamiskPeriode:!1}},t={args:{valgteBehandlingtyper:["BT-002","BT-006"],erDynamiskPeriode:!0}},o={args:{valgteBehandlingtyper:["BT-007"],erDynamiskPeriode:!1}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
