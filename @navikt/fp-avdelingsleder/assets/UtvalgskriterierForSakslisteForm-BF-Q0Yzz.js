import{u as g,j as r}from"./iframe-C5MiiFGG.js";import{a as y}from"./index-DhuMM0n2.js";import{N as p,P as c}from"./index.es-pfXiA5HI.js";import{t as f,a as b,o as k,D as T}from"./index.es-DKf4ovJt.js";import{u as h,V as u,H as D,f as I,L as j}from"./fplosAvdelingslederApi-DhjTSEd9.js";import{u as x}from"./useMutation-B_Kgrwpz.js";import{a as K}from"./AndreKriterierVelger-PBjFmV6_.js";import{B as q}from"./BehandlingstypeVelger-BnA8FK4e.js";import{F as v}from"./FagsakYtelseTypeVelger-CGmUvxtD.js";import{S as F}from"./SorteringVelger-CGkiVRWl.js";import{u as w}from"./useDebounce-3tQN7hkb.js";import{B as N}from"./Box-DtIMwfwE.js";import{H as V,M as P}from"./nb_NO-BHyDhga3.js";const R="_bredde_grd8c_1",U={bredde:R},_=b(3),A=k(100),L=(n,e)=>{const d=e.behandlingTyper?e.behandlingTyper.reduce((s,i)=>({...s,[i]:!0}),{}):{},o=e.fagsakYtelseTyper?e.fagsakYtelseTyper.reduce((s,i)=>({...s,[i]:!0}),{}):{},m=e.andreKriterier?e.andreKriterier.reduce((s,i)=>({...s,[i.andreKriterierType]:!0}),{}):{},t=e.andreKriterier?e.andreKriterier.reduce((s,i)=>({...s,[`${i.andreKriterierType}_inkluder`]:i.inkluder}),{}):{};return{sakslisteId:e.sakslisteId,navn:e.navn??n.formatMessage({id:"UtvalgskriterierForSakslisteForm.NyListe"}),sortering:e.sortering?e.sortering.sorteringType:void 0,fomDato:e.sortering?e.sortering.fomDato:void 0,tomDato:e.sortering?e.sortering.tomDato:void 0,fra:e.sortering?e.sortering.fra?.toString():void 0,til:e.sortering?e.sortering.til?.toString():void 0,erDynamiskPeriode:e.sortering?e.sortering.erDynamiskPeriode:void 0,...m,...t,...d,...o}},M=({valgtSaksliste:n,valgtAvdelingEnhet:e})=>{const d=h(),o=g(),{mutate:m}=x({mutationFn:a=>I(a.sakslisteId,a.navn,a.avdelingEnhet),onSuccess:()=>{d.invalidateQueries({queryKey:[j.SAKSLISTER_FOR_AVDELING]})}}),t=y({defaultValues:L(o,n)}),s=t.watch(),l=w("navn",a=>{m({sakslisteId:n.sakslisteId,navn:a,avdelingEnhet:e})},t.trigger);return r.jsx(p,{formMethods:t,children:r.jsx(N.New,{padding:"5",borderColor:"neutral-subtle",borderRadius:"0",borderWidth:"1",children:r.jsxs(u,{gap:"space-8",children:[r.jsx(V,{size:"small",level:"2",children:r.jsx(P,{id:"UtvalgskriterierForSakslisteForm.Utvalgskriterier"})}),r.jsxs(u,{gap:"space-16",children:[r.jsx(c,{name:"navn",control:t.control,label:o.formatMessage({id:"UtvalgskriterierForSakslisteForm.Navn"}),validate:[f,_,A,T],onChange:a=>l(a),className:U.bredde}),r.jsxs(D,{justify:"space-between",children:[r.jsxs(u,{gap:"space-16",children:[r.jsx(v,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e}),r.jsx(q,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})]}),r.jsx("div",{children:r.jsx(K,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})}),r.jsx("div",{children:r.jsx(F,{valgtSakslisteId:n.sakslisteId,valgteBehandlingtyper:n.behandlingTyper,valgtAvdelingEnhet:e,erDynamiskPeriode:!!s.erDynamiskPeriode})})]})]})]})})})};M.__docgenInfo={description:"",methods:[],displayName:"UtvalgskriterierForSakslisteForm",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn?: string;
