import{u as I,V as f,Z as y,L as c,h,b as k}from"./fplosAvdelingslederApi-DhjTSEd9.js";import{r as D,j as e,w as E}from"./iframe-C5MiiFGG.js";import{B as H,M as t,g as T,m as w}from"./nb_NO-BHyDhga3.js";import{u as C}from"./useMutation-B_Kgrwpz.js";import{S as R}from"./SletteSaksbehandlerModal-REchpnYW.js";import{T as n}from"./Table-DdeBiLcz.js";import{S as _}from"./Modal-DC8aCGhM.js";import"./BasePrimitive-DyD0Wl37.js";import"./preload-helper-D9Z9MdNV.js";import"./index-NoJYJMfq.js";const M="_removeIcon_16jh0_1",N={removeIcon:M},b=({saksbehandlere:S,valgtAvdelingEnhet:A})=>{const j=I(),[m,r]=D.useState(),{mutate:x}=C({mutationFn:a=>y(a.brukerIdent,A),onSuccess:()=>{j.invalidateQueries({queryKey:[c.SAKSBEHANDLERE_FOR_AVDELING]}),r(void 0)}}),i=S.toSorted((a,g)=>{const p=(s,u)=>s!=null&&u!=null?s.localeCompare(u):s==null&&u==null?0:s==null?1:-1,v=p(a.ansattAvdeling,g.ansattAvdeling);return v!==0?v:p(a.navn,g.navn)});return e.jsxs(f,{gap:"space-8",children:[i.length===0&&e.jsx(H,{size:"small",children:e.jsx(t,{id:"SaksbehandlereTabell.IngenSaksbehandlere"})}),i.length>0&&e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(t,{id:"SaksbehandlereTabell.Navn"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(t,{id:"SaksbehandlereTabell.Brukerident"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(t,{id:"SaksbehandlereTabell.AnsattVed"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:i.map(a=>e.jsxs(n.Row,{children:[e.jsx(n.DataCell,{scope:"row",children:a.navn}),e.jsx(n.DataCell,{children:a.brukerIdent}),e.jsx(n.DataCell,{children:a.ansattAvdeling}),e.jsx(n.DataCell,{children:e.jsx(_,{className:N.removeIcon,onMouseDown:()=>r(a),onKeyDown:()=>r(a)})})]},a.brukerIdent))})]}),m&&e.jsx(R,{valgtSaksbehandler:m,closeSletteModal:()=>r(void 0),fjernSaksbehandler:x})]})};b.__docgenInfo={description:"",methods:[],displayName:"SaksbehandlereTabell",props:{saksbehandlere:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  brukerIdent: string;
  navn: string;
