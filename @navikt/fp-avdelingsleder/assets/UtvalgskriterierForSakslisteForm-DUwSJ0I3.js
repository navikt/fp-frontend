import{c as d,u as E,j as r,t as R,d as y,o as g,D as I}from"./iframe-DS1xKNdJ.js";import{a as p,P as A,b as N}from"./index.es-DFXoxTXG.js";import{u as K}from"./useMutation-D7r8xf2y.js";import{V as u,H as _,f as D,L as v}from"./fplosAvdelingslederApi-DS4zsLv5.js";import{A as B}from"./AndreKriterierVelger-QiNxdfSf.js";import{B as S}from"./BehandlingstypeVelger-B72JKigU.js";import{F as c}from"./FagsakYtelseTypeVelger-BICA9ehf.js";import{S as L}from"./SorteringVelger-B2KxXX4A.js";import{u as f}from"./useDebounce-ZN6cSbNN.js";import{B as b}from"./Box-VF6YJQ7L.js";import{H as k,M as U}from"./nb_NO-HBhw1C8U.js";const F="_bredde_grd8c_1",P={bredde:F},h=y(3),O=g(100),V=(n,e)=>{const o=e.behandlingTyper?e.behandlingTyper.reduce((a,i)=>({...a,[i]:!0}),{}):{},s=e.fagsakYtelseTyper?e.fagsakYtelseTyper.reduce((a,i)=>({...a,[i]:!0}),{}):{},m=e.andreKriterier?e.andreKriterier.reduce((a,i)=>({...a,[i.andreKriterierType]:!0}),{}):{},l=e.andreKriterier?e.andreKriterier.reduce((a,i)=>({...a,[`${i.andreKriterierType}_inkluder`]:i.inkluder}),{}):{};return{sakslisteId:e.sakslisteId,navn:e.navn??n.formatMessage({id:"UtvalgskriterierForSakslisteForm.NyListe"}),sortering:e.sortering?e.sortering.sorteringType:void 0,fomDato:e.sortering?e.sortering.fomDato:void 0,tomDato:e.sortering?e.sortering.tomDato:void 0,fra:e.sortering?e.sortering.fra?.toString():void 0,til:e.sortering?e.sortering.til?.toString():void 0,erDynamiskPeriode:e.sortering?e.sortering.erDynamiskPeriode:void 0,...m,...l,...o,...s}},G=({valgtSaksliste:n,valgtAvdelingEnhet:e})=>{const o=d(),s=E(),{mutate:m}=K({mutationFn:t=>D(t.sakslisteId,t.navn,t.avdelingEnhet),onSuccess:()=>{o.invalidateQueries({queryKey:[v.SAKSLISTER_FOR_AVDELING]})}}),l=p({defaultValues:V(s,n)}),a=l.watch(),T=f("navn",t=>{m({sakslisteId:n.sakslisteId,navn:t,avdelingEnhet:e})},l.trigger);return r.jsx(A,{formMethods:l,children:r.jsx(b.New,{padding:"5",borderColor:"neutral-subtle",borderRadius:"0",borderWidth:"1",children:r.jsxs(u,{gap:"space-8",children:[r.jsx(k,{size:"small",level:"2",children:r.jsx(U,{id:"UtvalgskriterierForSakslisteForm.Utvalgskriterier"})}),r.jsxs(u,{gap:"space-16",children:[r.jsx(N,{name:"navn",control:l.control,label:s.formatMessage({id:"UtvalgskriterierForSakslisteForm.Navn"}),validate:[R,h,O,I],onChange:t=>T(t),className:P.bredde}),r.jsxs(_,{justify:"space-between",children:[r.jsxs(u,{gap:"space-16",children:[r.jsx(c,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e}),r.jsx(S,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})]}),r.jsx("div",{children:r.jsx(B,{valgtSakslisteId:n.sakslisteId,valgtAvdelingEnhet:e})}),r.jsx("div",{children:r.jsx(L,{valgtSakslisteId:n.sakslisteId,valgteBehandlingtyper:n.behandlingTyper,valgtAvdelingEnhet:e,erDynamiskPeriode:!!a.erDynamiskPeriode})})]})]})]})})})};G.__docgenInfo={description:"",methods:[],displayName:"UtvalgskriterierForSakslisteForm",props:{valgtSaksliste:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn?: string;
