import{j as e}from"./dayjs.min-BmqYrIeh.js";import{u as nn,H as ge,x as me,a as Y,W as A,D as pe,U as V,b as $,z as ke,M as g,K as O,O as E,c as S,d as H,L as Le,B as N,Z as ye,T as ve,p as be,r as rn,A as i,y as v,F as C,e as z,S as sn,V as an,h as X,R as ee,g as tn,f as ln,i as fe,j as on,Y as dn,k as un,l as de,m as gn,v as mn,n as B,E as pn,t as kn,P as yn,o as vn,q as M,s as F,w as bn,C as fn,G as qn}from"./style-tFzwxCX-.js";import{r as k}from"./index-uubelm5h.js";import"./v4-CQkTLCs1.js";import"./index-BdzLX9oW.js";const jn={NORGE:"NOR"};var cn=function(n,r){var s={};for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&r.indexOf(t)<0&&(s[t]=n[t]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var a=0,t=Object.getOwnPropertySymbols(n);a<t.length;a++)r.indexOf(t[a])<0&&Object.prototype.propertyIsEnumerable.call(n,t[a])&&(s[t[a]]=n[t[a]]);return s};const Tn=k.forwardRef((n,r)=>{var{title:s,titleId:t}=n,a=cn(n,["title","titleId"]);let o=nn();return o=s?t||"title-"+o:void 0,k.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",fill:"none",viewBox:"0 0 24 24",focusable:!1,role:"img",ref:r,"aria-labelledby":o},a),s?k.createElement("title",{id:o},s):null,k.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M18.998 6.94a.75.75 0 0 1 .063 1.058l-8 9a.75.75 0 0 1-1.091.032l-5-5a.75.75 0 1 1 1.06-1.06l4.438 4.437 7.471-8.405A.75.75 0 0 1 19 6.939",clipRule:"evenodd"}))}),Pn=["MedlemskapEndringerTabell.GjeldeneFom","MedlemskapEndringerTabell.Opplysning"],Ke=({perioder:n,velgPeriodeCallback:r,valgtPeriodeVurderingsdato:s,aksjonspunkter:t})=>e.jsx(ge,{headerTextCodes:Pn,children:n.map(a=>e.jsxs(me,{id:a.vurderingsdato,onMouseDown:r,onKeyDown:r,isSelected:a.vurderingsdato===s,model:a,isApLeftBorder:a.aksjonspunkter.some(o=>t.some(l=>l.definisjon===o&&l.status===Y.OPPRETTET))&&a.begrunnelse===void 0,children:[e.jsx(A,{children:e.jsx(pe,{dateString:a.vurderingsdato})}),e.jsx(A,{children:a.årsaker.join()})]},a.vurderingsdato))});Ke.__docgenInfo={description:"",methods:[],displayName:"MedlemskapEndringerTabell",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  endretAv?: string;
  endretTidspunkt?: string;
}>`}],raw:"Aksjonspunkt[]"},description:""}}};const hn=["OppholdstillatelseTabell.Periode","OppholdstillatelseTabell.Type"],Ue=({oppholdstillatelse:n,alleKodeverk:r})=>e.jsx(V,{title:$().formatMessage({id:"OppholdstillatelseTabell.Overskrift"}),children:e.jsx(ge,{headerTextCodes:hn,noHover:!0,children:n.map(s=>{var t;return e.jsxs(me,{children:[e.jsxs(A,{children:[s.fom&&e.jsx(ke,{dateStringFom:s.fom,dateStringTom:s.tom}),!s.fom&&e.jsxs("span",{children:[e.jsx(g,{id:"OppholdstillatelseTabell.Ukjent"}),"-",e.jsx(pe,{dateString:s.tom})]})]}),e.jsx(A,{children:(t=r[O.OPPHOLDSTILLATELSE_TYPE].find(a=>a.kode===s.oppholdstillatelseType))==null?void 0:t.navn})]},s.fom+s.tom)})})});Ue.__docgenInfo={description:"",methods:[],displayName:"OppholdstillatelseTabell",props:{oppholdstillatelse:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fom?: string;
  tom: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Q=n=>n??"",Rn=(n="",r="",s="",t="")=>`${Q(n)}, ${Q(r)} ${Q(s)} ${Q(t)}`,Ge=(n=[])=>n.reduce((r,s)=>{if(!s.adresseType||s.adresseType===E.UKJENT_ADRESSE)return{...r,[E.BOSTEDSADRESSE]:"UKJENT"};const t=[s.adresselinje1,s.adresselinje2,s.adresselinje3].filter(o=>!!o).join(", ");if(!t)return r;const a=s.land!==jn.NORGE?s.land:void 0;return{...r,[s.adresseType]:Rn(t,s.postNummer,s.poststed,a).trim()}},{}),wn="_dodEtikett_izib4_1",An="_defaultBostedSoker_izib4_6",On="_etikettMargin_izib4_10",Mn="_paddingBottom_izib4_14",I={dodEtikett:wn,defaultBostedSoker:An,etikettMargin:On,paddingBottom:Mn},Vn=n=>{const r=Ge(n);return r[E.POSTADRESSE]||r[E.BOSTEDSADRESSE]||"-"},Sn=n=>{const r=Ge(n);return r[E.POSTADRESSE_UTLAND]||r[E.MIDLERTIDIG_POSTADRESSE_UTLAND]||"-"},ue=({personopplysninger:n,sokerTypeText:r,regionTypes:s,personstatusTypes:t})=>{var o,l;const a=$();return e.jsx("div",{className:I.defaultBostedSoker,children:e.jsxs(S,{justify:"space-between",children:[e.jsxs("div",{children:[e.jsx(H,{children:r}),e.jsx(Le,{size:"small",children:n.navn?n.navn:"-"}),e.jsx(N,{size:"small",className:I.paddingBottom,children:Vn(n.adresser)}),e.jsx(H,{children:e.jsx(g,{id:"BostedSokerView.ForeignAddresse"})}),e.jsx(N,{size:"small",children:Sn(n.adresser)})]}),e.jsxs("div",{children:[n.personstatus&&e.jsx("div",{className:I.etikettMargin,children:e.jsx(ye,{content:a.formatMessage({id:"Personstatus.Hjelpetekst"}),alignBottom:!0,children:e.jsx(ve,{className:n.personstatus===be.DOD?I.dodEtikett:"",variant:"warning",children:n.personstatus===be.UDEFINERT?a.formatMessage({id:"Personstatus.Ukjent"}):(o=t.find(m=>m.kode===n.personstatus))==null?void 0:o.navn})})}),n.region&&n.region!==rn.UDEFINERT&&e.jsx("div",{className:I.etikettMargin,children:e.jsx(ye,{content:a.formatMessage({id:"BostedSokerView.Region"}),alignBottom:!0,children:e.jsx(ve,{variant:"warning",children:(l=s.find(m=>m.kode===n.region))==null?void 0:l.navn})})})]})]})})};ue.__docgenInfo={description:"",methods:[],displayName:"MedlemskapBostedSokerView",props:{personopplysninger:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  navn: string;
  personstatus: string;
  region: string;
  adresser: Personadresse[];
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const Bn="_dodEtikett_1a9q7_1",En="_col_1a9q7_6",Nn="_exclamationmarkIcon_1a9q7_10",Fn="_checkmarkIcon_1a9q7_16",ne={dodEtikett:Bn,col:En,exclamationmarkIcon:Nn,checkmarkIcon:Fn},Dn=n=>{const r=n.toLowerCase();return r.charAt(0).toUpperCase()+r.slice(1)},oe=(n,r)=>n!==void 0?e.jsxs(S,{gap:"4",children:[n===!0&&e.jsx(Tn,{className:ne.checkmarkIcon,title:r.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.Opphold"})}),n!==!0&&e.jsx(sn,{className:ne.exclamationmarkIcon,title:r.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.IkkeOpphold"})}),e.jsx(N,{size:"small",children:e.jsx(g,{id:n===!0?"OppholdINorgeOgAdresserFaktaPanel.Yes":"OppholdINorgeOgAdresserFaktaPanel.No"})})]}):null,qe=n=>n&&n.map(r=>e.jsx("div",{children:e.jsxs(S,{gap:"4",children:[e.jsx(N,{size:"small",children:Dn(r.landNavn)}),e.jsx(N,{size:"small",children:e.jsx(ke,{showTodayString:!0,dateStringFom:r.fom,dateStringTom:r.tom})})]})},`${r.landNavn}${r.fom}${r.tom}`)),se=({soknad:n,valgtPeriode:r,aksjonspunkter:s,readOnly:t,alleKodeverk:a,alleMerknaderFraBeslutter:o})=>{var q,f,R,T,j;const l=$(),m=r.aksjonspunkter.find(u=>u===i.AVKLAR_OM_BRUKER_ER_BOSATT),p=s.find(u=>m===u.definisjon),y=m&&p?p.status!==Y.OPPRETTET:!1,{personopplysningBruker:b,personopplysningAnnenPart:d}=r,w=k.useCallback((...u)=>e.jsx("b",{children:u}),[]);return e.jsx(V,{merknaderFraBeslutter:o[i.AVKLAR_OM_BRUKER_ER_BOSATT],children:e.jsxs(S,{children:[e.jsx("div",{className:ne.col,children:e.jsxs(V,{withoutBorder:!0,title:l.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.OppholdINorge"}),children:[e.jsx(H,{children:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.StayingInNorway"})}),e.jsx(v,{fourPx:!0}),oe((q=n==null?void 0:n.oppgittTilknytning)==null?void 0:q.oppholdNorgeNa,l),e.jsx(v,{sixteenPx:!0}),e.jsx(H,{children:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.StayingInNorwayLast12"})}),e.jsx(v,{fourPx:!0}),oe((f=n==null?void 0:n.oppgittTilknytning)==null?void 0:f.oppholdSistePeriode,l),e.jsx(v,{eightPx:!0}),qe((R=n==null?void 0:n.oppgittTilknytning)==null?void 0:R.utlandsoppholdFor),e.jsx(v,{sixteenPx:!0}),e.jsx(H,{children:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.StayingInNorwayNext12"})}),e.jsx(v,{fourPx:!0}),oe((T=n==null?void 0:n.oppgittTilknytning)==null?void 0:T.oppholdNestePeriode,l),e.jsx(v,{eightPx:!0}),qe((j=n==null?void 0:n.oppgittTilknytning)==null?void 0:j.utlandsoppholdEtter)]})}),e.jsxs("div",{className:ne.col,children:[e.jsxs(V,{withoutBorder:!0,title:l.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.BosattAdresser"}),children:[e.jsx(ue,{sokerTypeText:l.formatMessage({id:"BostedSokerFaktaIndex.Soker"}),personopplysninger:b,regionTypes:a[O.REGION],personstatusTypes:a[O.PERSONSTATUS_TYPE]}),d&&e.jsx(ue,{sokerTypeText:l.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.Parent"}),personopplysninger:d,regionTypes:a[O.REGION],personstatusTypes:a[O.PERSONSTATUS_TYPE]})]}),m&&e.jsx(C,{name:"bosattVurdering",hideLegend:!0,validate:[z],isReadOnly:t,isHorizontal:!0,isEdited:y,isTrueOrFalseSelection:!0,radios:[{label:l.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.ResidingInNorway"}),value:"true"},{label:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.NotResidingInNorway",values:{b:w}}),value:"false"}]})]})]})})};se.buildInitialValues=n=>({bosattVurdering:n.bosattVurdering||n.bosattVurdering===!1?n.bosattVurdering:void 0});se.__docgenInfo={description:`OppholdINorgeOgAdresserFaktaPanel

Er tilknyttet faktapanelet for medlemskap.
Viser opphold i innland og utland som er relevante for søker. ReadOnly.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"periode",optional:!1,type:null}],returns:null}],displayName:"OppholdINorgeOgAdresserFaktaPanel"};const In=["PerioderMedMedlemskapFaktaPanel.Period","PerioderMedMedlemskapFaktaPanel.Coverage","PerioderMedMedlemskapFaktaPanel.Status","PerioderMedMedlemskapFaktaPanel.Date"],ae=({valgtPeriode:n,readOnly:r,alleKodeverk:s,alleMerknaderFraBeslutter:t,medlemskap:a,soknad:o,aksjonspunkter:l})=>{const m=$(),p=s[O.MEDLEMSKAP_MANUELL_VURDERING_TYPE],y=k.useMemo(()=>[...p].sort((u,P)=>u.navn.localeCompare(P.navn)),[]),b=k.useMemo(()=>[...a.medlemskapPerioder].sort((u,P)=>new Date(u.fom).getTime()-new Date(P.fom).getTime()),[a.medlemskapPerioder]);if(!b||b.length===0)return e.jsx(V,{title:m.formatMessage({id:"PerioderMedMedlemskapFaktaPanel.ApplicationInformation"}),children:e.jsx(N,{size:"small",children:e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.NoInformation"})})});const d=n.aksjonspunkter.find(u=>u===i.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE),w=l.find(u=>d===u.definisjon),q=w?w.status!==Y.OPPRETTET:!1,f=tn(s),R=o.fodselsdatoer?Object.values(o.fodselsdatoer)[0]:void 0,{omsorgsovertakelseDato:T,termindato:j}=o;return e.jsxs(V,{title:m.formatMessage({id:"PerioderMedMedlemskapFaktaPanel.ApplicationInformation"}),merknaderFraBeslutter:t[i.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE],children:[e.jsx(ge,{headerTextCodes:In,noHover:!0,children:b.map(u=>{const P=f(u.dekningType,O.MEDLEMSKAP_DEKNING),J=f(u.medlemskapType,O.MEDLEMSKAP_TYPE),Z=u.fom+u.tom+P+J+u.beslutningsdato;return e.jsxs(me,{id:Z,children:[e.jsx(A,{children:e.jsx(ke,{showTodayString:!0,dateStringFom:u.fom,dateStringTom:u.tom})}),e.jsx(A,{children:P}),e.jsx(A,{children:J}),e.jsx(A,{children:u.beslutningsdato?e.jsx(pe,{dateString:u.beslutningsdato}):null})]},Z)})}),e.jsxs(an,{children:[e.jsx(S,{children:d&&e.jsx(C,{name:"medlemskapManuellVurderingType",hideLegend:!0,isEdited:q,validate:[z],isReadOnly:r,isHorizontal:!0,radios:y.map(u=>({label:u.navn,value:u.kode}))})}),e.jsxs(S,{justify:"end",children:[R&&e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.Fodselsdato",values:{dato:X(R).format(ee)}}),j&&e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.Termindato",values:{dato:X(j).format(ee)}}),T&&e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.Omsorgsovertakelse",values:{dato:X(T).format(ee)}})]})]})]})};ae.buildInitialValues=(n,r)=>r!==null?{medlemskapManuellVurderingType:n.medlemskapManuellVurderingType}:{};ae.__docgenInfo={description:`PerioderMedMedlemskapFaktaPanel

Setter opp aksjonspunktet for avklaring av perioder (Medlemskapsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"periode",optional:!1,type:null},{name:"medlemskapPerioder",optional:!1,type:null}],returns:null}],displayName:"PerioderMedMedlemskapFaktaPanel"};const te=({valgtPeriode:n,aksjonspunkter:r,readOnly:s,alleMerknaderFraBeslutter:t})=>{const a=$(),{watch:o}=ln(),l=o("erEosBorger"),m=n.aksjonspunkter.filter(d=>d===i.AVKLAR_OPPHOLDSRETT||d===i.AVKLAR_LOVLIG_OPPHOLD),p=r.find(d=>m.includes(d.definisjon)),y=(p==null?void 0:p.status)!==Y.OPPRETTET,b=k.useCallback((...d)=>e.jsx("b",{children:d}),[]);return e.jsxs(V,{title:a.formatMessage({id:"StatusForBorgerFaktaPanel.ApplicationInformation"}),merknaderFraBeslutter:p!=null&&p.definisjon?t[p.definisjon]:void 0,children:[e.jsx(C,{name:"erEosBorger",hideLegend:!0,validate:[z],isReadOnly:s,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.CitizenEEA"}),value:"true"},{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.CitizenOutsideEEA"}),value:"false"}]}),l&&e.jsxs(e.Fragment,{children:[e.jsx(v,{eightPx:!0}),e.jsx(fe,{children:e.jsx(C,{name:"oppholdsrettVurdering",label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.Oppholdsrett"}),validate:[z],isEdited:y,isReadOnly:s,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.HarOppholdsrett"}),value:"true"},{label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.HarIkkeOppholdsrett",values:{b}}),value:"false"}]})})]}),l===!1&&e.jsxs(e.Fragment,{children:[e.jsx(v,{eightPx:!0}),e.jsx(fe,{alignOffset:130,children:e.jsx(C,{name:"lovligOppholdVurdering",label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.LovligOpphold"}),validate:[z],isReadOnly:s,isEdited:y,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.HarLovligOpphold"}),value:"true"},{label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.HarIkkeLovligOpphold",values:{b}}),value:"false"}]})})]})]})},xn=(n,r)=>n.erEosBorger||n.erEosBorger===!1?n.erEosBorger:r.some(s=>s.definisjon===i.AVKLAR_OPPHOLDSRETT),_n=n=>n.oppholdsrettVurdering||n.oppholdsrettVurdering===!1?n.oppholdsrettVurdering:void 0,Ln=n=>n.lovligOppholdVurdering||n.lovligOppholdVurdering===!1?n.lovligOppholdVurdering:void 0;te.buildInitialValues=(n,r)=>{const s=xn(n,r);return{erEosBorger:s,oppholdsrettVurdering:s?_n(n):void 0,lovligOppholdVurdering:s===!1?Ln(n):void 0}};te.__docgenInfo={description:`StatusForBorgerFaktaPanel

Setter opp aksjonspunktet for avklaring av borgerstatus (Medlemskapsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"periode",optional:!1,type:null},{name:"aksjonspunkter",optional:!1,type:null}],returns:null}],displayName:"StatusForBorgerFaktaPanel"};const Kn="_showBorder_wtdd5_1",Un={showBorder:Kn},{AVKLAR_OPPHOLDSRETT:He,AVKLAR_LOVLIG_OPPHOLD:Ce}=i,re=(n,r)=>r.some(s=>s===n),Gn=(n,r,s)=>{const t=r.filter(o=>n.aksjonspunkter.includes(o.definisjon)||o.definisjon===i.AVKLAR_FORTSATT_MEDLEMSKAP);let a={};return(re(He,n.aksjonspunkter)||re(Ce,n.aksjonspunkter))&&(a=te.buildInitialValues(n,t)),{...se.buildInitialValues(n),...ae.buildInitialValues(n,s),...a,begrunnelse:n.begrunnelse}},ze=({valgtPeriode:n,readOnly:r,submittable:s,soknad:t,alleKodeverk:a,aksjonspunkter:o,alleMerknaderFraBeslutter:l,updateOppholdInntektPeriode:m,medlemskap:p,lagreEnkeltPeriode:y,setValgtPeriode:b})=>{const[d,w]=k.useState(!1),q=k.useMemo(()=>Gn(n,o,p.medlemskapPerioder),[n,o,t,p.medlemskapPerioder]),f=on({defaultValues:q}),R=k.useCallback(()=>{f.reset(q),b()},[]),T=o.length>0;return e.jsx(dn,{formMethods:f,onSubmit:j=>{w(!0),m(n.vurderingsdato,j),y&&y({...n,...j})},children:e.jsxs("div",{className:y?void 0:Un.showBorder,children:[!y&&e.jsx(Le,{size:"small",children:e.jsx(g,{id:"OppholdInntektOgPeriodeForm.Periode",values:{dato:X(n.vurderingsdato).format(ee)}})}),e.jsx(se,{valgtPeriode:n,soknad:t,aksjonspunkter:o,readOnly:r,alleKodeverk:a,alleMerknaderFraBeslutter:l}),e.jsx(v,{twentyPx:!0}),p.opphold.length>0&&e.jsxs(e.Fragment,{children:[e.jsx(Ue,{oppholdstillatelse:p.opphold,alleKodeverk:a}),e.jsx(v,{twentyPx:!0})]}),e.jsx(ae,{valgtPeriode:n,medlemskap:p,soknad:t,aksjonspunkter:o,readOnly:r,alleMerknaderFraBeslutter:l,alleKodeverk:a}),(re(He,n.aksjonspunkter)||re(Ce,n.aksjonspunkter))&&e.jsx(te,{valgtPeriode:n,aksjonspunkter:o,readOnly:r,alleMerknaderFraBeslutter:l}),e.jsx(v,{twentyPx:!0}),T&&n.aksjonspunkter&&n.aksjonspunkter.length>0&&e.jsx(un,{isReadOnly:r,isSubmittable:s,hasBegrunnelse:!!q.begrunnelse}),e.jsx(v,{twentyPx:!0}),!r&&T&&e.jsxs(S,{gap:"4",children:[e.jsx(de,{size:"small",variant:"primary",disabled:!f.formState.isDirty||d,loading:d,children:e.jsx(g,{id:y?"OppholdInntektOgPerioder.Bekreft":"OppholdInntektOgPeriode.Oppdater"})}),!y&&e.jsx(de,{size:"small",variant:"secondary",onClick:R,type:"button",children:e.jsx(g,{id:"OppholdInntektOgPeriode.Avbryt"})})]})]})})};ze.__docgenInfo={description:"",methods:[],displayName:"OppholdInntektOgPeriodeForm",props:{valgtPeriode:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vurderingsdato: string;
  personopplysningBruker: PersonopplysningMedlem;
  personopplysningAnnenPart?: PersonopplysningMedlem;
  aksjonspunkter: string[];
...
>`},name:"data"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  medlemskapManuellVurderingType?: string;
  begrunnelse?: string;
}>`}],raw:"MedlemPeriode[]"},name:"data"}],return:{name:"void"}}},description:""}}};const Yn=kn(vn),$e=({soknad:n,medlemskap:r,aksjonspunkter:s,submittable:t,alleMerknaderFraBeslutter:a,alleKodeverk:o,submitCallback:l,readOnly:m,formData:p,setFormData:y})=>e.jsx(yn,{value:Yn,children:e.jsx(Ye,{soknad:n,medlemskap:r,aksjonspunkter:s,submittable:t,alleMerknaderFraBeslutter:a,alleKodeverk:o,submitCallback:l,readOnly:m,formData:p,setFormData:y})}),Je=$e;$e.__docgenInfo={description:"",methods:[],displayName:"MedlemskapFaktaIndex",props:{medlemskap:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fom?: string;
  medlemskapPerioder: MedlemskapPeriode[];
  perioder: MedlemPeriode[];
  opphold: Oppholdstillatelse[];
