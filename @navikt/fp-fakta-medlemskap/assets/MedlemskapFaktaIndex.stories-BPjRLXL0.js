import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{u as nn,H as me,x as pe,W as A,D as ke,U as V,a as $,z as ye,M as g,K as O,O as E,l as rn,b as S,c as C,L as Ue,B as N,Z as be,T as fe,p as qe,r as sn,A as l,y as v,F as z,d as Y,S as an,V as tn,h as X,R as ee,g as ln,e as on,f as je,i as dn,Y as un,j as gn,k as ue,m as mn,v as pn,n as B,t as kn,P as yn,o as vn,q as M,s as F,w as bn,C as fn,E as qn}from"./style-BU7tw_Yo.js";import{r as k}from"./index-uubelm5h.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-jH2-tx3w.js";import"./index-CfOt2XX2.js";var jn=function(n,r){var s={};for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&r.indexOf(t)<0&&(s[t]=n[t]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var a=0,t=Object.getOwnPropertySymbols(n);a<t.length;a++)r.indexOf(t[a])<0&&Object.prototype.propertyIsEnumerable.call(n,t[a])&&(s[t[a]]=n[t[a]]);return s};const cn=k.forwardRef((n,r)=>{var{title:s,titleId:t}=n,a=jn(n,["title","titleId"]);let o=nn();return o=s?t||"title-"+o:void 0,k.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",fill:"none",viewBox:"0 0 24 24",focusable:!1,role:"img",ref:r,"aria-labelledby":o},a),s?k.createElement("title",{id:o},s):null,k.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M18.998 6.94a.75.75 0 0 1 .063 1.058l-8 9a.75.75 0 0 1-1.091.032l-5-5a.75.75 0 1 1 1.06-1.06l4.438 4.437 7.471-8.405A.75.75 0 0 1 19 6.939",clipRule:"evenodd"}))});var se=(n=>(n.BRUKERS_ANDEL="BRUKERS_ANDEL",n.FRILANS="FRILANS",n.EGEN_NÆRING="EGEN_NÆRING",n))(se||{});se.BRUKERS_ANDEL;se.FRILANS;se.EGEN_NÆRING;var D=(n=>(n.OPPRETTET="OPPR",n.UTFORT="UTFO",n.AVBRUTT="AVBR",n))(D||{});const Tn=n=>n==="OPPR",Pn=["MedlemskapEndringerTabell.GjeldeneFom","MedlemskapEndringerTabell.Opplysning"],Ge=({perioder:n,velgPeriodeCallback:r,valgtPeriodeVurderingsdato:s,aksjonspunkter:t})=>e.jsx(me,{headerTextCodes:Pn,children:n.map(a=>e.jsxs(pe,{id:a.vurderingsdato,onMouseDown:r,onKeyDown:r,isSelected:a.vurderingsdato===s,model:a,isApLeftBorder:a.aksjonspunkter.some(o=>t.some(i=>i.definisjon===o&&i.status===D.OPPRETTET))&&a.begrunnelse===void 0,children:[e.jsx(A,{children:e.jsx(ke,{dateString:a.vurderingsdato})}),e.jsx(A,{children:a.årsaker.join()})]},a.vurderingsdato))});Ge.__docgenInfo={description:"",methods:[],displayName:"MedlemskapEndringerTabell",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Q=n=>n??"",Rn=(n,r,s,t)=>`${Q(n)}, ${Q(r)} ${Q(s)} ${Q(t)}`,Ce=(n=[])=>n.reduce((r,s)=>{if(!s.adresseType||s.adresseType===E.UKJENT_ADRESSE)return{...r,[E.BOSTEDSADRESSE]:"UKJENT"};const t=[s.adresselinje1,s.adresselinje2,s.adresselinje3].filter(o=>!!o).join(", ");if(!t)return r;const a=s.land!==rn.NORGE?s.land:void 0;return{...r,[s.adresseType]:Rn(t,s.postNummer,s.poststed,a).trim()}},{}),hn="_dodEtikett_izib4_1",An="_defaultBostedSoker_izib4_6",On="_etikettMargin_izib4_10",Mn="_paddingBottom_izib4_14",_={dodEtikett:hn,defaultBostedSoker:An,etikettMargin:On,paddingBottom:Mn},Vn=n=>{const r=Ce(n);return r[E.POSTADRESSE]||r[E.BOSTEDSADRESSE]||"-"},Sn=n=>{const r=Ce(n);return r[E.POSTADRESSE_UTLAND]||r[E.MIDLERTIDIG_POSTADRESSE_UTLAND]||"-"},ge=({personopplysninger:n,sokerTypeText:r,regionTypes:s,personstatusTypes:t})=>{var o,i;const a=$();return e.jsx("div",{className:_.defaultBostedSoker,children:e.jsxs(S,{justify:"space-between",children:[e.jsxs("div",{children:[e.jsx(C,{children:r}),e.jsx(Ue,{size:"small",children:n.navn?n.navn:"-"}),e.jsx(N,{size:"small",className:_.paddingBottom,children:Vn(n.adresser)}),e.jsx(C,{children:e.jsx(g,{id:"BostedSokerView.ForeignAddresse"})}),e.jsx(N,{size:"small",children:Sn(n.adresser)})]}),e.jsxs("div",{children:[n.personstatus&&e.jsx("div",{className:_.etikettMargin,children:e.jsx(be,{content:a.formatMessage({id:"Personstatus.Hjelpetekst"}),alignBottom:!0,children:e.jsx(fe,{className:n.personstatus===qe.DOD?_.dodEtikett:"",variant:"warning",children:n.personstatus===qe.UDEFINERT?a.formatMessage({id:"Personstatus.Ukjent"}):(o=t.find(m=>m.kode===n.personstatus))==null?void 0:o.navn})})}),n.region&&n.region!==sn.UDEFINERT&&e.jsx("div",{className:_.etikettMargin,children:e.jsx(be,{content:a.formatMessage({id:"BostedSokerView.Region"}),alignBottom:!0,children:e.jsx(fe,{variant:"warning",children:(i=s.find(m=>m.kode===n.region))==null?void 0:i.navn})})})]})]})})};ge.__docgenInfo={description:"",methods:[],displayName:"MedlemskapBostedSokerView",props:{personopplysninger:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  navn: string;
  personstatus: string;
  region: string;
  adresser: Personadresse[];
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const Bn="_dodEtikett_1a9q7_1",En="_col_1a9q7_6",Nn="_exclamationmarkIcon_1a9q7_10",Fn="_checkmarkIcon_1a9q7_16",ne={dodEtikett:Bn,col:En,exclamationmarkIcon:Nn,checkmarkIcon:Fn},Dn=n=>{const r=n.toLowerCase();return r.charAt(0).toUpperCase()+r.slice(1)},de=(n,r)=>n!==void 0?e.jsxs(S,{gap:"4",children:[n===!0&&e.jsx(cn,{className:ne.checkmarkIcon,title:r.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.Opphold"})}),n!==!0&&e.jsx(an,{className:ne.exclamationmarkIcon,title:r.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.IkkeOpphold"})}),e.jsx(N,{size:"small",children:e.jsx(g,{id:n===!0?"OppholdINorgeOgAdresserFaktaPanel.Yes":"OppholdINorgeOgAdresserFaktaPanel.No"})})]}):null,ce=n=>n&&n.map(r=>e.jsx("div",{children:e.jsxs(S,{gap:"4",children:[e.jsx(N,{size:"small",children:Dn(r.landNavn)}),e.jsx(N,{size:"small",children:e.jsx(ye,{showTodayString:!0,dateStringFom:r.fom,dateStringTom:r.tom})})]})},`${r.landNavn}${r.fom}${r.tom}`)),ae=({soknad:n,valgtPeriode:r,aksjonspunkter:s,readOnly:t,alleKodeverk:a,alleMerknaderFraBeslutter:o})=>{var q,f,R,T,j;const i=$(),m=r.aksjonspunkter.find(u=>u===l.AVKLAR_OM_BRUKER_ER_BOSATT),p=s.find(u=>m===u.definisjon),y=m&&p?p.status!==D.OPPRETTET:!1,{personopplysningBruker:b,personopplysningAnnenPart:d}=r,h=k.useCallback((...u)=>e.jsx("b",{children:u}),[]);return e.jsx(V,{merknaderFraBeslutter:o[l.AVKLAR_OM_BRUKER_ER_BOSATT],children:e.jsxs(S,{children:[e.jsx("div",{className:ne.col,children:e.jsxs(V,{withoutBorder:!0,title:i.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.OppholdINorge"}),children:[e.jsx(C,{children:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.StayingInNorway"})}),e.jsx(v,{fourPx:!0}),de((q=n==null?void 0:n.oppgittTilknytning)==null?void 0:q.oppholdNorgeNa,i),e.jsx(v,{sixteenPx:!0}),e.jsx(C,{children:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.StayingInNorwayLast12"})}),e.jsx(v,{fourPx:!0}),de((f=n==null?void 0:n.oppgittTilknytning)==null?void 0:f.oppholdSistePeriode,i),e.jsx(v,{eightPx:!0}),ce((R=n==null?void 0:n.oppgittTilknytning)==null?void 0:R.utlandsoppholdFor),e.jsx(v,{sixteenPx:!0}),e.jsx(C,{children:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.StayingInNorwayNext12"})}),e.jsx(v,{fourPx:!0}),de((T=n==null?void 0:n.oppgittTilknytning)==null?void 0:T.oppholdNestePeriode,i),e.jsx(v,{eightPx:!0}),ce((j=n==null?void 0:n.oppgittTilknytning)==null?void 0:j.utlandsoppholdEtter)]})}),e.jsxs("div",{className:ne.col,children:[e.jsxs(V,{withoutBorder:!0,title:i.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.BosattAdresser"}),children:[e.jsx(ge,{sokerTypeText:i.formatMessage({id:"BostedSokerFaktaIndex.Soker"}),personopplysninger:b,regionTypes:a[O.REGION],personstatusTypes:a[O.PERSONSTATUS_TYPE]}),d&&e.jsx(ge,{sokerTypeText:i.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.Parent"}),personopplysninger:d,regionTypes:a[O.REGION],personstatusTypes:a[O.PERSONSTATUS_TYPE]})]}),m&&e.jsx(z,{name:"bosattVurdering",hideLegend:!0,validate:[Y],isReadOnly:t,isHorizontal:!0,isEdited:y,isTrueOrFalseSelection:!0,radios:[{label:i.formatMessage({id:"OppholdINorgeOgAdresserFaktaPanel.ResidingInNorway"}),value:"true"},{label:e.jsx(g,{id:"OppholdINorgeOgAdresserFaktaPanel.NotResidingInNorway",values:{b:h}}),value:"false"}]})]})]})})};ae.buildInitialValues=n=>({bosattVurdering:n.bosattVurdering||n.bosattVurdering===!1?n.bosattVurdering:void 0});ae.__docgenInfo={description:`OppholdINorgeOgAdresserFaktaPanel

Er tilknyttet faktapanelet for medlemskap.
Viser opphold i innland og utland som er relevante for søker. ReadOnly.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"periode",optional:!1,type:null}],returns:null}],displayName:"OppholdINorgeOgAdresserFaktaPanel"};const In=["PerioderMedMedlemskapFaktaPanel.Period","PerioderMedMedlemskapFaktaPanel.Coverage","PerioderMedMedlemskapFaktaPanel.Status","PerioderMedMedlemskapFaktaPanel.Date"],te=({valgtPeriode:n,readOnly:r,alleKodeverk:s,alleMerknaderFraBeslutter:t,medlemskap:a,soknad:o,aksjonspunkter:i})=>{const m=$(),p=s[O.MEDLEMSKAP_MANUELL_VURDERING_TYPE],y=k.useMemo(()=>[...p].sort((u,P)=>u.navn.localeCompare(P.navn)),[]),b=k.useMemo(()=>[...a.medlemskapPerioder].sort((u,P)=>new Date(u.fom).getTime()-new Date(P.fom).getTime()),[a.medlemskapPerioder]);if(!b||b.length===0)return e.jsx(V,{title:m.formatMessage({id:"PerioderMedMedlemskapFaktaPanel.ApplicationInformation"}),children:e.jsx(N,{size:"small",children:e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.NoInformation"})})});const d=n.aksjonspunkter.find(u=>u===l.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE),h=i.find(u=>d===u.definisjon),q=h?h.status!==D.OPPRETTET:!1,f=ln(s),R=o.fodselsdatoer?Object.values(o.fodselsdatoer)[0]:void 0,{omsorgsovertakelseDato:T,termindato:j}=o;return e.jsxs(V,{title:m.formatMessage({id:"PerioderMedMedlemskapFaktaPanel.ApplicationInformation"}),merknaderFraBeslutter:t[l.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE],children:[e.jsx(me,{headerTextCodes:In,noHover:!0,children:b.map(u=>{const P=f(u.dekningType,O.MEDLEMSKAP_DEKNING),J=f(u.medlemskapType,O.MEDLEMSKAP_TYPE),Z=u.fom+u.tom+P+J+u.beslutningsdato;return e.jsxs(pe,{id:Z,children:[e.jsx(A,{children:e.jsx(ye,{showTodayString:!0,dateStringFom:u.fom,dateStringTom:u.tom})}),e.jsx(A,{children:P}),e.jsx(A,{children:J}),e.jsx(A,{children:u.beslutningsdato?e.jsx(ke,{dateString:u.beslutningsdato}):null})]},Z)})}),e.jsxs(tn,{children:[e.jsx(S,{children:d&&e.jsx(z,{name:"medlemskapManuellVurderingType",hideLegend:!0,isEdited:q,validate:[Y],isReadOnly:r,isHorizontal:!0,radios:y.map(u=>({label:u.navn,value:u.kode}))})}),e.jsxs(S,{justify:"end",children:[R&&e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.Fodselsdato",values:{dato:X(R).format(ee)}}),j&&e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.Termindato",values:{dato:X(j).format(ee)}}),T&&e.jsx(g,{id:"PerioderMedMedlemskapFaktaPanel.Omsorgsovertakelse",values:{dato:X(T).format(ee)}})]})]})]})};te.buildInitialValues=(n,r)=>r!==null?{medlemskapManuellVurderingType:n.medlemskapManuellVurderingType}:{};te.__docgenInfo={description:`PerioderMedMedlemskapFaktaPanel

Setter opp aksjonspunktet for avklaring av perioder (Medlemskapsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"periode",optional:!1,type:null},{name:"medlemskapPerioder",optional:!1,type:null}],returns:null}],displayName:"PerioderMedMedlemskapFaktaPanel"};const le=({valgtPeriode:n,aksjonspunkter:r,readOnly:s,alleMerknaderFraBeslutter:t})=>{const a=$(),{watch:o}=on(),i=o("erEosBorger"),m=n.aksjonspunkter.filter(d=>d===l.AVKLAR_OPPHOLDSRETT||d===l.AVKLAR_LOVLIG_OPPHOLD),p=r.find(d=>m.includes(d.definisjon)),y=(p==null?void 0:p.status)!==D.OPPRETTET,b=k.useCallback((...d)=>e.jsx("b",{children:d}),[]);return e.jsxs(V,{title:a.formatMessage({id:"StatusForBorgerFaktaPanel.ApplicationInformation"}),merknaderFraBeslutter:p!=null&&p.definisjon?t[p.definisjon]:void 0,children:[e.jsx(z,{name:"erEosBorger",hideLegend:!0,validate:[Y],isReadOnly:s,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.CitizenEEA"}),value:"true"},{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.CitizenOutsideEEA"}),value:"false"}]}),i&&e.jsxs(e.Fragment,{children:[e.jsx(v,{eightPx:!0}),e.jsx(je,{children:e.jsx(z,{name:"oppholdsrettVurdering",label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.Oppholdsrett"}),validate:[Y],isEdited:y,isReadOnly:s,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.HarOppholdsrett"}),value:"true"},{label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.HarIkkeOppholdsrett",values:{b}}),value:"false"}]})})]}),i===!1&&e.jsxs(e.Fragment,{children:[e.jsx(v,{eightPx:!0}),e.jsx(je,{alignOffset:130,children:e.jsx(z,{name:"lovligOppholdVurdering",label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.LovligOpphold"}),validate:[Y],isReadOnly:s,isEdited:y,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"StatusForBorgerFaktaPanel.HarLovligOpphold"}),value:"true"},{label:e.jsx(g,{id:"StatusForBorgerFaktaPanel.HarIkkeLovligOpphold",values:{b}}),value:"false"}]})})]})]})},_n=(n,r)=>n.erEosBorger||n.erEosBorger===!1?n.erEosBorger:r.some(s=>s.definisjon===l.AVKLAR_OPPHOLDSRETT),xn=n=>n.oppholdsrettVurdering||n.oppholdsrettVurdering===!1?n.oppholdsrettVurdering:void 0,Ln=n=>n.lovligOppholdVurdering||n.lovligOppholdVurdering===!1?n.lovligOppholdVurdering:void 0;le.buildInitialValues=(n,r)=>{const s=_n(n,r);return{erEosBorger:s,oppholdsrettVurdering:s?xn(n):void 0,lovligOppholdVurdering:s===!1?Ln(n):void 0}};le.__docgenInfo={description:`StatusForBorgerFaktaPanel

Setter opp aksjonspunktet for avklaring av borgerstatus (Medlemskapsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"periode",optional:!1,type:null},{name:"aksjonspunkter",optional:!1,type:null}],returns:null}],displayName:"StatusForBorgerFaktaPanel"};const Kn="_showBorder_wtdd5_1",Un={showBorder:Kn},{AVKLAR_OPPHOLDSRETT:ze,AVKLAR_LOVLIG_OPPHOLD:Ye}=l,re=(n,r)=>r.some(s=>s===n),Gn=(n,r,s)=>{const t=r.filter(o=>n.aksjonspunkter.includes(o.definisjon)||o.definisjon===l.AVKLAR_FORTSATT_MEDLEMSKAP);let a={};return(re(ze,n.aksjonspunkter)||re(Ye,n.aksjonspunkter))&&(a=le.buildInitialValues(n,t)),{...ae.buildInitialValues(n),...te.buildInitialValues(n,s),...a,begrunnelse:n.begrunnelse}},$e=({valgtPeriode:n,readOnly:r,submittable:s,soknad:t,alleKodeverk:a,aksjonspunkter:o,alleMerknaderFraBeslutter:i,updateOppholdInntektPeriode:m,medlemskap:p,lagreEnkeltPeriode:y,setValgtPeriode:b})=>{const[d,h]=k.useState(!1),q=k.useMemo(()=>Gn(n,o,p.medlemskapPerioder),[n,o,t,p.medlemskapPerioder]),f=dn({defaultValues:q}),R=k.useCallback(()=>{f.reset(q),b()},[]),T=o.length>0;return e.jsx(un,{formMethods:f,onSubmit:j=>{h(!0),m(n.vurderingsdato,j),y&&y({...n,...j})},children:e.jsxs("div",{className:y?void 0:Un.showBorder,children:[!y&&e.jsx(Ue,{size:"small",children:e.jsx(g,{id:"OppholdInntektOgPeriodeForm.Periode",values:{dato:X(n.vurderingsdato).format(ee)}})}),e.jsx(ae,{valgtPeriode:n,soknad:t,aksjonspunkter:o,readOnly:r,alleKodeverk:a,alleMerknaderFraBeslutter:i}),e.jsx(v,{twentyPx:!0}),p.opphold.length>0&&e.jsxs(e.Fragment,{children:[e.jsx(He,{oppholdstillatelse:p.opphold,alleKodeverk:a}),e.jsx(v,{twentyPx:!0})]}),e.jsx(te,{valgtPeriode:n,medlemskap:p,soknad:t,aksjonspunkter:o,readOnly:r,alleMerknaderFraBeslutter:i,alleKodeverk:a}),(re(ze,n.aksjonspunkter)||re(Ye,n.aksjonspunkter))&&e.jsx(le,{valgtPeriode:n,aksjonspunkter:o,readOnly:r,alleMerknaderFraBeslutter:i}),e.jsx(v,{twentyPx:!0}),T&&n.aksjonspunkter&&n.aksjonspunkter.length>0&&e.jsx(gn,{isReadOnly:r,isSubmittable:s,hasBegrunnelse:!!q.begrunnelse}),e.jsx(v,{twentyPx:!0}),!r&&T&&e.jsxs(S,{gap:"4",children:[e.jsx(ue,{size:"small",variant:"primary",disabled:!f.formState.isDirty||d,loading:d,children:e.jsx(g,{id:y?"OppholdInntektOgPerioder.Bekreft":"OppholdInntektOgPeriode.Oppdater"})}),!y&&e.jsx(ue,{size:"small",variant:"secondary",onClick:R,type:"button",children:e.jsx(g,{id:"OppholdInntektOgPeriode.Avbryt"})})]})]})})};$e.__docgenInfo={description:"",methods:[],displayName:"OppholdInntektOgPeriodeForm",props:{valgtPeriode:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vurderingsdato: string;
  personopplysningBruker: PersonopplysningMedlem;
  personopplysningAnnenPart?: PersonopplysningMedlem;
  aksjonspunkter: string[];
...
PerioderFormValues & {
  ...
  medlemskapManuellVurderingType?: string;
  begrunnelse?: string;
}>`},name:"periode"}],return:{name:"void"}}},description:""}}};const Hn=[l.AVKLAR_OM_BRUKER_ER_BOSATT,l.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE,l.AVKLAR_OPPHOLDSRETT,l.AVKLAR_LOVLIG_OPPHOLD],Cn=(n,r)=>r.filter(s=>s.aksjonspunkter.includes(n.definisjon)||s.aksjonspunkter.length>0&&n.definisjon===l.AVKLAR_FORTSATT_MEDLEMSKAP),Te=(n,r)=>{const s=r.filter(i=>Hn.some(m=>m===i.definisjon)),t=s.some(i=>Tn(i.status)),a=r.filter(i=>i.definisjon===l.AVKLAR_FORTSATT_MEDLEMSKAP);return(t||a.length===0?s:a).map(i=>({kode:i.definisjon,begrunnelse:"",bekreftedePerioder:Cn(i,n)}))},zn=n=>{const r=[];return B(l.AVKLAR_FORTSATT_MEDLEMSKAP,n)&&r.push(e.jsx(g,{id:"MedlemskapInfoPanel.HarFortsattMedlemskap"},"HarFortsattMedlemskap")),B(l.AVKLAR_OM_BRUKER_ER_BOSATT,n)&&r.push(e.jsx(g,{id:"MedlemskapInfoPanel.ErSokerBosattINorge"},"ErSokerBosattINorge")),B(l.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE,n)&&r.push(e.jsx(g,{id:"MedlemskapInfoPanel.GyldigMedlemFolketrygden"},"GyldigMedlemFolketrygden")),B(l.AVKLAR_OPPHOLDSRETT,n)&&r.push(e.jsx(g,{id:"MedlemskapInfoPanel.EOSBorgerMedOppholdsrett"},"EOSBorgerMedOppholdsrett1")),B(l.AVKLAR_LOVLIG_OPPHOLD,n)&&r.push(e.jsx(g,{id:"MedlemskapInfoPanel.IkkeEOSBorgerMedLovligOpphold"},"IkkeEOSBorgerMedLovligOpphold")),r},Je=({submittable:n,readOnly:r,submitCallback:s,alleMerknaderFraBeslutter:t,aksjonspunkter:a,soknad:o,alleKodeverk:i,medlemskap:m,formData:p,setFormData:y})=>{const b=k.useMemo(()=>[...m.perioder||[]].sort((c,w)=>c.vurderingsdato.localeCompare(w.vurderingsdato)),[m.perioder]),[d,h]=k.useState(p||b),[q,f]=k.useState(!1),[R,T]=k.useState(!1);k.useEffect(()=>()=>{y(d)},[d]);const j=c=>c.find(w=>w.aksjonspunkter.length>0&&!w.begrunnelse),[u,P]=k.useState(d.length>1?j(d):d[0]),J=k.useCallback((c,w,W)=>{P(W)},[]),Z=k.useCallback((c,w)=>{const W=d.findIndex(oe=>oe.vurderingsdato===c),Xe={...d[W],...w},ie=d.map((oe,en)=>W===en?Xe:oe);h(ie),T(!0),ie.length>1&&P(j(ie))},[d]),Ze=()=>!!(!R||d&&d.length>0&&d.filter(w=>w.aksjonspunkter.length>0&&!w.begrunnelse).length>0),We=()=>(f(!0),s(Te(d,a))),Qe=c=>(f(!0),s(Te([c],a)));return e.jsxs(e.Fragment,{children:[e.jsx(mn,{size:"small",children:e.jsx(g,{id:"OppholdInntektOgPerioder.Overskrift"})}),e.jsx(v,{thirtyTwoPx:!0}),a.some(c=>c.status===D.OPPRETTET)&&e.jsxs(e.Fragment,{children:[e.jsx(pn,{children:zn(a)}),e.jsx(v,{thirtyTwoPx:!0})]}),e.jsx(v,{thirtyTwoPx:!0}),B(l.AVKLAR_FORTSATT_MEDLEMSKAP,a)&&e.jsx(Ge,{perioder:d,aksjonspunkter:a,valgtPeriodeVurderingsdato:u?u.vurderingsdato:void 0,velgPeriodeCallback:J}),u&&e.jsx($e,{readOnly:r,valgtPeriode:u,soknad:o,aksjonspunkter:a,submittable:n,updateOppholdInntektPeriode:Z,alleKodeverk:i,alleMerknaderFraBeslutter:t,medlemskap:m,lagreEnkeltPeriode:d.length===1?Qe:void 0,setValgtPeriode:P},u.vurderingsdato),e.jsx(v,{twentyPx:!0}),!r&&d.length>1&&e.jsx(ue,{size:"small",variant:"primary",onClick:We,disabled:q||Ze(),loading:q,type:"button",children:e.jsx(g,{id:"OppholdInntektOgPerioder.Bekreft"})})]})};Je.__docgenInfo={description:`MedlemskapInfoPanel
...
>`},name:"data"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  medlemskapManuellVurderingType?: string;
  begrunnelse?: string;
}>`}],raw:"MedlemPeriode[]"},name:"data"}],return:{name:"void"}}},description:""}}};const Yn=kn(vn),ve=({soknad:n,medlemskap:r,aksjonspunkter:s,submittable:t,alleMerknaderFraBeslutter:a,alleKodeverk:o,submitCallback:i,readOnly:m,formData:p,setFormData:y})=>e.jsx(yn,{value:Yn,children:e.jsx(Je,{soknad:n,medlemskap:r,aksjonspunkter:s,submittable:t,alleMerknaderFraBeslutter:a,alleKodeverk:o,submitCallback:i,readOnly:m,formData:p,setFormData:y})});ve.__docgenInfo={description:"",methods:[],displayName:"MedlemskapFaktaIndex",props:{medlemskap:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fom?: string;
  medlemskapPerioder: MedlemskapPeriode[];
  perioder: MedlemPeriode[];
  opphold: Oppholdstillatelse[];
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: string;
}>`},description:""}}};const $n={uuid:"1",versjon:1,type:fn.FORSTEGANGSSOKNAD,behandlingPaaVent:!1,status:qn.BEHANDLING_UTREDES},Jn={oppgittFordeling:{startDatoForPermisjon:"2019-01-01"},oppgittTilknytning:{oppholdNorgeNa:!0,oppholdNestePeriode:!0,oppholdSistePeriode:!0,utlandsoppholdFor:[{landNavn:"SVERIGE",fom:"2010-01-01",tom:"2011-01-01"}],utlandsoppholdEtter:[{landNavn:"DANMARK",fom:"2018-01-01",tom:"2019-01-01"}]},termindato:"2018-01-01"},Pe={notAccepted:!1},rr={title:"fakta/fakta-medlemskap-v2",component:ve},I=({medlemskap:n,aksjonspunkter:r,submitCallback:s,alleMerknaderFraBeslutter:t})=>e.jsx(ve,{behandling:$n,medlemskap:n,soknad:Jn,aksjonspunkter:r,alleKodeverk:bn,alleMerknaderFraBeslutter:t,submitCallback:s,readOnly:!1,harApneAksjonspunkter:!0,submittable:!0,setFormData:()=>{}}),x=I.bind({});x.args={medlemskap:{opphold:[{fom:"2019-01-01",tom:"2021-10-13",oppholdstillatelseType:"MIDLERTIDIG"},{tom:"2021-01-13",oppholdstillatelseType:"MIDLERTIDIG"}],medlemskapPerioder:[{fom:"2019-01-01",tom:"2021-10-13",medlemskapType:"AVKLARES",dekningType:"OPPHOR",kildeType:"FS22"}],perioder:[{vurderingsdato:"2018-11-07",personopplysningBruker:{personstatus:"BOSA",navn:"Mygg Robust",adresser:[],region:"NORDEN"},aksjonspunkter:[l.AVKLAR_OM_BRUKER_ER_BOSATT],årsaker:["SKJÆRINGSTIDSPUNKT"]}]},aksjonspunkter:[{definisjon:l.AVKLAR_OM_BRUKER_ER_BOSATT,status:M.OPPRETTET,begrunnelse:void 0,kanLoses:!0}],alleMerknaderFraBeslutter:{},submitCallback:F("button-click")};const L=I.bind({});L.args={medlemskap:{medlemskapPerioder:[{fom:"2021-06-30",tom:"2025-06-30",medlemskapType:"ENDELIG",dekningType:"IHT_AVTALE",kildeType:"ANNEN",beslutningsdato:"2021-06-30"}],perioder:[{vurderingsdato:"2022-06-28",aksjonspunkter:[l.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE],årsaker:["SKJÆRINGSTIDSPUNKT"],oppholdsrettVurdering:void 0,erEosBorger:void 0,lovligOppholdVurdering:void 0,bosattVurdering:void 0,medlemskapManuellVurderingType:void 0,begrunnelse:void 0,personopplysningBruker:{navn:"Papegøye Margaret",personstatus:"BOSA",region:"NORDEN",adresser:[{adresseType:"BOSTEDSADRESSE",postNummer:"2500",poststed:"Ukjent",land:"NOR"}]},personopplysningAnnenPart:{navn:"Papegøye Runar",personstatus:"BOSA",region:"NORDEN",adresser:[{adresseType:"BOSTEDSADRESSE",postNummer:"2500",poststed:"Ukjent",land:"NOR"}]}}],opphold:[],fom:void 0},aksjonspunkter:[{definisjon:l.AVKLAR_OM_BRUKER_HAR_GYLDIG_PERIODE,status:M.OPPRETTET,begrunnelse:void 0,kanLoses:!0}],alleMerknaderFraBeslutter:{},submitCallback:F("button-click")};const K=I.bind({});K.args={medlemskap:{opphold:[{fom:"2019-01-01",tom:"2021-10-13",oppholdstillatelseType:"MIDLERTIDIG"},{tom:"2021-01-13",oppholdstillatelseType:"MIDLERTIDIG"}],medlemskapPerioder:[{fom:"2019-01-01",tom:"2021-10-13",medlemskapType:"AVKLARES",dekningType:"OPPHOR",kildeType:"FS22"}],perioder:[{vurderingsdato:"2018-11-07",personopplysningBruker:{personstatus:"BOSA",navn:"Mygg Robust",adresser:[],region:"NORDEN"},aksjonspunkter:[l.AVKLAR_OPPHOLDSRETT],årsaker:["SKJÆRINGSTIDSPUNKT"]}]},aksjonspunkter:[{definisjon:l.AVKLAR_OPPHOLDSRETT,status:M.OPPRETTET,begrunnelse:void 0,kanLoses:!0}],alleMerknaderFraBeslutter:{},submitCallback:F("button-click")};const U=I.bind({});U.args={medlemskap:{opphold:[{fom:"2019-01-01",tom:"2021-10-13",oppholdstillatelseType:"MIDLERTIDIG"},{tom:"2021-01-13",oppholdstillatelseType:"MIDLERTIDIG"}],medlemskapPerioder:[{fom:"2019-01-01",tom:"2021-10-13",medlemskapType:"AVKLARES",dekningType:"OPPHOR",kildeType:"FS22"}],perioder:[{vurderingsdato:"2018-11-07",personopplysningBruker:{personstatus:"BOSA",navn:"Mygg Robust",adresser:[],region:"NORDEN"},aksjonspunkter:[l.AVKLAR_LOVLIG_OPPHOLD],årsaker:["SKJÆRINGSTIDSPUNKT"]}]},aksjonspunkter:[{definisjon:l.AVKLAR_LOVLIG_OPPHOLD,status:M.OPPRETTET,begrunnelse:void 0,kanLoses:!0}],alleMerknaderFraBeslutter:{},submitCallback:F("button-click")};const G=I.bind({});G.args={medlemskap:{opphold:[{fom:"2019-01-01",tom:"2021-10-13",oppholdstillatelseType:"MIDLERTIDIG"},{tom:"2021-01-13",oppholdstillatelseType:"MIDLERTIDIG"}],medlemskapPerioder:[{fom:"2019-01-01",tom:"2021-10-13",medlemskapType:"AVKLARES",dekningType:"OPPHOR",kildeType:"FS22"}],perioder:[{vurderingsdato:"2018-11-07",personopplysningBruker:{personstatus:"BOSA",navn:"Mygg Robust",adresser:[],region:"NORDEN"},lovligOppholdVurdering:!0,aksjonspunkter:[l.AVKLAR_LOVLIG_OPPHOLD],årsaker:["SKJÆRINGSTIDSPUNKT"],begrunnelse:"Denne er vurdert"}]},aksjonspunkter:[{definisjon:l.AVKLAR_LOVLIG_OPPHOLD,status:M.OPPRETTET,begrunnelse:void 0,kanLoses:!0}],alleMerknaderFraBeslutter:{[l.AVKLAR_LOVLIG_OPPHOLD]:{notAccepted:!0}},submitCallback:F("button-click")};const H=I.bind({});H.args={medlemskap:{opphold:[{fom:"2019-01-01",tom:"2021-10-13",oppholdstillatelseType:"MIDLERTIDIG"},{tom:"2021-01-13",oppholdstillatelseType:"MIDLERTIDIG"}],medlemskapPerioder:[{fom:"2019-01-01",tom:"2021-10-13",medlemskapType:"AVKLARES",dekningType:"OPPHOR",kildeType:"FS22"}],perioder:[{vurderingsdato:"2019-11-07",personopplysningBruker:{personstatus:"BOSA",adresser:[{adresseType:"BOSTEDSADRESSE",adresselinje1:"Skogvegen 3",postNummer:"4353",poststed:"Klepp Stasjon",land:"NOR"}],region:"NORDEN"},aksjonspunkter:[l.AVKLAR_OM_BRUKER_ER_BOSATT],årsaker:["SKJÆRINGSTIDSPUNKT"]},{vurderingsdato:"2018-11-07",personopplysningBruker:{personstatus:"BOSA",navn:"Mygg Robust",adresser:[],region:"NORDEN"},aksjonspunkter:[],årsaker:["SKJÆRINGSTIDSPUNKT"]},{vurderingsdato:"2016-01-01",personopplysningBruker:{personstatus:"BOSA",navn:"Mygg Robust",adresser:[],region:"NORDEN"},aksjonspunkter:[],årsaker:["SKJÆRINGSTIDSPUNKT"]},{vurderingsdato:"2017-10-05",personopplysningBruker:{personstatus:"BOSA",adresser:[{adresseType:"BOSTEDSADRESSE",adresselinje1:"Skogvegen 3",postNummer:"4353",poststed:"Klepp Stasjon",land:"NOR"}],region:"NORDEN"},aksjonspunkter:[l.AVKLAR_LOVLIG_OPPHOLD],årsaker:["SKJÆRINGSTIDSPUNKT"]}]},aksjonspunkter:[{definisjon:l.AVKLAR_OM_BRUKER_ER_BOSATT,status:M.UTFORT,begrunnelse:void 0,kanLoses:!0},{definisjon:l.AVKLAR_LOVLIG_OPPHOLD,status:M.UTFORT,begrunnelse:void 0,kanLoses:!0},{definisjon:l.AVKLAR_FORTSATT_MEDLEMSKAP,status:M.OPPRETTET,begrunnelse:void 0,kanLoses:!0}],alleMerknaderFraBeslutter:{[l.AVKLAR_OM_BRUKER_ER_BOSATT]:Pe,[l.AVKLAR_FORTSATT_MEDLEMSKAP]:Pe},submitCallback:F("button-click")};var we,Re,he;x.parameters={...x.parameters,docs:{...(we=x.parameters)==null?void 0:we.docs,source:{originalSource:`({
  medlemskap,
  aksjonspunkter,
  submitCallback,
  alleMerknaderFraBeslutter
}) => <MedlemskapFaktaIndex behandling={behandling} medlemskap={medlemskap} soknad={soknad} aksjonspunkter={aksjonspunkter} alleKodeverk={alleKodeverk as any} alleMerknaderFraBeslutter={alleMerknaderFraBeslutter} submitCallback={submitCallback} readOnly={false} harApneAksjonspunkter submittable setFormData={() => undefined} />`,...(he=(Re=x.parameters)==null?void 0:Re.docs)==null?void 0:he.source}}};var Ae,Oe,Me;L.parameters={...L.parameters,docs:{...(Ae=L.parameters)==null?void 0:Ae.docs,source:{originalSource:`({
  medlemskap,
  aksjonspunkter,
  submitCallback,
  alleMerknaderFraBeslutter
  ...
  submitCallback,
  alleMerknaderFraBeslutter
}) => <MedlemskapFaktaIndex behandling={behandling} medlemskap={medlemskap} soknad={soknad} aksjonspunkter={aksjonspunkter} alleKodeverk={alleKodeverk as any} alleMerknaderFraBeslutter={alleMerknaderFraBeslutter} submitCallback={submitCallback} readOnly={false} harApneAksjonspunkter submittable setFormData={() => undefined} />`,...(Be=(Se=K.parameters)==null?void 0:Se.docs)==null?void 0:Be.source}}};var Ee,Ne,Fe;U.parameters={...U.parameters,docs:{...(Ee=U.parameters)==null?void 0:Ee.docs,source:{originalSource:`({
  medlemskap,
  aksjonspunkter,
  submitCallback,
  alleMerknaderFraBeslutter
}) => <MedlemskapFaktaIndex behandling={behandling} medlemskap={medlemskap} soknad={soknad} aksjonspunkter={aksjonspunkter} alleKodeverk={alleKodeverk as any} alleMerknaderFraBeslutter={alleMerknaderFraBeslutter} submitCallback={submitCallback} readOnly={false} harApneAksjonspunkter submittable setFormData={() => undefined} />`,...(Fe=(Ne=U.parameters)==null?void 0:Ne.docs)==null?void 0:Fe.source}}};var De,Ie,_e;G.parameters={...G.parameters,docs:{...(De=G.parameters)==null?void 0:De.docs,source:{originalSource:`({
  medlemskap,
  aksjonspunkter,
  submitCallback,
  alleMerknaderFraBeslutter
