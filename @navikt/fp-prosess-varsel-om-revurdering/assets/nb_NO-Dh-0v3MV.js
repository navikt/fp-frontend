 ...
 */var he;function Hr(){if(he)return U;he=1;var e=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function t(n,r,s){var o=null;if(s!==void 0&&(o=""+s),r.key!==void 0&&(o=""+r.key),"key"in r){s={};for(var l in r)l!=="key"&&(s[l]=r[l])}else s=r;return r=s.ref,{$$typeof:e,type:n,key:o,ref:r!==void 0?r:null,props:s}}return U.Fragment=a,U.jsx=t,U.jsxs=t,U}var we;function zr(){return we||(we=1,be.exports=Hr()),be.exports}var F=zr();const kt=({children:e})=>!e||Array.isArray(e)&&e.length===0?null:F.jsx(pr,{variant:"warning",size:"small",children:F.jsx(Z,{gap:"space-8",children:p.Children.map(e,a=>F.jsx(T,{size:"small",children:a},He(a)?a.key:a))})}),G={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};W(G);const J="var(--ax-bg-neutral-strong)",Ce=4,Lr=(e,a,t)=>`
  .arrowBoxTop${e} {
...
*/var je;function Gr(){return je||(je=1,function(e){(function(){var a={}.hasOwnProperty;function t(){for(var s="",o=0;o<arguments.length;o++){var l=arguments[o];l&&(s=r(s,n.call(this,l)))}return s}function n(s){if(typeof s=="string"||typeof s=="number")return this&&this[s]||s;if(typeof s!="object")return"";if(Array.isArray(s))return t.apply(this,s);if(s.toString!==Object.prototype.toString&&!s.toString.toString().includes("[native code]"))return s.toString();var o="";for(var l in s)a.call(s,l)&&s[l]&&(o=r(o,this&&this[l]||l));return o}function r(s,o){return o?s?s+" "+o:s+o:s}e.exports?(t.default=t,e.exports=t):window.classNames=t})()}(Oe)),Oe.exports}var Xr=Gr();const oe=Vr(Xr),Yr="_borderbox_1a0x6_1",Jr="_error_1a0x6_5",Zr="_warning_1a0x6_8",Qr={borderbox:Yr,error:Jr,warning:Zr};oe.bind(Qr);const et="_aksjonspunkt_11wjs_1",nt="_erAksjonspunktApent_11wjs_4",rt="_erIkkeGodkjentAvBeslutter_11wjs_8",tt={aksjonspunkt:et,erAksjonspunktApent:nt,erIkkeGodkjentAvBeslutter:rt};oe.bind(tt);const re=({dateString:e,year:a,month:t,day:n})=>F.jsx(F.Fragment,{children:A(e,{year:a,month:t,day:n})});W(G);W(G);const at="_divider_1jpov_1",st="_dividerParagraf_1jpov_8",ot="_leftPanel_1jpov_11",lt="_rightPanel_1jpov_14",it={divider:at,dividerParagraf:st,leftPanel:ot,rightPanel:lt};oe.bind(it);const bt=()=>F.jsx("span",{"data-testid":"editedIcon",children:F.jsx(cn,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});W(G);W(G);const Ae=({soknad:e,termindato:a})=>{const t=e.fodselsdatoer?e.fodselsdatoer:{},n=Object.keys(t).length>0?"FodselsammenligningPanel.Fodselsdato":"FodselsammenligningPanel.Termindato",r=Object.keys(t).length>0?"FodselSammenligningOtherPanel.OpplysningerISoknad":"FodselSammenligningOtherPanel.TerminISoknad",s=dt(!!e,t,e.termindato,a);return g.jsxs(Z,{gap:"space-16",children:[g.jsx(te,{size:"small",level:"3",children:g.jsx(x,{id:r})}),g.jsxs(K,{gap:"space-16",children:[e.utstedtdato&&g.jsxs("div",{children:[g.jsx(B,{children:g.jsx(x,{id:"FodselsammenligningPanel.UstedtDato"})}),g.jsx(T,{children:g.jsx(re,{dateString:e.utstedtdato})})]}),g.jsxs("div",{children:[g.jsx(B,{children:g.jsx(x,{id:n})}),g.jsx(T,{children:s})]}),g.jsxs("div",{children:[g.jsx(B,{children:g.jsx(x,{id:"FodselsammenligningPanel.AntallBarn"})}),g.jsx(T,{children:e.antallBarn})]})]})]})},dt=(e,a,t,n)=>e&&Object.keys(a).length>0?A(Object.values(a)[0]):n?A(n):e?t?A(t):"-":null;Ae.__docgenInfo={description:"",methods:[],displayName:"FodselSammenligningOtherPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  soknadType: string;
  mottattDato: string;
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},vedtaksDatoSomSvangerskapsuke:{required:!1,tsType:{name:"number"},description:""}}};const Me=({avklartBarn:e,harDødtBarn:a})=>g.jsxs(Z,{gap:"space-16",children:[g.jsxs(K,{gap:"space-16",children:[g.jsx(te,{size:"small",level:"3",children:g.jsx(x,{id:"FodselsammenligningPanel.OpplysningerFReg"})}),a&&g.jsx(ye,{variant:"info",size:"small",children:g.jsx(x,{id:"FodselsammenligningPanel.Dodfodt"})})]}),e?.length?g.jsxs(j,{size:"small",children:[g.jsx(j.Header,{children:g.jsxs(j.Row,{children:[g.jsx(j.HeaderCell,{scope:"col",children:g.jsx(x,{id:"FodselsammenligningPanel.Fodselsdato"})}),a&&g.jsx(j.HeaderCell,{scope:"col",children:g.jsx(x,{id:"FodselsammenligningPanel.Dodsdato"})})]})}),g.jsx(j.Body,{children:e.map((t,n)=>{const r=t.fodselsdato+t.dodsdato+n;return g.jsxs(j.Row,{children:[g.jsx(j.DataCell,{children:g.jsx(T,{children:g.jsx(re,{dateString:t.fodselsdato})})}),a&&g.jsx(j.DataCell,{children:t.dodsdato?g.jsxs(K,{gap:"space-16",align:"center",children:[g.jsx(re,{dateString:t.dodsdato}),g.jsx(ye,{variant:"info",size:"small",children:g.jsx(x,{id:"FodselsammenligningPanel.Dod"})})]}):"-"})]},r)})})]}):g.jsx(T,{children:"-"})]});Me.__docgenInfo={description:"",methods:[],displayName:"OpplysningerFraFReg",props:{avklartBarn:{required:!0,tsType:{name:"union",raw:"AvklartBarn[] | undefined",elements:[{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fodselsdato: string;
  dodsdato: string | null;
}`,signature:{properties:[{key:"fodselsdato",value:{name:"string",required:!0}},{key:"dodsdato",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:`Readonly<{
  fodselsdato: string;
  dodsdato: string | null;
}>`}],raw:"AvklartBarn[]"},{name:"undefined"}]},description:""},harDødtBarn:{required:!0,tsType:{name:"boolean"},description:""}}};const mt=({behandlingsType:e,avklartBarn:a=[],soknad:t,vedtaksDatoSomSvangerskapsuke:n,termindato:r,soknadOriginalBehandling:s,familiehendelseOriginalBehandling:o})=>{const l=!!a.find(u=>!!u.dodsdato);return g.jsxs(K,{gap:"space-40",children:[g.jsxs("div",{children:[e!==de.REVURDERING&&g.jsx(Ae,{soknad:t,termindato:r}),e===de.REVURDERING&&g.jsx(Be,{soknadOriginalBehandling:s,familiehendelseOriginalBehandling:o,vedtaksDatoSomSvangerskapsuke:n})]}),g.jsx(Me,{avklartBarn:a,harDødtBarn:l})]})};mt.__docgenInfo={description:"",methods:[],displayName:"FodselSammenligningPanel",props:{behandlingsType:{required:!0,tsType:{name:"string"},description:""},avklartBarn:{required:!1,tsType:{name:"union",raw:"AvklartBarn[] | undefined",elements:[{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fodselsdato: string;
  dodsdato: string | null;
}`,signature:{properties:[{key:"fodselsdato",value:{name:"string",required:!0}},{key:"dodsdato",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:`Readonly<{
  fodselsdato: string;
