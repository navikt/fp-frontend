 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Os;function xu(){if(Os)return jn;Os=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function t(n,s,a){var i=null;if(a!==void 0&&(i=""+a),s.key!==void 0&&(i=""+s.key),"key"in s){a={};for(var o in s)o!=="key"&&(a[o]=s[o])}else a=s;return s=a.ref,{$$typeof:e,type:n,key:i,ref:s!==void 0?s:null,props:a}}return jn.Fragment=r,jn.jsx=t,jn.jsxs=t,jn}var Rs;function Pu(){return Rs||(Rs=1,Es.exports=xu()),Es.exports}var de=Pu();const _a=e=>e.reduce((r,t,n)=>({...r,[n]:s=>t(s)||!0}),{}),ja=(e,r)=>r.split(".").reduce((t,n)=>t!==void 0?t[n]:t,e)?.message;var sr={exports:{}},Su=sr.exports,ws;function Nu(){return ws||(ws=1,function(e,r){(function(t,n){e.exports=n()})(Su,function(){var t={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},n=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,s=/\d/,a=/\d\d/,i=/\d\d?/,o=/\d*[^-_:/,()\s\d]+/,d={},l=function(b){return(b=+b)+(b>68?1900:2e3)},u=function(b){return function(w){this[b]=+w}},f=[/[+-]\d\d:?(\d\d)?|Z/,function(b){(this.zone||(this.zone={})).offset=function(w){if(!w||w==="Z")return 0;var h=w.match(/([+-]|\d\d)/g),A=60*h[1]+(+h[2]||0);return A===0?0:h[0]==="+"?-A:A}(b)}],g=function(b){var w=d[b];return w&&(w.indexOf?w:w.s.concat(w.f))},p=function(b,w){var h,A=d.meridiem;if(A){for(var x=1;x<=24;x+=1)if(b.indexOf(A(x,0,w))>-1){h=x>12;break}}else h=b===(w?"pm":"PM");return h},v={A:[o,function(b){this.afternoon=p(b,!1)}],a:[o,function(b){this.afternoon=p(b,!0)}],Q:[s,function(b){this.month=3*(b-1)+1}],S:[s,function(b){this.milliseconds=100*+b}],SS:[a,function(b){this.milliseconds=10*+b}],SSS:[/\d{3}/,function(b){this.milliseconds=+b}],s:[i,u("seconds")],ss:[i,u("seconds")],m:[i,u("minutes")],mm:[i,u("minutes")],H:[i,u("hours")],h:[i,u("hours")],HH:[i,u("hours")],hh:[i,u("hours")],D:[i,u("day")],DD:[a,u("day")],Do:[o,function(b){var w=d.ordinal,h=b.match(/\d+/);if(this.day=h[0],w)for(var A=1;A<=31;A+=1)w(A).replace(/\[|\]/g,"")===b&&(this.day=A)}],w:[i,u("week")],ww:[a,u("week")],M:[i,u("month")],MM:[a,u("month")],MMM:[o,function(b){var w=g("months"),h=(g("monthsShort")||w.map(function(A){return A.slice(0,3)})).indexOf(b)+1;if(h<1)throw new Error;this.month=h%12||h}],MMMM:[o,function(b){var w=g("months").indexOf(b)+1;if(w<1)throw new Error;this.month=w%12||w}],Y:[/[+-]?\d+/,u("year")],YY:[a,function(b){this.year=l(b)}],YYYY:[/\d{4}/,u("year")],Z:f,ZZ:f};function k(b){var w,h;w=b,h=d&&d.formats;for(var A=(b=w.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(K,$,N){var O=N&&N.toUpperCase();return $||h[N]||t[N]||h[O].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(I,S,F){return S||F.slice(1)})})).match(n),x=A.length,y=0;y<x;y+=1){var P=A[y],_=v[P],C=_&&_[0],B=_&&_[1];A[y]=B?{regex:C,parser:B}:P.replace(/^\[|\]$/g,"")}return function(K){for(var $={},N=0,O=0;N<x;N+=1){var I=A[N];if(typeof I=="string")O+=I.length;else{var S=I.regex,F=I.parser,q=K.slice(O),D=S.exec(q)[0];F.call($,D),K=K.replace(D,"")}}return function(M){var H=M.afternoon;if(H!==void 0){var Y=M.hours;H?Y<12&&(M.hours+=12):Y===12&&(M.hours=0),delete M.afternoon}}($),$}}return function(b,w,h){h.p.customParseFormat=!0,b&&b.parseTwoDigitYear&&(l=b.parseTwoDigitYear);var A=w.prototype,x=A.parse;A.parse=function(y){var P=y.date,_=y.utc,C=y.args;this.$u=_;var B=C[1];if(typeof B=="string"){var K=C[2]===!0,$=C[3]===!0,N=K||$,O=C[2];$&&(O=C[2]),d=this.$locale(),!K&&O&&(d=h.Ls[O]),this.$d=function(q,D,M,H){try{if(["x","X"].indexOf(D)>-1)return new Date((D==="X"?1e3:1)*q);var Y=k(D)(q),W=Y.year,J=Y.month,Ne=Y.day,ve=Y.hours,fe=Y.minutes,le=Y.seconds,X=Y.milliseconds,se=Y.zone,ye=Y.week,ke=new Date,be=Ne||(W||J?1:ke.getDate()),Qe=W||ke.getFullYear(),Ce=0;W&&!J||(Ce=J>0?J-1:ke.getMonth());var Be,On=ve||0,Rn=fe||0,Kn=le||0,on=X||0;return se?new Date(Date.UTC(Qe,Ce,be,On,Rn,Kn,on+60*se.offset*1e3)):M?new Date(Date.UTC(Qe,Ce,be,On,Rn,Kn,on)):(Be=new Date(Qe,Ce,be,On,Rn,Kn,on),ye&&(Be=H(Be).week(ye).toDate()),Be)}catch{return new Date("")}}(P,B,_,h),this.init(),O&&O!==!0&&(this.$L=this.locale(O).$L),N&&P!=this.format(B)&&(this.$d=new Date("")),d={}}else if(B instanceof Array)for(var I=B.length,S=1;S<=I;S+=1){C[1]=B[S-1];var F=h.apply(this,C);if(F.isValid()){this.$d=F.$d,this.$L=F.$L,this.init();break}S===I&&(this.$d=new Date(""))}else x.call(this,y)}}})}(sr)),sr.exports}var Mu=Nu();const Du=ju(Mu),Fu="_textarea_1snk6_1",qu="_readOnlyField_1snk6_7",Ts={textarea:Fu,readOnlyField:qu},Lu=e=>e!=null&&e!=="",Vu=({label:e,value:r,isEdited:t=!1,type:n,hideLabel:s,size:a})=>Lu(r)?de.jsxs(Le,{gap:"1",children:[e&&!s&&de.jsx(me,{size:a,children:e}),de.jsxs(pe,{gap:"2",align:"center",wrap:!1,children:[de.jsx(Ds,{className:n==="textarea"?Ts.textarea:Ts.readOnlyField,size:a,children:r}),t&&de.jsx(Ia,{})]})]}):null;Pn.extend(Du);const Cu="_hideRadioLabels_1u3xf_1",Bu={hideRadioLabels:Cu},Uu=({label:e,description:r,validate:t=[],radios:n,onChange:s,isReadOnly:a=!1,isHorizontal:i=!1,parse:o=v=>v,isTrueOrFalseSelection:d=!1,hideLegend:l=!1,hideRadioLabels:u=!1,isEdited:f=!1,size:g="small",...p})=>{const{name:v,control:k,disabled:b}=p,{formState:{errors:w}}=Ze(),{field:h}=ba({name:v,control:k,rules:{validate:c.useMemo(()=>_a(t),[t])}}),A=d?y=>y==="true":o,x=de.jsxs(pe,{justify:"center",gap:"2",children:[e,a&&f&&de.jsx(Ia,{})]});return de.jsxs(Nd,{name:v,value:h.value!==void 0?h.value:null,onChange:y=>{s&&s(y),h.onChange(y)},size:g,legend:x,description:r,error:ja(w,v),className:u?Bu.hideRadioLabels:"",hideLegend:l,children:[!i&&n.map(y=>de.jsxs(c.Fragment,{children:[de.jsx(Qr,{size:g,value:A(y.value),disabled:y.disabled||b||a,children:y.label}),h.value===A(y.value)&&y.element]},y.value)),i&&de.jsxs(de.Fragment,{children:[de.jsx(pe,{gap:"4",children:n.map(y=>de.jsx(Qr,{size:g,value:A(y.value),disabled:y.disabled||b||a,children:y.label},y.value))}),n.filter(y=>h.value===A(y.value)).map(y=>de.jsx(c.Fragment,{children:y.element},y.value))]})]})},Ku="_textAreaFieldWithBadges_bdz0b_1",Gu="_etikettWrapper_bdz0b_4",As={textAreaFieldWithBadges:Ku,etikettWrapper:Gu},$u=({name:e,control:r,label:t,readOnly:n,maxLength:s,badges:a,validate:i=[],parse:o=p=>p,className:d,description:l,isEdited:u,size:f="small",...g})=>{const{formState:{errors:p}}=Ze(),{field:v}=ba({name:e,control:r,rules:{validate:c.useMemo(()=>_a(i),[i])}});return n?de.jsx(Vu,{size:f,label:t,value:v.value,type:"textarea",isEdited:u,hideLabel:g.hideLabel}):de.jsxs("div",{className:a?As.textAreaFieldWithBadges:null,children:[a&&de.jsx("div",{className:As.etikettWrapper,children:a.map(({type:k,titleText:b})=>de.jsx(Ad,{variant:k,size:"small",children:b},b))}),de.jsx(Cd,{size:f,label:t,description:l,className:d,autoComplete:"off",...v,onChange:k=>v.onChange(k.currentTarget.value!==""?o(k.currentTarget.value):null),value:v.value?v.value:"",error:ja(p,e),maxLength:s,...g})]})},Hu=({formMethods:e,onSubmit:r,children:t,className:n,setDataOnUnmount:s})=>{const{handleSubmit:a,getValues:i}=e;return c.useEffect(()=>()=>{s&&s(i())},[]),de.jsx(Kd,{...e,children:de.jsx("form",{className:n,onSubmit:r?a(o=>r(o)):void 0,children:t})})};var ar=(e=>(e.BRUK_PERMISJON="BRUK_PERMISJON",e.IKKE_BRUK_PERMISJON="IKKE_BRUK_PERMISJON",e))(ar||{}),$t={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Is;function zu(){return Is||(Is=1,function(e){(function(){var r={}.hasOwnProperty;function t(){for(var a="",i=0;i<arguments.length;i++){var o=arguments[i];o&&(a=s(a,n.call(this,o)))}return a}function n(a){if(typeof a=="string"||typeof a=="number")return this&&this[a]||a;if(typeof a!="object")return"";if(Array.isArray(a))return t.apply(this,a);if(a.toString!==Object.prototype.toString&&!a.toString.toString().includes("[native code]"))return a.toString();var i="";for(var o in a)r.call(a,o)&&a[o]&&(i=s(i,this&&this[o]||o));return i}function s(a,i){return i?a?a+" "+i:a+i:a}e.exports?(t.default=t,e.exports=t):window.classNames=t})()}($t)),$t.exports}var Yu=zu();const Wu=_s(Yu),Ju="_boks_kspkv_1",Xu="_aksjonspunkt_kspkv_9",Zu="_harBorderTop_kspkv_13",xa={boks:Ju,aksjonspunkt:Xu,harBorderTop:Zu},Qu=Wu.bind(xa),Pa=({harÅpentAksjonspunkt:e,harBorderTop:r,children:t})=>T.jsx("div",{className:Qu(xa.boks,{aksjonspunkt:e,harBorderTop:r}),children:t});Pa.__docgenInfo={description:"",methods:[],displayName:"ArbeidsforholdBoks",props:{harÅpentAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},harBorderTop:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactElement | ReactElement[]",elements:[{name:"ReactElement"},{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"}]},description:""}}};const Sa=({saksnummer:e,journalpostId:r,dokumentId:t,dokumentTittel:n,children:s})=>{const a=`${r}-${t}`,i=ti(e,r,t);return T.jsx(ca,{href:i,target:a,rel:"noopener noreferrer",onClick:ec(n),children:s??n})},ec=e=>r=>{e&&(r.preventDefault(),ri(r.currentTarget.href,r.currentTarget.target,e))};Sa.__docgenInfo={description:"",methods:[],displayName:"DokumentLink",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},journalpostId:{required:!0,tsType:{name:"string"},description:""},dokumentId:{required:!0,tsType:{name:"string"},description:""},dokumentTittel:{required:!1,tsType:{name:"string"},description:""}}};const nc="_inline_17flc_1",tc="_phoneIcon_17flc_5",rc="_docIcon_17flc_11",Ht={inline:nc,phoneIcon:tc,docIcon:rc},Na=({saksnummer:e,inntektsmelding:r})=>T.jsxs(Le,{gap:"4",children:[T.jsxs(pe,{gap:"4",children:[T.jsx(me,{size:"small",children:T.jsx(Q,{id:"InntektsmeldingOpplysningerPanel.Inntektsmelding"})}),T.jsx(ne,{size:"small",children:T.jsx(rr,{beløp:r.inntektPrMnd})})]}),T.jsxs(pe,{gap:"4",children:[T.jsx(me,{size:"small",children:T.jsx(Q,{id:"InntektsmeldingOpplysningerPanel.Refusjon"})}),T.jsx(ne,{size:"small",children:T.jsx(Q,{id:r.refusjonPrMnd?"InntektsmeldingOpplysningerPanel.Ja":"InntektsmeldingOpplysningerPanel.Nei"})})]}),r.refusjonPrMnd&&T.jsxs(pe,{gap:"4",children:[T.jsx(me,{size:"small",children:T.jsx(Q,{id:"InntektsmeldingOpplysningerPanel.Refusjonsbeløp"})}),T.jsx(ne,{size:"small",children:T.jsx(rr,{beløp:r.refusjonPrMnd})})]}),T.jsx(Sa,{saksnummer:e,journalpostId:r.journalpostId,dokumentId:r.dokumentId,children:T.jsxs(pe,{gap:"1",children:[T.jsx(ne,{size:"small",className:Ht.inline,children:T.jsx(Q,{id:"InntektsmeldingOpplysningerPanel.ÅpneInntektsmelding"})}),T.jsx(Ii,{className:Ht.docIcon})]})}),T.jsxs(pe,{gap:"4",align:"center",children:[T.jsx(Mi,{className:Ht.phoneIcon}),T.jsxs(Le,{gap:"1",children:[T.jsx(me,{size:"small",children:T.jsx(Q,{id:"InntektsmeldingOpplysningerPanel.Kontaktinfo"})}),T.jsx(nt,{children:r.kontaktpersonNavn}),T.jsx(nt,{children:T.jsx(Q,{id:"InntektsmeldingOpplysningerPanel.Tlf",values:{nr:r.kontaktpersonNummer}})})]})]})]});Na.__docgenInfo={description:"",methods:[],displayName:"InntektsmeldingOpplysningerPanel",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},inntektsmelding:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  inntektPrMnd: number;
  ...
  innsendingsårsak: keyof typeof InntektsmeldingInnsendingsårsak;
  tilknyttedeBehandlingIder: string[];
}>`},description:""}}};const sc="_inline_p7hb9_1",ac="_arrow_p7hb9_5",zt={inline:sc,arrow:ac},Ma=({inntektsposter:e,skjæringstidspunkt:r})=>{const[t,n]=c.useState(!1),s=ic(r,e);return T.jsxs(T.Fragment,{children:[e.length>0&&T.jsxs(Le,{gap:"2",children:[T.jsx(me,{size:"small",children:T.jsx(Q,{id:"InntektsposterPanel.Inntekter"})}),T.jsx(Le,{gap:"1",width:"150px",children:s.filter((a,i)=>t?!0:i<3).map(a=>T.jsxs(pe,{justify:"space-between",children:[T.jsxs(pe,{gap:"1",children:[T.jsx(ne,{size:"small",children:T.jsx(Q,{id:`InntektsposterPanel.${Pn(a.fom).month()+1}`})}),T.jsx(ne,{size:"small",children:Pn(a.fom).year()})]},a.fom),T.jsx(ne,{size:"small",children:T.jsx(rr,{beløp:a.beløp})})]},a.fom))}),T.jsxs(ca,{onClick:a=>{a.preventDefault(),n(!t)},href:"",children:[T.jsx("span",{children:T.jsx(ne,{size:"small",className:zt.inline,children:T.jsx(Q,{id:t?"InntektsposterPanel.FaerreManeder":"InntektsposterPanel.TidligereManeder"})})}),t?T.jsx(wi,{className:zt.arrow}):T.jsx(Oi,{className:zt.arrow})]})]}),e.length===0&&T.jsx(me,{size:"small",children:T.jsx(Q,{id:"InntektsposterPanel.IngenInntekt"})})]})},ic=(e,r)=>{const n=Pn(e).startOf("month"),s=n.subtract(12,"month"),a=[];for(let i=n;i.isAfter(s);i=i.subtract(1,"month")){const o=i.format(_r),d=r.find(l=>Pn(l.fom).startOf("month").format(_r)===o);a.push({beløp:d?.beløp||0,fom:o})}return a};Ma.__docgenInfo={description:"",methods:[],displayName:"InntektsposterPanel",props:{inntektsposter:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  beløp: number;
  fom: string;
  tom: string;
  type: string;
