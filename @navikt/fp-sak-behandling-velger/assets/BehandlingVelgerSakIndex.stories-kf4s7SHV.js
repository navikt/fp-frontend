...
*/var ir;function Dl(){return ir||(ir=1,function(e){(function(){var r={}.hasOwnProperty;function a(){for(var o="",l=0;l<arguments.length;l++){var i=arguments[l];i&&(o=t(o,n.call(this,i)))}return o}function n(o){if(typeof o=="string"||typeof o=="number")return this&&this[o]||o;if(typeof o!="object")return"";if(Array.isArray(o))return a.apply(this,o);if(o.toString!==Object.prototype.toString&&!o.toString.toString().includes("[native code]"))return o.toString();var l="";for(var i in o)r.call(o,i)&&o[i]&&(l=t(l,this&&this[i]||i));return l}function t(o,l){return l?o?o+" "+l:o+l:o}e.exports?(a.default=a,e.exports=a):window.classNames=a})()}(or)),or.exports}var Ol=Dl();const Pn=fl(Ol),Il="_borderbox_1a0x6_1",Fl="_error_1a0x6_5",Pl="_warning_1a0x6_8",bl={borderbox:Il,error:Fl,warning:Pl};Pn.bind(bl);const Vl="_aksjonspunkt_11wjs_1",hl="_erAksjonspunktApent_11wjs_4",Gl="_erIkkeGodkjentAvBeslutter_11wjs_8",Ml={aksjonspunkt:Vl,erAksjonspunktApent:hl,erIkkeGodkjentAvBeslutter:Gl};Pn.bind(Ml);const sr=({dateTimeString:e,...r})=>lr.jsx(lr.Fragment,{children:Br(e,r)});Le(Me);Le(Me);const Ul="_divider_1jpov_1",Bl="_dividerParagraf_1jpov_8",jl="_leftPanel_1jpov_11",wl="_rightPanel_1jpov_14",Hl={divider:Ul,dividerParagraf:Bl,leftPanel:jl,rightPanel:wl};Pn.bind(Hl);Le(Me);Le(Me);const Yl="_starImage_1fr57_1",ql="_chevronImage_1fr57_6",xl="_pushRightCorner_1fr57_15",Cl="_line_1fr57_19",Jl="_arsakPadding_1fr57_24",$l="_inline_1fr57_30",Wl="_firstColumnWidth_1fr57_33",ee={starImage:Yl,chevronImage:ql,pushRightCorner:xl,line:Cl,arsakPadding:Jl,inline:$l,firstColumnWidth:Wl},zl=[gn.RE_KLAGE_KA,gn.RE_KLAGE_NFP],Xl=e=>!!e&&zl.some(r=>r===e),xe=({withChevronDown:e=!1,withChevronUp:r=!1,behandling:a,alleKodeverk:n,alleKodeverkTilbakekreving:t})=>{const o=kr(),l=a.type===se.TILBAKEKREVING||a.type===se.TILBAKEKREVING_REVURDERING,i=l?t.BehandlingType:n.BehandlingType,d=l?t.BehandlingResultatType:n.BehandlingResultatType;return S.jsx(Fn.New,{borderWidth:"2",borderColor:"neutral-subtle",borderRadius:"large",padding:"3",children:S.jsxs(vn,{gap:"space-4",children:[S.jsxs(Fe,{gap:"space-16",children:[S.jsx("div",{className:ee.arsakPadding,children:S.jsx(gr,{size:"small",children:i.find(s=>s.kode===a.type)?.navn??""})}),(a.type===se.REVURDERING||a.type===se.KLAGE)&&a.førsteÅrsak?.behandlingArsakType&&S.jsxs(S.Fragment,{children:["-",S.jsx(Q,{size:"small",children:n.BehandlingÅrsakType.find(s=>s.kode===a.førsteÅrsak?.behandlingArsakType)?.navn??""})]}),a.type===se.TILBAKEKREVING_REVURDERING&&Xl(a.førsteÅrsak?.behandlingArsakType)&&S.jsxs(S.Fragment,{children:["-",S.jsx(Q,{size:"small",children:S.jsx(ve,{id:"Behandlingspunkt.Årsak.Klage"})})]}),S.jsx(_l,{}),a.gjeldendeVedtak&&S.jsx(ia,{className:ee.starImage,title:o.formatMessage({id:"BehandlingPickerItemContent.GjeldendeVedtak"})}),e&&S.jsx(aa,{title:o.formatMessage({id:"BehandlingPickerItemContent.Open"}),className:ee.chevronImage}),r&&S.jsx(la,{title:o.formatMessage({id:"BehandlingPickerItemContent.Close"}),className:ee.chevronImage})]}),S.jsx("div",{children:S.jsx("hr",{className:ee.line})}),S.jsxs(vn,{gap:"space-4",children:[S.jsxs(Fe,{gap:"space-4",children:[S.jsx("div",{className:ee.firstColumnWidth,children:S.jsx(Q,{size:"small",children:S.jsx(ve,{id:"BehandlingPickerItemContent.Behandlingstatus"})})}),S.jsx("div",{children:S.jsx(Q,{size:"small",children:n.BehandlingStatus.find(s=>s.kode===a.status)?.navn??""})})]}),S.jsxs(vn,{gap:"space-16",children:[S.jsxs(Fe,{gap:"space-4",children:[S.jsx("div",{className:ee.firstColumnWidth,children:S.jsx(Q,{size:"small",children:S.jsx(ve,{id:"BehandlingPickerItemContent.Resultat"})})}),S.jsx("div",{children:S.jsx(Q,{size:"small",children:d.find(s=>s.kode===a.behandlingsresultat?.type)?.navn??"-"})})]}),S.jsxs(Fe,{gap:"space-4",children:[S.jsx("div",{className:ee.firstColumnWidth,children:S.jsx(Q,{size:"small",children:S.jsx(ve,{id:"BehandlingPickerItemContent.Opprettet"})})}),S.jsx("div",{children:S.jsx(Q,{size:"small",children:S.jsx(sr,{dateTimeString:a.opprettet,separator:"kl"})})})]})]}),S.jsxs(Fe,{gap:"space-4",children:[S.jsx("div",{className:ee.firstColumnWidth,children:S.jsx(Q,{size:"small",children:S.jsx(ve,{id:"BehandlingPickerItemContent.Avsluttet"})})}),S.jsx("div",{children:a.avsluttet&&S.jsx(Q,{size:"small",children:S.jsx(sr,{dateTimeString:a.avsluttet,separator:"kl"})})}),S.jsxs("div",{className:ee.pushRightCorner,children:[S.jsx(Q,{size:"small",className:ee.inline,children:S.jsx(ve,{id:"BehandlingPickerItemContent.Enhet"})}),S.jsx(Sl,{content:a.behandlendeEnhetNavn,placement:"left",children:S.jsx(Q,{size:"small",className:ee.inline,children:a.behandlendeEnhetId})})]})]})]})]})})};xe.__docgenInfo={description:`BehandlingInformasjon
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  K extends TilbakekrevingKodeverkType ? K : unknown
>[]`}}]}},description:""}}};const Zl="_linkToBehandling_1j8le_1",Ql="_toggleShowAllButton_1j8le_2",dr={linkToBehandling:Zl,toggleShowAllButton:Ql},Or=({behandling:e,erKunEnBehandling:r,erAktiv:a,skalViseAlleBehandlinger:n,toggleVisAlleBehandlinger:t,renderRadSomLenke:o,alleKodeverk:l,alleKodeverkTilbakekreving:i})=>r&&a?S.jsx(xe,{behandling:e,withChevronDown:!1,withChevronUp:!1,alleKodeverk:l,alleKodeverkTilbakekreving:i}):r||n?o(dr.linkToBehandling,S.jsx(xe,{behandling:e,withChevronDown:!1,withChevronUp:n&&a,alleKodeverk:l,alleKodeverkTilbakekreving:i}),e.uuid):a?S.jsx("button",{type:"button",className:dr.toggleShowAllButton,onClick:t,children:S.jsx(xe,{behandling:e,withChevronDown:!n,withChevronUp:n,alleKodeverk:l,alleKodeverkTilbakekreving:i})}):null;Or.__docgenInfo={description:"",methods:[],displayName:"BehandlingListeRad",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  K extends TilbakekrevingKodeverkType ? K : unknown
>[]`}}]}},description:""}}};const eo="_behandlingList_12m8o_1",no={behandlingList:eo},ro=e=>[...e].sort((r,a)=>r.avsluttet&&!a.avsluttet?1:!r.avsluttet&&a.avsluttet?-1:r.avsluttet&&a.avsluttet?Ue(a.avsluttet).diff(Ue(r.avsluttet)):Ue(a.opprettet).diff(Ue(r.opprettet))),Ir=({behandlinger:e,renderRadSomLenke:r,behandlingUuid:a,skalViseAlleBehandlinger:n,toggleVisAlleBehandlinger:t,alleKodeverk:o,alleKodeverkTilbakekreving:l})=>{const i=ro(e).filter(d=>n||d.uuid===a);return S.jsxs("ul",{className:no.behandlingList,children:[e.length===0&&S.jsx(Fn.New,{borderWidth:"2",borderColor:"neutral-subtle",borderRadius:"large",padding:"3",children:S.jsx(gr,{size:"small",children:S.jsx(ve,{id:"BehandlingList.ZeroBehandlinger"})})}),e.length>0&&i.map(d=>S.jsx("li",{"data-testid":`behandling-${d.uuid}`,children:S.jsx(Or,{erKunEnBehandling:e.length===1,behandling:d,renderRadSomLenke:r,erAktiv:d.uuid===a,skalViseAlleBehandlinger:n,toggleVisAlleBehandlinger:t,alleKodeverk:o,alleKodeverkTilbakekreving:l})},d.uuid))]})};Ir.__docgenInfo={description:`BehandlingerListe
