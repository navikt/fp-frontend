import{V as _,c as C,H as $,F as t,b as Q,P as X,r as Z,m as J,w as ee,a as A}from"./nb_NO-BxpHY2iN.js";import{u as ne,S as re,K as j,$ as ae,j as R,k as l,l as T,m as w,F as c,W as te,a as se,g as le}from"./BehovForTilretteleggingPanel-BdhUZBG0.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as v}from"./index-C4XKfyRp.js";import{E as ie}from"./EngangsstonadPapirsoknadIndex-CQug3vsU.js";import{F as ue}from"./ForeldrepengerPapirsoknadIndex-B7MFuibX.js";import{S as oe}from"./SvangerskapspengerPapirsoknadIndex-BT9z4ugr.js";import"./v4-CtRu48qb.js";import"./entry-preview-Dci9YZRd.js";import"./iframe-P4A3-32C.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";const ge=[c.ADOPSJON,c.FODSEL],z=({setSoknadData:a,fagsakYtelseType:i,alleKodeverk:s})=>{const u=ne({defaultValues:{fagsakYtelseType:i,familieHendelseType:void 0,foreldreType:void 0}}),b=u.watch("fagsakYtelseType"),q=v.useCallback(r=>a(new re(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[a]),n=s[j.FAGSAK_YTELSE],f=s[j.FAMILIE_HENDELSE_TYPE],o=s[j.FORELDRE_TYPE];return e.jsx(ae,{formMethods:u,onSubmit:q,children:e.jsx(R,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(_,{gap:"4",padding:"5",children:[e.jsx(C,{size:"small",children:e.jsx(l,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs($,{gap:"20",children:[e.jsx(T,{label:e.jsx(l,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[w],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),b!==t.SVANGERSKAPSPENGER&&e.jsx(T,{name:"familieHendelseType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Tema"}),validate:[w],radios:f.filter(({kode:r})=>ge.some(h=>h===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(T,{name:"foreldreType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Soker"}),validate:[w],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(R,{style:{textAlign:"end"},children:e.jsx(Q,{type:"submit",disabled:u.formState.isSubmitting||u.formState.isSubmitted,children:e.jsx(l,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};z.__docgenInfo={description:`SoknadTypePickerForm
...
Toppkomponent for registrering av papirsøknad der søknadstype, tema og søker/foreldretype blir valgt.`,methods:[],displayName:"SoknadTypePickerForm",props:{setSoknadData:{required:!0,tsType:{name:"signature",type:"function",raw:"(soknadData: SoknadData) => void",signature:{arguments:[{type:{name:"SoknadData"},name:"soknadData"}],return:{name:"void"}}},description:""},fagsakYtelseType:{required:!0,tsType:{name:"string"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const de=Z(J),W=({fagsak:a,kodeverk:i,readOnly:s,lagreUfullstendig:u,lagreFullstendig:b,erEndringssøknad:q})=>{const[n,f]=v.useState(),o=v.useCallback(h=>(n&&b(h,n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve()),[n]),r=v.useCallback(()=>(n&&u(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve()),[n]);return e.jsx(X,{value:de,children:e.jsxs(_,{gap:"4",padding:"4",children:[e.jsx(C,{size:"small",children:e.jsx(l,{id:"Registrering.RegistrereSoknad"})}),!s&&e.jsx(te,{children:e.jsx(l,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(z,{setSoknadData:f,fagsakYtelseType:a.fagsakYtelseType,alleKodeverk:i}),n&&n.getFagsakYtelseType()===t.ENGANGSSTONAD&&e.jsx(ie,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:s,soknadData:n,alleKodeverk:i}),n&&n.getFagsakYtelseType()===t.FORELDREPENGER&&e.jsx(ue,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:s,soknadData:n,alleKodeverk:i,fagsakPersonnummer:a.bruker.fødselsnummer,erEndringssøknad:q}),n&&n.getFagsakYtelseType()===t.SVANGERSKAPSPENGER&&e.jsx(oe,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:s,soknadData:n,alleKodeverk:i})]})})};W.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Be={component:W,decorators:[ee,le(J)],args:{readOnly:!1,kodeverk:se,lagreFullstendig:a=>(A("lagreFullstendig")(a),Promise.resolve(a)),lagreUfullstendig:(...a)=>(A("lagreUfullstendig")(a),Promise.resolve({}))}},g={args:{fagsak:{fagsakYtelseType:t.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},d={args:{fagsak:{fagsakYtelseType:t.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},k={args:{fagsak:{fagsakYtelseType:t.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},m={args:{fagsak:{fagsakYtelseType:t.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},y={args:{fagsak:{fagsakYtelseType:t.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},p={args:{fagsak:{fagsakYtelseType:t.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var S,E,B;g.parameters={...g.parameters,docs:{...(S=g.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(B=(E=g.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var P,F,K;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.FORELDREPENGER,
      bruker: {
...
}`,...(K=(F=d.parameters)==null?void 0:F.docs)==null?void 0:K.source}}};var V,N,O;k.parameters={...k.parameters,docs:{...(V=k.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(O=(N=k.parameters)==null?void 0:N.docs)==null?void 0:O.source}}};var Y,H,I;m.parameters={...m.parameters,docs:{...(Y=m.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.SVANGERSKAPSPENGER,
      bruker: {
...
}`,...(I=(H=m.parameters)==null?void 0:H.docs)==null?void 0:I.source}}};var G,L,x;y.parameters={...y.parameters,docs:{...(G=y.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(x=(L=y.parameters)==null?void 0:L.docs)==null?void 0:x.source}}};var U,M,D;p.parameters={...p.parameters,docs:{...(U=p.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.ENGANGSSTONAD,
      bruker: {
...
}`,...(D=(M=p.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};const Pe=["ForeldrepengerFørstegang","ForeldrepengerEndring","SvangerskapspengerFørstegang","SvangerskapspengerEndring","EngangsstonadFørstegang","EngangsstonadEndring"];export{p as EngangsstonadEndring,y as EngangsstonadFørstegang,d as ForeldrepengerEndring,g as ForeldrepengerFørstegang,m as SvangerskapspengerEndring,k as SvangerskapspengerFørstegang,Pe as __namedExportsOrder,Be as default};
