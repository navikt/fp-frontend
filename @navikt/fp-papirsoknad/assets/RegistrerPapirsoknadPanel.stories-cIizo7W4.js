import{j as e,t as T,r as I,P as L,a as D,w as P}from"./iframe-BHeeROv2.js";import{u as V,C as G,B as N,M as t,S as _,R,F as A,a as b,W as O,b as q,g as B}from"./BehovForTilretteleggingPanel-CyPAvESo.js";import{E as f}from"./EngangsstonadPapirsoknadIndex-Comk2ZEV.js";import{F as h}from"./ForeldrepengerPapirsoknadIndex-BSNRHIll.js";import{V as y,H as p,a as U,B as M,m as S}from"./nb_NO-DNfFJ5bw.js";import{S as j}from"./SvangerskapspengerPapirsoknadIndex-BNBqiP07.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CxzDtZVg.js";const H=[A.ADOPSJON,A.FODSEL],K=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:r})=>{const l=V({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),m=l.watch("fagsakYtelseType"),n=r.FagsakYtelseType,o=r.FamilieHendelseType,s=r.ForeldreType;return e.jsx(G,{formMethods:l,onSubmit:a=>{i(new b(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),l.reset(a)},children:e.jsx(N.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(y,{gap:"space-16",padding:"5",children:[e.jsx(p,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(U,{gap:"20",children:[e.jsx(_,{name:"fagsakYtelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],children:n.map(a=>e.jsx(R,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),m!=="SVP"&&e.jsx(_,{name:"familieHendelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],children:o.filter(({kode:a})=>H.some(g=>g===a)).map(a=>e.jsx(R,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(_,{name:"foreldreType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],children:s.map(a=>e.jsx(R,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(N,{style:{textAlign:"end"},children:e.jsx(M,{type:"submit",disabled:!l.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};K.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const w=D(S),F=({fagsak:i,kodeverk:u,readOnly:r,lagrePapirsøknad:l,erEndringssøknad:m})=>{const[n,o]=I.useState(),s=g=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,g),Promise.resolve()),a=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(L,{value:w,children:e.jsxs(y,{gap:"space-16",padding:"4",children:[e.jsx(p,{size:"small",level:"2",children:m?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(O,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(K,{setSoknadData:o,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()==="ES"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()==="FP"&&e.jsx(h,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:m}),n&&n.getFagsakYtelseType()==="SVP"&&e.jsx(j,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u})]})})};F.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  saksnummer: string;
...
| 'DELAYED'
| 'CANCELLED'
| 'HALTED'`,elements:[{name:"literal",value:"'PENDING'"},{name:"literal",value:"'COMPLETE'"},{name:"literal",value:"'DELAYED'"},{name:"literal",value:"'CANCELLED'"},{name:"literal",value:"'HALTED'"}],required:!1}},{key:"eta",value:{name:"string",required:!1}},{key:"message",value:{name:"string",required:!0}},{key:"pollIntervalMillis",value:{name:"number",required:!1}},{key:"location",value:{name:"string",required:!1}},{key:"cancelUri",value:{name:"string",required:!1}},{key:"readOnly",value:{name:"boolean",required:!1}},{key:"pending",value:{name:"boolean",required:!1}}]},required:!1}},{key:"behandlingKoet",value:{name:"boolean",required:!1}}]}}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:c}=__STORYBOOK_MODULE_ACTIONS__,Z={component:F,decorators:[P,B(S)],args:{readOnly:!1,kodeverk:q,lagrePapirsøknad:i=>(c("lagrePapirsøknad")(i),Promise.resolve({}))}},E={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},d={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},k={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
