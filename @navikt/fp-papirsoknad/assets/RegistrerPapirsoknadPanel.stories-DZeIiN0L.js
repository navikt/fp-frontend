import{j as e,t as A,r as o,P,a as F,w as k}from"./iframe-CIENZKRI.js";import{u as V,C as g,B as I,M as t,S,R as s,a as M,W as B,b as y,g as U}from"./BehovForTilretteleggingPanel-DOMDa0Ho.js";import{E as p}from"./EngangsstonadPapirsoknadIndex-U4ZgmTLh.js";import{F as H}from"./ForeldrepengerPapirsoknadIndex-Cl8ETeBJ.js";import{V as L,H as K,a as b,B as q,m as D}from"./nb_NO-B8m9QYFa.js";import{S as f}from"./SvangerskapspengerPapirsoknadIndex-CI7fIUp6.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BXa8Xwme.js";const h=new Set(["ADPSJN","FODSL"]),G=({setSoknadData:E,fagsakYtelseType:i,alleKodeverk:r})=>{const n=V({defaultValues:{fagsakYtelseType:i,familieHendelseType:void 0,foreldreType:void 0}}),m=n.watch("fagsakYtelseType"),l=r.FagsakYtelseType,T=r.FamilieHendelseType,u=r.ForeldreType;return e.jsx(g,{formMethods:n,onSubmit:a=>{E(new M(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),n.reset(a)},children:e.jsx(I.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(L,{gap:"space-16",padding:"5",children:[e.jsx(K,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(b,{gap:"20",children:[e.jsx(S,{name:"fagsakYtelseType",control:n.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[A],children:l.map(a=>e.jsx(s,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),m!=="SVP"&&e.jsx(S,{name:"familieHendelseType",control:n.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[A],children:T.filter(({kode:a})=>h.has(a)).map(a=>e.jsx(s,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(S,{name:"foreldreType",control:n.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[A],children:u.map(a=>e.jsx(s,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(I,{style:{textAlign:"end"},children:e.jsx(q,{type:"submit",disabled:!n.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};G.__docgenInfo={description:`SoknadTypePickerForm
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Y=F(D),O=({fagsak:E,kodeverk:i,readOnly:r,lagrePapirsøknad:n,erEndringssøknad:m})=>{const[l,T]=o.useState(),u=d=>(l&&n(l.fagsakYtelseType,l.familieHendelseType,l.foreldreType,d),Promise.resolve()),a=()=>(l&&n(l.fagsakYtelseType,l.familieHendelseType,l.foreldreType),Promise.resolve());return e.jsx(P,{value:Y,children:e.jsxs(L,{gap:"space-16",padding:"4",children:[e.jsx(K,{size:"small",level:"2",children:m?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(B,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(G,{setSoknadData:T,fagsakYtelseType:E.fagsakYtelseType,alleKodeverk:i}),l&&l.getFagsakYtelseType()==="ES"&&e.jsx(p,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:l,alleKodeverk:i}),l&&l.getFagsakYtelseType()==="FP"&&e.jsx(H,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:l,alleKodeverk:i,fagsakPersonnummer:E.bruker.fødselsnummer,erEndringssøknad:m}),l&&l.getFagsakYtelseType()==="SVP"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:l,alleKodeverk:i})]})})};O.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string;
...
) => Promise<Behandling>`,signature:{arguments:[{type:{name:"union",raw:"'ES' | 'FP' | 'SVP' | '-'",elements:[{name:"literal",value:"'ES'"},{name:"literal",value:"'FP'"},{name:"literal",value:"'SVP'"},{name:"literal",value:"'-'"}]},name:"fagsakYtelseType"},{type:{name:"union",raw:`| 'ADPSJN'
| 'OMSRGO'
| 'FODSL'
| 'TERM'
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:J}=__STORYBOOK_MODULE_ACTIONS__,Q={component:O,decorators:[k,U(D)],args:{readOnly:!1,kodeverk:y,lagrePapirsøknad:E=>(J("lagrePapirsøknad")(E),Promise.resolve({}))}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},N={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},_={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},R={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
