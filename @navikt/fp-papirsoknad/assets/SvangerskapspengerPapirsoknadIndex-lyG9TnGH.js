import{j as a}from"./iframe-Bs05aB8Z.js";import{u as K,L as i,e as u,j as N,k as m,i as R,F as v,V as T,I as _,d as A,f as S,C as O,H as G}from"./BehovForTilretteleggingPanel-DBFLvUIs.js";const P=()=>({...S.initialValues(),...A.initialValues(),..._.initialValues(),...T.initialValues(),...v.initialValues(),...R.initialValues(),...m.initialValues(),...N.initialValues(),...u.initialValues(),...i.initialValues()}),F=e=>({...S.transformValues(e),...A.transformValues(e),..._.transformValues(e),...T.transformValues(e),...v.transformValues(e),...R.transformValues(e),...m.transformValues(e),...N.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),I=({readOnly:e,soknadData:n,alleKodeverk:l,onSubmit:E,onSubmitUfullstendigsoknad:r})=>{const t=K({defaultValues:P()}),L=t.watch("mottattDato");return a.jsxs(O,{formMethods:t,onSubmit:D=>E(F(D)),children:[a.jsxs(G,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(S,{readOnly:e}),a.jsx(A,{readOnly:e,alleKodeverk:l,erAdopsjon:n.getFamilieHendelseType()!=="ADPSJN",mottattDato:L}),a.jsx(_,{readOnly:e,alleKodeverk:l}),a.jsx(T,{readOnly:e,alleKodeverk:l}),a.jsx(v,{readOnly:e}),a.jsx(R,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:l}),a.jsx(m,{readOnly:e}),a.jsx(N,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:r,submitting:t.formState.isSubmitting,erEndringssøknad:!1})]})};I.__docgenInfo={description:`SvangerskapspengerForm
