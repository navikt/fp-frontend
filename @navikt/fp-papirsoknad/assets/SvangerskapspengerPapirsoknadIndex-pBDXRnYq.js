import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{u as F,L as l,c as u,h as k,i as d,d as o,e as g,V as y,I as p,f as v,M as m,N as R,H as j,F as K}from"./BehovForTilretteleggingPanel-BCdjrWKr.js";import"./withThemeDecorator-B4N3Iszh.js";const V=()=>({...m.initialValues(),...v.initialValues(),...p.initialValues(),...y.initialValues(),...g.initialValues(),...o.initialValues(),...d.initialValues(),...k.initialValues(),...u.initialValues(),...l.initialValues()}),P=e=>({...m.transformValues(e),...v.transformValues(e),...p.transformValues(e),...y.transformValues(e),...g.transformValues(e),...o.transformValues(e),...d.transformValues(e),...k.transformValues(e),...u.transformValues(e),...l.transformValues(e)}),T=({readOnly:e,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=F({defaultValues:V()}),A=i.watch("mottattDato");return r.jsxs(R,{formMethods:i,onSubmit:q=>t(P(q)),children:[r.jsxs(j,{columns:{sm:1,md:2},gap:"4",children:[r.jsx(m,{readOnly:e}),r.jsx(v,{readOnly:e,alleKodeverk:a,erAdopsjon:n.getFamilieHendelseType()!==K.ADOPSJON,mottattDato:A}),r.jsx(p,{readOnly:e,alleKodeverk:a}),r.jsx(y,{readOnly:e,alleKodeverk:a}),r.jsx(g,{readOnly:e}),r.jsx(o,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:a}),r.jsx(d,{readOnly:e}),r.jsx(k,{readOnly:e}),r.jsx(u,{readOnly:e})]}),r.jsx(l,{readOnly:e,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting})]})};T.__docgenInfo={description:`SvangerskapspengerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{w as S};
