import{j as e,t as T,F as l,r as I,P as D,a as M,w as U}from"./iframe-BTg9xa2y.js";import{u as H,N as L,B as A,M as s,a as b,F as E,S as Y,K as x,b as J,g as C}from"./BehovForTilretteleggingPanel-DeGDuPl-.js";import{E as z}from"./EngangsstonadPapirsoknadIndex-CFaZNvRr.js";import{F as W}from"./ForeldrepengerPapirsoknadIndex-BCQOXbzn.js";import{V as G,H as c,a as Q,B as X,m as O}from"./nb_NO-Be6KcCN5.js";import{S as Z}from"./SvangerskapspengerPapirsoknadIndex-D2cDzzE5.js";import"./index-C0X4JzzF.js";const $=[E.ADOPSJON,E.FODSEL],P=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const a=H({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),o=a.watch("fagsakYtelseType"),n=t.FagsakYtelseType,p=t.FamilieHendelseType,k=t.ForeldreType;return e.jsx(L,{formMethods:a,onSubmit:r=>{i(new Y(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),a.reset(r)},children:e.jsx(A,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(G,{gap:"4",padding:"5",children:[e.jsx(c,{size:"small",children:e.jsx(s,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(Q,{gap:"20",children:[e.jsx(b,{name:"fagsakYtelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),o!==l.SVANGERSKAPSPENGER&&e.jsx(b,{name:"familieHendelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],radios:p.filter(({kode:r})=>$.some(v=>v===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(b,{name:"foreldreType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],radios:k.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(X,{type:"submit",disabled:!a.formState.isDirty,children:e.jsx(s,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};P.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ee=M(O),_=({fagsak:i,kodeverk:u,readOnly:t,lagrePapirsøknad:a,erEndringssøknad:o})=>{const[n,p]=I.useState(),k=v=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,v),Promise.resolve()),r=()=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(D,{value:ee,children:e.jsxs(G,{gap:"4",padding:"4",children:[e.jsx(c,{size:"small",children:o?e.jsx(s,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(s,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(x,{children:e.jsx(s,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(P,{setSoknadData:p,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.ENGANGSSTONAD&&e.jsx(z,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.FORELDREPENGER&&e.jsx(W,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:o}),n&&n.getFagsakYtelseType()===l.SVANGERSKAPSPENGER&&e.jsx(Z,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})};_.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:ne}=__STORYBOOK_MODULE_ACTIONS__,ke={component:_,decorators:[U,C(O)],args:{readOnly:!1,kodeverk:J,lagrePapirsøknad:i=>(ne("lagrePapirsøknad")(i),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:l.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:l.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};var q,R,h;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(h=(R=d.parameters)==null?void 0:R.docs)==null?void 0:h.source}}};var j,f,V;g.parameters={...g.parameters,docs:{...(j=g.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.FORELDREPENGER,
      bruker: {
...
}`,...(V=(f=g.parameters)==null?void 0:f.docs)==null?void 0:V.source}}};var S,K,B;m.parameters={...m.parameters,docs:{...(S=m.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(B=(K=m.parameters)==null?void 0:K.docs)==null?void 0:B.source}}};var N,w,F;y.parameters={...y.parameters,docs:{...(N=y.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(F=(w=y.parameters)==null?void 0:w.docs)==null?void 0:F.source}}};const oe=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{y as EngangsstonadFørstegangssøknad,g as ForeldrepengerEndringssøknad,d as ForeldrepengerFørstegangssøknad,m as SvangerskapspengerFørstegangssøknad,oe as __namedExportsOrder,ke as default};
