 ...
 */var Yi;function lp(){if(Yi)return ta;Yi=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,t,s){var i=null;if(s!==void 0&&(i=""+s),t.key!==void 0&&(i=""+t.key),"key"in t){s={};for(var o in t)o!=="key"&&(s[o]=t[o])}else s=t;return t=s.ref,{$$typeof:e,type:a,key:i,ref:t!==void 0?t:null,props:s}}return ta.Fragment=r,ta.jsx=n,ta.jsxs=n,ta}var Ci;function dp(){return Ci||(Ci=1,Hi.exports=lp()),Hi.exports}var $e=dp();const bT=({children:e})=>{const r=O.Children.toArray(e);return r.length===0?null:$e.jsx(ot,{variant:"warning",size:"small",children:$e.jsx(W,{gap:"space-8","data-testid":"aksjonspunkt-text-container",children:r.map(n=>$e.jsx(Ze,{size:"small",children:n},up(n)))})})},up=e=>{if(O.isValidElement(e))return e.key;if(typeof e=="string"||typeof e=="number")return`tekst-${e}`},Sa={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};Re(Sa);const Ja="var(--ax-bg-neutral-strong)",Ul=4,kp=(e,r,n)=>`
  .arrowBoxTop${e} {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const Ue="frilans",ka=(e,r)=>e(r),cy=(e=[])=>e.map(r=>r.periodeFom).filter(r=>r&&r!=="").sort((r,n)=>Ie(r,gr).diff(Ie(n,gr))),fy=Es(50),Ry=(e,r,n,a)=>()=>{const t=ka(e,`${r}.fomDato`);return n.length>0&&n[0]&&t&&!Ie(n[0]).isSameOrBefore(Ie(t))?a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},nd=({readOnly:e})=>{const r=fe(),{control:n,getValues:a,watch:t,trigger:s,formState:{isSubmitted:i}}=B(),{fields:o,remove:d,append:m}=tr({control:n,name:`${Ue}.oppdragPerioder`}),u=t(`${Ue}.perioder`),k=cy(u);return l.jsx(cr,{bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:o,readOnly:e,append:m,remove:d,children:(v,p,E)=>{const f=`${Ue}.oppdragPerioder.${p}`;return l.jsxs(Be,{gap:"space-16",paddingBlock:"2",align:"end",children:[l.jsx(Q,{name:`${Ue}.oppdragPerioder.${p}.fomDato`,control:n,label:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[re,Ry(a,f,k,r),()=>{const T=ka(a,`${f}.fomDato`),c=ka(a,`${f}.tomDato`);return c&&T?ar(c)(T):null}],onChange:()=>i?s():void 0}),l.jsx(Q,{name:`${Ue}.oppdragPerioder.${p}.tomDato`,control:n,label:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[re,()=>{const T=ka(a,`${f}.fomDato`),c=ka(a,`${f}.tomDato`);return c&&T?Ge(T)(c):null}],onChange:()=>i?s():void 0}),l.jsx(je,{name:`${Ue}.oppdragPerioder.${p}.oppdragsgiver`,control:n,validate:[fy],label:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),E&&l.jsx("div",{children:E()})]},v.id)}})};nd.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray
...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Fy=Re(Le),Xs=({readOnly:e})=>l.jsx(dr,{value:Fy,children:l.jsx(Cn,{readOnly:e})});Xs.initialValues=Cn.initialValues;Xs.transformValues=Cn.transformValues;Xs.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Kn="arbeidsforhold",an=({children:e,remove:r,readOnly:n,index:a})=>l.jsxs(l.Fragment,{children:[a>0&&l.jsx(Pp,{spaceUnder:!0,spaceAbove:!0}),l.jsxs(Be,{wrap:!1,justify:"space-between",children:[l.jsx(Be,{wrap:!0,gap:"space-16",children:e}),!n&&a>0&&l.jsx(We,{type:"button",variant:"tertiary-neutral",icon:l.jsx(ut,{}),onClick:()=>r(a)})]})]});an.__docgenInfo={description:"",methods:[],displayName:"FieldArrayRow",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},remove:{required:!0,tsType:{name:"signature",type:"function",raw:"(index: number) => void",signature:{arguments:[{type:{name:"number"},name:"index"}],return:{name:"void"}}},description:""},index:{required:!0,tsType:{name:"number"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Oy=Es(50),Ny=e=>e.filter(({kode:r})=>r!==dt.NORGE).map(({kode:r,navn:n})=>l.jsx("option",{value:r,children:n},r)),ad=({alleKodeverk:e,readOnly:r})=>{const n=fe(),{control:a}=B(),{fields:t,remove:s,append:i}=tr({control:a,name:Kn}),o=e.Landkoder.slice().sort((d,m)=>d.navn.localeCompare(m.navn));return l.jsx(cr,{fields:t,bodyText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:r,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:s,append:i,children:(d,m)=>l.jsxs(an,{remove:s,index:m,readOnly:r,children:[l.jsx(je,{readOnly:r,control:a,name:`${Kn}.${m}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[Oy],maxLength:99}),l.jsx(Q,{name:`${Kn}.${m}.periodeFom`,control:a,isReadOnly:r,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[re]}),l.jsx(Q,{name:`${Kn}.${m}.periodeTom`,control:a,isReadOnly:r,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[re]}),l.jsx(nr,{name:`${Kn}.${m}.land`,control:a,readOnly:r,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:Ny(o),size:"small"})]},d.id)})};ad.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const sT=(e,r,n)=>r===Ta.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):r===Ta.SYKDOM_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):n,iT=(e,r,n,a)=>e.filter(({kode:t})=>n||t!==Ta.ALENEOMSORG&&t!==Ta.IKKE_RETT_ANNEN_FORELDER).map(({kode:t,navn:s})=>r?l.jsx("option",{value:t,children:s},t):l.jsx("option",{value:t,children:sT(a,t,s)},t)),Kt=({foreldreType:e,alleKodeverk:r,readOnly:n,erEndringssøknad:a})=>{const t=fe(),s=r.OverføringÅrsak,i=iT(s,e===lt.MOR,a,t),{watch:o,control:d}=B(),m=o(`${me}.skalOvertaKvote`)||!1;return l.jsxs(W,{gap:"space-8",children:[l.jsx(ur,{children:l.jsx(j,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),l.jsx(lr,{name:`${me}.skalOvertaKvote`,control:d,readOnly:n,label:l.jsx(j,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),m&&l.jsx(dd,{selectValues:i,readOnly:n})]})};Kt.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});Kt.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
