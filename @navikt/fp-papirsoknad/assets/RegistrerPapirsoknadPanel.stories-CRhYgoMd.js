import{V as _,c as C,H as $,F as t,b as Q,P as X,f as Z,m as J,w as ee,a as A}from"./nb_NO-B1sr8bdU.js";import{u as ne,S as re,K as j,$ as ae,j as R,k as l,l as T,m as w,F as c,W as te,a as se,g as le}from"./BehovForTilretteleggingPanel-BY1_ICDk.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as v}from"./index-C4XKfyRp.js";import{E as ie}from"./EngangsstonadPapirsoknadIndex-DjKz6FO3.js";import{F as ue}from"./ForeldrepengerPapirsoknadIndex-DxvoA8z-.js";import{S as oe}from"./SvangerskapspengerPapirsoknadIndex-DBMMJCqt.js";import"./v4-CtRu48qb.js";import"./entry-preview-BCyS24w3.js";import"./iframe-D_nV7Xem.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";const ge=[c.ADOPSJON,c.FODSEL],z=({setSoknadData:a,fagsakYtelseType:i,alleKodeverk:s})=>{const u=ne({defaultValues:{fagsakYtelseType:i,familieHendelseType:void 0,foreldreType:void 0}}),b=u.watch("fagsakYtelseType"),q=v.useCallback(r=>a(new re(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[a]),n=s[j.FAGSAK_YTELSE],f=s[j.FAMILIE_HENDELSE_TYPE],o=s[j.FORELDRE_TYPE];return e.jsx(ae,{formMethods:u,onSubmit:q,children:e.jsx(R,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(_,{gap:"4",padding:"5",children:[e.jsx(C,{size:"small",children:e.jsx(l,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs($,{gap:"20",children:[e.jsx(T,{label:e.jsx(l,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[w],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),b!==t.SVANGERSKAPSPENGER&&e.jsx(T,{name:"familieHendelseType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Tema"}),validate:[w],radios:f.filter(({kode:r})=>ge.some(h=>h===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(T,{name:"foreldreType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Soker"}),validate:[w],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(R,{style:{textAlign:"end"},children:e.jsx(Q,{type:"submit",disabled:u.formState.isSubmitting||u.formState.isSubmitted,children:e.jsx(l,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};z.__docgenInfo={description:`SoknadTypePickerForm
