import{j as a}from"./iframe-C4meVAis.js";import{u as P,L as u,h as N,i as R,f as m,P as F,H as V,e as T,A as v,O as _,c as A,T as S,D as I,j as L,F as D,V as O,I as K,d as G}from"./BehovForTilretteleggingPanel-B-TtJB26.js";const p=()=>({...m.initialValues(),...R.initialValues(),...N.initialValues(),...u.initialValues()}),g=e=>({...m.transformValues(e),...R.transformValues(e),...N.tranformValues(e),...u.transformValues(e)}),s=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:r,onSubmitUfullstendigsoknad:t})=>{const i=P({defaultValues:p()});return a.jsxs(F,{formMethods:i,onSubmit:E=>r(g(E)),children:[a.jsxs(V,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(m,{readOnly:e}),a.jsx(N,{annenForelderInformertRequired:!0,readOnly:e})]}),a.jsx(R,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!0}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!0})]})};s.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
