import{V as _,c as C,H as $,F as t,b as Q,P as X,f as Z,m as J,w as ee,a as w}from"./nb_NO-Cn5tsTcH.js";import{u as ne,S as re,K as j,h as ae,k as R,l,J as h,m as c,F as A,n as te,a as se,g as le}from"./BehovForTilretteleggingPanel-BSL_QBmf.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as v}from"./index-_2TAQcTa.js";import{E as ie}from"./EngangsstonadPapirsoknadIndex-CDVtKPMs.js";import{F as ue}from"./ForeldrepengerPapirsoknadIndex-DWdCxVgx.js";import{S as oe}from"./SvangerskapspengerPapirsoknadIndex-B5rNKQjo.js";import"./v4-CtRu48qb.js";import"./entry-preview-Ns4f9iyJ.js";import"./iframe-D0J1wjsF.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BwSyabb1.js";import"./index-CXQShRbs.js";import"./index-BsrZSYsV.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CQwh6Daz.js";import"./dayjs.min-DkLNzaWO.js";const ge=[A.ADOPSJON,A.FODSEL],z=({setSoknadData:a,fagsakYtelseType:i,alleKodeverk:s})=>{const u=ne({defaultValues:{fagsakYtelseType:i,familieHendelseType:void 0,foreldreType:void 0}}),b=u.watch("fagsakYtelseType"),f=v.useCallback(r=>a(new re(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[a]),n=s[j.FAGSAK_YTELSE],q=s[j.FAMILIE_HENDELSE_TYPE],o=s[j.FORELDRE_TYPE];return e.jsx(ae,{formMethods:u,onSubmit:f,children:e.jsx(R,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(_,{gap:"4",padding:"5",children:[e.jsx(C,{size:"small",children:e.jsx(l,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs($,{gap:"20",children:[e.jsx(h,{label:e.jsx(l,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[c],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),b!==t.SVANGERSKAPSPENGER&&e.jsx(h,{name:"familieHendelseType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Tema"}),validate:[c],radios:q.filter(({kode:r})=>ge.some(T=>T===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(h,{name:"foreldreType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Soker"}),validate:[c],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(R,{style:{textAlign:"end"},children:e.jsx(Q,{type:"submit",disabled:u.formState.isSubmitting||u.formState.isSubmitted,children:e.jsx(l,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};z.__docgenInfo={description:`SoknadTypePickerForm
