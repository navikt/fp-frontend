import{j as a}from"./iframe-D4pnO6wK.js";import{c as n,O as E,d as r,e as t,T as v,u as G,L as _,f as A,P,H as F}from"./BehovForTilretteleggingPanel-7VM93mx4.js";const R=({readOnly:e,soknadData:l,alleKodeverk:i,fodselsdato:u,mottattDato:N})=>a.jsxs(a.Fragment,{children:[a.jsx(n,{readOnly:e,soknadData:l}),a.jsx(E,{readOnly:e,familieHendelseType:l.getFamilieHendelseType(),fodselsdato:u}),a.jsx(r,{readOnly:e,alleKodeverk:i,erAdopsjon:l.getFamilieHendelseType()!=="ADPSJN",mottattDato:N}),a.jsx(t,{readOnly:e})]});R.initialValues=()=>({...n.initialValues(),...E.initialValues(),...r.initialValues(),...t.initialValues()});R.transformValues=e=>({...n.transformValues(e),...E.transformValues(e),...r.transformValues(e),...t.transformValues(e)});R.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringAdopsjonOgOmsorgGrid.initialValues"}],raw:"ReturnType<typeof RegistreringAdopsjonOgOmsorgGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringAdopsjonOgOmsorgGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const S=({readOnly:e,soknadData:l,alleKodeverk:i,onSubmitUfullstendigsoknad:u,onSubmit:N})=>{const L=I(l.getFamilieHendelseType()),m=G({defaultValues:V()}),D=m.watch("foedselsDato"),O=m.watch("mottattDato");return a.jsxs(P,{formMethods:m,onSubmit:K=>N(M(l,K)),children:[a.jsxs(F,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(A,{readOnly:e}),a.jsx(L,{soknadData:l,readOnly:e,alleKodeverk:i,fodselsdato:D,mottattDato:O})]}),a.jsx(_,{readOnly:e,submitting:m.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},V=()=>({...A.initialValues(),...T.initialValues(),...R.initialValues(),..._.initialValues()}),M=(e,l)=>({...A.transformValues(l),...I(e.getFamilieHendelseType()).transformValues(l),..._.transformValues(l)}),I=e=>{if(e==="FODSL")return T;if(e==="ADPSJN")return R;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};S.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
  [K in Exclude<KodeverkType, 'PeriodeResultatÅrsak'>]: KodeverkMedNavn<K extends KodeverkType ? K : unknown>[];
}`,signature:{properties:[{key:{name:"Exclude",elements:[{name:"signature",type:"object",raw:`{
