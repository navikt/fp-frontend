import{j as e,F as l,r as V,P as S,w as K}from"./iframe-lMmQThvQ.js";import{u as N,N as B,B as A,M as s,a as T,t as b,F as E,S as w,K as F,b as O,g as _}from"./BehovForTilretteleggingPanel-BcYkwVEB.js";import{V as q,H as R,a as G,B as c,r as P,m as h}from"./nb_NO-BQouOlBI.js";import{E as I}from"./EngangsstonadPapirsoknadIndex-CMa6jOET.js";import{F as D}from"./ForeldrepengerPapirsoknadIndex-DhUPddzw.js";import{S as M}from"./SvangerskapspengerPapirsoknadIndex-D9UC5xma.js";import"./index-D1a2dDpX.js";const U=[E.ADOPSJON,E.FODSEL],j=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const a=N({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),k=a.watch("fagsakYtelseType"),n=t.FagsakYtelseType,p=t.FamilieHendelseType,o=t.ForeldreType;return e.jsx(B,{formMethods:a,onSubmit:r=>{i(new w(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),a.reset(r)},children:e.jsx(A,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(q,{gap:"4",padding:"5",children:[e.jsx(R,{size:"small",children:e.jsx(s,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(G,{gap:"20",children:[e.jsx(T,{name:"fagsakYtelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[b],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),k!==l.SVANGERSKAPSPENGER&&e.jsx(T,{name:"familieHendelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Tema"}),validate:[b],radios:p.filter(({kode:r})=>U.some(v=>v===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(T,{name:"foreldreType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Soker"}),validate:[b],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(c,{type:"submit",disabled:!a.formState.isDirty,children:e.jsx(s,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};j.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const H=P(h),f=({fagsak:i,kodeverk:u,readOnly:t,lagrePapirsøknad:a,erEndringssøknad:k})=>{const[n,p]=V.useState(),o=v=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,v),Promise.resolve()),r=()=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(S,{value:H,children:e.jsxs(q,{gap:"4",padding:"4",children:[e.jsx(R,{size:"small",children:k?e.jsx(s,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(s,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(F,{children:e.jsx(s,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(j,{setSoknadData:p,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.ENGANGSSTONAD&&e.jsx(I,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.FORELDREPENGER&&e.jsx(D,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:k}),n&&n.getFagsakYtelseType()===l.SVANGERSKAPSPENGER&&e.jsx(M,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:t,soknadData:n,alleKodeverk:u})]})})};f.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:L}=__STORYBOOK_MODULE_ACTIONS__,X={component:f,decorators:[K,_(h)],args:{readOnly:!1,kodeverk:O,lagrePapirsøknad:i=>(L("lagrePapirsøknad")(i),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:l.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:l.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
