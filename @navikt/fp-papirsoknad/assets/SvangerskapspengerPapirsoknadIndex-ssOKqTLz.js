import{j as r}from"./iframe-BctlxGYK.js";import{u as F,L as l,f as u,l as k,m as d,j as o,k as g,V as y,I as p,d as v,h as m,N as R,H as j,F as K}from"./BehovForTilretteleggingPanel-BZTkBt-s.js";const V=()=>({...m.initialValues(),...v.initialValues(),...p.initialValues(),...y.initialValues(),...g.initialValues(),...o.initialValues(),...d.initialValues(),...k.initialValues(),...u.initialValues(),...l.initialValues()}),P=e=>({...m.transformValues(e),...v.transformValues(e),...p.transformValues(e),...y.transformValues(e),...g.transformValues(e),...o.transformValues(e),...d.transformValues(e),...k.transformValues(e),...u.transformValues(e),...l.transformValues(e)}),T=({readOnly:e,soknadData:n,alleKodeverk:a,onSubmit:s,onSubmitUfullstendigsoknad:t})=>{const i=F({defaultValues:V()}),A=i.watch("mottattDato");return r.jsxs(R,{formMethods:i,onSubmit:q=>s(P(q)),children:[r.jsxs(j,{columns:{sm:1,md:2},gap:"4",children:[r.jsx(m,{readOnly:e}),r.jsx(v,{readOnly:e,alleKodeverk:a,erAdopsjon:n.getFamilieHendelseType()!==K.ADOPSJON,mottattDato:A}),r.jsx(p,{readOnly:e,alleKodeverk:a}),r.jsx(y,{readOnly:e,alleKodeverk:a}),r.jsx(g,{readOnly:e}),r.jsx(o,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:a}),r.jsx(d,{readOnly:e}),r.jsx(k,{readOnly:e}),r.jsx(u,{readOnly:e})]}),r.jsx(l,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!1})]})};T.__docgenInfo={description:`SvangerskapspengerForm
