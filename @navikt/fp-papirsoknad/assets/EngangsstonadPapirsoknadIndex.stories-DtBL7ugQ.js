import{j as n}from"./jsx-runtime-DR9Q75dM.js";import{R as D,O as d,f as o,S as K,b as v,d as k,a as U,M as X,L as J,r as $,h as i,i as b,z as S,j as A}from"./BehovForTilretteleggingPanel-CAryNlDx.js";import{H as G,u as Y,$ as z,b as B,w as C}from"./index.es-Bjm0LBRH.js";import"./index-DRjF_FHU.js";import"./v4-CQkTLCs1.js";import"./index-rX-Bn4lm.js";import"./dayjs.min-DN4LN79F.js";const Q="_col_hlukm_1",j={col:Q},F="omsorg",l=({readOnly:e,soknadData:r,alleKodeverk:s,fodselsdato:a,mottattDato:t})=>n.jsxs(G,{justify:"space-between",children:[n.jsxs("div",{className:j.col,children:[n.jsx(D,{readOnly:e,soknadData:r}),n.jsx(d,{readOnly:e,alleKodeverk:s,erAdopsjon:r.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:t}),n.jsx(K,{readOnly:e})]}),n.jsx("div",{className:j.col,children:n.jsx(v,{readOnly:e,familieHendelseType:r.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:a})})]});l.transformValues=e=>({...d.transformValues(e),[F]:v.transformValues(e[F])});l.buildInitialValues=()=>({[F]:{},...d.buildInitialValues()});l.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const de={title:"papirsoknad/papirsoknad-es",component:c,decorators:[C]},u=()=>n.jsx(c,{onSubmitUfullstendigsoknad:i("button-click"),onSubmit:i("button-click"),readOnly:!1,soknadData:new b(S.ENGANGSSTONAD,o.FODSEL,k.MOR),alleKodeverk:A}),g=()=>n.jsx(c,{onSubmitUfullstendigsoknad:i("button-click"),onSubmit:i("button-click"),readOnly:!1,soknadData:new b(S.ENGANGSSTONAD,o.ADOPSJON,k.MOR),alleKodeverk:A}),p=()=>n.jsx(c,{onSubmitUfullstendigsoknad:i("button-click"),onSubmit:i("button-click"),readOnly:!1,soknadData:new b(S.ENGANGSSTONAD,o.FODSEL,k.FAR),alleKodeverk:A});u.__docgenInfo={description:"",methods:[],displayName:"visPapirsoknadForMorVedFødsel"};g.__docgenInfo={description:"",methods:[],displayName:"visPapirsoknadForMorVedAdopsjon"};p.__docgenInfo={description:"",methods:[],displayName:"visPapirsoknadForFarVedFødsel"};var V,P,M;u.parameters={...u.parameters,docs:{...(V=u.parameters)==null?void 0:V.docs,source:{originalSource:"() => <EngangsstonadPapirsoknadIndex onSubmitUfullstendigsoknad={action('button-click') as () => Promise<any>} onSubmit={action('button-click') as (values: any) => Promise<any>} readOnly={false} soknadData={new SoknadData(FagsakYtelseType.ENGANGSSTONAD, familieHendelseType.FODSEL, foreldreType.MOR)} alleKodeverk={alleKodeverk as any} />",...(M=(P=u.parameters)==null?void 0:P.docs)==null?void 0:M.source}}};var _,x,I;g.parameters={...g.parameters,docs:{...(_=g.parameters)==null?void 0:_.docs,source:{originalSource:"() => <EngangsstonadPapirsoknadIndex onSubmitUfullstendigsoknad={action('button-click') as () => Promise<any>} onSubmit={action('button-click') as (values: any) => Promise<any>} readOnly={false} soknadData={new SoknadData(FagsakYtelseType.ENGANGSSTONAD, familieHendelseType.ADOPSJON, foreldreType.MOR)} alleKodeverk={alleKodeverk as any} />",...(I=(x=g.parameters)==null?void 0:x.docs)==null?void 0:I.source}}};var E,q,h;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:"() => <EngangsstonadPapirsoknadIndex onSubmitUfullstendigsoknad={action('button-click') as () => Promise<any>} onSubmit={action('button-click') as (values: any) => Promise<any>} readOnly={false} soknadData={new SoknadData(FagsakYtelseType.ENGANGSSTONAD, familieHendelseType.FODSEL, foreldreType.FAR)} alleKodeverk={alleKodeverk as any} />",...(h=(q=p.parameters)==null?void 0:q.docs)==null?void 0:h.source}}};const le=["visPapirsoknadForMorVedFødsel","visPapirsoknadForMorVedAdopsjon","visPapirsoknadForFarVedFødsel"];export{le as __namedExportsOrder,de as default,p as visPapirsoknadForFarVedFødsel,g as visPapirsoknadForMorVedAdopsjon,u as visPapirsoknadForMorVedFødsel};
