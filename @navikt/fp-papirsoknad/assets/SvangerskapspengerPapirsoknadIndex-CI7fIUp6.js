import{j as a}from"./iframe-CIENZKRI.js";import{u as K,L as i,e as u,j as N,k as R,i as m,F as T,V as v,I as _,d as A,f as S,C as O,H as G}from"./BehovForTilretteleggingPanel-DOMDa0Ho.js";const P=()=>({...S.initialValues(),...A.initialValues(),..._.initialValues(),...v.initialValues(),...T.initialValues(),...m.initialValues(),...R.initialValues(),...N.initialValues(),...u.initialValues(),...i.initialValues()}),F=e=>({...S.transformValues(e),...A.transformValues(e),..._.transformValues(e),...v.transformValues(e),...T.transformValues(e),...m.transformValues(e),...R.transformValues(e),...N.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),I=({readOnly:e,soknadData:n,alleKodeverk:l,onSubmit:E,onSubmitUfullstendigsoknad:r})=>{const t=K({defaultValues:P()}),L=t.watch("mottattDato");return a.jsxs(O,{formMethods:t,onSubmit:D=>E(F(D)),children:[a.jsxs(G,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(S,{readOnly:e}),a.jsx(A,{readOnly:e,alleKodeverk:l,erAdopsjon:n.getFamilieHendelseType()!=="ADPSJN",mottattDato:L}),a.jsx(_,{readOnly:e,alleKodeverk:l}),a.jsx(v,{readOnly:e,alleKodeverk:l}),a.jsx(T,{readOnly:e}),a.jsx(m,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:l}),a.jsx(R,{readOnly:e}),a.jsx(N,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:r,submitting:t.formState.isSubmitting,erEndringssøknad:!1})]})};I.__docgenInfo={description:`SvangerskapspengerForm
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{s as S};
