import{j as e,t as g,r as I,P as L,a as D,w as P}from"./iframe-DOzVjHoR.js";import{u as V,C as G,B as R,M as t,S as T,R as _,a as b,F as N,W as O,b as q,g as B}from"./BehovForTilretteleggingPanel-qvNZ-wW8.js";import{E as h}from"./EngangsstonadPapirsoknadIndex-N0zLDkc_.js";import{F as f}from"./ForeldrepengerPapirsoknadIndex-DCsuXPyF.js";import{V as A,H as y,a as U,B as M,m as p}from"./nb_NO-DJp2WZD7.js";import{S as j}from"./SvangerskapspengerPapirsoknadIndex-jLpUHu0C.js";import"./preload-helper-PPVm8Dsz.js";import"./index-WEoiDTHi.js";const H=new Set([N.ADOPSJON,N.FODSEL]),S=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:r})=>{const l=V({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),m=l.watch("fagsakYtelseType"),n=r.FagsakYtelseType,o=r.FamilieHendelseType,s=r.ForeldreType;return e.jsx(G,{formMethods:l,onSubmit:a=>{i(new b(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),l.reset(a)},children:e.jsx(R.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(A,{gap:"space-16",padding:"5",children:[e.jsx(y,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(U,{gap:"20",children:[e.jsx(T,{name:"fagsakYtelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[g],children:n.map(a=>e.jsx(_,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),m!=="SVP"&&e.jsx(T,{name:"familieHendelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[g],children:o.filter(({kode:a})=>H.has(a)).map(a=>e.jsx(_,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(T,{name:"foreldreType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[g],children:s.map(a=>e.jsx(_,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(R,{style:{textAlign:"end"},children:e.jsx(M,{type:"submit",disabled:!l.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};S.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const w=D(p),K=({fagsak:i,kodeverk:u,readOnly:r,lagrePapirsøknad:l,erEndringssøknad:m})=>{const[n,o]=I.useState(),s=F=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,F),Promise.resolve()),a=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(L,{value:w,children:e.jsxs(A,{gap:"space-16",padding:"4",children:[e.jsx(y,{size:"small",level:"2",children:m?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(O,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(S,{setSoknadData:o,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()==="ES"&&e.jsx(h,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()==="FP"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:m}),n&&n.getFagsakYtelseType()==="SVP"&&e.jsx(j,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u})]})})};K.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:c}=__STORYBOOK_MODULE_ACTIONS__,Z={component:K,decorators:[P,B(p)],args:{readOnly:!1,kodeverk:q,lagrePapirsøknad:i=>(c("lagrePapirsøknad")(i),Promise.resolve({}))}},E={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},d={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},k={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
...
}`,...k.parameters?.docs?.source}}};const $=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{k as EngangsstonadFørstegangssøknad,v as ForeldrepengerEndringssøknad,E as ForeldrepengerFørstegangssøknad,d as SvangerskapspengerFørstegangssøknad,$ as __namedExportsOrder,Z as default};
