import{j as e,t as T,F as i,r as F,P as S,a as h,w as j}from"./iframe-VdkpOt00.js";import{u as P,D as f,B as b,M as t,F as E,R as A,a as q,S as B,W as w,b as O,g as G}from"./BehovForTilretteleggingPanel-BvFJaoya.js";import{E as I}from"./EngangsstonadPapirsoknadIndex-DOXHz9su.js";import{F as c}from"./ForeldrepengerPapirsoknadIndex-8FtIu5AS.js";import{V as R,H as V,a as L,B as D,m as N}from"./nb_NO-CyfzYWLz.js";import{S as U}from"./SvangerskapspengerPapirsoknadIndex-6jDwBJIA.js";import"./preload-helper-D9Z9MdNV.js";import"./index-BDXi29Rm.js";const M=[q.ADOPSJON,q.FODSEL],K=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:l})=>{const r=P({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),k=r.watch("fagsakYtelseType"),a=l.FagsakYtelseType,y=l.FamilieHendelseType,o=l.ForeldreType;return e.jsx(f,{formMethods:r,onSubmit:n=>{s(new B(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType)),r.reset(n)},children:e.jsx(b.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(R,{gap:"space-16",padding:"5",children:[e.jsx(V,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(L,{gap:"20",children:[e.jsx(E,{name:"fagsakYtelseType",control:r.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],children:a.map(n=>e.jsx(A,{value:n.kode,size:"small",disabled:!0,children:n.navn},n.kode))}),k!==i.SVANGERSKAPSPENGER&&e.jsx(E,{name:"familieHendelseType",control:r.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],children:y.filter(({kode:n})=>M.some(p=>p===n)).map(n=>e.jsx(A,{value:n.kode,size:"small",children:n.navn},n.kode))}),e.jsx(E,{name:"foreldreType",control:r.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],children:o.map(n=>e.jsx(A,{value:n.kode,size:"small",children:n.navn},n.kode))})]}),e.jsx(b,{style:{textAlign:"end"},children:e.jsx(D,{type:"submit",disabled:!r.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};K.__docgenInfo={description:`SoknadTypePickerForm
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Y}=__STORYBOOK_MODULE_ACTIONS__,$={component:_,decorators:[j,G(N)],args:{readOnly:!1,kodeverk:O,lagrePapirsøknad:s=>(Y("lagrePapirsøknad")(s),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:i.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},m={args:{fagsak:{fagsakYtelseType:i.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},g={args:{fagsak:{fagsakYtelseType:i.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:i.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
