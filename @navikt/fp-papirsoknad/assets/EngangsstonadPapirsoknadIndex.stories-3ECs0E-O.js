import{R as n}from"./index-DogsOklH.js";import{R as K,O as d,f as o,S as G,b as y,d as k,a as X,M as J,L as $,r as Y,h as i,i as E,z as b,j as S}from"./BehovForTilretteleggingPanel-ximUljBz.js";import{H as x,u as z,O as B,a as C,w as Q}from"./index.es-5uBy1Mkv.js";import"./v4-yQnnJER4.js";import"./_commonjs-dynamic-modules-h-SxKiO4.js";import"./index-MroJ3egt.js";const W="_col_hlukm_1",N={col:W},F="omsorg",l=({readOnly:e,soknadData:r,alleKodeverk:s,fodselsdato:a,mottattDato:t})=>n.createElement(x,{justify:"space-between"},n.createElement("div",{className:N.col},n.createElement(K,{readOnly:e,soknadData:r}),n.createElement(d,{readOnly:e,alleKodeverk:s,erAdopsjon:r.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:t}),n.createElement(G,{readOnly:e})),n.createElement("div",{className:N.col},n.createElement(y,{readOnly:e,familieHendelseType:r.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:a})));l.transformValues=e=>({...d.transformValues(e),[F]:y.transformValues(e[F])});l.buildInitialValues=()=>({[F]:{},...d.buildInitialValues()});l.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
