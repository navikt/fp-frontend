import{j as e,F as s,r as I,P as D,a as M,w as U}from"./iframe-BctlxGYK.js";import{u as H,N as L,B as A,M as t,a as T,e as b,F as E,S as Y,K as x,b as J,g as C}from"./BehovForTilretteleggingPanel-BZTkBt-s.js";import{E as z}from"./EngangsstonadPapirsoknadIndex-CtTEKsgf.js";import{F as W}from"./ForeldrepengerPapirsoknadIndex-ByAe8ktf.js";import{V as G,H as O,a as Q,B as X,m as P}from"./nb_NO-CaE5AbKC.js";import{S as Z}from"./SvangerskapspengerPapirsoknadIndex-ssOKqTLz.js";import"./index-CMZZEDUZ.js";const $=[E.ADOPSJON,E.FODSEL],_=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:a})=>{const l=H({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),o=l.watch("fagsakYtelseType"),n=a.FagsakYtelseType,p=a.FamilieHendelseType,k=a.ForeldreType;return e.jsx(L,{formMethods:l,onSubmit:r=>{i(new Y(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),l.reset(r)},children:e.jsx(A,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(G,{gap:"4",padding:"5",children:[e.jsx(O,{size:"small",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(Q,{gap:"20",children:[e.jsx(T,{label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[b],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),o!==s.SVANGERSKAPSPENGER&&e.jsx(T,{name:"familieHendelseType",label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[b],radios:p.filter(({kode:r})=>$.some(v=>v===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(T,{name:"foreldreType",label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[b],radios:k.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(X,{type:"submit",disabled:!l.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};_.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ee=M(P),c=({fagsak:i,kodeverk:u,readOnly:a,lagrePapirsøknad:l,erEndringssøknad:o})=>{const[n,p]=I.useState(),k=v=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,v),Promise.resolve()),r=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(D,{value:ee,children:e.jsxs(G,{gap:"4",padding:"4",children:[e.jsx(O,{size:"small",children:o?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!a&&e.jsx(x,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(_,{setSoknadData:p,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===s.ENGANGSSTONAD&&e.jsx(z,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:a,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===s.FORELDREPENGER&&e.jsx(W,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:a,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:o}),n&&n.getFagsakYtelseType()===s.SVANGERSKAPSPENGER&&e.jsx(Z,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:a,soknadData:n,alleKodeverk:u})]})})};c.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:ne}=__STORYBOOK_MODULE_ACTIONS__,ke={component:c,decorators:[U,C(P)],args:{readOnly:!1,kodeverk:J,lagrePapirsøknad:i=>(ne("lagrePapirsøknad")(i),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:s.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:s.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:s.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:s.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};var q,R,h;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    fagsak: {
