import{j as n}from"./dayjs.min-BmqYrIeh.js";import{R as D,O as d,f as o,S as K,b as y,d as k,a as X,M as J,L as $,r as Y,h as i,i as b,z as S,j as A}from"./BehovForTilretteleggingPanel-BaHF4mWE.js";import{H as G,u as z,D as B,b as C,w as Q}from"./index.es-NN30iNwR.js";import"./index-uubelm5h.js";import"./v4-CQkTLCs1.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-BdzLX9oW.js";const W="_col_hlukm_1",j={col:W},F="omsorg",l=({readOnly:e,soknadData:r,alleKodeverk:s,fodselsdato:a,mottattDato:t})=>n.jsxs(G,{justify:"space-between",children:[n.jsxs("div",{className:j.col,children:[n.jsx(D,{readOnly:e,soknadData:r}),n.jsx(d,{readOnly:e,alleKodeverk:s,erAdopsjon:r.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:t}),n.jsx(K,{readOnly:e})]}),n.jsx("div",{className:j.col,children:n.jsx(y,{readOnly:e,familieHendelseType:r.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:a})})]});l.transformValues=e=>({...d.transformValues(e),[F]:y.transformValues(e[F])});l.buildInitialValues=()=>({[F]:{},...d.buildInitialValues()});l.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
