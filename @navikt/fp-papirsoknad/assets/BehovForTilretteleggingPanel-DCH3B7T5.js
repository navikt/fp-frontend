...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const zn=({readOnly:e,alleKodeverk:r})=>l.jsx(xe,{children:l.jsxs(X,{gap:"space-16",children:[l.jsx(Se,{size:"small",level:"3",children:l.jsx(w,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),l.jsx(Na,{children:l.jsx(w,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),l.jsx(md,{readOnly:e,alleKodeverk:r})]})});zn.initialValues=()=>({[Vn]:[]});const La=e=>e===void 0||e==="";zn.transformValues=({arbeidsforhold:e})=>({arbeidsforhold:e?.filter(r=>!(La(r.arbeidsgiver)&&La(r.land)&&La(r.periodeFom)&&La(r.periodeTom)))});zn.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  registrerVerge?: boolean;
  ufullstendigSoeknad?: boolean;
}`,signature:{properties:[{key:"kommentarEndring",value:{name:"string",required:!1}},{key:"registrerVerge",value:{name:"boolean",required:!1}},{key:"ufullstendigSoeknad",value:{name:"boolean",required:!1}}]}}}}],displayName:"LagreSoknadPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},submitting:{required:!0,tsType:{name:"boolean"},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const aE=ce(Le),co=()=>ne().subtract(1,"year").subtract(1,"day"),tE=()=>ne(),ti=({readOnly:e})=>{const{control:r}=H();return l.jsx(ur,{value:aE,children:l.jsx(xe,{children:l.jsxs(X,{gap:"space-16",children:[l.jsx(Se,{size:"small",level:"3",children:l.jsx(w,{id:"Registrering.Omsoknaden.MottattDato"},"regDatoTittel")}),l.jsx(Q,{name:"mottattDato",control:r,label:l.jsx(w,{id:"Registrering.Omsoknaden.MottattDato"},"regDatoUnder"),fromDate:co().toDate(),toDate:tE().toDate(),validate:[G,re,xn,Ge(co())],isReadOnly:e})]})})})};ti.initialValues=()=>({mottattDato:void 0});ti.transformValues=({mottattDato:e})=>({mottattDato:e});ti.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  mottattDato?: string;
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Qn=({readOnly:e=!0,alleKodeverk:r,mottattDato:n,erAdopsjon:a})=>{const{formatMessage:t}=Ae(),s=r.Landkoder.slice().sort((u,k)=>u.navn.localeCompare(k.navn)),{watch:i,control:o}=H(),d=!i("oppholdSisteTolvINorge",!0),g=!i("oppholdNesteTolvINorge",!0);return l.jsx(xe,{children:l.jsxs(X,{gap:"space-16",children:[l.jsx(Se,{size:"small",level:"3",children:l.jsx(w,{id:"Registrering.Opphold"})}),l.jsx(qe,{name:"oppholdINorge",control:o,label:t({id:a?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:e}),l.jsxs(X,{gap:"space-8",children:[l.jsx(qe,{name:"oppholdSisteTolvINorge",control:o,label:l.jsx(w,{id:"Registrering.OppholdSisteTolv"}),readOnly:e}),d&&l.jsx(ar,{alignOffset:58,children:l.jsx(cs,{erTidligereOpphold:!0,mottattDato:n,countryCodes:s,readOnly:e})})]}),l.jsxs(X,{gap:"space-8",children:[l.jsx(qe,{name:"oppholdNesteTolvINorge",control:o,label:l.jsx(w,{id:"Registrering.OppholdNesteTolv"}),readOnly:e}),g&&l.jsx(ar,{alignOffset:58,children:l.jsx(cs,{mottattDato:n,countryCodes:s,readOnly:e})})]})]})})};Qn.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});Qn.transformValues=({oppholdINorge:e,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:n,tidligereOppholdUtenlands:a,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:e,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!n,tidligereOppholdUtenlands:r?void 0:a,fremtidigeOppholdUtenlands:n?void 0:t});Qn.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  rettigheter?: string;
}`,signature:{properties:[{key:"rettigheter",value:{name:"string",required:!1}}]},alias:"RettigheterFormValues"}}],returns:null}],displayName:"RettigheterPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""}}};const wa=ce(Le),is={BOKMAL:"NB",NYNORSK:"NN",ENGELSK:"EN"},li=({readOnly:e})=>{const{control:r}=H();return l.jsx(xe,{children:l.jsxs(X,{gap:"space-16",children:[l.jsx(Se,{size:"small",level:"3",children:wa.formatMessage({id:"Registrering.Sprak"})}),l.jsx(Jr,{name:"språkkode",control:r,validate:[G],isReadOnly:e,radios:[{label:wa.formatMessage({id:"Registrering.Sprak.Bokmal"}),value:is.BOKMAL},{label:wa.formatMessage({id:"Registrering.Sprak.Nynorsk"}),value:is.NYNORSK},{label:wa.formatMessage({id:"Registrering.Sprak.Engelsk"}),value:is.ENGELSK}]})]})})};li.initialValues=()=>({språkkode:void 0});li.transformValues=({språkkode:e})=>({språkkode:e});li.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  språkkode?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const os=ce(Le),ui=({readOnly:e})=>{const{control:r}=H();return l.jsx(xe,{children:l.jsxs(X,{gap:"space-16",children:[l.jsx(Se,{size:"small",level:"3",children:os.formatMessage({id:"Registrering.Dekningsgrad.Title"})}),l.jsx(Jr,{name:"dekningsgrad",control:r,validate:[G],isReadOnly:e,isHorizontal:!0,radios:[{label:os.formatMessage({id:"Registrering.Dekningsgrad.prosent.80"}),value:"80_PROSENT"},{label:os.formatMessage({id:"Registrering.Dekningsgrad.prosent.100"}),value:"100_PROSENT"}]})]})})};ui.initialValues=()=>({dekningsgrad:void 0});ui.transformValues=({dekningsgrad:e})=>({dekningsgrad:e});ui.__docgenInfo={description:"Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  dekningsgrad?: string;
  ...
  dekningsgrad?: string;
}`,signature:{properties:[{key:"dekningsgrad",value:{name:"string",required:!1}}]},alias:"FormValues"}}],returns:null}],displayName:"DekningsgradIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ho=ce(Le),ki=({readOnly:e,annenForelderInformertRequired:r=!1})=>{const{control:n}=H();return l.jsx(xe,{children:l.jsxs(X,{gap:"space-16",children:[l.jsx(Se,{size:"small",level:"3",children:ho.formatMessage({id:"Registrering.TheOtherParent.Confirmation"})}),l.jsx(qe,{name:"annenForelderInformert",control:n,label:ho.formatMessage({id:"Registrering.TheOtherParent.OtherParentKnowPeriods"}),isRequired:r,readOnly:e})]})})};ki.initialValues=()=>({annenForelderInformert:void 0});ki.tranformValues=({annenForelderInformert:e})=>({annenForelderInformert:e});ki.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
