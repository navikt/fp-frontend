import{V as _,c as C,H as Q,F as t,b as X,P as Z,f as $,m as J,w as ee,a as w}from"./nb_NO-Cgy3pGLd.js";import{u as ne,S as re,j,K as ae,k as R,l,m as h,n as c,F as A,o as te,a as se,g as le}from"./BehovForTilretteleggingPanel-CVVmoujO.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as v}from"./index-_2TAQcTa.js";import{E as ie}from"./EngangsstonadPapirsoknadIndex-DP_xwk6H.js";import{F as ue}from"./ForeldrepengerPapirsoknadIndex-FQYvkeVI.js";import{S as oe}from"./SvangerskapspengerPapirsoknadIndex-DFADHN0y.js";import"./v4-CtRu48qb.js";import"./entry-preview-O08Svf41.js";import"./iframe-CZKL_ksS.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BwSyabb1.js";import"./index-CXQShRbs.js";import"./index-0bQSHhiP.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CQwh6Daz.js";import"./dayjs.min-DkLNzaWO.js";const ge=[A.ADOPSJON,A.FODSEL],z=({setSoknadData:a,fagsakYtelseType:i,alleKodeverk:s})=>{const u=ne({defaultValues:{fagsakYtelseType:i,familieHendelseType:void 0,foreldreType:void 0}}),b=u.watch("fagsakYtelseType"),f=v.useCallback(r=>a(new re(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[a]),n=s[j.FAGSAK_YTELSE],q=s[j.FAMILIE_HENDELSE_TYPE],o=s[j.FORELDRE_TYPE];return e.jsx(ae,{formMethods:u,onSubmit:f,children:e.jsx(R,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(_,{gap:"4",padding:"5",children:[e.jsx(C,{size:"small",children:e.jsx(l,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(Q,{gap:"20",children:[e.jsx(h,{label:e.jsx(l,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[c],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),b!==t.SVANGERSKAPSPENGER&&e.jsx(h,{name:"familieHendelseType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Tema"}),validate:[c],radios:q.filter(({kode:r})=>ge.some(T=>T===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(h,{name:"foreldreType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Soker"}),validate:[c],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(R,{style:{textAlign:"end"},children:e.jsx(X,{type:"submit",disabled:u.formState.isSubmitting||u.formState.isSubmitted,children:e.jsx(l,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};z.__docgenInfo={description:`SoknadTypePickerForm
...
Toppkomponent for registrering av papirsøknad der søknadstype, tema og søker/foreldretype blir valgt.`,methods:[],displayName:"SoknadTypePickerForm",props:{setSoknadData:{required:!0,tsType:{name:"signature",type:"function",raw:"(soknadData: SoknadData) => void",signature:{arguments:[{type:{name:"SoknadData"},name:"soknadData"}],return:{name:"void"}}},description:""},fagsakYtelseType:{required:!0,tsType:{name:"string"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const de=$(J),W=({fagsak:a,kodeverk:i,readOnly:s,lagreUfullstendig:u,lagreFullstendig:b,erEndringssøknad:f})=>{const[n,q]=v.useState(),o=v.useCallback(T=>(n&&b(T,n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve()),[n]),r=v.useCallback(()=>(n&&u(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve()),[n]);return e.jsx(Z,{value:de,children:e.jsxs(_,{gap:"4",padding:"4",children:[e.jsx(C,{size:"small",children:e.jsx(l,{id:"Registrering.RegistrereSoknad"})}),!s&&e.jsx(te,{children:e.jsx(l,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(z,{setSoknadData:q,fagsakYtelseType:a.fagsakYtelseType,alleKodeverk:i}),n&&n.getFagsakYtelseType()===t.ENGANGSSTONAD&&e.jsx(ie,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:s,soknadData:n,alleKodeverk:i}),n&&n.getFagsakYtelseType()===t.FORELDREPENGER&&e.jsx(ue,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:s,soknadData:n,alleKodeverk:i,fagsakPersonnummer:a.bruker.fødselsnummer,erEndringssøknad:f}),n&&n.getFagsakYtelseType()===t.SVANGERSKAPSPENGER&&e.jsx(oe,{onSubmitUfullstendigsoknad:r,onSubmit:o,readOnly:s,soknadData:n,alleKodeverk:i})]})})};W.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
...
| { type: 'LINJESKIFT' }`,elements:[{name:"signature",type:"object",raw:`{
  ...
  foreldreType: string,
) => Promise<any>`,signature:{arguments:[{type:{name:"any"},name:"formValues"},{type:{name:"string"},name:"fagsakYtelseType"},{type:{name:"string"},name:"familieHendelseType"},{type:{name:"string"},name:"foreldreType"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Fe={component:W,decorators:[ee,le(J)],args:{readOnly:!1,kodeverk:se,lagreFullstendig:a=>(w("lagreFullstendig")(a),Promise.resolve(a)),lagreUfullstendig:(...a)=>(w("lagreUfullstendig")(a),Promise.resolve())}},g={args:{fagsak:{fagsakYtelseType:t.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},d={args:{fagsak:{fagsakYtelseType:t.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},k={args:{fagsak:{fagsakYtelseType:t.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},m={args:{fagsak:{fagsakYtelseType:t.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},p={args:{fagsak:{fagsakYtelseType:t.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:t.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var E,S,F;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(F=(S=g.parameters)==null?void 0:S.docs)==null?void 0:F.source}}};var K,P,B;d.parameters={...d.parameters,docs:{...(K=d.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.FORELDREPENGER,
      bruker: {
...
}`,...(B=(P=d.parameters)==null?void 0:P.docs)==null?void 0:B.source}}};var N,O,V;k.parameters={...k.parameters,docs:{...(N=k.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(V=(O=k.parameters)==null?void 0:O.docs)==null?void 0:V.source}}};var Y,I,G;m.parameters={...m.parameters,docs:{...(Y=m.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.SVANGERSKAPSPENGER,
      bruker: {
...
}`,...(G=(I=m.parameters)==null?void 0:I.docs)==null?void 0:G.source}}};var x,H,D;p.parameters={...p.parameters,docs:{...(x=p.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(D=(H=p.parameters)==null?void 0:H.docs)==null?void 0:D.source}}};var L,M,U;y.parameters={...y.parameters,docs:{...(L=y.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.ENGANGSSTONAD,
      bruker: {
...
}`,...(U=(M=y.parameters)==null?void 0:M.docs)==null?void 0:U.source}}};const Ke=["ForeldrepengerFørstegang","ForeldrepengerEndring","SvangerskapspengerFørstegang","SvangerskapspengerEndring","EngangsstonadFørstegang","EngangsstonadEndring"];export{y as EngangsstonadEndring,p as EngangsstonadFørstegang,d as ForeldrepengerEndring,g as ForeldrepengerFørstegang,m as SvangerskapspengerEndring,k as SvangerskapspengerFørstegang,Ke as __namedExportsOrder,Fe as default};
