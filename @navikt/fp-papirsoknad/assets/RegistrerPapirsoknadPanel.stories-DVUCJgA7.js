import{j as e,F as l,r as V,T as S,P as K,w as N}from"./iframe-CKZvDsWp.js";import{u as B,N as w,B as A,M as s,a as T,t as b,F as E,S as F,K as O,b as c,g as _}from"./BehovForTilretteleggingPanel-DCH3B7T5.js";import{V as q,H as R,a as G,B as P,r as I,m as h}from"./nb_NO-CaRP0_Pe.js";import{E as D}from"./EngangsstonadPapirsoknadIndex-DRTrCcrK.js";import{F as M}from"./ForeldrepengerPapirsoknadIndex-B8yBEAge.js";import{S as U}from"./SvangerskapspengerPapirsoknadIndex-DIvNyihx.js";import"./index-B7XwvW9I.js";const H=[E.ADOPSJON,E.FODSEL],j=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const a=B({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),o=a.watch("fagsakYtelseType"),n=t.FagsakYtelseType,p=t.FamilieHendelseType,k=t.ForeldreType;return e.jsx(w,{formMethods:a,onSubmit:r=>{i(new F(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),a.reset(r)},children:e.jsx(A.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(q,{gap:"space-16",padding:"5",children:[e.jsx(R,{size:"small",level:"3",children:e.jsx(s,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(G,{gap:"20",children:[e.jsx(T,{name:"fagsakYtelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[b],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),o!==l.SVANGERSKAPSPENGER&&e.jsx(T,{name:"familieHendelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Tema"}),validate:[b],radios:p.filter(({kode:r})=>H.some(v=>v===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(T,{name:"foreldreType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Soker"}),validate:[b],radios:k.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(P,{type:"submit",disabled:!a.formState.isDirty,children:e.jsx(s,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};j.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const L=I(h),f=({fagsak:i,kodeverk:u,readOnly:t,lagrePapirsøknad:a,erEndringssøknad:o})=>{const[n,p]=V.useState(),k=v=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,v),Promise.resolve()),r=()=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(S,{theme:"light",children:e.jsx(K,{value:L,children:e.jsxs(q,{gap:"space-16",padding:"4",children:[e.jsx(R,{size:"small",level:"2",children:o?e.jsx(s,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(s,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(O,{children:e.jsx(s,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(j,{setSoknadData:p,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.ENGANGSSTONAD&&e.jsx(D,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.FORELDREPENGER&&e.jsx(M,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:o}),n&&n.getFagsakYtelseType()===l.SVANGERSKAPSPENGER&&e.jsx(U,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})})};f.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Y}=__STORYBOOK_MODULE_ACTIONS__,Z={component:f,decorators:[N,_(h)],args:{readOnly:!1,kodeverk:c,lagrePapirsøknad:i=>(Y("lagrePapirsøknad")(i),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:l.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:l.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
