import{j as r}from"./jsx-runtime-CLpGMVip.js";import{u as I,r as S,H as h,M as u,O as m,c as j,I as k,V as l,e as g,A as p,D as y,T as v,R as c,f as w,h as q,d as D,P as T,B as R,i as f,L as P}from"./BehovForTilretteleggingPanel-DMWke6ZQ.js";import"./nb_NO-CKZGATbu.js";const O=()=>({...u.initialValues(),...m.initialValues(),...k.initialValues(),...l.initialValues(),...g.initialValues(),...p.initialValues(),...y.initialValues(),...v.initialValues(),...c.initialValues(),...w.initialValues(),...q.initialValues(),...T.initialValues(),...R.initialValues(),...f.initialValues(),...P.initialValues()}),H=e=>({...u.transformValues(e),...m.transformValues(e),...k.transformValues(e),...l.transformValues(e),...g.transformValues(e),...p.transformValues(e),...y.transformValues(e),...v.transformValues(e),...c.transformValues(e),...w.transformValues(e),...q.transformValues(e),...T.transformValues(e),...R.tranformValues(e),...f.transformValues(e),...P.transformValues(e)}),A=({readOnly:e,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:i,fagsakPersonnummer:o,erEndringssøknad:d})=>{const s=I({defaultValues:O()}),F=s.watch("annenForelder.sokerHarAleneomsorg"),x=s.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),V=!F&&x!==!1,K=s.watch("foedselsDato"),N=s.watch("mottattDato");return r.jsxs(S,{formMethods:s,onSubmit:M=>t(H(M)),children:[r.jsxs(h,{columns:{sm:1,md:2},gap:"4",children:[r.jsx(u,{readOnly:e}),r.jsx(m,{readOnly:e,erAdopsjon:n.getFamilieHendelseType()===j.ADOPSJON,alleKodeverk:a,mottattDato:N}),r.jsx(k,{readOnly:e,alleKodeverk:a}),r.jsx(l,{readOnly:e,alleKodeverk:a}),r.jsx(g,{readOnly:e}),r.jsx(p,{readOnly:e,alleKodeverk:a}),r.jsx(y,{readOnly:e}),n.getFamilieHendelseType()===j.FODSEL&&r.jsx(v,{readOnly:e,erForeldrepenger:!0}),r.jsx(c,{readOnly:e,soknadData:n}),r.jsx(w,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:K,isForeldrepengerFagsak:!0}),r.jsx(q,{readOnly:e,alleKodeverk:a,fagsakPersonnummer:o,sokerErMor:n.getForeldreType()===D.MOR}),r.jsx(T,{foreldreType:n.getForeldreType(),readOnly:e,alleKodeverk:a,erEndringssøknad:d}),r.jsx(R,{annenForelderInformertRequired:V,readOnly:e}),r.jsx(f,{readOnly:e})]}),r.jsx(P,{readOnly:e,onSubmitUfullstendigsoknad:i,submitting:s.formState.isSubmitting})]})};A.__docgenInfo={description:`ForeldrepengerForm
