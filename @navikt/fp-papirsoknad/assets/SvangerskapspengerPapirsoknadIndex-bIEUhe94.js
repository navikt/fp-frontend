import{j as a}from"./iframe-BlJmj1jX.js";import{u as K,L as i,e as u,j as m,k as N,i as v,F as R,V as T,I as _,d as A,f as S,C as O,H as G}from"./BehovForTilretteleggingPanel-DGERDBAT.js";const s=()=>({...S.initialValues(),...A.initialValues(),..._.initialValues(),...T.initialValues(),...R.initialValues(),...v.initialValues(),...N.initialValues(),...m.initialValues(),...u.initialValues(),...i.initialValues()}),P=e=>({...S.transformValues(e),...A.transformValues(e),..._.transformValues(e),...T.transformValues(e),...R.transformValues(e),...v.transformValues(e),...N.transformValues(e),...m.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),I=({readOnly:e,soknadData:n,alleKodeverk:l,onSubmit:r,onSubmitUfullstendigsoknad:E})=>{const t=K({defaultValues:s()}),L=t.watch("mottattDato");return a.jsxs(O,{formMethods:t,onSubmit:D=>r(P(D)),children:[a.jsxs(G,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(S,{readOnly:e}),a.jsx(A,{readOnly:e,alleKodeverk:l,erAdopsjon:n.getFamilieHendelseType()!=="ADPSJN",mottattDato:L}),a.jsx(_,{readOnly:e,alleKodeverk:l}),a.jsx(T,{readOnly:e,alleKodeverk:l}),a.jsx(R,{readOnly:e}),a.jsx(v,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:l}),a.jsx(N,{readOnly:e}),a.jsx(m,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:E,submitting:t.formState.isSubmitting,erEndringssøknad:!1})]})};I.__docgenInfo={description:`SvangerskapspengerForm
