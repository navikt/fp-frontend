import{j as a}from"./index-Byyjg8XX.js";import{u as R,L as i,c as u,h as k,i as o,d,e as m,V as v,I as g,f as p,M as y,N as j,H as K,F as P}from"./BehovForTilretteleggingPanel-BOC9CXbA.js";import"./nb_NO-CWrk3_uh.js";const F=()=>({...y.initialValues(),...p.initialValues(),...g.initialValues(),...v.initialValues(),...m.initialValues(),...d.initialValues(),...o.initialValues(),...k.initialValues(),...u.initialValues(),...i.initialValues()}),V=e=>({...y.transformValues(e),...p.transformValues(e),...g.transformValues(e),...v.transformValues(e),...m.transformValues(e),...d.transformValues(e),...o.transformValues(e),...k.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),T=({readOnly:e,soknadData:r,alleKodeverk:n,onSubmit:l,onSubmitUfullstendigsoknad:t})=>{const s=R({defaultValues:F()}),A=s.watch("mottattDato");return a.jsxs(j,{formMethods:s,onSubmit:w=>l(V(w)),children:[a.jsxs(K,{columns:{sm:1,md:2},gap:"4",children:[a.jsx(y,{readOnly:e}),a.jsx(p,{readOnly:e,alleKodeverk:n,erAdopsjon:r.getFamilieHendelseType()!==P.ADOPSJON,mottattDato:A}),a.jsx(g,{readOnly:e,alleKodeverk:n}),a.jsx(v,{readOnly:e,alleKodeverk:n}),a.jsx(m,{readOnly:e}),a.jsx(d,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:n}),a.jsx(o,{readOnly:e}),a.jsx(k,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:s.formState.isSubmitting})]})};T.__docgenInfo={description:`SvangerskapspengerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{c as S};
