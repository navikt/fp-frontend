import{j as n}from"./jsx-runtime-QvZ8i92b.js";import{R as D,O as d,f as o,S as K,b as v,d as k,a as U,M as X,L as J,r as Y,h as i,i as b,z as S,j as A}from"./BehovForTilretteleggingPanel-BQRZwd5Q.js";import{H as G,u as $,Y as z,b as B,w as C}from"./index.es-Bm6In8dg.js";import"./index-uubelm5h.js";import"./v4-CQkTLCs1.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-CfOt2XX2.js";import"./dayjs.min-jH2-tx3w.js";const Q="_col_hlukm_1",j={col:Q},F="omsorg",l=({readOnly:e,soknadData:r,alleKodeverk:s,fodselsdato:a,mottattDato:t})=>n.jsxs(G,{justify:"space-between",children:[n.jsxs("div",{className:j.col,children:[n.jsx(D,{readOnly:e,soknadData:r}),n.jsx(d,{readOnly:e,alleKodeverk:s,erAdopsjon:r.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:t}),n.jsx(K,{readOnly:e})]}),n.jsx("div",{className:j.col,children:n.jsx(v,{readOnly:e,familieHendelseType:r.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:a})})]});l.transformValues=e=>({...d.transformValues(e),[F]:v.transformValues(e[F])});l.buildInitialValues=()=>({[F]:{},...d.buildInitialValues()});l.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
