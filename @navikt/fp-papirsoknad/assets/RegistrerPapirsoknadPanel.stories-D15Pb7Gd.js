import{j as e,t as T,r as L,P as D,a as F,w as P}from"./iframe-CljjPBeF.js";import{u as V,C as G,B as R,M as t,S as g,R as _,a as O,F as N,W as b,b as B,g as q}from"./BehovForTilretteleggingPanel-CfcrSlq5.js";import{E as f}from"./EngangsstonadPapirsoknadIndex-DelTdEF3.js";import{F as h}from"./ForeldrepengerPapirsoknadIndex-RAmEGsW5.js";import{V as A,H as y,a as U,B as M,m as S}from"./nb_NO-pIb774Rx.js";import{S as H}from"./SvangerskapspengerPapirsoknadIndex-CHqN-8nJ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-cGojZpqZ.js";const j=new Set([N.ADOPSJON,N.FODSEL]),p=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:r})=>{const l=V({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),E=l.watch("fagsakYtelseType"),n=r.FagsakYtelseType,k=r.FamilieHendelseType,s=r.ForeldreType;return e.jsx(G,{formMethods:l,onSubmit:a=>{i(new O(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),l.reset(a)},children:e.jsx(R.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(A,{gap:"space-16",padding:"5",children:[e.jsx(y,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(U,{gap:"20",children:[e.jsx(g,{name:"fagsakYtelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],children:n.map(a=>e.jsx(_,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),E!=="SVP"&&e.jsx(g,{name:"familieHendelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],children:k.filter(({kode:a})=>j.has(a)).map(a=>e.jsx(_,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(g,{name:"foreldreType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],children:s.map(a=>e.jsx(_,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(R,{style:{textAlign:"end"},children:e.jsx(M,{type:"submit",disabled:!l.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};p.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const w=F(S),K=({fagsak:i,kodeverk:u,readOnly:r,lagrePapirsøknad:l,erEndringssøknad:E})=>{const[n,k]=L.useState(),s=I=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,I),Promise.resolve()),a=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(D,{value:w,children:e.jsxs(A,{gap:"space-16",padding:"4",children:[e.jsx(y,{size:"small",level:"2",children:E?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(b,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(p,{setSoknadData:k,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()==="ES"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()==="FP"&&e.jsx(h,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:E}),n&&n.getFagsakYtelseType()==="SVP"&&e.jsx(H,{onSubmitUfullstendigsoknad:a,onSubmit:s,readOnly:r,soknadData:n,alleKodeverk:u})]})})};K.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Y}=__STORYBOOK_MODULE_ACTIONS__,Z={component:K,decorators:[P,q(S)],args:{readOnly:!1,kodeverk:B,lagrePapirsøknad:i=>(Y("lagrePapirsøknad")(i),Promise.resolve({}))}},m={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},d={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},o={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
...
}`,...o.parameters?.docs?.source}}};const $=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{o as EngangsstonadFørstegangssøknad,v as ForeldrepengerEndringssøknad,m as ForeldrepengerFørstegangssøknad,d as SvangerskapspengerFørstegangssøknad,$ as __namedExportsOrder,Z as default};
