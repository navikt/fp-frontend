import{H as x,R as D,O as i,F as o,S as h,c,e as m,b as L,u as X,$ as J,M as $,L as U,r as Y,h as z,i as B,j as T,k as R,l as f}from"./BehovForTilretteleggingPanel-B_s46QE_.js";import{b as C,w as Q,m as W}from"./nb_NO-DIJMf3NU.js";import{j as r}from"./jsx-runtime-DR9Q75dM.js";import"./index-DRjF_FHU.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-DN4LN79F.js";import"./index-rX-Bn4lm.js";const Z="_col_hlukm_1",N={col:Z},F="omsorg",d=({readOnly:e,soknadData:n,alleKodeverk:s,fodselsdato:a,mottattDato:t})=>r.jsxs(x,{justify:"space-between",children:[r.jsxs("div",{className:N.col,children:[r.jsx(D,{readOnly:e,soknadData:n}),r.jsx(i,{readOnly:e,alleKodeverk:s,erAdopsjon:n.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:t}),r.jsx(h,{readOnly:e})]}),r.jsx("div",{className:N.col,children:r.jsx(c,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:a})})]});d.transformValues=e=>({...i.transformValues(e),[F]:c.transformValues(e[F])});d.buildInitialValues=()=>({[F]:{},...i.buildInitialValues()});d.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const me={title:"papirsoknad/engangstonad",component:K,decorators:[Q,z(W)],args:{readOnly:!1,alleKodeverk:B,onSubmit:e=>(T("onSubmit")(e),Promise.resolve(e)),onSubmitUfullstendigsoknad:()=>(T("onSubmitUfullstendigsoknad")(),Promise.resolve())}},g={args:{soknadData:new R(f.ENGANGSSTONAD,o.FODSEL,m.MOR)}},p={args:{soknadData:new R(f.ENGANGSSTONAD,o.ADOPSJON,m.MOR)}},k={args:{soknadData:new R(f.ENGANGSSTONAD,o.FODSEL,m.FAR)}};var j,V,M;g.parameters={...g.parameters,docs:{...(j=g.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
