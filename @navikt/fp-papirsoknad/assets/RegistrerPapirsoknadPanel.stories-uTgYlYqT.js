import{F as a,P as z,r as W,w as Q,a as X}from"./withThemeDecorator-BkhEodUZ.js";import{u as Z,S as $,N as ee,j as q,k as i,l as A,m as E,F as R,G as ne,a as re,g as ae}from"./BehovForTilretteleggingPanel-Bi9Jnuuw.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as M}from"./index-C4XKfyRp.js";import{E as te}from"./EngangsstonadPapirsoknadIndex-B008d8N3.js";import{F as se}from"./ForeldrepengerPapirsoknadIndex-Desje_Sm.js";import{V as H,b as Y,H as le,a as ie,m as L}from"./nb_NO-CAJSWZ6r.js";import{S as ue}from"./SvangerskapspengerPapirsoknadIndex-DBxUIcH7.js";import"./v4-CtRu48qb.js";import"./entry-preview-CErbD4F3.js";import"./iframe-DQTVhHQ2.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";const ke=[R.ADOPSJON,R.FODSEL],x=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:t})=>{const l=Z({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),T=l.watch("fagsakYtelseType"),n=M.useCallback(r=>s(new $(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[s]),b=t.FagsakYtelseType,k=t.FamilieHendelseType,o=t.ForeldreType;return e.jsx(ee,{formMethods:l,onSubmit:n,children:e.jsx(q,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(H,{gap:"4",padding:"5",children:[e.jsx(Y,{size:"small",children:e.jsx(i,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(le,{gap:"20",children:[e.jsx(A,{label:e.jsx(i,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[E],radios:b.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),T!==a.SVANGERSKAPSPENGER&&e.jsx(A,{name:"familieHendelseType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Tema"}),validate:[E],radios:k.filter(({kode:r})=>ke.some(C=>C===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(A,{name:"foreldreType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Soker"}),validate:[E],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(q,{style:{textAlign:"end"},children:e.jsx(ie,{type:"submit",disabled:l.formState.isSubmitting||l.formState.isSubmitted,children:e.jsx(i,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};x.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const oe=W(L),J=({fagsak:s,kodeverk:u,readOnly:t,lagrePapirsøknad:l,erEndringssøknad:T})=>{const[n,b]=M.useState(),k=r=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,r),Promise.resolve()),o=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(z,{value:oe,children:e.jsxs(H,{gap:"4",padding:"4",children:[e.jsx(Y,{size:"small",children:e.jsx(i,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(ne,{children:e.jsx(i,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(x,{setSoknadData:b,fagsakYtelseType:s.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.ENGANGSSTONAD&&e.jsx(te,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.FORELDREPENGER&&e.jsx(se,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:s.bruker.fødselsnummer,erEndringssøknad:T}),n&&n.getFagsakYtelseType()===a.SVANGERSKAPSPENGER&&e.jsx(ue,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})};J.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ke={component:J,decorators:[Q,ae(L)],args:{readOnly:!1,kodeverk:re,lagrePapirsøknad:s=>(X("lagrePapirsøknad")(s),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},p={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var h,j,f;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(f=(j=d.parameters)==null?void 0:j.docs)==null?void 0:f.source}}};var S,V,K;g.parameters={...g.parameters,docs:{...(S=g.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.FORELDREPENGER,
      bruker: {
...
}`,...(K=(V=g.parameters)==null?void 0:V.docs)==null?void 0:K.source}}};var N,B,w;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(w=(B=m.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};var F,G,c;y.parameters={...y.parameters,docs:{...(F=y.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.SVANGERSKAPSPENGER,
      bruker: {
...
}`,...(c=(G=y.parameters)==null?void 0:G.docs)==null?void 0:c.source}}};var P,O,_;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(_=(O=p.parameters)==null?void 0:O.docs)==null?void 0:_.source}}};var I,D,U;v.parameters={...v.parameters,docs:{...(I=v.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.ENGANGSSTONAD,
      bruker: {
...
}`,...(U=(D=v.parameters)==null?void 0:D.docs)==null?void 0:U.source}}};const Ne=["ForeldrepengerFørstegang","ForeldrepengerEndring","SvangerskapspengerFørstegang","SvangerskapspengerEndring","EngangsstonadFørstegang","EngangsstonadEndring"];export{v as EngangsstonadEndring,p as EngangsstonadFørstegang,g as ForeldrepengerEndring,d as ForeldrepengerFørstegang,y as SvangerskapspengerEndring,m as SvangerskapspengerFørstegang,Ne as __namedExportsOrder,Ke as default};
