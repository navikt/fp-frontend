import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{u as q,L as o,c as u,i as l,j as d,d as g,e as m,V as k,I as v,f as p,M as y,h as P,H as T,F as A}from"./BehovForTilretteleggingPanel-Cu3bq3pP.js";import"./nb_NO-qsLCk1ai.js";const j=()=>({...y.initialValues(),...p.initialValues(),...v.initialValues(),...k.initialValues(),...m.initialValues(),...g.initialValues(),...d.initialValues(),...l.initialValues(),...u.initialValues(),...o.initialValues()}),K=e=>({...y.transformValues(e),...p.transformValues(e),...v.transformValues(e),...k.transformValues(e),...m.transformValues(e),...g.transformValues(e),...d.transformValues(e),...l.transformValues(e),...u.transformValues(e),...o.transformValues(e)}),c=({readOnly:e,soknadData:a,alleKodeverk:n,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=q({defaultValues:j()}),w=i.watch("mottattDato");return r.jsxs(P,{formMethods:i,onSubmit:R=>t(K(R)),children:[r.jsxs(T,{columns:{sm:1,md:2},gap:"4",children:[r.jsx(y,{readOnly:e}),r.jsx(p,{readOnly:e,alleKodeverk:n,erAdopsjon:a.getFamilieHendelseType()!==A.ADOPSJON,mottattDato:w}),r.jsx(v,{readOnly:e,alleKodeverk:n}),r.jsx(k,{readOnly:e,alleKodeverk:n}),r.jsx(m,{readOnly:e}),r.jsx(g,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:n}),r.jsx(d,{readOnly:e}),r.jsx(l,{readOnly:e}),r.jsx(u,{readOnly:e})]}),r.jsx(o,{readOnly:e,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting})]})};c.__docgenInfo={description:`SvangerskapspengerForm
