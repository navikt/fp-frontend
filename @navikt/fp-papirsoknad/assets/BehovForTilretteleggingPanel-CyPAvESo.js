...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const hy=Re(Ue),Js=({readOnly:e})=>l.jsx(dr,{value:hy,children:l.jsx(Cn,{readOnly:e})});Js.initialValues=Cn.initialValues;Js.transformValues=Cn.transformValues;Js.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const $n=({readOnly:e,alleKodeverk:r})=>l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:l.jsx(j,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),l.jsx(lt,{children:l.jsx(j,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),l.jsx(td,{readOnly:e,alleKodeverk:r})]})});$n.initialValues=()=>({[Pn]:[]});const ja=e=>e===void 0||e==="";$n.transformValues=({arbeidsforhold:e})=>({arbeidsforhold:e?.filter(r=>!(ja(r.arbeidsgiver)&&ja(r.land)&&ja(r.periodeFom)&&ja(r.periodeTom)))});$n.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  mottattDato?: string;
}`,signature:{properties:[{key:"mottattDato",value:{name:"string",required:!1}}]},alias:"MottattDatoFormValues"}}],returns:null}],displayName:"MottattDatoPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Ur="omsorg",Vy="_barnInput_1jjt5_1",qy={barnInput:Vy},jy=10,Ly=e=>e?Nd(1)(e):void 0,wy=e=>e?it(10)(e):void 0,ko=(e,r)=>n=>{if(e===0&&r&&n)return bd(n,Array.isArray(r)?r[0]:r)},Jn=({readOnly:e=!0,familieHendelseType:r,isForeldrepengerFagsak:n,fodselsdatoer:a})=>{const{formatMessage:t}=fe(),{control:s,watch:i}=B(),{fields:o,remove:d,append:m}=tr({control:s,name:`${Ur}.foedselsDato`}),u=i(`${Ur}.antallBarn`)??0;return O.useEffect(()=>{if(o.length>Math.max(u,0))for(let g=o.length;g>u;g-=1)d(g-1);else if(o.length<Math.min(u,jy))for(let g=o.length;g<u;g+=1)m({id:g,dato:void 0})},[u]),l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:l.jsx(j,{id:r===Sr.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),n&&r===Sr.ADOPSJON&&l.jsx(Mr,{name:`${Ur}.erEktefellesBarn`,control:s,label:l.jsx(j,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[G],isReadOnly:e,children:l.jsxs(He,{gap:"space-16",children:[l.jsx(Ve,{value:!0,size:"small",children:l.jsx(j,{id:"Registrering.Adopsjon.Ja"})}),l.jsx(Ve,{value:!1,size:"small",children:l.jsx(j,{id:"Registrering.Adopsjon.Nei"})})]})}),l.jsx(Q,{name:`${Ur}.omsorgsovertakelsesdato`,control:s,label:t({id:r===Sr.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:e,validate:r===Sr.ADOPSJON?[G,re]:[re]}),l.jsxs(He,{gap:"space-16",children:[r===Sr.ADOPSJON&&l.jsx(Q,{name:`${Ur}.ankomstdato`,control:s,label:t({id:"Registrering.Adopsjon.Ankomstdato"}),isReadOnly:e,validate:[re]}),l.jsx(we,{name:`${Ur}.antallBarn`,control:s,label:t({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:e,className:qy.barnInput,parse:g=>{const v=Number.parseInt(g.toString(),10);return Number.isNaN(v)?g:v},validate:[...r===Sr.ADOPSJON?[G]:[],yn,Ly,wy]})]}),o.map((g,v)=>l.jsx(k.Fragment,{children:l.jsx(Q,{name:`${Ur}.foedselsDato.${v}.dato`,control:s,isReadOnly:e,validate:r===Sr.ADOPSJON?[G,re,wn,ko(v,a)]:[re,wn,ko(v,a)],label:t({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:v+1})})},g.id))]})})};Jn.initialValues=()=>({[Ur]:{}});Jn.transformValues=({omsorg:e})=>({[Ur]:{...e,foedselsDato:e.foedselsDato&&e.foedselsDato.length>0?e.foedselsDato.map(r=>r.dato):void 0}});Jn.__docgenInfo={description:`OmsorgOgAdopsjonPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  rettigheter?: string;
}`,signature:{properties:[{key:"rettigheter",value:{name:"string",required:!1}}]},alias:"RettigheterFormValues"}}],returns:null}],displayName:"RettigheterPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""}}};const La=Re(Ue),ts={BOKMAL:"NB",NYNORSK:"NN",ENGELSK:"EN"},ni=({readOnly:e})=>{const{control:r}=B();return l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:La.formatMessage({id:"Registrering.Sprak"})}),l.jsxs(Mr,{name:"språkkode",control:r,validate:[G],isReadOnly:e,children:[l.jsx(Ve,{value:ts.BOKMAL,size:"small",children:La.formatMessage({id:"Registrering.Sprak.Bokmal"})}),l.jsx(Ve,{value:ts.NYNORSK,size:"small",children:La.formatMessage({id:"Registrering.Sprak.Nynorsk"})}),l.jsx(Ve,{value:ts.ENGELSK,size:"small",children:La.formatMessage({id:"Registrering.Sprak.Engelsk"})})]})]})})};ni.initialValues=()=>({språkkode:void 0});ni.transformValues=({språkkode:e})=>({språkkode:e});ni.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  språkkode?: string;
  ...
  språkkode?: string;
}`,signature:{properties:[{key:"språkkode",value:{name:"string",required:!1}}]},alias:"SprakFormValues"}}],returns:null}],displayName:"SprakPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const pn="egenVirksomhet",be=`${pn}.virksomheter`,Hy={},Yy=e=>e.map(({kode:r,navn:n})=>l.jsx("option",{value:r,children:n},r)),Rt=({index:e,readOnly:r,alleKodeverk:n})=>{const a=fe(),t=n.Landkoder.slice().sort((o,d)=>o.navn.localeCompare(d.navn)),{getValues:s,control:i}=B();return l.jsx(qe,{name:`${be}.${e}.virksomhetRegistrertINorge`,control:i,label:l.jsx(j,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:r,trueContent:l.jsx(er,{children:l.jsx(we,{name:`${be}.${e}.organisasjonsnummer`,control:i,readOnly:r,validate:[G,yn,Sd],label:l.jsx(j,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:l.jsx(er,{alignOffset:58,children:l.jsxs(W,{gap:"space-16",children:[l.jsx(rr,{name:`${be}.${e}.landJobberFra`,control:i,className:Hy.landBredde,selectValues:Yy(t),validate:[G],label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),l.jsxs(He,{gap:"space-16",children:[l.jsx(Q,{name:`${be}.${e}.fom`,control:i,isReadOnly:r,validate:[G,re,wn],label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),l.jsx(Q,{name:`${be}.${e}.tom`,control:i,isReadOnly:r,validate:[re,o=>{const d=s(`${be}.${e}.fom`);return d?hd(d,o):null}],label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};Rt.transformValues=({virksomhetRegistrertINorge:e,organisasjonsnummer:r,landJobberFra:n,fom:a,tom:t})=>({virksomhetRegistrertINorge:e,organisasjonsnummer:e?r:void 0,...e===!1?{landJobberFra:n,fom:a,tom:t}:{landJobberFra:"NOR"}});Rt.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const Cy="_inntektBredde_1xgnj_1",$y={inntektBredde:Cy},Ot=({readOnly:e,index:r})=>{const{control:n}=B();return l.jsx(qe,{name:`${be}.${r}.varigEndretEllerStartetSisteFireAr`,control:n,label:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.NewlyStartedOrChanged"}),readOnly:e,trueContent:l.jsx(er,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(ur,{size:"small",children:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.Reason"})}),l.jsxs(Ys,{name:`${be}.${r}.varigEndretEllerStartetSisteFireArArsak`,control:n,validate:[G],children:[l.jsx(po,{value:"harVarigEndring",label:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.HarVarigEndring"}),readOnly:e,index:r}),l.jsx(Sa,{value:"erNyoppstartet",readOnly:e,children:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.ErNyoppstartet"})}),l.jsx(po,{value:"erNyIArbeidslivet",label:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.NyIArbeidslivet"}),readOnly:e,index:r})]}),l.jsx(Ql,{name:`${be}.${r}.beskrivelseAvEndring`,control:n,label:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.VirksomhetEndretBeskrivelse"}),validate:[Es]}),l.jsx(we,{name:`${be}.${r}.inntekt`,control:n,label:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.Inntekt"}),readOnly:e,validate:[yn,G],className:$y.inntektBredde,parse:a=>{const t=Number.parseInt(a.toString(),10);return Number.isNaN(t)?a:t}})]})})})};Ot.transformValues=({varigEndretEllerStartetSisteFireAr:e,varigEndretEllerStartetSisteFireArArsak:r,varigEndringGjeldendeFom:n,nyIArbeidslivetFom:a,beskrivelseAvEndring:t,inntekt:s})=>{const i=r.includes("harVarigEndring"),o=r.includes("erNyoppstartet"),d=r.includes("erNyIArbeidslivet");return{varigEndretEllerStartetSisteFireAr:e,...e?{harVarigEndring:i,...i?{varigEndringGjeldendeFom:n}:{},erNyoppstartet:o,erNyIArbeidslivet:d,...d?{nyIArbeidslivetFom:a}:{},beskrivelseAvEndring:t,inntekt:s}:{}}};const po=({value:e,label:r,readOnly:n,index:a})=>{const{watch:t,control:s}=B(),i=t(`${be}.${a}.varigEndretEllerStartetSisteFireArArsak`),[o,d]=O.useState(i.includes(e));return l.jsxs(W,{gap:"space-12",children:[l.jsx(Sa,{value:e,onClick:()=>d(!o),disabled:n,children:r}),o&&l.jsx(er,{children:l.jsx(Q,{name:e==="harVarigEndring"?`${be}.${a}.varigEndringGjeldendeFom`:`${be}.${a}.nyIArbeidslivetFom`,control:s,isReadOnly:n,validate:[re,G],label:l.jsx(j,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})]})};Ot.__docgenInfo={description:`VirksomhetStartetEndretPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ss=Re(Ue),ti=({readOnly:e})=>{const{control:r}=B();return l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:ss.formatMessage({id:"Registrering.Dekningsgrad.Title"})}),l.jsx(Mr,{name:"dekningsgrad",control:r,validate:[G],isReadOnly:e,children:l.jsxs(He,{gap:"space-16",children:[l.jsx(Ve,{value:"80_PROSENT",size:"small",children:ss.formatMessage({id:"Registrering.Dekningsgrad.prosent.80"})}),l.jsx(Ve,{value:"100_PROSENT",size:"small",children:ss.formatMessage({id:"Registrering.Dekningsgrad.prosent.100"})})]})})]})})};ti.initialValues=()=>({dekningsgrad:void 0});ti.transformValues=({dekningsgrad:e})=>({dekningsgrad:e});ti.__docgenInfo={description:"Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  dekningsgrad?: string;
  ...
  dekningsgrad?: string;
}`,signature:{properties:[{key:"dekningsgrad",value:{name:"string",required:!1}}]},alias:"FormValues"}}],returns:null}],displayName:"DekningsgradIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const To=Re(Ue),si=({readOnly:e,annenForelderInformertRequired:r=!1})=>{const{control:n}=B();return l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:To.formatMessage({id:"Registrering.TheOtherParent.Confirmation"})}),l.jsx(qe,{name:"annenForelderInformert",control:n,label:To.formatMessage({id:"Registrering.TheOtherParent.OtherParentKnowPeriods"}),isRequired:r,readOnly:e})]})})};si.initialValues=()=>({annenForelderInformert:void 0});si.tranformValues=({annenForelderInformert:e})=>({annenForelderInformert:e});si.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  annenForelderInformert?: boolean;
}`,signature:{properties:[{key:"annenForelderInformert",value:{name:"boolean",required:!1}}]},alias:"BekreftelseFormValues"}}],returns:null}],displayName:"BekreftelsePanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},annenForelderInformertRequired:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const me="tidsromPermisjon",Ln="graderingPeriode",ii="oppholdPerioder",id="overforingsperioder",ht="utsettelsePeriode",ya="permisjonsPerioder",oi=`${me}.${ya}`,hr=e=>`${oi}.${e}`,Xy=it(100),li=[Gr.FELLESPERIODE,Gr.FEDREKVOTE,Gr.FORELDREPENGER_FOR_FODSEL,Gr.FORELDREPENGER,Gr.MODREKVOTE],od=[Gr.FEDREKVOTE,Gr.FORELDREPENGER_FOR_FODSEL,Gr.MODREKVOTE],St=({sokerErMor:e,readOnly:r,alleKodeverk:n})=>{const a=fe(),t=n.UttakPeriodeType,s=n.MorsAktivitet;s.filter(({kode:E})=>E==="-").length===0&&s.unshift({kode:"-",navn:"",kodeverk:""});const{control:i,getValues:o,trigger:d,watch:m,formState:{isSubmitted:u}}=B(),{fields:g,remove:v,append:p}=tr({control:i,name:oi});return O.useEffect(()=>{g.length===0&&p({})},[]),l.jsx(cr,{readOnly:r,fields:g,addButtonText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyTemplate:{periodeType:"",periodeFom:"",periodeTom:""},append:p,remove:v,children:(E,c)=>{const T=c===0,f=m(hr(c)),R=eT(f.periodeFom),F=od.some(h=>h===f.periodeType)||f.periodeType==="";return l.jsxs(tn,{readOnly:r,remove:v,index:c,children:[l.jsx("div",{children:l.jsx(rr,{name:`${hr(c)}.periodeType`,control:i,readOnly:r,label:wa(T,a.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:Zy(t),validate:[G]})}),l.jsx(Q,{isReadOnly:r,control:i,name:`${hr(c)}.periodeFom`,label:wa(T,a.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[G,re,Ao(o,c,!0),Eo(o)],onChange:()=>u?d():void 0}),l.jsx(Q,{isReadOnly:r,control:i,name:`${hr(c)}.periodeTom`,label:wa(T,a.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[G,re,Ao(o,c,!1),Eo(o)],onChange:()=>u?d():void 0}),!e&&l.jsx(rr,{name:`${hr(c)}.morsAktivitet`,control:i,readOnly:r,disabled:F,label:wa(T,a.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:Qy(s),hideValueOnDisable:!0}),l.jsx("div",{children:l.jsx(lr,{name:`${hr(c)}.flerbarnsdager`,control:i,readOnly:r,label:l.jsx(j,{id:"Registrering.Permisjon.Flerbarnsdager"})})}),l.jsx("div",{children:l.jsx(lr,{name:`${hr(c)}.harSamtidigUttak`,control:i,readOnly:r,label:l.jsx(j,{id:"Registrering.Permisjon.HarSamtidigUttak"})})}),f.harSamtidigUttak&&l.jsx(we,{name:`${hr(c)}.samtidigUttaksprosent`,control:i,validate:[is,Xy],label:a.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:h=>Number.isNaN(h)?h:Number.parseFloat(h.toString()).toFixed(2)}),R&&l.jsx(dt,{size:"small",variant:"warning",children:l.jsx(j,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},E.id)}})};St.transformValues=e=>e.map(r=>od.some(n=>n===r.periodeType)?{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,flerbarnsdager:r.flerbarnsdager??!1,harSamtidigUttak:r.harSamtidigUttak??!1,samtidigUttaksprosent:r.samtidigUttaksprosent}:{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,morsAktivitet:r.morsAktivitet,flerbarnsdager:r.flerbarnsdager??!1,harSamtidigUttak:r.harSamtidigUttak??!1,samtidigUttaksprosent:r.samtidigUttaksprosent});const Zy=e=>e.filter(({kode:r})=>li.some(n=>n===r)).map(({kode:r,navn:n})=>l.jsx("option",{value:r,children:n},r)),Qy=e=>e.map(({kode:r,navn:n})=>l.jsx("option",{value:r,children:n},r)),wa=(e,r)=>e?r:"",eT=e=>!!e&&je(e,gr).isBefore(je("2019-01-01")),Eo=e=>()=>{const n=(e(oi)??[]).filter(({periodeFom:a,periodeTom:t})=>a!==""&&t!=="").map(({periodeFom:a,periodeTom:t})=>[a,t]);return Gn(n)},Ao=(e,r,n)=>()=>{const a=e(`${hr(r)}.periodeFom`),t=e(`${hr(r)}.periodeTom`);return!t||!a?null:n?nr(t)(a):xe(a)(t)};St.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ui=`${me}.${id}`,kn=e=>`${ui}.${e}`,bo=e=>()=>{const n=(e(ui)??[]).filter(({periodeFom:a,periodeTom:t})=>a!==""&&t!=="").map(({periodeFom:a,periodeTom:t})=>[a,t]);return n.length>0?Gn(n):void 0},ho={periodeFom:"",periodeTom:"",overforingArsak:""},ud=({selectValues:e,readOnly:r})=>{const n=fe(),{control:a,getValues:t,trigger:s,formState:{isSubmitted:i}}=B(),{fields:o,remove:d,append:m}=tr({control:a,name:ui});return O.useEffect(()=>{o.length===0&&m(ho)},[]),l.jsx(cr,{fields:o,emptyTemplate:ho,addButtonText:n.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:m,remove:d,children:(u,g)=>l.jsxs(tn,{readOnly:r,remove:d,index:g,children:[l.jsx("div",{children:l.jsx(rr,{name:`${kn(g)}.overforingArsak`,control:a,label:n.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[G],readOnly:r})}),l.jsx(Q,{name:`${kn(g)}.periodeFom`,control:a,isReadOnly:r,validate:[G,re,()=>{const v=t(`${kn(g)}.periodeFom`),p=t(`${kn(g)}.periodeTom`);return p&&v?nr(p)(v):null},bo(t)],label:l.jsx(j,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>i?s():void 0}),l.jsx(Q,{name:`${kn(g)}.periodeTom`,control:a,isReadOnly:r,validate:[G,re,()=>{const v=t(`${kn(g)}.periodeFom`),p=t(`${kn(g)}.periodeTom`);return p&&v?xe(v)(p):null},bo(t)],label:l.jsx(j,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>i?s():void 0})]},u.id)})};ud.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Nr=Re(Ue),vT=e=>r=>{const n=e("foedselsDato");return Mo(n,r)},pT=e=>r=>{const n=e("termindato");return Dd(n,r)},gi=({readOnly:e,erForeldrepenger:r=!1})=>{const{watch:n,getValues:a,control:t}=B(),s=n("erBarnetFodt");return l.jsx(dr,{value:Nr,children:l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:Nr.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),l.jsxs(Mr,{name:"erBarnetFodt",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[G],isReadOnly:e,children:[l.jsx(Ve,{value:!0,size:"small",children:l.jsx(j,{id:"Registrering.TerminOgFodsel.ErFodt"})}),l.jsx(Ve,{value:!1,size:"small",children:l.jsx(j,{id:"Registrering.TerminOgFodsel.ErIkkeFodt"})})]}),s!==void 0&&l.jsxs(W,{gap:"space-16",children:[s===!1&&l.jsxs(l.Fragment,{children:[l.jsxs(He,{gap:"space-16",children:[l.jsx(Q,{name:"termindato",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:e,fromDate:In().toDate(),toDate:Dn().toDate(),defaultMonth:new Date,validate:[G,re,xe(In()),nr(Dn())]}),l.jsx(we,{name:"antallBarn",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:e,parse:i=>{const o=Number.parseInt(i.toString(),10);return Number.isNaN(o)?i:o},validate:[G,yn,Ti,Ei]})]}),l.jsx(Q,{name:"terminbekreftelseDato",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.UtstedtDato"}),isReadOnly:e,fromDate:Pd().toDate(),toDate:Kd().toDate(),defaultMonth:new Date,validate:[re,pT(a)]})]}),s===!0&&l.jsxs(l.Fragment,{children:[l.jsxs(He,{gap:"space-16",children:[l.jsx(Q,{name:"foedselsDato",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:e,validate:[G,re,xe(Ba()),wn],fromDate:Ba().toDate(),toDate:Io().toDate()}),l.jsx(we,{name:"antallBarn",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:e,parse:i=>{const o=Number.parseInt(i.toString(),10);return Number.isNaN(o)?i:o},validate:[G,yn,Ti,Ei]})]}),r&&l.jsx(dt,{size:"small",variant:"info",children:l.jsx(ur,{size:"small",children:Nr.formatMessage({id:"Registrering.TerminOgFodsel.RettTilPrematuruker"})})}),l.jsx(Q,{name:"termindato",control:t,label:Nr.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:e,validate:[re,xe(In()),nr(Dn()),vT(a)],fromDate:In().toDate(),toDate:Dn().toDate(),defaultMonth:new Date})]})]})]})})})};gi.initialValues=()=>({erBarnetFodt:void 0});gi.transformValues=({antallBarn:e,erBarnetFodt:r,foedselsDato:n,termindato:a,terminbekreftelseDato:t})=>r?{erBarnetFodt:!0,termindato:a,foedselsDato:n,antallBarn:e}:{erBarnetFodt:!1,termindato:a,terminbekreftelseDato:t,antallBarnFraTerminbekreftelse:e};gi.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
...
| {
  ...
  foedselsDato?: string;
  antallBarn?: number;
}`,signature:{properties:[{key:"erBarnetFodt",value:{name:"literal",value:"true",required:!0}},{key:"termindato",value:{name:"string",required:!1}},{key:"foedselsDato",value:{name:"string",required:!1}},{key:"antallBarn",value:{name:"number",required:!1}}]}}]}}}],displayName:"TerminOgFodselPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},erForeldrepenger:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Kn=Re(Ue),yT=e=>r=>{const n=e("foedselsDato");return Mo(n,r)},mi=({readOnly:e})=>{const{getValues:r,watch:n,control:a}=B(),t=n("erBarnetFodt");return l.jsx(Ye,{children:l.jsxs(W,{gap:"space-16",children:[l.jsx(he,{size:"small",level:"3",children:Kn.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),l.jsxs(Mr,{name:"erBarnetFodt",control:a,label:Kn.formatMessage({id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[G],isReadOnly:e,children:[l.jsx(Ve,{value:!0,size:"small",children:Kn.formatMessage({id:"Registrering.TerminOgFodsel.ErFodt"})}),l.jsx(Ve,{value:!1,size:"small",children:Kn.formatMessage({id:"Registrering.TerminOgFodsel.ErIkkeFodt"})})]}),t&&l.jsx(Q,{name:"foedselsDato",control:a,label:Kn.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:e,fromDate:Ba().toDate(),toDate:Io().toDate(),validate:[G,re,wn,xe(Ba())]}),l.jsx(Q,{name:"termindato",control:a,label:Kn.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:e,fromDate:In().toDate(),toDate:Dn().toDate(),defaultMonth:new Date,validate:[G,re,xe(In()),nr(Dn()),yT(r)]})]})})};mi.initialValues=()=>({termindato:void 0,foedselsDato:void 0,erBarnetFodt:!1});mi.transformValues=({erBarnetFodt:e,foedselsDato:r,termindato:n})=>({erBarnetFodt:e,termindato:n,foedselsDato:e?r:void 0});mi.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
  foedselsDato?: string;
  erBarnetFodt?: boolean;
  ...
  notRegisteredInput?: boolean;
}`,signature:{properties:[{key:"notRegisteredInput",value:{name:"boolean",required:!1}}]}}],required:!0}}]},alias:"FormValues"}}],returns:null}],displayName:"BehovForTilretteleggingPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};export{Ws as A,ha as B,PT as C,ti as D,Sr as F,ST as H,zs as I,Xs as L,j as M,Qs as O,ki as P,Ve as R,Mr as S,gi as T,ai as V,_T as W,DT as a,hT as b,ut as c,ri as d,ei as e,ni as f,bT as g,Zs as h,si as i,$s as j,Js as k,vi as l,mi as m,KT as u};
