import{j as a}from"./iframe-CljjPBeF.js";import{u as A,L as s,f as u,l as k,m as d,j as m,k as v,V as o,I as g,e as y,h as E,C as N,H as S,F as I}from"./BehovForTilretteleggingPanel-CfcrSlq5.js";const F=()=>({...E.initialValues(),...y.initialValues(),...g.initialValues(),...o.initialValues(),...v.initialValues(),...m.initialValues(),...d.initialValues(),...k.initialValues(),...u.initialValues(),...s.initialValues()}),P=e=>({...E.transformValues(e),...y.transformValues(e),...g.transformValues(e),...o.transformValues(e),...v.transformValues(e),...m.transformValues(e),...d.transformValues(e),...k.transformValues(e),...u.transformValues(e),...s.transformValues(e)}),T=({readOnly:e,soknadData:n,alleKodeverk:r,onSubmit:l,onSubmitUfullstendigsoknad:t})=>{const i=A({defaultValues:F()}),p=i.watch("mottattDato");return a.jsxs(N,{formMethods:i,onSubmit:R=>l(P(R)),children:[a.jsxs(S,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(E,{readOnly:e}),a.jsx(y,{readOnly:e,alleKodeverk:r,erAdopsjon:n.getFamilieHendelseType()!==I.ADOPSJON,mottattDato:p}),a.jsx(g,{readOnly:e,alleKodeverk:r}),a.jsx(o,{readOnly:e,alleKodeverk:r}),a.jsx(v,{readOnly:e}),a.jsx(m,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:r}),a.jsx(d,{readOnly:e}),a.jsx(k,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(s,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!1})]})};T.__docgenInfo={description:`SvangerskapspengerForm
