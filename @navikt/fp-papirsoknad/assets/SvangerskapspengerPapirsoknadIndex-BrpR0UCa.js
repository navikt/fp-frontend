import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{u as q,L as o,c as d,i as u,j as l,d as g,e as m,V as k,I as v,f as p,M as y,h as P,H as A,F as T}from"./BehovForTilretteleggingPanel-BS3SYPqg.js";import"./nb_NO-BE_uoNrT.js";const j=()=>({...y.initialValues(),...p.initialValues(),...v.initialValues(),...k.initialValues(),...m.initialValues(),...g.initialValues(),...l.initialValues(),...u.initialValues(),...d.initialValues(),...o.initialValues()}),K=e=>({...y.transformValues(e),...p.transformValues(e),...v.transformValues(e),...k.transformValues(e),...m.transformValues(e),...g.transformValues(e),...l.transformValues(e),...u.transformValues(e),...d.transformValues(e),...o.transformValues(e)}),c=({readOnly:e,soknadData:a,alleKodeverk:n,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=q({defaultValues:j()}),w=i.watch("mottattDato");return r.jsxs(P,{formMethods:i,onSubmit:R=>t(K(R)),children:[r.jsxs(A,{columns:{sm:1,md:2},gap:"4",children:[r.jsx(y,{readOnly:e}),r.jsx(p,{readOnly:e,alleKodeverk:n,erAdopsjon:a.getFamilieHendelseType()!==T.ADOPSJON,mottattDato:w}),r.jsx(v,{readOnly:e,alleKodeverk:n}),r.jsx(k,{readOnly:e,alleKodeverk:n}),r.jsx(m,{readOnly:e}),r.jsx(g,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:n}),r.jsx(l,{readOnly:e}),r.jsx(u,{readOnly:e}),r.jsx(d,{readOnly:e})]}),r.jsx(o,{readOnly:e,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting})]})};c.__docgenInfo={description:`SvangerskapspengerForm
