import{j as a}from"./iframe-BajhCNZS.js";import{u as P,L as u,h as N,P as m,f as R,C as F,H as V,e as v,A as T,O as _,c as A,T as S,D as I,i as L,F as D,V as K,I as O,d as G}from"./BehovForTilretteleggingPanel-CAThnpr_.js";const g=()=>({...R.initialValues(),...m.initialValues(),...N.initialValues(),...u.initialValues()}),p=e=>({...R.transformValues(e),...m.transformValues(e),...N.tranformValues(e),...u.transformValues(e)}),s=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:r,onSubmitUfullstendigsoknad:t})=>{const i=P({defaultValues:g()});return a.jsxs(F,{formMethods:i,onSubmit:E=>r(p(E)),children:[a.jsxs(V,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(R,{readOnly:e}),a.jsx(N,{annenForelderInformertRequired:!0,readOnly:e})]}),a.jsx(m,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!0}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!0})]})};s.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
