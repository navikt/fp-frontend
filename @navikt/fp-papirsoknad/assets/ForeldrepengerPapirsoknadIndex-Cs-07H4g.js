import{j as a}from"./iframe-Bm9C45kA.js";import{u as s,L as u,h as m,P as N,f as v,C as P,H as F,e as R,A as T,O as _,c as A,T as S,D as I,i as L,F as D,V as K,I as O,d as G}from"./BehovForTilretteleggingPanel-Cn8UKcEk.js";const y=()=>({...v.initialValues(),...N.initialValues(),...m.initialValues(),...u.initialValues()}),p=e=>({...v.transformValues(e),...N.transformValues(e),...m.tranformValues(e),...u.transformValues(e)}),V=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:E,onSubmitUfullstendigsoknad:t})=>{const i=s({defaultValues:y()});return a.jsxs(P,{formMethods:i,onSubmit:r=>E(p(r)),children:[a.jsxs(F,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(v,{readOnly:e}),a.jsx(m,{annenForelderInformertRequired:!0,readOnly:e})]}),a.jsx(N,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!0}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!0})]})};V.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
