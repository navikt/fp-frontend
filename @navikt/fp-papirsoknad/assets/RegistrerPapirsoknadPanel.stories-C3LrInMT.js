import{j as e,t as T,F as i,r as S,P as F,a as _,w as j}from"./iframe-QUrzy32s.js";import{u as f,D as B,B as A,M as t,F as E,R as b,a as q,S as w,W as P,b as O,g as G}from"./BehovForTilretteleggingPanel-D4lbK-dZ.js";import{E as c}from"./EngangsstonadPapirsoknadIndex-BCg4_rF-.js";import{F as I}from"./ForeldrepengerPapirsoknadIndex-DdqLfn34.js";import{V as R,H as V,a as D,B as U,m as h}from"./nb_NO-bfoI5DrA.js";import{S as L}from"./SvangerskapspengerPapirsoknadIndex-BHd6AD6w.js";import"./preload-helper-D9Z9MdNV.js";import"./index-Y5edyTDp.js";const M=[q.ADOPSJON,q.FODSEL],K=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:l})=>{const r=f({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),k=r.watch("fagsakYtelseType"),a=l.FagsakYtelseType,y=l.FamilieHendelseType,o=l.ForeldreType;return e.jsx(B,{formMethods:r,onSubmit:n=>{s(new w(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType)),r.reset(n)},children:e.jsx(A.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(R,{gap:"space-16",padding:"5",children:[e.jsx(V,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(D,{gap:"20",children:[e.jsx(E,{name:"fagsakYtelseType",control:r.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],children:a.map(n=>e.jsx(b,{value:n.kode,size:"small",disabled:!0,children:n.navn},n.kode))}),k!==i.SVANGERSKAPSPENGER&&e.jsx(E,{name:"familieHendelseType",control:r.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],children:y.filter(({kode:n})=>M.some(p=>p===n)).map(n=>e.jsx(b,{value:n.kode,size:"small",children:n.navn},n.kode))}),e.jsx(E,{name:"foreldreType",control:r.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],children:o.map(n=>e.jsx(b,{value:n.kode,size:"small",children:n.navn},n.kode))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(U,{type:"submit",disabled:!r.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};K.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const H=_(h),N=({fagsak:s,kodeverk:u,readOnly:l,lagrePapirsøknad:r,erEndringssøknad:k})=>{const[a,y]=S.useState(),o=p=>(a&&r(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType,p),Promise.resolve()),n=()=>(a&&r(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType),Promise.resolve());return e.jsx(F,{value:H,children:e.jsxs(R,{gap:"space-16",padding:"4",children:[e.jsx(V,{size:"small",level:"2",children:k?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!l&&e.jsx(P,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(K,{setSoknadData:y,fagsakYtelseType:s.fagsakYtelseType,alleKodeverk:u}),a&&a.getFagsakYtelseType()===i.ENGANGSSTONAD&&e.jsx(c,{onSubmitUfullstendigsoknad:n,onSubmit:o,readOnly:l,soknadData:a,alleKodeverk:u}),a&&a.getFagsakYtelseType()===i.FORELDREPENGER&&e.jsx(I,{onSubmitUfullstendigsoknad:n,onSubmit:o,readOnly:l,soknadData:a,alleKodeverk:u,fagsakPersonnummer:s.bruker.fødselsnummer,erEndringssøknad:k}),a&&a.getFagsakYtelseType()===i.SVANGERSKAPSPENGER&&e.jsx(L,{onSubmitUfullstendigsoknad:n,onSubmit:o,readOnly:l,soknadData:a,alleKodeverk:u})]})})};N.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<VurderÅrsak>"},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Y}=__STORYBOOK_MODULE_ACTIONS__,$={component:N,decorators:[j,G(h)],args:{readOnly:!1,kodeverk:O,lagrePapirsøknad:s=>(Y("lagrePapirsøknad")(s),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:i.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},m={args:{fagsak:{fagsakYtelseType:i.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},g={args:{fagsak:{fagsakYtelseType:i.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:i.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
