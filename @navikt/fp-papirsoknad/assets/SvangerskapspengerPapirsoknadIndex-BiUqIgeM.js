import{j as r}from"./iframe-urELOOVV.js";import{u as R,L as l,f as u,l as k,m as d,j as o,k as g,V as y,I as m,e as v,h as p,C as F,H as K,F as j}from"./BehovForTilretteleggingPanel-DczemBsi.js";const V=()=>({...p.initialValues(),...v.initialValues(),...m.initialValues(),...y.initialValues(),...g.initialValues(),...o.initialValues(),...d.initialValues(),...k.initialValues(),...u.initialValues(),...l.initialValues()}),w=e=>({...p.transformValues(e),...v.transformValues(e),...m.transformValues(e),...y.transformValues(e),...g.transformValues(e),...o.transformValues(e),...d.transformValues(e),...k.transformValues(e),...u.transformValues(e),...l.transformValues(e)}),T=({readOnly:e,soknadData:a,alleKodeverk:n,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=R({defaultValues:V()}),A=i.watch("mottattDato");return r.jsxs(F,{formMethods:i,onSubmit:q=>t(w(q)),children:[r.jsxs(K,{columns:{sm:1,md:2},gap:"space-16",children:[r.jsx(p,{readOnly:e}),r.jsx(v,{readOnly:e,alleKodeverk:n,erAdopsjon:a.getFamilieHendelseType()!==j.ADOPSJON,mottattDato:A}),r.jsx(m,{readOnly:e,alleKodeverk:n}),r.jsx(y,{readOnly:e,alleKodeverk:n}),r.jsx(g,{readOnly:e}),r.jsx(o,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:n}),r.jsx(d,{readOnly:e}),r.jsx(k,{readOnly:e}),r.jsx(u,{readOnly:e})]}),r.jsx(l,{readOnly:e,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting,erEndringssøknad:!1})]})};T.__docgenInfo={description:`SvangerskapspengerForm
