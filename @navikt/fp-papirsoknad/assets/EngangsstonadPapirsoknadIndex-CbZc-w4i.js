import{j as a}from"./iframe-Dv6c0f1w.js";import{c as l,O as r,d as E,e as t,T as N,u as o,L as v,f as A,C as I,H as y}from"./BehovForTilretteleggingPanel-CtbTNDpF.js";const R=({readOnly:e,soknadData:n,alleKodeverk:i,fodselsdato:u,mottattDato:T})=>a.jsxs(a.Fragment,{children:[a.jsx(l,{readOnly:e,soknadData:n}),a.jsx(r,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:u}),a.jsx(E,{readOnly:e,alleKodeverk:i,erAdopsjon:n.getFamilieHendelseType()!=="ADPSJN",mottattDato:T}),a.jsx(t,{readOnly:e})]});R.initialValues=()=>({...l.initialValues(),...r.initialValues(),...E.initialValues(),...t.initialValues()});R.transformValues=e=>({...l.transformValues(e),...r.transformValues(e),...E.transformValues(e),...t.transformValues(e)});R.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringAdopsjonOgOmsorgGrid.initialValues"}],raw:"ReturnType<typeof RegistreringAdopsjonOgOmsorgGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringAdopsjonOgOmsorgGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const s=({readOnly:e,soknadData:n,alleKodeverk:i,fodselsdato:u,mottattDato:T})=>a.jsxs(a.Fragment,{children:[n.getForeldreType()!=="MOR"&&a.jsx(l,{readOnly:e,soknadData:n}),n.getForeldreType()!=="MOR"&&a.jsx(r,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:u}),a.jsx(E,{readOnly:e,erAdopsjon:n.getFamilieHendelseType()==="ADPSJN",alleKodeverk:i,mottattDato:T}),a.jsx(N,{readOnly:e,erForeldrepenger:!1}),a.jsx(t,{readOnly:e})]});s.initialValues=()=>({...l.initialValues(),...E.initialValues(),...r.initialValues(),...N.initialValues(),...t.initialValues()});s.transformValues=e=>({...l.transformValues(e),...E.transformValues(e),...r.transformValues(e),...N.transformValues(e),...t.transformValues(e)});s.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringFodselGrid.initialValues"}],raw:"ReturnType<typeof RegistreringFodselGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringFodselGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const S=({readOnly:e,soknadData:n,alleKodeverk:i,onSubmitUfullstendigsoknad:u,onSubmit:T})=>{const k=_(n.getFamilieHendelseType()),m=o({defaultValues:g()}),d=m.watch("foedselsDato"),D=m.watch("mottattDato");return a.jsxs(I,{formMethods:m,onSubmit:L=>T(G(n,L)),children:[a.jsxs(y,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(A,{readOnly:e}),a.jsx(k,{soknadData:n,readOnly:e,alleKodeverk:i,fodselsdato:d,mottattDato:D})]}),a.jsx(v,{readOnly:e,submitting:m.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},g=()=>({...A.initialValues(),...s.initialValues(),...R.initialValues(),...v.initialValues()}),G=(e,n)=>({...A.transformValues(n),..._(e.getFamilieHendelseType()).transformValues(n),...v.transformValues(n)}),_=e=>{if(e==="FODSL")return s;if(e==="ADPSJN")return R;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};S.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{p as E};
