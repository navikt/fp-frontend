import{j as a}from"./iframe-D4pnO6wK.js";import{u as O,L as i,e as u,k as N,l as R,j as T,F as m,V as v,I as _,d as A,f as S,P as K,H as G}from"./BehovForTilretteleggingPanel-7VM93mx4.js";const P=()=>({...S.initialValues(),...A.initialValues(),..._.initialValues(),...v.initialValues(),...m.initialValues(),...T.initialValues(),...R.initialValues(),...N.initialValues(),...u.initialValues(),...i.initialValues()}),F=e=>({...S.transformValues(e),...A.transformValues(e),..._.transformValues(e),...v.transformValues(e),...m.transformValues(e),...T.transformValues(e),...R.transformValues(e),...N.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),I=({readOnly:e,soknadData:n,alleKodeverk:l,onSubmit:E,onSubmitUfullstendigsoknad:r})=>{const t=O({defaultValues:P()}),L=t.watch("mottattDato");return a.jsxs(K,{formMethods:t,onSubmit:D=>E(F(D)),children:[a.jsxs(G,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(S,{readOnly:e}),a.jsx(A,{readOnly:e,alleKodeverk:l,erAdopsjon:n.getFamilieHendelseType()!=="ADPSJN",mottattDato:L}),a.jsx(_,{readOnly:e,alleKodeverk:l}),a.jsx(v,{readOnly:e,alleKodeverk:l}),a.jsx(m,{readOnly:e}),a.jsx(T,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:l}),a.jsx(R,{readOnly:e}),a.jsx(N,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:r,submitting:t.formState.isSubmitting,erEndringssøknad:!1})]})};I.__docgenInfo={description:`SvangerskapspengerForm
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{V as S};
