import{j as e,t as A,r as o,P,e as F,w as V}from"./iframe-C4meVAis.js";import{u as k,P as g,B as I,M as t,S,R as s,a as M,K as B,b as y,g as U}from"./BehovForTilretteleggingPanel-B-TtJB26.js";import{E as p}from"./EngangsstonadPapirsoknadIndex-DQ64JwuW.js";import{F as H}from"./ForeldrepengerPapirsoknadIndex-Dk1hu28Y.js";import{V as L,H as D,a as b,B as q,m as K}from"./nb_NO-PV2IM8zu.js";import{S as f}from"./SvangerskapspengerPapirsoknadIndex-BSAb-QNU.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DxFFbbRE.js";const h=new Set(["ADPSJN","FODSL"]),O=({setSoknadData:E,fagsakYtelseType:i,alleKodeverk:r})=>{const n=k({defaultValues:{fagsakYtelseType:i,familieHendelseType:void 0,foreldreType:void 0}}),m=n.watch("fagsakYtelseType"),l=r.FagsakYtelseType,T=r.FamilieHendelseType,u=r.ForeldreType;return e.jsx(g,{formMethods:n,onSubmit:a=>{E(new M(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),n.reset(a)},children:e.jsx(I.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(L,{gap:"space-16",padding:"5",children:[e.jsx(D,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(b,{gap:"20",children:[e.jsx(S,{name:"fagsakYtelseType",control:n.control,legend:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[A],children:l.map(a=>e.jsx(s,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),m!=="SVP"&&e.jsx(S,{name:"familieHendelseType",control:n.control,legend:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[A],children:T.filter(({kode:a})=>h.has(a)).map(a=>e.jsx(s,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(S,{name:"foreldreType",control:n.control,legend:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[A],children:u.map(a=>e.jsx(s,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(I,{style:{textAlign:"end"},children:e.jsx(q,{type:"submit",disabled:!n.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};O.__docgenInfo={description:`SoknadTypePickerForm

Toppkomponent for registrering av papirsøknad der søknadstype, tema og søker/foreldretype blir valgt.`,methods:[],displayName:"SoknadTypePickerForm",props:{setSoknadData:{required:!0,tsType:{name:"signature",type:"function",raw:"(soknadData: SoknadData) => void",signature:{arguments:[{type:{name:"SoknadData"},name:"soknadData"}],return:{name:"void"}}},description:""},fagsakYtelseType:{required:!0,tsType:{name:"union",raw:"'ES' | 'FP' | 'SVP' | '-'",elements:[{name:"literal",value:"'ES'"},{name:"literal",value:"'FP'"},{name:"literal",value:"'SVP'"},{name:"literal",value:"'-'"}]},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Y=F(K),G=({fagsak:E,kodeverk:i,readOnly:r,lagrePapirsøknad:n,erEndringssøknad:m})=>{const[l,T]=o.useState(),u=d=>(l&&n(l.fagsakYtelseType,l.familieHendelseType,l.foreldreType,d),Promise.resolve()),a=()=>(l&&n(l.fagsakYtelseType,l.familieHendelseType,l.foreldreType),Promise.resolve());return e.jsx(P,{value:Y,children:e.jsxs(L,{gap:"space-16",padding:"4",children:[e.jsx(D,{size:"small",level:"2",children:m?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(B,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(O,{setSoknadData:T,fagsakYtelseType:E.fagsakYtelseType,alleKodeverk:i}),l&&l.getFagsakYtelseType()==="ES"&&e.jsx(p,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:l,alleKodeverk:i}),l&&l.getFagsakYtelseType()==="FP"&&e.jsx(H,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:l,alleKodeverk:i,fagsakPersonnummer:E.bruker.fødselsnummer,erEndringssøknad:m}),l&&l.getFagsakYtelseType()==="SVP"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:l,alleKodeverk:i})]})})};G.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string;
...
| 'MMOR'
| 'ANPA'
| '-'`,elements:[{name:"literal",value:"'EKTE'"},{name:"literal",value:"'BARN'"},{name:"literal",value:"'FARA'"},{name:"literal",value:"'MORA'"},{name:"literal",value:"'REPA'"},{name:"literal",value:"'MMOR'"},{name:"literal",value:"'ANPA'"},{name:"literal",value:"'-'"}],required:!0}},{key:"sakSkalTilInfotrygd",value:{name:"boolean",required:!0}},{key:"saksnummer",value:{name:"string",required:!0}},{key:"status",value:{name:"union",raw:"'OPPR' | 'UBEH' | 'LOP' | 'AVSLU'",elements:[{name:"literal",value:"'OPPR'"},{name:"literal",value:"'UBEH'"},{name:"literal",value:"'LOP'"},{name:"literal",value:"'AVSLU'"}],required:!0}}]}},description:""},kodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
  [K in Exclude<KodeverkType, 'PeriodeResultatÅrsak'>]: KodeverkMedNavn<K extends KodeverkType ? K : unknown>[];
}`,signature:{properties:[{key:{name:"Exclude",elements:[{name:"signature",type:"object",raw:`{
...
) => Promise<BehandlingFpSak>`,signature:{arguments:[{type:{name:"union",raw:"'ES' | 'FP' | 'SVP' | '-'",elements:[{name:"literal",value:"'ES'"},{name:"literal",value:"'FP'"},{name:"literal",value:"'SVP'"},{name:"literal",value:"'-'"}]},name:"fagsakYtelseType"},{type:{name:"union",raw:`| 'ADPSJN'
| 'OMSRGO'
| 'FODSL'
| 'TERM'
| '-'`,elements:[{name:"literal",value:"'ADPSJN'"},{name:"literal",value:"'OMSRGO'"},{name:"literal",value:"'FODSL'"},{name:"literal",value:"'TERM'"},{name:"literal",value:"'-'"}]},name:"familieHendelseType"},{type:{name:"union",raw:"'MOR' | 'FAR' | 'MEDMOR' | 'ANDRE' | '-'",elements:[{name:"literal",value:"'MOR'"},{name:"literal",value:"'FAR'"},{name:"literal",value:"'MEDMOR'"},{name:"literal",value:"'ANDRE'"},{name:"literal",value:"'-'"}]},name:"foreldreType"},{type:{name:"union",raw:"EngangsstønadValues | ForeldrepengerValues | ForeldrepengerEndringssøknadValues | SvangerskapsValues",elements:[{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"}]},name:"formValues"}],return:{name:"Promise",elements:[{name:"signature",type:"object",raw:`{
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}}],raw:"Promise<BehandlingFpSak>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:J}=__STORYBOOK_MODULE_ACTIONS__,Q={component:G,decorators:[V,U(K)],args:{readOnly:!1,kodeverk:y,lagrePapirsøknad:E=>(J("lagrePapirsøknad")(E),Promise.resolve({}))}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},N={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},_={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},R={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
...
}`,...R.parameters?.docs?.source}}};const z=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{R as EngangsstonadFørstegangssøknad,N as ForeldrepengerEndringssøknad,v as ForeldrepengerFørstegangssøknad,_ as SvangerskapspengerFørstegangssøknad,z as __namedExportsOrder,Q as default};
