import{j as e,F as l,r as I,P as D,a as M,w as U}from"./iframe-D8yt8DoB.js";import{u as H,N as L,B as A,M as s,a as T,t as b,F as E,S as Y,K as x,b as J,g as C}from"./BehovForTilretteleggingPanel-rH1RgfpO.js";import{E as z}from"./EngangsstonadPapirsoknadIndex-CugGlfab.js";import{F as W}from"./ForeldrepengerPapirsoknadIndex-BjeR86vs.js";import{V as G,H as c,a as Q,B as X,m as O}from"./nb_NO-CXYtvIkY.js";import{S as Z}from"./SvangerskapspengerPapirsoknadIndex-B5EUQbio.js";import"./index-r_gHOPbW.js";const $=[E.ADOPSJON,E.FODSEL],P=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const a=H({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),o=a.watch("fagsakYtelseType"),n=t.FagsakYtelseType,p=t.FamilieHendelseType,k=t.ForeldreType;return e.jsx(L,{formMethods:a,onSubmit:r=>{i(new Y(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),a.reset(r)},children:e.jsx(A,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(G,{gap:"4",padding:"5",children:[e.jsx(c,{size:"small",children:e.jsx(s,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(Q,{gap:"20",children:[e.jsx(T,{name:"fagsakYtelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[b],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),o!==l.SVANGERSKAPSPENGER&&e.jsx(T,{name:"familieHendelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Tema"}),validate:[b],radios:p.filter(({kode:r})=>$.some(v=>v===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(T,{name:"foreldreType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Soker"}),validate:[b],radios:k.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(X,{type:"submit",disabled:!a.formState.isDirty,children:e.jsx(s,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};P.__docgenInfo={description:`SoknadTypePickerForm
