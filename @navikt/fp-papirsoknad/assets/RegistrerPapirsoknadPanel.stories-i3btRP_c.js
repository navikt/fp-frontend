import{V as M,c as H,H as z,F as a,b as W,P as Q,r as X,m as Y,w as Z,a as $}from"./nb_NO-Dzx0OGfR.js";import{u as ee,S as ne,N as re,j as q,k as i,l as A,m as E,F as R,J as ae,a as te,g as se}from"./BehovForTilretteleggingPanel-DdxUYRyJ.js";import{j as e}from"./index-Byyjg8XX.js";import{r as L}from"./index-C4XKfyRp.js";import{E as le}from"./EngangsstonadPapirsoknadIndex-oIVOwH9m.js";import{F as ie}from"./ForeldrepengerPapirsoknadIndex-D7SSuxFx.js";import{S as ue}from"./SvangerskapspengerPapirsoknadIndex-CGcydYfN.js";import"./v4-CtRu48qb.js";import"./entry-preview-DCjkaVZA.js";import"./iframe-C9j-ozyf.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";const ke=[R.ADOPSJON,R.FODSEL],x=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:t})=>{const l=ee({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),T=l.watch("fagsakYtelseType"),n=L.useCallback(r=>s(new ne(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[s]),b=t.FagsakYtelseType,k=t.FamilieHendelseType,o=t.ForeldreType;return e.jsx(re,{formMethods:l,onSubmit:n,children:e.jsx(q,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(M,{gap:"4",padding:"5",children:[e.jsx(H,{size:"small",children:e.jsx(i,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(z,{gap:"20",children:[e.jsx(A,{label:e.jsx(i,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[E],radios:b.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),T!==a.SVANGERSKAPSPENGER&&e.jsx(A,{name:"familieHendelseType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Tema"}),validate:[E],radios:k.filter(({kode:r})=>ke.some(C=>C===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(A,{name:"foreldreType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Soker"}),validate:[E],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(q,{style:{textAlign:"end"},children:e.jsx(W,{type:"submit",disabled:l.formState.isSubmitting||l.formState.isSubmitted,children:e.jsx(i,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};x.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const oe=X(Y),J=({fagsak:s,kodeverk:u,readOnly:t,lagrePapirsøknad:l,erEndringssøknad:T})=>{const[n,b]=L.useState(),k=r=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,r),Promise.resolve()),o=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(Q,{value:oe,children:e.jsxs(M,{gap:"4",padding:"4",children:[e.jsx(H,{size:"small",children:e.jsx(i,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(ae,{children:e.jsx(i,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(x,{setSoknadData:b,fagsakYtelseType:s.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.ENGANGSSTONAD&&e.jsx(le,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.FORELDREPENGER&&e.jsx(ie,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:s.bruker.fødselsnummer,erEndringssøknad:T}),n&&n.getFagsakYtelseType()===a.SVANGERSKAPSPENGER&&e.jsx(ue,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})};J.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ve={component:J,decorators:[Z,se(Y)],args:{readOnly:!1,kodeverk:te,lagrePapirsøknad:s=>($("lagrePapirsøknad")(s),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},p={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var h,j,f;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(w=(B=m.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};var F,c,G;y.parameters={...y.parameters,docs:{...(F=y.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.SVANGERSKAPSPENGER,
      bruker: {
...
}`,...(G=(c=y.parameters)==null?void 0:c.docs)==null?void 0:G.source}}};var P,O,_;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    fagsak: {
