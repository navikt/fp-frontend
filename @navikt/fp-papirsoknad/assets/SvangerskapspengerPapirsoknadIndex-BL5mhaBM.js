import{j as a}from"./iframe-Dv6c0f1w.js";import{u as D,L as i,e as u,j as T,k as s,i as R,F as m,V as N,I as v,d as S,f as A,C as L,H as o}from"./BehovForTilretteleggingPanel-CtbTNDpF.js";const I=()=>({...A.initialValues(),...S.initialValues(),...v.initialValues(),...N.initialValues(),...m.initialValues(),...R.initialValues(),...s.initialValues(),...T.initialValues(),...u.initialValues(),...i.initialValues()}),g=e=>({...A.transformValues(e),...S.transformValues(e),...v.transformValues(e),...N.transformValues(e),...m.transformValues(e),...R.transformValues(e),...s.transformValues(e),...T.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),_=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:r,onSubmitUfullstendigsoknad:E})=>{const t=D({defaultValues:I()}),k=t.watch("mottattDato");return a.jsxs(L,{formMethods:t,onSubmit:d=>r(g(d)),children:[a.jsxs(o,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(A,{readOnly:e}),a.jsx(S,{readOnly:e,alleKodeverk:n,erAdopsjon:l.getFamilieHendelseType()!=="ADPSJN",mottattDato:k}),a.jsx(v,{readOnly:e,alleKodeverk:n}),a.jsx(N,{readOnly:e,alleKodeverk:n}),a.jsx(m,{readOnly:e}),a.jsx(R,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:n}),a.jsx(s,{readOnly:e}),a.jsx(T,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:E,submitting:t.formState.isSubmitting,erEndringssøknad:!1})]})};_.__docgenInfo={description:`SvangerskapspengerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{y as S};
