import{j as e,t as N,r as K,P as y,a as G,w as p}from"./iframe-Dv6c0f1w.js";import{u as F,C as P,B as o,M as t,S as d,R as A,a as V,W as O,b as B,g as b}from"./BehovForTilretteleggingPanel-CtbTNDpF.js";import{E as U}from"./EngangsstonadPapirsoknadIndex-CbZc-w4i.js";import{F as M}from"./ForeldrepengerPapirsoknadIndex-CwEDDhYo.js";import{V as k,H as S,a as q,B as H,m as g}from"./nb_NO-DT83dvd9.js";import{S as f}from"./SvangerskapspengerPapirsoknadIndex-BL5mhaBM.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BfjQhpM5.js";const h=new Set(["ADPSJN","FODSL"]),L=({setSoknadData:i,fagsakYtelseType:E,alleKodeverk:r})=>{const l=F({defaultValues:{fagsakYtelseType:E,familieHendelseType:void 0,foreldreType:void 0}}),s=l.watch("fagsakYtelseType"),n=r.FagsakYtelseType,R=r.FamilieHendelseType,u=r.ForeldreType;return e.jsx(P,{formMethods:l,onSubmit:a=>{i(new V(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),l.reset(a)},children:e.jsx(o.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(k,{gap:"space-16",padding:"5",children:[e.jsx(S,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(q,{gap:"20",children:[e.jsx(d,{name:"fagsakYtelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[N],children:n.map(a=>e.jsx(A,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),s!=="SVP"&&e.jsx(d,{name:"familieHendelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[N],children:R.filter(({kode:a})=>h.has(a)).map(a=>e.jsx(A,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(d,{name:"foreldreType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[N],children:u.map(a=>e.jsx(A,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(o,{style:{textAlign:"end"},children:e.jsx(H,{type:"submit",disabled:!l.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};L.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const j=G(g),D=({fagsak:i,kodeverk:E,readOnly:r,lagrePapirsøknad:l,erEndringssøknad:s})=>{const[n,R]=K.useState(),u=I=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,I),Promise.resolve()),a=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(y,{value:j,children:e.jsxs(k,{gap:"space-16",padding:"4",children:[e.jsx(S,{size:"small",level:"2",children:s?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(O,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(L,{setSoknadData:R,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:E}),n&&n.getFagsakYtelseType()==="ES"&&e.jsx(U,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:n,alleKodeverk:E}),n&&n.getFagsakYtelseType()==="FP"&&e.jsx(M,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:n,alleKodeverk:E,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:s}),n&&n.getFagsakYtelseType()==="SVP"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:u,readOnly:r,soknadData:n,alleKodeverk:E})]})})};D.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:w}=__STORYBOOK_MODULE_ACTIONS__,X={component:D,decorators:[p,b(g)],args:{readOnly:!1,kodeverk:B,lagrePapirsøknad:i=>(w("lagrePapirsøknad")(i),Promise.resolve({}))}},m={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},T={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},_={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
...
}`,..._.parameters?.docs?.source}}};const Z=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{_ as EngangsstonadFørstegangssøknad,v as ForeldrepengerEndringssøknad,m as ForeldrepengerFørstegangssøknad,T as SvangerskapspengerFørstegangssøknad,Z as __namedExportsOrder,X as default};
