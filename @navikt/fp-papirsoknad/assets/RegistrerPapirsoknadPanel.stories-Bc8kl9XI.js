import{V as Y,c as x,H as W,F as a,b as Q,P as X,r as Z,m as U,w as $,a as ee}from"./nb_NO-BkLeEWzt.js";import{u as ne,S as re,K as T,N as ae,j as q,k as i,l as f,m as R,F as A,J as te,a as se,g as le}from"./BehovForTilretteleggingPanel-UQhj7kk5.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as M}from"./index-C4XKfyRp.js";import{E as ie}from"./EngangsstonadPapirsoknadIndex-DfameUqY.js";import{F as ue}from"./ForeldrepengerPapirsoknadIndex-B3ZOECKh.js";import{S as oe}from"./SvangerskapspengerPapirsoknadIndex-D5pPIY1v.js";import"./v4-CtRu48qb.js";import"./entry-preview-qyZtrjI6.js";import"./iframe-O99INJZn.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";const ge=[A.ADOPSJON,A.FODSEL],J=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:t})=>{const l=ne({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),b=l.watch("fagsakYtelseType"),n=M.useCallback(r=>s(new re(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[s]),E=t[T.FAGSAK_YTELSE],o=t[T.FAMILIE_HENDELSE_TYPE],g=t[T.FORELDRE_TYPE];return e.jsx(ae,{formMethods:l,onSubmit:n,children:e.jsx(q,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(Y,{gap:"4",padding:"5",children:[e.jsx(x,{size:"small",children:e.jsx(i,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(W,{gap:"20",children:[e.jsx(f,{label:e.jsx(i,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[R],radios:E.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),b!==a.SVANGERSKAPSPENGER&&e.jsx(f,{name:"familieHendelseType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Tema"}),validate:[R],radios:o.filter(({kode:r})=>ge.some(z=>z===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(f,{name:"foreldreType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Soker"}),validate:[R],radios:g.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(q,{style:{textAlign:"end"},children:e.jsx(Q,{type:"submit",disabled:l.formState.isSubmitting||l.formState.isSubmitted,children:e.jsx(i,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};J.__docgenInfo={description:`SoknadTypePickerForm
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const de=Z(U),C=({fagsak:s,kodeverk:u,readOnly:t,lagrePapirsøknad:l,erEndringssøknad:b})=>{const[n,E]=M.useState(),o=r=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,r),Promise.resolve()),g=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(X,{value:de,children:e.jsxs(Y,{gap:"4",padding:"4",children:[e.jsx(x,{size:"small",children:e.jsx(i,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(te,{children:e.jsx(i,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(J,{setSoknadData:E,fagsakYtelseType:s.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.ENGANGSSTONAD&&e.jsx(ie,{onSubmitUfullstendigsoknad:g,onSubmit:o,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.FORELDREPENGER&&e.jsx(ue,{onSubmitUfullstendigsoknad:g,onSubmit:o,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:s.bruker.fødselsnummer,erEndringssøknad:b}),n&&n.getFagsakYtelseType()===a.SVANGERSKAPSPENGER&&e.jsx(oe,{onSubmitUfullstendigsoknad:g,onSubmit:o,readOnly:t,soknadData:n,alleKodeverk:u})]})})};C.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ve={component:C,decorators:[$,le(U)],args:{readOnly:!1,kodeverk:se,lagrePapirsøknad:s=>(ee("lagrePapirsøknad")(s),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},k={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},p={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var N,h,S;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(S=(h=d.parameters)==null?void 0:h.docs)==null?void 0:S.source}}};var j,w,V;k.parameters={...k.parameters,docs:{...(j=k.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.FORELDREPENGER,
      bruker: {
...
}`,...(V=(w=k.parameters)==null?void 0:w.docs)==null?void 0:V.source}}};var K,B,c;m.parameters={...m.parameters,docs:{...(K=m.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(c=(B=m.parameters)==null?void 0:B.docs)==null?void 0:c.source}}};var _,G,I;y.parameters={...y.parameters,docs:{...(_=y.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.SVANGERSKAPSPENGER,
      bruker: {
...
}`,...(I=(G=y.parameters)==null?void 0:G.docs)==null?void 0:I.source}}};var F,P,D;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(D=(P=p.parameters)==null?void 0:P.docs)==null?void 0:D.source}}};var O,L,H;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.ENGANGSSTONAD,
      bruker: {
...
}`,...(H=(L=v.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};const Ke=["ForeldrepengerFørstegang","ForeldrepengerEndring","SvangerskapspengerFørstegang","SvangerskapspengerEndring","EngangsstonadFørstegang","EngangsstonadEndring"];export{v as EngangsstonadEndring,p as EngangsstonadFørstegang,k as ForeldrepengerEndring,d as ForeldrepengerFørstegang,y as SvangerskapspengerEndring,m as SvangerskapspengerFørstegang,Ke as __namedExportsOrder,Ve as default};
