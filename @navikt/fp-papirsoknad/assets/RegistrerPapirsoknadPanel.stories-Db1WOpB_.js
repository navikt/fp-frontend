import{F as a,P as z,r as W,w as Q,a as X}from"./withThemeDecorator-B4N3Iszh.js";import{u as Z,S as $,N as ee,j as q,k as i,l as A,m as E,F as R,J as ne,a as re,g as ae}from"./BehovForTilretteleggingPanel-BCdjrWKr.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as M}from"./index-C4XKfyRp.js";import{E as te}from"./EngangsstonadPapirsoknadIndex-DnbwUrmT.js";import{F as se}from"./ForeldrepengerPapirsoknadIndex-BE3OvjcS.js";import{V as H,b as Y,H as le,a as ie,m as L}from"./nb_NO-SbDZ4Vpp.js";import{S as ue}from"./SvangerskapspengerPapirsoknadIndex-pBDXRnYq.js";import"./v4-CtRu48qb.js";import"./entry-preview-CFQk_pzm.js";import"./iframe-2_KpNKeM.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";const ke=[R.ADOPSJON,R.FODSEL],x=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:t})=>{const l=Z({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),T=l.watch("fagsakYtelseType"),n=M.useCallback(r=>s(new $(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[s]),b=t.FagsakYtelseType,k=t.FamilieHendelseType,o=t.ForeldreType;return e.jsx(ee,{formMethods:l,onSubmit:n,children:e.jsx(q,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(H,{gap:"4",padding:"5",children:[e.jsx(Y,{size:"small",children:e.jsx(i,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(le,{gap:"20",children:[e.jsx(A,{label:e.jsx(i,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[E],radios:b.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),T!==a.SVANGERSKAPSPENGER&&e.jsx(A,{name:"familieHendelseType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Tema"}),validate:[E],radios:k.filter(({kode:r})=>ke.some(C=>C===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(A,{name:"foreldreType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Soker"}),validate:[E],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(q,{style:{textAlign:"end"},children:e.jsx(ie,{type:"submit",disabled:l.formState.isSubmitting||l.formState.isSubmitted,children:e.jsx(i,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};x.__docgenInfo={description:`SoknadTypePickerForm
