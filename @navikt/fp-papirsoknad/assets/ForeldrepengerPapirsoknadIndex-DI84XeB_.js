import{j as a}from"./iframe-CE5QgjSZ.js";import{u as s,L as u,h as m,P as N,f as v,C as P,H as F,e as R,A as T,O as _,c as A,T as S,D as I,i as L,F as D,V as K,I as O,d as G}from"./BehovForTilretteleggingPanel-D9s3MQiH.js";const y=()=>({...v.initialValues(),...N.initialValues(),...m.initialValues(),...u.initialValues()}),p=e=>({...v.transformValues(e),...N.transformValues(e),...m.tranformValues(e),...u.transformValues(e)}),V=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:E,onSubmitUfullstendigsoknad:t})=>{const i=s({defaultValues:y()});return a.jsxs(P,{formMethods:i,onSubmit:r=>E(p(r)),children:[a.jsxs(F,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(v,{readOnly:e}),a.jsx(m,{annenForelderInformertRequired:!0,readOnly:e})]}),a.jsx(N,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!0}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!0})]})};V.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerEndringssøknadValues) => Promise<void>",signature:{arguments:[{type:{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""}}};const H=()=>({...v.initialValues(),...G.initialValues(),...O.initialValues(),...K.initialValues(),...D.initialValues(),...L.initialValues(),...I.initialValues(),...S.initialValues(),...A.initialValues(),..._.initialValues(),...T.initialValues(),...N.initialValues(),...m.initialValues(),...R.initialValues(),...u.initialValues()}),J=e=>({...v.transformValues(e),...G.transformValues(e),...O.transformValues(e),...K.transformValues(e),...D.transformValues(e),...L.transformValues(e),...I.transformValues(e),...S.transformValues(e),...A.transformValues(e),..._.transformValues(e),...T.transformValues(e),...N.transformValues(e),...m.tranformValues(e),...R.transformValues(e),...u.transformValues(e)}),M=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:E,onSubmitUfullstendigsoknad:t,fagsakPersonnummer:i})=>{const r=s({defaultValues:H()}),k=r.watch("annenForelder.sokerHarAleneomsorg"),U=r.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),o=!k&&U!==!1,B=r.watch("foedselsDato"),d=r.watch("mottattDato");return a.jsxs(P,{formMethods:r,onSubmit:g=>E(J(g)),children:[a.jsxs(F,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(v,{readOnly:e}),a.jsx(G,{readOnly:e,erAdopsjon:l.getFamilieHendelseType()==="ADPSJN",alleKodeverk:n,mottattDato:d}),a.jsx(O,{readOnly:e,alleKodeverk:n}),a.jsx(K,{readOnly:e,alleKodeverk:n}),a.jsx(D,{readOnly:e}),a.jsx(L,{readOnly:e,alleKodeverk:n}),a.jsx(I,{readOnly:e}),l.getFamilieHendelseType()==="FODSL"&&a.jsx(S,{readOnly:e,erForeldrepenger:!0}),a.jsx(A,{readOnly:e,soknadData:l}),a.jsx(_,{readOnly:e,familieHendelseType:l.getFamilieHendelseType(),fodselsdato:B,isForeldrepengerFagsak:!0}),a.jsx(T,{readOnly:e,alleKodeverk:n,fagsakPersonnummer:i,sokerErMor:l.getForeldreType()==="MOR"}),a.jsx(N,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!1}),a.jsx(m,{annenForelderInformertRequired:o,readOnly:e}),a.jsx(R,{readOnly:e})]}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:r.formState.isSubmitting,erEndringssøknad:!1})]})};M.__docgenInfo={description:`ForeldrepengerForm
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerValues) => Promise<void>",signature:{arguments:[{type:{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""}}};const Y=({onSubmitUfullstendigsoknad:e,onSubmit:l,readOnly:n,soknadData:E,alleKodeverk:t,fagsakPersonnummer:i,erEndringssøknad:r})=>r?a.jsx(V,{onSubmitUfullstendigsoknad:e,onSubmit:l,readOnly:n,soknadData:E,alleKodeverk:t}):a.jsx(M,{onSubmitUfullstendigsoknad:e,onSubmit:l,readOnly:n,soknadData:E,alleKodeverk:t,fagsakPersonnummer:i});Y.__docgenInfo={description:"",methods:[],displayName:"ForeldrepengerPapirsoknadIndex",props:{onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerValues | ForeldrepengerEndringssøknadValues) => Promise<void>",signature:{arguments:[{type:{name:"union",raw:"ForeldrepengerValues | ForeldrepengerEndringssøknadValues",elements:[{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"}]},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
  LineærAvslagsårsak: LineærAvslagsårsakKodeverk[];
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};export{Y as F};
