import{j as n}from"./jsx-runtime-DR9Q75dM.js";import{u as R,$ as T,H as j,M as o,O as d,c as x,I as u,V as m,e as k,A as l,j as g,k as p,i as v,L as y}from"./BehovForTilretteleggingPanel-DtPA_kH7.js";import"./nb_NO-eEOSsEWf.js";const P=()=>({...o.initialValues(),...d.initialValues(),...u.initialValues(),...m.initialValues(),...k.initialValues(),...l.initialValues(),...g.initialValues(),...p.initialValues(),...v.initialValues(),...y.initialValues()}),V=e=>({...o.transformValues(e),...d.transformValues(e),...u.transformValues(e),...m.transformValues(e),...k.transformValues(e),...l.transformValues(e),...g.transformValues(e),...p.transformValues(e),...v.transformValues(e),...y.transformValues(e)}),c=({readOnly:e,soknadData:a,alleKodeverk:r,onSubmit:s,onSubmitUfullstendigsoknad:t})=>{const i=R({defaultValues:P()}),w=i.watch("mottattDato");return n.jsxs(T,{formMethods:i,onSubmit:q=>s(V(q)),children:[n.jsxs(j,{columns:{sm:1,md:2},gap:"4",children:[n.jsx(o,{readOnly:e}),n.jsx(d,{readOnly:e,alleKodeverk:r,erAdopsjon:a.getFamilieHendelseType()!==x.ADOPSJON,mottattDato:w}),n.jsx(u,{readOnly:e,alleKodeverk:r}),n.jsx(m,{readOnly:e,alleKodeverk:r}),n.jsx(k,{readOnly:e}),n.jsx(l,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:r}),n.jsx(g,{readOnly:e}),n.jsx(p,{readOnly:e}),n.jsx(v,{readOnly:e})]}),n.jsx(y,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting})]})};c.__docgenInfo={description:`SvangerskapspengerForm
