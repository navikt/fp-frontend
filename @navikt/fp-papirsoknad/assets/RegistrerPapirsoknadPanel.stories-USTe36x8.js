import{j as e,t as _,r as g,P as G,a as O,w as P}from"./iframe-Be1yU01i.js";import{u as F,C as V,B as d,M as t,S as A,R as S,a as y,W as p,b as B,g as M}from"./BehovForTilretteleggingPanel-AprDcFC3.js";import{E as U}from"./EngangsstonadPapirsoknadIndex-Blv8WTx7.js";import{F as b}from"./ForeldrepengerPapirsoknadIndex-FpzBRYJ6.js";import{V as L,H as o,a as H,B as q,m as I}from"./nb_NO-Cz5nDP3K.js";import{S as f}from"./SvangerskapspengerPapirsoknadIndex-CkEFNbR5.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DIoHCtGh.js";const h=new Set(["ADPSJN","FODSL"]),k=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:r})=>{const n=F({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),m=n.watch("fagsakYtelseType"),l=r.FagsakYtelseType,s=r.FamilieHendelseType,E=r.ForeldreType;return e.jsx(V,{formMethods:n,onSubmit:a=>{i(new y(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),n.reset(a)},children:e.jsx(d.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(L,{gap:"space-16",padding:"5",children:[e.jsx(o,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(H,{gap:"20",children:[e.jsx(A,{name:"fagsakYtelseType",control:n.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[_],children:l.map(a=>e.jsx(S,{value:a.kode,size:"small",disabled:!0,children:a.navn},a.kode))}),m!=="SVP"&&e.jsx(A,{name:"familieHendelseType",control:n.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[_],children:s.filter(({kode:a})=>h.has(a)).map(a=>e.jsx(S,{value:a.kode,size:"small",children:a.navn},a.kode))}),e.jsx(A,{name:"foreldreType",control:n.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[_],children:E.map(a=>e.jsx(S,{value:a.kode,size:"small",children:a.navn},a.kode))})]}),e.jsx(d,{style:{textAlign:"end"},children:e.jsx(q,{type:"submit",disabled:!n.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};k.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Y=O(I),D=({fagsak:i,kodeverk:u,readOnly:r,lagrePapirsøknad:n,erEndringssøknad:m})=>{const[l,s]=g.useState(),E=K=>(l&&n(l.fagsakYtelseType,l.familieHendelseType,l.foreldreType,K),Promise.resolve()),a=()=>(l&&n(l.fagsakYtelseType,l.familieHendelseType,l.foreldreType),Promise.resolve());return e.jsx(G,{value:Y,children:e.jsxs(L,{gap:"space-16",padding:"4",children:[e.jsx(o,{size:"small",level:"2",children:m?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(p,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(k,{setSoknadData:s,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),l&&l.getFagsakYtelseType()==="ES"&&e.jsx(U,{onSubmitUfullstendigsoknad:a,onSubmit:E,readOnly:r,soknadData:l,alleKodeverk:u}),l&&l.getFagsakYtelseType()==="FP"&&e.jsx(b,{onSubmitUfullstendigsoknad:a,onSubmit:E,readOnly:r,soknadData:l,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:m}),l&&l.getFagsakYtelseType()==="SVP"&&e.jsx(f,{onSubmitUfullstendigsoknad:a,onSubmit:E,readOnly:r,soknadData:l,alleKodeverk:u})]})})};D.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:w}=__STORYBOOK_MODULE_ACTIONS__,Q={component:D,decorators:[P,M(I)],args:{readOnly:!1,kodeverk:B,lagrePapirsøknad:i=>(w("lagrePapirsøknad")(i),Promise.resolve({}))}},v={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},T={args:{fagsak:{fagsakYtelseType:"FP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},R={args:{fagsak:{fagsakYtelseType:"SVP",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},N={args:{fagsak:{fagsakYtelseType:"ES",bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: 'FP',
      bruker: {
...
}`,...N.parameters?.docs?.source}}};const z=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{N as EngangsstonadFørstegangssøknad,T as ForeldrepengerEndringssøknad,v as ForeldrepengerFørstegangssøknad,R as SvangerskapspengerFørstegangssøknad,z as __namedExportsOrder,Q as default};
