import{c as S,u as te,S as se,K as R,$ as ie,l as u,m as j,n as A,F as k,v as le,g as oe,a as ge,b as w}from"./BehovForTilretteleggingPanel-h5kBbRwW.js";import{g as de,b as ue,o as ke,P as me,c as ye,S as pe,V as W,d as J,H as ve,a as be,t as fe,e as qe,m as Q,w as ce}from"./nb_NO-DPGl9Xar.js";import{j as r}from"./jsx-runtime-DR9Q75dM.js";import{r as y,R as P}from"./index-DRjF_FHU.js";import{E as Te}from"./EngangsstonadPapirsoknadIndex-DXX9611L.js";import{F as he}from"./ForeldrepengerPapirsoknadIndex-DE9z13fY.js";import{S as Re}from"./SvangerskapspengerPapirsoknadIndex-CL0TQK4y.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-DN4LN79F.js";import"./index-rX-Bn4lm.js";var je=function(e,l){var s={};for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&l.indexOf(t)<0&&(s[t]=e[t]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,t=Object.getOwnPropertySymbols(e);i<t.length;i++)l.indexOf(t[i])<0&&Object.prototype.propertyIsEnumerable.call(e,t[i])&&(s[t[i]]=e[t[i]]);return s};const N=y.forwardRef((e,l)=>{var{children:s,className:t,as:i="div",background:g,borderColor:n,borderWidth:d,borderRadius:o,shadow:a,style:m,asChild:ee}=e,E=je(e,["children","className","as","background","borderColor","borderWidth","borderRadius","shadow","style","asChild"]);const ne=Object.assign(Object.assign(Object.assign({},m),{"--__ac-box-background":g?`var(--a-${g})`:void 0,"--__ac-box-shadow":a?`var(--a-shadow-${a})`:void 0,"--__ac-box-border-color":n?`var(--a-${n})`:void 0,"--__ac-box-border-width":d?d.split(" ").map(ae=>`${ae}px`).join(" "):void 0}),de("box","border-radius","border-radius",o,!1,["0"])),re=ee?pe:i;return P.createElement(ue,Object.assign({},E),P.createElement(re,Object.assign({},ke(E,me),{ref:l,style:ne,className:ye("navds-box",t,{"navds-box-bg":g,"navds-box-border-color":n,"navds-box-border-width":d,"navds-box-border-radius":o,"navds-box-shadow":a})}),s))});var h=(e=>(e.BRUKERS_ANDEL="BRUKERS_ANDEL",e.FRILANS="FRILANS",e.EGEN_NÆRING="EGEN_NÆRING",e))(h||{});h.BRUKERS_ANDEL;h.FRILANS;h.EGEN_NÆRING;var T=(e=>(e.ENGANGSSTONAD="ES",e.FORELDREPENGER="FP",e.SVANGERSKAPSPENGER="SVP",e.PLEIEPENGER="PSB",e.OMSORGSPENGER="OMP",e.OMSORGSPENGER_MIDLERTIDIG_ALENE="OMP_MA",e.OMSORGSPENGER_KRONISK_SYKT_BARN="OMP_KS",e.OMSORGSPENGER_ALENE_OM_OMSORGEN="OMP_AO",e.FRISINN="FRISINN",e.PLEIEPENGER_SLUTTFASE="PPN",e))(T||{});const Ae=[S.ADOPSJON,S.FODSEL],X=({setSoknadData:e,fagsakYtelseType:l,alleKodeverk:s})=>{const t=te({defaultValues:{fagsakYtelseType:l,familieHendelseType:void 0,foreldreType:void 0}}),i=t.watch("fagsakYtelseType"),g=y.useCallback(a=>e(new se(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType)),[e]),n=s[R.FAGSAK_YTELSE],d=s[R.FAMILIE_HENDELSE_TYPE],o=s[R.FORELDRE_TYPE];return r.jsx(ie,{formMethods:t,onSubmit:g,children:r.jsx(N,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:r.jsxs(W,{gap:"4",padding:"5",children:[r.jsx(J,{size:"small",children:r.jsx(u,{id:"Registrering.Omsoknaden.Title"})}),r.jsxs(ve,{gap:"20",children:[r.jsx(j,{label:r.jsx(u,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[A],radios:n.map(a=>({label:a.navn,value:a.kode})),disabled:!0}),i!==k.SVANGERSKAPSPENGER&&r.jsx(j,{name:"familieHendelseType",label:r.jsx(u,{id:"Registrering.Omsoknaden.Tema"}),validate:[A],radios:d.filter(({kode:a})=>Ae.some(m=>m===a)).map(a=>({label:a.navn,value:a.kode}))}),r.jsx(j,{name:"foreldreType",label:r.jsx(u,{id:"Registrering.Omsoknaden.Soker"}),validate:[A],radios:o.map(a=>({label:a.navn,value:a.kode}))})]}),r.jsx(N,{style:{textAlign:"end"},children:r.jsx(be,{type:"submit",disabled:t.formState.isSubmitting||t.formState.isSubmitted,children:r.jsx(u,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};X.__docgenInfo={description:`SoknadTypePickerForm
...
Readonly<{
  ...
  foreldreType: string,
) => Promise<any>`,signature:{arguments:[{type:{name:"any"},name:"formValues"},{type:{name:"string"},name:"fagsakYtelseType"},{type:{name:"string"},name:"familieHendelseType"},{type:{name:"string"},name:"foreldreType"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ie={component:Z,decorators:[ce,oe(Q)],args:{readOnly:!1,kodeverk:ge,lagreFullstendig:e=>(w("lagreFullstendig")(e),Promise.resolve(e)),lagreUfullstendig:(...e)=>(w("lagreUfullstendig")(e),Promise.resolve())}},p={args:{fagsak:{fagsakYtelseType:k.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:k.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},b={args:{fagsak:{fagsakYtelseType:k.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},f={args:{fagsak:{fagsakYtelseType:k.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},q={args:{fagsak:{fagsakYtelseType:k.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},c={args:{fagsak:{fagsakYtelseType:k.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var O,F,B;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    fagsak: {
