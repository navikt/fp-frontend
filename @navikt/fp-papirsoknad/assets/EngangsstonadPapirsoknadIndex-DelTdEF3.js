import{j as a}from"./iframe-CljjPBeF.js";import{d as n,O as l,e as t,F as o,f as i,c as E,T as g,u as I,L as y,h as T,C as P,H as K}from"./BehovForTilretteleggingPanel-CfcrSlq5.js";const d=({readOnly:e,soknadData:r,alleKodeverk:s,fodselsdato:u,mottattDato:k})=>a.jsxs(a.Fragment,{children:[a.jsx(n,{readOnly:e,soknadData:r}),a.jsx(l,{readOnly:e,familieHendelseType:r.getFamilieHendelseType(),fodselsdato:u}),a.jsx(t,{readOnly:e,alleKodeverk:s,erAdopsjon:r.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:k}),a.jsx(i,{readOnly:e})]});d.initialValues=()=>({...n.initialValues(),...l.initialValues(),...t.initialValues(),...i.initialValues()});d.transformValues=e=>({...n.transformValues(e),...l.transformValues(e),...t.transformValues(e),...i.transformValues(e)});d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringAdopsjonOgOmsorgGrid.initialValues"}],raw:"ReturnType<typeof RegistreringAdopsjonOgOmsorgGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringAdopsjonOgOmsorgGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const p=({readOnly:e,soknadData:r,alleKodeverk:s,onSubmitUfullstendigsoknad:u,onSubmit:k})=>{const A=R(r.getFamilieHendelseType()),v=I({defaultValues:L()}),N=v.watch("foedselsDato"),S=v.watch("mottattDato");return a.jsxs(P,{formMethods:v,onSubmit:F=>k(q(r,F)),children:[a.jsxs(K,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(T,{readOnly:e}),a.jsx(A,{soknadData:r,readOnly:e,alleKodeverk:s,fodselsdato:N,mottattDato:S})]}),a.jsx(y,{readOnly:e,submitting:v.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},L=()=>({...T.initialValues(),...m.initialValues(),...d.initialValues(),...y.initialValues()}),q=(e,r)=>({...T.transformValues(r),...R(e.getFamilieHendelseType()).transformValues(r),...y.transformValues(r)}),R=e=>{if(e===o.FODSEL)return m;if(e===o.ADOPSJON)return d;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};p.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};export{D as E};
