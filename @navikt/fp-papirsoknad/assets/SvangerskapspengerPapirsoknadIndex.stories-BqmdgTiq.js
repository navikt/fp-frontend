...
Form-komponent for registrering av papirsøknad for svangerskapspenger.`,methods:[],displayName:"SvangerskapspengerForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const te={title:"papirsoknad/svangerskapspenger",component:f,decorators:[J,U(X)],args:{readOnly:!1,alleKodeverk:B,onSubmit:r=>(R("onSubmit")(r),Promise.resolve(r)),onSubmitUfullstendigsoknad:()=>(R("onSubmitUfullstendigsoknad")(),Promise.resolve())}},t={args:{soknadData:new v(y.SVANGERSKAPSPENGER,d.FODSEL,c.MOR)}},o={args:{soknadData:new v(y.SVANGERSKAPSPENGER,d.ADOPSJON,c.MOR)}},i={args:{soknadData:new v(y.SVANGERSKAPSPENGER,d.FODSEL,c.FAR)}};var F,w,A;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
