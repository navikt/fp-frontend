import{w as M,F as e}from"./iframe-D8yt8DoB.js";import{b as N,g as w,S as a,F as r,c as s}from"./BehovForTilretteleggingPanel-rH1RgfpO.js";import{F as G}from"./ForeldrepengerPapirsoknadIndex-BjeR86vs.js";import{m as f}from"./nb_NO-CXYtvIkY.js";import"./index-r_gHOPbW.js";const{action:E}=__STORYBOOK_MODULE_ACTIONS__,b={component:G,decorators:[M,w(f)],args:{readOnly:!1,alleKodeverk:N,onSubmit:P=>(E("onSubmit")(P),Promise.resolve()),onSubmitUfullstendigsoknad:()=>(E("onSubmitUfullstendigsoknad")(),Promise.resolve()),erEndringssøknad:!1,fagsakPersonnummer:"12345678910"}},o={args:{soknadData:new a(e.FORELDREPENGER,r.FODSEL,s.MOR)}},n={args:{soknadData:new a(e.FORELDREPENGER,r.ADOPSJON,s.MOR)}},d={args:{soknadData:new a(e.FORELDREPENGER,r.OMSORG,s.MOR)}},t={args:{soknadData:new a(e.FORELDREPENGER,r.FODSEL,s.FAR)}},F={args:{soknadData:new a(e.FORELDREPENGER,r.FODSEL,s.FAR),erEndringssøknad:!0}};var m,p,l;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
