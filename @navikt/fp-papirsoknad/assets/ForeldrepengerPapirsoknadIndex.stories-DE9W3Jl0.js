import{w as p,F as e}from"./iframe-C2mZREHM.js";import{b as l,g as R,S as a,F as r,c as s}from"./BehovForTilretteleggingPanel-s_boJfiR.js";import{F as c}from"./ForeldrepengerPapirsoknadIndex-CiW9-F3m.js";import{m as i}from"./nb_NO-DmJbUH1c.js";import"./index-CGdcVf24.js";const{action:E}=__STORYBOOK_MODULE_ACTIONS__,S={component:c,decorators:[p,R(i)],args:{readOnly:!1,alleKodeverk:l,onSubmit:m=>(E("onSubmit")(m),Promise.resolve()),onSubmitUfullstendigsoknad:()=>(E("onSubmitUfullstendigsoknad")(),Promise.resolve()),erEndringssøknad:!1,fagsakPersonnummer:"12345678910"}},o={args:{soknadData:new a(e.FORELDREPENGER,r.FODSEL,s.MOR)}},n={args:{soknadData:new a(e.FORELDREPENGER,r.ADOPSJON,s.MOR)}},d={args:{soknadData:new a(e.FORELDREPENGER,r.OMSORG,s.MOR)}},t={args:{soknadData:new a(e.FORELDREPENGER,r.FODSEL,s.FAR)}},F={args:{soknadData:new a(e.FORELDREPENGER,r.FODSEL,s.FAR),erEndringssøknad:!0}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
