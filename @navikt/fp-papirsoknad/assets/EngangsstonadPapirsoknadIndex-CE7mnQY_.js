import{j as r}from"./iframe-BDa-1pi0.js";import{d as a,O as t,e as s,F as y,f as i,c as T,T as m,u as j,L as v,h as p,C as w,H as O}from"./BehovForTilretteleggingPanel-DPmWZUUG.js";const d=({readOnly:e,soknadData:n,alleKodeverk:l,fodselsdato:u,mottattDato:k})=>r.jsxs(r.Fragment,{children:[r.jsx(a,{readOnly:e,soknadData:n}),r.jsx(t,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:u}),r.jsx(s,{readOnly:e,alleKodeverk:l,erAdopsjon:n.getFamilieHendelseType()!==y.ADOPSJON,mottattDato:k}),r.jsx(i,{readOnly:e})]});d.initialValues=()=>({...a.initialValues(),...t.initialValues(),...s.initialValues(),...i.initialValues()});d.transformValues=e=>({...a.transformValues(e),...t.transformValues(e),...s.transformValues(e),...i.transformValues(e)});d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringAdopsjonOgOmsorgGrid.initialValues"}],raw:"ReturnType<typeof RegistreringAdopsjonOgOmsorgGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringAdopsjonOgOmsorgGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const o=({readOnly:e,soknadData:n,alleKodeverk:l,fodselsdato:u,mottattDato:k})=>r.jsxs(r.Fragment,{children:[n.getForeldreType()!==T.MOR&&r.jsx(a,{readOnly:e,soknadData:n}),n.getForeldreType()!==T.MOR&&r.jsx(t,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:u}),r.jsx(s,{readOnly:e,erAdopsjon:n.getFamilieHendelseType()===y.ADOPSJON,alleKodeverk:l,mottattDato:k}),r.jsx(m,{readOnly:e,erForeldrepenger:!1}),r.jsx(i,{readOnly:e})]});o.initialValues=()=>({...a.initialValues(),...s.initialValues(),...t.initialValues(),...m.initialValues(),...i.initialValues()});o.transformValues=e=>({...a.transformValues(e),...s.transformValues(e),...t.transformValues(e),...m.transformValues(e),...i.transformValues(e)});o.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringFodselGrid.initialValues"}],raw:"ReturnType<typeof RegistreringFodselGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringFodselGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const A=({readOnly:e,soknadData:n,alleKodeverk:l,onSubmitUfullstendigsoknad:u,onSubmit:k})=>{const R=q(n.getFamilieHendelseType()),g=j({defaultValues:P()}),F=g.watch("foedselsDato"),K=g.watch("mottattDato");return r.jsxs(w,{formMethods:g,onSubmit:V=>k(B(n,V)),children:[r.jsxs(O,{columns:{sm:1,md:2},gap:"space-16",children:[r.jsx(p,{readOnly:e}),r.jsx(R,{soknadData:n,readOnly:e,alleKodeverk:l,fodselsdato:F,mottattDato:K})]}),r.jsx(v,{readOnly:e,submitting:g.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},P=()=>({...p.initialValues(),...o.initialValues(),...d.initialValues(),...v.initialValues()}),B=(e,n)=>({...p.transformValues(n),...q(e.getFamilieHendelseType()).transformValues(n),...v.transformValues(n)}),q=e=>{if(e===y.FODSEL)return o;if(e===y.ADOPSJON)return d;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};A.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
