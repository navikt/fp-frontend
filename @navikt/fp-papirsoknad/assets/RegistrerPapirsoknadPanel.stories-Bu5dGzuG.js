import{j as e,t as T,F as l,r as S,P as K,a as N,w as B}from"./iframe-DOO905g7.js";import{u as w,D as F,B as E,M as s,F as b,R as A,a as q,S as c,K as O,b as _,g as G}from"./BehovForTilretteleggingPanel-46cf00Nt.js";import{E as P}from"./EngangsstonadPapirsoknadIndex-CcQCdRuX.js";import{F as I}from"./ForeldrepengerPapirsoknadIndex-C-vIaA1I.js";import{V as R,H as h,a as D,B as M,m as j}from"./nb_NO-BXFtxTq4.js";import{S as U}from"./SvangerskapspengerPapirsoknadIndex-D6o4rVv4.js";import"./preload-helper-D9Z9MdNV.js";import"./index-DUiDdraD.js";const H=[q.ADOPSJON,q.FODSEL],f=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const a=w({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),o=a.watch("fagsakYtelseType"),r=t.FagsakYtelseType,p=t.FamilieHendelseType,k=t.ForeldreType;return e.jsx(F,{formMethods:a,onSubmit:n=>{i(new c(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType)),a.reset(n)},children:e.jsx(E.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(R,{gap:"space-16",padding:"5",children:[e.jsx(h,{size:"small",level:"3",children:e.jsx(s,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(D,{gap:"20",children:[e.jsx(b,{name:"fagsakYtelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],children:r.map(n=>e.jsx(A,{value:n.kode,size:"small",disabled:!0,children:n.navn},n.kode))}),o!==l.SVANGERSKAPSPENGER&&e.jsx(b,{name:"familieHendelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],children:p.filter(({kode:n})=>H.some(v=>v===n)).map(n=>e.jsx(A,{value:n.kode,size:"small",children:n.navn},n.kode))}),e.jsx(b,{name:"foreldreType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],children:k.map(n=>e.jsx(A,{value:n.kode,size:"small",children:n.navn},n.kode))})]}),e.jsx(E,{style:{textAlign:"end"},children:e.jsx(M,{type:"submit",disabled:!a.formState.isDirty,children:e.jsx(s,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};f.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const L=N(j),V=({fagsak:i,kodeverk:u,readOnly:t,lagrePapirsøknad:a,erEndringssøknad:o})=>{const[r,p]=S.useState(),k=v=>(r&&a(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType,v),Promise.resolve()),n=()=>(r&&a(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType),Promise.resolve());return e.jsx(K,{value:L,children:e.jsxs(R,{gap:"space-16",padding:"4",children:[e.jsx(h,{size:"small",level:"2",children:o?e.jsx(s,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(s,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(O,{children:e.jsx(s,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(f,{setSoknadData:p,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),r&&r.getFagsakYtelseType()===l.ENGANGSSTONAD&&e.jsx(P,{onSubmitUfullstendigsoknad:n,onSubmit:k,readOnly:t,soknadData:r,alleKodeverk:u}),r&&r.getFagsakYtelseType()===l.FORELDREPENGER&&e.jsx(I,{onSubmitUfullstendigsoknad:n,onSubmit:k,readOnly:t,soknadData:r,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:o}),r&&r.getFagsakYtelseType()===l.SVANGERSKAPSPENGER&&e.jsx(U,{onSubmitUfullstendigsoknad:n,onSubmit:k,readOnly:t,soknadData:r,alleKodeverk:u})]})})};V.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Y}=__STORYBOOK_MODULE_ACTIONS__,$={component:V,decorators:[B,G(j)],args:{readOnly:!1,kodeverk:_,lagrePapirsøknad:i=>(Y("lagrePapirsøknad")(i),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:l.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:l.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
