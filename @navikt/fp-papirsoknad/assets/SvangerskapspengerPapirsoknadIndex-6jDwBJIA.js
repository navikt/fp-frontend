import{j as r}from"./iframe-VdkpOt00.js";import{u as R,L as l,f as u,m as k,n as d,k as o,l as g,V as y,I as v,e as p,h as m,D as F,H as K,a as j}from"./BehovForTilretteleggingPanel-BvFJaoya.js";const V=()=>({...m.initialValues(),...p.initialValues(),...v.initialValues(),...y.initialValues(),...g.initialValues(),...o.initialValues(),...d.initialValues(),...k.initialValues(),...u.initialValues(),...l.initialValues()}),w=e=>({...m.transformValues(e),...p.transformValues(e),...v.transformValues(e),...y.transformValues(e),...g.transformValues(e),...o.transformValues(e),...d.transformValues(e),...k.transformValues(e),...u.transformValues(e),...l.transformValues(e)}),T=({readOnly:e,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=R({defaultValues:V()}),A=i.watch("mottattDato");return r.jsxs(F,{formMethods:i,onSubmit:q=>t(w(q)),children:[r.jsxs(K,{columns:{sm:1,md:2},gap:"space-16",children:[r.jsx(m,{readOnly:e}),r.jsx(p,{readOnly:e,alleKodeverk:a,erAdopsjon:n.getFamilieHendelseType()!==j.ADOPSJON,mottattDato:A}),r.jsx(v,{readOnly:e,alleKodeverk:a}),r.jsx(y,{readOnly:e,alleKodeverk:a}),r.jsx(g,{readOnly:e}),r.jsx(o,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:a}),r.jsx(d,{readOnly:e}),r.jsx(k,{readOnly:e}),r.jsx(u,{readOnly:e})]}),r.jsx(l,{readOnly:e,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting,erEndringssøknad:!1})]})};T.__docgenInfo={description:`SvangerskapspengerForm
