...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const S=({readOnly:e,soknadData:l,alleKodeverk:i,onSubmitUfullstendigsoknad:u,onSubmit:N})=>{const L=I(l.getFamilieHendelseType()),T=G({defaultValues:V()}),D=T.watch("foedselsDato"),K=T.watch("mottattDato");return a.jsxs(P,{formMethods:T,onSubmit:O=>N(s(l,O)),children:[a.jsxs(F,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(A,{readOnly:e}),a.jsx(L,{soknadData:l,readOnly:e,alleKodeverk:i,fodselsdato:D,mottattDato:K})]}),a.jsx(_,{readOnly:e,submitting:T.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},V=()=>({...A.initialValues(),...m.initialValues(),...R.initialValues(),..._.initialValues()}),s=(e,l)=>({...A.transformValues(l),...I(e.getFamilieHendelseType()).transformValues(l),..._.transformValues(l)}),I=e=>{if(e==="FODSL")return m;if(e==="ADPSJN")return R;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};S.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
