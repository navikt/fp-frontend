import{j as r}from"./jsx-runtime-QvZ8i92b.js";import{K as b,M as O,O as g,f as l,I,V as _,F as v,A as y,k as h,l as V,S as G,L as Y,g as L,h as t,i as c,z as S,d as P,j as R}from"./BehovForTilretteleggingPanel-CckZy7oH.js";import{u as U,Y as H,t as B,P as J,w as X}from"./index.es-B3xcrzIZ.js";import{r as z}from"./index-uubelm5h.js";import{m as C}from"./nb_NO-D8BNTxjC.js";import"./v4-CQkTLCs1.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-CfOt2XX2.js";import"./dayjs.min-jH2-tx3w.js";const p="frilans",Q=n=>({...y.buildInitialValues(n),...I.buildInitialValues(),...g.buildInitialValues(),...V.buildInitialValues(),[p]:v.buildInitialValues()}),W=n=>{let a=[];const{tilretteleggingArbeidsforhold:e}=n;return e!=null&&e.sokForArbeidsgiver&&(e!=null&&e.tilretteleggingForArbeidsgiver)&&(a=a.concat(e.tilretteleggingForArbeidsgiver.map(s=>({"@type":"VI",behovsdato:s.behovsdato,organisasjonsnummer:s.organisasjonsnummer,tilrettelegginger:s.tilretteleggingArbeidsgiver})))),e!=null&&e.sokForFrilans&&a.push({"@type":"FR",behovsdato:e.behovsdatoFrilans,tilrettelegginger:e.tilretteleggingFrilans}),e!=null&&e.sokForSelvstendigNaringsdrivende&&a.push({"@type":"SN",behovsdato:e.behovsdatoSN,tilrettelegginger:e.tilretteleggingSelvstendigNaringsdrivende}),a},Z=(n,a)=>({...g.transformValues(n),foedselsDato:n.foedselsDato,tilretteleggingArbeidsforhold:W(n),[p]:v.transformValues(n[p]),[L]:y.transformValues(n,a)}),q=({readOnly:n,soknadData:a,alleKodeverk:e,onSubmit:s,onSubmitUfullstendigsoknad:u})=>{const k=U({defaultValues:z.useMemo(()=>Q(e[b.ARBEID_TYPE]),[])}),D=e[b.ARBEID_TYPE],K=k.watch("mottattDato");return r.jsxs(H,{formMethods:k,onSubmit:M=>s(Z(M,D)),children:[r.jsx(O,{readOnly:n}),r.jsx(g,{readOnly:n,alleKodeverk:e,erAdopsjon:a.getFamilieHendelseType()!==l.ADOPSJON,mottattDato:K}),r.jsx(I,{readOnly:n,alleKodeverk:e}),r.jsx(_,{readOnly:n,alleKodeverk:e}),r.jsx(v,{readOnly:n}),r.jsx(y,{readOnly:n,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:e}),r.jsx(h,{readOnly:n}),r.jsx(V,{readOnly:n}),r.jsx(G,{readOnly:n}),r.jsx(Y,{readOnly:n,onSubmitUfullstendigsoknad:u,submitting:k.formState.isSubmitting})]})};q.__docgenInfo={description:`SvangerskapspengerForm
