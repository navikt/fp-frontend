...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const R=({readOnly:e,soknadData:l,alleKodeverk:i,fodselsdato:u,mottattDato:N})=>a.jsxs(a.Fragment,{children:[l.getForeldreType()!=="MOR"&&a.jsx(n,{readOnly:e,soknadData:l}),l.getForeldreType()!=="MOR"&&a.jsx(r,{readOnly:e,familieHendelseType:l.getFamilieHendelseType(),fodselsdato:u}),a.jsx(E,{readOnly:e,erAdopsjon:l.getFamilieHendelseType()==="ADPSJN",alleKodeverk:i,mottattDato:N}),a.jsx(T,{readOnly:e,erForeldrepenger:!1}),a.jsx(t,{readOnly:e})]});R.initialValues=()=>({...n.initialValues(),...E.initialValues(),...r.initialValues(),...T.initialValues(),...t.initialValues()});R.transformValues=e=>({...n.transformValues(e),...E.transformValues(e),...r.transformValues(e),...T.transformValues(e),...t.transformValues(e)});R.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringFodselGrid.initialValues"}],raw:"ReturnType<typeof RegistreringFodselGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringFodselGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
  LineærAvslagsårsak: LineærAvslagsårsakKodeverk[];
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const S=({readOnly:e,soknadData:l,alleKodeverk:i,onSubmitUfullstendigsoknad:u,onSubmit:N})=>{const L=I(l.getFamilieHendelseType()),v=G({defaultValues:F()}),D=v.watch("foedselsDato"),K=v.watch("mottattDato");return a.jsxs(P,{formMethods:v,onSubmit:O=>N(V(l,O)),children:[a.jsxs(s,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(A,{readOnly:e}),a.jsx(L,{soknadData:l,readOnly:e,alleKodeverk:i,fodselsdato:D,mottattDato:K})]}),a.jsx(_,{readOnly:e,submitting:v.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},F=()=>({...A.initialValues(),...R.initialValues(),...m.initialValues(),..._.initialValues()}),V=(e,l)=>({...A.transformValues(l),...I(e.getFamilieHendelseType()).transformValues(l),..._.transformValues(l)}),I=e=>{if(e==="FODSL")return R;if(e==="ADPSJN")return m;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};S.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
  LineærAvslagsårsak: LineærAvslagsårsakKodeverk[];
