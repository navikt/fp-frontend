import{j as a}from"./iframe-Be1yU01i.js";import{c as n,O as r,d as t,e as E,T,u as K,L as A,f as S,C as O,H as P}from"./BehovForTilretteleggingPanel-AprDcFC3.js";const v=({readOnly:e,soknadData:l,alleKodeverk:i,fodselsdato:u,mottattDato:m})=>a.jsxs(a.Fragment,{children:[a.jsx(n,{readOnly:e,soknadData:l}),a.jsx(r,{readOnly:e,familieHendelseType:l.getFamilieHendelseType(),fodselsdato:u}),a.jsx(t,{readOnly:e,alleKodeverk:i,erAdopsjon:l.getFamilieHendelseType()!=="ADPSJN",mottattDato:m}),a.jsx(E,{readOnly:e})]});v.initialValues=()=>({...n.initialValues(),...r.initialValues(),...t.initialValues(),...E.initialValues()});v.transformValues=e=>({...n.transformValues(e),...r.transformValues(e),...t.transformValues(e),...E.transformValues(e)});v.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:null},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"ReturnType",elements:[{name:"RegistreringAdopsjonOgOmsorgGrid.initialValues"}],raw:"ReturnType<typeof RegistreringAdopsjonOgOmsorgGrid.initialValues>",alias:"ReturnType"}}],returns:null}],displayName:"RegistreringAdopsjonOgOmsorgGrid",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fodselsdato:{required:!1,tsType:{name:"string"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const _=({readOnly:e,soknadData:l,alleKodeverk:i,onSubmitUfullstendigsoknad:u,onSubmit:m})=>{const I=L(l.getFamilieHendelseType()),N=K({defaultValues:k()}),s=N.watch("foedselsDato"),D=N.watch("mottattDato");return a.jsxs(O,{formMethods:N,onSubmit:G=>m(o(l,G)),children:[a.jsxs(P,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(S,{readOnly:e}),a.jsx(I,{soknadData:l,readOnly:e,alleKodeverk:i,fodselsdato:s,mottattDato:D})]}),a.jsx(A,{readOnly:e,submitting:N.formState.isSubmitting,onSubmitUfullstendigsoknad:u,erEndringssøknad:!1})]})},k=()=>({...S.initialValues(),...R.initialValues(),...v.initialValues(),...A.initialValues()}),o=(e,l)=>({...S.transformValues(l),...L(e.getFamilieHendelseType()).transformValues(l),...A.transformValues(l)}),L=e=>{if(e==="FODSL")return R;if(e==="ADPSJN")return v;throw new Error(`Unsupported FamilieHendelseType i papirsoknad for engangsstønad: ${e}`)};_.__docgenInfo={description:"",methods:[],displayName:"EngangsstonadForm",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
  Avslagsårsak: AvslagsårsakKodeverk;
  GraderingAvslagÅrsak: GraderingAvslagÅrsakKodeverk[];
  PeriodeResultatÅrsak: PeriodeResultatÅrsakKodeverk[];
}`,elements:[{name:"signature",type:"object",raw:`{
