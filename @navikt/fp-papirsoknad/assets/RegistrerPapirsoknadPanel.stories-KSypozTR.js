import{j as e,t as _,r as F,P as I,a as D,w as P}from"./iframe-CF-6rkyw.js";import{u as V,D as b,B as N,M as t,F as T,R,a as A,S as G,W as O,b as B,g as h}from"./BehovForTilretteleggingPanel-c0I8DcHt.js";import{E as q}from"./EngangsstonadPapirsoknadIndex-zJB__LCV.js";import{F as w}from"./ForeldrepengerPapirsoknadIndex-Cb1kS8-M.js";import{V as y,H as p,a as U,B as j,m as S}from"./nb_NO-Ei8CeYJM.js";import{S as f}from"./SvangerskapspengerPapirsoknadIndex-DsRZydTD.js";import"./preload-helper-D9Z9MdNV.js";import"./index-Dv_9XDSC.js";const M=[A.ADOPSJON,A.FODSEL],K=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:r})=>{const l=V({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),m=l.watch("fagsakYtelseType"),a=r.FagsakYtelseType,g=r.FamilieHendelseType,s=r.ForeldreType;return e.jsx(b,{formMethods:l,onSubmit:n=>{i(new G(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType)),l.reset(n)},children:e.jsx(N.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(y,{gap:"space-16",padding:"5",children:[e.jsx(p,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(U,{gap:"20",children:[e.jsx(T,{name:"fagsakYtelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[_],children:a.map(n=>e.jsx(R,{value:n.kode,size:"small",disabled:!0,children:n.navn},n.kode))}),m!=="SVP"&&e.jsx(T,{name:"familieHendelseType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Tema"}),validate:[_],children:g.filter(({kode:n})=>M.some(k=>k===n)).map(n=>e.jsx(R,{value:n.kode,size:"small",children:n.navn},n.kode))}),e.jsx(T,{name:"foreldreType",control:l.control,label:e.jsx(t,{id:"Registrering.Omsoknaden.Soker"}),validate:[_],children:s.map(n=>e.jsx(R,{value:n.kode,size:"small",children:n.navn},n.kode))})]}),e.jsx(N,{style:{textAlign:"end"},children:e.jsx(j,{type:"submit",disabled:!l.formState.isDirty,children:e.jsx(t,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};K.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const H=D(S),L=({fagsak:i,kodeverk:u,readOnly:r,lagrePapirsøknad:l,erEndringssøknad:m})=>{const[a,g]=F.useState(),s=k=>(a&&l(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType,k),Promise.resolve()),n=()=>(a&&l(a.fagsakYtelseType,a.familieHendelseType,a.foreldreType),Promise.resolve());return e.jsx(I,{value:H,children:e.jsxs(y,{gap:"space-16",padding:"4",children:[e.jsx(p,{size:"small",level:"2",children:m?e.jsx(t,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(t,{id:"Registrering.RegistrereSoknad"})}),!r&&e.jsx(O,{children:e.jsx(t,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(K,{setSoknadData:g,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),a&&a.getFagsakYtelseType()==="ES"&&e.jsx(q,{onSubmitUfullstendigsoknad:n,onSubmit:s,readOnly:r,soknadData:a,alleKodeverk:u}),a&&a.getFagsakYtelseType()==="FP"&&e.jsx(w,{onSubmitUfullstendigsoknad:n,onSubmit:s,readOnly:r,soknadData:a,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:m}),a&&a.getFagsakYtelseType()==="SVP"&&e.jsx(f,{onSubmitUfullstendigsoknad:n,onSubmit:s,readOnly:r,soknadData:a,alleKodeverk:u})]})})};L.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  saksnummer: string;
...
}`,...d.parameters?.docs?.source}}};const $=["ForeldrepengerFørstegangssøknad","ForeldrepengerEndringssøknad","SvangerskapspengerFørstegangssøknad","EngangsstonadFørstegangssøknad"];export{d as EngangsstonadFørstegangssøknad,v as ForeldrepengerEndringssøknad,E as ForeldrepengerFørstegangssøknad,o as SvangerskapspengerFørstegangssøknad,$ as __namedExportsOrder,Z as default};
