import{j as a}from"./iframe-D4pnO6wK.js";import{u as P,L as u,h as N,i as R,f as m,P as F,H as V,e as T,A as v,O as _,c as A,T as S,D as I,j as L,F as D,V as O,I as K,d as G}from"./BehovForTilretteleggingPanel-7VM93mx4.js";const p=()=>({...m.initialValues(),...R.initialValues(),...N.initialValues(),...u.initialValues()}),g=e=>({...m.transformValues(e),...R.transformValues(e),...N.tranformValues(e),...u.transformValues(e)}),s=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:r,onSubmitUfullstendigsoknad:t})=>{const i=P({defaultValues:p()});return a.jsxs(F,{formMethods:i,onSubmit:E=>r(g(E)),children:[a.jsxs(V,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(m,{readOnly:e}),a.jsx(N,{annenForelderInformertRequired:!0,readOnly:e})]}),a.jsx(R,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!0}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!0})]})};s.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerEndringssøknadValues) => Promise<void>",signature:{arguments:[{type:{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""}}};const H=()=>({...m.initialValues(),...G.initialValues(),...K.initialValues(),...O.initialValues(),...D.initialValues(),...L.initialValues(),...I.initialValues(),...S.initialValues(),...A.initialValues(),..._.initialValues(),...v.initialValues(),...R.initialValues(),...N.initialValues(),...T.initialValues(),...u.initialValues()}),J=e=>({...m.transformValues(e),...G.transformValues(e),...K.transformValues(e),...O.transformValues(e),...D.transformValues(e),...L.transformValues(e),...I.transformValues(e),...S.transformValues(e),...A.transformValues(e),..._.transformValues(e),...v.transformValues(e),...R.transformValues(e),...N.tranformValues(e),...T.transformValues(e),...u.transformValues(e)}),M=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:r,onSubmitUfullstendigsoknad:t,fagsakPersonnummer:i})=>{const E=P({defaultValues:H()}),U=E.watch("annenForelder.sokerHarAleneomsorg"),B=E.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),o=!U&&B!==!1,k=E.watch("foedselsDato"),d=E.watch("mottattDato");return a.jsxs(F,{formMethods:E,onSubmit:y=>r(J(y)),children:[a.jsxs(V,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(m,{readOnly:e}),a.jsx(G,{readOnly:e,erAdopsjon:l.getFamilieHendelseType()==="ADPSJN",alleKodeverk:n,mottattDato:d}),a.jsx(K,{readOnly:e,alleKodeverk:n}),a.jsx(O,{readOnly:e,alleKodeverk:n}),a.jsx(D,{readOnly:e}),a.jsx(L,{readOnly:e,alleKodeverk:n}),a.jsx(I,{readOnly:e}),l.getFamilieHendelseType()==="FODSL"&&a.jsx(S,{readOnly:e,erForeldrepenger:!0}),a.jsx(A,{readOnly:e,soknadData:l}),a.jsx(_,{readOnly:e,familieHendelseType:l.getFamilieHendelseType(),fodselsdato:k,isForeldrepengerFagsak:!0}),a.jsx(v,{readOnly:e,alleKodeverk:n,fagsakPersonnummer:i,sokerErMor:l.getForeldreType()==="MOR"}),a.jsx(R,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!1}),a.jsx(N,{annenForelderInformertRequired:o,readOnly:e}),a.jsx(T,{readOnly:e})]}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:E.formState.isSubmitting,erEndringssøknad:!1})]})};M.__docgenInfo={description:`ForeldrepengerForm
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};export{Y as F};
