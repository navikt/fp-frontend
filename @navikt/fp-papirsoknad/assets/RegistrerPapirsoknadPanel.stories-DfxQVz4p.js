import{j as e,F as a,r as J,P as C,a as z,w as W}from"./iframe-OQTkaiOT.js";import{u as Q,N as X,B as q,M as l,a as A,e as E,F as R,S as Z,W as $,b as ee,g as ne}from"./BehovForTilretteleggingPanel-DINwe5f5.js";import{E as re}from"./EngangsstonadPapirsoknadIndex-DO9ZqBEG.js";import{F as ae}from"./ForeldrepengerPapirsoknadIndex-CupXHkk3.js";import{V as U,H,a as te,B as se,m as Y}from"./nb_NO-Dit08w5o.js";import{S as le}from"./SvangerskapspengerPapirsoknadIndex-CvKbfgLc.js";import"./index-C8B3P6eZ.js";const ie=[R.ADOPSJON,R.FODSEL],L=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const s=Q({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),v=s.watch("fagsakYtelseType"),n=t.FagsakYtelseType,T=t.FamilieHendelseType,k=t.ForeldreType;return e.jsx(X,{formMethods:s,onSubmit:r=>i(new Z(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),children:e.jsx(q,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(U,{gap:"4",padding:"5",children:[e.jsx(H,{size:"small",children:e.jsx(l,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(te,{gap:"20",children:[e.jsx(A,{label:e.jsx(l,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[E],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),v!==a.SVANGERSKAPSPENGER&&e.jsx(A,{name:"familieHendelseType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Tema"}),validate:[E],radios:T.filter(({kode:r})=>ie.some(b=>b===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(A,{name:"foreldreType",label:e.jsx(l,{id:"Registrering.Omsoknaden.Soker"}),validate:[E],radios:k.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(q,{style:{textAlign:"end"},children:e.jsx(se,{type:"submit",disabled:s.formState.isSubmitting||s.formState.isSubmitted,children:e.jsx(l,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};L.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ue=z(Y),x=({fagsak:i,kodeverk:u,readOnly:t,lagrePapirsøknad:s,erEndringssøknad:v})=>{const[n,T]=J.useState(),k=b=>(n&&s(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,b),Promise.resolve()),r=()=>(n&&s(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(C,{value:ue,children:e.jsxs(U,{gap:"4",padding:"4",children:[e.jsx(H,{size:"small",children:e.jsx(l,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx($,{children:e.jsx(l,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(L,{setSoknadData:T,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.ENGANGSSTONAD&&e.jsx(re,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.FORELDREPENGER&&e.jsx(ae,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:v}),n&&n.getFagsakYtelseType()===a.SVANGERSKAPSPENGER&&e.jsx(le,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})};x.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:ke}=__STORYBOOK_MODULE_ACTIONS__,Te={component:x,decorators:[W,ne(Y)],args:{readOnly:!1,kodeverk:ee,lagrePapirsøknad:i=>(ke("lagrePapirsøknad")(i),Promise.resolve({}))}},o={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},d={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},g={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},m={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},y={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},p={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var h,j,f;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(f=(j=o.parameters)==null?void 0:j.docs)==null?void 0:f.source}}};var S,V,K;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.FORELDREPENGER,
      bruker: {
...
}`,...(K=(V=d.parameters)==null?void 0:V.docs)==null?void 0:K.source}}};var N,B,w;g.parameters={...g.parameters,docs:{...(N=g.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(w=(B=g.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};var F,G,c;m.parameters={...m.parameters,docs:{...(F=m.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.SVANGERSKAPSPENGER,
      bruker: {
...
}`,...(c=(G=m.parameters)==null?void 0:G.docs)==null?void 0:c.source}}};var P,O,_;y.parameters={...y.parameters,docs:{...(P=y.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(_=(O=y.parameters)==null?void 0:O.docs)==null?void 0:_.source}}};var I,D,M;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.ENGANGSSTONAD,
      bruker: {
...
}`,...(M=(D=p.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};const be=["ForeldrepengerFørstegang","ForeldrepengerEndring","SvangerskapspengerFørstegang","SvangerskapspengerEndring","EngangsstonadFørstegang","EngangsstonadEndring"];export{p as EngangsstonadEndring,y as EngangsstonadFørstegang,d as ForeldrepengerEndring,o as ForeldrepengerFørstegang,m as SvangerskapspengerEndring,g as SvangerskapspengerFørstegang,be as __namedExportsOrder,Te as default};
