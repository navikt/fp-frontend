import{j as e,t as T,F as l,r as V,P as S,a as K,w as B}from"./iframe-BSV3Lgl_.js";import{u as N,N as w,B as A,M as s,a as b,F as E,S as F,K as G,b as c,g as O}from"./BehovForTilretteleggingPanel-Bm516C1H.js";import{E as P}from"./EngangsstonadPapirsoknadIndex-DMXXPyvm.js";import{F as _}from"./ForeldrepengerPapirsoknadIndex-BsDSqQfV.js";import{V as q,H as R,a as I,B as D,m as h}from"./nb_NO-Bx1KWIqO.js";import{S as M}from"./SvangerskapspengerPapirsoknadIndex-uGCu0Zio.js";import"./index-BMsi0Xfa.js";const U=[E.ADOPSJON,E.FODSEL],j=({setSoknadData:i,fagsakYtelseType:u,alleKodeverk:t})=>{const a=N({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),o=a.watch("fagsakYtelseType"),n=t.FagsakYtelseType,p=t.FamilieHendelseType,k=t.ForeldreType;return e.jsx(w,{formMethods:a,onSubmit:r=>{i(new F(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),a.reset(r)},children:e.jsx(A,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(q,{gap:"4",padding:"5",children:[e.jsx(R,{size:"small",children:e.jsx(s,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(I,{gap:"20",children:[e.jsx(b,{name:"fagsakYtelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[T],radios:n.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),o!==l.SVANGERSKAPSPENGER&&e.jsx(b,{name:"familieHendelseType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Tema"}),validate:[T],radios:p.filter(({kode:r})=>U.some(v=>v===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(b,{name:"foreldreType",control:a.control,label:e.jsx(s,{id:"Registrering.Omsoknaden.Soker"}),validate:[T],radios:k.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(A,{style:{textAlign:"end"},children:e.jsx(D,{type:"submit",disabled:!a.formState.isDirty,children:e.jsx(s,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};j.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const H=K(h),f=({fagsak:i,kodeverk:u,readOnly:t,lagrePapirsøknad:a,erEndringssøknad:o})=>{const[n,p]=V.useState(),k=v=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,v),Promise.resolve()),r=()=>(n&&a(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(S,{value:H,children:e.jsxs(q,{gap:"4",padding:"4",children:[e.jsx(R,{size:"small",children:o?e.jsx(s,{id:"Registrering.RegistrereEndringssoknad"}):e.jsx(s,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(G,{children:e.jsx(s,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(j,{setSoknadData:p,fagsakYtelseType:i.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.ENGANGSSTONAD&&e.jsx(P,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===l.FORELDREPENGER&&e.jsx(_,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:i.bruker.fødselsnummer,erEndringssøknad:o}),n&&n.getFagsakYtelseType()===l.SVANGERSKAPSPENGER&&e.jsx(M,{onSubmitUfullstendigsoknad:r,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})};f.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:L}=__STORYBOOK_MODULE_ACTIONS__,X={component:f,decorators:[B,O(h)],args:{readOnly:!1,kodeverk:c,lagrePapirsøknad:i=>(L("lagrePapirsøknad")(i),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:l.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:l.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:l.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    fagsak: {
