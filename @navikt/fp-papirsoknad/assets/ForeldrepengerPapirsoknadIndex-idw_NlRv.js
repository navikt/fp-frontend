import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{u as b,L as k,c as d,B as o,P as g,A as y,O as p,R as m,T as v,D as T,d as A,e as q,V as F,I as R,f as j,M as P,N as U,H as f,F as V,b as B}from"./BehovForTilretteleggingPanel-KooltQzB.js";import"./withThemeDecorator-DH7q3_o3.js";const H=()=>({...P.initialValues(),...j.initialValues(),...R.initialValues(),...F.initialValues(),...q.initialValues(),...A.initialValues(),...T.initialValues(),...v.initialValues(),...m.initialValues(),...p.initialValues(),...y.initialValues(),...g.initialValues(),...o.initialValues(),...d.initialValues(),...k.initialValues()}),x=e=>({...P.transformValues(e),...j.transformValues(e),...R.transformValues(e),...F.transformValues(e),...q.transformValues(e),...A.transformValues(e),...T.transformValues(e),...v.transformValues(e),...m.transformValues(e),...p.transformValues(e),...y.transformValues(e),...g.transformValues(e),...o.tranformValues(e),...d.transformValues(e),...k.transformValues(e)}),w=({readOnly:e,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:i,fagsakPersonnummer:l,erEndringssøknad:u})=>{const s=b({defaultValues:H()}),K=s.watch("annenForelder.sokerHarAleneomsorg"),h=s.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),M=!K&&h!==!1,O=s.watch("foedselsDato"),c=s.watch("mottattDato");return r.jsxs(U,{formMethods:s,onSubmit:S=>t(x(S)),children:[r.jsxs(f,{columns:{sm:1,md:2},gap:"4",children:[r.jsx(P,{readOnly:e}),r.jsx(j,{readOnly:e,erAdopsjon:n.getFamilieHendelseType()===V.ADOPSJON,alleKodeverk:a,mottattDato:c}),r.jsx(R,{readOnly:e,alleKodeverk:a}),r.jsx(F,{readOnly:e,alleKodeverk:a}),r.jsx(q,{readOnly:e}),r.jsx(A,{readOnly:e,alleKodeverk:a}),r.jsx(T,{readOnly:e}),n.getFamilieHendelseType()===V.FODSEL&&r.jsx(v,{readOnly:e,erForeldrepenger:!0}),r.jsx(m,{readOnly:e,soknadData:n}),r.jsx(p,{readOnly:e,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:O,isForeldrepengerFagsak:!0}),r.jsx(y,{readOnly:e,alleKodeverk:a,fagsakPersonnummer:l,sokerErMor:n.getForeldreType()===B.MOR}),r.jsx(g,{foreldreType:n.getForeldreType(),readOnly:e,alleKodeverk:a,erEndringssøknad:u}),r.jsx(o,{annenForelderInformertRequired:M,readOnly:e}),r.jsx(d,{readOnly:e})]}),r.jsx(k,{readOnly:e,onSubmitUfullstendigsoknad:i,submitting:s.formState.isSubmitting})]})};w.__docgenInfo={description:`ForeldrepengerForm
