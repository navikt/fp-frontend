import{r as U,j as e,F as a,P as z,a as W,w as Q}from"./iframe-CWsUMSCO.js";import{u as X,S as Z,N as $,B as q,M as i,a as A,e as E,F as R,W as ee,b as ne,g as re}from"./BehovForTilretteleggingPanel-CrnKGDKS.js";import{E as ae}from"./EngangsstonadPapirsoknadIndex-3qrtf6Lt.js";import{F as te}from"./ForeldrepengerPapirsoknadIndex-zwGqogiz.js";import{V as H,H as Y,a as se,B as le,m as L}from"./nb_NO-D08Dpjck.js";import{S as ie}from"./SvangerskapspengerPapirsoknadIndex-BEU0jdlg.js";import"./index-DNKsE2Hn.js";const ue=[R.ADOPSJON,R.FODSEL],x=({setSoknadData:s,fagsakYtelseType:u,alleKodeverk:t})=>{const l=X({defaultValues:{fagsakYtelseType:u,familieHendelseType:void 0,foreldreType:void 0}}),T=l.watch("fagsakYtelseType"),n=U.useCallback(r=>s(new Z(r.fagsakYtelseType,r.familieHendelseType,r.foreldreType)),[s]),b=t.FagsakYtelseType,k=t.FamilieHendelseType,o=t.ForeldreType;return e.jsx($,{formMethods:l,onSubmit:n,children:e.jsx(q,{background:"bg-subtle",borderColor:"border-default",borderWidth:"1",children:e.jsxs(H,{gap:"4",padding:"5",children:[e.jsx(Y,{size:"small",children:e.jsx(i,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(se,{gap:"20",children:[e.jsx(A,{label:e.jsx(i,{id:"Registrering.Omsoknaden.soknadstype"}),name:"fagsakYtelseType",validate:[E],radios:b.map(r=>({label:r.navn,value:r.kode})),disabled:!0}),T!==a.SVANGERSKAPSPENGER&&e.jsx(A,{name:"familieHendelseType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Tema"}),validate:[E],radios:k.filter(({kode:r})=>ue.some(C=>C===r)).map(r=>({label:r.navn,value:r.kode}))}),e.jsx(A,{name:"foreldreType",label:e.jsx(i,{id:"Registrering.Omsoknaden.Soker"}),validate:[E],radios:o.map(r=>({label:r.navn,value:r.kode}))})]}),e.jsx(q,{style:{textAlign:"end"},children:e.jsx(le,{type:"submit",disabled:l.formState.isSubmitting||l.formState.isSubmitted,children:e.jsx(i,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};x.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ke=W(L),J=({fagsak:s,kodeverk:u,readOnly:t,lagrePapirsøknad:l,erEndringssøknad:T})=>{const[n,b]=U.useState(),k=r=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType,r),Promise.resolve()),o=()=>(n&&l(n.fagsakYtelseType,n.familieHendelseType,n.foreldreType),Promise.resolve());return e.jsx(z,{value:ke,children:e.jsxs(H,{gap:"4",padding:"4",children:[e.jsx(Y,{size:"small",children:e.jsx(i,{id:"Registrering.RegistrereSoknad"})}),!t&&e.jsx(ee,{children:e.jsx(i,{id:"Registrering.RegistrerAlleOpplysninger"})}),e.jsx(x,{setSoknadData:b,fagsakYtelseType:s.fagsakYtelseType,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.ENGANGSSTONAD&&e.jsx(ae,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u}),n&&n.getFagsakYtelseType()===a.FORELDREPENGER&&e.jsx(te,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u,fagsakPersonnummer:s.bruker.fødselsnummer,erEndringssøknad:T}),n&&n.getFagsakYtelseType()===a.SVANGERSKAPSPENGER&&e.jsx(ie,{onSubmitUfullstendigsoknad:o,onSubmit:k,readOnly:t,soknadData:n,alleKodeverk:u})]})})};J.__docgenInfo={description:"",methods:[],displayName:"RegistrerPapirsoknadPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]}],raw:"Promise<Behandling>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:oe}=__STORYBOOK_MODULE_ACTIONS__,be={component:J,decorators:[Q,re(L)],args:{readOnly:!1,kodeverk:ne,lagrePapirsøknad:s=>(oe("lagrePapirsøknad")(s),Promise.resolve({}))}},d={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},g={args:{fagsak:{fagsakYtelseType:a.FORELDREPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},m={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},y={args:{fagsak:{fagsakYtelseType:a.SVANGERSKAPSPENGER,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}},p={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!1}},v={args:{fagsak:{fagsakYtelseType:a.ENGANGSSTONAD,bruker:{fødselsnummer:"00000000000"}},erEndringssøknad:!0}};var h,j,f;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    fagsak: {
...
}`,...(_=(O=p.parameters)==null?void 0:O.docs)==null?void 0:_.source}}};var I,D,M;v.parameters={...v.parameters,docs:{...(I=v.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    fagsak: {
      fagsakYtelseType: FagsakYtelseType.ENGANGSSTONAD,
      bruker: {
