import{j as a}from"./iframe-Be1yU01i.js";import{u as D,L as i,e as u,j as m,k as v,i as R,F as N,V as T,I as A,d as S,f as _,C as G,H as K}from"./BehovForTilretteleggingPanel-AprDcFC3.js";const O=()=>({..._.initialValues(),...S.initialValues(),...A.initialValues(),...T.initialValues(),...N.initialValues(),...R.initialValues(),...v.initialValues(),...m.initialValues(),...u.initialValues(),...i.initialValues()}),P=e=>({..._.transformValues(e),...S.transformValues(e),...A.transformValues(e),...T.transformValues(e),...N.transformValues(e),...R.transformValues(e),...v.transformValues(e),...m.transformValues(e),...u.transformValues(e),...i.transformValues(e)}),L=({readOnly:e,soknadData:n,alleKodeverk:l,onSubmit:r,onSubmitUfullstendigsoknad:t})=>{const E=D({defaultValues:O()}),I=E.watch("mottattDato");return a.jsxs(G,{formMethods:E,onSubmit:s=>r(P(s)),children:[a.jsxs(K,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(_,{readOnly:e}),a.jsx(S,{readOnly:e,alleKodeverk:l,erAdopsjon:n.getFamilieHendelseType()!=="ADPSJN",mottattDato:I}),a.jsx(A,{readOnly:e,alleKodeverk:l}),a.jsx(T,{readOnly:e,alleKodeverk:l}),a.jsx(N,{readOnly:e}),a.jsx(R,{readOnly:e,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:l}),a.jsx(v,{readOnly:e}),a.jsx(m,{readOnly:e}),a.jsx(u,{readOnly:e})]}),a.jsx(i,{readOnly:e,onSubmitUfullstendigsoknad:t,submitting:E.formState.isSubmitting,erEndringssøknad:!1})]})};L.__docgenInfo={description:`SvangerskapspengerForm
