import{R as n}from"./index-BBkUAzwr.js";import{R as K,O as d,f as o,S as G,b as y,d as k,a as X,M as J,L as $,r as Y,h as i,i as b,z as E,j as S}from"./BehovForTilretteleggingPanel-BeEJ1_Hp.js";import{H as x,u as z,D as B,b as C,w as Q}from"./index.es-DDeP7LpD.js";import"./v4-CQkTLCs1.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./index-BfZ0jBbx.js";import"./dayjs.min-CcgqzSAt.js";const W="_col_hlukm_1",N={col:W},F="omsorg",l=({readOnly:e,soknadData:r,alleKodeverk:s,fodselsdato:a,mottattDato:t})=>n.createElement(x,{justify:"space-between"},n.createElement("div",{className:N.col},n.createElement(K,{readOnly:e,soknadData:r}),n.createElement(d,{readOnly:e,alleKodeverk:s,erAdopsjon:r.getFamilieHendelseType()!==o.ADOPSJON,mottattDato:t}),n.createElement(G,{readOnly:e})),n.createElement("div",{className:N.col},n.createElement(y,{readOnly:e,familieHendelseType:r.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:a})));l.transformValues=e=>({...d.transformValues(e),[F]:y.transformValues(e[F])});l.buildInitialValues=()=>({[F]:{},...d.buildInitialValues()});l.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const le={title:"papirsoknad/papirsoknad-es",component:v,decorators:[Q]},u=()=>n.createElement(v,{onSubmitUfullstendigsoknad:i("button-click"),onSubmit:i("button-click"),readOnly:!1,soknadData:new b(E.ENGANGSSTONAD,o.FODSEL,k.MOR),alleKodeverk:S}),g=()=>n.createElement(v,{onSubmitUfullstendigsoknad:i("button-click"),onSubmit:i("button-click"),readOnly:!1,soknadData:new b(E.ENGANGSSTONAD,o.ADOPSJON,k.MOR),alleKodeverk:S}),p=()=>n.createElement(v,{onSubmitUfullstendigsoknad:i("button-click"),onSubmit:i("button-click"),readOnly:!1,soknadData:new b(E.ENGANGSSTONAD,o.FODSEL,k.FAR),alleKodeverk:S});u.__docgenInfo={description:"",methods:[],displayName:"visPapirsoknadForMorVedFødsel"};g.__docgenInfo={description:"",methods:[],displayName:"visPapirsoknadForMorVedAdopsjon"};p.__docgenInfo={description:"",methods:[],displayName:"visPapirsoknadForFarVedFødsel"};var V,P,M;u.parameters={...u.parameters,docs:{...(V=u.parameters)==null?void 0:V.docs,source:{originalSource:"() => <EngangsstonadPapirsoknadIndex onSubmitUfullstendigsoknad={(action('button-click') as () => Promise<any>)} onSubmit={(action('button-click') as (values: any) => Promise<any>)} readOnly={false} soknadData={new SoknadData(FagsakYtelseType.ENGANGSSTONAD, familieHendelseType.FODSEL, foreldreType.MOR)} alleKodeverk={(alleKodeverk as any)} />",...(M=(P=u.parameters)==null?void 0:P.docs)==null?void 0:M.source}}};var _,I,q;g.parameters={...g.parameters,docs:{...(_=g.parameters)==null?void 0:_.docs,source:{originalSource:"() => <EngangsstonadPapirsoknadIndex onSubmitUfullstendigsoknad={(action('button-click') as () => Promise<any>)} onSubmit={(action('button-click') as (values: any) => Promise<any>)} readOnly={false} soknadData={new SoknadData(FagsakYtelseType.ENGANGSSTONAD, familieHendelseType.ADOPSJON, foreldreType.MOR)} alleKodeverk={(alleKodeverk as any)} />",...(q=(I=g.parameters)==null?void 0:I.docs)==null?void 0:q.source}}};var D,j,h;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:"() => <EngangsstonadPapirsoknadIndex onSubmitUfullstendigsoknad={(action('button-click') as () => Promise<any>)} onSubmit={(action('button-click') as (values: any) => Promise<any>)} readOnly={false} soknadData={new SoknadData(FagsakYtelseType.ENGANGSSTONAD, familieHendelseType.FODSEL, foreldreType.FAR)} alleKodeverk={(alleKodeverk as any)} />",...(h=(j=p.parameters)==null?void 0:j.docs)==null?void 0:h.source}}};const me=["visPapirsoknadForMorVedFødsel","visPapirsoknadForMorVedAdopsjon","visPapirsoknadForFarVedFødsel"];export{me as __namedExportsOrder,le as default,p as visPapirsoknadForFarVedFødsel,g as visPapirsoknadForMorVedAdopsjon,u as visPapirsoknadForMorVedFødsel};
