import{j as a}from"./iframe-Be1yU01i.js";import{u as O,L as u,h as m,P as v,f as R,C as P,H as k,e as N,A as T,O as A,c as S,T as _,D as L,i as I,F as s,V as D,I as G,d as K}from"./BehovForTilretteleggingPanel-AprDcFC3.js";const y=()=>({...R.initialValues(),...v.initialValues(),...m.initialValues(),...u.initialValues()}),p=e=>({...R.transformValues(e),...v.transformValues(e),...m.tranformValues(e),...u.transformValues(e)}),o=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:t,onSubmitUfullstendigsoknad:i})=>{const E=O({defaultValues:y()});return a.jsxs(P,{formMethods:E,onSubmit:r=>t(p(r)),children:[a.jsxs(k,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(R,{readOnly:e}),a.jsx(m,{annenForelderInformertRequired:!0,readOnly:e})]}),a.jsx(v,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!0}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:i,submitting:E.formState.isSubmitting,erEndringssøknad:!0})]})};o.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerEndringssøknadValues) => Promise<void>",signature:{arguments:[{type:{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""}}};const H=()=>({...R.initialValues(),...K.initialValues(),...G.initialValues(),...D.initialValues(),...s.initialValues(),...I.initialValues(),...L.initialValues(),..._.initialValues(),...S.initialValues(),...A.initialValues(),...T.initialValues(),...v.initialValues(),...m.initialValues(),...N.initialValues(),...u.initialValues()}),Y=e=>({...R.transformValues(e),...K.transformValues(e),...G.transformValues(e),...D.transformValues(e),...s.transformValues(e),...I.transformValues(e),...L.transformValues(e),..._.transformValues(e),...S.transformValues(e),...A.transformValues(e),...T.transformValues(e),...v.transformValues(e),...m.tranformValues(e),...N.transformValues(e),...u.transformValues(e)}),d=({readOnly:e,soknadData:l,alleKodeverk:n,onSubmit:t,onSubmitUfullstendigsoknad:i,fagsakPersonnummer:E})=>{const r=O({defaultValues:H()}),F=r.watch("annenForelder.sokerHarAleneomsorg"),M=r.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),V=!F&&M!==!1,U=r.watch("foedselsDato"),g=r.watch("mottattDato");return a.jsxs(P,{formMethods:r,onSubmit:B=>t(Y(B)),children:[a.jsxs(k,{columns:{sm:1,md:2},gap:"space-16",children:[a.jsx(R,{readOnly:e}),a.jsx(K,{readOnly:e,erAdopsjon:l.getFamilieHendelseType()==="ADPSJN",alleKodeverk:n,mottattDato:g}),a.jsx(G,{readOnly:e,alleKodeverk:n}),a.jsx(D,{readOnly:e,alleKodeverk:n}),a.jsx(s,{readOnly:e}),a.jsx(I,{readOnly:e,alleKodeverk:n}),a.jsx(L,{readOnly:e}),l.getFamilieHendelseType()==="FODSL"&&a.jsx(_,{readOnly:e,erForeldrepenger:!0}),a.jsx(S,{readOnly:e,soknadData:l}),a.jsx(A,{readOnly:e,familieHendelseType:l.getFamilieHendelseType(),fodselsdato:U,isForeldrepengerFagsak:!0}),a.jsx(T,{readOnly:e,alleKodeverk:n,fagsakPersonnummer:E,sokerErMor:l.getForeldreType()==="MOR"}),a.jsx(v,{foreldreType:l.getForeldreType(),readOnly:e,alleKodeverk:n,erEndringssøknad:!1}),a.jsx(m,{annenForelderInformertRequired:V,readOnly:e}),a.jsx(N,{readOnly:e})]}),a.jsx(u,{readOnly:e,onSubmitUfullstendigsoknad:i,submitting:r.formState.isSubmitting,erEndringssøknad:!1})]})};d.__docgenInfo={description:`ForeldrepengerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};export{J as F};
