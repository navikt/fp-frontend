...
som viser at ingen dokumenter finnes på fagsak.`,methods:[],displayName:"DocumentListInnsyn",props:{saksNr:{required:!0,tsType:{name:"string"},description:""},documents:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kommunikasjonsretning: string;
  gjelderFor?: string;
}>`}],raw:"Dokument[]"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const ue=({vedtaksdokumenter:e,behandlingTypes:t})=>{const[r,a]=l.useState(!1),s=l.useCallback(i=>{a(!r),i.preventDefault()},[r]);return e.length===0?n.jsx(g,{id:"DocumentListInnsyn.Vedtaksdokumentasjon",values:{numberOfDocuments:0}}):n.jsxs(n.Fragment,{children:[n.jsxs(O,{href:"#",onClick:s,children:[n.jsx(g,{id:"DocumentListInnsyn.Vedtaksdokumentasjon",values:{numberOfDocuments:e.length}}),r?n.jsx(Pe,{}):n.jsx(Fe,{})]}),r&&n.jsxs(n.Fragment,{children:[n.jsx(d,{fourPx:!0}),n.jsx(Se,{children:e.map(i=>{var u;return n.jsxs(De,{children:[n.jsx(z,{children:n.jsx(Ee,{dateString:i.opprettetDato})}),n.jsx(z,{children:n.jsx(O,{href:je(i.behandlingUuid),target:"_blank",children:((u=t.find(o=>o.kode===i.tittel))==null?void 0:u.navn)||"-"})})]},i.behandlingUuid)})})]})]})};ue.__docgenInfo={description:"",methods:[],displayName:"VedtakDocuments",props:{behandlingTypes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  tittel: string;
  opprettetDato: string;
}>`}],raw:"InnsynVedtaksdokument[]"},description:""}}};const un=[],on=e=>e.reduce((t,r)=>({[`dokument_${r.dokumentId}`]:r.fikkInnsyn,...t}),{}),gn=(e,t,r,a,s)=>({mottattDato:e,innsynResultatType:t||void 0,fristDato:s||Te().add(3,"days").format(Oe),sattPaVent:a[0].status===x.OPPRETTET?void 0:!!s,...se.buildInitialValues(a),...on(r||[])}),dn=(e,t)=>t.map(r=>({dokumentId:r.dokumentId,journalpostId:r.journalpostId,fikkInnsyn:!!e[`dokument_${r.dokumentId}`]})),kn=e=>Object.keys(e).filter(t=>!t.startsWith("dokument_")).reduce((t,r)=>({...t,[r]:e[r]}),{}),mn=(e,t)=>({kode:A.VURDER_INNSYN,innsynDokumenter:dn(e,t),...kn(e)}),yn=e=>{const t=e.filter(r=>r.kommunikasjonsretning===F.INN);return e.forEach(r=>!t.some(a=>a.dokumentId===r.dokumentId)&&t.push(r)),t},oe=({readOnly:e,readOnlySubmitButton:t,innsynMottattDato:r,alleKodeverk:a,vedtaksdokumentasjon:s,innsynResultatType:i,fristBehandlingPåVent:u,innsynDokumenter:o,alleDokumenter:k=[],aksjonspunkter:m,submitCallback:j,saksNr:p,formData:S,setFormData:D})=>{const v=B(),E=l.useMemo(()=>gn(r,i,o,m,u),[r,i,u,o,m]),T=Z({defaultValues:S||E}),N=l.useMemo(()=>yn(k),[k]),V=l.useMemo(()=>a[G.INNSYN_RESULTAT_TYPE].filter(q=>q.kode!=="-").sort((q,pe)=>q.navn.localeCompare(pe.navn)).reverse(),[a]),b=m[0].status===x.OPPRETTET,y=T.watch("innsynResultatType"),M=T.watch("sattPaVent");return n.jsxs(ee,{formMethods:T,onSubmit:q=>j(mn(q,k)),setDataOnUnmount:D,children:[n.jsx(L,{size:"small",children:n.jsx(g,{id:"InnsynForm.Innsynsbehandling"})}),n.jsx(d,{twentyPx:!0}),n.jsx(Ne,{isAksjonspunktOpen:b,children:[n.jsx(g,{id:"InnsynForm.VurderKravetOmInnsyn"},"1")]}),n.jsx(d,{twentyPx:!0}),n.jsx(C,{name:"mottattDato",label:v.formatMessage({id:"InnsynForm.DatoMottattKrav"}),isReadOnly:e,isEdited:!b,validate:[I,Y]}),n.jsx(d,{sixteenPx:!0}),n.jsx(ue,{vedtaksdokumenter:s||un,behandlingTypes:a[G.BEHANDLING_TYPE]}),n.jsx(d,{twentyPx:!0}),n.jsx(U,{saksNr:p,documents:N,readOnly:e}),n.jsx(se,{readOnly:e}),n.jsx(d,{sixteenPx:!0}),n.jsx($,{name:"innsynResultatType",label:n.jsx(g,{id:"InnsynForm.Resultat"}),validate:[I],isReadOnly:e,isHorizontal:!0,isEdited:!b,radios:V.map(q=>({value:q.kode,label:q.navn}))}),(y===h.INNVILGET||y===h.DELVISTINNVILGET)&&n.jsxs(n.Fragment,{children:[n.jsx(d,{eightPx:!0}),n.jsxs(Ke,{alignOffset:y===h.INNVILGET?28:176,children:[n.jsx($,{name:"sattPaVent",label:n.jsx(g,{id:"InnsynForm.VelgVidereAksjon"}),validate:[I],isReadOnly:e,isEdited:!b,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:v.formatMessage({id:"InnsynForm.SettBehandlingPåVent"})},{value:"false",label:v.formatMessage({id:"InnsynForm.ForeslåOgFatteVedtak"})}]}),M&&n.jsxs(n.Fragment,{children:[n.jsx(d,{eightPx:!0}),n.jsx(C,{name:"fristDato",label:v.formatMessage({id:"InnsynForm.FristDato"}),isReadOnly:e,isEdited:!b,validate:[I,Y]})]})]})]}),n.jsx(d,{sixteenPx:!0}),n.jsx(ie,{isReadOnly:e,isSubmittable:!t,isSubmitting:T.formState.isSubmitting,isDirty:T.formState.isDirty,text:M?v.formatMessage({id:"SubmitButton.SettPåVent"}):void 0})]})};oe.__docgenInfo={description:`InnsynForm
...
Readonly<{
  ...
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const fn="_checkboxCol_vtbic_1",hn="_linkCol_vtbic_5",jn="_image_vtbic_9",Tn="_noDocuments_vtbic_15",An="_hidden_vtbic_19",wn="_table_vtbic_23",K={checkboxCol:fn,linkCol:hn,image:jn,noDocuments:Tn,hidden:An,table:wn},cn=["DocumentListVedtakInnsyn.Dokument"],ke=({documents:e,saksNr:t})=>e.length===0?n.jsx(c,{size:"small",className:K.noDocuments,children:n.jsx(g,{id:"DocumentListVedtakInnsyn.NoDocuments"})}):n.jsxs(n.Fragment,{children:[n.jsx(qe,{className:K.noDocuments,children:n.jsx(g,{id:"DocumentListVedtakInnsyn.InnsynsDok"})}),n.jsx(re,{noHover:!0,headerTextCodes:cn,children:e.map(r=>{const a=parseInt(r.dokumentId,10);return n.jsx(ae,{id:a,children:n.jsx(w,{className:K.linkCol,children:n.jsx("a",{href:X(t,r.journalpostId,r.dokumentId),className:"lenke lenke--frittstaende",target:"_blank",rel:"noopener noreferrer",children:r.tittel})})},a)})})]});ke.__docgenInfo={description:`DocumentListVedtakInnsyn
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const J=e=>{const{aksjonspunkt:t,behandlingsresultat:r}=e,a=t.some(s=>s.status===x.OPPRETTET);return t.length===0||a?P.IKKE_VURDERT:(r==null?void 0:r.type)===W.INNSYN_INNVILGET||(r==null?void 0:r.type)===W.INNSYN_DELVIS_INNVILGET?P.OPPFYLT:P.IKKE_OPPFYLT},Hn=(e,t,r)=>a=>{const s={...a,behandlingUuid:r.uuid,fagsakYtelseType:t.fagsakYtelseType};return e(s).then(i=>Me(i))},Ln=(e,t)=>()=>(t(!1),()=>{e(!0)}),xn=[A.FORESLA_VEDTAK],Un=e=>[{key:R.INNSYN},{key:R.INNSYN_DOKUMENTER,params:{saksnummer:e}}],ve=({fagsak:e,opneSokeside:t,setSkalOppdatereEtterBekreftelseAvAp:r,...a})=>{const s=B(),[i,u]=l.useState(!1),o=Ln(u,r),k=_e(),{startRequest:m}=Ve.useRestApiRunner(R.PREVIEW_MESSAGE),j=l.useCallback(Hn(m,e,k.behandling),[k.behandling.versjon]);return n.jsx(le,{...a,panelEndepunkter:Un(e.saksnummer),aksjonspunktKoder:xn,prosessPanelKode:ne.VEDTAK,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.Vedtak"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:()=>J(a.behandling),lagringSideEffekter:o,hentSkalMarkeresSomAktiv:()=>J(a.behandling)!==P.IKKE_VURDERT,renderPanel:p=>n.jsxs(n.Fragment,{children:[n.jsx(Ge,{visModal:i,lukkModal:()=>{u(!1),t()},behandlingsresultat:k.behandling.behandlingsresultat}),n.jsx(ye,{saksnummer:e.saksnummer,previewCallback:j,alleDokumenter:p==null?void 0:p.innsynDokumenter,...p})]})})};ve.__docgenInfo={description:"",methods:[],displayName:"InnsynVedtakProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
