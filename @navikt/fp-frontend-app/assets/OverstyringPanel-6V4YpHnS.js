import{j as e}from"./index-nufLo1NJ.js";import{c as _,D as A,n as I,r as S,b as B,y as x,E as w,e as j,M as O,Y as K}from"./index.es-BF0mzhuJ.js";import{ae as D,a1 as v,ar as L,h as T,V as E,f as m,g as p,H as F,K as M,L as N}from"./withPanelData-C7rtReP7.js";import{r as U}from"./index-mMUbb89k.js";import{A as z}from"./aksjonspunktStatus-xM4O_ZUY.js";import{V as $}from"./BehandlingHenlagtPanel-oN7aMoYE.js";import{S as C}from"./Checkmark-D1ehXmEa.js";import{S as H}from"./TotrinnskontrollIndex-CrGsRMEO.js";import{S as Y,K as h,i as J}from"./index.es-CX0DFsEA.js";import{S as X}from"./CheckmarkCircleFill-DMwwlZrE.js";import{S as W}from"./ExclamationmarkTriangleFill-l-GXXVqE.js";const Q="_begrunnelseTextField_hw8s7_6",Z={begrunnelseTextField:Q},c={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=v(c),ne=S(3),re=B(2e3),se=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ae=n=>s=>s!==void 0||n,V=({readOnly:n,text:s,useAllWidth:r=!1,notRequired:a=!1})=>{const{formState:{isDirty:l}}=_(),t=a?()=>!1:ae(l);return e.jsx("div",{className:r?"":Z.begrunnelseTextField,children:e.jsx(A,{name:"begrunnelse",label:s??ee.formatMessage({id:se(n)}),validate:[I(t),ne,re,x],maxLength:2e3,readOnly:n,parse:D})})},te=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";V.buildInitialValues=n=>({begrunnelse:L(te(n))});V.transformValues=n=>({begrunnelse:n.begrunnelse});V.__docgenInfo={description:`ProsessStegBegrunnelseTextField
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Avslagsårsak'>[]"},description:""},customVilkarIkkeOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},customVilkarOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},skalKunneInnvilge:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},validatorsForRadioOptions:{required:!1,tsType:{name:"Array",elements:[{name:"unknown"}],raw:"((value: boolean) => string | null | undefined)[]"},description:""}}};const pe="_vilkar_t9zom_1",ve="_aksjonspunktMargin_t9zom_5",ce="_godkjentImage_t9zom_10",ye="_avslattImage_t9zom_16",y={vilkar:pe,aksjonspunktMargin:ve,godkjentImage:ce,avslattImage:ye},b=v(c),Ee=({lovReferanse:n,title:s,originalErVilkarOk:r,isAksjonspunktOpen:a,readOnlySubmitButton:l,readOnly:t,rendreFakta:o,isDirty:g,erIkkeGodkjentAvBeslutter:i,isSubmitting:k,children:u})=>e.jsxs(E,{gap:"4",children:[e.jsxs(m,{gap:"2",children:[r!==void 0&&e.jsxs(e.Fragment,{children:[r&&e.jsx(X,{className:y.godkjentImage}),!r&&e.jsx(Y,{className:y.avslattImage})]}),e.jsx(F,{size:"small",children:s}),n&&e.jsx(M,{className:y.vilkar,children:n})]}),e.jsxs(m,{gap:"2",children:[r&&e.jsx(N,{size:"small",children:b.formatMessage({id:"ProsessPanelTemplate.ErOppfylt"})}),r===!1&&e.jsx(N,{size:"small",children:b.formatMessage({id:"ProsessPanelTemplate.ErIkkeOppfylt"})}),!a&&r===void 0&&e.jsx(p,{size:"small",children:b.formatMessage({id:"ProsessPanelTemplate.IkkeBehandlet"})})]}),e.jsx(h,{className:y.aksjonspunktMargin,erAksjonspunktApent:a,erIkkeGodkjentAvBeslutter:i,children:e.jsxs(E,{gap:"4",children:[e.jsx("div",{children:u}),e.jsx(P,{isReadOnly:t,isSubmittable:!l,isDirty:g,isSubmitting:k})]})}),o==null?void 0:o()]});Ee.__docgenInfo={description:"",methods:[],displayName:"ProsessPanelTemplate",props:{title:{required:!0,tsType:{name:"string"},description:""},lovReferanse:{required:!1,tsType:{name:"string"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},originalErVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},rendreFakta:{required:!1,tsType:{name:"signature",type:"function",raw:"() => ReactNode",signature:{arguments:[],return:{name:"ReactNode"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const fe="_aksjonspunktMargin_pxm8x_1",be="_exclamationmarkIcon_pxm8x_6",q={aksjonspunktMargin:fe,exclamationmarkIcon:be},d=v(c),Te=S(3),Ne=B(1500),_e=n=>s=>s!==void 0||n,Ve=({erOverstyrt:n,isSolvable:s,erVilkarOk:r,hasAksjonspunkt:a,overrideReadOnly:l,isSubmitting:t,isPristine:o,toggleAv:g,erIkkeGodkjentAvBeslutter:i,children:k})=>{const{formState:{isDirty:u}}=_(),G=_e(u);return e.jsx(h,{className:q.aksjonspunktMargin,erAksjonspunktApent:n,erIkkeGodkjentAvBeslutter:i,children:e.jsxs(E,{gap:"4",children:[e.jsx(N,{size:"medium",children:d.formatMessage({id:"OverstyringPanel.AutomatiskVurdering"})}),e.jsx("div",{children:k}),(n||a)&&e.jsx(A,{name:"begrunnelse",label:d.formatMessage({id:"OverstyringPanel.Vilkar"}),validate:[G,Te,Ne,x],maxLength:1500,readOnly:l||!n}),!n&&r!==void 0&&e.jsxs(m,{gap:"2",children:[e.jsx(J,{}),e.jsx(p,{size:"small",children:d.formatMessage({id:"OverstyringPanel.Endret"})})]}),n&&e.jsxs(e.Fragment,{children:[e.jsxs(m,{gap:"2",children:[e.jsx(W,{className:q.exclamationmarkIcon}),e.jsx(p,{size:"small",children:d.formatMessage({id:"OverstyringPanel.Unntakstilfeller"})})]}),e.jsxs(m,{gap:"2",children:[!l&&e.jsx(T,{size:"small",variant:"primary",loading:t,disabled:t||!s||o,children:d.formatMessage({id:"OverstyringPanel.ConfirmInformation"})}),e.jsx(T,{size:"small",variant:"secondary",loading:t,disabled:t,onClick:g,type:"button",children:d.formatMessage({id:"OverstyringPanel.Avbryt"})})]})]})]})})};Ve.__docgenInfo={description:"",methods:[],displayName:"OverstyringPanel",props:{erOverstyrt:{required:!0,tsType:{name:"boolean"},description:""},isSolvable:{required:!0,tsType:{name:"boolean"},description:""},erVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},hasAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},overrideReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isPristine:{required:!0,tsType:{name:"boolean"},description:""},toggleAv:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};export{Ve as O,V as P,R as V,P as a,Ee as b};
