import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as T,u as b,n as F}from"./fagsakApi-BRdURs0O.js";import{a as K,$ as x,F as A,p as I,u as M}from"./index.es-FAoReYFy.js";import{u as N,V as _,g as m,f as y,h as P,P as E,a7 as V}from"./withPanelData-CUsclcZj.js";import{r as O}from"./index.es-CiYn-l0f.js";import{K as c}from"./alleKodeverk-Ga5AMxGN.js";import{g as C}from"./kodeverkUtils-DLZgokMR.js";import{T as s}from"./Table-BPKZemzl.js";import{M as u}from"./message-HdFYDHgy.js";import"./index-mMUbb89k.js";import{S as Y}from"./ExclamationmarkTriangleFill-CFVGhOtj.js";import{p as D}from"./paths-DvkOoXIy.js";import{a as L}from"./index-DcGDEF8s.js";const w=({fagsaker:r,selectFagsakCallback:a,alleKodeverk:t})=>{const i=C(t);return e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:r.map(n=>e.jsxs(s.Row,{onMouseDown:()=>a(n.saksnummer),onKeyDown:()=>a(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:i(n.fagsakYtelseType,c.FAGSAK_YTELSE)}),e.jsx(s.DataCell,{children:i(n.status,c.FAGSAK_STATUS)})]},n.saksnummer))})]})};w.__docgenInfo={description:`FagsakList
