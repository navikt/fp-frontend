...
Readonly<{
  ...
  foreldreType: string,
) => Promise<any>`,signature:{arguments:[{type:{name:"any"},name:"formValues"},{type:{name:"string"},name:"fagsakYtelseType"},{type:{name:"string"},name:"familieHendelseType"},{type:{name:"string"},name:"foreldreType"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Fk="_alertStyle_1d8gt_1",wk="_modalStyle_1d8gt_6",Pk="_fullWidth_1d8gt_11",_k="_reduceMargin_1d8gt_16",xk="_left_1d8gt_20",Sk="_right_1d8gt_24",Mn={alertStyle:Fk,modalStyle:wk,fullWidth:Pk,reduceMargin:_k,left:xk,right:Sk},Cr=re(dt),Vi=({isOpen:s=!1})=>r.jsx(Xe,{className:Mn.modalStyle,open:s,"aria-label":Cr.formatMessage({id:"SoknadRegistrertModal.ContentLabel"}),onClose:()=>{},children:r.jsx(Xe.Body,{children:r.jsxs(Qr,{size:"small",variant:"success",className:Mn.alertStyle,children:[r.jsxs("div",{className:Mn.left,children:[r.jsx("p",{className:Mn.reduceMargin,children:Cr.formatMessage({id:"SoknadRegistrertModal.InfoTextOne"})}),r.jsx("p",{className:Mn.reduceMargin,children:Cr.formatMessage({id:"SoknadRegistrertModal.InfoTextTwo"})})]}),r.jsx("div",{className:Mn.right,children:r.jsx(Ks,{to:"/",children:r.jsx(Ke,{size:"small",variant:"primary",children:Cr.formatMessage({id:"SoknadRegistrertModal.OkButtonText"})})})})]})})});Vi.__docgenInfo={description:`SoknadRegistrertModal
