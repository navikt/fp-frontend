import{j as u}from"./jsx-runtime-D_zvdyIk.js";import{r as k}from"./index-Dxs5m6lS.js";import{u as f,f as T,a4 as R,a5 as P,a6 as B}from"./withPanelData-CYdhV39l.js";import{E as F}from"./index.es-DUgerlB4.js";import{u as M}from"./fagsakApi-maleOn_7.js";import{V as S}from"./BehandlingMenuIndex-CDs4nJco.js";import{A as K}from"./aksjonspunktCodes-BLM-Fgv6.js";import{u as E,h as V}from"./behandlingApi-FBUCt0uW.js";import{B as v}from"./FagsakIndex-Dw2OdSWT.js";import{I as N}from"./index.es-BXYmAHo_.js";import{S as O}from"./ExclamationmarkTriangleFill-mervqxeU.js";import{i as p}from"./aksjonspunktStatus-xM4O_ZUY.js";import{e as D,g as x}from"./useStandardProsessPanelProps-CpCAnGNg.js";const _=n=>{const[t,e]=k.useState([]),s=r=>{e(l=>{const a=[...l],d=a.findIndex(i=>i.id===r.id);return d>=0?a.splice(d,1,r):a.push(r),a}),n==null||n(r.harApneAksjonspunkter?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:t.filter(r=>r.skalVisesImeny),settFaktaPanelMenyData:s}},L="_container_610fz_1",I="_content_610fz_6",U="_sideMenu_610fz_14",y={container:L,content:I,sideMenu:U},C=({valgtFaktaSteg:n,valgtProsessSteg:t,setFaktaPanelMedÅpentApInfo:e,children:s})=>{const r=f(),{oppdaterProsessStegOgFaktaPanelIUrl:l}=k.use(v),{faktaPanelMenyData:a,settFaktaPanelMenyData:d}=_(e),i=a.length>0;return u.jsxs(T,{className:y.container,wrap:!1,children:[i&&u.jsx("div",{className:y.sideMenu,"data-testid":"fakta-meny",children:u.jsx(N,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?u.jsx(O,{color:"var(--a-orange-600)"}):void 0})),onClick:o=>{l(t,a[o].id)}})}),u.jsx("div",{className:y.content,children:u.jsx(G,{valgtFaktaSteg:n,settFaktaPanelMenyData:d,faktaPanelMenyData:a,children:s})})]})},h=k.createContext({}),G=n=>{const{children:t,...e}=n,s=k.useMemo(()=>e,[e]);return u.jsx(h.Provider,{value:s,children:t})};C.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
