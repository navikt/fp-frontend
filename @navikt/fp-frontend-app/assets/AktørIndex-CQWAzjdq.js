import{j as e,i as g,P as y,b as p,L as v}from"./iframe-DVmnXKxP.js";import{X as f}from"./index.es-DZHg5t2e.js";import{u as q,r as j}from"./fagsakApi-Btkd8a98.js";import{V as c}from"./VisittkortSakIndex-CuXUx9CX.js";import{V as w,a as I,B as T}from"./VStack-CiOFCpSk.js";import{M as k}from"./message-DClLBoUZ.js";import{E as F}from"./IngenBehandlingValgtPanel-CJXLk4oB.js";import{u as R}from"./useTrackRouteParam-D2NeFv3Z.js";import{p as E}from"./paths-SmmZVinF.js";import{u as o}from"./useKodeverk-C44s-e5s.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",level:"2",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
