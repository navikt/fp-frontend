import{j as r}from"./jsx-runtime-CLpGMVip.js";import{r as u}from"./index-B8jnc8p3.js";import{F as C,D as F,I as q,$ as _}from"./index.es-ylySzHC6.js";import{B as j}from"./behandlingDataContext-BdfTXpp6.js";import{k as D}from"./withPanelData-B0zkdg-8.js";import{s as T,i as I,q as c}from"./index.es-zqjR_SMY.js";import{S}from"./ExclamationmarkTriangleFill-D_leAKaU.js";import{V as A,B as E}from"./BehandlingHenlagtPanel-DQLcgfCu.js";const h=({menyData:a,oppdaterFaktaPanelIUrl:i})=>{const o=D();return r.jsx(T,{heading:o.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(t=>({label:t.tekst??"",active:t.erAktiv,icon:t.harApneAksjonspunkter?r.jsx(S,{color:"var(--a-orange-600)"}):void 0})),onClick:i})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{menyData:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}}],raw:"ProsessPanelMenyData[]",required:!0}}]}},name:"ekstraProps"}],return:{name:"ReactElement"}}},description:""},valgtProsessSteg:{required:!1,tsType:{name:"string"},description:""},valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""}}};export{H as B};
