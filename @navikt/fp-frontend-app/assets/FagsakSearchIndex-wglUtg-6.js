import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as T,u as b,n as F}from"./initFetch-ChXFpEDe.js";import{a as K,e as x,X as A,p as I,u as M}from"./index.es-CmO1OSHi.js";import{u as N,V as _,g as m,f as y,h as P,P as E,a5 as V}from"./withPanelData-g3ZJRFFm.js";import{n as O}from"./index.es-3mY2NE4O.js";import{K as c}from"./alleKodeverk-Dm9joGL5.js";import{g as C}from"./kodeverkUtils-DLZgokMR.js";import{T as s}from"./Table-ZQu-oQwV.js";import{M as u}from"./message-BNb4AvKI.js";import"./index-DjhIdADd.js";import{S as Y}from"./ExclamationmarkTriangleFill-CdfK8heW.js";import{p as D}from"./paths-CHo4Pa8b.js";import{a as L}from"./index-CiTJJs0Y.js";const w=({fagsaker:r,selectFagsakCallback:a,alleKodeverk:t})=>{const i=C(t);return e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:r.map(n=>e.jsxs(s.Row,{onMouseDown:()=>a(n.saksnummer),onKeyDown:()=>a(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:i(n.fagsakYtelseType,c.FAGSAK_YTELSE)}),e.jsx(s.DataCell,{children:i(n.status,c.FAGSAK_STATUS)})]},n.saksnummer))})]})};w.__docgenInfo={description:`FagsakList
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSearch",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const X={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},Z=O(X),S=({fagsaker:r=[],searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n=!1,searchResultAccessDenied:d,alleKodeverk:l})=>e.jsx(E,{value:Z,children:e.jsx(h,{fagsaker:r,searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n,searchResultAccessDenied:d,alleKodeverk:l})});S.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  status: string;
  aktørId: string;
