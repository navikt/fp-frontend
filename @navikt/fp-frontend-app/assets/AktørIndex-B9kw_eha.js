import{j as e,i as g,P as v,b as p,L as y}from"./iframe-Cc3omapF.js";import{Q as q}from"./index.es-BZcNyl5y.js";import{u as f,r as c}from"./fagsakApi-Dl3IK1m3.js";import{V as w}from"./VisittkortSakIndex-CUKM51Is.js";import{V as N,a as A,B as j}from"./VStack-BS7xUE_y.js";import{M as d}from"./message-BD0ajGHY.js";import{E as R}from"./IngenBehandlingValgtPanel-HTEHLcr6.js";import{u as E}from"./useTrackRouteParam-BNUNbNk0.js";import{p as T}from"./paths-C3-6l03g.js";import{u as m}from"./useKodeverk-R_OIMhjx.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(w,{bruker:n.person}),e.jsx(N,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(A,{size:"small",level:"2",children:e.jsx(d,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
  person: PersonDto;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FagsakYtelseType'>[]"},description:""},renderSomLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(className: string | undefined, fagsakKomponent: ReactNode, saksnummer: string) => ReactElement",signature:{arguments:[{type:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},name:"className"},{type:{name:"ReactNode"},name:"fagsakKomponent"},{type:{name:"string"},name:"saksnummer"}],return:{name:"ReactElement"}}},description:""}}};const S={"AktoerGrid.IngenFagsaker":"Har ingen fagsaker i fpsak","AktorSakIndex.UgyldigAktorId":"Ugyldig aktørId: {id}"},I=p(S),k=({valgtAktorId:n,aktorInfo:r,...t})=>e.jsxs(v,{value:I,children:[r&&e.jsx(o,{aktorInfo:r,...t}),!r&&e.jsx(j,{size:"small",children:e.jsx(d,{id:"AktorSakIndex.UgyldigAktorId",values:{id:n}})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørSakIndex",props:{valgtAktorId:{required:!0,tsType:{name:"string"},description:""},aktorInfo:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
  person: PersonDto;
  fagsaker: Array<FagsakSøkDto>;
}`,signature:{properties:[{key:"aktørId",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"person",value:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FagsakYtelseType'>[]"},description:""},renderSomLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(className: string | undefined, fagsakKomponent: ReactNode, saksnummer: string) => ReactElement",signature:{arguments:[{type:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},name:"className"},{type:{name:"ReactNode"},name:"fagsakKomponent"},{type:{name:"string"},name:"saksnummer"}],return:{name:"ReactElement"}}},description:""}}};const P=()=>{const{selected:n}=E({paramName:"aktoerId"}),{data:r,status:t}=f(c(n)),l=m("FagsakStatus"),a=m("FagsakYtelseType");return t==="pending"?e.jsx(q,{}):t==="error"?e.jsx(R,{}):e.jsx(k,{valgtAktorId:n,aktorInfo:r,fagsakStatuser:l,fagsakYtelseTyper:a,renderSomLenke:(u,i,s)=>e.jsx(y,{to:T(s),className:u,children:i})})};P.__docgenInfo={description:"",methods:[],displayName:"AktørIndex"};export{P as A};
