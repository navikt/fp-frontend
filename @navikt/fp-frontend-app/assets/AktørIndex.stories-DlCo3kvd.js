import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{w as A,M as C,R as U,a as w,F as I}from"./withThemeDecorator-CWw-votO.js";import{r as P}from"./index.es-rZHtKJ0C.js";import{u as c,a as x,F as s,i,b as d,w as D,n as v,c as y,d as F}from"./fagsakApi-CPN6WPmi.js";import{h as t,H as e,c as L}from"./index-Dyi8laJ0.js";import{a as g}from"./alleKodeverk-DO07GSZv.js";import{K as S}from"./Kjonnkode-C-fkzSiP.js";import{i as k}from"./initFetchFptilbake-B5Zqz4Xk.js";import{A as T}from"./AktørIndex-DjAoSkwu.js";import"./index-mMUbb89k.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./v4-CtRu48qb.js";import"./entry-preview-CLlQdOhP.js";import"./iframe-BwtNNplS.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-DtNjo1hO.js";import"./index-CXQShRbs.js";import"./VStack-1a6xp81y.js";import"./index-D4MMZV7Z.js";import"./index-0CCRSEf1.js";import"./CheckmarkCircleFill-BHI1QPIm.js";import"./ExclamationmarkTriangleFill-BWNVRWoR.js";import"./behandlingResultatType-CKS0Ckn9.js";import"./vilkarUtfallType-vN0hVpa7.js";import"./decorators-Bnaor6Ku.js";import"./VisittkortSakIndex-CDCfWRob.js";import"./index.es-DX7RPEtw.js";import"./Link-CoYM6QC8.js";import"./Tooltip-BeKJDdRL.js";import"./Checkmark-Z93n-U2y.js";import"./Popover-1x74mQOo.js";import"./message-CipVOp0b.js";import"./Tag-3ngdwDzW.js";import"./Spacer-Y3FmKLdJ.js";import"./IngenBehandlingValgtPanel-CrnI-kfz.js";import"./useTrackRouteParam-B35xOys4.js";import"./paths-D1GjjdZU.js";import"./useKodeverk-CPn-PC-j.js";const E=m=>L(D(v(i.links.find(l=>l.rel===m)).href)),p={navn:"Espen Utvikler",fødselsnummer:"11111111111",kjønn:S.MANN,fødselsdato:"2000-01-02",dødsdato:null,aktørId:"22222222"},b={fagsaker:[{saksnummer:"123",fagsakYtelseType:I.FORELDREPENGER,status:d.OPPRETTET,aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p},{saksnummer:"252523",fagsakYtelseType:I.ENGANGSSTONAD,status:d.LOPENDE,aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p}],person:p},Ht={title:"app/AktørIndex",decorators:[A],component:T,parameters:{layout:"fullscreen"},render:()=>{const{status:m}=c(y()),{kodeverkOptions:l}=x(),{data:O}=c(l(m==="success"));return O?r.jsx(C,{initialEntries:["/fagsak/352011079"],children:r.jsx(U,{children:r.jsx(w,{element:r.jsx(T,{}),path:"/fagsak/:aktoerId"})})}):r.jsx(P,{})}},a={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>e.json(b))]}}},o={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>e.json({fagsaker:[],person:{...p,aktørId:null}}))]}}},n={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>new e(null,{status:500}))]}}};var R,u,h;a.parameters={...a.parameters,docs:{...(R=a.parameters)==null?void 0:R.docs,source:{originalSource:`{
  parameters: {
    msw: {
