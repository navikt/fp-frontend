import{j as r}from"./jsx-runtime-CLpGMVip.js";import{r as u}from"./index-B8jnc8p3.js";import{W as C,z as F,Y as q,H as _}from"./index.es-frODTQOm.js";import{B as j}from"./behandlingDataContext-BdfTXpp6.js";import{k as D}from"./withPanelData-DymM_XOp.js";import{s as T,i as S,q as c}from"./index.es-D8SnAkJU.js";import{S as I}from"./ExclamationmarkTriangleFill-DsLG1GMc.js";import{V as A,B as E}from"./BehandlingHenlagtPanel-B1YP-FnW.js";const h=({menyData:a,oppdaterFaktaPanelIUrl:i})=>{const o=D();return r.jsx(T,{heading:o.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(t=>({label:t.tekst??"",active:t.erAktiv,icon:t.harApneAksjonspunkter?r.jsx(I,{color:"var(--a-orange-600)"}):void 0})),onClick:i})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{menyData:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
