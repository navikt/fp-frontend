import{j as e,i as g,P as v,b as p,L as y}from"./iframe-H3mbAjlI.js";import{Q as f}from"./index.es-C21mZBmo.js";import{u as q,r as _}from"./fagsakApi-CN3zGI6Y.js";import{V as c}from"./VisittkortSakIndex-faofesUw.js";import{V as w,a as j,B as N}from"./VStack-xB0fUnYX.js";import{M as m}from"./message-DCXqF6c0.js";import{E as A}from"./IngenBehandlingValgtPanel-BrQHV0aV.js";import{u as R}from"./useTrackRouteParam-C-yi891S.js";import{p as E}from"./paths-x88lYTUJ.js";import{u as d}from"./useKodeverk-DWGUlEAT.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person,familiehendelse:null}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(j,{size:"small",level:"2",children:e.jsx(m,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
