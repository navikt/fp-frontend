...
Viser barn fra søknad`,methods:[],displayName:"BarnPanel",props:{alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: FarSøkerType | null;
}>`},description:""}}};const Ge=({aktoerId:n,navn:r,kjønn:a,adresser:t,dødsdato:s})=>{const o=Me(t,_e.POSTADRESSE),l=Me(t,_e.BOSTEDSADRESSE);return{aktoerId:n,navn:r,dødsdato:s,adresse:o??l,erMor:a===tr.KVINNE}},gn=({personoversikt:n,alleMerknaderFraBeslutter:r})=>{const a=j(),t=[Ge(n.bruker)];return n.annenPart&&t.push(Ge(n.annenPart)),e.jsx(E,{title:a.formatMessage({id:"ForeldrePanel.Foreldre"}),merknaderFraBeslutter:r[m.OMSORGSOVERTAKELSE],children:e.jsx(b,{gap:"8",children:t.map(s=>e.jsxs(b,{gap:"2",children:[e.jsx(J,{size:"small",children:s.navn}),e.jsx(F,{size:"small",children:e.jsx(d,{id:"ForeldrePanel.Address"})}),e.jsx(f,{size:"small",children:s.adresse&&!s.dødsdato?Xn(s.adresse):"-"}),s.dødsdato&&e.jsxs(e.Fragment,{children:[e.jsx(F,{size:"small",children:e.jsx(d,{id:"ForeldrePanel.DeathDate"})}),e.jsx(f,{size:"small",children:e.jsx(W,{dateString:s.dødsdato})})]})]},`${s.aktoerId}`))})})};gn.__docgenInfo={description:`ForeldrePanel
