import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as v,a as l,n as f,M as q}from"./index.es-nXZEdz3T.js";import{u as c,h as j}from"./initFetch-Cq4QZeRk.js";import{V as w,m as R,P as I,h as x,x as A}from"./withPanelData-C1LhPvEw.js";import{K as k}from"./alleKodeverk-BFmIlMu4.js";import{R as F}from"./index-DjhIdADd.js";import{V as T}from"./VisittkortSakIndex-0rjprqTn.js";import{E as K}from"./IngenBehandlingValgtPanel-BlFM-d8L.js";import{p as b}from"./paths-BqtTtEXC.js";import{u as S}from"./useTrackRouteParam-pS8mqPMU.js";import{u as m}from"./useKodeverk-DnOKLtkx.js";const y=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:d})=>e.jsxs(e.Fragment,{children:[e.jsx(T,{bruker:n.person}),e.jsx(w,{gap:"2",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(s=>{var i,g;const a=(i=t.find(o=>o.kode===s.fagsakYtelseType))==null?void 0:i.navn,u=(g=r.find(o=>o.kode===s.status))==null?void 0:g.navn;return e.jsxs(F.Fragment,{children:[d(void 0,`${a} (${s.saksnummer}) ${u}`,s.saksnummer),e.jsx(v,{sixteenPx:!0})]},s.saksnummer)}):e.jsx(R,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});y.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
