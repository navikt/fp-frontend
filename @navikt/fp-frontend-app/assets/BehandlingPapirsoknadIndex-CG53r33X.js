...
og trykker på 'Lagre og start behandling'. Ved å trykke på OK blir saken sendt til behandling av avslag.`,methods:[],displayName:"LukkPapirsoknadModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},handleSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const at=Zr(1500),Le=({submitting:e,onSubmitUfullstendigsoknad:n,readOnly:a=!0})=>{const t=F(),[s,i]=h.useState(!1),{watch:o}=A(),l=o("ufullstendigSoeknad")||!1,d=h.useCallback(()=>{i(!s)},[i,s]);return r.jsx(D,{children:r.jsxs(q,{gap:"4",children:[r.jsx(w,{size:"small",children:t.formatMessage({id:"Registrering.SaveApplication.Title"})}),r.jsx(xn,{name:"kommentarEndring",label:t.formatMessage({id:"Registrering.SaveApplication.Label"}),description:t.formatMessage({id:"Registrering.SaveApplication.Description"}),maxLength:1500,validate:[at,en],readOnly:a}),r.jsxs("div",{children:[r.jsx(z,{name:"registrerVerge",label:t.formatMessage({id:"Registrering.Verge"}),readOnly:a}),r.jsx(z,{name:"ufullstendigSoeknad",label:t.formatMessage({id:"Registrering.SaveApplication.OpplysningspliktErIkkeOverholdt"}),readOnly:a})]}),r.jsxs("div",{children:[!l&&r.jsx(W,{id:"saveButton",size:"small",variant:"primary",loading:e,disabled:a||e,onClick:Fa,children:r.jsx(m,{id:"Registrering.SaveApplication.SaveButton"})}),l&&r.jsx(W,{id:"endButton",onClick:d,size:"small",variant:"primary",loading:e,disabled:a||e,type:"button",children:r.jsx(m,{id:"Registrering.SaveApplication.EndButton"})})]}),r.jsx(Wn,{handleSubmit:n,showModal:s,cancelEvent:d})]})})};Le.initialValues=()=>({kommentarEndring:void 0,registrerVerge:!1,ufullstendigSoeknad:!1});Le.transformValues=({kommentarEndring:e,registrerVerge:n,ufullstendigSoeknad:a})=>({kommentarEndring:e,registrerVerge:n,ufullstendigSoeknad:a});Le.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  mottattDato?: string;
}`,signature:{properties:[{key:"mottattDato",value:{name:"string",required:!1}}]},alias:"MottattDatoFormValues"}}],returns:null}],displayName:"MottattDatoPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const le="omsorg",ot="_barnInput_1jjt5_1",lt="_col_1jjt5_5",dt={barnInput:ot,col:lt},gt=10,ut=e=>e?Ln(1)(e):void 0,mt=e=>e?lr(10)(e):void 0,pn=(e,n)=>a=>{if(e===0&&n&&a)return Ea(a,Array.isArray(n)?n[0]:n)},Ge=({readOnly:e=!0,familieHendelseType:n,isForeldrepengerFagsak:a,fodselsdatoer:t})=>{const{formatMessage:s}=F(),{control:i,watch:o}=A(),{fields:l,remove:d,append:u}=C({control:i,name:`${le}.foedselsDato`}),p=o(`${le}.antallBarn`)??0;return h.useEffect(()=>{if(l.length>Math.max(p,0))for(let g=l.length;g>p;g-=1)d(g-1);else if(l.length<Math.min(p,gt))for(let g=l.length;g<p;g+=1)u({id:g,dato:void 0})},[p]),r.jsx(D,{children:r.jsxs(q,{gap:"4",children:[r.jsx(w,{size:"small",children:r.jsx(m,{id:n===S.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),a&&n===S.ADOPSJON&&r.jsx(ae,{name:`${le}.erEktefellesBarn`,label:r.jsx(m,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[k],isReadOnly:e,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:s({id:"Registrering.Adopsjon.Ja"}),value:"true"},{label:s({id:"Registrering.Adopsjon.Nei"}),value:"false"}]}),r.jsx(f,{name:`${le}.omsorgsovertakelsesdato`,label:s({id:n===S.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:e,validate:n===S.ADOPSJON?[k,c]:[c]}),r.jsxs(K,{gap:"4",children:[n===S.ADOPSJON&&r.jsx(f,{name:`${le}.ankomstdato`,label:s({id:"Registrering.Adopsjon.Ankomstdato"}),isReadOnly:e,validate:[c]}),r.jsx(I,{name:`${le}.antallBarn`,label:s({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:e,className:dt.barnInput,parse:g=>{const y=parseInt(g.toString(),10);return Number.isNaN(y)?g:y},validate:[...n===S.ADOPSJON?[k]:[],he,ut,mt]})]}),l.map((g,y)=>r.jsx(Kn.Fragment,{children:r.jsx(f,{name:`${le}.foedselsDato.${y}.dato`,isReadOnly:e,validate:n===S.ADOPSJON?[k,c,Ie,pn(y,t)]:[c,Ie,pn(y,t)],label:s({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:y+1})})},g.id))]})})};Ge.initialValues=()=>({[le]:{}});Ge.transformValues=({omsorg:e})=>({[le]:{...e,foedselsDato:e.foedselsDato&&e.foedselsDato.length>0?e.foedselsDato.map(n=>n.dato):void 0}});Ge.__docgenInfo={description:`OmsorgOgAdopsjonPanel
...
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const Sr=({index:e,readOnly:n})=>r.jsx(N,{name:`${V}.${e}.harRegnskapsforer`,label:r.jsx(m,{id:"Registrering.VirksomhetRegnskapPanel.Accountant"}),readOnly:n,trueContent:r.jsx(G,{marginTop:8,children:r.jsxs(q,{gap:"4",children:[r.jsx(I,{name:`${V}.${e}.navnRegnskapsforer`,readOnly:n,validate:[k,en],label:r.jsx(m,{id:"Registrering.VirksomhetRegnskapPanel.AccountantName"})}),r.jsx(I,{name:`${V}.${e}.tlfRegnskapsforer`,readOnly:n,validate:[k,he],label:r.jsx(m,{id:"Registrering.VirksomhetRegnskapPanel.AccountantPhone"})})]})})});Sr.transformValues=({harRegnskapsforer:e,navnRegnskapsforer:n,tlfRegnskapsforer:a})=>({harRegnskapsforer:e,...e?{navnRegnskapsforer:n}:{},...e?{tlfRegnskapsforer:a}:{}});Sr.__docgenInfo={description:`VirksomhetRegnskapPanel
...
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
  ...
  annenForelderInformert?: boolean;
}`,signature:{properties:[{key:"annenForelderInformert",value:{name:"boolean",required:!1}}]},alias:"BekreftelseFormValues"}}],returns:null}],displayName:"BekreftelsePanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},annenForelderInformertRequired:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const j="tidsromPermisjon",Se="graderingPeriode",tn="oppholdPerioder",Zn="overforingsperioder",Kr="utsettelsePeriode",sr="permisjonsPerioder",sn=`${j}.${sr}`,se=e=>`${sn}.${e}`,Ft=lr(100),on=[ye.FELLESPERIODE,ye.FEDREKVOTE,ye.FORELDREPENGER_FOR_FODSEL,ye.FORELDREPENGER,ye.MODREKVOTE],Et=e=>e.filter(({kode:n})=>on.some(a=>a===n)).map(({kode:n,navn:a})=>r.jsx("option",{value:n,children:a},n)),wt=e=>e.map(({kode:n,navn:a})=>r.jsx("option",{value:n,children:a},n)),ea=[ye.FEDREKVOTE,ye.FORELDREPENGER_FOR_FODSEL,ye.MODREKVOTE],br=(e,n)=>e?n:"",Vt=e=>!!e&&T(e,de).isBefore(T("2019-01-01")),Rn=e=>()=>{const a=(e(sn)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return _e(a)},qn=(e,n,a)=>()=>{const t=e(`${se(n)}.periodeFom`),s=e(`${se(n)}.periodeTom`);return!s||!t?null:a?U(s)(t):_(t)(s)},Dr=({sokerErMor:e,readOnly:n,alleKodeverk:a})=>{const t=F(),s=a[M.UTTAK_PERIODE_TYPE],i=a[M.MORS_AKTIVITET];i.filter(({kode:b})=>b==="-").length===0&&i.unshift({kode:"-",navn:"",kodeverk:""});const{control:o,getValues:l,trigger:d,watch:u,formState:{isSubmitted:p}}=A(),{fields:g,remove:y,append:v}=C({control:o,name:sn});return h.useEffect(()=>{g.length===0&&v({})},[]),r.jsx(te,{readOnly:n,fields:g,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyPeriodTemplate:{},append:v,remove:y,children:(b,R)=>{const B=R===0,O=u(se(R)),Qe=Vt(O.periodeFom),qa=ea.some(Ze=>Ze===O.periodeType)||O.periodeType==="";return r.jsxs(Fe,{readOnly:n,remove:y,index:R,children:[r.jsx("div",{children:r.jsx(Y,{readOnly:n,name:`${se(R)}.periodeType`,label:br(B,t.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:Et(s),validate:[k]})}),r.jsx(f,{isReadOnly:n,name:`${se(R)}.periodeFom`,label:br(B,t.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[k,c,qn(l,R,!0),Rn(l)],onChange:()=>p?d():void 0}),r.jsx(f,{isReadOnly:n,name:`${se(R)}.periodeTom`,label:br(B,t.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[k,c,qn(l,R,!1),Rn(l)],onChange:()=>p?d():void 0}),!e&&r.jsx(Y,{readOnly:n,disabled:qa,name:`${se(R)}.morsAktivitet`,label:br(B,t.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:wt(i),hideValueOnDisable:!0}),r.jsx(z,{readOnly:n,name:`${se(R)}.flerbarnsdager`,label:r.jsx(m,{id:"Registrering.Permisjon.Flerbarnsdager"})}),r.jsx(z,{readOnly:n,name:`${se(R)}.harSamtidigUttak`,label:r.jsx(m,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),O.harSamtidigUttak&&r.jsx(I,{name:`${se(R)}.samtidigUttaksprosent`,validate:[zr,Ft],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:Ze=>Number.isNaN(Ze)?Ze:parseFloat(Ze.toString()).toFixed(2)}),Qe&&r.jsx(Er,{size:"small",variant:"warning",children:r.jsx(m,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},b.id)}})};Dr.transformValues=e=>e.map(n=>ea.some(a=>a===n.periodeType)?{periodeType:n.periodeType,periodeFom:n.periodeFom,periodeTom:n.periodeTom,flerbarnsdager:n.flerbarnsdager?n.flerbarnsdager:!1,harSamtidigUttak:n.harSamtidigUttak?n.harSamtidigUttak:!1,samtidigUttaksprosent:n.samtidigUttaksprosent}:{periodeType:n.periodeType,periodeFom:n.periodeFom,periodeTom:n.periodeTom,morsAktivitet:n.morsAktivitet,flerbarnsdager:n.flerbarnsdager?n.flerbarnsdager:!1,harSamtidigUttak:n.harSamtidigUttak?n.harSamtidigUttak:!1,samtidigUttaksprosent:n.samtidigUttaksprosent});Dr.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av perioder med permijon.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Nt=Pa(9),Ar=`${j}.${Se}`,X=e=>`${Ar}.${e}`,An=e=>()=>{const a=(e(`${Ar}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?_e(a):void 0},hn=(e,n,a)=>()=>{const t=e(`${X(n)}.periodeFom`),s=e(`${X(n)}.periodeTom`);return!s||!t?null:a?U(s)(t):_(t)(s)},Pt=(e,n)=>a=>e(`${X(n)}.arbeidskategoriType`)===be.ARBEIDSTAKER?k(a):void 0,Ot=e=>{if(e)return e.length===11?Dn(e):Nt(e)},jn={periodeFom:"",periodeTom:"",periodeForGradering:"",prosentandelArbeid:"",skalGraderes:!1},St=[be.ARBEIDSTAKER,be.SELVSTENDIG_NAERINGSDRIVENDE,be.FRILANSER],Tn=lr(100),It=e=>e.filter(({kode:n})=>on.some(a=>a===n)).map(({kode:n,navn:a})=>r.jsx("option",{value:n,children:a},n)),_t=e=>e.filter(({kode:n})=>St.some(a=>a===n)).map(({kode:n,navn:a})=>r.jsx("option",{value:n,children:a},n)),ra=({graderingKvoter:e,readOnly:n,arbeidskategoriTyper:a})=>{const t=F(),{watch:s,control:i,getValues:o,trigger:l,formState:{isSubmitted:d}}=A(),{fields:u,remove:p,append:g}=C({control:i,name:`${Ar}`}),y=s(`${Ar}`)||[];return h.useEffect(()=>{u.length===0&&g(jn)},[]),r.jsx(te,{fields:u,emptyPeriodTemplate:jn,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,remove:p,append:g,children:(v,b)=>{const{harSamtidigUttak:R,periodeFom:B}=y[b],O=B&&T(B,de).isBefore(T("2019-01-01"));return r.jsxs(Fe,{readOnly:n,remove:p,index:b,children:[r.jsx(Y,{name:`${X(b)}.periodeForGradering`,selectValues:It(e),label:t.formatMessage({id:"Registrering.Permisjon.Gradering.Periode"}),validate:[k]}),r.jsx(f,{label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),name:`${X(b)}.periodeFom`,validate:[k,c,hn(o,b,!0),An(o)],onChange:()=>d?l():void 0}),r.jsx(f,{label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),name:`${X(b)}.periodeTom`,validate:[k,c,hn(o,b,!1),An(o)],onChange:()=>d?l():void 0}),r.jsx(I,{label:r.jsx(m,{id:"Registrering.Permisjon.Gradering.Prosentandel"}),name:`${X(b)}.prosentandelArbeid`,validate:[k,zr,Tn],normalizeOnBlur:Qe=>Number.isNaN(Qe)?Qe:parseFloat(Qe.toString()).toFixed(2)}),r.jsx(I,{label:t.formatMessage({id:"Registrering.Permisjon.Orgnr"}),name:`${X(b)}.arbeidsgiverIdentifikator`,validate:[Pt(o,b),he,Ot]}),r.jsx(Y,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${X(b)}.arbeidskategoriType`,selectValues:_t(a),validate:[k],onChange:()=>d?l():void 0}),r.jsx(z,{name:`${X(b)}.skalGraderes`,label:r.jsx(m,{id:"Registrering.Permisjon.Gradering.SkalGraderes"})}),r.jsx(z,{readOnly:n,name:`${X(b)}.flerbarnsdager`,label:r.jsx(m,{id:"Registrering.Permisjon.Flerbarnsdager"})}),r.jsx(z,{name:`${X(b)}.harSamtidigUttak`,label:r.jsx(m,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),R&&r.jsx(I,{name:`${X(b)}.samtidigUttaksprosent`,validate:[k,zr,Tn],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"})}),O&&r.jsx(Er,{size:"small",variant:"warning",children:r.jsx(m,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},v.id)}})};ra.__docgenInfo={description:`RenderGraderingPeriodeFieldArray
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};class $t{constructor(n,a,t){ur(this,"fagsakYtelseType");ur(this,"familieHendelseType");ur(this,"foreldreType");this.fagsakYtelseType=Ur(n),n===Gn.SVANGERSKAPSPENGER?this.familieHendelseType=S.FODSEL:this.familieHendelseType=Ur(a),this.foreldreType=Ur(t)}getFagsakYtelseType(){return this.fagsakYtelseType}getFamilieHendelseType(){return this.familieHendelseType}getForeldreType(){return this.foreldreType}}const Ht=E(P),gn=({readOnly:e})=>r.jsx(J,{value:Ht,children:r.jsx(ae,{name:"erBarnetFodt",label:r.jsx(m,{id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[k],isReadOnly:e,isTrueOrFalseSelection:!0,radios:[{label:r.jsx(m,{id:"Registrering.TerminOgFodsel.ErFodt"}),value:"true"},{label:r.jsx(m,{id:"Registrering.TerminOgFodsel.ErIkkeFodt"}),value:"false"}]})});gn.__docgenInfo={description:"",methods:[],displayName:"ErBarnetFodt",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Sn=E(P);T.extend(Oa);T.extend(Sa);const In=Ln(1),_n=lr(9),hr=()=>T().subtract(5,"year"),ia=()=>T(),Yt=()=>T().subtract(5,"year"),Ct=()=>T().subtract(0,"year"),Pe=()=>T().subtract(5,"year"),Oe=()=>T().add(6,"months"),Jt=(e,n)=>{const a=e?T(e,de):void 0,t=T().startOf("day"),s=a!=null&&a.isValid()&&(a!=null&&a.isBefore(t))?a:t;return U(s)(n)},oa=(e,n)=>{const a=e?T(e,de):void 0,t=T(n,de);if(!(a!=null&&a.isValid())||!(t!=null&&t.isValid()))return null;const s=a.subtract(3,"weeks").subtract(1,"day"),i=a.add(5,"months").add(1,"day");return s.isSameOrAfter(t)?Sn.formatMessage({id:"ValidationMessage.ForTidligTermin"}):i.isSameOrBefore(t)?Sn.formatMessage({id:"ValidationMessage.ForSenTermin"}):null},oe=E(P),Xt=e=>n=>{const a=e("foedselsDato");return oa(a,n)},zt=e=>n=>{const a=e("termindato");return Jt(a,n)},pe=({readOnly:e,erForeldrepenger:n=!1})=>{const{watch:a,getValues:t}=A(),s=a("erBarnetFodt");return r.jsx(J,{value:oe,children:r.jsx(D,{children:r.jsxs(q,{gap:"4",children:[r.jsx(w,{size:"small",children:oe.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),r.jsx(gn,{readOnly:e}),s!==void 0&&r.jsxs(q,{gap:"4",children:[s===!1&&r.jsxs(r.Fragment,{children:[r.jsxs(K,{gap:"4",children:[r.jsx(f,{name:"termindato",label:oe.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:e,fromDate:Pe().toDate(),toDate:Oe().toDate(),defaultMonth:new Date,validate:[k,c,_(Pe()),U(Oe())]}),r.jsx(I,{name:"antallBarn",label:oe.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:e,parse:i=>{const o=parseInt(i.toString(),10);return isNaN(o)?i:o},validate:[k,he,In,_n]})]}),r.jsx(f,{name:"terminbekreftelseDato",label:oe.formatMessage({id:"Registrering.TerminOgFodsel.UtstedtDato"}),isReadOnly:e,fromDate:Yt().toDate(),toDate:Ct().toDate(),defaultMonth:new Date,validate:[c,zt(t)]})]}),s===!0&&r.jsxs(r.Fragment,{children:[r.jsxs(K,{gap:"4",children:[r.jsx(f,{name:"foedselsDato",label:oe.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:e,validate:[k,c,_(hr()),Ie],fromDate:hr().toDate(),toDate:ia().toDate()}),r.jsx(I,{name:"antallBarn",label:oe.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:e,parse:i=>{const o=parseInt(i.toString(),10);return Number.isNaN(o)?i:o},validate:[k,he,In,_n]})]}),n&&r.jsx(Er,{size:"small",variant:"info",children:r.jsx(fe,{size:"small",children:oe.formatMessage({id:"Registrering.TerminOgFodsel.RettTilPrematuruker"})})}),r.jsx(f,{name:"termindato",label:oe.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:e,validate:[c,_(Pe()),U(Oe()),Xt(t)],fromDate:Pe().toDate(),toDate:Oe().toDate(),defaultMonth:new Date})]})]})]})})})};pe.initialValues=()=>({erBarnetFodt:void 0});pe.transformValues=({antallBarn:e,erBarnetFodt:n,foedselsDato:a,termindato:t,terminbekreftelseDato:s})=>n?{erBarnetFodt:!0,termindato:t,foedselsDato:a,antallBarn:e}:{erBarnetFodt:!1,termindato:t,terminbekreftelseDato:s,antallBarnFraTerminbekreftelse:e};pe.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
