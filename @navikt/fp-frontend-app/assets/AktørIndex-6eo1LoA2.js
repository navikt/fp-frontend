import{j as e}from"./jsx-runtime-CLpGMVip.js";import{d as v,M as l,n as f,$ as q}from"./index.es--I8zRZCQ.js";import{u as c,h as j}from"./initFetch-CJQRkX56.js";import{V as w,m as R,P as I,h as x,W as A}from"./withPanelData-6WAhG8pN.js";import{K as k}from"./alleKodeverk-BFmIlMu4.js";import{R as F}from"./index-B8jnc8p3.js";import{V as T}from"./VisittkortSakIndex-BlBROW-3.js";import{E as K}from"./IngenBehandlingValgtPanel-P3NtMWKp.js";import{p as b}from"./paths-B-r4TiOp.js";import{u as S}from"./useTrackRouteParam-De6n8hDO.js";import{u as m}from"./useKodeverk-DbUC_m-y.js";const y=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:d})=>e.jsxs(e.Fragment,{children:[e.jsx(T,{bruker:n.person}),e.jsx(w,{gap:"2",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(s=>{var i,g;const a=(i=t.find(o=>o.kode===s.fagsakYtelseType))==null?void 0:i.navn,u=(g=r.find(o=>o.kode===s.status))==null?void 0:g.navn;return e.jsxs(F.Fragment,{children:[d(void 0,`${a} (${s.saksnummer}) ${u}`,s.saksnummer),e.jsx(v,{sixteenPx:!0})]},s.saksnummer)}):e.jsx(R,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});y.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
