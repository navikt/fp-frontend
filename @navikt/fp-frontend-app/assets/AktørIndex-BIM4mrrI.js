import{j as e}from"./jsx-runtime-BDPtolqC.js";import{V as f,H as q,P as c,B as j,_ as R}from"./alleKodeverk-B3AibkSl.js";import{g as w,M as y,n as I,H as x}from"./index.es-dGlS6Fbw.js";import{u as A,j as T}from"./initFetch-Ix2oJbRX.js";import"./aktivitetStatus-02fOJoqz.js";import{K as m}from"./kodeverkTyper-CavWL6Ds.js";import{R as F}from"./index-B54hSm9S.js";import{R as K,V as b}from"./VisittkortSakIndex-CSZENhBR.js";import{E as S}from"./IngenBehandlingValgtPanel-zGecvNxh.js";import{p as E}from"./paths-CeNa7t0Q.js";import{u as N}from"./useTrackRouteParam-BHDqBshG.js";import{u as l}from"./useKodeverk-CRXhM29t.js";const p=({aktorInfo:n,fagsakStatuser:s,fagsakYtelseTyper:a,renderSomLenke:t})=>{const i=n.fagsaker.length>0?n.fagsaker[0]:{relasjonsRolleType:K.MOR};return e.jsxs(e.Fragment,{children:[e.jsx(b,{fagsak:i,fagsakPersoner:{bruker:n.person}}),e.jsx(f,{gap:"2",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(r=>{var g,k;const d=(g=a.find(o=>o.kode===r.fagsakYtelseType))==null?void 0:g.navn,u=(k=s.find(o=>o.kode===r.status))==null?void 0:k.navn;return e.jsxs(F.Fragment,{children:[t(void 0,`${d} (${r.saksnummer}) ${u}`,r.saksnummer),e.jsx(w,{sixteenPx:!0})]},r.saksnummer)}):e.jsx(q,{size:"small",children:e.jsx(y,{id:"AktoerGrid.IngenFagsaker"})})})]})};p.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
