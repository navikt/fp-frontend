import{r as l,j as o}from"./iframe-CoSbPJjN.js";import{c as g}from"./index.es-oxwgCptE.js";import{i as y,A as p}from"./index-DGx2lYag.js";import{S as T}from"./SettPaVentModalIndex-Dw4oaQZ9.js";import{u as A}from"./behandlingApi-BA9w7Fez.js";const E=({behandling:e,kodeverk:t,opneSokeside:i,erTilbakekreving:u=!1,skalIkkeViseModal:n=!1})=>{const[s,r]=l.useState(!n&&e.behandlingPåVent),k=()=>r(!1),d=A(e),{mutate:v}=g({mutationFn:a=>d.oppdaterPåVent({...a,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>i()});l.useEffect(()=>{n||r(e.behandlingPåVent)},[e.versjon,n]);const m=e.aksjonspunkt.filter(a=>y(a.status)).some(a=>a.definisjon===p.AUTO_MANUELT_SATT_PÅ_VENT);return o.jsx(T,{submitCallback:v,cancelEvent:k,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:m,ventearsaker:t.Venteårsak,erTilbakekreving:u,showModal:s})};E.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
