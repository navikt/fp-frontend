import{j as e,a7 as K,bG as q,y as S,G as I,z as h,b as c,m as O,a8 as D,v as V}from"./iframe-C2Ehhb0j.js";import{a as A,O as x,A as F,M as L}from"./index.es-kaF6HHx-.js";import{b as M}from"./index-Bvx8nXnQ.js";import{V as U}from"./vilkarUtfallType-vN0hVpa7.js";import{b as j,V as T,H as m,B as v,a as $,D as z,L as N}from"./VStack-AuiruW1P.js";import{S as C}from"./Checkmark-BNDz8nb7.js";import{S as Y}from"./TotrinnskontrollIndex-B7JDr9oz.js";import{S as H,U as P,n as J}from"./index.es-Byvxle2F.js";import{S as X}from"./CheckmarkCircleFill-yvNhwtCW.js";import{S as W}from"./ExclamationmarkTriangleFill-K--advek.js";const Q="_begrunnelseTextField_hw8s7_6",Z={begrunnelseTextField:Q},y={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=c(y),ne=S(3),ae=I(2e3),se=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",re=n=>s=>s!==void 0||n,R=({readOnly:n,text:s,useAllWidth:a=!1,notRequired:r=!1})=>{const{formState:{isDirty:l},control:t}=A(),o=r?()=>!1:re(l);return e.jsx("div",{className:a?"":Z.begrunnelseTextField,children:e.jsx(x,{name:"begrunnelse",control:t,label:s??ee.formatMessage({id:se(n)}),validate:[q(o),ne,ae,h],maxLength:2e3,readOnly:n,parse:K})})},te=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";R.buildInitialValues=n=>({begrunnelse:O(te(n))});R.transformValues=n=>({begrunnelse:n.begrunnelse});R.__docgenInfo={description:`ProsessStegBegrunnelseTextField
