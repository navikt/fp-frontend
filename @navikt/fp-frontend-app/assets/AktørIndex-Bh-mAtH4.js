import{j as e,i as g,P as y,b as p,L as v}from"./iframe-BBDSkZ_h.js";import{X as f}from"./index.es-DsGrfFWK.js";import{u as q,r as j}from"./fagsakApi-uUpQ5VM4.js";import{V as c}from"./VisittkortSakIndex-C5XLriGR.js";import{V as w,a as I,B as T}from"./VStack-Cc-tSHU5.js";import{M as k}from"./message-CPNu86qJ.js";import{E as F}from"./IngenBehandlingValgtPanel-9vuzi77w.js";import{u as R}from"./useTrackRouteParam-D50JNSsW.js";import{p as E}from"./paths-CnYX9lKj.js";import{u as o}from"./useKodeverk-DcuiaP2p.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",level:"2",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
