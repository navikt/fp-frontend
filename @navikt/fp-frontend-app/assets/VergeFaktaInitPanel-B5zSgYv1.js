import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./index-mMUbb89k.js";import{u as f,f as c,a4 as h,a5 as B,a6 as E}from"./withPanelData-BiObwzXx.js";import{e as K}from"./index.es-DXcgUwHE.js";import{u as O}from"./fagsakApi-BwzO4WkW.js";import{V as S}from"./BehandlingMenuIndex-DXyVUn8K.js";import{A as V}from"./aksjonspunktCodes-BLM-Fgv6.js";import{u as P,h as _}from"./behandlingApi-sQK0gjyo.js";import{B as p}from"./FagsakIndex-CDVupykK.js";import{K as D}from"./index.es-Ibjkr2lw.js";import{S as F}from"./ExclamationmarkTriangleFill-BxOfsbPZ.js";import{i as v}from"./aksjonspunktStatus-xM4O_ZUY.js";import{e as M,g as N}from"./useStandardProsessPanelProps-SCvIItlt.js";const L=n=>{const[a,e]=d.useState([]),s=r=>{e(i=>{const t=[...i],g=t.findIndex(l=>l.id===r.id);return g>=0?t.splice(g,1,r):t.push(r),t}),n==null||n(r.harApneAksjonspunkter?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:a.filter(r=>r.skalVisesImeny),settFaktaPanelMenyData:s}},U="_container_610fz_1",I="_content_610fz_6",G="_sideMenu_610fz_14",y={container:U,content:I,sideMenu:G},H=({valgtFaktaSteg:n,valgtProsessSteg:a,setFaktaPanelMedÅpentApInfo:e,children:s})=>{const r=f(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(p),{faktaPanelMenyData:t,settFaktaPanelMenyData:g}=L(e),l=t.length>0;return o.jsxs(c,{className:y.container,wrap:!1,children:[l&&o.jsx("div",{className:y.sideMenu,"data-testid":"fakta-meny",children:o.jsx(D,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:t.map(u=>({label:u.tekst,active:u.erAktiv,icon:u.harApneAksjonspunkter?o.jsx(F,{color:"var(--a-orange-600)"}):void 0})),onClick:u=>{i(a,t[u].id)}})}),o.jsx("div",{className:y.content,children:o.jsx(x,{valgtFaktaSteg:n,settFaktaPanelMenyData:g,faktaPanelMenyData:t,children:s})})]})},q=d.createContext({}),x=n=>{const{children:a,...e}=n,s=d.useMemo(()=>e,[e]);return o.jsx(q.Provider,{value:s,children:a})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",C=(n,a,e,s)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:i}=d.use(q),t=e&&(r===n||s&&r===J);return d.useEffect(()=>{i({id:n,tekst:a,erAktiv:t,harApneAksjonspunkter:s,skalVisesImeny:e})},[e,t,s]),e&&t},j=({standardPanelProps:n,skalPanelVisesIMeny:a,faktaPanelKode:e,faktaPanelMenyTekst:s,children:r})=>{const{behandling:i,fagsak:t,alleKodeverk:g}=d.use(p),l=C(e,s,a,n.harApneAksjonspunkter);return o.jsx(h,{behandling:i,children:l?o.jsx(B,{behandling:i,fagsak:t,alleKodeverk:g,aksjonspunkterForPanel:n.aksjonspunkter,harÅpneAksjonspunkter:n.harApneAksjonspunkter,submitCallback:n.submitCallback,isReadOnly:n.readOnly,alleMerknaderFraBeslutter:n.alleMerknaderFraBeslutter,children:r}):null})};j.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
>`,elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}]}],raw:"FaktaAksjonspunkt[]"}]},name:"aksjonspunkterSomSkalLagres"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}},required:!0}},{key:"alleKodeverk",value:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
  alleKodeverk: AlleKodeverk;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",A="default",Y=(n,a,e,s,r,i)=>t=>{const l=(Array.isArray(t)?t:[t]).map(k=>({"@type":k.kode,...k})),u={saksnummer:n.saksnummer,behandlingUuid:a.uuid,behandlingVersjon:a.versjon};if(l&&r&&i){if(l.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(l[0].kode))return r({...u,overstyrteAksjonspunktDtoer:l}).then(()=>e(A,b))}return s({...u,bekreftedeAksjonspunktDtoer:l}).then(()=>e(A,b))},z=(n,a=[])=>{const{behandling:e,rettigheter:s,fagsak:r,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:t,oppdaterProsessStegOgFaktaPanelIUrl:g,alleKodeverk:l}=d.use(p),{aksjonspunkt:u}=e,k=u&&n?u.filter(m=>n.includes(m.definisjon)):[],T=M(e,[],s,!1),w=N(e.status,k),R=Y(r,e,g,i,t,a);return{behandling:e,submittable:!k.some(m=>v(m.status))||k.some(m=>m.kanLoses),harApneAksjonspunkter:k.some(m=>v(m.status)&&m.kanLoses),alleKodeverk:l,aksjonspunkter:k,readOnly:T,alleMerknaderFraBeslutter:w,submitCallback:R}},Q=[V.AVKLAR_VERGE],W=()=>{const n=f(),a=z(Q),{behandling:e}=d.use(p),s=P(e),r=_(e,"VERGE"),{data:i,isFetching:t}=O(s.vergeOptions(e,r));return o.jsx(j,{standardPanelProps:a,faktaPanelKode:E.VERGE,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:r,children:t?o.jsx(K,{}):o.jsx(S,{verge:i,alleKodeverk:a.alleKodeverk,submittable:a.submittable})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{H as F,W as V,j as a,z as u};
