...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const En=({saksnummer:e,fagsakMarkeringer:r,hentOgSettBehandling:a,lukkModal:n})=>{const t=Un(),i=ge(),o=ar(Q.FAGSAK_MARKERING).toSorted((u,d)=>u.navn.localeCompare(d.navn)),{mutate:l}=ne({mutationFn:u=>i.endreSakMarkering(u),onSuccess:()=>{a(),t.invalidateQueries({queryKey:[Dn.FETCH_FAGSAK]})}});return s.jsx(yn,{saksnummer:e,fagsakMarkeringer:r,endreFagsakMarkering:l,lukkModal:n,fagsakMarkeringerKodeverk:o})};En.__docgenInfo={description:"",methods:[],displayName:"EndreFagsakMarkeringMenyModal",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},fagsakMarkeringer:{required:!0,tsType:{name:"union",raw:"Saksmarkering[] | undefined",elements:[{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  fagsakMarkering: string;
  kortNavn?: string;
