...
Presentasjonskomponent. Har ansvar for å sette opp formen for att registrere verge.`,methods:[],displayName:"RegistrereVergeInfoPanel",props:{alleKodeverk:{required:!0,tsType:{name:"union",raw:"AlleKodeverk | AlleKodeverkTilbakekreving",elements:[{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<TilbakekrevingKodeverkType, KodeverkMedNavn[]>"}]},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const ur=pe($t),ff=u=>ur.formatMessage({id:u?"MenyVergeIndex.OpprettVerge":"MenyVergeIndex.FjernVerge"}),Lu=({verge:u,type:v,fjernVerge:i,opprettVerge:p,lukkModal:q,alleKodeverk:w})=>{const T=v==="FJERN",A=gr({defaultValues:an.buildInitialValues(u)}),B=S=>{T?i():p(an.transformValues(S)),q()},V=A.watch("vergeType");return bn.useEffect(()=>{u&&A.reset(an.buildInitialValues(u))},[u]),g.jsx(xe,{value:ur,children:g.jsx(dr,{formMethods:A,onSubmit:B,children:g.jsxs(ie,{open:!0,width:"small",onClose:q,"aria-label":ur.formatMessage({id:T?"MenyVergeIndex.FjernVergeSporsmal":"MenyVergeIndex.OpprettVergeSporsmal"}),children:[g.jsx(ie.Header,{closeButton:!0,children:g.jsx(Mr,{size:"medium",children:ur.formatMessage({id:T?"MenyVergeIndex.FjernVergeSporsmal":"MenyVergeIndex.OpprettVergeSporsmal"})})}),g.jsx(ie.Body,{children:g.jsx(an,{readOnly:T,vergetyper:w[De.VERGE_TYPE],valgtVergeType:V})}),g.jsxs(ie.Footer,{children:[g.jsx(Fe,{variant:"primary",size:"small",autoFocus:!0,type:"submit",children:ur.formatMessage({id:T?"MenyVergeIndex.Fjern":"MenyVergeIndex.Opprett"})}),g.jsx(Fe,{variant:"secondary",size:"small",onClick:q,type:"button",children:ur.formatMessage({id:"MenyVergeIndex.Avbryt"})})]})]})})})};Lu.__docgenInfo={description:"",methods:[],displayName:"MenyVergeIndex",props:{verge:{required:!0,tsType:{name:"union",raw:"Verge | undefined",elements:[{name:"intersection",raw:`{
  navn: string;
  gyldigFom: string;
  gyldigTom: string | null;
  vergeType: string;
