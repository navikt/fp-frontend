import{l as S,a6 as le,j as n,v as q,a7 as te,G as x,y as ie,z as se,a8 as ue,F as w,P as H,b as Y,r as I,n as oe,a9 as G,I as V}from"./iframe-DP0bw5r4.js";import{n as P,s as C,u as me,t as de,d as ge}from"./fagsakApi-C8JaXKR9.js";import{u as ke,D as ve,M,O as pe,c as K}from"./index.es-CGxM7siz.js";import{D as i}from"./dokumentMalType-B-Xou3xH.js";import{V as ye}from"./venteArsakType-BJdSFL9e.js";import{U as be}from"./UkjentAdresseMeldingIndex-CvAtGr4b.js";import{V as J,H as j,b as z,M as L,L as Ee}from"./VStack-B8bR5D8x.js";import{L as _e}from"./Link-H4fcV7It.js";import{M as T}from"./message-DCdiqgv1.js";import{S as Te}from"./CheckmarkCircleFill-B8DtgTPm.js";import{u as D}from"./useKodeverk-DmOlyg-L.js";import{S as he}from"./SupportHeader-D-R4H4r3.js";import{S as Ae}from"./SettPaVentReadOnlyModal-Bgz4to9-.js";import{A as Ve}from"./index.es-Bzt56NFd.js";var y=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(y||{});const fe="_bredde_jav4h_9",O={bredde:fe},Ne=x(4e3),Re=x(1e4),qe=ie(3),Q=({behandling:e,forhåndsvisBrev:a,submitCallback:t,revurderingVarslingArsak:d,fagsakYtelseType:g,kanVeilede:r,meldingFormData:s,setMeldingFormData:b,brukerManglerAdresse:_})=>{const o=S(),m=ke({defaultValues:s??Be(e)}),k=m.watch("brevmalkode"),E=m.watch("fritekst"),u=m.watch("arsakskode"),f=Se(d,g);if(!e.språkkode)return null;const{formState:h,control:v}=m,A=l=>{k&&E?a({brevmalkode:k,fritekst:E,arsakskode:u}):E||m.setError("fritekst",{type:"manual",message:o.formatMessage({id:"Messages.FritekstRequired"})}),l.preventDefault()},N=le(e.språkkode),p=k===i.VARSEL_OM_REVURDERING;return n.jsx(ve,{formMethods:m,onSubmit:l=>t(ce(l)),setDataOnUnmount:b,children:n.jsxs(J,{gap:"space-16",children:[n.jsx(M,{name:"brevmalkode",control:v,label:o.formatMessage({id:"Messages.Template"}),validate:[q],selectValues:e.brevmaler.map(l=>n.jsx("option",{value:l.kode,disabled:!l.tilgjengelig,children:l.navn},l.kode)),className:O.bredde}),p&&n.jsx(M,{name:"arsakskode",control:v,label:o.formatMessage({id:"Messages.Årsak"}),validate:[q],selectValues:f.map(l=>n.jsx("option",{value:l.kode,children:l.navn},l.kode)),className:O.bredde}),je(k,u)&&n.jsx(pe,{name:"fritekst",control:v,label:o.formatMessage({id:Ke(k)}),validate:[q,p?Re:Ne,qe,se],maxLength:p?1e4:4e3,badges:[{type:"info",titleText:N}],parse:te}),_&&n.jsx(be,{}),n.jsxs(j,{justify:"space-between",children:[(!p||p&&u!==void 0)&&n.jsx(_e,{href:"#",onClick:A,onKeyDown:l=>l.key==="Enter"?A(l):null,children:n.jsx(T,{id:"Messages.Preview"})}),n.jsx(z,{size:"small",variant:"primary",loading:h.isSubmitting,disabled:h.isSubmitting||r,onClick:ue,children:n.jsx(T,{id:"Messages.Submit"})})]})]})})},Ke=e=>e===i.INNHENTE_OPPLYSNINGER||e===i.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",je=(e,a)=>e===i.INNHENTE_OPPLYSNINGER||e===i.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===i.VARSEL_OM_TILBAKEKREVING||e===i.TBK_INNHENTE_OPPLYSNINGER||e===i.VARSEL_OM_REVURDERING&&a===y.ANNET,Se=(e,a)=>a===w.ENGANGSSTONAD?e.filter(t=>t.kode===y.BARN_IKKE_REGISTRERT_FOLKEREGISTER||t.kode===y.ANNET):a===w.SVANGERSKAPSPENGER?e.filter(t=>t.kode!==y.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&t.kode!==y.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Be=e=>{const a={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...a,brevmalkode:i.VARSEL_OM_REVURDERING}:{...a}},ce=e=>{const a=e;return e.brevmalkode===i.VARSEL_OM_REVURDERING&&a.arsakskode!==y.ANNET&&(a.fritekst=" "),a};Q.__docgenInfo={description:`Messages
...
| '-'`,elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean | null;
}>`}]},description:""}}};const we="_image_v04s1_1",Ie="_modal_v04s1_8",U={image:we,modal:Ie},X=({showModal:e,closeEvent:a})=>{const t=S();return n.jsx(L,{className:U.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:a,children:n.jsx(L.Body,{children:n.jsxs(j,{justify:"space-between",align:"center",children:[n.jsxs(j,{gap:"space-8",align:"center",children:[n.jsx(Te,{className:U.image,title:t.formatMessage({id:"MessagesModal.description"})}),n.jsx(Ee,{size:"small",children:n.jsx(T,{id:"MessagesModal.text"})})]}),n.jsx(z,{size:"small",variant:"primary",onClick:a,autoFocus:!0,type:"button",children:n.jsx(T,{id:"MessagesModal.OK"})})]})})})};X.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Ge=Y($),Z=e=>n.jsx(H,{value:Ge,children:n.jsx(X,{...e})});Z.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Pe=e=>e.behandlingPåVent?e.fristBehandlingPåVent:null,Me=({fagsakData:e,valgtBehandlingUuid:a,meldingFormData:t,setMeldingFormData:d,hentOgSettBehandling:g,toggleVisUtvidetBehandlingDetaljerKnapp:r})=>{const s=S(),[b,_]=I.useState(!1),[o,m]=I.useState(!1),k=oe(),E=e.getFagsak(),u=P(e.getBehandling(a)),f=C(u),h=me(ge()),{innloggetBruker:{kanVeilede:v}}=P(h.data),A=D("Venteårsak")||[],N=D("RevurderingVarslingÅrsak"),{mutateAsync:p,status:l}=K({mutationFn:R=>f.sendMelding(R)}),ee=Le(m,p,g,_,d,u),ne=()=>{k("/")},ae=Oe(u),re=()=>(m(!1),g()),B=l==="success",c=u.behandlingTillatteOperasjoner,F=!v&&e.getAlleBehandlinger().some(R=>!R.avsluttet)&&c?.behandlingKanSendeMelding;return n.jsxs(n.Fragment,{children:[o&&n.jsx(Z,{showModal:B&&o,closeEvent:re}),n.jsx(he,{tekst:s.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:r,children:n.jsxs(J,{gap:"space-16",children:[!F&&n.jsx(Ve,{variant:"info",children:n.jsx(T,{id:De(v,c?.behandlingKanSendeMelding)})}),F&&n.jsx(W,{submitCallback:ee,behandling:u,forhåndsvisBrev:ae,revurderingVarslingArsak:N,fagsakYtelseType:E.fagsakYtelseType,kanVeilede:v,meldingFormData:t,setMeldingFormData:d,brukerManglerAdresse:E.brukerManglerAdresse})]})}),B&&b&&n.jsx(Ae,{lukkCallback:ne,ventearsak:ye.AVV_DOK,ventearsaker:A,frist:Pe(u)})]})},Le=(e,a,t,d,g,r)=>s=>{const b=s.brevmalkode===i.INNHENTE_OPPLYSNINGER||s.brevmalkode===i.VARSEL_OM_REVURDERING||s.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,_=V.TILBAKEKREVING===r.type||V.TILBAKEKREVING_REVURDERING===r.type;e(!b);const o=_?{behandlingUuid:r.uuid,fritekst:s.fritekst,brevmalkode:s.brevmalkode}:{behandlingUuid:r.uuid,brevmalkode:s.brevmalkode,fritekst:s.fritekst,arsakskode:s.arsakskode};return a(o).then(()=>{g(),b?d(!0):t()})},De=(e,a)=>a?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Oe=e=>{const a=C(e),{mutate:t}=K({mutationFn:r=>a.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:r.brevmalkode,fritekst:r.fritekst||" ",arsakskode:r.arsakskode}),onSuccess:r=>{G(r)}}),{mutate:d}=K({mutationFn:r=>de(e.uuid,r.brevmalkode,r.fritekst??" "),onSuccess:r=>{G(r)}}),g=V.TILBAKEKREVING===e.type||V.TILBAKEKREVING_REVURDERING===e.type;return r=>{g?d(r):t(r)}};Me.__docgenInfo={description:`MeldingIndex
...
Har ansvar for å hente mottakere og brevmaler fra serveren.`,methods:[],displayName:"MeldingIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},meldingFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  fritekst?: string;
  arsakskode?: string;
}`,signature:{properties:[{key:"brevmalkode",value:{name:"string",required:!1}},{key:"fritekst",value:{name:"string",required:!1}},{key:"arsakskode",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{Me as M,y as R};
