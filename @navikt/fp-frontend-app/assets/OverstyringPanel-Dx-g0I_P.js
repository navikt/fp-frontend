import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as _,N as q,r as I,b as S,o as B,c as x,E as O,e as j,M as w,Y as K}from"./index.es-DY6WDHLL.js";import{F as D,r as v,C as F,S as L,c as M,G as h,o as U}from"./index.es-BOpbI0BI.js";import{r as z}from"./index-mMUbb89k.js";import{A as C}from"./aksjonspunktStatus-xM4O_ZUY.js";import{h as T,V as E,f as m,g as p,H as $,E as Y,L as N}from"./withPanelData-CrlnTImC.js";import{V as H}from"./BehandlingHenlagtPanel-DgBMqhS8.js";import{S as J}from"./TotrinnskontrollIndex-BlWUAvNw.js";import{S as X}from"./CheckmarkCircleFill-BfcMLWRn.js";import{S as W}from"./ExclamationmarkTriangleFill-BMC9rths.js";const Q="_begrunnelseTextField_hw8s7_6",Z={begrunnelseTextField:Q},c={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=v(c),ne=S(3),re=B(2e3),se=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ae=n=>s=>s!==void 0||n,V=({readOnly:n,text:s,useAllWidth:r=!1,notRequired:a=!1})=>{const{formState:{isDirty:l}}=_(),t=a?()=>!1:ae(l);return e.jsx("div",{className:r?"":Z.begrunnelseTextField,children:e.jsx(q,{name:"begrunnelse",label:s??ee.formatMessage({id:se(n)}),validate:[I(t),ne,re,x],maxLength:2e3,readOnly:n,parse:D})})},te=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";V.buildInitialValues=n=>({begrunnelse:F(te(n))});V.transformValues=n=>({begrunnelse:n.begrunnelse});V.__docgenInfo={description:`ProsessStegBegrunnelseTextField
