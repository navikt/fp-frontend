import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as h,u as R,n as w}from"./fagsakApi-GpheZX3v.js";import{a as S,N as K,A as f,v as b,u as M}from"./index.es-cagrzevs.js";import{u as O,k as P,r as V,t as U}from"./withThemeDecorator-zwF_VyQA.js";import{T as i}from"./Table-ByToo0Jy.js";import{M as d}from"./message-qvfAPF2U.js";import{V as B,B as g,a as p,b as H}from"./VStack-BYX9WX4q.js";import"./index-mMUbb89k.js";import{S as x}from"./ExclamationmarkTriangleFill-DcC5p28j.js";import{p as Y}from"./paths-NmmZRYgu.js";import{b as I}from"./index-BVlhR-8X.js";const q=({fagsaker:r,selectFagsakCallback:n,alleKodeverk:t})=>e.jsxs(i,{children:[e.jsx(i.Header,{children:e.jsxs(i.Row,{children:[e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FagsakList.Saksnummer"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FagsakList.Sakstype"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FagsakList.Status"})})]})}),e.jsx(i.Body,{children:r.map(a=>{var s,l;return e.jsxs(i.Row,{onMouseDown:()=>n(a.saksnummer),onKeyDown:()=>n(a.saksnummer),children:[e.jsx(i.DataCell,{children:a.saksnummer}),e.jsx(i.DataCell,{children:((s=t.FagsakYtelseType.find(u=>u.kode===a.fagsakYtelseType))==null?void 0:s.navn)??""}),e.jsx(i.DataCell,{children:((l=t.FagsakStatus.find(u=>u.kode===a.status))==null?void 0:l.navn)??""})]},a.saksnummer)})})]});q.__docgenInfo={description:`FagsakList
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const E="_container_74un9_1",N="_advarselIcon_74un9_6",v={container:E,advarselIcon:N},G=(r,n)=>!!(r||n===void 0||n.length<1),A=({searchStarted:r,searchResultAccessDenied:n,searchFagsakCallback:t})=>{const a=O(),s=S({defaultValues:{searchString:""}}),l=s.watch("searchString");return e.jsx(K,{formMethods:s,onSubmit:t,className:v.container,children:e.jsxs(B,{gap:"2",children:[e.jsx(g,{size:"small",children:e.jsx(d,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(p,{gap:"2",align:"end",children:[e.jsx(f,{name:"searchString",label:a.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[b]}),e.jsx(H,{variant:"primary",size:"small",loading:r,disabled:G(r,l),children:e.jsx(d,{id:"Search.Search"})})]}),n&&e.jsxs(p,{gap:"2",align:"end",children:[e.jsx(x,{className:v.advarselIcon}),e.jsx(g,{size:"small",children:e.jsx(d,{id:n.feilmelding})})]})]})})};A.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const L="_container_gwama_1",D="_label_gwama_9",T={container:L,label:D},c=({fagsaker:r,searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:a,searchStarted:s,searchResultAccessDenied:l,alleKodeverk:u})=>e.jsxs("div",{className:T.container,children:[e.jsx(A,{searchFagsakCallback:n,searchStarted:s,searchResultAccessDenied:l}),t&&r.length===0&&e.jsx(g,{size:"small",className:T.label,children:e.jsx(d,{id:"FagsakSearch.ZeroSearchResults"})}),t&&r.length>1&&e.jsx(q,{fagsaker:r,selectFagsakCallback:a,alleKodeverk:u})]});c.__docgenInfo={description:`FagsakSearch
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const _={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},C=V(_),F=({fagsaker:r=[],searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:a,searchStarted:s=!1,searchResultAccessDenied:l,alleKodeverk:u})=>e.jsx(P,{value:C,children:e.jsx(c,{fagsaker:r,searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:a,searchStarted:s,searchResultAccessDenied:l,alleKodeverk:u})});F.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  status: FagsakStatus;
  aktørId: string;
