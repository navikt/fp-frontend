...
Statisk visning av tittel i utvidbart panel dersom faresignaler er funnet.`,methods:[],displayName:"HoyRisikoTittel",props:{risikoklassifisering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const ae=()=>s.jsx(J,{background:"surface-success-subtle",borderRadius:"large",padding:"3",children:s.jsxs(V,{gap:"4",align:"center",children:[s.jsx(Oe,{title:x().formatMessage({id:"Risikopanel.Tittel"}),height:24,width:24,color:"var(--a-surface-success)"}),s.jsx(q,{size:"small",children:s.jsx(f,{id:"Risikopanel.Tittel.IngenFaresignaler"})})]})});ae.__docgenInfo={description:`IngenRisikoPanel

Statisk visning av panel som tilsier ingen faresignaler funnet i behandlingen.`,methods:[],displayName:"IngenRisikoPanel"};const te=()=>s.jsx(J,{borderWidth:"2",borderColor:"border-divider",borderRadius:"large",padding:"3",children:s.jsxs(V,{gap:"4",align:"center",children:[s.jsx(Pe,{title:x().formatMessage({id:"Risikopanel.Tittel"}),color:"var(--a-gray-600)",height:24,width:24}),s.jsx(q,{size:"small",children:s.jsx(f,{id:"Risikopanel.Tittel.ManglerKlassifisering"})})]})});te.__docgenInfo={description:`ManglendeKlassifiseringPanel
...
om klassifisering er utført og ingen faresignaler er funnet og om klassifisering er utført og faresignaler er funnet`,methods:[],displayName:"RisikoklassifiseringSakIndex",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const un=({fagsakData:e,behandling:r,setBehandling:t})=>{const n=e.getFagsak(),{selected:a=!1}=xe({paramName:"risiko",parse:u=>u==="true",isQueryParam:!0}),i=Y(),l=$(),o=()=>{i(I(l)(!a))},{kodeverkOptions:m}=M(),{data:d}=T(m()),p=e.getBehandling(r==null?void 0:r.uuid);return r&&p?s.jsx(gn,{isRiskPanelOpen:a,fagsak:n,toggleRiskPanel:o,behandlingAppKontekst:p,behandling:r,setBehandling:t}):s.jsx(S,{risikoklassifisering:n.kontrollResultat,isPanelOpen:a,readOnly:!0,toggleRiskPanel:o,faresignalVurderinger:w(d)[Q.FARESIGNAL_VURDERING]})},gn=({fagsak:e,behandling:r,behandlingAppKontekst:t,setBehandling:n,toggleRiskPanel:a,isRiskPanelOpen:i})=>{const{behandlingPåVent:l,status:o,type:m,risikoAksjonspunkt:d,kontrollResultat:p}=t,{kodeverkOptions:u}=M(),b=T(ge()),{data:se}=T(u()),_=w(b.data).innloggetBruker,ie=Xe(_,e.status,o,m),le=dn(_,ie,l),K=Y(),G=$();g.useEffect(()=>{d&&d.status===N.OPPRETTET&&!i&&K(I(G)(!0)),d&&d.status===N.UTFORT&&K(I(G)(!1))},[!!d,r.uuid,r.versjon]);const{lagreAksjonspunkter:oe}=Ve(r,n),ue=L=>{oe({behandlingUuid:r.uuid,behandlingVersjon:r.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":L.kode,...L}]})};return s.jsx(S,{aksjonspunkt:d,risikoklassifisering:p,isPanelOpen:i,readOnly:le,submitAksjonspunkt:ue,toggleRiskPanel:a,faresignalVurderinger:w(se)[Q.FARESIGNAL_VURDERING]})},dn=(e,r,t)=>{if(t)return!0;const{kanSaksbehandle:n}=e;return!n||!r.writeAccess.isEnabled};un.__docgenInfo={description:`RisikoklassifiseringIndex
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""}}};export{v as E,O as K,un as R,Pe as S,Xe as g};
