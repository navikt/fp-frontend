import{r as d,l as A,j as s,bG as f,bH as q,bi as S}from"./iframe-CBp6UAcl.js";import{Q as V}from"./index.es-DfkfMcvK.js";import{u as j}from"./fagsakApi-nE7xbCgC.js";import{V as I}from"./BehandlingMenuIndex-Cb9k-T1Y.js";import{i as E,A as L}from"./index-CwkFZ1m1.js";import{u as P,c as D}from"./behandlingApi-C4ZPNzyn.js";import{B as v}from"./FagsakIndex-DvMFCsK-.js";import{W as F}from"./index.es-B54-0bfO.js";import{H as w}from"./VStack-BqsKaB0k.js";import{S as O}from"./ExclamationmarkTriangleFill-By1-ETC_.js";import{e as B,g as G}from"./useStandardProsessPanelProps-B3IP7w3i.js";const h=a=>{const[l,e]=d.useState([]),t=n=>{e(i=>{const r=[...i],m=r.findIndex(u=>u.id===n.id);return m>=0?r.splice(m,1,n):r.push(n),r}),a?.(n.harApneAksjonspunkter?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:l.filter(n=>n.skalVisesImeny),settFaktaPanelMenyData:t}},c="_container_4o186_1",M="_content_4o186_6",U="_sideMenu_4o186_19",p={container:c,content:M,sideMenu:U},H=({valgtFaktaSteg:a,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const n=A(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(v),{faktaPanelMenyData:r,settFaktaPanelMenyData:m}=h(e),u=r.length>0;return s.jsxs(w,{className:p.container,wrap:!1,children:[u&&s.jsx("div",{className:p.sideMenu,"data-testid":"fakta-meny",children:s.jsx(F,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?s.jsx(O,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(l,r[o].id)}})}),s.jsx("div",{className:p.content,children:s.jsx(Y,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:r,children:t})})]})},_=d.createContext({}),Y=a=>{const{children:l,...e}=a,t=d.useMemo(()=>e,[e]);return s.jsx(_.Provider,{value:t,children:l})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",x=(a,l,e,t)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:i}=d.use(_),r=e&&(n===a||t&&n===J);return d.useEffect(()=>{i({id:a,tekst:l,erAktiv:r,harApneAksjonspunkter:t,skalVisesImeny:e})},[e,r,t]),e&&r},b=({standardPanelProps:a,skalPanelVisesIMeny:l,faktaPanelKode:e,faktaPanelMenyTekst:t,children:n})=>{const{behandling:i,fagsak:r,alleKodeverk:m}=d.use(v),u=x(e,t,l,a.harÅpneAksjonspunkter);return s.jsx(f,{behandling:i,children:u?s.jsx(q,{behandling:i,fagsak:r,alleKodeverk:m,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpneAksjonspunkter:a.harÅpneAksjonspunkter,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,children:n}):null})};b.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'OVST'
| 'SAOV'
| '-'`,elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"isReadOnly",value:{name:"boolean",required:!0}},{key:"submittable",value:{name:"boolean",required:!0}},{key:"harÅpneAksjonspunkter",value:{name:"boolean",required:!0}},{key:"submitCallback",value:{name:"signature",type:"function",raw:"(aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>",signature:{arguments:[{type:{name:"union",raw:"FaktaAksjonspunkt | FaktaAksjonspunkt[]",elements:[{name:"union",raw:`| AvklarVergeAp
...
| 'ANNEN_PERMISJON'`,elements:[{name:"literal",value:"'-'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'PERMITTERING'"},{name:"literal",value:"'ANNEN_PERMISJON'"}],required:!0}}]},required:!0}}]}}],raw:"Array<tjenester_behandling_uttak_dokumentasjon_DokumentasjonVurderingBehovDto_AktivitetskravGrunnlagArbeid>",required:!1}}]}}],raw:"DokumentasjonVurderingBehov[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpneAksjonspunkter: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const y="default",T="default",C=(a,l,e,t,n,i)=>r=>{const u=(Array.isArray(r)?r:[r]).map(g=>({"@type":g.kode,...g})),o={saksnummer:a.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(u&&n&&i){if(u.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return n({...o,overstyrteAksjonspunktDtoer:u}).then(()=>e(T,y))}return t({...o,bekreftedeAksjonspunktDtoer:u}).then(()=>e(T,y))},Q=(a,l=[])=>{const{behandling:e,rettigheter:t,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=d.use(v),{aksjonspunkt:o}=e,g=o&&a?o.filter(k=>a.includes(k.definisjon)):[],R=B(e,[],t,!1),N=G(e.status,g),K=C(n,e,m,i,r,l);return{behandling:e,submittable:!g.some(k=>E(k.status))||g.some(k=>k.kanLoses),harÅpneAksjonspunkter:g.some(k=>E(k.status)&&k.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:g,isReadOnly:R,alleMerknaderFraBeslutter:N,submitCallback:K}},W=[L.AVKLAR_VERGE],z=()=>{const a=A(),l=Q(W),{behandling:e}=d.use(v),t=P(e),n=D(e,"VERGE"),{data:i,isFetching:r}=j(t.vergeOptions(e,n));return s.jsx(b,{standardPanelProps:l,faktaPanelKode:S.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?s.jsx(V,{}):s.jsx(I,{verge:i,alleKodeverk:l.alleKodeverk,submittable:l.submittable})})};z.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{b as F,z as V,H as a,Q as u};
