...
er satt til Iverksetter vedtak. Ved å trykke på knapp blir saksbehandler tatt tilbake til sokesiden.`,methods:[],displayName:"HenlagtBehandlingModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const BE="_modal_osiwa_1",SE="_button_osiwa_5",KE="_selectWidth_osiwa_9",Pa={modal:BE,button:SE,selectWidth:KE},wE=_s(1500),cu=(o,p,s)=>h=>{o({behandlingUuid:p,dokumentMal:jT.INFO_OM_HENLEGGELSE,fritekst:s}),h.preventDefault()},Yu=(o,p)=>x.TILBAKEKREVING_REVURDERING===o&&oe.HENLAGT_FEILOPPRETTET_MED_BREV===p,jE=(o,p,s,h)=>Yu(o,p)?!(p&&s&&h):!(p&&s),IE=(o,p,s)=>o===x.TILBAKEKREVING?oe.HENLAGT_FEILOPPRETTET===p:o===x.TILBAKEKREVING_REVURDERING?oe.HENLAGT_FEILOPPRETTET_MED_BREV===p&&!!s:[oe.HENLAGT_SOKNAD_TRUKKET,oe.HENLAGT_KLAGE_TRUKKET,oe.HENLAGT_INNSYN_TRUKKET].some(h=>h===p),GE={[x.KLAGE]:[oe.HENLAGT_KLAGE_TRUKKET,oe.HENLAGT_FEILOPPRETTET],[x.ANKE]:[oe.HENLAGT_ANKE_TRUKKET,oe.HENLAGT_FEILOPPRETTET],[x.DOKUMENTINNSYN]:[oe.HENLAGT_INNSYN_TRUKKET,oe.HENLAGT_FEILOPPRETTET],[x.TILBAKEKREVING]:[Da.HENLAGT_FEILOPPRETTET],[x.TILBAKEKREVING_REVURDERING]:[Da.HENLAGT_FEILOPPRETTET_MED_BREV,Da.HENLAGT_FEILOPPRETTET_UTEN_BREV],[x.REVURDERING]:[oe.HENLAGT_SOKNAD_TRUKKET,oe.HENLAGT_FEILOPPRETTET,oe.HENLAGT_SOKNAD_MANGLER],[x.FORSTEGANGSSOKNAD]:[oe.HENLAGT_SOKNAD_TRUKKET,oe.HENLAGT_FEILOPPRETTET,oe.HENLAGT_SOKNAD_MANGLER]},FE=(o,p,s)=>GE[p].filter(b=>s!==Ua.ENGANGSSTONAD||s===Ua.ENGANGSSTONAD&&b!==oe.HENLAGT_SOKNAD_MANGLER).flatMap(b=>{const A=o.find(R=>R.kode===b);return A?[A]:[]}),Cu=({handleSubmit:o,cancelEvent:p,forhandsvisHenleggBehandling:s,behandlingUuid:h,ytelseType:b,behandlingType:A,behandlingResultatTyper:R})=>{const c=ir(),_=ur(),w=_.watch("årsakKode"),j=_.watch("begrunnelse"),F=_.watch("fritekst"),te=IE(A,w,F),X=FE(R,A,b);return d.jsx(or,{formMethods:_,onSubmit:o,children:d.jsxs(ae,{className:Pa.modal,open:!0,"aria-label":c.formatMessage({id:"HenleggBehandlingModal.ModalDescription"}),onClose:p,children:[d.jsx(ae.Header,{children:d.jsx(Pr,{size:"small",children:d.jsx(J,{id:"HenleggBehandlingModal.HenleggBehandling"})})}),d.jsx(ae.Body,{children:d.jsxs(Tn,{gap:"4",children:[d.jsx(Or,{name:"årsakKode",control:_.control,className:Pa.selectWidth,label:c.formatMessage({id:"HenleggBehandlingModal.ArsakField"}),validate:[ce],selectValues:X.map(me=>d.jsx("option",{value:me.kode,children:c.formatMessage({id:me.kode})},me.kode))}),d.jsx(xa,{name:"begrunnelse",control:_.control,label:c.formatMessage({id:"HenleggBehandlingModal.BegrunnelseField"}),validate:[ce,wE,La],maxLength:1500}),Yu(A,w)&&d.jsx("div",{className:Pa.fritekstTilBrevTextArea,children:d.jsx(xa,{name:"fritekst",control:_.control,label:c.formatMessage({id:"HenleggBehandlingModal.Fritekst"}),validate:[ce,La],maxLength:2e3,parse:pT})}),te&&d.jsxs(Vn,{justify:"space-between",children:[d.jsx(Ja,{size:"small",children:c.formatMessage({id:"HenleggBehandlingModal.SokerInformeres"})}),d.jsx(IT,{href:"#",onClick:cu(s,h,F),onKeyDown:cu(s,h,F),children:d.jsx(J,{id:"HenleggBehandlingModal.ForhandsvisBrev"})})]})]})}),d.jsxs(ae.Footer,{children:[d.jsx(je,{variant:"primary",size:"small",className:Pa.button,disabled:jE(A,w,j,F),children:d.jsx(J,{id:"HenleggBehandlingModal.HenleggBehandlingSubmit"})}),d.jsx(je,{variant:"secondary",size:"small",onClick:p,type:"button",children:d.jsx(J,{id:"HenleggBehandlingModal.Avbryt"})})]})]})})};Cu.__docgenInfo={description:`HenleggBehandlingModal
