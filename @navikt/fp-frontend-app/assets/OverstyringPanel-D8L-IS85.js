import{j as e}from"./index-nufLo1NJ.js";import{c as j,D as q,n as B,r as S,b as I,y as h,E as G,e as _,M as w,Y as O}from"./index.es-CmV-Vl-v.js";import{af as D,a1 as v,ar as F,h as b,V as E,f as m,g as p,H as L,K as M,L as V}from"./withPanelData-BscNDdOr.js";import{r as U}from"./index-mMUbb89k.js";import{a as z}from"./index-Dyi8laJ0.js";import{V as Y}from"./vilkarUtfallType-vN0hVpa7.js";import{S as $}from"./Checkmark-C2PF80cw.js";import{S as C}from"./TotrinnskontrollIndex-BTrHAOhl.js";import{S as H,K as x,i as J}from"./index.es-DjkJlD88.js";import{S as X}from"./CheckmarkCircleFill-BxAWzD58.js";import{S as W}from"./ExclamationmarkTriangleFill-DQAOjWRr.js";const Q="_begrunnelseTextField_hw8s7_6",Z={begrunnelseTextField:Q},c={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=v(c),ne=S(3),se=I(2e3),ae=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",re=n=>a=>a!==void 0||n,N=({readOnly:n,text:a,useAllWidth:s=!1,notRequired:r=!1})=>{const{formState:{isDirty:l}}=j(),t=r?()=>!1:re(l);return e.jsx("div",{className:s?"":Z.begrunnelseTextField,children:e.jsx(q,{name:"begrunnelse",label:a??ee.formatMessage({id:ae(n)}),validate:[B(t),ne,se,h],maxLength:2e3,readOnly:n,parse:D})})},te=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";N.buildInitialValues=n=>({begrunnelse:F(te(n))});N.transformValues=n=>({begrunnelse:n.begrunnelse});N.__docgenInfo={description:`ProsessStegBegrunnelseTextField
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Avslagsårsak'>[]"},description:""},customVilkarIkkeOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},customVilkarOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},skalKunneInnvilge:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},validatorsForRadioOptions:{required:!1,tsType:{name:"Array",elements:[{name:"unknown"}],raw:"((value: boolean) => string | null | undefined)[]"},description:""}}};const pe="_vilkar_t9zom_1",ve="_aksjonspunktMargin_t9zom_5",ce="_godkjentImage_t9zom_10",ye="_avslattImage_t9zom_16",y={vilkar:pe,aksjonspunktMargin:ve,godkjentImage:ce,avslattImage:ye},f=v(c),Ee=({lovReferanse:n,title:a,originalErVilkarOk:s,isAksjonspunktOpen:r,readOnlySubmitButton:l,readOnly:t,rendreFakta:o,isDirty:k,erIkkeGodkjentAvBeslutter:i,isSubmitting:g,children:u})=>e.jsxs(E,{gap:"4",children:[e.jsxs(m,{gap:"2",children:[s!==void 0&&e.jsxs(e.Fragment,{children:[s&&e.jsx(X,{className:y.godkjentImage}),!s&&e.jsx(H,{className:y.avslattImage})]}),e.jsx(L,{size:"small",children:a}),n&&e.jsx(M,{className:y.vilkar,children:n})]}),e.jsxs(m,{gap:"2",children:[s&&e.jsx(V,{size:"small",children:f.formatMessage({id:"ProsessPanelTemplate.ErOppfylt"})}),s===!1&&e.jsx(V,{size:"small",children:f.formatMessage({id:"ProsessPanelTemplate.ErIkkeOppfylt"})}),!r&&s===void 0&&e.jsx(p,{size:"small",children:f.formatMessage({id:"ProsessPanelTemplate.IkkeBehandlet"})})]}),e.jsx(x,{className:y.aksjonspunktMargin,erAksjonspunktApent:r,erIkkeGodkjentAvBeslutter:i,children:e.jsxs(E,{gap:"4",children:[e.jsx("div",{children:u}),e.jsx(P,{isReadOnly:t,isSubmittable:!l,isDirty:k,isSubmitting:g})]})}),o==null?void 0:o()]});Ee.__docgenInfo={description:"",methods:[],displayName:"ProsessPanelTemplate",props:{title:{required:!0,tsType:{name:"string"},description:""},lovReferanse:{required:!1,tsType:{name:"string"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},originalErVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},rendreFakta:{required:!1,tsType:{name:"signature",type:"function",raw:"() => ReactNode",signature:{arguments:[],return:{name:"ReactNode"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Te="_aksjonspunktMargin_pxm8x_1",fe="_exclamationmarkIcon_pxm8x_6",R={aksjonspunktMargin:Te,exclamationmarkIcon:fe},d=v(c),be=S(3),Ve=I(1500),je=n=>a=>a!==void 0||n,Ne=({erOverstyrt:n,isSolvable:a,erVilkarOk:s,hasAksjonspunkt:r,overrideReadOnly:l,isSubmitting:t,isPristine:o,toggleAv:k,erIkkeGodkjentAvBeslutter:i,children:g})=>{const{formState:{isDirty:u}}=j(),K=je(u);return e.jsx(x,{className:R.aksjonspunktMargin,erAksjonspunktApent:n,erIkkeGodkjentAvBeslutter:i,children:e.jsxs(E,{gap:"4",children:[e.jsx(V,{size:"medium",children:d.formatMessage({id:"OverstyringPanel.AutomatiskVurdering"})}),e.jsx("div",{children:g}),(n||r)&&e.jsx(q,{name:"begrunnelse",label:d.formatMessage({id:"OverstyringPanel.Vilkar"}),validate:[K,be,Ve,h],maxLength:1500,readOnly:l||!n}),!n&&s!==void 0&&e.jsxs(m,{gap:"2",children:[e.jsx(J,{}),e.jsx(p,{size:"small",children:d.formatMessage({id:"OverstyringPanel.Endret"})})]}),n&&e.jsxs(e.Fragment,{children:[e.jsxs(m,{gap:"2",children:[e.jsx(W,{className:R.exclamationmarkIcon}),e.jsx(p,{size:"small",children:d.formatMessage({id:"OverstyringPanel.Unntakstilfeller"})})]}),e.jsxs(m,{gap:"2",children:[!l&&e.jsx(b,{size:"small",variant:"primary",loading:t,disabled:t||!a||o,children:d.formatMessage({id:"OverstyringPanel.ConfirmInformation"})}),e.jsx(b,{size:"small",variant:"secondary",loading:t,disabled:t,onClick:k,type:"button",children:d.formatMessage({id:"OverstyringPanel.Avbryt"})})]})]})]})})};Ne.__docgenInfo={description:"",methods:[],displayName:"OverstyringPanel",props:{erOverstyrt:{required:!0,tsType:{name:"boolean"},description:""},isSolvable:{required:!0,tsType:{name:"boolean"},description:""},erVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},hasAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},overrideReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isPristine:{required:!0,tsType:{name:"boolean"},description:""},toggleAv:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};export{Ne as O,N as P,A as V,P as a,Ee as b};
