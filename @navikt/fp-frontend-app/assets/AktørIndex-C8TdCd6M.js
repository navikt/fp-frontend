import{j as e,i as g,P as y,b as p,L as v}from"./iframe-DXT16xPG.js";import{X as f}from"./index.es-DND9XIpe.js";import{u as q,r as j}from"./fagsakApi-BJbAnKwV.js";import{V as c}from"./VisittkortSakIndex-B-zXOpyG.js";import{V as w,a as I,B as T}from"./VStack-Cs3eHoBQ.js";import{M as k}from"./message-4YC-GSXH.js";import{E as F}from"./IngenBehandlingValgtPanel-B0piDUwu.js";import{u as R}from"./useTrackRouteParam-7KrBstI3.js";import{p as E}from"./paths-CNwQMMIY.js";import{u as o}from"./useKodeverk-M5Jyo9g9.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",level:"2",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
