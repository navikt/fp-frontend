import{r as g,k as T,j as u,aD as E,aE as K,ax as h}from"./iframe-DAcOOZqk.js";import{X as c}from"./index.es-CjqG00-O.js";import{u as B}from"./fagsakApi-B1981UXF.js";import{V}from"./BehandlingMenuIndex-euhZF0m9.js";import{i as v,A as S}from"./index-B2w3P7d3.js";import{u as O,c as _}from"./behandlingApi-kyC_rKfY.js";import{B as p}from"./FagsakIndex-CK4tawGc.js";import{W as P}from"./index.es-9vA7B2V8.js";import{H as N}from"./VStack-Bi6ogD22.js";import{S as F}from"./ExclamationmarkTriangleFill-DaiEfIwG.js";import{e as D,g as M}from"./useStandardProsessPanelProps-xp0abzlR.js";const U=t=>{const[a,e]=g.useState([]),s=n=>{e(i=>{const r=[...i],d=r.findIndex(l=>l.id===n.id);return d>=0?r.splice(d,1,n):r.push(n),r}),t?.(n.harApneAksjonspunkter?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:a.filter(n=>n.skalVisesImeny),settFaktaPanelMenyData:s}},G="_container_610fz_1",I="_content_610fz_6",L="_sideMenu_610fz_14",y={container:G,content:I,sideMenu:L},H=({valgtFaktaSteg:t,valgtProsessSteg:a,setFaktaPanelMedÅpentApInfo:e,children:s})=>{const n=T(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=g.use(p),{faktaPanelMenyData:r,settFaktaPanelMenyData:d}=U(e),l=r.length>0;return u.jsxs(N,{className:y.container,wrap:!1,children:[l&&u.jsx("div",{className:y.sideMenu,"data-testid":"fakta-meny",children:u.jsx(P,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?u.jsx(F,{color:"var(--a-orange-600)"}):void 0})),onClick:o=>{i(a,r[o].id)}})}),u.jsx("div",{className:y.content,children:u.jsx(Y,{valgtFaktaSteg:t,settFaktaPanelMenyData:d,faktaPanelMenyData:r,children:s})})]})},f=g.createContext({}),Y=t=>{const{children:a,...e}=t,s=g.useMemo(()=>e,[e]);return u.jsx(f.Provider,{value:s,children:a})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const x="default",J=(t,a,e,s)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:i}=g.use(f),r=e&&(n===t||s&&n===x);return g.useEffect(()=>{i({id:t,tekst:a,erAktiv:r,harApneAksjonspunkter:s,skalVisesImeny:e})},[e,r,s]),e&&r},q=({standardPanelProps:t,skalPanelVisesIMeny:a,faktaPanelKode:e,faktaPanelMenyTekst:s,children:n})=>{const{behandling:i,fagsak:r,alleKodeverk:d}=g.use(p),l=J(e,s,a,t.harApneAksjonspunkter);return u.jsx(E,{behandling:i,children:l?u.jsx(K,{behandling:i,fagsak:r,alleKodeverk:d,aksjonspunkterForPanel:t.aksjonspunkter,harÅpneAksjonspunkter:t.harApneAksjonspunkter,submitCallback:t.submitCallback,isReadOnly:t.readOnly,alleMerknaderFraBeslutter:t.alleMerknaderFraBeslutter,children:n}):null})};q.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
  alleKodeverk: AlleKodeverk;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",A="default",C=(t,a,e,s,n,i)=>r=>{const l=(Array.isArray(r)?r:[r]).map(k=>({"@type":k.kode,...k})),o={saksnummer:t.saksnummer,behandlingUuid:a.uuid,behandlingVersjon:a.versjon};if(l&&n&&i){if(l.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(l[0].kode))return n({...o,overstyrteAksjonspunktDtoer:l}).then(()=>e(A,b))}return s({...o,bekreftedeAksjonspunktDtoer:l}).then(()=>e(A,b))},z=(t,a=[])=>{const{behandling:e,rettigheter:s,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:d,alleKodeverk:l}=g.use(p),{aksjonspunkt:o}=e,k=o&&t?o.filter(m=>t.includes(m.definisjon)):[],j=D(e,[],s,!1),R=M(e.status,k),w=C(n,e,d,i,r,a);return{behandling:e,submittable:!k.some(m=>v(m.status))||k.some(m=>m.kanLoses),harApneAksjonspunkter:k.some(m=>v(m.status)&&m.kanLoses),alleKodeverk:l,aksjonspunkter:k,readOnly:j,alleMerknaderFraBeslutter:R,submitCallback:w}},W=[S.AVKLAR_VERGE],X=()=>{const t=T(),a=z(W),{behandling:e}=g.use(p),s=O(e),n=_(e,"VERGE"),{data:i,isFetching:r}=B(s.vergeOptions(e,n));return u.jsx(q,{standardPanelProps:a,faktaPanelKode:h.VERGE,faktaPanelMenyTekst:t.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?u.jsx(c,{}):u.jsx(V,{verge:i,alleKodeverk:a.alleKodeverk,submittable:a.submittable})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{q as F,X as V,H as a,z as u};
