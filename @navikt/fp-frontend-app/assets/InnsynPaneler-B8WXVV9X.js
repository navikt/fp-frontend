import{a as I,j as e,B as w,H as x,N as qe,t as J,P as W,D as fe,L as U,G as he,v as je,k as ce}from"./index.es-DudHP408.js";import{r as v}from"./index-DVXBtNgz.js";import{B as Te}from"./BehandlingContainer-CWQ6HQTU.js";import{v as Ae,X as Z,Y as we,$ as Re,a0 as Ie,a1 as _,a2 as Ve,g as X,K as H,O as Q,d as G,a as B,f as C,T as Y,o as Be,L as T,P as ee,B as R,w as Pe,Z as Se,I as De,k as Fe,a3 as Ne,r as Ee,a4 as $}from"./AppIndex.stories-epglhxQ5.js";import{M as o,L as ne,x as re,H as A,f as Ke,h as Oe,i as xe,g,F as ae,a as te,B as S,C as Le,E as Me,T as Ue,O as _e}from"./index.es-D-kSCM_B.js";import{a as se,P as ie,b as le}from"./OverstyringPanel-CnQQ5z4H.js";import{P as ue,u as He}from"./ProsessDefaultInitPanel-CJqvUR4O.js";import{x as P,H as Ge}from"./index.es-zhgnUGpN.js";import{I as Ce}from"./IverksetterVedtakStatusModal-BiLnyXPc.js";import"./index-Cbx7Fas8.js";import"./tslib.es6-BntfKcQG.js";import"./BehandlingHenlagtPanel-C6z_1x6f.js";import"./useRestApiRunner-UjZYnLQd.js";import"./bind-Dx2DsUka.js";import"./index.es-Dp3V3PSg.js";import"./iframe-C6qgoWw2.js";import"../sb-preview/runtime.js";import"./SettPaVentReadOnlyModal-Ljm9BXuW.js";import"./index-CYjD5YP1.js";import"./nb_NO-CzPLdtEk.js";const c={INNVILGET:"INNV",DELVISTINNVILGET:"DELV",AVVIST:"AVVIST"},D={INN:"INN",UT:"UT",NOTAT:"N"},Ye="_checkboxCol_jtrmq_1",$e="_linkCol_jtrmq_5",ze="_imageInn_jtrmq_9",Je="_imageSend_jtrmq_16",We="_imageIntern_jtrmq_22",Ze="_noDocuments_jtrmq_29",Xe="_hidden_jtrmq_35",Qe="_table_jtrmq_39",f={checkboxCol:Ye,linkCol:$e,imageInn:ze,imageSend:Je,imageIntern:We,noDocuments:Ze,hidden:Xe,table:Qe},en=(n,a)=>n.kommunikasjonsretning===D.INN?e.jsx(we,{title:a.formatMessage({id:"DocumentListInnsyn.Motta"}),className:f.imageInn}):n.kommunikasjonsretning===D.UT?e.jsx(Re,{title:a.formatMessage({id:"DocumentListInnsyn.Send"}),className:f.imageSend}):e.jsx(Ie,{title:a.formatMessage({id:"DocumentListInnsyn.Intern"}),className:f.imageIntern}),nn=()=>e.jsx("span",{className:f.hidden,children:"-"}),L=({documents:n,saksNr:a,readOnly:r})=>{const t=I();if(n.length===0)return e.jsx(w,{size:"small",className:f.noDocuments,children:e.jsx(o,{id:"DocumentListInnsyn.NoDocuments"})});const i=r?["DocumentListInnsyn.DocumentType"]:["DocumentListInnsyn.CheckBox","DocumentListInnsyn.Direction","DocumentListInnsyn.DocumentType","DocumentListInnsyn.DateTime"];return e.jsxs(e.Fragment,{children:[e.jsx(x,{size:"small",className:f.noDocuments,children:e.jsx(o,{id:"DocumentListInnsyn.VelgInnsynsDok"})}),e.jsx(ne,{headerTextCodes:i,children:n.map(s=>{const l=en(s,t),u=parseInt(s.dokumentId,10);return e.jsxs(re,{id:u,children:[e.jsx(A,{className:f.checkboxCol,children:e.jsx(Ae,{label:nn(),name:`dokument_${u}`,disabled:r})}),e.jsx(A,{hidden:r,children:l}),e.jsx(A,{className:f.linkCol,children:e.jsx("a",{href:Z(a,s.journalpostId,s.dokumentId),className:"lenke lenke--frittstaende",target:"_blank",rel:"noopener noreferrer",children:s.tittel})}),e.jsx(A,{hidden:r,children:s.tidspunkt?e.jsx(Ke,{dateTimeString:s.tidspunkt}):e.jsx(w,{size:"small",children:e.jsx(o,{id:"DocumentListInnsyn.IProduksjon"})})})]},u)})})]})};L.defaultProps={readOnly:!1};L.__docgenInfo={description:`DocumentListInnsyn
...
som viser at ingen dokumenter finnes på fagsak.`,methods:[],displayName:"DocumentListInnsyn",props:{saksNr:{required:!0,tsType:{name:"string"},description:""},documents:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kommunikasjonsretning: string;
  gjelderFor?: string;
}>`}],raw:"Dokument[]"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const oe=({vedtaksdokumenter:n,behandlingTypes:a})=>{const[r,t]=v.useState(!1),i=v.useCallback(s=>{t(!r),s.preventDefault()},[r]);return n.length===0?e.jsx(o,{id:"DocumentListInnsyn.Vedtaksdokumentasjon",values:{numberOfDocuments:0}}):e.jsxs(e.Fragment,{children:[e.jsxs(_,{href:"#",onClick:i,children:[e.jsx(o,{id:"DocumentListInnsyn.Vedtaksdokumentasjon",values:{numberOfDocuments:n.length}}),r?e.jsx(Oe,{}):e.jsx(xe,{})]}),r&&e.jsxs(e.Fragment,{children:[e.jsx(g,{fourPx:!0}),e.jsx(ae,{children:n.map(s=>{var l;return e.jsxs(te,{children:[e.jsx(S,{children:e.jsx(Le,{dateString:s.opprettetDato})}),e.jsx(S,{children:e.jsx(_,{href:Ve(s.behandlingUuid),target:"_blank",children:((l=a.find(u=>u.kode===s.tittel))==null?void 0:l.navn)||"-"})})]},s.behandlingUuid)})})]})]})};oe.__docgenInfo={description:"",methods:[],displayName:"VedtakDocuments",props:{behandlingTypes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  tittel: string;
  opprettetDato: string;
}>`}],raw:"InnsynVedtaksdokument[]"},description:""}}};const rn=[],an=n=>n.reduce((a,r)=>({[`dokument_${r.dokumentId}`]:r.fikkInnsyn,...a}),{}),tn=(n,a,r,t,i)=>({mottattDato:n,innsynResultatType:a||void 0,fristDato:i||Be().add(3,"days").format(qe),sattPaVent:t[0].status===se.OPPRETTET?void 0:!!i,...ie.buildInitialValues(t),...an(r||[])}),sn=(n,a)=>a.map(r=>({dokumentId:r.dokumentId,journalpostId:r.journalpostId,fikkInnsyn:!!n[`dokument_${r.dokumentId}`]})),ln=n=>Object.keys(n).filter(a=>!a.startsWith("dokument_")).reduce((a,r)=>({...a,[r]:n[r]}),{}),un=(n,a)=>({kode:T.VURDER_INNSYN,innsynDokumenter:sn(n,a),...ln(n)}),on=n=>{const a=n.filter(r=>r.kommunikasjonsretning===D.INN);return n.forEach(r=>!a.some(t=>t.dokumentId===r.dokumentId)&&a.push(r)),a},de=({readOnly:n,readOnlySubmitButton:a,innsynMottattDato:r,alleKodeverk:t,vedtaksdokumentasjon:i,innsynResultatType:s,fristBehandlingPåVent:l,innsynDokumenter:u,alleDokumenter:k=[],aksjonspunkter:m,submitCallback:h,saksNr:p,formData:F,setFormData:N})=>{const y=I(),E=v.useMemo(()=>tn(r,s,u,m,l),[r,s,l,u,m]),j=X({defaultValues:F||E}),K=v.useMemo(()=>on(k),[k]),V=v.useMemo(()=>t[H.INNSYN_RESULTAT_TYPE].filter(q=>q.kode!=="-").sort((q,be)=>q.navn.localeCompare(be.navn)).reverse(),[t]),b=m[0].status===se.OPPRETTET,d=j.watch("innsynResultatType"),M=j.watch("sattPaVent");return e.jsxs(Q,{formMethods:j,onSubmit:q=>h(un(q,k)),setDataOnUnmount:N,children:[e.jsx(x,{size:"small",children:e.jsx(o,{id:"InnsynForm.Innsynsbehandling"})}),e.jsx(g,{twentyPx:!0}),e.jsx(Me,{isAksjonspunktOpen:b,children:[e.jsx(o,{id:"InnsynForm.VurderKravetOmInnsyn"},"1")]}),e.jsx(g,{twentyPx:!0}),e.jsx(G,{name:"mottattDato",label:y.formatMessage({id:"InnsynForm.DatoMottattKrav"}),isReadOnly:n,isEdited:!b,validate:[B,C]}),e.jsx(g,{sixteenPx:!0}),e.jsx(oe,{vedtaksdokumenter:i||rn,behandlingTypes:t[H.BEHANDLING_TYPE]}),e.jsx(g,{twentyPx:!0}),e.jsx(L,{saksNr:p,documents:K,readOnly:n}),e.jsx(ie,{readOnly:n}),e.jsx(g,{sixteenPx:!0}),e.jsx(Y,{name:"innsynResultatType",label:e.jsx(o,{id:"InnsynForm.Resultat"}),validate:[B],isReadOnly:n,isHorizontal:!0,isEdited:!b,radios:V.map(q=>({value:q.kode,label:q.navn}))}),(d===c.INNVILGET||d===c.DELVISTINNVILGET)&&e.jsxs(e.Fragment,{children:[e.jsx(g,{eightPx:!0}),e.jsxs(Ue,{alignOffset:d===c.INNVILGET?28:176,children:[e.jsx(Y,{name:"sattPaVent",label:e.jsx(o,{id:"InnsynForm.VelgVidereAksjon"}),validate:[B],isReadOnly:n,isEdited:!b,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:y.formatMessage({id:"InnsynForm.SettBehandlingPåVent"})},{value:"false",label:y.formatMessage({id:"InnsynForm.ForeslåOgFatteVedtak"})}]}),M&&e.jsxs(e.Fragment,{children:[e.jsx(g,{eightPx:!0}),e.jsx(G,{name:"fristDato",label:y.formatMessage({id:"InnsynForm.FristDato"}),isReadOnly:n,isEdited:!b,validate:[B,C]})]})]})]}),e.jsx(g,{sixteenPx:!0}),e.jsx(le,{isReadOnly:n,isSubmittable:!a,isSubmitting:j.formState.isSubmitting,isDirty:j.formState.isDirty,text:M?y.formatMessage({id:"SubmitButton.SettPåVent"}):void 0})]})};de.__docgenInfo={description:`InnsynForm
...
som viser at ingen dokumenter finnes på fagsak.`,methods:[],displayName:"DocumentListVedtakInnsyn",props:{saksNr:{required:!0,tsType:{name:"string"},description:""},documents:{required:!0,tsType:{name:"Array",elements:[{name:"unknown"}],raw:`({
  fikkInnsyn: boolean;
} & Dokument)[]`},description:""}}};const jn="_wordwrap_1hm28_1",cn={wordwrap:jn},Tn=De(1500),An=Fe(3),wn=(n,a)=>r=>{r.preventDefault();const t={fritekst:a||" ",mottaker:"",dokumentMal:Ne.INNSYN_SVAR,gjelderVedtak:!0};n(t)},Rn=n=>{const a=n.filter(r=>r.kommunikasjonsretning===D.INN);return n.forEach(r=>!a.some(t=>t.dokumentId===r.dokumentId)&&a.push(r)),a},In=(n,a)=>n.filter(r=>a.find(t=>t.dokumentId===r.dokumentId)).map(r=>{var t;return{...r,fikkInnsyn:((t=a.find(i=>i.dokumentId===r.dokumentId))==null?void 0:t.fikkInnsyn)||!1}}),Vn=n=>n===c.AVVIST?"InnsynVedtakForm.Avslatt":n===c.DELVISTINNVILGET?"InnsynVedtakForm.Delvis":"InnsynVedtakForm.Innvilget",Bn=(n,a)=>{var r;return{mottattDato:n,begrunnelse:(r=a.find(t=>t.definisjon===T.FORESLA_VEDTAK))==null?void 0:r.begrunnelse}},Pn=n=>({kode:T.FORESLA_VEDTAK,...n}),ye=({readOnly:n,previewCallback:a,saksNr:r,innsynMottattDato:t,aksjonspunkter:i,submitCallback:s,innsynResultatType:l,innsynDokumenter:u,sprakkode:k,alleDokumenter:m,formData:h,setFormData:p})=>{var b;const F=I(),N=v.useMemo(()=>Bn(t,i),[t,i]),y=X({defaultValues:h||N}),E=v.useMemo(()=>In(Rn(m),u),[m,u]),j=(b=i.find(d=>d.definisjon===T.VURDER_INNSYN))==null?void 0:b.begrunnelse,K=y.watch("begrunnelse"),V=wn(a,K);return e.jsxs(Q,{formMethods:y,onSubmit:d=>s(Pn(d)),setDataOnUnmount:p,children:[e.jsx(x,{size:"small",children:e.jsx(o,{id:n?"InnsynVedtakForm.Vedtak":"InnsynVedtakForm.ForslagVedtak"})}),e.jsx(g,{eightPx:!0}),e.jsx(U,{size:"small",children:e.jsx(o,{id:"InnsynVedtakForm.Resultat"})}),e.jsx(w,{size:"small",children:e.jsx(o,{id:Vn(l)})}),e.jsx(g,{eightPx:!0}),e.jsx(U,{size:"small",children:e.jsx(o,{id:"InnsynVedtakForm.Vurdering"})}),e.jsx(w,{size:"small",className:cn.wordwrap,children:he(j)}),e.jsx(g,{twentyPx:!0}),l!==c.INNVILGET&&e.jsx(Pe,{name:"begrunnelse",label:F.formatMessage({id:"InnsynVedtakForm.Fritekst"}),validate:[An,Tn,Se],maxLength:1500,readOnly:n,parse:d=>d.toString().replaceAll(new RegExp("\\p{Dash_Punctuation}","gu"),"-").replaceAll("	"," "),badges:[{type:"info",titleText:je(k)}]}),e.jsx(g,{twentyPx:!0}),l!==c.AVVIST&&e.jsx(me,{saksNr:r,documents:E.filter(d=>d.fikkInnsyn===!0)}),e.jsx(g,{twentyPx:!0}),e.jsx(ae,{children:e.jsxs(te,{children:[!n&&e.jsx(S,{children:e.jsx(le,{isReadOnly:n,isSubmittable:!0,isSubmitting:y.formState.isSubmitting,isDirty:y.formState.isDirty,hasEmptyRequiredFields:!1})}),e.jsx(S,{children:e.jsx("a",{onClick:V,onKeyDown:d=>d.key==="Enter"?V(d):null,className:"lenke lenke--frittstaende",target:"_blank",rel:"noopener noreferrer",role:"link",tabIndex:0,children:e.jsx(o,{id:n?"InnsynVedtakForm.VisVedtaksbrev":"InnsynVedtakForm.ForhåndsvisBrev"})})})]})})]})};ye.__docgenInfo={description:`InnsynVedtakForm
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const z=n=>{const{aksjonspunkt:a,behandlingsresultat:r}=n,t=a.some(i=>i.status===Ge.OPPRETTET);return a.length===0||t?P.IKKE_VURDERT:(r==null?void 0:r.type)===$.INNSYN_INNVILGET||(r==null?void 0:r.type)===$.INNSYN_DELVIS_INNVILGET?P.OPPFYLT:P.IKKE_OPPFYLT},Fn=(n,a,r)=>t=>{const i={...t,behandlingUuid:r.uuid,fagsakYtelseType:a.fagsakYtelseType};return n(i).then(s=>ce(s))},Nn=(n,a)=>()=>(a(!1),()=>{n(!0)}),En=[T.FORESLA_VEDTAK],Kn=n=>[{key:R.INNSYN},{key:R.INNSYN_DOKUMENTER,params:{saksnummer:n}}],pe=({fagsak:n,opneSokeside:a,setSkalOppdatereEtterBekreftelseAvAp:r,...t})=>{const i=I(),[s,l]=v.useState(!1),u=Nn(l,r),k=He(),{startRequest:m}=Ee.useRestApiRunner(R.PREVIEW_MESSAGE),h=v.useCallback(Fn(m,n,k.behandling),[k.behandling.versjon]);return e.jsx(ue,{...t,panelEndepunkter:Kn(n.saksnummer),aksjonspunktKoder:En,prosessPanelKode:ee.VEDTAK,prosessPanelMenyTekst:i.formatMessage({id:"Behandlingspunkt.Vedtak"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:()=>z(t.behandling),lagringSideEffekter:u,hentSkalMarkeresSomAktiv:()=>z(t.behandling)!==P.IKKE_VURDERT,renderPanel:p=>e.jsxs(e.Fragment,{children:[e.jsx(Ce,{visModal:s,lukkModal:()=>{l(!1),a()},behandlingsresultat:k.behandling.behandlingsresultat}),e.jsx(ve,{saksnummer:n.saksnummer,previewCallback:h,alleDokumenter:p==null?void 0:p.innsynDokumenter,...p})]})})};pe.__docgenInfo={description:"",methods:[],displayName:"InnsynVedtakProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
