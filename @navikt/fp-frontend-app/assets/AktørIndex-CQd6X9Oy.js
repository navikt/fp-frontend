import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{b as v,r as f}from"./index.es-DiQ2Qcyv.js";import{u as q,e as j}from"./fagsakApi-Dezu0wuQ.js";import{V as c,H as w,P as I,g as R,Y as K}from"./withPanelData-Cc_RqdZf.js";import{K as m}from"./alleKodeverk-BGvpDL3l.js";import{R as A}from"./index-mMUbb89k.js";import{V as T}from"./VisittkortSakIndex-CvRQoU5o.js";import{M as l}from"./message-BkyZBQP_.js";import{E as x}from"./IngenBehandlingValgtPanel-o_ZaWNIP.js";import{p as E}from"./paths-HrFw5lRQ.js";import{u as b}from"./useTrackRouteParam-CzCZptF0.js";import{u as g}from"./useKodeverk-gvH_PTFe.js";const y=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:d})=>e.jsxs(e.Fragment,{children:[e.jsx(T,{bruker:n.person}),e.jsx(c,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(t=>{var i,k;const a=(i=s.find(o=>o.kode===t.fagsakYtelseType))==null?void 0:i.navn,u=(k=r.find(o=>o.kode===t.status))==null?void 0:k.navn;return e.jsx(A.Fragment,{children:d(void 0,`${a} (${t.saksnummer}) ${u}`,t.saksnummer)},t.saksnummer)}):e.jsx(w,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});y.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},renderSomLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(className: string | undefined, fagsakKomponent: ReactNode, saksnummer: string) => ReactElement",signature:{arguments:[{type:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},name:"className"},{type:{name:"ReactNode"},name:"fagsakKomponent"},{type:{name:"string"},name:"saksnummer"}],return:{name:"ReactElement"}}},description:""}}};const F={"AktoerGrid.IngenFagsaker":"Har ingen fagsaker i fpsak","AktorSakIndex.UgyldigAktorId":"Ugyldig aktørId: {id}"},S=v(F),p=({valgtAktorId:n,aktorInfo:r,...s})=>e.jsxs(I,{value:S,children:[r&&e.jsx(y,{aktorInfo:r,...s}),!r&&e.jsx(R,{size:"small",children:e.jsx(l,{id:"AktorSakIndex.UgyldigAktorId",values:{id:n}})})]});p.__docgenInfo={description:"",methods:[],displayName:"AktørSakIndex",props:{valgtAktorId:{required:!0,tsType:{name:"string"},description:""},aktorInfo:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fagsaker: FagsakEnkel[];
  person: Person;
}`,signature:{properties:[{key:"fagsaker",value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},renderSomLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(className: string | undefined, fagsakKomponent: ReactNode, saksnummer: string) => ReactElement",signature:{arguments:[{type:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},name:"className"},{type:{name:"ReactNode"},name:"fagsakKomponent"},{type:{name:"string"},name:"saksnummer"}],return:{name:"ReactElement"}}},description:""}}};const N=()=>{const{selected:n}=b({paramName:"aktoerId",parse:a=>Number.parseInt(a,10)}),{data:r,status:s}=q(j(n)),d=g(m.FAGSAK_STATUS),t=g(m.FAGSAK_YTELSE);return s==="pending"?e.jsx(f,{}):s==="error"?e.jsx(x,{}):e.jsx(p,{valgtAktorId:n,aktorInfo:r,fagsakStatuser:d,fagsakYtelseTyper:t,renderSomLenke:(a,u,i)=>e.jsx(K,{to:E(i),className:a,children:u})})};N.__docgenInfo={description:"",methods:[],displayName:"AktørIndex"};export{N as A};
