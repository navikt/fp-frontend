...
Statisk visning av panel som tilsier ingen risikoklassifisering er utført for valgt behandling, eller at ingen behandling er valgt.`,methods:[],displayName:"ManglendeKlassifiseringPanel"};var B=(e=>(e.HOY="HOY",e.IKKE_HOY="IKKE_HOY",e.IKKE_KLASSIFISERT="IKKE_KLASSIFISERT",e.UDEFINERT="-",e))(B||{});const pn={"Risikopanel.Tittel":"Faresignaler","Risikopanel.Tittel.IngenFaresignaler":"Ingen faresignaler oppdaget","Risikopanel.Tittel.Faresignaler":"Faresignaler oppdaget","Risikopanel.Tittel.ManglerKlassifisering":"Venter på mulige faresignaler","Risikopanel.Panel.Tittel":"Vurder faresignalene","Risikopanel.Panel.Medlemskap":"Medlemskap","Risikopanel.Panel.ArbeidsforholdInntekt":"Arbeidsforhold og inntekt","Risikopanel.Form.Resultat":"Resultat av vurderingen","Risikopanel.Form.Bekreft":"Bekreft og fortsett","Risikopanel.Forms.Vurdering":"Vurdering"},yn=Ee(pn),M=(e,a)=>a!=null&&a.kontrollresultat?a.kontrollresultat===e:!1,ne=({aksjonspunkt:e,risikoklassifisering:a,isPanelOpen:t,readOnly:n,submitAksjonspunkt:r,toggleRiskPanel:i,faresignalVurderinger:g})=>{const l=M(B.IKKE_HOY,a),m=M(B.HOY,a);return s.jsxs(be,{value:yn,children:[l&&s.jsx(Z,{}),a&&m&&s.jsx(X,{risikoklassifisering:a,aksjonspunkt:e,readOnly:n,isRiskPanelOpen:t,submitCallback:r,toggleRiskPanel:i,faresignalVurderinger:g}),!l&&!m&&s.jsx(ee,{})]})};ne.__docgenInfo={description:`RisikoklassifiseringSakIndex
...
om klassifisering er utført og ingen faresignaler er funnet og om klassifisering er utført og faresignaler er funnet`,methods:[],displayName:"RisikoklassifiseringSakIndex",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const vn=(e,a,t)=>{if(t)return!0;const{kanSaksbehandle:n}=e;return!n||!a.writeAccess.isEnabled},fn=({fagsakData:e,behandlingVersjon:a,behandlingUuid:t,setBehandling:n})=>{const r=e.getFagsak(),i=e.getBehandling(t),g=i?i.behandlingPaaVent:!1,l=i==null?void 0:i.status,m=i==null?void 0:i.type,k=i==null?void 0:i.risikoAksjonspunkt,o=(i==null?void 0:i.kontrollResultat)||r.kontrollResultat,{selected:N=!1}=Ge({paramName:"risiko",parse:b=>b==="true",isQueryParam:!0}),I=he(),w=qe(),{kodeverkOptions:re}=de(),ae=L(ke()),{data:te}=L(re()),G=C(ae.data).innloggetBruker,se=sn(G,r.status,l,m),ie=vn(G,se,g),le=()=>{I(E(w)(!N))};u.useEffect(()=>{k&&k.status===q.OPPRETTET&&!N&&I(E(w)(!0)),k&&k.status===q.UTFORT&&I(E(w)(!1))},[!!k,t,a]);const{startRequest:oe}=Ke.useRestApiRunner(Le.SAVE_AKSJONSPUNKT),ue=b=>{if(!t||!a)return Promise.reject();const ge={behandlingUuid:t,saksnummer:r.saksnummer,behandlingVersjon:a,bekreftedeAksjonspunktDtoer:[{"@type":b.kode,...b}]};return oe(ge).then(K=>{K&&n(K)})};return s.jsx(ne,{aksjonspunkt:k,risikoklassifisering:o,isPanelOpen:N,readOnly:ie,submitAksjonspunkt:ue,toggleRiskPanel:le,faresignalVurderinger:C(te)[me.FARESIGNAL_VURDERING]})};fn.__docgenInfo={description:`RisikoklassifiseringIndex
