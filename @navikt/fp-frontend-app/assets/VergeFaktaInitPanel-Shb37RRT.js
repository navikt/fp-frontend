...
Readonly<{
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Qk="_selectWidth_1ur6m_1",ec="_leftCol_1ur6m_5",Wu={selectWidth:Qk,leftCol:ec},Un=({intl:m,readOnly:b,vergetyper:u=[],alleMerknaderFraBeslutter:x,valgtVergeType:A})=>y.jsxs(sk,{merknaderFraBeslutter:x[ht.AVKLAR_VERGE],children:[y.jsx(vk,{name:"vergeType",className:Wu.selectWidth,label:m.formatMessage({id:"Verge.TypeVerge"}),validate:[Vn],selectValues:u.map(P=>y.jsx("option",{value:P.kode,children:P.navn},P.kode)),readOnly:b}),y.jsx(uk,{children:A&&y.jsxs(y.Fragment,{children:[y.jsx(pt,{sixteenPx:!0}),y.jsxs(Nu,{children:[y.jsx(ft,{className:Wu.leftCol,children:y.jsx(Ua,{name:"navn",label:m.formatMessage({id:"Verge.Navn"}),validate:[Vn,pk],readOnly:b})}),y.jsxs(ft,{children:[A!==Xa.ADVOKAT&&y.jsx(Ua,{name:"fnr",label:m.formatMessage({id:"Verge.FodselsNummer"}),validate:[Vn,kk],readOnly:b}),A===Xa.ADVOKAT&&y.jsx(Ua,{name:"organisasjonsnummer",label:m.formatMessage({id:"Verge.Organisasjonsnummer"}),validate:[Vn],readOnly:b})]})]}),y.jsx(pt,{sixteenPx:!0}),y.jsxs(Nu,{children:[y.jsx(ft,{children:y.jsx(Iu,{name:"gyldigFom",label:m.formatMessage({id:"Verge.PeriodeFOM"}),validate:[Vn,Lu],isReadOnly:b})}),y.jsx(ft,{children:y.jsx(Iu,{name:"gyldigTom",label:m.formatMessage({id:"Verge.PeriodeTOM"}),validate:[Lu],isReadOnly:b})})]})]})})]});Un.buildInitialValues=m=>({navn:m.navn,gyldigFom:m.gyldigFom,gyldigTom:m.gyldigTom,fnr:m.fnr,organisasjonsnummer:m.organisasjonsnummer,vergeType:m.vergeType||void 0});Un.transformValues=m=>({vergeType:m.vergeType,navn:m.navn,fnr:m.fnr,organisasjonsnummer:m.organisasjonsnummer,gyldigFom:m.gyldigFom,gyldigTom:m.gyldigTom,kode:ht.AVKLAR_VERGE});Un.__docgenInfo={description:`RegistrereVergeFaktaForm
