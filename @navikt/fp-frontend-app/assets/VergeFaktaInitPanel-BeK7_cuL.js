import{r as g,l as T,j as u,bH as w,bI as _,bj as K}from"./iframe-Cc3omapF.js";import{Q as V}from"./index.es-BZcNyl5y.js";import{u as c}from"./fagsakApi-Dl3IK1m3.js";import{V as h}from"./BehandlingMenuIndex-DLhcZRnG.js";import{i as y,A as B}from"./index-48rqNLx5.js";import{u as F,c as P}from"./behandlingApi-hjTigezG.js";import{B as p}from"./FagsakIndex-B6QjreXZ.js";import{W as S}from"./index.es-B8lVUMdD.js";import{H as O}from"./VStack-BS7xUE_y.js";import{S as N}from"./ExclamationmarkTriangleFill-DErr1Ung.js";import{e as D,g as M}from"./useStandardProsessPanelProps-C45N0sPj.js";const U=a=>{const[t,e]=g.useState([]),l=n=>{e(s=>{const r=[...s],d=r.findIndex(i=>i.id===n.id);return d>=0?r.splice(d,1,n):r.push(n),r}),a?.(n.harApneAksjonspunkter?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:t.filter(n=>n.skalVisesImeny),settFaktaPanelMenyData:l}},L="_container_4o186_1",G="_content_4o186_6",I="_sideMenu_4o186_19",v={container:L,content:G,sideMenu:I},H=({valgtFaktaSteg:a,valgtProsessSteg:t,setFaktaPanelMedÅpentApInfo:e,children:l})=>{const n=T(),{oppdaterProsessStegOgFaktaPanelIUrl:s}=g.use(p),{faktaPanelMenyData:r,settFaktaPanelMenyData:d}=U(e),i=r.length>0;return u.jsxs(O,{className:v.container,wrap:!1,children:[i&&u.jsx("div",{className:v.sideMenu,"data-testid":"fakta-meny",children:u.jsx(S,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?u.jsx(N,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{s(t,r[o].id)}})}),u.jsx("div",{className:v.content,children:u.jsx(Y,{valgtFaktaSteg:a,settFaktaPanelMenyData:d,faktaPanelMenyData:r,children:l})})]})},f=g.createContext({}),Y=a=>{const{children:t,...e}=a,l=g.useMemo(()=>e,[e]);return u.jsx(f.Provider,{value:l,children:t})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const x="default",J=(a,t,e,l)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:s}=g.use(f),r=e&&(n===a||l&&n===x);return g.useEffect(()=>{s({id:a,tekst:t,erAktiv:r,harApneAksjonspunkter:l,skalVisesImeny:e})},[e,r,l]),e&&r},q=({standardPanelProps:a,skalPanelVisesIMeny:t,faktaPanelKode:e,faktaPanelMenyTekst:l,children:n})=>{const{behandling:s,fagsak:r,alleKodeverk:d}=g.use(p),i=J(e,l,t,a.harApneAksjonspunkter);return u.jsx(w,{behandling:s,children:i?u.jsx(_,{behandling:s,fagsak:r,alleKodeverk:d,aksjonspunkterForPanel:a.aksjonspunkter,harÅpneAksjonspunkter:a.harApneAksjonspunkter,submitCallback:a.submitCallback,isReadOnly:a.readOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,children:n}):null})};q.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
  alleKodeverk: AlleKodeverk;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",A="default",C=(a,t,e,l,n,s)=>r=>{const i=(Array.isArray(r)?r:[r]).map(k=>({"@type":k.kode,...k})),o={saksnummer:a.saksnummer,behandlingUuid:t.uuid,behandlingVersjon:t.versjon};if(i&&n&&s){if(i.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(s.includes(i[0].kode))return n({...o,overstyrteAksjonspunktDtoer:i}).then(()=>e(A,b))}return l({...o,bekreftedeAksjonspunktDtoer:i}).then(()=>e(A,b))},Q=(a,t=[])=>{const{behandling:e,rettigheter:l,fagsak:n,lagreAksjonspunkter:s,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:d,alleKodeverk:i}=g.use(p),{aksjonspunkt:o}=e,k=o&&a?o.filter(m=>a.includes(m.definisjon)):[],j=D(e,[],l,!1),E=M(e.status,k),R=C(n,e,d,s,r,t);return{behandling:e,submittable:!k.some(m=>y(m.status))||k.some(m=>m.kanLoses),harApneAksjonspunkter:k.some(m=>y(m.status)&&m.kanLoses),alleKodeverk:i,aksjonspunkter:k,readOnly:j,alleMerknaderFraBeslutter:E,submitCallback:R}},W=[B.AVKLAR_VERGE],z=()=>{const a=T(),t=Q(W),{behandling:e}=g.use(p),l=F(e),n=P(e,"VERGE"),{data:s,isFetching:r}=c(l.vergeOptions(e,n));return u.jsx(q,{standardPanelProps:t,faktaPanelKode:K.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?u.jsx(V,{}):u.jsx(h,{verge:s,alleKodeverk:t.alleKodeverk,submittable:t.submittable})})};z.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{q as F,z as V,H as a,Q as u};
