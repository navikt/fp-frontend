import{j as e}from"./jsx-runtime-CLpGMVip.js";import{B as $e}from"./BehandlingContainer-DL1k3Yq1.js";import{V as Qe}from"./VergeFaktaInitPanel-BnPIs8H6.js";import{r as q}from"./index-B8jnc8p3.js";import{n as L,d as N,k as V,ap as E,am as ke,m as M,J as Ze,V as C,H as B,L as f,h as b,P as ne,B as me,a0 as ve,l as oe}from"./withPanelData-CPuNzjz_.js";import{M as i,d as g,N as pe,f as Ke,Z as ye,n as ae,$ as J,Q as be,p as Xe,x as We}from"./index.es-C0E93eWg.js";import{u as $}from"./initFetch-BJVp8vEy.js";import{a as fe,r as he,Q as re,e as T,Z as _,b as ce,N as je,u as w}from"./index.es-D98-2_qQ.js";import{A as y}from"./aksjonspunktCodes-BuBbCIxs.js";import{a as Ae,b as er,B as R}from"./behandlingResultatType-DHbqkXMl.js";import{P as U}from"./skjermlenkeCodes-1SvLTuBb.js";import{h as Y}from"./moment-C5S46NFB.js";import{K as P}from"./alleKodeverk-Ck9zwXaq.js";import{g as te}from"./kodeverkUtils-DLZgokMR.js";import{P as qe,a as le}from"./OverstyringPanel-Cw-zA0Zm.js";import{u as Q,a as Ve}from"./behandlingApi-v-44y4EH.js";import{u as Z,P as X}from"./useStandardProsessPanelProps-Cu8ABFP-.js";import{B as W}from"./behandlingDataContext-BdfTXpp6.js";import{A as Te}from"./aksjonspunktStatus-xM4O_ZUY.js";import{V as D}from"./BehandlingHenlagtPanel-7FappHrE.js";import{v as rr}from"./validerApKodeOgHentApEnum-BXdt7Uis.js";import{L as Fe}from"./Link-DSMrdPv1.js";import{F as nr}from"./FatterVedtakStatusModal-BipE5jhO.js";import{D as H}from"./dokumentMalType-uHvYWaNM.js";import{K as ar}from"./KlageBehandlingModal-D07Gi9pZ.js";import"./index.es-CAkBOe9l.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./useFormField-DMqClypr.js";import"./Tooltip-CxOWhK-Z.js";import"./index-Dmw-q_WW.js";import"./index-Dv0WEcwZ.js";import"./Popover-hNE7cLSs.js";import"./ExclamationmarkTriangleFill-5q9HjC_H.js";import"./Box-BWm0X2SF.js";import"./bind-oYjWB_aQ.js";import"./Kjonnkode-C-fkzSiP.js";import"./Table-BQeupv8U.js";import"./v4-CtRu48qb.js";import"./react-BXF3hTSQ.js";import"./iframe-A9UBnFV9.js";import"./chunk-XP5HYGXS-DH4vAeCa.js";import"./dayjs.min-CJilavqB.js";import"./CheckmarkCircleFill-D8brF2qS.js";import"./index-DqeTBbD1.js";import"./decorators-DIzpaN6C.js";import"./Checkbox-CHK127WR.js";import"./Tag-CPDVUY0D.js";import"./TotrinnskontrollIndex-CMeGfsJT.js";import"./behandlingArsakType-CTXggz2Y.js";import"./paths-vMcrxrN5.js";import"./useKodeverk-DLF1yEh7.js";import"./useVisForhandsvisningAvMelding-BKvcIvMo.js";import"./SupportHeader-CytHG1L1.js";import"./ErrorBoundary-j29h23X0.js";import"./IngenBehandlingValgtPanel-CN9yBlL8.js";import"./RestApiErrorContext-D3DzVTT-.js";var k=(r=>(r.STADFESTE_YTELSESVEDTAK="STADFESTE_YTELSESVEDTAK",r.MEDHOLD_I_KLAGE="MEDHOLD_I_KLAGE",r.OPPHEVE_YTELSESVEDTAK="OPPHEVE_YTELSESVEDTAK",r.AVVIS_KLAGE="AVVIS_KLAGE",r.HJEMSENDE_UTEN_Å_OPPHEVE="HJEMSENDE_UTEN_Å_OPPHEVE",r))(k||{}),S=(r=>(r.DELVIS_MEDHOLD_I_KLAGE="DELVIS_MEDHOLD_I_KLAGE",r.GUNST_MEDHOLD_I_KLAGE="GUNST_MEDHOLD_I_KLAGE",r.UGUNST_MEDHOLD_I_KLAGE="UGUNST_MEDHOLD_I_KLAGE",r.UDEFINERT="-",r))(S||{});const I="ikkePaklagdVedtak",ie=r=>r.erKlagerPart===!1||r.erFristOverholdt===!1||r.erKonkret===!1||r.erSignert===!1||r.vedtak===I,Be=(r,a)=>r.find(t=>t.uuid===a),se=(r,a)=>{const t=Be(r,a);return!!t&&(t.type===N.TILBAKEKREVING||t.type===N.TILBAKEKREVING_REVURDERING)},Pe=(r,a)=>{const t=se(r,a),l=Be(r,a);return l&&t?{tilbakekrevingUuid:l.uuid,tilbakekrevingVedtakDato:l.avsluttet,tilbakekrevingBehandlingType:l.type}:void 0},tr=(r,a,t,l)=>({kode:l,begrunnelse:r.begrunnelse,behandlingUuid:a,erKlagerPart:r.erKlagerPart,erFristOverholdt:r.erFristOverholdt,erKonkret:r.erKonkret,erSignert:r.erSignert,erTilbakekreving:se(t,r.vedtak),klageTilbakekreving:Pe(t,r.vedtak),paKlagdBehandlingUuid:r.vedtak===I?void 0:r.vedtak,fritekstTilBrev:ie(r)?r.fritekstTilBrev:void 0}),Ee=({behandlingUuid:r,saveKlage:a,avsluttedeBehandlinger:t,spinner:l=!1,aksjonspunktCode:n,readOnly:s=!1,handleSubmit:o})=>s?null:e.jsx(L,{size:"small",variant:"primary",loading:l,onClick:o(d=>a(tr(d,r,t,n))),type:"button",children:e.jsx(i,{id:"TempsaveKlageButton.TempSaveButton"})});Ee.__docgenInfo={description:"",methods:[],displayName:"TempsaveKlageButton",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunktCode:{required:!0,tsType:{name:"string"},description:""},avsluttedeBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  type: string;
  avsluttet?: string;
  uuid: string;
