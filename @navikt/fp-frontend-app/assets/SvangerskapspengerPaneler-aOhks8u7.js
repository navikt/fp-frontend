...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const St=({alleBehandlinger:n,behandling:r,fagsak:t,valgtProsessSteg:a,valgtFaktaSteg:i,oppdaterProsessStegOgFaktaPanelIUrl:s,opneSokeside:g,toggleOppdateringAvFagsakOgBehandling:o,arbeidsgivere:l,personoversikt:u,rettigheter:d,hentOgSettBehandling:m})=>{const f=j.useCallback(k=>e.jsxs(e.Fragment,{children:[e.jsx(An,{...k,fagsak:t,rettigheter:d}),e.jsx(En,{...k,saksnummer:t.saksnummer,behandlingUuid:r.uuid,rettigheter:d,arbeidsgiverOpplysningerPerId:l,hentOgSettBehandling:m}),e.jsx(On,{fagsak:t,alleBehandlinger:n,arbeidsgiverOpplysningerPerId:l,...k}),e.jsx(Vn,{...k,arbeidsgiverOpplysningerPerId:l}),e.jsx(cn,{...k}),e.jsx(_n,{...k}),e.jsx(ln,{...k,arbeidsgiverOpplysningerPerId:l}),e.jsx(Rn,{...k,fagsak:t}),e.jsx(In,{...k,arbeidsgiverOpplysningerPerId:l}),e.jsx(Dn,{...k,saksnummer:t.saksnummer,arbeidsgiverOpplysningerPerId:l}),e.jsx(Kn,{...k,arbeidsgiverOpplysningerPerId:l,rettigheter:d}),e.jsx(Nn,{...k,arbeidsgiverOpplysningerPerId:l})]}),[u,r,d,t,l,m]),p=j.useCallback((k,v)=>e.jsxs(e.Fragment,{children:[e.jsx(wn,{...k,arbeidsgiverOpplysningerPerId:l}),e.jsx(kn,{...k,rettigheter:d,oppdaterProsessStegOgFaktaPanelIUrl:s}),e.jsx(xn,{...k,arbeidsgiverOpplysningerPerId:l}),e.jsx(Gn,{...k}),e.jsx(Ln,{...k,rettigheter:d}),e.jsx(mn,{...k,arbeidsgiverOpplysningerPerId:l,personoversikt:u}),e.jsx(Pn,{...k,fagsak:t,menyData:v.allMenyData,arbeidsgiverOpplysningerPerId:l}),e.jsx(pn,{...k,fagsak:t,opneSokeside:g,toggleOppdatereFagsakContext:o})]}),[u,t,g,o,l,d,s]);return e.jsx(fn,{behandling:r,valgtProsessSteg:a,valgtFaktaSteg:i,oppdaterProsessStegOgFaktaPanelIUrl:s,hentFaktaPaneler:f,hentProsessPaneler:p})};St.__docgenInfo={description:"",methods:[],displayName:"SvangerskapspengerPaneler",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
