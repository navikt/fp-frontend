...
Statisk visning av panel som tilsier ingen faresignaler funnet i behandlingen.`,methods:[],displayName:"AvklarFaresignalerForm",props:{aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const O=({risikoFaresignaler:e,labelId:a})=>s.jsxs(s.Fragment,{children:[s.jsx(j,{size:"small",children:s.jsx(v,{id:a})}),s.jsx("ul",{children:e.faresignaler.map(t=>s.jsx("li",{children:s.jsx(fe,{size:"small",children:Ne(t)})},t))})]}),X=({risikoklassifisering:e})=>{var a,t;return s.jsxs(s.Fragment,{children:[((a=e.medlFaresignaler)==null?void 0:a.faresignaler)&&s.jsx(O,{risikoFaresignaler:e.medlFaresignaler,labelId:"Risikopanel.Panel.Medlemskap"}),((t=e.iayFaresignaler)==null?void 0:t.faresignaler)&&s.jsx(O,{risikoFaresignaler:e.iayFaresignaler,labelId:"Risikopanel.Panel.ArbeidsforholdInntekt"})]})};O.__docgenInfo={description:"",methods:[],displayName:"FarePanel",props:{risikoFaresignaler:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  faresignaler: string[];
...
}>`},description:""}}};const Z=({risikoklassifisering:e,aksjonspunkt:a,readOnly:t,submitCallback:n,faresignalVurderinger:r})=>s.jsxs(Ie,{children:[a&&a.status===q.OPPRETTET&&s.jsxs(s.Fragment,{children:[s.jsx(we,{children:s.jsx(v,{id:"Risikopanel.Panel.Tittel"})}),s.jsx(h,{sixteenPx:!0})]}),s.jsx(X,{risikoklassifisering:e}),!!a&&s.jsx(Q,{aksjonspunkt:a,readOnly:t,submitCallback:n,risikoklassifisering:e,faresignalVurderinger:r})]});Z.__docgenInfo={description:`AvklarFaresignaler
...
Statisk visning av panel som tilsier ingen faresignaler funnet i behandlingen.`,methods:[],displayName:"HoyRisikoPanel",props:{risikoklassifisering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const kn="_hoyRisikoPanel_za867_1",mn={hoyRisikoPanel:kn},J=({risikoklassifisering:e,aksjonspunkt:a,readOnly:t,submitCallback:n,isRiskPanelOpen:r,toggleRiskPanel:i,faresignalVurderinger:g})=>{const l=V();return s.jsxs(y,{"aria-label":l.formatMessage({id:"Risikopanel.Tittel"}),open:r,className:mn.hoyRisikoPanel,children:[s.jsx(y.Header,{onClick:i,children:s.jsx(y.Title,{children:s.jsxs(F,{gap:"4",align:"center",children:[s.jsx(Ae,{title:l.formatMessage({id:"Risikopanel.Tittel"}),color:"var(--a-red-500)",height:24,width:24}),s.jsx(j,{size:"small",children:s.jsx(v,{id:"Risikopanel.Tittel.Faresignaler"})})]})})}),s.jsx(y.Content,{children:s.jsx(Z,{risikoklassifisering:e,aksjonspunkt:a,readOnly:t,submitCallback:n,faresignalVurderinger:g})})]})};J.__docgenInfo={description:`HoyRisikoTittel
...
om klassifisering er utført og ingen faresignaler er funnet og om klassifisering er utført og faresignaler er funnet`,methods:[],displayName:"RisikoklassifiseringSakIndex",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const vn=(e,a,t)=>{if(t)return!0;const{kanSaksbehandle:n}=e;return!n||!a.writeAccess.isEnabled},fn=({fagsakData:e,behandlingVersjon:a,behandlingUuid:t,setBehandling:n})=>{const r=e.getFagsak(),i=e.getBehandling(t),g=i?i.behandlingPaaVent:!1,l=i==null?void 0:i.status,m=i==null?void 0:i.type,k=i==null?void 0:i.risikoAksjonspunkt,o=(i==null?void 0:i.kontrollResultat)||r.kontrollResultat,{selected:N=!1}=Ke({paramName:"risiko",parse:b=>b==="true",isQueryParam:!0}),I=he(),w=qe(),{kodeverkOptions:re}=de(),ae=C(ke()),{data:te}=C(re()),K=H(ae.data).innloggetBruker,se=sn(K,r.status,l,m),ie=vn(K,se,g),le=()=>{I(E(w)(!N))};u.useEffect(()=>{k&&k.status===q.OPPRETTET&&!N&&I(E(w)(!0)),k&&k.status===q.UTFORT&&I(E(w)(!1))},[!!k,t,a]);const{startRequest:oe}=Ge.useRestApiRunner(Ce.SAVE_AKSJONSPUNKT),ue=b=>{if(!t||!a)return Promise.reject();const ge={behandlingUuid:t,saksnummer:r.saksnummer,behandlingVersjon:a,bekreftedeAksjonspunktDtoer:[{"@type":b.kode,...b}]};return oe(ge).then(G=>{G&&n(G)})};return s.jsx(ne,{aksjonspunkt:k,risikoklassifisering:o,isPanelOpen:N,readOnly:ie,submitAksjonspunkt:ue,toggleRiskPanel:le,faresignalVurderinger:H(te)[me.FARESIGNAL_VURDERING]})};fn.__docgenInfo={description:`RisikoklassifiseringIndex
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""}}};export{q as A,y as E,B as K,fn as R,Le as S,sn as g,Bn as i};
