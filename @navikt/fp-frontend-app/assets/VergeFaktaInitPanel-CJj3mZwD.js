import{j as o}from"./index-nufLo1NJ.js";import{r as g}from"./index-mMUbb89k.js";import{u as f,f as E,a9 as c,aa as K,ab as B}from"./withPanelData-BscNDdOr.js";import{r as h}from"./index.es-DjkJlD88.js";import{u as V}from"./fagsakApi-DGB7KD_K.js";import{V as S}from"./BehandlingMenuIndex-oXcNatRM.js";import{i as v,A as O}from"./index-Dyi8laJ0.js";import{u as _,h as P}from"./behandlingApi-CLFTsbD6.js";import{B as p}from"./FagsakIndex-Ccv3e7ZH.js";import{t as N}from"./index.es-BRyCKvrV.js";import{S as D}from"./ExclamationmarkTriangleFill-DQAOjWRr.js";import{e as F,g as M}from"./useStandardProsessPanelProps-DnLbHTz4.js";const G=n=>{const[a,e]=g.useState([]),s=r=>{e(i=>{const t=[...i],d=t.findIndex(l=>l.id===r.id);return d>=0?t.splice(d,1,r):t.push(r),t}),n==null||n(r.harApneAksjonspunkter?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:a.filter(r=>r.skalVisesImeny),settFaktaPanelMenyData:s}},U="_container_610fz_1",I="_content_610fz_6",L="_sideMenu_610fz_14",y={container:U,content:I,sideMenu:L},H=({valgtFaktaSteg:n,valgtProsessSteg:a,setFaktaPanelMedÅpentApInfo:e,children:s})=>{const r=f(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=g.use(p),{faktaPanelMenyData:t,settFaktaPanelMenyData:d}=G(e),l=t.length>0;return o.jsxs(E,{className:y.container,wrap:!1,children:[l&&o.jsx("div",{className:y.sideMenu,"data-testid":"fakta-meny",children:o.jsx(N,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:t.map(u=>({label:u.tekst,active:u.erAktiv,icon:u.harApneAksjonspunkter?o.jsx(D,{color:"var(--a-orange-600)"}):void 0})),onClick:u=>{i(a,t[u].id)}})}),o.jsx("div",{className:y.content,children:o.jsx(x,{valgtFaktaSteg:n,settFaktaPanelMenyData:d,faktaPanelMenyData:t,children:s})})]})},T=g.createContext({}),x=n=>{const{children:a,...e}=n,s=g.useMemo(()=>e,[e]);return o.jsx(T.Provider,{value:s,children:a})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",J=(n,a,e,s)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:i}=g.use(T),t=e&&(r===n||s&&r===Y);return g.useEffect(()=>{i({id:n,tekst:a,erAktiv:t,harApneAksjonspunkter:s,skalVisesImeny:e})},[e,t,s]),e&&t},q=({standardPanelProps:n,skalPanelVisesIMeny:a,faktaPanelKode:e,faktaPanelMenyTekst:s,children:r})=>{const{behandling:i,fagsak:t,alleKodeverk:d}=g.use(p),l=J(e,s,a,n.harApneAksjonspunkter);return o.jsx(c,{behandling:i,children:l?o.jsx(K,{behandling:i,fagsak:t,alleKodeverk:d,aksjonspunkterForPanel:n.aksjonspunkter,harÅpneAksjonspunkter:n.harApneAksjonspunkter,submitCallback:n.submitCallback,isReadOnly:n.readOnly,alleMerknaderFraBeslutter:n.alleMerknaderFraBeslutter,children:r}):null})};q.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
