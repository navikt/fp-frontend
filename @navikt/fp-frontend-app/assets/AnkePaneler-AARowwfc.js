...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  underBehandlingKabalTrygderett?: boolean;
  behandletAvKabal?: boolean;
}>`},description:""}}};const ue=[E.AUTO_VENT_ANKE_OVERSENDT_TIL_TRYGDERETTEN],H=()=>{const n=_(),t=K(ue),{behandling:r}=f.use(c),o=O(r),{data:u}=V(o.anke.ankeVurderingOptions(r));return e.jsx(N,{standardPanelProps:t,prosessPanelKode:I.ANKE_MERKNADER,prosessPanelMenyTekst:n.formatMessage({id:"Behandlingspunkt.AnkeMerknader"}),skalPanelVisesIMeny:!0,children:u?e.jsx(U,{ankeVurdering:u}):e.jsx(S,{})})};H.__docgenInfo={description:"",methods:[],displayName:"AnkeTrygderettsbehandlingProsessStegInitPanel"};const ke=({valgtProsessSteg:n,valgtFaktaSteg:t})=>e.jsxs(e.Fragment,{children:[e.jsxs(Y,{valgtProsessSteg:n,valgtFaktaSteg:t,children:[e.jsx(D,{}),e.jsx(M,{}),e.jsx(H,{})]}),e.jsx(J,{valgtFaktaSteg:t,valgtProsessSteg:n,children:e.jsx(z,{})})]});ke.__docgenInfo={description:"",methods:[],displayName:"AnkePaneler",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""}}};export{ke as default};
