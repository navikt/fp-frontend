...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const Zl=[re.AVKLAR_ARBEIDSFORHOLD],_y=({arbeidsgiverOpplysningerPerId:e})=>{const n=z(),r=Qn(Zl),{behandling:t}=R.use(En),a=Rn(t),{data:s}=Tn(a.arbeidOgInntektOptions(t));return i.jsx(Xn,{standardPanelProps:r,faktaPanelKode:Wn.ARBEIDSFORHOLD,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Arbeidsforhold"}),skalPanelVisesIMeny:Zl.some(l=>sa(l,t.aksjonspunkt)),children:s?i.jsx(em,{arbeidOgInntekt:s,arbeidsgiverOpplysningerPerId:e}):i.jsx(In,{})})};_y.__docgenInfo={description:`ArbeidsforholdFaktaInitPanel
...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const mn=({tittel:e,children:n})=>i.jsxs(B,{gap:"1",children:[i.jsx(x,{size:"medium",children:e}),n]});mn.__docgenInfo={description:"",methods:[],displayName:"InntektsmeldingInfoBlokk",props:{tittel:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const Nk=({arbeidsgiverOpplysninger:e,arbeidsgiverIdent:n})=>{const r=z();return i.jsxs(mn,{tittel:r.formatMessage({id:"InntektsmeldingFaktaPanel.arbeidsgiver.heading"}),children:[i.jsxs("span",{children:[i.jsx(m,{id:"InntektsmeldingFaktaPanel.arbeidsgiver.navn"}),": ",e.navn]}),i.jsxs("span",{children:[i.jsx(m,{id:"InntektsmeldingFaktaPanel.arbeidsgiver.underenhet"}),": ",n]})]})};Nk.__docgenInfo={description:"",methods:[],displayName:"Arbeidsgiver",props:{arbeidsgiverOpplysninger:{required:!0,tsType:{name:"Readonly",elements:[{name:"union",raw:`| {
    erPrivatPerson: true;
    identifikator: string;
    navn: string;
    referanse: string;
...
Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Pk=({kildeSystem:e})=>{const n=z(),r=R.useMemo(()=>{switch(e.toUpperCase()){case"NAV_NO":return n.formatMessage({id:"InntektsmeldingFaktaPanel.kilde.nav"});case"ALTINN":return n.formatMessage({id:"InntektsmeldingFaktaPanel.kilde.altinn"});default:return n.formatMessage({id:"InntektsmeldingFaktaPanel.kilde.lps"})}},[n,e]);return i.jsx(mn,{tittel:n.formatMessage({id:"InntektsmeldingFaktaPanel.kilde.heading"}),children:r})};Pk.__docgenInfo={description:"",methods:[],displayName:"KildeSystem",props:{kildeSystem:{required:!0,tsType:{name:"string"},description:""}}};const Bk=({inntektsmelding:e})=>{const n=z();return i.jsxs(mn,{tittel:n.formatMessage({id:"InntektsmeldingFaktaPanel.kontaktperson.heading"}),children:[i.jsxs("span",{children:[i.jsx(m,{id:"InntektsmeldingFaktaPanel.kontaktperson.navn"}),": ",e.kontaktpersonNavn]}),i.jsxs("span",{children:[i.jsx(m,{id:"InntektsmeldingFaktaPanel.kontaktperson.telefon"}),": ",e.kontaktpersonNummer]})]})};Bk.__docgenInfo={description:"",methods:[],displayName:"KontaktPerson",props:{inntektsmelding:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  inntektPrMnd: number;
  refusjonPrMnd?: number;
  arbeidsgiverIdent: string;
  eksternArbeidsforholdId?: string | null;
...
>`},description:""}}};const xk=({inntektsmelding:e})=>{const n=z();if(e.refusjonsperioder.length===0)return i.jsx(mn,{tittel:n.formatMessage({id:"InntektsmeldingFaktaPanel.refusjon.heading"}),children:i.jsx("span",{children:e.refusjonPrMnd?V(e.refusjonPrMnd):i.jsx(m,{id:"InntektsmeldingFaktaPanel.refusjon.ingen"})})});const r=[...e.refusjonsperioder].sort((t,a)=>new Date(t.fom).getTime()-new Date(a.fom).getTime());return i.jsxs(mn,{tittel:n.formatMessage({id:"InntektsmeldingFaktaPanel.refusjon.heading"}),children:[i.jsx("span",{children:"Krever refusjon"}),i.jsx("span",{children:V(e.refusjonPrMnd??0)}),i.jsx("span",{children:"Endringer i perioden:"}),i.jsx("ul",{children:r.map(t=>i.jsx("li",{children:i.jsx(m,{id:"InntektsmeldingFaktaPanel.refusjon.endring.periode",values:{kroner:V(t.refusjonsbeløp.verdi),fom:i.jsx(be,{dateString:t.fom})}})},t.indexKey))})]})};xk.__docgenInfo={description:"",methods:[],displayName:"Refusjon",props:{inntektsmelding:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  inntektPrMnd: number;
  refusjonPrMnd?: number;
  arbeidsgiverIdent: string;
  eksternArbeidsforholdId?: string | null;
...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const jN=[re.VURDER_PERIODER_MED_OPPTJENING],cN=({arbeidsgiverOpplysningerPerId:e})=>{const n=z(),{behandling:r}=R.use(En),t=Qn(jN),a=r.vilkår.some(u=>u.vilkarType===Yn.OPPTJENINGSVILKARET)&&r.vilkår.some(u=>u.vilkarType===Yn.MEDLEMSKAPSVILKARET&&u.vilkarStatus===Dg.OPPFYLT),s=Rn(r),{data:l,isFetching:o}=Tn(s.opptjeningOptions(r,a));return i.jsx(Xn,{standardPanelProps:t,faktaPanelKode:Wn.OPPTJENINGSVILKARET,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Opptjening"}),skalPanelVisesIMeny:a,children:o?i.jsx(In,{}):i.jsx(Uk,{opptjening:l,arbeidsgiverOpplysningerPerId:e})})};cN.__docgenInfo={description:"",methods:[],displayName:"OpptjeningsvilkaretFaktaInitPanel",props:{arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"union",raw:`| {
    erPrivatPerson: true;
    identifikator: string;
    navn: string;
    referanse: string;
...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const Mu=[re.VURDER_ARBEIDSFORHOLD_PERMISJON],HN=({arbeidsgiverOpplysningerPerId:e})=>{const n=z(),{behandling:r}=R.use(En),t=Qn(Mu),a=Rn(r),{data:s}=Tn(a.arbeidOgInntektOptions(r));return i.jsx(Xn,{standardPanelProps:t,faktaPanelKode:Wn.PERMISJON,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Permisjon"}),skalPanelVisesIMeny:Mu.some(l=>sa(l,r.aksjonspunkt)),children:s?i.jsx(Qk,{arbeidOgInntekt:s,arbeidsgiverOpplysningerPerId:e}):i.jsx(In,{})})};HN.__docgenInfo={description:"",methods:[],displayName:"PermisjonFaktaInitPanel",props:{arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"union",raw:`| {
    erPrivatPerson: true;
    identifikator: string;
    navn: string;
    referanse: string;
