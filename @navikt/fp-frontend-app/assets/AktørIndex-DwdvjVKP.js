import{j as e,i as p,P as v,b as f,L as q}from"./iframe-Dnfhn1YB.js";import{Q as j}from"./index.es-fOUzb52u.js";import{u as w,r as c}from"./fagsakApi-DIKZF_1h.js";import{V as I}from"./VisittkortSakIndex-C2IArgvV.js";import{V as T,a as F,B as R}from"./VStack-DUh9eA8z.js";import{M as l}from"./message-58ng55Ym.js";import{E}from"./IngenBehandlingValgtPanel-CZvy_wT2.js";import{u as K}from"./useTrackRouteParam-BB7btqgU.js";import{p as x}from"./paths-CzPEKygu.js";import{u as m}from"./useKodeverk-BMe4Yse_.js";const g=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(I,{bruker:n.person}),e.jsx(T,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{var t,k;const i=(t=s.find(o=>o.kode===a.fagsakYtelseType))==null?void 0:t.navn,d=(k=r.find(o=>o.kode===a.status))==null?void 0:k.navn;return e.jsx(p.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(F,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});g.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
