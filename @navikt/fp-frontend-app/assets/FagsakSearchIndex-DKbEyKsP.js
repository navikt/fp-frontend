import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as T,u as b,n as F}from"./initFetch-i6NRQl-j.js";import{a as K,e as x,X as A,p as I,u as M}from"./index.es-cjZwphL1.js";import{k as N,V as _,h as k,H as y,n as P,P as E,C as V}from"./withPanelData-GOmTAiR7.js";import{a as u,d as O,n as C}from"./index.es-CZJHMjzL.js";import{K as c}from"./alleKodeverk-BFmIlMu4.js";import{g as Y}from"./kodeverkUtils-DLZgokMR.js";import{T as s}from"./Table-DyJaznXk.js";import"./index-DjhIdADd.js";import{S as D}from"./ExclamationmarkTriangleFill-Jd_pHapJ.js";import{p as H}from"./paths-BXEWg1CO.js";import{a as L}from"./index-CfpqQiaz.js";const j=({fagsaker:r,selectFagsakCallback:a,alleKodeverk:t})=>{const i=Y(t);return e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:r.map(n=>e.jsxs(s.Row,{onMouseDown:()=>a(n.saksnummer),onKeyDown:()=>a(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:i(n.fagsakYtelseType,c.FAGSAK_YTELSE)}),e.jsx(s.DataCell,{children:i(n.status,c.FAGSAK_STATUS)})]},n.saksnummer))})]})};j.__docgenInfo={description:`FagsakList
