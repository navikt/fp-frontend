import{j as e,i as g,P as y,b as p,L as v}from"./iframe-C-gWpEI4.js";import{X as f}from"./index.es-Zhk1lkMb.js";import{u as q,r as j}from"./fagsakApi-Dw-MAcYJ.js";import{V as w}from"./VisittkortSakIndex-Ck6it4oe.js";import{V as c,a as I,B as T}from"./VStack-fpw_0gkk.js";import{M as k}from"./message-Oq6C-QQ2.js";import{E as F}from"./IngenBehandlingValgtPanel-Cgti6iIn.js";import{u as R}from"./useTrackRouteParam-Dd1JR0nP.js";import{p as E}from"./paths-BxSW6lHq.js";import{u as o}from"./useKodeverk-CkaInK_N.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(w,{bruker:n.person}),e.jsx(c,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
