...
om klassifisering er utført og ingen faresignaler er funnet og om klassifisering er utført og faresignaler er funnet`,methods:[],displayName:"RisikoklassifiseringSakIndex",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const dn=({fagsakData:e,behandling:a,setBehandling:t})=>{const n=e.getFagsak(),{selected:r=!1}=xe({paramName:"risiko",parse:g=>g==="true",isQueryParam:!0}),i=Y(),l=$(),o=()=>{i(E(l)(!r))},{kodeverkOptions:m}=D(),{data:d}=A(m()),y=e.getBehandling(a==null?void 0:a.uuid);return a&&y?s.jsx(kn,{isRiskPanelOpen:r,fagsak:n,toggleRiskPanel:o,behandlingAppKontekst:y,behandling:a,setBehandling:t}):s.jsx(_,{risikoklassifisering:n.kontrollResultat,isPanelOpen:r,readOnly:!0,toggleRiskPanel:o,faresignalVurderinger:N(d)[Q.FARESIGNAL_VURDERING]})},kn=({fagsak:e,behandling:a,behandlingAppKontekst:t,setBehandling:n,toggleRiskPanel:r,isRiskPanelOpen:i})=>{const{behandlingPaaVent:l,status:o,type:m,risikoAksjonspunkt:d,kontrollResultat:y}=t,{kodeverkOptions:g}=D(),c=A(ge()),{data:se}=A(g()),K=N(c.data).innloggetBruker,ie=en(K,e.status,o,m),le=mn(K,ie,l),G=Y(),L=$();u.useEffect(()=>{d&&d.status===w.OPPRETTET&&!i&&G(E(L)(!0)),d&&d.status===w.UTFORT&&G(E(L)(!1))},[!!d,a.uuid,a.versjon]);const{lagreAksjonspunkter:oe}=Ve(a,n),ue=H=>{oe({behandlingUuid:a.uuid,behandlingVersjon:a.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":H.kode,...H}]})};return s.jsx(_,{aksjonspunkt:d,risikoklassifisering:y,isPanelOpen:i,readOnly:le,submitAksjonspunkt:ue,toggleRiskPanel:r,faresignalVurderinger:N(se)[Q.FARESIGNAL_VURDERING]})},mn=(e,a,t)=>{if(t)return!0;const{kanSaksbehandle:n}=e;return!n||!a.writeAccess.isEnabled};dn.__docgenInfo={description:`RisikoklassifiseringIndex
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""}}};export{v as E,x as K,dn as R,Fe as S,en as g};
