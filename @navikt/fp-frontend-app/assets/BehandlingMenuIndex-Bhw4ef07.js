...
Ved å trykke på ok skal ny behandling(1.gangsbehandling) av sak opprettes.`,methods:[],displayName:"EndreUtlandModal",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},fagsakMarkeringer:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const cb={"MenyEndreUtlandIndex.MenyTittel":"Endre saksmerking","MenyEndreUtlandIndex.UtlandTittel":"Saksmarkering","MenyEndreUtlandIndex.Ok":"OK","MenyEndreUtlandIndex.Avbryt":"Avbryt"},Wu=pe(cb),Vb=()=>Wu.formatMessage({id:"MenyEndreUtlandIndex.MenyTittel"}),$u=({endreFagsakMarkering:u,lukkModal:v,...i})=>{const p=A=>{u(A),v()};return g.jsx(Ge,{value:Wu,children:g.jsx(Yu,{cancelEvent:v,submitCallback:p,...i})})};$u.__docgenInfo={description:"",methods:[],displayName:"MenyEndreUtlandIndex",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},fagsakMarkeringer:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  fagsakMarkering: string;
  kortNavn?: string;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},gaaTilSokeside:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Yb="_modal_1awdg_11",Wb="_typeBredde_1awdg_29",$b="_arsakBredde_1awdg_33",Ni={modal:Yb,typeBredde:Wb,arsakBredde:$b},Jb=(u,v)=>{const i=v.some(p=>p.kode===u.kode);return g.jsx("option",{value:u.kode,disabled:!i,children:` ${u.navn} `},u.kode)},zb=[W.ANNET,W.FEIL_I_LOVANDVENDELSE,W.FEIL_ELLER_ENDRET_FAKTA,W.FEIL_REGELVERKSFORSTAELSE,W.FEIL_PROSESSUELL],Zb=[W.BEREEGNINGSGRUNNLAG,W.MEDLEMSKAP,W.OPPTJENING,W.FORDELING,W.INNTEKT,W.DØD,W.SØKERS_RELASJON,W.SØKNADSFRIST,W.KLAGE_U_INNTK,W.KLAGE_M_INNTK],Xb=[W.KLAGE_U_INNTK,W.KLAGE_M_INNTK,W.RE_ENDRET_INNTEKTSMELDING,W.RE_ENDRING_FRA_BRUKER,W.FØDSEL,W.DØD,W.ANNET,W.INNTEKT],Qb=[W.RE_FORELDELSE,W.RE_VILKÅR,W.RE_KLAGE_KA,W.RE_KLAGE_NFP,W.RE_FEILUTBETALT_BELØP_REDUSERT],ef=(u,v,i,p)=>{if(p===U.TILBAKEKREVING_REVURDERING)return Qb.flatMap(A=>{const N=i.find(T=>T.kode===A);return N?[N]:[]});if(p===U.REVURDERING){const A=u===Pa.FORELDREPENGER,N=u===Pa.SVANGERSKAPSPENGER;let T=A?Zb:zb;return N&&(T=Xb),v.filter(R=>T.some(c=>c===R.kode)).sort((R,c)=>R.navn.localeCompare(c.navn))}return[]},nf=u=>[...u].sort((v,i)=>v.navn.localeCompare(i.navn)),rf=(u,v,i={kanBehandlingOpprettes:!1,kanRevurderingOpprettes:!1})=>u.filter(p=>p.kode===U.TILBAKEKREVING?i.kanBehandlingOpprettes:p.kode===U.TILBAKEKREVING_REVURDERING?i.kanRevurderingOpprettes:v.some(A=>A.behandlingType===p.kode&&A.kanOppretteBehandling)),eo=({submitCallback:u,cancelEvent:v,behandlingstyper:i,uuidForSistLukkede:p,ytelseType:A,behandlingOppretting:N,kanTilbakekrevingOpprettes:T,revurderingArsaker:R,tilbakekrevingRevurderingArsaker:c})=>{const j=or(),B=gr(),I=ne=>u({...ne,eksternUuid:p,fagsakYtelseType:A}),z=B.watch("behandlingType"),ee=nf(i),me=rf(ee,N,T),_e=ef(A,R,c,z);return g.jsx(dr,{formMethods:B,onSubmit:I,children:g.jsxs(ie,{className:Ni.modal,open:!0,"aria-label":j.formatMessage({id:"MenyNyBehandlingIndex.ModalDescription"}),onClose:v,children:[g.jsx(ie.Header,{children:g.jsx(Fr,{size:"small",children:g.jsx(J,{id:"MenyNyBehandlingIndex.OpprettNyForstegangsbehandling"})})}),g.jsx(ie.Body,{children:g.jsxs(bn,{gap:"4",children:[g.jsx(Lr,{name:"behandlingType",label:"",validate:[Re],selectValues:ee.map(ne=>Jb(ne,me)),className:Ni.typeBredde}),z===U.FORSTEGANGSSOKNAD&&g.jsx(KE,{name:"nyBehandlingEtterKlage",label:j.formatMessage({id:"MenyNyBehandlingIndex.NyBehandlingEtterKlage"})}),_e.length>0&&g.jsx(Lr,{name:"behandlingArsakType",label:"",hideLabel:!0,validate:[Re],className:Ni.arsakBredde,selectValues:_e.map(ne=>g.jsx("option",{value:ne.kode,children:ne.navn},ne.kode))})]})}),g.jsxs(ie.Footer,{children:[g.jsx(Ie,{size:"small",variant:"primary",children:g.jsx(J,{id:"MenyNyBehandlingIndex.Ok"})}),g.jsx(Ie,{size:"small",variant:"secondary",onClick:v,type:"button",children:g.jsx(J,{id:"MenyNyBehandlingIndex.Avbryt"})})]})]})})};eo.__docgenInfo={description:`NyBehandlingModal
