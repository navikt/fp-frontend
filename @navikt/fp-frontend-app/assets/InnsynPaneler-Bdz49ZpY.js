...
som viser at ingen dokumenter finnes på fagsak.`,methods:[],displayName:"DocumentListInnsyn",props:{saksNr:{required:!0,tsType:{name:"string"},description:""},documents:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kommunikasjonsretning: string;
  gjelderFor?: string;
}>`}],raw:"Dokument[]"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const ge=({vedtaksdokumenter:n,behandlingTypes:t})=>{const[r,a]=l.useState(!1),s=l.useCallback(i=>{a(!r),i.preventDefault()},[r]);return n.length===0?e.jsx(g,{id:"DocumentListInnsyn.Vedtaksdokumentasjon",values:{numberOfDocuments:0}}):e.jsxs(e.Fragment,{children:[e.jsxs($,{href:"#",onClick:s,children:[e.jsx(g,{id:"DocumentListInnsyn.Vedtaksdokumentasjon",values:{numberOfDocuments:n.length}}),r?e.jsx(Oe,{}):e.jsx(Ke,{})]}),r&&e.jsxs(e.Fragment,{children:[e.jsx(d,{fourPx:!0}),e.jsx(te,{children:n.map(i=>{var u;return e.jsxs(se,{children:[e.jsx(F,{children:e.jsx(xe,{dateString:i.opprettetDato})}),e.jsx(F,{children:e.jsx($,{href:Be(i.behandlingUuid),target:"_blank",children:((u=t.find(o=>o.kode===i.tittel))==null?void 0:u.navn)||"-"})})]},i.behandlingUuid)})})]})]})};ge.__docgenInfo={description:"",methods:[],displayName:"VedtakDocuments",props:{behandlingTypes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  tittel: string;
  opprettetDato: string;
}>`}],raw:"InnsynVedtaksdokument[]"},description:""}}};const un=[],on=n=>n.reduce((t,r)=>({[`dokument_${r.dokumentId}`]:r.fikkInnsyn,...t}),{}),gn=(n,t,r,a,s)=>({mottattDato:n,innsynResultatType:t||void 0,fristDato:s||Ve().add(3,"days").format(he),sattPaVent:a[0].status===ie.OPPRETTET?void 0:!!s,...le.buildInitialValues(a),...on(r||[])}),dn=(n,t)=>t.map(r=>({dokumentId:r.dokumentId,journalpostId:r.journalpostId,fikkInnsyn:!!n[`dokument_${r.dokumentId}`]})),kn=n=>Object.keys(n).filter(t=>!t.startsWith("dokument_")).reduce((t,r)=>({...t,[r]:n[r]}),{}),mn=(n,t)=>({kode:c.VURDER_INNSYN,innsynDokumenter:dn(n,t),...kn(n)}),yn=n=>{const t=n.filter(r=>r.kommunikasjonsretning===S.INN);return n.forEach(r=>!t.some(a=>a.dokumentId===r.dokumentId)&&t.push(r)),t},de=({readOnly:n,readOnlySubmitButton:t,innsynMottattDato:r,alleKodeverk:a,vedtaksdokumentasjon:s,innsynResultatType:i,fristBehandlingPåVent:u,innsynDokumenter:o,alleDokumenter:k=[],aksjonspunkter:m,submitCallback:h,saksNr:p,formData:N,setFormData:D})=>{const v=B(),E=l.useMemo(()=>gn(r,i,o,m,u),[r,i,u,o,m]),j=X({defaultValues:N||E}),O=l.useMemo(()=>yn(k),[k]),V=l.useMemo(()=>a[_.INNSYN_RESULTAT_TYPE].filter(q=>q.kode!=="-").sort((q,qe)=>q.navn.localeCompare(qe.navn)).reverse(),[a]),b=m[0].status===ie.OPPRETTET,y=j.watch("innsynResultatType"),H=j.watch("sattPaVent");return e.jsxs(ee,{formMethods:j,onSubmit:q=>h(mn(q,k)),setDataOnUnmount:D,children:[e.jsx(L,{size:"small",children:e.jsx(g,{id:"InnsynForm.Innsynsbehandling"})}),e.jsx(d,{twentyPx:!0}),e.jsx(Le,{isAksjonspunktOpen:b,children:[e.jsx(g,{id:"InnsynForm.VurderKravetOmInnsyn"},"1")]}),e.jsx(d,{twentyPx:!0}),e.jsx(G,{name:"mottattDato",label:v.formatMessage({id:"InnsynForm.DatoMottattKrav"}),isReadOnly:n,isEdited:!b,validate:[I,C]}),e.jsx(d,{sixteenPx:!0}),e.jsx(ge,{vedtaksdokumenter:s||un,behandlingTypes:a[_.BEHANDLING_TYPE]}),e.jsx(d,{twentyPx:!0}),e.jsx(M,{saksNr:p,documents:O,readOnly:n}),e.jsx(le,{readOnly:n}),e.jsx(d,{sixteenPx:!0}),e.jsx(Y,{name:"innsynResultatType",label:e.jsx(g,{id:"InnsynForm.Resultat"}),validate:[I],isReadOnly:n,isHorizontal:!0,isEdited:!b,radios:V.map(q=>({value:q.kode,label:q.navn}))}),(y===T.INNVILGET||y===T.DELVISTINNVILGET)&&e.jsxs(e.Fragment,{children:[e.jsx(d,{eightPx:!0}),e.jsxs(Me,{alignOffset:y===T.INNVILGET?28:176,children:[e.jsx(Y,{name:"sattPaVent",label:e.jsx(g,{id:"InnsynForm.VelgVidereAksjon"}),validate:[I],isReadOnly:n,isEdited:!b,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:v.formatMessage({id:"InnsynForm.SettBehandlingPåVent"})},{value:"false",label:v.formatMessage({id:"InnsynForm.ForeslåOgFatteVedtak"})}]}),H&&e.jsxs(e.Fragment,{children:[e.jsx(d,{eightPx:!0}),e.jsx(G,{name:"fristDato",label:v.formatMessage({id:"InnsynForm.FristDato"}),isReadOnly:n,isEdited:!b,validate:[I,C]})]})]})]}),e.jsx(d,{sixteenPx:!0}),e.jsx(ue,{isReadOnly:n,isSubmittable:!t,isSubmitting:j.formState.isSubmitting,isDirty:j.formState.isDirty,text:H?v.formatMessage({id:"SubmitButton.SettPåVent"}):void 0})]})};de.__docgenInfo={description:`InnsynForm
...
som viser at ingen dokumenter finnes på fagsak.`,methods:[],displayName:"DocumentListVedtakInnsyn",props:{saksNr:{required:!0,tsType:{name:"string"},description:""},documents:{required:!0,tsType:{name:"Array",elements:[{name:"unknown"}],raw:`({
  fikkInnsyn: boolean;
} & Dokument)[]`},description:""}}};const Rn="_wordwrap_1hm28_1",Bn={wordwrap:Rn},Vn=Fe(1500),In=Se(3),Pn=(n,t)=>r=>{r.preventDefault();const a={fritekst:t||" ",mottaker:"",dokumentMal:Ne.INNSYN_SVAR,gjelderVedtak:!0};n(a)},Fn=n=>{const t=n.filter(r=>r.kommunikasjonsretning===S.INN);return n.forEach(r=>!t.some(a=>a.dokumentId===r.dokumentId)&&t.push(r)),t},Sn=(n,t)=>n.filter(r=>t.find(a=>a.dokumentId===r.dokumentId)).map(r=>{var a;return{...r,fikkInnsyn:((a=t.find(s=>s.dokumentId===r.dokumentId))==null?void 0:a.fikkInnsyn)||!1}}),Nn=n=>n===T.AVVIST?"InnsynVedtakForm.Avslatt":n===T.DELVISTINNVILGET?"InnsynVedtakForm.Delvis":"InnsynVedtakForm.Innvilget",Dn=(n,t)=>{var r;return{mottattDato:n,begrunnelse:(r=t.find(a=>a.definisjon===c.FORESLA_VEDTAK))==null?void 0:r.begrunnelse}},En=n=>({kode:c.FORESLA_VEDTAK,...n}),ve=({readOnly:n,previewCallback:t,saksNr:r,innsynMottattDato:a,aksjonspunkter:s,submitCallback:i,innsynResultatType:u,innsynDokumenter:o,sprakkode:k,alleDokumenter:m,formData:h,setFormData:p})=>{var b;const N=B(),D=l.useMemo(()=>Dn(a,s),[a,s]),v=X({defaultValues:h||D}),E=l.useMemo(()=>Sn(Fn(m),o),[m,o]),j=(b=s.find(y=>y.definisjon===c.VURDER_INNSYN))==null?void 0:b.begrunnelse,O=v.watch("begrunnelse"),V=Pn(t,O);return e.jsxs(ee,{formMethods:v,onSubmit:y=>i(En(y)),setDataOnUnmount:p,children:[e.jsx(L,{size:"small",children:e.jsx(g,{id:n?"InnsynVedtakForm.Vedtak":"InnsynVedtakForm.ForslagVedtak"})}),e.jsx(d,{eightPx:!0}),e.jsx(U,{size:"small",children:e.jsx(g,{id:"InnsynVedtakForm.Resultat"})}),e.jsx(w,{size:"small",children:e.jsx(g,{id:Nn(u)})}),e.jsx(d,{eightPx:!0}),e.jsx(U,{size:"small",children:e.jsx(g,{id:"InnsynVedtakForm.Vurdering"})}),e.jsx(w,{size:"small",className:Bn.wordwrap,children:Te(j)}),e.jsx(d,{twentyPx:!0}),u!==T.INNVILGET&&e.jsx(Ie,{name:"begrunnelse",label:N.formatMessage({id:"InnsynVedtakForm.Fritekst"}),validate:[In,Vn,Pe],maxLength:1500,readOnly:n,parse:ce,badges:[{type:"info",titleText:Ae(k)}]}),e.jsx(d,{twentyPx:!0}),u!==T.AVVIST&&e.jsx(ye,{saksNr:r,documents:E.filter(y=>y.fikkInnsyn===!0)}),e.jsx(d,{twentyPx:!0}),e.jsx(te,{children:e.jsxs(se,{children:[!n&&e.jsx(F,{children:e.jsx(ue,{isReadOnly:n,isSubmittable:!0,isSubmitting:v.formState.isSubmitting,isDirty:v.formState.isDirty,hasEmptyRequiredFields:!1})}),e.jsx(F,{children:e.jsx("a",{onClick:V,onKeyDown:y=>y.key==="Enter"?V(y):null,className:"lenke lenke--frittstaende",target:"_blank",rel:"noopener noreferrer",role:"link",tabIndex:0,children:e.jsx(g,{id:n?"InnsynVedtakForm.VisVedtaksbrev":"InnsynVedtakForm.ForhåndsvisBrev"})})})]})})]})};ve.__docgenInfo={description:`InnsynVedtakForm
