import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as b}from"./index-DRjF_FHU.js";import{B as _e}from"./BehandlingContainer-DFu81qx2.js";import{V as Ge}from"./VergeFaktaInitPanel-YYs5gs8E.js";import{e as x,b as K,H as N,D as Ye,V as Y,d as c,L as h,B as f,P as Q,M as ge}from"./nb_NO-BvZ51WMw.js";import{O as M,f as de,$ as ke,V as q,M as W,H as B,k as S,a as me,b as ye,h as C,K as V,T as X,B as ve,r as U,l as w,x as D,A as pe,a2 as H}from"./AppIndex.stories-Cu-C7Hs4.js";import"./aktivitetStatus-02fOJoqz.js";import{a as be,b as Ce,B as O}from"./behandlingResultatType-DHbqkXMl.js";import{M as u,y as d,e as qe,a as fe,K as he,t as Z,o as je,u as ze,m as $e}from"./index.es-DgvnPOIp.js";import{P as Ae,a as ee}from"./OverstyringPanel-BkjJSW8a.js";import{P as z,u as Te}from"./ProsessDefaultInitPanel-DB1Cqhm-.js";import{V as I}from"./BehandlingHenlagtPanel-D7ce66c6.js";import{v as Je}from"./validerApKodeOgHentApEnum-BJOxEDqe.js";import{L as Ke}from"./index.es-DO2r2S9Z.js";import{F as We}from"./FatterVedtakStatusModal-BVIXhi9s.js";import{K as Qe}from"./KlageBehandlingModal-CWMKXOkI.js";import"./bind-HXjDzSm9.js";import"./index-rX-Bn4lm.js";import"./iframe-sqxhCA2W.js";import"../sb-preview/runtime.js";import"./SettPaVentReadOnlyModal-CTLkZwUR.js";var m=(n=>(n.STADFESTE_YTELSESVEDTAK="STADFESTE_YTELSESVEDTAK",n.MEDHOLD_I_KLAGE="MEDHOLD_I_KLAGE",n.OPPHEVE_YTELSESVEDTAK="OPPHEVE_YTELSESVEDTAK",n.AVVIS_KLAGE="AVVIS_KLAGE",n.HJEMSENDE_UTEN_Å_OPPHEVE="HJEMSENDE_UTEN_Å_OPPHEVE",n))(m||{}),F=(n=>(n.DELVIS_MEDHOLD_I_KLAGE="DELVIS_MEDHOLD_I_KLAGE",n.GUNST_MEDHOLD_I_KLAGE="GUNST_MEDHOLD_I_KLAGE",n.UGUNST_MEDHOLD_I_KLAGE="UGUNST_MEDHOLD_I_KLAGE",n.UDEFINERT="-",n))(F||{});const L="ikkePaklagdVedtak",ne=n=>n.erKlagerPart===!1||n.erFristOverholdt===!1||n.erKonkret===!1||n.erSignert===!1||n.vedtak===L,Be=(n,r)=>n.find(t=>t.uuid===r),re=(n,r)=>{const t=Be(n,r);return!!t&&(t.type===M.TILBAKEKREVING||t.type===M.TILBAKEKREVING_REVURDERING)},Re=(n,r)=>{const t=re(n,r),s=Be(n,r);return s&&t?{tilbakekrevingUuid:s.uuid,tilbakekrevingVedtakDato:s.avsluttet,tilbakekrevingBehandlingType:s.type}:void 0},Xe=(n,r,t,s)=>({kode:s,begrunnelse:n.begrunnelse,behandlingUuid:r,erKlagerPart:n.erKlagerPart,erFristOverholdt:n.erFristOverholdt,erKonkret:n.erKonkret,erSignert:n.erSignert,erTilbakekreving:re(t,n.vedtak),klageTilbakekreving:Re(t,n.vedtak),paKlagdBehandlingUuid:n.vedtak===L?void 0:n.vedtak,fritekstTilBrev:ne(n)?n.fritekstTilBrev:void 0}),ae=({behandlingUuid:n,saveKlage:r,avsluttedeBehandlinger:t,spinner:s,aksjonspunktCode:a,readOnly:l,handleSubmit:g})=>l?null:e.jsx(x,{size:"small",variant:"primary",loading:s,onClick:g(i=>r(Xe(i,n,t,a))),type:"button",children:e.jsx(u,{id:"TempsaveKlageButton.TempSaveButton"})});ae.defaultProps={spinner:!1,readOnly:!1};ae.__docgenInfo={description:"",methods:[],displayName:"TempsaveKlageButton",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunktCode:{required:!0,tsType:{name:"string"},description:""},avsluttedeBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  type: string;
  avsluttet?: string;
  uuid: string;
  ...
  vedtak?: string;
  fritekstTilBrev?: string;
}`,signature:{properties:[{key:"erKlagerPart",value:{name:"boolean",required:!1}},{key:"erFristOverholdt",value:{name:"boolean",required:!1}},{key:"erKonkret",value:{name:"boolean",required:!1}},{key:"erSignert",value:{name:"boolean",required:!1}},{key:"begrunnelse",value:{name:"string",required:!1}},{key:"vedtak",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}}]}}],raw:"UseFormHandleSubmit<FormValues>"},description:""}}};const Ze="_selectBredde_19ro0_1",en="_textField_19ro0_4",nn={selectBredde:Ze,textField:en},rn=n=>n!=null&&n.paKlagdBehandlingUuid?`${n.paKlagdBehandlingUuid}`:L,an=(n,r,t)=>[e.jsx("option",{value:L,children:r.formatMessage({id:"Klage.Formkrav.IkkePåklagdVedtak"})},"formkrav")].concat([...n].sort((a,l)=>C(a.avsluttet).diff(C(l.avsluttet))).map(a=>e.jsx("option",{value:`${a.uuid}`,children:`${t(a.type,V.BEHANDLING_TYPE)} ${C(a.avsluttet).format(he)}`},a.uuid))),tn=n=>n===q.VURDERING_AV_FORMKRAV_KLAGE_NFP?"Klage.LovhjemmelNFP":"Klage.LovhjemmelKA",sn=n=>{const r=n?n.klageFormkravResultatNFP:null,t=n?n.klageVurderingResultatNFP:null;return{vedtak:r?rn(r):"",begrunnelse:r?r.begrunnelse:void 0,erKlagerPart:r?r.erKlagerPart:void 0,erKonkret:r?r.erKlageKonkret:void 0,erFristOverholdt:r?r.erKlagefirstOverholdt:void 0,erSignert:r?r.erSignert:void 0,fritekstTilBrev:t?t.fritekstTilBrev:void 0}},ln=(n,r)=>({erKlagerPart:n.erKlagerPart,erFristOverholdt:n.erFristOverholdt,erKonkret:n.erKonkret,erSignert:n.erSignert,begrunnelse:n.begrunnelse,kode:q.VURDERING_AV_FORMKRAV_KLAGE_NFP,vedtakBehandlingUuid:n.vedtak===L?void 0:n.vedtak,erTilbakekreving:re(r,n.vedtak),tilbakekrevingInfo:Re(r,n.vedtak),fritekstTilBrev:ne(n)?n.fritekstTilBrev:void 0}),we=({behandlingUuid:n,readOnly:r,klageVurdering:t,readOnlySubmitButton:s,alleKodeverk:a,avsluttedeBehandlinger:l,submitCallback:g,lagreFormkravVurdering:i,formData:v,setFormData:p})=>{const o=K(),y=X(a),k=an(l,o,y),R=b.useMemo(()=>sn(t),[t]),A=de({defaultValues:v||R}),P=A.watch();return e.jsxs(ke,{formMethods:A,onSubmit:T=>g(ln(T,l)),setDataOnUnmount:p,children:[e.jsx(N,{size:"small",children:o.formatMessage({id:"Klage.Formkrav.Title"})}),e.jsx(d,{fourPx:!0}),e.jsx(Ye,{children:o.formatMessage({id:tn(q.VURDERING_AV_FORMKRAV_KLAGE_NFP)})}),e.jsx(d,{sixteenPx:!0}),e.jsxs(Y,{gap:"6",children:[e.jsx(qe,{isAksjonspunktOpen:!s,children:[e.jsx(u,{id:"Klage.Formkrav.HelpText"},q.VURDERING_AV_FORMKRAV_KLAGE_NFP)]}),e.jsx(Y,{gap:"6",children:e.jsxs(c,{gap:"10",children:[e.jsx("div",{children:e.jsx(W,{readOnly:r,validate:[B],name:"vedtak",label:o.formatMessage({id:"Klage.Formkrav.VelgVedtak"}),selectValues:k,className:nn.selectBredde})}),e.jsxs(Y,{gap:"5",children:[e.jsxs(c,{gap:"4",children:[e.jsx(S,{name:"erKlagerPart",label:o.formatMessage({id:"Klage.Formkrav.ErKlagerPart"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]}),e.jsx(S,{name:"erKonkret",label:o.formatMessage({id:"Klage.Formkrav.ErKonkret"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]})]}),e.jsxs(c,{gap:"4",children:[e.jsx(S,{name:"erFristOverholdt",label:o.formatMessage({id:"Klage.Formkrav.ErFristOverholdt"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]}),e.jsx(S,{name:"erSignert",label:o.formatMessage({id:"Klage.Formkrav.ErSignert"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]})]})]})]})}),e.jsx(Ae,{readOnly:r}),ne(P)&&e.jsx(me,{name:"fritekstTilBrev",label:o.formatMessage({id:"FormkravKlageFormNfp.Fritekst"}),maxLength:1e5,validate:[B,ye],readOnly:r,parse:fe}),e.jsxs(c,{justify:"space-between",children:[e.jsx(ee,{isReadOnly:r,isSubmittable:!s,isSubmitting:A.formState.isSubmitting,isDirty:A.formState.isDirty}),e.jsx(ae,{behandlingUuid:n,saveKlage:i,avsluttedeBehandlinger:l,handleSubmit:A.handleSubmit,readOnly:r,aksjonspunktCode:q.VURDERING_AV_FORMKRAV_KLAGE_NFP})]})]})]})};we.__docgenInfo={description:`FormkravklageformNfp
...
Readonly<{
  ...
  url?: string;
  utgått: boolean;
}>`}],raw:"HistorikkInnslagDokumentLink[]",required:!0}},{key:"tittel",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"body",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}],raw:`Readonly<{
  aktør: HistorikkUtfører;
  opprettetTidspunkt: string;
  behandlingUuid: string;
  skjermlenke: string | null;
...
Readonly<{
  ...
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const kn=[q.VURDER_FORMKRAV_NK],mn=[w.KLAGE_VURDERING],Pe=({alleBehandlinger:n,hentOgSettBehandling:r,...t})=>{const s=K(),a=b.useMemo(()=>n.filter(i=>i.status===ve.AVSLUTTET).filter(i=>(i.type!==M.KLAGE||be(i.resultatType))&&i.type!==M.ANKE),[n]),{startRequest:l}=U.useRestApiRunner(w.SAVE_FORMKRAV_VURDERING),g=i=>l(i).then(()=>r(!0));return e.jsx(z,{...t,panelEndepunkter:mn,aksjonspunktKoder:kn,prosessPanelKode:D.FORMKRAV_KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.FormkravKlageKA"}),skalPanelVisesIMeny:()=>!0,renderPanel:i=>e.jsx(te,{avsluttedeBehandlinger:a,lagreFormkravVurdering:g,...i})})};Pe.__docgenInfo={description:"",methods:[],displayName:"FormKravKlageInstansProsessStegInitPanel",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  uuid: string;
  type: string;
  status: string;
  opprettet: string;
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const jn=(n,r,t)=>s=>{const a={...s,behandlingUuid:t.uuid,fagsakYtelseType:r.fagsakYtelseType};return n(a).then(l=>je(l))},oe=(n,r=[])=>{const t=r.some(a=>a.status===pe.OPPRETTET);if(r.length===0||t)return I.IKKE_VURDERT;const s=n==null?void 0:n.type;return s===O.HENLAGT_KLAGE_TRUKKET||s===O.HENLAGT_FEILOPPRETTET?I.IKKE_VURDERT:s===O.KLAGE_AVVIST||s===O.KLAGE_YTELSESVEDTAK_OPPHEVET?I.IKKE_OPPFYLT:I.OPPFYLT},An=(n,r)=>()=>(r(!1),()=>{n(!0)}),Tn=[q.FORESLA_VEDTAK,q.FATTER_VEDTAK,q.FORESLA_VEDTAK_MANUELT],Kn=[w.KLAGE_VURDERING],Oe=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,...s})=>{const a=K(),[l,g]=b.useState(!1),i=Te(),v=An(g,r),{startRequest:p}=U.useRestApiRunner(w.PREVIEW_MESSAGE),o=b.useCallback(jn(p,n,i.behandling),[i.behandling.versjon]),{aksjonspunkt:y}=s.behandling;return e.jsx(z,{...s,panelEndepunkter:Kn,aksjonspunktKoder:Tn,prosessPanelKode:D.KLAGE_RESULTAT,prosessPanelMenyTekst:a.formatMessage({id:"Behandlingspunkt.ResultatKlage"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:k=>oe(k.behandling.behandlingsresultat,y),lagringSideEffekter:v,hentSkalMarkeresSomAktiv:k=>oe(k.behandling.behandlingsresultat,y)!==I.IKKE_VURDERT,renderPanel:k=>e.jsxs(e.Fragment,{children:[e.jsx(We,{visModal:l,lukkModal:()=>{g(!1),t()},tekst:a.formatMessage({id:"FatterVedtakStatusModal.KlagenErFerdigbehandlet"})}),e.jsx(Se,{previewVedtakCallback:o,...k})]})})};Oe.__docgenInfo={description:"",methods:[],displayName:"KlageresultatProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Setter opp readonly-panel for behandling av klage (KA).`,methods:[],displayName:"BehandleKlageFormKa",props:{alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  underBehandlingKabal?: boolean;
  behandletAvKabal?: boolean;
}>`},description:""}}};const Me=({erModalÅpen:n,lukkModal:r,isSubmittable:t,isSubmitting:s,isDirty:a,readOnly:l,valgtHjemmel:g})=>{const i=K();return e.jsx(ge,{width:"500px",open:n,"aria-label":i.formatMessage({id:"Klage.Modal.Overskrift"}),onClose:r,children:e.jsx(ge.Body,{children:e.jsxs(Y,{gap:"3",children:[e.jsxs("div",{children:[e.jsx(h,{size:"medium",children:e.jsx(u,{id:"Klage.Modal.Overskrift"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.SendTilKlageinstans"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.Valg"})}),e.jsx(d,{eightPx:!0}),e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.Oppretthold"})}),e.jsx(d,{fourPx:!0}),g&&e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.Hjemmel",values:{hjemmel:g}})}),e.jsx(d,{fourPx:!0})]}),e.jsx("div",{children:e.jsxs(c,{gap:"2",children:[e.jsx(ee,{isReadOnly:l,isSubmittable:t,isSubmitting:s,isDirty:a}),e.jsx(x,{size:"small",variant:"primary",onClick:r,autoFocus:!0,type:"button",children:e.jsx(u,{id:"Klage.Modal.Avbryt"})})]})})]})})})};Me.__docgenInfo={description:"",methods:[],displayName:"BekreftOgSubmitKlageModal",props:{erModalÅpen:{required:!0,tsType:{name:"boolean"},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},isSubmittable:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!0,tsType:{name:"boolean"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},valgtHjemmel:{required:!1,tsType:{name:"string"},description:""}}};const Bn="_fritekstTilBrevTextArea_n72am_1",Rn={fritekstTilBrevTextArea:Bn},se=({sprakkode:n,readOnly:r})=>e.jsx("div",{className:Rn.fritekstTilBrevTextArea,children:e.jsx(me,{name:"fritekstTilBrev",label:K().formatMessage({id:"FritekstKlageBrevTextField.Fritekst"}),validate:[B,ye],readOnly:r,maxLength:1e5,badges:[{type:"info",titleText:ze(n)}],parse:fe})});se.defaultProps={readOnly:!0};se.__docgenInfo={description:"",methods:[],displayName:"FritekstKlageBrevTextField",props:{sprakkode:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const wn="_previewLink_1xd5p_1",cn="_select_1xd5p_7",Vn="_selectReadOnly_1xd5p_10",Pn="_confirmVilkarForm_1xd5p_14",En="_panel_1xd5p_17",Fn="_fritekstTilBrevTextArea_1xd5p_20",Sn="_explanationTextarea_1xd5p_23",_={previewLink:wn,select:cn,selectReadOnly:Vn,confirmVilkarForm:Pn,panel:En,fritekstTilBrevTextArea:Fn,explanationTextarea:Sn},He=({readOnly:n,medholdReasons:r,alleHjemmlerMedNavn:t,klageVurdering:s})=>{const a=K(),l=r.map(i=>e.jsx("option",{value:i.kode,children:i.navn},i.kode)),g=t.map(i=>e.jsx("option",{value:i.kode,children:i.navn},i.kode));return e.jsxs(e.Fragment,{children:[e.jsx(S,{name:"klageVurdering",validate:[B],isReadOnly:n,isHorizontal:!0,radios:[{value:m.MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.ResolveKlage.ChangeVedtak"})},{value:m.STADFESTE_YTELSESVEDTAK,label:a.formatMessage({id:"Klage.ResolveKlage.KeepVedtakNfp"})}]}),s===m.MEDHOLD_I_KLAGE&&e.jsxs(e.Fragment,{children:[e.jsx(d,{sixteenPx:!0}),e.jsxs($e,{children:[e.jsx(W,{readOnly:n,name:"klageMedholdArsak",selectValues:l,className:n?_.selectReadOnly:_.select,label:a.formatMessage({id:"Klage.ResolveKlage.Cause"}),validate:[B]}),e.jsx(d,{sixteenPx:!0}),e.jsx(S,{name:"klageVurderingOmgjoer",validate:[B],isReadOnly:n,radios:[{value:F.GUNST_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.Omgjort"})},{value:F.UGUNST_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.Ugunst"})},{value:F.DELVIS_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.DelvisOmgjort"})}]})]})]}),e.jsx(d,{sixteenPx:!0}),e.jsx(W,{readOnly:n,name:"klageHjemmel",selectValues:g,className:n?_.selectReadOnly:_.select,label:a.formatMessage({id:"Klage.ResolveKlage.Hjemmel"}),validate:[B]}),e.jsx(d,{sixteenPx:!0})]})};He.__docgenInfo={description:"",methods:[],displayName:"KlageVurderingRadioOptionsNfp",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},medholdReasons:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
  ...
  klageMedholdArsak?: string;
  klageHjemmel?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}},{key:"klageVurdering",value:{name:"string",required:!1}},{key:"klageVurderingOmgjoer",value:{name:"string",required:!1}},{key:"klageMedholdArsak",value:{name:"string",required:!1}},{key:"klageHjemmel",value:{name:"string",required:!1}}]}}],raw:"UseFormHandleSubmit<KlageFormType>"},description:""}}};const Hn="_confirmVilkarForm_13k5i_1",In={confirmVilkarForm:Hn},Un=n=>({klageMedholdArsak:n.klageVurdering===m.MEDHOLD_I_KLAGE?n.klageMedholdArsak:void 0,klageVurderingOmgjoer:n.klageVurdering===m.MEDHOLD_I_KLAGE?n.klageVurderingOmgjoer:void 0,klageHjemmel:n.klageHjemmel,klageVurdering:n.klageVurdering,fritekstTilBrev:n.fritekstTilBrev,begrunnelse:n.begrunnelse,kode:q.BEHANDLE_KLAGE_NFP}),G=n=>{if(n&&n!=="-")return n},xn=(n,r)=>n.filter(({kode:t})=>r.includes(t)).sort((t,s)=>t.kode.localeCompare(s.kode)),Dn=n=>n.map(r=>r),Ln=n=>({klageMedholdArsak:G(n==null?void 0:n.klageMedholdArsak),klageVurderingOmgjoer:G(n==null?void 0:n.klageVurderingOmgjoer),klageHjemmel:G(n==null?void 0:n.klageHjemmel),klageVurdering:G(n==null?void 0:n.klageVurdering),begrunnelse:n?n.begrunnelse:void 0,fritekstTilBrev:n?n.fritekstTilBrev:void 0}),Ue=({readOnly:n,klageVurdering:r,previewCallback:t,saveKlage:s,readOnlySubmitButton:a,sprakkode:l,alleAktuelleHjemler:g,alleKodeverk:i,submitCallback:v,formData:p,setFormData:o})=>{var ue;const y=xn(i[V.KLAGE_HJEMMEL],Dn(g)),k=K(),[R,A]=b.useState(!1),P=b.useMemo(()=>Ln(r.klageVurderingResultatNFP),[r]),T=de({defaultValues:p||P}),j=T.watch(),$=b.useCallback(()=>{A(!1)},[]),E=b.useCallback(()=>{A(!0)},[]);return e.jsxs(ke,{formMethods:T,onSubmit:J=>v(Un(J)),setDataOnUnmount:o,children:[e.jsx(N,{size:"small",children:k.formatMessage({id:"Klage.ResolveKlage.Title"})}),e.jsx(d,{fourPx:!0}),e.jsx(qe,{isAksjonspunktOpen:!a,children:[e.jsx(u,{id:"Klage.ResolveKlage.HelpText"},q.BEHANDLE_KLAGE_NFP)]}),e.jsx(He,{readOnly:n,klageVurdering:j.klageVurdering,medholdReasons:i[V.KLAGE_MEDHOLD_ARSAK],alleHjemmlerMedNavn:y}),e.jsxs("div",{className:In.confirmVilkarForm,children:[e.jsx(Ae,{readOnly:n,text:k.formatMessage({id:"BehandleKlageFormNfp.BegrunnelseForKlage"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(se,{sprakkode:l,readOnly:n}),e.jsx(d,{sixteenPx:!0}),e.jsxs(c,{justify:"space-between",children:[e.jsxs(c,{gap:"4",children:[j.klageVurdering===m.STADFESTE_YTELSESVEDTAK&&e.jsxs(e.Fragment,{children:[e.jsx(x,{variant:"primary",type:"button",size:"small",onClick:()=>E(),disabled:n,children:e.jsx(u,{id:"Klage.Behandle.Bekreft"})}),e.jsx(Me,{erModalÅpen:R,lukkModal:$,valgtHjemmel:(ue=y.find(J=>J.kode===j.klageHjemmel))==null?void 0:ue.navn,readOnly:n,isSubmittable:!a,isSubmitting:T.formState.isSubmitting,isDirty:T.formState.isValid})]}),j.klageVurdering!==m.STADFESTE_YTELSESVEDTAK&&e.jsx(ee,{isReadOnly:n,isSubmittable:!a,isSubmitting:T.formState.isSubmitting,isDirty:T.formState.isDirty}),!n&&j.klageVurdering&&j.fritekstTilBrev&&j.fritekstTilBrev.length>2&&e.jsx(Ie,{previewCallback:t,fritekstTilBrev:j.fritekstTilBrev,klageVurdering:j.klageVurdering})]}),e.jsx(ie,{saveKlage:s,handleSubmit:T.handleSubmit,readOnly:n,aksjonspunktCode:q.BEHANDLE_KLAGE_NFP})]})]})]})};Ue.__docgenInfo={description:`BehandleklageformNfp
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const Yn=(n,r,t)=>s=>{const a={...s,behandlingUuid:t.uuid,fagsakYtelseType:r.fagsakYtelseType};return n(a).then(l=>je(l))},Cn=(n,r,t)=>s=>{const a={behandlingUuid:r.uuid,...s};return n(a).then(()=>t(!0))},zn=(n,r,t)=>s=>{const a=s.some(l=>l.kode===q.BEHANDLE_KLAGE_NFP&&l.klageVurdering===m.STADFESTE_YTELSESVEDTAK);return a&&r(!1),()=>{a?n(!0):t&&t("default","default")}},$n=[w.KLAGE_VURDERING],le=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,aksjonspunktKoder:a,prosessPanelKode:l,prosessPanelMenyTekst:g,hentOgSettBehandling:i,...v})=>{const[p,o]=b.useState(!1),y=Te(),k=r?zn(o,r,s):void 0,{startRequest:R}=U.useRestApiRunner(w.PREVIEW_MESSAGE),A=b.useCallback(Yn(R,n,y.behandling),[y.behandling.versjon]),{startRequest:P}=U.useRestApiRunner(w.SAVE_KLAGE_VURDERING),T=b.useCallback(Cn(P,y.behandling,i),[y.behandling.versjon]);return e.jsx(z,{...v,panelEndepunkter:$n,aksjonspunktKoder:a,prosessPanelKode:l,prosessPanelMenyTekst:g,skalPanelVisesIMeny:()=>!0,lagringSideEffekter:k,renderPanel:j=>e.jsxs(e.Fragment,{children:[e.jsx(Qe,{visModal:p,lukkModal:()=>{o(!1),t&&t()}}),e.jsx(xe,{previewCallback:A,saveKlage:T,...j})]})})};le.__docgenInfo={description:"",methods:[],displayName:"VurderingFellesProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Jn=[q.BEHANDLE_KLAGE_NFP],De=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,hentOgSettBehandling:a,...l})=>e.jsx(le,{...l,fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,aksjonspunktKoder:Jn,prosessPanelKode:D.KLAGE_NAV_FAMILIE_OG_PENSJON,prosessPanelMenyTekst:K().formatMessage({id:"Behandlingspunkt.CheckKlageNFP"}),hentOgSettBehandling:a});De.__docgenInfo={description:"",methods:[],displayName:"VurderingFamOgPensjonProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Wn=[q.BEHANDLE_KLAGE_NK],Le=({fagsak:n,hentOgSettBehandling:r,...t})=>e.jsx(le,{...t,aksjonspunktKoder:Wn,fagsak:n,prosessPanelKode:D.KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:K().formatMessage({id:"Behandlingspunkt.CheckKlageNK"}),hentOgSettBehandling:r});Le.__docgenInfo={description:"",methods:[],displayName:"VurderingKlageInstansProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
