...
Har ansvar for å sette opp formen for faktapenelet til Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonInfoPanel",props:{submittable:{required:!0,tsType:{name:"boolean"},description:""},isForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  gjeldende: FamilieHendelse;
  register: FamilieHendelse;
}>`},description:""},isForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const Cr=[u.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE,u.ADOPSJONSDOKUMENTAJON,u.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN],Jr=n=>{const r=He(Cr),{behandling:a,fagsak:t}=h.use(ge),s=De(a),{data:o}=N(s.familiehendelseOptions(a)),{data:i}=N(s.søknadOptions(a));return e.jsx(Ye,{...n,standardPanelProps:r,faktaPanelKode:Ge.ADOPSJONSVILKARET,faktaPanelMenyTekst:j().formatMessage({id:"FaktaInitPanel.Title.Adopsjon"}),skalPanelVisesIMeny:a.vilkår.some(l=>ir.some(g=>g===l.vilkarType)),children:o&&i?e.jsx(Fn,{familiehendelse:o,soknad:i,isForeldrepengerFagsak:t.fagsakYtelseType===yn.FORELDREPENGER,submittable:r.submittable}):e.jsx(Te,{})})};Jr.__docgenInfo={description:"",methods:[],displayName:"AdopsjonsvilkaretFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},registrerFaktaPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FaktaPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Wr="_colMargin_1r8hu_1",ce={colMargin:Wr},ve=n=>n?x(n,Se).format(Re):"-",Qr=(n,r,a,t)=>n&&Object.keys(r).length>0?ve(Object.values(r)[0]):t?ve(t):n?a?ve(a):"-":null,cn=({soknad:n,termindato:r})=>{const a=n.fodselsdatoer?n.fodselsdatoer:{},t=Object.keys(a).length>0?"FodselsammenligningPanel.Fodselsdato":"FodselsammenligningPanel.Termindato",s=Object.keys(a).length>0?"FodselSammenligningOtherPanel.OpplysningerISoknad":"FodselSammenligningOtherPanel.TerminISoknad",o=h.useMemo(()=>Qr(!!n,a,n.termindato,r),[n,a,r]);return e.jsxs(e.Fragment,{children:[e.jsx(ue,{size:"small",children:e.jsx(d,{id:s})}),e.jsx(b,{sixteenPx:!0}),e.jsx(fe,{children:e.jsxs(qe,{children:[n.utstedtdato&&e.jsxs(K,{className:ce.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.UstedtDato"})}),e.jsx(c,{size:"small",children:ve(n.utstedtdato)})]}),e.jsxs(K,{className:ce.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:t})}),e.jsx(c,{size:"small",children:o})]}),e.jsxs(K,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.AntallBarn"})}),e.jsx(c,{size:"small",children:n.antallBarn})]})]})})]})};cn.__docgenInfo={description:`FodselSammenligningOtherPanel
...
Viser sammenligning av fødsel ved ytelsesvedtak/søknad og oppdatert informasjon fra TPS.`,methods:[],displayName:"FodselSammenligningOtherPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: string;
}>`},description:""},termindato:{required:!1,tsType:{name:"string"},description:""}}};const Ee=n=>n?x(n,Se).format(Re):"-",Xr=(n,r,a)=>{if(!r&&!a)return"";const t=a||{termindato:void 0,avklartBarn:[]};if(n){const s=t.termindato?t.termindato:r==null?void 0:r.termindato;return s?Ee(s):void 0}return t.avklartBarn&&t.avklartBarn.length>0?Ee(t.avklartBarn[0].fodselsdato):r!=null&&r.fodselsdatoer?Ee(Object.values(r.fodselsdatoer)[0]):"-"},Zr=(n,r,a)=>{if(!r&&!a)return 0;const t=a||{termindato:void 0,antallBarnTermin:void 0,avklartBarn:[]};return n?t.termindato?t.antallBarnTermin:r==null?void 0:r.antallBarn:t.avklartBarn&&t.avklartBarn.length>0?t.avklartBarn.length:r==null?void 0:r.antallBarn},jn=({vedtaksDatoSomSvangerskapsuke:n,soknadOriginalBehandling:r,familiehendelseOriginalBehandling:a})=>{const t=a&&!!a.termindato||!(r!=null&&r.fodselsdatoer)||Object.keys(r.fodselsdatoer).length===0,s=t?"FodselsammenligningPanel.Termindato":"FodselsammenligningPanel.Fodselsdato",o=Xr(t,r,a),i=Zr(t,r,a),l=a?(!a.avklartBarn||a.avklartBarn.length===0)&&!!n:!1;return e.jsxs(e.Fragment,{children:[e.jsx(ue,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.Ytelsesvedtak"})}),e.jsx(b,{sixteenPx:!0}),e.jsx(fe,{children:e.jsxs(qe,{children:[l&&e.jsxs(K,{className:ce.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.FodtISvangerskapsuke"})}),e.jsx(c,{size:"small",children:n})]}),e.jsxs(K,{className:ce.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:s})}),e.jsx(c,{size:"small",children:o??"-"})]}),e.jsxs(K,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.AntallBarn"})}),e.jsx(c,{size:"small",children:i??"-"})]})]})})]})};jn.__docgenInfo={description:`FodselSammenligningRevurderingPanel
...
Presentasjonskomponent. Viser sammenligning av fødsel ved ytelsesvedtak/søknad og oppdatert informasjon fra TPS.`,methods:[],displayName:"FodselSammenligningRevurderingPanel",props:{soknadOriginalBehandling:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},vedtaksDatoSomSvangerskapsuke:{required:!1,tsType:{name:"number"},description:""}}};const ea="_noChildrenInTps_3z81w_1",na="_colWidthLeft_3z81w_5",ra="_colWidthRight_3z81w_9",Ie={noChildrenInTps:ea,colWidthLeft:na,colWidthRight:ra},rn=n=>n?x(n,Se).format(Re):"-",Tn=({behandlingsTypeKode:n,avklartBarn:r,nrOfDodfodteBarn:a,soknad:t,vedtaksDatoSomSvangerskapsuke:s,termindato:o,soknadOriginalBehandling:i,familiehendelseOriginalBehandling:l})=>e.jsx(fe,{children:e.jsxs(qe,{children:[e.jsxs(K,{className:Ie.colWidthLeft,children:[n!==be.REVURDERING&&e.jsx(cn,{soknad:t,termindato:o}),n===be.REVURDERING&&e.jsx(jn,{soknadOriginalBehandling:i,familiehendelseOriginalBehandling:l,vedtaksDatoSomSvangerskapsuke:s})]}),e.jsxs(K,{className:Ie.colWidthRight,children:[e.jsx(fe,{children:e.jsxs(qe,{children:[e.jsx(K,{children:e.jsx(ue,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.OpplysningerTPS"})})}),a>0&&e.jsx(K,{children:e.jsx(Xe,{variant:"info",children:e.jsx(d,{id:"FodselsammenligningPanel.Dodfodt"})})})]})}),r.length>0&&e.jsxs(U,{children:[e.jsx(U.Header,{children:e.jsxs(U.Row,{children:[e.jsx(U.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FodselsammenligningPanel.Fodselsdato"})}),e.jsx(U.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FodselsammenligningPanel.Dodsdato"})})]})}),e.jsx(U.Body,{children:r.map(g=>{const m=g.fodselsdato+g.dodsdato;return e.jsxs(U.Row,{id:m,children:[e.jsx(U.DataCell,{children:e.jsx(c,{size:"small",children:rn(g.fodselsdato)})}),e.jsx(U.DataCell,{children:e.jsx(c,{size:"small",children:g.dodsdato?rn(g.dodsdato):"-"})}),e.jsx(U.DataCell,{children:g.dodsdato&&e.jsx(Xe,{variant:"info",children:e.jsx(d,{id:"FodselsammenligningPanel.Dod"})})})]},m)})})]}),r.length===0&&e.jsx("div",{className:Ie.noChildrenInTps,children:e.jsx(c,{size:"small",children:"-"})})]})]})});Tn.__docgenInfo={description:`FodselSammenlingningPanel
...
Setter opp aksjonspunktet for avklaring av manglende fødsel (Fødselsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"soknad",optional:!1,type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""}}};const ua="_marginBottom_8wozi_1",ga="_bredde_8wozi_5",an={marginBottom:ua,bredde:ga},ma=Zn(1),ka=er(9),pa=(n,r)=>!!n&&!!r&&!x(n).isAfter(x(r).subtract(18,"weeks").subtract(4,"days")),oe=({readOnly:n,soknad:r,gjeldendeFamiliehendelse:a,submittable:t,alleMerknaderFraBeslutter:s})=>{const o=j(),i=he(r,a),{watch:l}=ee(),g=l("termindato"),m=l("utstedtdato"),k=l("begrunnelse"),y=pa(m,g),{avklartBarn:p}=a,q=p&&p.length>0?p[0].fodselsdato:void 0,v=p?p.length:0,f=a.erOverstyrt||!1;return e.jsxs(e.Fragment,{children:[e.jsx(O,{title:o.formatMessage({id:"TermindatoFaktaForm.ApplicationInformation"}),merknaderFraBeslutter:s[u.TERMINBEKREFTELSE],children:e.jsxs(X,{gap:"4",children:[e.jsx(H,{name:"utstedtdato",label:o.formatMessage({id:"TermindatoFaktaForm.UtstedtDato"}),validate:[B,Y],isReadOnly:n,isEdited:i.utstedtdato}),e.jsx(H,{name:"termindato",label:o.formatMessage({id:"TermindatoFaktaForm.Termindato"}),validate:[B,Y],isReadOnly:n,isEdited:i.termindato}),e.jsx(Qn,{name:"antallBarn",label:o.formatMessage({id:"TermindatoFaktaForm.AntallBarn"}),parse:F=>{const R=parseInt(F.toString(),10);return Number.isNaN(R)?F:R},validate:[B,Xn,ma,ka],readOnly:n,className:an.bredde,isEdited:i.antallBarn})]})}),q&&!f&&e.jsx(O,{title:o.formatMessage({id:"TermindatoFaktaForm.OpplysningerTPS"}),children:e.jsxs(X,{gap:"10",children:[e.jsxs("div",{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"TermindatoFaktaForm.FodselsdatoTps"})}),e.jsx(b,{fourPx:!0}),e.jsx(c,{size:"small",children:e.jsx(Ke,{dateString:q})})]}),e.jsxs("div",{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"TermindatoFaktaForm.AntallBarnTps"})}),e.jsx(b,{fourPx:!0}),e.jsx(c,{size:"small",children:v})]})]})}),e.jsx(b,{sixteenPx:!0}),e.jsx(_,{isSubmittable:t,isReadOnly:n,hasBegrunnelse:!!k}),y&&e.jsxs(e.Fragment,{children:[e.jsx(b,{sixteenPx:!0}),e.jsx(Yn,{variant:"warning",className:an.marginBottom,children:e.jsx(d,{id:"TermindatoFaktaForm.AdvarselForTidligUtstedtdato"})})]})]})};oe.buildInitialValues=(n,r,a)=>{const t=n.antallBarn?n.antallBarn:NaN;return{utstedtdato:r.utstedtdato?r.utstedtdato:n.utstedtdato,termindato:r.termindato?r.termindato:n.termindato,antallBarn:r.antallBarnTermin?r.antallBarnTermin:t,..._.initialValues(a)}};oe.transformValues=n=>({kode:u.TERMINBEKREFTELSE,utstedtdato:n.utstedtdato,termindato:n.termindato,antallBarn:n.antallBarn,..._.transformValues(n)});oe.__docgenInfo={description:`TermindatoFaktaForm
...
Har ansvar for å sette opp formen for faktapenelet til Fødselsvilkåret.`,methods:[],displayName:"FodselInfoPanel",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const ca=[u.TERMINBEKREFTELSE,u.SJEKK_MANGLENDE_FODSEL],ja=n=>{const r=j(),{behandling:a}=h.use(ge),t=He(ca),s=De(a),{data:o}=N(s.familiehendelseOptions(a)),{data:i}=N(s.søknadOptions(a)),{data:l}=N(s.familiehendelseOrigninalBehandlingOptions(a)),{data:g}=N(s.søknadOriginalBehandlingOptions(a));return e.jsx(Ye,{...n,standardPanelProps:t,faktaPanelKode:Ge.FODSELSVILKARET,faktaPanelMenyTekst:r.formatMessage({id:"FaktaInitPanel.Title.Fodsel"}),skalPanelVisesIMeny:a.vilkår.some(m=>lr.some(k=>k===m.vilkarType)),children:o&&i?e.jsx(An,{soknad:i,familiehendelse:o,familiehendelseOriginalBehandling:l,soknadOriginalBehandling:g,submittable:t.submittable}):e.jsx(Te,{})})};ja.__docgenInfo={description:"",methods:[],displayName:"FodselvilkaretFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},registrerFaktaPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FaktaPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Dn=({alleMerknaderFraBeslutter:n,soknad:r})=>{const a=j(),{adopsjonFodelsedatoer:t}=r;return e.jsx(O,{title:a.formatMessage({id:"BarnPanel.BarnDetSøkesOm"}),merknaderFraBeslutter:n[u.OMSORGSOVERTAKELSE],children:t&&Object.keys(t).map(s=>e.jsxs(kn.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"BarnPanel.ChildNumberBornData",values:{childNumber:s}})}),e.jsx(c,{size:"small",children:x(t[parseInt(s,10)]).format(Re)}),e.jsx(b,{eightPx:!0})]},`${s}`))})};Dn.__docgenInfo={description:`BarnPanel
...
Viser barn fra søknad`,methods:[],displayName:"BarnPanel",props:{alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: string;
}>`},description:""}}};const tn=({aktoerId:n,navn:r,kjønn:a,adresser:t,dødsdato:s})=>{const o=Je(t,We.POSTADRESSE),i=Je(t,We.BOSTEDSADRESSE);return{aktorId:n,navn:r,dodsdato:s,adresse:o||i,erMor:a===kr.KVINNE}},Bn=({personoversikt:n,alleMerknaderFraBeslutter:r})=>{const a=j(),t=h.useMemo(()=>{const s=[tn(n.bruker)];return n.annenPart&&s.push(tn(n.annenPart)),s},[n]);return e.jsx(O,{title:a.formatMessage({id:"ForeldrePanel.Foreldre"}),merknaderFraBeslutter:r[u.OMSORGSOVERTAKELSE],children:e.jsx(de,{gap:"8",children:t.map(s=>e.jsxs(de,{gap:"2",children:[e.jsx(ue,{size:"small",children:s.navn}),e.jsx(S,{size:"small",children:e.jsx(d,{id:"ForeldrePanel.Address"})}),e.jsx(c,{size:"small",children:s.adresse&&!s.dodsdato?sr(s.adresse):"-"}),s.dodsdato&&e.jsxs(e.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"ForeldrePanel.DeathDate"})}),e.jsx(c,{size:"small",children:e.jsx(Ke,{dateString:s.dodsdato})})]})]},`${s.aktorId}`))})})};Bn.__docgenInfo={description:`ForeldrePanel
...
Har ansvar for å sette opp form for faktapenelet til Omsorgsvilkåret.`,methods:[],displayName:"OmsorgOgForeldreansvarInfoPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  relatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
  innvilgetRelatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const dn=[u.OMSORGSOVERTAKELSE,u.AVKLAR_VILKAR_FOR_FORELDREANSVAR],Ea=({personoversikt:n,...r})=>{const a=j(),t=He(dn),{behandling:s}=h.use(ge),o=De(s),{data:i}=N(o.søknadOptions(s)),{data:l}=N(o.familiehendelseOptions(s)),{data:g}=N(o.inntektArbeidYtelseOptions(s));return e.jsx(Ye,{...r,standardPanelProps:t,faktaPanelKode:Ge.OMSORGSVILKARET,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.OmsorgOgForeldreansvar"}),skalPanelVisesIMeny:dn.some(m=>w(m,s.aksjonspunkt)),children:i&&l&&g?e.jsx(hn,{soknad:i,familiehendelse:l,inntektArbeidYtelse:g,personoversikt:n,submittable:t.submittable}):e.jsx(Te,{})})};Ea.__docgenInfo={description:"",methods:[],displayName:"OmsorgOgForeldreansvarFaktaInitPanel",props:{personoversikt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  bruker: PersonopplysningerBasis;
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}`,signature:{properties:[{key:"bruker",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Ia="_flexContainer_16pq7_48",un={flexContainer:Ia},gn=rr(3),xa=ar(1e4),_a=n=>({kode:me(n[0].definisjon,u.VARSEL_REVURDERING_ETTERKONTROLL,u.VARSEL_REVURDERING_MANUELL),begrunnelse:n[0].begrunnelse,sendVarsel:void 0}),_e=n=>n||{},Ma=[],Nn=({familiehendelse:n,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,previewCallback:s})=>{const o=j(),{isReadOnly:i,alleKodeverk:l,behandling:g,submitCallback:m,aksjonspunkterForPanel:k}=$(),y=_a(k),{formData:p,setFormData:q}=Q(),v=C({defaultValues:p||y}),f=v.watch(),[F,R]=h.useState(!1),A=h.useCallback(()=>R(!1),[R]),P=h.useCallback(()=>R(!0),[R]),M=le=>{v.trigger().then(Ve=>{Ve&&m({...f,...le}),R(!1)})},T=h.useCallback(le=>{le.preventDefault(),s({dokumentMal:yr.VARSEL_OM_REVURDERING,arsakskode:vr.ANNET,fritekst:f.fritekst||" "})},[f.fritekst]),{avklartBarn:D}=_e(n.register),{termindato:L}=_e(n.gjeldende),{vedtaksDatoSomSvangerskapsuke:ye}=_e(n.gjeldende),_n=g.behandlingÅrsaker.reduce((le,Ve)=>le||Ve.erAutomatiskRevurdering,!1),Mn=l[W.VENT_AARSAK]||Ma,Un=zn(g.sprakkode);return e.jsxs(e.Fragment,{children:[e.jsxs(J,{formMethods:v,onSubmit:m,setDataOnUnmount:q,children:[e.jsx(ue,{size:"small",children:e.jsx(d,{id:"VarselOmRevurderingForm.VarselOmRevurdering"})}),e.jsx(b,{eightPx:!0}),!i&&k[0].status===Fe.OPPRETTET&&e.jsxs(e.Fragment,{children:[e.jsx(je,{children:e.jsx(d,{id:"VarselOmRevurderingForm.VarselOmRevurderingVurder"})}),e.jsx(b,{twentyPx:!0}),_n&&e.jsxs(e.Fragment,{children:[e.jsx(Ne,{behandlingsTypeKode:g.type,avklartBarn:D,termindato:L,vedtaksDatoSomSvangerskapsuke:ye,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t}),e.jsx(b,{sixteenPx:!0})]}),e.jsx(Ae,{name:"sendVarsel",validate:[B],isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"VarselOmRevurderingForm.SendVarsel"})},{value:"false",label:o.formatMessage({id:"VarselOmRevurderingForm.IkkeSendVarsel"})}]}),f.sendVarsel&&e.jsxs(e.Fragment,{children:[e.jsx(b,{sixteenPx:!0}),e.jsxs(vn,{children:[e.jsx($e,{badges:[{type:"info",titleText:Un}],name:"fritekst",label:o.formatMessage({id:"VarselOmRevurderingForm.FritekstIBrev"}),validate:[B,gn,xa,Ce],maxLength:1e4,parse:$n}),e.jsx(b,{fourPx:!0}),e.jsx("a",{href:"",onClick:T,className:pr(un.previewLink,"lenke lenke--frittstaende"),children:e.jsx(d,{id:"VarselOmRevurderingForm.Preview"})})]})]}),e.jsx("div",{className:un.flexContainer,children:e.jsx($e,{name:"begrunnelse",label:o.formatMessage({id:"VarselOmRevurderingForm.BegrunnelseForSvar"}),validate:[B,gn,Ce]})}),e.jsx(b,{sixteenPx:!0}),e.jsx(Kn,{variant:"primary",size:"small",onClick:f.sendVarsel?P:void 0,loading:v.formState.isSubmitting,disabled:v.formState.isSubmitting,type:f.sendVarsel?"button":"submit",children:e.jsx(d,{id:"VarselOmRevurderingForm.Bekreft"})})]}),(i||k[0].status!==Fe.OPPRETTET)&&e.jsxs(e.Fragment,{children:[e.jsx(pn,{children:e.jsx(d,{id:"VarselOmRevurderingForm.Begrunnelse"})}),e.jsx(c,{size:"small",children:f.begrunnelse})]})]}),e.jsx(br,{showModal:F,frist:x().add(28,"days").format(Se),cancelEvent:A,submitCallback:M,ventearsaker:Mn,visBrevErBestilt:!0,hasManualPaVent:!0,erTilbakekreving:g.type===be.TILBAKEKREVING||g.type===be.TILBAKEKREVING_REVURDERING})]})};Nn.__docgenInfo={description:`VarselOmRevurderingForm
...
Setter opp aksjonspunktet for avklaring av varsel om revurdering i søknad.`,methods:[],displayName:"VarselOmRevurderingForm",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  dokumentMal: string;
  fritekst: string;
}`,signature:{properties:[{key:"arsakskode",value:{name:"string",required:!0}},{key:"dokumentMal",value:{name:"string",required:!0}},{key:"fritekst",value:{name:"string",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const La=(n,r)=>a=>{const t=a.length>0&&"sendVarsel"in a[0]&&a[0].sendVarsel;return n(!t),()=>{t&&r()}},Ha=[u.VARSEL_REVURDERING_MANUELL,u.VARSEL_REVURDERING_ETTERKONTROLL],Ya=n=>{const r=j(),{setSkalOppdatereEtterBekreftelseAvAp:a,fagsak:t,behandling:s}=h.use(ge),o=Ln(),i=La(a,()=>{o("/")}),l=fn(Ha,[],i),g=De(s),{data:m}=N(g.familiehendelseOptions(s)),{data:k}=N(g.søknadOptions(s)),{data:y}=N(g.familiehendelseOrigninalBehandlingOptions(s)),{data:p}=N(g.søknadOriginalBehandlingOptions(s)),{mutate:q}=tr({mutationFn:v=>mr({...v,behandlingUuid:s.uuid,fagsakYtelseType:t.fagsakYtelseType}),onSuccess:Cn});return e.jsx(fr,{...n,standardPanelProps:l,prosessPanelKode:gr.VARSEL,prosessPanelMenyTekst:r.formatMessage({id:"Behandlingspunkt.CheckVarselRevurdering"}),skalPanelVisesIMeny:dr(l.aksjonspunkter),children:m&&k&&y&&p?e.jsx(Pn,{familiehendelse:m,soknad:k,familiehendelseOriginalBehandling:y,soknadOriginalBehandling:p,previewCallback:q}):e.jsx(Te,{})})};Ya.__docgenInfo={description:"",methods:[],displayName:"VarselProsessStegInitPanel",props:{valgtProsessSteg:{required:!1,tsType:{name:"string"},description:""},registrerProsessPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ProsessPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Ga=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),za=(n,r)=>r.map(a=>({...E.transformValues(n),...V.transformValues(n),kode:me(a.definisjon,u.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD,u.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD,u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)})),On=({readOnlySubmitButton:n,isEngangsstonad:r,isForeldreansvar2Ledd:a,status:t})=>{const s=j(),{behandling:o,alleKodeverk:i,aksjonspunkterForPanel:l,submitCallback:g,harÅpneAksjonspunkter:m,isReadOnly:k,alleMerknaderFraBeslutter:y}=$(),p=l.some(T=>{var D;return(D=y[T.definisjon])==null?void 0:D.notAccepted}),q=Ga(l,t,o.behandlingsresultat),{formData:v,setFormData:f}=Q(),F=C({defaultValues:v||q}),R=a?I.FORELDREANSVARSVILKARET_2_LEDD:I.FORELDREANSVARSVILKARET_4_LEDD,A=i[W.AVSLAGSARSAK][R],P=m?void 0:we.OPPFYLT===t,M=h.useCallback((...T)=>e.jsx("b",{children:T}),[]);return e.jsx(J,{formMethods:F,onSubmit:T=>g(za(T,l)),setDataOnUnmount:f,children:e.jsxs(Be,{title:s.formatMessage({id:"ErForeldreansvarVilkaarOppfyltForm.Foreldreansvar"}),isAksjonspunktOpen:!n,readOnlySubmitButton:n,readOnly:k,originalErVilkarOk:P,erIkkeGodkjentAvBeslutter:p,isDirty:F.formState.isDirty,isSubmitting:F.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"ErForeldreansvarVilkaarOppfyltForm.RettTilStonad"})}),e.jsx(E,{avslagsarsaker:A,readOnly:k,customVilkarOppfyltText:e.jsx(d,{id:r?"FodselVilkarForm.OppfyltEs":"FodselVilkarForm.OppfyltFp"}),customVilkarIkkeOppfyltText:e.jsx(d,{id:r?"FodselVilkarForm.IkkeOppfyltEs":"FodselVilkarForm.IkkeOppfyltFp",values:{b:M}})}),e.jsx(V,{readOnly:k})]})})};On.__docgenInfo={description:`ErForeldreansvarVilkaarOppfyltForm

Setter opp aksjonspunkter for avklaring av foreldreansvarvilkåret 2 eller 4 ledd.`,methods:[],displayName:"ErForeldreansvarVilkaarOppfyltForm",props:{isForeldreansvar2Ledd:{required:!0,tsType:{name:"boolean"},description:""},isEngangsstonad:{required:!0,tsType:{name:"boolean"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const $a={"ErForeldreansvarVilkaarOppfyltForm.Foreldreansvar":"Foreldreansvaret","ErForeldreansvarVilkaarOppfyltForm.ErVilkaretOppfylt":"Er vilkåret oppfylt?","ErForeldreansvarVilkaarOppfyltForm.RettTilStonad":"Rett til stønad ved overtakelse av foreldreansvaret","FodselVilkarForm.OppfyltEs":"Far har rett til engangsstønad, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfyltEs":"Far har ikke rett til engangsstønad, vilkåret er <b>ikke</b> oppfylt","FodselVilkarForm.OppfyltFp":"Far har rett til foreldrepenger, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfyltFp":"Far har ikke rett til foreldrepenger, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},Ca=z($a),Vn=n=>e.jsx(G,{value:Ca,children:e.jsx(On,{...n})});Vn.__docgenInfo={description:"",methods:[],displayName:"ForeldreansvarVilkarProsessIndex",props:{isForeldreansvar2Ledd:{required:!0,tsType:{name:"boolean"},description:""},isEngangsstonad:{required:!0,tsType:{name:"boolean"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const Ja=[u.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD,u.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD,u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN],Wa={[u.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD]:"ErForeldreansvarVilkaarOppfyltForm.2LeddParagrafEngangsStonad",[u.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD]:"ErForeldreansvarVilkaarOppfyltForm.4LeddParagraf",[u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN]:"SRBVilkarForm.VurderSammeBarn",[u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN]:"SRBVilkarForm.VurderAnnenForelderSammeBarn"},mn=[I.FORELDREANSVARSVILKARET_2_LEDD,I.FORELDREANSVARSVILKARET_4_LEDD],Qa=n=>{const r=j(),{behandling:a}=h.use(ge),t=fn(Ja,mn);return e.jsx(ur,{...n,standardPanelProps:t,behandlingVersjon:a.versjon,vilkarKoder:mn,inngangsvilkarPanelKode:"FORELDREANSVARSVILKARET",hentInngangsvilkarPanelTekst:t.aksjonspunkter.length>0?r.formatMessage({id:Wa[t.aksjonspunkter[0].definisjon]}):"",renderPanel:({skalVises:s})=>e.jsx(e.Fragment,{children:s&&e.jsx(Vn,{isEngangsstonad:!0,isForeldreansvar2Ledd:t.vilkar.some(o=>o.vilkarType===I.FORELDREANSVARSVILKARET_2_LEDD),status:t.status,readOnlySubmitButton:t.readOnlySubmitButton})})})};Qa.__docgenInfo={description:"",methods:[],displayName:"ForeldreansvarInngangsvilkarInitPanel",props:{registrerInngangsvilkarPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: InngangsvilkarPanelData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  aksjonspunktTekst?: string;
  harApentAksjonspunkt: boolean;
  status: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"aksjonspunktTekst",value:{name:"string",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!0}},{key:"status",value:{name:"string",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""},erPanelValgt:{required:!0,tsType:{name:"boolean"},description:""},harInngangsvilkarApentAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""}}};const Xa=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),Za=(n,r)=>({...E.transformValues(n),...V.transformValues(n),kode:me(r[0].definisjon,u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)}),En=({vilkar:n,readOnlySubmitButton:r,status:a})=>{const t=j(),{behandling:s,alleKodeverk:o,aksjonspunkterForPanel:i,submitCallback:l,harÅpneAksjonspunkter:g,isReadOnly:m,alleMerknaderFraBeslutter:k}=$(),y=i.some(T=>{var D;return(D=k[T.definisjon])==null?void 0:D.notAccepted}),p=Xa(i,a,s.behandlingsresultat),{formData:q,setFormData:v}=Q(),f=C({defaultValues:q||p}),F=o[W.AVSLAGSARSAK][I.ADOPSJONSVILKARET],A=i.some(T=>T.status===Fe.OPPRETTET)?void 0:we.OPPFYLT===a,{lovReferanse:P}=n[0],M=(...T)=>e.jsx("b",{children:T});return e.jsx(J,{formMethods:f,onSubmit:T=>l(Za(T,i)),setDataOnUnmount:v,children:e.jsxs(Be,{title:t.formatMessage({id:"AdopsjonVilkarForm.Adopsjon"}),isAksjonspunktOpen:g,readOnlySubmitButton:r,readOnly:m,lovReferanse:P,originalErVilkarOk:A,erIkkeGodkjentAvBeslutter:y,isDirty:f.formState.isDirty,isSubmitting:f.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"AdopsjonVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(E,{avslagsarsaker:F,readOnly:m,customVilkarOppfyltText:e.jsx(d,{id:"AdopsjonVilkarForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(d,{id:"AdopsjonVilkarForm.IkkeOppfylt",values:{b:M}})}),e.jsx(V,{readOnly:m})]})})};En.__docgenInfo={description:`AdopsjonVilkarForm
...
Setter opp aksjonspunktet for avklaring av Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""}}};const at=["1002","1003","1032"],tt=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),st=(n,r)=>({...E.transformValues(n),...V.transformValues(n),kode:me(r[0].definisjon,u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)}),ot=(n,r)=>n?r.filter(a=>!at.includes(a.kode)):r,In=({readOnlySubmitButton:n,status:r,ytelseTypeKode:a,vilkar:t})=>{const s=j(),{behandling:o,alleKodeverk:i,aksjonspunkterForPanel:l,submitCallback:g,harÅpneAksjonspunkter:m,isReadOnly:k,alleMerknaderFraBeslutter:y}=$(),p=l.some(L=>{var ye;return(ye=y[L.definisjon])==null?void 0:ye.notAccepted}),q=tt(l,r,o.behandlingsresultat),{formData:v,setFormData:f}=Q(),F=C({defaultValues:v||q}),R=i[W.AVSLAGSARSAK][I.FODSELSVILKARET_MOR],A=ot(a===yn.FORELDREPENGER,R),M=l.some(L=>L.status===Fe.OPPRETTET)?void 0:we.OPPFYLT===r,{lovReferanse:T}=t[0],D=(...L)=>e.jsx("b",{children:L});return e.jsx(J,{formMethods:F,onSubmit:L=>g(st(L,l)),setDataOnUnmount:f,children:e.jsxs(Be,{title:s.formatMessage({id:"FodselVilkarForm.Fodsel"}),isAksjonspunktOpen:m,readOnlySubmitButton:n,readOnly:k,lovReferanse:T,originalErVilkarOk:M,erIkkeGodkjentAvBeslutter:p,isDirty:F.formState.isDirty,isSubmitting:F.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(E,{avslagsarsaker:A,readOnly:k,customVilkarOppfyltText:e.jsx(d,{id:"FodselVilkarForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(d,{id:"FodselVilkarForm.IkkeOppfylt",values:{b:D}})}),e.jsx(V,{useAllWidth:!0,readOnly:k})]})})};In.__docgenInfo={description:`FodselVilkarForm
...
Setter opp aksjonspunktet for avklaring av Fødselsvilkåret.`,methods:[],displayName:"FodselVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const it={"FodselVilkarForm.Fodsel":"Fødsel","FodselVilkarForm.TidligereUtbetaltStonad":"Tidligere utbetalte foreldrepenger eller engangsstønad","FodselVilkarForm.Oppfylt":"Er utbetalt for et annet barn, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfylt":"Er utbetalt for dette barnet, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},lt=z(it),dt=n=>e.jsx(G,{value:lt,children:e.jsx(In,{...n})});dt.__docgenInfo={description:"",methods:[],displayName:"FodselVilkarProsessIndex",props:{ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkarType: string;
  vilkarStatus: string;
  avslagKode?: string;
  lovReferanse?: string;
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""}}};const ut=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),gt=(n,r)=>r.map(a=>({...E.transformValues(n),...V.transformValues(n),kode:me(a.definisjon,u.MANUELL_VURDERING_AV_OMSORGSVILKARET,u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)})),xn=({readOnlySubmitButton:n,status:r})=>{const a=j(),{behandling:t,alleKodeverk:s,aksjonspunkterForPanel:o,submitCallback:i,isReadOnly:l,alleMerknaderFraBeslutter:g,harÅpneAksjonspunkter:m}=$(),k=o.some(A=>{var P;return(P=g[A.definisjon])==null?void 0:P.notAccepted}),y=ut(o,r,t.behandlingsresultat),{formData:p,setFormData:q}=Q(),v=C({defaultValues:p||y}),f=s[W.AVSLAGSARSAK][I.OMSORGSVILKARET],F=m?void 0:we.OPPFYLT===r,R=h.useCallback(A=>e.jsx("b",{children:A}),[]);return e.jsx(J,{formMethods:v,onSubmit:A=>i(gt(A,o)),setDataOnUnmount:q,children:e.jsxs(Be,{title:a.formatMessage({id:"ErOmsorgVilkaarOppfyltForm.Omsorg"}),isAksjonspunktOpen:!n,readOnlySubmitButton:n,readOnly:l,originalErVilkarOk:F,erIkkeGodkjentAvBeslutter:k,isDirty:v.formState.isDirty,isSubmitting:v.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"ErOmsorgVilkaarOppfyltForm.VilkaretOppfylt"})}),e.jsx(E,{avslagsarsaker:f,readOnly:l,customVilkarOppfyltText:e.jsx(d,{id:"ErOmsorgVilkaarOppfyltForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(d,{id:"ErOmsorgVilkaarOppfyltForm.IkkeOppfylt",values:{b:R}})}),e.jsx(V,{readOnly:l})]})})};xn.__docgenInfo={description:`ErOmsorgVilkaarOppfyltForm

Setter opp aksjonspunkter for avklaring av omsorgsvilkåret.`,methods:[],displayName:"ErOmsorgVilkaarOppfyltForm",props:{status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const mt={"ErOmsorgVilkaarOppfyltForm.Omsorg":"Omsorg","ErOmsorgVilkaarOppfyltForm.Anvendes":"Vilkår som anvendes","ErOmsorgVilkaarOppfyltForm.VilkaretOppfylt":"Far rett til engangsstønad","ErOmsorgVilkaarOppfyltForm.Oppfylt":"Far har rett til engangsstønad, vilkåret er oppfylt","ErOmsorgVilkaarOppfyltForm.IkkeOppfylt":"Far har ikke rett til engangsstønad, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},kt=z(mt),pt=n=>e.jsx(G,{value:kt,children:e.jsx(xn,{...n})});pt.__docgenInfo={description:"",methods:[],displayName:"OmsorgVilkarProsessIndex",props:{status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};export{rt as A,dt as F,pt as O,Ya as V,Qa as a,Ea as b,Jr as c,ja as d};
