import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{a as R,u as T,g as F,n as b}from"./initFetch-CcKaOXGz.js";import{$ as K,F as x,c as A,u as I}from"./index.es-DmQnRt8c.js";import{h as M,V as N,B as k,j as v,k as _,P,v as E}from"./withQueryClient-BF6cwJb8.js";import{M as u,S as V,y as O,t as C}from"./index.es-Bt-4RxCK.js";import"./aktivitetStatus-02fOJoqz.js";import{K as y}from"./alleKodeverk-Bv_e3DK6.js";import{g as Y}from"./kodeverkUtils-DLZgokMR.js";import{T as s}from"./Table-DW3S1o5W.js";import{u as D}from"./index.esm-BEBEgcF_.js";import"./index-DRjF_FHU.js";import{p as L}from"./paths-C9HiGUXm.js";const q=({fagsaker:r,selectFagsakCallback:a,alleKodeverk:t})=>{const i=Y(t);return e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:r.map(n=>e.jsxs(s.Row,{onMouseDown:()=>a(n.saksnummer),onKeyDown:()=>a(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:i(n.fagsakYtelseType,y.FAGSAK_YTELSE)}),e.jsx(s.DataCell,{children:i(n.status,y.FAGSAK_STATUS)})]},n.saksnummer))})]})};q.__docgenInfo={description:`FagsakList
...
Formaterer fagsak-søkeresultatet for visning i tabell. Sortering av fagsakene blir håndtert her.`,methods:[],displayName:"FagsakList",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const H="_container_74un9_1",z="_advarselIcon_74un9_6",c={container:H,advarselIcon:z},B=(r,a)=>!!(r||a===void 0||a.length<1),j=({searchStarted:r,searchResultAccessDenied:a,searchFagsakCallback:t})=>{const i=M(),n=D({defaultValues:{searchString:""}}),d=n.watch("searchString");return e.jsx(K,{formMethods:n,onSubmit:t,className:c.container,children:e.jsxs(N,{gap:"2",children:[e.jsx(k,{size:"small",children:e.jsx(u,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(v,{gap:"2",align:"end",children:[e.jsx(x,{name:"searchString",label:i.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[A]}),e.jsx(_,{variant:"primary",size:"small",loading:r,disabled:B(r,d),children:e.jsx(u,{id:"Search.Search"})})]}),a&&e.jsx(e.Fragment,{children:e.jsxs(v,{gap:"2",align:"end",children:[e.jsx(V,{className:c.advarselIcon}),e.jsx(k,{size:"small",children:e.jsx(u,{id:a.feilmelding})})]})})]})})};j.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const $="_container_gwama_1",G="_label_gwama_9",f={container:$,label:G},w=({fagsaker:r,searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n,searchResultAccessDenied:d,alleKodeverk:g})=>e.jsxs("div",{className:f.container,children:[e.jsx(j,{searchFagsakCallback:a,searchStarted:n,searchResultAccessDenied:d}),t&&r.length===0&&e.jsx(k,{size:"small",className:f.label,children:e.jsx(u,{id:"FagsakSearch.ZeroSearchResults"})}),e.jsx(O,{eightPx:!0}),t&&r.length>1&&e.jsx(q,{fagsaker:r,selectFagsakCallback:i,alleKodeverk:g})]});w.__docgenInfo={description:`FagsakSearch
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSearch",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const U={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},Z=C(U),h=({fagsaker:r=[],searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n=!1,searchResultAccessDenied:d,alleKodeverk:g})=>e.jsx(P,{value:Z,children:e.jsx(w,{fagsaker:r,searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n,searchResultAccessDenied:d,alleKodeverk:g})});h.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  status: string;
  aktørId: string;
