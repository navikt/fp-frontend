import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{u as q,a as _,X as R,b as V,e as S,n as M,c as L,H as A,d as z,k as E,M as C,A as $}from"./AppIndex.stories-DDDJHRLj.js";import{t as y,a as G,G as U,b as H,W as F,H as c,L as u,c as D,y as o,O,q as Y,S as X}from"./index.es-BXIlixZT.js";import{r as W}from"./index-DRjF_FHU.js";import"./aktivitetStatus-02fOJoqz.js";import{V as K}from"./BehandlingHenlagtPanel-D_kxw2Pz.js";import{e as T,V as J,d as Q,B as v,S as Z,H as ee,D as ne,L as h}from"./VStack-Bfcz_O9r.js";const f={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},se="_explanationTextarea_hw8s7_1",re="_begrunnelseTextField_hw8s7_6",ae={explanationTextarea:se,begrunnelseTextField:re},te=y(f),ie=S(3),le=M(2e3),oe=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ue=n=>r=>r!==void 0||n,P=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:i}}=q(),t=a?()=>!1:ue(i);return e.jsx("div",{className:s?"":ae.begrunnelseTextField,children:e.jsx(_,{name:"begrunnelse",label:r||te.formatMessage({id:oe(n)}),validate:[R(t),ie,le,V],maxLength:2e3,readOnly:n,parse:G})})},de=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";P.buildInitialValues=n=>({begrunnelse:U(de(n))});P.transformValues=n=>({begrunnelse:n.begrunnelse});P.__docgenInfo={description:`ProsessStegBegrunnelseTextField
