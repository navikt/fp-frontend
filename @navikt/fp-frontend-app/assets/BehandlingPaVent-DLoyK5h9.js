import{j as v}from"./index-nufLo1NJ.js";import{r as l}from"./index-mMUbb89k.js";import{u as m}from"./index.es-CmV-Vl-v.js";import{i as y,A as p}from"./index-Dyi8laJ0.js";import"./withPanelData-BscNDdOr.js";import{S as T}from"./SettPaVentModalIndex-BntZHH3K.js";import{u as E}from"./behandlingApi-CLFTsbD6.js";const b=({behandling:e,kodeverk:t,opneSokeside:s,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,r]=l.useState(!a&&e.behandlingPåVent),o=()=>r(!1),k=E(e),{mutate:d}=m({mutationFn:n=>k.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>s()});l.useEffect(()=>{a||r(e.behandlingPåVent)},[e.versjon,a]);const g=e.aksjonspunkt.filter(n=>y(n.status)).some(n=>n.definisjon===p.AUTO_MANUELT_SATT_PÅ_VENT);return v.jsx(T,{submitCallback:d,cancelEvent:o,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:g,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:u})};b.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
