import{j as u}from"./index-nufLo1NJ.js";import{r as d}from"./index-mMUbb89k.js";import{u as f,f as E,a9 as c,aa as B,ab as K}from"./withPanelData-DPuHUr4Y.js";import{r as h}from"./index.es-DJ6BCpYL.js";import{u as V}from"./fagsakApi-BuY4aD1j.js";import{V as S}from"./BehandlingMenuIndex-F1IBvN0s.js";import{A as _}from"./aksjonspunktCodes-CwqG_2qJ.js";import{u as O,h as N}from"./behandlingApi-Y2pAjD4W.js";import{B as p}from"./FagsakIndex-BMv86F8I.js";import{t as D}from"./index.es-CkapHLx0.js";import{S as P}from"./ExclamationmarkTriangleFill-CrvpSpF4.js";import{i as y}from"./aksjonspunktStatus-xM4O_ZUY.js";import{e as F,g as M}from"./useStandardProsessPanelProps-DzIHA-b2.js";const G=n=>{const[a,e]=d.useState([]),s=r=>{e(i=>{const t=[...i],g=t.findIndex(l=>l.id===r.id);return g>=0?t.splice(g,1,r):t.push(r),t}),n==null||n(r.harApneAksjonspunkter?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:a.filter(r=>r.skalVisesImeny),settFaktaPanelMenyData:s}},I="_container_610fz_1",L="_content_610fz_6",U="_sideMenu_610fz_14",v={container:I,content:L,sideMenu:U},H=({valgtFaktaSteg:n,valgtProsessSteg:a,setFaktaPanelMedÅpentApInfo:e,children:s})=>{const r=f(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(p),{faktaPanelMenyData:t,settFaktaPanelMenyData:g}=G(e),l=t.length>0;return u.jsxs(E,{className:v.container,wrap:!1,children:[l&&u.jsx("div",{className:v.sideMenu,"data-testid":"fakta-meny",children:u.jsx(D,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:t.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?u.jsx(P,{color:"var(--a-orange-600)"}):void 0})),onClick:o=>{i(a,t[o].id)}})}),u.jsx("div",{className:v.content,children:u.jsx(x,{valgtFaktaSteg:n,settFaktaPanelMenyData:g,faktaPanelMenyData:t,children:s})})]})},T=d.createContext({}),x=n=>{const{children:a,...e}=n,s=d.useMemo(()=>e,[e]);return u.jsx(T.Provider,{value:s,children:a})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",Y=(n,a,e,s)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:i}=d.use(T),t=e&&(r===n||s&&r===J);return d.useEffect(()=>{i({id:n,tekst:a,erAktiv:t,harApneAksjonspunkter:s,skalVisesImeny:e})},[e,t,s]),e&&t},q=({standardPanelProps:n,skalPanelVisesIMeny:a,faktaPanelKode:e,faktaPanelMenyTekst:s,children:r})=>{const{behandling:i,fagsak:t,alleKodeverk:g}=d.use(p),l=Y(e,s,a,n.harApneAksjonspunkter);return u.jsx(c,{behandling:i,children:l?u.jsx(B,{behandling:i,fagsak:t,alleKodeverk:g,aksjonspunkterForPanel:n.aksjonspunkter,harÅpneAksjonspunkter:n.harApneAksjonspunkter,submitCallback:n.submitCallback,isReadOnly:n.readOnly,alleMerknaderFraBeslutter:n.alleMerknaderFraBeslutter,children:r}):null})};q.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
