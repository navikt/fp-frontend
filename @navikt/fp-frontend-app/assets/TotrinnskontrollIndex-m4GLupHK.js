...
}`,signature:{properties:[{key:"aktivitetType",value:{name:"string",required:!0}},{key:"erEndring",value:{name:"boolean",required:!0}},{key:"godkjent",value:{name:"boolean",required:!0}},{key:"arbeidsgiverReferanse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"arbeidsgiverNavn",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"orgnr",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"privatpersonFødselsdato",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},description:""}}};const rn=e=>e?.fastsattVarigEndringNaering?a.jsx(u,{id:"ToTrinnsForm.Beregning.VarigEndring"}):a.jsx(u,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),z=e=>e.uttakPerioder?e.uttakPerioder.map(n=>{const l=Y(n.fom),i=Y(n.tom);let t;return n.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":n.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":n.erEndret&&(e.aksjonspunktKode===r.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===r.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":n.erEndret&&e.aksjonspunktKode===r.OVERSTYRING_AV_UTTAKPERIODER||n.erEndret&&e.aksjonspunktKode===r.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":n.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",a.jsx(u,{id:t,values:{a:l,b:i}},t)}):[],tn=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(n=>a.jsx(ue,{aktivitet:n},n.aktivitetType)):[],un=e=>{const n=Ze[e.aksjonspunktKode];return n?[a.jsx(u,{id:n},n)]:[]},En=e=>{const n=en[e.aksjonspunktKode];return n?[a.jsx(u,{id:n},n)]:[]},sn=e=>{const n=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[a.jsx(u,{id:n},n)]},on=(e,n)=>n?.faktaOmBeregningTilfeller?n.faktaOmBeregningTilfeller.flatMap(l=>{const i=e.find(t=>t.kode===l);return i?[a.jsx("div",{children:i.navn},i.navn)]:[]}):[],mn=e=>{let n="";switch(e?.type){case b.KLAGE_YTELSESVEDTAK_STADFESTET:n="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case b.KLAGE_YTELSESVEDTAK_OPPHEVET:n="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case b.KLAGE_AVVIST:n="ToTrinnsForm.Klage.Avvist";break;case b.HJEMSENDE_UTEN_OPPHEVE:n="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case b.KLAGE_DELVIS_MEDHOLD:n="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case b.KLAGE_OMGJORT_UGUNST:n="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case b.KLAGE_MEDHOLD:n="ToTrinnsForm.Klage.OmgjortTilGunst";break}return a.jsx(u,{id:n})},vn=(e,n)=>e===h.FATTER_VEDTAK?[mn(n)]:[],_n=()=>a.jsx(u,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),Tn=()=>a.jsx(u,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),dn=e=>e.aksjonspunktKode===r.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===r.VURDERING_AV_FORMKRAV_KLAGE_NFP,Ee=(e,n,l,i,t,E)=>t.aksjonspunktKode===r.VURDER_PERIODER_MED_OPPTJENING?tn(t):t.aksjonspunktKode===r.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[rn(t.beregningDto)]:t.aksjonspunktKode===r.VURDER_FAKTA_FOR_ATFL_SN?on(l,t.beregningDto):fe(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0||we(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0?z(t):t.aksjonspunktKode===r.AVKLAR_ANNEN_FORELDER_RETT?[_n()]:t.aksjonspunktKode===r.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?sn(e):t.aksjonspunktKode===r.OVERSTYRING_AV_RETT_OG_OMSORG?[Tn()]:dn(t)?vn(n,E):i?En(t):un(t),kn=Se(3),gn=Le(2e3),N="aksjonspunktGodkjenning",Nn=(e,n)=>!e(`${N}.${n}.feilFakta`)&&!e(`${N}.${n}.feilLov`)&&!e(`${N}.${n}.feilSkjønn`)&&!e(`${N}.${n}.feilUtredning`)&&!e(`${N}.${n}.feilSaksflyt`)&&!e(`${N}.${n}.feilBegrunnelse`),se=({index:e,totrinnskontrollSkjermlenkeContext:n,readOnly:l})=>{const{watch:i,getValues:t,control:E}=re(),T=i("aksjonspunktGodkjenning"),{aksjonspunktKode:d,totrinnskontrollGodkjent:k}=T[e],m=n.find(o=>o.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===d)),v=m?.totrinnskontrollAksjonspunkter.find(o=>o.aksjonspunktKode===d),s=!k&&Nn(t,e)?Re():void 0,g=Be(`${N}.${e}.faktagruppe`,s);return!m||!v?null:a.jsxs(G,{gap:"space-12",children:[a.jsx(Oe,{name:`${N}.${e}.totrinnskontrollGodkjent`,control:E,isReadOnly:l,hideLegend:!0,children:a.jsxs(P,{gap:"space-16",children:[a.jsx(x,{value:!0,size:"small",children:a.jsx(u,{id:"ApprovalField.Godkjent"})}),a.jsx(x,{value:!1,size:"small",children:a.jsx(u,{id:"ApprovalField.Vurder"})})]})}),k===!1&&a.jsx(Me,{alignOffset:k?1:110,children:a.jsxs(G,{gap:"space-8",children:[a.jsx(te,{size:"small",children:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),a.jsx(U,{size:"small",children:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),a.jsxs(G,{gap:"space-16",children:[a.jsx(G,{gap:"space-4",children:a.jsxs(P,{justify:"space-between",style:{width:"300px"},children:[a.jsxs(G,{gap:"space-4",children:[a.jsx(B,{name:`${N}.${e}.feilFakta`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilSkjønn`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilLov`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:l})]}),a.jsxs(G,{gap:"space-4",children:[a.jsx(B,{name:`${N}.${e}.feilUtredning`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilSaksflyt`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilBegrunnelse`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:l})]})]})}),g&&a.jsx(Ye,{size:"small",children:g}),a.jsx(je,{name:`${N}.${e}.besluttersBegrunnelse`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[Ae,kn,gn,pe],readOnly:l})]})]})})]})};se.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"erSlettet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erEndret",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erLagtTil",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}}],raw:"Array<foreldrepenger_domene_uttak_UttakPeriodeEndringDto>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Rn="_aksjonspunktTextContainer_1pwmv_5",An="_lenke_1pwmv_10",Q={aksjonspunktTextContainer:Rn,lenke:An},Sn="aksjonspunktGodkjenning",oe=({behandling:e,totrinnskontrollSkjermlenkeContext:n,readOnly:l,erForeldrepengerFagsak:i,erTilbakekreving:t,skjemalenkeTyper:E,faktaOmBeregningTilfeller:T,lagLenke:d})=>{const{control:k,watch:m}=re(),{fields:v}=he({control:k,name:Sn}),s=m("aksjonspunktGodkjenning");return a.jsx(G,{gap:"space-24",children:v.map((g,o)=>{const{aksjonspunktKode:A}=s[o],L=n.find(S=>S.totrinnskontrollAksjonspunkter.some(D=>D.aksjonspunktKode===A)),y=L?.totrinnskontrollAksjonspunkter.find(S=>S.aksjonspunktKode===A);if(!L||!y)return null;const K=Ee(i,e.status,T,t,y,e.behandlingsresultat),I=E.find(S=>S.kode===L.skjermlenkeType),_=d(L.skjermlenkeType);return a.jsxs("div",{children:[_&&I&&a.jsx(ee,{to:_,onClick:()=>window.scroll(0,0),className:Q.lenke,children:I.navn}),K.map((S,D)=>a.jsx("div",{className:Q.aksjonspunktTextContainer,children:a.jsx(U,{size:"small",children:S})},A.concat("_".concat(D.toString())))),a.jsx(se,{index:o,totrinnskontrollSkjermlenkeContext:n,readOnly:l})]},g.id)})})};oe.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const W=(e=[])=>e.every(n=>n.totrinnskontrollGodkjent),X=(e=[])=>e.every(n=>n.totrinnskontrollGodkjent!==void 0&&n.totrinnskontrollGodkjent!==null),Ln=(e,n)=>{if(!n)return!0;const{konsekvenserForYtelsen:l}=n;return!Array.isArray(l)||l.length!==1?!0:!e.some(i=>i===l[0])},pn=e=>e.reduce((n,l)=>l===R.FEIL_FAKTA?{...n,feilFakta:!0}:l===R.FEIL_LOV?{...n,feilLov:!0}:l===R.FEIL_REGEL?{...n,feilSkjønn:!0}:l===R.SKJØNN?{...n,feilSkjønn:!0}:l===R.UTREDNING?{...n,feilUtredning:!0}:l===R.SAKSFLYT||l===R.ANNET?{...n,feilSaksflyt:!0}:l===R.BEGRUNNELSE?{...n,feilBegrunnelse:!0}:{},{}),Kn=e=>({aksjonspunktGodkjenning:e.map(n=>n.totrinnskontrollAksjonspunkter).flat().map(n=>({aksjonspunktKode:n.aksjonspunktKode,totrinnskontrollGodkjent:n.totrinnskontrollGodkjent,besluttersBegrunnelse:ne(n.besluttersBegrunnelse??void 0),...pn(n.vurderPaNyttArsaker?n.vurderPaNyttArsaker:[])}))}),me=({behandling:e,onSubmit:n,forhandsvisVedtaksbrev:l,readOnly:i,erBehandlingEtterKlage:t,erForeldrepengerFagsak:E,skjemalenkeTyper:T,erTilbakekreving:d,totrinnskontrollSkjermlenkeContext:k,faktaOmBeregningTilfeller:m,lagLenke:v,beslutterFormData:s,setBeslutterFormData:g})=>{const o=e&&e.type===F.KLAGE,A=e&&e.type===F.ANKE,L=Ln([w.ENDRING_I_FORDELING_AV_YTELSEN,w.INGEN_ENDRING],e.behandlingsresultat),y=Kn(k),K=Ue({defaultValues:s||y}),I=K.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?a.jsx(qe,{formMethods:K,onSubmit:n,setDataOnUnmount:g,children:a.jsxs(G,{gap:"space-24",children:[!i&&a.jsx(He,{children:a.jsx(u,{id:"HelpText.ToTrinnsKontroll"})}),a.jsx(oe,{behandling:e,erForeldrepengerFagsak:E,erTilbakekreving:d,readOnly:i,totrinnskontrollSkjermlenkeContext:k,skjemalenkeTyper:T,faktaOmBeregningTilfeller:m,lagLenke:v}),a.jsxs(P,{gap:"space-16",style:{marginBottom:"50px"},children:[a.jsx(f,{variant:"primary",size:"small",disabled:!W(I)||!X(I)||K.formState.isSubmitting,loading:K.formState.isSubmitting,children:a.jsx(u,{id:"ToTrinnsForm.Godkjenn"})}),a.jsx(f,{variant:"primary",size:"small",disabled:W(I)||!X(I)||K.formState.isSubmitting,loading:K.formState.isSubmitting,onClick:Ke,children:a.jsx(u,{id:"ToTrinnsForm.SendTilbake"})}),!o&&!t&&!A&&!d&&L&&a.jsx(Je,{href:"#",onClick:l,children:a.jsx(u,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};me.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
>[]`}}]}}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ApData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Un="_image_1t1ka_1",qn="_modal_1t1ka_9",Z={image:Un,modal:qn},fn=(e,n,l,i)=>e===F.TILBAKEKREVING?"FatterVedtakApprovalModal.Tilbakekreving":e===F.TILBAKEKREVING_REVURDERING?"FatterVedtakApprovalModal.TilbakekrevingRevurdering":e===F.KLAGE?"FatterVedtakApprovalModal.ModalDescriptionKlage":e===F.ANKE?"FatterVedtakApprovalModal.ModalDescriptionAnke":i?"FatterVedtakApprovalModal.UendretUtfall":n&&n.type===b.AVSLATT?"FatterVedtakApprovalModal.IkkeInnvilget":l?"FatterVedtakApprovalModal.OpphortVedtak":"FatterVedtakApprovalModal.InnvilgetVedtak",wn=(e,n)=>n===F.KLAGE?"FatterVedtakApprovalModal.ModalDescriptionKlage":n===F.ANKE?"FatterVedtakApprovalModal.ModalDescriptionAnke":e?"FatterVedtakApprovalModal.ModalDescriptionOpphort":"FatterVedtakApprovalModal.ModalDescriptionApproval",H=e=>e===h.FATTER_VEDTAK,Mn=(e,n,l,i,t,E)=>e?H(n)?fn(l,i,t,E):"":"FatterVedtakApprovalModal.VedtakReturneresTilSaksbehandler",Hn=e=>H(e)?"FatterVedtakApprovalModal.Innvilget":"",cn=(e,n,l)=>H(e)?wn(l,n):"FatterVedtakApprovalModal.ModalDescription",de=({closeEvent:e,allAksjonspunktApproved:n,behandlingStatusKode:l,behandlingTypeKode:i,behandlingsresultat:t,harSammeResultatSomOriginalBehandling:E})=>{const T=M(),d=!!t&&t.type===b.OPPHOR,k=Mn(n,l,i,t,d,E),m=Hn(l),v=cn(l,i,d);return a.jsx($,{className:Z.modal,open:!0,"aria-label":T.formatMessage({id:v}),onClose:e,children:a.jsx($.Body,{children:a.jsxs(P,{justify:"space-between",align:"center",wrap:!1,children:[a.jsxs(P,{gap:"space-8",children:[a.jsx(Ce,{className:Z.image,title:T.formatMessage({id:m})}),a.jsxs(G,{gap:"space-4",children:[a.jsx(te,{size:"small",children:a.jsx(u,{id:k})}),a.jsx(U,{size:"small",children:a.jsx(u,{id:"FatterVedtakApprovalModal.GoToSearchPage"})})]})]}),a.jsx(f,{size:"small",variant:"primary",onClick:e,autoFocus:!0,type:"button",children:a.jsx(u,{id:"FatterVedtakApprovalModal.Ok"})})]})})})};de.__docgenInfo={description:`FatterVedtakApprovalModal
...
| 'BT-007'
| 'BT-009'
| '-'`,elements:[{name:"literal",value:"'BT-002'"},{name:"literal",value:"'BT-003'"},{name:"literal",value:"'BT-004'"},{name:"literal",value:"'BT-008'"},{name:"literal",value:"'BT-006'"},{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"},{name:"literal",value:"'-'"}]},description:""},harSammeResultatSomOriginalBehandling:{required:!1,tsType:{name:"boolean"},description:""}}};const Yn=le(_e),ke=({behandling:e,closeEvent:n,allAksjonspunktApproved:l})=>a.jsx(ae,{value:Yn,children:a.jsx(de,{closeEvent:n,allAksjonspunktApproved:l,behandlingsresultat:e.behandlingsresultat??void 0,behandlingStatusKode:e.status,behandlingTypeKode:e.type,harSammeResultatSomOriginalBehandling:e.behandlingsresultat?.erRevurderingMedUendretUtfall||!1})});ke.__docgenInfo={description:"",methods:[],displayName:"FatterVedtakTotrinnskontrollModalSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const ge=({behandling:e,pushLocation:n,allAksjonspunktApproved:l})=>a.jsx(ke,{behandling:e,closeEvent:()=>{n("/")},allAksjonspunktApproved:l});ge.__docgenInfo={description:"",methods:[],displayName:"BeslutterModalIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Jn=({fagsakData:e,valgtBehandlingUuid:n,beslutterFormData:l,setBeslutterFormData:i,toggleVisUtvidetBehandlingDetaljerKnapp:t})=>{const E=M(),[T,d]=O.useState(!1),[k,m]=O.useState(!1),v=e.getFagsak(),s=J(e.getBehandling(n)),g=Ve(s),o=De(),A=Fe(),L=Ge(Pe()),{brukernavn:y,kanVeilede:K}=J(L.data).innloggetBruker,I=ze(s.type),{mutate:_}=C({mutationFn:p=>g.lagreTotrinnsaksjonspunkt(p)}),{mutate:S}=C({mutationFn:()=>g.forhåndsvisMelding({behandlingUuid:s.uuid}),onSuccess:p=>{be(p)}});if(!s.totrinnskontrollÅrsaker)return null;const D=p=>{const Ne={behandlingUuid:s.uuid,behandlingVersjon:s.versjon,bekreftedeAksjonspunktDtoer:[p.fatterVedtakAksjonspunktDto]};m(p.erAlleAksjonspunktGodkjent),d(!0),_(Ne)},c=s.status===h.FATTER_VEDTAK;return a.jsxs(a.Fragment,{children:[a.jsx(Qe,{tekst:E.formatMessage({id:c?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),toggleVisUtvidetBehandlingDetaljerKnapp:t,children:a.jsx(Te,{behandling:s,location:o,readOnly:y===s.ansvarligSaksbehandler||K,onSubmit:D,forhandsvisVedtaksbrev:S,fagsakYtelseType:v.fagsakYtelseType,alleKodeverk:I,createLocationForSkjermlenke:$e,beslutterFormData:l,setBeslutterFormData:i})}),T&&a.jsx(ge,{behandling:s,pushLocation:A,allAksjonspunktApproved:k})]})};Jn.__docgenInfo={description:`TotrinnskontrollIndex
...
Ansvarlig for att rita opp vilkår og aksjonspunkter med toTrinnskontroll`,methods:[],displayName:"TotrinnskontrollIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},beslutterFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{w as K,Xe as S,Jn as T};
