...
Readonly<{
  ...
  submitCallback: (aksjonspunktData: any) => Promise<void>;
  alleKodeverk: AlleKodeverk;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",c="default",Q=(n,t,e,s,r,l)=>a=>{const i=(Array.isArray(a)?a:[a]).map(g=>({"@type":g.kode,...g})),o={saksnummer:n.saksnummer,behandlingUuid:t.uuid,behandlingVersjon:t.versjon};if(i&&r&&l){if(i.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(l.includes(i[0].kode))return r({...o,overstyrteAksjonspunktDtoer:i}).then(()=>e(c,b))}return s({...o,bekreftedeAksjonspunktDtoer:i}).then(()=>e(c,b))},Y=(n,t=[])=>{const{behandling:e,rettigheter:s,fagsak:r,lagreAksjonspunkter:l,lagreOverstyrteAksjonspunkter:a,oppdaterProsessStegOgFaktaPanelIUrl:d,alleKodeverk:i}=k.use(v),{aksjonspunkt:o}=e,g=o&&n?o.filter(m=>n.includes(m.definisjon)):[],j=D(e,[],s,!1),A=x(e.status,g),w=Q(r,e,d,l,a,t);return{behandling:e,submittable:!g.some(m=>p(m.status))||g.some(m=>m.kanLoses),harApneAksjonspunkter:g.some(m=>p(m.status)&&m.kanLoses),alleKodeverk:i,aksjonspunkter:g,readOnly:j,alleMerknaderFraBeslutter:A,submitCallback:w}},J=[S.AVKLAR_VERGE],W=()=>{const n=f(),t=Y(J),{behandling:e}=k.use(v),s=E(e),r=V(e,"VERGE"),{data:l,isFetching:a}=F(s.vergeOptions(e,r));return u.jsx(q,{standardPanelProps:t,faktaPanelKode:K.VERGE,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:r,children:a?u.jsx(B,{}):u.jsx(M,{verge:l,alleKodeverk:t.alleKodeverk,submittable:t.submittable})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{I as F,W as V,q as a,Y as u};
