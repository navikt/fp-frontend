import{j as e,h as g,P as y,L as p}from"./iframe-Cf_ksEjy.js";import{r as v,X as f}from"./index.es-OJRdCDml.js";import{u as q,r as j}from"./fagsakApi-G8yv0H3R.js";import{V as w}from"./VisittkortSakIndex-B-ZnSmt5.js";import{V as c,a as I,B as T}from"./VStack-DaJyDAMB.js";import{M as k}from"./message-BP4tlGDO.js";import{E as F}from"./IngenBehandlingValgtPanel-DzEXYssM.js";import{u as R}from"./useTrackRouteParam-O2s9NzX-.js";import{p as E}from"./paths-BioNs3Ij.js";import{u as o}from"./useKodeverk-Y8oAF4uQ.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(w,{bruker:n.person}),e.jsx(c,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
