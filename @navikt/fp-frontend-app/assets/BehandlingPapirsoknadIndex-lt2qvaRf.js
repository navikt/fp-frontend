...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const I="frilans",rr=(r,n)=>r(n),Ga=(r=[])=>r.map(n=>n.periodeFom).filter(n=>n&&n!=="").sort((n,a)=>re(n,ce).diff(re(a,ce))),La=en(50),Ha=(r,n,a,t)=>()=>{const s=rr(r,`${n}.fomDato`);return a.length>0&&a[0]&&s&&!re(a[0]).isSameOrBefore(re(s))?t.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},Cn=({readOnly:r})=>{const n=V(),{control:a,getValues:t,watch:s,trigger:i,formState:{isSubmitted:l}}=A(),{fields:o,remove:u,append:g}=X({control:a,name:`${I}.oppdragPerioder`}),p=s(`${I}.perioder`),k=Ga(p);return e.jsx(se,{bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:o,readOnly:r,append:g,remove:u,children:(v,y,R)=>{const F=`${I}.oppdragPerioder.${y}`;return e.jsxs(L,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(E,{name:`${I}.oppdragPerioder.${y}.fomDato`,control:a,label:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[q,Ha(t,F,k,n),()=>{const D=rr(t,`${F}.fomDato`),_=rr(t,`${F}.tomDato`);return _&&D?z(_)(D):null}],onChange:()=>l?i():void 0}),e.jsx(E,{name:`${I}.oppdragPerioder.${y}.tomDato`,control:a,label:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[q,()=>{const D=rr(t,`${F}.fomDato`),_=rr(t,`${F}.tomDato`);return _&&D?B(D)(_):null}],onChange:()=>l?i():void 0}),e.jsx(w,{name:`${I}.oppdragPerioder.${y}.oppdragsgiver`,control:a,validate:[La],label:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),R&&e.jsx("div",{children:R()})]},v.id)}})};Cn.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerEndringssøknadValues) => Promise<void>",signature:{arguments:[{type:{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""}}};const Jt=()=>({...x.initialValues(),...Y.initialValues(),...ge.initialValues(),...me.initialValues(),...ke.initialValues(),...de.initialValues(),...$e.initialValues(),...ye.initialValues(),...te.initialValues(),...ae.initialValues(),...Be.initialValues(),...ve.initialValues(),...pe.initialValues(),...$.initialValues(),...H.initialValues()}),Ct=r=>({...x.transformValues(r),...Y.transformValues(r),...ge.transformValues(r),...me.transformValues(r),...ke.transformValues(r),...de.transformValues(r),...$e.transformValues(r),...ye.transformValues(r),...te.transformValues(r),...ae.transformValues(r),...Be.transformValues(r),...ve.transformValues(r),...pe.tranformValues(r),...$.transformValues(r),...H.transformValues(r)}),da=({readOnly:r,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:s,fagsakPersonnummer:i})=>{const l=or({defaultValues:Jt()}),o=l.watch("annenForelder.sokerHarAleneomsorg"),u=l.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),g=!o&&u!==!1,p=l.watch("foedselsDato"),k=l.watch("mottattDato");return e.jsxs(dr,{formMethods:l,onSubmit:v=>t(Ct(v)),children:[e.jsxs(_r,{columns:{sm:1,md:2},gap:"space-16",children:[e.jsx(x,{readOnly:r}),e.jsx(Y,{readOnly:r,erAdopsjon:n.getFamilieHendelseType()===c.ADOPSJON,alleKodeverk:a,mottattDato:k}),e.jsx(ge,{readOnly:r,alleKodeverk:a}),e.jsx(me,{readOnly:r,alleKodeverk:a}),e.jsx(ke,{readOnly:r}),e.jsx(de,{readOnly:r,alleKodeverk:a}),e.jsx($e,{readOnly:r}),n.getFamilieHendelseType()===c.FODSEL&&e.jsx(ye,{readOnly:r,erForeldrepenger:!0}),e.jsx(te,{readOnly:r,soknadData:n}),e.jsx(ae,{readOnly:r,familieHendelseType:n.getFamilieHendelseType(),fodselsdato:p,isForeldrepengerFagsak:!0}),e.jsx(Be,{readOnly:r,alleKodeverk:a,fagsakPersonnummer:i,sokerErMor:n.getForeldreType()===he.MOR}),e.jsx(ve,{foreldreType:n.getForeldreType(),readOnly:r,alleKodeverk:a,erEndringssøknad:!1}),e.jsx(pe,{annenForelderInformertRequired:g,readOnly:r}),e.jsx($,{readOnly:r})]}),e.jsx(H,{readOnly:r,onSubmitUfullstendigsoknad:s,submitting:l.formState.isSubmitting,erEndringssøknad:!1})]})};da.__docgenInfo={description:`ForeldrepengerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const zt=[c.ADOPSJON,c.FODSEL],ga=({setSoknadData:r,fagsakYtelseType:n,alleKodeverk:a})=>{const t=or({defaultValues:{fagsakYtelseType:n,familieHendelseType:void 0,foreldreType:void 0}}),s=t.watch("fagsakYtelseType"),i=a.FagsakYtelseType,l=a.FamilieHendelseType,o=a.ForeldreType;return e.jsx(dr,{formMethods:t,onSubmit:u=>{r(new lt(u.fagsakYtelseType,u.familieHendelseType,u.foreldreType)),t.reset(u)},children:e.jsx(ir.New,{background:"neutral-moderate",borderWidth:"1",children:e.jsxs(T,{gap:"space-16",padding:"5",children:[e.jsx(N,{size:"small",level:"3",children:e.jsx(d,{id:"Registrering.Omsoknaden.Title"})}),e.jsxs(L,{gap:"20",children:[e.jsx(Q,{name:"fagsakYtelseType",control:t.control,label:e.jsx(d,{id:"Registrering.Omsoknaden.soknadstype"}),validate:[m],children:i.map(u=>e.jsx(j,{value:u.kode,size:"small",disabled:!0,children:u.navn},u.kode))}),s!=="SVP"&&e.jsx(Q,{name:"familieHendelseType",control:t.control,label:e.jsx(d,{id:"Registrering.Omsoknaden.Tema"}),validate:[m],children:l.filter(({kode:u})=>zt.some(g=>g===u)).map(u=>e.jsx(j,{value:u.kode,size:"small",children:u.navn},u.kode))}),e.jsx(Q,{name:"foreldreType",control:t.control,label:e.jsx(d,{id:"Registrering.Omsoknaden.Soker"}),validate:[m],children:o.map(u=>e.jsx(j,{value:u.kode,size:"small",children:u.navn},u.kode))})]}),e.jsx(ir,{style:{textAlign:"end"},children:e.jsx(ne,{type:"submit",disabled:!t.formState.isDirty,children:e.jsx(d,{id:"Registrering.Omsoknaden.VisSkjema"})})})]})})})};ga.__docgenInfo={description:`SoknadTypePickerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Xt=()=>({...x.initialValues(),...Y.initialValues(),...ge.initialValues(),...me.initialValues(),...ke.initialValues(),...de.initialValues(),...ze.initialValues(),...Xe.initialValues(),...$.initialValues(),...H.initialValues()}),Wt=r=>({...x.transformValues(r),...Y.transformValues(r),...ge.transformValues(r),...me.transformValues(r),...ke.transformValues(r),...de.transformValues(r),...ze.transformValues(r),...Xe.transformValues(r),...$.transformValues(r),...H.transformValues(r)}),ma=({readOnly:r,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=or({defaultValues:Xt()}),l=i.watch("mottattDato");return e.jsxs(dr,{formMethods:i,onSubmit:o=>t(Wt(o)),children:[e.jsxs(_r,{columns:{sm:1,md:2},gap:"space-16",children:[e.jsx(x,{readOnly:r}),e.jsx(Y,{readOnly:r,alleKodeverk:a,erAdopsjon:n.getFamilieHendelseType()!==c.ADOPSJON,mottattDato:l}),e.jsx(ge,{readOnly:r,alleKodeverk:a}),e.jsx(me,{readOnly:r,alleKodeverk:a}),e.jsx(ke,{readOnly:r}),e.jsx(de,{readOnly:r,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:a}),e.jsx(ze,{readOnly:r}),e.jsx(Xe,{readOnly:r}),e.jsx($,{readOnly:r})]}),e.jsx(H,{readOnly:r,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting,erEndringssøknad:!1})]})};ma.__docgenInfo={description:`SvangerskapspengerForm
...
Informasjonsmodal som vises til saksbehandler når en papirsøknad har blitt registrert.`,methods:[],displayName:"SoknadRegistrertModal",props:{isOpen:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Qt=()=>{const[r,n]=S.useState(!1),{alleKodeverk:a,behandling:t,rettigheter:s,fagsak:i,setSkalOppdatereEtterBekreftelseAvAp:l}=S.use(Yn),o=!s.writeAccess.isEnabled||t.behandlingPåVent,u=es(n,l),g=t.aksjonspunkt.some(p=>p.definisjon===Qe.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER);return e.jsxs(e.Fragment,{children:[e.jsx(Ta,{isOpen:r}),e.jsx(ya,{fagsak:i,kodeverk:a,readOnly:o,lagrePapirsøknad:u,erEndringssøknad:g})]})},es=(r,n)=>{const{behandling:a,fagsak:t,lagreAksjonspunkter:s}=S.use(Yn);return async(i,l,o,u)=>{const g=[{"@type":rs(a.aksjonspunkt),tema:l,soknadstype:i,soker:o,...u}];u&&n(!1);const p=await s({saksnummer:t.saksnummer,behandlingUuid:a.uuid,behandlingVersjon:a.versjon,bekreftedeAksjonspunktDtoer:g});return u?r(!0):window.scrollTo(0,0),p}},rs=r=>r.map(n=>n.definisjon).filter(n=>n===Qe.REGISTRER_PAPIRSOKNAD_ENGANGSSTONAD||n===Qe.REGISTRER_PAPIRSOKNAD_FORELDREPENGER||n===Qe.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER||n===Qe.REGISTRER_PAPIRSOKNAD_SVANGERSKAPSPENGER)[0];Qt.__docgenInfo={description:`BehandlingPapirsoknadIndex
