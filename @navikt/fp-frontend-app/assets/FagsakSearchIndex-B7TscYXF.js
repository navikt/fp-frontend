import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as T,u as b,n as F}from"./initFetch-DqSQrJwm.js";import{a as K,e as x,X as A,p as I,u as M}from"./index.es-XLV2GzfI.js";import{u as N,V as _,g as m,f as y,h as P,P as E,a5 as V}from"./withPanelData-CgQBDAX_.js";import{$ as O}from"./index.es-BvqpLIx-.js";import{K as c}from"./alleKodeverk-Dm9joGL5.js";import{g as C}from"./kodeverkUtils-DLZgokMR.js";import{T as s}from"./Table-mDYWAjSi.js";import{M as u}from"./message-BIGUIiay.js";import"./index-DjhIdADd.js";import{S as Y}from"./ExclamationmarkTriangleFill-C8jNl3yq.js";import{p as D}from"./paths-DK3ue82i.js";import{a as L}from"./index-CiTJJs0Y.js";const w=({fagsaker:r,selectFagsakCallback:a,alleKodeverk:t})=>{const i=C(t);return e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:r.map(n=>e.jsxs(s.Row,{onMouseDown:()=>a(n.saksnummer),onKeyDown:()=>a(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:i(n.fagsakYtelseType,c.FAGSAK_YTELSE)}),e.jsx(s.DataCell,{children:i(n.status,c.FAGSAK_STATUS)})]},n.saksnummer))})]})};w.__docgenInfo={description:`FagsakList
...
Formaterer fagsak-søkeresultatet for visning i tabell. Sortering av fagsakene blir håndtert her.`,methods:[],displayName:"FagsakList",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const H="_container_74un9_1",z="_advarselIcon_74un9_6",f={container:H,advarselIcon:z},B=(r,a)=>!!(r||a===void 0||a.length<1),j=({searchStarted:r,searchResultAccessDenied:a,searchFagsakCallback:t})=>{const i=N(),n=K({defaultValues:{searchString:""}}),d=n.watch("searchString");return e.jsx(x,{formMethods:n,onSubmit:t,className:f.container,children:e.jsxs(_,{gap:"2",children:[e.jsx(m,{size:"small",children:e.jsx(u,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(y,{gap:"2",align:"end",children:[e.jsx(A,{name:"searchString",label:i.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[I]}),e.jsx(P,{variant:"primary",size:"small",loading:r,disabled:B(r,d),children:e.jsx(u,{id:"Search.Search"})})]}),a&&e.jsxs(y,{gap:"2",align:"end",children:[e.jsx(Y,{className:f.advarselIcon}),e.jsx(m,{size:"small",children:e.jsx(u,{id:a.feilmelding})})]})]})})};j.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const $="_container_gwama_1",G="_label_gwama_9",q={container:$,label:G},h=({fagsaker:r,searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n,searchResultAccessDenied:d,alleKodeverk:l})=>e.jsxs("div",{className:q.container,children:[e.jsx(j,{searchFagsakCallback:a,searchStarted:n,searchResultAccessDenied:d}),t&&r.length===0&&e.jsx(m,{size:"small",className:q.label,children:e.jsx(u,{id:"FagsakSearch.ZeroSearchResults"})}),t&&r.length>1&&e.jsx(w,{fagsaker:r,selectFagsakCallback:i,alleKodeverk:l})]});h.__docgenInfo={description:`FagsakSearch
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSearch",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const U={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},X=O(U),S=({fagsaker:r=[],searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n=!1,searchResultAccessDenied:d,alleKodeverk:l})=>e.jsx(E,{value:X,children:e.jsx(h,{fagsaker:r,searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n,searchResultAccessDenied:d,alleKodeverk:l})});S.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  status: string;
  aktørId: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Z=[],Q=()=>{var p;const{kodeverkOptions:r,søkFagsak:a}=T(),{data:t}=b(r()),i=V(),n=o=>{o&&i(D(o))},{mutate:d,data:l=Z,status:k,error:g}=M({mutationFn:o=>a(o.searchString),onSuccess:o=>{var v;o.length===1&&n((v=o[0])==null?void 0:v.saksnummer)}}),R=g&&g instanceof L&&g.response.status===403?(p=g.response)==null?void 0:p.data:void 0;return e.jsx(S,{fagsaker:l,searchFagsakCallback:d,searchResultReceived:k==="success",selectFagsakCallback:n,searchStarted:k==="pending",searchResultAccessDenied:R,alleKodeverk:F(t)})};Q.__docgenInfo={description:`FagsakSearchIndex
