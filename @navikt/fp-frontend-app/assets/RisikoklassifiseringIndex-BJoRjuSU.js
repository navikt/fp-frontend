...
om klassifisering er utført og ingen faresignaler er funnet og om klassifisering er utført og faresignaler er funnet`,methods:[],displayName:"RisikoklassifiseringSakIndex",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const on=({fagsakData:e,behandling:r,setBehandling:t})=>{const n=e.getFagsak(),{selected:a=!1}=xe({paramName:"risiko",parse:o=>o==="true",isQueryParam:!0}),l=Y(),i=$(),u=()=>{l(I(i)(!a))},{kodeverkOptions:k}=M(),{data:d}=R(k()),p=e.getBehandling(r==null?void 0:r.uuid);return r&&p?s.jsx(gn,{isRiskPanelOpen:a,fagsak:n,toggleRiskPanel:u,behandlingAppKontekst:p,behandling:r,setBehandling:t}):s.jsx(S,{risikoklassifisering:n.kontrollResultat,isPanelOpen:a,readOnly:!0,toggleRiskPanel:u,faresignalVurderinger:T(d)[Q.FARESIGNAL_VURDERING]})},gn=({fagsak:e,behandling:r,behandlingAppKontekst:t,setBehandling:n,toggleRiskPanel:a,isRiskPanelOpen:l})=>{const{behandlingPåVent:i,status:u,type:k,risikoAksjonspunkt:d,kontrollResultat:p}=t,{kodeverkOptions:o}=M(),f=R(ge()),{data:se}=R(o()),_=T(f.data).innloggetBruker,le=Xe(_,e.status,u,k),ie=dn(_,le,i),K=Y(),G=$();g.useEffect(()=>{d&&d.status===N.OPPRETTET&&!l&&K(I(G)(!0)),d&&d.status===N.UTFORT&&K(I(G)(!1))},[!!d,r.uuid,r.versjon]);const{lagreAksjonspunkter:ue}=Ve(r,n),oe=L=>{ue({behandlingUuid:r.uuid,behandlingVersjon:r.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":L.kode,...L}]})};return s.jsx(S,{aksjonspunkt:d??void 0,risikoklassifisering:p,isPanelOpen:l,readOnly:ie,submitAksjonspunkt:oe,toggleRiskPanel:a,faresignalVurderinger:T(se)[Q.FARESIGNAL_VURDERING]})},dn=(e,r,t)=>{if(t)return!0;const{kanSaksbehandle:n}=e;return!n||!r.writeAccess.isEnabled};on.__docgenInfo={description:`RisikoklassifiseringIndex
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""}}};export{v as E,O as K,on as R,Pe as S,Xe as g};
