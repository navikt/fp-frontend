import{j as e}from"./jsx-runtime-qGIIFXMu.js";import{r as b}from"./index-CDs2tPxN.js";import{c as I,a as K,H as S,D as ze,e as G,b as N,d as ve,ad as ye,L as h,B as f,t as Q,P as X,q as $e,M as oe,x as pe}from"./index.es-DZCnD4JN.js";import{I as Je,b as be,Y as C,x as H,H as We,W as U}from"./index.es-zhgnUGpN.js";import{a4 as de,d as qe,Y as fe,H as q,c as Z,a as B,F,M as he,Z as je,n as Y,K as P,G as ee,a5 as Ae,r as M,B as c,q as x,a1 as O,a6 as Ze,a2 as ke}from"./AppIndex.stories-BT2mrDre.js";import{P as Te,b as ne,a as Qe}from"./OverstyringPanel-COqka0PL.js";import{M as u,y as d,c as Ke,O as Xe,W as Be,H as we,L as z}from"./index.es-B7i7KCiU.js";import{P as $,u as ce}from"./ProsessDefaultInitPanel-CFpUjDII.js";import{W as Re}from"./index.es-DLE317xt.js";import{K as en}from"./KlageBehandlingModal-Dt9GQpQ5.js";import{v as nn}from"./validerApKodeOgHentApEnum-BJOxEDqe.js";import{F as rn}from"./FatterVedtakStatusModal-CXaQAi9c.js";import{V as an}from"./VergeFaktaInitPanel-EhVoKn1I.js";import{B as tn}from"./BehandlingContainer-BRIcWlPf.js";import"./index-DHUlIts1.js";import"./useRestApiRunner-CQE2m9r8.js";import"./iframe-BA7ZUWGs.js";import"../sb-preview/runtime.js";import"./SettPaVentReadOnlyModal-CuA3M8Z_.js";import"./index-27BIJqHF.js";import"./nb_NO-B9XIc68F.js";import"./BehandlingHenlagtPanel-CZMQqOj_.js";import"./bind-DK9GJUjU.js";const v={STADFESTE_YTELSESVEDTAK:"STADFESTE_YTELSESVEDTAK",MEDHOLD_I_KLAGE:"MEDHOLD_I_KLAGE",OPPHEVE_YTELSESVEDTAK:"OPPHEVE_YTELSESVEDTAK",AVVIS_KLAGE:"AVVIS_KLAGE",HJEMSENDE_UTEN_Å_OPPHEVE:"HJEMSENDE_UTEN_Å_OPPHEVE"},E={DELVIS_MEDHOLD_I_KLAGE:"DELVIS_MEDHOLD_I_KLAGE",GUNST_MEDHOLD_I_KLAGE:"GUNST_MEDHOLD_I_KLAGE",UGUNST_MEDHOLD_I_KLAGE:"UGUNST_MEDHOLD_I_KLAGE",UDEFINERT:"-"},sn={"Klage.LovhjemmelNFP":"Fvl §§ 28, 31, 32, 33 og ftrl § 21-12","Klage.LovhjemmelKA":"Fvl §§  28, 31, 32, 34 og ftrl § 21-12","Klage.Formkrav.VelgVedtak":"Vedtaket som er påklagd","Klage.Formkrav.Title":"Vurder formkrav","Klage.Formkrav.HelpText":"Vurder om klagen oppfyller formkravene","Klage.Formkrav.IkkePåklagdVedtak":"Ikke påklagd et vedtak","Klage.Formkrav.ErKlagerPart":"Er klager part i saken?","Klage.Formkrav.ErKonkret":"Klages det på konkrete elementer i vedtaket?","Klage.Formkrav.ErFristOverholdt":"Er klagefristen overholdt?","Klage.Formkrav.ErSignert":"Er klagen signert?","Klage.Formkrav.KabalText":"Fortsett klagebehandlingen i KABAL: Kryss av, velg hjemmel og trykk send","Klage.Formkrav.SeKabalText":"Klagen behandles i KABAL","Klage.Formkrav.SendTilKabal":"Send til KABAL","Klage.Formkrav.Hjemmel":"Hjemmel","Klage.Formkrav.Ja":"Ja","Klage.Formkrav.Nei":"Nei","Klage.Formkrav.Vurdering":"Vurdering","FormkravKlageFormNfp.Fritekst":"Fritekst","TempsaveKlageButton.TempSaveButton":"Lagre","Malform.Beskrivelse":"Foretrukket språk"},ln="_selectBredde_19ro0_1",un="_textField_19ro0_4",gn={selectBredde:ln,textField:un},D="ikkePaklagdVedtak",re=n=>n.erKlagerPart===!1||n.erFristOverholdt===!1||n.erKonkret===!1||n.erSignert===!1||n.vedtak===D,Ve=(n,r)=>n.find(t=>t.uuid===r),ae=(n,r)=>{const t=Ve(n,r);return!!t&&(t.type===de.TILBAKEKREVING||t.type===de.TILBAKEKREVING_REVURDERING)},Pe=(n,r)=>{const t=ae(n,r),s=Ve(n,r);return s&&t?{tilbakekrevingUuid:s.uuid,tilbakekrevingVedtakDato:s.avsluttet,tilbakekrevingBehandlingType:s.type}:void 0},on=(n,r,t,s)=>({kode:s,begrunnelse:n.begrunnelse,behandlingUuid:r,erKlagerPart:n.erKlagerPart,erFristOverholdt:n.erFristOverholdt,erKonkret:n.erKonkret,erSignert:n.erSignert,erTilbakekreving:ae(t,n.vedtak),klageTilbakekreving:Pe(t,n.vedtak),paKlagdBehandlingUuid:n.vedtak===D?void 0:n.vedtak,fritekstTilBrev:re(n)?n.fritekstTilBrev:void 0}),te=({behandlingUuid:n,saveKlage:r,avsluttedeBehandlinger:t,spinner:s,aksjonspunktCode:a,readOnly:l,handleSubmit:g})=>l?null:e.jsx(I,{size:"small",variant:"primary",loading:s,onClick:g(i=>r(on(i,n,t,a))),type:"button",children:e.jsx(u,{id:"TempsaveKlageButton.TempSaveButton"})});te.defaultProps={spinner:!1,readOnly:!1};te.__docgenInfo={description:"",methods:[],displayName:"TempsaveKlageButton",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunktCode:{required:!0,tsType:{name:"string"},description:""},avsluttedeBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  type: string;
  avsluttet?: string;
  uuid: string;
  ...
  vedtak?: string;
  fritekstTilBrev?: string;
}`,signature:{properties:[{key:"erKlagerPart",value:{name:"boolean",required:!1}},{key:"erFristOverholdt",value:{name:"boolean",required:!1}},{key:"erKonkret",value:{name:"boolean",required:!1}},{key:"erSignert",value:{name:"boolean",required:!1}},{key:"begrunnelse",value:{name:"string",required:!1}},{key:"vedtak",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}}]}}],raw:"UseFormHandleSubmit<FormValues>"},description:""}}};const dn=n=>n!=null&&n.paKlagdBehandlingUuid?`${n.paKlagdBehandlingUuid}`:D,kn=(n,r,t)=>[e.jsx("option",{value:D,children:r.formatMessage({id:"Klage.Formkrav.IkkePåklagdVedtak"})},"formkrav")].concat([...n].sort((a,l)=>Y(a.avsluttet).diff(Y(l.avsluttet))).map(a=>e.jsx("option",{value:`${a.uuid}`,children:`${t(a.type,P.BEHANDLING_TYPE)} ${Y(a.avsluttet).format(ye)}`},a.uuid))),mn=n=>n===q.VURDERING_AV_FORMKRAV_KLAGE_NFP?"Klage.LovhjemmelNFP":"Klage.LovhjemmelKA",vn=n=>{const r=n?n.klageFormkravResultatNFP:null,t=n?n.klageVurderingResultatNFP:null;return{vedtak:r?dn(r):"",begrunnelse:r?r.begrunnelse:void 0,erKlagerPart:r?r.erKlagerPart:void 0,erKonkret:r?r.erKlageKonkret:void 0,erFristOverholdt:r?r.erKlagefirstOverholdt:void 0,erSignert:r?r.erSignert:void 0,fritekstTilBrev:t?t.fritekstTilBrev:void 0}},yn=(n,r)=>({erKlagerPart:n.erKlagerPart,erFristOverholdt:n.erFristOverholdt,erKonkret:n.erKonkret,erSignert:n.erSignert,begrunnelse:n.begrunnelse,kode:q.VURDERING_AV_FORMKRAV_KLAGE_NFP,vedtakBehandlingUuid:n.vedtak===D?void 0:n.vedtak,erTilbakekreving:ae(r,n.vedtak),tilbakekrevingInfo:Pe(r,n.vedtak),fritekstTilBrev:re(n)?n.fritekstTilBrev:void 0}),Fe=({behandlingUuid:n,readOnly:r,klageVurdering:t,readOnlySubmitButton:s,alleKodeverk:a,avsluttedeBehandlinger:l,submitCallback:g,lagreFormkravVurdering:i,formData:y,setFormData:p})=>{const o=K(),m=ee(a),k=kn(l,o,m),w=b.useMemo(()=>vn(t),[t]),A=qe({defaultValues:y||w}),R=A.watch();return e.jsxs(fe,{formMethods:A,onSubmit:T=>g(yn(T,l)),setDataOnUnmount:p,children:[e.jsx(S,{size:"small",children:o.formatMessage({id:"Klage.Formkrav.Title"})}),e.jsx(d,{fourPx:!0}),e.jsx(ze,{children:o.formatMessage({id:mn(q.VURDERING_AV_FORMKRAV_KLAGE_NFP)})}),e.jsx(d,{sixteenPx:!0}),e.jsxs(G,{gap:"6",children:[e.jsx(Ke,{isAksjonspunktOpen:!s,children:[e.jsx(u,{id:"Klage.Formkrav.HelpText"},q.VURDERING_AV_FORMKRAV_KLAGE_NFP)]}),e.jsx(G,{gap:"6",children:e.jsxs(N,{gap:"10",children:[e.jsx("div",{children:e.jsx(Z,{readOnly:r,validate:[B],name:"vedtak",label:o.formatMessage({id:"Klage.Formkrav.VelgVedtak"}),selectValues:k,className:gn.selectBredde})}),e.jsxs(G,{gap:"5",children:[e.jsxs(N,{gap:"4",children:[e.jsx(F,{name:"erKlagerPart",label:o.formatMessage({id:"Klage.Formkrav.ErKlagerPart"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]}),e.jsx(F,{name:"erKonkret",label:o.formatMessage({id:"Klage.Formkrav.ErKonkret"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]})]}),e.jsxs(N,{gap:"4",children:[e.jsx(F,{name:"erFristOverholdt",label:o.formatMessage({id:"Klage.Formkrav.ErFristOverholdt"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]}),e.jsx(F,{name:"erSignert",label:o.formatMessage({id:"Klage.Formkrav.ErSignert"}),validate:[B],isReadOnly:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"Klage.Formkrav.Ja"})},{value:"false",label:o.formatMessage({id:"Klage.Formkrav.Nei"})}]})]})]})]})}),e.jsx(Te,{readOnly:r}),re(R)&&e.jsx(he,{name:"fritekstTilBrev",label:o.formatMessage({id:"FormkravKlageFormNfp.Fritekst"}),maxLength:1e5,validate:[B,je],readOnly:r,parse:ve}),e.jsxs(N,{justify:"space-between",children:[e.jsx(ne,{isReadOnly:r,isSubmittable:!s,isSubmitting:A.formState.isSubmitting,isDirty:A.formState.isDirty}),e.jsx(te,{behandlingUuid:n,saveKlage:i,avsluttedeBehandlinger:l,handleSubmit:A.handleSubmit,readOnly:r,aksjonspunktCode:q.VURDERING_AV_FORMKRAV_KLAGE_NFP})]})]})]})};Fe.__docgenInfo={description:`FormkravklageformNfp
...
AksjonspunktTilBekreftelse<AksjonspunktCode.VURDERING_AV_FORMKRAV_KLAGE_NFP>`,elements:[{name:"signature",type:"object",raw:`{
  ...
  vedtak?: string;
  fritekstTilBrev?: string;
}`,signature:{properties:[{key:"erKlagerPart",value:{name:"boolean",required:!1}},{key:"erFristOverholdt",value:{name:"boolean",required:!1}},{key:"erKonkret",value:{name:"boolean",required:!1}},{key:"erSignert",value:{name:"boolean",required:!1}},{key:"begrunnelse",value:{name:"string",required:!1}},{key:"vedtak",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Ee=({klageVurdering:n,alleKodeverk:r,avsluttedeBehandlinger:t})=>{var y;const s=K(),{klageFormkravResultatKA:a,underBehandlingKabal:l,behandletAvKabal:g}=n;let i=s.formatMessage({id:"Klage.Formkrav.IkkePåklagdVedtak"});if(a!=null&&a.paKlagdBehandlingUuid){const p=t.find(o=>o.uuid===a.paKlagdBehandlingUuid);p&&(i=`${(y=r[Je.BEHANDLING_TYPE].find(m=>m.kode===p.type))==null?void 0:y.navn} ${Y(p.avsluttet).format(ye)}`)}return e.jsxs(e.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.Title"})}),e.jsx(d,{sixteenPx:!0}),l&&e.jsxs(e.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.SeKabalText"})}),e.jsx(d,{sixteenPx:!0})]}),!l&&!g&&e.jsxs(e.Fragment,{children:[e.jsx(h,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.VelgVedtak"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{size:"small",children:i}),e.jsx(d,{sixteenPx:!0}),e.jsx(h,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.ErKlagerPart"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{size:"small",children:a!=null&&a.erKlagerPart?e.jsx(u,{id:"Klage.Formkrav.Ja"}):e.jsx(u,{id:"Klage.Formkrav.Nei"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(h,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.ErKonkret"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{size:"small",children:a!=null&&a.erKlageKonkret?e.jsx(u,{id:"Klage.Formkrav.Ja"}):e.jsx(u,{id:"Klage.Formkrav.Nei"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(h,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.ErFristOverholdt"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{size:"small",children:a!=null&&a.erKlagefirstOverholdt?e.jsx(u,{id:"Klage.Formkrav.Ja"}):e.jsx(u,{id:"Klage.Formkrav.Nei"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(h,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.ErSignert"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{size:"small",children:a!=null&&a.erSignert?e.jsx(u,{id:"Klage.Formkrav.Ja"}):e.jsx(u,{id:"Klage.Formkrav.Nei"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(h,{size:"small",children:e.jsx(u,{id:"Klage.Formkrav.Vurdering"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{size:"small",children:a==null?void 0:a.begrunnelse})]})]})};Ee.__docgenInfo={description:`FormkravKlageKa
...
Readonly panel for formkrav klage (KA).`,methods:[],displayName:"FormkravKlageKa",props:{klageVurdering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  avsluttet?: string;
  uuid: string;
}`,signature:{properties:[{key:"type",value:{name:"string",required:!0}},{key:"avsluttet",value:{name:"string",required:!1}},{key:"uuid",value:{name:"string",required:!0}}]}}],raw:"AvsluttetBehandling[]"},description:""}}};const pn=Q(sn),se=({behandling:n,klageVurdering:r={},avsluttedeBehandlinger:t,aksjonspunkter:s,submitCallback:a,isReadOnly:l,readOnlySubmitButton:g,alleKodeverk:i,formData:y,setFormData:p,lagreFormkravVurdering:o})=>e.jsxs(X,{value:pn,children:[s.some(m=>m.definisjon===q.VURDERING_AV_FORMKRAV_KLAGE_NFP)&&e.jsx(Fe,{behandlingUuid:n.uuid,klageVurdering:r,submitCallback:a,readOnly:l,readOnlySubmitButton:g,alleKodeverk:i,avsluttedeBehandlinger:t,lagreFormkravVurdering:o,formData:y,setFormData:p}),r.klageFormkravResultatKA&&e.jsx(Ee,{klageVurdering:r,alleKodeverk:i,avsluttedeBehandlinger:t})]});se.__docgenInfo={description:"",methods:[],displayName:"FormkravProsessIndex",props:{klageVurdering:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  klageVurderingResultatNK?: KlageVurderingResultat;
  klageVurderingResultatNFP?: KlageVurderingResultat;
  klageFormkravResultatKA?: {
    avvistArsaker: string[];
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const bn=[q.VURDERING_AV_FORMKRAV_KLAGE_NFP],qn=[c.KLAGE_VURDERING],Se=({alleBehandlinger:n,hentOgSettBehandling:r,...t})=>{const s=K(),a=b.useMemo(()=>n.filter(i=>i.status===be.AVSLUTTET).filter(i=>(i.type!==C.KLAGE||Ae(i.resultatType))&&i.type!==C.ANKE),[n]),{startRequest:l}=M.useRestApiRunner(c.SAVE_FORMKRAV_VURDERING),g=i=>l(i).then(()=>r(!0));return e.jsx($,{...t,panelEndepunkter:qn,aksjonspunktKoder:bn,prosessPanelKode:x.FORMKRAV_KLAGE_NAV_FAMILIE_OG_PENSJON,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.FormkravKlageNFP"}),skalPanelVisesIMeny:()=>!0,renderPanel:i=>e.jsx(se,{avsluttedeBehandlinger:a,lagreFormkravVurdering:g,...i})})};Se.__docgenInfo={description:"",methods:[],displayName:"FormKravFamOgPensjonProsessStegInitPanel",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  uuid: string;
  type: string;
  status: string;
  opprettet: string;
...
Setter opp readonly-panel for behandling av klage (KA).`,methods:[],displayName:"BehandleKlageFormKa",props:{alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  underBehandlingKabal?: boolean;
  behandletAvKabal?: boolean;
}>`},description:""}}};const hn="_previewLink_1xd5p_1",jn="_select_1xd5p_7",An="_selectReadOnly_1xd5p_10",Tn="_confirmVilkarForm_1xd5p_14",Kn="_panel_1xd5p_17",Bn="_fritekstTilBrevTextArea_1xd5p_20",wn="_explanationTextarea_1xd5p_23",L={previewLink:hn,select:jn,selectReadOnly:An,confirmVilkarForm:Tn,panel:Kn,fritekstTilBrevTextArea:Bn,explanationTextarea:wn},Ne=({readOnly:n,medholdReasons:r,alleHjemmlerMedNavn:t,klageVurdering:s})=>{const a=K(),l=r.map(i=>e.jsx("option",{value:i.kode,children:i.navn},i.kode)),g=t.map(i=>e.jsx("option",{value:i.kode,children:i.navn},i.kode));return e.jsxs(e.Fragment,{children:[e.jsx(F,{name:"klageVurdering",validate:[B],isReadOnly:n,isHorizontal:!0,radios:[{value:v.MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.ResolveKlage.ChangeVedtak"})},{value:v.STADFESTE_YTELSESVEDTAK,label:a.formatMessage({id:"Klage.ResolveKlage.KeepVedtakNfp"})}]}),s===v.MEDHOLD_I_KLAGE&&e.jsxs(e.Fragment,{children:[e.jsx(d,{sixteenPx:!0}),e.jsxs(Xe,{children:[e.jsx(Z,{readOnly:n,name:"klageMedholdArsak",selectValues:l,className:n?L.selectReadOnly:L.select,label:a.formatMessage({id:"Klage.ResolveKlage.Cause"}),validate:[B]}),e.jsx(d,{sixteenPx:!0}),e.jsx(F,{name:"klageVurderingOmgjoer",validate:[B],isReadOnly:n,radios:[{value:E.GUNST_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.Omgjort"})},{value:E.UGUNST_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.Ugunst"})},{value:E.DELVIS_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.DelvisOmgjort"})}]})]})]}),e.jsx(d,{sixteenPx:!0}),e.jsx(Z,{readOnly:n,name:"klageHjemmel",selectValues:g,className:n?L.selectReadOnly:L.select,label:a.formatMessage({id:"Klage.ResolveKlage.Hjemmel"}),validate:[B]}),e.jsx(d,{sixteenPx:!0})]})};Ne.__docgenInfo={description:"",methods:[],displayName:"KlageVurderingRadioOptionsNfp",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},medholdReasons:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},klageVurdering:{required:!1,tsType:{name:"string"},description:""}}};const cn="_fritekstTilBrevTextArea_n72am_1",Rn={fritekstTilBrevTextArea:cn},ie=({sprakkode:n,readOnly:r})=>e.jsx("div",{className:Rn.fritekstTilBrevTextArea,children:e.jsx(he,{name:"fritekstTilBrev",label:K().formatMessage({id:"FritekstKlageBrevTextField.Fritekst"}),validate:[B,je],readOnly:r,maxLength:1e5,badges:[{type:"info",titleText:$e(n)}],parse:ve})});ie.defaultProps={readOnly:!0};ie.__docgenInfo={description:"",methods:[],displayName:"FritekstKlageBrevTextField",props:{sprakkode:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const Vn="_previewLink_hcaux_1",Pn={previewLink:Vn},Fn=(n,r)=>{switch(r){case v.STADFESTE_YTELSESVEDTAK:return n?O.KLAGE_STADFESTET:O.KLAGE_OVERSENDT;case v.OPPHEVE_YTELSESVEDTAK:return O.KLAGE_HJEMSENDT;case v.HJEMSENDE_UTEN_Å_OPPHEVE:return O.KLAGE_HJEMSENDT;case v.MEDHOLD_I_KLAGE:return O.KLAGE_OMGJORING;default:return}},En=(n,r)=>({fritekst:r||"",dokumentMal:Fn(!1,n),erOpphevetKlage:n===v.OPPHEVE_YTELSESVEDTAK}),He=({previewCallback:n,fritekstTilBrev:r,klageVurdering:t})=>{const s=a=>{n(En(t,r)),a.preventDefault()};return e.jsx(e.Fragment,{children:e.jsx("a",{href:"",onClick:a=>{s(a)},onKeyDown:a=>a.key==="Enter"?s(a):null,className:Re(Pn.previewLink,"lenke lenke--frittstaende"),children:e.jsx(u,{id:"PreviewKlageLink.ForhandvisBrev"})})})};He.__docgenInfo={description:"",methods:[],displayName:"PreviewKlageLink",props:{previewCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BrevData) => Promise<any>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  fritekst: string;
  dokumentMal?: string;
  erOpphevetKlage: boolean;
}`,signature:{properties:[{key:"fritekst",value:{name:"string",required:!0}},{key:"dokumentMal",value:{name:"string",required:!1}},{key:"erOpphevetKlage",value:{name:"boolean",required:!0}}]}},name:"data"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},fritekstTilBrev:{required:!1,tsType:{name:"string"},description:""},klageVurdering:{required:!1,tsType:{name:"string"},description:""}}};const Sn=(n,r)=>({kode:r,klageMedholdArsak:n.klageVurdering===v.MEDHOLD_I_KLAGE||n.klageVurdering===v.OPPHEVE_YTELSESVEDTAK?n.klageMedholdArsak:void 0,klageVurderingOmgjoer:n.klageVurdering===v.MEDHOLD_I_KLAGE?n.klageVurderingOmgjoer:void 0,klageHjemmel:n.klageHjemmel,fritekstTilBrev:n.fritekstTilBrev,begrunnelse:n.begrunnelse,klageVurdering:n.klageVurdering}),le=({saveKlage:n,spinner:r,aksjonspunktCode:t,readOnly:s,handleSubmit:a})=>s?null:e.jsx(I,{size:"small",variant:"primary",loading:r,onClick:a(l=>n(Sn(l,t))),type:"button",children:e.jsx(u,{id:"Klage.ResolveKlage.TempSaveButton"})});le.defaultProps={spinner:!1,readOnly:!1};le.__docgenInfo={description:"",methods:[],displayName:"TempsaveKlageButton",props:{aksjonspunktCode:{required:!0,tsType:{name:"string"},description:""},saveKlage:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: TransformedValues) => Promise<any>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  kode: string;
  klageMedholdArsak?: string;
  klageVurderingOmgjoer?: string;
  klageHjemmel?: string;
  ...
  klageMedholdArsak?: string;
  klageHjemmel?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}},{key:"klageVurdering",value:{name:"string",required:!1}},{key:"klageVurderingOmgjoer",value:{name:"string",required:!1}},{key:"klageMedholdArsak",value:{name:"string",required:!1}},{key:"klageHjemmel",value:{name:"string",required:!1}}]}}],raw:"UseFormHandleSubmit<KlageFormType>"},description:""}}};const On="_confirmVilkarForm_13k5i_1",Nn={confirmVilkarForm:On},Me=({erModalÅpen:n,lukkModal:r,isSubmittable:t,isSubmitting:s,isDirty:a,readOnly:l,valgtHjemmel:g})=>{const i=K();return e.jsx(oe,{width:"500px",open:n,"aria-label":i.formatMessage({id:"Klage.Modal.Overskrift"}),onClose:r,children:e.jsx(oe.Body,{children:e.jsxs(G,{gap:"3",children:[e.jsxs("div",{children:[e.jsx(h,{size:"medium",children:e.jsx(u,{id:"Klage.Modal.Overskrift"})}),e.jsx(d,{fourPx:!0}),e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.SendTilKlageinstans"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.Valg"})}),e.jsx(d,{eightPx:!0}),e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.Oppretthold"})}),e.jsx(d,{fourPx:!0}),g&&e.jsx(f,{children:e.jsx(u,{id:"Klage.Modal.Hjemmel",values:{hjemmel:g}})}),e.jsx(d,{fourPx:!0})]}),e.jsx("div",{children:e.jsxs(N,{gap:"2",children:[e.jsx(ne,{isReadOnly:l,isSubmittable:t,isSubmitting:s,isDirty:a}),e.jsx(I,{size:"small",variant:"primary",onClick:r,autoFocus:!0,type:"button",children:e.jsx(u,{id:"Klage.Modal.Avbryt"})})]})})]})})})};Me.__docgenInfo={description:"",methods:[],displayName:"BekreftOgSubmitKlageModal",props:{erModalÅpen:{required:!0,tsType:{name:"boolean"},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},isSubmittable:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!0,tsType:{name:"boolean"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},valgtHjemmel:{required:!1,tsType:{name:"string"},description:""}}};const Hn=n=>({klageMedholdArsak:n.klageVurdering===v.MEDHOLD_I_KLAGE?n.klageMedholdArsak:void 0,klageVurderingOmgjoer:n.klageVurdering===v.MEDHOLD_I_KLAGE?n.klageVurderingOmgjoer:void 0,klageHjemmel:n.klageHjemmel,klageVurdering:n.klageVurdering,fritekstTilBrev:n.fritekstTilBrev,begrunnelse:n.begrunnelse,kode:q.BEHANDLE_KLAGE_NFP}),_=n=>{if(n&&n!=="-")return n},Mn=(n,r)=>n.filter(({kode:t})=>r.includes(t)).sort((t,s)=>t.kode.localeCompare(s.kode)),In=n=>n.map(r=>r),xn=n=>({klageMedholdArsak:_(n==null?void 0:n.klageMedholdArsak),klageVurderingOmgjoer:_(n==null?void 0:n.klageVurderingOmgjoer),klageHjemmel:_(n==null?void 0:n.klageHjemmel),klageVurdering:_(n==null?void 0:n.klageVurdering),begrunnelse:n?n.begrunnelse:void 0,fritekstTilBrev:n?n.fritekstTilBrev:void 0}),Ie=({readOnly:n,klageVurdering:r,previewCallback:t,saveKlage:s,readOnlySubmitButton:a,sprakkode:l,alleAktuelleHjemler:g,alleKodeverk:i,submitCallback:y,formData:p,setFormData:o})=>{var ge;const m=Mn(i[P.KLAGE_HJEMMEL],In(g)),k=K(),[w,A]=b.useState(!1),R=b.useMemo(()=>xn(r.klageVurderingResultatNFP),[r]),T=qe({defaultValues:p||R}),j=T.watch(),J=b.useCallback(()=>{A(!1)},[]),V=b.useCallback(()=>{A(!0)},[]);return e.jsxs(fe,{formMethods:T,onSubmit:W=>y(Hn(W)),setDataOnUnmount:o,children:[e.jsx(S,{size:"small",children:k.formatMessage({id:"Klage.ResolveKlage.Title"})}),e.jsx(d,{fourPx:!0}),e.jsx(Ke,{isAksjonspunktOpen:!a,children:[e.jsx(u,{id:"Klage.ResolveKlage.HelpText"},q.BEHANDLE_KLAGE_NFP)]}),e.jsx(Ne,{readOnly:n,klageVurdering:j.klageVurdering,medholdReasons:i[P.KLAGE_MEDHOLD_ARSAK],alleHjemmlerMedNavn:m}),e.jsxs("div",{className:Nn.confirmVilkarForm,children:[e.jsx(Te,{readOnly:n,text:k.formatMessage({id:"BehandleKlageFormNfp.BegrunnelseForKlage"})}),e.jsx(d,{sixteenPx:!0}),e.jsx(ie,{sprakkode:l,readOnly:n}),e.jsx(d,{sixteenPx:!0}),e.jsx(Be,{children:e.jsxs(we,{spaceBetween:!0,children:[e.jsxs(z,{children:[j.klageVurdering===v.STADFESTE_YTELSESVEDTAK&&e.jsxs(e.Fragment,{children:[e.jsx(I,{variant:"primary",type:"button",size:"small",onClick:()=>V(),disabled:n,children:e.jsx(u,{id:"Klage.Behandle.Bekreft"})}),e.jsx(Me,{erModalÅpen:w,lukkModal:J,valgtHjemmel:(ge=m.find(W=>W.kode===j.klageHjemmel))==null?void 0:ge.navn,readOnly:n,isSubmittable:!a,isSubmitting:T.formState.isSubmitting,isDirty:T.formState.isValid})]}),j.klageVurdering!==v.STADFESTE_YTELSESVEDTAK&&e.jsx(ne,{isReadOnly:n,isSubmittable:!a,isSubmitting:T.formState.isSubmitting,isDirty:T.formState.isDirty}),!n&&j.klageVurdering&&j.fritekstTilBrev&&j.fritekstTilBrev.length>2&&e.jsx(He,{previewCallback:t,fritekstTilBrev:j.fritekstTilBrev,klageVurdering:j.klageVurdering})]}),e.jsx(z,{children:e.jsx(le,{saveKlage:s,handleSubmit:T.handleSubmit,readOnly:n,aksjonspunktCode:q.BEHANDLE_KLAGE_NFP})})]})})]})]})};Ie.__docgenInfo={description:`BehandleklageformNfp
...
Presentasjonskomponent. Setter opp aksjonspunktet for behandling av klage (NFP).`,methods:[],displayName:"BehandleKlageFormNfp",props:{previewCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BrevData) => Promise<any>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  klageMedholdArsak?: string;
  klageHjemmel?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}},{key:"klageVurdering",value:{name:"string",required:!1}},{key:"klageVurderingOmgjoer",value:{name:"string",required:!1}},{key:"klageMedholdArsak",value:{name:"string",required:!1}},{key:"klageHjemmel",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Dn=Q(fn),xe=({behandling:n,klageVurdering:r,alleKodeverk:t,saveKlage:s,submitCallback:a,isReadOnly:l,previewCallback:g,readOnlySubmitButton:i,aksjonspunkter:y,formData:p,setFormData:o})=>e.jsxs(X,{value:Dn,children:[r.klageVurderingResultatNK&&e.jsx(Oe,{klageVurdering:r,alleKodeverk:t}),y.some(m=>m.definisjon===q.BEHANDLE_KLAGE_NFP)&&e.jsx(Ie,{sprakkode:n.sprakkode,klageVurdering:r,saveKlage:s,submitCallback:a,readOnly:l,previewCallback:g,readOnlySubmitButton:i,alleKodeverk:t,alleAktuelleHjemler:r.aktuelleHjemler?r.aktuelleHjemler:[],formData:p,setFormData:o})]});xe.__docgenInfo={description:"",methods:[],displayName:"KlagevurderingProsessIndex",props:{klageVurdering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  klageVurderingResultatNK?: KlageVurderingResultat;
  klageVurderingResultatNFP?: KlageVurderingResultat;
  klageFormkravResultatKA?: {
    avvistArsaker: string[];
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const Un=(n,r,t)=>s=>{const a={...s,behandlingUuid:t.uuid,fagsakYtelseType:r.fagsakYtelseType};return n(a).then(l=>pe(l))},Ln=(n,r,t)=>s=>{const a={behandlingUuid:r.uuid,...s};return n(a).then(()=>t(!0))},_n=(n,r,t)=>s=>{const a=s.some(l=>l.kode===q.BEHANDLE_KLAGE_NFP&&l.klageVurdering===v.STADFESTE_YTELSESVEDTAK);return a&&r(!1),()=>{a?n(!0):t&&t("default","default")}},Gn=[c.KLAGE_VURDERING],ue=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,aksjonspunktKoder:a,prosessPanelKode:l,prosessPanelMenyTekst:g,hentOgSettBehandling:i,...y})=>{const[p,o]=b.useState(!1),m=ce(),k=r?_n(o,r,s):void 0,{startRequest:w}=M.useRestApiRunner(c.PREVIEW_MESSAGE),A=b.useCallback(Un(w,n,m.behandling),[m.behandling.versjon]),{startRequest:R}=M.useRestApiRunner(c.SAVE_KLAGE_VURDERING),T=b.useCallback(Ln(R,m.behandling,i),[m.behandling.versjon]);return e.jsx($,{...y,panelEndepunkter:Gn,aksjonspunktKoder:a,prosessPanelKode:l,prosessPanelMenyTekst:g,skalPanelVisesIMeny:()=>!0,lagringSideEffekter:k,renderPanel:j=>e.jsxs(e.Fragment,{children:[e.jsx(en,{visModal:p,lukkModal:()=>{o(!1),t&&t()}}),e.jsx(xe,{previewCallback:A,saveKlage:T,...j})]})})};ue.__docgenInfo={description:"",methods:[],displayName:"VurderingFellesProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Yn=[q.BEHANDLE_KLAGE_NFP],De=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,hentOgSettBehandling:a,...l})=>e.jsx(ue,{...l,fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,aksjonspunktKoder:Yn,prosessPanelKode:x.KLAGE_NAV_FAMILIE_OG_PENSJON,prosessPanelMenyTekst:K().formatMessage({id:"Behandlingspunkt.CheckKlageNFP"}),hentOgSettBehandling:a});De.__docgenInfo={description:"",methods:[],displayName:"VurderingFamOgPensjonProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Cn=[q.VURDER_FORMKRAV_NK],zn=[c.KLAGE_VURDERING],Ue=({alleBehandlinger:n,hentOgSettBehandling:r,...t})=>{const s=K(),a=b.useMemo(()=>n.filter(i=>i.status===be.AVSLUTTET).filter(i=>(i.type!==C.KLAGE||Ae(i.resultatType))&&i.type!==C.ANKE),[n]),{startRequest:l}=M.useRestApiRunner(c.SAVE_FORMKRAV_VURDERING),g=i=>l(i).then(()=>r(!0));return e.jsx($,{...t,panelEndepunkter:zn,aksjonspunktKoder:Cn,prosessPanelKode:x.FORMKRAV_KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.FormkravKlageKA"}),skalPanelVisesIMeny:()=>!0,renderPanel:i=>e.jsx(se,{avsluttedeBehandlinger:a,lagreFormkravVurdering:g,...i})})};Ue.__docgenInfo={description:"",methods:[],displayName:"FormKravKlageInstansProsessStegInitPanel",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  uuid: string;
  type: string;
  status: string;
  opprettet: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const $n=[q.BEHANDLE_KLAGE_NK],Le=({fagsak:n,hentOgSettBehandling:r,...t})=>e.jsx(ue,{...t,aksjonspunktKoder:$n,fagsak:n,prosessPanelKode:x.KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:K().formatMessage({id:"Behandlingspunkt.CheckKlageNK"}),hentOgSettBehandling:r});Le.__docgenInfo={description:"",methods:[],displayName:"VurderingKlageInstansProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Jn="_mainButton_lcisw_1",Wn={mainButton:Jn},_e=({behandlingPaaVent:n,previewVedtakCallback:r,readOnly:t,lagreVedtak:s,isSubmitting:a})=>{const l=b.useCallback(g=>{g.preventDefault(),r()},[]);return e.jsx(Be,{children:e.jsxs(we,{children:[!t&&e.jsx(z,{children:e.jsx(I,{variant:"primary",size:"small",className:Wn.mainButton,onClick:s,disabled:n||a,loading:a,type:"button",children:e.jsx(u,{id:"VedtakKlageForm.TilGodkjenning"})})}),e.jsx(z,{children:e.jsx("a",{href:"",onClick:l,onKeyDown:g=>g.key==="Enter"?l(g):null,className:Re("lenke lenke--frittstaende"),children:e.jsx(u,{id:"VedtakKlageForm.ForhandvisBrev"})})})]})})};_e.__docgenInfo={description:"",methods:[],displayName:"VedtakKlageSubmitPanel",props:{previewVedtakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<any>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},behandlingPaaVent:{required:!0,tsType:{name:"boolean"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},lagreVedtak:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""}}};const Zn={GUNST_MEDHOLD_I_KLAGE:"VedtakKlageForm.KlageOmgjortGunst",UGUNST_MEDHOLD_I_KLAGE:"VedtakKlageForm.KlageOmgjortUgunst",DELVIS_MEDHOLD_I_KLAGE:"VedtakKlageForm.KlageOmgjortDelvis"},Qn=n=>()=>n({gjelderVedtak:!0}),Xn=n=>{if(n){if(n.klageFormkravResultatKA&&n.klageVurderingResultatNK)return n.klageFormkravResultatKA.avvistArsaker;if(n.klageFormkravResultatNFP)return n.klageFormkravResultatNFP.avvistArsaker}return[]},er=(n,r)=>{var s,a;const t=ee(r);if(n){if((s=n.klageVurderingResultatNK)!=null&&s.klageMedholdArsak)return t(n.klageVurderingResultatNK.klageMedholdArsak,P.KLAGE_MEDHOLD_ARSAK);if((a=n.klageVurderingResultatNFP)!=null&&a.klageMedholdArsak)return t(n.klageVurderingResultatNFP.klageMedholdArsak,P.KLAGE_MEDHOLD_ARSAK)}return null},nr=n=>{const r=n.klageVurderingResultatNK?n.klageVurderingResultatNK:n.klageVurderingResultatNFP;switch(r==null?void 0:r.klageVurdering){case v.AVVIS_KLAGE:return"VedtakKlageForm.KlageAvvist";case v.STADFESTE_YTELSESVEDTAK:return"VedtakKlageForm.KlageStadfestet";case v.OPPHEVE_YTELSESVEDTAK:return"VedtakKlageForm.YtelsesvedtakOpphevet";case v.HJEMSENDE_UTEN_Å_OPPHEVE:return"VedtakKlageForm.HjemmsendUtenOpphev";case v.MEDHOLD_I_KLAGE:return Zn[(r==null?void 0:r.klageVurderingOmgjoer)||""];default:return"VedtakKlageForm.IkkeFastsatt"}},Ge=({submitCallback:n,klageVurdering:r,behandlingsresultat:t,readOnly:s,aksjonspunkter:a,previewVedtakCallback:l,behandlingPaaVent:g,alleKodeverk:i})=>{const y=b.useMemo(()=>Xn(r),[r]),p=b.useMemo(()=>er(r,i),[r]),o=b.useMemo(()=>nr(r),[r]),m=r.klageVurderingResultatNK?r.klageVurderingResultatNK:r.klageVurderingResultatNFP,k=Ze(t.type),[w,A]=b.useState(!1),R=b.useCallback(()=>{A(!0);const J=a.filter(V=>V.status===Qe.OPPRETTET).map(V=>V.definisjon).map(V=>({kode:nn(V,q.FORESLA_VEDTAK,q.FORESLA_VEDTAK_MANUELT)}));n(J).then(()=>A(!1))},[a]),T=ee(i);return e.jsxs(e.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(u,{id:"VedtakKlageForm.Header"})}),e.jsx(d,{twentyPx:!0}),e.jsx(h,{size:"small",children:e.jsx(u,{id:"VedtakKlageForm.Resultat"})}),o&&e.jsx(f,{size:"small",children:e.jsx(u,{id:o})}),e.jsx(d,{sixteenPx:!0}),t.type===ke.KLAGE_AVVIST&&e.jsxs(e.Fragment,{children:[e.jsx(h,{size:"small",children:e.jsx(u,{id:"VedtakKlageForm.ArsakTilAvvisning"})}),y.map(j=>e.jsx(f,{size:"small",children:T(j,P.KLAGE_AVVIST_AARSAK)},j)),e.jsx(d,{sixteenPx:!0})]}),k&&e.jsxs(e.Fragment,{children:[e.jsx(h,{size:"small",children:e.jsx(u,{id:"VedtakKlageForm.ArsakTilOmgjoring"})}),p,e.jsx(d,{sixteenPx:!0})]}),t.type===ke.KLAGE_YTELSESVEDTAK_OPPHEVET&&e.jsxs(e.Fragment,{children:[e.jsx(h,{size:"small",children:e.jsx(u,{id:"VedtakKlageForm.ArsakTilOppheving"})}),p,e.jsx(d,{sixteenPx:!0})]}),(m==null?void 0:m.klageVurdertAv)==="NFP"&&e.jsx(_e,{previewVedtakCallback:Qn(l),readOnly:s,behandlingPaaVent:g,lagreVedtak:R,isSubmitting:w})]})};Ge.__docgenInfo={description:"VedtakKlageForm",methods:[],displayName:"VedtakKlageForm",props:{behandlingsresultat:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
  type: string;
  avslagsarsak?: string;
  avslagsarsakFritekst?: string;
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const tr=(n,r,t)=>s=>{const a={...s,behandlingUuid:t.uuid,fagsakYtelseType:r.fagsakYtelseType};return n(a).then(l=>pe(l))},me=(n,r=[])=>{const t=r.some(a=>a.status===We.OPPRETTET);if(r.length===0||t)return H.IKKE_VURDERT;const s=n==null?void 0:n.type;return s===U.HENLAGT_KLAGE_TRUKKET||s===U.HENLAGT_FEILOPPRETTET?H.IKKE_VURDERT:s===U.KLAGE_AVVIST||s===U.KLAGE_YTELSESVEDTAK_OPPHEVET?H.IKKE_OPPFYLT:H.OPPFYLT},sr=(n,r)=>()=>(r(!1),()=>{n(!0)}),ir=[q.FORESLA_VEDTAK,q.FATTER_VEDTAK,q.FORESLA_VEDTAK_MANUELT],lr=[c.KLAGE_VURDERING],Ce=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,...s})=>{const a=K(),[l,g]=b.useState(!1),i=ce(),y=sr(g,r),{startRequest:p}=M.useRestApiRunner(c.PREVIEW_MESSAGE),o=b.useCallback(tr(p,n,i.behandling),[i.behandling.versjon]),{aksjonspunkt:m}=s.behandling;return e.jsx($,{...s,panelEndepunkter:lr,aksjonspunktKoder:ir,prosessPanelKode:x.KLAGE_RESULTAT,prosessPanelMenyTekst:a.formatMessage({id:"Behandlingspunkt.ResultatKlage"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:k=>me(k.behandling.behandlingsresultat,m),lagringSideEffekter:y,hentSkalMarkeresSomAktiv:k=>me(k.behandling.behandlingsresultat,m)!==H.IKKE_VURDERT,renderPanel:k=>e.jsxs(e.Fragment,{children:[e.jsx(rn,{visModal:l,lukkModal:()=>{g(!1),t()},tekst:a.formatMessage({id:"FatterVedtakStatusModal.KlagenErFerdigbehandlet"})}),e.jsx(Ye,{previewVedtakCallback:o,...k})]})})};Ce.__docgenInfo={description:"",methods:[],displayName:"KlageresultatProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const ur=({behandling:n,fagsak:r,valgtProsessSteg:t,valgtFaktaSteg:s,oppdaterProsessStegOgFaktaPanelIUrl:a,opneSokeside:l,setSkalOppdatereEtterBekreftelseAvAp:g,alleBehandlinger:i,hentOgSettBehandling:y})=>{const p=b.useCallback(k=>e.jsx(an,{...k}),[]),o=b.useMemo(()=>i.filter(k=>!k.behandlingHenlagt).map(k=>{var w;return{uuid:k.uuid,type:k.type,status:k.status,opprettet:k.opprettet,avsluttet:k.avsluttet,resultatType:(w=k.behandlingsresultat)==null?void 0:w.type}}),[i]),m=b.useCallback(k=>e.jsxs(e.Fragment,{children:[e.jsx(Se,{...k,alleBehandlinger:o,hentOgSettBehandling:y}),e.jsx(De,{...k,fagsak:r,opneSokeside:l,setSkalOppdatereEtterBekreftelseAvAp:g,oppdaterProsessStegOgFaktaPanelIUrl:a,hentOgSettBehandling:y}),e.jsx(Ue,{...k,alleBehandlinger:o,hentOgSettBehandling:y}),e.jsx(Le,{...k,fagsak:r,hentOgSettBehandling:y}),e.jsx(Ce,{...k,fagsak:r,opneSokeside:l,setSkalOppdatereEtterBekreftelseAvAp:g})]}),[o,r,l,g,a]);return e.jsx(tn,{behandling:n,valgtProsessSteg:t,valgtFaktaSteg:s,oppdaterProsessStegOgFaktaPanelIUrl:a,hentFaktaPaneler:p,hentProsessPaneler:m})};ur.__docgenInfo={description:"",methods:[],displayName:"KlagePaneler",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]}],raw:"BehandlingAppKontekst[]"},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"(keepData?: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"keepData"}],return:{name:"void"}}},description:""}}};export{ur as default};
