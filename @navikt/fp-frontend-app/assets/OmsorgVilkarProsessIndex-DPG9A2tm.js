...
Setter opp aksjonspunktet for avklaring av termindato (Fødselsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"soknad",optional:!1,type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""},alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""}}};const{TERMINBEKREFTELSE:Me,SJEKK_MANGLENDE_FODSEL:Ue}=d,ba=n=>{const r=[];return w(Me,n)&&r.push(e.jsx(g,{id:"FodselInfoPanel.KontrollerMotTerminbekreftelsen"},"KontrollerMotTerminbekreftelsen")),w(Ue,n)&&r.push(e.jsx(g,{id:"FodselInfoPanel.KontrollerMotFodselsdokumentasjon"},"KontrollerMotFodselsdokumentasjon")),r},fa=(n,r,a,t)=>({...a?se.buildInitialValues(n,r.gjeldende,a):{},...t?te.buildInitialValues(n,r.gjeldende,t):{}}),qa=(n,r,a,t)=>{const s=[];return a&&s.push(se.transformValues(n)),t&&s.push(te.transformValues(n,r)),s},Fa=[],Rn=({submittable:n,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,familiehendelse:s})=>{var P,M,T;const{submitCallback:o,behandling:i,aksjonspunkterForPanel:l,harÅpneAksjonspunkter:u,alleMerknaderFraBeslutter:m,isReadOnly:k}=z(),y=((P=s==null?void 0:s.register)==null?void 0:P.avklartBarn)||Fa,p=(M=s==null?void 0:s.gjeldende)==null?void 0:M.termindato,q=(T=s==null?void 0:s.gjeldende)==null?void 0:T.vedtaksDatoSomSvangerskapsuke,v=l.find(D=>D.definisjon===Me),f=l.find(D=>D.definisjon===Ue),{formData:F,setFormData:R}=W(),A=$({defaultValues:F||fa(r,s,v,f)});return e.jsxs(e.Fragment,{children:[u&&e.jsx(ce,{children:ba(l)}),e.jsx(b,{sixteenPx:!0}),e.jsxs(C,{formMethods:A,onSubmit:D=>o(qa(D,y,v,f)),setDataOnUnmount:R,children:[w(Me,l)&&e.jsx(se,{readOnly:k,submittable:n,alleMerknaderFraBeslutter:m,soknad:r,gjeldendeFamiliehendelse:s.gjeldende}),w(Ue,l)&&e.jsx(te,{behandlingType:i.type,readOnly:k,submittable:n,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,alleMerknaderFraBeslutter:m,soknad:r,avklartBarn:y,familiehendelse:s}),l.length!==0&&!k&&e.jsxs(e.Fragment,{children:[e.jsx(b,{twentyPx:!0}),e.jsx(Le,{isSubmittable:n,isReadOnly:k,isSubmitting:A.formState.isSubmitting,isDirty:A.formState.isDirty})]}),l.length===0&&e.jsx(he,{behandlingsTypeKode:i.type,avklartBarn:y,termindato:p,vedtaksDatoSomSvangerskapsuke:q,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t})]})]})};Rn.__docgenInfo={description:`FodselInfoPanel
...
Har ansvar for å sette opp formen for faktapenelet til Fødselsvilkåret.`,methods:[],displayName:"FodselInfoPanel",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const Ta=[d.TERMINBEKREFTELSE,d.SJEKK_MANGLENDE_FODSEL],Sa=n=>{const r=j(),{behandling:a}=h.use(ue),t=He(Ta),s=Ae(a),{data:o}=N(s.familiehendelseOptions(a)),{data:i}=N(s.søknadOptions(a)),{data:l}=N(s.familiehendelseOrigninalBehandlingOptions(a)),{data:u}=N(s.søknadOriginalBehandlingOptions(a));return e.jsx(Ye,{...n,standardPanelProps:t,faktaPanelKode:Ge.FODSELSVILKARET,faktaPanelMenyTekst:r.formatMessage({id:"FaktaInitPanel.Title.Fodsel"}),skalPanelVisesIMeny:a.vilkår.some(m=>ur.some(k=>k===m.vilkarType)),children:o&&i?e.jsx(An,{soknad:i,familiehendelse:o,familiehendelseOriginalBehandling:l,soknadOriginalBehandling:u,submittable:t.submittable}):e.jsx(je,{})})};Sa.__docgenInfo={description:"",methods:[],displayName:"FodselvilkaretFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},registrerFaktaPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FaktaPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
...
RettighetFormValues & {
  ...
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}>`},description:""}}};const Pa=(n,r)=>({...oe.transformValues(n,r),..._.transformValues(n)}),Oa=(n,r,a,t,s)=>{const o=t.find(i=>i.definisjon===d.OMSORGSOVERTAKELSE||i.definisjon===d.AVKLAR_VILKAR_FOR_FORELDREANSVAR);return{...oe.buildInitialValues(n,r,a,bn(s)),..._.initialValues(o)}},Va=n=>n?[e.jsx(g,{id:"OmsorgOgForeldreansvarInfoPanel.CheckInformationForeldreansvar"},"CheckInformation")]:[e.jsx(g,{id:"OmsorgOgForeldreansvarInfoPanel.CheckInformationOmsorgsovertakelse"},"CheckInformation")],wn=({submittable:n,innvilgetRelatertTilgrensendeYtelserForAnnenForelder:r,soknad:a,gjeldendeFamiliehendelse:t,personoversikt:s})=>{const o=j(),{aksjonspunkterForPanel:i,alleMerknaderFraBeslutter:l,harÅpneAksjonspunkter:u,submitCallback:m,isReadOnly:k,alleKodeverk:y}=z(),p=$({defaultValues:Oa(a,t,r,i,y)}),q=p.watch("begrunnelse"),v=w(d.AVKLAR_VILKAR_FOR_FORELDREANSVAR,i);return e.jsx(C,{formMethods:p,onSubmit:f=>m(Pa(f,i[0])),children:e.jsxs(le,{gap:"5",children:[!k&&u&&e.jsx(ce,{children:Va(v)}),e.jsx(oe,{erAksjonspunktForeldreansvar:v,readOnly:k,vilkarTypes:y[J.OMSORGSOVERTAKELSE_VILKAR_TYPE],alleMerknaderFraBeslutter:l,soknad:a,gjeldendeFamiliehendelse:t,personoversikt:s}),e.jsx(_,{isSubmittable:n,isReadOnly:k,hasBegrunnelse:!!q,label:o.formatMessage({id:v?"OmsorgOgForeldreansvarInfoPanel.BegrunnelseTitleFp":"OmsorgOgForeldreansvarInfoPanel.BegrunnelseTitleEs"})}),e.jsx(Le,{isSubmittable:n,isSubmitting:p.formState.isSubmitting,isDirty:p.formState.isDirty,isReadOnly:k})]})})};wn.__docgenInfo={description:`OmsorgOgForeldreansvarInfoPanel
...
Har ansvar for å sette opp form for faktapenelet til Omsorgsvilkåret.`,methods:[],displayName:"OmsorgOgForeldreansvarInfoPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  relatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
  innvilgetRelatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const dn=[d.OMSORGSOVERTAKELSE,d.AVKLAR_VILKAR_FOR_FORELDREANSVAR],xa=({personoversikt:n,...r})=>{const a=j(),t=He(dn),{behandling:s}=h.use(ue),o=Ae(s),{data:i}=N(o.søknadOptions(s)),{data:l}=N(o.familiehendelseOptions(s)),{data:u}=N(o.inntektArbeidYtelseOptions(s));return e.jsx(Ye,{...r,standardPanelProps:t,faktaPanelKode:Ge.OMSORGSVILKARET,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.OmsorgOgForeldreansvar"}),skalPanelVisesIMeny:dn.some(m=>w(m,s.aksjonspunkt)),children:i&&l&&u?e.jsx(hn,{soknad:i,familiehendelse:l,inntektArbeidYtelse:u,personoversikt:n,submittable:t.submittable}):e.jsx(je,{})})};xa.__docgenInfo={description:"",methods:[],displayName:"OmsorgOgForeldreansvarFaktaInitPanel",props:{personoversikt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  bruker: PersonopplysningerBasis;
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}`,signature:{properties:[{key:"bruker",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
Setter opp aksjonspunktet for avklaring av varsel om revurdering i søknad.`,methods:[],displayName:"VarselOmRevurderingForm",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  dokumentMal: string;
  fritekst: string;
}`,signature:{properties:[{key:"arsakskode",value:{name:"string",required:!0}},{key:"dokumentMal",value:{name:"string",required:!0}},{key:"fritekst",value:{name:"string",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const La={"VarselOmRevurderingForm.VarselOmRevurdering":"Varsel om revurdering","VarselOmRevurderingForm.VarselOmRevurderingVurder":"Vurder om varsel om revurdering skal sendes til søker","VarselOmRevurderingForm.Etterkontroll":"Etterkontroll","VarselOmRevurderingForm.Manuell":"Manuell","VarselOmRevurderingForm.Bekreft":"Bekreft og fortsett","VarselOmRevurderingForm.IkkeSendVarsel":"Ikke send varsel til søker","VarselOmRevurderingForm.SendVarsel":"Send varsel til søker","VarselOmRevurderingForm.FritekstIBrev":"Fritekst i brev","VarselOmRevurderingForm.BegrunnelseForSvar":"Begrunnelse","VarselOmRevurderingForm.BrevBlirBestilt":"Brevet blir bestilt","VarselOmRevurderingForm.Begrunnelse":"Begrunnelse","VarselOmRevurderingForm.UtstedDato":"Utstedt dato","VarselOmRevurderingForm.Ytelsesvedtak":"Vedtak","VarselOmRevurderingForm.OpplysningerISoknad":"Opplysninger om fødsel i søknaden","VarselOmRevurderingForm.Preview":"Forhåndsvis","Malform.Beskrivelse":"Foretrukket språk"},Ha=G(La),Pn=n=>e.jsx(Y,{value:Ha,children:e.jsx(Nn,{...n})});Pn.__docgenInfo={description:"",methods:[],displayName:"VarselOmRevurderingProsessIndex",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  oppgitt: FamilieHendelse;
  gjeldende: FamilieHendelse;
  register: FamilieHendelse;
}`,signature:{properties:[{key:"oppgitt",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  dokumentMal: string;
  fritekst: string;
}`,signature:{properties:[{key:"arsakskode",value:{name:"string",required:!0}},{key:"dokumentMal",value:{name:"string",required:!0}},{key:"fritekst",value:{name:"string",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Ya=(n,r)=>a=>{const t=a.length>0&&"sendVarsel"in a[0]&&a[0].sendVarsel;return n(!t),()=>{t&&r()}},Ga=[d.VARSEL_REVURDERING_MANUELL,d.VARSEL_REVURDERING_ETTERKONTROLL],za=n=>{const r=j(),{setSkalOppdatereEtterBekreftelseAvAp:a,fagsak:t,behandling:s}=h.use(ue),o=Ln(),i=Ya(a,()=>{o("/")}),l=fn(Ga,[],i),u=Ae(s),{data:m}=N(u.familiehendelseOptions(s)),{data:k}=N(u.søknadOptions(s)),{data:y}=N(u.familiehendelseOrigninalBehandlingOptions(s)),{data:p}=N(u.søknadOriginalBehandlingOptions(s)),{mutate:q}=or({mutationFn:v=>pr({...v,behandlingUuid:s.uuid,fagsakYtelseType:t.fagsakYtelseType}),onSuccess:Wn});return e.jsx(Fr,{...n,standardPanelProps:l,prosessPanelKode:kr.VARSEL,prosessPanelMenyTekst:r.formatMessage({id:"Behandlingspunkt.CheckVarselRevurdering"}),skalPanelVisesIMeny:gr(l.aksjonspunkter),children:m&&k&&y&&p?e.jsx(Pn,{familiehendelse:m,soknad:k,familiehendelseOriginalBehandling:y,soknadOriginalBehandling:p,previewCallback:q}):e.jsx(je,{})})};za.__docgenInfo={description:"",methods:[],displayName:"VarselProsessStegInitPanel",props:{valgtProsessSteg:{required:!1,tsType:{name:"string"},description:""},registrerProsessPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ProsessPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const $a=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),Ca=(n,r)=>r.map(a=>({...E.transformValues(n),...V.transformValues(n),kode:ge(a.definisjon,d.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD,d.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD,d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)})),On=({readOnlySubmitButton:n,isEngangsstonad:r,isForeldreansvar2Ledd:a,status:t})=>{const s=j(),{behandling:o,alleKodeverk:i,aksjonspunkterForPanel:l,submitCallback:u,harÅpneAksjonspunkter:m,isReadOnly:k,alleMerknaderFraBeslutter:y}=z(),p=l.some(T=>{var D;return(D=y[T.definisjon])==null?void 0:D.notAccepted}),q=$a(l,t,o.behandlingsresultat),{formData:v,setFormData:f}=W(),F=$({defaultValues:v||q}),R=a?I.FORELDREANSVARSVILKARET_2_LEDD:I.FORELDREANSVARSVILKARET_4_LEDD,A=i[J.AVSLAGSARSAK][R],P=m?void 0:Be.OPPFYLT===t,M=h.useCallback((...T)=>e.jsx("b",{children:T}),[]);return e.jsx(C,{formMethods:F,onSubmit:T=>u(Ca(T,l)),setDataOnUnmount:f,children:e.jsxs(De,{title:s.formatMessage({id:"ErForeldreansvarVilkaarOppfyltForm.Foreldreansvar"}),isAksjonspunktOpen:!n,readOnlySubmitButton:n,readOnly:k,originalErVilkarOk:P,erIkkeGodkjentAvBeslutter:p,isDirty:F.formState.isDirty,isSubmitting:F.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"ErForeldreansvarVilkaarOppfyltForm.RettTilStonad"})}),e.jsx(E,{avslagsarsaker:A,readOnly:k,customVilkarOppfyltText:e.jsx(g,{id:r?"FodselVilkarForm.OppfyltEs":"FodselVilkarForm.OppfyltFp"}),customVilkarIkkeOppfyltText:e.jsx(g,{id:r?"FodselVilkarForm.IkkeOppfyltEs":"FodselVilkarForm.IkkeOppfyltFp",values:{b:M}})}),e.jsx(V,{readOnly:k})]})})};On.__docgenInfo={description:`ErForeldreansvarVilkaarOppfyltForm

Setter opp aksjonspunkter for avklaring av foreldreansvarvilkåret 2 eller 4 ledd.`,methods:[],displayName:"ErForeldreansvarVilkaarOppfyltForm",props:{isForeldreansvar2Ledd:{required:!0,tsType:{name:"boolean"},description:""},isEngangsstonad:{required:!0,tsType:{name:"boolean"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const Ja={"ErForeldreansvarVilkaarOppfyltForm.Foreldreansvar":"Foreldreansvaret","ErForeldreansvarVilkaarOppfyltForm.ErVilkaretOppfylt":"Er vilkåret oppfylt?","ErForeldreansvarVilkaarOppfyltForm.RettTilStonad":"Rett til stønad ved overtakelse av foreldreansvaret","FodselVilkarForm.OppfyltEs":"Far har rett til engangsstønad, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfyltEs":"Far har ikke rett til engangsstønad, vilkåret er <b>ikke</b> oppfylt","FodselVilkarForm.OppfyltFp":"Far har rett til foreldrepenger, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfyltFp":"Far har ikke rett til foreldrepenger, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},Wa=G(Ja),Vn=n=>e.jsx(Y,{value:Wa,children:e.jsx(On,{...n})});Vn.__docgenInfo={description:"",methods:[],displayName:"ForeldreansvarVilkarProsessIndex",props:{isForeldreansvar2Ledd:{required:!0,tsType:{name:"boolean"},description:""},isEngangsstonad:{required:!0,tsType:{name:"boolean"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const Qa=[d.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD,d.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD,d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN],Xa={[d.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD]:"ErForeldreansvarVilkaarOppfyltForm.2LeddParagrafEngangsStonad",[d.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_4_LEDD]:"ErForeldreansvarVilkaarOppfyltForm.4LeddParagraf",[d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN]:"SRBVilkarForm.VurderSammeBarn",[d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN]:"SRBVilkarForm.VurderAnnenForelderSammeBarn"},mn=[I.FORELDREANSVARSVILKARET_2_LEDD,I.FORELDREANSVARSVILKARET_4_LEDD],Za=n=>{const r=j(),{behandling:a}=h.use(ue),t=fn(Qa,mn);return e.jsx(mr,{...n,standardPanelProps:t,behandlingVersjon:a.versjon,vilkarKoder:mn,inngangsvilkarPanelKode:"FORELDREANSVARSVILKARET",hentInngangsvilkarPanelTekst:t.aksjonspunkter.length>0?r.formatMessage({id:Xa[t.aksjonspunkter[0].definisjon]}):"",renderPanel:({skalVises:s})=>e.jsx(e.Fragment,{children:s&&e.jsx(Vn,{isEngangsstonad:!0,isForeldreansvar2Ledd:t.vilkar.some(o=>o.vilkarType===I.FORELDREANSVARSVILKARET_2_LEDD),status:t.status,readOnlySubmitButton:t.readOnlySubmitButton})})})};Za.__docgenInfo={description:"",methods:[],displayName:"ForeldreansvarInngangsvilkarInitPanel",props:{registrerInngangsvilkarPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: InngangsvilkarPanelData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  aksjonspunktTekst?: string;
  harApentAksjonspunkt: boolean;
  status: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"aksjonspunktTekst",value:{name:"string",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!0}},{key:"status",value:{name:"string",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""},erPanelValgt:{required:!0,tsType:{name:"boolean"},description:""},harInngangsvilkarApentAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""}}};const et=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),nt=(n,r)=>({...E.transformValues(n),...V.transformValues(n),kode:ge(r[0].definisjon,d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)}),En=({vilkar:n,readOnlySubmitButton:r,status:a})=>{const t=j(),{behandling:s,alleKodeverk:o,aksjonspunkterForPanel:i,submitCallback:l,harÅpneAksjonspunkter:u,isReadOnly:m,alleMerknaderFraBeslutter:k}=z(),y=i.some(T=>{var D;return(D=k[T.definisjon])==null?void 0:D.notAccepted}),p=et(i,a,s.behandlingsresultat),{formData:q,setFormData:v}=W(),f=$({defaultValues:q||p}),F=o[J.AVSLAGSARSAK][I.ADOPSJONSVILKARET],A=i.some(T=>T.status===qe.OPPRETTET)?void 0:Be.OPPFYLT===a,{lovReferanse:P}=n[0],M=(...T)=>e.jsx("b",{children:T});return e.jsx(C,{formMethods:f,onSubmit:T=>l(nt(T,i)),setDataOnUnmount:v,children:e.jsxs(De,{title:t.formatMessage({id:"AdopsjonVilkarForm.Adopsjon"}),isAksjonspunktOpen:u,readOnlySubmitButton:r,readOnly:m,lovReferanse:P,originalErVilkarOk:A,erIkkeGodkjentAvBeslutter:y,isDirty:f.formState.isDirty,isSubmitting:f.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"AdopsjonVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(E,{avslagsarsaker:F,readOnly:m,customVilkarOppfyltText:e.jsx(g,{id:"AdopsjonVilkarForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(g,{id:"AdopsjonVilkarForm.IkkeOppfylt",values:{b:M}})}),e.jsx(V,{readOnly:m})]})})};En.__docgenInfo={description:`AdopsjonVilkarForm
...
Setter opp aksjonspunktet for avklaring av Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const rt={"AdopsjonVilkarForm.Adopsjon":"Adopsjon","AdopsjonVilkarForm.TidligereUtbetaltStonad":"Tidligere utbetalte foreldrepenger eller engangsstønad","AdopsjonVilkarForm.Oppfylt":"Er utbetalt for et annet barn, vilkåret er oppfylt","AdopsjonVilkarForm.IkkeOppfylt":"Er utbetalt for dette barnet, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},at=G(rt),tt=n=>e.jsx(Y,{value:at,children:e.jsx(En,{...n})});tt.__docgenInfo={description:"",methods:[],displayName:"AdopsjonVilkarProsessIndex",props:{status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkarType: string;
  vilkarStatus: string;
  avslagKode?: string;
  lovReferanse?: string;
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""}}};const st=["1002","1003","1032"],ot=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),it=(n,r)=>({...E.transformValues(n),...V.transformValues(n),kode:ge(r[0].definisjon,d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)}),lt=(n,r)=>n?r.filter(a=>!st.includes(a.kode)):r,In=({readOnlySubmitButton:n,status:r,ytelseTypeKode:a,vilkar:t})=>{const s=j(),{behandling:o,alleKodeverk:i,aksjonspunkterForPanel:l,submitCallback:u,harÅpneAksjonspunkter:m,isReadOnly:k,alleMerknaderFraBeslutter:y}=z(),p=l.some(K=>{var pe;return(pe=y[K.definisjon])==null?void 0:pe.notAccepted}),q=ot(l,r,o.behandlingsresultat),{formData:v,setFormData:f}=W(),F=$({defaultValues:v||q}),R=i[J.AVSLAGSARSAK][I.FODSELSVILKARET_MOR],A=lt(a===yn.FORELDREPENGER,R),M=l.some(K=>K.status===qe.OPPRETTET)?void 0:Be.OPPFYLT===r,{lovReferanse:T}=t[0],D=(...K)=>e.jsx("b",{children:K});return e.jsx(C,{formMethods:F,onSubmit:K=>u(it(K,l)),setDataOnUnmount:f,children:e.jsxs(De,{title:s.formatMessage({id:"FodselVilkarForm.Fodsel"}),isAksjonspunktOpen:m,readOnlySubmitButton:n,readOnly:k,lovReferanse:T,originalErVilkarOk:M,erIkkeGodkjentAvBeslutter:p,isDirty:F.formState.isDirty,isSubmitting:F.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"FodselVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(E,{avslagsarsaker:A,readOnly:k,customVilkarOppfyltText:e.jsx(g,{id:"FodselVilkarForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(g,{id:"FodselVilkarForm.IkkeOppfylt",values:{b:D}})}),e.jsx(V,{useAllWidth:!0,readOnly:k})]})})};In.__docgenInfo={description:`FodselVilkarForm
...
Setter opp aksjonspunktet for avklaring av Fødselsvilkåret.`,methods:[],displayName:"FodselVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const dt={"FodselVilkarForm.Fodsel":"Fødsel","FodselVilkarForm.TidligereUtbetaltStonad":"Tidligere utbetalte foreldrepenger eller engangsstønad","FodselVilkarForm.Oppfylt":"Er utbetalt for et annet barn, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfylt":"Er utbetalt for dette barnet, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},ut=G(dt),gt=n=>e.jsx(Y,{value:ut,children:e.jsx(In,{...n})});gt.__docgenInfo={description:"",methods:[],displayName:"FodselVilkarProsessIndex",props:{ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkarType: string;
  vilkarStatus: string;
  avslagKode?: string;
  lovReferanse?: string;
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""}}};const mt=(n,r,a)=>({...E.buildInitialValues(n,r,a),...V.buildInitialValues(n)}),kt=(n,r)=>r.map(a=>({...E.transformValues(n),...V.transformValues(n),kode:ge(a.definisjon,d.MANUELL_VURDERING_AV_OMSORGSVILKARET,d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)})),xn=({readOnlySubmitButton:n,status:r})=>{const a=j(),{behandling:t,alleKodeverk:s,aksjonspunkterForPanel:o,submitCallback:i,isReadOnly:l,alleMerknaderFraBeslutter:u,harÅpneAksjonspunkter:m}=z(),k=o.some(A=>{var P;return(P=u[A.definisjon])==null?void 0:P.notAccepted}),y=mt(o,r,t.behandlingsresultat),{formData:p,setFormData:q}=W(),v=$({defaultValues:p||y}),f=s[J.AVSLAGSARSAK][I.OMSORGSVILKARET],F=m?void 0:Be.OPPFYLT===r,R=h.useCallback(A=>e.jsx("b",{children:A}),[]);return e.jsx(C,{formMethods:v,onSubmit:A=>i(kt(A,o)),setDataOnUnmount:q,children:e.jsxs(De,{title:a.formatMessage({id:"ErOmsorgVilkaarOppfyltForm.Omsorg"}),isAksjonspunktOpen:!n,readOnlySubmitButton:n,readOnly:l,originalErVilkarOk:F,erIkkeGodkjentAvBeslutter:k,isDirty:v.formState.isDirty,isSubmitting:v.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"ErOmsorgVilkaarOppfyltForm.VilkaretOppfylt"})}),e.jsx(E,{avslagsarsaker:f,readOnly:l,customVilkarOppfyltText:e.jsx(g,{id:"ErOmsorgVilkaarOppfyltForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(g,{id:"ErOmsorgVilkaarOppfyltForm.IkkeOppfylt",values:{b:R}})}),e.jsx(V,{readOnly:l})]})})};xn.__docgenInfo={description:`ErOmsorgVilkaarOppfyltForm

Setter opp aksjonspunkter for avklaring av omsorgsvilkåret.`,methods:[],displayName:"ErOmsorgVilkaarOppfyltForm",props:{status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const pt={"ErOmsorgVilkaarOppfyltForm.Omsorg":"Omsorg","ErOmsorgVilkaarOppfyltForm.Anvendes":"Vilkår som anvendes","ErOmsorgVilkaarOppfyltForm.VilkaretOppfylt":"Far rett til engangsstønad","ErOmsorgVilkaarOppfyltForm.Oppfylt":"Far har rett til engangsstønad, vilkåret er oppfylt","ErOmsorgVilkaarOppfyltForm.IkkeOppfylt":"Far har ikke rett til engangsstønad, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},yt=G(pt),vt=n=>e.jsx(Y,{value:yt,children:e.jsx(xn,{...n})});vt.__docgenInfo={description:"",methods:[],displayName:"OmsorgVilkarProsessIndex",props:{status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};export{tt as A,gt as F,vt as O,za as V,Za as a,xa as b,Qr as c,Sa as d};
