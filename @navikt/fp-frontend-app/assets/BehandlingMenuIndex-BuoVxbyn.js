...
`)+A+`return __p
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'AdresseType'>[]"},description:""}}};const sp=pe(Da),op=o=>{switch(o){case Es.KVINNE:return Tt.female;case Es.MANN:return Tt.male;default:return Tt.unknown}},Ur=({rolle:o="BRUKER",alleKodeverk:k,harSammeAdresser:t,navn:E,kjønn:h,sivilstand:f,fødselsdato:b,dødsdato:N,adresser:R,showIcon:S=!0})=>{const P=o==="BARN";return m.jsx(Ie,{value:sp,children:m.jsx(Hr.New,{background:"neutral-moderate",padding:"4",borderRadius:"large","aria-label":E,children:m.jsxs(Pe,{gap:"space-4",children:[m.jsxs(Sn,{gap:"space-20",children:[S&&m.jsx("div",{children:m.jsx(qy,{gender:op(h),isChild:P})}),m.jsxs("div",{children:[m.jsxs(Sn,{gap:"space-16",children:[m.jsx($r,{children:m.jsx($,{id:"PersonPanel.RolleOgNavn",values:{rolle:o,navn:E}})}),P&&b&&!N&&m.jsx(Yr,{children:m.jsx($,{id:"PersonPanel.Fodt",values:{dato:ds(b)}})}),N&&m.jsx(Yr,{children:m.jsx($,{id:"PersonPanel.Dod",values:{dato:ds(N)}})})]}),!P&&f&&m.jsx(Nt,{"aria-label":"Sivilstand",children:k.SivilstandType.find(L=>L.kode===f)?.navn})]})]}),m.jsxs(Nt,{children:[o==="BARN"&&m.jsx($,{id:"PersonPanel.Beskrivelse.Barn",values:{rolle:o}}),o==="BRUKER"&&m.jsx($,{id:"PersonPanel.Beskrivelse.Bruker",values:{rolle:o}}),o==="ANNEN_PART"&&m.jsx($,{id:"PersonPanel.Beskrivelse.Annenpart",values:{rolle:o}})]}),m.jsx(Ps,{harSammeAdresser:t,adresser:R,adresseKodeverk:k.AdresseType,erAnnenpart:o==="ANNEN_PART"})]})})})};Ur.__docgenInfo={description:"",methods:[],displayName:"Personopplysninger",props:{rolle:{required:!1,tsType:{name:"union",raw:"'BARN' | 'BRUKER' | 'ANNEN_PART'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'BRUKER'"},{name:"literal",value:"'ANNEN_PART'"}]},description:"",defaultValue:{value:"'BRUKER'",computed:!1}},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
>[]`}}]}}]},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},type:{required:!0,tsType:{name:"union",raw:"'OPPRETT' | 'FJERN'",elements:[{name:"literal",value:"'OPPRETT'"},{name:"literal",value:"'FJERN'"}]},description:""},fjernVerge:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},opprettVerge:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: OpprettVergeParams) => void",signature:{arguments:[{type:{name:"intersection",raw:`{
  ...
  gyldigTom?: string;
  vergeType: VergeType;
}`,signature:{properties:[{key:"navn",value:{name:"string",required:!0}},{key:"gyldigFom",value:{name:"string",required:!0}},{key:"gyldigTom",value:{name:"string",required:!1}},{key:"vergeType",value:{name:"union",raw:"'BARN' | 'FBARN' | 'VOKSEN' | 'ADVOKAT' | 'ANNEN_F'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'FBARN'"},{name:"literal",value:"'VOKSEN'"},{name:"literal",value:"'ADVOKAT'"},{name:"literal",value:"'ANNEN_F'"}],required:!0}}]}},{name:"union",raw:"(T & { [K in keyof U]?: never }) | (U & { [K in keyof T]?: never })",elements:[{name:"unknown"},{name:"unknown"}]}]},name:"values"}],return:{name:"void"}}},description:""}}};const Vt=pe(Bt),pp=()=>Vt.formatMessage({id:"MenyTaAvVentIndex.ResumeBehandling"}),Os=({taBehandlingAvVent:o,lukkModal:k})=>m.jsx(Ie,{value:Vt,children:m.jsx(ct,{text:Vt.formatMessage({id:"MenyTaAvVentIndex.TaAvVent"}),showModal:!0,submit:()=>{o(),k()},cancel:k})});Os.__docgenInfo={description:"",methods:[],displayName:"MenyTaAvVentIndex",props:{taBehandlingAvVent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Ep="_modal_tyvxs_1",Tp="_selectWidth_tyvxs_6",At={modal:Ep,selectWidth:Tp},_p=Ft(400),Gs=({handleSubmit:o,lukkModal:k,behandlendeEnheter:t,gjeldendeBehandlendeEnhetId:E,gjeldendeBehandlendeEnhetNavn:h})=>{const f=t.map((L,le)=>m.jsx("option",{value:`${le}`,children:`${L.enhetId} ${L.enhetNavn}`},L.enhetId)),b=[m.jsx("option",{disabled:!0,children:`${E} ${h}`},E)].concat(f),N=sa(),R=oa(),S=R.watch("nyEnhet"),P=R.watch("begrunnelse");return m.jsx(ma,{formMethods:R,onSubmit:o,children:m.jsxs(re,{className:At.modal,open:!0,"aria-label":N.formatMessage({id:"EndreBehandlendeEnhetModal.ModalDescription"}),onClose:k,children:[m.jsx(re.Header,{children:m.jsx(ja,{size:"small",level:"2",children:m.jsx($,{id:"EndreBehandlendeEnhetModal.EndreEnhet"})})}),m.jsx(re.Body,{children:m.jsxs(Pe,{gap:"space-16",children:[m.jsx(Ga,{name:"nyEnhet",control:R.control,label:N.formatMessage({id:"EndreBehandlendeEnhetModal.NyEnhetField"}),validate:[Ne],selectValues:b,className:At.selectWidth}),m.jsx(xr,{name:"begrunnelse",control:R.control,label:N.formatMessage({id:"EndreBehandlendeEnhetModal.BegrunnelseField"}),validate:[Ne,_p,Dr],maxLength:400})]})}),m.jsxs(re.Footer,{children:[m.jsx(we,{size:"small",variant:"primary",className:At.button,disabled:!(S&&P),children:N.formatMessage({id:"EndreBehandlendeEnhetModal.Ok"})}),m.jsx(we,{size:"small",variant:"secondary",onClick:k,type:"button",children:N.formatMessage({id:"EndreBehandlendeEnhetModal.Avbryt"})})]})]})})};Gs.__docgenInfo={description:`EndreBehandlendeEnhetModal
...
Ved å trykke på ok skal ny behandling(1.gangsbehandling) av sak opprettes.`,methods:[],displayName:"EndreUtlandModal",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},fagsakMarkeringer:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FagsakMarkering'>[]"},description:""}}};const Rp="_image_1xqqe_1",Fp="_modal_1xqqe_8",bs={image:Rp,modal:Fp},Ys=({showModal:o,closeEvent:k})=>{const t=sa();return m.jsx(re,{className:bs.modal,open:o,"aria-label":t.formatMessage({id:"HenlagtBehandlingModal.ModalDescription"}),onClose:k,children:m.jsx(re.Body,{children:m.jsxs(Sn,{justify:"space-between",children:[m.jsxs(Sn,{gap:"space-12",children:[m.jsx(Py,{className:bs.image,title:t.formatMessage({id:"HenlagtBehandlingModal.Henlagt"})}),m.jsxs(Pe,{gap:"space-4",children:[m.jsx($r,{size:"small",children:m.jsx($,{id:"HenlagtBehandlingModal.BehandlingenErHenlagt"})}),m.jsx(Yr,{size:"small",children:m.jsx($,{id:"HenlagtBehandlingModal.RutetTilForsiden"})})]})]}),m.jsx(we,{variant:"primary",size:"small",onClick:k,autoFocus:!0,type:"button",children:m.jsx($,{id:"HenlagtBehandlingModal.Ok"})})]})})})};Ys.__docgenInfo={description:`HenlagtBehandlingModal

Denne modalen vises etter en vilkarsvurdering der behandlingsstatusen
er satt til Iverksetter vedtak. Ved å trykke på knapp blir saksbehandler tatt tilbake til sokesiden.`,methods:[],displayName:"HenlagtBehandlingModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Sp="_modal_osiwa_1",qp="_button_osiwa_5",cp="_selectWidth_osiwa_9",Gr={modal:Sp,button:qp,selectWidth:cp},Bp=Ft(1500),Pp={[x.KLAGE]:[oe.HENLAGT_KLAGE_TRUKKET,oe.HENLAGT_FEILOPPRETTET],[x.ANKE]:[oe.HENLAGT_ANKE_TRUKKET,oe.HENLAGT_FEILOPPRETTET],[x.DOKUMENTINNSYN]:[oe.HENLAGT_INNSYN_TRUKKET,oe.HENLAGT_FEILOPPRETTET],[x.TILBAKEKREVING]:[jr.HENLAGT_FEILOPPRETTET],[x.TILBAKEKREVING_REVURDERING]:[jr.HENLAGT_FEILOPPRETTET_MED_BREV,jr.HENLAGT_FEILOPPRETTET_UTEN_BREV],[x.REVURDERING]:[oe.HENLAGT_SOKNAD_TRUKKET,oe.HENLAGT_FEILOPPRETTET,oe.HENLAGT_SOKNAD_MANGLER],[x.FORSTEGANGSSOKNAD]:[oe.HENLAGT_SOKNAD_TRUKKET,oe.HENLAGT_FEILOPPRETTET,oe.HENLAGT_SOKNAD_MANGLER]},Cs=({handleSubmit:o,cancelEvent:k,forhandsvisHenleggBehandling:t,behandlingUuid:E,ytelseType:h,behandlingType:f,behandlingResultatTyper:b})=>{const N=sa(),R=oa(),S=R.watch("årsakKode"),P=R.watch("begrunnelse"),L=R.watch("fritekst"),le=Ip(f,S,L),X=Lp(b,f,h);return m.jsx(ma,{formMethods:R,onSubmit:o,children:m.jsxs(re,{className:Gr.modal,open:!0,"aria-label":N.formatMessage({id:"HenleggBehandlingModal.ModalDescription"}),onClose:k,children:[m.jsx(re.Header,{children:m.jsx(ja,{size:"small",level:"2",children:m.jsx($,{id:"HenleggBehandlingModal.HenleggBehandling"})})}),m.jsx(re.Body,{children:m.jsxs(Pe,{gap:"space-16",children:[m.jsx(Ga,{name:"årsakKode",control:R.control,className:Gr.selectWidth,label:N.formatMessage({id:"HenleggBehandlingModal.ArsakField"}),validate:[Ne],selectValues:X.map(ge=>m.jsx("option",{value:ge.kode,children:N.formatMessage({id:ge.kode})},ge.kode))}),m.jsx(xr,{name:"begrunnelse",control:R.control,label:N.formatMessage({id:"HenleggBehandlingModal.BegrunnelseField"}),validate:[Ne,Bp,Dr],maxLength:1500}),Js(f,S)&&m.jsx("div",{className:Gr.fritekstTilBrevTextArea,children:m.jsx(xr,{name:"fritekst",control:R.control,label:N.formatMessage({id:"HenleggBehandlingModal.Fritekst"}),validate:[Ne,Dr],maxLength:2e3,parse:yy})}),le&&m.jsxs(Sn,{justify:"space-between",children:[m.jsx($r,{size:"small",children:N.formatMessage({id:"HenleggBehandlingModal.SokerInformeres"})}),m.jsx(Iy,{href:"#",onClick:Ns(t,E,L),onKeyDown:Ns(t,E,L),children:m.jsx($,{id:"HenleggBehandlingModal.ForhandsvisBrev"})})]})]})}),m.jsxs(re.Footer,{children:[m.jsx(we,{variant:"primary",size:"small",className:Gr.button,disabled:wp(f,S,P,L),children:m.jsx($,{id:"HenleggBehandlingModal.HenleggBehandlingSubmit"})}),m.jsx(we,{variant:"secondary",size:"small",onClick:k,type:"button",children:m.jsx($,{id:"HenleggBehandlingModal.Avbryt"})})]})]})})},Ns=(o,k,t)=>E=>{o({behandlingUuid:k,dokumentMal:wy.INFO_OM_HENLEGGELSE,fritekst:t}),E.preventDefault()},Js=(o,k)=>x.TILBAKEKREVING_REVURDERING===o&&oe.HENLAGT_FEILOPPRETTET_MED_BREV===k,wp=(o,k,t,E)=>Js(o,k)?!(k&&t&&E):!(k&&t),Ip=(o,k,t)=>o===x.TILBAKEKREVING?oe.HENLAGT_FEILOPPRETTET===k:o===x.TILBAKEKREVING_REVURDERING?oe.HENLAGT_FEILOPPRETTET_MED_BREV===k&&!!t:[oe.HENLAGT_SOKNAD_TRUKKET,oe.HENLAGT_KLAGE_TRUKKET,oe.HENLAGT_INNSYN_TRUKKET].some(E=>E===k),Lp=(o,k,t)=>Pp[k].filter(h=>t!==Mr.ENGANGSSTONAD||t===Mr.ENGANGSSTONAD&&h!==oe.HENLAGT_SOKNAD_MANGLER).flatMap(h=>{const f=o.find(b=>b.kode===h);return f?[f]:[]});Cs.__docgenInfo={description:`HenleggBehandlingModal
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const r0=({behandling:o,hentOgSettBehandling:k,lukkModal:t})=>{const E=Be(qt()),h=Ua(o),{mutate:f}=un({mutationFn:b=>h.endreBehandlendeEnhet({...b,behandlingUuid:o.uuid,behandlingVersjon:o.versjon}),onSuccess:()=>k()});return m.jsx(Us,{behandlendeEnhetId:o.behandlendeEnhetId,behandlendeEnhetNavn:o.behandlendeEnhetNavn,nyBehandlendeEnhet:f,behandlendeEnheter:en(E.data).behandlendeEnheter,lukkModal:t})};r0.__docgenInfo={description:"",methods:[],displayName:"EndreBehandlendeEnhetMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const l0=({saksnummer:o,fagsakMarkeringer:k,hentOgSettBehandling:t,lukkModal:E})=>{const h=St(),f=Wr(),b=Uy("FagsakMarkering").toSorted((R,S)=>R.navn.localeCompare(S.navn)),{mutate:N}=un({mutationFn:R=>f.endreSakMarkering(R),onSuccess:()=>{t(),h.invalidateQueries({queryKey:[Oa.FETCH_FAGSAK]})}});return m.jsx(Hs,{saksnummer:o,fagsakMarkeringer:k,endreFagsakMarkering:N,lukkModal:E,fagsakMarkeringerKodeverk:b})};l0.__docgenInfo={description:"",methods:[],displayName:"EndreFagsakMarkeringMenyModal",props:{saksnummer:{required:!0,tsType:{name:"string"},description:""},fagsakMarkeringer:{required:!0,tsType:{name:"union",raw:"Saksmarkering[] | undefined",elements:[{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  fagsakMarkering: FagsakMarkeringKode;
  kortNavn?: string;
}`,signature:{properties:[{key:"fagsakMarkering",value:{name:"FagsakMarkeringKode",required:!0}},{key:"kortNavn",value:{name:"string",required:!1}}]}}],raw:"Saksmarkering[]"},{name:"undefined"}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const t0=({behandling:o,behandlingAppKontekst:k,fagsakYtelseType:t,lukkModal:E})=>{const h=Wr(),f=Ua(o),{data:b}=Be(h.kodeverkOptions()),{data:N}=Be(h.fptilbake.kodeverkOptions()),{mutateAsync:R}=un({mutationFn:X=>f.henleggBehandling({...X,behandlingUuid:o.uuid,behandlingVersjon:o.versjon})}),S=o.type===x.TILBAKEKREVING||o.type===x.TILBAKEKREVING_REVURDERING?en(N).BehandlingResultatType:en(b).BehandlingResultatType,P=Vs(),L=()=>P("/"),le=sE(k);return m.jsx($s,{valgtBehandling:o,forhandsvisHenleggBehandling:le,henleggBehandling:R,ytelseType:t,behandlingResultatTyper:S,lukkModal:E,gaaTilSokeside:L})},sE=o=>{const k=_y(o),{mutate:t}=un({mutationFn:f=>k.forhåndsvisMelding(f),onSuccess:f=>{gs(f)}}),{mutate:E}=un({mutationFn:f=>Ay(f.behandlingUuid,f.fritekst??""),onSuccess:f=>{gs(f)}}),h=x.TILBAKEKREVING===o.type||x.TILBAKEKREVING_REVURDERING===o.type;return f=>{h?E(f):t(f)}};t0.__docgenInfo={description:"",methods:[],displayName:"HenleggMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const oE=o=>{const{setIsRequestPending:k}=Oy(),{onBehandlingSuccess:t}=Gy(o),{mutate:E}=un({mutationFn:async h=>{const f=h.isTilbakekreving?await hy(h.params):await fy(h.params);return jy(f,k)},onSuccess:t});return{lagNyBehandling:E}},mE=[x.FORSTEGANGSSOKNAD,x.KLAGE,x.REVURDERING,x.DOKUMENTINNSYN,x.TILBAKEKREVING,x.TILBAKEKREVING_REVURDERING],dE=(o=[])=>{const k=o.find(t=>t.gjeldendeVedtak&&t.status===Ey.AVSLUTTET&&(t.type===x.FORSTEGANGSSOKNAD||t.type===x.REVURDERING));return k?k.uuid:void 0},u0=({fagsakData:o,behandlingUuid:k,lukkModal:t})=>{const E=o.getFagsak(),h=o.getAlleBehandlinger(),f=o.getBehandling(k),b=dE(h),N=Hy().includes(Cr.FPTILBAKE),R=Wr(),{data:S}=Be(R.kodeverkOptions()),{data:P}=Be(R.fptilbake.kodeverkOptions()),L=Be(qt()),{innloggetBruker:le}=en(L.data),X=N&&!le.kanVeilede&&b!==void 0,{data:ge=!1}=Be(R.fptilbake.kanTilbakekrevingOpprettesOptions(X,E.saksnummer,b)),Ve=f?.type===x.TILBAKEKREVING||f?.type===x.TILBAKEKREVING_REVURDERING,ee=N&&!le.kanVeilede&&Ve&&!!k,{data:Tn=!1}=Be(R.fptilbake.kanTilbakekrevingRevurderingOpprettesOptions(ee,k)),Ma=P?P.BehandlingÅrsakType:void 0,He=S?S.BehandlingÅrsakType:void 0,qn=en(S).BehandlingType.filter(Pn=>mE.some(va=>va===Pn.kode)),Ye=Vs(),cn=py(),Ce=Pn=>{const va=My(E.saksnummer,Pn?.uuid);Ye(xy({...cn,pathname:va}))},{lagNyBehandling:Bn}=oE(Ce);return m.jsx(Xs,{saksnummer:E.saksnummer,behandlingUuid:f?.uuid,uuidForSistLukkede:b,behandlingOppretting:o.getBehandlingOppretting(),kanTilbakekrevingOpprettes:{kanBehandlingOpprettes:ge,kanRevurderingOpprettes:Tn},behandlingstyper:qn,tilbakekrevingRevurderingArsaker:Ma,revurderingArsaker:He,ytelseType:E.fagsakYtelseType,lagNyBehandling:Bn,lukkModal:t})};u0.__docgenInfo={description:"",methods:[],displayName:"NyBehandlingMenyModal",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},behandlingUuid:{required:!1,tsType:{name:"string"},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const s0=({behandling:o,hentOgSettBehandling:k,lukkModal:t})=>{const E=Wr(),h=Ua(o),{data:f}=Be(E.kodeverkOptions()),{data:b}=Be(E.fptilbake.kodeverkOptions()),{mutate:N}=un({mutationFn:S=>h.settBehandlingPåVent({frist:S.frist,ventearsak:S.ventearsak,behandlingUuid:o.uuid,behandlingVersjon:o.versjon}),onSuccess:()=>k()}),R=o.type===x.TILBAKEKREVING||o.type===x.TILBAKEKREVING_REVURDERING?en(b).Venteårsak:en(f).Venteårsak;return m.jsx(n0,{settBehandlingPaVent:N,ventearsaker:R,lukkModal:t,erTilbakekreving:o.type===x.TILBAKEKREVING||o.type===x.TILBAKEKREVING_REVURDERING})};s0.__docgenInfo={description:"",methods:[],displayName:"SettPaVentMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const m0=({behandlingAppKontekst:o,behandling:k,hentOgSettBehandling:t,lukkModal:E})=>{const h=o.behandlingTillatteOperasjoner?.vergeBehandlingsmeny,f=Dy(k.type),b=St(),N=()=>{t(),b.invalidateQueries({queryKey:[Oa.FETCH_FAGSAK]}),b.invalidateQueries({queryKey:[Oa.FETCH_FAGSAKDATA_FPTILBAKE]}),b.invalidateQueries({queryKey:[Ts.VERGE]}),b.invalidateQueries({queryKey:[Ts.VERGE_HENT]})},R=Ua(k),{mutate:S}=un({mutationFn:R.verge.opprettVergeV2,onSuccess:N}),{mutate:P}=un({mutationFn:R.verge.fjernVergeV2,onSuccess:N}),{data:L}=Be(R.verge.hent(k));return m.jsx(Ls,{type:bt.OPPRETT===h?"OPPRETT":"FJERN",verge:L,opprettVerge:S,fjernVerge:P,lukkModal:E,alleKodeverk:f})};m0.__docgenInfo={description:"",methods:[],displayName:"VergeMenyModal",props:{behandlingAppKontekst:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const vE=({fagsakData:o,behandlingUuid:k,behandling:t,setBehandling:E,hentOgSettBehandling:h})=>{const f=Be(qt()),{innloggetBruker:b}=en(f.data),[N,R]=Jr.useState(),S=()=>R(void 0),P=o.getFagsak(),L=o.getBehandling(k),le=gE(L,P);return b.kanVeilede?null:m.jsxs(m.Fragment,{children:[m.jsxs(Ia,{children:[m.jsx(we,{size:"small",as:Ia.Toggle,iconPosition:"right",variant:"secondary",icon:m.jsx(Fy,{"aria-hidden":!0}),children:m.jsx($,{id:"BehandlingMenuIndex.Behandlingsmeny"})}),m.jsx(Ia.Menu,{children:m.jsx(Ia.Menu.List,{children:Object.keys(le).filter(X=>!le[X].disabled).map(X=>m.jsx(Ia.Menu.List.Item,{onClick:()=>{R(X)},children:le[X].text},X))})})]}),N==="NY_BEHANDLING"&&m.jsx(u0,{fagsakData:o,behandlingUuid:k,lukkModal:S}),N==="ENDRE_FAGSAK_MARKERING"&&m.jsx(l0,{saksnummer:P.saksnummer,fagsakMarkeringer:P.fagsakMarkeringer,hentOgSettBehandling:h,lukkModal:S}),N==="VERGE"&&L&&t&&m.jsx(m0,{behandlingAppKontekst:L,behandling:t,lukkModal:S,hentOgSettBehandling:h}),N==="ÅPNE_FOR_ENDRINGER"&&t&&m.jsx(a0,{behandling:t,setBehandling:E,lukkModal:S}),N==="ENDRE_BEHANDLENDE_ENHET"&&t&&m.jsx(r0,{behandling:t,hentOgSettBehandling:h,lukkModal:S}),N==="HENLEGG"&&L&&t&&m.jsx(t0,{behandlingAppKontekst:L,behandling:t,fagsakYtelseType:P.fagsakYtelseType,lukkModal:S}),N==="SETT_PÅ_VENT"&&t&&m.jsx(s0,{behandling:t,hentOgSettBehandling:h,lukkModal:S}),N==="TA_AV_VENT"&&t&&m.jsx(o0,{behandling:t,setBehandling:E,lukkModal:S}),N==="MERK_SOM_HASTER"&&t&&m.jsx(i0,{behandling:t,hentOgSettBehandling:h,lukkModal:S})]})},gE=(o,k)=>{const t=o?o.behandlingPåVent:!1,E=o?.behandlingTillatteOperasjoner,h=E?.vergeBehandlingsmeny,f=h===bt.FJERN&&!!o?.uuid&&!!o?.versjon,b=h===bt.OPPRETT&&!!o?.uuid&&!!o?.versjon;return{TA_AV_VENT:{disabled:!E?.behandlingKanGjenopptas,text:pp()},SETT_PÅ_VENT:{disabled:!E?.behandlingKanSettesPaVent,text:uE()},HENLEGG:{disabled:!E?.behandlingKanHenlegges,text:xp()},ENDRE_BEHANDLENDE_ENHET:{disabled:!E?.behandlingKanBytteEnhet,text:Ap()},ÅPNE_FOR_ENDRINGER:{disabled:!E?.behandlingKanOpnesForEndringer,text:fp()},NY_BEHANDLING:{disabled:k.sakSkalTilInfotrygd,text:tE()},ENDRE_FAGSAK_MARKERING:{disabled:k.sakSkalTilInfotrygd,text:Kp()},VERGE:{disabled:!(!t&&(b||f)),text:yp(b)},MERK_SOM_HASTER:{disabled:!E?.behandlingKanMerkesHaster,text:Yp()}}};vE.__docgenInfo={description:"",methods:[],displayName:"BehandlingMenuIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},behandlingUuid:{required:!1,tsType:{name:"string"},description:""},behandling:{required:!1,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
