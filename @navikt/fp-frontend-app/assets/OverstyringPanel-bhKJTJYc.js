import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as x,K as w,r as A,c as I,o as V,N as _,E as M,b as B,J as F,Z as E}from"./index.es-BQggd8eJ.js";import{l as L,f as c,c as z,S as C,d as $,q as O,e as U}from"./index.es-n0vZVEve.js";import{r as G}from"./index-DjhIdADd.js";import{A as D}from"./aksjonspunktStatus-xM4O_ZUY.js";import{h as T,V as f,f as m,g as p,H as Y,D as K,L as q}from"./withPanelData-uKl3GsGR.js";import{V as H}from"./BehandlingHenlagtPanel-CuHPzS07.js";import{S as J}from"./TotrinnskontrollIndex-J8KyDUgL.js";import{S as X}from"./CheckmarkCircleFill-DYdilZYC.js";import{S as Z}from"./ExclamationmarkTriangleFill-C4Vd7zRj.js";const W="_begrunnelseTextField_hw8s7_6",Q={begrunnelseTextField:W},v={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=c(v),ne=I(3),se=V(2e3),re=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ae=n=>r=>r!==void 0||n,h=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:l}}=x(),t=a?()=>!1:ae(l);return e.jsx("div",{className:s?"":Q.begrunnelseTextField,children:e.jsx(w,{name:"begrunnelse",label:r??ee.formatMessage({id:re(n)}),validate:[A(t),ne,se,_],maxLength:2e3,readOnly:n,parse:L})})},te=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";h.buildInitialValues=n=>({begrunnelse:z(te(n))});h.transformValues=n=>({begrunnelse:n.begrunnelse});h.__docgenInfo={description:`ProsessStegBegrunnelseTextField
