import{l as F,a6 as le,j as n,v as f,a7 as te,G as x,y as ie,z as se,a8 as ue,F as I,P as H,b as Y,r as P,n as oe,a9 as w,I as A}from"./iframe-ByDDCd0c.js";import{n as G,s as C,u as me,t as de,d as ge}from"./fagsakApi-BshxkCGj.js";import{u as ke,D as ve,M as L,O as ye,c as q}from"./index.es-BdpJum2y.js";import{D as i}from"./dokumentMalType-B-Xou3xH.js";import{V as Ee}from"./venteArsakType-BJdSFL9e.js";import{U as pe}from"./UkjentAdresseMeldingIndex-BJDNKi69.js";import{V as J,H as S,b as z,M as O,L as be}from"./VStack-D0LIxmN1.js";import{L as _e}from"./Link-D7dEfHEH.js";import{M as T}from"./message-B1ro2onp.js";import{S as Te}from"./CheckmarkCircleFill-D0cH2XjT.js";import{u as M}from"./useKodeverk-PEJTCEIq.js";import{S as Ve}from"./SupportHeader-C2xo-VXz.js";import{S as Ne}from"./SettPaVentReadOnlyModal-DNWxfwzw.js";import{A as Ae}from"./index.es-DCKkpvOu.js";var E=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(E||{});const Ke="_bredde_jav4h_9",D={bredde:Ke},Re=x(4e3),he=x(1e4),fe=ie(3),Q=({behandling:e,forhåndsvisBrev:a,submitCallback:t,revurderingVarslingArsak:d,fagsakYtelseType:g,kanVeilede:r,meldingFormData:s,setMeldingFormData:p,brukerManglerAdresse:_})=>{const o=F(),m=ke({defaultValues:s??Be(e)}),k=m.watch("brevmalkode"),b=m.watch("fritekst"),u=m.watch("arsakskode"),K=Fe(d,g);if(!e.språkkode)return null;const{formState:V,control:v}=m,N=l=>{k&&b?a({brevmalkode:k,fritekst:b,arsakskode:u}):b||m.setError("fritekst",{type:"manual",message:o.formatMessage({id:"Messages.FritekstRequired"})}),l.preventDefault()},R=le(e.språkkode),y=k===i.VARSEL_OM_REVURDERING;return n.jsx(ve,{formMethods:m,onSubmit:l=>t(je(l)),setDataOnUnmount:p,children:n.jsxs(J,{gap:"space-16",children:[n.jsx(L,{name:"brevmalkode",control:v,label:o.formatMessage({id:"Messages.Template"}),validate:[f],selectValues:e.brevmaler.map(l=>n.jsx("option",{value:l.kode,disabled:!l.tilgjengelig,children:l.navn},l.kode)),className:D.bredde}),y&&n.jsx(L,{name:"arsakskode",control:v,label:o.formatMessage({id:"Messages.Årsak"}),validate:[f],selectValues:K.map(l=>n.jsx("option",{value:l.kode,children:l.navn},l.kode)),className:D.bredde}),Se(k,u)&&n.jsx(ye,{name:"fritekst",control:v,label:o.formatMessage({id:qe(k)}),validate:[f,y?he:Re,fe,se],maxLength:y?1e4:4e3,badges:[{type:"info",titleText:R}],parse:te}),_&&n.jsx(pe,{}),n.jsxs(S,{justify:"space-between",children:[(!y||y&&u!==void 0)&&n.jsx(_e,{href:"#",onClick:N,onKeyDown:l=>l.key==="Enter"?N(l):null,children:n.jsx(T,{id:"Messages.Preview"})}),n.jsx(z,{size:"small",variant:"primary",loading:V.isSubmitting,disabled:V.isSubmitting||r,onClick:ue,children:n.jsx(T,{id:"Messages.Submit"})})]})]})})},qe=e=>e===i.INNHENTE_OPPLYSNINGER||e===i.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",Se=(e,a)=>e===i.INNHENTE_OPPLYSNINGER||e===i.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===i.VARSEL_OM_TILBAKEKREVING||e===i.TBK_INNHENTE_OPPLYSNINGER||e===i.VARSEL_OM_REVURDERING&&a===E.ANNET,Fe=(e,a)=>a===I.ENGANGSSTONAD?e.filter(t=>t.kode===E.BARN_IKKE_REGISTRERT_FOLKEREGISTER||t.kode===E.ANNET):a===I.SVANGERSKAPSPENGER?e.filter(t=>t.kode!==E.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&t.kode!==E.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Be=e=>{const a={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...a,brevmalkode:i.VARSEL_OM_REVURDERING}:{...a}},je=e=>{const a=e;return e.brevmalkode===i.VARSEL_OM_REVURDERING&&a.arsakskode!==E.ANNET&&(a.fritekst=" "),a};Q.__docgenInfo={description:`Messages
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"kontrollResultat",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean | null;
}>`}]},description:""}}};const Ie="_image_v04s1_1",Pe="_modal_v04s1_8",U={image:Ie,modal:Pe},X=({showModal:e,closeEvent:a})=>{const t=F();return n.jsx(O,{className:U.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:a,children:n.jsx(O.Body,{children:n.jsxs(S,{justify:"space-between",align:"center",children:[n.jsxs(S,{gap:"space-8",align:"center",children:[n.jsx(Te,{className:U.image,title:t.formatMessage({id:"MessagesModal.description"})}),n.jsx(be,{size:"small",children:n.jsx(T,{id:"MessagesModal.text"})})]}),n.jsx(z,{size:"small",variant:"primary",onClick:a,autoFocus:!0,type:"button",children:n.jsx(T,{id:"MessagesModal.OK"})})]})})})};X.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const we=Y($),Z=e=>n.jsx(H,{value:we,children:n.jsx(X,{...e})});Z.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Ge=e=>e.behandlingPåVent?e.fristBehandlingPåVent:null,Le=({fagsakData:e,valgtBehandlingUuid:a,meldingFormData:t,setMeldingFormData:d,hentOgSettBehandling:g,toggleVisUtvidetBehandlingDetaljerKnapp:r})=>{const s=F(),[p,_]=P.useState(!1),[o,m]=P.useState(!1),k=oe(),b=e.getFagsak(),u=G(e.getBehandling(a)),K=C(u),V=me(ge()),{innloggetBruker:{kanVeilede:v}}=G(V.data),N=M("Venteårsak")||[],R=M("RevurderingVarslingÅrsak"),{mutateAsync:y,status:l}=q({mutationFn:h=>K.sendMelding(h)}),ee=Oe(m,y,g,_,d,u),ne=()=>{k("/")},ae=De(u),re=()=>(m(!1),g()),B=l==="success",j=u.behandlingTillatteOperasjoner,c=!v&&e.getAlleBehandlinger().some(h=>!h.avsluttet)&&j?.behandlingKanSendeMelding;return n.jsxs(n.Fragment,{children:[o&&n.jsx(Z,{showModal:B&&o,closeEvent:re}),n.jsx(Ve,{tekst:s.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:r,children:n.jsxs(J,{gap:"space-16",children:[!c&&n.jsx(Ae,{variant:"info",children:n.jsx(T,{id:Me(v,j?.behandlingKanSendeMelding)})}),c&&n.jsx(W,{submitCallback:ee,behandling:u,forhåndsvisBrev:ae,revurderingVarslingArsak:R,fagsakYtelseType:b.fagsakYtelseType,kanVeilede:v,meldingFormData:t,setMeldingFormData:d,brukerManglerAdresse:b.brukerManglerAdresse})]})}),B&&p&&n.jsx(Ne,{lukkCallback:ne,ventearsak:Ee.AVV_DOK,ventearsaker:N,frist:Ge(u)})]})},Oe=(e,a,t,d,g,r)=>s=>{const p=s.brevmalkode===i.INNHENTE_OPPLYSNINGER||s.brevmalkode===i.VARSEL_OM_REVURDERING||s.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,_=A.TILBAKEKREVING===r.type||A.TILBAKEKREVING_REVURDERING===r.type;e(!p);const o=_?{behandlingUuid:r.uuid,fritekst:s.fritekst,brevmalkode:s.brevmalkode}:{behandlingUuid:r.uuid,brevmalkode:s.brevmalkode,fritekst:s.fritekst,arsakskode:s.arsakskode};return a(o).then(()=>{g(),p?d(!0):t()})},Me=(e,a)=>a?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",De=e=>{const a=C(e),{mutate:t}=q({mutationFn:r=>a.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:r.brevmalkode,fritekst:r.fritekst||" ",arsakskode:r.arsakskode}),onSuccess:r=>{w(r)}}),{mutate:d}=q({mutationFn:r=>de(e.uuid,r.brevmalkode,r.fritekst??" "),onSuccess:r=>{w(r)}}),g=A.TILBAKEKREVING===e.type||A.TILBAKEKREVING_REVURDERING===e.type;return r=>{g?d(r):t(r)}};Le.__docgenInfo={description:`MeldingIndex
...
Har ansvar for å hente mottakere og brevmaler fra serveren.`,methods:[],displayName:"MeldingIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},meldingFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  fritekst?: string;
  arsakskode?: string;
}`,signature:{properties:[{key:"brevmalkode",value:{name:"string",required:!1}},{key:"fritekst",value:{name:"string",required:!1}},{key:"arsakskode",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{Le as M,E as R};
