...
Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ra=({readOnly:s})=>{const{watch:i}=Y(),o=i(`${vr}.harHattOppdragForFamilie`);return r.jsxs(r.Fragment,{children:[r.jsx(U,{name:`${vr}.harHattOppdragForFamilie`,label:r.jsx(h,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),validate:[A],isReadOnly:s,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:r.jsx(h,{id:"Registrering.FrilansOppdrag.Yes"}),value:"true"},{label:r.jsx(h,{id:"Registrering.FrilansOppdrag.No"}),value:"false"}]}),o&&r.jsxs(r.Fragment,{children:[r.jsx(y,{eightPx:!0}),r.jsxs(de,{children:[r.jsx(me,{size:"small",children:r.jsx(h,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),r.jsx(y,{fourPx:!0}),r.jsx(Qs,{readOnly:s})]})]})]})};ra.buildInitialValues=()=>({oppdragPerioder:[Zs],perioder:void 0});ra.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"intersection",raw:`{
  ...
  erNyoppstartetFrilanser?: boolean;
  harInntektFraFosterhjem?: boolean;
}`,signature:{properties:[{key:"harSokerPeriodeMedFrilans",value:{name:"boolean",required:!1}},{key:"erNyoppstartetFrilanser",value:{name:"boolean",required:!1}},{key:"harInntektFraFosterhjem",value:{name:"boolean",required:!1}}]}},{name:"FormValues"},{name:"FormValues"}],alias:"FormValues"}}],returns:null}],displayName:"FrilansPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Fg="_notLastRow_uwn16_1",Pg={notLastRow:Fg},_g=rt(50),Dn="arbeidsforhold",Ng={arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},xg=s=>s.filter(({kode:i})=>i!==st.NORGE).map(({kode:i,navn:o})=>r.jsx("option",{value:i,children:o},i)),ei=({alleKodeverk:s,readOnly:i})=>{const o=H(),{control:d}=Y(),{fields:g,remove:k,append:v}=fe({control:d,name:Dn}),m=s[Q.LANDKODER].slice().sort((f,c)=>f.navn.localeCompare(c.navn));return r.jsx(Oe,{fields:g,emptyPeriodTemplate:Ng,bodyText:o.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:i,remove:k,append:v,children:(f,c,R)=>r.jsxs("div",{className:c!==g.length-1?Pg.notLastRow:"",children:[r.jsx(ee,{children:r.jsxs(L,{children:[r.jsx(q,{children:r.jsx(le,{readOnly:i,name:`${Dn}.${c}.arbeidsgiver`,label:c===0?o.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}):"",validate:[_g],maxLength:99})}),r.jsx(q,{children:r.jsx(M,{isReadOnly:i,name:`${Dn}.${c}.periodeFom`,label:c===0?o.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}):"",validate:[I]})}),r.jsx(q,{children:r.jsx(M,{isReadOnly:i,name:`${Dn}.${c}.periodeTom`,label:c===0?o.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}):"",validate:[I]})}),r.jsx(q,{children:r.jsx(ce,{readOnly:i,name:`${Dn}.${c}.land`,label:c===0?o.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}):"",selectValues:xg(m)})}),R&&r.jsx(q,{children:R()})]})}),r.jsx(y,{twentyPx:!0})]},f.id)})};ei.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const vs="typeVirksomhet",ys={[Kn.DAGMAMMA]:1,[Kn.FISKE]:2,[Kn.JORDBRUK_ELLER_SKOGBRUK]:3,[Kn.ANNEN]:4},im=(s,i)=>s>i?1:s<i?-1:0,gi=({readOnly:s,alleKodeverk:i})=>{var R,w;const o=i[Q.VIRKSOMHET_TYPE],d=V.useMemo(()=>o.filter(b=>b.kode!==Kn.FRILANSER).sort((b,F)=>im(ys[b.kode],ys[F.kode])),[]),{watch:g,setError:k,formState:v,clearErrors:m}=Y(),f=g(vs),c=!f||!Object.values(f).some(b=>b===!0);return V.useEffect(()=>{c&&k("notRegisteredInput",{type:"custom",message:Ju()}),c||m("notRegisteredInput")},[c]),r.jsxs(r.Fragment,{children:[r.jsx(y,{eightPx:!0}),r.jsx(me,{size:"small",children:r.jsx(h,{id:"Registrering.VirksomhetNaeringTypePanel.Title"})}),r.jsx(y,{fourPx:!0}),d.map(b=>r.jsxs(V.Fragment,{children:[r.jsx(y,{fourPx:!0}),r.jsx(ie,{name:`${vs}.${b.kode}`,label:b.navn,readOnly:s},b.kode)]},b.kode)),v.isSubmitted&&((R=v.errors.notRegisteredInput)==null?void 0:R.message)&&r.jsx(br,{children:(w=v.errors.notRegisteredInput)==null?void 0:w.message})]})};gi.__docgenInfo={description:`VirksomhetTypeNaringPanel
...
papirsøknad dersom søknad gjelder foreldrepenger og saksbehandler skal legge til ny virksomhet for søker.`,methods:[],displayName:"VirksomhetTypeNaringPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const lm="_savebutton_tgfg3_1",om="_cancelbutton_tgfg3_1",dm="_form_tgfg3_5",cs={savebutton:lm,cancelbutton:om,form:dm},mi=({showModal:s=!1,readOnly:i=!1,closeEvent:o,onSubmit:d,alleKodeverk:g,virksomhet:k})=>{const v=H(),m=fr({defaultValues:k});return r.jsx(hr,{formMethods:m,children:r.jsxs(Xe,{open:s,"aria-label":v.formatMessage({id:"Registrering.RegistrerVirksomhetModalForm.ModalDescription"}),onClose:o,children:[r.jsx(Xe.Header,{children:r.jsx(ne,{size:"small",children:r.jsx(h,{id:"Registrering.RegistrerVirksomhetModalForm.Title"})})}),r.jsxs(Xe.Body,{children:[r.jsx(li,{readOnly:i,alleKodeverk:g}),r.jsx(gi,{readOnly:i,alleKodeverk:g}),r.jsx(di,{readOnly:i}),r.jsx(oi,{readOnly:i}),r.jsx(y,{sixteenPx:!0}),r.jsx(ui,{readOnly:i}),r.jsx(y,{sixteenPx:!0})]}),r.jsxs(Xe.Footer,{children:[r.jsx(Ke,{size:"small",variant:"primary",onClick:m.handleSubmit(d),disabled:i,className:cs.savebutton,type:"button",children:r.jsx(h,{id:"Registrering.RegistrerVirksomhetModalForm.Save"})}),r.jsx(Ke,{size:"small",variant:"secondary",onClick:o,disabled:i,className:cs.cancelbutton,type:"button",children:r.jsx(h,{id:"Registrering.RegistrerVirksomhetModalForm.Cancel"})})]})]})})};mi.__docgenInfo={description:`RegistrerVirksomhetModalForm
...
Viser inputfelter for tilrettelegging av arbeidsforhold for selvstendig næringsdrivende eller frilans.`,methods:[],displayName:"BehovForTilretteleggingFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"string"},description:""}}};const Ss="tilretteleggingArbeidsforhold",Vs="tilretteleggingForArbeidsgiver",ok={organisasjonsnummer:"",behovsdato:""},Ai=({readOnly:s})=>{const i=H(),{control:o}=Y(),{fields:d,append:g}=fe({control:o,name:`${Ss}.${Vs}`}),k=()=>{g(ok)},v=`${Ss}.${Vs}`;return r.jsx(r.Fragment,{children:d.map((m,f)=>r.jsxs("div",{children:[r.jsx(ee,{children:r.jsxs(L,{children:[r.jsx(q,{children:r.jsx(le,{readOnly:s,name:`${v}.${f}.organisasjonsnummer`,label:i.formatMessage({id:"TilretteleggingForArbeidsgiverFieldArray.OrgNr"}),validate:[A,c=>Qu(c.toString()),eg],maxLength:99})}),r.jsx(q,{children:r.jsx(M,{name:`${v}.${f}.behovsdato`,label:i.formatMessage({id:"TilretteleggingForArbeidsgiverFieldArray.TilretteleggingFra"}),validate:[A],isReadOnly:s})})]})}),r.jsx(y,{sixteenPx:!0}),r.jsx(Zr,{name:`${v}.${f}.${sk}`,readOnly:s}),d.length>f+1&&r.jsxs(r.Fragment,{children:[r.jsx("hr",{}),r.jsx(y,{sixteenPx:!0})]}),d.length===f+1&&r.jsx(Ke,{size:"small",variant:"secondary",onClick:k,type:"button",children:r.jsx(h,{id:"TilretteleggingForArbeidsgiverFieldArray.LeggTilArbeidsgiver"})})]},m.id))})};Ai.__docgenInfo={description:"",methods:[],displayName:"TilretteleggingForArbeidsgiverFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Ie=te(ue),dk="tilretteleggingForArbeidsgiver",ve="tilretteleggingArbeidsforhold",ma=({readOnly:s})=>{var c,R,w,b;const{watch:i,setError:o,clearErrors:d,formState:g}=Y(),k=i(`${ve}.sokForSelvstendigNaringsdrivende`),v=i(`${ve}.sokForFrilans`),m=i(`${ve}.sokForArbeidsgiver`),f=!k&&!v&&!m;return V.useEffect(()=>{f&&o(`${ve}.notRegisteredInput`,{type:"custom",message:Ie.formatMessage({id:"BehovForTilretteleggingPanel.MinstEnMaaVereJa"})}),f||d(`${ve}.notRegisteredInput`)},[f]),r.jsx(ke,{value:Ie,children:r.jsxs(oe,{children:[r.jsx(ne,{size:"small",children:r.jsx(h,{id:"BehovForTilretteleggingPanel.BehovForTilrettelegging"})}),r.jsx(y,{sixteenPx:!0}),g.isSubmitted&&((R=(c=g.errors[ve])==null?void 0:c.notRegisteredInput)==null?void 0:R.message)&&r.jsx(br,{children:(b=(w=g.errors[ve])==null?void 0:w.notRegisteredInput)==null?void 0:b.message}),r.jsx(U,{name:`${ve}.sokForSelvstendigNaringsdrivende`,label:r.jsx(h,{id:"BehovForTilretteleggingPanel.SokForSelvstendigNaringsdrivende"}),validate:[A],isReadOnly:s,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.Ja"}),value:"true"},{label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.Nei"}),value:"false"}]}),r.jsx(y,{sixteenPx:!0}),k&&r.jsxs(de,{children:[r.jsx(M,{name:`${ve}.behovsdatoSN`,label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.TilretteleggingFra"}),validate:[A],isReadOnly:s}),r.jsx(Zr,{name:`${ve}.${ik}`,readOnly:s})]}),r.jsx(U,{name:`${ve}.sokForFrilans`,label:r.jsx(h,{id:"BehovForTilretteleggingPanel.SokForFrilans"}),validate:[A],isReadOnly:s,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.Ja"}),value:"true"},{label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.Nei"}),value:"false"}]}),r.jsx(y,{sixteenPx:!0}),v&&r.jsxs(de,{children:[r.jsx(M,{name:`${ve}.behovsdatoFrilans`,label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.TilretteleggingFra"}),validate:[A],isReadOnly:s}),r.jsx(Zr,{name:`${ve}.${lk}`,readOnly:s})]}),r.jsx(U,{name:`${ve}.sokForArbeidsgiver`,label:r.jsx(h,{id:"BehovForTilretteleggingPanel.SokForArbeidsgiver"}),validate:[A],isReadOnly:s,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.Ja"}),value:"true"},{label:Ie.formatMessage({id:"BehovForTilretteleggingPanel.Nei"}),value:"false"}]}),r.jsx(y,{sixteenPx:!0}),m&&r.jsx(de,{children:r.jsx(Ai,{readOnly:s})})]})})};ma.buildInitialValues=()=>({[ve]:{[dk]:[{}]}});ma.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Za="omsorg",Qa="frilans",pk=s=>({[Qa]:nn.buildInitialValues(),...en.buildInitialValues(s),...Cn.buildInitialValues(),[Za]:{},...ye.buildInitialValues(),...Xn.buildInitialValues()}),vk=(s,i)=>{let o=s;return s.rettigheter===Bn.IKKE_RELEVANT&&(o=Hs(s,"rettigheter")),{...ye.transformValues(o),[Za]:vn.transformValues(o[Za]),[pn]:en.transformValues(o,i),[be]:Xn.transformValues(o),[Qa]:nn.transformValues(o[Qa])}},Pi=({readOnly:s,soknadData:i,alleKodeverk:o,onSubmit:d,onSubmitUfullstendigsoknad:g,fagsakPersonnummer:k,erEndringssøknad:v})=>{const m=fr({defaultValues:V.useMemo(()=>pk(o[Q.ARBEID_TYPE]),[])}),f=o[Q.ARBEID_TYPE],c=m.watch("sokerHarAleneomsorg"),R=m.watch("denAndreForelderenHarRettPaForeldrepenger"),w=!c&&R!==!1,b=m.watch("foedselsDato"),F=m.watch("mottattDato");return r.jsxs(hr,{formMethods:m,onSubmit:T=>d(vk(T,f)),children:[r.jsx(sa,{readOnly:s}),r.jsx(ye,{readOnly:s,erAdopsjon:i.getFamilieHendelseType()!==se.ADOPSJON,alleKodeverk:o,mottattDato:F}),r.jsx(Cn,{readOnly:s,alleKodeverk:o}),r.jsx(ot,{readOnly:s,alleKodeverk:o}),r.jsx(nn,{readOnly:s}),r.jsx(en,{readOnly:s,alleKodeverk:o}),r.jsx(vi,{readOnly:s}),i.getFamilieHendelseType()===se.FODSEL&&r.jsx(lt,{readOnly:s,erForeldrepenger:!0}),r.jsx(la,{readOnly:s,soknadData:i}),r.jsx(vn,{readOnly:s,familieHendelseType:i.getFamilieHendelseType(),fodselsdato:b,isForeldrepengerFagsak:!0}),r.jsx(Ws,{readOnly:s,permisjonRettigheterPanel:r.jsx(ci,{readOnly:s,denAndreForelderenHarRettPaForeldrepenger:R,sokerErMor:i.getForeldreType()===An.MOR}),alleKodeverk:o,fagsakPersonnummer:k}),r.jsx(Xn,{foreldreType:i.getForeldreType(),readOnly:s,alleKodeverk:o,erEndringssøknad:v}),r.jsx(yi,{annenForelderInformertRequired:w,readOnly:s}),r.jsx(Rr,{readOnly:s}),r.jsx(ta,{readOnly:s,onSubmitUfullstendigsoknad:g,submitting:m.formState.isSubmitting})]})};Pi.__docgenInfo={description:`ForeldrepengerForm
...
Readonly<{
  ...
  foreldreType: string,
) => Promise<any>`,signature:{arguments:[{type:{name:"any"},name:"formValues"},{type:{name:"string"},name:"fagsakYtelseType"},{type:{name:"string"},name:"familieHendelseType"},{type:{name:"string"},name:"foreldreType"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const wk="_alertStyle_1d8gt_1",Fk="_modalStyle_1d8gt_6",Pk="_fullWidth_1d8gt_11",_k="_reduceMargin_1d8gt_16",Nk="_left_1d8gt_20",xk="_right_1d8gt_24",In={alertStyle:wk,modalStyle:Fk,fullWidth:Pk,reduceMargin:_k,left:Nk,right:xk},gr=te(Si),Mi=({isOpen:s=!1})=>r.jsx(ke,{value:gr,children:r.jsx(Xe,{className:In.modalStyle,open:s,"aria-label":gr.formatMessage({id:"SoknadRegistrertModal.ContentLabel"}),onClose:()=>{},children:r.jsx(Xe.Body,{children:r.jsxs(ea,{size:"small",variant:"success",className:In.alertStyle,children:[r.jsxs("div",{className:In.left,children:[r.jsx("p",{className:In.reduceMargin,children:gr.formatMessage({id:"SoknadRegistrertModal.InfoTextOne"})}),r.jsx("p",{className:In.reduceMargin,children:gr.formatMessage({id:"SoknadRegistrertModal.InfoTextTwo"})})]}),r.jsx("div",{className:In.right,children:r.jsx(Ks,{to:"/",children:r.jsx(Ke,{size:"small",variant:"primary",children:gr.formatMessage({id:"SoknadRegistrertModal.OkButtonText"})})})})]})})})});Mi.__docgenInfo={description:`SoknadRegistrertModal

Informasjonsmodal som vises til saksbehandler når en papirsøknad har blitt registrert.`,methods:[],displayName:"SoknadRegistrertModal",props:{isOpen:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Ok=s=>s.map(i=>i.definisjon).filter(i=>i===mr.REGISTRER_PAPIRSOKNAD_ENGANGSSTONAD||i===mr.REGISTRER_PAPIRSOKNAD_FORELDREPENGER||i===mr.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER||i===mr.REGISTRER_PAPIRSOKNAD_SVANGERSKAPSPENGER)[0],Sk=(s,i,o,d)=>(g,k,v,m)=>{const f=[{"@type":Ok(s.aksjonspunkt),tema:v,soknadstype:k,soker:m,...g}],c={saksnummer:i.saksnummer,behandlingUuid:s.uuid,behandlingVersjon:s.versjon,bekreftedeAksjonspunktDtoer:f};return o(c).then(R=>{var w;((w=R==null?void 0:R.taskStatus)==null?void 0:w.status)!==ig.HALTED&&d(!0)})},Ei=({fagsak:s,behandling:i,kodeverk:o,rettigheter:d,lagreAksjonspunkt:g})=>{const[k,v]=V.useState(!1),m=!d.writeAccess.isEnabled||i.behandlingPaaVent,f=V.useMemo(()=>Sk(i,s,g,v),[i,s,g,v]),c=V.useCallback((F,T,x)=>f({ufullstendigSoeknad:!0},F,T,x),[f]),R=ng(),w=V.useCallback(()=>{R("/")},[]);if(!i.aksjonspunkt)return r.jsx(Uu,{});const b=i.aksjonspunkt.some(F=>F.definisjon===mr.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER);return r.jsxs(r.Fragment,{children:[r.jsx(rg,{behandling:i,kodeverk:o,opneSokeside:w}),r.jsx(Mi,{isOpen:k}),r.jsx(Vi,{fagsak:s,kodeverk:o,readOnly:m,lagreUfullstendig:c,lagreFullstendig:f,erEndringssøknad:b})]})};Ei.__docgenInfo={description:`RegisterPapirsoknad
