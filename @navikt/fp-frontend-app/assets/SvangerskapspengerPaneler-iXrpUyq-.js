...
Readonly<{
  ...
  status: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"aksjonspunktTekst",value:{name:"string",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!0}},{key:"status",value:{name:"string",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""},erPanelValgt:{required:!0,tsType:{name:"boolean"},description:""},harInngangsvilkarApentAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""}}};const ft=[c.VURDER_OPPTJENINGSVILKARET],Fe=[ee.OPPTJENINGSPERIODE,ee.OPPTJENINGSVILKARET],qt=[P.OPPTJENING],dn=({behandlingVersjon:n,rettigheter:r,...t})=>{const a=S();return e.jsx(Ee,{...t,behandlingVersjon:n,panelEndepunkter:qt,aksjonspunktKoder:ft,vilkarKoder:Fe,inngangsvilkarPanelKode:"OPPTJENINGSVILKARET",hentInngangsvilkarPanelTekst:()=>a.formatMessage({id:"OpptjeningVilkarView.VurderOmSøkerHarRett"}),renderPanel:(s,i,g)=>e.jsxs(e.Fragment,{children:[s.aksjonspunkter.length===0&&e.jsxs(e.Fragment,{children:[e.jsx(qn,{aksjonspunkter:s.aksjonspunkter,aksjonspunktKode:c.OVERSTYRING_AV_OPPTJENINGSVILKARET,vilkar:s.vilkar,vilkarKoder:Fe,panelTekstKode:"Inngangsvilkar.Opptjeningsvilkaret",erMedlemskapsPanel:!1,toggleOverstyring:g,erOverstyrt:i,overrideReadOnly:s.isReadOnly||t.harInngangsvilkarApentAksjonspunkt&&!(s.isAksjonspunktOpen||i),kanOverstyreAccess:r.kanOverstyreAccess}),e.jsx(q,{thirtyTwoPx:!0})]}),s.aksjonspunkter.length>0&&e.jsxs(e.Fragment,{children:[e.jsx(Sn,{erSvpFagsak:!0,lovReferanse:s.vilkar[0].lovReferanse,...s}),e.jsx(q,{thirtyTwoPx:!0})]})]})})};dn.__docgenInfo={description:"",methods:[],displayName:"OpptjeningInngangsvilkarInitPanel",props:{behandlingVersjon:{required:!0,tsType:{name:"number"},description:""},rettigheter:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  writeAccess: Aksess;
