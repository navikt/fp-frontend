import{j as E}from"./index.es-F0qSFwOk.js";import{R as S}from"./useRestApiRunner-TTpw9JJv.js";import{r as d}from"./index-DogsOklH.js";import{S as K,R as O,r as w}from"./AppIndex.stories-9OsSP8Ou.js";import{b as B,H as V,x as v,E as D}from"./index.es-tCBKjOwM.js";import{K as U}from"./index.es-eBKYcsqQ.js";import{P as L}from"./BehandlingHenlagtPanel-Zz_MIhhD.js";const A={MANUELL:"MANU",AUTOPUNKT:"AUTO",OVERSTYRING:"OVST",SAKSBEHANDLEROVERSTYRING:"SAOV"},F={OPPFYLT:"OPPFYLT",IKKE_OPPFYLT:"IKKE_OPPFYLT",IKKE_VURDERT:"IKKE_VURDERT"},N=a=>a.taskStatus&&a.taskStatus.readOnly?a.taskStatus.readOnly:!1,_=(a,r,t,e)=>{const{behandlingPaaVent:g}=a,n=e||N(a),l=r.some(i=>!i.overstyrbar);return!t.writeAccess.isEnabled||g||n||l},M=(a,r)=>a.status!==B.BEHANDLING_UTREDES?{}:r.reduce((t,e)=>({...t,[e.definisjon]:{notAccepted:e.toTrinnsBehandling&&e.toTrinnsBehandlingGodkjent===!1}}),{}),I="default",Y="default",H=(a,r,t,e,g,n)=>l=>{const i=Array.isArray(l)?l:[l],s=i.map(o=>({"@type":o.kode,...o})),k={saksnummer:r.saksnummer,behandlingUuid:t.uuid,behandlingVersjon:t.versjon},m=a(i);if(n){const o=e.filter(p=>i.some(y=>y.kode===p.definisjon)),f=o.some(p=>p.aksjonspunktType===A.OVERSTYRING||p.aksjonspunktType===A.SAKSBEHANDLEROVERSTYRING);if(i.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(o.length===0||f)return n({...k,overstyrteAksjonspunktDtoer:s},!0).then(m)}return g({...k,bekreftedeAksjonspunktDtoer:s},!0).then(m)},C=(a,r)=>{if(a.length>0){const t=a.map(e=>e.vilkarStatus);return t.some(e=>e===v.IKKE_VURDERT)?v.IKKE_VURDERT:t.every(e=>e===v.OPPFYLT)?v.OPPFYLT:v.IKKE_OPPFYLT}return r.length>0?r.some(t=>D(t.status))?v.IKKE_VURDERT:v.OPPFYLT:v.IKKE_VURDERT},G=(a,r,t)=>{const[e,g]=d.useState(),n=d.useContext(K),{aksjonspunkt:l,vilkår:i}=n.behandling;d.useEffect(()=>{e&&g(void 0)},[n.behandling.versjon]);const s=d.useMemo(()=>l&&a?l.filter(u=>a.includes(u.definisjon)):[],[l,a]),k=d.useMemo(()=>i&&r?i.filter(u=>r.includes(u.vilkarType)):[],[i,r]),m=_(n.behandling,k,n.rettigheter,n.hasFetchError),o=d.useMemo(()=>M(n.behandling,s),[n.behandling.versjon,s]),f=s.some(u=>u.status===V.OPPRETTET&&u.kanLoses),p=d.useMemo(()=>C(k,s),[k,s]),y=!s.some(u=>u.kanLoses)||v.OPPFYLT===p,b=d.useCallback(()=>()=>{n.oppdaterProsessStegOgFaktaPanelIUrl(Y,I)},[]),h=d.useMemo(()=>H(t||b,n.fagsak,n.behandling,s,n.lagreAksjonspunkter,n.lagreOverstyrteAksjonspunkter),[n.behandling.versjon,s]);return{behandling:n.behandling,isAksjonspunktOpen:f,aksjonspunkter:s,vilkar:k,alleKodeverk:n.alleKodeverk,alleMerknaderFraBeslutter:o,isReadOnly:m,readOnlySubmitButton:y,submitCallback:h,status:p,formData:e,setFormData:g}},x="default",W=(a,r,t,e,g,n,l,i)=>{const[s,k]=d.useState(!1);d.useEffect(()=>{a({id:r})},[]);const m=e&&(i===r||l&&i===x),o=U(e);return d.useEffect(()=>{e?a({id:r,tekst:t,erAktiv:m,harApentAksjonspunkt:g,status:n}):!e&&o&&a({id:r}),k(m)},[e,o,m,g,n]),e&&s},z=({valgtProsessSteg:a,behandling:r,registrerProsessPanel:t,panelEndepunkter:e=[],aksjonspunktKoder:g,vilkarKoder:n,skalPanelVisesIMeny:l,renderPanel:i,prosessPanelKode:s,prosessPanelMenyTekst:k,lagringSideEffekter:m,hentOverstyrtStatus:o,erOverstyrt:f=!1,hentSkalMarkeresSomAktiv:p})=>{const y=G(g,n,m),b=o?o(y):y.status,h=p&&p(y)&&!r.behandlingHenlagt,u=f||y.isAksjonspunktOpen,c=W(t,s,k,l(y),u,b,h||u,a),q=e.map(P=>P instanceof O?{key:P}:P),T=!c||q.length===0||b===F.IKKE_VURDERT&&!u,{data:R,state:j}=w.useMultipleRestApi(q,{updateTriggers:[c,r.versjon,b,u],suspendRequest:T,isCachingOn:!0});return E.jsx(L,{erPanelValgt:c,erAksjonspunktOpent:y.isAksjonspunktOpen,status:b,dataState:q.length>0?j:S.SUCCESS,children:i({...R,...y})})};z.__docgenInfo={description:"",methods:[],displayName:"ProsessDefaultInitPanel",props:{panelEndepunkter:{required:!1,tsType:{name:"union",raw:"RestKey<any, any>[] | { key: RestKey<any, any>; params?: any }[]",elements:[{name:"Array",elements:[{name:"RestKey",elements:[{name:"any"},{name:"any"}],raw:"RestKey<any, any>"}],raw:"RestKey<any, any>[]"},{name:"Array",elements:[{name:"signature",type:"object",raw:"{ key: RestKey<any, any>; params?: any }",signature:{properties:[{key:"key",value:{name:"RestKey",elements:[{name:"any"},{name:"any"}],raw:"RestKey<any, any>",required:!0}},{key:"params",value:{name:"any",required:!1}}]}}],raw:"{ key: RestKey<any, any>; params?: any }[]"}]},description:"",defaultValue:{value:"[]",computed:!1}},aksjonspunktKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},vilkarKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: StandardProsessPanelProps) => boolean",signature:{arguments:[{type:{name:"StandardProsessPanelProps"},name:"data"}],return:{name:"boolean"}}},description:""},hentOverstyrtStatus:{required:!1,tsType:{name:"signature",type:"function",raw:"(standardData: StandardProsessPanelProps) => string",signature:{arguments:[{type:{name:"StandardProsessPanelProps"},name:"standardData"}],return:{name:"string"}}},description:""},renderPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: PANEL_DATA & StandardProsessPanelProps) => ReactElement",signature:{arguments:[{type:{name:"intersection",raw:"PANEL_DATA & StandardProsessPanelProps",elements:[{name:"PANEL_DATA"},{name:"StandardProsessPanelProps"}]},name:"data"}],return:{name:"ReactElement"}}},description:""},prosessPanelKode:{required:!0,tsType:{name:"ProsessStegCode"},description:""},prosessPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},lagringSideEffekter:{required:!1,tsType:{name:"signature",type:"function",raw:"(aksjonspunktModeller: any) => () => void",signature:{arguments:[{type:{name:"any"},name:"aksjonspunktModeller"}],return:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}}}},description:""},erOverstyrt:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},hentSkalMarkeresSomAktiv:{required:!1,tsType:{name:"signature",type:"function",raw:"(standardData: StandardProsessPanelProps) => boolean",signature:{arguments:[{type:{name:"StandardProsessPanelProps"},name:"standardData"}],return:{name:"boolean"}}},description:""},behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  ...
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};export{z as P,W as a,_ as e,M as g,G as u,F as v};
