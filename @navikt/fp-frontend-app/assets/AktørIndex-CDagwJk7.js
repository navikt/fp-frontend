import{j as e,h as g,P as y,L as p}from"./iframe-CV_Hmyy8.js";import{r as v,X as f}from"./index.es-TTvnTWWZ.js";import{u as q,r as j}from"./fagsakApi-BvggaIfg.js";import{V as w}from"./VisittkortSakIndex-Dreh5uMY.js";import{V as c,a as I,B as T}from"./VStack-Bv5rBkCi.js";import{M as k}from"./message-BCcn_Hah.js";import{E as F}from"./IngenBehandlingValgtPanel-C-hbAP3Q.js";import{u as R}from"./useTrackRouteParam-uhxPcZ-R.js";import{p as E}from"./paths-CoJHJN6e.js";import{u as o}from"./useKodeverk-D_JgFByH.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(w,{bruker:n.person}),e.jsx(c,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
