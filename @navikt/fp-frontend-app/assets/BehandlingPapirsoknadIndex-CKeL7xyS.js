...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const un=`${j}.${ln}`,Re=r=>`${un}.${r}`,wn=r=>()=>{const a=(r(`${un}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Me(a):void 0},Nn={periodeFom:"",periodeTom:"",årsak:""},Mt=[pr.UTTAK_MØDREKVOTE_ANNEN_FORELDER,pr.UTTAK_FEDREKVOTE_ANNEN_FORELDER,pr.UTTAK_FELLESP_ANNEN_FORELDER,pr.UTTAK_FORELDREPENGER_ANNEN_FORELDER],Dt=r=>r.filter(({kode:n})=>Mt.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),sa=({oppholdsReasons:r,readOnly:n})=>{const a=h(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:o}}=A(),{fields:l,remove:g,append:u}=z({control:t,name:`${un}`});return q.useEffect(()=>{l.length===0&&u(Nn)},[]),e.jsx(se,{fields:l,emptyPeriodTemplate:Nn,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,append:u,remove:g,children:(k,d)=>e.jsxs(be,{readOnly:n,remove:g,index:d,children:[e.jsx(b,{name:`${Re(d)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,F,()=>{const y=s(`${Re(d)}.periodeFom`),v=s(`${Re(d)}.periodeTom`);return v&&y?U(v)(y):null},wn(s)],onChange:()=>o?i():void 0}),e.jsx(b,{name:`${Re(d)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,F,()=>{const y=s(`${Re(d)}.periodeFom`),v=s(`${Re(d)}.periodeTom`);return v&&y?x(y)(v):null},wn(s)],onChange:()=>o?i():void 0}),e.jsx("div",{children:e.jsx(Y,{name:`${Re(d)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:Dt(r),validate:[p]})})]},k.id)})};sa.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const xt=(r,n,a)=>n===dr.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?r.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):n===dr.SYKDOM_ANNEN_FORELDER?r.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):a,Kt=(r,n,a,t)=>r.filter(({kode:s})=>a||s!==dr.ALENEOMSORG&&s!==dr.IKKE_RETT_ANNEN_FORELDER).map(({kode:s,navn:i})=>n?e.jsx("option",{value:s,children:i},s):e.jsx("option",{value:s,children:xt(t,s,i)},s)),Hr=({foreldreType:r,alleKodeverk:n,readOnly:a,erEndringssøknad:t})=>{const s=h(),i=n[K.OVERFOERING_AARSAK_TYPE],o=Kt(i,r===Te.MOR,t,s),{watch:l}=A(),g=l(`${j}.skalOvertaKvote`)||!1;return e.jsxs(R,{gap:"2",children:[e.jsx(ce,{children:e.jsx(m,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),e.jsx(Q,{readOnly:a,name:`${j}.skalOvertaKvote`,label:e.jsx(m,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),g&&e.jsx(ia,{selectValues:o,readOnly:a})]})};Hr.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});Hr.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Bt=N(O),ze=({foreldreType:r,readOnly:n,alleKodeverk:a,erEndringssøknad:t})=>e.jsx(X,{value:Bt,children:e.jsx(Xe,{readOnly:n,foreldreType:r,alleKodeverk:a,erEndringssøknad:t})});ze.transformValues=Xe.transformValues;ze.initialValues=Xe.initialValues;ze.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
