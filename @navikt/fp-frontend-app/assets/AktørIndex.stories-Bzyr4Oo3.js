import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{w as A,M as C,R as U,a as w,F as I}from"./withPanelData-CsqbhLo5.js";import{r as P}from"./index.es-DSM9FLKG.js";import{u as c,a as x,F as s,i,w as D,n as v,b as L,c as F}from"./fagsakApi-Dbw7rjRN.js";import{h as t,H as e,c as S}from"./index-Cg096ojA.js";import{F as d}from"./fagsakStatus-NXwGwLtb.js";import{a as g}from"./alleKodeverk-BGvpDL3l.js";import{K as b}from"./Kjonnkode-C-fkzSiP.js";import{i as k}from"./initFetchFptilbake-CspdHVpU.js";import{A as T}from"./AktørIndex-Cn7uRyvE.js";import"./index-mMUbb89k.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D4MMZV7Z.js";import"./index-0CCRSEf1.js";import"./v4-CtRu48qb.js";import"./entry-preview-CqXOzLz1.js";import"./iframe-OBY5t3Tg.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-DtNjo1hO.js";import"./index-CXQShRbs.js";import"./dayjs.min-Cke173X9.js";import"./CheckmarkCircleFill-CPBt4o6Z.js";import"./ExclamationmarkTriangleFill-DXdjBwoq.js";import"./decorators-Bnaor6Ku.js";import"./VisittkortSakIndex-BFCJggzl.js";import"./index.es-939H5FlU.js";import"./Link-n8-25l5v.js";import"./Tooltip-C9metaBB.js";import"./Checkmark-layTVeeY.js";import"./Popover-M1tk0wDv.js";import"./message-FsWhrVPj.js";import"./Tag-CVw4bjlR.js";import"./Spacer-Dsafd-H5.js";import"./IngenBehandlingValgtPanel-D45BNtpN.js";import"./useTrackRouteParam-B6cZihzz.js";import"./paths-DMfsIPIy.js";import"./useKodeverk-P7HsZp7g.js";const E=m=>S(D(v(i.links.find(l=>l.rel===m)).href)),p={navn:"Espen Utvikler",fødselsnummer:"11111111111",kjønn:b.MANN,fødselsdato:"2000-01-02",dødsdato:null,aktørId:"22222222"},y={fagsaker:[{saksnummer:"123",fagsakYtelseType:I.FORELDREPENGER,status:d.OPPRETTET,aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p},{saksnummer:"252523",fagsakYtelseType:I.ENGANGSSTONAD,status:d.LOPENDE,aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p}],person:p},jt={title:"app/AktørIndex",decorators:[A],component:T,render:()=>{const{status:m}=c(L()),{kodeverkOptions:l}=x(),{data:O}=c(l(m==="success"));return O?r.jsx(C,{initialEntries:["/fagsak/352011079"],children:r.jsx(U,{children:r.jsx(w,{element:r.jsx(T,{}),path:"/fagsak/:aktoerId"})})}):r.jsx(P,{})}},a={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>e.json(y))]}}},o={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>e.json({fagsaker:[],person:{...p,aktørId:null}}))]}}},n={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>new e(null,{status:500}))]}}};var R,u,h;a.parameters={...a.parameters,docs:{...(R=a.parameters)==null?void 0:R.docs,source:{originalSource:`{
  parameters: {
    msw: {
