import{j as E}from"./jsx-runtime-DR9Q75dM.js";import{R as ue,r as c}from"./index-DRjF_FHU.js";import{H as Or,m as le,S as Ge,h as qe,x as ie,I as re,E as Vr,X as bn,Y as _r,b as Ir}from"./index.es-zhgnUGpN.js";import{U as Tn,M as p,y as j,c as cn,P as Jn,d as Wn,A as Pn,X as Sn,J as Zn,e as xn,x as Qe,f as M,O as Te,z as wr,S as Nr,F as Dr}from"./index.es-BiksuNaP.js";import{F as Kr,V as Mr}from"./VergeFaktaInitPanel-CU_ESOit.js";import{B as Ur}from"./BehandlingContainer-CIkXUNx2.js";import{t as an,P as tn,f as Le,H as ge,B as q,a as G,b as U,V as Gr,d as F,c as I,L as z,g as Xn,h as Qn,R as C,i as Z,G as je,M as de,A as er,D as J,C as nr,E as Lr,j as $r,x as Cr}from"./index.es-CQVjxYGZ.js";import{Y as qn,d as Fe,$ as Be,A as ke,H as _,a as me,k as oe,P as en,g as nn,p as Hr,f as rr,h as sn,i as ln,j as Re,e as Se,n as ce,c as ar,l as tr,U as sr,D as ir,r as An,B as X,m as Rn,o as lr,K as or,M as rn,q as yn,s as $,t as dr,u as Ce,L as zr,w as ur,v as Yr,E as Ye,x as Jr,y as Wr,F as Zr,z as Xr,C as Qr,G as ea}from"./AppIndex.stories-BhgIhfNw.js";import{T as Ae,S as gr,a as kr,b as mr}from"./Timeline-CETmJKYQ.js";import{S as vr,a as pr,b as na}from"./index.es-5Xk-Uc_M.js";import{S as br}from"./FigureCombination-NmLJRrtn.js";import{P as Fn}from"./ProsessDefaultInitPanel-BGGJEiS5.js";import{F as ra}from"./FatterVedtakStatusModal-CQkufdHh.js";import"./bind-BilxuNmH.js";import"./useRestApiRunner-BKOIDkPf.js";import"./BehandlingHenlagtPanel-DAPqDV4i.js";import"./index-rX-Bn4lm.js";import"./iframe-B_nxX4y7.js";import"../sb-preview/runtime.js";import"./SettPaVentReadOnlyModal-SXefeS1t.js";import"./nb_NO-CLehlXOw.js";const gn={INGEN_TILBAKEBETALING:"INGEN_TILBAKEBETALING",DELVIS_TILBAKEBETALING:"DELVIS_TILBAKEBETALING",FULL_TILBAKEBETALING:"FULL_TILBAKEBETALING"};var on=(e=>(e.VURDER_FORELDELSE="5003",e))(on||{}),yr={exports:{}},we={};/**
 * @license React
...
Readonly<{
  ...
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};var dn=(e=>(e.VURDER_TILBAKEKREVING="5002",e))(dn||{}),hr={exports:{}},Ne={};/**
 * @license React
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};var Bn=(e=>(e.FORESLA_VEDTAK="5004",e))(Bn||{}),xr={exports:{}},Ke={};/**
 * @license React
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ln;function Fs(){if(Ln)return Ke;Ln=1;var e=ue,r=Symbol.for("react.element"),a=Symbol.for("react.fragment"),t=Object.prototype.hasOwnProperty,s=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,o={key:!0,ref:!0,__self:!0,__source:!0};function i(g,m,y){var u,l={},v=null,d=null;y!==void 0&&(v=""+y),m.key!==void 0&&(v=""+m.key),m.ref!==void 0&&(d=m.ref);for(u in m)t.call(m,u)&&!o.hasOwnProperty(u)&&(l[u]=m[u]);if(g&&g.defaultProps)for(u in m=g.defaultProps,m)l[u]===void 0&&(l[u]=m[u]);return{$$typeof:r,type:g,key:v,ref:d,props:l,_owner:s.current}}return Ke.Fragment=a,Ke.jsx=i,Ke.jsxs=i,Ke}xr.exports=Fs();var b=xr.exports;const Bs="_table_gko8z_1",Ss={table:Bs},Es=["TilbakekrevingVedtakPeriodeTabell.Periode","TilbakekrevingVedtakPeriodeTabell.FeilutbetaltBelop","TilbakekrevingVedtakPeriodeTabell.Vurdering","TilbakekrevingVedtakPeriodeTabell.AndelAvBelop","TilbakekrevingVedtakPeriodeTabell.Renter","TilbakekrevingVedtakPeriodeTabell.ForSkatt","TilbakekrevingVedtakPeriodeTabell.BelopSomTilbakekreves"],Os=({perioder:e,kodeverkSamlingFpTilbake:r})=>{const a=e.map(t=>{var s;return b.jsxs(Qe,{children:[b.jsx(M,{children:b.jsx(q,{size:"small",children:b.jsx(wr,{dateStringFom:t.periode.fom,dateStringTom:t.periode.tom})})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:Z(t.feilutbetaltBeløp)})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:(s=r[re.AKTSOMHET].find(o=>o.kode===t.vurdering))==null?void 0:s.navn})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:t.andelAvBeløp!==void 0&&t.andelAvBeløp!==null?`${t.andelAvBeløp}%`:""})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:t.renterProsent?`${t.renterProsent}%`:""})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:Z(t.tilbakekrevingBeløp)})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:Z(t.tilbakekrevingBeløpEtterSkatt)})})]},t.periode.fom)}).concat(b.jsxs(Qe,{children:[b.jsx(M,{children:b.jsx(q,{size:"small",children:b.jsx(p,{id:"TilbakekrevingVedtakPeriodeTabell.Sum"})})}),b.jsx(M,{children:b.jsx(q,{size:"small",children:Z(e.reduce((t,s)=>t+s.feilutbetaltBeløp,0))})}),b.jsx(M,{}),b.jsx(M,{}),b.jsx(M,{}),b.jsx(M,{children:b.jsx(z,{size:"small",children:Z(e.reduce((t,s)=>t+s.tilbakekrevingBeløp,0))})}),b.jsx(M,{children:b.jsx(z,{size:"small",children:Z(e.reduce((t,s)=>t+s.tilbakekrevingBeløpEtterSkatt,0))})})]},"sum"));return b.jsx("div",{className:Ss.table,children:b.jsx(xn,{noHover:!0,headerTextCodes:Es,children:a})})},W={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"},Vs="_addCircleIcon_84ecs_1",_s="_imageText_84ecs_7",Is="_addPeriode_84ecs_12",vn={addCircleIcon:Vs,imageText:_s,addPeriode:Is},qr=Se(3),ws=ce(4e3),Ns=[qr,me],Ds=[_,qr,me],Ks=({type:e,readOnly:r,fritekstPakrevet:a,maximumLength:t})=>{const s=G(),{watch:o}=Ce(),i=o(e)===void 0,[g,m]=c.useState(i&&!a),y=a?Ds:Ns;return y.push(t?ce(t):ws),b.jsxs(b.Fragment,{children:[g&&!r&&b.jsxs(b.Fragment,{children:[b.jsx(j,{eightPx:!0}),b.jsxs("div",{onClick:u=>{u.preventDefault(),m(!1)},onKeyDown:u=>{u.preventDefault(),m(!1)},className:vn.addPeriode,role:"button",tabIndex:0,children:[b.jsx(Jr,{className:vn.addCircleIcon,title:s.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),b.jsx(J,{size:"small",className:vn.imageText,children:b.jsx(p,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})]}),!g&&b.jsxs(b.Fragment,{children:[b.jsx(j,{eightPx:!0}),b.jsx(ke,{name:e,label:s.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:y,maxLength:t||4e3,readOnly:r})]})]})},Ms="_container_aetpe_1",Us="_gulmarkering_aetpe_4",$n={container:Ms,gulmarkering:Us},jn=({intl:e,vedtaksbrevAvsnitt:r,readOnly:a,perioderSomIkkeHarUtfyltObligatoriskVerdi:t,fritekstOppsummeringPakrevdMenIkkeUtfylt:s=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:o})=>b.jsxs("div",{className:$n.container,children:[b.jsx(j,{twentyPx:!0}),b.jsx(ge,{size:"small",children:b.jsx(p,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),b.jsx(j,{eightPx:!0}),r.map(i=>{const g=i.underavsnittsliste,m=`${i.fom}_${i.tom}`,y=t.some(l=>l===m),u=i.avsnittstype===W.OPPSUMMERING&&s;return b.jsxs(ue.Fragment,{children:[b.jsxs(Ye,{"aria-label":"periode",defaultOpen:y||u,className:y||u?$n.gulmarkering:"",children:[b.jsx(Ye.Header,{children:b.jsx(Ye.Title,{size:"small",children:i.overskrift?i.overskrift:e.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),b.jsx(Ye.Content,{children:g.map(l=>b.jsxs(ue.Fragment,{children:[l.overskrift&&b.jsx(z,{size:"small",children:l.overskrift}),l.brødtekst&&b.jsx(q,{size:"small",children:l.brødtekst}),l.fritekstTillatt&&b.jsxs(b.Fragment,{children:[b.jsx(j,{eightPx:!0}),b.jsx(Ks,{type:l.underavsnittstype?`${m}.${l.underavsnittstype}`:i.avsnittstype,readOnly:a,fritekstPakrevet:l.fritekstPåkrevet,maximumLength:o?1e4:void 0})]}),b.jsx(j,{eightPx:!0})]},(l.underavsnittstype||"")+l.overskrift+l.brødtekst))})]}),b.jsx(j,{eightPx:!0})]},i.avsnittstype+i.fom)})]});jn.buildInitialValues=e=>e.filter(r=>r.underavsnittsliste.some(a=>a.fritekst)).reduce((r,a)=>{const t=a.underavsnittsliste.filter(o=>o.fritekst).reduce((o,i)=>({...o,[i.underavsnittstype?i.underavsnittstype:a.avsnittstype]:je(i.fritekst)}),{}),s=a.fom?{[`${a.fom}_${a.tom}`]:t}:t;return{...r,...s}},{});const Gs="_buttonLink_sudxz_1",Ls="_padding_sudxz_8",$s="_infoTextContainer_sudxz_11",Cs="_infoTextIconColumn_sudxz_14",Hs="_infoTextIcon_sudxz_14",zs="_infotextColumn_sudxz_26",pn={buttonLink:Gs,padding:Ls,infoTextContainer:$s,infoTextIconColumn:Cs,infoTextIcon:Hs,infotextColumn:zs},Ar=e=>{const r=$r(e,W.OPPSUMMERING);return{oppsummeringstekst:e[W.OPPSUMMERING],perioderMedTekst:Object.keys(r).map(a=>({fom:a.split("_")[0],tom:a.split("_")[1],faktaAvsnitt:r[a][W.FAKTA],foreldelseAvsnitt:r[a][W.FORELDELSE],vilkaarAvsnitt:r[a][W.VILKAR],saerligeGrunnerAvsnitt:r[a][W.SARLIGEGRUNNER],saerligeGrunnerAnnetAvsnitt:r[a][W.SARLIGEGRUNNER_ANNET]}))}},Ys=(e,r)=>e.some(a=>a.avsnittstype===W.OPPSUMMERING&&a.underavsnittsliste.some(t=>t.fritekstPåkrevet)&&!r[W.OPPSUMMERING]),Js=e=>({kode:Bn.FORESLA_VEDTAK,...Ar(e)}),Ws=(e,r)=>e.reduce((a,t)=>{const s=`${t.fom}_${t.tom}`,o=r[s];return t.underavsnittsliste.some(i=>i.fritekstPåkrevet&&i.underavsnittstype===W.FAKTA)&&(!o||!o[W.FAKTA])||t.underavsnittsliste.some(i=>i.fritekstPåkrevet&&i.underavsnittstype===W.SARLIGEGRUNNER_ANNET)&&(!o||!o[W.SARLIGEGRUNNER_ANNET])?a.concat(s):a},[]),Cn=(e,r,a)=>t=>{e({uuid:r,...Ar(a)}),t.preventDefault()},Zs=({submitCallback:e,readOnly:r,fetchPreviewVedtaksbrev:a,avsnittsliste:t,behandlingUuid:s,erRevurderingTilbakekrevingKlage:o,erRevurderingTilbakekrevingFeilBeløpBortfalt:i,formData:g,setFormData:m})=>{const y=t,u=c.useMemo(()=>g||jn.buildInitialValues(y),[g,y]),l=G(),v=Fe({defaultValues:u}),d=v.watch(),A=Ys(y,d),f=Ws(y,d),T=A||f.length>0;return b.jsxs(Be,{formMethods:v,onSubmit:S=>e(Js(S)),setDataOnUnmount:m,children:[b.jsx(j,{twentyPx:!0}),b.jsx(jn,{intl:l,vedtaksbrevAvsnitt:y,readOnly:r,perioderSomIkkeHarUtfyltObligatoriskVerdi:c.useMemo(()=>f,[]),fritekstOppsummeringPakrevdMenIkkeUtfylt:A,erRevurderingTilbakekrevingFeilBeløpBortfalt:i}),b.jsx(j,{twentyPx:!0}),b.jsxs(U,{gap:"10",children:[b.jsx(qn,{text:l.formatMessage({id:"TilbakekrevingVedtakForm.TilGodkjenning"}),isReadOnly:r,isSubmittable:f.length===0&&!A,isSubmitting:v.formState.isSubmitting,isDirty:v.formState.isDirty,hasErrors:T}),f.length===0&&b.jsx("div",{className:pn.padding,children:b.jsx("a",{href:"",onClick:Cn(a,s,d),onKeyDown:S=>S.key==="Enter"?Cn(a,s,d)(S):null,className:na(pn.buttonLink,"lenke lenke--frittstaende"),children:b.jsx(p,{id:"TilbakekrevingVedtakForm.ForhandvisBrev"})})})]}),b.jsx(j,{sixteenPx:!0}),o&&b.jsxs(U,{children:[b.jsx(Nr,{className:pn.infoTextIcon}),b.jsx(p,{id:"TilbakekrevingVedtakForm.Infotekst.Klage"})]})]})},Xs=({submitCallback:e,readOnly:r,resultat:a,perioder:t,kodeverkSamlingFpTilbake:s,behandlingUuid:o,avsnittsliste:i,fetchPreviewVedtaksbrev:g,erRevurderingTilbakekrevingKlage:m,erRevurderingTilbakekrevingFeilBeløpBortfalt:y,formData:u,setFormData:l})=>{var v;return b.jsxs(b.Fragment,{children:[b.jsx(ge,{size:"small",children:b.jsx(p,{id:"TilbakekrevingVedtak.Vedtak"})}),b.jsx(j,{twentyPx:!0}),b.jsx(J,{children:b.jsx(p,{id:"TilbakekrevingVedtak.Resultat"})}),b.jsx(q,{size:"small",children:(v=s[re.VEDTAK_RESULTAT_TYPE].find(d=>d.kode===a))==null?void 0:v.navn}),b.jsx(j,{sixteenPx:!0}),b.jsx(Os,{perioder:t,kodeverkSamlingFpTilbake:s}),b.jsx(j,{sixteenPx:!0}),b.jsx(Zs,{submitCallback:e,readOnly:r,behandlingUuid:o,avsnittsliste:i,fetchPreviewVedtaksbrev:g,erRevurderingTilbakekrevingKlage:m,erRevurderingTilbakekrevingFeilBeløpBortfalt:y,formData:u,setFormData:l})]})},Qs={"TilbakekrevingVedtak.Resultat":"Resultat","TilbakekrevingVedtak.Vedtaksbrev":"Vedtaksbrev","TilbakekrevingVedtak.Vedtak":"Vedtak","TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst":"Legg til utdypende tekst","TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst":"Utdypende tekst","TilbakekrevingVedtakPeriodeTabell.Periode":"Periode","TilbakekrevingVedtakPeriodeTabell.FeilutbetaltBelop":"Feilutbetalt beløp","TilbakekrevingVedtakPeriodeTabell.Vurdering":"Vurdering","TilbakekrevingVedtakPeriodeTabell.AndelAvBelop":"Andel av beløp","TilbakekrevingVedtakPeriodeTabell.Renter":"Renter","TilbakekrevingVedtakPeriodeTabell.ForSkatt":"Beløp før skatt","TilbakekrevingVedtakPeriodeTabell.BelopSomTilbakekreves":"Beløp etter skatt","TilbakekrevingVedtakPeriodeTabell.Sum":"Sum","TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift":"Lovhjemler og klagerett","TilbakekrevingVedtakForm.TilGodkjenning":"Til godkjenning","TilbakekrevingVedtakForm.ForhandvisBrev":"Forhåndsvis brev","TilbakekrevingVedtakForm.Infotekst.Klage":"Vedtaksbrev sendes ikke ut fra denne behandlingen, men må sendes av saksbehandler fra klagebehandlingen"},ei=an(Qs),ni=({behandling:e,beregningsresultat:r,isReadOnly:a,submitCallback:t,kodeverkSamlingFpTilbake:s,formData:o,setFormData:i,vedtaksbrev:g,fetchPreviewVedtaksbrev:m,erRevurderingTilbakekrevingKlage:y,erRevurderingTilbakekrevingFeilBeløpBortfalt:u})=>b.jsx(tn,{value:ei,children:b.jsx(Xs,{behandlingUuid:e.uuid,perioder:r.beregningResultatPerioder,resultat:r.vedtakResultatType,avsnittsliste:g.avsnittsliste,submitCallback:t,readOnly:a,kodeverkSamlingFpTilbake:s,fetchPreviewVedtaksbrev:m,erRevurderingTilbakekrevingKlage:y,erRevurderingTilbakekrevingFeilBeløpBortfalt:u,formData:o,setFormData:i})}),ri=[Bn.FORESLA_VEDTAK],ai=[X.VEDTAKSBREV,X.BEREGNINGSRESULTAT],ti=[bn.RE_KLAGE_KA,bn.RE_KLAGE_NFP],si=e=>!!e&&ti.some(r=>r===e),ii=e=>{if(!e)return ie.IKKE_VURDERT;const{type:r}=e;return r===gn.INGEN_TILBAKEBETALING?ie.IKKE_OPPFYLT:r===gn.DELVIS_TILBAKEBETALING||r===gn.FULL_TILBAKEBETALING?ie.OPPFYLT:ie.IKKE_VURDERT},li=e=>()=>()=>{e(!0)},Rr=({tilbakekrevingKodeverk:e,opneSokeside:r,harApenRevurdering:a,...t})=>{const s=G(),[o,i]=c.useState(a),g=c.useCallback(()=>i(!1),[]),[m,y]=c.useState(!1),u=li(y),{startRequest:l}=An.useRestApiRunner(X.PREVIEW_VEDTAKSBREV),v=c.useCallback(T=>l(T).then(Cr),[]),{behandling:d}=t,A=d.førsteÅrsak&&si(d.førsteÅrsak.behandlingArsakType),f=d.førsteÅrsak&&bn.RE_FEILUTBETALT_BELØP_REDUSERT===d.førsteÅrsak.behandlingArsakType;return E.jsxs(E.Fragment,{children:[E.jsx(ra,{visModal:m,lukkModal:()=>{y(!1),r()},tekst:s.formatMessage({id:"FatterTilbakekrevingVedtakStatusModal.Sendt"})}),o&&E.jsx(Zn,{headerText:s.formatMessage({id:"BehandlingTilbakekrevingIndex.ApenRevurderingHeader"}),bodyText:s.formatMessage({id:"BehandlingTilbakekrevingIndex.ApenRevurdering"}),showModal:!0,submit:g}),E.jsx(Fn,{...t,panelEndepunkter:ai,aksjonspunktKoder:ri,prosessPanelKode:Rn.VEDTAK,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.Vedtak"}),skalPanelVisesIMeny:()=>!0,lagringSideEffekter:u,hentOverstyrtStatus:T=>ii(T.behandling.behandlingsresultat),renderPanel:T=>E.jsx(ni,{kodeverkSamlingFpTilbake:e,fetchPreviewVedtaksbrev:v,erRevurderingTilbakekrevingKlage:A||!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:f||!1,...T})})]})};Rr.__docgenInfo={description:"",methods:[],displayName:"VedtakTilbakekrevingProsessInitPanel",props:{tilbakekrevingKodeverk:{required:!0,tsType:{name:"Record",elements:[{name:"tilbakekrevingKodeverkTyper"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};var un=(e=>(e.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",e))(un||{}),Fr={exports:{}},Me={};/**
 * @license React
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hn;function oi(){if(Hn)return Me;Hn=1;var e=ue,r=Symbol.for("react.element"),a=Symbol.for("react.fragment"),t=Object.prototype.hasOwnProperty,s=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,o={key:!0,ref:!0,__self:!0,__source:!0};function i(g,m,y){var u,l={},v=null,d=null;y!==void 0&&(v=""+y),m.key!==void 0&&(v=""+m.key),m.ref!==void 0&&(d=m.ref);for(u in m)t.call(m,u)&&!o.hasOwnProperty(u)&&(l[u]=m[u]);if(g&&g.defaultProps)for(u in m=g.defaultProps,m)l[u]===void 0&&(l[u]=m[u]);return{$$typeof:r,type:g,key:v,ref:d,props:l,_owner:s.current}}return Me.Fragment=a,Me.jsx=i,Me.jsxs=i,Me}Fr.exports=oi();var h=Fr.exports;const di="_feilutbetalingTable_1bepb_1",ui="_redText_1bepb_8",zn={feilutbetalingTable:di,redText:ui},he="perioder",gi=["FeilutbetalingInfoPanel.Period","FeilutbetalingInfoPanel.Hendelse","FeilutbetalingInfoPanel.Beløp"],ki=(e,r)=>{const a=e.find(t=>t.hendelseType===r);return a!=null&&a.hendelseUndertyper&&a.hendelseUndertyper.length>0?a.hendelseUndertyper:void 0},mi=({perioder:e,årsaker:r,readOnly:a,behandlePerioderSamlet:t,kodeverkSamlingFpTilbake:s})=>{const{control:o,watch:i,setValue:g,getValues:m}=Ce(),{fields:y}=Wr({control:o,name:he}),u=(l,v,d)=>{t&&y.forEach((A,f)=>{v!==f&&(d?m(`${he}.${f}.årsak`)===d&&g(`${he}.${f}.${d}.underÅrsak`,l):g(`${he}.${f}.årsak`,l))})};return h.jsx("div",{className:zn.feilutbetalingTable,children:h.jsx(xn,{headerTextCodes:gi,noHover:!0,children:y.map((l,v)=>{const d=i(`${he}.${v}.årsak`),A=ki(r,d);return h.jsxs(Qe,{children:[h.jsx(M,{children:`${$(l.fom).format(C)} - ${$(l.tom).format(C)}`}),h.jsxs(M,{children:[h.jsx(rn,{name:`${he}.${v}.årsak`,selectValues:r.map(f=>{var T;return h.jsx("option",{value:f.hendelseType,children:(T=s[re.HENDELSE_TYPE].find(S=>S.kode===f.hendelseType))==null?void 0:T.navn},f.hendelseType)}),validate:[_],disabled:a,onChange:f=>u(f.target.value,v),label:""}),A&&h.jsx(rn,{name:`${he}.${v}.${d}.underÅrsak`,selectValues:A.map(f=>{var T;return h.jsx("option",{value:f,children:(T=s[re.HENDELSE_UNDERTYPE].find(S=>S.kode===f))==null?void 0:T.navn},f)}),validate:[_],disabled:a,onChange:f=>u(f.target.value,v,d),label:""})]}),h.jsx(M,{className:zn.redText,children:e?e[v].belop:null})]},l.id)})})})},vi="_textarea_14pq5_1",pi="_textPadding_14pq5_4",bi="_redText_14pq5_7",Yn={textarea:vi,textPadding:pi,redText:bi},yi=Se(3),Br=4e3,fi=ce(Br),Sr=e=>e.behandlingFakta.perioder?[...e.behandlingFakta.perioder].sort((r,a)=>$(r.fom).diff($(a.fom))):[],hi=e=>{const{behandlingFakta:{begrunnelse:r}}=e;return{begrunnelse:je(r),perioder:Sr(e).map(a=>{const{fom:t,tom:s,feilutbetalingÅrsakDto:o}=a,i={fom:t,tom:s};if(!o)return i;const{hendelseType:g,hendelseUndertype:m}=o;return{...i,årsak:g,[g]:{underÅrsak:m||null}}})}},ji=(e,r)=>{const a=e.perioder.map(t=>{const s=r.find(i=>i.hendelseType===t.årsak),o=s!=null&&s.hendelseUndertyper?s.hendelseUndertyper.find(i=>{var g;return i===((g=t[t.årsak])==null?void 0:g.underÅrsak)}):void 0;return{fom:t.fom,tom:t.tom,årsak:{hendelseType:s==null?void 0:s.hendelseType,hendelseUndertype:o}}});return{kode:un.AVKLAR_FAKTA_FOR_FEILUTBETALING,begrunnelse:e.begrunnelse,feilutbetalingFakta:a}},Ti=(e,r)=>{const{hendelseTyper:a}=e;return a.sort((t,s)=>{var o,i;const g=((o=r[re.HENDELSE_TYPE].find(d=>d.kode===t.hendelseType))==null?void 0:o.navn)||"",m=((i=r[re.HENDELSE_TYPE].find(d=>d.kode===s.hendelseType))==null?void 0:i.navn)||"",y=g.startsWith("§"),u=m.startsWith("§"),l=y?g.replace(/\D/g,""):g,v=u?m.replace(/\D/g,""):m;return y&&u?l-v:l.localeCompare(v)})},ci=({hasOpenAksjonspunkter:e,feilutbetalingAarsak:r,feilutbetalingFakta:a,readOnly:t,alleMerknaderFraBeslutter:s,kodeverkSamlingFpTilbake:o,kodeverkSamlingFpsak:i,formData:g,setFormData:m,submitCallback:y})=>{var u,l;const v=G(),d=a.behandlingFakta,A=hi(a),f=Fe({defaultValues:g||A}),T=f.watch("behandlePerioderSamlet")||!1,S=Ti(r,o);return h.jsxs(h.Fragment,{children:[h.jsx(cn,{isAksjonspunktOpen:e,children:[h.jsx(p,{id:"FeilutbetalingInfoPanel.Aksjonspunkt"},"1")]}),h.jsx(j,{sixteenPx:!0}),h.jsxs(Be,{formMethods:f,onSubmit:V=>y(ji(V,S)),setDataOnUnmount:m,children:[h.jsxs(U,{gap:"10",wrap:!0,children:[h.jsxs("div",{children:[h.jsx(z,{size:"small",children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Feilutbetaling"})}),h.jsx(j,{sixteenPx:!0}),h.jsxs(U,{justify:"space-between",children:[h.jsxs("div",{children:[h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.PeriodeMedFeilutbetaling"})}),h.jsx(q,{size:"small",children:`${$(d.totalPeriodeFom).format(C)} - ${$(d.totalPeriodeTom).format(C)}`})]}),h.jsxs("div",{children:[h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.FeilutbetaltBeløp"})}),h.jsx(q,{size:"small",className:Yn.redText,children:d.aktuellFeilUtbetaltBeløp})]}),h.jsxs("div",{children:[h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.TidligereVarseltBeløp"})}),h.jsx(q,{size:"small",children:d.tidligereVarseltBeløp?d.tidligereVarseltBeløp:h.jsx(p,{id:"FeilutbetalingInfoPanel.IkkeVarslet"})})]})]}),h.jsx(j,{sixteenPx:!0}),h.jsx(ur,{name:"behandlePerioderSamlet",label:v.formatMessage({id:"FeilutbetalingInfoPanel.BehandlePerioderSamlet"}),readOnly:t}),h.jsx(j,{sixteenPx:!0}),h.jsx(Tn,{merknaderFraBeslutter:s[un.AVKLAR_FAKTA_FOR_FEILUTBETALING],withoutBorder:!0,children:h.jsx(mi,{perioder:Sr(a),behandlePerioderSamlet:T,årsaker:S,readOnly:t,kodeverkSamlingFpTilbake:o})})]}),h.jsxs("div",{children:[h.jsx(z,{size:"small",children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Revurdering"})}),h.jsx(j,{sixteenPx:!0}),h.jsxs(U,{gap:"4",children:[h.jsxs("div",{children:[h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Årsaker"})}),d.behandlingÅrsaker&&h.jsx(q,{size:"small",children:d.behandlingÅrsaker.map(V=>{var x;return(x=i[re.BEHANDLING_AARSAK].find(P=>P.kode===V.behandlingArsakType))==null?void 0:x.navn}).join(", ")})]}),d.datoForRevurderingsvedtak&&h.jsxs("div",{children:[h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.DatoForRevurdering"})}),h.jsx(q,{size:"small",children:$(d.datoForRevurderingsvedtak).format(C)})]})]}),h.jsx(j,{sixteenPx:!0}),h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Resultat"})}),d.behandlingsresultat&&h.jsx(q,{size:"small",children:(u=i[re.BEHANDLING_AARSAK].find(V=>{var x;return V.kode===((x=d.behandlingsresultat)==null?void 0:x.type)}))==null?void 0:u.navn}),h.jsx(j,{sixteenPx:!0}),h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Konsekvens"})}),d.behandlingsresultat&&h.jsx(q,{size:"small",children:d.behandlingsresultat.konsekvenserForYtelsen.map(V=>{var x;return(x=i[re.KONSEKVENS_FOR_YTELSEN].find(P=>P.kode===V))==null?void 0:x.navn}).join(", ")}),h.jsx(j,{sixteenPx:!0}),h.jsx(J,{children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Tilbakekrevingsvalg"})}),d.tilbakekrevingValg&&h.jsx(q,{size:"small",children:(l=o[re.TILBAKEKR_VIDERE_BEH].find(V=>{var x;return V.kode===((x=d.tilbakekrevingValg)==null?void 0:x.videreBehandling)}))==null?void 0:l.navn})]})]}),h.jsx(j,{sixteenPx:!0}),h.jsx("div",{className:Yn.textarea,children:h.jsx(ke,{name:"begrunnelse",label:v.formatMessage({id:"FeilutbetalingInfoPanel.Begrunnelse"}),validate:[_,yi,fi,me],maxLength:Br,readOnly:t})}),h.jsx(j,{sixteenPx:!0}),h.jsx(I,{variant:"primary",size:"small",disabled:t||!f.formState.isDirty||f.formState.isSubmitting,loading:f.formState.isSubmitting,children:h.jsx(p,{id:"FeilutbetalingInfoPanel.Confirm"})})]})]})},Pi={"FeilutbetalingInfoPanel.Revurdering":"Revurdering","FeilutbetalingInfoPanel.Feilutbetaling":"Feilutbetaling","FeilutbetalingInfoPanel.Årsaker":"Årsak(er) til revurdering","FeilutbetalingInfoPanel.DatoForRevurdering":"Dato for revurderingsvedtak","FeilutbetalingInfoPanel.Konsekvens":"Konsekvens","FeilutbetalingInfoPanel.Tilbakekrevingsvalg":"Tilbakekrevingsvalg","FeilutbetalingInfoPanel.PeriodeMedFeilutbetaling":"Periode med feilutbetaling","FeilutbetalingInfoPanel.FeilutbetaltBeløp":"Feilutbetalt beløp totalt","FeilutbetalingInfoPanel.TidligereVarseltBeløp":"Tidligere varslet beløp","FeilutbetalingInfoPanel.Period":"Period","FeilutbetalingInfoPanel.Hendelse":"Hendelse","FeilutbetalingInfoPanel.Beløp":"Feilutbetalt beløp","FeilutbetalingInfoPanel.Resultat":"Resultat","FeilutbetalingInfoPanel.Begrunnelse":"Forklar årsaken(e) til feilutbetalingen","FeilutbetalingInfoPanel.Aksjonspunkt":"Kontroller at korrekt hendelse er satt","FeilutbetalingInfoPanel.Confirm":"Bekreft og fortsett","FeilutbetalingInfoPanel.IkkeVarslet":"Ikke varslet","FeilutbetalingInfoPanel.BehandlePerioderSamlet":"Behandle alle perioder samlet"},xi=an(Pi),qi=({feilutbetalingFakta:e,feilutbetalingAarsak:r,fagsakYtelseTypeKode:a,isAksjonspunktOpen:t,isReadOnly:s,kodeverkSamlingFpsak:o,kodeverkSamlingFpTilbake:i,alleMerknaderFraBeslutter:g,submitCallback:m,formData:y,setFormData:u})=>{const l=r.find(v=>v.ytelseType===a);if(!l)throw Error(`Mangler feilutbetalingsårsak for ytelsetype ${a}`);return h.jsx(tn,{value:xi,children:h.jsx(ci,{feilutbetalingFakta:e,feilutbetalingAarsak:l,alleMerknaderFraBeslutter:g,kodeverkSamlingFpTilbake:i,kodeverkSamlingFpsak:o,submitCallback:m,readOnly:s,hasOpenAksjonspunkter:t,formData:y,setFormData:u})})},Ai=[un.AVKLAR_FAKTA_FOR_FEILUTBETALING],Ri=[X.FEILUTBETALING_FAKTA,X.FEILUTBETALING_AARSAK],Er=({behandling:e,valgtFaktaSteg:r,registrerFaktaPanel:a,tilbakekrevingKodeverk:t,fagsakYtelseTypeKode:s})=>E.jsx(Kr,{behandling:e,valgtFaktaSteg:r,registrerFaktaPanel:a,panelEndepunkter:Ri,aksjonspunktKoder:Ai,faktaPanelKode:Zr.FEILUTBETALING,faktaPanelMenyTekst:G().formatMessage({id:"TilbakekrevingFakta.FaktaFeilutbetaling"}),skalPanelVisesIMeny:()=>lr.hasPath(X.FEILUTBETALING_FAKTA.name),renderPanel:o=>E.jsx(qi,{fagsakYtelseTypeKode:s,kodeverkSamlingFpTilbake:t,kodeverkSamlingFpsak:o.alleKodeverk,isAksjonspunktOpen:o.harApneAksjonspunkter,isReadOnly:o.readOnly,...o})});Er.__docgenInfo={description:"FeilutbetalingFaktaInitPanel",methods:[],displayName:"FeilutbetalingFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<tilbakekrevingKodeverkTyper, KodeverkMedNavn[]>"},description:""},fagsakYtelseTypeKode:{required:!0,tsType:{name:"string"},description:""}}};const Fi=({behandling:e,fagsak:r,valgtProsessSteg:a,valgtFaktaSteg:t,oppdaterProsessStegOgFaktaPanelIUrl:s,opneSokeside:o,alleBehandlinger:i})=>{const{data:g}=Xr.useRestApi(Qr.KODEVERK_FPTILBAKE),y=c.useMemo(()=>i.filter(v=>!v.behandlingHenlagt).map(v=>{var d;return{uuid:v.uuid,type:v.type,status:v.status,opprettet:v.opprettet,avsluttet:v.avsluttet,resultatType:(d=v.behandlingsresultat)==null?void 0:d.type}}),[i]).some(v=>v.type===_r.REVURDERING&&v.status!==Ir.AVSLUTTET),u=c.useCallback(v=>g?E.jsxs(E.Fragment,{children:[E.jsx(Er,{tilbakekrevingKodeverk:g,fagsakYtelseTypeKode:r.fagsakYtelseType,...v}),E.jsx(Mr,{...v})]}):E.jsx(E.Fragment,{children:"placeholder"}),[g,r]),l=c.useCallback(v=>g?E.jsxs(E.Fragment,{children:[E.jsx(fr,{...v,relasjonsRolleType:r.relasjonsRolleType,tilbakekrevingKodeverk:g}),E.jsx(Pr,{...v,relasjonsRolleType:r.relasjonsRolleType,tilbakekrevingKodeverk:g}),E.jsx(Rr,{...v,harApenRevurdering:y,opneSokeside:o,tilbakekrevingKodeverk:g})]}):E.jsx(E.Fragment,{children:"placeholder"}),[g,y,r,o,s]);return g?E.jsxs(E.Fragment,{children:[E.jsx(ea,{behandling:e,opneSokeside:o,kodeverk:g,erTilbakekreving:!0},e.versjon),E.jsx(Ur,{behandling:e,valgtProsessSteg:a,valgtFaktaSteg:t,oppdaterProsessStegOgFaktaPanelIUrl:s,hentFaktaPaneler:u,hentProsessPaneler:l})]}):E.jsx(Dr,{})};Fi.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingPaneler",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
