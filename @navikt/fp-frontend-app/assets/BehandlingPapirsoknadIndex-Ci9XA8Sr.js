...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const ys="typeVirksomhet",fs={[ur.DAGMAMMA]:1,[ur.FISKE]:2,[ur.JORDBRUK_ELLER_SKOGBRUK]:3,[ur.ANNEN]:4},im=(s,i)=>s>i?1:s<i?-1:0,mi=({readOnly:s,alleKodeverk:i})=>{var j,F;const o=i[ee.VIRKSOMHET_TYPE],d=V.useMemo(()=>o.filter(b=>b.kode!==ur.FRILANSER).sort((b,w)=>im(fs[b.kode],fs[w.kode])),[]),{watch:g,setError:k,formState:v,clearErrors:m}=Y(),h=g(ys),f=!h||!Object.values(h).some(b=>b===!0);return V.useEffect(()=>{f&&k("notRegisteredInput",{type:"custom",message:zu()}),f||m("notRegisteredInput")},[f]),r.jsxs(r.Fragment,{children:[r.jsx(y,{eightPx:!0}),r.jsx(me,{size:"small",children:r.jsx(c,{id:"Registrering.VirksomhetNaeringTypePanel.Title"})}),r.jsx(y,{fourPx:!0}),d.map(b=>r.jsxs(V.Fragment,{children:[r.jsx(y,{fourPx:!0}),r.jsx(ie,{name:`${ys}.${b.kode}`,label:b.navn,readOnly:s},b.kode)]},b.kode)),v.isSubmitted&&((j=v.errors.notRegisteredInput)==null?void 0:j.message)&&r.jsx(yr,{children:(F=v.errors.notRegisteredInput)==null?void 0:F.message})]})};mi.__docgenInfo={description:`VirksomhetTypeNaringPanel
