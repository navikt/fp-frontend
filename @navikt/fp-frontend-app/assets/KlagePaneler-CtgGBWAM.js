...
Presentasjonskomponent. Setter opp aksjonspunktet for behandling av klage (NFP).`,methods:[],displayName:"BehandleKlageFormNfp",props:{previewCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BrevData) => Promise<any>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  klageMedholdArsak?: string;
  klageHjemmel?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}},{key:"klageVurdering",value:{name:"string",required:!1}},{key:"klageVurderingOmgjoer",value:{name:"string",required:!1}},{key:"klageMedholdArsak",value:{name:"string",required:!1}},{key:"klageHjemmel",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const En=Z(kn),Ne=({behandling:n,klageVurdering:r,alleKodeverk:t,saveKlage:s,submitCallback:a,isReadOnly:l,previewCallback:g,readOnlySubmitButton:i,aksjonspunkter:v,formData:p,setFormData:o})=>e.jsxs(Q,{value:En,children:[r.klageVurderingResultatNK&&e.jsx(Pe,{klageVurdering:r,alleKodeverk:t}),v.some(y=>y.definisjon===q.BEHANDLE_KLAGE_NFP)&&e.jsx(Oe,{sprakkode:n.sprakkode,klageVurdering:r,saveKlage:s,submitCallback:a,readOnly:l,previewCallback:g,readOnlySubmitButton:i,alleKodeverk:t,alleAktuelleHjemler:r.aktuelleHjemler?r.aktuelleHjemler:[],formData:p,setFormData:o})]});Ne.__docgenInfo={description:"",methods:[],displayName:"KlagevurderingProsessIndex",props:{klageVurdering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  klageVurderingResultatNK?: KlageVurderingResultat;
  klageVurderingResultatNFP?: KlageVurderingResultat;
  klageFormkravResultatKA?: {
    avvistArsaker: string[];
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const Fn=(n,r,t)=>s=>{const a={...s,behandlingUuid:t.uuid,fagsakYtelseType:r.fagsakYtelseType};return n(a).then(l=>je(l))},Sn=(n,r,t)=>s=>{const a={behandlingUuid:r.uuid,...s};return n(a).then(()=>t(!0))},On=(n,r,t)=>s=>{const a=s.some(l=>l.kode===q.BEHANDLE_KLAGE_NFP&&l.klageVurdering===m.STADFESTE_YTELSESVEDTAK);return a&&r(!1),()=>{a?n(!0):t&&t("default","default")}},Nn=[w.KLAGE_VURDERING],le=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,aksjonspunktKoder:a,prosessPanelKode:l,prosessPanelMenyTekst:g,hentOgSettBehandling:i,...v})=>{const[p,o]=b.useState(!1),y=Te(),k=r?On(o,r,s):void 0,{startRequest:R}=U.useRestApiRunner(w.PREVIEW_MESSAGE),A=b.useCallback(Fn(R,n,y.behandling),[y.behandling.versjon]),{startRequest:P}=U.useRestApiRunner(w.SAVE_KLAGE_VURDERING),T=b.useCallback(Sn(P,y.behandling,i),[y.behandling.versjon]);return e.jsx(z,{...v,panelEndepunkter:Nn,aksjonspunktKoder:a,prosessPanelKode:l,prosessPanelMenyTekst:g,skalPanelVisesIMeny:()=>!0,lagringSideEffekter:k,renderPanel:j=>e.jsxs(e.Fragment,{children:[e.jsx(ze,{visModal:p,lukkModal:()=>{o(!1),t&&t()}}),e.jsx(Ne,{previewCallback:A,saveKlage:T,...j})]})})};le.__docgenInfo={description:"",methods:[],displayName:"VurderingFellesProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Mn=[q.BEHANDLE_KLAGE_NFP],Me=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,hentOgSettBehandling:a,...l})=>e.jsx(le,{...l,fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,oppdaterProsessStegOgFaktaPanelIUrl:s,aksjonspunktKoder:Mn,prosessPanelKode:D.KLAGE_NAV_FAMILIE_OG_PENSJON,prosessPanelMenyTekst:K().formatMessage({id:"Behandlingspunkt.CheckKlageNFP"}),hentOgSettBehandling:a});Me.__docgenInfo={description:"",methods:[],displayName:"VurderingFamOgPensjonProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Hn=[q.VURDER_FORMKRAV_NK],In=[w.KLAGE_VURDERING],He=({alleBehandlinger:n,hentOgSettBehandling:r,...t})=>{const s=K(),a=b.useMemo(()=>n.filter(i=>i.status===ve.AVSLUTTET).filter(i=>(i.type!==M.KLAGE||be(i.resultatType))&&i.type!==M.ANKE),[n]),{startRequest:l}=U.useRestApiRunner(w.SAVE_FORMKRAV_VURDERING),g=i=>l(i).then(()=>r(!0));return e.jsx(z,{...t,panelEndepunkter:In,aksjonspunktKoder:Hn,prosessPanelKode:D.FORMKRAV_KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.FormkravKlageKA"}),skalPanelVisesIMeny:()=>!0,renderPanel:i=>e.jsx(te,{avsluttedeBehandlinger:a,lagreFormkravVurdering:g,...i})})};He.__docgenInfo={description:"",methods:[],displayName:"FormKravKlageInstansProsessStegInitPanel",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  uuid: string;
  type: string;
  status: string;
  opprettet: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Un=[q.BEHANDLE_KLAGE_NK],Ie=({fagsak:n,hentOgSettBehandling:r,...t})=>e.jsx(le,{...t,aksjonspunktKoder:Un,fagsak:n,prosessPanelKode:D.KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:K().formatMessage({id:"Behandlingspunkt.CheckKlageNK"}),hentOgSettBehandling:r});Ie.__docgenInfo={description:"",methods:[],displayName:"VurderingKlageInstansProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const zn=(n,r,t)=>s=>{const a={...s,behandlingUuid:t.uuid,fagsakYtelseType:r.fagsakYtelseType};return n(a).then(l=>je(l))},oe=(n,r=[])=>{const t=r.some(a=>a.status===pe.OPPRETTET);if(r.length===0||t)return I.IKKE_VURDERT;const s=n==null?void 0:n.type;return s===O.HENLAGT_KLAGE_TRUKKET||s===O.HENLAGT_FEILOPPRETTET?I.IKKE_VURDERT:s===O.KLAGE_AVVIST||s===O.KLAGE_YTELSESVEDTAK_OPPHEVET?I.IKKE_OPPFYLT:I.OPPFYLT},$n=(n,r)=>()=>(r(!1),()=>{n(!0)}),Jn=[q.FORESLA_VEDTAK,q.FATTER_VEDTAK,q.FORESLA_VEDTAK_MANUELT],Wn=[w.KLAGE_VURDERING],Le=({fagsak:n,setSkalOppdatereEtterBekreftelseAvAp:r,opneSokeside:t,...s})=>{const a=K(),[l,g]=b.useState(!1),i=Te(),v=$n(g,r),{startRequest:p}=U.useRestApiRunner(w.PREVIEW_MESSAGE),o=b.useCallback(zn(p,n,i.behandling),[i.behandling.versjon]),{aksjonspunkt:y}=s.behandling;return e.jsx(z,{...s,panelEndepunkter:Wn,aksjonspunktKoder:Jn,prosessPanelKode:D.KLAGE_RESULTAT,prosessPanelMenyTekst:a.formatMessage({id:"Behandlingspunkt.ResultatKlage"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:k=>oe(k.behandling.behandlingsresultat,y),lagringSideEffekter:v,hentSkalMarkeresSomAktiv:k=>oe(k.behandling.behandlingsresultat,y)!==I.IKKE_VURDERT,renderPanel:k=>e.jsxs(e.Fragment,{children:[e.jsx(Je,{visModal:l,lukkModal:()=>{g(!1),t()},tekst:a.formatMessage({id:"FatterVedtakStatusModal.KlagenErFerdigbehandlet"})}),e.jsx(De,{previewVedtakCallback:o,...k})]})})};Le.__docgenInfo={description:"",methods:[],displayName:"KlageresultatProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
