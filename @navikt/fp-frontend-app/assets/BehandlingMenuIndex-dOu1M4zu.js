...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}>`},description:""}}};const wu={"RegistrereVergeInfoPanel.CheckInformation":"Fyll ut og kontroller vergeopplysninger","Verge.KontaktPerson":"Kontaktperson","Verge.Navn":"Navn","Verge.Mandat":"Mandat","Verge.FodselsNummer":"Fødselsnummer","Verge.PeriodeFOM":"Periode f.o.m.","Verge.PeriodeTOM":"Periode t.o.m.","Verge.TypeVerge":"Type verge","Verge.VergeFullmektig":"Verge/fullmektig","Verge.Soker":"Søker","Verge.BrukerErUnderTvungenForvaltning":"Søker er under tvungen forvaltning","Verge.Organisasjonsnummer":"Organisasjonsnummer"},lr=ye(wu),tn=({readOnly:o,vergetyper:v=[],valgtVergeType:l})=>{const{control:h}=AT();return d.jsxs(Tn,{gap:"space-16",children:[d.jsx(Or,{name:"vergeType",control:h,label:lr.formatMessage({id:"Verge.TypeVerge"}),validate:[ce],selectValues:v.map(b=>d.jsx("option",{value:b.kode,children:b.navn},b.kode)),readOnly:o}),l&&d.jsxs(d.Fragment,{children:[d.jsxs(Vn,{gap:"space-16",children:[d.jsx(Tl,{name:"navn",control:h,label:lr.formatMessage({id:"Verge.Navn"}),validate:[ce,uT],readOnly:o}),l==="ADVOKAT"?d.jsx(Tl,{name:"organisasjonsnummer",control:h,label:lr.formatMessage({id:"Verge.Organisasjonsnummer"}),validate:[ce,oT],readOnly:o}):d.jsx(Tl,{name:"fnr",control:h,label:lr.formatMessage({id:"Verge.FodselsNummer"}),validate:[ce,dT],readOnly:o})]}),d.jsxs(Vn,{gap:"space-16",children:[d.jsx(vu,{name:"gyldigFom",control:h,label:lr.formatMessage({id:"Verge.PeriodeFOM"}),validate:[ce,ku],isReadOnly:o}),d.jsx(vu,{name:"gyldigTom",control:h,label:lr.formatMessage({id:"Verge.PeriodeTOM"}),validate:[ku],isReadOnly:o})]})]})]})};tn.buildInitialValues=o=>({...o,gyldigTom:o?.gyldigTom??void 0});tn.transformValues=o=>({vergeType:o.vergeType,navn:o.navn,gyldigFom:o.gyldigFom,gyldigTom:o.gyldigTom,...o.vergeType==="ADVOKAT"?{organisasjonsnummer:Xe(o.organisasjonsnummer)}:{fnr:Xe(o.fnr)}});tn.__docgenInfo={description:`RegistrereVergeFaktaForm
...
Formkomponent. Registrering og oppdatering av verge.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"verge",optional:!1,type:{name:"intersection",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavnTilbakekreving<'VergeType'>[]"}]},description:"",defaultValue:{value:"[]",computed:!1}},valgtVergeType:{required:!0,tsType:{name:"union",raw:"VergeType | undefined",elements:[{name:"union",raw:"'BARN' | 'FBARN' | 'VOKSEN' | 'ADVOKAT' | 'ANNEN_F'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'FBARN'"},{name:"literal",value:"'VOKSEN'"},{name:"literal",value:"'ADVOKAT'"},{name:"literal",value:"'ANNEN_F'"}]},{name:"undefined"}]},description:""}}};const dE=(o,v)=>o?{...dr.initialValues(v),...tn.buildInitialValues(o)}:void 0,gE=o=>({kode:Nu.AVKLAR_VERGE,...tn.transformValues(o),...dr.transformValues(o)}),ju=({submittable:o,verge:v,alleKodeverk:l})=>{const h=ir(),{aksjonspunkterForPanel:b,submitCallback:A,alleMerknaderFraBeslutter:R,harÅpneAksjonspunkter:c,isReadOnly:_}=gT(),{mellomlagretFormData:w,setMellomlagretFormData:j}=kT(),G=ur({defaultValues:w??dE(v,b),shouldUnregister:!0}),te=G.watch("vergeType"),X=G.watch("begrunnelse"),me=l.VergeType.sort((Ne,ee)=>Ne.navn.localeCompare(ee.navn));return d.jsxs(d.Fragment,{children:[c&&d.jsx(qT,{children:h.formatMessage({id:"RegistrereVergeInfoPanel.CheckInformation"})}),d.jsx(or,{formMethods:G,onSubmit:Ne=>A(gE(Ne)),setDataOnUnmount:j,children:d.jsxs(Tn,{gap:"space-24",children:[d.jsx(_T,{merknaderFraBeslutter:R[Nu.AVKLAR_VERGE],children:d.jsx(tn,{readOnly:_||b.length===0,vergetyper:me,valgtVergeType:te})}),b.length!==0&&d.jsxs(d.Fragment,{children:[d.jsx(dr,{control:G.control,isSubmittable:o,isReadOnly:_,hasBegrunnelse:!!X}),d.jsx(_u,{isSubmittable:o&&!!te,isReadOnly:_,isSubmitting:G.formState.isSubmitting,isDirty:G.formState.isDirty})]})]})})]})};ju.__docgenInfo={description:`RegistrereVergeInfoPanel
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const no=({behandling:o,hentOgSettBehandling:v,lukkModal:l})=>{const h=we(Bl()),b=Pr(o),{mutate:A}=ln({mutationFn:R=>b.endreBehandlendeEnhet({...R,behandlingUuid:o.uuid,behandlingVersjon:o.versjon}),onSuccess:()=>v()});return d.jsx(Du,{behandlendeEnhetId:o.behandlendeEnhetId,behandlendeEnhetNavn:o.behandlendeEnhetNavn,nyBehandlendeEnhet:A,behandlendeEnheter:Xe(h.data).behandlendeEnheter,lukkModal:l})};no.__docgenInfo={description:"",methods:[],displayName:"EndreBehandlendeEnhetMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  fagsakMarkering: FagsakMarkeringKode;
  kortNavn?: string;
}`,signature:{properties:[{key:"fagsakMarkering",value:{name:"FagsakMarkeringKode",required:!0}},{key:"kortNavn",value:{name:"string",required:!1}}]}}],raw:"Saksmarkering[]"},{name:"undefined"}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const ao=({behandling:o,behandlingAppKontekst:v,fagsakYtelseType:l,lukkModal:h})=>{const b=$a(),A=Pr(o),{data:R}=we(b.kodeverkOptions()),{data:c}=we(b.fptilbake.kodeverkOptions()),{mutateAsync:_}=ln({mutationFn:X=>A.henleggBehandling({...X,behandlingUuid:o.uuid,behandlingVersjon:o.versjon})}),w=o.type===x.TILBAKEKREVING||o.type===x.TILBAKEKREVING_REVURDERING?Xe(c).BehandlingResultatType:Xe(R).BehandlingResultatType,j=cu(),G=()=>j("/"),te=ih(v);return d.jsx(Wu,{valgtBehandling:o,forhandsvisHenleggBehandling:te,henleggBehandling:_,ytelseType:l,behandlingResultatTyper:w,lukkModal:h,gaaTilSokeside:G})},ih=o=>{const v=TT(o),{mutate:l}=ln({mutationFn:A=>v.forhåndsvisMelding(A),onSuccess:A=>{mu(A)}}),{mutate:h}=ln({mutationFn:A=>ET(A.behandlingUuid,A.fritekst??""),onSuccess:A=>{mu(A)}}),b=x.TILBAKEKREVING===o.type||x.TILBAKEKREVING_REVURDERING===o.type;return A=>{b?h(A):l(A)}};ao.__docgenInfo={description:"",methods:[],displayName:"HenleggMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const uo=({behandlingAppKontekst:o,behandling:v,hentOgSettBehandling:l,lukkModal:h})=>{const b=o.behandlingTillatteOperasjoner?.vergeBehandlingsmeny,A=PT(v.type),R=Vl(),c=()=>{l(),R.invalidateQueries({queryKey:[Gr.FETCH_FAGSAK]}),R.invalidateQueries({queryKey:[Gr.FETCH_FAGSAKDATA_FPTILBAKE]}),R.invalidateQueries({queryKey:[Tu.VERGE]}),R.invalidateQueries({queryKey:[Tu.VERGE_HENT]})},_=Pr(v),{mutate:w}=ln({mutationFn:_.verge.opprettVergeV2,onSuccess:c}),{mutate:j}=ln({mutationFn:_.verge.fjernVergeV2,onSuccess:c}),{data:G}=we(_.verge.hent(v));return d.jsx(Iu,{type:Al.OPPRETT===b?"OPPRETT":"FJERN",verge:G,opprettVerge:w,fjernVerge:j,lukkModal:h,alleKodeverk:A})};uo.__docgenInfo={description:"",methods:[],displayName:"VergeMenyModal",props:{behandlingAppKontekst:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  behandlingTillatteOperasjoner: BehandlingTillatteOperasjoner;
  brevmaler: Brevmal[];
  totrinnskontrollÅrsaker: TotrinnskontrollSkjermlenkeContext[];
