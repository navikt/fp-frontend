import{j as e}from"./jsx-runtime-CLpGMVip.js";import{f as v,M as l,n as f,H as q}from"./index.es-BJ5ePes3.js";import{u as c,h as j}from"./initFetch-CULiu9VR.js";import{V as w,m as R,P as I,h as x,W as A}from"./withPanelData-BD6kgoz0.js";import{K as k}from"./alleKodeverk-Ck9zwXaq.js";import{R as F}from"./index-B5OHeJSP.js";import{V as T}from"./VisittkortSakIndex-XlZNqnE3.js";import{E as K}from"./IngenBehandlingValgtPanel-BjRN6abd.js";import{p as b}from"./paths-BG-6LyE8.js";import{u as S}from"./useTrackRouteParam-CFfsK9bW.js";import{u as m}from"./useKodeverk-my-TNnbV.js";const y=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:d})=>e.jsxs(e.Fragment,{children:[e.jsx(T,{bruker:n.person}),e.jsx(w,{gap:"2",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(s=>{var i,g;const a=(i=t.find(o=>o.kode===s.fagsakYtelseType))==null?void 0:i.navn,u=(g=r.find(o=>o.kode===s.status))==null?void 0:g.navn;return e.jsxs(F.Fragment,{children:[d(void 0,`${a} (${s.saksnummer}) ${u}`,s.saksnummer),e.jsx(v,{sixteenPx:!0})]},s.saksnummer)}):e.jsx(R,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});y.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
