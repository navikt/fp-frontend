import{j as a}from"./jsx-runtime-CLpGMVip.js";import{F as T,w as A,M as D,R as C,a as w}from"./withPanelData-BD6kgoz0.js";import{H as P}from"./index.es-BJ5ePes3.js";import{u as I,a as U,F as s,i,w as x,n as v,b as F,c as L}from"./initFetch-CULiu9VR.js";import{h as t,H as e}from"./index-DqeTBbD1.js";import{F as c}from"./fagsakStatus-NXwGwLtb.js";import{a as g}from"./alleKodeverk-Ck9zwXaq.js";import{K as S}from"./Kjonnkode-C-fkzSiP.js";import{A as d}from"./AktørIndex-BkzW8f8k.js";import{i as k}from"./initFetchTilbake-BtBiXUqM.js";import"./index-B5OHeJSP.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-sT6466e8.js";import"./index-DYwZEShM.js";import"./v4-CtRu48qb.js";import"./dayjs.min-CJilavqB.js";import"./ExclamationmarkTriangleFill-BaHUn2cM.js";import"./CheckmarkCircleFill-DKFIcv_a.js";import"./decorators-DIzpaN6C.js";import"./VisittkortSakIndex-XlZNqnE3.js";import"./index.es-758GeVNB.js";import"./useFormField-DxSG1hRL.js";import"./Link-BgL3YgA-.js";import"./Tooltip-CMJ3erQV.js";import"./Popover-DcNCAbik.js";import"./Tag-CzS4vEx9.js";import"./Spacer-CXEI7Xul.js";import"./IngenBehandlingValgtPanel-BjRN6abd.js";import"./paths-BG-6LyE8.js";import"./skjermlenkeCodes-1SvLTuBb.js";import"./useTrackRouteParam-CFfsK9bW.js";import"./useKodeverk-my-TNnbV.js";const E=m=>x(v(i.links.find(l=>l.rel===m)).href),p={navn:"Espen Utvikler",fødselsnummer:"121221",kjønn:S.MANN,fødselsdato:"2000-01-02"},b={fagsaker:[{saksnummer:"123",fagsakYtelseType:T.FORELDREPENGER,status:c.OPPRETTET,aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p},{saksnummer:"252523",fagsakYtelseType:T.ENGANGSSTONAD,status:c.LOPENDE,aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p}],person:{...p,aktørId:"12121221"}},dt={title:"app/AktørIndex",decorators:[A],component:d,render:()=>{const{status:m}=I(L()),{kodeverkOptions:l}=U(),{data:O}=I(l(m==="success"));return O?a.jsx(D,{initialEntries:["/fagsak/352011079"],children:a.jsx(C,{children:a.jsx(w,{element:a.jsx(d,{}),path:"/fagsak/:aktoerId"})})}):a.jsx(P,{})}},r={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>e.json(b))]}}},o={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>e.json({fagsaker:[],person:p}))]}}},n={parameters:{msw:{handlers:[t.get(s.INIT_FETCH,()=>e.json(i)),t.get(s.INIT_FETCH_FPTILBAKE,()=>e.json(k)),t.get(E(F.KODEVERK),()=>e.json(g)),t.get(s.AKTOER_INFO,()=>new e(null,{status:500}))]}}};var R,u,h;r.parameters={...r.parameters,docs:{...(R=r.parameters)==null?void 0:R.docs,source:{originalSource:`{
  parameters: {
    msw: {
...
}`,...(N=(_=n.parameters)==null?void 0:_.docs)==null?void 0:N.source}}};const Rt=["Default","IngenFagsaker","AktørInfoKallFeilet"];export{n as AktørInfoKallFeilet,r as Default,o as IngenFagsaker,Rt as __namedExportsOrder,dt as default};
