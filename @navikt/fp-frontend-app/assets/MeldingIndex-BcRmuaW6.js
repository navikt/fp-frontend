import{l as c,a7 as te,j as n,v as j,a8 as se,G as H,y as le,z as ie,a9 as oe,F as I,P as U,b as Y,r as G,n as ue,aa as M,I as R}from"./iframe-CiGJN7AW.js";import{n as F,s as C,u as de,t as ge,d as ke}from"./fagsakApi-DWqssfeS.js";import{u as me,N as ve,O as D,D as pe,c as B}from"./index.es-CcruyY3k.js";import{D as l}from"./dokumentMalType-B-Xou3xH.js";import{V as ye}from"./venteArsakType-BJdSFL9e.js";import{U as be}from"./UkjentAdresseMeldingIndex-B6QMMpPG.js";import{V as J,H as S,b as z,M as O,L as Ee}from"./VStack-B16vNITV.js";import{L as Te}from"./Link-5gz8LI0X.js";import{M as f}from"./message-2gl_T2Ct.js";import{S as fe}from"./CheckmarkCircleFill-CUoFwSH0.js";import{u as L}from"./useKodeverk-Byw048yt.js";import{S as he}from"./SupportHeader-CNz3VFxA.js";import{S as Ae}from"./SettPaVentReadOnlyModal-C0kqN2Q5.js";import{A as Re}from"./index.es-CqxvZVop.js";var y=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(y||{});const Ne="_bredde_jav4h_9",P={bredde:Ne},qe=H(4e3),Ve=H(1e4),je=le(3),Be=e=>e===l.INNHENTE_OPPLYSNINGER||e===l.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",Se=(e,r)=>e===l.INNHENTE_OPPLYSNINGER||e===l.FRITEKST||e===l.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===l.VARSEL_OM_TILBAKEKREVING||e===l.TBK_INNHENTE_OPPLYSNINGER||e===l.VARSEL_OM_REVURDERING&&r===y.ANNET,ce=(e,r)=>r===I.ENGANGSSTONAD?e.filter(s=>s.kode===y.BARN_IKKE_REGISTRERT_FOLKEREGISTER||s.kode===y.ANNET):r===I.SVANGERSKAPSPENGER?e.filter(s=>s.kode!==y.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&s.kode!==y.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Ke=e=>{const r={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...r,brevmalkode:l.VARSEL_OM_REVURDERING}:{...r}},_e=e=>{const r=e;return e.brevmalkode===l.VARSEL_OM_REVURDERING&&r.arsakskode!==y.ANNET&&(r.fritekst=" "),r},Q=({behandling:e,forhåndsvisBrev:r,submitCallback:s,revurderingVarslingArsak:g,fagsakYtelseType:k,kanVeilede:a,meldingFormData:i,setMeldingFormData:b,brukerManglerAdresse:T})=>{const u=c(),d=me({defaultValues:i??Ke(e)}),m=d.watch("brevmalkode"),E=d.watch("fritekst"),o=d.watch("arsakskode"),N=ce(g,k);if(!e.språkkode)return null;const{formState:h,control:v}=d,A=t=>{m&&E?r({brevmalkode:m,fritekst:E,arsakskode:o}):E||d.setError("fritekst",{type:"manual",message:u.formatMessage({id:"Messages.FritekstRequired"})}),t.preventDefault()},q=te(e.språkkode),p=m===l.VARSEL_OM_REVURDERING;return n.jsx(ve,{formMethods:d,onSubmit:t=>s(_e(t)),setDataOnUnmount:b,children:n.jsxs(J,{gap:"4",children:[n.jsx(D,{name:"brevmalkode",control:v,label:u.formatMessage({id:"Messages.Template"}),validate:[j],selectValues:e.brevmaler.map(t=>n.jsx("option",{value:t.kode,disabled:!t.tilgjengelig,children:t.navn},t.kode)),className:P.bredde}),p&&n.jsx(D,{name:"arsakskode",control:v,label:u.formatMessage({id:"Messages.Årsak"}),validate:[j],selectValues:N.map(t=>n.jsx("option",{value:t.kode,children:t.navn},t.kode)),className:P.bredde}),Se(m,o)&&n.jsx(pe,{name:"fritekst",control:v,label:u.formatMessage({id:Be(m)}),validate:[j,p?Ve:qe,je,ie],maxLength:p?1e4:4e3,badges:[{type:"info",titleText:q}],parse:se}),T&&n.jsx(be,{}),n.jsxs(S,{justify:"space-between",children:[(!p||p&&o!==void 0)&&n.jsx(Te,{href:"#",onClick:A,onKeyDown:t=>t.key==="Enter"?A(t):null,children:n.jsx(f,{id:"Messages.Preview"})}),n.jsx(z,{size:"small",variant:"primary",loading:h.isSubmitting,disabled:h.isSubmitting||a,onClick:oe,children:n.jsx(f,{id:"Messages.Submit"})})]})]})})};Q.__docgenInfo={description:`Messages
