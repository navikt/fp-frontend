import{r as g,l as T,j as u,bH as R,bI as K,bj as w}from"./iframe-CoSbPJjN.js";import{Q as V}from"./index.es-DY0RMBZW.js";import{u as F}from"./fagsakApi-Cm8_-XZz.js";import{V as P}from"./BehandlingMenuIndex-Chr5hU8v.js";import{i as y,A as S}from"./index-DGx2lYag.js";import{u as B,c}from"./behandlingApi-BA9w7Fez.js";import{B as p}from"./FagsakIndex-COzL8-fV.js";import{W as N}from"./index.es-CNvGogqv.js";import{H as h}from"./VStack-BF1SS0zY.js";import{S as O}from"./ExclamationmarkTriangleFill-D8Z_NrdL.js";import{e as D,g as L}from"./useStandardProsessPanelProps-DS-PtXcE.js";const U=a=>{const[t,e]=g.useState([]),l=n=>{e(i=>{const r=[...i],d=r.findIndex(s=>s.id===n.id);return d>=0?r.splice(d,1,n):r.push(n),r}),a?.(n.harApneAksjonspunkter?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:t.filter(n=>n.skalVisesImeny),settFaktaPanelMenyData:l}},I="_container_4o186_1",M="_content_4o186_6",G="_sideMenu_4o186_19",v={container:I,content:M,sideMenu:G},H=({valgtFaktaSteg:a,valgtProsessSteg:t,setFaktaPanelMedÅpentApInfo:e,children:l})=>{const n=T(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=g.use(p),{faktaPanelMenyData:r,settFaktaPanelMenyData:d}=U(e),s=r.length>0;return u.jsxs(h,{className:v.container,wrap:!1,children:[s&&u.jsx("div",{className:v.sideMenu,"data-testid":"fakta-meny",children:u.jsx(N,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?u.jsx(O,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(t,r[o].id)}})}),u.jsx("div",{className:v.content,children:u.jsx(Y,{valgtFaktaSteg:a,settFaktaPanelMenyData:d,faktaPanelMenyData:r,children:l})})]})},f=g.createContext({}),Y=a=>{const{children:t,...e}=a,l=g.useMemo(()=>e,[e]);return u.jsx(f.Provider,{value:l,children:t})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",x=(a,t,e,l)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:i}=g.use(f),r=e&&(n===a||l&&n===J);return g.useEffect(()=>{i({id:a,tekst:t,erAktiv:r,harApneAksjonspunkter:l,skalVisesImeny:e})},[e,r,l]),e&&r},q=({standardPanelProps:a,skalPanelVisesIMeny:t,faktaPanelKode:e,faktaPanelMenyTekst:l,children:n})=>{const{behandling:i,fagsak:r,alleKodeverk:d}=g.use(p),s=x(e,l,t,a.harApneAksjonspunkter);return u.jsx(R,{behandling:i,children:s?u.jsx(K,{behandling:i,fagsak:r,alleKodeverk:d,aksjonspunkterForPanel:a.aksjonspunkter,harÅpneAksjonspunkter:a.harApneAksjonspunkter,submitCallback:a.submitCallback,isReadOnly:a.readOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,children:n}):null})};q.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
  alleKodeverk: AlleKodeverk;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",A="default",C=(a,t,e,l,n,i)=>r=>{const s=(Array.isArray(r)?r:[r]).map(m=>({"@type":m.kode,...m})),o={saksnummer:a.saksnummer,behandlingUuid:t.uuid,behandlingVersjon:t.versjon};if(s&&n&&i){if(s.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(s[0].kode))return n({...o,overstyrteAksjonspunktDtoer:s}).then(()=>e(A,b))}return l({...o,bekreftedeAksjonspunktDtoer:s}).then(()=>e(A,b))},Q=(a,t=[])=>{const{behandling:e,rettigheter:l,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:d,alleKodeverk:s}=g.use(p),{aksjonspunkt:o}=e,m=o&&a?o.filter(k=>a.includes(k.definisjon)):[],E=D(e,[],l,!1),j=L(e.status,m),_=C(n,e,d,i,r,t);return{behandling:e,submittable:!m.some(k=>y(k.status))||m.some(k=>k.kanLoses),harApneAksjonspunkter:m.some(k=>y(k.status)&&k.kanLoses),alleKodeverk:s,aksjonspunkter:m,readOnly:E,alleMerknaderFraBeslutter:j,submitCallback:_}},W=[S.AVKLAR_VERGE],z=()=>{const a=T(),t=Q(W),{behandling:e}=g.use(p),l=B(e),n=c(e,"VERGE"),{data:i,isFetching:r}=F(l.vergeOptions(e,n));return u.jsx(q,{standardPanelProps:t,faktaPanelKode:w.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?u.jsx(V,{}):u.jsx(P,{verge:i,alleKodeverk:t.alleKodeverk,submittable:t.submittable})})};z.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{q as F,z as V,H as a,Q as u};
