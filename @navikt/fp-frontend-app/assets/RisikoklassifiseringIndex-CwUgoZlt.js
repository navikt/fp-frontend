...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},description:""},risikoklassifisering:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaresignalVurdering'>[]"},description:""}}};const ua=({fagsakData:e,behandling:n,setBehandling:r})=>{const a=e.getFagsak(),{selected:l=!1}=Ie({paramName:"risiko",parse:y=>y==="true",isQueryParam:!0}),u=C(),i=J(),m=()=>{u(h(i)(!l))},{kodeverkOptions:s}=z(),{data:d}=P(s()),E=e.getBehandling(n?.uuid);return n&&E?t.jsx(sa,{isRiskPanelOpen:l,fagsak:a,toggleRiskPanel:m,behandlingAppKontekst:E,behandling:n,setBehandling:r}):t.jsx(B,{risikoklassifisering:a.kontrollResultat,isPanelOpen:l,readOnly:!0,toggleRiskPanel:m,faresignalVurderinger:c(d).FaresignalVurdering})},sa=({fagsak:e,behandling:n,behandlingAppKontekst:r,setBehandling:a,toggleRiskPanel:l,isRiskPanelOpen:u})=>{const{behandlingPåVent:i,status:m,type:s,risikoAksjonspunkt:d,kontrollResultat:E}=r,{kodeverkOptions:y}=z(),T=P(Ee()),{data:p}=P(y()),G=c(T.data).innloggetBruker,te=We(G,e.status,m,s),ie=ma(G,te,i),j=C(),U=J();v.useEffect(()=>{d&&d.status===S.OPPRETTET&&!u&&j(h(U)(!0)),d&&d.status===S.UTFORT&&j(h(U)(!1))},[!!d,n.uuid,n.versjon]);const{lagreAksjonspunkter:ue}=he(n,a),se=D=>{ue({behandlingUuid:n.uuid,behandlingVersjon:n.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":D.kode,...D}]})};return t.jsx(B,{aksjonspunkt:d??void 0,risikoklassifisering:E,isPanelOpen:u,readOnly:ie,submitAksjonspunkt:se,toggleRiskPanel:l,faresignalVurderinger:c(p).FaresignalVurdering})},ma=(e,n,r)=>{if(r)return!0;const{kanSaksbehandle:a}=e;return!a||!n.writeAccess.isEnabled};ua.__docgenInfo={description:`RisikoklassifiseringIndex
