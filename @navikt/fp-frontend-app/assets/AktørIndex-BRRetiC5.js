import{j as e,i as p,P as v,b as f,L as q}from"./iframe-BJbBKX5G.js";import{Q as j}from"./index.es-COUBxaIS.js";import{u as w,r as c}from"./fagsakApi-CNOW27NJ.js";import{V as I}from"./VisittkortSakIndex-CRTvcrF7.js";import{V as T,a as F,B as R}from"./VStack-fiEfhAKI.js";import{M as l}from"./message-Dl4GeJzg.js";import{E}from"./IngenBehandlingValgtPanel-Ddqdootp.js";import{u as K}from"./useTrackRouteParam-BY407SHu.js";import{p as x}from"./paths-Ci-AIiCp.js";import{u as m}from"./useKodeverk-CohoKnfq.js";const g=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(I,{bruker:n.person}),e.jsx(T,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{var t,k;const i=(t=s.find(o=>o.kode===a.fagsakYtelseType))==null?void 0:t.navn,d=(k=r.find(o=>o.kode===a.status))==null?void 0:k.navn;return e.jsx(p.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(F,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});g.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
