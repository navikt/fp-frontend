import{j as e}from"./jsx-runtime-CLpGMVip.js";import{d as h,b as I,f as V,N as _,c as O,l as F,E,e as R,Z as z,Q as L}from"./index.es-CAKzYmxM.js";import{n as v,d as $,e as C,S as U,W as N,z as c,Y as d,g as G,f as o,$ as S,K as Y}from"./index.es-z2KRwyMl.js";import{r as D}from"./index-B8jnc8p3.js";import{A as K}from"./aksjonspunktStatus-xM4O_ZUY.js";import{n as T,V as H,H as W,h as y,m as Q,J as X,L as q}from"./withPanelData-DwrBBCSV.js";import{V as Z}from"./BehandlingHenlagtPanel-De-KuRh6.js";import{S as J}from"./TotrinnskontrollIndex-xoTJ1-AU.js";import{S as ee}from"./CheckmarkCircleFill-DE_gi2ZR.js";import{S as ne}from"./ExclamationmarkTriangleFill-BA6FvCBM.js";const se="_explanationTextarea_hw8s7_1",re="_begrunnelseTextField_hw8s7_6",ae={explanationTextarea:se,begrunnelseTextField:re},f={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},te=v(f),ie=O(3),le=F(2e3),oe=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",de=n=>r=>r!==void 0||n,P=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:i}}=h(),t=a?()=>!1:de(i);return e.jsx("div",{className:s?"":ae.begrunnelseTextField,children:e.jsx(I,{name:"begrunnelse",label:r||te.formatMessage({id:oe(n)}),validate:[V(t),ie,le,_],maxLength:2e3,readOnly:n,parse:$})})},ue=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";P.buildInitialValues=n=>({begrunnelse:C(ue(n))});P.transformValues=n=>({begrunnelse:n.begrunnelse});P.__docgenInfo={description:`ProsessStegBegrunnelseTextField
