...
Viser tillrettlegging før svangerskapspenger`,methods:[],displayName:"TilretteleggingFaktaForm",props:{behandlingVersjon:{required:!0,tsType:{name:"number"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},harApneAksjonspunkter:{required:!0,tsType:{name:"boolean"},description:""},arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  fødselsdato?: string;
}>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const Se=[c.FODSELTILRETTELEGGING],at=[c.OVERSTYR_AVKLAR_STARTDATO],st=[E.ARBEID_OG_INNTEKT,E.SVANGERSKAPSPENGER_TILRETTELEGGING],gn=({arbeidsgiverOpplysningerPerId:n,...r})=>e.jsx(Hn,{...r,panelEndepunkter:st,aksjonspunktKoder:Se,overstyringApKoder:at,faktaPanelKode:rr.FODSELTILRETTELEGGING,faktaPanelMenyTekst:F().formatMessage({id:"FodselOgTilretteleggingInfoPanel.FaktaFodselOgTilrettelegging"}),skalPanelVisesIMeny:()=>!0,renderPanel:t=>e.jsx(on,{arbeidsgiverOpplysningerPerId:n,...t,readOnly:t.readOnly||!r.behandling.aksjonspunkt.some(a=>Se.some(i=>i===a.definisjon))})});gn.__docgenInfo={description:"",methods:[],displayName:"FodseltilretteleggingFaktaInitPanel",props:{arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  erPrivatPerson: boolean;
  referanse?: string;
  identifikator: string;
  navn: string;
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const bt=[c.VURDER_TILBAKETREKK],ft=[E.BEREGNINGRESULTAT_DAGYTELSE,E.FAMILIEHENDELSE,E.SOKNAD,E.FERIEPENGEGRUNNLAG],yn=({arbeidsgiverOpplysningerPerId:n,personoversikt:r,...t})=>e.jsx(Ue,{...t,panelEndepunkter:ft,aksjonspunktKoder:bt,prosessPanelKode:De.TILKJENT_YTELSE,prosessPanelMenyTekst:F().formatMessage({id:"Behandlingspunkt.TilkjentYtelse"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:()=>tr.hasPath(E.BEREGNINGRESULTAT_DAGYTELSE.name)?O.OPPFYLT:O.IKKE_VURDERT,renderPanel:a=>e.jsx(In,{arbeidsgiverOpplysningerPerId:n,personoversikt:r,beregningresultat:a==null?void 0:a.beregningresultatDagytelse,...a})});yn.__docgenInfo={description:"",methods:[],displayName:"TilkjentYtelseProsessStegInitPanel",props:{arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  erPrivatPerson: boolean;
  referanse?: string;
  identifikator: string;
  navn: string;
