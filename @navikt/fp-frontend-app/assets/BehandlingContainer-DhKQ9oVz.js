import{j as r}from"./jsx-runtime-CLpGMVip.js";import{r as u}from"./index-B5OHeJSP.js";import{W as C,z as F,Y as q,H as _}from"./index.es-BEBRLXnK.js";import{B as j}from"./behandlingDataContext-BMbp9e-c.js";import{h as D}from"./FormDataContext-B1rdxO_J.js";import{s as T,i as S,q as c}from"./index.es-TIZ8fSLE.js";import{S as I}from"./ExclamationmarkTriangleFill-D2K_ewMd.js";import{V as A,B as E}from"./BehandlingHenlagtPanel-Dy1MJY7R.js";import"./aktivitetStatus-02fOJoqz.js";const h=({menyData:a,oppdaterFaktaPanelIUrl:i})=>{const o=D();return r.jsx(T,{heading:o.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(t=>({label:t.tekst??"",active:t.erAktiv,icon:t.harApneAksjonspunkter?r.jsx(I,{color:"var(--a-orange-600)"}):void 0})),onClick:i})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{menyData:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
