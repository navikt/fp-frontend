import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{u as q,A as I,F as _,Y as V,k as F,y as O,e as L,a as A,b as E,c as z,M as $}from"./AppIndex.stories-Cgziq5AP.js";import{t as y,d as C,G as U,c as T,e as G,b as Y,B as v,S as D,H,D as W,L as h}from"./index.es-Bx4jUivQ.js";import{r as X}from"./index-DRjF_FHU.js";import{H as K}from"./index.es-zhgnUGpN.js";import{v as J}from"./ProsessDefaultInitPanel-NfaZFvFN.js";import{a as Q,W as M,H as c,L as u,b as Z,y as o,$ as S,q as ee,S as ne}from"./index.es-B6prUBbJ.js";const Le={OPPRETTET:"OPPR",UTFORT:"UTFO",AVBRUTT:"AVBR"},f={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},se="_explanationTextarea_hw8s7_1",re="_begrunnelseTextField_hw8s7_6",ae={explanationTextarea:se,begrunnelseTextField:re},te=y(f),ie=F(3),le=O(2e3),oe=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ue=n=>r=>r!==void 0||n,P=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:i}}=q(),t=a?()=>!1:ue(i);return e.jsx("div",{className:s?"":ae.begrunnelseTextField,children:e.jsx(I,{name:"begrunnelse",label:r||te.formatMessage({id:oe(n)}),validate:[_(t),ie,le,V],maxLength:2e3,readOnly:n,parse:C})})},de=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";P.buildInitialValues=n=>({begrunnelse:U(de(n))});P.transformValues=n=>({begrunnelse:n.begrunnelse});P.__docgenInfo={description:`ProsessStegBegrunnelseTextField
...
Presentasjonskomponent. Lar NAV-ansatt velge om vilkåret skal oppfylles eller avvises.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"aksjonspunkter",optional:!1,type:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erVilkarOk?: boolean;
  avslagskode?: string;
}`,signature:{properties:[{key:"erVilkarOk",value:{name:"boolean",required:!1}},{key:"avslagskode",value:{name:"string",required:!1}}]}}}},{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:null}],returns:null}],displayName:"VilkarResultPicker",props:{skalKunneInnvilge:{defaultValue:{value:"true",computed:!1},required:!1}}};const je="_vilkar_t9zom_1",xe="_aksjonspunktMargin_t9zom_5",Te="_godkjentImage_t9zom_10",he="_avslattImage_t9zom_16",b={vilkar:je,aksjonspunktMargin:xe,godkjentImage:Te,avslattImage:he},x=y(f),qe=({lovReferanse:n,title:r,originalErVilkarOk:s,isAksjonspunktOpen:a,readOnlySubmitButton:i,readOnly:t,rendreFakta:d,isDirty:k,erIkkeGodkjentAvBeslutter:l,isSubmitting:p,children:g})=>e.jsxs(e.Fragment,{children:[e.jsxs(M,{children:[e.jsxs(c,{children:[s!==void 0&&e.jsxs(u,{children:[s&&e.jsx(D,{className:b.godkjentImage}),!s&&e.jsx(Z,{className:b.avslattImage})]}),e.jsx(u,{children:e.jsx(H,{size:"small",children:r})}),n&&e.jsx(u,{children:e.jsx(W,{className:b.vilkar,children:n})})]}),e.jsx(c,{children:e.jsxs(u,{children:[s&&e.jsxs(e.Fragment,{children:[e.jsx(o,{eightPx:!0}),e.jsx(h,{size:"small",children:x.formatMessage({id:"ProsessPanelTemplate.ErOppfylt"})})]}),s===!1&&e.jsxs(e.Fragment,{children:[e.jsx(o,{eightPx:!0}),e.jsx(h,{size:"small",children:x.formatMessage({id:"ProsessPanelTemplate.ErIkkeOppfylt"})})]}),!a&&s===void 0&&e.jsxs(e.Fragment,{children:[e.jsx(o,{eightPx:!0}),e.jsx(v,{size:"small",children:x.formatMessage({id:"ProsessPanelTemplate.IkkeBehandlet"})})]})]})})]}),a&&e.jsx(o,{eightPx:!0}),e.jsxs(S,{className:b.aksjonspunktMargin,erAksjonspunktApent:a,erIkkeGodkjentAvBeslutter:l,children:[g,!t&&e.jsx(o,{sixteenPx:!0}),e.jsx(N,{isReadOnly:t,isSubmittable:!i,isDirty:k,isSubmitting:p})]}),d&&e.jsxs(e.Fragment,{children:[e.jsx(o,{sixteenPx:!0}),d()]})]});qe.__docgenInfo={description:"",methods:[],displayName:"ProsessPanelTemplate",props:{title:{required:!0,tsType:{name:"string"},description:""},lovReferanse:{required:!1,tsType:{name:"string"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},originalErVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},rendreFakta:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Pe="_aksjonspunktMargin_pxm8x_1",Be="_exclamationmarkIcon_pxm8x_6",R={aksjonspunktMargin:Pe,exclamationmarkIcon:Be},m=y(f),Ae=F(3),Re=O(1500),Ie=n=>r=>r!==void 0||n,_e=({erOverstyrt:n,isSolvable:r,erVilkarOk:s,hasAksjonspunkt:a,overrideReadOnly:i,isSubmitting:t,isPristine:d,toggleAv:k,erIkkeGodkjentAvBeslutter:l,children:p})=>{const{formState:{isDirty:g}}=q(),w=Ie(g);return e.jsxs(S,{className:R.aksjonspunktMargin,erAksjonspunktApent:n,erIkkeGodkjentAvBeslutter:l,children:[e.jsx(h,{size:"medium",children:m.formatMessage({id:"OverstyringPanel.AutomatiskVurdering"})}),e.jsx(o,{eightPx:!0}),p,(n||a)&&e.jsxs(e.Fragment,{children:[e.jsx(o,{eightPx:!0}),e.jsx(I,{name:"begrunnelse",label:m.formatMessage({id:"OverstyringPanel.Vilkar"}),validate:[w,Ae,Re,V],maxLength:1500,readOnly:i||!n})]}),e.jsx(o,{sixteenPx:!0}),!n&&s!==void 0&&e.jsxs(e.Fragment,{children:[e.jsx(o,{fourPx:!0}),e.jsxs(c,{children:[e.jsx(u,{children:e.jsx(ee,{})}),e.jsx(u,{children:e.jsx(v,{size:"small",children:m.formatMessage({id:"OverstyringPanel.Endret"})})})]})]}),n&&e.jsxs(M,{children:[e.jsxs(c,{children:[e.jsx(u,{children:e.jsx(ne,{className:R.exclamationmarkIcon})}),e.jsx(u,{children:e.jsx(v,{size:"small",children:m.formatMessage({id:"OverstyringPanel.Unntakstilfeller"})})})]}),e.jsx(o,{sixteenPx:!0}),e.jsxs(c,{children:[e.jsx(u,{children:!i&&e.jsx(T,{size:"small",variant:"primary",loading:t,disabled:t||!r||d,children:m.formatMessage({id:"OverstyringPanel.ConfirmInformation"})})}),e.jsx(u,{children:e.jsx(T,{size:"small",variant:"secondary",loading:t,disabled:t,onClick:k,type:"button",children:m.formatMessage({id:"OverstyringPanel.Avbryt"})})})]})]})]})};_e.__docgenInfo={description:"",methods:[],displayName:"OverstyringPanel",props:{erOverstyrt:{required:!0,tsType:{name:"boolean"},description:""},isSolvable:{required:!0,tsType:{name:"boolean"},description:""},erVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},hasAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},overrideReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isPristine:{required:!0,tsType:{name:"boolean"},description:""},toggleAv:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};export{_e as O,P,B as V,Le as a,N as b,qe as c};
