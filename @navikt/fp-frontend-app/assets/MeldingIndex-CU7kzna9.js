import{l as y,a5 as le,j as n,v as V,a6 as re,E as H,y as te,z as ie,a7 as ue,P as c,b as Y,r as h,n as Ee,a8 as O,G as I}from"./iframe-CmZteKSd.js";import{n as f,s as x,u as se,t as me,d as oe}from"./fagsakApi-DQMN_kMv.js";import{u as _e,D as ve,M as q,O as de,c as p}from"./index.es-CfTV3nac.js";import{D as i}from"./dokumentMalType-B-Xou3xH.js";import{V as Te}from"./venteArsakType-BJdSFL9e.js";import{U as ge}from"./UkjentAdresseMeldingIndex-Dp72phhF.js";import{V as J,H as F,b as C,M as U,L as Ne}from"./VStack-DTCeD3GB.js";import{L as Re}from"./Link-C6630lCg.js";import{M as A}from"./message-CLb9ApLX.js";import{S as ke}from"./CheckmarkCircleFill-CwP0RSkG.js";import{u as w}from"./useKodeverk-DbcR_0Y_.js";import{S as Ae}from"./SupportHeader-B7t1lAyJ.js";import{S as Se}from"./SettPaVentReadOnlyModal-7WFw2MSV.js";import{A as Le}from"./index.es-_gx3ED7v.js";var g=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(g||{});const Ie="_bredde_jav4h_9",M={bredde:Ie},Ke=H(4e3),De=H(1e4),be=te(3),z=({behandling:e,forhåndsvisBrev:a,submitCallback:t,revurderingVarslingArsak:o,fagsakYtelseType:_,kanVeilede:l,meldingFormData:u,setMeldingFormData:N,brukerManglerAdresse:k})=>{const s=y(),m=_e({defaultValues:u??ye(e)}),v=m.watch("brevmalkode"),R=m.watch("fritekst"),E=m.watch("arsakskode"),K=Fe(o,_);if(!e.språkkode)return null;const{formState:S,control:d}=m,L=r=>{v&&R?a({brevmalkode:v,fritekst:R,arsakskode:E}):R||m.setError("fritekst",{type:"manual",message:s.formatMessage({id:"Messages.FritekstRequired"})}),r.preventDefault()},D=le(e.språkkode),T=v===i.VARSEL_OM_REVURDERING;return n.jsx(ve,{formMethods:m,onSubmit:r=>t(Ge(r)),setDataOnUnmount:N,children:n.jsxs(J,{gap:"space-16",children:[n.jsx(q,{name:"brevmalkode",control:d,label:s.formatMessage({id:"Messages.Template"}),validate:[V],selectValues:e.brevmaler.map(r=>n.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:M.bredde}),T&&n.jsx(q,{name:"arsakskode",control:d,label:s.formatMessage({id:"Messages.Årsak"}),validate:[V],selectValues:K.map(r=>n.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:M.bredde}),pe(v,E)&&n.jsx(de,{name:"fritekst",control:d,label:s.formatMessage({id:Ve(v)}),validate:[V,T?De:Ke,be,ie],maxLength:T?1e4:4e3,badges:[{type:"info",titleText:D}],parse:re}),k&&n.jsx(ge,{}),n.jsxs(F,{justify:"space-between",children:[(!T||T&&E!==void 0)&&n.jsx(Re,{href:"#",onClick:L,onKeyDown:r=>r.key==="Enter"?L(r):null,children:n.jsx(A,{id:"Messages.Preview"})}),n.jsx(C,{size:"small",variant:"primary",loading:S.isSubmitting,disabled:S.isSubmitting||l,onClick:ue,children:n.jsx(A,{id:"Messages.Submit"})})]})]})})},Ve=e=>e===i.INNHENTE_OPPLYSNINGER||e===i.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",pe=(e,a)=>e===i.INNHENTE_OPPLYSNINGER||e===i.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===i.VARSEL_OM_TILBAKEKREVING||e===i.TBK_INNHENTE_OPPLYSNINGER||e===i.VARSEL_OM_REVURDERING&&a===g.ANNET,Fe=(e,a)=>a==="ES"?e.filter(t=>t.kode===g.BARN_IKKE_REGISTRERT_FOLKEREGISTER||t.kode===g.ANNET):a==="SVP"?e.filter(t=>t.kode!==g.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&t.kode!==g.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,ye=e=>{const a={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...a,brevmalkode:i.VARSEL_OM_REVURDERING}:{...a}},Ge=e=>{const a=e;return e.brevmalkode===i.VARSEL_OM_REVURDERING&&a.arsakskode!==g.ANNET&&(a.fritekst=" "),a};z.__docgenInfo={description:`Messages
...
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: FormValues) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  fritekst?: string;
  arsakskode?: string;
}`,signature:{properties:[{key:"brevmalkode",value:{name:"string",required:!1}},{key:"fritekst",value:{name:"string",required:!1}},{key:"arsakskode",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""},brukerManglerAdresse:{required:!0,tsType:{name:"boolean"},description:""}}};const Q={"Messages.Årsak":"Årsak","Messages.Fritekst":"Fritekst","Messages.Template":"Mal","Messages.DocumentList":"Liste over dokumenter (skriv ett dokument pr. linje)","Messages.Submit":"Send brev","Messages.Preview":"Forhåndsvis","Messages.PreviewText":"Forhåndsvis varselbrev","Messages.Beskrivelse":"Foretrukket språk","Messages.FritekstRequired":"Feltet må fylles ut","MessagesModal.description":"Brevet er bestilt","MessagesModal.text":"Brevet er bestilt","MessagesModal.OK":"OK","Malform.Beskrivelse":"Foretrukket språk"},Pe=Y(Q),$=e=>n.jsx(c,{value:Pe,children:n.jsx(z,{...e})});$.__docgenInfo={description:"",methods:[],displayName:"MeldingerSakIndex",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: FormValues) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  brevmalkode?: string;
  fritekst?: string;
  arsakskode?: string;
}`,signature:{properties:[{key:"brevmalkode",value:{name:"string",required:!1}},{key:"fritekst",value:{name:"string",required:!1}},{key:"arsakskode",value:{name:"string",required:!1}}]}},name:"values"}],return:{name:"void"}}},description:""},forhåndsvisBrev:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: ForhåndsvisBrevParams) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""}}};const Be="_image_v04s1_1",he="_modal_v04s1_8",j={image:Be,modal:he},W=({showModal:e,closeEvent:a})=>{const t=y();return n.jsx(U,{className:j.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:a,children:n.jsx(U.Body,{children:n.jsxs(F,{justify:"space-between",align:"center",children:[n.jsxs(F,{gap:"space-8",align:"center",children:[n.jsx(ke,{className:j.image,title:t.formatMessage({id:"MessagesModal.description"})}),n.jsx(Ne,{size:"small",children:n.jsx(A,{id:"MessagesModal.text"})})]}),n.jsx(C,{size:"small",variant:"primary",onClick:a,autoFocus:!0,type:"button",children:n.jsx(A,{id:"MessagesModal.OK"})})]})})})};W.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Oe=Y(Q),X=e=>n.jsx(c,{value:Oe,children:n.jsx(W,{...e})});X.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const fe=e=>e.behandlingPåVent?e.fristBehandlingPåVent:null,qe=({fagsakData:e,valgtBehandlingUuid:a,meldingFormData:t,setMeldingFormData:o,hentOgSettBehandling:_,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const u=y(),[N,k]=h.useState(!1),[s,m]=h.useState(!1),v=Ee(),R=e.getFagsak(),E=f(e.getBehandling(a)),K=x(E),S=se(oe()),{innloggetBruker:{kanVeilede:d}}=f(S.data),L=w("Venteårsak")||[],D=w("RevurderingVarslingÅrsak"),{mutateAsync:T,status:r}=p({mutationFn:b=>K.sendMelding(b)}),Z=Ue(m,T,_,k,o,E),ee=()=>{v("/")},ne=Me(E),ae=()=>(m(!1),_()),G=r==="success",P=E.behandlingTillatteOperasjoner,B=!d&&e.getAlleBehandlinger().some(b=>!b.avsluttet)&&P?.behandlingKanSendeMelding;return n.jsxs(n.Fragment,{children:[s&&n.jsx(X,{showModal:G&&s,closeEvent:ae}),n.jsx(Ae,{tekst:u.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:n.jsxs(J,{gap:"space-16",children:[!B&&n.jsx(Le,{variant:"info",children:n.jsx(A,{id:we(d,P?.behandlingKanSendeMelding)})}),B&&n.jsx($,{submitCallback:Z,behandling:E,forhåndsvisBrev:ne,revurderingVarslingArsak:D,fagsakYtelseType:R.fagsakYtelseType,kanVeilede:d,meldingFormData:t,setMeldingFormData:o,brukerManglerAdresse:R.brukerManglerAdresse})]})}),G&&N&&n.jsx(Se,{lukkCallback:ee,ventearsak:Te.AVV_DOK,ventearsaker:L,frist:fe(E)})]})},Ue=(e,a,t,o,_,l)=>u=>{const N=u.brevmalkode===i.INNHENTE_OPPLYSNINGER||u.brevmalkode===i.VARSEL_OM_REVURDERING||u.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,k=I.TILBAKEKREVING===l.type||I.TILBAKEKREVING_REVURDERING===l.type;e(!N);const s=k?{behandlingUuid:l.uuid,fritekst:u.fritekst,brevmalkode:u.brevmalkode}:{behandlingUuid:l.uuid,brevmalkode:u.brevmalkode,fritekst:u.fritekst,arsakskode:u.arsakskode};return a(s).then(()=>{_(),N?o(!0):t()})},we=(e,a)=>a?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Me=e=>{const a=x(e),{mutate:t}=p({mutationFn:l=>a.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:l.brevmalkode,fritekst:l.fritekst||" ",arsakskode:l.arsakskode}),onSuccess:l=>{O(l)}}),{mutate:o}=p({mutationFn:l=>me(e.uuid,l.brevmalkode,l.fritekst??" "),onSuccess:l=>{O(l)}}),_=I.TILBAKEKREVING===e.type||I.TILBAKEKREVING_REVURDERING===e.type;return l=>{_?o(l):t(l)}};qe.__docgenInfo={description:`MeldingIndex
...
Har ansvar for å hente mottakere og brevmaler fra serveren.`,methods:[],displayName:"MeldingIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},meldingFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  fritekst?: string;
  arsakskode?: string;
}`,signature:{properties:[{key:"brevmalkode",value:{name:"string",required:!1}},{key:"fritekst",value:{name:"string",required:!1}},{key:"arsakskode",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{qe as M,g as R};
