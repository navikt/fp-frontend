...
`)+c+`return __p
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const Mk=cr(bt),Kk=v=>{switch(v){case Iu.KVINNE:return Wa.female;case Iu.MANN:return Wa.male;default:return Wa.unknown}},vt=({rolle:v="BRUKER",alleKodeverk:b,harSammeAdresser:u,navn:x,kjønn:A,sivilstand:P,fødselsdato:j,dødsdato:$,adresser:D,showIcon:Q=!0})=>{var Z;const M=v==="BARN";return y.jsx(yt,{value:Mk,children:y.jsx(pt,{background:"bg-subtle",padding:"4",borderRadius:"large","aria-label":x,children:y.jsxs(Ja,{gap:"1",children:[y.jsxs($a,{gap:"5",children:[Q&&y.jsx("div",{children:y.jsx(Ak,{gender:Kk(A),isChild:M})}),y.jsxs("div",{children:[y.jsxs($a,{gap:"4",children:[y.jsx(Gu,{children:y.jsx(Pe,{id:"PersonPanel.RolleOgNavn",values:{rolle:v,navn:x}})}),M&&j&&!$&&y.jsx(Ya,{children:y.jsx(Pe,{id:"PersonPanel.Fodt",values:{dato:Fu(j)}})}),$&&y.jsx(Ya,{children:y.jsx(Pe,{id:"PersonPanel.Dod",values:{dato:Fu($)}})})]}),!M&&P&&y.jsx(za,{"aria-label":"Sivilstand",children:(Z=b[kt.SIVILSTAND_TYPE].find(Be=>Be.kode===P))==null?void 0:Z.navn})]})]}),y.jsxs(za,{children:[v==="BARN"&&y.jsx(Pe,{id:"PersonPanel.Beskrivelse.Barn",values:{rolle:v}}),v==="BRUKER"&&y.jsx(Pe,{id:"PersonPanel.Beskrivelse.Bruker",values:{rolle:v}}),v==="ANNEN_PART"&&y.jsx(Pe,{id:"PersonPanel.Beskrivelse.Annenpart",values:{rolle:v}})]}),y.jsx(Xu,{harSammeAdresser:u,adresser:D,adresseKodeverk:b[kt.ADRESSE_TYPE]})]})})})};vt.__docgenInfo={description:"",methods:[],displayName:"Personopplysninger",props:{rolle:{required:!1,tsType:{name:"union",raw:"'BARN' | 'BRUKER' | 'ANNEN_PART'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'BRUKER'"},{name:"literal",value:"'ANNEN_PART'"}]},description:"",defaultValue:{value:"'BRUKER'",computed:!1}},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
  ...
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}>`},description:""}}};const Dk="_boks_c3bfh_1",Vk="_harBorderLeft_c3bfh_8",Uk="_harBorderTop_c3bfh_12",Ju={boks:Dk,harBorderLeft:Vk,harBorderTop:Uk},Wk=wk.bind(Ju),Gk=({harBorderTop:v=!1,harBorderLeft:b=!0,children:u})=>y.jsx("div",{className:Wk(Ju.boks,{harBorderLeft:b,harBorderTop:v}),children:u});Gk.__docgenInfo={description:"",methods:[],displayName:"Boks",props:{harBorderTop:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},harBorderLeft:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const Qu=({erPanelValgt:v,dataState:b,children:u})=>v?b!==$u.SUCCESS?y.jsx(tk,{}):u:null;Qu.__docgenInfo={description:"",methods:[],displayName:"FaktaPanelWrapper",props:{erPanelValgt:{required:!0,tsType:{name:"boolean"},description:""},dataState:{required:!0,tsType:{name:"RestApiState"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactElement | null",elements:[{name:"ReactElement"},{name:"null"}]},description:""}}};const Hk="default",$k=(v,b,u,x,A,P)=>{const[j,$]=Me.useState(!1);Me.useEffect(()=>{v({id:b})},[]);const D=x&&(P===b||A&&P===Hk),Q=ak(x);return Me.useEffect(()=>{x?v({id:b,tekst:u,erAktiv:D,harApneAksjonspunkter:A}):!x&&Q&&v({id:b}),$(D)},[Q,x,D,A]),x&&j},Du="default",Vu="default",Yk=(v,b,u,x,A,P)=>j=>{const D=(Array.isArray(j)?j:[j]).map(M=>({"@type":M.kode,...M})),Q={saksnummer:v.saksnummer,behandlingUuid:b.uuid,behandlingVersjon:b.versjon};if(D&&A&&P){if(D.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(P.includes(D[0].kode))return A({...Q,overstyrteAksjonspunktDtoer:D},!0).then(()=>u(Vu,Du))}return x({...Q,bekreftedeAksjonspunktDtoer:D},!0).then(()=>u(Vu,Du))},zk=(v,b=[])=>{const[u,x]=Me.useState(),A=Me.useContext(vk);Me.useEffect(()=>{u&&x(void 0)},[A.behandling.versjon]);const{aksjonspunkt:P}=A.behandling,j=Me.useMemo(()=>P&&v?P.filter(M=>v.includes(M.definisjon)):[],[P,v]),$=Tk(A.behandling,[],A.rettigheter,A.hasFetchError),D=Me.useMemo(()=>Rk(A.behandling,j),[A.behandling.versjon,j]),Q=Me.useMemo(()=>Yk(A.fagsak,A.behandling,A.oppdaterProsessStegOgFaktaPanelIUrl,A.lagreAksjonspunkter,A.lagreOverstyrteAksjonspunkter,b),[A.behandling.versjon,b]);return{behandling:A.behandling,submittable:!j.some(M=>Lu(M.status))||j.some(M=>M.kanLoses),harApneAksjonspunkter:j.some(M=>Lu(M.status)&&M.kanLoses),alleKodeverk:A.alleKodeverk,aksjonspunkter:j,readOnly:$,alleMerknaderFraBeslutter:D,submitCallback:Q,formData:u,setFormData:x}},el=({valgtFaktaSteg:v,behandling:b,registrerFaktaPanel:u,panelEndepunkter:x=[],aksjonspunktKoder:A,overstyringApKoder:P,skalPanelVisesIMeny:j,renderPanel:$,faktaPanelKode:D,faktaPanelMenyTekst:Q})=>{const M=zk(A,P),Z=$k(u,D,Q,j(),M.harApneAksjonspunkter,v),Be=x.map(De=>({key:De})),{data:Ke,state:Ce}=mk.useMultipleRestApi(Be,{updateTriggers:[Z,b==null?void 0:b.versjon],suspendRequest:!Z||Be.length===0,isCachingOn:!0});return y.jsx(Qu,{erPanelValgt:Z,dataState:Be.length>0?Ce:$u.SUCCESS,children:$({...Ke,...M})})};el.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{panelEndepunkter:{required:!1,tsType:{name:"Array",elements:[{name:"RestKey",elements:[{name:"any"},{name:"any"}],raw:"RestKey<any, any>"}],raw:"RestKey<any, any>[]"},description:"",defaultValue:{value:"[]",computed:!1}},aksjonspunktKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},overstyringApKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"signature",type:"function",raw:"() => boolean",signature:{arguments:[],return:{name:"boolean"}}},description:""},renderPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: PANEL_DATA & StandardFaktaPanelProps) => ReactElement",signature:{arguments:[{type:{name:"intersection",raw:"PANEL_DATA & StandardFaktaPanelProps",elements:[{name:"PANEL_DATA"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
Readonly<{
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Zk="_selectWidth_1ur6m_1",Xk="_leftCol_1ur6m_5",Uu={selectWidth:Zk,leftCol:Xk},xn=({intl:v,readOnly:b,vergetyper:u=[],alleMerknaderFraBeslutter:x,valgtVergeType:A})=>y.jsxs(ik,{merknaderFraBeslutter:x[ht.AVKLAR_VERGE],children:[y.jsx(pk,{name:"vergeType",className:Uu.selectWidth,label:v.formatMessage({id:"Verge.TypeVerge"}),validate:[Hn],selectValues:u.map(P=>y.jsx("option",{value:P.kode,children:P.navn},P.kode)),readOnly:b}),y.jsx(sk,{children:A&&y.jsxs(y.Fragment,{children:[y.jsx(mt,{sixteenPx:!0}),y.jsxs(Nu,{children:[y.jsx(ft,{className:Uu.leftCol,children:y.jsx(Ua,{name:"navn",label:v.formatMessage({id:"Verge.Navn"}),validate:[Hn,kk],readOnly:b})}),y.jsxs(ft,{children:[A!==Xa.ADVOKAT&&y.jsx(Ua,{name:"fnr",label:v.formatMessage({id:"Verge.FodselsNummer"}),validate:[Hn,ck],readOnly:b}),A===Xa.ADVOKAT&&y.jsx(Ua,{name:"organisasjonsnummer",label:v.formatMessage({id:"Verge.Organisasjonsnummer"}),validate:[Hn],readOnly:b})]})]}),y.jsx(mt,{sixteenPx:!0}),y.jsxs(Nu,{children:[y.jsx(ft,{children:y.jsx(Ou,{name:"gyldigFom",label:v.formatMessage({id:"Verge.PeriodeFOM"}),validate:[Hn,Mu],isReadOnly:b})}),y.jsx(ft,{children:y.jsx(Ou,{name:"gyldigTom",label:v.formatMessage({id:"Verge.PeriodeTOM"}),validate:[Mu],isReadOnly:b})})]})]})})]});xn.defaultProps={vergetyper:[]};xn.buildInitialValues=v=>({navn:v.navn,gyldigFom:v.gyldigFom,gyldigTom:v.gyldigTom,fnr:v.fnr,organisasjonsnummer:v.organisasjonsnummer,vergeType:v.vergeType||void 0});xn.transformValues=v=>({vergeType:v.vergeType,navn:v.navn,fnr:v.fnr,organisasjonsnummer:v.organisasjonsnummer,gyldigFom:v.gyldigFom,gyldigTom:v.gyldigTom,kode:ht.AVKLAR_VERGE});xn.__docgenInfo={description:`RegistrereVergeFaktaForm
...
}`,signature:{properties:[{key:"vergeType",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"fnr",value:{name:"string",required:!0}},{key:"organisasjonsnummer",value:{name:"string",required:!0}},{key:"gyldigFom",value:{name:"string",required:!0}},{key:"gyldigTom",value:{name:"string",required:!1}},{key:"kode",value:{name:"AksjonspunktKode.AVKLAR_VERGE",required:!0}}]}}}}],displayName:"RegistrereVergeFaktaForm",props:{vergetyper:{defaultValue:{value:"[]",computed:!1},required:!1}}};const Jk=(v,b)=>({begrunnelse:yr.buildInitialValues(b.filter(u=>u.definisjon===ht.AVKLAR_VERGE)[0]).begrunnelse,...xn.buildInitialValues(v||{})}),Qk=v=>({...xn.transformValues(v),begrunnelse:v.begrunnelse}),nl=({hasOpenAksjonspunkter:v,submittable:b,readOnly:u,alleMerknaderFraBeslutter:x,aksjonspunkter:A,verge:P,alleKodeverk:j,submitCallback:$,formData:D,setFormData:Q})=>{const M=Hu(),Z=yk({defaultValues:D||Jk(P,A),shouldUnregister:!0}),Be=Z.watch("vergeType"),Ke=Z.watch("begrunnelse"),Ce=Me.useMemo(()=>j[kt.VERGE_TYPE].sort((De,ge)=>De.navn.localeCompare(ge.navn)),[j[kt.VERGE_TYPE]]);return A.length===0?null:y.jsxs(y.Fragment,{children:[y.jsx(uk,{isAksjonspunktOpen:v,children:[M.formatMessage({id:"RegistrereVergeInfoPanel.CheckInformation"})]}),y.jsxs(hk,{formMethods:Z,onSubmit:De=>$(Qk(De)),setDataOnUnmount:Q,children:[y.jsx(xn,{readOnly:u,intl:M,vergetyper:Ce,valgtVergeType:Be,alleMerknaderFraBeslutter:x}),y.jsx(mt,{twentyPx:!0}),y.jsx(yr,{isSubmittable:b,isReadOnly:u,hasBegrunnelse:!!Ke}),y.jsx(mt,{twentyPx:!0}),y.jsx(Yu,{isSubmittable:b&&!!Be,isReadOnly:u,isSubmitting:Z.formState.isSubmitting,isDirty:Z.formState.isDirty})]})]})};nl.__docgenInfo={description:`RegistrereVergeInfoPanel
...
Presentasjonskomponent. Har ansvar for å sette opp formen for att registrere verge.`,methods:[],displayName:"RegistrereVergeInfoPanel",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: AvklarVergeAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<TilbakekrevingKodeverkType, KodeverkMedNavn[]>"}]},description:""}}};const Wu=[ht.AVKLAR_VERGE],rc=[qk.VERGE],tc=({valgtFaktaSteg:v,behandling:b,registrerFaktaPanel:u})=>y.jsx(el,{valgtFaktaSteg:v,behandling:b,registrerFaktaPanel:u,panelEndepunkter:rc,aksjonspunktKoder:Wu,faktaPanelKode:bk.VERGE,faktaPanelMenyTekst:Hu().formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:()=>Wu.some(x=>_k(x,b.aksjonspunkt)),renderPanel:x=>y.jsx(rl,{...x})});tc.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};export{Gk as B,el as F,Ck as P,tc as V,Yu as a,yr as b,Nk as c,Lk as d,Ik as e,Fk as f,vc as g,vt as h,mc as i,Zu as j,Ok as k,zu as s};
