import{r as t,j as y}from"./iframe-Cotodpjf.js";import{c as v}from"./index.es-CMT5Sp03.js";import{i as p,A as m}from"./index-DBCjAzYk.js";import{S as T}from"./SettPaVentModalIndex-7SGqRkLD.js";import{u as A}from"./behandlingApi-BXX5eGPI.js";const q=({behandling:e,kodeverk:l,opneSokeside:s,erTilbakekreving:i=!1,skalIkkeViseModal:r=!1})=>{const[u,a]=t.useState(!r&&e.behandlingPåVent),k=()=>a(!1),d=A(e),{mutate:o}=v({mutationFn:n=>d.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>s()});t.useEffect(()=>{r||a(e.behandlingPåVent)},[e.versjon,r]);const g=e.aksjonspunkt.filter(n=>p(n.status)).some(n=>n.definisjon===m.AUTO_MANUELT_SATT_PÅ_VENT);return y.jsx(T,{submitCallback:o,cancelEvent:k,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:g,ventearsaker:l.Venteårsak,erTilbakekreving:i,showModal:u})};q.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
