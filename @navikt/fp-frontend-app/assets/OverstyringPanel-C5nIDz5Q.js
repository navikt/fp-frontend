import{j as e,U as K,b as v,m as w,r as O}from"./iframe-DaT-6NHp.js";import{a as j,g as q,a4 as B,r as S,f as I,y as h,E as D,e as _,M as F,Y as L}from"./index.es-SUrURpHW.js";import{b as M}from"./index-CuvBi0Zn.js";import{V as U}from"./vilkarUtfallType-vN0hVpa7.js";import{b as f,V as E,H as m,B as p,a as z,D as Y,L as V}from"./VStack-Dc6RlHb2.js";import{S as $}from"./Checkmark-6go0sr7D.js";import{S as C}from"./TotrinnskontrollIndex-BbdeF_h5.js";import{S as H,J as x,o as J}from"./index.es-5lAmf7Pc.js";import{S as X}from"./CheckmarkCircleFill-DMjkJCi_.js";import{S as W}from"./ExclamationmarkTriangleFill-B_DNBF31.js";const Q="_begrunnelseTextField_hw8s7_6",Z={begrunnelseTextField:Q},y={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=v(y),ne=S(3),se=I(2e3),ae=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",re=n=>a=>a!==void 0||n,N=({readOnly:n,text:a,useAllWidth:s=!1,notRequired:r=!1})=>{const{formState:{isDirty:l}}=j(),t=r?()=>!1:re(l);return e.jsx("div",{className:s?"":Z.begrunnelseTextField,children:e.jsx(q,{name:"begrunnelse",label:a??ee.formatMessage({id:ae(n)}),validate:[B(t),ne,se,h],maxLength:2e3,readOnly:n,parse:K})})},te=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";N.buildInitialValues=n=>({begrunnelse:w(te(n))});N.transformValues=n=>({begrunnelse:n.begrunnelse});N.__docgenInfo={description:`ProsessStegBegrunnelseTextField
