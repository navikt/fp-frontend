import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./index-DjhIdADd.js";import{D as C,I as F,b as q,M as _}from"./index.es-CxLfJ8ME.js";import{a as j}from"./behandlingDataContext-BnLc3C0Q.js";import{k as D}from"./withPanelData-qofNgRun.js";import{E as T,y as I,q as c}from"./index.es-NZkkt8sl.js";import{S}from"./ExclamationmarkTriangleFill-6g_sp-6j.js";import{V as A,B as E}from"./BehandlingHenlagtPanel-D7255wql.js";const h=({menyData:a,oppdaterFaktaPanelIUrl:i})=>{const o=D();return r.jsx(T,{heading:o.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(t=>({label:t.tekst??"",active:t.erAktiv,icon:t.harApneAksjonspunkter?r.jsx(S,{color:"var(--a-orange-600)"}):void 0})),onClick:i})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{menyData:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
