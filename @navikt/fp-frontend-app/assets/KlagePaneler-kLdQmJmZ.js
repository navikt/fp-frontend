...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const pn=[y.VURDERING_AV_FORMKRAV_KLAGE_NFP],bn=[B.KLAGE_VURDERING],Fe=({alleBehandlinger:n,...r})=>{const t=K(),s=b.useMemo(()=>n.filter(i=>i.status===pe.AVSLUTTET).filter(i=>(i.type!==C.KLAGE||he(i.resultatType))&&i.type!==C.ANKE),[n]),{startRequest:a}=H.useRestApiRunner(B.SAVE_FORMKRAV_VURDERING);return e.jsx($,{...r,panelEndepunkter:bn,aksjonspunktKoder:pn,prosessPanelKode:U.FORMKRAV_KLAGE_NAV_FAMILIE_OG_PENSJON,prosessPanelMenyTekst:t.formatMessage({id:"Behandlingspunkt.FormkravKlageNFP"}),skalPanelVisesIMeny:()=>!0,renderPanel:i=>e.jsx(se,{avsluttedeBehandlinger:s,lagreFormkravVurdering:a,...i})})};Fe.__docgenInfo={description:"",methods:[],displayName:"FormKravFamOgPensjonProsessStegInitPanel",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  uuid: string;
  type: string;
  status: string;
  opprettet: string;
...
Setter opp readonly-panel for behandling av klage (KA).`,methods:[],displayName:"BehandleKlageFormKa",props:{alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  underBehandlingKabal?: boolean;
  behandletAvKabal?: boolean;
}>`},description:""}}};const fn="_previewLink_1xd5p_1",hn="_select_1xd5p_7",jn="_selectReadOnly_1xd5p_10",An="_confirmVilkarForm_1xd5p_14",Tn="_panel_1xd5p_17",Kn="_fritekstTilBrevTextArea_1xd5p_20",cn="_explanationTextarea_1xd5p_23",L={previewLink:fn,select:hn,selectReadOnly:jn,confirmVilkarForm:An,panel:Tn,fritekstTilBrevTextArea:Kn,explanationTextarea:cn},Se=({readOnly:n,medholdReasons:r,alleHjemmlerMedNavn:t,klageVurdering:s})=>{const a=K(),i=r.map(o=>e.jsx("option",{value:o.kode,children:o.navn},o.kode)),k=t.map(o=>e.jsx("option",{value:o.kode,children:o.navn},o.kode));return e.jsxs(e.Fragment,{children:[e.jsx(F,{name:"klageVurdering",validate:[c],isReadOnly:n,isHorizontal:!0,radios:[{value:m.MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.ResolveKlage.ChangeVedtak"})},{value:m.STADFESTE_YTELSESVEDTAK,label:a.formatMessage({id:"Klage.ResolveKlage.KeepVedtakNfp"})}]}),s===m.MEDHOLD_I_KLAGE&&e.jsxs(e.Fragment,{children:[e.jsx(d,{sixteenPx:!0}),e.jsxs(Qe,{children:[e.jsx(Z,{readOnly:n,name:"klageMedholdArsak",selectValues:i,className:n?L.selectReadOnly:L.select,label:a.formatMessage({id:"Klage.ResolveKlage.Cause"}),validate:[c]}),e.jsx(d,{sixteenPx:!0}),e.jsx(F,{name:"klageVurderingOmgjoer",validate:[c],isReadOnly:n,radios:[{value:E.GUNST_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.Omgjort"})},{value:E.UGUNST_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.Ugunst"})},{value:E.DELVIS_MEDHOLD_I_KLAGE,label:a.formatMessage({id:"Klage.Behandle.DelvisOmgjort"})}]})]})]}),e.jsx(d,{sixteenPx:!0}),e.jsx(Z,{readOnly:n,name:"klageHjemmel",selectValues:k,className:n?L.selectReadOnly:L.select,label:a.formatMessage({id:"Klage.ResolveKlage.Hjemmel"}),validate:[c]}),e.jsx(d,{sixteenPx:!0})]})};Se.__docgenInfo={description:"",methods:[],displayName:"KlageVurderingRadioOptionsNfp",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},medholdReasons:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
...
Readonly<{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Yn=[y.VURDER_FORMKRAV_NK],Cn=[B.KLAGE_VURDERING],Ue=({alleBehandlinger:n,...r})=>{const t=K(),s=b.useMemo(()=>n.filter(i=>i.status===pe.AVSLUTTET).filter(i=>(i.type!==C.KLAGE||he(i.resultatType))&&i.type!==C.ANKE),[n]),{startRequest:a}=H.useRestApiRunner(B.SAVE_FORMKRAV_VURDERING);return e.jsx($,{...r,panelEndepunkter:Cn,aksjonspunktKoder:Yn,prosessPanelKode:U.FORMKRAV_KLAGE_NAV_KLAGEINSTANS,prosessPanelMenyTekst:t.formatMessage({id:"Behandlingspunkt.FormkravKlageKA"}),skalPanelVisesIMeny:()=>!0,renderPanel:i=>e.jsx(se,{avsluttedeBehandlinger:s,lagreFormkravVurdering:a,...i})})};Ue.__docgenInfo={description:"",methods:[],displayName:"FormKravKlageInstansProsessStegInitPanel",props:{alleBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  uuid: string;
  type: string;
  status: string;
  opprettet: string;
