...
Har ansvar for å sette opp formen for faktapenelet til Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonInfoPanel",props:{submittable:{required:!0,tsType:{name:"boolean"},description:""},isForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  gjeldende: FamilieHendelse;
  register: FamilieHendelse;
}>`},description:""},isForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const Cr=[u.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE,u.ADOPSJONSDOKUMENTAJON,u.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN],Jr=()=>{const n=Ye(Cr),{behandling:r,fagsak:a}=Y.use(De),t=Ae(r),{data:s}=h(t.familiehendelseOptions(r)),{data:o}=h(t.søknadOptions(r));return e.jsx(Ge,{standardPanelProps:n,faktaPanelKode:He.ADOPSJONSVILKARET,faktaPanelMenyTekst:j().formatMessage({id:"FaktaInitPanel.Title.Adopsjon"}),skalPanelVisesIMeny:r.vilkår.some(i=>ir.some(l=>l===i.vilkarType)),children:s&&o?e.jsx(Fn,{familiehendelse:s,soknad:o,isForeldrepengerFagsak:a.fagsakYtelseType===yn.FORELDREPENGER,submittable:n.submittable}):e.jsx(je,{})})};Jr.__docgenInfo={description:"",methods:[],displayName:"AdopsjonsvilkaretFaktaInitPanel"};const Wr="_colMargin_1r8hu_1",Fe={colMargin:Wr},ye=n=>n?I(n,Te).format(Se):"-",Qr=(n,r,a,t)=>n&&Object.keys(r).length>0?ye(Object.values(r)[0]):t?ye(t):n?a?ye(a):"-":null,cn=({soknad:n,termindato:r})=>{const a=n.fodselsdatoer?n.fodselsdatoer:{},t=Object.keys(a).length>0?"FodselsammenligningPanel.Fodselsdato":"FodselsammenligningPanel.Termindato",s=Object.keys(a).length>0?"FodselSammenligningOtherPanel.OpplysningerISoknad":"FodselSammenligningOtherPanel.TerminISoknad",o=Y.useMemo(()=>Qr(!!n,a,n.termindato,r),[n,a,r]);return e.jsxs(e.Fragment,{children:[e.jsx(ue,{size:"small",children:e.jsx(d,{id:s})}),e.jsx(b,{sixteenPx:!0}),e.jsx(be,{children:e.jsxs(fe,{children:[n.utstedtdato&&e.jsxs(U,{className:Fe.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.UstedtDato"})}),e.jsx(c,{size:"small",children:ye(n.utstedtdato)})]}),e.jsxs(U,{className:Fe.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:t})}),e.jsx(c,{size:"small",children:o})]}),e.jsxs(U,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.AntallBarn"})}),e.jsx(c,{size:"small",children:n.antallBarn})]})]})})]})};cn.__docgenInfo={description:`FodselSammenligningOtherPanel
...
Viser sammenligning av fødsel ved ytelsesvedtak/søknad og oppdatert informasjon fra TPS.`,methods:[],displayName:"FodselSammenligningOtherPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: string;
}>`},description:""},termindato:{required:!1,tsType:{name:"string"},description:""}}};const Ee=n=>n?I(n,Te).format(Se):"-",Xr=(n,r,a)=>{if(!r&&!a)return"";const t=a||{termindato:void 0,avklartBarn:[]};if(n){const s=t.termindato?t.termindato:r==null?void 0:r.termindato;return s?Ee(s):void 0}return t.avklartBarn&&t.avklartBarn.length>0?Ee(t.avklartBarn[0].fodselsdato):r!=null&&r.fodselsdatoer?Ee(Object.values(r.fodselsdatoer)[0]):"-"},Zr=(n,r,a)=>{if(!r&&!a)return 0;const t=a||{termindato:void 0,antallBarnTermin:void 0,avklartBarn:[]};return n?t.termindato?t.antallBarnTermin:r==null?void 0:r.antallBarn:t.avklartBarn&&t.avklartBarn.length>0?t.avklartBarn.length:r==null?void 0:r.antallBarn},jn=({vedtaksDatoSomSvangerskapsuke:n,soknadOriginalBehandling:r,familiehendelseOriginalBehandling:a})=>{const t=a&&!!a.termindato||!(r!=null&&r.fodselsdatoer)||Object.keys(r.fodselsdatoer).length===0,s=t?"FodselsammenligningPanel.Termindato":"FodselsammenligningPanel.Fodselsdato",o=Xr(t,r,a),i=Zr(t,r,a),l=a?(!a.avklartBarn||a.avklartBarn.length===0)&&!!n:!1;return e.jsxs(e.Fragment,{children:[e.jsx(ue,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.Ytelsesvedtak"})}),e.jsx(b,{sixteenPx:!0}),e.jsx(be,{children:e.jsxs(fe,{children:[l&&e.jsxs(U,{className:Fe.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.FodtISvangerskapsuke"})}),e.jsx(c,{size:"small",children:n})]}),e.jsxs(U,{className:Fe.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:s})}),e.jsx(c,{size:"small",children:o??"-"})]}),e.jsxs(U,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselsammenligningPanel.AntallBarn"})}),e.jsx(c,{size:"small",children:i??"-"})]})]})})]})};jn.__docgenInfo={description:`FodselSammenligningRevurderingPanel
...
Har ansvar for å sette opp formen for faktapenelet til Fødselsvilkåret.`,methods:[],displayName:"FodselInfoPanel",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const ca=[u.TERMINBEKREFTELSE,u.SJEKK_MANGLENDE_FODSEL],ja=()=>{const n=j(),{behandling:r}=Y.use(De),a=Ye(ca),t=Ae(r),{data:s}=h(t.familiehendelseOptions(r)),{data:o}=h(t.søknadOptions(r)),{data:i}=h(t.familiehendelseOrigninalBehandlingOptions(r)),{data:l}=h(t.søknadOriginalBehandlingOptions(r));return e.jsx(Ge,{standardPanelProps:a,faktaPanelKode:He.FODSELSVILKARET,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Fodsel"}),skalPanelVisesIMeny:r.vilkår.some(g=>lr.some(m=>m===g.vilkarType)),children:s&&o?e.jsx(An,{soknad:o,familiehendelse:s,familiehendelseOriginalBehandling:i,soknadOriginalBehandling:l,submittable:a.submittable}):e.jsx(je,{})})};ja.__docgenInfo={description:"",methods:[],displayName:"FodselvilkaretFaktaInitPanel"};const Dn=({alleMerknaderFraBeslutter:n,soknad:r})=>{const a=j(),{adopsjonFodelsedatoer:t}=r;return e.jsx(P,{title:a.formatMessage({id:"BarnPanel.BarnDetSøkesOm"}),merknaderFraBeslutter:n[u.OMSORGSOVERTAKELSE],children:t&&Object.keys(t).map(s=>e.jsxs(kn.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"BarnPanel.ChildNumberBornData",values:{childNumber:s}})}),e.jsx(c,{size:"small",children:I(t[parseInt(s,10)]).format(Se)}),e.jsx(b,{eightPx:!0})]},`${s}`))})};Dn.__docgenInfo={description:`BarnPanel
...
Viser barn fra søknad`,methods:[],displayName:"BarnPanel",props:{alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: string;
}>`},description:""}}};const tn=({aktoerId:n,navn:r,kjønn:a,adresser:t,dødsdato:s})=>{const o=Je(t,We.POSTADRESSE),i=Je(t,We.BOSTEDSADRESSE);return{aktoerId:n,navn:r,dødsdato:s,adresse:o||i,erMor:a===kr.KVINNE}},Bn=({personoversikt:n,alleMerknaderFraBeslutter:r})=>{const a=j(),t=Y.useMemo(()=>{const s=[tn(n.bruker)];return n.annenPart&&s.push(tn(n.annenPart)),s},[n]);return e.jsx(P,{title:a.formatMessage({id:"ForeldrePanel.Foreldre"}),merknaderFraBeslutter:r[u.OMSORGSOVERTAKELSE],children:e.jsx(de,{gap:"8",children:t.map(s=>e.jsxs(de,{gap:"2",children:[e.jsx(ue,{size:"small",children:s.navn}),e.jsx(S,{size:"small",children:e.jsx(d,{id:"ForeldrePanel.Address"})}),e.jsx(c,{size:"small",children:s.adresse&&!s.dødsdato?sr(s.adresse):"-"}),s.dødsdato&&e.jsxs(e.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"ForeldrePanel.DeathDate"})}),e.jsx(c,{size:"small",children:e.jsx(Ke,{dateString:s.dødsdato})})]})]},`${s.aktoerId}`))})})};Bn.__docgenInfo={description:`ForeldrePanel
...
Har ansvar for å sette opp form for faktapenelet til Omsorgsvilkåret.`,methods:[],displayName:"OmsorgOgForeldreansvarInfoPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  relatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
  innvilgetRelatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const dn=[u.OMSORGSOVERTAKELSE,u.AVKLAR_VILKAR_FOR_FORELDREANSVAR],Ea=({personoversikt:n})=>{const r=j(),a=Ye(dn),{behandling:t}=Y.use(De),s=Ae(t),{data:o}=h(s.søknadOptions(t)),{data:i}=h(s.familiehendelseOptions(t)),{data:l}=h(s.inntektArbeidYtelseOptions(t));return e.jsx(Ge,{standardPanelProps:a,faktaPanelKode:He.OMSORGSVILKARET,faktaPanelMenyTekst:r.formatMessage({id:"FaktaInitPanel.Title.OmsorgOgForeldreansvar"}),skalPanelVisesIMeny:dn.some(g=>w(g,t.aksjonspunkt)),children:o&&i&&l?e.jsx(hn,{soknad:o,familiehendelse:i,inntektArbeidYtelse:l,personoversikt:n,submittable:a.submittable}):e.jsx(je,{})})};Ea.__docgenInfo={description:"",methods:[],displayName:"OmsorgOgForeldreansvarFaktaInitPanel",props:{personoversikt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  bruker: PersonopplysningerBasis;
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}`,signature:{properties:[{key:"bruker",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}>`},description:""}}};const Ia="_flexContainer_16pq7_48",un={flexContainer:Ia},gn=rr(3),xa=ar(1e4),_a=n=>({kode:ge(n[0].definisjon,u.VARSEL_REVURDERING_ETTERKONTROLL,u.VARSEL_REVURDERING_MANUELL),begrunnelse:n[0].begrunnelse??"",sendVarsel:void 0}),_e=n=>n||{},Ma=[],Nn=({familiehendelse:n,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,previewCallback:s})=>{const o=j(),{isReadOnly:i,alleKodeverk:l,behandling:g,submitCallback:m,aksjonspunkterForPanel:k}=z(),y=_a(k),{formData:p,setFormData:q}=Q(),v=C({defaultValues:p||y}),f=v.watch(),[F,A]=Y.useState(!1),R=()=>A(!1),N=()=>A(!0),_=le=>{v.trigger().then(Ve=>{Ve&&m({...f,...le}),A(!1)})},T=le=>{le.preventDefault(),s({dokumentMal:yr.VARSEL_OM_REVURDERING,arsakskode:vr.ANNET,fritekst:f.fritekst||" "})},{avklartBarn:D}=_e(n.register),{termindato:K}=_e(n.gjeldende),{vedtaksDatoSomSvangerskapsuke:pe}=_e(n.gjeldende),_n=g.behandlingÅrsaker.reduce((le,Ve)=>le||Ve.erAutomatiskRevurdering,!1),Mn=l[W.VENT_AARSAK]||Ma,Un=$n(g.sprakkode);return e.jsxs(e.Fragment,{children:[e.jsxs(J,{formMethods:v,onSubmit:m,setDataOnUnmount:q,children:[e.jsx(ue,{size:"small",children:e.jsx(d,{id:"VarselOmRevurderingForm.VarselOmRevurdering"})}),e.jsx(b,{eightPx:!0}),!i&&k[0].status===qe.OPPRETTET&&e.jsxs(e.Fragment,{children:[e.jsx(ce,{children:e.jsx(d,{id:"VarselOmRevurderingForm.VarselOmRevurderingVurder"})}),e.jsx(b,{twentyPx:!0}),_n&&e.jsxs(e.Fragment,{children:[e.jsx(Ne,{behandlingsTypeKode:g.type,avklartBarn:D,termindato:K,vedtaksDatoSomSvangerskapsuke:pe,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t}),e.jsx(b,{sixteenPx:!0})]}),e.jsx(Re,{name:"sendVarsel",validate:[B],isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"VarselOmRevurderingForm.SendVarsel"})},{value:"false",label:o.formatMessage({id:"VarselOmRevurderingForm.IkkeSendVarsel"})}]}),f.sendVarsel&&e.jsxs(e.Fragment,{children:[e.jsx(b,{sixteenPx:!0}),e.jsxs(vn,{children:[e.jsx(ze,{badges:[{type:"info",titleText:Un}],name:"fritekst",label:o.formatMessage({id:"VarselOmRevurderingForm.FritekstIBrev"}),validate:[B,gn,xa,Ce],maxLength:1e4,parse:zn}),e.jsx(b,{fourPx:!0}),e.jsx("a",{href:"",onClick:T,className:pr(un.previewLink,"lenke lenke--frittstaende"),children:e.jsx(d,{id:"VarselOmRevurderingForm.Preview"})})]})]}),e.jsx("div",{className:un.flexContainer,children:e.jsx(ze,{name:"begrunnelse",label:o.formatMessage({id:"VarselOmRevurderingForm.BegrunnelseForSvar"}),validate:[B,gn,Ce]})}),e.jsx(b,{sixteenPx:!0}),e.jsx(Kn,{variant:"primary",size:"small",onClick:f.sendVarsel?N:void 0,loading:v.formState.isSubmitting,disabled:v.formState.isSubmitting,type:f.sendVarsel?"button":"submit",children:e.jsx(d,{id:"VarselOmRevurderingForm.Bekreft"})})]}),(i||k[0].status!==qe.OPPRETTET)&&e.jsxs(e.Fragment,{children:[e.jsx(pn,{children:e.jsx(d,{id:"VarselOmRevurderingForm.Begrunnelse"})}),e.jsx(c,{size:"small",children:f.begrunnelse})]})]}),e.jsx(br,{showModal:F,frist:I().add(28,"days").format(Te),cancelEvent:R,submitCallback:_,ventearsaker:Mn,visBrevErBestilt:!0,hasManualPaVent:!0,erTilbakekreving:g.type===ve.TILBAKEKREVING||g.type===ve.TILBAKEKREVING_REVURDERING})]})};Nn.__docgenInfo={description:`VarselOmRevurderingForm
...
Setter opp aksjonspunktet for avklaring av Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""}}};const at=["1002","1003","1032"],tt=(n,r,a)=>({...V.buildInitialValues(n,r,a),...O.buildInitialValues(n)}),st=(n,r)=>({...V.transformValues(n),...O.transformValues(n),kode:ge(r[0].definisjon,u.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,u.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)}),ot=(n,r)=>n?r.filter(a=>!at.includes(a.kode)):r,In=({readOnlySubmitButton:n,status:r,ytelseTypeKode:a,vilkar:t})=>{const s=j(),{behandling:o,alleKodeverk:i,aksjonspunkterForPanel:l,submitCallback:g,harÅpneAksjonspunkter:m,isReadOnly:k,alleMerknaderFraBeslutter:y}=z(),p=l.some(K=>{var pe;return(pe=y[K.definisjon])==null?void 0:pe.notAccepted}),q=tt(l,r,o.behandlingsresultat),{formData:v,setFormData:f}=Q(),F=C({defaultValues:v||q}),A=i[W.AVSLAGSARSAK][E.FODSELSVILKARET_MOR],R=ot(a===yn.FORELDREPENGER,A),_=l.some(K=>K.status===qe.OPPRETTET)?void 0:we.OPPFYLT===r,{lovReferanse:T}=t[0],D=(...K)=>e.jsx("b",{children:K});return e.jsx(J,{formMethods:F,onSubmit:K=>g(st(K,l)),setDataOnUnmount:f,children:e.jsxs(Be,{title:s.formatMessage({id:"FodselVilkarForm.Fodsel"}),isAksjonspunktOpen:m,readOnlySubmitButton:n,readOnly:k,lovReferanse:T,originalErVilkarOk:_,erIkkeGodkjentAvBeslutter:p,isDirty:F.formState.isDirty,isSubmitting:F.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(d,{id:"FodselVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(V,{avslagsarsaker:R,readOnly:k,customVilkarOppfyltText:e.jsx(d,{id:"FodselVilkarForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(d,{id:"FodselVilkarForm.IkkeOppfylt",values:{b:D}})}),e.jsx(O,{useAllWidth:!0,readOnly:k})]})})};In.__docgenInfo={description:`FodselVilkarForm
