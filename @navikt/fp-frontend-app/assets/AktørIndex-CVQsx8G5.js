import{j as e,i as g,P as y,b as p,L as v}from"./iframe-eHkQob7L.js";import{X as f}from"./index.es-Cl8-Jp35.js";import{u as q,r as j}from"./fagsakApi-CmDpXSBz.js";import{V as c}from"./VisittkortSakIndex-COg95ZEB.js";import{V as w,a as I,B as T}from"./VStack-n0JfkQ_X.js";import{M as k}from"./message-BPk6P2Cj.js";import{E as F}from"./IngenBehandlingValgtPanel-Cadd2gE_.js";import{u as R}from"./useTrackRouteParam-dsKgIPL6.js";import{p as E}from"./paths-DMvTK_Uu.js";import{u as o}from"./useKodeverk-vDy-n_yK.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",level:"2",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
