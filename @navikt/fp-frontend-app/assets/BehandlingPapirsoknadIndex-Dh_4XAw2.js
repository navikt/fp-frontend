...
og trykker på 'Lagre og start behandling'. Ved å trykke på OK blir saken sendt til behandling av avslag.`,methods:[],displayName:"LukkPapirsoknadModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},handleSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const nt=an(1500),Be=({submitting:r,onSubmitUfullstendigsoknad:n,readOnly:a=!0})=>{const t=h(),[s,i]=q.useState(!1),{watch:o}=A(),l=o("ufullstendigSoeknad")||!1,g=q.useCallback(()=>{i(!s)},[i,s]);return e.jsx(L,{children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:t.formatMessage({id:"Registrering.SaveApplication.Title"})}),e.jsx(Yn,{name:"kommentarEndring",label:t.formatMessage({id:"Registrering.SaveApplication.Label"}),description:t.formatMessage({id:"Registrering.SaveApplication.Description"}),maxLength:1500,validate:[nt,tn],readOnly:a}),e.jsxs("div",{children:[e.jsx(Z,{name:"registrerVerge",label:t.formatMessage({id:"Registrering.Verge"}),readOnly:a}),e.jsx(Z,{name:"ufullstendigSoeknad",label:t.formatMessage({id:"Registrering.SaveApplication.OpplysningspliktErIkkeOverholdt"}),readOnly:a})]}),e.jsxs("div",{children:[!l&&e.jsx(J,{id:"saveButton",size:"small",variant:"primary",loading:r,disabled:a||r,onClick:Ia,children:e.jsx(m,{id:"Registrering.SaveApplication.SaveButton"})}),l&&e.jsx(J,{id:"endButton",onClick:g,size:"small",variant:"primary",loading:r,disabled:a||r,type:"button",children:e.jsx(m,{id:"Registrering.SaveApplication.EndButton"})})]}),e.jsx(ea,{handleSubmit:n,showModal:s,cancelEvent:g})]})})};Be.initialValues=()=>({kommentarEndring:void 0,registrerVerge:!1,ufullstendigSoeknad:!1});Be.transformValues=({kommentarEndring:r,registrerVerge:n,ufullstendigSoeknad:a})=>({kommentarEndring:r,registrerVerge:n,ufullstendigSoeknad:a});Be.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  mottattDato?: string;
}`,signature:{properties:[{key:"mottattDato",value:{name:"string",required:!1}}]},alias:"MottattDatoFormValues"}}],returns:null}],displayName:"MottattDatoPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const de="omsorg",it="_barnInput_1jjt5_1",ot={barnInput:it},lt=10,dt=r=>r?Cn(1)(r):void 0,gt=r=>r?gr(10)(r):void 0,yn=(r,n)=>a=>{if(r===0&&n&&a)return Oa(a,Array.isArray(n)?n[0]:n)},Ue=({readOnly:r=!0,familieHendelseType:n,isForeldrepengerFagsak:a,fodselsdatoer:t})=>{const{formatMessage:s}=h(),{control:i,watch:o}=A(),{fields:l,remove:g,append:u}=z({control:i,name:`${de}.foedselsDato`}),k=o(`${de}.antallBarn`)??0;return q.useEffect(()=>{if(l.length>Math.max(k,0))for(let d=l.length;d>k;d-=1)g(d-1);else if(l.length<Math.min(k,lt))for(let d=l.length;d<k;d+=1)u({id:d,dato:void 0})},[k]),e.jsx(L,{children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:e.jsx(m,{id:n===M.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),a&&n===M.ADOPSJON&&e.jsx(te,{name:`${de}.erEktefellesBarn`,label:e.jsx(m,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[p],isReadOnly:r,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:s({id:"Registrering.Adopsjon.Ja"}),value:"true"},{label:s({id:"Registrering.Adopsjon.Nei"}),value:"false"}]}),e.jsx(b,{name:`${de}.omsorgsovertakelsesdato`,label:s({id:n===M.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:r,validate:n===M.ADOPSJON?[p,F]:[F]}),e.jsxs(C,{gap:"4",children:[n===M.ADOPSJON&&e.jsx(b,{name:`${de}.ankomstdato`,label:s({id:"Registrering.Adopsjon.Ankomstdato"}),isReadOnly:r,validate:[F]}),e.jsx(D,{name:`${de}.antallBarn`,label:s({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:r,className:ot.barnInput,parse:d=>{const y=parseInt(d.toString(),10);return Number.isNaN(y)?d:y},validate:[...n===M.ADOPSJON?[p]:[],je,dt,gt]})]}),l.map((d,y)=>e.jsx(Kn.Fragment,{children:e.jsx(b,{name:`${de}.foedselsDato.${y}.dato`,isReadOnly:r,validate:n===M.ADOPSJON?[p,F,_e,yn(y,t)]:[F,_e,yn(y,t)],label:s({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:y+1})})},d.id))]})})};Ue.initialValues=()=>({[de]:{}});Ue.transformValues=({omsorg:r})=>({[de]:{...r,foedselsDato:r.foedselsDato&&r.foedselsDato.length>0?r.foedselsDato.map(n=>n.dato):void 0}});Ue.__docgenInfo={description:`OmsorgOgAdopsjonPanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const pt=N(O),$=({readOnly:r,erAdopsjon:n,alleKodeverk:a,mottattDato:t})=>e.jsx(X,{value:pt,children:e.jsx($e,{readOnly:r,erAdopsjon:n,alleKodeverk:a,mottattDato:t})});$.initialValues=$e.initialValues;$.transformValues=$e.transformValues;$.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  ...
  rettigheter?: string;
}`,signature:{properties:[{key:"rettigheter",value:{name:"string",required:!1}}]},alias:"RettigheterFormValues"}}],returns:null}],displayName:"RettigheterPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""}}};const cr=N(O),Xr={BOKMAL:"NB",NYNORSK:"NN",ENGELSK:"EN"},H=({readOnly:r})=>e.jsx(L,{children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:cr.formatMessage({id:"Registrering.Sprak"})}),e.jsx(te,{name:"språkkode",validate:[p],isReadOnly:r,radios:[{label:cr.formatMessage({id:"Registrering.Sprak.Bokmal"}),value:Xr.BOKMAL},{label:cr.formatMessage({id:"Registrering.Sprak.Nynorsk"}),value:Xr.NYNORSK},{label:cr.formatMessage({id:"Registrering.Sprak.Engelsk"}),value:Xr.ENGELSK}]})]})});H.initialValues=()=>({språkkode:void 0});H.transformValues=({språkkode:r})=>({språkkode:r});H.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  språkkode?: string;
...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const ct="_inntektBredde_1xgnj_1",bt={inntektBredde:ct},Rt=({readOnly:r,index:n})=>[{value:"harVarigEndring",label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.HarVarigEndring"}),element:e.jsx(B,{marginTop:8,children:e.jsx(b,{name:`${P}.${n}.varigEndringGjeldendeFom`,isReadOnly:r,validate:[F,p],label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})},{value:"erNyoppstartet",label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.ErNyoppstartet"})},{value:"erNyIArbeidslivet",label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.NyIArbeidslivet"}),element:e.jsx(B,{marginTop:8,children:e.jsx(b,{name:`${P}.${n}.nyIArbeidslivetFom`,isReadOnly:r,validate:[F,p],label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})}],xr=({readOnly:r,index:n})=>e.jsx(I,{name:`${P}.${n}.varigEndretEllerStartetSisteFireAr`,label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.NewlyStartedOrChanged"}),readOnly:r,trueContent:e.jsx(B,{marginTop:8,children:e.jsxs(R,{gap:"4",children:[e.jsx(ce,{size:"small",children:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.Reason"})}),e.jsx(nn,{validate:[p],name:`${P}.${n}.varigEndretEllerStartetSisteFireArArsak`,checkboxes:Rt({readOnly:r,index:n})}),e.jsx(Yn,{name:`${P}.${n}.beskrivelseAvEndring`,label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.VirksomhetEndretBeskrivelse"}),validate:[tn]}),e.jsx(D,{name:`${P}.${n}.inntekt`,label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.Inntekt"}),readOnly:r,validate:[je,p],className:bt.inntektBredde,parse:a=>{const t=parseInt(a.toString(),10);return Number.isNaN(t)?a:t}})]})})});xr.transformValues=({varigEndretEllerStartetSisteFireAr:r,varigEndretEllerStartetSisteFireArArsak:n,varigEndringGjeldendeFom:a,nyIArbeidslivetFom:t,beskrivelseAvEndring:s,inntekt:i})=>{const o=n.includes("harVarigEndring"),l=n.includes("erNyoppstartet"),g=n.includes("erNyIArbeidslivet");return{varigEndretEllerStartetSisteFireAr:r,...r?{harVarigEndring:o,...o?{varigEndringGjeldendeFom:a}:{},erNyoppstartet:l,erNyIArbeidslivet:g,...g?{nyIArbeidslivetFom:t}:{},beskrivelseAvEndring:s,inntekt:i}:{}}};xr.__docgenInfo={description:`VirksomhetStartetEndretPanel
...
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const qt=N(O),pe=({readOnly:r,alleKodeverk:n})=>e.jsx(X,{value:qt,children:e.jsx(He,{readOnly:r,alleKodeverk:n})});pe.initialValues=He.initialValues;pe.transformValues=He.transformValues;pe.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [EGEN_VIRKSOMHET_NAME_PREFIX]: VirksomhetSubFormValues;
}`,signature:{properties:[{key:"egenVirksomhet",value:{name:"signature",type:"object",raw:`{
  harArbeidetIEgenVirksomhet?: boolean;
  virksomheter: RegistrerVirksomhetFormValues[];
...
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const zr=N(O),Ye=({readOnly:r})=>e.jsxs(L,{children:[e.jsx(T,{size:"small",children:zr.formatMessage({id:"Registrering.Dekningsgrad.Title"})}),e.jsx(Bn,{sixteenPx:!0}),e.jsx(te,{name:"dekningsgrad",validate:[p],isReadOnly:r,isHorizontal:!0,radios:[{label:zr.formatMessage({id:"Registrering.Dekningsgrad.prosent.80"}),value:"80_PROSENT"},{label:zr.formatMessage({id:"Registrering.Dekningsgrad.prosent.100"}),value:"100_PROSENT"}]})]});Ye.initialValues=()=>({dekningsgrad:void 0});Ye.transformValues=({dekningsgrad:r})=>({dekningsgrad:r});Ye.__docgenInfo={description:"Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  dekningsgrad?: string;
...
Viser inputfelter for dato for bestemmelse av perioder med permijon.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const wt=Ma(9),jr=`${j}.${Oe}`,W=r=>`${jr}.${r}`,jn=r=>()=>{const a=(r(`${jr}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Me(a):void 0},Tn=(r,n,a)=>()=>{const t=r(`${W(n)}.periodeFom`),s=r(`${W(n)}.periodeTom`);return!s||!t?null:a?U(s)(t):x(t)(s)},Nt=(r,n)=>a=>r(`${W(n)}.arbeidskategoriType`)===fe.ARBEIDSTAKER?p(a):void 0,Vt=r=>{if(r)return r.length===11?Hn(r):wt(r)},En={periodeFom:"",periodeTom:"",periodeForGradering:"",prosentandelArbeid:"",skalGraderes:!1},Pt=[fe.ARBEIDSTAKER,fe.SELVSTENDIG_NAERINGSDRIVENDE,fe.FRILANSER],hn=gr(100),It=r=>r.filter(({kode:n})=>gn.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),Ot=r=>r.filter(({kode:n})=>Pt.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),ta=({graderingKvoter:r,readOnly:n,arbeidskategoriTyper:a})=>{const t=h(),{watch:s,control:i,getValues:o,trigger:l,formState:{isSubmitted:g}}=A(),{fields:u,remove:k,append:d}=z({control:i,name:`${jr}`}),y=s(`${jr}`)||[];return q.useEffect(()=>{u.length===0&&d(En)},[]),e.jsx(se,{fields:u,emptyPeriodTemplate:En,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,remove:k,append:d,children:(v,f)=>{const{harSamtidigUttak:c,periodeFom:S}=y[f],_=S&&E(S,ge).isBefore(E("2019-01-01"));return e.jsxs(be,{readOnly:n,remove:k,index:f,children:[e.jsx(Y,{name:`${W(f)}.periodeForGradering`,selectValues:It(r),label:t.formatMessage({id:"Registrering.Permisjon.Gradering.Periode"}),validate:[p]}),e.jsx(b,{label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),name:`${W(f)}.periodeFom`,validate:[p,F,Tn(o,f,!0),jn(o)],onChange:()=>g?l():void 0}),e.jsx(b,{label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),name:`${W(f)}.periodeTom`,validate:[p,F,Tn(o,f,!1),jn(o)],onChange:()=>g?l():void 0}),e.jsx(D,{label:e.jsx(m,{id:"Registrering.Permisjon.Gradering.Prosentandel"}),name:`${W(f)}.prosentandelArbeid`,validate:[p,Qr,hn],normalizeOnBlur:Qe=>Number.isNaN(Qe)?Qe:parseFloat(Qe.toString()).toFixed(2)}),e.jsx(D,{label:t.formatMessage({id:"Registrering.Permisjon.Orgnr"}),name:`${W(f)}.arbeidsgiverIdentifikator`,validate:[Nt(o,f),je,Vt]}),e.jsx(Y,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${W(f)}.arbeidskategoriType`,selectValues:Ot(a),validate:[p],onChange:()=>g?l():void 0}),e.jsx(Z,{name:`${W(f)}.skalGraderes`,label:e.jsx(m,{id:"Registrering.Permisjon.Gradering.SkalGraderes"})}),e.jsx(Z,{readOnly:n,name:`${W(f)}.flerbarnsdager`,label:e.jsx(m,{id:"Registrering.Permisjon.Flerbarnsdager"})}),e.jsx(Z,{name:`${W(f)}.harSamtidigUttak`,label:e.jsx(m,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),c&&e.jsx(D,{name:`${W(f)}.samtidigUttaksprosent`,validate:[p,Qr,hn],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"})}),_&&e.jsx(Nr,{size:"small",variant:"warning",children:e.jsx(m,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},v.id)}})};ta.__docgenInfo={description:`RenderGraderingPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const un=`${j}.${ln}`,Re=r=>`${un}.${r}`,wn=r=>()=>{const a=(r(`${un}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Me(a):void 0},Nn={periodeFom:"",periodeTom:"",årsak:""},St=[pr.UTTAK_MØDREKVOTE_ANNEN_FORELDER,pr.UTTAK_FEDREKVOTE_ANNEN_FORELDER,pr.UTTAK_FELLESP_ANNEN_FORELDER,pr.UTTAK_FORELDREPENGER_ANNEN_FORELDER],_t=r=>r.filter(({kode:n})=>St.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),sa=({oppholdsReasons:r,readOnly:n})=>{const a=h(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:o}}=A(),{fields:l,remove:g,append:u}=z({control:t,name:`${un}`});return q.useEffect(()=>{l.length===0&&u(Nn)},[]),e.jsx(se,{fields:l,emptyPeriodTemplate:Nn,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,append:u,remove:g,children:(k,d)=>e.jsxs(be,{readOnly:n,remove:g,index:d,children:[e.jsx(b,{name:`${Re(d)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,F,()=>{const y=s(`${Re(d)}.periodeFom`),v=s(`${Re(d)}.periodeTom`);return v&&y?U(v)(y):null},wn(s)],onChange:()=>o?i():void 0}),e.jsx(b,{name:`${Re(d)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,F,()=>{const y=s(`${Re(d)}.periodeFom`),v=s(`${Re(d)}.periodeTom`);return v&&y?x(y)(v):null},wn(s)],onChange:()=>o?i():void 0}),e.jsx("div",{children:e.jsx(Y,{name:`${Re(d)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:_t(r),validate:[p]})})]},k.id)})};sa.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Gt=N(O),kn=({readOnly:r})=>e.jsx(X,{value:Gt,children:e.jsx(te,{name:"erBarnetFodt",label:e.jsx(m,{id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[p],isReadOnly:r,isTrueOrFalseSelection:!0,radios:[{label:e.jsx(m,{id:"Registrering.TerminOgFodsel.ErFodt"}),value:"true"},{label:e.jsx(m,{id:"Registrering.TerminOgFodsel.ErIkkeFodt"}),value:"false"}]})});kn.__docgenInfo={description:"",methods:[],displayName:"ErBarnetFodt",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const _n=N(O);E.extend(La);E.extend(Ga);const Mn=Cn(1),Dn=gr(9),Tr=()=>E().subtract(8,"year"),da=()=>E(),Bt=()=>E().subtract(8,"year"),Ut=()=>E().subtract(0,"year"),Pe=()=>E().subtract(8,"year"),Ie=()=>E().add(9,"months"),$t=(r,n)=>{const a=r?E(r,ge):void 0,t=E().startOf("day"),s=a!=null&&a.isValid()&&(a!=null&&a.isBefore(t))?a:t;return U(s)(n)},ga=(r,n)=>{const a=r?E(r,ge):void 0,t=E(n,ge);if(!(a!=null&&a.isValid())||!(t!=null&&t.isValid()))return null;const s=a.subtract(3,"weeks").subtract(1,"day"),i=a.add(5,"months").add(1,"day");return s.isSameOrAfter(t)?_n.formatMessage({id:"ValidationMessage.ForTidligTermin"}):i.isSameOrBefore(t)?_n.formatMessage({id:"ValidationMessage.ForSenTermin"}):null},le=N(O),Ht=r=>n=>{const a=r("foedselsDato");return ga(a,n)},Yt=r=>n=>{const a=r("termindato");return $t(a,n)},ve=({readOnly:r,erForeldrepenger:n=!1})=>{const{watch:a,getValues:t}=A(),s=a("erBarnetFodt");return e.jsx(X,{value:le,children:e.jsx(L,{children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:le.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),e.jsx(kn,{readOnly:r}),s!==void 0&&e.jsxs(R,{gap:"4",children:[s===!1&&e.jsxs(e.Fragment,{children:[e.jsxs(C,{gap:"4",children:[e.jsx(b,{name:"termindato",label:le.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:r,fromDate:Pe().toDate(),toDate:Ie().toDate(),defaultMonth:new Date,validate:[p,F,x(Pe()),U(Ie())]}),e.jsx(D,{name:"antallBarn",label:le.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:r,parse:i=>{const o=parseInt(i.toString(),10);return isNaN(o)?i:o},validate:[p,je,Mn,Dn]})]}),e.jsx(b,{name:"terminbekreftelseDato",label:le.formatMessage({id:"Registrering.TerminOgFodsel.UtstedtDato"}),isReadOnly:r,fromDate:Bt().toDate(),toDate:Ut().toDate(),defaultMonth:new Date,validate:[F,Yt(t)]})]}),s===!0&&e.jsxs(e.Fragment,{children:[e.jsxs(C,{gap:"4",children:[e.jsx(b,{name:"foedselsDato",label:le.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:r,validate:[p,F,x(Tr()),_e],fromDate:Tr().toDate(),toDate:da().toDate()}),e.jsx(D,{name:"antallBarn",label:le.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:r,parse:i=>{const o=parseInt(i.toString(),10);return Number.isNaN(o)?i:o},validate:[p,je,Mn,Dn]})]}),n&&e.jsx(Nr,{size:"small",variant:"info",children:e.jsx(ce,{size:"small",children:le.formatMessage({id:"Registrering.TerminOgFodsel.RettTilPrematuruker"})})}),e.jsx(b,{name:"termindato",label:le.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:r,validate:[F,x(Pe()),U(Ie()),Ht(t)],fromDate:Pe().toDate(),toDate:Ie().toDate(),defaultMonth:new Date})]})]})]})})})};ve.initialValues=()=>({erBarnetFodt:void 0});ve.transformValues=({antallBarn:r,erBarnetFodt:n,foedselsDato:a,termindato:t,terminbekreftelseDato:s})=>n?{erBarnetFodt:!0,termindato:t,foedselsDato:a,antallBarn:r}:{erBarnetFodt:!1,termindato:t,terminbekreftelseDato:s,antallBarnFraTerminbekreftelse:r};ve.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
...
| {
  ...
  foedselsDato?: string;
  erBarnetFodt?: boolean;
}`,signature:{properties:[{key:"termindato",value:{name:"string",required:!1}},{key:"foedselsDato",value:{name:"string",required:!1}},{key:"erBarnetFodt",value:{name:"boolean",required:!1}}]},alias:"FormValues"}}],returns:null}],displayName:"TerminOgFodselPanelSvp",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const V="tilretteleggingArbeidsforhold",Er="tilretteleggingForArbeidsgiver",Jt="tilretteleggingSelvstendigNaringsdrivende",Xt="tilretteleggingFrilans",zt="tilretteleggingArbeidsgiver",Wt=gr(100),xn={tilretteleggingType:"",dato:"",stillingsprosent:""},hr=({readOnly:r,name:n})=>{const a=h(),{control:t}=A(),{fields:s,remove:i,append:o}=z({control:t,name:n});return q.useEffect(()=>{s.length===0&&o(xn)},[]),e.jsx(lr,{background:"surface-action-subtle",padding:"3",style:{borderLeft:"4px solid var(--a-lightblue-700)"},children:e.jsx(se,{fields:s,emptyPeriodTemplate:xn,bodyText:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.LeggTilTilretteleggingsbehov"}),readOnly:r,append:o,remove:i,children:(l,g)=>e.jsxs(be,{readOnly:r,remove:i,index:g,children:[e.jsx(Y,{readOnly:r,name:`${n}.${g}.tilretteleggingType`,label:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.BehovForTilrettelegging"}),validate:[p],selectValues:[e.jsx("option",{value:he.HEL_TILRETTELEGGING,children:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.KanGjennomfores"})},he.HEL_TILRETTELEGGING),e.jsx("option",{value:he.DELVIS_TILRETTELEGGING,children:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.RedusertArbeid"})},he.DELVIS_TILRETTELEGGING),e.jsx("option",{value:he.INGEN_TILRETTELEGGING,children:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.KanIkkeGjennomfores"})},he.INGEN_TILRETTELEGGING)]}),e.jsx(b,{isReadOnly:r,name:`${n}.${g}.dato`,label:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.FraDato"}),validate:[p]}),e.jsx(D,{readOnly:r,name:`${n}.${g}.stillingsprosent`,label:a.formatMessage({id:"BehovForTilrettteleggingFieldArray.Stillingsprosent"}),validate:[p,Wt],maxLength:99})]},l.id)})})};hr.__docgenInfo={description:"",methods:[],displayName:"BehovForTilretteleggingFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"string"},description:""}}};const rn=`${V}.${Er}`,Zr=r=>`${rn}.${r}`,ua=({open:r,readOnly:n=!1,index:a,remove:t})=>{const{getFieldState:s,watch:i}=A(),{error:o}=s(`${rn}.${a}`),l=i(`${rn}.${a}.organisasjonsnummer`),[g,u]=q.useState(r),k=h();return e.jsxs(w.Row,{shadeOnHover:!1,style:{backgroundColor:o&&!g?"var(--a-red-50)":"none"},children:[e.jsx(w.DataCell,{valign:"top",children:e.jsx(J,{type:"button",variant:"tertiary-neutral",onClick:()=>u(d=>!d),icon:g?e.jsx(Un,{"aria-label":"Vis mindre"}):e.jsx($n,{"aria-label":"Vis mer"})})}),e.jsxs(w.DataCell,{valign:"top",children:[e.jsx(lr,{hidden:g,paddingBlock:"3",children:e.jsx(Se,{weight:"semibold",children:l})}),e.jsxs(R,{gap:"4",hidden:!g,children:[e.jsxs(C,{gap:"4",children:[e.jsx(D,{readOnly:n,name:`${Zr(a)}.organisasjonsnummer`,label:k.formatMessage({id:"RegistrerArbeidsgiverRad.OrgNr"}),validate:[p,d=>Da(d.toString()),xa],maxLength:99}),e.jsx(b,{name:`${Zr(a)}.behovsdato`,label:k.formatMessage({id:"RegistrerArbeidsgiverRad.TilretteleggingFra"}),validate:[p],isReadOnly:n})]}),e.jsx(hr,{name:`${Zr(a)}.${zt}`,readOnly:n})]})]}),e.jsx(w.DataCell,{valign:"top",align:"right",children:e.jsx(J,{type:"button",variant:"tertiary-neutral",onClick:t,onKeyDown:t,icon:e.jsx(Ir,{"aria-label":"Slett rad"})})})]})};ua.__docgenInfo={description:"",methods:[],displayName:"RegistrerArbeidsgiverRad",props:{index:{required:!0,tsType:{name:"number"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},remove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},open:{required:!0,tsType:{name:"boolean"},description:""}}};const Zt={organisasjonsnummer:"",behovsdato:""},Qt=`${V}.${Er}`,ma=({readOnly:r})=>{var g,u,k,d,y;const n=h(),{control:a,formState:{errors:t}}=A(),{fields:s,append:i,remove:o}=z({control:a,name:Qt,rules:{required:n.formatMessage({id:"TilretteleggingForArbeidsgiverFieldArray.ArrayMinLength"})}}),l=()=>{i(Zt)};return q.useEffect(()=>{s.length===0&&l()},[]),e.jsxs(R,{gap:"4",children:[e.jsxs(w,{children:[e.jsx(w.Header,{children:e.jsxs(w.Row,{children:[e.jsx(w.HeaderCell,{style:{width:"48px"}}),e.jsx(w.HeaderCell,{children:e.jsx(m,{id:"TilretteleggingForArbeidsgiverFieldArray.Title"})}),e.jsx(w.HeaderCell,{style:{width:"48px"}})]})}),e.jsx(w.Body,{children:s.map((v,f)=>e.jsx(ua,{index:f,open:f+1===s.length,remove:()=>o(f),readOnly:r},v.id))})]}),((k=(u=(g=t[V])==null?void 0:g[Er])==null?void 0:u.root)==null?void 0:k.message)&&e.jsx(wr,{children:(y=(d=t[V])==null?void 0:d[Er].root)==null?void 0:y.message}),e.jsx("div",{children:e.jsx(J,{size:"small",variant:"tertiary",onClick:l,type:"button",icon:e.jsx(Jn,{"aria-hidden":!0}),children:e.jsx(m,{id:"TilretteleggingForArbeidsgiverFieldArray.LeggTilArbeidsgiver"})})})]})};ma.__docgenInfo={description:"",methods:[],displayName:"TilretteleggingForArbeidsgiverFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const es=r=>{const n=[];return r!=null&&r.sokForArbeidsgiver&&(r!=null&&r.tilretteleggingForArbeidsgiver)&&n.push(...r.tilretteleggingForArbeidsgiver.map(a=>({"@type":"VI",behovsdato:a.behovsdato,organisasjonsnummer:a.organisasjonsnummer,tilrettelegginger:a.tilretteleggingArbeidsgiver}))),r!=null&&r.sokForFrilans&&n.push({"@type":"FR",behovsdato:r.behovsdatoFrilans,tilrettelegginger:r.tilretteleggingFrilans}),r!=null&&r.sokForSelvstendigNaringsdrivende&&n.push({"@type":"SN",behovsdato:r.behovsdatoSN,tilrettelegginger:r.tilretteleggingSelvstendigNaringsdrivende}),n},Rr=N(O),Ze=({readOnly:r})=>{var g,u,k,d;const{watch:n,setError:a,clearErrors:t,formState:s}=A(),[i,o,l]=n([`${V}.sokForSelvstendigNaringsdrivende`,`${V}.sokForFrilans`,`${V}.sokForArbeidsgiver`]);return q.useEffect(()=>{!i&&!o&&!l?a(`${V}.notRegisteredInput`,{type:"custom",message:Rr.formatMessage({id:"BehovForTilretteleggingPanel.MinstEnMaaVereJa"})}):t(`${V}.notRegisteredInput`)},[i,o,l]),e.jsx(X,{value:Rr,children:e.jsx(L,{children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:e.jsx(m,{id:"BehovForTilretteleggingPanel.BehovForTilrettelegging"})}),s.isSubmitted&&((u=(g=s.errors[V])==null?void 0:g.notRegisteredInput)==null?void 0:u.message)&&e.jsx(wr,{children:(d=(k=s.errors[V])==null?void 0:k.notRegisteredInput)==null?void 0:d.message}),e.jsx(I,{name:`${V}.sokForSelvstendigNaringsdrivende`,label:e.jsx(m,{id:"BehovForTilretteleggingPanel.SokForSelvstendigNaringsdrivende"}),readOnly:r,trueContent:e.jsx(B,{marginTop:4,children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:e.jsx(m,{id:"BehovForTilretteleggingPanel.TittelSN"})}),e.jsx(b,{name:`${V}.behovsdatoSN`,label:Rr.formatMessage({id:"BehovForTilretteleggingPanel.TilretteleggingFra"}),validate:[p],isReadOnly:r}),e.jsx(hr,{name:`${V}.${Jt}`,readOnly:r})]})})}),e.jsx(I,{name:`${V}.sokForFrilans`,label:e.jsx(m,{id:"BehovForTilretteleggingPanel.SokForFrilans"}),readOnly:r,trueContent:e.jsx(B,{marginTop:4,children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:e.jsx(m,{id:"BehovForTilretteleggingPanel.TittelFrilans"})}),e.jsx(b,{name:`${V}.behovsdatoFrilans`,label:Rr.formatMessage({id:"BehovForTilretteleggingPanel.TilretteleggingFra"}),validate:[p],isReadOnly:r}),e.jsx(hr,{name:`${V}.${Xt}`,readOnly:r})]})})}),e.jsx(I,{name:`${V}.sokForArbeidsgiver`,label:e.jsx(m,{id:"BehovForTilretteleggingPanel.SokForArbeidsgiver"}),readOnly:r,trueContent:e.jsx(B,{marginTop:4,children:e.jsxs(R,{gap:"4",children:[e.jsx(T,{size:"small",children:e.jsx(m,{id:"BehovForTilretteleggingPanel.TittelArbeidstaker"})}),e.jsx(ma,{readOnly:r})]})})})]})})})};Ze.initialValues=()=>({[V]:{}});Ze.transformValues=({tilretteleggingArbeidsforhold:r})=>({[V]:es(r)});Ze.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
Toppkomponent for registrering av papirsøknad der søknadstype, tema og søker/foreldretype blir valgt.`,methods:[],displayName:"SoknadTypePickerForm",props:{setSoknadData:{required:!0,tsType:{name:"signature",type:"function",raw:"(soknadData: SoknadData) => void",signature:{arguments:[{type:{name:"SoknadData"},name:"soknadData"}],return:{name:"void"}}},description:""},fagsakYtelseType:{required:!0,tsType:{name:"string"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const is=()=>({...re.initialValues(),...$.initialValues(),...ke.initialValues(),...pe.initialValues(),...me.initialValues(),...ue.initialValues(),...We.initialValues(),...Ze.initialValues(),...H.initialValues(),...ee.initialValues()}),os=r=>({...re.transformValues(r),...$.transformValues(r),...ke.transformValues(r),...pe.transformValues(r),...me.transformValues(r),...ue.transformValues(r),...We.transformValues(r),...Ze.transformValues(r),...H.transformValues(r),...ee.transformValues(r)}),ca=({readOnly:r,soknadData:n,alleKodeverk:a,onSubmit:t,onSubmitUfullstendigsoknad:s})=>{const i=Vr({defaultValues:is()}),o=i.watch("mottattDato");return e.jsxs(Pr,{formMethods:i,onSubmit:l=>t(os(l)),children:[e.jsxs(on,{columns:{sm:1,md:2},gap:"4",children:[e.jsx(re,{readOnly:r}),e.jsx($,{readOnly:r,alleKodeverk:a,erAdopsjon:n.getFamilieHendelseType()!==M.ADOPSJON,mottattDato:o}),e.jsx(ke,{readOnly:r,alleKodeverk:a}),e.jsx(pe,{readOnly:r,alleKodeverk:a}),e.jsx(me,{readOnly:r}),e.jsx(ue,{readOnly:r,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:a}),e.jsx(We,{readOnly:r}),e.jsx(Ze,{readOnly:r}),e.jsx(H,{readOnly:r})]}),e.jsx(ee,{readOnly:r,onSubmitUfullstendigsoknad:s,submitting:i.formState.isSubmitting})]})};ca.__docgenInfo={description:`SvangerskapspengerForm
...
Informasjonsmodal som vises til saksbehandler når en papirsøknad har blitt registrert.`,methods:[],displayName:"SoknadRegistrertModal",props:{isOpen:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const ds=()=>{const[r,n]=q.useState(!1),{alleKodeverk:a,behandling:t,rettigheter:s,fagsak:i,lagreAksjonspunkter:o}=q.use(Ua),l=Ea(),g=()=>{l("/")},u=!s.writeAccess.isEnabled||t.behandlingPaaVent,k=us(t,i,o,n),d=(v,f,c)=>k({ufullstendigSoeknad:!0},v,f,c),y=t.aksjonspunkt.some(v=>v.definisjon===rr.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER);return e.jsxs(e.Fragment,{children:[e.jsx(Ba,{behandling:t,kodeverk:a,opneSokeside:g}),e.jsx(Aa,{isOpen:r}),e.jsx(Fa,{fagsak:i,kodeverk:a,readOnly:u,lagreUfullstendig:d,lagreFullstendig:k,erEndringssøknad:y})]})},gs=r=>r.map(n=>n.definisjon).filter(n=>n===rr.REGISTRER_PAPIRSOKNAD_ENGANGSSTONAD||n===rr.REGISTRER_PAPIRSOKNAD_FORELDREPENGER||n===rr.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER||n===rr.REGISTRER_PAPIRSOKNAD_SVANGERSKAPSPENGER)[0],us=(r,n,a,t)=>(s,i,o,l)=>{const g=[{"@type":gs(r.aksjonspunkt),tema:o,soknadstype:i,soker:l,...s}],u={saksnummer:n.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon,bekreftedeAksjonspunktDtoer:g};return a(u).then(k=>{var d;((d=k==null?void 0:k.taskStatus)==null?void 0:d.status)!==ha.HALTED&&t(!0)})};ds.__docgenInfo={description:`BehandlingPapirsoknadIndex
