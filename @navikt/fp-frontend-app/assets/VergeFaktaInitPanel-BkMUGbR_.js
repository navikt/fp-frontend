import{j as n}from"./jsx-runtime-qGIIFXMu.js";import{t as P,P as V,G as X,c as Z,b as J,f as Q,L as ee,B as ne,D as re,a as L}from"./index.es-gCnhCeOD.js";import{M as ae,a as p,Z as te,k as se,I as ie,e as le,T as ue,S as oe,r as de,H as j,c as ge,O as R,U as ke,V as me,P as F,d as E,f as ye,K as S,Y as ve,z as pe,B as be}from"./AppIndex.stories-BdaSPn8l.js";import{r as k}from"./index-CDs2tPxN.js";import{M as h,X as fe,F as qe,U as he,W as ce,y as c,H as K,L as q,c as je}from"./index.es-clJhGBPp.js";import{R as _}from"./useRestApiRunner-CQE2m9r8.js";import{E as N}from"./index.es-zhgnUGpN.js";import{e as Te,g as Ae}from"./ProsessDefaultInitPanel-CL1KIiit.js";var B=(e=>(e.BARN="BARN",e.FBARN="FBARN",e.VOKSEN="VOKSEN",e.ADVOKAT="ADVOKAT",e.ANNEN_F="ANNEN_F",e))(B||{});const G={"MerkePanel.Dod":"DØD","MerkePanel.DodTittel":"Personen er død","MerkePanel.DodFodt":"DØDFØDT","MerkePanel.Diskresjon6":"Kode 6","MerkePanel.Diskresjon7":"Kode 7","MerkePanel.EgenAnsatt":"NAV","MerkePanel.Verge":"Verge","MerkePanel.Diskresjon6Tittel":"Personen har diskresjonsmerking kode 6","MerkePanel.Diskresjon7Tittel":"Personen har diskresjonsmerking kode 7","MerkePanel.EgenAnsattTittel":"Personen er ansatt i NAV","MerkePanel.VergeTittel":"Personen har verge","SubmitButton.ConfirmInformation":"Bekreft og fortsett","FaktaBegrunnelseTextField.BegrunnEndringene":"Begrunn endringene","FaktaBegrunnelseTextField.Vurdering":"Vurdering","FaktaBegrunnelseTextField.Begrunnelse":"Begrunnelse","FaktaKilde.Soknad":"FRA SØKNADEN","FaktaKilde.FREG":"FRA FOLKEREGISTERET","FaktaKilde.MEDL":"FRA MEDLEMSKAPSREGISTERET"},w=P(G),Re=se(3),we=ie(1500),f=({isReadOnly:e,isSubmittable:r,hasBegrunnelse:t,label:s,hasReadOnlyLabel:a=!1,hasVurderingText:i=!1,name:l="begrunnelse"})=>{const g=i?"FaktaBegrunnelseTextField.Vurdering":"FaktaBegrunnelseTextField.BegrunnEndringene",u=()=>e?a?w.formatMessage({id:"FaktaBegrunnelseTextField.Begrunnelse"}):"":s||w.formatMessage({id:g});return n.jsx(V,{value:w,children:(r||t)&&n.jsx(ae,{name:l,label:u(),validate:[p,Re,we,te],maxLength:1500,readOnly:e})})},Be=e=>e&&Array.isArray(e)?e.length>0?e[0].begrunnelse:"":e&&!Array.isArray(e)?e.begrunnelse:"";f.buildInitialValues=(e,r="begrunnelse")=>({[r]:X(Be(e))});f.transformValues=(e,r="begrunnelse")=>({begrunnelse:e[r]});f.__docgenInfo={description:"FaktaBegrunnelseTextField",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"aksjonspunkt",optional:!0,type:{name:"union",raw:"Aksjonspunkt[] | Aksjonspunkt",elements:[{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
...
}`,signature:{properties:[{key:"vergeType",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"fnr",value:{name:"string",required:!0}},{key:"organisasjonsnummer",value:{name:"string",required:!0}},{key:"gyldigFom",value:{name:"string",required:!0}},{key:"gyldigTom",value:{name:"string",required:!1}},{key:"kode",value:{name:"AksjonspunktCode.AVKLAR_VERGE",required:!0}}]}}}}],displayName:"RegistrereVergeFaktaForm",props:{vergetyper:{defaultValue:{value:"[]",computed:!1},required:!1}}};const Ge=(e,r)=>({begrunnelse:f.buildInitialValues(r.filter(t=>t.definisjon===j.AVKLAR_VERGE)[0]).begrunnelse,...y.buildInitialValues(e||{})}),Ie=e=>({...y.transformValues(e),begrunnelse:e.begrunnelse}),W=({hasOpenAksjonspunkter:e,submittable:r,readOnly:t,alleMerknaderFraBeslutter:s,aksjonspunkter:a,verge:i,alleKodeverk:l,submitCallback:g,formData:u,setFormData:d})=>{const o=L(),m=ye({defaultValues:u||Ge(i,a),shouldUnregister:!0}),v=m.watch("vergeType"),T=m.watch("begrunnelse"),A=k.useMemo(()=>l[S.VERGE_TYPE].sort((b,$)=>b.navn.localeCompare($.navn)),[l[S.VERGE_TYPE]]);return a.length===0?null:n.jsxs(n.Fragment,{children:[n.jsx(je,{isAksjonspunktOpen:e,children:[o.formatMessage({id:"RegistrereVergeInfoPanel.CheckInformation"})]}),n.jsxs(ve,{formMethods:m,onSubmit:b=>g(Ie(b)),setDataOnUnmount:d,children:[n.jsx(y,{readOnly:t,intl:o,vergetyper:A,valgtVergeType:v,alleMerknaderFraBeslutter:s}),n.jsx(c,{twentyPx:!0}),n.jsx(f,{isSubmittable:r,isReadOnly:t,hasBegrunnelse:!!T}),n.jsx(c,{twentyPx:!0}),n.jsx(I,{isSubmittable:r&&!!v,isReadOnly:t,isSubmitting:m.formState.isSubmitting,isDirty:m.formState.isDirty})]})]})};W.__docgenInfo={description:`RegistrereVergeInfoPanel
...
Presentasjonskomponent. Har ansvar for å sette opp formen for att registrere verge.`,methods:[],displayName:"RegistrereVergeInfoPanel",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: AvklarVergeAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<tilbakekrevingKodeverkTyper, KodeverkMedNavn[]>"}]},description:""}}};const O=[j.AVKLAR_VERGE],He=[be.VERGE],Ye=({valgtFaktaSteg:e,behandling:r,registrerFaktaPanel:t})=>n.jsx(Y,{valgtFaktaSteg:e,behandling:r,registrerFaktaPanel:t,panelEndepunkter:He,aksjonspunktKoder:O,faktaPanelKode:pe.VERGE,faktaPanelMenyTekst:L().formatMessage({id:"RegistrereVergeInfoPanel.Info"}),skalPanelVisesIMeny:()=>{var s;return!!((s=r.aksjonspunkt)!=null&&s.some(a=>a.definisjon===O[0]))},renderPanel:s=>n.jsx(z,{...s})});Ye.__docgenInfo={description:"VergeFaktaInitPanel",methods:[],displayName:"VergeFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};export{Y as F,Ye as V,I as a,f as b,Fe as c,C as d,Se as e,Ee as f,U as g};
