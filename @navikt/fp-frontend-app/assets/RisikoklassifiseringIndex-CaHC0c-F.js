...
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},description:""},isPanelOpen:{required:!0,tsType:{name:"boolean"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},submitAksjonspunkt:{required:!1,tsType:{name:"signature",type:"function",raw:"(data: AvklartRisikoklassifiseringAp) => void",signature:{arguments:[{type:{name:"intersection",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaresignalVurdering'>[]"},description:""}}};const ma=({fagsakData:e,behandling:n,setBehandling:r})=>{const a=e.getFagsak(),{selected:l=!1}=Ge({paramName:"risiko",parse:T=>T==="true",isQueryParam:!0}),u=x(),i=C(),s=()=>{u(D(i)(!l))},{kodeverkOptions:m}=J(),{data:_}=b(m()),N=e.getBehandling(n?.uuid);return n&&N?t.jsx(sa,{isRiskPanelOpen:l,fagsak:a,toggleRiskPanel:s,behandlingAppKontekst:N,behandling:n,setBehandling:r}):t.jsx(O,{risikoklassifisering:a.kontrollResultat,isPanelOpen:l,readOnly:!0,toggleRiskPanel:s,faresignalVurderinger:y(_).FaresignalVurdering})},sa=({fagsak:e,behandling:n,behandlingAppKontekst:r,setBehandling:a,toggleRiskPanel:l,isRiskPanelOpen:u})=>{const{behandlingPåVent:i,status:s,type:m,risikoAksjonspunkt:_,kontrollResultat:N}=r,{kodeverkOptions:T}=J(),p=b(Ne()),{data:R}=b(T()),B=y(p.data).innloggetBruker,te=Xe(B,e.status,s,m),ie=va(B,te,i),w=x(),q=C();o.useEffect(()=>{_&&Re(_)&&!u&&w(D(q)(!0)),_&&_.status===z.UTFORT&&w(D(q)(!1))},[!!_,n.uuid,n.versjon]);const{lagreAksjonspunkter:ue}=he(n,a),me=j=>{ue({behandlingUuid:n.uuid,behandlingVersjon:n.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":j.kode,...j}]})};return t.jsx(O,{aksjonspunkt:_??void 0,risikoklassifisering:N??void 0,isPanelOpen:u,readOnly:ie,submitAksjonspunkt:me,toggleRiskPanel:l,faresignalVurderinger:y(R).FaresignalVurdering})},va=(e,n,r)=>{if(r)return!0;const{kanSaksbehandle:a}=e;return!a||!n.writeAccess.isEnabled};ma.__docgenInfo={description:`RisikoklassifiseringIndex
