import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{n as v,Q as f}from"./index.es-3mY2NE4O.js";import{u as q,h as j}from"./initFetch-ChXFpEDe.js";import{V as c,H as w,P as I,g as R,X as K}from"./withPanelData-g3ZJRFFm.js";import{K as m}from"./alleKodeverk-Dm9joGL5.js";import{R as A}from"./index-DjhIdADd.js";import{V as T}from"./VisittkortSakIndex-l56CKae7.js";import{M as l}from"./message-BNb4AvKI.js";import{E as x}from"./IngenBehandlingValgtPanel-CqIrUXpn.js";import{p as E}from"./paths-CHo4Pa8b.js";import{u as F}from"./useTrackRouteParam-CNphPZc5.js";import{u as g}from"./useKodeverk-BHr7o7nr.js";const y=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:d})=>e.jsxs(e.Fragment,{children:[e.jsx(T,{bruker:n.person}),e.jsx(c,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(t=>{var i,k;const a=(i=s.find(o=>o.kode===t.fagsakYtelseType))==null?void 0:i.navn,u=(k=r.find(o=>o.kode===t.status))==null?void 0:k.navn;return e.jsx(A.Fragment,{children:d(void 0,`${a} (${t.saksnummer}) ${u}`,t.saksnummer)},t.saksnummer)}):e.jsx(w,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});y.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},renderSomLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(className: string | undefined, fagsakKomponent: ReactNode, saksnummer: string) => ReactElement",signature:{arguments:[{type:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},name:"className"},{type:{name:"ReactNode"},name:"fagsakKomponent"},{type:{name:"string"},name:"saksnummer"}],return:{name:"ReactElement"}}},description:""}}};const N=()=>{const{selected:n}=F({paramName:"aktoerId",parse:a=>Number.parseInt(a,10)}),{data:r,status:s}=q(j(n)),d=g(m.FAGSAK_STATUS),t=g(m.FAGSAK_YTELSE);return s==="pending"?e.jsx(f,{}):s==="error"?e.jsx(x,{}):e.jsx(p,{valgtAktorId:n,aktorInfo:r,fagsakStatuser:d,fagsakYtelseTyper:t,renderSomLenke:(a,u,i)=>e.jsx(K,{to:E(i),className:a,children:u})})};N.__docgenInfo={description:"",methods:[],displayName:"AktørIndex"};export{N as A};
