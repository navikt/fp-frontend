import{j as r}from"./jsx-runtime-CLpGMVip.js";import{r as u}from"./index-B5OHeJSP.js";import{W as C,z as F,Y as q,H as _}from"./index.es-BJ5ePes3.js";import{B as j}from"./behandlingDataContext-BMbp9e-c.js";import{k as D}from"./withPanelData-BD6kgoz0.js";import{s as T,i as S,q as c}from"./index.es-758GeVNB.js";import{S as I}from"./ExclamationmarkTriangleFill-BaHUn2cM.js";import{V as A,B as E}from"./BehandlingHenlagtPanel-DP91amuS.js";const h=({menyData:a,oppdaterFaktaPanelIUrl:i})=>{const o=D();return r.jsx(T,{heading:o.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(t=>({label:t.tekst??"",active:t.erAktiv,icon:t.harApneAksjonspunkter?r.jsx(I,{color:"var(--a-orange-600)"}):void 0})),onClick:i})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{menyData:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}}],raw:"FaktaPanelMenyData[]"},description:""},oppdaterFaktaPanelIUrl:{required:!0,tsType:{name:"signature",type:"function",raw:"(index: number) => void",signature:{arguments:[{type:{name:"number"},name:"index"}],return:{name:"void"}}},description:""}}};const N="_container_610fz_1",R="_content_610fz_6",B="_sideMenu_610fz_14",P={container:N,content:R,sideMenu:B},x=({hentPaneler:a,valgtFaktaSteg:i,valgtProsessSteg:o,setApentFaktaPanel:t,apentFaktaPanelInfo:s})=>{const{oppdaterProsessStegOgFaktaPanelIUrl:d}=u.use(j),[m,k]=u.useState([]),y=u.useCallback(e=>{k(p=>{const l=[...p],g=l.findIndex(f=>f.id===e.id);return g>=0?l.splice(g,1,e):l.push(e),l}),!e.harApneAksjonspunkter&&(s==null?void 0:s.urlCode)===e.id&&t(void 0),e.harApneAksjonspunkter&&(s==null?void 0:s.urlCode)!==e.id&&t({urlCode:e.id,text:e.tekst??""})},[s]),n=u.useMemo(()=>m.filter(e=>!!e.tekst),[m]),v=u.useCallback(e=>{if(n){const p=n[e];d(o,p.id)}},[n,o,d]);return a?r.jsx("div",{className:P.container,children:r.jsx(C,{fullHeight:!0,children:r.jsxs(F,{children:[r.jsx(q,{className:P.sideMenu,children:n&&n.length>0&&r.jsx(h,{menyData:n,oppdaterFaktaPanelIUrl:v})}),r.jsx(q,{className:P.content,children:a({valgtFaktaSteg:i,registrerFaktaPanel:y})})]})})}):null};x.__docgenInfo={description:"",methods:[],displayName:"FaktaContainer",props:{hentPaneler:{required:!1,tsType:{name:"signature",type:"function",raw:"(props: FaktaPanelInitProps) => ReactElement",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  harApentAksjonspunkt?: boolean;
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}}],raw:"ProsessPanelMenyData[]",required:!0}}]}},name:"ekstraProps"}],return:{name:"ReactElement"}}},description:""},valgtProsessSteg:{required:!1,tsType:{name:"string"},description:""},valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""}}};export{Y as B};
