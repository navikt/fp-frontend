...
Har ansvar for å sette opp form for faktapenelet til Omsorgsvilkåret.`,methods:[],displayName:"OmsorgOgForeldreansvarInfoPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},vedtaksDatoSomSvangerskapsuke:{required:!0,tsType:{name:"union",raw:"number | undefined",elements:[{name:"number"},{name:"undefined"}]},description:""}}};const We=Cn(3),ba=Jn(1e4),fa=n=>({kode:ue(n[0].definisjon,m.VARSEL_REVURDERING_ETTERKONTROLL,m.VARSEL_REVURDERING_MANUELL),begrunnelse:n[0].begrunnelse??"",sendVarsel:void 0}),De=n=>n??{},fn=({familiehendelse:n,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,previewCallback:s})=>{const o=j(),{isReadOnly:l,alleKodeverk:d,behandling:u,submitCallback:g,aksjonspunkterForPanel:k}=$(),p=fa(k),{mellomlagretFormData:y,setMellomlagretFormData:F}=Q(),f=z({defaultValues:y??p}),q=f.watch(),[S,h]=de.useState(!1),P=()=>h(!1),K=()=>h(!0),A=ie=>{f.trigger().then(Re=>{Re&&g({...q,...ie}),h(!1)})},V=ie=>{ie.preventDefault(),s({dokumentMal:lr.VARSEL_OM_REVURDERING,arsakskode:ir.ANNET,fritekst:q.fritekst??" "})},{avklartBarn:N}=De(n.register),{termindato:ke}=De(n.gjeldende),{vedtaksDatoSomSvangerskapsuke:An}=De(n.gjeldende),Rn=u.behandlingÅrsaker.reduce((ie,Re)=>ie||Re.erAutomatiskRevurdering,!1),wn=d.Venteårsak??[],Bn=Pn(u.språkkode);return e.jsxs(e.Fragment,{children:[e.jsx(C,{formMethods:f,onSubmit:g,setDataOnUnmount:F,children:e.jsxs(v,{gap:"4",children:[e.jsx(J,{size:"small",children:e.jsx(i,{id:"VarselOmRevurderingForm.VarselOmRevurdering"})}),!l&&k[0].status===pe.OPPRETTET&&e.jsxs(e.Fragment,{children:[e.jsx(be,{children:e.jsx(i,{id:"VarselOmRevurderingForm.VarselOmRevurderingVurder"})}),Rn&&e.jsx(bn,{behandlingsType:u.type,avklartBarn:N,termindato:ke,vedtaksDatoSomSvangerskapsuke:An,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t}),e.jsx(qe,{name:"sendVarsel",validate:[w],isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"VarselOmRevurderingForm.SendVarsel"}),element:e.jsx(Ze,{marginTop:6,children:e.jsxs(v,{gap:"2",children:[e.jsx(xe,{badges:[{type:"info",titleText:Bn}],name:"fritekst",label:o.formatMessage({id:"VarselOmRevurderingForm.FritekstIBrev"}),validate:[w,We,ba,Me],maxLength:1e4,parse:Nn}),e.jsx("div",{children:e.jsx(ur,{href:"#",onClick:V,children:e.jsx(i,{id:"VarselOmRevurderingForm.Preview"})})})]})})},{value:"false",label:o.formatMessage({id:"VarselOmRevurderingForm.IkkeSendVarsel"})}]}),e.jsx(xe,{name:"begrunnelse",label:o.formatMessage({id:"VarselOmRevurderingForm.BegrunnelseForSvar"}),validate:[w,We,Me]}),e.jsx("div",{children:e.jsx(nr,{variant:"primary",size:"small",onClick:q.sendVarsel?K:void 0,loading:f.formState.isSubmitting,disabled:f.formState.isSubmitting,type:q.sendVarsel?"button":"submit",children:e.jsx(i,{id:"VarselOmRevurderingForm.Bekreft"})})})]}),(l||k[0].status!==pe.OPPRETTET)&&e.jsx(Wn,{size:"small",label:e.jsx(i,{id:"VarselOmRevurderingForm.Begrunnelse"}),value:q.begrunnelse,type:"textarea"})]})}),e.jsx(dr,{showModal:S,frist:G().add(28,"days").format(On),cancelEvent:P,submitCallback:A,ventearsaker:wn,visBrevErBestilt:!0,hasManualPaVent:!0,ventearsak:null,erTilbakekreving:u.type===Z.TILBAKEKREVING||u.type===Z.TILBAKEKREVING_REVURDERING})]})};fn.__docgenInfo={description:`VarselOmRevurderingForm
...
Setter opp aksjonspunktet for avklaring av Fødselsvilkåret.`,methods:[],displayName:"FodselVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""}}};const Ka={"FodselVilkarForm.Fodsel":"Fødsel","FodselVilkarForm.TidligereUtbetaltStonad":"Tidligere utbetalte foreldrepenger eller engangsstønad","FodselVilkarForm.Oppfylt":"Er utbetalt for et annet barn, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfylt":"Er utbetalt for dette barnet, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},_a=Y(Ka),Ha=n=>e.jsx(L,{value:_a,children:e.jsx(cn,{...n})});Ha.__docgenInfo={description:"",methods:[],displayName:"FodselVilkarProsessIndex",props:{ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"string"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkarType: VilkarType;
  vilkarStatus: VilkarUtfallType;
  avslagKode?: string | null;
  lovReferanse?: string;
