import{j as m}from"./jsx-runtime-D_zvdyIk.js";import{r as t}from"./index-mMUbb89k.js";import{u as v}from"./index.es-myIdYxtV.js";import{A as y}from"./aksjonspunktCodes-Cv9tgqDr.js";import{i as p}from"./aksjonspunktStatus-xM4O_ZUY.js";import"./withPanelData-Cxc-_rcp.js";import{K as E}from"./alleKodeverk-Dp2FRR0Y.js";import{S as b}from"./SettPaVentModalIndex-DA_aYyhO.js";import{u as N}from"./behandlingApi-BsizdQgL.js";const A=({behandling:e,kodeverk:s,opneSokeside:l,erTilbakekreving:i=!1,skalIkkeViseModal:r=!1})=>{const[u,a]=t.useState(!r&&e.behandlingPåVent),o=()=>a(!1),d=N(e),{mutate:g}=v({mutationFn:n=>d.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>l()});t.useEffect(()=>{r||a(e.behandlingPåVent)},[e.versjon,r]);const k=e.aksjonspunkt.filter(n=>p(n.status)).some(n=>n.definisjon===y.AUTO_MANUELT_SATT_PÅ_VENT);return m.jsx(b,{submitCallback:g,cancelEvent:o,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:k,ventearsaker:s[E.VENT_AARSAK],erTilbakekreving:i,showModal:u})};A.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
