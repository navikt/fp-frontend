...
Readonly panel for formkrav klage (KA).`,methods:[],displayName:"FormkravKlageKa",props:{klageVurdering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  avsluttet?: string;
  uuid: string;
}`,signature:{properties:[{key:"type",value:{name:"string",required:!0}},{key:"avsluttet",value:{name:"string",required:!1}},{key:"uuid",value:{name:"string",required:!0}}]}}],raw:"AvsluttetBehandling[]"},description:""}}};const pn=Z(sn),se=({behandling:n,klageVurdering:r={},avsluttedeBehandlinger:t,aksjonspunkter:s,submitCallback:a,isReadOnly:l,readOnlySubmitButton:g,alleKodeverk:i,formData:y,setFormData:p,lagreFormkravVurdering:o})=>e.jsxs(Q,{value:pn,children:[s.some(m=>m.definisjon===q.VURDERING_AV_FORMKRAV_KLAGE_NFP)&&e.jsx(Fe,{behandlingUuid:n.uuid,klageVurdering:r,submitCallback:a,readOnly:l,readOnlySubmitButton:g,alleKodeverk:i,avsluttedeBehandlinger:t,lagreFormkravVurdering:o,formData:y,setFormData:p}),r.klageFormkravResultatKA&&e.jsx(Ee,{klageVurdering:r,alleKodeverk:i,avsluttedeBehandlinger:t})]});se.__docgenInfo={description:"",methods:[],displayName:"FormkravProsessIndex",props:{klageVurdering:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  klageVurderingResultatNK?: KlageVurderingResultat;
  klageVurderingResultatNFP?: KlageVurderingResultat;
  klageFormkravResultatKA?: {
    avvistArsaker: string[];
...
Presentasjonskomponent. Setter opp aksjonspunktet for behandling av klage (NFP).`,methods:[],displayName:"BehandleKlageFormNfp",props:{previewCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BrevData) => Promise<any>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  klageMedholdArsak?: string;
  klageHjemmel?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}},{key:"fritekstTilBrev",value:{name:"string",required:!1}},{key:"klageVurdering",value:{name:"string",required:!1}},{key:"klageVurderingOmgjoer",value:{name:"string",required:!1}},{key:"klageMedholdArsak",value:{name:"string",required:!1}},{key:"klageHjemmel",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Dn=Z(fn),xe=({behandling:n,klageVurdering:r,alleKodeverk:t,saveKlage:s,submitCallback:a,isReadOnly:l,previewCallback:g,readOnlySubmitButton:i,aksjonspunkter:y,formData:p,setFormData:o})=>e.jsxs(Q,{value:Dn,children:[r.klageVurderingResultatNK&&e.jsx(Oe,{klageVurdering:r,alleKodeverk:t}),y.some(m=>m.definisjon===q.BEHANDLE_KLAGE_NFP)&&e.jsx(Ie,{sprakkode:n.sprakkode,klageVurdering:r,saveKlage:s,submitCallback:a,readOnly:l,previewCallback:g,readOnlySubmitButton:i,alleKodeverk:t,alleAktuelleHjemler:r.aktuelleHjemler?r.aktuelleHjemler:[],formData:p,setFormData:o})]});xe.__docgenInfo={description:"",methods:[],displayName:"KlagevurderingProsessIndex",props:{klageVurdering:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  klageVurderingResultatNK?: KlageVurderingResultat;
  klageVurderingResultatNFP?: KlageVurderingResultat;
  klageFormkravResultatKA?: {
    avvistArsaker: string[];
