...
Readonly<{
  ...
  underBehandlingKabalTrygderett?: boolean;
  behandletAvKabal?: boolean;
}>`},description:""}}};const ye=[j.AUTO_VENT_ANKE_OVERSENDT_TIL_TRYGDERETTEN],L=()=>{const n=c(),a=T(ye),{behandling:r}=K.use(V),g=R(r),{data:k}=P(g.anke.ankeVurderingOptions(r));return e.jsx(x,{standardPanelProps:a,prosessPanelKode:S.ANKE_MERKNADER,prosessPanelMenyTekst:n.formatMessage({id:"Behandlingspunkt.AnkeMerknader"}),skalPanelVisesIMeny:!0,children:k?e.jsx(H,{ankeVurdering:k}):e.jsx(I,{})})};L.__docgenInfo={description:"",methods:[],displayName:"AnkeTrygderettsbehandlingProsessStegInitPanel"};const he=({valgtProsessSteg:n,valgtFaktaSteg:a})=>e.jsxs(e.Fragment,{children:[e.jsxs(Y,{valgtProsessSteg:n,valgtFaktaSteg:a,children:[e.jsx(M,{}),e.jsx(U,{}),e.jsx(L,{})]}),e.jsx(z,{valgtFaktaSteg:a,valgtProsessSteg:n,children:e.jsx(J,{})})]});he.__docgenInfo={description:"",methods:[],displayName:"AnkePaneler",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""}}};export{he as default};
