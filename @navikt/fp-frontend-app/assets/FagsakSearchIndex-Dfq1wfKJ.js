import{j as e}from"./jsx-runtime-CLpGMVip.js";import{a as T,u as b,n as F}from"./initFetch-Da712kaG.js";import{a as K,r as x,H as A,p as I,u as M}from"./index.es-DlLizdOt.js";import{k as N,V as _,h as k,H as y,n as P,P as E,a0 as V}from"./withPanelData-4wt_n4Hm.js";import{M as u,d as O,n as C}from"./index.es-Rn5szVsq.js";import{K as c}from"./alleKodeverk-BFmIlMu4.js";import{g as Y}from"./kodeverkUtils-DLZgokMR.js";import{T as s}from"./Table-6KbP-5uU.js";import"./index-B8jnc8p3.js";import{S as D}from"./ExclamationmarkTriangleFill-D3tNvM-K.js";import{p as H}from"./paths-D6GFD1kz.js";import{a as L}from"./index-DqeTBbD1.js";const j=({fagsaker:r,selectFagsakCallback:a,alleKodeverk:t})=>{const i=Y(t);return e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:r.map(n=>e.jsxs(s.Row,{onMouseDown:()=>a(n.saksnummer),onKeyDown:()=>a(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:i(n.fagsakYtelseType,c.FAGSAK_YTELSE)}),e.jsx(s.DataCell,{children:i(n.status,c.FAGSAK_STATUS)})]},n.saksnummer))})]})};j.__docgenInfo={description:`FagsakList
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSearch",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const $={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},Q=C($),S=({fagsaker:r=[],searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n=!1,searchResultAccessDenied:d,alleKodeverk:g})=>e.jsx(E,{value:Q,children:e.jsx(h,{fagsaker:r,searchFagsakCallback:a,searchResultReceived:t,selectFagsakCallback:i,searchStarted:n,searchResultAccessDenied:d,alleKodeverk:g})});S.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  status: string;
  aktørId: string;
