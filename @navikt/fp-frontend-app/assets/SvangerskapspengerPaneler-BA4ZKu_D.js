...
Viser tillrettlegging før svangerskapspenger`,methods:[],displayName:"TilretteleggingFaktaForm",props:{behandlingVersjon:{required:!0,tsType:{name:"number"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},harApneAksjonspunkter:{required:!0,tsType:{name:"boolean"},description:""},arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  fødselsdato?: string;
}>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const we=[c.FODSELTILRETTELEGGING],st=[c.OVERSTYR_AVKLAR_STARTDATO],it=[P.ARBEID_OG_INNTEKT,P.SVANGERSKAPSPENGER_TILRETTELEGGING],gn=({arbeidsgiverOpplysningerPerId:n,...r})=>e.jsx(Hn,{...r,panelEndepunkter:it,aksjonspunktKoder:we,overstyringApKoder:st,faktaPanelKode:sr.FODSELTILRETTELEGGING,faktaPanelMenyTekst:B().formatMessage({id:"FaktaInitPanel.Title.FodselOgTilrettelegging"}),skalPanelVisesIMeny:()=>!0,renderPanel:t=>e.jsx(on,{arbeidsgiverOpplysningerPerId:n,...t,readOnly:t.readOnly||!we.some(a=>ir(a,r.behandling.aksjonspunkt))})});gn.__docgenInfo={description:"",methods:[],displayName:"FodselOgTilretteleggingFaktaInitPanel",props:{arbeidsgiverOpplysningerPerId:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  erPrivatPerson: boolean;
  referanse?: string;
  identifikator: string;
  navn: string;
