import{j as e}from"./jsx-runtime-CLpGMVip.js";import{B as $e}from"./BehandlingContainer-Dv8qQ1Av.js";import{V as Qe}from"./VergeFaktaInitPanel-B8-USl0z.js";import{r as q}from"./index-B8jnc8p3.js";import{n as L,d as N,k as V,ap as E,am as ke,m as M,J as Ze,V as C,H as B,L as f,h as b,P as ne,B as me,a0 as ve,l as oe}from"./withPanelData-C_2vLFzV.js";import{M as i,d as g,N as pe,f as Ke,Z as ye,n as ae,$ as J,Q as be,p as Xe,x as We}from"./index.es-h-DRP8gS.js";import{u as $}from"./initFetch-DlB8shxc.js";import{a as fe,r as he,Q as re,e as T,Z as _,b as ce,N as je,u as w}from"./index.es-GVrn7-iN.js";import{A as y}from"./aksjonspunktCodes-BuBbCIxs.js";import{a as Ae,b as er,B as R}from"./behandlingResultatType-DHbqkXMl.js";import{P as U}from"./skjermlenkeCodes-1SvLTuBb.js";import{h as Y}from"./moment-C5S46NFB.js";import{K as P}from"./alleKodeverk-Ck9zwXaq.js";import{g as te}from"./kodeverkUtils-DLZgokMR.js";import{P as qe,a as le}from"./OverstyringPanel-wXyB0Ejy.js";import{u as Q,a as Ve}from"./behandlingApi-v-44y4EH.js";import{u as Z,P as X}from"./useStandardProsessPanelProps-CTwMUcOA.js";import{B as W}from"./behandlingDataContext-BdfTXpp6.js";import{A as Te}from"./aksjonspunktStatus-xM4O_ZUY.js";import{V as D}from"./BehandlingHenlagtPanel-CwTlm0mC.js";import{v as rr}from"./validerApKodeOgHentApEnum-BojQgEP_.js";import{L as Fe}from"./Link-CPG0QPsQ.js";import{F as nr}from"./FatterVedtakStatusModal-MEBkQzlB.js";import{D as H}from"./dokumentMalType-uHvYWaNM.js";import{K as ar}from"./KlageBehandlingModal-BLFc2bxU.js";import"./index.es-hO6CWccn.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./useFormField-DQ-tGm72.js";import"./Tooltip-CxYR0Ri2.js";import"./index-Dmw-q_WW.js";import"./index-Dv0WEcwZ.js";import"./Popover-CC6v92Dy.js";import"./ExclamationmarkTriangleFill-BijRIKPT.js";import"./Box-tA5UDL1d.js";import"./bind-oYjWB_aQ.js";import"./Kjonnkode-C-fkzSiP.js";import"./Table-DxnOvmms.js";import"./v4-CtRu48qb.js";import"./react-BuCZm47s.js";import"./iframe-85gFjBbp.js";import"./chunk-XP5HYGXS-DH4vAeCa.js";import"./dayjs.min-CJilavqB.js";import"./CheckmarkCircleFill-CRmS3QyZ.js";import"./index-DqeTBbD1.js";import"./decorators-DIzpaN6C.js";import"./Checkbox-nZNBdIgq.js";import"./Tag-Db53Zi_m.js";import"./TotrinnskontrollIndex-DmHMajHo.js";import"./behandlingArsakType-CTXggz2Y.js";import"./paths-Mb_fGD6f.js";import"./useKodeverk-uLmsNpGs.js";import"./useVisForhandsvisningAvMelding-CF5vLcDR.js";import"./SupportHeader-DvXBF6_8.js";import"./ErrorBoundary-no2ydPMp.js";import"./IngenBehandlingValgtPanel-0oCwXeeV.js";import"./RestApiErrorContext-D3DzVTT-.js";var k=(r=>(r.STADFESTE_YTELSESVEDTAK="STADFESTE_YTELSESVEDTAK",r.MEDHOLD_I_KLAGE="MEDHOLD_I_KLAGE",r.OPPHEVE_YTELSESVEDTAK="OPPHEVE_YTELSESVEDTAK",r.AVVIS_KLAGE="AVVIS_KLAGE",r.HJEMSENDE_UTEN_Å_OPPHEVE="HJEMSENDE_UTEN_Å_OPPHEVE",r))(k||{}),S=(r=>(r.DELVIS_MEDHOLD_I_KLAGE="DELVIS_MEDHOLD_I_KLAGE",r.GUNST_MEDHOLD_I_KLAGE="GUNST_MEDHOLD_I_KLAGE",r.UGUNST_MEDHOLD_I_KLAGE="UGUNST_MEDHOLD_I_KLAGE",r.UDEFINERT="-",r))(S||{});const I="ikkePaklagdVedtak",ie=r=>r.erKlagerPart===!1||r.erFristOverholdt===!1||r.erKonkret===!1||r.erSignert===!1||r.vedtak===I,Be=(r,a)=>r.find(t=>t.uuid===a),se=(r,a)=>{const t=Be(r,a);return!!t&&(t.type===N.TILBAKEKREVING||t.type===N.TILBAKEKREVING_REVURDERING)},Pe=(r,a)=>{const t=se(r,a),l=Be(r,a);return l&&t?{tilbakekrevingUuid:l.uuid,tilbakekrevingVedtakDato:l.avsluttet,tilbakekrevingBehandlingType:l.type}:void 0},tr=(r,a,t,l)=>({kode:l,begrunnelse:r.begrunnelse,behandlingUuid:a,erKlagerPart:r.erKlagerPart,erFristOverholdt:r.erFristOverholdt,erKonkret:r.erKonkret,erSignert:r.erSignert,erTilbakekreving:se(t,r.vedtak),klageTilbakekreving:Pe(t,r.vedtak),paKlagdBehandlingUuid:r.vedtak===I?void 0:r.vedtak,fritekstTilBrev:ie(r)?r.fritekstTilBrev:void 0}),Ee=({behandlingUuid:r,saveKlage:a,avsluttedeBehandlinger:t,spinner:l=!1,aksjonspunktCode:n,readOnly:s=!1,handleSubmit:o})=>s?null:e.jsx(L,{size:"small",variant:"primary",loading:l,onClick:o(d=>a(tr(d,r,t,n))),type:"button",children:e.jsx(i,{id:"TempsaveKlageButton.TempSaveButton"})});Ee.__docgenInfo={description:"",methods:[],displayName:"TempsaveKlageButton",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunktCode:{required:!0,tsType:{name:"string"},description:""},avsluttedeBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  type: string;
  avsluttet?: string;
  uuid: string;
