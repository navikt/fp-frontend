import{j as e}from"./jsx-runtime-CLpGMVip.js";import{f as v,M as l,n as f,H as q}from"./index.es-CLCeEg4m.js";import{u as c,j}from"./initFetch-DK4cSTvy.js";import"./aktivitetStatus-02fOJoqz.js";import{K as k}from"./alleKodeverk-Ck9zwXaq.js";import{V as w,H as R,P as I,B as x,Z as A}from"./withQueryClient-DTem1OUy.js";import{R as F}from"./index-B5OHeJSP.js";import{V as T}from"./VisittkortSakIndex-sveCpfkJ.js";import{E as K}from"./IngenBehandlingValgtPanel-C2vIsWz6.js";import{p as b}from"./paths-BRpjkuL4.js";import{u as S}from"./useTrackRouteParam-Ch0yNoKb.js";import{u as m}from"./useKodeverk-DQG-UHsp.js";const y=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:d})=>e.jsxs(e.Fragment,{children:[e.jsx(T,{bruker:n.person}),e.jsx(w,{gap:"2",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(s=>{var i,g;const a=(i=t.find(o=>o.kode===s.fagsakYtelseType))==null?void 0:i.navn,u=(g=r.find(o=>o.kode===s.status))==null?void 0:g.navn;return e.jsxs(F.Fragment,{children:[d(void 0,`${a} (${s.saksnummer}) ${u}`,s.saksnummer),e.jsx(v,{sixteenPx:!0})]},s.saksnummer)}):e.jsx(R,{size:"small",children:e.jsx(l,{id:"AktoerGrid.IngenFagsaker"})})})]});y.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
