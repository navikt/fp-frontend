...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const I="_container_74un9_1",E="_advarselIcon_74un9_6",p={container:I,advarselIcon:E},N=(r,n)=>!!(r||n===void 0||n.length<1),q=({searchStarted:r,searchResultAccessDenied:n,searchFagsakCallback:t})=>{const a=j(),s=M({defaultValues:{searchString:""}}),l=s.watch("searchString");return e.jsx(O,{formMethods:s,onSubmit:t,className:p.container,children:e.jsxs(U,{gap:"2",children:[e.jsx(g,{size:"small",children:e.jsx(k,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(m,{gap:"2",align:"end",children:[e.jsx(P,{name:"searchString",control:s.control,label:a.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[h]}),e.jsx(B,{variant:"primary",size:"small",loading:r,disabled:N(r,l),children:e.jsx(k,{id:"Search.Search"})})]}),n&&e.jsxs(m,{gap:"2",align:"end",children:[e.jsx(H,{className:p.advarselIcon}),e.jsx(g,{size:"small",children:e.jsx(k,{id:n.feilmelding})})]})]})})};q.__docgenInfo={description:`SearchForm
