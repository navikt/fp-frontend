import{j as e,i as g,P as y,b as p,L as v}from"./iframe-L6RViAaa.js";import{X as f}from"./index.es-DcmD3r8S.js";import{u as q,r as j}from"./fagsakApi-DIe9Qa42.js";import{V as w}from"./VisittkortSakIndex-jsk1Ow4F.js";import{V as c,a as I,B as T}from"./VStack-BwRgwtxq.js";import{M as k}from"./message-sgs3Q0kV.js";import{E as F}from"./IngenBehandlingValgtPanel-DQJHnt9M.js";import{u as R}from"./useTrackRouteParam-tpSshNaB.js";import{p as E}from"./paths-FGzLcyOu.js";import{u as o}from"./useKodeverk-DmYL-Isw.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(w,{bruker:n.person}),e.jsx(c,{gap:"4",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
