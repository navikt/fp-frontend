...
Formkomponent. Registrering og oppdatering av verge.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"verge",optional:!1,type:{name:"union",raw:"Verge | undefined",elements:[{name:"intersection",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:"",defaultValue:{value:"[]",computed:!1}},valgtVergeType:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""}}};const Vh=(i,d)=>({...Rr.initialValues(d),...cn.buildInitialValues(i)}),Fh=i=>({kode:to.AVKLAR_VERGE,...cn.transformValues(i),...Rr.transformValues(i)}),co=({submittable:i,verge:d,alleKodeverk:a})=>{const u=Ar(),{aksjonspunkterForPanel:g,submitCallback:f,alleMerknaderFraBeslutter:h,harÅpneAksjonspunkter:q,isReadOnly:j}=$f(),{formData:R,setFormData:E}=Wf(),S=jr({defaultValues:R||Vh(d,g),shouldUnregister:!0}),I=S.watch("vergeType"),P=S.watch("begrunnelse"),J=N.useMemo(()=>a[ln.VERGE_TYPE].sort((me,W)=>me.navn.localeCompare(W.navn)),[a[ln.VERGE_TYPE]]);return m.jsxs(m.Fragment,{children:[q&&m.jsx(nb,{children:u.formatMessage({id:"RegistrereVergeInfoPanel.CheckInformation"})}),m.jsxs(wr,{formMethods:S,onSubmit:me=>f(Fh(me)),setDataOnUnmount:E,children:[m.jsx(rb,{merknaderFraBeslutter:h[to.AVKLAR_VERGE],children:m.jsx(cn,{readOnly:j||g.length===0,vergetyper:J,valgtVergeType:I})}),g.length!==0&&m.jsxs(m.Fragment,{children:[m.jsx(rr,{twentyPx:!0}),m.jsx(Rr,{isSubmittable:i,isReadOnly:j,hasBegrunnelse:!!P}),m.jsx(rr,{twentyPx:!0}),m.jsx(vo,{isSubmittable:i&&!!I,isReadOnly:j,isSubmitting:S.formState.isSubmitting,isDirty:S.formState.isDirty})]})]})]})};co.__docgenInfo={description:`RegistrereVergeInfoPanel
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Uo=({behandling:i,hentOgSettBehandling:d,lukkModal:a})=>{const u=We(Yi()),g=la(i),{mutate:f}=tr({mutationFn:h=>g.endreBehandlendeEnhet({...h,behandlingUuid:i.uuid,behandlingVersjon:i.versjon}),onSuccess:()=>d()});return m.jsx(wo,{behandlingVersjon:i.versjon,behandlendeEnhetId:i.behandlendeEnhetId,behandlendeEnhetNavn:i.behandlendeEnhetNavn,nyBehandlendeEnhet:f,behandlendeEnheter:xn(u.data).behandlendeEnheter,lukkModal:a})};Uo.__docgenInfo={description:"",methods:[],displayName:"EndreBehandlendeEnhetMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Wo=i=>Lu(i.behandling,"VERGE_FJERN_V2")||Lu(i.behandling,"VERGE_OPPRETT_V2")?m.jsx(Yo,{...i}):m.jsx(Oc,{...i}),Oc=({fagsak:i,behandlingAppKontekst:d,behandling:a,setBehandling:u,lukkModal:g})=>{var E;const f=(E=d.behandlingTillatteOperasjoner)==null?void 0:E.vergeBehandlingsmeny,h=Wi(),q=ro(),j=()=>{h(io({...q,pathname:ao(i.saksnummer,a.uuid)}))},R=Zi(a,S=>{u(S),j()});return m.jsx(mo,{fjernVerge:Zr.FJERN===f?R.fjernVergeV1:void 0,opprettVerge:Zr.OPPRETT===f?R.opprettVergeV1:void 0,lukkModal:g})},Yo=({behandlingAppKontekst:i,behandling:d,hentOgSettBehandling:a,lukkModal:u})=>{var I;const g=(I=i.behandlingTillatteOperasjoner)==null?void 0:I.vergeBehandlingsmeny,f=Ab(d.type),h=no(),q=()=>{a(),h.invalidateQueries({queryKey:[Di.FETCH_FAGSAK]}),h.invalidateQueries({queryKey:[Di.FETCH_FAGSAKDATA_FPTILBAKE]}),h.invalidateQueries({queryKey:[Uu.VERGE]}),h.invalidateQueries({queryKey:[Uu.VERGE_HENT]})},j=la(d),{mutate:R}=tr({mutationFn:j.verge.opprettVergeV2,onSuccess:q}),{mutate:E}=tr({mutationFn:j.verge.fjernVergeV2,onSuccess:q}),{data:S}=We(j.verge.hent(d));return m.jsx(qo,{type:Zr.OPPRETT===g?"OPPRETT":"FJERN",verge:S,opprettVerge:R,fjernVerge:E,lukkModal:u,alleKodeverk:f})};Wo.__docgenInfo={description:"",methods:[],displayName:"VergeMenyModal",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};export{aa as A,Kc as B,vo as F,Kh as P,ch as T,Mh as V,Rr as a,Rh as b,wh as c,Xt as d,Ph as e,jh as f,dq as g,gq as h,po as i,Bh as j,yo as s,wb as u};
