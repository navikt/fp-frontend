import{j as e,i as g,P as y,b as p,L as v}from"./iframe-CAr8c5Eo.js";import{X as f}from"./index.es-imdVDkne.js";import{u as q,r as j}from"./fagsakApi-Dt8BnMvP.js";import{V as c}from"./VisittkortSakIndex-DoPuRpFS.js";import{V as w,a as I,B as T}from"./VStack-DcUlD83Z.js";import{M as k}from"./message-DJj_VkWI.js";import{E as F}from"./IngenBehandlingValgtPanel-DtrAXf4J.js";import{u as R}from"./useTrackRouteParam-DpcgMhHW.js";import{p as E}from"./paths-CSMGTJ8p.js";import{u as o}from"./useKodeverk-BqgOX9Oq.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",level:"2",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
