import{l as j,j as e,x as G,aT as Dn,a3 as $,a4 as X,P as L,b as Y,r as de,aL as Ne,F as Qe,o as w,B as ee,i as hn,V as Pn,W as Nn,y as On,n as Vn,X as En,aP as In,Y as ve}from"./iframe-Cs6twVbq.js";import{r as E,K as be,X as fe,W as Ze,H as W,A as Un,n as xn}from"./index.es-YNS18tnB.js";import{G as Kn,u as O,I as Mn,E as x}from"./fagsakApi-nQoOUuDZ.js";import{b as Q,P as _,t as B,O as H,M as qe,u as z,N as C,d as _n,$ as Hn,q as Ue,A as Ln,g as Yn,r as Gn,s as $n,Y as zn,D as xe,a as Cn,o as Jn,c as Ke,W as Wn,e as Xn}from"./index.es-CmqguzHd.js";import{F as K,a as Oe,f as Qn,d as Me}from"./BehandlingMenuIndex-DOqQ6xCd.js";import{A as m,f as D,b as pe}from"./index-Bni6Mx7T.js";import{i as Zn}from"./isSameOrBefore-DSvq1d4_.js";import{V as b,H as h,L as F,B as f,D as er,a as J,b as nr}from"./VStack-Cbf59n_t.js";import{S as rr}from"./ExclamationmarkTriangleFill-D3lkQDUB.js";import{M as d}from"./message-Dztmm5bT.js";import{u as Te,f as ar}from"./behandlingApi--_eNoPfR.js";import{u as Ve,F as Ee}from"./VergeFaktaInitPanel-C8n7293D.js";import{B as Fe}from"./FagsakIndex-DisqV1Me.js";import{T as ye}from"./Tag-CD65vkIB.js";import{T as S}from"./Table-z3ceVBw4.js";import{N as tr}from"./VisittkortSakIndex-CZSMeKOX.js";import{A as _e,s as sr,a as or}from"./MedlemskapInngangsvilkarInitPanel-BDV-l-aJ.js";import{H as He}from"./HGrid-DkZRQLCP.js";import{D as lr}from"./dokumentMalType-B-Xou3xH.js";import{R as ir}from"./MeldingIndex-CvWxr6kS.js";import{S as dr}from"./SettPaVentModalIndex-CqJbVvF1.js";import{P as I,V as U,b as je}from"./OverstyringPanel-L6hIwIoo.js";import{v as ue}from"./validerApKodeOgHentApEnum-rsyIqtMD.js";import{L as ur}from"./Link-BK73k868.js";import{u as en,P as gr}from"./useStandardProsessPanelProps-DXtIBR6p.js";import{V as ce}from"./vilkarUtfallType-vN0hVpa7.js";const ge=n=>n!=null,Z=(n,r)=>ge(r)&&n!==r,mr="_container_t96ng_1",kr="_image_t96ng_6",Le={container:mr,image:kr};G.extend(Zn);const re=({readOnly:n,soknad:r,gjeldendeFamiliehendelse:a,erForeldrepengerFagsak:t,hasEktefellesBarnAksjonspunkt:s,alleMerknaderFraBeslutter:o})=>{const l=j(),{watch:i,control:u}=Q(),g=i("fodselsdatoer")??{},k=i("omsorgsovertakelseDato"),v=i("barnetsAnkomstTilNorgeDato"),p=vr(r,a);return e.jsx(E,{title:l.formatMessage({id:"DokumentasjonFaktaForm.ApplicationInformation"}),merknaderFraBeslutter:o[m.ADOPSJONSDOKUMENTAJON],children:e.jsxs(b,{gap:"4",className:Le.container,children:[e.jsx(_,{name:"omsorgsovertakelseDato",control:u,label:t&&s?l.formatMessage({id:"DokumentasjonFaktaForm.Stebarnsadopsjon"}):l.formatMessage({id:"DokumentasjonFaktaForm.Omsorgsovertakelsesdato"}),validate:[B,H],isReadOnly:n,isEdited:Z(r.omsorgsovertakelseDato,a.omsorgsovertakelseDato)}),t&&v&&e.jsx(_,{name:"barnetsAnkomstTilNorgeDato",control:u,label:l.formatMessage({id:"DokumentasjonFaktaForm.DatoForBarnetsAnkomstTilNorge"}),validate:[H],isReadOnly:n,isEdited:Z(r.barnetsAnkomstTilNorgeDato,a.ankomstNorge)}),Object.keys(g).map((q,y)=>e.jsxs(h,{gap:"4",children:[e.jsx(_,{name:`fodselsdatoer.${q}`,label:l.formatMessage({id:"DokumentasjonFaktaForm.Fodselsdato"},{number:y+1}),validate:[B,H],isReadOnly:n,isEdited:p(q)}),!n&&yr(g,parseInt(q,10),k)&&e.jsx(rr,{className:Le.image,title:l.formatMessage({id:"DokumentasjonFaktaForm.BarnErOver15Ar"})})]},`div-${m.ADOPSJONSDOKUMENTAJON}-${q}`)),e.jsxs("div",{children:[e.jsx(F,{size:"small",children:l.formatMessage({id:"DokumentasjonFaktaForm.AntallBarnSomFyllerVilkaret"})}),e.jsx(f,{size:"small",children:pr(g,k)})]})]})})},pr=(n,r)=>{if(Object.keys(n).filter(s=>n[parseInt(s,10)]).length===0||!r)return"-";const t=G(r).subtract(15,"years");return Object.values(n).map(s=>G(s).isAfter(t)?1:0).reduce((s,o)=>s+o,0)},yr=(n,r,a)=>!!n[r]&&!!a&&G(n[r]).isSameOrBefore(G(a).subtract(15,"years"));re.buildInitialValues=(n,r)=>({omsorgsovertakelseDato:(r==null?void 0:r.omsorgsovertakelseDato)??n.omsorgsovertakelseDato,barnetsAnkomstTilNorgeDato:(r==null?void 0:r.ankomstNorge)??n.barnetsAnkomstTilNorgeDato,fodselsdatoer:(r==null?void 0:r.adopsjonFodelsedatoer)??n.adopsjonFodelsedatoer});re.transformValues=n=>({kode:m.ADOPSJONSDOKUMENTAJON,omsorgsovertakelseDato:n.omsorgsovertakelseDato??"",fodselsdatoer:n.fodselsdatoer??""});const vr=(n,r)=>a=>{const t=Dn(n.adopsjonFodelsedatoer,r.adopsjonFodelsedatoer);return t?t[a]:!1};re.__docgenInfo={description:`DokumentasjonFaktaForm
