...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const E="_container_tt7dx_1",Y="_advarselIcon_tt7dx_6",p={container:E,advarselIcon:Y},I=(r,n)=>!!(r||n===void 0||n.length<1),q=({searchStarted:r,searchResultAccessDenied:n,searchFagsakCallback:t})=>{const a=j(),s=b({defaultValues:{searchString:""}}),l=s.watch("searchString");return e.jsx(M,{formMethods:s,onSubmit:t,className:p.container,children:e.jsxs(B,{gap:"space-8",children:[e.jsx(g,{size:"small",children:e.jsx(k,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(m,{gap:"space-8",align:"end",children:[e.jsx(V,{name:"searchString",control:s.control,label:a.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[h]}),e.jsx(U,{variant:"primary",size:"small",loading:r,disabled:I(r,l),children:e.jsx(k,{id:"Search.Search"})})]}),n&&e.jsxs(m,{gap:"space-8",align:"end",children:[e.jsx(N,{className:p.advarselIcon}),e.jsx(g,{size:"small",children:e.jsx(k,{id:n.feilmelding})})]})]})})};q.__docgenInfo={description:`SearchForm
