import{j as E}from"./jsx-runtime-DR9Q75dM.js";import{R as ue,r as c}from"./index-DRjF_FHU.js";import"./aktivitetStatus-02fOJoqz.js";import{Y as Tn,f as Fe,$ as Be,a as ge,H as _,b as ke,k as oe,P as en,g as nn,p as Or,h as Jn,j as tn,l as sn,m as Re,e as Se,n as ce,d as Wn,o as Zn,U as Xn,D as Qn,r as cn,q as X,s as Pn,t as er,K as nr,M as rn,F as bn,v as $,w as rr,u as Ce,L as Vr,x as ar,y as _r,i as Ir,E as Ye,z as wr,C as yn,G as Nr,I as Dr,J as Kr,N as Mr,O as Ur,B as Gr,Q as Lr}from"./AppIndex.stories-BCbl3Utf.js";import{t as ln,e as Le,U as qn,M as p,y as j,f as xn,P as tr,d as F,g as sr,h as ir,R as C,i as Z,G as je,j as An,A as lr,X as Sn,J as or,k as Rn,x as an,l as M,m as Te,C as dr,z as $r,S as Cr,n as Hr,o as zr,F as Yr}from"./index.es-DH0d4ek-.js";import{F as Jr,V as Wr}from"./VergeFaktaInitPanel-jaPxYsgj.js";import{B as Zr}from"./BehandlingContainer-DYN-cDjG.js";import{P as on,H as me,B as x,b as G,d as U,V as Xr,e as I,L as z,f as ur,M as de,D as J,E as Qr}from"./VStack-BVYVp7vW.js";import{H as ea,m as le,S as Ge,T as xe,a as gr,b as kr,h as Ae,c as mr,I as re}from"./index.es-DPjpKjbu.js";import{S as vr,a as pr,b as na}from"./index.es-On-uWaPh.js";import{S as br}from"./FigureCombination-Dy9lbj2l.js";import{V as ie}from"./BehandlingHenlagtPanel-C0oWskp7.js";import{P as Fn}from"./ProsessDefaultInitPanel-bgFzZmPD.js";import{F as ra}from"./FatterVedtakStatusModal-C_kQa47g.js";import"./bind-Bji6QwHW.js";import"./index-rX-Bn4lm.js";import"./iframe-Dwd9G_cq.js";import"../sb-preview/runtime.js";import"./SettPaVentReadOnlyModal-DakQHXG8.js";import"./behandlingResultatType-DHbqkXMl.js";import"./nb_NO-DvsgJ24X.js";var Qe=(e=>(e.INGEN_TILBAKEBETALING="INGEN_TILBAKEBETALING",e.DELVIS_TILBAKEBETALING="DELVIS_TILBAKEBETALING",e.FULL_TILBAKEBETALING="FULL_TILBAKEBETALING",e))(Qe||{}),dn=(e=>(e.VURDER_FORELDELSE="5003",e))(dn||{}),yr={exports:{}},we={};/**
 * @license React
...
Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<TilbakekrevingKodeverkType, KodeverkMedNavn[]>"},description:""},fagsakYtelseTypeKode:{required:!0,tsType:{name:"string"},description:""}}};const Fi=({behandling:e,fagsak:r,valgtProsessSteg:a,valgtFaktaSteg:t,oppdaterProsessStegOgFaktaPanelIUrl:s,opneSokeside:o,alleBehandlinger:i})=>{const{data:g}=Kr.useRestApi(Mr.KODEVERK_FPTILBAKE),y=c.useMemo(()=>i.filter(v=>!v.behandlingHenlagt).map(v=>{var d;return{uuid:v.uuid,type:v.type,status:v.status,opprettet:v.opprettet,avsluttet:v.avsluttet,resultatType:(d=v.behandlingsresultat)==null?void 0:d.type}}),[i]).some(v=>v.type===Ur.REVURDERING&&v.status!==Gr.AVSLUTTET),u=c.useCallback(v=>g?E.jsxs(E.Fragment,{children:[E.jsx(Er,{tilbakekrevingKodeverk:g,fagsakYtelseTypeKode:r.fagsakYtelseType,...v}),E.jsx(Wr,{...v})]}):E.jsx(E.Fragment,{children:"placeholder"}),[g,r]),l=c.useCallback(v=>g?E.jsxs(E.Fragment,{children:[E.jsx(fr,{...v,relasjonsRolleType:r.relasjonsRolleType,tilbakekrevingKodeverk:g}),E.jsx(Pr,{...v,relasjonsRolleType:r.relasjonsRolleType,tilbakekrevingKodeverk:g}),E.jsx(Rr,{...v,harApenRevurdering:y,opneSokeside:o,tilbakekrevingKodeverk:g})]}):E.jsx(E.Fragment,{children:"placeholder"}),[g,y,r,o,s]);return g?E.jsxs(E.Fragment,{children:[E.jsx(Lr,{behandling:e,opneSokeside:o,kodeverk:g,erTilbakekreving:!0},e.versjon),E.jsx(Zr,{behandling:e,valgtProsessSteg:a,valgtFaktaSteg:t,oppdaterProsessStegOgFaktaPanelIUrl:s,hentFaktaPaneler:u,hentProsessPaneler:l})]}):E.jsx(Yr,{})};Fi.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingPaneler",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
