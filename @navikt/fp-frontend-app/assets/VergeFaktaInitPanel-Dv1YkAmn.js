import{j as n}from"./jsx-runtime-qGIIFXMu.js";import{t as P,P as V,G as X,c as Z,b as J,f as Q,L as ee,B as ne,D as re,a as L}from"./index.es-DoOGnbFN.js";import{M as ae,a as p,Z as te,k as se,I as ie,e as le,T as ue,S as oe,r as de,H as j,c as ge,O as R,U as ke,V as me,P as F,d as S,f as ye,K as E,Y as ve,z as pe,B as be}from"./AppIndex.stories-BRDw0U2I.js";import{r as k}from"./index-CDs2tPxN.js";import{M as h,X as fe,F as qe,U as he,W as ce,y as c,H as K,L as q,c as je}from"./index.es-Dug_iKsu.js";import{R as _}from"./useRestApiRunner-CQE2m9r8.js";import{E as N}from"./index.es-zhgnUGpN.js";import{e as Te,g as Ae}from"./ProsessDefaultInitPanel-LddoPiVe.js";var B=(e=>(e.BARN="BARN",e.FBARN="FBARN",e.VOKSEN="VOKSEN",e.ADVOKAT="ADVOKAT",e.ANNEN_F="ANNEN_F",e))(B||{});const I={"MerkePanel.Dod":"DØD","MerkePanel.DodTittel":"Personen er død","MerkePanel.DodFodt":"DØDFØDT","MerkePanel.Diskresjon6":"Kode 6","MerkePanel.Diskresjon7":"Kode 7","MerkePanel.EgenAnsatt":"NAV","MerkePanel.Verge":"Verge","MerkePanel.Diskresjon6Tittel":"Personen har diskresjonsmerking kode 6","MerkePanel.Diskresjon7Tittel":"Personen har diskresjonsmerking kode 7","MerkePanel.EgenAnsattTittel":"Personen er ansatt i NAV","MerkePanel.VergeTittel":"Personen har verge","SubmitButton.ConfirmInformation":"Bekreft og fortsett","FaktaBegrunnelseTextField.BegrunnEndringene":"Begrunn endringene","FaktaBegrunnelseTextField.Vurdering":"Vurdering","FaktaBegrunnelseTextField.Begrunnelse":"Begrunnelse","FaktaKilde.Soknad":"FRA SØKNADEN","FaktaKilde.FREG":"FRA FOLKEREGISTERET","FaktaKilde.MEDL":"FRA MEDLEMSKAPSREGISTERET"},w=P(I),Re=se(3),we=ie(1500),f=({isReadOnly:e,isSubmittable:r,hasBegrunnelse:t,label:s,hasReadOnlyLabel:a=!1,hasVurderingText:i=!1,name:l="begrunnelse"})=>{const g=i?"FaktaBegrunnelseTextField.Vurdering":"FaktaBegrunnelseTextField.BegrunnEndringene",u=()=>e?a?w.formatMessage({id:"FaktaBegrunnelseTextField.Begrunnelse"}):"":s||w.formatMessage({id:g});return n.jsx(V,{value:w,children:(r||t)&&n.jsx(ae,{name:l,label:u(),validate:[p,Re,we,te],maxLength:1500,readOnly:e})})},Be=e=>e&&Array.isArray(e)?e.length>0?e[0].begrunnelse:"":e&&!Array.isArray(e)?e.begrunnelse:"";f.buildInitialValues=(e,r="begrunnelse")=>({[r]:X(Be(e))});f.transformValues=(e,r="begrunnelse")=>({begrunnelse:e[r]});f.__docgenInfo={description:"FaktaBegrunnelseTextField",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"aksjonspunkt",optional:!0,type:{name:"union",raw:"Aksjonspunkt[] | Aksjonspunkt",elements:[{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
