import{j as e}from"./jsx-runtime-BDPtolqC.js";import{b as q,L as _,r as V,N as R,a as F,l as S,E as L,e as A,A as z,$ as E}from"./index.es-DT3aXwL0.js";import{n as y,f as $,c as C,d as U,V as M,Y as c,z as u,h as Y,g as o,i as N,X as G,S as D}from"./index.es-dGlS6Fbw.js";import{r as X}from"./index-B54hSm9S.js";import{A as H}from"./RisikoklassifiseringIndex-CapKkKJQ.js";import"./aktivitetStatus-02fOJoqz.js";import{V as K}from"./BehandlingHenlagtPanel-DUpT-ri2.js";import{l as T,V as W,k as J,B as v,Y as Q,H as Z,F as ee,L as h}from"./alleKodeverk-B3AibkSl.js";import{S as ne}from"./TotrinnskontrollIndex-CWJ-vsKW.js";const se="_explanationTextarea_hw8s7_1",re="_begrunnelseTextField_hw8s7_6",ae={explanationTextarea:se,begrunnelseTextField:re},f={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},te=y(f),ie=F(3),le=S(2e3),oe=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ue=n=>r=>r!==void 0||n,P=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:i}}=q(),t=a?()=>!1:ue(i);return e.jsx("div",{className:s?"":ae.begrunnelseTextField,children:e.jsx(_,{name:"begrunnelse",label:r||te.formatMessage({id:oe(n)}),validate:[V(t),ie,le,R],maxLength:2e3,readOnly:n,parse:$})})},de=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";P.buildInitialValues=n=>({begrunnelse:C(de(n))});P.transformValues=n=>({begrunnelse:n.begrunnelse});P.__docgenInfo={description:`ProsessStegBegrunnelseTextField
