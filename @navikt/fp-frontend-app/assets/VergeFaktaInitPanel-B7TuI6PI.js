import{r as d,l as y,j as s,bG as S,bH as I,bi as V}from"./iframe-DoiceIWA.js";import{Q as f}from"./index.es-DDd7pO56.js";import{u as D}from"./fagsakApi-B_jAt4JW.js";import{V as q}from"./BehandlingMenuIndex-C-JJ2bvk.js";import{i as p,A as L}from"./index-oVuILd1f.js";import{u as P,c as j}from"./behandlingApi-DjHGxoWE.js";import{B as v}from"./FagsakIndex-BdqITJKN.js";import{W as O}from"./index.es-DRVdYkYy.js";import{H as F}from"./VStack-BKysgEKf.js";import{S as w}from"./ExclamationmarkTriangleFill-D0Mch1J0.js";import{e as G,g as B}from"./useStandardProsessPanelProps-DCJnoHNb.js";const h=a=>{const[l,e]=d.useState([]),t=n=>{e(i=>{const r=[...i],m=r.findIndex(u=>u.id===n.id);return m>=0?r.splice(m,1,n):r.push(n),r}),a?.(n.harApneAksjonspunkter?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:l.filter(n=>n.skalVisesImeny),settFaktaPanelMenyData:t}},c="_container_4o186_1",M="_content_4o186_6",U="_sideMenu_4o186_19",E={container:c,content:M,sideMenu:U},H=({valgtFaktaSteg:a,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const n=y(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(v),{faktaPanelMenyData:r,settFaktaPanelMenyData:m}=h(e),u=r.length>0;return s.jsxs(F,{className:E.container,wrap:!1,children:[u&&s.jsx("div",{className:E.sideMenu,"data-testid":"fakta-meny",children:s.jsx(O,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?s.jsx(w,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(l,r[o].id)}})}),s.jsx("div",{className:E.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:r,children:t})})]})},_=d.createContext({}),J=a=>{const{children:l,...e}=a,t=d.useMemo(()=>e,[e]);return s.jsx(_.Provider,{value:t,children:l})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",x=(a,l,e,t)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:i}=d.use(_),r=e&&(n===a||t&&n===Y);return d.useEffect(()=>{i({id:a,tekst:l,erAktiv:r,harApneAksjonspunkter:t,skalVisesImeny:e})},[e,r,t]),e&&r},R=({standardPanelProps:a,skalPanelVisesIMeny:l,faktaPanelKode:e,faktaPanelMenyTekst:t,children:n})=>{const{behandling:i,fagsak:r,alleKodeverk:m}=d.use(v),u=x(e,t,l,a.harÅpneAksjonspunkter);return s.jsx(S,{behandling:i,children:u?s.jsx(I,{behandling:i,fagsak:r,alleKodeverk:m,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpneAksjonspunkter:a.harÅpneAksjonspunkter,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,children:n}):null})};R.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'ANNEN_PERMISJON'`,elements:[{name:"literal",value:"'-'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'PERMITTERING'"},{name:"literal",value:"'ANNEN_PERMISJON'"}],required:!0}}]},required:!0}}]}}],raw:"Array<tjenester_behandling_uttak_dokumentasjon_DokumentasjonVurderingBehovDto_AktivitetskravGrunnlagArbeid>",required:!1}}]}}],raw:"DokumentasjonVurderingBehov[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpneAksjonspunkter: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const T="default",A="default",C=(a,l,e,t,n,i)=>r=>{const u=(Array.isArray(r)?r:[r]).map(g=>({"@type":g.kode,...g})),o={saksnummer:a.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(u&&n&&i){if(u.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return n({...o,overstyrteAksjonspunktDtoer:u}).then(()=>e(A,T))}return t({...o,bekreftedeAksjonspunktDtoer:u}).then(()=>e(A,T))},Q=(a,l=[])=>{const{behandling:e,rettigheter:t,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=d.use(v),{aksjonspunkt:o}=e,g=o&&a?o.filter(k=>a.includes(k.definisjon)):[],b=G(e,[],t,!1),N=B(e.status,g),K=C(n,e,m,i,r,l);return{behandling:e,submittable:!g.some(k=>p(k.status))||g.some(k=>k.kanLoses),harÅpneAksjonspunkter:g.some(k=>p(k.status)&&k.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:g,isReadOnly:b,alleMerknaderFraBeslutter:N,submitCallback:K}},W=[L.AVKLAR_VERGE],z=()=>{const a=y(),l=Q(W),{behandling:e}=d.use(v),t=P(e),n=j(e,"VERGE"),{data:i,isFetching:r}=D(t.vergeOptions(e,n));return s.jsx(R,{standardPanelProps:l,faktaPanelKode:V.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?s.jsx(f,{}):s.jsx(q,{verge:i,alleKodeverk:l.alleKodeverk,submittable:l.submittable})})};z.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{R as F,z as V,H as a,Q as u};
