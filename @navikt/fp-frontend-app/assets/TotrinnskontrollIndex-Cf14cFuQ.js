...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean | null;
}>`}]},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Cn=({fagsakData:e,valgtBehandlingUuid:n,beslutterFormData:t,setBeslutterFormData:i,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const u=U(),[p,v]=B.useState(!1),[k,f]=B.useState(!1),o=e.getFagsak(),g=$(e.getBehandling(n)),q=he(g),m=fe(),d=qe(),b=Ee(Re()),{brukernavn:E,kanVeilede:j}=$(b.data).innloggetBruker,h=$e(g.type),{mutate:y}=Pe({mutationFn:S=>q.lagreTotrinnsaksjonspunkt(S)}),A=Je(g),V=()=>{A(!1,{behandlingUuid:g.uuid,fagsakYtelseType:o.fagsakYtelseType,gjelderVedtak:!0})};if(!g.totrinnskontrollÅrsaker)return null;const D=S=>{const be={behandlingUuid:g.uuid,behandlingVersjon:g.versjon,bekreftedeAksjonspunktDtoer:[S.fatterVedtakAksjonspunktDto]};f(S.erAlleAksjonspunktGodkjent),v(!0),y(be)},O=g.status===_.FATTER_VEDTAK;return r.jsxs(r.Fragment,{children:[r.jsx(ze,{tekst:u.formatMessage({id:O?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:r.jsx(me,{behandling:g,location:m,readOnly:E===g.ansvarligSaksbehandler||j,onSubmit:D,forhandsvisVedtaksbrev:V,fagsakYtelseType:o.fagsakYtelseType,alleKodeverk:h,createLocationForSkjermlenke:Ye,beslutterFormData:t,setBeslutterFormData:i})}),p&&r.jsx(ye,{behandling:g,pushLocation:d,allAksjonspunktApproved:k})]})};Cn.__docgenInfo={description:`TotrinnskontrollIndex
