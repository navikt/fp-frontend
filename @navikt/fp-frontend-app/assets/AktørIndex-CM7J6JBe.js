import{j as e,i as g,P as v,b as p,L as y}from"./iframe-BGDiT7Gy.js";import{Q as f}from"./index.es-BdBHwG7_.js";import{u as q,r as _}from"./fagsakApi-Jjs9m_ub.js";import{V as c}from"./VisittkortSakIndex--HNu_U7G.js";import{V as w,a as j,B as N}from"./VStack-D3h1m5z5.js";import{M as m}from"./message-C_aysfyQ.js";import{E as A}from"./IngenBehandlingValgtPanel-DddrfKZM.js";import{u as R}from"./useTrackRouteParam-0SD2IehU.js";import{p as E}from"./paths-Cj16gDzy.js";import{u as d}from"./useKodeverk-D26NB5_7.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person,familiehendelse:null}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(j,{size:"small",level:"2",children:e.jsx(m,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
