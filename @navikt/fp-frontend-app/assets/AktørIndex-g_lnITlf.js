import{j as e,i as g,P as v,b as p,L as y}from"./iframe-D6pyJFnd.js";import{Q as f}from"./index.es-794cribz.js";import{u as q,r as _}from"./fagsakApi-jjFtvP3u.js";import{V as c}from"./VisittkortSakIndex-CFkJS07R.js";import{V as w,a as j,B as N}from"./VStack-C99L3Mdl.js";import{M as m}from"./message-Cqbtq1E-.js";import{E as A}from"./IngenBehandlingValgtPanel-D7S4yFTG.js";import{u as R}from"./useTrackRouteParam-Bkv7ep03.js";import{p as E}from"./paths-C1vEGeKw.js";import{u as d}from"./useKodeverk-BOkIebGV.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person,familiehendelse:null}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(j,{size:"small",level:"2",children:e.jsx(m,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
