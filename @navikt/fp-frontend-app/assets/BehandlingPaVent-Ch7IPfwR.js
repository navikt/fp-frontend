import{r,j as d}from"./iframe-5rMcjlRF.js";import{c as o}from"./index.es-DjJajryJ.js";import{e as T,A as g}from"./index-B0A8hxr4.js";import{S as y}from"./SettPaVentModalIndex-BQ-cfAD3.js";import{u as _}from"./behandlingApi-CT2d_1b3.js";const p=({behandling:e,kodeverk:t,opneSokeside:u,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[s,l]=r.useState(!a&&e.behandlingPåVent),m=()=>l(!1),v=_(e),{mutate:E}=o({mutationFn:n=>v.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>u()});r.useEffect(()=>{a||l(e.behandlingPåVent)},[e.versjon,a]);const k=e.aksjonspunkt.filter(T).some(n=>n.definisjon===g.AUTO_MANUELT_SATT_PÅ_VENT);return d.jsx(y,{submitCallback:E,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:k,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:s})};p.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
