import{r,j as d}from"./iframe-DoJe53TY.js";import{c as o}from"./index.es-D9FXigbt.js";import{i as T,A as g}from"./index-SW6f2y40.js";import{S as y}from"./SettPaVentModalIndex-CoZUBi58.js";import{u as _}from"./behandlingApi-CZGItjpY.js";const p=({behandling:e,kodeverk:t,opneSokeside:u,erTilbakekreving:i=!1,skalIkkeViseModal:n=!1})=>{const[s,l]=r.useState(!n&&e.behandlingPåVent),m=()=>l(!1),v=_(e),{mutate:E}=o({mutationFn:a=>v.oppdaterPåVent({...a,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>u()});r.useEffect(()=>{n||l(e.behandlingPåVent)},[e.versjon,n]);const k=e.aksjonspunkt.filter(a=>T(a.status)).some(a=>a.definisjon===g.AUTO_MANUELT_SATT_PÅ_VENT);return d.jsx(y,{submitCallback:E,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:k,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:s})};p.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
