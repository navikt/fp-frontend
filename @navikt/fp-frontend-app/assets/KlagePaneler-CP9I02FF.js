import{j as e}from"./jsx-runtime-CLpGMVip.js";import{B as $e}from"./BehandlingContainer-P4pndrVN.js";import{V as Qe}from"./VergeFaktaInitPanel-Bu4hvwNL.js";import{r as q}from"./index-B8jnc8p3.js";import{n as L,d as N,k as V,ap as E,am as ke,m as M,J as Ze,V as C,H as B,L as f,h as b,P as ne,B as me,a0 as ve,l as oe}from"./withPanelData-B0zkdg-8.js";import{M as i,d as g,N as pe,f as Ke,Z as ye,n as ae,$ as J,Q as be,p as Xe,x as We}from"./index.es-ylySzHC6.js";import{u as $}from"./initFetch-D5usnyLB.js";import{a as fe,r as he,Q as re,e as T,Z as _,b as ce,N as je,u as w}from"./index.es-BQQElYKk.js";import{A as y}from"./aksjonspunktCodes-BuBbCIxs.js";import{a as Ae,b as er,B as R}from"./behandlingResultatType-DHbqkXMl.js";import{P as U}from"./skjermlenkeCodes-1SvLTuBb.js";import{h as Y}from"./moment-C5S46NFB.js";import{K as P}from"./alleKodeverk-BFmIlMu4.js";import{g as te}from"./kodeverkUtils-DLZgokMR.js";import{P as qe,a as le}from"./OverstyringPanel-D-2cSafS.js";import{u as Q,a as Ve}from"./behandlingApi-D-WukIEf.js";import{u as Z,P as X}from"./useStandardProsessPanelProps-BqQDEqPU.js";import{B as W}from"./behandlingDataContext-BdfTXpp6.js";import{A as Te}from"./aksjonspunktStatus-xM4O_ZUY.js";import{V as D}from"./BehandlingHenlagtPanel-DQLcgfCu.js";import{v as rr}from"./validerApKodeOgHentApEnum-BmY8PdAM.js";import{L as Fe}from"./Link-CTZril0t.js";import{F as nr}from"./FatterVedtakStatusModal-DfxZBVs-.js";import{D as H}from"./dokumentMalType-uHvYWaNM.js";import{K as ar}from"./KlageBehandlingModal-BPyxQsqc.js";import"./index.es-zqjR_SMY.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./useFormField-BScuxMwd.js";import"./Tooltip-VVc4HmcT.js";import"./index-Dmw-q_WW.js";import"./index-Dv0WEcwZ.js";import"./Popover-j5Posq5M.js";import"./ExclamationmarkTriangleFill-D_leAKaU.js";import"./Box-CF-Ry_--.js";import"./bind-oYjWB_aQ.js";import"./Kjonnkode-C-fkzSiP.js";import"./Table-vchRXySs.js";import"./v4-CtRu48qb.js";import"./react-BtE7MjBI.js";import"./iframe-D060KNsZ.js";import"./chunk-XP5HYGXS-DH4vAeCa.js";import"./dayjs.min-CJilavqB.js";import"./CheckmarkCircleFill-Bn_EgKw2.js";import"./index-DqeTBbD1.js";import"./decorators-DIzpaN6C.js";import"./Checkbox-DHHmJwCX.js";import"./Tag-B0trkwuC.js";import"./TotrinnskontrollIndex-BKNk8aP9.js";import"./behandlingArsakType-CTXggz2Y.js";import"./paths-CEGYO3h7.js";import"./useKodeverk-BZipmmsT.js";import"./useVisForhandsvisningAvMelding-C8t4mlLs.js";import"./SupportHeader-BWYh47K3.js";import"./ErrorBoundary-ux0MYjFD.js";import"./IngenBehandlingValgtPanel-paf2uh67.js";import"./RestApiErrorContext-D3DzVTT-.js";var k=(r=>(r.STADFESTE_YTELSESVEDTAK="STADFESTE_YTELSESVEDTAK",r.MEDHOLD_I_KLAGE="MEDHOLD_I_KLAGE",r.OPPHEVE_YTELSESVEDTAK="OPPHEVE_YTELSESVEDTAK",r.AVVIS_KLAGE="AVVIS_KLAGE",r.HJEMSENDE_UTEN_Å_OPPHEVE="HJEMSENDE_UTEN_Å_OPPHEVE",r))(k||{}),S=(r=>(r.DELVIS_MEDHOLD_I_KLAGE="DELVIS_MEDHOLD_I_KLAGE",r.GUNST_MEDHOLD_I_KLAGE="GUNST_MEDHOLD_I_KLAGE",r.UGUNST_MEDHOLD_I_KLAGE="UGUNST_MEDHOLD_I_KLAGE",r.UDEFINERT="-",r))(S||{});const I="ikkePaklagdVedtak",ie=r=>r.erKlagerPart===!1||r.erFristOverholdt===!1||r.erKonkret===!1||r.erSignert===!1||r.vedtak===I,Be=(r,a)=>r.find(t=>t.uuid===a),se=(r,a)=>{const t=Be(r,a);return!!t&&(t.type===N.TILBAKEKREVING||t.type===N.TILBAKEKREVING_REVURDERING)},Pe=(r,a)=>{const t=se(r,a),l=Be(r,a);return l&&t?{tilbakekrevingUuid:l.uuid,tilbakekrevingVedtakDato:l.avsluttet,tilbakekrevingBehandlingType:l.type}:void 0},tr=(r,a,t,l)=>({kode:l,begrunnelse:r.begrunnelse,behandlingUuid:a,erKlagerPart:r.erKlagerPart,erFristOverholdt:r.erFristOverholdt,erKonkret:r.erKonkret,erSignert:r.erSignert,erTilbakekreving:se(t,r.vedtak),klageTilbakekreving:Pe(t,r.vedtak),paKlagdBehandlingUuid:r.vedtak===I?void 0:r.vedtak,fritekstTilBrev:ie(r)?r.fritekstTilBrev:void 0}),Ee=({behandlingUuid:r,saveKlage:a,avsluttedeBehandlinger:t,spinner:l=!1,aksjonspunktCode:n,readOnly:s=!1,handleSubmit:o})=>s?null:e.jsx(L,{size:"small",variant:"primary",loading:l,onClick:o(d=>a(tr(d,r,t,n))),type:"button",children:e.jsx(i,{id:"TempsaveKlageButton.TempSaveButton"})});Ee.__docgenInfo={description:"",methods:[],displayName:"TempsaveKlageButton",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunktCode:{required:!0,tsType:{name:"string"},description:""},avsluttedeBehandlinger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  type: string;
  avsluttet?: string;
  uuid: string;
