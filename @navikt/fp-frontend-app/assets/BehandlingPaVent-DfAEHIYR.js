import{r as t,j as y}from"./iframe-DHius6PL.js";import{d as v}from"./index.es-D5NNmgZx.js";import{i as p,A as m}from"./index-CLtB9ERq.js";import{S as T}from"./SettPaVentModalIndex-cU-n18Ur.js";import{u as A}from"./behandlingApi-BwYynTC-.js";const q=({behandling:e,kodeverk:s,opneSokeside:l,erTilbakekreving:i=!1,skalIkkeViseModal:r=!1})=>{const[u,a]=t.useState(!r&&e.behandlingPåVent),k=()=>a(!1),d=A(e),{mutate:o}=v({mutationFn:n=>d.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>l()});t.useEffect(()=>{r||a(e.behandlingPåVent)},[e.versjon,r]);const g=e.aksjonspunkt.filter(n=>p(n.status)).some(n=>n.definisjon===m.AUTO_MANUELT_SATT_PÅ_VENT);return y.jsx(T,{submitCallback:o,cancelEvent:k,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:g,ventearsaker:s.Venteårsak,erTilbakekreving:i,showModal:u})};q.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
