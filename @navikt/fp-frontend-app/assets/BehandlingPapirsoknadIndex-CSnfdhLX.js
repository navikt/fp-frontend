...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const ys="typeVirksomhet",fs={[ur.DAGMAMMA]:1,[ur.FISKE]:2,[ur.JORDBRUK_ELLER_SKOGBRUK]:3,[ur.ANNEN]:4},sm=(s,i)=>s>i?1:s<i?-1:0,mi=({readOnly:s,alleKodeverk:i})=>{var j,F;const o=i[ee.VIRKSOMHET_TYPE],d=M.useMemo(()=>o.filter(b=>b.kode!==ur.FRILANSER).sort((b,w)=>sm(fs[b.kode],fs[w.kode])),[]),{watch:g,setError:k,formState:v,clearErrors:m}=Y(),h=g(ys),f=!h||!Object.values(h).some(b=>b===!0);return M.useEffect(()=>{f&&k("notRegisteredInput",{type:"custom",message:zu()}),f||m("notRegisteredInput")},[f]),r.jsxs(r.Fragment,{children:[r.jsx(y,{eightPx:!0}),r.jsx(me,{size:"small",children:r.jsx(c,{id:"Registrering.VirksomhetNaeringTypePanel.Title"})}),r.jsx(y,{fourPx:!0}),d.map(b=>r.jsxs(M.Fragment,{children:[r.jsx(y,{fourPx:!0}),r.jsx(ie,{name:`${ys}.${b.kode}`,label:b.navn,readOnly:s},b.kode)]},b.kode)),v.isSubmitted&&((j=v.errors.notRegisteredInput)==null?void 0:j.message)&&r.jsx(kr,{children:(F=v.errors.notRegisteredInput)==null?void 0:F.message})]})};mi.__docgenInfo={description:`VirksomhetTypeNaringPanel
...
}`,signature:{properties:[{key:"skalGradere",value:{name:"boolean",required:!1}},{key:"graderingPeriode",value:{name:"FormValues",required:!1}}]},alias:"FormValues"}}],returns:null},{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:null}],displayName:"PermisjonGraderingPanel"};const Je="tidsromPermisjon",ln="overforingsperioder",_s=s=>()=>{const o=s(`${Je}.${ln}`).filter(({periodeFom:d,periodeTom:g})=>d!==""&&g!=="").map(({periodeFom:d,periodeTom:g})=>[d,g]);return o.length>0?Yn(o):void 0},xs={periodeFom:"",periodeTom:"",overforingArsak:""},Ti=({selectValues:s,readOnly:i})=>{const o=H(),{control:d,getValues:g,trigger:k,formState:{isSubmitted:v}}=Y(),{fields:m,remove:h,append:f}=he({control:d,name:`${Je}.${ln}`});M.useEffect(()=>{m.length===0&&f(xs)},[]);const j=`${Je}.${ln}`;return r.jsx(Oe,{fields:m,emptyPeriodTemplate:xs,bodyText:o.formatMessage({id:"Registrering.Permisjon.Utsettelse.LeggTilPeriode"}),readOnly:i,append:f,remove:h,children:(F,b,w)=>r.jsx(Q,{wrap:!0,children:r.jsxs(L,{children:[r.jsx(T,{children:r.jsx(fe,{name:`${j}.${b}.overforingArsak`,label:b===0?o.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}):"",selectValues:s,validate:[q],readOnly:i})}),r.jsxs(r.Fragment,{children:[r.jsx(T,{children:r.jsx(E,{isReadOnly:i,name:`${j}.${b}.periodeFom`,validate:[q,V,()=>{const A=g(`${Je}.${ln}.${b}.periodeFom`),S=g(`${Je}.${ln}.${b}.periodeTom`);return S&&A?qe(S)(A):null},_s(g)],label:b===0?r.jsx(c,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}):"",onChange:()=>v?k():void 0})}),r.jsx(T,{children:r.jsx(E,{isReadOnly:i,name:`${j}.${b}.periodeTom`,validate:[q,V,()=>{const A=g(`${Je}.${ln}.${b}.periodeFom`),S=g(`${Je}.${ln}.${b}.periodeTom`);return S&&A?Se(A)(S):null},_s(g)],label:b===0?r.jsx(c,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}):"",onChange:()=>v?k():void 0})}),w&&r.jsx(T,{children:w()})]})]})},F.id)})};Ti.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray
...
}`,signature:{properties:[{key:"notRegisteredInput",value:{name:"boolean",required:!1}}]}}],required:!0}}]}}}}],displayName:"BehovForTilretteleggingPanel"};const dk="_col_hlukm_1",Vs={col:dk},Ja="omsorg",Jn=({readOnly:s,soknadData:i,alleKodeverk:o,fodselsdato:d,mottattDato:g})=>r.jsxs(Ks,{justify:"space-between",children:[r.jsxs("div",{className:Vs.col,children:[r.jsx(ia,{readOnly:s,soknadData:i}),r.jsx(ye,{readOnly:s,alleKodeverk:o,erAdopsjon:i.getFamilieHendelseType()!==se.ADOPSJON,mottattDato:g}),r.jsx(fr,{readOnly:s})]}),r.jsx("div",{className:Vs.col,children:r.jsx(kn,{readOnly:s,familieHendelseType:i.getFamilieHendelseType(),isForeldrepengerFagsak:!1,fodselsdato:d})})]});Jn.transformValues=s=>({...ye.transformValues(s),[Ja]:kn.transformValues(s[Ja])});Jn.buildInitialValues=()=>({[Ja]:{},...ye.buildInitialValues()});Jn.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"intersection",raw:`{
  rettigheter?: string;
  foedselsDato?: string;
...
Readonly<{
  ...
  foreldreType: string,
) => Promise<any>`,signature:{arguments:[{type:{name:"any"},name:"formValues"},{type:{name:"string"},name:"fagsakYtelseType"},{type:{name:"string"},name:"familieHendelseType"},{type:{name:"string"},name:"foreldreType"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Fk="_alertStyle_1d8gt_1",wk="_modalStyle_1d8gt_6",Pk="_fullWidth_1d8gt_11",_k="_reduceMargin_1d8gt_16",xk="_left_1d8gt_20",Sk="_right_1d8gt_24",Vn={alertStyle:Fk,modalStyle:wk,fullWidth:Pk,reduceMargin:_k,left:xk,right:Sk},Cr=re(dt),Mi=({isOpen:s=!1})=>r.jsx(Xe,{className:Vn.modalStyle,open:s,"aria-label":Cr.formatMessage({id:"SoknadRegistrertModal.ContentLabel"}),onClose:()=>{},children:r.jsx(Xe.Body,{children:r.jsxs(Qr,{size:"small",variant:"success",className:Vn.alertStyle,children:[r.jsxs("div",{className:Vn.left,children:[r.jsx("p",{className:Vn.reduceMargin,children:Cr.formatMessage({id:"SoknadRegistrertModal.InfoTextOne"})}),r.jsx("p",{className:Vn.reduceMargin,children:Cr.formatMessage({id:"SoknadRegistrertModal.InfoTextTwo"})})]}),r.jsx("div",{className:Vn.right,children:r.jsx($s,{to:"/",children:r.jsx(Be,{size:"small",variant:"primary",children:Cr.formatMessage({id:"SoknadRegistrertModal.OkButtonText"})})})})]})})});Mi.__docgenInfo={description:`SoknadRegistrertModal

Informasjonsmodal som vises til saksbehandler når en papirsøknad har blitt registrert.`,methods:[],displayName:"SoknadRegistrertModal",props:{isOpen:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Ok=s=>s.map(i=>i.definisjon).filter(i=>i===dr.REGISTRER_PAPIRSOKNAD_ENGANGSSTONAD||i===dr.REGISTRER_PAPIRSOKNAD_FORELDREPENGER||i===dr.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER||i===dr.REGISTRER_PAPIRSOKNAD_SVANGERSKAPSPENGER)[0],Nk=(s,i,o,d)=>(g,k,v,m)=>{const h=[{"@type":Ok(s.aksjonspunkt),tema:v,soknadstype:k,soker:m,...g}],f={saksnummer:i.saksnummer,behandlingUuid:s.uuid,behandlingVersjon:s.versjon,bekreftedeAksjonspunktDtoer:h};return o(f).then(j=>{var F;((F=j==null?void 0:j.taskStatus)==null?void 0:F.status)!==tg.HALTED&&d(!0)})},Vi=({fagsak:s,behandling:i,kodeverk:o,rettigheter:d,lagreAksjonspunkt:g})=>{const[k,v]=M.useState(!1),m=!d.writeAccess.isEnabled||i.behandlingPaaVent,h=M.useMemo(()=>Nk(i,s,g,v),[i,s,g,v]),f=M.useCallback((w,A,S)=>h({ufullstendigSoeknad:!0},w,A,S),[h]),j=eg(),F=M.useCallback(()=>{j("/")},[]);if(!i.aksjonspunkt)return r.jsx(Uu,{});const b=i.aksjonspunkt.some(w=>w.definisjon===dr.REGISTRER_PAPIR_ENDRINGSØKNAD_FORELDREPENGER);return r.jsxs(r.Fragment,{children:[r.jsx(ng,{behandling:i,kodeverk:o,opneSokeside:F}),r.jsx(Mi,{isOpen:k}),r.jsx(Ei,{fagsak:s,kodeverk:o,readOnly:m,lagreUfullstendig:f,lagreFullstendig:h,erEndringssøknad:b})]})};Vi.__docgenInfo={description:`RegisterPapirsoknad
