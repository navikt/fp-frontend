import{t as f,j as e,G as C,c as P,B as y,S as z,H as D,D as E,L as q}from"./index.es-BPByIdSg.js";import{u as B,k as F,p as O,Z as S,a as M,I as N,e as $,b as T,c as U,P as G,F as H,d as Y,f as W}from"./AppIndex.stories-F5RXqf9t.js";import{r as X}from"./index-DVXBtNgz.js";import{b as i,W as _,H as m,L as d,a as Z,c as K,D as w,q as J,S as Q}from"./index.es-DE_dHijX.js";import{H as ee}from"./index.es-zhgnUGpN.js";import{v as ne}from"./ProsessDefaultInitPanel-CB14U3MF.js";const Me={OPPRETTET:"OPPR",UTFORT:"UTFO",AVBRUTT:"AVBR"},x={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.VilkarDato":"Dato for opphør av medlemskapet","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},se="_explanationTextarea_hw8s7_1",re="_begrunnelseTextField_hw8s7_6",ae={explanationTextarea:se,begrunnelseTextField:re},te=f(x),ie=M(3),le=N(2e3),oe=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",ue=n=>r=>r!==void 0||n,I=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:l}}=B(),t=a?()=>!1:ue(l);return e.jsx("div",{className:s?"":ae.begrunnelseTextField,children:e.jsx(F,{name:"begrunnelse",label:r||te.formatMessage({id:oe(n)}),validate:[O(t),ie,le,S],maxLength:2e3,readOnly:n,parse:u=>u.toString().replaceAll(new RegExp("\\p{Dash_Punctuation}","gu"),"-")})})},de=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";I.buildInitialValues=n=>({begrunnelse:C(de(n))});I.transformValues=n=>({begrunnelse:n.begrunnelse});I.__docgenInfo={description:`ProsessStegBegrunnelseTextField
