...
Statisk visning av panel som tilsier ingen risikoklassifisering er utført for valgt behandling, eller at ingen behandling er valgt.`,methods:[],displayName:"ManglendeKlassifiseringPanel"};var w=(e=>(e.HOY="HOY",e.IKKE_HOY="IKKE_HOY",e.IKKE_KLASSIFISERT="IKKE_KLASSIFISERT",e.UDEFINERT="-",e))(w||{});const ln={"Risikopanel.Tittel":"Faresignaler","Risikopanel.Tittel.IngenFaresignaler":"Ingen faresignaler oppdaget","Risikopanel.Tittel.Faresignaler":"Faresignaler oppdaget","Risikopanel.Tittel.ManglerKlassifisering":"Venter på mulige faresignaler","Risikopanel.Panel.Tittel":"Vurder faresignalene","Risikopanel.Panel.Medlemskap":"Medlemskap","Risikopanel.Panel.ArbeidsforholdInntekt":"Arbeidsforhold og inntekt","Risikopanel.Form.Resultat":"Resultat av vurderingen","Risikopanel.Form.Bekreft":"Bekreft og fortsett","Risikopanel.Forms.Vurdering":"Vurdering"},un=be(ln),U=(e,r)=>r!=null&&r.kontrollresultat?r.kontrollresultat===e:!1,O=({aksjonspunkt:e,risikoklassifisering:r,isPanelOpen:t,readOnly:n,submitAksjonspunkt:a,toggleRiskPanel:l,faresignalVurderinger:i})=>{const u=U(w.IKKE_HOY,r),k=U(w.HOY,r);return s.jsxs(ye,{value:un,children:[u&&s.jsx(ae,{}),r&&k&&s.jsx(re,{risikoklassifisering:r,aksjonspunkt:e,readOnly:n,isRiskPanelOpen:t,submitCallback:a,toggleRiskPanel:l,faresignalVurderinger:i}),!u&&!k&&s.jsx(te,{})]})};O.__docgenInfo={description:`RisikoklassifiseringSakIndex
...
om klassifisering er utført og ingen faresignaler er funnet og om klassifisering er utført og faresignaler er funnet`,methods:[],displayName:"RisikoklassifiseringSakIndex",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const on=({fagsakData:e,behandling:r,setBehandling:t})=>{const n=e.getFagsak(),{selected:a=!1}=Se({paramName:"risiko",parse:o=>o==="true",isQueryParam:!0}),l=z(),i=J(),u=()=>{l(V(i)(!a))},{kodeverkOptions:k}=C(),{data:d}=T(k()),p=e.getBehandling(r==null?void 0:r.uuid);return r&&p?s.jsx(gn,{isRiskPanelOpen:a,fagsak:n,toggleRiskPanel:u,behandlingAppKontekst:p,behandling:r,setBehandling:t}):s.jsx(O,{risikoklassifisering:n.kontrollResultat,isPanelOpen:a,readOnly:!0,toggleRiskPanel:u,faresignalVurderinger:q(d)[$.FARESIGNAL_VURDERING]})},gn=({fagsak:e,behandling:r,behandlingAppKontekst:t,setBehandling:n,toggleRiskPanel:a,isRiskPanelOpen:l})=>{const{behandlingPåVent:i,status:u,type:k,risikoAksjonspunkt:d,kontrollResultat:p}=t,{kodeverkOptions:o}=C(),f=T(ge()),{data:se}=T(o()),F=q(f.data).innloggetBruker,le=Xe(F,e.status,u,k),ie=dn(F,le,i),x=z(),P=J();g.useEffect(()=>{d&&d.status===A.OPPRETTET&&!l&&x(V(P)(!0)),d&&d.status===A.UTFORT&&x(V(P)(!1))},[!!d,r.uuid,r.versjon]);const{lagreAksjonspunkter:ue}=Be(r,n),oe=D=>{ue({behandlingUuid:r.uuid,behandlingVersjon:r.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":D.kode,...D}]})};return s.jsx(O,{aksjonspunkt:d??void 0,risikoklassifisering:p,isPanelOpen:l,readOnly:ie,submitAksjonspunkt:oe,toggleRiskPanel:a,faresignalVurderinger:q(se)[$.FARESIGNAL_VURDERING]})},dn=(e,r,t)=>{if(t)return!0;const{kanSaksbehandle:n}=e;return!n||!r.writeAccess.isEnabled};on.__docgenInfo={description:`RisikoklassifiseringIndex
