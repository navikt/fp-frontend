import{r as g,l as T,j as u,bH as K,bI as j,bj as V}from"./iframe-Kbkccahz.js";import{Q as w}from"./index.es-vD2QijKD.js";import{u as N}from"./fagsakApi-1OzcMs2p.js";import{V as S}from"./BehandlingMenuIndex-D01Md3qA.js";import{i as y,A as h}from"./index-B6ssYYyN.js";import{u as O,c as P}from"./behandlingApi-Bw2hJ2cu.js";import{B as v}from"./FagsakIndex-CCq9Upu6.js";import{W as B}from"./index.es-DxEK9Cik.js";import{H as F}from"./VStack-BJyDSUur.js";import{S as c}from"./ExclamationmarkTriangleFill-5JgmMX1G.js";import{e as D,g as I}from"./useStandardProsessPanelProps-B3IBpvLu.js";const G=a=>{const[t,e]=g.useState([]),l=n=>{e(i=>{const r=[...i],d=r.findIndex(s=>s.id===n.id);return d>=0?r.splice(d,1,n):r.push(n),r}),a?.(n.harApneAksjonspunkter?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:t.filter(n=>n.skalVisesImeny),settFaktaPanelMenyData:l}},L="_container_4o186_1",M="_content_4o186_6",U="_sideMenu_4o186_19",p={container:L,content:M,sideMenu:U},H=({valgtFaktaSteg:a,valgtProsessSteg:t,setFaktaPanelMedÅpentApInfo:e,children:l})=>{const n=T(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=g.use(v),{faktaPanelMenyData:r,settFaktaPanelMenyData:d}=G(e),s=r.length>0;return u.jsxs(F,{className:p.container,wrap:!1,children:[s&&u.jsx("div",{className:p.sideMenu,"data-testid":"fakta-meny",children:u.jsx(B,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harApneAksjonspunkter?u.jsx(c,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(t,r[o].id)}})}),u.jsx("div",{className:p.content,children:u.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:d,faktaPanelMenyData:r,children:l})})]})},E=g.createContext({}),J=a=>{const{children:t,...e}=a,l=g.useMemo(()=>e,[e]);return u.jsx(E.Provider,{value:l,children:t})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",x=(a,t,e,l)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:i}=g.use(E),r=e&&(n===a||l&&n===Y);return g.useEffect(()=>{i({id:a,tekst:t,erAktiv:r,harApneAksjonspunkter:l,skalVisesImeny:e})},[e,r,l]),e&&r},_=({standardPanelProps:a,skalPanelVisesIMeny:t,faktaPanelKode:e,faktaPanelMenyTekst:l,children:n})=>{const{behandling:i,fagsak:r,alleKodeverk:d}=g.use(v),s=x(e,l,t,a.harÅpneAksjonspunkter);return u.jsx(K,{behandling:i,children:s?u.jsx(j,{behandling:i,fagsak:r,alleKodeverk:d,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpneAksjonspunkter:a.harÅpneAksjonspunkter,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,children:n}):null})};_.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| '-'`,elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]",required:!0}},{key:"harSøknad",value:{name:"boolean",required:!0}},{key:"harSattEndringsdato",value:{name:"boolean",required:!0}},{key:"sjekkSimuleringResultat",value:{name:"boolean",required:!0}},{key:"taskStatus",value:{name:"union",raw:`{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}],required:!0}},{key:"alleKodeverk",value:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
| 'ANNEN_PERMISJON'`,elements:[{name:"literal",value:"'-'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'PERMITTERING'"},{name:"literal",value:"'ANNEN_PERMISJON'"}],required:!0}}]},required:!0}}]}}],raw:"Array<tjenester_behandling_uttak_dokumentasjon_DokumentasjonVurderingBehovDto_AktivitetskravGrunnlagArbeid>",required:!1}}]}}],raw:"DokumentasjonVurderingBehov[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpneAksjonspunkter: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",A="default",C=(a,t,e,l,n,i)=>r=>{const s=(Array.isArray(r)?r:[r]).map(k=>({"@type":k.kode,...k})),o={saksnummer:a.saksnummer,behandlingUuid:t.uuid,behandlingVersjon:t.versjon};if(s&&n&&i){if(s.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(s[0].kode))return n({...o,overstyrteAksjonspunktDtoer:s}).then(()=>e(A,b))}return l({...o,bekreftedeAksjonspunktDtoer:s}).then(()=>e(A,b))},Q=(a,t=[])=>{const{behandling:e,rettigheter:l,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:d,alleKodeverk:s}=g.use(v),{aksjonspunkt:o}=e,k=o&&a?o.filter(m=>a.includes(m.definisjon)):[],f=D(e,[],l,!1),R=I(e.status,k),q=C(n,e,d,i,r,t);return{behandling:e,submittable:!k.some(m=>y(m.status))||k.some(m=>m.kanLoses),harÅpneAksjonspunkter:k.some(m=>y(m.status)&&m.kanLoses),alleKodeverk:s,aksjonspunkterForPanel:k,isReadOnly:f,alleMerknaderFraBeslutter:R,submitCallback:q}},W=[h.AVKLAR_VERGE],z=()=>{const a=T(),t=Q(W),{behandling:e}=g.use(v),l=O(e),n=P(e,"VERGE"),{data:i,isFetching:r}=N(l.vergeOptions(e,n));return u.jsx(_,{standardPanelProps:t,faktaPanelKode:V.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?u.jsx(w,{}):u.jsx(S,{verge:i,alleKodeverk:t.alleKodeverk,submittable:t.submittable})})};z.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{_ as F,z as V,H as a,Q as u};
