import{j as e,a7 as h,bG as I,y as f,G as L,z as B,b as E,m as x,a8 as w,v as y}from"./iframe-DmsLcgj8.js";import{a as P,O as j,F as D,R as b,M as U}from"./index.es-UEqd1-Jj.js";import{b as M}from"./index-rT_r2_TR.js";import{V as Y}from"./vilkarUtfallType-vN0hVpa7.js";import{b as F,V as c,H as o,B as k,a as J,D as z,L as K}from"./VStack-D8JsMLPG.js";import{S as $}from"./Checkmark-ZQ8wodyN.js";import{S as C}from"./TotrinnskontrollIndex-VBCWdTBS.js";import{S as H,J as q,o as X}from"./index.es-CsWMiBLN.js";import{S as W}from"./CheckmarkCircleFill-CqADk2Bu.js";import{S as Q}from"./ExclamationmarkTriangleFill-MDG4yaFs.js";const Z="_begrunnelseTextField_hw8s7_6",ee={begrunnelseTextField:Z},p={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ae=E(p),le=f(3),ne=L(2e3),re=a=>a?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",te=a=>n=>n!==void 0||a,A=({readOnly:a,text:n,useAllWidth:l=!1,notRequired:r=!1})=>{const{formState:{isDirty:i},control:t}=P(),u=r?()=>!1:te(i);return e.jsx("div",{className:l?"":ee.begrunnelseTextField,children:e.jsx(j,{name:"begrunnelse",control:t,label:n??ae.formatMessage({id:re(a)}),validate:[I(u),le,ne,B],maxLength:2e3,readOnly:a,parse:h})})},ie=a=>a.length>0&&a[0].begrunnelse?a[0].begrunnelse:"";A.buildInitialValues=a=>({begrunnelse:x(ie(a))});A.transformValues=a=>({begrunnelse:a.begrunnelse});A.__docgenInfo={description:`ProsessStegBegrunnelseTextField
...
>`},{name:"null"}],required:!0}},{key:"besluttersBegrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"aksjonspunktType",value:{name:"union",raw:"'AUTO' | 'MANU' | 'OVST' | 'SAOV' | '-'",elements:[{name:"literal",value:"'AUTO'"},{name:"literal",value:"'MANU'"},{name:"literal",value:"'OVST'"},{name:"literal",value:"'SAOV'"},{name:"literal",value:"'-'"}],required:!0}},{key:"kanLoses",value:{name:"boolean",required:!0}},{key:"erAktivt",value:{name:"boolean",required:!0}},{key:"fristTid",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretTidspunkt",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"endretAv",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"Aksjonspunkt[]"}}],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  begrunnelse?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}}]},alias:"FormValues"}}],returns:{type:{name:"signature",type:"object",raw:"{ begrunnelse: string | undefined }",signature:{properties:[{key:"begrunnelse",value:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}],required:!0}}]}}}}],displayName:"ProsessStegBegrunnelseTextField",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},text:{required:!1,tsType:{name:"string"},description:""},useAllWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},notRequired:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const se=E(p),ue=(a,n,l,r)=>!l&&!n||a?!0:r===void 0?!l:!l&&r||r,O=({isReadOnly:a,isSubmittable:n,isSubmitting:l,isDirty:r,text:i,onClick:t,hasEmptyRequiredFields:u})=>a?null:e.jsx("div",{children:e.jsx(F,{size:"small",variant:"primary",loading:l,disabled:ue(l,n,r,u),onClick:t||w,type:t?"button":"submit",children:i??se.formatMessage({id:"SubmitButton.ConfirmInformation"})})});O.__docgenInfo={description:"",methods:[],displayName:"ProsessStegSubmitButton",props:{isReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmittable:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},text:{required:!1,tsType:{name:"string"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent"},name:"event"}],return:{name:"void"}}},description:""},hasEmptyRequiredFields:{required:!1,tsType:{name:"boolean"},description:""}}};const me="_godkjentImage_bo2wj_1",ve="_avslattImage_bo2wj_7",oe="_selectBredde_bo2wj_13",N={godkjentImage:me,avslattImage:ve,selectBredde:oe},de=E(p),_e=(a,n)=>()=>a===!1&&!n,ge=a=>a.toSorted((n,l)=>n.navn.localeCompare(l.navn)),R=({avslagsarsaker:a,customVilkarIkkeOppfyltText:n,customVilkarOppfyltText:l,readOnly:r,skalKunneInnvilge:i=!0,validatorsForRadioOptions:t})=>{const{getValues:u,watch:d,control:m}=P(),s=d("erVilkarOk"),_=t?t.concat(y):[y];return e.jsxs(c,{gap:"space-16",paddingInline:"4",children:[r&&s!==void 0&&e.jsxs(o,{gap:"space-8",children:[s&&e.jsx($,{className:N.godkjentImage}),!s&&e.jsx(C,{className:N.avslattImage}),s&&e.jsx(k,{size:"small",children:l}),!s&&e.jsx(k,{size:"small",children:n})]}),(!r||s===void 0)&&e.jsxs(D,{name:"erVilkarOk",control:m,validate:_,isReadOnly:r,children:[e.jsx(b,{value:!0,size:"small",disabled:!i,children:l}),e.jsx(b,{value:!1,size:"small",children:n})]}),s!==void 0&&!s&&a&&e.jsx(U,{name:"avslagskode",control:m,label:de.formatMessage({id:"VilkarResultPicker.Arsak"}),selectValues:ge(a||[]).map(g=>e.jsx("option",{value:g.kode,children:g.navn},g.kode)),readOnly:r,className:N.selectBredde,validate:[I(_e(s,u("avslagskode")))]})]})};R.buildInitialValues=(a,n,l)=>{const i=a.some(t=>t.status===M.OPPRETTET)?void 0:Y.OPPFYLT===n;return{erVilkarOk:i,avslagskode:i===!1&&l?.avslagsarsak?l.avslagsarsak:void 0}};R.transformValues=a=>a.erVilkarOk?{erVilkarOk:a.erVilkarOk}:{erVilkarOk:a.erVilkarOk,avslagskode:a.avslagskode};R.__docgenInfo={description:`VilkarResultPicker
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Avslagsårsak'>[]"},description:""},customVilkarIkkeOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},customVilkarOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},skalKunneInnvilge:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},validatorsForRadioOptions:{required:!1,tsType:{name:"Array",elements:[{name:"unknown"}],raw:"((value: string | number | boolean) => string | null | undefined)[]"},description:""}}};const ke="_vilkar_1ciy8_1",Ee="_aksjonspunktMargin_1ciy8_5",pe="_godkjentImage_1ciy8_10",Ve="_avslattImage_1ciy8_16",V={vilkar:ke,aksjonspunktMargin:Ee,godkjentImage:pe,avslattImage:Ve},T=E(p),ce=({lovReferanse:a,title:n,originalErVilkarOk:l,isAksjonspunktOpen:r,readOnlySubmitButton:i,readOnly:t,rendreFakta:u,isDirty:d,erIkkeGodkjentAvBeslutter:m,isSubmitting:s,children:_})=>e.jsxs(c,{gap:"space-16",children:[e.jsxs(o,{gap:"space-8",children:[l!==void 0&&e.jsxs(e.Fragment,{children:[l&&e.jsx(W,{className:V.godkjentImage}),!l&&e.jsx(H,{className:V.avslattImage})]}),e.jsx(J,{size:"small",level:"3",children:n}),a&&e.jsx(z,{className:V.vilkar,children:a})]}),e.jsxs(o,{gap:"space-8",children:[l&&e.jsx(K,{size:"small",children:T.formatMessage({id:"ProsessPanelTemplate.ErOppfylt"})}),l===!1&&e.jsx(K,{size:"small",children:T.formatMessage({id:"ProsessPanelTemplate.ErIkkeOppfylt"})}),!r&&l===void 0&&e.jsx(k,{size:"small",children:T.formatMessage({id:"ProsessPanelTemplate.IkkeBehandlet"})})]}),e.jsx(q,{className:V.aksjonspunktMargin,erAksjonspunktApent:r,erIkkeGodkjentAvBeslutter:m,children:e.jsxs(c,{gap:"space-16",children:[e.jsx("div",{children:_}),e.jsx(O,{isReadOnly:t,isSubmittable:!i,isDirty:d,isSubmitting:s})]})}),u?.()]});ce.__docgenInfo={description:"",methods:[],displayName:"ProsessPanelTemplate",props:{title:{required:!0,tsType:{name:"string"},description:""},lovReferanse:{required:!1,tsType:{name:"string"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},readOnlySubmitButton:{required:!0,tsType:{name:"boolean"},description:""},originalErVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},rendreFakta:{required:!1,tsType:{name:"signature",type:"function",raw:"() => ReactNode",signature:{arguments:[],return:{name:"ReactNode"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Ne="_aksjonspunktMargin_15w18_1",Te="_exclamationmarkIcon_15w18_6",S={aksjonspunktMargin:Ne,exclamationmarkIcon:Te},v=E(p),ye=f(3),Fe=L(1500),Ke=a=>n=>n!==void 0||a?y(n):void 0,Pe=({erOverstyrt:a,isSolvable:n,erVilkarOk:l,hasAksjonspunkt:r,overrideReadOnly:i,isSubmitting:t,isPristine:u,toggleAv:d,erIkkeGodkjentAvBeslutter:m,children:s})=>{const{formState:{isDirty:_},control:g}=P(),G=Ke(_);return e.jsx(q,{className:S.aksjonspunktMargin,erAksjonspunktApent:a,erIkkeGodkjentAvBeslutter:m,children:e.jsxs(c,{gap:"space-16",children:[e.jsx(K,{size:"medium",children:v.formatMessage({id:"OverstyringPanel.AutomatiskVurdering"})}),e.jsx("div",{children:s}),(a||r)&&e.jsx(j,{name:"begrunnelse",control:g,label:v.formatMessage({id:"OverstyringPanel.Vilkar"}),validate:[G,ye,Fe,B],maxLength:1500,readOnly:i||!a}),!a&&l!==void 0&&e.jsxs(o,{gap:"space-8",children:[e.jsx(X,{}),e.jsx(k,{size:"small",children:v.formatMessage({id:"OverstyringPanel.Endret"})})]}),a&&e.jsxs(e.Fragment,{children:[e.jsxs(o,{gap:"space-8",children:[e.jsx(Q,{className:S.exclamationmarkIcon}),e.jsx(k,{size:"small",children:v.formatMessage({id:"OverstyringPanel.Unntakstilfeller"})})]}),e.jsxs(o,{gap:"space-8",children:[!i&&e.jsx(F,{size:"small",variant:"primary",loading:t,disabled:t||!n||u,children:v.formatMessage({id:"OverstyringPanel.ConfirmInformation"})}),e.jsx(F,{size:"small",variant:"secondary",loading:t,disabled:t,onClick:d,type:"button",children:v.formatMessage({id:"OverstyringPanel.Avbryt"})})]})]})]})})};Pe.__docgenInfo={description:"",methods:[],displayName:"OverstyringPanel",props:{erOverstyrt:{required:!0,tsType:{name:"boolean"},description:""},isSolvable:{required:!0,tsType:{name:"boolean"},description:""},erVilkarOk:{required:!1,tsType:{name:"boolean"},description:""},hasAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},overrideReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isPristine:{required:!0,tsType:{name:"boolean"},description:""},toggleAv:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};export{Pe as O,A as P,R as V,O as a,ce as b};
