...
Readonly<{
  ...
  innsendingsårsak: keyof typeof InntektsmeldingInnsendingsårsak;
  tilknyttedeBehandlingIder: string[];
}>`},description:""}}};const _m=({inntektsmelding:e,fagsak:n})=>i.jsx(se,{type:"button",onClick:()=>{window.open(zi(n.saksnummer,e.journalpostId,e.dokumentId),"_blank")},variant:"secondary",size:"small",icon:i.jsx(jp,{}),children:i.jsx(k,{id:"InntektsmeldingFaktaPanel.modal.trigger"})});_m.__docgenInfo={description:"",methods:[],displayName:"LastNedPdfKnapp",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
