import{j as e,i as g,P as y,b as p,L as v}from"./iframe-Duvu2UuF.js";import{X as f}from"./index.es-3VTj6eJo.js";import{u as q,r as j}from"./fagsakApi-CkDBUY-Q.js";import{V as c}from"./VisittkortSakIndex-DTJCSgdF.js";import{V as w,a as I,B as T}from"./VStack-BzsaBcbL.js";import{M as k}from"./message-CyTcPugX.js";import{E as F}from"./IngenBehandlingValgtPanel-CS5_4aVx.js";import{u as R}from"./useTrackRouteParam-BLCMjApL.js";import{p as E}from"./paths-sYa4i-pK.js";import{u as o}from"./useKodeverk-BfblMj1o.js";const m=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:s,renderSomLenke:u})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=s.find(t=>t.kode===a.fagsakYtelseType)?.navn,d=r.find(t=>t.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:u(void 0,`${i} (${a.saksnummer}) ${d}`,a.saksnummer)},a.saksnummer)}):e.jsx(I,{size:"small",level:"2",children:e.jsx(k,{id:"AktoerGrid.IngenFagsaker"})})})]});m.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
