import{k as c,j as n,F as I,P as H,r as G,l as te,B as R}from"./iframe-CV_Hmyy8.js";import{g as se,w as le,r as U,A as ie,h as M}from"./index.es-TTvnTWWZ.js";import{n as F,s as Y,u as oe,t as ue,d as de}from"./fagsakApi-BvggaIfg.js";import{u as ge,N as ke,O as D,t as j,D as me,o as C,a as ve,M as pe,E as ye,e as B}from"./index.es-CfPZNWz1.js";import{D as l}from"./dokumentMalType-B-Xou3xH.js";import{V as be}from"./venteArsakType-BJdSFL9e.js";import{U as Ee}from"./UkjentAdresseMeldingIndex-MAojGseY.js";import{V as J,H as S,b as z,M as O,L as Te}from"./VStack-Bv5rBkCi.js";import{L as fe}from"./Link-CAHtuBgr.js";import{M as f}from"./message-BCcn_Hah.js";import{S as he}from"./CheckmarkCircleFill-D-fzFANo.js";import{u as L}from"./useKodeverk-D_JgFByH.js";import{S as Ae}from"./SupportHeader-BXNekXOH.js";import{S as Re}from"./SettPaVentReadOnlyModal-4rPpbLXN.js";var y=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(y||{});const Ne="_bredde_jav4h_9",P={bredde:Ne},qe=C(4e3),Ve=C(1e4),je=ve(3),Q=({behandling:e,forhåndsvisBrev:r,submitCallback:s,revurderingVarslingArsak:g,fagsakYtelseType:k,kanVeilede:a,meldingFormData:i,setMeldingFormData:b,brukerManglerAdresse:T})=>{const u=c(),d=ge({defaultValues:i??Ke(e)}),m=d.watch("brevmalkode"),E=d.watch("fritekst"),o=d.watch("arsakskode"),N=ce(g,k);if(!e.språkkode)return null;const{formState:h,control:v}=d,A=t=>{m&&E?r({brevmalkode:m,fritekst:E,arsakskode:o}):E||d.setError("fritekst",{type:"manual",message:u.formatMessage({id:"Messages.FritekstRequired"})}),t.preventDefault()},q=se(e.språkkode),p=m===l.VARSEL_OM_REVURDERING;return n.jsx(ke,{formMethods:d,onSubmit:t=>s(_e(t)),setDataOnUnmount:b,children:n.jsxs(J,{gap:"4",children:[n.jsx(D,{name:"brevmalkode",control:v,label:u.formatMessage({id:"Messages.Template"}),validate:[j],selectValues:e.brevmaler.map(t=>n.jsx("option",{value:t.kode,disabled:!t.tilgjengelig,children:t.navn},t.kode)),className:P.bredde}),p&&n.jsx(D,{name:"arsakskode",control:v,label:u.formatMessage({id:"Messages.Årsak"}),validate:[j],selectValues:N.map(t=>n.jsx("option",{value:t.kode,children:t.navn},t.kode)),className:P.bredde}),Se(m,o)&&n.jsx(me,{name:"fritekst",control:v,label:u.formatMessage({id:Be(m)}),validate:[j,p?Ve:qe,je,pe],maxLength:p?1e4:4e3,badges:[{type:"info",titleText:q}],parse:le}),T&&n.jsx(Ee,{}),n.jsxs(S,{justify:"space-between",children:[(!p||p&&o!==void 0)&&n.jsx(fe,{href:"#",onClick:A,onKeyDown:t=>t.key==="Enter"?A(t):null,children:n.jsx(f,{id:"Messages.Preview"})}),n.jsx(z,{size:"small",variant:"primary",loading:h.isSubmitting,disabled:h.isSubmitting||a,onClick:ye,children:n.jsx(f,{id:"Messages.Submit"})})]})]})})},Be=e=>e===l.INNHENTE_OPPLYSNINGER||e===l.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",Se=(e,r)=>e===l.INNHENTE_OPPLYSNINGER||e===l.FRITEKST||e===l.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===l.VARSEL_OM_TILBAKEKREVING||e===l.TBK_INNHENTE_OPPLYSNINGER||e===l.VARSEL_OM_REVURDERING&&r===y.ANNET,ce=(e,r)=>r===I.ENGANGSSTONAD?e.filter(s=>s.kode===y.BARN_IKKE_REGISTRERT_FOLKEREGISTER||s.kode===y.ANNET):r===I.SVANGERSKAPSPENGER?e.filter(s=>s.kode!==y.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&s.kode!==y.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Ke=e=>{const r={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...r,brevmalkode:l.VARSEL_OM_REVURDERING}:{...r}},_e=e=>{const r=e;return e.brevmalkode===l.VARSEL_OM_REVURDERING&&r.arsakskode!==y.ANNET&&(r.fritekst=" "),r};Q.__docgenInfo={description:`Messages
...
| 'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'`,elements:[{name:"literal",value:"'VEDTAKSBREV_PRODUSERES'"},{name:"literal",value:"'INGEN_VEDTAKSBREV'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_ANKE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_KLAGEBEHANDLING'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_BEHANDLING_ETTER_KLAGE'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_JUSTERING_AV_FERIEPENGER'"},{name:"literal",value:"'INGEN_VEDTAKSBREV_INGEN_KONSEKVENS_FOR_YTELSE'"}],required:!0}}]}}],raw:`Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean | null;
}>`}]},description:""}}};const Ie="_image_bs6d4_1",Ge="_modal_bs6d4_8",x={image:Ie,modal:Ge},X=({showModal:e,closeEvent:r})=>{const s=c();return n.jsx(O,{className:x.modal,open:e,"aria-label":s.formatMessage({id:"MessagesModal.description"}),onClose:r,children:n.jsx(O.Body,{children:n.jsxs(S,{justify:"space-between",align:"center",children:[n.jsxs(S,{gap:"2",align:"center",children:[n.jsx(he,{className:x.image,title:s.formatMessage({id:"MessagesModal.description"})}),n.jsx(Te,{size:"small",children:n.jsx(f,{id:"MessagesModal.text"})})]}),n.jsx(z,{size:"small",variant:"primary",onClick:r,autoFocus:!0,type:"button",children:n.jsx(f,{id:"MessagesModal.OK"})})]})})})};X.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Me=U($),Z=e=>n.jsx(H,{value:Me,children:n.jsx(X,{...e})});Z.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Fe=e=>e.behandlingPåVent?e.fristBehandlingPåVent:null,De=({fagsakData:e,valgtBehandlingUuid:r,meldingFormData:s,setMeldingFormData:g,hentOgSettBehandling:k,toggleVisUtvidetBehandlingDetaljerKnapp:a})=>{const i=c(),[b,T]=G.useState(!1),[u,d]=G.useState(!1),m=te(),E=e.getFagsak(),o=F(e.getBehandling(r)),N=Y(o),h=oe(de()),{innloggetBruker:{kanVeilede:v}}=F(h.data),A=L("Venteårsak")||[],q=L("RevurderingVarslingÅrsak"),{mutateAsync:p,status:t}=B({mutationFn:V=>N.sendMelding(V)}),ee=Oe(d,p,k,T,g,o),ne=()=>{m("/")},re=Pe(o),ae=()=>(d(!1),k()),K=t==="success",_=o.behandlingTillatteOperasjoner,w=!v&&e.getAlleBehandlinger().some(V=>!V.avsluttet)&&_?.behandlingKanSendeMelding;return n.jsxs(n.Fragment,{children:[u&&n.jsx(Z,{showModal:K&&u,closeEvent:ae}),n.jsx(Ae,{tekst:i.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:a,children:n.jsxs(J,{gap:"4",children:[!w&&n.jsx(ie,{variant:"info",children:n.jsx(f,{id:Le(v,_?.behandlingKanSendeMelding)})}),w&&n.jsx(W,{submitCallback:ee,behandling:o,forhåndsvisBrev:re,revurderingVarslingArsak:q,fagsakYtelseType:E.fagsakYtelseType,kanVeilede:v,meldingFormData:s,setMeldingFormData:g,brukerManglerAdresse:E.brukerManglerAdresse})]})}),K&&b&&n.jsx(Re,{lukkCallback:ne,ventearsak:be.AVV_DOK,ventearsaker:A,frist:Fe(o)})]})},Oe=(e,r,s,g,k,a)=>i=>{const b=i.brevmalkode===l.INNHENTE_OPPLYSNINGER||i.brevmalkode===l.VARSEL_OM_REVURDERING||i.brevmalkode===l.ETTERLYS_INNTEKTSMELDING,T=R.TILBAKEKREVING===a.type||R.TILBAKEKREVING_REVURDERING===a.type;e(!b);const u=T?{behandlingUuid:a.uuid,fritekst:i.fritekst,brevmalkode:i.brevmalkode}:{behandlingUuid:a.uuid,brevmalkode:i.brevmalkode,fritekst:i.fritekst,arsakskode:i.arsakskode};return r(u).then(()=>{k(),b?g(!0):s()})},Le=(e,r)=>r?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Pe=e=>{const r=Y(e),{mutate:s}=B({mutationFn:a=>r.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:a.brevmalkode,fritekst:a.fritekst||" ",arsakskode:a.arsakskode}),onSuccess:a=>{M(a)}}),{mutate:g}=B({mutationFn:a=>ue(e.uuid,a.brevmalkode,a.fritekst??" "),onSuccess:a=>{M(a)}}),k=R.TILBAKEKREVING===e.type||R.TILBAKEKREVING_REVURDERING===e.type;return a=>{k?g(a):s(a)}};De.__docgenInfo={description:`MeldingIndex
