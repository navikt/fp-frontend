import{j as e,k as j,P as h,l as R}from"./iframe-CV_Hmyy8.js";import{a as K,u as w,n as S}from"./fagsakApi-BvggaIfg.js";import{u as O,N as f,A as b,p as M,e as V}from"./index.es-CfPZNWz1.js";import{r as P}from"./index.es-TTvnTWWZ.js";import{T as i}from"./Table-eaOxWgCj.js";import{M as k}from"./message-BCcn_Hah.js";import{V as B,B as g,H as m,b as U}from"./VStack-Bv5rBkCi.js";import{S as N}from"./ExclamationmarkTriangleFill-DQjkigbG.js";import{p as H}from"./paths-CoJHJN6e.js";import{a as x}from"./index-DYnG7e5j.js";const T=({fagsaker:r,selectFagsakCallback:n,alleKodeverk:t})=>e.jsxs(i,{children:[e.jsx(i.Header,{children:e.jsxs(i.Row,{children:[e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(k,{id:"FagsakList.Saksnummer"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(k,{id:"FagsakList.Sakstype"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(k,{id:"FagsakList.Status"})})]})}),e.jsx(i.Body,{children:r.map(a=>e.jsxs(i.Row,{onMouseDown:()=>n(a.saksnummer),onKeyDown:()=>n(a.saksnummer),children:[e.jsx(i.DataCell,{children:a.saksnummer}),e.jsx(i.DataCell,{children:t.FagsakYtelseType.find(s=>s.kode===a.fagsakYtelseType)?.navn??""}),e.jsx(i.DataCell,{children:t.FagsakStatus.find(s=>s.kode===a.status)?.navn??""})]},a.saksnummer))})]});T.__docgenInfo={description:`FagsakList
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const E="_container_74un9_1",Y="_advarselIcon_74un9_6",p={container:E,advarselIcon:Y},I=(r,n)=>!!(r||n===void 0||n.length<1),q=({searchStarted:r,searchResultAccessDenied:n,searchFagsakCallback:t})=>{const a=j(),s=O({defaultValues:{searchString:""}}),l=s.watch("searchString");return e.jsx(f,{formMethods:s,onSubmit:t,className:p.container,children:e.jsxs(B,{gap:"2",children:[e.jsx(g,{size:"small",children:e.jsx(k,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(m,{gap:"2",align:"end",children:[e.jsx(b,{name:"searchString",control:s.control,label:a.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[M]}),e.jsx(U,{variant:"primary",size:"small",loading:r,disabled:I(r,l),children:e.jsx(k,{id:"Search.Search"})})]}),n&&e.jsxs(m,{gap:"2",align:"end",children:[e.jsx(N,{className:p.advarselIcon}),e.jsx(g,{size:"small",children:e.jsx(k,{id:n.feilmelding})})]})]})})};q.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const G="_container_gwama_1",D="_label_gwama_9",v={container:G,label:D},A=({fagsaker:r,searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:a,searchStarted:s,searchResultAccessDenied:l,alleKodeverk:d})=>e.jsxs("div",{className:v.container,children:[e.jsx(q,{searchFagsakCallback:n,searchStarted:s,searchResultAccessDenied:l}),t&&r.length===0&&e.jsx(g,{size:"small",className:v.label,children:e.jsx(k,{id:"FagsakSearch.ZeroSearchResults"})}),t&&r.length>1&&e.jsx(T,{fagsaker:r,selectFagsakCallback:a,alleKodeverk:d})]});A.__docgenInfo={description:`FagsakSearch
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const C=()=>{const{kodeverkOptions:r,søkFagsak:n}=K(),{data:t}=w(r()),a=R(),s=u=>{u&&a(H(u))},{mutate:l,data:d=[],status:y,error:o}=V({mutationFn:u=>n(u.searchString),onSuccess:u=>{u.length===1&&s(u[0]?.saksnummer)}}),F=o&&o instanceof x&&o.response.status===403&&"data"in o.response?o.response.data:void 0;return e.jsx(c,{fagsaker:d,searchFagsakCallback:l,searchResultReceived:y==="success",selectFagsakCallback:s,searchStarted:y==="pending",searchResultAccessDenied:F,alleKodeverk:S(t)})};C.__docgenInfo={description:`FagsakSearchIndex
