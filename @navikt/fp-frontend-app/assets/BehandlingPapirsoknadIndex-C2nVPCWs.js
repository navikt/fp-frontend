...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  språkkode?: string;
}`,signature:{properties:[{key:"språkkode",value:{name:"string",required:!1}}]},alias:"SprakFormValues"}}],returns:null}],displayName:"SprakPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const qe="egenVirksomhet",P=`${qe}.virksomheter`,yt="_orgNrBredde_cby8r_1",ft={orgNrBredde:yt},ct=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),Mr=({index:r,readOnly:n,alleKodeverk:a})=>{const t=h(),s=a[K.LANDKODER].slice().sort((o,l)=>o.navn.localeCompare(l.navn)),{getValues:i}=A();return e.jsx(I,{name:`${P}.${r}.virksomhetRegistrertINorge`,label:e.jsx(m,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(B,{marginTop:8,children:e.jsx(D,{name:`${P}.${r}.organisasjonsnummer`,readOnly:n,validate:[p,je,Sa],label:e.jsx(m,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(B,{alignOffset:58,marginTop:8,children:e.jsxs(R,{gap:"4",children:[e.jsx(Y,{name:`${P}.${r}.landJobberFra`,className:ft.landBredde,selectValues:ct(s),validate:[p],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(C,{gap:"4",children:[e.jsx(b,{isReadOnly:n,validate:[p,F,_e],name:`${P}.${r}.fom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(b,{isReadOnly:n,validate:[F,o=>{const l=i(`${P}.${r}.fom`);return l?_a(l,o):null}],name:`${P}.${r}.tom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};Mr.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:s})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:s}:{landJobberFra:"NOR"}});Mr.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const bt="_inntektBredde_1xgnj_1",Rt={inntektBredde:bt},Ft=({readOnly:r,index:n})=>[{value:"harVarigEndring",label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.HarVarigEndring"}),element:e.jsx(B,{marginTop:8,children:e.jsx(b,{name:`${P}.${n}.varigEndringGjeldendeFom`,isReadOnly:r,validate:[F,p],label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})},{value:"erNyoppstartet",label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.ErNyoppstartet"})},{value:"erNyIArbeidslivet",label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.NyIArbeidslivet"}),element:e.jsx(B,{marginTop:8,children:e.jsx(b,{name:`${P}.${n}.nyIArbeidslivetFom`,isReadOnly:r,validate:[F,p],label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})}],xr=({readOnly:r,index:n})=>e.jsx(I,{name:`${P}.${n}.varigEndretEllerStartetSisteFireAr`,label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.NewlyStartedOrChanged"}),readOnly:r,trueContent:e.jsx(B,{marginTop:8,children:e.jsxs(R,{gap:"4",children:[e.jsx(ce,{size:"small",children:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.Reason"})}),e.jsx(nn,{validate:[p],name:`${P}.${n}.varigEndretEllerStartetSisteFireArArsak`,checkboxes:Ft({readOnly:r,index:n})}),e.jsx(Yn,{name:`${P}.${n}.beskrivelseAvEndring`,label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.VirksomhetEndretBeskrivelse"}),validate:[tn]}),e.jsx(D,{name:`${P}.${n}.inntekt`,label:e.jsx(m,{id:"Registrering.VirksomhetStartetPanel.Inntekt"}),readOnly:r,validate:[je,p],className:Rt.inntektBredde,parse:a=>{const t=parseInt(a.toString(),10);return Number.isNaN(t)?a:t}})]})})});xr.transformValues=({varigEndretEllerStartetSisteFireAr:r,varigEndretEllerStartetSisteFireArArsak:n,varigEndringGjeldendeFom:a,nyIArbeidslivetFom:t,beskrivelseAvEndring:s,inntekt:i})=>{const o=n.includes("harVarigEndring"),l=n.includes("erNyoppstartet"),g=n.includes("erNyIArbeidslivet");return{varigEndretEllerStartetSisteFireAr:r,...r?{harVarigEndring:o,...o?{varigEndringGjeldendeFom:a}:{},erNyoppstartet:l,erNyIArbeidslivet:g,...g?{nyIArbeidslivetFom:t}:{},beskrivelseAvEndring:s,inntekt:i}:{}}};xr.__docgenInfo={description:`VirksomhetStartetEndretPanel
...
papirsøknad dersom søknad gjelder foreldrepenger og saksbehandler skal legge til ny virksomhet for søker.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  beskrivelseAvEndring?: string;
  inntekt?: number;
}`,signature:{properties:[{key:"varigEndretEllerStartetSisteFireAr",value:{name:"boolean",required:!1}},{key:"varigEndretEllerStartetSisteFireArArsak",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"varigEndringGjeldendeFom",value:{name:"string",required:!1}},{key:"nyIArbeidslivetFom",value:{name:"string",required:!1}},{key:"beskrivelseAvEndring",value:{name:"string",required:!1}},{key:"inntekt",value:{name:"number",required:!1}}]},alias:"StartedEndretFormValues"}}],returns:null}],displayName:"VirksomhetStartetEndretPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const Rn={[oe.DAGMAMMA]:1,[oe.FISKE]:2,[oe.JORDBRUK_ELLER_SKOGBRUK]:3,[oe.ANNEN]:4},At=(r,n)=>r>n?1:r<n?-1:0,qt=r=>r[K.VIRKSOMHET_TYPE].filter(n=>n.kode!==oe.FRILANSER).sort((n,a)=>At(Rn[n.kode],Rn[a.kode])).map(n=>({value:n.kode,label:n.navn})),Kr=({readOnly:r,alleKodeverk:n,index:a})=>e.jsx(nn,{label:e.jsx(m,{id:"Registrering.VirksomhetNaeringTypePanel.Title"}),name:`${P}.${a}.typeVirksomhet`,validate:[p],checkboxes:qt(n),isReadOnly:r});Kr.transformValues=({typeVirksomhet:r})=>({typeVirksomhet:{ANNEN:r.includes(oe.ANNEN),FISKE:r.includes(oe.FISKE),DAGMAMMA:r.includes(oe.DAGMAMMA),JORDBRUK_SKOGBRUK:r.includes(oe.JORDBRUK_ELLER_SKOGBRUK)}});Kr.__docgenInfo={description:`VirksomhetTypeNaringPanel
...
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const jt=N(O),pe=({readOnly:r,alleKodeverk:n})=>e.jsx(X,{value:jt,children:e.jsx(He,{readOnly:r,alleKodeverk:n})});pe.initialValues=He.initialValues;pe.transformValues=He.transformValues;pe.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [EGEN_VIRKSOMHET_NAME_PREFIX]: VirksomhetSubFormValues;
}`,signature:{properties:[{key:"egenVirksomhet",value:{name:"signature",type:"object",raw:`{
  harArbeidetIEgenVirksomhet?: boolean;
  virksomheter: RegistrerVirksomhetFormValues[];
...
Viser inputfelter for dato for bestemmelse av perioder med permijon.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Nt=Ma(9),jr=`${j}.${Oe}`,W=r=>`${jr}.${r}`,jn=r=>()=>{const a=(r(`${jr}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Me(a):void 0},Tn=(r,n,a)=>()=>{const t=r(`${W(n)}.periodeFom`),s=r(`${W(n)}.periodeTom`);return!s||!t?null:a?U(s)(t):x(t)(s)},Vt=(r,n)=>a=>r(`${W(n)}.arbeidskategoriType`)===fe.ARBEIDSTAKER?p(a):void 0,Pt=r=>{if(r)return r.length===11?Hn(r):Nt(r)},En={periodeFom:"",periodeTom:"",periodeForGradering:"",prosentandelArbeid:"",skalGraderes:!1},It=[fe.ARBEIDSTAKER,fe.SELVSTENDIG_NAERINGSDRIVENDE,fe.FRILANSER],hn=gr(100),Ot=r=>r.filter(({kode:n})=>gn.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),St=r=>r.filter(({kode:n})=>It.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),ta=({graderingKvoter:r,readOnly:n,arbeidskategoriTyper:a})=>{const t=h(),{watch:s,control:i,getValues:o,trigger:l,formState:{isSubmitted:g}}=A(),{fields:u,remove:k,append:d}=z({control:i,name:`${jr}`}),y=s(`${jr}`)||[];return q.useEffect(()=>{u.length===0&&d(En)},[]),e.jsx(se,{fields:u,emptyPeriodTemplate:En,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,remove:k,append:d,children:(v,f)=>{const{harSamtidigUttak:c,periodeFom:S}=y[f],_=S&&E(S,ge).isBefore(E("2019-01-01"));return e.jsxs(be,{readOnly:n,remove:k,index:f,children:[e.jsx(Y,{name:`${W(f)}.periodeForGradering`,selectValues:Ot(r),label:t.formatMessage({id:"Registrering.Permisjon.Gradering.Periode"}),validate:[p]}),e.jsx(b,{label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),name:`${W(f)}.periodeFom`,validate:[p,F,Tn(o,f,!0),jn(o)],onChange:()=>g?l():void 0}),e.jsx(b,{label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),name:`${W(f)}.periodeTom`,validate:[p,F,Tn(o,f,!1),jn(o)],onChange:()=>g?l():void 0}),e.jsx(D,{label:e.jsx(m,{id:"Registrering.Permisjon.Gradering.Prosentandel"}),name:`${W(f)}.prosentandelArbeid`,validate:[p,Zr,hn],normalizeOnBlur:Ze=>Number.isNaN(Ze)?Ze:parseFloat(Ze.toString()).toFixed(2)}),e.jsx(D,{label:t.formatMessage({id:"Registrering.Permisjon.Orgnr"}),name:`${W(f)}.arbeidsgiverIdentifikator`,validate:[Vt(o,f),je,Pt]}),e.jsx(Y,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${W(f)}.arbeidskategoriType`,selectValues:St(a),validate:[p],onChange:()=>g?l():void 0}),e.jsx(Q,{name:`${W(f)}.skalGraderes`,label:e.jsx(m,{id:"Registrering.Permisjon.Gradering.SkalGraderes"})}),e.jsx(Q,{readOnly:n,name:`${W(f)}.flerbarnsdager`,label:e.jsx(m,{id:"Registrering.Permisjon.Flerbarnsdager"})}),e.jsx(Q,{name:`${W(f)}.harSamtidigUttak`,label:e.jsx(m,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),c&&e.jsx(D,{name:`${W(f)}.samtidigUttaksprosent`,validate:[p,Zr,hn],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"})}),_&&e.jsx(Nr,{size:"small",variant:"warning",children:e.jsx(m,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},v.id)}})};ta.__docgenInfo={description:`RenderGraderingPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const un=`${j}.${ln}`,Re=r=>`${un}.${r}`,wn=r=>()=>{const a=(r(`${un}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Me(a):void 0},Nn={periodeFom:"",periodeTom:"",årsak:""},_t=[pr.UTTAK_MØDREKVOTE_ANNEN_FORELDER,pr.UTTAK_FEDREKVOTE_ANNEN_FORELDER,pr.UTTAK_FELLESP_ANNEN_FORELDER,pr.UTTAK_FORELDREPENGER_ANNEN_FORELDER],Mt=r=>r.filter(({kode:n})=>_t.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),sa=({oppholdsReasons:r,readOnly:n})=>{const a=h(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:o}}=A(),{fields:l,remove:g,append:u}=z({control:t,name:`${un}`});return q.useEffect(()=>{l.length===0&&u(Nn)},[]),e.jsx(se,{fields:l,emptyPeriodTemplate:Nn,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,append:u,remove:g,children:(k,d)=>e.jsxs(be,{readOnly:n,remove:g,index:d,children:[e.jsx(b,{name:`${Re(d)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,F,()=>{const y=s(`${Re(d)}.periodeFom`),v=s(`${Re(d)}.periodeTom`);return v&&y?U(v)(y):null},wn(s)],onChange:()=>o?i():void 0}),e.jsx(b,{name:`${Re(d)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,F,()=>{const y=s(`${Re(d)}.periodeFom`),v=s(`${Re(d)}.periodeTom`);return v&&y?x(y)(v):null},wn(s)],onChange:()=>o?i():void 0}),e.jsx("div",{children:e.jsx(Y,{name:`${Re(d)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:Mt(r),validate:[p]})})]},k.id)})};sa.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Dt=(r,n,a)=>n===dr.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?r.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):n===dr.SYKDOM_ANNEN_FORELDER?r.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):a,xt=(r,n,a,t)=>r.filter(({kode:s})=>a||s!==dr.ALENEOMSORG&&s!==dr.IKKE_RETT_ANNEN_FORELDER).map(({kode:s,navn:i})=>n?e.jsx("option",{value:s,children:i},s):e.jsx("option",{value:s,children:Dt(t,s,i)},s)),Hr=({foreldreType:r,alleKodeverk:n,readOnly:a,erEndringssøknad:t})=>{const s=h(),i=n[K.OVERFOERING_AARSAK_TYPE],o=xt(i,r===Te.MOR,t,s),{watch:l}=A(),g=l(`${j}.skalOvertaKvote`)||!1;return e.jsxs(R,{gap:"2",children:[e.jsx(ce,{children:e.jsx(m,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),e.jsx(Q,{readOnly:a,name:`${j}.skalOvertaKvote`,label:e.jsx(m,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),g&&e.jsx(ia,{selectValues:o,readOnly:a})]})};Hr.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});Hr.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const In={periodeFom:"",periodeTom:"",arsakForUtsettelse:""},oa=`${j}.${Gr}`,Ae=r=>`${oa}.${r}`,On=r=>()=>{const a=(r(`${oa}`)||[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Me(a):void 0},Sn=(r,n,a)=>()=>{const t=`${Ae(n)}`,s=r(`${t}.periodeFom`),i=r(`${t}.periodeTom`);return!i&&!s?null:a?U(i)(s):x(s)(i)},Kt=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),Lt=r=>r.filter(({kode:n})=>gn.some(a=>a===n)).map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),la=({utsettelseReasons:r,utsettelseKvoter:n,readOnly:a})=>{const t=h(),{control:s,getValues:i,trigger:o,formState:{isSubmitted:l}}=A(),{fields:g,remove:u,append:k}=z({control:s,name:`${j}.${Gr}`});q.useEffect(()=>{g.length===0&&k(In)},[]);const d=q.useCallback(()=>l?o():void 0,[l,o]);return e.jsx(se,{fields:g,emptyPeriodTemplate:In,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:a,append:k,remove:u,children:(y,v)=>e.jsxs(be,{readOnly:a,remove:u,index:v,children:[e.jsx(Y,{name:`${Ae(v)}.periodeForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Periode"}),selectValues:Lt(n),validate:[p]}),e.jsx(b,{name:`${Ae(v)}.periodeFom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,F,Sn(i,v,!0),On(i)],onChange:d}),e.jsx(b,{name:`${Ae(v)}.periodeTom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,F,Sn(i,v,!1),On(i)],onChange:d}),e.jsx(Y,{name:`${Ae(v)}.arsakForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Arsak"}),selectValues:Kt(r),validate:[p],onChange:d}),e.jsx(Y,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${Ae(v)}.erArbeidstaker`,selectValues:[e.jsx("option",{value:"true",children:t.formatMessage({id:"Registrering.Permisjon.ErArbeidstaker"})},"true"),e.jsx("option",{value:"false",children:t.formatMessage({id:"Registrering.Permisjon.ErIkkeArbeidstaker"})},"false")],validate:[f=>i(`${Ae(v)}.arsakForUtsettelse`)==="ARBEID"?p(f):void 0]})]},y.id)})};la.__docgenInfo={description:`RenderUtsettelsePeriodeFieldArray
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Gt=N(O),ze=({foreldreType:r,readOnly:n,alleKodeverk:a,erEndringssøknad:t})=>e.jsx(X,{value:Gt,children:e.jsx(Xe,{readOnly:n,foreldreType:r,alleKodeverk:a,erEndringssøknad:t})});ze.transformValues=Xe.transformValues;ze.initialValues=Xe.initialValues;ze.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
