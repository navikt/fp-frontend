import{j as m}from"./jsx-runtime-D_zvdyIk.js";import{r as t}from"./index-DjhIdADd.js";import{u as v}from"./index.es-Cya7j3zS.js";import{A as y}from"./aksjonspunktCodes-BLM-Fgv6.js";import{i as p}from"./aksjonspunktStatus-xM4O_ZUY.js";import"./withPanelData-BSfUHwIs.js";import{K as b}from"./alleKodeverk-Dm9joGL5.js";import{S as q}from"./SettPaVentModalIndex-CCxBAdqa.js";import{u as h}from"./behandlingApi-_VsH7i31.js";const f=({behandling:e,kodeverk:s,opneSokeside:l,erTilbakekreving:i=!1,skalIkkeViseModal:r=!1})=>{const[u,a]=t.useState(!r&&e.behandlingPåVent),o=()=>a(!1),d=h(e),{mutate:g}=v({mutationFn:n=>d.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>l()});t.useEffect(()=>{r||a(e.behandlingPåVent)},[e.versjon,r]);const k=e.aksjonspunkt.filter(n=>p(n.status)).some(n=>n.definisjon===y.AUTO_MANUELT_SATT_PÅ_VENT);return m.jsx(q,{submitCallback:g,cancelEvent:o,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:k,ventearsaker:s[b.VENT_AARSAK],erTilbakekreving:i,showModal:u})};f.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
