...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Jn=({fagsakData:e,valgtBehandlingUuid:n,beslutterFormData:t,setBeslutterFormData:s,toggleVisUtvidetBehandlingDetaljerKnapp:i})=>{const u=U(),[p,v]=V.useState(!1),[k,f]=V.useState(!1),o=e.getFagsak(),g=$(e.getBehandling(n)),q=he(g),m=fe(),d=qe(),b=Ee(Re()),{brukernavn:E,kanVeilede:j}=$(b.data).innloggetBruker,h=Qe(g.type),{mutate:y}=Pe({mutationFn:S=>q.lagreTotrinnsaksjonspunkt(S)}),A=Xe(g),O=()=>{A(!1,{behandlingUuid:g.uuid,fagsakYtelseType:o.fagsakYtelseType,gjelderVedtak:!0})};if(!g.totrinnskontrollÅrsaker)return null;const I=S=>{const be={behandlingUuid:g.uuid,behandlingVersjon:g.versjon,bekreftedeAksjonspunktDtoer:[S.fatterVedtakAksjonspunktDto]};f(S.erAlleAksjonspunktGodkjent),v(!0),y(be)},N=g.status===_.FATTER_VEDTAK;return r.jsxs(r.Fragment,{children:[r.jsx(We,{tekst:u.formatMessage({id:N?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),toggleVisUtvidetBehandlingDetaljerKnapp:i,children:r.jsx(me,{behandling:g,location:m,readOnly:E===g.ansvarligSaksbehandler||j,onSubmit:I,forhandsvisVedtaksbrev:O,fagsakYtelseType:o.fagsakYtelseType,alleKodeverk:h,createLocationForSkjermlenke:ze,beslutterFormData:t,setBeslutterFormData:s})}),p&&r.jsx(ye,{behandling:g,pushLocation:d,allAksjonspunktApproved:k})]})};Jn.__docgenInfo={description:`TotrinnskontrollIndex
