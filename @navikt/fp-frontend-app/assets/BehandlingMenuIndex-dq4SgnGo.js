...
Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},gaaTilSokeside:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Ba="_container_1awdg_1",Ea="_image_1awdg_5",Ra="_modal_1awdg_11",wa="_label_1awdg_15",Sa="_button_1awdg_19",Pa="_cancelButton_1awdg_25",Va="_typeBredde_1awdg_29",Na="_arsakBredde_1awdg_33",ce={container:Ba,image:Ea,modal:Ra,label:wa,button:Sa,cancelButton:Pa,typeBredde:Va,arsakBredde:Na},Ka=(e,r)=>{const a=r.some(n=>n.kode===e.kode);return s.jsx("option",{value:e.kode,disabled:!a,children:` ${e.navn} `},e.kode)},Oa=[h.ANNET,h.FEIL_I_LOVANDVENDELSE,h.FEIL_ELLER_ENDRET_FAKTA,h.FEIL_REGELVERKSFORSTAELSE,h.FEIL_PROSESSUELL],Ma=[h.BEREEGNINGSGRUNNLAG,h.MEDLEMSKAP,h.OPPTJENING,h.FORDELING,h.INNTEKT,h.DØD,h.SØKERS_RELASJON,h.SØKNADSFRIST,h.KLAGE_U_INNTK,h.KLAGE_M_INNTK],Fa=[h.KLAGE_U_INNTK,h.KLAGE_M_INNTK,h.RE_ENDRET_INNTEKTSMELDING,h.RE_ENDRING_FRA_BRUKER,h.FØDSEL,h.DØD,h.ANNET,h.INNTEKT],Ia=[h.RE_FORELDELSE,h.RE_VILKÅR,h.RE_KLAGE_KA,h.RE_KLAGE_NFP,h.RE_FEILUTBETALT_BELØP_REDUSERT],_a=(e,r,a,n)=>{if(n===v.TILBAKEKREVING_REVURDERING)return Ia.flatMap(t=>{const i=a.find(u=>u.kode===t);return i?[i]:[]});if(n===v.REVURDERING){const t=e===le.FORELDREPENGER,i=e===le.SVANGERSKAPSPENGER;let u=t?Ma:Oa;return i&&(u=Fa),r.filter(l=>u.some(o=>o===l.kode)).sort((l,o)=>l.navn.localeCompare(o.navn))}return[]},xa=e=>[...e].sort((r,a)=>r.navn.localeCompare(a.navn)),Ha=(e,r,a={kanBehandlingOpprettes:!1,kanRevurderingOpprettes:!1})=>e.filter(n=>n.kode===v.TILBAKEKREVING?a.kanBehandlingOpprettes:n.kode===v.TILBAKEKREVING_REVURDERING?a.kanRevurderingOpprettes:r.some(t=>t.behandlingType===n.kode&&t.kanOppretteBehandling)),fn=({submitCallback:e,cancelEvent:r,behandlingstyper:a,uuidForSistLukkede:n,ytelseType:t,behandlingOppretting:i,kanTilbakekrevingOpprettes:u,revurderingArsaker:l,tilbakekrevingRevurderingArsaker:o})=>{const d=ee(),y=ke(),m=A=>e({...A,eksternUuid:n,fagsakYtelseType:t}),p=y.watch("behandlingType"),k=xa(a),j=Ha(k,i,u),S=_a(t,l,o,p);return s.jsx(ye,{formMethods:y,onSubmit:m,children:s.jsxs(B,{className:ce.modal,open:!0,"aria-label":d.formatMessage({id:"MenyNyBehandlingIndex.ModalDescription"}),onClose:r,children:[s.jsx(B.Header,{children:s.jsx(de,{size:"small",children:s.jsx(R,{id:"MenyNyBehandlingIndex.OpprettNyForstegangsbehandling"})})}),s.jsxs(B.Body,{children:[s.jsx(ie,{name:"behandlingType",label:"",validate:[W],selectValues:k.map(A=>Ka(A,j)),className:ce.typeBredde}),s.jsx(Z,{sixteenPx:!0}),p===v.FORSTEGANGSSOKNAD&&s.jsxs(s.Fragment,{children:[s.jsx(Qn,{name:"nyBehandlingEtterKlage",label:d.formatMessage({id:"MenyNyBehandlingIndex.NyBehandlingEtterKlage"})}),s.jsx(Z,{sixteenPx:!0})]}),S.length>0&&s.jsx(ie,{name:"behandlingArsakType",label:"",hideLabel:!0,validate:[W],className:ce.arsakBredde,selectValues:S.map(A=>s.jsx("option",{value:A.kode,children:A.navn},A.kode))})]}),s.jsxs(B.Footer,{children:[s.jsx(F,{size:"small",variant:"primary",children:s.jsx(R,{id:"MenyNyBehandlingIndex.Ok"})}),s.jsx(F,{size:"small",variant:"secondary",onClick:r,type:"button",children:s.jsx(R,{id:"MenyNyBehandlingIndex.Avbryt"})})]})]})})};fn.__docgenInfo={description:`NyBehandlingModal
...
Ved å trykke på ok skal ny behandling(1.gangsbehandling) av sak opprettes.`,methods:[],displayName:"NyBehandlingModal",props:{ytelseType:{required:!0,tsType:{name:"string"},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},erTilbakekreving:{required:!0,tsType:{name:"boolean"},description:""}}};const An=({behandling:e,setBehandling:r,lukkModal:a})=>{const n=Ve(e,r);return s.jsx(dn,{apneBehandlingForEndringer:n.åpneForEndringer,lukkModal:a})};An.__docgenInfo={description:"",methods:[],displayName:"ApneForEndringerMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Bn=({behandling:e,hentOgSettBehandling:r,lukkModal:a})=>{const n=V(Se()),t=Ne(e),{mutate:i}=ne({mutationFn:u=>t.endreBehandlendeEnhet({...u,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>r()});return s.jsx(un,{behandlingVersjon:e.versjon,behandlendeEnhetId:e.behandlendeEnhetId,behandlendeEnhetNavn:e.behandlendeEnhetNavn,nyBehandlendeEnhet:i,behandlendeEnheter:x(n.data).behandlendeEnheter,lukkModal:a})};Bn.__docgenInfo={description:"",methods:[],displayName:"EndreBehandlendeEnhetMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]},description:""},fagsakYtelseType:{required:!0,tsType:{name:"string"},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const $a=e=>{const{setIsRequestPending:r}=er(),{onBehandlingSuccess:a}=nr(e),{mutate:n}=ne({mutationFn:async t=>{const i=t.isTilbakekreving?await Cn(t.params):await $n(t.params);return rr(i,r)},onSuccess:a});return{lagNyBehandling:n}},Ya=[v.FORSTEGANGSSOKNAD,v.KLAGE,v.REVURDERING,v.DOKUMENTINNSYN,v.TILBAKEKREVING,v.TILBAKEKREVING_REVURDERING],za=(e=[])=>{const r=e.find(a=>a.gjeldendeVedtak&&a.status===sr.AVSLUTTET&&(a.type===v.FORSTEGANGSSOKNAD||a.type===v.REVURDERING));return r?r.uuid:void 0},wn=({fagsakData:e,behandlingUuid:r,lukkModal:a})=>{const n=e.getFagsak(),t=e.getAlleBehandlinger(),i=e.getBehandling(r),u=za(t),l=ir().includes(ue.FPTILBAKE),o=ge(),{data:d}=V(o.kodeverkOptions()),{data:y}=V(o.fptilbake.kodeverkOptions()),m=V(Se()),{innloggetBruker:p}=x(m.data),k=l&&!p.kanVeilede&&u!==void 0,{data:j=!1}=V(o.fptilbake.kanTilbakekrevingOpprettesOptions(k,n.saksnummer,u)),S=(i==null?void 0:i.type)===v.TILBAKEKREVING||(i==null?void 0:i.type)===v.TILBAKEKREVING_REVURDERING,A=l&&!p.kanVeilede&&S&&!!r,{data:N=!1}=V(o.fptilbake.kanTilbakekrevingRevurderingOpprettesOptions(A,r)),b=new Ie(i==null?void 0:i.type).medFpSakKodeverk(x(d)).medFpTilbakeKodeverk(x(y)),K=we(),q=ze(),E=_=>{const C=Qe(n.saksnummer,_==null?void 0:_.uuid);K(Je({...q,pathname:C}))},{lagNyBehandling:H}=$a(E);return s.jsx(cn,{saksnummer:n.saksnummer,behandlingUuid:i==null?void 0:i.uuid,uuidForSistLukkede:u,behandlingOppretting:e.getBehandlingOppretting(),kanTilbakekrevingOpprettes:{kanBehandlingOpprettes:j,kanRevurderingOpprettes:N},behandlingstyper:b.getKodeverkForBehandlingstyper(Ya,Q.BEHANDLING_TYPE),tilbakekrevingRevurderingArsaker:b.getKodeverkForBehandlingstype(Q.BEHANDLING_AARSAK,v.TILBAKEKREVING_REVURDERING),revurderingArsaker:b.getKodeverkForBehandlingstype(Q.BEHANDLING_AARSAK,v.REVURDERING),ytelseType:n.fagsakYtelseType,lagNyBehandling:H,lukkModal:a})};wn.__docgenInfo={description:"",methods:[],displayName:"NyBehandlingMenyModal",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},behandlingUuid:{required:!1,tsType:{name:"string"},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Sn=({behandling:e,hentOgSettBehandling:r,lukkModal:a})=>{const n=ge(),t=Ne(e),{data:i}=V(n.kodeverkOptions()),{data:u}=V(n.fptilbake.kodeverkOptions()),{mutate:l}=ne({mutationFn:d=>t.settBehandlingPåVent({frist:d.frist,ventearsak:d.ventearsak,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>r()}),o=new Ie(e.type).medFpSakKodeverk(x(i)).medFpTilbakeKodeverk(x(u));return s.jsx(Tn,{settBehandlingPaVent:l,ventearsaker:o.getKodeverkForValgtBehandling(Q.VENT_AARSAK),lukkModal:a,erTilbakekreving:e.type===v.TILBAKEKREVING||e.type===v.TILBAKEKREVING_REVURDERING})};Sn.__docgenInfo={description:"",methods:[],displayName:"SettPaVentMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Pn=({behandling:e,setBehandling:r,lukkModal:a})=>{const n=Ve(e,r);return s.jsx(sn,{behandlingVersjon:e.versjon,taBehandlingAvVent:n.gjenopptaBehandling,lukkModal:a})};Pn.__docgenInfo={description:"",methods:[],displayName:"TaAvVentMenyModal",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Vn=({fagsak:e,behandlingAppKontekst:r,behandling:a,setBehandling:n,lukkModal:t})=>{var y;const i=(y=r.behandlingTillatteOperasjoner)==null?void 0:y.vergeBehandlingsmeny,u=we(),l=ze(),o=()=>{u(Je({...l,pathname:Qe(e.saksnummer,a.uuid)}))},d=Ve(a,m=>{n(m),o()});return s.jsx(tn,{fjernVerge:oe.FJERN===i?d.fjernVerge:void 0,opprettVerge:oe.OPPRETT===i?d.opprettVerge:void 0,lukkModal:t})};Vn.__docgenInfo={description:"",methods:[],displayName:"VergeMenyModal",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Wa=({fagsakData:e,behandlingUuid:r,behandling:a,setBehandling:n,hentOgSettBehandling:t})=>{const i=V(Se()),{innloggetBruker:u}=x(i.data),[l,o]=g.useState(),d=()=>o(void 0),y=e.getFagsak(),m=e.getBehandling(r),p=Qa(m,y);return u.kanVeilede?null:s.jsxs(s.Fragment,{children:[s.jsxs(Y,{children:[s.jsx(F,{size:"small",as:Y.Toggle,iconPosition:"right",variant:"secondary",icon:s.jsx(zn,{"aria-hidden":!0}),children:s.jsx(R,{id:"BehandlingMenuIndex.Behandlingsmeny"})}),s.jsx(Y.Menu,{children:s.jsx(Y.Menu.List,{children:Object.keys(p).filter(k=>!p[k].disabled).map(k=>s.jsx(Y.Menu.List.Item,{onClick:()=>{o(k)},children:p[k].text},k))})})]}),l==="NY_BEHANDLING"&&s.jsx(wn,{fagsakData:e,behandlingUuid:r,lukkModal:d}),l==="ENDRE_FAGSAK_MARKERING"&&s.jsx(En,{saksnummer:y.saksnummer,fagsakMarkeringer:y.fagsakMarkeringer,hentOgSettBehandling:t,lukkModal:d}),l==="VERGE"&&m&&a&&s.jsx(Vn,{fagsak:y,behandlingAppKontekst:m,behandling:a,setBehandling:n,lukkModal:d}),l==="ÅPNE_FOR_ENDRINGER"&&a&&s.jsx(An,{behandling:a,setBehandling:n,lukkModal:d}),l==="ENDRE_BEHANDLENDE_ENHET"&&a&&s.jsx(Bn,{behandling:a,hentOgSettBehandling:t,lukkModal:d}),l==="HENLEGG"&&m&&a&&s.jsx(Rn,{behandlingAppKontekst:m,behandling:a,fagsakYtelseType:y.fagsakYtelseType,lukkModal:d}),l==="SETT_PÅ_VENT"&&a&&s.jsx(Sn,{behandling:a,hentOgSettBehandling:t,lukkModal:d}),l==="TA_AV_VENT"&&a&&s.jsx(Pn,{behandling:a,setBehandling:n,lukkModal:d})]})},Qa=(e,r)=>{const a=e?e.behandlingPaaVent:!1,n=e==null?void 0:e.behandlingTillatteOperasjoner,t=n==null?void 0:n.vergeBehandlingsmeny,i=t===oe.FJERN&&!!(e!=null&&e.uuid)&&!!(e!=null&&e.versjon),u=t===oe.OPPRETT&&!!(e!=null&&e.uuid)&&!!(e!=null&&e.versjon);return{TA_AV_VENT:{disabled:!(n!=null&&n.behandlingKanGjenopptas),text:Jr()},SETT_PÅ_VENT:{disabled:!(n!=null&&n.behandlingKanSettesPaVent),text:Ca()},HENLEGG:{disabled:!(n!=null&&n.behandlingKanHenlegges),text:Aa()},ENDRE_BEHANDLENDE_ENHET:{disabled:!(n!=null&&n.behandlingKanBytteEnhet),text:na()},ÅPNE_FOR_ENDRINGER:{disabled:!(n!=null&&n.behandlingKanOpnesForEndringer),text:aa()},NY_BEHANDLING:{disabled:r.sakSkalTilInfotrygd,text:Ga()},ENDRE_FAGSAK_MARKERING:{disabled:r.sakSkalTilInfotrygd,text:la()},VERGE:{disabled:!(!a&&(u||i)),text:Qr(u)}}};Wa.__docgenInfo={description:"",methods:[],displayName:"BehandlingMenuIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},behandlingUuid:{required:!1,tsType:{name:"string"},description:""},behandling:{required:!1,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};export{ue as A,Wa as B,ir as u};
