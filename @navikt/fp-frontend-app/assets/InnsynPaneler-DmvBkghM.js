...
Readonly<{
  ...
  status?: string;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApentAksjonspunkt",value:{name:"boolean",required:!1}},{key:"status",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const hn="_checkboxCol_vtbic_1",jn="_linkCol_vtbic_5",Tn="_image_vtbic_9",cn="_noDocuments_vtbic_15",An="_hidden_vtbic_19",wn="_table_vtbic_23",O={checkboxCol:hn,linkCol:jn,image:Tn,noDocuments:cn,hidden:An,table:wn},Rn=["DocumentListVedtakInnsyn.Dokument"],ke=({documents:n,saksNr:t})=>n.length===0?e.jsx(w,{size:"small",className:O.noDocuments,children:e.jsx(g,{id:"DocumentListVedtakInnsyn.NoDocuments"})}):e.jsxs(e.Fragment,{children:[e.jsx(fe,{className:O.noDocuments,children:e.jsx(g,{id:"DocumentListVedtakInnsyn.InnsynsDok"})}),e.jsx(re,{noHover:!0,headerTextCodes:Rn,children:n.map(r=>{const a=parseInt(r.dokumentId,10);return e.jsx(ae,{id:a,children:e.jsx(A,{className:O.linkCol,children:e.jsx("a",{href:Q(t,r.journalpostId,r.dokumentId),className:"lenke lenke--frittstaende",target:"_blank",rel:"noopener noreferrer",children:r.tittel})})},a)})})]});ke.__docgenInfo={description:`DocumentListVedtakInnsyn
