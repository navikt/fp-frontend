import{j as e,i as g,P as v,b as y,L as p}from"./iframe-Bdpl6UO-.js";import{Q as q}from"./index.es-DecM86qy.js";import{u as N,r as A}from"./fagsakApi-BsBFK8zm.js";import{V as f}from"./VisittkortSakIndex-BssOH9Aa.js";import{V as c,a as w,B as R}from"./VStack-CKEMSKDT.js";import{M as d}from"./message-B7OHQXvh.js";import{E}from"./IngenBehandlingValgtPanel-DSn_P3t7.js";import{u as P}from"./useTrackRouteParam-CtXA3mmU.js";import{p as j}from"./paths-DJ7GNHbs.js";import{u as m}from"./useKodeverk-Fx61Bw_D.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(f,{bruker:n.person}),e.jsx(c,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(w,{size:"small",level:"2",children:e.jsx(d,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
  person: PersonDto;
