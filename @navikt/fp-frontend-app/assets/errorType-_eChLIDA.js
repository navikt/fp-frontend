import{r,j as E}from"./iframe-Bzjbb7SY.js";const a={errors:[]},o=r.createContext(a),u=r.createContext(void 0),T=({children:e,initialState:s})=>{const[n,t]=r.useReducer((p,i)=>{switch(i.type){case"add":return{errors:p.errors.concat(i.data)};case"remove":return a;default:throw new Error}},s||a);return E.jsx(o.Provider,{value:n,children:E.jsx(u.Provider,{value:t,children:e})})},g=()=>{const e=r.useContext(u);return{addErrorMessage:t=>{e&&e({type:"add",data:t})},removeErrorMessages:()=>{e&&e({type:"remove"})}}},d=()=>r.useContext(o).errors;T.__docgenInfo={description:"Tilbyr kontekst for lagring av feilmeldinger.",methods:[],displayName:"RestApiErrorProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},initialState:{required:!1,tsType:{name:"signature",type:"object",raw:"{ errors: FpError[] }",signature:{properties:[{key:"errors",value:{name:"Array",elements:[{name:"union",raw:`| GeneralError
| PollingTimeoutError
