...
Presentasjonskomponent. Setter opp aksjonspunktet for avklaring av adopsjonsopplysninger i søknaden.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"soknad",optional:!1,type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}}}],displayName:"DokumentasjonFaktaForm"};const Ir="_container_1gzrs_1",xr="_hr_1gzrs_6",en={container:Ir,hr:xr},re=({readOnly:n,ektefellesBarnIsEdited:r=!1,alleMerknaderFraBeslutter:a})=>{const t=T();return e.jsx(O,{title:t.formatMessage({id:"EktefelleFaktaForm.ApplicationInformation"}),merknaderFraBeslutter:a[d.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN],children:e.jsxs("div",{className:en.container,children:[e.jsx(c,{size:"small",children:e.jsx(g,{id:"EktefelleFaktaForm.EktefellesBarn"})}),e.jsx(b,{twentyPx:!0}),e.jsx("hr",{className:en.hr}),e.jsx(Re,{name:"ektefellesBarn",hideLegend:!0,validate:[B],isReadOnly:n,isEdited:r,isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{label:t.formatMessage({id:"EktefelleFaktaForm.ErIkkeValg"}),value:"false"},{label:t.formatMessage({id:"EktefelleFaktaForm.ErValg"}),value:"true"}]})]})})};re.buildInitialValues=n=>({ektefellesBarn:n&&n.ektefellesBarn!==null?n.ektefellesBarn:void 0});re.transformValues=n=>({kode:d.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN,ektefellesBarn:n});re.__docgenInfo={description:`EktefelleFaktaForm
...
Presentasjonskomponent. Setter opp aksjonspunktet for vurdering av om mann adopterer alene.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"familiehendelse",optional:!1,type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}}}],displayName:"MannAdoptererAleneFaktaForm"};const Kr="_leftCol_6myh9_1",Ur="_rightCol_6myh9_6",Lr={leftCol:Kr,rightCol:Ur},{ADOPSJONSDOKUMENTAJON:Hr,OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE:ke,OM_ADOPSJON_GJELDER_EKTEFELLES_BARN:X}=d,Yr=[ke,Hr,X],Gr=n=>{const r=[e.jsx(g,{id:"AdopsjonInfoPanel.KontrollerMotDok"},"KontrollerMotDok")];return h(X,n)&&r.push(e.jsx(g,{id:"AdopsjonInfoPanel.VurderOmEktefellesBarn"},"VurderOmEktefellesBarn")),h(ke,n)&&r.push(e.jsx(g,{id:"AdopsjonInfoPanel.VurderOmMannAdoptererAlene"},"VurderOmMannAdoptererAlene")),r},zr=(n,r,a)=>{const t=a.filter(i=>Yr.some(l=>l===i.definisjon));let s={};h(ke,t)&&(s=ae.buildInitialValues(r));let o={};return h(X,t)&&(o=re.buildInitialValues(r)),{...ne.buildInitialValues(n,r),...o,...s,..._.initialValues(t[0])}},$r=(n,r)=>{const a=[];return a.push(ne.transformValues(n)),h(X,r)&&n.ektefellesBarn!==void 0&&a.push(re.transformValues(n.ektefellesBarn)),h(ke,r)&&n.mannAdoptererAlene!==void 0&&a.push(ae.transformValues(n.mannAdoptererAlene)),a.map(t=>({...t,begrunnelse:n.begrunnelse}))},Cr=(n,r)=>he(n,r),qn=({submittable:n,isForeldrepengerFagsak:r,soknad:a,gjeldendeFamiliehendelse:t})=>{const{alleKodeverk:s,submitCallback:o,aksjonspunkterForPanel:i,harÅpneAksjonspunkter:l,alleMerknaderFraBeslutter:u,isReadOnly:m}=z(),{formData:k,setFormData:y}=W(),p=$({defaultValues:k||zr(a,t,i)}),q=p.watch("begrunnelse"),v=Cr(a,t),f=F=>o($r(F,i));return e.jsxs(e.Fragment,{children:[l&&e.jsx(ce,{children:Gr(i)}),e.jsxs(C,{formMethods:p,onSubmit:f,setDataOnUnmount:y,children:[e.jsx(b,{eightPx:!0}),e.jsxs(Q,{gap:"4",wrap:!0,children:[e.jsx("div",{className:Lr.leftCol,children:e.jsx(ne,{readOnly:m,editedStatus:v,erForeldrepengerFagsak:r,alleMerknaderFraBeslutter:u,hasEktefellesBarnAksjonspunkt:h(X,i)})}),h(X,i)&&e.jsx(re,{readOnly:m,alleMerknaderFraBeslutter:u,ektefellesBarnIsEdited:v.ektefellesBarn}),h(ke,i)&&e.jsx(ae,{farSokerType:a.farSokerType,readOnly:m,mannAdoptererAlene:v.mannAdoptererAlene,alleMerknaderFraBeslutter:u,alleKodeverk:s})]}),i&&i.length>0&&e.jsxs(e.Fragment,{children:[e.jsx(b,{twentyPx:!0}),e.jsx(_,{isSubmittable:n,isReadOnly:m,hasBegrunnelse:!!q}),e.jsx(b,{twentyPx:!0}),e.jsx(Le,{isSubmittable:n,isReadOnly:m,isSubmitting:p.formState.isSubmitting,isDirty:p.formState.isDirty})]})]})]})};qn.__docgenInfo={description:`AdopsjonInfoPanel
...
Har ansvar for å sette opp formen for faktapenelet til Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonInfoPanel",props:{submittable:{required:!0,tsType:{name:"boolean"},description:""},isForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  gjeldende: FamilieHendelse;
  register: FamilieHendelse;
}>`},description:""},isForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const Qr=[d.OM_SOKER_ER_MANN_SOM_ADOPTERER_ALENE,d.ADOPSJONSDOKUMENTAJON,d.OM_ADOPSJON_GJELDER_EKTEFELLES_BARN],Xr=n=>{const r=He(Qr),{behandling:a,fagsak:t}=w.use(ue),s=Ae(a),{data:o}=N(s.familiehendelseOptions(a)),{data:i}=N(s.søknadOptions(a));return e.jsx(Ye,{...n,standardPanelProps:r,faktaPanelKode:Ge.ADOPSJONSVILKARET,faktaPanelMenyTekst:T().formatMessage({id:"FaktaInitPanel.Title.Adopsjon"}),skalPanelVisesIMeny:a.vilkår.some(l=>dr.some(u=>u===l.vilkarType)),children:o&&i?e.jsx(Fn,{familiehendelse:o,soknad:i,isForeldrepengerFagsak:t.fagsakYtelseType===yn.FORELDREPENGER,submittable:r.submittable}):e.jsx(je,{})})};Xr.__docgenInfo={description:"",methods:[],displayName:"AdopsjonsvilkaretFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},registrerFaktaPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FaktaPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Zr="_colMargin_1r8hu_1",Fe={colMargin:Zr},ye=n=>n?x(n,Te).format(Se):"-",ea=(n,r,a,t)=>n&&Object.keys(r).length>0?ye(Object.values(r)[0]):t?ye(t):n?a?ye(a):"-":null,cn=({soknad:n,termindato:r})=>{const a=n.fodselsdatoer?n.fodselsdatoer:{},t=Object.keys(a).length>0?"FodselsammenligningPanel.Fodselsdato":"FodselsammenligningPanel.Termindato",s=Object.keys(a).length>0?"FodselSammenligningOtherPanel.OpplysningerISoknad":"FodselSammenligningOtherPanel.TerminISoknad",o=w.useMemo(()=>ea(!!n,a,n.termindato,r),[n,a,r]);return e.jsxs(e.Fragment,{children:[e.jsx(de,{size:"small",children:e.jsx(g,{id:s})}),e.jsx(b,{sixteenPx:!0}),e.jsx(be,{children:e.jsxs(fe,{children:[n.utstedtdato&&e.jsxs(K,{className:Fe.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"FodselsammenligningPanel.UstedtDato"})}),e.jsx(c,{size:"small",children:ye(n.utstedtdato)})]}),e.jsxs(K,{className:Fe.colMargin,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:t})}),e.jsx(c,{size:"small",children:o})]}),e.jsxs(K,{children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"FodselsammenligningPanel.AntallBarn"})}),e.jsx(c,{size:"small",children:n.antallBarn})]})]})})]})};cn.__docgenInfo={description:`FodselSammenligningOtherPanel
...
Setter opp aksjonspunktet for avklaring av termindato (Fødselsvilkåret).`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"soknad",optional:!1,type:null},{name:"familiehendelse",optional:!1,type:null},{name:"aksjonspunkt",optional:!1,type:null}],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}}}],displayName:"TermindatoFaktaForm"};const{TERMINBEKREFTELSE:Me,SJEKK_MANGLENDE_FODSEL:Ke}=d,Ta=n=>{const r=[];return h(Me,n)&&r.push(e.jsx(g,{id:"FodselInfoPanel.KontrollerMotTerminbekreftelsen"},"KontrollerMotTerminbekreftelsen")),h(Ke,n)&&r.push(e.jsx(g,{id:"FodselInfoPanel.KontrollerMotFodselsdokumentasjon"},"KontrollerMotFodselsdokumentasjon")),r},Sa=(n,r,a,t)=>({...a?se.buildInitialValues(n,r.gjeldende,a):{},...t?te.buildInitialValues(n,r.gjeldende,t):{}}),Ra=(n,r,a,t)=>{const s=[];return a&&s.push(se.transformValues(n)),t&&s.push(te.transformValues(n,r)),s},Aa=[],Rn=({submittable:n,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,familiehendelse:s})=>{var P,M,j;const{submitCallback:o,behandling:i,aksjonspunkterForPanel:l,harÅpneAksjonspunkter:u,alleMerknaderFraBeslutter:m,isReadOnly:k}=z(),y=((P=s==null?void 0:s.register)==null?void 0:P.avklartBarn)||Aa,p=(M=s==null?void 0:s.gjeldende)==null?void 0:M.termindato,q=(j=s==null?void 0:s.gjeldende)==null?void 0:j.vedtaksDatoSomSvangerskapsuke,v=l.find(D=>D.definisjon===Me),f=l.find(D=>D.definisjon===Ke),{formData:F,setFormData:R}=W(),A=$({defaultValues:F||Sa(r,s,v,f)});return e.jsxs(e.Fragment,{children:[u&&e.jsx(ce,{children:Ta(l)}),e.jsx(b,{sixteenPx:!0}),e.jsxs(C,{formMethods:A,onSubmit:D=>o(Ra(D,y,v,f)),setDataOnUnmount:R,children:[h(Me,l)&&e.jsx(se,{readOnly:k,submittable:n,alleMerknaderFraBeslutter:m,soknad:r,gjeldendeFamiliehendelse:s.gjeldende}),h(Ke,l)&&e.jsx(te,{behandlingType:i.type,readOnly:k,submittable:n,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,alleMerknaderFraBeslutter:m,soknad:r,avklartBarn:y,familiehendelse:s}),l.length!==0&&!k&&e.jsxs(e.Fragment,{children:[e.jsx(b,{twentyPx:!0}),e.jsx(Le,{isSubmittable:n,isReadOnly:k,isSubmitting:A.formState.isSubmitting,isDirty:A.formState.isDirty})]}),l.length===0&&e.jsx(we,{behandlingsTypeKode:i.type,avklartBarn:y,termindato:p,vedtaksDatoSomSvangerskapsuke:q,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t})]})]})};Rn.__docgenInfo={description:`FodselInfoPanel
...
Har ansvar for å sette opp formen for faktapenelet til Fødselsvilkåret.`,methods:[],displayName:"FodselInfoPanel",props:{familiehendelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erOverstyrt?: boolean;
  foreldreansvarDato?: string;
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const ha=[d.TERMINBEKREFTELSE,d.SJEKK_MANGLENDE_FODSEL],wa=n=>{const r=T(),{behandling:a}=w.use(ue),t=He(ha),s=Ae(a),{data:o}=N(s.familiehendelseOptions(a)),{data:i}=N(s.søknadOptions(a)),{data:l}=N(s.familiehendelseOrigninalBehandlingOptions(a)),{data:u}=N(s.søknadOriginalBehandlingOptions(a));return e.jsx(Ye,{...n,standardPanelProps:t,faktaPanelKode:Ge.FODSELSVILKARET,faktaPanelMenyTekst:r.formatMessage({id:"FaktaInitPanel.Title.Fodsel"}),skalPanelVisesIMeny:a.vilkår.some(m=>ur.some(k=>k===m.vilkarType)),children:o&&i?e.jsx(An,{soknad:i,familiehendelse:o,familiehendelseOriginalBehandling:l,soknadOriginalBehandling:u,submittable:t.submittable}):e.jsx(je,{})})};wa.__docgenInfo={description:"",methods:[],displayName:"FodselvilkaretFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},registrerFaktaPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FaktaPanelMenyData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  tekst?: string;
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Dn=({intl:n,alleMerknaderFraBeslutter:r,soknad:a})=>{const{adopsjonFodelsedatoer:t}=a;return e.jsx(O,{title:n.formatMessage({id:"BarnPanel.BarnDetSøkesOm"}),merknaderFraBeslutter:r[d.OMSORGSOVERTAKELSE],children:t&&Object.keys(t).map(s=>e.jsxs(kn.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"BarnPanel.ChildNumberBornData",values:{childNumber:s}})}),e.jsx(c,{size:"small",children:x(t[parseInt(s,10)]).format(Se)}),e.jsx(b,{eightPx:!0})]},`${s}`))})};Dn.__docgenInfo={description:`BarnPanel
...
Viser barn fra søknad`,methods:[],displayName:"BarnPanel",props:{alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""},soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  adopsjonFodelsedatoer?: Record<number, string>;
  farSokerType?: string;
}>`},description:""}}};const tn=({aktoerId:n,navn:r,kjønn:a,adresser:t,dødsdato:s})=>{const o=Je(t,We.POSTADRESSE),i=Je(t,We.BOSTEDSADRESSE);return{aktorId:n,navn:r,dodsdato:s,adresse:o||i,erMor:a===yr.KVINNE}},Bn=({intl:n,personoversikt:r,alleMerknaderFraBeslutter:a})=>{const t=w.useMemo(()=>{const s=[tn(r.bruker)];return r.annenPart&&s.push(tn(r.annenPart)),s},[r]);return e.jsx(O,{title:n.formatMessage({id:"ForeldrePanel.Foreldre"}),merknaderFraBeslutter:a[d.OMSORGSOVERTAKELSE],children:e.jsx(le,{gap:"8",children:t.map(s=>e.jsxs(le,{gap:"2",children:[e.jsx(de,{size:"small",children:s.navn}),e.jsx(S,{size:"small",children:e.jsx(g,{id:"ForeldrePanel.Address"})}),e.jsx(c,{size:"small",children:s.adresse&&!s.dodsdato?ir(s.adresse):"-"}),s.dodsdato&&e.jsxs(e.Fragment,{children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"ForeldrePanel.DeathDate"})}),e.jsx(c,{size:"small",children:e.jsx(Ue,{dateString:s.dodsdato})})]})]},`${s.aktorId}`))})})};Bn.__docgenInfo={description:`ForeldrePanel
...
Presentasjonskomponent. Brukes i tilknytning til faktapanel for omsorg.`,methods:[],displayName:"ForeldrePanel",props:{personoversikt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  omsorgsovertakelseDato?: string;
  foreldreansvarDato?: string;
}`,signature:{properties:[{key:"omsorgsovertakelseDato",value:{name:"string",required:!1}},{key:"foreldreansvarDato",value:{name:"string",required:!1}}]}}}}],displayName:"OmsorgsovertakelseFaktaPanel"};const Pa="_iverksatt_tqzwn_1",Oa="_wrapper_tqzwn_5",sn={iverksatt:Pa,wrapper:Oa},on=n=>n.tilgrensendeYtelserListe.filter(r=>r.statusNavn!=="Åpen"),Pe=({alleMerknaderFraBeslutter:n})=>{const r=T(),{watch:a}=Z(),t=a("farSokerType"),s=a("ytelser");return e.jsxs(O,{title:r.formatMessage({id:"OmsorgOgForeldreansvarFaktaForm.Rettighet"}),merknaderFraBeslutter:n[d.OMSORGSOVERTAKELSE],children:[e.jsx(c,{size:"small",children:t||"-"}),e.jsx(b,{sixteenPx:!0}),e.jsxs(O,{withoutBorder:!0,title:r.formatMessage({id:"OmsorgOgForeldreansvarFaktaForm.AndreYtelseTilMor"}),children:[s.map(o=>on(o).map(i=>e.jsx("div",{className:sn.wrapper,children:e.jsxs(c,{size:"small",className:sn.iverksatt,children:[e.jsx(g,{id:"OmsorgOgForeldreansvarFaktaForm.YtelseIverksatt",values:{ytelseType:o.relatertYtelseNavn}}),e.jsx(Ue,{dateString:i.periodeFraDato})]})},`${o.relatertYtelseNavn}-${i.periodeFraDato}`))),!s.some(o=>on(o).length>0)&&"-"]})]})};Pe.buildInitialValues=(n,r,a)=>({ytelser:r,farSokerType:n.farSokerType?a(n.farSokerType,J.FAR_SOEKER_TYPE):void 0});Pe.__docgenInfo={description:"RettighetFaktaPanel",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"soknad",optional:!1,type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  soknadType: string;
  mottattDato: string;
  begrunnelseForSenInnsending: string | undefined;
  antallBarn: number;
...
RettighetFormValues & {
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}]}}}],displayName:"OmsorgOgForeldreansvarFaktaForm"};const _a=(n,r)=>({...oe.transformValues(n,r),..._.transformValues(n)}),Ma=(n,r,a,t,s)=>{const o=t.find(i=>i.definisjon===d.OMSORGSOVERTAKELSE||i.definisjon===d.AVKLAR_VILKAR_FOR_FORELDREANSVAR);return{...oe.buildInitialValues(n,r,a,bn(s)),..._.initialValues(o)}},Ka=n=>n?[e.jsx(g,{id:"OmsorgOgForeldreansvarInfoPanel.CheckInformationForeldreansvar"},"CheckInformation")]:[e.jsx(g,{id:"OmsorgOgForeldreansvarInfoPanel.CheckInformationOmsorgsovertakelse"},"CheckInformation")],hn=({submittable:n,innvilgetRelatertTilgrensendeYtelserForAnnenForelder:r,soknad:a,gjeldendeFamiliehendelse:t,personoversikt:s})=>{const o=T(),{aksjonspunkterForPanel:i,alleMerknaderFraBeslutter:l,harÅpneAksjonspunkter:u,submitCallback:m,isReadOnly:k,alleKodeverk:y}=z(),p=$({defaultValues:Ma(a,t,r,i,y)}),q=p.watch("begrunnelse"),v=h(d.AVKLAR_VILKAR_FOR_FORELDREANSVAR,i);return e.jsx(C,{formMethods:p,onSubmit:f=>m(_a(f,i[0])),children:e.jsxs(le,{gap:"5",children:[!k&&u&&e.jsx(ce,{children:Ka(v)}),e.jsx(oe,{erAksjonspunktForeldreansvar:v,readOnly:k,vilkarTypes:y[J.OMSORGSOVERTAKELSE_VILKAR_TYPE],alleMerknaderFraBeslutter:l,soknad:a,gjeldendeFamiliehendelse:t,personoversikt:s}),e.jsx(_,{isSubmittable:n,isReadOnly:k,hasBegrunnelse:!!q,label:o.formatMessage({id:v?"OmsorgOgForeldreansvarInfoPanel.BegrunnelseTitleFp":"OmsorgOgForeldreansvarInfoPanel.BegrunnelseTitleEs"})}),e.jsx(Le,{isSubmittable:n,isSubmitting:p.formState.isSubmitting,isDirty:p.formState.isDirty,isReadOnly:k})]})})};hn.__docgenInfo={description:`OmsorgOgForeldreansvarInfoPanel
...
Har ansvar for å sette opp form for faktapenelet til Omsorgsvilkåret.`,methods:[],displayName:"OmsorgOgForeldreansvarInfoPanel",props:{soknad:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  relatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
  innvilgetRelatertTilgrensendeYtelserForAnnenForelder: RelatertTilgrensedYtelse[];
}>`},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const dn=[d.OMSORGSOVERTAKELSE,d.AVKLAR_VILKAR_FOR_FORELDREANSVAR],Ha=({personoversikt:n,...r})=>{const a=T(),t=He(dn),{behandling:s}=w.use(ue),o=Ae(s),{data:i}=N(o.søknadOptions(s)),{data:l}=N(o.familiehendelseOptions(s)),{data:u}=N(o.inntektArbeidYtelseOptions(s));return e.jsx(Ye,{...r,standardPanelProps:t,faktaPanelKode:Ge.OMSORGSVILKARET,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.OmsorgOgForeldreansvar"}),skalPanelVisesIMeny:dn.some(m=>h(m,s.aksjonspunkt)),children:i&&l&&u?e.jsx(wn,{soknad:i,familiehendelse:l,inntektArbeidYtelse:u,personoversikt:n,submittable:t.submittable}):e.jsx(je,{})})};Ha.__docgenInfo={description:"",methods:[],displayName:"OmsorgOgForeldreansvarFaktaInitPanel",props:{personoversikt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  bruker: PersonopplysningerBasis;
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}`,signature:{properties:[{key:"bruker",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Ya="_divider_16pq7_1",Ga="_image_16pq7_12",za="_labelColumn_16pq7_18",$a="_panelWrapper_16pq7_22",Ca="_varselRow_16pq7_28",Ja="_panel_16pq7_22",Wa="_flexContainer_16pq7_48",Qa="_warningRow_16pq7_67",un={divider:Ya,image:Ga,labelColumn:za,panelWrapper:$a,varselRow:Ca,panel:Ja,flexContainer:Wa,warningRow:Qa},gn=tr(3),Xa=sr(1e4),Za=n=>({kode:ge(n[0].definisjon,d.VARSEL_REVURDERING_ETTERKONTROLL,d.VARSEL_REVURDERING_MANUELL),begrunnelse:n[0].begrunnelse,sendVarsel:void 0}),_e=n=>n||{},et=[],Nn=({familiehendelse:n,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t,previewCallback:s})=>{const o=T(),{isReadOnly:i,alleKodeverk:l,behandling:u,submitCallback:m,aksjonspunkterForPanel:k}=z(),y=Za(k),{formData:p,setFormData:q}=W(),v=$({defaultValues:p||y}),f=v.watch(),[F,R]=w.useState(!1),A=w.useCallback(()=>R(!1),[R]),P=w.useCallback(()=>R(!0),[R]),M=ie=>{v.trigger().then(Oe=>{Oe&&m({...f,...ie}),R(!1)})},j=w.useCallback(ie=>{ie.preventDefault(),s({dokumentMal:br.VARSEL_OM_REVURDERING,arsakskode:fr.ANNET,fritekst:f.fritekst||" "})},[f.fritekst]),{avklartBarn:D}=_e(n.register),{termindato:U}=_e(n.gjeldende),{vedtaksDatoSomSvangerskapsuke:pe}=_e(n.gjeldende),_n=u.behandlingÅrsaker.reduce((ie,Oe)=>ie||Oe.erAutomatiskRevurdering,!1),Mn=l[J.VENT_AARSAK]||et,Kn=Cn(u.sprakkode);return e.jsxs(e.Fragment,{children:[e.jsxs(C,{formMethods:v,onSubmit:m,setDataOnUnmount:q,children:[e.jsx(de,{size:"small",children:e.jsx(g,{id:"VarselOmRevurderingForm.VarselOmRevurdering"})}),e.jsx(b,{eightPx:!0}),!i&&k[0].status===qe.OPPRETTET&&e.jsxs(e.Fragment,{children:[e.jsx(ce,{children:e.jsx(g,{id:"VarselOmRevurderingForm.VarselOmRevurderingVurder"})}),e.jsx(b,{twentyPx:!0}),_n&&e.jsxs(e.Fragment,{children:[e.jsx(we,{behandlingsTypeKode:u.type,avklartBarn:D,termindato:U,vedtaksDatoSomSvangerskapsuke:pe,soknad:r,soknadOriginalBehandling:a,familiehendelseOriginalBehandling:t}),e.jsx(b,{sixteenPx:!0})]}),e.jsx(Re,{name:"sendVarsel",validate:[B],isHorizontal:!0,isTrueOrFalseSelection:!0,radios:[{value:"true",label:o.formatMessage({id:"VarselOmRevurderingForm.SendVarsel"})},{value:"false",label:o.formatMessage({id:"VarselOmRevurderingForm.IkkeSendVarsel"})}]}),f.sendVarsel&&e.jsxs(e.Fragment,{children:[e.jsx(b,{sixteenPx:!0}),e.jsxs(vn,{children:[e.jsx($e,{badges:[{type:"info",titleText:Kn}],name:"fritekst",label:o.formatMessage({id:"VarselOmRevurderingForm.FritekstIBrev"}),validate:[B,gn,Xa,Ce],maxLength:1e4,parse:Jn}),e.jsx(b,{fourPx:!0}),e.jsx("a",{href:"",onClick:j,className:vr(un.previewLink,"lenke lenke--frittstaende"),children:e.jsx(g,{id:"VarselOmRevurderingForm.Preview"})})]})]}),e.jsx("div",{className:un.flexContainer,children:e.jsx($e,{name:"begrunnelse",label:o.formatMessage({id:"VarselOmRevurderingForm.BegrunnelseForSvar"}),validate:[B,gn,Ce]})}),e.jsx(b,{sixteenPx:!0}),e.jsx(Un,{variant:"primary",size:"small",onClick:f.sendVarsel?P:void 0,loading:v.formState.isSubmitting,disabled:v.formState.isSubmitting,type:f.sendVarsel?"button":"submit",children:e.jsx(g,{id:"VarselOmRevurderingForm.Bekreft"})})]}),(i||k[0].status!==qe.OPPRETTET)&&e.jsxs(e.Fragment,{children:[e.jsx(pn,{children:e.jsx(g,{id:"VarselOmRevurderingForm.Begrunnelse"})}),e.jsx(c,{size:"small",children:f.begrunnelse})]})]}),e.jsx(qr,{showModal:F,frist:x().add(28,"days").format(Te),cancelEvent:A,submitCallback:M,ventearsaker:Mn,visBrevErBestilt:!0,hasManualPaVent:!0,erTilbakekreving:u.type===ve.TILBAKEKREVING||u.type===ve.TILBAKEKREVING_REVURDERING})]})};Nn.__docgenInfo={description:`VarselOmRevurderingForm
...
Setter opp aksjonspunktet for avklaring av Adopsjonsvilkåret.`,methods:[],displayName:"AdopsjonVilkarForm",props:{status:{required:!0,tsType:{name:"string"},description:""},vilkar:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""}}};const ft=["1002","1003","1032"],qt=(n,r,a)=>({...V.buildInitialValues(n,r,a),...E.buildInitialValues(n)}),Ft=(n,r)=>({...V.transformValues(n),...E.transformValues(n),kode:ge(r[0].definisjon,d.AVKLAR_OM_STONAD_GJELDER_SAMME_BARN,d.AVKLAR_OM_STONAD_TIL_ANNEN_FORELDER_GJELDER_SAMME_BARN)}),ct=(n,r)=>n?r.filter(a=>!ft.includes(a.kode)):r,In=({readOnlySubmitButton:n,status:r,ytelseTypeKode:a,vilkar:t})=>{const s=T(),{behandling:o,alleKodeverk:i,aksjonspunkterForPanel:l,submitCallback:u,harÅpneAksjonspunkter:m,isReadOnly:k,alleMerknaderFraBeslutter:y}=z(),p=l.some(U=>{var pe;return(pe=y[U.definisjon])==null?void 0:pe.notAccepted}),q=qt(l,r,o.behandlingsresultat),{formData:v,setFormData:f}=W(),F=$({defaultValues:v||q}),R=i[J.AVSLAGSARSAK][I.FODSELSVILKARET_MOR],A=ct(a===yn.FORELDREPENGER,R),M=l.some(U=>U.status===qe.OPPRETTET)?void 0:Be.OPPFYLT===r,{lovReferanse:j}=t[0],D=(...U)=>e.jsx("b",{children:U});return e.jsx(C,{formMethods:F,onSubmit:U=>u(Ft(U,l)),setDataOnUnmount:f,children:e.jsxs(De,{title:s.formatMessage({id:"FodselVilkarForm.Fodsel"}),isAksjonspunktOpen:m,readOnlySubmitButton:n,readOnly:k,lovReferanse:j,originalErVilkarOk:M,erIkkeGodkjentAvBeslutter:p,isDirty:F.formState.isDirty,isSubmitting:F.formState.isSubmitting,children:[e.jsx(S,{size:"small",children:e.jsx(g,{id:"FodselVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(V,{avslagsarsaker:A,readOnly:k,customVilkarOppfyltText:e.jsx(g,{id:"FodselVilkarForm.Oppfylt"}),customVilkarIkkeOppfyltText:e.jsx(g,{id:"FodselVilkarForm.IkkeOppfylt",values:{b:D}})}),e.jsx(E,{useAllWidth:!0,readOnly:k})]})})};In.__docgenInfo={description:`FodselVilkarForm
