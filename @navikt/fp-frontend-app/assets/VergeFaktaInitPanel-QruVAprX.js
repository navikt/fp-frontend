...
`)+c+`return __p
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const zk=Un(yr),Zk=m=>{switch(m){case Ou.KVINNE:return Ua.female;case Ou.MANN:return Ua.male;default:return Ua.unknown}},vt=({rolle:m="BRUKER",alleKodeverk:h,harSammeAdresser:u,navn:w,kjønn:A,sivilstand:B,fødselsdato:j,dødsdato:$,adresser:D,showIcon:Q=!0})=>{var Z;const M=m==="BARN";return y.jsx(ht,{value:zk,children:y.jsx(ct,{background:"bg-subtle",padding:"4",borderRadius:"large","aria-label":w,children:y.jsxs(Xa,{gap:"1",children:[y.jsxs(Ha,{gap:"5",children:[Q&&y.jsx("div",{children:y.jsx(qk,{gender:Zk(A),isChild:M})}),y.jsxs("div",{children:[y.jsxs(Ha,{gap:"4",children:[y.jsx($u,{children:y.jsx(Be,{id:"PersonPanel.RolleOgNavn",values:{rolle:m,navn:w}})}),M&&j&&!$&&y.jsx($a,{children:y.jsx(Be,{id:"PersonPanel.Fodt",values:{dato:Fu(j)}})}),$&&y.jsx($a,{children:y.jsx(Be,{id:"PersonPanel.Dod",values:{dato:Fu($)}})})]}),!M&&B&&y.jsx(Ya,{"aria-label":"Sivilstand",children:(Z=h[yt.SIVILSTAND_TYPE].find(Pe=>Pe.kode===B))==null?void 0:Z.navn})]})]}),y.jsxs(Ya,{children:[m==="BARN"&&y.jsx(Be,{id:"PersonPanel.Beskrivelse.Barn",values:{rolle:m}}),m==="BRUKER"&&y.jsx(Be,{id:"PersonPanel.Beskrivelse.Bruker",values:{rolle:m}}),m==="ANNEN_PART"&&y.jsx(Be,{id:"PersonPanel.Beskrivelse.Annenpart",values:{rolle:m}})]}),y.jsx(el,{harSammeAdresser:u,adresser:D,adresseKodeverk:h[yt.ADRESSE_TYPE]})]})})})};vt.__docgenInfo={description:"",methods:[],displayName:"Personopplysninger",props:{rolle:{required:!1,tsType:{name:"union",raw:"'BARN' | 'BRUKER' | 'ANNEN_PART'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'BRUKER'"},{name:"literal",value:"'ANNEN_PART'"}]},description:"",defaultValue:{value:"'BRUKER'",computed:!1}},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
  ...
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}>`},description:""}}};const nl=({erPanelValgt:m,dataState:h,children:u})=>m?h!==zu.SUCCESS?y.jsx(ik,{}):u:null;nl.__docgenInfo={description:"",methods:[],displayName:"FaktaPanelWrapper",props:{erPanelValgt:{required:!0,tsType:{name:"boolean"},description:""},dataState:{required:!0,tsType:{name:"RestApiState"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactElement | null",elements:[{name:"ReactElement"},{name:"null"}]},description:""}}};const Jk="default",Qk=(m,h,u,w,A,B)=>{const[j,$]=Me.useState(!1);Me.useEffect(()=>{m({id:h})},[]);const D=w&&(B===h||A&&B===Jk),Q=sk(w);return Me.useEffect(()=>{w?m({id:h,tekst:u,erAktiv:D,harApneAksjonspunkter:A}):!w&&Q&&m({id:h}),$(D)},[Q,w,D,A]),w&&j},Uu="default",Wu="default",ec=(m,h,u,w,A,B)=>j=>{const D=(Array.isArray(j)?j:[j]).map(M=>({"@type":M.kode,...M})),Q={saksnummer:m.saksnummer,behandlingUuid:h.uuid,behandlingVersjon:h.versjon};if(D&&A&&B){if(D.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(B.includes(D[0].kode))return A({...Q,overstyrteAksjonspunktDtoer:D},!0).then(()=>u(Wu,Uu))}return w({...Q,bekreftedeAksjonspunktDtoer:D},!0).then(()=>u(Wu,Uu))},nc=(m,h=[])=>{const[u,w]=Me.useState(),A=Me.useContext(Bk);Me.useEffect(()=>{u&&w(void 0)},[A.behandling.versjon]);const{aksjonspunkt:B}=A.behandling,j=Me.useMemo(()=>B&&m?B.filter(M=>m.includes(M.definisjon)):[],[B,m]),$=xk(A.behandling,[],A.rettigheter,A.hasFetchError),D=Me.useMemo(()=>jk(A.behandling,j),[A.behandling.versjon,j]),Q=Me.useMemo(()=>ec(A.fagsak,A.behandling,A.oppdaterProsessStegOgFaktaPanelIUrl,A.lagreAksjonspunkter,A.lagreOverstyrteAksjonspunkter,h),[A.behandling.versjon,h]);return{behandling:A.behandling,submittable:!j.some(M=>Mu(M.status))||j.some(M=>M.kanLoses),harApneAksjonspunkter:j.some(M=>Mu(M.status)&&M.kanLoses),alleKodeverk:A.alleKodeverk,aksjonspunkter:j,readOnly:$,alleMerknaderFraBeslutter:D,submitCallback:Q,formData:u,setFormData:w}},rl=({valgtFaktaSteg:m,behandling:h,registrerFaktaPanel:u,panelEndepunkter:w=[],aksjonspunktKoder:A,overstyringApKoder:B,skalPanelVisesIMeny:j,renderPanel:$,faktaPanelKode:D,faktaPanelMenyTekst:Q})=>{const M=nc(A,B),Z=Qk(u,D,Q,j(),M.harApneAksjonspunkter,m),Pe=w.map(De=>({key:De})),{data:Ce,state:Ke}=wk.useMultipleRestApi(Pe,{updateTriggers:[Z,h==null?void 0:h.versjon],suspendRequest:!Z||Pe.length===0,isCachingOn:!0});return y.jsx(nl,{erPanelValgt:Z,dataState:Pe.length>0?Ke:zu.SUCCESS,children:$({...Ce,...M})})};rl.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{panelEndepunkter:{required:!1,tsType:{name:"Array",elements:[{name:"RestKey",elements:[{name:"any"},{name:"any"}],raw:"RestKey<any, any>"}],raw:"RestKey<any, any>[]"},description:"",defaultValue:{value:"[]",computed:!1}},aksjonspunktKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},overstyringApKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"signature",type:"function",raw:"() => boolean",signature:{arguments:[],return:{name:"boolean"}}},description:""},renderPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: PANEL_DATA & StandardFaktaPanelProps) => ReactElement",signature:{arguments:[{type:{name:"intersection",raw:"PANEL_DATA & StandardFaktaPanelProps",elements:[{name:"PANEL_DATA"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
Readonly<{
  ...
  erAktiv?: boolean;
  harApneAksjonspunkter?: boolean;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"tekst",value:{name:"string",required:!1}},{key:"erAktiv",value:{name:"boolean",required:!1}},{key:"harApneAksjonspunkter",value:{name:"boolean",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""}}};export{Yk as B,rl as F,Xk as P,Ik as T,oc as V,Zu as a,Wn as b,Kk as c,Vk as d,Dk as e,Ck as f,Pc as g,vt as h,Sc as i,Ju as j,Uk as k,Xu as s};
