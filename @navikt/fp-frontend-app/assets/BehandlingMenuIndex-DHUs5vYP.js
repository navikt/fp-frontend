...
Readonly<{
  ...
  vilkår: Vilkar[];
  alleUttaksperioderAvslått: boolean;
}>`}]},{name:"undefined"}]},name:"behandling"}],return:{name:"void"}}},description:""},lukkModal:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Wo=i=>Lu(i.behandling,"VERGE_FJERN_V2")||Lu(i.behandling,"VERGE_OPPRETT_V2")?m.jsx(Yo,{...i}):m.jsx(xc,{...i}),xc=({fagsak:i,behandlingAppKontekst:d,behandling:a,setBehandling:u,lukkModal:g})=>{var E;const f=(E=d.behandlingTillatteOperasjoner)==null?void 0:E.vergeBehandlingsmeny,h=Wi(),q=ro(),j=()=>{h(io({...q,pathname:ao(i.saksnummer,a.uuid)}))},R=Zi(a,S=>{u(S),j()});return m.jsx(mo,{fjernVerge:Zr.FJERN===f?R.fjernVergeV1:void 0,opprettVerge:Zr.OPPRETT===f?R.opprettVergeV1:void 0,lukkModal:g})},Yo=({behandlingAppKontekst:i,behandling:d,hentOgSettBehandling:a,lukkModal:u})=>{var I;const g=(I=i.behandlingTillatteOperasjoner)==null?void 0:I.vergeBehandlingsmeny,f=Ab(d.type),h=no(),q=()=>{a(),h.invalidateQueries({queryKey:[Di.FETCH_FAGSAK]}),h.invalidateQueries({queryKey:[Di.FETCH_FAGSAKDATA_FPTILBAKE]}),h.invalidateQueries({queryKey:[Uu.VERGE]}),h.invalidateQueries({queryKey:[Uu.VERGE_HENT]})},j=la(d),{mutate:R}=rr({mutationFn:j.verge.opprettVergeV2,onSuccess:q}),{mutate:E}=rr({mutationFn:j.verge.fjernVergeV2,onSuccess:q}),{data:S}=We(j.verge.hent(d));return m.jsx(qo,{type:Zr.OPPRETT===g?"OPPRETT":"FJERN",verge:S,opprettVerge:R,fjernVerge:E,lukkModal:u,alleKodeverk:f})};Wo.__docgenInfo={description:"",methods:[],displayName:"VergeMenyModal",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
