...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
  alleKodeverk: AlleKodeverk;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const b="default",A="default",C=(t,a,e,s,n,i)=>r=>{const l=(Array.isArray(r)?r:[r]).map(k=>({"@type":k.kode,...k})),o={saksnummer:t.saksnummer,behandlingUuid:a.uuid,behandlingVersjon:a.versjon};if(l&&n&&i){if(l.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(l[0].kode))return n({...o,overstyrteAksjonspunktDtoer:l}).then(()=>e(A,b))}return s({...o,bekreftedeAksjonspunktDtoer:l}).then(()=>e(A,b))},W=(t,a=[])=>{const{behandling:e,rettigheter:s,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:d,alleKodeverk:l}=g.use(p),{aksjonspunkt:o}=e,k=o&&t?o.filter(m=>t.includes(m.definisjon)):[],j=D(e,[],s,!1),R=M(e.status,k),E=C(n,e,d,i,r,a);return{behandling:e,submittable:!k.some(m=>v(m.status))||k.some(m=>m.kanLoses),harApneAksjonspunkter:k.some(m=>v(m.status)&&m.kanLoses),alleKodeverk:l,aksjonspunkter:k,readOnly:j,alleMerknaderFraBeslutter:R,submitCallback:E}},X=[S.AVKLAR_VERGE],Q=()=>{const t=T(),a=W(X),{behandling:e}=g.use(p),s=O(e),n=_(e,"VERGE"),{data:i,isFetching:r}=B(s.vergeOptions(e,n));return u.jsx(q,{standardPanelProps:a,faktaPanelKode:h.VERGE,faktaPanelMenyTekst:t.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?u.jsx(c,{}):u.jsx(V,{verge:i,alleKodeverk:a.alleKodeverk,submittable:a.submittable})})};Q.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{q as F,Q as V,H as a,W as u};
