...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Wn=({fagsakData:e,valgtBehandlingUuid:r,beslutterFormData:t,setBeslutterFormData:s})=>{const i=C(),[g,m]=V.useState(!1),[p,d]=V.useState(!1),b=e.getFagsak(),o=$(e.getBehandling(r)),A=Ke(o),f=he(),k=Ee(),u=Oe(Ne()),{brukernavn:y,kanVeilede:E}=$(u.data).innloggetBruker,T=Xe(o.type),{mutate:q}=He({mutationFn:R=>A.lagreTotrinnsaksjonspunkt(R)}),v=Qe(o),j=()=>{v(!1,{behandlingUuid:o.uuid,fagsakYtelseType:b.fagsakYtelseType,gjelderVedtak:!0})};if(!o.totrinnskontrollÅrsaker)return null;const O=R=>{const Te={behandlingUuid:o.uuid,behandlingVersjon:o.versjon,bekreftedeAksjonspunktDtoer:[R.fatterVedtakAksjonspunktDto]};d(R.erAlleAksjonspunktGodkjent),m(!0),q(Te)},P=o.status===L.FATTER_VEDTAK;return n.jsxs(n.Fragment,{children:[n.jsxs(Ze,{tekst:i.formatMessage({id:P?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),children:[n.jsx(K,{sixteenPx:!0}),n.jsx(pe,{behandling:o,location:f,readOnly:y===o.ansvarligSaksbehandler||E,onSubmit:O,forhandsvisVedtaksbrev:j,fagsakYtelseType:b.fagsakYtelseType,alleKodeverk:T,createLocationForSkjermlenke:ze,beslutterFormData:t,setBeslutterFormData:s})]}),g&&n.jsx(be,{behandling:o,pushLocation:k,allAksjonspunktApproved:p})]})};Wn.__docgenInfo={description:`TotrinnskontrollIndex

Ansvarlig for att rita opp vilkår og aksjonspunkter med toTrinnskontroll`,methods:[],displayName:"TotrinnskontrollIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},beslutterFormData:{required:!1,tsType:{name:"any"},description:""},setBeslutterFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data?: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};export{U as K,en as S,Wn as T};
