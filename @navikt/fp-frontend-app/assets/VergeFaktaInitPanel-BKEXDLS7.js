...
`;else if(Il.test(T))throw new P($);c=(d?c.replace(hl,""):c).replace(bl,"$1").replace(_l,"$1;"),c="function("+(T||"obj")+`) {
`+(T?"":`obj || (obj = {});
`)+"var __t, __p = ''"+(o?", __e = _.escape":"")+(d?`, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
`:`;
`)+c+`return __p
}`;var F=Pu(function(){return C(s,A+"return "+c).apply(u,l)});if(F.source=c,Ea(F))throw F;return F}function up(e){return K(e).toLowerCase()}function lp(e){return K(e).toUpperCase()}function op(e,n,r){if(e=K(e),e&&(r||n===u))return Mi(e);if(!e||!(n=ce(n)))return e;var t=Fe(e),a=Fe(n),s=Ci(t,a),l=Ki(t,a)+1;return mn(t,s,l).join("")}function gp(e,n,r){if(e=K(e),e&&(r||n===u))return e.slice(0,Vi(e)+1);if(!e||!(n=ce(n)))return e;var t=Fe(e),a=Ki(t,Fe(n))+1;return mn(t,0,a).join("")}function dp(e,n,r){if(e=K(e),e&&(r||n===u))return e.replace(Et,"");if(!e||!(n=ce(n)))return e;var t=Fe(e),a=Ci(t,Fe(n));return mn(t,a).join("")}function fp(e,n){var r=tl,t=al;if(Y(n)){var a="separator"in n?n.separator:a;r="length"in n?E(n.length):r,t="omission"in n?ce(n.omission):t}e=K(e);var s=e.length;if(Nn(e)){var l=Fe(e);s=l.length}if(r>=s)return e;var o=r-In(t);if(o<1)return t;var d=l?mn(l,0,o).join(""):e.slice(0,o);if(a===u)return d+t;if(l&&(o+=d.length-o),Fa(a)){if(e.slice(o).search(a)){var p,k=d;for(a.global||(a=zt(a.source,K(si.exec(a))+"g")),a.lastIndex=0;p=a.exec(k);)var c=p.index;d=d.slice(0,c===u?o:c)}}else if(e.indexOf(ce(a),o)!=o){var h=d.lastIndexOf(a);h>-1&&(d=d.slice(0,h))}return d+t}function vp(e){return e=K(e),e&&Al.test(e)?e.replace(ti,Do):e}var mp=Vn(function(e,n,r){return e+(r?" ":"")+n.toUpperCase()}),La=Bs("toUpperCase");function ju(e,n,r){return e=K(e),n=r?u:n,n===u?Lo(e)?Wo(e):xo(e):e.match(n)||[]}var Pu=N(function(e,n){try{return pe(e,u,n)}catch(r){return Ea(r)?r:new P(r)}}),pp=en(function(e,n){return Ae(n,function(r){r=$e(r),Je(e,r,Ba(e[r],e))}),e});function kp(e){var n=e==null?0:e.length,r=w();return e=n?H(e,function(t){if(typeof t[1]!="function")throw new qe(j);return[r(t[0]),t[1]]}):[],N(function(t){for(var a=-1;++a<n;){var s=e[a];if(pe(s[0],this,t))return pe(s[1],this,t)}})}function cp(e){return Dg(Te(e,Z))}function Oa(e){return function(){return e}}function yp(e,n){return e==null||e!==e?n:e}var hp=Es(),bp=Es(!0);function me(e){return e}function Ma(e){return ls(typeof e=="function"?e:Te(e,Z))}function _p(e){return gs(Te(e,Z))}function Ap(e,n){return ds(e,Te(n,Z))}var qp=N(function(e,n){return function(r){return or(r,e,n)}}),wp=N(function(e,n){return function(r){return or(e,r,n)}});function Ca(e,n,r){var t=re(n),a=Hr(n,t);r==null&&!(Y(n)&&(a.length||!t.length))&&(r=n,n=e,e=this,a=Hr(n,re(n)));var s=!(Y(r)&&"chain"in r)||!!r.chain,l=rn(e);return Ae(a,function(o){var d=n[o];e[o]=d,l&&(e.prototype[o]=function(){var p=this.__chain__;if(s||p){var k=e(this.__wrapped__),c=k.__actions__=de(this.__actions__);return c.push({func:d,args:arguments,thisArg:e}),k.__chain__=p,k}return d.apply(e,ln([this.value()],arguments))})}),e}function Tp(){return te._===this&&(te._=Zo),this}function Ka(){}function Rp(e){return e=E(e),N(function(n){return fs(n,e)})}var xp=ca(H),jp=ca(Fi),Pp=ca(Vt);function Bu(e){return wa(e)?Ut($e(e)):ad(e)}function Bp(e){return function(n){return e==null?u:qn(e,n)}}var Sp=Ns(),Ep=Ns(!0);function Da(){return[]}function Va(){return!1}function Fp(){return{}}function Np(){return""}function Ip(){return!0}function Lp(e,n){if(e=E(e),e<1||e>sn)return[];var r=We,t=ie(e,We);n=w(n),e-=We;for(var a=Ht(t,n);++r<e;)n(r);return a}function Op(e){return B(e)?H(e,$e):ye(e)?[e]:de(Zs(K(e)))}function Mp(e){var n=++Yo;return K(e)+n}var Cp=Jr(function(e,n){return e+n},0),Kp=ya("ceil"),Dp=Jr(function(e,n){return e/n},1),Vp=ya("floor");function Up(e){return e&&e.length?Gr(e,me,ta):u}function Wp(e,n){return e&&e.length?Gr(e,w(n,2),ta):u}function Gp(e){return Li(e,me)}function Hp(e,n){return Li(e,w(n,2))}function $p(e){return e&&e.length?Gr(e,me,ua):u}function Yp(e,n){return e&&e.length?Gr(e,w(n,2),ua):u}var zp=Jr(function(e,n){return e*n},1),Zp=ya("round"),Xp=Jr(function(e,n){return e-n},0);function Jp(e){return e&&e.length?Gt(e,me):0}function Qp(e,n){return e&&e.length?Gt(e,w(n,2)):0}return i.after=_v,i.ary=uu,i.assign=lm,i.assignIn=_u,i.assignInWith=dt,i.assignWith=om,i.at=gm,i.before=lu,i.bind=Ba,i.bindAll=pp,i.bindKey=ou,i.castArray=Fv,i.chain=au,i.chunk=Dd,i.compact=Vd,i.concat=Ud,i.cond=kp,i.conforms=cp,i.constant=Oa,i.countBy=Jf,i.create=dm,i.curry=gu,i.curryRight=du,i.debounce=fu,i.defaults=fm,i.defaultsDeep=vm,i.defer=Av,i.delay=qv,i.difference=Wd,i.differenceBy=Gd,i.differenceWith=Hd,i.drop=$d,i.dropRight=Yd,i.dropRightWhile=zd,i.dropWhile=Zd,i.fill=Xd,i.filter=ev,i.flatMap=tv,i.flatMapDeep=av,i.flatMapDepth=iv,i.flatten=eu,i.flattenDeep=Jd,i.flattenDepth=Qd,i.flip=wv,i.flow=hp,i.flowRight=bp,i.fromPairs=ef,i.functions=bm,i.functionsIn=_m,i.groupBy=sv,i.initial=rf,i.intersection=tf,i.intersectionBy=af,i.intersectionWith=sf,i.invert=qm,i.invertBy=wm,i.invokeMap=lv,i.iteratee=Ma,i.keyBy=ov,i.keys=re,i.keysIn=ve,i.map=it,i.mapKeys=Rm,i.mapValues=xm,i.matches=_p,i.matchesProperty=Ap,i.memoize=ut,i.merge=jm,i.mergeWith=Au,i.method=qp,i.methodOf=wp,i.mixin=Ca,i.negate=lt,i.nthArg=Rp,i.omit=Pm,i.omitBy=Bm,i.once=Tv,i.orderBy=gv,i.over=xp,i.overArgs=Rv,i.overEvery=jp,i.overSome=Pp,i.partial=Sa,i.partialRight=vu,i.partition=dv,i.pick=Sm,i.pickBy=qu,i.property=Bu,i.propertyOf=Bp,i.pull=gf,i.pullAll=ru,i.pullAllBy=df,i.pullAllWith=ff,i.pullAt=vf,i.range=Sp,i.rangeRight=Ep,i.rearg=xv,i.reject=mv,i.remove=mf,i.rest=jv,i.reverse=ja,i.sampleSize=kv,i.set=Fm,i.setWith=Nm,i.shuffle=cv,i.slice=pf,i.sortBy=bv,i.sortedUniq=Af,i.sortedUniqBy=qf,i.split=tp,i.spread=Pv,i.tail=wf,i.take=Tf,i.takeRight=Rf,i.takeRightWhile=xf,i.takeWhile=jf,i.tap=Uf,i.throttle=Bv,i.thru=at,i.toArray=yu,i.toPairs=wu,i.toPairsIn=Tu,i.toPath=Op,i.toPlainObject=bu,i.transform=Im,i.unary=Sv,i.union=Pf,i.unionBy=Bf,i.unionWith=Sf,i.uniq=Ef,i.uniqBy=Ff,i.uniqWith=Nf,i.unset=Lm,i.unzip=Pa,i.unzipWith=tu,i.update=Om,i.updateWith=Mm,i.values=Gn,i.valuesIn=Cm,i.without=If,i.words=ju,i.wrap=Ev,i.xor=Lf,i.xorBy=Of,i.xorWith=Mf,i.zip=Cf,i.zipObject=Kf,i.zipObjectDeep=Df,i.zipWith=Vf,i.entries=wu,i.entriesIn=Tu,i.extend=_u,i.extendWith=dt,Ca(i,i),i.add=Cp,i.attempt=Pu,i.camelCase=Um,i.capitalize=Ru,i.ceil=Kp,i.clamp=Km,i.clone=Nv,i.cloneDeep=Lv,i.cloneDeepWith=Ov,i.cloneWith=Iv,i.conformsTo=Mv,i.deburr=xu,i.defaultTo=yp,i.divide=Dp,i.endsWith=Wm,i.eq=Ie,i.escape=Gm,i.escapeRegExp=Hm,i.every=Qf,i.find=nv,i.findIndex=Js,i.findKey=mm,i.findLast=rv,i.findLastIndex=Qs,i.findLastKey=pm,i.floor=Vp,i.forEach=iu,i.forEachRight=su,i.forIn=km,i.forInRight=cm,i.forOwn=ym,i.forOwnRight=hm,i.get=Na,i.gt=Cv,i.gte=Kv,i.has=Am,i.hasIn=Ia,i.head=nu,i.identity=me,i.includes=uv,i.indexOf=nf,i.inRange=Dm,i.invoke=Tm,i.isArguments=Rn,i.isArray=B,i.isArrayBuffer=Dv,i.isArrayLike=fe,i.isArrayLikeObject=X,i.isBoolean=Vv,i.isBuffer=pn,i.isDate=Uv,i.isElement=Wv,i.isEmpty=Gv,i.isEqual=Hv,i.isEqualWith=$v,i.isError=Ea,i.isFinite=Yv,i.isFunction=rn,i.isInteger=mu,i.isLength=ot,i.isMap=pu,i.isMatch=zv,i.isMatchWith=Zv,i.isNaN=Xv,i.isNative=Jv,i.isNil=em,i.isNull=Qv,i.isNumber=ku,i.isObject=Y,i.isObjectLike=z,i.isPlainObject=pr,i.isRegExp=Fa,i.isSafeInteger=nm,i.isSet=cu,i.isString=gt,i.isSymbol=ye,i.isTypedArray=Wn,i.isUndefined=rm,i.isWeakMap=tm,i.isWeakSet=am,i.join=uf,i.kebabCase=$m,i.last=xe,i.lastIndexOf=lf,i.lowerCase=Ym,i.lowerFirst=zm,i.lt=im,i.lte=sm,i.max=Up,i.maxBy=Wp,i.mean=Gp,i.meanBy=Hp,i.min=$p,i.minBy=Yp,i.stubArray=Da,i.stubFalse=Va,i.stubObject=Fp,i.stubString=Np,i.stubTrue=Ip,i.multiply=zp,i.nth=of,i.noConflict=Tp,i.noop=Ka,i.now=st,i.pad=Zm,i.padEnd=Xm,i.padStart=Jm,i.parseInt=Qm,i.random=Vm,i.reduce=fv,i.reduceRight=vv,i.repeat=ep,i.replace=np,i.result=Em,i.round=Zp,i.runInContext=g,i.sample=pv,i.size=yv,i.snakeCase=rp,i.some=hv,i.sortedIndex=kf,i.sortedIndexBy=cf,i.sortedIndexOf=yf,i.sortedLastIndex=hf,i.sortedLastIndexBy=bf,i.sortedLastIndexOf=_f,i.startCase=ap,i.startsWith=ip,i.subtract=Xp,i.sum=Jp,i.sumBy=Qp,i.template=sp,i.times=Lp,i.toFinite=tn,i.toInteger=E,i.toLength=hu,i.toLower=up,i.toNumber=je,i.toSafeInteger=um,i.toString=K,i.toUpper=lp,i.trim=op,i.trimEnd=gp,i.trimStart=dp,i.truncate=fp,i.unescape=vp,i.uniqueId=Mp,i.upperCase=mp,i.upperFirst=La,i.each=iu,i.eachRight=su,i.first=nu,Ca(i,function(){var e={};return Ge(i,function(n,r){V.call(i.prototype,r)||(e[r]=n)}),e}(),{chain:!1}),i.VERSION=x,Ae(["bind","bindKey","curry","curryRight","partial","partialRight"],function(e){i[e].placeholder=i}),Ae(["drop","take"],function(e,n){L.prototype[e]=function(r){r=r===u?1:ne(E(r),0);var t=this.__filtered__&&!n?new L(this):this.clone();return t.__filtered__?t.__takeCount__=ie(r,t.__takeCount__):t.__views__.push({size:ie(r,We),type:e+(t.__dir__<0?"Right":"")}),t},L.prototype[e+"Right"]=function(r){return this.reverse()[e](r).reverse()}}),Ae(["filter","map","takeWhile"],function(e,n){var r=n+1,t=r==ei||r==ll;L.prototype[e]=function(a){var s=this.clone();return s.__iteratees__.push({iteratee:w(a,3),type:r}),s.__filtered__=s.__filtered__||t,s}}),Ae(["head","last"],function(e,n){var r="take"+(n?"Right":"");L.prototype[e]=function(){return this[r](1).value()[0]}}),Ae(["initial","tail"],function(e,n){var r="drop"+(n?"":"Right");L.prototype[e]=function(){return this.__filtered__?new L(this):this[r](1)}}),L.prototype.compact=function(){return this.filter(me)},L.prototype.find=function(e){return this.filter(e).head()},L.prototype.findLast=function(e){return this.reverse().find(e)},L.prototype.invokeMap=N(function(e,n){return typeof e=="function"?new L(this):this.map(function(r){return or(r,e,n)})}),L.prototype.reject=function(e){return this.filter(lt(w(e)))},L.prototype.slice=function(e,n){e=E(e);var r=this;return r.__filtered__&&(e>0||n<0)?new L(r):(e<0?r=r.takeRight(-e):e&&(r=r.drop(e)),n!==u&&(n=E(n),r=n<0?r.dropRight(-n):r.take(n-e)),r)},L.prototype.takeRightWhile=function(e){return this.reverse().takeWhile(e).reverse()},L.prototype.toArray=function(){return this.take(We)},Ge(L.prototype,function(e,n){var r=/^(?:filter|find|map|reject)|While$/.test(n),t=/^(?:head|last)$/.test(n),a=i[t?"take"+(n=="last"?"Right":""):n],s=t||/^find/.test(n);a&&(i.prototype[n]=function(){var l=this.__wrapped__,o=t?[1]:arguments,d=l instanceof L,p=o[0],k=d||B(l),c=function(I){var O=a.apply(i,ln([I],o));return t&&h?O[0]:O};k&&r&&typeof p=="function"&&p.length!=1&&(d=k=!1);var h=this.__chain__,A=!!this.__actions__.length,T=s&&!h,F=d&&!A;if(!s&&k){l=F?l:new L(this);var R=e.apply(l,o);return R.__actions__.push({func:at,args:[c],thisArg:u}),new we(R,h)}return T&&F?e.apply(this,o):(R=this.thru(c),T?t?R.value()[0]:R.value():R)})}),Ae(["pop","push","shift","sort","splice","unshift"],function(e){var n=Br[e],r=/^(?:push|sort|unshift)$/.test(e)?"tap":"thru",t=/^(?:pop|shift)$/.test(e);i.prototype[e]=function(){var a=arguments;if(t&&!this.__chain__){var s=this.value();return n.apply(B(s)?s:[],a)}return this[r](function(l){return n.apply(B(l)?l:[],a)})}}),Ge(L.prototype,function(e,n){var r=i[n];if(r){var t=r.name+"";V.call(Cn,t)||(Cn[t]=[]),Cn[t].push({name:n,func:r})}}),Cn[Xr(u,kn).name]=[{name:"wrapper",func:u}],L.prototype.clone=fg,L.prototype.reverse=vg,L.prototype.value=mg,i.prototype.at=Wf,i.prototype.chain=Gf,i.prototype.commit=Hf,i.prototype.next=$f,i.prototype.plant=zf,i.prototype.reverse=Zf,i.prototype.toJSON=i.prototype.valueOf=i.prototype.value=Xf,i.prototype.first=i.prototype.head,rr&&(i.prototype[rr]=Yf),i},Ln=Go();yn?((yn.exports=Ln)._=Ln,Mt._=Ln):te._=Ln}).call(kr)})(ct,ct.exports);var Cu=ct.exports;const Sk="NORGE",Ku=v=>v??"",Ek=v=>{const{adresselinje1:b,adresselinje2:u,adresselinje3:x,postNummer:q,poststed:S,land:j}=v,$=[b,u,x].filter(M=>!!M).join(", "),D=`${Ku(q)} ${Ku(S)}`,Q=(j==null?void 0:j.toUpperCase())!==Sk?j:void 0;return[$,D,Q].map(M=>M==null?void 0:M.trim()).filter(M=>!!M).join(", ").trim()},vc=(v,b)=>[...v].sort(zu).find(u=>u.adresseType===b),mc=(v,b)=>v.length!==b.length?!1:v.every(u=>b.some(x=>Cu.isEqual(u,x)))&&b.every(u=>v.some(x=>Cu.isEqual(x,u)));function Fk(v){throw new Error("Uventet enum verdi: alle tilfeller skal må håndteres:",v)}const Ha=cr(bt);var Nk=(v=>(v[v.SOKNAD=0]="SOKNAD",v[v.FREG=1]="FREG",v[v.MEDL=2]="MEDL",v))(Nk||{});const Ik=v=>{switch(v){case 0:return Ha.formatMessage({id:"FaktaKilde.Soknad"});case 1:return Ha.formatMessage({id:"FaktaKilde.FREG"});case 2:return Ha.formatMessage({id:"FaktaKilde.MEDL"});default:return Fk(v)}},Zu=Me.forwardRef((v,b)=>y.jsx(Ya,{gap:"2",style:{display:"flex"},...v,ref:b}));Zu.displayName="FaktaGruppe";const Lk=({label:v,value:b,kilde:u})=>y.jsx(mt,{background:"bg-subtle",flexGrow:"1",paddingBlock:"2",paddingInline:"4",borderRadius:"medium",children:y.jsxs(Ja,{gap:"6",children:[y.jsxs("div",{children:[y.jsx(Gu,{size:"small",children:v}),y.jsx(za,{size:"large",children:b})]}),y.jsx(Za,{uppercase:!0,children:Ik(u)})]})});Zu.__docgenInfo={description:"",methods:[],displayName:"FaktaGruppe"};Lk.__docgenInfo={description:"",methods:[],displayName:"FaktaBox",props:{label:{required:!0,tsType:{name:"union",raw:"string | ReactNode",elements:[{name:"string"},{name:"ReactNode"}]},description:""},value:{required:!0,tsType:{name:"string"},description:""},kilde:{required:!0,tsType:{name:"FaktaKilde"},description:""}}};const Xu=({adresser:v,erAnnenpart:b=!1,harSammeAdresser:u=!1,adresseKodeverk:x})=>{if(u)return y.jsx(mt,{padding:"4",children:y.jsx(Eu,{textColor:"subtle",children:y.jsx(Pe,{id:"AdresseTabell.SammeAdresse"})})});const q=S=>S+1===v.length?{border:"0px"}:{};return y.jsxs(y.Fragment,{children:[v.length===0&&y.jsx(mt,{padding:"4",children:y.jsx(Eu,{textColor:"subtle",children:y.jsx(Pe,{id:"AdresseTabell.IngenAdresse",values:{erAnnenpart:b}})})}),v.length>0&&y.jsxs(Oe,{style:{tableLayout:"fixed"},children:[y.jsx(Oe.Header,{children:y.jsxs(Oe.Row,{children:[y.jsx(Oe.HeaderCell,{children:y.jsx(Pe,{id:"AdresseTabell.PeriodeLabel"})}),y.jsx(Oe.HeaderCell,{children:y.jsx(Pe,{id:"AdresseTabell.AdresseLabel"})}),y.jsx(Oe.HeaderCell,{children:y.jsx(Pe,{id:"AdresseTabell.TypeLabel"})})]})}),y.jsx(Oe.Body,{children:v.sort(zu).map((S,j)=>{var $;return y.jsxs(Oe.Row,{children:[y.jsx(Oe.DataCell,{style:q(j),children:y.jsx(kk,{dateStringFom:S.fom,dateStringTom:S.tom===$a?void 0:S.tom})}),y.jsx(Oe.DataCell,{style:q(j),children:Ek(S)}),y.jsx(Oe.DataCell,{style:q(j),children:($=x.find(D=>D.kode===S.adresseType))==null?void 0:$.navn})]},j)})})]})]})};Xu.__docgenInfo={description:"",methods:[],displayName:"AdresseTabell",props:{adresser:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
  adresseType?: string;
  ...
  poststed?: string | null;
  land?: string;
}>`}],raw:"Personadresse[]"},description:""},kjønn:{required:!1,tsType:{name:"string"},description:""},showIcon:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const Ck=({personoversikt:{barn:v,bruker:b,annenPart:u},alleKodeverk:x})=>y.jsxs(Ja,{gap:"2",children:[v.map(q=>y.jsx(vt,{...q,alleKodeverk:x,rolle:"BARN"},q.aktoerId)),y.jsx(vt,{rolle:"BRUKER",alleKodeverk:x,...b}),u&&y.jsx(vt,{...u,rolle:"ANNEN_PART",alleKodeverk:x})]});Ck.__docgenInfo={description:"",methods:[],displayName:"PersonopplysningerForFamilie",props:{alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
  ...
  annenPart?: PersonopplysningerBasis;
  barn: PersonopplysningerBasis[];
}>`},description:""}}};const Kk="_boks_c3bfh_1",Dk="_harBorderLeft_c3bfh_8",Vk="_harBorderTop_c3bfh_12",Ju={boks:Kk,harBorderLeft:Dk,harBorderTop:Vk},Uk=qk.bind(Ju),Wk=({harBorderTop:v=!1,harBorderLeft:b=!0,children:u})=>y.jsx("div",{className:Uk(Ju.boks,{harBorderLeft:b,harBorderTop:v}),children:u});Wk.__docgenInfo={description:"",methods:[],displayName:"Boks",props:{harBorderTop:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},harBorderLeft:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const Du="default",Vu="default",Gk=(v,b,u,x,q,S)=>j=>{const D=(Array.isArray(j)?j:[j]).map(M=>({"@type":M.kode,...M})),Q={saksnummer:v.saksnummer,behandlingUuid:b.uuid,behandlingVersjon:b.versjon};if(D&&q&&S){if(D.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(S.includes(D[0].kode))return q({...Q,overstyrteAksjonspunktDtoer:D},!0).then(()=>u(Vu,Du))}return x({...Q,bekreftedeAksjonspunktDtoer:D},!0).then(()=>u(Vu,Du))},Hk=(v,b=[])=>{const[u,x]=Me.useState(),q=Me.useContext(uk);Me.useEffect(()=>{u&&x(void 0)},[q.behandling.versjon]);const{aksjonspunkt:S}=q.behandling,j=Me.useMemo(()=>S&&v?S.filter(M=>v.includes(M.definisjon)):[],[S,v]),$=wk(q.behandling,[],q.rettigheter,q.hasFetchError),D=Me.useMemo(()=>Tk(q.behandling,j),[q.behandling.versjon,j]),Q=Me.useMemo(()=>Gk(q.fagsak,q.behandling,q.oppdaterProsessStegOgFaktaPanelIUrl,q.lagreAksjonspunkter,q.lagreOverstyrteAksjonspunkter,b),[q.behandling.versjon,b]);return{behandling:q.behandling,submittable:!j.some(M=>Mu(M.status))||j.some(M=>M.kanLoses),harApneAksjonspunkter:j.some(M=>Mu(M.status)&&M.kanLoses),alleKodeverk:q.alleKodeverk,aksjonspunkter:j,readOnly:$,alleMerknaderFraBeslutter:D,submitCallback:Q,formData:u,setFormData:x}},$k="default",Yk=(v,b,u,x,q,S)=>{const[j,$]=Me.useState(!1);Me.useEffect(()=>{v({id:b})},[]);const D=x&&(S===b||q&&S===$k),Q=ck(x);return Me.useEffect(()=>{x?v({id:b,tekst:u,erAktiv:D,harApneAksjonspunkter:q}):!x&&Q&&v({id:b}),$(D)},[Q,x,D,q]),x&&j},Qu=({erPanelValgt:v,dataState:b,children:u})=>v?b!==$u.SUCCESS?y.jsx(yk,{}):u:null;Qu.__docgenInfo={description:"",methods:[],displayName:"FaktaPanelWrapper",props:{erPanelValgt:{required:!0,tsType:{name:"boolean"},description:""},dataState:{required:!0,tsType:{name:"RestApiState"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactElement | null",elements:[{name:"ReactElement"},{name:"null"}]},description:""}}};const el=({valgtFaktaSteg:v,behandling:b,registrerFaktaPanel:u,panelEndepunkter:x=[],aksjonspunktKoder:q,overstyringApKoder:S,skalPanelVisesIMeny:j,renderPanel:$,faktaPanelKode:D,faktaPanelMenyTekst:Q})=>{const M=Hk(q,S),Z=Yk(u,D,Q,j(),M.harApneAksjonspunkter,v),Be=x.map(De=>({key:De})),{data:Ce,state:Ke}=lk.useMultipleRestApi(Be,{updateTriggers:[Z,b==null?void 0:b.versjon],suspendRequest:!Z||Be.length===0,isCachingOn:!0});return y.jsx(Qu,{erPanelValgt:Z,dataState:Be.length>0?Ke:$u.SUCCESS,children:$({...Ce,...M})})};el.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{panelEndepunkter:{required:!1,tsType:{name:"Array",elements:[{name:"RestKey",elements:[{name:"any"},{name:"any"}],raw:"RestKey<any, any>"}],raw:"RestKey<any, any>[]"},description:"",defaultValue:{value:"[]",computed:!1}},aksjonspunktKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},overstyringApKoder:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"signature",type:"function",raw:"() => boolean",signature:{arguments:[],return:{name:"boolean"}}},description:""},renderPanel:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: PANEL_DATA & StandardFaktaPanelProps) => ReactElement",signature:{arguments:[{type:{name:"intersection",raw:"PANEL_DATA & StandardFaktaPanelProps",elements:[{name:"PANEL_DATA"},{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
Presentasjonskomponent. Har ansvar for å sette opp formen for att registrere verge.`,methods:[],displayName:"RegistrereVergeInfoPanel",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: AvklarVergeAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<tilbakekrevingKodeverkTyper, KodeverkMedNavn[]>"}]},description:""}}};const Wu=[ht.AVKLAR_VERGE],nc=[pk.VERGE],rc=({valgtFaktaSteg:v,behandling:b,registrerFaktaPanel:u})=>y.jsx(el,{valgtFaktaSteg:v,behandling:b,registrerFaktaPanel:u,panelEndepunkter:nc,aksjonspunktKoder:Wu,faktaPanelKode:mk.VERGE,faktaPanelMenyTekst:Hu().formatMessage({id:"RegistrereVergeInfoPanel.Info"}),skalPanelVisesIMeny:()=>{var x;return!!((x=b.aksjonspunkt)!=null&&x.some(q=>q.definisjon===Wu[0]))},renderPanel:x=>y.jsx(rl,{...x})});rc.__docgenInfo={description:"VergeFaktaInitPanel",methods:[],displayName:"VergeFaktaInitPanel",props:{valgtFaktaSteg:{required:!1,tsType:{name:"string"},description:""},behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
  aksjonspunkt: Aksjonspunkt[];
  harSøknad: boolean;
  harSattEndringsdato: boolean;
