import{j as m}from"./index-nufLo1NJ.js";import{r as l}from"./index-mMUbb89k.js";import{u as v}from"./index.es-3EalTioe.js";import{A as y}from"./aksjonspunktCodes-CwqG_2qJ.js";import{i as p}from"./aksjonspunktStatus-xM4O_ZUY.js";import"./withPanelData-mrNJc-4P.js";import{S as T}from"./SettPaVentModalIndex-DZFnfrxc.js";import{u as E}from"./behandlingApi-Y2pAjD4W.js";const b=({behandling:e,kodeverk:t,opneSokeside:s,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,r]=l.useState(!a&&e.behandlingPåVent),o=()=>r(!1),k=E(e),{mutate:d}=v({mutationFn:n=>k.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>s()});l.useEffect(()=>{a||r(e.behandlingPåVent)},[e.versjon,a]);const g=e.aksjonspunkt.filter(n=>p(n.status)).some(n=>n.definisjon===y.AUTO_MANUELT_SATT_PÅ_VENT);return m.jsx(T,{submitCallback:d,cancelEvent:o,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:g,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:u})};b.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"intersection",raw:`BehandlingFellesData &
Readonly<{
