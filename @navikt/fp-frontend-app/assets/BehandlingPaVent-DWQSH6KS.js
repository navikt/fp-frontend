import{r,j as d}from"./iframe-DoiceIWA.js";import{c as o}from"./index.es-Bm0FXcUi.js";import{i as T,A as g}from"./index-oVuILd1f.js";import{S as y}from"./SettPaVentModalIndex-CVEe10g9.js";import{u as _}from"./behandlingApi-DjHGxoWE.js";const p=({behandling:e,kodeverk:t,opneSokeside:u,erTilbakekreving:i=!1,skalIkkeViseModal:n=!1})=>{const[s,l]=r.useState(!n&&e.behandlingPåVent),m=()=>l(!1),v=_(e),{mutate:E}=o({mutationFn:a=>v.oppdaterPåVent({...a,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>u()});r.useEffect(()=>{n||l(e.behandlingPåVent)},[e.versjon,n]);const k=e.aksjonspunkt.filter(a=>T(a.status)).some(a=>a.definisjon===g.AUTO_MANUELT_SATT_PÅ_VENT);return d.jsx(y,{submitCallback:E,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:k,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:s})};p.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
