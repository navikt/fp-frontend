import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./index-mMUbb89k.js";import{u as f,f as R,a4 as c,a5 as B,a6 as K}from"./withPanelData-DJnwqwDR.js";import{e as h}from"./index.es-CNaRprpx.js";import{u as _}from"./fagsakApi-BmC_NtRq.js";import{V}from"./BehandlingMenuIndex-CozYgAiK.js";import{A as S}from"./aksjonspunktCodes-Cv9tgqDr.js";import{u as O,h as N}from"./behandlingApi-BsizdQgL.js";import{B as p}from"./FagsakIndex-6pIQXYaM.js";import{K as D}from"./index.es-C2SR5Obw.js";import{S as P}from"./ExclamationmarkTriangleFill-D3GrT3Pk.js";import{i as v}from"./aksjonspunktStatus-xM4O_ZUY.js";import{e as F,g as M}from"./useStandardProsessPanelProps-j6IIcaiI.js";const G=n=>{const[a,e]=d.useState([]),s=r=>{e(i=>{const t=[...i],g=t.findIndex(l=>l.id===r.id);return g>=0?t.splice(g,1,r):t.push(r),t}),n==null||n(r.harApneAksjonspunkter?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:a.filter(r=>r.skalVisesImeny),settFaktaPanelMenyData:s}},I="_container_610fz_1",L="_content_610fz_6",U="_sideMenu_610fz_14",y={container:I,content:L,sideMenu:U},H=({valgtFaktaSteg:n,valgtProsessSteg:a,setFaktaPanelMedÅpentApInfo:e,children:s})=>{const r=f(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(p),{faktaPanelMenyData:t,settFaktaPanelMenyData:g}=G(e),l=t.length>0;return o.jsxs(R,{className:y.container,wrap:!1,children:[l&&o.jsx("div",{className:y.sideMenu,"data-testid":"fakta-meny",children:o.jsx(D,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:t.map(u=>({label:u.tekst,active:u.erAktiv,icon:u.harApneAksjonspunkter?o.jsx(P,{color:"var(--a-orange-600)"}):void 0})),onClick:u=>{i(a,t[u].id)}})}),o.jsx("div",{className:y.content,children:o.jsx(x,{valgtFaktaSteg:n,settFaktaPanelMenyData:g,faktaPanelMenyData:t,children:s})})]})},q=d.createContext({}),x=n=>{const{children:a,...e}=n,s=d.useMemo(()=>e,[e]);return o.jsx(q.Provider,{value:s,children:a})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",Y=(n,a,e,s)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:i}=d.use(q),t=e&&(r===n||s&&r===J);return d.useEffect(()=>{i({id:n,tekst:a,erAktiv:t,harApneAksjonspunkter:s,skalVisesImeny:e})},[e,t,s]),e&&t},j=({standardPanelProps:n,skalPanelVisesIMeny:a,faktaPanelKode:e,faktaPanelMenyTekst:s,children:r})=>{const{behandling:i,fagsak:t,alleKodeverk:g}=d.use(p),l=Y(e,s,a,n.harApneAksjonspunkter);return o.jsx(c,{behandling:i,children:l?o.jsx(B,{behandling:i,fagsak:t,alleKodeverk:g,aksjonspunkterForPanel:n.aksjonspunkter,harÅpneAksjonspunkter:n.harApneAksjonspunkter,submitCallback:n.submitCallback,isReadOnly:n.readOnly,alleMerknaderFraBeslutter:n.alleMerknaderFraBeslutter,children:r}):null})};j.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
