...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const J=n=>{const{aksjonspunkt:t,behandlingsresultat:r}=n,a=t.some(s=>s.status===_e.OPPRETTET);return t.length===0||a?P.IKKE_VURDERT:(r==null?void 0:r.type)===$.INNSYN_INNVILGET||(r==null?void 0:r.type)===$.INNSYN_DELVIS_INNVILGET?P.OPPFYLT:P.IKKE_OPPFYLT},Kn=(n,t,r)=>a=>{const s={...a,behandlingUuid:r.uuid,fagsakYtelseType:t.fagsakYtelseType};return n(s).then(i=>Te(i))},xn=(n,t)=>()=>(t(!1),()=>{n(!0)}),Ln=[T.FORESLA_VEDTAK],Mn=n=>[{key:R.INNSYN},{key:R.INNSYN_DOKUMENTER,params:{saksnummer:n}}],be=({fagsak:n,opneSokeside:t,setSkalOppdatereEtterBekreftelseAvAp:r,...a})=>{const s=I(),[i,u]=l.useState(!1),o=xn(u,r),m=Ue(),{startRequest:y}=Fe.useRestApiRunner(R.PREVIEW_MESSAGE),h=l.useCallback(Kn(y,n,m.behandling),[m.behandling.versjon]);return e.jsx(oe,{...a,panelEndepunkter:Mn(n.saksnummer),aksjonspunktKoder:Ln,prosessPanelKode:ne.VEDTAK,prosessPanelMenyTekst:s.formatMessage({id:"Behandlingspunkt.Vedtak"}),skalPanelVisesIMeny:()=>!0,hentOverstyrtStatus:()=>J(a.behandling),lagringSideEffekter:o,hentSkalMarkeresSomAktiv:()=>J(a.behandling)!==P.IKKE_VURDERT,renderPanel:p=>e.jsxs(e.Fragment,{children:[e.jsx(He,{visModal:i,lukkModal:()=>{u(!1),t()},behandlingsresultat:m.behandling.behandlingsresultat}),e.jsx(pe,{saksnummer:n.saksnummer,previewCallback:h,alleDokumenter:p==null?void 0:p.innsynDokumenter,...p})]})})};be.__docgenInfo={description:"",methods:[],displayName:"InnsynVedtakProsessStegInitPanel",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: string;
  relasjonsRolleType: string;
  status: string;
