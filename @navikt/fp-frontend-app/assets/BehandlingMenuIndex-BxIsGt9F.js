...
>`},{name:"signature",type:"object",raw:`{
  ...
  fnr?: string;
  organisasjonsnummer?: string;
}`,signature:{properties:[{key:"gyldigTom",value:{name:"string",required:!1}},{key:"fnr",value:{name:"string",required:!1}},{key:"organisasjonsnummer",value:{name:"string",required:!1}}]}}]},{name:"undefined"}]},description:""}}};const ok=Te(Gs),dk=({verge:m,alleKodeverk:_})=>E.jsx(Be,{value:ok,children:E.jsx(fs,{verge:m,alleKodeverk:_})});dk.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaIndex",props:{verge:{required:!0,tsType:{name:"union",raw:"Verge | undefined",elements:[{name:"intersection",raw:`Omit<
  foreldrepenger_domene_person_verge_dto_VergeDto,
  'gyldigTom' | 'fnr' | 'organisasjonsnummer'
> & {
  gyldigTom?: string;
