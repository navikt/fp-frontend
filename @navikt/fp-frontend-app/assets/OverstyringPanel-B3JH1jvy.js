import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{d as h,K as I,r as V,c as _,o as O,N as F,E,b as R,J as L,Z as z}from"./index.es-BKl5c88V.js";import{l as $,n as y,c as C,S as U,Z as N,X as c,K as d,d as G,a as o,W as S,e as K}from"./index.es-S809g6hm.js";import{r as Y}from"./index-DjhIdADd.js";import{A as D}from"./aksjonspunktStatus-xM4O_ZUY.js";import{n as T,V as X,H as Z,h as v,m as H,a3 as W,L as q}from"./withPanelData-BkSpkxDu.js";import{V as J}from"./BehandlingHenlagtPanel-DsFUWNRR.js";import{S as Q}from"./TotrinnskontrollIndex-YqIZMJhO.js";import{S as ee}from"./CheckmarkCircleFill-C9ydMpLz.js";import{S as ne}from"./ExclamationmarkTriangleFill-Dhnsmg5e.js";const se="_begrunnelseTextField_hw8s7_6",re={begrunnelseTextField:se},f={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ae=y(f),te=_(3),ie=O(2e3),le=n=>n?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",oe=n=>r=>r!==void 0||n,P=({readOnly:n,text:r,useAllWidth:s=!1,notRequired:a=!1})=>{const{formState:{isDirty:i}}=h(),t=a?()=>!1:oe(i);return e.jsx("div",{className:s?"":re.begrunnelseTextField,children:e.jsx(I,{name:"begrunnelse",label:r??ae.formatMessage({id:le(n)}),validate:[V(t),te,ie,F],maxLength:2e3,readOnly:n,parse:$})})},de=n=>n.length>0&&n[0].begrunnelse?n[0].begrunnelse:"";P.buildInitialValues=n=>({begrunnelse:C(de(n))});P.transformValues=n=>({begrunnelse:n.begrunnelse});P.__docgenInfo={description:`ProsessStegBegrunnelseTextField
