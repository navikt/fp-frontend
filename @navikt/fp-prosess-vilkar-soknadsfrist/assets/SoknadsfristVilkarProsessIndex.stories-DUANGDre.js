 ...
 */var Rt;function Vl(){if(Rt)return $e;Rt=1;var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.fragment");function t(a,r,l){var i=null;if(l!==void 0&&(i=""+l),r.key!==void 0&&(i=""+r.key),"key"in r){l={};for(var s in r)s!=="key"&&(l[s]=r[s])}else l=r;return r=l.ref,{$$typeof:e,type:a,key:i,ref:r!==void 0?r:null,props:l}}return $e.Fragment=n,$e.jsx=t,$e.jsxs=t,$e}var Ot;function Kl(){return Ot||(Ot=1,pt.exports=Vl()),pt.exports}var Ea=Kl();const Qe={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};Ee(Qe);var Dt={exports:{}};/*!
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kt;function ai(){if(kt)return He;kt=1;var e=Symbol.for("react.transitional.element"),n=Symbol.for("react.fragment");function t(a,r,l){var i=null;if(l!==void 0&&(i=""+l),r.key!==void 0&&(i=""+r.key),"key"in r){l={};for(var s in r)s!=="key"&&(l[s]=r[s])}else l=r;return r=l.ref,{$$typeof:e,type:a,key:i,ref:r!==void 0?r:null,props:l}}return He.Fragment=n,He.jsx=t,He.jsxs=t,He}var It;function ti(){return It||(It=1,At.exports=ai()),At.exports}var te=ti();const sn=e=>e.reduce((n,t,a)=>({...n,[a]:r=>t(r)||!0}),{}),on=(e,n)=>n.split(".").reduce((t,a)=>t!==void 0?t[a]:t,e)?.message;var Ia={exports:{}},ni=Ia.exports,Lt;function ri(){return Lt||(Lt=1,(function(e,n){(function(t,a){e.exports=a()})(ni,function(){var t={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},a=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,r=/\d/,l=/\d\d/,i=/\d\d?/,s=/\d*[^-_:/,()\s\d]+/,d={},f=function(g){return(g=+g)+(g>68?1900:2e3)},c=function(g){return function(A){this[g]=+A}},v=[/[+-]\d\d:?(\d\d)?|Z/,function(g){(this.zone||(this.zone={})).offset=(function(A){if(!A||A==="Z")return 0;var p=A.match(/([+-]|\d\d)/g),k=60*p[1]+(+p[2]||0);return k===0?0:p[0]==="+"?-k:k})(g)}],_=function(g){var A=d[g];return A&&(A.indexOf?A:A.s.concat(A.f))},y=function(g,A){var p,k=d.meridiem;if(k){for(var F=1;F<=24;F+=1)if(g.indexOf(k(F,0,A))>-1){p=F>12;break}}else p=g===(A?"pm":"PM");return p},N={A:[s,function(g){this.afternoon=y(g,!1)}],a:[s,function(g){this.afternoon=y(g,!0)}],Q:[r,function(g){this.month=3*(g-1)+1}],S:[r,function(g){this.milliseconds=100*+g}],SS:[l,function(g){this.milliseconds=10*+g}],SSS:[/\d{3}/,function(g){this.milliseconds=+g}],s:[i,c("seconds")],ss:[i,c("seconds")],m:[i,c("minutes")],mm:[i,c("minutes")],H:[i,c("hours")],h:[i,c("hours")],HH:[i,c("hours")],hh:[i,c("hours")],D:[i,c("day")],DD:[l,c("day")],Do:[s,function(g){var A=d.ordinal,p=g.match(/\d+/);if(this.day=p[0],A)for(var k=1;k<=31;k+=1)A(k).replace(/\[|\]/g,"")===g&&(this.day=k)}],w:[i,c("week")],ww:[l,c("week")],M:[i,c("month")],MM:[l,c("month")],MMM:[s,function(g){var A=_("months"),p=(_("monthsShort")||A.map(function(k){return k.slice(0,3)})).indexOf(g)+1;if(p<1)throw new Error;this.month=p%12||p}],MMMM:[s,function(g){var A=_("months").indexOf(g)+1;if(A<1)throw new Error;this.month=A%12||A}],Y:[/[+-]?\d+/,c("year")],YY:[l,function(g){this.year=f(g)}],YYYY:[/\d{4}/,c("year")],Z:v,ZZ:v};function D(g){var A,p;A=g,p=d&&d.formats;for(var k=(g=A.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(M,x,h){var R=h&&h.toUpperCase();return x||p[h]||t[h]||p[R].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(K,q,j){return q||j.slice(1)})})).match(a),F=k.length,V=0;V<F;V+=1){var C=k[V],G=N[C],U=G&&G[0],w=G&&G[1];k[V]=w?{regex:U,parser:w}:C.replace(/^\[|\]$/g,"")}return function(M){for(var x={},h=0,R=0;h<F;h+=1){var K=k[h];if(typeof K=="string")R+=K.length;else{var q=K.regex,j=K.parser,X=M.slice(R),ne=q.exec(X)[0];j.call(x,ne),M=M.replace(ne,"")}}return(function(re){var fe=re.afternoon;if(fe!==void 0){var ee=re.hours;fe?ee<12&&(re.hours+=12):ee===12&&(re.hours=0),delete re.afternoon}})(x),x}}return function(g,A,p){p.p.customParseFormat=!0,g&&g.parseTwoDigitYear&&(f=g.parseTwoDigitYear);var k=A.prototype,F=k.parse;k.parse=function(V){var C=V.date,G=V.utc,U=V.args;this.$u=G;var w=U[1];if(typeof w=="string"){var M=U[2]===!0,x=U[3]===!0,h=M||x,R=U[2];x&&(R=U[2]),d=this.$locale(),!M&&R&&(d=p.Ls[R]),this.$d=(function(X,ne,re,fe){try{if(["x","X"].indexOf(ne)>-1)return new Date((ne==="X"?1e3:1)*X);var ee=D(ne)(X),we=ee.year,Te=ee.month,Sa=ee.day,Ze=ee.hours,ya=ee.minutes,Ge=ee.seconds,ea=ee.milliseconds,De=ee.zone,be=ee.week,xe=new Date,he=Sa||(we||Te?1:xe.getDate()),Me=we||xe.getFullYear(),Ne=0;we&&!Te||(Ne=Te>0?Te-1:xe.getMonth());var pe,je=Ze||0,Ue=ya||0,aa=Ge||0,Ae=ea||0;return De?new Date(Date.UTC(Me,Ne,he,je,Ue,aa,Ae+60*De.offset*1e3)):re?new Date(Date.UTC(Me,Ne,he,je,Ue,aa,Ae)):(pe=new Date(Me,Ne,he,je,Ue,aa,Ae),be&&(pe=fe(pe).week(be).toDate()),pe)}catch{return new Date("")}})(C,w,G,p),this.init(),R&&R!==!0&&(this.$L=this.locale(R).$L),h&&C!=this.format(w)&&(this.$d=new Date("")),d={}}else if(w instanceof Array)for(var K=w.length,q=1;q<=K;q+=1){U[1]=w[q-1];var j=p.apply(this,U);if(j.isValid()){this.$d=j.$d,this.$L=j.$L,this.init();break}q===K&&(this.$d=new Date(""))}else F.call(this,V)}}})})(Ia)),Ia.exports}var li=ri();const ii=ei(li),si="_textarea_14c7r_1",oi="_readOnlyField_14c7r_7",Ft={textarea:si,readOnlyField:oi},ui=e=>e!=null&&e!=="",di=({label:e,value:n,isEdited:t=!1,type:a,hideLabel:r,size:l})=>ui(n)?te.jsxs(Re,{gap:"space-4",children:[e&&!r&&te.jsx(_a,{size:l,children:e}),te.jsxs(ua,{gap:"space-8",align:"center",wrap:!1,children:[te.jsx(Mt,{className:a==="textarea"?Ft.textarea:Ft.readOnlyField,size:l,children:n}),t&&te.jsx(ln,{})]})]}):null;Gt.extend(ii);const ci="_noReadOnlyIcon_11vhl_2",mi={noReadOnlyIcon:ci},Ei=({label:e,description:n,validate:t=[],onChange:a,children:r,className:l,isReadOnly:i=!1,size:s="small",isEdited:d=!1,hideLegend:f=!1,...c})=>{const{name:v,control:_}=c,{formState:{errors:y}}=Ve(),{field:N}=Xt({name:v,control:_,rules:{validate:sn(t)}});return te.jsx(rl,{name:v,value:N.value!==void 0?N.value:null,legend:te.jsxs(ua,{justify:"center",gap:"space-8",children:[e,i&&d&&te.jsx(ln,{})]}),hideLegend:f,"aria-readonly":i,readOnly:i,description:n,size:s,error:on(y,v),onChange:D=>{a&&a(D),N.onChange(D)},className:Zl(l,mi.noReadOnlyIcon),children:r})},fi="_textAreaFieldWithBadges_bdz0b_1",vi="_etikettWrapper_bdz0b_4",Pt={textAreaFieldWithBadges:fi,etikettWrapper:vi},_i=({name:e,control:n,label:t,readOnly:a,maxLength:r,badges:l,validate:i=[],parse:s=y=>y,className:d,description:f,isEdited:c,size:v="small",..._})=>{const{formState:{errors:y}}=Ve(),{field:N}=Xt({name:e,control:n,rules:{validate:I.useMemo(()=>sn(i),[i])}});return a?te.jsx(di,{size:v,label:t,value:N.value,type:"textarea",isEdited:c,hideLabel:_.hideLabel}):te.jsxs("div",{className:l?Pt.textAreaFieldWithBadges:null,children:[l&&te.jsx("div",{className:Pt.etikettWrapper,children:l.map(({type:D,titleText:g})=>te.jsx(Xr,{variant:D,size:"small",children:g},g))}),te.jsx(cl,{size:v,label:t,description:f,className:d,autoComplete:"off",...N,onChange:D=>N.onChange(D.currentTarget.value!==""?s(D.currentTarget.value):null),value:N.value?N.value:"",error:on(y,e),maxLength:r,..._})]})},gi=({formMethods:e,onSubmit:n,children:t,className:a,setDataOnUnmount:r})=>{const{handleSubmit:l,getValues:i}=e;return I.useEffect(()=>()=>{r&&r(i())},[]),te.jsx(fl,{...e,children:te.jsx("form",{className:a,onSubmit:n?l(s=>n(s)):void 0,children:t})})},Si="_begrunnelseTextField_hw8s7_6",yi={begrunnelseTextField:Si},Xe={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},Ti=Ee(Xe),Ni=Sn(3),pi=yn(2e3),Ri=e=>e?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",Oi=e=>n=>n!==void 0||e,Ke=({readOnly:e,text:n,useAllWidth:t=!1,notRequired:a=!1})=>{const{formState:{isDirty:r},control:l}=Ve(),i=a?()=>!1:Oi(r);return P.jsx("div",{className:t?"":yi.begrunnelseTextField,children:P.jsx(_i,{name:"begrunnelse",control:l,label:n??Ti.formatMessage({id:Ri(e)}),validate:[gn(i),Ni,pi,Tn],maxLength:2e3,readOnly:e,parse:_n})})},Di=e=>e.at(0)?.begrunnelse??"";Ke.buildInitialValues=e=>({begrunnelse:Nn(Di(e))});Ke.transformValues=e=>({begrunnelse:e.begrunnelse});Ke.__docgenInfo={description:`ProsessStegBegrunnelseTextField
...
| 'IKKE_OPPFYLT'
| 'IKKE_VURDERT'
| '-'`,elements:[{name:"literal",value:"'OPPFYLT'"},{name:"literal",value:"'IKKE_OPPFYLT'"},{name:"literal",value:"'IKKE_VURDERT'"},{name:"literal",value:"'-'"}]},description:""}}};const xi={soknadType:"ST-001",mottattDato:"2019-01-01",begrunnelseForSenInnsending:"Dette er en begrunnelse",søknadsfrist:{mottattDato:"2019-01-01",utledetSøknadsfrist:"2019-07-01",dagerOversittetFrist:2}},Mi={fødselTermin:{fødselsdato:"2019-01-02"}},Bi={title:"prosess/prosess-vilkar-soknadsfrist",component:La,decorators:[hn,An],args:{soknad:xi,familiehendelse:Mi},render:e=>P.jsx(La,{...e})},ra={args:{aksjonspunkterForPanel:[{definisjon:ze.MANUELL_VURDERING_AV_SØKNADSFRISTVILKÅRET,status:"OPPR",vilkarType:"FP_VK_3"}],isReadOnly:!1,status:"IKKE_VURDERT"}},la={args:{aksjonspunkterForPanel:[{definisjon:ze.MANUELL_VURDERING_AV_SØKNADSFRISTVILKÅRET,status:"UTFO",begrunnelse:"Dette vilkåret er godkjent",vilkarType:"FP_VK_3"}],isReadOnly:!0,isSubmittable:!1,status:"OPPFYLT"}},ia={args:{behandling:{uuid:"1",versjon:1,behandlingsresultat:{avslagsarsak:"1099"}},aksjonspunkterForPanel:[{definisjon:ze.MANUELL_VURDERING_AV_SØKNADSFRISTVILKÅRET,status:"UTFO",begrunnelse:"Dette vilkåret er avslått",vilkarType:"FP_VK_3"}],isReadOnly:!0,isSubmittable:!1,status:"IKKE_OPPFYLT"}};ra.parameters={...ra.parameters,docs:{...ra.parameters?.docs,source:{originalSource:`{
  args: {
