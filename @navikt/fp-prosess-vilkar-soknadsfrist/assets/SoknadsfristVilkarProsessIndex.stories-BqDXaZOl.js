...
| 'IKKE_OPPFYLT'
| 'IKKE_VURDERT'
| '-'`,elements:[{name:"literal",value:"'OPPFYLT'"},{name:"literal",value:"'IKKE_OPPFYLT'"},{name:"literal",value:"'IKKE_VURDERT'"},{name:"literal",value:"'-'"}]},description:""}}};const xi={soknadType:"ST-001",mottattDato:"2019-01-01",begrunnelseForSenInnsending:"Dette er en begrunnelse",søknadsfrist:{mottattDato:"2019-01-01",utledetSøknadsfrist:"2019-07-01",dagerOversittetFrist:2}},Mi={fødselTermin:{fødselsdato:"2019-01-02"}},Bi={title:"prosess/prosess-vilkar-soknadsfrist",component:La,decorators:[hn,An],args:{soknad:xi,familiehendelse:Mi},render:e=>V.jsx(La,{...e})},ra={args:{aksjonspunkterForPanel:[{definisjon:ze.MANUELL_VURDERING_AV_SØKNADSFRISTVILKÅRET,status:"OPPR",vilkarType:"FP_VK_3"}],isReadOnly:!1,status:"IKKE_VURDERT"}},la={args:{aksjonspunkterForPanel:[{definisjon:ze.MANUELL_VURDERING_AV_SØKNADSFRISTVILKÅRET,status:"UTFO",begrunnelse:"Dette vilkåret er godkjent",vilkarType:"FP_VK_3"}],isReadOnly:!0,isSubmittable:!1,status:"OPPFYLT"}},ia={args:{behandling:{uuid:"1",versjon:1,behandlingsresultat:{avslagsarsak:"1099"}},aksjonspunkterForPanel:[{definisjon:ze.MANUELL_VURDERING_AV_SØKNADSFRISTVILKÅRET,status:"UTFO",begrunnelse:"Dette vilkåret er avslått",vilkarType:"FP_VK_3"}],isReadOnly:!0,isSubmittable:!1,status:"IKKE_OPPFYLT"}};ra.parameters={...ra.parameters,docs:{...ra.parameters?.docs,source:{originalSource:`{
  args: {
