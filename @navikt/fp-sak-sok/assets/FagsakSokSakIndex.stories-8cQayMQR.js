...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};var Ce=e=>e.type==="checkbox",Le=e=>e instanceof Date,re=e=>e==null;const cn=e=>typeof e=="object";var $=e=>!re(e)&&!Array.isArray(e)&&cn(e)&&!Le(e),pn=e=>$(e)&&e.target?Ce(e.target)?e.target.checked:e.target.value:e,qr=e=>e.substring(0,e.search(/\.\d+(\.|$)/))||e,Un=(e,r)=>e.has(qr(r)),Wr=e=>{const r=e.constructor&&e.constructor.prototype;return $(r)&&r.hasOwnProperty("isPrototypeOf")},Ia=typeof window<"u"&&typeof window.HTMLElement<"u"&&typeof document<"u";function X(e){let r;const n=Array.isArray(e),a=typeof FileList<"u"?e instanceof FileList:!1;if(e instanceof Date)r=new Date(e);else if(!(Ia&&(e instanceof Blob||a))&&(n||$(e)))if(r=n?[]:Object.create(Object.getPrototypeOf(e)),!n&&!Wr(e))r=e;else for(const l in e)e.hasOwnProperty(l)&&(r[l]=X(e[l]));else return e;return r}var ta=e=>/^\w*$/.test(e),q=e=>e===void 0,Da=e=>Array.isArray(e)?e.filter(Boolean):[],Oa=e=>Da(e.replace(/["|']|\]/g,"").split(/\.|\[/)),m=(e,r,n)=>{if(!r||!$(e))return n;const a=(ta(r)?[r]:Oa(r)).reduce((l,t)=>re(l)?l:l[t],e);return q(a)||a===e?q(e[r])?n:e[r]:a},te=e=>typeof e=="boolean",w=(e,r,n)=>{let a=-1;const l=ta(r)?[r]:Oa(r),t=l.length,E=t-1;for(;++a<t;){const v=l[a];let u=n;if(a!==E){const N=e[v];u=$(N)||Array.isArray(N)?N:isNaN(+l[a+1])?{}:[]}if(v==="__proto__"||v==="constructor"||v==="prototype")return;e[v]=u,e=e[v]}};const ea={BLUR:"blur",FOCUS_OUT:"focusout",CHANGE:"change"},oe={onBlur:"onBlur",onChange:"onChange",onSubmit:"onSubmit",onTouched:"onTouched",all:"all"},Ae={max:"max",min:"min",maxLength:"maxLength",minLength:"minLength",pattern:"pattern",required:"required",validate:"validate"},Fa=A.createContext(null);Fa.displayName="HookFormContext";const Ea=()=>A.useContext(Fa),Zr=e=>{const{children:r,...n}=e;return A.createElement(Fa.Provider,{value:n},r)};var Bn=(e,r,n,a=!0)=>{const l={defaultValues:r._defaultValues};for(const t in e)Object.defineProperty(l,t,{get:()=>{const E=t;return r._proxyFormState[E]!==oe.all&&(r._proxyFormState[E]=!a||oe.all),n&&(n[E]=!0),e[E]}});return l};const ga=typeof window<"u"?A.useLayoutEffect:A.useEffect;function $r(e){const r=Ea(),{control:n=r.control,disabled:a,name:l,exact:t}=e||{},[E,v]=A.useState(n._formState),u=A.useRef({isDirty:!1,isLoading:!1,dirtyFields:!1,touchedFields:!1,validatingFields:!1,isValidating:!1,isValid:!1,errors:!1});return ga(()=>n._subscribe({name:l,formState:u.current,exact:t,callback:N=>{!a&&v({...n._formState,...N})}}),[l,a,t]),A.useEffect(()=>{u.current.isValid&&n._setValid(!0)},[n]),A.useMemo(()=>Bn(E,n,u.current,!1),[E,n])}var Ee=e=>typeof e=="string",bn=(e,r,n,a,l)=>Ee(e)?(a&&r.watch.add(e),m(n,e,l)):Array.isArray(e)?e.map(t=>(a&&r.watch.add(t),m(n,t))):(a&&(r.watchAll=!0),n),_a=e=>re(e)||!cn(e);function Ne(e,r,n=new WeakSet){if(_a(e)||_a(r))return e===r;if(Le(e)&&Le(r))return e.getTime()===r.getTime();const a=Object.keys(e),l=Object.keys(r);if(a.length!==l.length)return!1;if(n.has(e)||n.has(r))return!0;n.add(e),n.add(r);for(const t of a){const E=e[t];if(!l.includes(t))return!1;if(t!=="ref"){const v=r[t];if(Le(E)&&Le(v)||$(E)&&$(v)||Array.isArray(E)&&Array.isArray(v)?!Ne(E,v,n):E!==v)return!1}}return!0}function Xr(e){const r=Ea(),{control:n=r.control,name:a,defaultValue:l,disabled:t,exact:E,compute:v}=e||{},u=A.useRef(l),N=A.useRef(v),T=A.useRef(void 0);N.current=v;const d=A.useMemo(()=>n._getWatch(a,u.current),[n,a]),[s,P]=A.useState(N.current?N.current(d):d);return ga(()=>n._subscribe({name:a,formState:{values:!0},exact:E,callback:M=>{if(!t){const F=bn(a,n._names,M.values||n._formValues,!1,u.current);if(N.current){const k=N.current(F);Ne(k,T.current)||(P(k),T.current=k)}else P(F)}}}),[n,t,a,E]),A.useEffect(()=>n._removeUnmounted()),s}function zr(e){const r=Ea(),{name:n,disabled:a,control:l=r.control,shouldUnregister:t,defaultValue:E}=e,v=Un(l._names.array,n),u=A.useMemo(()=>m(l._formValues,n,m(l._defaultValues,n,E)),[l,n,E]),N=Xr({control:l,name:n,defaultValue:u,exact:!0}),T=$r({control:l,name:n,exact:!0}),d=A.useRef(e),s=A.useRef(void 0),P=A.useRef(l.register(n,{...e.rules,value:N,...te(e.disabled)?{disabled:e.disabled}:{}}));d.current=e;const M=A.useMemo(()=>Object.defineProperties({},{invalid:{enumerable:!0,get:()=>!!m(T.errors,n)},isDirty:{enumerable:!0,get:()=>!!m(T.dirtyFields,n)},isTouched:{enumerable:!0,get:()=>!!m(T.touchedFields,n)},isValidating:{enumerable:!0,get:()=>!!m(T.validatingFields,n)},error:{enumerable:!0,get:()=>m(T.errors,n)}}),[T,n]),F=A.useCallback(D=>P.current.onChange({target:{value:pn(D),name:n},type:ea.CHANGE}),[n]),k=A.useCallback(()=>P.current.onBlur({target:{value:m(l._formValues,n),name:n},type:ea.BLUR}),[n,l._formValues]),g=A.useCallback(D=>{const y=m(l._fields,n);y&&D&&(y._f.ref={focus:()=>D.focus&&D.focus(),select:()=>D.select&&D.select(),setCustomValidity:f=>D.setCustomValidity(f),reportValidity:()=>D.reportValidity()})},[l._fields,n]),I=A.useMemo(()=>({name:n,value:N,...te(a)||T.disabled?{disabled:T.disabled||a}:{},onChange:F,onBlur:k,ref:g}),[n,a,T.disabled,F,k,g,N]);return A.useEffect(()=>{const D=l._options.shouldUnregister||t,y=s.current;y&&y!==n&&!v&&l.unregister(y),l.register(n,{...d.current.rules,...te(d.current.disabled)?{disabled:d.current.disabled}:{}});const f=(b,J)=>{const C=m(l._fields,b);C&&C._f&&(C._f.mount=J)};if(f(n,!0),D){const b=X(m(l._options.defaultValues,n,d.current.defaultValue));w(l._defaultValues,n,b),q(m(l._formValues,n))&&w(l._formValues,n,b)}return!v&&l.register(n),s.current=n,()=>{(v?D&&!l._state.action:D)?l.unregister(n):f(n,!1)}},[n,l,v,t]),A.useEffect(()=>{l._setDisabledField({disabled:a,name:n})},[a,n,l]),A.useMemo(()=>({field:I,formState:T,fieldState:M}),[I,T,M])}var Qr=(e,r,n,a,l)=>r?{...n[e],types:{...n[e]&&n[e].types?n[e].types:{},[a]:l||!0}}:{},we=e=>Array.isArray(e)?e:[e],Ja=()=>{let e=[];return{get observers(){return e},next:l=>{for(const t of e)t.next&&t.next(l)},subscribe:l=>(e.push(l),{unsubscribe:()=>{e=e.filter(t=>t!==l)}}),unsubscribe:()=>{e=[]}}};function hn(e,r){const n={};for(const a in e)if(e.hasOwnProperty(a)){const l=e[a],t=r[a];if(l&&$(l)&&t){const E=hn(l,t);$(E)&&(n[a]=E)}else e[a]&&(n[a]=t)}return n}var le=e=>$(e)&&!Object.keys(e).length,Ga=e=>e.type==="file",Te=e=>typeof e=="function",aa=e=>{if(!Ia)return!1;const r=e?e.ownerDocument:0;return e instanceof(r&&r.defaultView?r.defaultView.HTMLElement:HTMLElement)},Hn=e=>e.type==="select-multiple",Pa=e=>e.type==="radio",et=e=>Pa(e)||Ce(e),Aa=e=>aa(e)&&e.isConnected;function at(e,r){const n=r.slice(0,-1).length;let a=0;for(;a<n;)e=q(e)?a++:e[r[a++]];return e}function nt(e){for(const r in e)if(e.hasOwnProperty(r)&&!q(e[r]))return!1;return!0}function Z(e,r){const n=Array.isArray(r)?r:ta(r)?[r]:Oa(r),a=n.length===1?e:at(e,n),l=n.length-1,t=n[l];return a&&delete a[t],l!==0&&($(a)&&le(a)||Array.isArray(a)&&nt(a))&&Z(e,n.slice(0,-1)),e}var lt=e=>{for(const r in e)if(Te(e[r]))return!0;return!1};function Yn(e){return Array.isArray(e)||$(e)&&!lt(e)}function ka(e,r={}){for(const n in e)Yn(e[n])?(r[n]=Array.isArray(e[n])?[]:{},ka(e[n],r[n])):q(e[n])||(r[n]=!0);return r}function Ge(e,r,n){n||(n=ka(r));for(const a in e)Yn(e[a])?q(r)||_a(n[a])?n[a]=ka(e[a],Array.isArray(e[a])?[]:{}):Ge(e[a],re(r)?{}:r[a],n[a]):n[a]=!Ne(e[a],r[a]);return n}const ja={value:!1,isValid:!1},Ca={value:!0,isValid:!0};var wn=e=>{if(Array.isArray(e)){if(e.length>1){const r=e.filter(n=>n&&n.checked&&!n.disabled).map(n=>n.value);return{value:r,isValid:!!r.length}}return e[0].checked&&!e[0].disabled?e[0].attributes&&!q(e[0].attributes.value)?q(e[0].value)||e[0].value===""?Ca:{value:e[0].value,isValid:!0}:Ca:ja}return ja},Jn=(e,{valueAsNumber:r,valueAsDate:n,setValueAs:a})=>q(e)?e:r?e===""?NaN:e&&+e:n&&Ee(e)?new Date(e):a?a(e):e;const xa={isValid:!1,value:null};var jn=e=>Array.isArray(e)?e.reduce((r,n)=>n&&n.checked&&!n.disabled?{isValid:!0,value:n.value}:r,xa):xa;function qa(e){const r=e.ref;return Ga(r)?r.files:Pa(r)?jn(e.refs).value:Hn(r)?[...r.selectedOptions].map(({value:n})=>n):Ce(r)?wn(e.refs).value:Jn(q(r.value)?e.ref.value:r.value,e)}var rt=(e,r,n,a)=>{const l={};for(const t of e){const E=m(r,t);E&&w(l,t,E._f)}return{criteriaMode:n,names:[...e],fields:l,shouldUseNativeValidation:a}},na=e=>e instanceof RegExp,he=e=>q(e)?e:na(e)?e.source:$(e)?na(e.value)?e.value.source:e.value:e,Wa=e=>({isOnSubmit:!e||e===oe.onSubmit,isOnBlur:e===oe.onBlur,isOnChange:e===oe.onChange,isOnAll:e===oe.all,isOnTouch:e===oe.onTouched});const Za="AsyncFunction";var tt=e=>!!e&&!!e.validate&&!!(Te(e.validate)&&e.validate.constructor.name===Za||$(e.validate)&&Object.values(e.validate).find(r=>r.constructor.name===Za)),Et=e=>e.mount&&(e.required||e.min||e.max||e.maxLength||e.minLength||e.pattern||e.validate),$a=(e,r,n)=>!n&&(r.watchAll||r.watch.has(e)||[...r.watch].some(a=>e.startsWith(a)&&/^\.\w+/.test(e.slice(a.length))));const Je=(e,r,n,a)=>{for(const l of n||Object.keys(e)){const t=m(e,l);if(t){const{_f:E,...v}=t;if(E){if(E.refs&&E.refs[0]&&r(E.refs[0],l)&&!a)return!0;if(E.ref&&r(E.ref,E.name)&&!a)return!0;if(Je(v,r))break}else if($(v)&&Je(v,r))break}}};function Xa(e,r,n){const a=m(e,n);if(a||ta(n))return{error:a,name:n};const l=n.split(".");for(;l.length;){const t=l.join("."),E=m(r,t),v=m(e,t);if(E&&!Array.isArray(E)&&n!==t)return{name:n};if(v&&v.type)return{name:t,error:v};if(v&&v.root&&v.root.type)return{name:`${t}.root`,error:v.root};l.pop()}return{name:n}}var it=(e,r,n,a)=>{n(e);const{name:l,...t}=e;return le(t)||Object.keys(t).length>=Object.keys(r).length||Object.keys(t).find(E=>r[E]===(!a||oe.all))},vt=(e,r,n)=>!e||!r||e===r||we(e).some(a=>a&&(n?a===r:a.startsWith(r)||r.startsWith(a))),Rt=(e,r,n,a,l)=>l.isOnAll?!1:!n&&l.isOnTouch?!(r||e):(n?a.isOnBlur:l.isOnBlur)?!e:(n?a.isOnChange:l.isOnChange)?e:!0,ot=(e,r)=>!Da(m(e,r)).length&&Z(e,r),Tt=(e,r,n)=>{const a=we(m(e,n));return w(a,"root",r[n]),w(e,n,a),e};function za(e,r,n="validate"){if(Ee(e)||Array.isArray(e)&&e.every(Ee)||te(e)&&!e)return{type:n,message:Ee(e)?e:"",ref:r}}var ge=e=>$(e)&&!na(e)?e:{value:e,message:""},Qa=async(e,r,n,a,l,t)=>{const{ref:E,refs:v,required:u,maxLength:N,minLength:T,min:d,max:s,pattern:P,validate:M,name:F,valueAsNumber:k,mount:g}=e._f,I=m(n,F);if(!g||r.has(F))return{};const D=v?v[0]:E,y=V=>{l&&D.reportValidity&&(D.setCustomValidity(te(V)?"":V||""),D.reportValidity())},f={},b=Pa(E),J=Ce(E),C=b||J,H=(k||Ga(E))&&q(E.value)&&q(I)||aa(E)&&E.value===""||I===""||Array.isArray(I)&&!I.length,W=Qr.bind(null,F,a,f),U=(V,L,c,h=Ae.maxLength,x=Ae.minLength)=>{const ee=V?L:c;f[F]={type:V?h:x,message:ee,ref:E,...W(V?h:x,ee)}};if(t?!Array.isArray(I)||!I.length:u&&(!C&&(H||re(I))||te(I)&&!I||J&&!wn(v).isValid||b&&!jn(v).isValid)){const{value:V,message:L}=Ee(u)?{value:!!u,message:u}:ge(u);if(V&&(f[F]={type:Ae.required,message:L,ref:D,...W(Ae.required,L)},!a))return y(L),f}if(!H&&(!re(d)||!re(s))){let V,L;const c=ge(s),h=ge(d);if(!re(I)&&!isNaN(I)){const x=E.valueAsNumber||I&&+I;re(c.value)||(V=x>c.value),re(h.value)||(L=x<h.value)}else{const x=E.valueAsDate||new Date(I),ee=ue=>new Date(new Date().toDateString()+" "+ue),ie=E.type=="time",ne=E.type=="week";Ee(c.value)&&I&&(V=ie?ee(I)>ee(c.value):ne?I>c.value:x>new Date(c.value)),Ee(h.value)&&I&&(L=ie?ee(I)<ee(h.value):ne?I<h.value:x<new Date(h.value))}if((V||L)&&(U(!!V,c.message,h.message,Ae.max,Ae.min),!a))return y(f[F].message),f}if((N||T)&&!H&&(Ee(I)||t&&Array.isArray(I))){const V=ge(N),L=ge(T),c=!re(V.value)&&I.length>+V.value,h=!re(L.value)&&I.length<+L.value;if((c||h)&&(U(c,V.message,L.message),!a))return y(f[F].message),f}if(P&&!H&&Ee(I)){const{value:V,message:L}=ge(P);if(na(V)&&!I.match(V)&&(f[F]={type:Ae.pattern,message:L,ref:E,...W(Ae.pattern,L)},!a))return y(L),f}if(M){if(Te(M)){const V=await M(I,n),L=za(V,D);if(L&&(f[F]={...L,...W(Ae.validate,L.message)},!a))return y(L.message),f}else if($(M)){let V={};for(const L in M){if(!le(V)&&!a)break;const c=za(await M[L](I,n),D,L);c&&(V={...c,...W(L,c.message)},y(c.message),a&&(f[F]=V))}if(!le(V)&&(f[F]={ref:D,...V},!a))return f}}return y(!0),f};const ut={mode:oe.onSubmit,reValidateMode:oe.onChange,shouldFocusError:!0};function At(e={}){let r={...ut,...e},n={submitCount:0,isDirty:!1,isReady:!1,isLoading:Te(r.defaultValues),isValidating:!1,isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,touchedFields:{},dirtyFields:{},validatingFields:{},errors:r.errors||{},disabled:r.disabled||!1},a={},l=$(r.defaultValues)||$(r.values)?X(r.defaultValues||r.values)||{}:{},t=r.shouldUnregister?{}:X(l),E={action:!1,mount:!1,watch:!1},v={mount:new Set,disabled:new Set,unMount:new Set,array:new Set,watch:new Set},u,N=0;const T={isDirty:!1,dirtyFields:!1,validatingFields:!1,touchedFields:!1,isValidating:!1,isValid:!1,errors:!1};let d={...T};const s={array:Ja(),state:Ja()},P=r.criteriaMode===oe.all,M=i=>R=>{clearTimeout(N),N=setTimeout(i,R)},F=async i=>{if(!r.disabled&&(T.isValid||d.isValid||i)){const R=r.resolver?le((await J()).errors):await H(a,!0);R!==n.isValid&&s.state.next({isValid:R})}},k=(i,R)=>{!r.disabled&&(T.isValidating||T.validatingFields||d.isValidating||d.validatingFields)&&((i||Array.from(v.mount)).forEach(o=>{o&&(R?w(n.validatingFields,o,R):Z(n.validatingFields,o))}),s.state.next({validatingFields:n.validatingFields,isValidating:!le(n.validatingFields)}))},g=(i,R=[],o,K,S=!0,_=!0)=>{if(K&&o&&!r.disabled){if(E.action=!0,_&&Array.isArray(m(a,i))){const G=o(m(a,i),K.argA,K.argB);S&&w(a,i,G)}if(_&&Array.isArray(m(n.errors,i))){const G=o(m(n.errors,i),K.argA,K.argB);S&&w(n.errors,i,G),ot(n.errors,i)}if((T.touchedFields||d.touchedFields)&&_&&Array.isArray(m(n.touchedFields,i))){const G=o(m(n.touchedFields,i),K.argA,K.argB);S&&w(n.touchedFields,i,G)}(T.dirtyFields||d.dirtyFields)&&(n.dirtyFields=Ge(l,t)),s.state.next({name:i,isDirty:U(i,R),dirtyFields:n.dirtyFields,errors:n.errors,isValid:n.isValid})}else w(t,i,R)},I=(i,R)=>{w(n.errors,i,R),s.state.next({errors:n.errors})},D=i=>{n.errors=i,s.state.next({errors:n.errors,isValid:!1})},y=(i,R,o,K)=>{const S=m(a,i);if(S){const _=m(t,i,q(o)?m(l,i):o);q(_)||K&&K.defaultChecked||R?w(t,i,R?_:qa(S._f)):c(i,_),E.mount&&F()}},f=(i,R,o,K,S)=>{let _=!1,G=!1;const B={name:i};if(!r.disabled){if(!o||K){(T.isDirty||d.isDirty)&&(G=n.isDirty,n.isDirty=B.isDirty=U(),_=G!==B.isDirty);const Y=Ne(m(l,i),R);G=!!m(n.dirtyFields,i),Y?Z(n.dirtyFields,i):w(n.dirtyFields,i,!0),B.dirtyFields=n.dirtyFields,_=_||(T.dirtyFields||d.dirtyFields)&&G!==!Y}if(o){const Y=m(n.touchedFields,i);Y||(w(n.touchedFields,i,o),B.touchedFields=n.touchedFields,_=_||(T.touchedFields||d.touchedFields)&&Y!==o)}_&&S&&s.state.next(B)}return _?B:{}},b=(i,R,o,K)=>{const S=m(n.errors,i),_=(T.isValid||d.isValid)&&te(R)&&n.isValid!==R;if(r.delayError&&o?(u=M(()=>I(i,o)),u(r.delayError)):(clearTimeout(N),u=null,o?w(n.errors,i,o):Z(n.errors,i)),(o?!Ne(S,o):S)||!le(K)||_){const G={...K,..._&&te(R)?{isValid:R}:{},errors:n.errors,name:i};n={...n,...G},s.state.next(G)}},J=async i=>{k(i,!0);const R=await r.resolver(t,r.context,rt(i||v.mount,a,r.criteriaMode,r.shouldUseNativeValidation));return k(i),R},C=async i=>{const{errors:R}=await J(i);if(i)for(const o of i){const K=m(R,o);K?w(n.errors,o,K):Z(n.errors,o)}else n.errors=R;return R},H=async(i,R,o={valid:!0})=>{for(const K in i){const S=i[K];if(S){const{_f:_,...G}=S;if(_){const B=v.array.has(_.name),Y=S._f&&tt(S._f);Y&&T.validatingFields&&k([_.name],!0);const ve=await Qa(S,v.disabled,t,P,r.shouldUseNativeValidation&&!R,B);if(Y&&T.validatingFields&&k([_.name]),ve[_.name]&&(o.valid=!1,R))break;!R&&(m(ve,_.name)?B?Tt(n.errors,ve,_.name):w(n.errors,_.name,ve[_.name]):Z(n.errors,_.name))}!le(G)&&await H(G,R,o)}}return o.valid},W=()=>{for(const i of v.unMount){const R=m(a,i);R&&(R._f.refs?R._f.refs.every(o=>!Aa(o)):!Aa(R._f.ref))&&fe(i)}v.unMount=new Set},U=(i,R)=>!r.disabled&&(i&&R&&w(t,i,R),!Ne(ue(),l)),V=(i,R,o)=>bn(i,v,{...E.mount?t:q(R)?l:Ee(i)?{[i]:R}:R},o,R),L=i=>Da(m(E.mount?t:l,i,r.shouldUnregister?m(l,i,[]):[])),c=(i,R,o={})=>{const K=m(a,i);let S=R;if(K){const _=K._f;_&&(!_.disabled&&w(t,i,Jn(R,_)),S=aa(_.ref)&&re(R)?"":R,Hn(_.ref)?[..._.ref.options].forEach(G=>G.selected=S.includes(G.value)):_.refs?Ce(_.ref)?_.refs.forEach(G=>{(!G.defaultChecked||!G.disabled)&&(Array.isArray(S)?G.checked=!!S.find(B=>B===G.value):G.checked=S===G.value||!!S)}):_.refs.forEach(G=>G.checked=G.value===S):Ga(_.ref)?_.ref.value="":(_.ref.value=S,_.ref.type||s.state.next({name:i,values:X(t)})))}(o.shouldDirty||o.shouldTouch)&&f(i,S,o.shouldTouch,o.shouldDirty,!0),o.shouldValidate&&ne(i)},h=(i,R,o)=>{for(const K in R){if(!R.hasOwnProperty(K))return;const S=R[K],_=i+"."+K,G=m(a,_);(v.array.has(i)||$(S)||G&&!G._f)&&!Le(S)?h(_,S,o):c(_,S,o)}},x=(i,R,o={})=>{const K=m(a,i),S=v.array.has(i),_=X(R);w(t,i,_),S?(s.array.next({name:i,values:X(t)}),(T.isDirty||T.dirtyFields||d.isDirty||d.dirtyFields)&&o.shouldDirty&&s.state.next({name:i,dirtyFields:Ge(l,t),isDirty:U(i,_)})):K&&!K._f&&!re(_)?h(i,_,o):c(i,_,o),$a(i,v)&&s.state.next({...n,name:i}),s.state.next({name:E.mount?i:void 0,values:X(t)})},ee=async i=>{E.mount=!0;const R=i.target;let o=R.name,K=!0;const S=m(a,o),_=Y=>{K=Number.isNaN(Y)||Le(Y)&&isNaN(Y.getTime())||Ne(Y,m(t,o,Y))},G=Wa(r.mode),B=Wa(r.reValidateMode);if(S){let Y,ve;const $e=R.type?qa(S._f):pn(i),se=i.type===ea.BLUR||i.type===ea.FOCUS_OUT,qn=!Et(S._f)&&!r.resolver&&!m(n.errors,o)&&!S._f.deps||Rt(se,m(n.touchedFields,o),n.isSubmitted,B,G),Ra=$a(o,v,se);w(t,o,$e),se?(!R||!R.readOnly)&&(S._f.onBlur&&S._f.onBlur(i),u&&u(0)):S._f.onChange&&S._f.onChange(i);const oa=f(o,$e,se),Wn=!le(oa)||Ra;if(!se&&s.state.next({name:o,type:i.type,values:X(t)}),qn)return(T.isValid||d.isValid)&&(r.mode==="onBlur"?se&&F():se||F()),Wn&&s.state.next({name:o,...Ra?{}:oa});if(!se&&Ra&&s.state.next({...n}),r.resolver){const{errors:Ma}=await J([o]);if(_($e),K){const Zn=Xa(n.errors,a,o),fa=Xa(Ma,a,Zn.name||o);Y=fa.error,o=fa.name,ve=le(Ma)}}else k([o],!0),Y=(await Qa(S,v.disabled,t,P,r.shouldUseNativeValidation))[o],k([o]),_($e),K&&(Y?ve=!1:(T.isValid||d.isValid)&&(ve=await H(a,!0)));K&&(S._f.deps&&(!Array.isArray(S._f.deps)||S._f.deps.length>0)&&ne(S._f.deps),b(o,ve,Y,oa))}},ie=(i,R)=>{if(m(n.errors,R)&&i.focus)return i.focus(),1},ne=async(i,R={})=>{let o,K;const S=we(i);if(r.resolver){const _=await C(q(i)?i:S);o=le(_),K=i?!S.some(G=>m(_,G)):o}else i?(K=(await Promise.all(S.map(async _=>{const G=m(a,_);return await H(G&&G._f?{[_]:G}:G)}))).every(Boolean),!(!K&&!n.isValid)&&F()):K=o=await H(a);return s.state.next({...!Ee(i)||(T.isValid||d.isValid)&&o!==n.isValid?{}:{name:i},...r.resolver||!i?{isValid:o}:{},errors:n.errors}),R.shouldFocus&&!K&&Je(a,ie,i?S:v.mount),K},ue=(i,R)=>{let o={...E.mount?t:l};return R&&(o=hn(R.dirtyFields?n.dirtyFields:n.touchedFields,o)),q(i)?o:Ee(i)?m(o,i):i.map(K=>m(o,K))},ae=(i,R)=>({invalid:!!m((R||n).errors,i),isDirty:!!m((R||n).dirtyFields,i),error:m((R||n).errors,i),isValidating:!!m(n.validatingFields,i),isTouched:!!m((R||n).touchedFields,i)}),Me=i=>{i&&we(i).forEach(R=>Z(n.errors,R)),s.state.next({errors:i?n.errors:{}})},ke=(i,R,o)=>{const K=(m(a,i,{_f:{}})._f||{}).ref,S=m(n.errors,i)||{},{ref:_,message:G,type:B,...Y}=S;w(n.errors,i,{...Y,...R,ref:K}),s.state.next({name:i,errors:n.errors,isValid:!1}),o&&o.shouldFocus&&K&&K.focus&&K.focus()},ia=(i,R)=>Te(i)?s.state.subscribe({next:o=>"values"in o&&i(V(void 0,R),o)}):V(i,R,!0),qe=i=>s.state.subscribe({next:R=>{vt(i.name,R.name,i.exact)&&it(R,i.formState||T,Ue,i.reRenderRoot)&&i.callback({values:{...t},...n,...R,defaultValues:l})}}).unsubscribe,va=i=>(E.mount=!0,d={...d,...i.formState},qe({...i,formState:d})),fe=(i,R={})=>{for(const o of i?we(i):v.mount)v.mount.delete(o),v.array.delete(o),R.keepValue||(Z(a,o),Z(t,o)),!R.keepError&&Z(n.errors,o),!R.keepDirty&&Z(n.dirtyFields,o),!R.keepTouched&&Z(n.touchedFields,o),!R.keepIsValidating&&Z(n.validatingFields,o),!r.shouldUnregister&&!R.keepDefaultValue&&Z(l,o);s.state.next({values:X(t)}),s.state.next({...n,...R.keepDirty?{isDirty:U()}:{}}),!R.keepIsValid&&F()},We=({disabled:i,name:R})=>{(te(i)&&E.mount||i||v.disabled.has(R))&&(i?v.disabled.add(R):v.disabled.delete(R))},Ie=(i,R={})=>{let o=m(a,i);const K=te(R.disabled)||te(r.disabled);return w(a,i,{...o||{},_f:{...o&&o._f?o._f:{ref:{name:i}},name:i,mount:!0,...R}}),v.mount.add(i),o?We({disabled:te(R.disabled)?R.disabled:r.disabled,name:i}):y(i,!0,R.value),{...K?{disabled:R.disabled||r.disabled}:{},...r.progressive?{required:!!R.required,min:he(R.min),max:he(R.max),minLength:he(R.minLength),maxLength:he(R.maxLength),pattern:he(R.pattern)}:{},name:i,onChange:ee,onBlur:ee,ref:S=>{if(S){Ie(i,R),o=m(a,i);const _=q(S.value)&&S.querySelectorAll&&S.querySelectorAll("input,select,textarea")[0]||S,G=et(_),B=o._f.refs||[];if(G?B.find(Y=>Y===_):_===o._f.ref)return;w(a,i,{_f:{...o._f,...G?{refs:[...B.filter(Aa),_,...Array.isArray(m(l,i))?[{}]:[]],ref:{type:_.type,name:i}}:{ref:_}}}),y(i,!1,void 0,_)}else o=m(a,i,{}),o._f&&(o._f.mount=!1),(r.shouldUnregister||R.shouldUnregister)&&!(Un(v.array,i)&&E.action)&&v.unMount.add(i)}}},De=()=>r.shouldFocusError&&Je(a,ie,v.mount),ye=i=>{te(i)&&(s.state.next({disabled:i}),Je(a,(R,o)=>{const K=m(a,o);K&&(R.disabled=K._f.disabled||i,Array.isArray(K._f.refs)&&K._f.refs.forEach(S=>{S.disabled=K._f.disabled||i}))},0,!1))},Oe=(i,R)=>async o=>{let K;o&&(o.preventDefault&&o.preventDefault(),o.persist&&o.persist());let S=X(t);if(s.state.next({isSubmitting:!0}),r.resolver){const{errors:_,values:G}=await J();n.errors=_,S=X(G)}else await H(a);if(v.disabled.size)for(const _ of v.disabled)Z(S,_);if(Z(n.errors,"root"),le(n.errors)){s.state.next({errors:{}});try{await i(S,o)}catch(_){K=_}}else R&&await R({...n.errors},o),De(),setTimeout(De);if(s.state.next({isSubmitted:!0,isSubmitting:!1,isSubmitSuccessful:le(n.errors)&&!K,submitCount:n.submitCount+1,errors:n.errors}),K)throw K},ce=(i,R={})=>{m(a,i)&&(q(R.defaultValue)?x(i,X(m(l,i))):(x(i,R.defaultValue),w(l,i,X(R.defaultValue))),R.keepTouched||Z(n.touchedFields,i),R.keepDirty||(Z(n.dirtyFields,i),n.isDirty=R.defaultValue?U(i,X(m(l,i))):U()),R.keepError||(Z(n.errors,i),T.isValid&&F()),s.state.next({...n}))},Se=(i,R={})=>{const o=i?X(i):l,K=X(o),S=le(i),_=S?l:K;if(R.keepDefaultValues||(l=o),!R.keepValues){if(R.keepDirtyValues){const G=new Set([...v.mount,...Object.keys(Ge(l,t))]);for(const B of Array.from(G))m(n.dirtyFields,B)?w(_,B,m(t,B)):x(B,m(_,B))}else{if(Ia&&q(i))for(const G of v.mount){const B=m(a,G);if(B&&B._f){const Y=Array.isArray(B._f.refs)?B._f.refs[0]:B._f.ref;if(aa(Y)){const ve=Y.closest("form");if(ve){ve.reset();break}}}}if(R.keepFieldsRef)for(const G of v.mount)x(G,m(_,G));else a={}}t=r.shouldUnregister?R.keepDefaultValues?X(l):{}:X(_),s.array.next({values:{..._}}),s.state.next({values:{..._}})}v={mount:R.keepDirtyValues?v.mount:new Set,unMount:new Set,array:new Set,disabled:new Set,watch:new Set,watchAll:!1,focus:""},E.mount=!T.isValid||!!R.keepIsValid||!!R.keepDirtyValues,E.watch=!!r.shouldUnregister,s.state.next({submitCount:R.keepSubmitCount?n.submitCount:0,isDirty:S?!1:R.keepDirty?n.isDirty:!!(R.keepDefaultValues&&!Ne(i,l)),isSubmitted:R.keepIsSubmitted?n.isSubmitted:!1,dirtyFields:S?{}:R.keepDirtyValues?R.keepDefaultValues&&t?Ge(l,t):n.dirtyFields:R.keepDefaultValues&&i?Ge(l,i):R.keepDirty?n.dirtyFields:{},touchedFields:R.keepTouched?n.touchedFields:{},errors:R.keepErrors?n.errors:{},isSubmitSuccessful:R.keepIsSubmitSuccessful?n.isSubmitSuccessful:!1,isSubmitting:!1,defaultValues:l})},me=(i,R)=>Se(Te(i)?i(t):i,R),pe=(i,R={})=>{const o=m(a,i),K=o&&o._f;if(K){const S=K.refs?K.refs[0]:K.ref;S.focus&&(S.focus(),R.shouldSelect&&Te(S.select)&&S.select())}},Ue=i=>{n={...n,...i}},Fe={control:{register:Ie,unregister:fe,getFieldState:ae,handleSubmit:Oe,setError:ke,_subscribe:qe,_runSchema:J,_focusError:De,_getWatch:V,_getDirty:U,_setValid:F,_setFieldArray:g,_setDisabledField:We,_setErrors:D,_getFieldArray:L,_reset:Se,_resetDefaultValues:()=>Te(r.defaultValues)&&r.defaultValues().then(i=>{me(i,r.resetOptions),s.state.next({isLoading:!1})}),_removeUnmounted:W,_disableForm:ye,_subjects:s,_proxyFormState:T,get _fields(){return a},get _formValues(){return t},get _state(){return E},set _state(i){E=i},get _defaultValues(){return l},get _names(){return v},set _names(i){v=i},get _formState(){return n},get _options(){return r},set _options(i){r={...r,...i}}},subscribe:va,trigger:ne,register:Ie,handleSubmit:Oe,watch:ia,setValue:x,getValues:ue,reset:me,resetField:ce,clearErrors:Me,unregister:fe,setError:ke,setFocus:pe,getFieldState:ae};return{...Fe,formControl:Fe}}function Nt(e={}){const r=A.useRef(void 0),n=A.useRef(void 0),[a,l]=A.useState({isDirty:!1,isValidating:!1,isLoading:Te(e.defaultValues),isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,submitCount:0,dirtyFields:{},touchedFields:{},validatingFields:{},errors:e.errors||{},disabled:e.disabled||!1,isReady:!1,defaultValues:Te(e.defaultValues)?void 0:e.defaultValues});if(!r.current)if(e.formControl)r.current={...e.formControl,formState:a},e.defaultValues&&!Te(e.defaultValues)&&e.formControl.reset(e.defaultValues,e.resetOptions);else{const{formControl:E,...v}=At(e);r.current={...v,formState:a}}const t=r.current.control;return t._options=e,ga(()=>{const E=t._subscribe({formState:t._proxyFormState,callback:()=>l({...t._formState}),reRenderRoot:!0});return l(v=>({...v,isReady:!0})),t._formState.isReady=!0,E},[t]),A.useEffect(()=>t._disableForm(e.disabled),[t,e.disabled]),A.useEffect(()=>{e.mode&&(t._options.mode=e.mode),e.reValidateMode&&(t._options.reValidateMode=e.reValidateMode)},[t,e.mode,e.reValidateMode]),A.useEffect(()=>{e.errors&&(t._setErrors(e.errors),t._focusError())},[t,e.errors]),A.useEffect(()=>{e.shouldUnregister&&t._subjects.state.next({values:t._getWatch()})},[t,e.shouldUnregister]),A.useEffect(()=>{if(t._proxyFormState.isDirty){const E=t._getDirty();E!==a.isDirty&&t._subjects.state.next({isDirty:E})}},[t,a.isDirty]),A.useEffect(()=>{e.values&&!Ne(e.values,n.current)?(t._reset(e.values,{keepFieldsRef:!0,...t._options.resetOptions}),n.current=e.values,l(E=>({...E}))):t._resetDefaultValues()},[t,e.values]),A.useEffect(()=>{t._state.mount||(t._setValid(),t._state.mount=!0),t._state.watch&&(t._state.watch=!1,t._subjects.state.next({...t._formState})),t._removeUnmounted()}),r.current.formState=Bn(a,t),r.current}function dt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var en={exports:{}},He={};/**
 * @license React
 ...
 */var an;function st(){if(an)return He;an=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var v in l)v!=="key"&&(t[v]=l[v])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return He.Fragment=r,He.jsx=n,He.jsxs=n,He}var nn;function _t(){return nn||(nn=1,en.exports=st()),en.exports}var ln=_t();const xe={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre","KopierbarTekst.Kopier":"Klikk for å kopiere","KopierbarTekst.Kopiert":"Kopiert!"};Pe(xe);var rn={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var tn;function kt(){return tn||(tn=1,(function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var v=arguments[E];v&&(t=l(t,a.call(this,v)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return this&&this[t]||t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(this,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var v in t)r.call(t,v)&&t[v]&&(E=l(E,this&&this[v]||v));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(rn)),rn.exports}var St=kt();const Va=dt(St),mt="_borderbox_1a0x6_1",Lt="_error_1a0x6_5",Kt="_warning_1a0x6_8",It={borderbox:mt,error:Lt,warning:Kt};Va.bind(It);const Dt="_aksjonspunkt_11wjs_1",Ot="_erAksjonspunktApent_11wjs_4",Ft="_erIkkeGodkjentAvBeslutter_11wjs_8",gt={aksjonspunkt:Dt,erAksjonspunktApent:Ot,erIkkeGodkjentAvBeslutter:Ft};Va.bind(gt);Pe(xe);Pe(xe);const Gt="_divider_1jpov_1",Pt="_dividerParagraf_1jpov_8",Vt="_leftPanel_1jpov_11",Mt="_rightPanel_1jpov_14",ft={divider:Gt,dividerParagraf:Pt,leftPanel:Vt,rightPanel:Mt};Va.bind(ft);const yt=()=>ln.jsx("span",{"data-testid":"editedIcon",children:ln.jsx(Sl,{title:"Saksbehandler har endret feltets verdi",height:20,width:20,color:"var(--ax-text-neutral)"})});Pe(xe);Pe(xe);var Na={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var En;function ct(){return En||(En=1,(function(e){(function(){var r={}.hasOwnProperty;function n(){for(var t="",E=0;E<arguments.length;E++){var v=arguments[E];v&&(t=l(t,a(v)))}return t}function a(t){if(typeof t=="string"||typeof t=="number")return t;if(typeof t!="object")return"";if(Array.isArray(t))return n.apply(null,t);if(t.toString!==Object.prototype.toString&&!t.toString.toString().includes("[native code]"))return t.toString();var E="";for(var v in t)r.call(t,v)&&t[v]&&(E=l(E,v));return E}function l(t,E){return E?t?t+" "+E:t+E:t}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(Na)),Na.exports}ct();function pt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var vn={exports:{}},Ye={};/**
 * @license React
 * react-jsx-runtime.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rn;function Ut(){if(Rn)return Ye;Rn=1;var e=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function n(a,l,t){var E=null;if(t!==void 0&&(E=""+t),l.key!==void 0&&(E=""+l.key),"key"in l){t={};for(var v in l)v!=="key"&&(t[v]=l[v])}else t=l;return l=t.ref,{$$typeof:e,type:a,key:E,ref:l!==void 0?l:null,props:t}}return Ye.Fragment=r,Ye.jsx=n,Ye.jsxs=n,Ye}var on;function Bt(){return on||(on=1,vn.exports=Ut()),vn.exports}var de=Bt();const bt=e=>e.reduce((r,n,a)=>({...r,[a]:l=>n(l)||!0}),{}),ht=(e,r)=>r.split(".").reduce((n,a)=>n!==void 0?n[a]:n,e)?.message;var Sa={exports:{}},Ht=Sa.exports,Tn;function Yt(){return Tn||(Tn=1,(function(e,r){(function(n,a){e.exports=a()})(Ht,function(){var n={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},a=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,l=/\d/,t=/\d\d/,E=/\d\d?/,v=/\d*[^-_:/,()\s\d]+/,u={},N=function(k){return(k=+k)+(k>68?1900:2e3)},T=function(k){return function(g){this[k]=+g}},d=[/[+-]\d\d:?(\d\d)?|Z/,function(k){(this.zone||(this.zone={})).offset=(function(g){if(!g||g==="Z")return 0;var I=g.match(/([+-]|\d\d)/g),D=60*I[1]+(+I[2]||0);return D===0?0:I[0]==="+"?-D:D})(k)}],s=function(k){var g=u[k];return g&&(g.indexOf?g:g.s.concat(g.f))},P=function(k,g){var I,D=u.meridiem;if(D){for(var y=1;y<=24;y+=1)if(k.indexOf(D(y,0,g))>-1){I=y>12;break}}else I=k===(g?"pm":"PM");return I},M={A:[v,function(k){this.afternoon=P(k,!1)}],a:[v,function(k){this.afternoon=P(k,!0)}],Q:[l,function(k){this.month=3*(k-1)+1}],S:[l,function(k){this.milliseconds=100*+k}],SS:[t,function(k){this.milliseconds=10*+k}],SSS:[/\d{3}/,function(k){this.milliseconds=+k}],s:[E,T("seconds")],ss:[E,T("seconds")],m:[E,T("minutes")],mm:[E,T("minutes")],H:[E,T("hours")],h:[E,T("hours")],HH:[E,T("hours")],hh:[E,T("hours")],D:[E,T("day")],DD:[t,T("day")],Do:[v,function(k){var g=u.ordinal,I=k.match(/\d+/);if(this.day=I[0],g)for(var D=1;D<=31;D+=1)g(D).replace(/\[|\]/g,"")===k&&(this.day=D)}],w:[E,T("week")],ww:[t,T("week")],M:[E,T("month")],MM:[t,T("month")],MMM:[v,function(k){var g=s("months"),I=(s("monthsShort")||g.map(function(D){return D.slice(0,3)})).indexOf(k)+1;if(I<1)throw new Error;this.month=I%12||I}],MMMM:[v,function(k){var g=s("months").indexOf(k)+1;if(g<1)throw new Error;this.month=g%12||g}],Y:[/[+-]?\d+/,T("year")],YY:[t,function(k){this.year=N(k)}],YYYY:[/\d{4}/,T("year")],Z:d,ZZ:d};function F(k){var g,I;g=k,I=u&&u.formats;for(var D=(k=g.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(W,U,V){var L=V&&V.toUpperCase();return U||I[V]||n[V]||I[L].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(c,h,x){return h||x.slice(1)})})).match(a),y=D.length,f=0;f<y;f+=1){var b=D[f],J=M[b],C=J&&J[0],H=J&&J[1];D[f]=H?{regex:C,parser:H}:b.replace(/^\[|\]$/g,"")}return function(W){for(var U={},V=0,L=0;V<y;V+=1){var c=D[V];if(typeof c=="string")L+=c.length;else{var h=c.regex,x=c.parser,ee=W.slice(L),ie=h.exec(ee)[0];x.call(U,ie),W=W.replace(ie,"")}}return(function(ne){var ue=ne.afternoon;if(ue!==void 0){var ae=ne.hours;ue?ae<12&&(ne.hours+=12):ae===12&&(ne.hours=0),delete ne.afternoon}})(U),U}}return function(k,g,I){I.p.customParseFormat=!0,k&&k.parseTwoDigitYear&&(N=k.parseTwoDigitYear);var D=g.prototype,y=D.parse;D.parse=function(f){var b=f.date,J=f.utc,C=f.args;this.$u=J;var H=C[1];if(typeof H=="string"){var W=C[2]===!0,U=C[3]===!0,V=W||U,L=C[2];U&&(L=C[2]),u=this.$locale(),!W&&L&&(u=I.Ls[L]),this.$d=(function(ee,ie,ne,ue){try{if(["x","X"].indexOf(ie)>-1)return new Date((ie==="X"?1e3:1)*ee);var ae=F(ie)(ee),Me=ae.year,ke=ae.month,ia=ae.day,qe=ae.hours,va=ae.minutes,fe=ae.seconds,We=ae.milliseconds,Ie=ae.zone,De=ae.week,ye=new Date,Oe=ia||(Me||ke?1:ye.getDate()),ce=Me||ye.getFullYear(),Se=0;Me&&!ke||(Se=ke>0?ke-1:ye.getMonth());var me,pe=qe||0,Ue=va||0,Ze=fe||0,Fe=We||0;return Ie?new Date(Date.UTC(ce,Se,Oe,pe,Ue,Ze,Fe+60*Ie.offset*1e3)):ne?new Date(Date.UTC(ce,Se,Oe,pe,Ue,Ze,Fe)):(me=new Date(ce,Se,Oe,pe,Ue,Ze,Fe),De&&(me=ue(me).week(De).toDate()),me)}catch{return new Date("")}})(b,H,J,I),this.init(),L&&L!==!0&&(this.$L=this.locale(L).$L),V&&b!=this.format(H)&&(this.$d=new Date("")),u={}}else if(H instanceof Array)for(var c=H.length,h=1;h<=c;h+=1){C[1]=H[h-1];var x=I.apply(this,C);if(x.isValid()){this.$d=x.$d,this.$L=x.$L,this.init();break}h===c&&(this.$d=new Date(""))}else y.call(this,f)}}})})(Sa)),Sa.exports}var wt=Yt();const Jt=pt(wt),jt="_textarea_14c7r_1",Ct="_readOnlyField_14c7r_7",un={textarea:jt,readOnlyField:Ct},xt=e=>e!=null&&e!=="",qt=({label:e,value:r,isEdited:n=!1,type:a,hideLabel:l,size:t})=>xt(r)?de.jsxs(gn,{gap:"space-4",children:[e&&!l&&de.jsx(La,{size:t,children:e}),de.jsxs(sa,{gap:"space-8",align:"center",wrap:!1,children:[de.jsx(Kn,{className:a==="textarea"?un.textarea:un.readOnlyField,size:t,children:r}),n&&de.jsx(yt,{})]})]}):null;$n.extend(Jt);const Wt=({name:e,control:r,label:n,validate:a=[],readOnly:l=!1,type:t,shouldValidateOnBlur:E=!1,onBlur:v,onChange:u,parse:N=g=>g,format:T=g=>g,normalizeOnBlur:d,isEdited:s,autoComplete:P="off",hideLabel:M,size:F="small",...k})=>{const{formState:{errors:g},trigger:I}=Ea(),{field:D}=zr({name:e,control:r,rules:{validate:O.useMemo(()=>bt(a),[a])}});return l?de.jsx(qt,{label:n,value:D.value,isEdited:s,hideLabel:M,size:F}):de.jsx(xr,{size:F,hideLabel:M,label:n,error:ht(g,e),...D,value:D.value?T(D.value):"",autoComplete:P,type:t,onChange:y=>{const f=y.currentTarget.value?N(y.currentTarget.value):null;return u&&u(f),D.onChange(f)},onBlur:async y=>{if(D.onBlur(),E){const f=await I();v&&f&&v(y?.target?.value)}else v&&v(y?.target?.value);d&&D.onChange(y?.target?.value?d(N(y?.target?.value)):null)},...k})},Zt=({formMethods:e,onSubmit:r,children:n,className:a,setDataOnUnmount:l})=>{const{handleSubmit:t,getValues:E}=e;return O.useEffect(()=>()=>{l&&l(E())},[]),de.jsx(Zr,{...e,children:de.jsx("form",{className:a,onSubmit:r?t(v=>r(v)):void 0,children:n})})},$t="_container_tt7dx_1",Xt="_advarselIcon_tt7dx_6",An={container:$t,advarselIcon:Xt},zt=(e,r)=>!!(e||r===void 0||r.length<1),Cn=({searchStarted:e,searchResultAccessDenied:r,searchFagsakCallback:n})=>{const a=_n(),l=Nt({defaultValues:{searchString:""}}),t=l.watch("searchString");return p.jsx(Zt,{formMethods:l,onSubmit:n,className:An.container,children:p.jsxs(gn,{gap:"space-8",children:[p.jsx(je,{size:"small",children:p.jsx(_e,{id:"Search.SearchFagsakOrPerson"})}),p.jsxs(sa,{gap:"space-8",align:"end",children:[p.jsx(Wt,{name:"searchString",control:l.control,label:a.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[Xn]}),p.jsx(ur,{variant:"primary",size:"small",loading:e,disabled:zt(e,t),children:p.jsx(_e,{id:"Search.Search"})})]}),r&&p.jsxs(sa,{gap:"space-8",align:"end",children:[p.jsx(dl,{className:An.advarselIcon}),p.jsx(je,{size:"small",children:p.jsx(_e,{id:r.feilmelding})})]})]})})};Cn.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const Qt="_container_gwama_1",eE="_label_gwama_9",Nn={container:Qt,label:eE},xn=({fagsaker:e,searchFagsakCallback:r,searchResultReceived:n,selectFagsakCallback:a,searchStarted:l,searchResultAccessDenied:t,alleKodeverk:E})=>p.jsxs("div",{className:Nn.container,children:[p.jsx(Cn,{searchFagsakCallback:r,searchStarted:l,searchResultAccessDenied:t}),n&&e.length===0&&p.jsx(je,{size:"small",className:Nn.label,children:p.jsx(_e,{id:"FagsakSearch.ZeroSearchResults"})}),n&&e.length>1&&p.jsx(yn,{fagsaker:e,selectFagsakCallback:a,alleKodeverk:E})]});xn.__docgenInfo={description:`FagsakSearch
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const{action:dn}=__STORYBOOK_MODULE_ACTIONS__,sn={saksnummer:"1",fagsakYtelseType:"FP",relasjonsRolleType:"-",status:"OPPR",aktørId:"",person:{navn:"",fødselsnummer:"",kjønn:"-",fødselsdato:"",dodsdato:void 0,språkkode:"-"},barnFødt:"",opprettet:""},tE={title:"sak/sak-sok",component:ma,args:{selectFagsakCallback:dn("button-click"),searchFagsakCallback:dn("button-click"),alleKodeverk:el,searchResultReceived:!1,searchStarted:!1},render:e=>{const[r,n]=O.useState(e),a=l=>(r.searchFagsakCallback(l),n(t=>({...t,searchResultReceived:!0})),Promise.resolve(r.fagsaker));return p.jsx(ma,{...r,searchFagsakCallback:a})}},Xe={args:{fagsaker:[{...sn,saksnummer:"1",fagsakYtelseType:"FP"},{...sn,saksnummer:"2",fagsakYtelseType:"ES"}]}},ze={args:{fagsaker:[],searchResultAccessDenied:{feilmelding:"FagsakSokSakIndex.HarIkkeAdgang"}}},Qe={args:{fagsaker:[]}};Xe.parameters={...Xe.parameters,docs:{...Xe.parameters?.docs,source:{originalSource:`{
  args: {
    fagsaker: [{
      ...defaultSak,
      saksnummer: '1',
