import{j as e}from"./dayjs.min-D0F5fy79.js";import{g as U,h as K,l as C,w as H,W as z,e as X,L as x,P as N,b as R,S as G,H as J,M as W,q as Q,O as Z,t as ee,k as re,m as ne,c as $,d as ae,Y as se,B as te}from"./nb_NO-CdUvm0lp.js";import{K as _,a as F}from"./alleKodeverk-DLgIwMJI.js";import"./withRouter-DFPnh569.js";import{r as oe,R as le}from"./index-CTjT7uj6.js";import{r as P,b as T,I as ie,c as de}from"./index.es-R_VB8V1y.js";import"./v4-CQkTLCs1.js";import"./index-CYM-y3Gt.js";const E={LONN_UNDER_UTDANNING:"LØNN_UNDER_UTDANNING",UTENLANDSK_ARBEIDSFORHOLD:"UTENLANDSK_ARBEIDSFORHOLD",FRILANSER:"FRILANSER",MILITÆR_ELLER_SIVILTJENESTE:"MILITÆR_ELLER_SIVILTJENESTE"},ue="_notLastRow_7c46s_1",me={notLastRow:ue},u="andreYtelser",j="PERIODER",y=(n,a)=>n(a),A=({readOnly:n,name:a})=>{const r=U(),{getValues:s,control:o,trigger:i,formState:{isSubmitted:l}}=K(),{fields:t,remove:b,append:B}=C({control:o,name:`${u}.${a}`});return e.jsx(H,{fields:t,bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:n,append:B,remove:b,children:(q,g,V)=>{const d=`${u}.${a}.${g}`;return e.jsxs("div",{children:[e.jsx("div",{className:g!==t.length-1?me.notLastRow:"",children:e.jsx(z,{children:e.jsxs(X,{children:[e.jsx(x,{children:e.jsx(N,{name:`${d}.periodeFom`,label:g===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[P,T,()=>{const p=y(s,`${d}.periodeFom`),c=y(s,`${d}.periodeTom`);return c&&p?ie(c)(p):null}],onChange:()=>l?i():void 0})}),e.jsx(x,{children:e.jsx(N,{name:`${d}.periodeTom`,label:g===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[P,T,()=>{const p=y(s,`${d}.periodeFom`),c=y(s,`${d}.periodeTom`);return c&&p?de(p)(c):null}],onChange:()=>l?i():void 0})}),V&&e.jsx(x,{children:V()})]})})}),e.jsx(R,{sixteenPx:!0})]},q.id)}})};A.transformValues=(n,a)=>n.map(r=>({ytelseType:a,periodeFom:r.periodeFom,periodeTom:r.periodeTom}));A.__docgenInfo={description:`RenderAndreYtelserPerioderFieldArray
