import{u as h,r as f,j as r,P as L,a as U}from"./iframe-PSLltoVy.js";import{u as D,a as B,$ as I,H,P as E,B as w,l as x,V as O,b as G,C as $,W as C,m as X,c as J,N as z}from"./nb_NO-CwdsBB97.js";import{a as W}from"./alleKodeverk-DO07GSZv.js";import{t as q,O as F,V as Q,J as Z}from"./index.es-0tMb955Z.js";import{S as ee}from"./Trash-CWq-EBK2.js";import{M as re}from"./message-B3oE8p95.js";import"./index-CmUVxGlo.js";var g=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(g||{});const m="andreYtelser",_="andreYtelserPerioder",K="andreYtelserTyper",V=({readOnly:e,name:a})=>{const n=h(),{getValues:t,control:d,trigger:l,formState:{isSubmitted:v}}=D(),{fields:T,remove:A,append:R}=B({control:d,name:a});return f.useEffect(()=>{T.length===0&&R({periodeFom:"",periodeTom:""})},[]),r.jsx(I,{fields:T,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:R,remove:A,children:(Y,s)=>{const b=`${a}.${s}`;return r.jsxs(H,{gap:"2",children:[r.jsx(E,{name:`${b}.periodeFom`,control:d,label:s===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[q,F,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${s}`);return o&&k?Q(o)(k):null}],onChange:()=>v?l():void 0}),r.jsx(E,{name:`${a}.${s}.periodeTom`,control:d,label:s===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[q,F,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${s}`);return k&&o?Z(k)(o):null}],onChange:()=>v?l():void 0}),!e&&s>0&&r.jsx("div",{children:r.jsx(w,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(ee,{}),onClick:()=>A(s)})})]},Y.id)}})};V.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const ne=(e,a)=>a?e.filter(n=>n.kode===g.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==g.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==g.FRILANSER&&n.kode!==g.LONN_UNDER_UTDANNING),u=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:n})=>{const t=n.ArbeidType,d=ne(t,a);return r.jsx(x,{children:r.jsxs(O,{gap:"4",children:[r.jsx(G,{size:"small",children:r.jsx(re,{id:"Registrering.AndreYtelser.Title"})}),r.jsx($,{isReadOnly:e,name:`${m}.${K}`,checkboxes:d.map(l=>({label:l.navn,value:l.kode,element:r.jsx(C,{children:r.jsx(V,{name:`${m}.${_}.${l.kode}`,readOnly:e})})}))})]})})};u.initialValues=()=>({[m]:{[K]:[],[_]:{}}});u.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[m]:e.flatMap(n=>a[n].map(t=>({ytelseType:n,...t})))});u.__docgenInfo={description:`AndreYtelserPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:te}=__STORYBOOK_MODULE_ACTIONS__,ge={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:te("onSubmit")},args:{readOnly:!1,alleKodeverk:W},render:(e,{parameters:{submitCallback:a}})=>{const n=J({defaultValues:i.initialValues()});return r.jsx(z,{formMethods:n,onSubmit:t=>a(i.transformValues(t)),children:r.jsxs(O,{gap:"10",children:[r.jsx(i,{...e}),r.jsx(w,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{kunMiliterEllerSiviltjeneste:!1}},p={args:{kunMiliterEllerSiviltjeneste:!0}};var c,j,P;y.parameters={...y.parameters,docs:{...(c=y.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: false
  }
}`,...(P=(j=y.parameters)==null?void 0:j.docs)==null?void 0:P.source}}};var M,S,N;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: true
  }
}`,...(N=(S=p.parameters)==null?void 0:S.docs)==null?void 0:N.source}}};const ye=["Default","KunMiliterEllerSiviltjeneste"];export{y as Default,p as KunMiliterEllerSiviltjeneste,ye as __namedExportsOrder,ge as default};
