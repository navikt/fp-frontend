import{u as R,j as r,o as K,O as y,P as b,a as j}from"./iframe-Tk08YZhP.js";import{u as V,a as w,$ as O,A as h,P as m,O as M,l as c,V as p,b as f,D as P,m as N,d as S,N as B,B as E}from"./nb_NO-BAAwQWc3.js";import{a as U}from"./alleKodeverk-DO07GSZv.js";import{L as I}from"./landkoder-Bgpqk6-g.js";import{F as H}from"./FieldArrayRow-BZ4jOq29.js";import{M as v}from"./message-CILpIcF8.js";import"./index-Ebiahg_i.js";import"./Trash-CzhGcbkB.js";const l="arbeidsforhold",G=K(50),_=a=>a.filter(({kode:e})=>e!==I.NORGE).map(({kode:e,navn:n})=>r.jsx("option",{value:e,children:n},e)),T=({alleKodeverk:a,readOnly:e})=>{const n=R(),{control:s}=V(),{fields:A,remove:g,append:q}=w({control:s,name:l}),F=a.Landkoder.slice().sort((o,t)=>o.navn.localeCompare(t.navn));return r.jsx(O,{fields:A,bodyText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:g,append:q,children:(o,t)=>r.jsxs(H,{remove:g,index:t,readOnly:e,children:[r.jsx(h,{readOnly:e,control:s,name:`${l}.${t}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[G],maxLength:99}),r.jsx(m,{name:`${l}.${t}.periodeFom`,control:s,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[y]}),r.jsx(m,{name:`${l}.${t}.periodeTom`,control:s,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[y]}),r.jsx(M,{name:`${l}.${t}.land`,control:s,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:_(F),size:"small"})]},o.id)})};T.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
