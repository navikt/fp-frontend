import{u as S,r as w,j as e,t as y,O as c,g as B,i as N,l as M,c as h,F as O,e as E,P,a as V}from"./iframe-DInCRIld.js";import{u as I,a as T,d as J,V as D,b as G,S as X,H as A,R as q,T as j,k as $,m as H,e as L,f as z,B as C}from"./nb_NO-Bk4xRdNm.js";import{F as n}from"./familieHendelseType-CLnpSBng.js";import{M as b}from"./message-DqTCE2hS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-KhX67pJN.js";const t="omsorg",K="_barnInput_1jjt5_1",U={barnInput:K},Y=10,Q=r=>r?N(1)(r):void 0,W=r=>r?M(10)(r):void 0,F=(r,a)=>o=>{if(r===0&&a&&o)return E(o,Array.isArray(a)?a[0]:a)},u=({readOnly:r=!0,familieHendelseType:a,isForeldrepengerFagsak:o,fodselsdatoer:d})=>{const{formatMessage:f}=S(),{control:m,watch:R}=I(),{fields:g,remove:_,append:x}=T({control:m,name:`${t}.foedselsDato`}),p=R(`${t}.antallBarn`)??0;return w.useEffect(()=>{if(g.length>Math.max(p,0))for(let s=g.length;s>p;s-=1)_(s-1);else if(g.length<Math.min(p,Y))for(let s=g.length;s<p;s+=1)x({id:s,dato:void 0})},[p]),e.jsx(J,{children:e.jsxs(D,{gap:"space-16",children:[e.jsx(G,{size:"small",level:"3",children:e.jsx(b,{id:a===n.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),o&&a===n.ADOPSJON&&e.jsx(X,{name:`${t}.erEktefellesBarn`,control:m,label:e.jsx(b,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[y],isReadOnly:r,children:e.jsxs(A,{gap:"space-16",children:[e.jsx(q,{value:!0,size:"small",children:e.jsx(b,{id:"Registrering.Adopsjon.Ja"})}),e.jsx(q,{value:!1,size:"small",children:e.jsx(b,{id:"Registrering.Adopsjon.Nei"})})]})}),e.jsx(j,{name:`${t}.omsorgsovertakelsesdato`,control:m,label:f({id:a===n.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:r,validate:a===n.ADOPSJON?[y,c]:[c]}),e.jsxs(A,{gap:"space-16",children:[a===n.ADOPSJON&&e.jsx(j,{name:`${t}.ankomstdato`,control:m,label:f({id:"Registrering.Adopsjon.Ankomstdato"}),isReadOnly:r,validate:[c]}),e.jsx($,{name:`${t}.antallBarn`,control:m,label:f({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:r,className:U.barnInput,parse:s=>{const i=Number.parseInt(s.toString(),10);return Number.isNaN(i)?s:i},validate:[...a===n.ADOPSJON?[y]:[],B,Q,W]})]}),g.map((s,i)=>e.jsx(h.Fragment,{children:e.jsx(j,{name:`${t}.foedselsDato.${i}.dato`,control:m,isReadOnly:r,validate:a===n.ADOPSJON?[y,c,O,F(i,d)]:[c,O,F(i,d)],label:f({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:i+1})})},s.id))]})})};u.initialValues=()=>({[t]:{}});u.transformValues=({omsorg:r})=>({[t]:{...r,foedselsDato:r.foedselsDato&&r.foedselsDato.length>0?r.foedselsDato.map(a=>a.dato):void 0}});u.__docgenInfo={description:`OmsorgOgAdopsjonPanel
