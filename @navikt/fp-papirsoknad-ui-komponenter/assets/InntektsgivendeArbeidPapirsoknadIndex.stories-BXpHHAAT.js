import{u as R,j as r,o as K,O as m,P as b,a as j}from"./iframe-C1sFionz.js";import{u as V,a as w,$ as O,P as h,O as y,Y as E,d as M,V as p,b as c,D as f,m as P,f as N,N as S,B}from"./nb_NO-4PokJr1K.js";import{a as U}from"./alleKodeverk-DO07GSZv.js";import{L as I}from"./landkoder-Bgpqk6-g.js";import{F as H}from"./FieldArrayRow-j-4Mt2K1.js";import{M as v}from"./message-BjW1_AEN.js";import"./preload-helper-D9Z9MdNV.js";import"./index-PUXk9Lbs.js";import"./Trash-fwiJlhEK.js";const l="arbeidsforhold",G=K(50),_=n=>n.filter(({kode:e})=>e!==I.NORGE).map(({kode:e,navn:a})=>r.jsx("option",{value:e,children:a},e)),T=({alleKodeverk:n,readOnly:e})=>{const a=R(),{control:t}=V(),{fields:A,remove:g,append:q}=w({control:t,name:l}),F=n.Landkoder.slice().sort((o,s)=>o.navn.localeCompare(s.navn));return r.jsx(O,{fields:A,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:g,append:q,children:(o,s)=>r.jsxs(H,{remove:g,index:s,readOnly:e,children:[r.jsx(h,{readOnly:e,control:t,name:`${l}.${s}.arbeidsgiver`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[G],maxLength:99}),r.jsx(y,{name:`${l}.${s}.periodeFom`,control:t,isReadOnly:e,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[m]}),r.jsx(y,{name:`${l}.${s}.periodeTom`,control:t,isReadOnly:e,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[m]}),r.jsx(E,{name:`${l}.${s}.land`,control:t,readOnly:e,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:_(F),size:"small"})]},o.id)})};T.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const u=({readOnly:n,alleKodeverk:e})=>r.jsx(M,{children:r.jsxs(p,{gap:"space-16",children:[r.jsx(c,{size:"small",level:"3",children:r.jsx(v,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),r.jsx(f,{children:r.jsx(v,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),r.jsx(T,{readOnly:n,alleKodeverk:e})]})});u.initialValues=()=>({[l]:[]});const k=n=>n===void 0||n==="";u.transformValues=({arbeidsforhold:n})=>({arbeidsforhold:n?.filter(e=>!(k(e.arbeidsgiver)&&k(e.land)&&k(e.periodeFom)&&k(e.periodeTom)))});u.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Y=j(P),i=({readOnly:n,alleKodeverk:e})=>r.jsx(b,{value:Y,children:r.jsx(u,{readOnly:n,alleKodeverk:e})});i.initialValues=u.initialValues;i.transformValues=u.transformValues;i.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const{action:D}=__STORYBOOK_MODULE_ACTIONS__,Z={title:"ui-komponenter/inntektsgivende-arbeid",component:i,args:{readOnly:!1,alleKodeverk:U},parameters:{submitCallback:D("onSubmit")},render:(n,{parameters:{submitCallback:e}})=>{const a=N({defaultValues:i.initialValues()});return r.jsx(S,{formMethods:a,onSubmit:t=>e(i.transformValues(t)),children:r.jsxs(p,{gap:"space-40",children:[r.jsx(i,{...n}),r.jsx(B,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},d={};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"{}",...d.parameters?.docs?.source}}};const ee=["Default"];export{d as Default,ee as __namedExportsOrder,Z as default};
