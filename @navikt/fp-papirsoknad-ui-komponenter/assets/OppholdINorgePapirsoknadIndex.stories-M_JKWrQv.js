import{u as I,j as e,c as E,t as F,O as w,R as c,d as K,b as N,J as j,h as G,P as Y,a as L}from"./iframe-DiHcgQyU.js";import{u as B,a as _,N as D,H as $,M as C,y as U,l as z,V as T,b as J,W as M,m as W,c as Q,D as X,B as Z}from"./nb_NO-BYZDwTo_.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as f}from"./TrueFalseInput-CSxnDgTy.js";import{L as re}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-B1F-2BuA.js";import"./preload-helper-D9Z9MdNV.js";import"./index-DaDLoiL7.js";const ae={land:void 0,periodeFom:void 0,periodeTom:void 0},A=(a,r)=>a(r),S=(a,r)=>()=>{const l=a(r).filter(({periodeFom:t,periodeTom:n})=>t&&t!==""&&n&&n!=="").map(({periodeFom:t,periodeTom:n})=>[t,n]);return l.length>0?G(l):void 0},ne=a=>a.filter(({kode:r})=>r!==re.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(a,r,s,l)=>()=>{const t=A(a,`${r}.${s}.periodeFom`),n=A(a,`${r}.${s}.periodeTom`);return!n||!t?null:l?c(n)(t):j(t)(n)},b=({erTidligereOpphold:a=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=I(),n=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:i,trigger:g,formState:{isSubmitted:m}}=B(),{fields:q,remove:h,append:x}=_({control:o,name:n}),H=ne(l);return e.jsx(D,{fields:q,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:ae,readOnly:s,remove:h,append:x,children:(V,d,R)=>e.jsx(E.Fragment,{children:e.jsxs($,{gap:"space-16",paddingBlock:"2",children:[e.jsx(C,{name:`${n}.${d}.land`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:H,readOnly:s,validate:[F]}),e.jsx(U,{name:`${n}.${d}.periodeFom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,w,P(i,n,d,!0),()=>{const k=A(i,`${n}.${d}.periodeFom`);return a?c(K().format(N))(k):r?j(r)(k):void 0},S(i,n)],onChange:()=>m?g():void 0}),e.jsx(U,{name:`${n}.${d}.periodeTom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,w,P(i,n,d,!1),()=>{const k=A(i,`${n}.${d}.periodeTom`);return a?c(K().format(N))(k):r?j(r)(k):void 0},S(i,n)],onChange:()=>m?g():void 0}),R&&e.jsx("div",{children:R()})]},V.id)},V.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:a=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=I(),n=r.Landkoder.slice().sort((q,h)=>q.navn.localeCompare(h.navn)),{watch:o,control:i}=B(),g=!o("oppholdSisteTolvINorge",!0),m=!o("oppholdNesteTolvINorge",!0);return e.jsx(z,{children:e.jsxs(T,{gap:"space-16",children:[e.jsx(J,{size:"small",level:"3",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(f,{name:"oppholdINorge",control:i,label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:a}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:a}),g&&e.jsx(M,{alignOffset:58,children:e.jsx(b,{erTidligereOpphold:!0,mottattDato:s,countryCodes:n,readOnly:a})})]}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:a}),m&&e.jsx(M,{alignOffset:58,children:e.jsx(b,{mottattDato:s,countryCodes:n,readOnly:a})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:a,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:a,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});p.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const se=L(W),u=({readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:l})=>e.jsx(Y,{value:se,children:e.jsx(p,{readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:l})});u.initialValues=p.initialValues;u.transformValues=p.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
}`,...v.parameters?.docs?.source}}};const ye=["ForFodsel","ForAdopsjon"];export{v as ForAdopsjon,y as ForFodsel,ye as __namedExportsOrder,me as default};
