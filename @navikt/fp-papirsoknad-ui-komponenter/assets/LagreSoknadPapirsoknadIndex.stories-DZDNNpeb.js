import{j as e}from"./jsx-runtime-DjgmBYnU.js";import{j as h,l as o,H as L,b as x,o as p,B as d,d as q,a as E,V as P,p as w,F as c,M as f,n as T,P as F,m as A,c as B,W as R}from"./nb_NO-CbRPWb2t.js";import{N as C,E as I,l as _,a as j}from"./index.es-BYNffZI8.js";import{L as O,w as U}from"./alleKodeverk-BSex6Kn3.js";import{r as b}from"./index-D7mKeUb6.js";import{S as z}from"./ExclamationmarkTriangleFill-C7DAeKSn.js";import"./index-DjXIRphR.js";import"./dayjs.min-Boho2IT3.js";import"./index-BdR6VAUc.js";import"./index-DCOq8Jev.js";import"./v4-CtRu48qb.js";const V=({showModal:r,handleSubmit:s,cancelEvent:n})=>{const a=h();return e.jsxs(o,{open:r,"aria-label":a.formatMessage({id:"ModalLukkPapirSoknad.ModalDescription"}),onClose:n,children:[e.jsx(o.Header,{children:e.jsxs(L,{gap:"4",children:[e.jsx(z,{color:"var(--a-orange-500)",width:35,height:35,title:a.formatMessage({id:"ModalLukkPapirSoknad.Avslutt"})}),e.jsx(x,{size:"medium",id:"modal-heading",children:a.formatMessage({id:"ModalLukkPapirSoknad.Title"})})]})}),e.jsxs(o.Body,{children:[e.jsx(p,{weight:"semibold",children:a.formatMessage({id:"ModalLukkPapirSoknad.Opplysninger"})}),e.jsx(p,{children:a.formatMessage({id:"ModalLukkPapirSoknad.Bekreft"})})]}),e.jsxs(o.Footer,{children:[e.jsx(O,{to:"/",children:e.jsx(d,{variant:"primary",onClick:()=>s(),type:"button",children:a.formatMessage({id:"ModalLukkPapirSoknad.Ok"})})}),e.jsx(d,{variant:"secondary",onClick:n,type:"button",children:a.formatMessage({id:"ModalLukkPapirSoknad.Avbryt"})})]})]})};V.__docgenInfo={description:`LukkPapirSoknadModal

Denne modalen vises når saksbehandler velger 'Ikke mulig å fullføre registrering av søknad'
og trykker på 'Lagre og start behandling'. Ved å trykke på OK blir saken sendt til behandling av avslag.`,methods:[],displayName:"LukkPapirsoknadModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},handleSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const D=_(1500),t=({submitting:r,onSubmitUfullstendigsoknad:s,readOnly:n=!0})=>{const a=h(),[u,m]=b.useState(!1),{watch:M}=q(),g=M("ufullstendigSoeknad")||!1,k=b.useCallback(()=>{m(!u)},[m,u]);return e.jsx(E,{children:e.jsxs(P,{gap:"4",children:[e.jsx(x,{size:"small",children:a.formatMessage({id:"Registrering.SaveApplication.Title"})}),e.jsx(w,{name:"kommentarEndring",label:a.formatMessage({id:"Registrering.SaveApplication.Label"}),description:a.formatMessage({id:"Registrering.SaveApplication.Description"}),maxLength:1500,validate:[D,C],readOnly:n}),e.jsxs("div",{children:[e.jsx(c,{name:"registrerVerge",label:a.formatMessage({id:"Registrering.Verge"}),readOnly:n}),e.jsx(c,{name:"ufullstendigSoeknad",label:a.formatMessage({id:"Registrering.SaveApplication.OpplysningspliktErIkkeOverholdt"}),readOnly:n})]}),e.jsxs("div",{children:[!g&&e.jsx(d,{id:"saveButton",size:"small",variant:"primary",loading:r,disabled:n||r,onClick:I,children:e.jsx(f,{id:"Registrering.SaveApplication.SaveButton"})}),g&&e.jsx(d,{id:"endButton",onClick:k,size:"small",variant:"primary",loading:r,disabled:n||r,type:"button",children:e.jsx(f,{id:"Registrering.SaveApplication.EndButton"})})]}),e.jsx(V,{handleSubmit:s,showModal:u,cancelEvent:k})]})})};t.initialValues=()=>({kommentarEndring:void 0,registrerVerge:!1,ufullstendigSoeknad:!1});t.transformValues=({kommentarEndring:r,registrerVerge:s,ufullstendigSoeknad:n})=>({kommentarEndring:r,registrerVerge:s,ufullstendigSoeknad:n});t.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
