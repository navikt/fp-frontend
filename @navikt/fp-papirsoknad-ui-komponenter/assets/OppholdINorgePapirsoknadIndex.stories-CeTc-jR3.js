import{u as Y,j as e,R as C,d as w,b as K,P as D,a as z}from"./iframe-BrVq1Ni6.js";import{u as L,a as J,$ as W,H as Q,Y as X,P as U,l as Z,V as T,b as ee,W as M,m as re,d as ne,N as ae,B as se}from"./nb_NO-QbGOywF-.js";import{a as te}from"./alleKodeverk-DO07GSZv.js";import{T as F}from"./TrueFalseInput-DDJbOC05.js";import{t as f,O as N,V as c,J as j,h as le}from"./index.es-CQZm98y5.js";import{L as ie}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-CsYO9NvZ.js";import"./index-BMSy3fFj.js";const oe={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(n,r)=>n(r),P=(n,r)=>()=>{const l=n(r).filter(({periodeFom:t,periodeTom:a})=>t&&t!==""&&a&&a!=="").map(({periodeFom:t,periodeTom:a})=>[t,a]);return l.length>0?le(l):void 0},de=n=>n.filter(({kode:r})=>r!==ie.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),S=(n,r,s,l)=>()=>{const t=q(n,`${r}.${s}.periodeFom`),a=q(n,`${r}.${s}.periodeTom`);return!a||!t?null:l?c(a)(t):j(t)(a)},b=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=Y(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:i,trigger:g,formState:{isSubmitted:m}}=L(),{fields:A,remove:h,append:$}=J({control:o,name:a}),_=de(l);return e.jsx(W,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:oe,readOnly:s,remove:h,append:$,children:(V,d,R)=>e.jsx(C.Fragment,{children:e.jsxs(Q,{gap:"4",paddingBlock:"2",children:[e.jsx(X,{name:`${a}.${d}.land`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:_,readOnly:s,validate:[f]}),e.jsx(U,{name:`${a}.${d}.periodeFom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[f,N,S(i,a,d,!0),()=>{const k=q(i,`${a}.${d}.periodeFom`);return n?c(w().format(K))(k):r?j(r)(k):void 0},P(i,a)],onChange:()=>m?g():void 0}),e.jsx(U,{name:`${a}.${d}.periodeTom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[f,N,S(i,a,d,!1),()=>{const k=q(i,`${a}.${d}.periodeTom`);return n?c(w().format(K))(k):r?j(r)(k):void 0},P(i,a)],onChange:()=>m?g():void 0}),R&&e.jsx("div",{children:R()})]},V.id)},V.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:n=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=Y(),a=r.Landkoder.slice().sort((A,h)=>A.navn.localeCompare(h.navn)),{watch:o,control:i}=L(),g=!o("oppholdSisteTolvINorge",!0),m=!o("oppholdNesteTolvINorge",!0);return e.jsx(Z,{children:e.jsxs(T,{gap:"4",children:[e.jsx(ee,{size:"small",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(F,{name:"oppholdINorge",control:i,label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(T,{gap:"2",children:[e.jsx(F,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),g&&e.jsx(M,{alignOffset:58,children:e.jsx(b,{erTidligereOpphold:!0,mottattDato:s,countryCodes:a,readOnly:n})})]}),e.jsxs(T,{gap:"2",children:[e.jsx(F,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),m&&e.jsx(M,{alignOffset:58,children:e.jsx(b,{mottattDato:s,countryCodes:a,readOnly:n})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});p.__docgenInfo={description:`OppholdINorgePanel
