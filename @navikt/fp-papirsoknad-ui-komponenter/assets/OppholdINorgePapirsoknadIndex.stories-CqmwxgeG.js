import{u as G,r as C,j as e,R as D,d as R,b as w,P as z,a as J}from"./iframe-Cm0JmO_C.js";import{u as Y,a as Q,$ as W,H as X,Y as Z,P as K,d as ee,V as T,b as re,c as U,m as ae,e as ne,N as se,B as te}from"./nb_NO-VNyzhOy5.js";import{a as le}from"./alleKodeverk-DO07GSZv.js";import{T as h}from"./TrueFalseInput-C_vW5n_R.js";import{e as F,p as M,D as O,H as c,O as ie}from"./index.es-huFxRk9k.js";import{L as oe}from"./landkoder-Bgpqk6-g.js";import{M as f}from"./message-DzccQiQe.js";import"./index-fBLuJmba.js";const de={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(a,r)=>a(r),N=(a,r)=>()=>{const l=a(r).filter(({periodeFom:t,periodeTom:n})=>t&&t!==""&&n&&n!=="").map(({periodeFom:t,periodeTom:n})=>[t,n]);return l.length>0?ie(l):void 0},ue=a=>a.filter(({kode:r})=>r!==oe.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(a,r,s,l)=>()=>{const t=q(a,`${r}.${s}.periodeFom`),n=q(a,`${r}.${s}.periodeTom`);return!n||!t?null:l?O(n)(t):c(t)(n)},j=({erTidligereOpphold:a=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=G(),n=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:k,getValues:i,trigger:g,formState:{isSubmitted:m}}=Y(),{fields:A,remove:L,append:$}=Q({control:k,name:n}),_=C.useMemo(()=>ue(l),[l]);return e.jsx(W,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:de,readOnly:s,remove:L,append:$,children:(b,o,V)=>e.jsx(D.Fragment,{children:e.jsxs(X,{gap:"4",paddingBlock:"2",children:[e.jsx(Z,{name:`${n}.${o}.land`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:_,readOnly:s,validate:[F]}),e.jsx(K,{name:`${n}.${o}.periodeFom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,M,P(i,n,o,!0),()=>{const p=q(i,`${n}.${o}.periodeFom`);return a?O(R().format(w))(p):r?c(r)(p):void 0},N(i,n)],onChange:()=>m?g():void 0}),e.jsx(K,{name:`${n}.${o}.periodeTom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,M,P(i,n,o,!1),()=>{const p=q(i,`${n}.${o}.periodeTom`);return a?O(R().format(w))(p):r?c(r)(p):void 0},N(i,n)],onChange:()=>m?g():void 0}),V&&e.jsx("div",{children:V()})]},b.id)},b.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const u=({readOnly:a=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=G(),n=r.Landkoder.slice().sort((m,A)=>m.navn.localeCompare(A.navn)),{watch:k}=Y(),i=!k("oppholdSisteTolvINorge",!0),g=!k("oppholdNesteTolvINorge",!0);return e.jsx(ee,{children:e.jsxs(T,{gap:"4",children:[e.jsx(re,{size:"small",children:e.jsx(f,{id:"Registrering.Opphold"})}),e.jsx(h,{name:"oppholdINorge",label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:a}),e.jsxs(T,{gap:"2",children:[e.jsx(h,{name:"oppholdSisteTolvINorge",label:e.jsx(f,{id:"Registrering.OppholdSisteTolv"}),readOnly:a}),i&&e.jsx(U,{alignOffset:58,children:e.jsx(j,{erTidligereOpphold:!0,mottattDato:s,countryCodes:n,readOnly:a})})]}),e.jsxs(T,{gap:"2",children:[e.jsx(h,{name:"oppholdNesteTolvINorge",label:e.jsx(f,{id:"Registrering.OppholdNesteTolv"}),readOnly:a}),g&&e.jsx(U,{alignOffset:58,children:e.jsx(j,{mottattDato:s,countryCodes:n,readOnly:a})})]})]})})};u.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});u.transformValues=({oppholdINorge:a,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:a,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});u.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const pe=J(ae),d=({readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:l})=>e.jsx(z,{value:pe,children:e.jsx(u,{readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:l})});d.initialValues=u.initialValues;d.transformValues=u.transformValues;d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:ke}=__STORYBOOK_MODULE_ACTIONS__,Fe={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:ke("onSubmit")},args:{readOnly:!1,alleKodeverk:le,mottattDato:"2022-05-30"},render:(a,{parameters:{submitCallback:r}})=>{const s=ne({defaultValues:d.initialValues()});return e.jsx(se,{formMethods:s,onSubmit:l=>r(d.transformValues(l)),children:e.jsxs(T,{gap:"10",children:[e.jsx(d,{...a}),e.jsx(te,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{erAdopsjon:!1}},v={args:{erAdopsjon:!0}};var S,I,B;y.parameters={...y.parameters,docs:{...(S=y.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
}`,...(B=(I=y.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};var x,H,E;v.parameters={...v.parameters,docs:{...(x=v.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    erAdopsjon: true
  }
}`,...(E=(H=v.parameters)==null?void 0:H.docs)==null?void 0:E.source}}};const fe=["ForFodsel","ForAdopsjon"];export{v as ForAdopsjon,y as ForFodsel,fe as __namedExportsOrder,Fe as default};
