import{u as y,r as o,j as a,t as G,O,R as V,J as U,P as p,a as B}from"./iframe-CEXpT7hR.js";import{u as S,a as H,P as Y,H as q,T as K,d as w,V as s,b as J,j as c,C,c as j,m as b,e as h,f,B as Z}from"./nb_NO-BWbLkVCC.js";import{a as W}from"./alleKodeverk-DO07GSZv.js";import{M as X}from"./message-Fn81Dywe.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DacWvyjk.js";const N="andreYtelser",d="andreYtelserPerioder",_="andreYtelserTyper",k=({readOnly:l,name:n})=>{const e=y(),{getValues:r,control:t,trigger:i,formState:{isSubmitted:L}}=S(),{fields:I,remove:P,append:D}=H({control:t,name:n});return o.useEffect(()=>{I.length===0&&D({periodeFom:"",periodeTom:""})},[]),a.jsx(Y,{fields:I,addButtonText:e.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:l,append:D,remove:P,children:(M,u,F)=>{const g=`${n}.${u}`;return a.jsxs(q,{gap:"space-8",align:"end",children:[a.jsx(K,{name:`${g}.periodeFom`,control:t,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[G,O,()=>{const{periodeFom:v,periodeTom:R}=r(`${n}.${u}`);return R&&v?V(R)(v):null}],onChange:()=>L?i():void 0}),a.jsx(K,{name:`${n}.${u}.periodeTom`,control:t,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[G,O,()=>{const{periodeFom:v,periodeTom:R}=r(`${n}.${u}`);return v&&R?U(v)(R):null}],onChange:()=>L?i():void 0}),a.jsx("div",{children:F})]},M.id)}})};k.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const m=({readOnly:l,kunMiliterEllerSiviltjeneste:n=!1,alleKodeverk:e})=>{const{control:r}=S(),t=$(e.ArbeidType,n);return a.jsx(w,{children:a.jsxs(s,{gap:"space-16",children:[a.jsx(J,{size:"small",level:"3",children:a.jsx(X,{id:"Registrering.AndreYtelser.Title"})}),a.jsx(c,{name:`${N}.${_}`,control:r,isReadOnly:l,children:t.map(i=>a.jsx(x,{arbeidstype:i,readOnly:l},i.kode))})]})})};m.initialValues=()=>({[N]:{[_]:[],[d]:{}}});m.transformValues=({andreYtelser:{andreYtelserTyper:l,andreYtelserPerioder:n}})=>({[N]:l.flatMap(e=>n[e]?.map(r=>({ytelseType:e,...r}))).filter(e=>e!==void 0)});const x=({arbeidstype:l,readOnly:n})=>{const{watch:e}=S(),r=e(`${N}.${_}`),[t,i]=o.useState(r.includes(l.kode));return a.jsxs(s,{gap:"space-12",children:[a.jsx(C,{value:l.kode,onClick:()=>i(!t),disabled:n,children:l.navn}),t&&a.jsx(j,{children:a.jsx(k,{name:`${N}.${d}.${l.kode}`,readOnly:n})})]})},$=(l,n)=>n?l.filter(e=>e.kode==="MILITÆR_ELLER_SIVILTJENESTE"):l.filter(e=>e.kode!=="UTENLANDSK_ARBEIDSFORHOLD"&&e.kode!=="FRILANSER"&&e.kode!=="LØNN_UNDER_UTDANNING");m.__docgenInfo={description:`AndreYtelserPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:z}=__STORYBOOK_MODULE_ACTIONS__,ie={title:"ui-komponenter/andre-ytelser",component:E,parameters:{submitCallback:z("onSubmit")},args:{readOnly:!1,alleKodeverk:W},render:(l,{parameters:{submitCallback:n}})=>{const e=h({defaultValues:E.initialValues()});return a.jsx(f,{formMethods:e,onSubmit:r=>n(E.transformValues(r)),children:a.jsxs(s,{gap:"space-40",children:[a.jsx(E,{...l}),a.jsx(Z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},T={args:{kunMiliterEllerSiviltjeneste:!1}},A={args:{kunMiliterEllerSiviltjeneste:!0}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...A.parameters?.docs?.source}}};const Ee=["Default","KunMiliterEllerSiviltjeneste"];export{T as Default,A as KunMiliterEllerSiviltjeneste,Ee as __namedExportsOrder,ie as default};
