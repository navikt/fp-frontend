import{u as $,j as e,d as O,b as N,P as W,a as U}from"./iframe-wRiEbax3.js";import{u as I,a as E,$ as L,H as C,P as T,A as Y,W as B,L as G,l as J,V as x,b as Q,D as Z,m as ee,c as re,N as ae,B as ne}from"./nb_NO-CCZbSLZt.js";import{T as P}from"./TrueFalseInput-XOsP1TnC.js";import{p as w,D as X,H as z,a as ie,e as M}from"./index.es-D6rbkOhl.js";import{M as m}from"./message-Do5C69VI.js";import"./index-CQ2rW2c7.js";const o="frilans",v=(r,a)=>r(a),oe=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,i)=>O(a,N).diff(O(i,N))),te=ie(50),se=(r,a,i,n)=>()=>{const d=v(r,`${a}.fomDato`);return i.length>0&&i[0]&&d&&!O(i[0]).isSameOrBefore(O(d))?n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},K=({readOnly:r})=>{const a=$(),{control:i,getValues:n,watch:d,trigger:g,formState:{isSubmitted:c}}=I(),{fields:V,remove:A,append:S}=E({control:i,name:`${o}.oppdragPerioder`}),k=d(`${o}.perioder`),h=oe(k);return e.jsx(L,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:V,readOnly:r,append:S,remove:A,children:(t,p,s)=>{const l=`${o}.oppdragPerioder.${p}`;return e.jsxs(C,{gap:"4",paddingBlock:"2",align:"end",children:[e.jsx(T,{name:`${l}.fomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[w,se(n,l,h,a),()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?X(b)(f):null}],onChange:()=>c?g():void 0}),e.jsx(T,{name:`${l}.tomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[w,()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?z(f)(b):null}],onChange:()=>c?g():void 0}),e.jsx(Y,{name:`${l}.oppdragsgiver`,validate:[te],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},t.id)}})};K.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const F=({readOnly:r})=>{const{watch:a}=I(),i=a(`${o}.harHattOppdragForFamilie`);return e.jsxs(e.Fragment,{children:[e.jsx(P,{name:`${o}.harHattOppdragForFamilie`,label:e.jsx(m,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),i&&e.jsxs(B,{children:[e.jsx(G,{size:"small",children:e.jsx(m,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(K,{readOnly:r})]})]})};F.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});F.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});F.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]}}}}],displayName:"FrilansPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const y=({readOnly:r})=>e.jsx(J,{children:e.jsxs(x,{gap:"4",children:[e.jsx(Q,{size:"small",children:e.jsx(m,{id:"Registrering.Frilans.Title"})}),e.jsx(P,{name:`${o}.harSokerPeriodeMedFrilans`,label:e.jsx(m,{id:"Registrering.Frilans.HarFrilansvirksomhet"}),readOnly:r,trueContent:e.jsx(B,{marginTop:8,children:e.jsxs(x,{gap:"4",children:[e.jsx(Z,{children:e.jsx(m,{id:"Registrering.Frilans.OppgiPeriode"})}),e.jsx(D,{readOnly:r}),e.jsx(P,{name:`${o}.erNyoppstartetFrilanser`,label:e.jsx(m,{id:"Registrering.Frilans.ErNyoppstartedFrilanser"}),readOnly:r}),e.jsx(P,{name:`${o}.harInntektFraFosterhjem`,label:e.jsx(m,{id:"Registrering.Frilans.HarInntektFraForsterhjem"}),readOnly:r}),e.jsx(F,{readOnly:r})]})})})]})});y.initialValues=()=>({[o]:{...D.initialValues(),...F.initialValues()}});y.transformValues=({frilans:r})=>({[o]:r.harSokerPeriodeMedFrilans===!1?{harSokerPeriodeMedFrilans:!1}:{harSokerPeriodeMedFrilans:!0,perioder:r.perioder,erNyoppstartetFrilanser:r.erNyoppstartetFrilanser,harInntektFraFosterhjem:r.harInntektFraFosterhjem,...F.transformValues(r)}});y.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const le=U(ee),u=({readOnly:r})=>e.jsx(W,{value:le,children:e.jsx(y,{readOnly:r})});u.initialValues=y.initialValues;u.transformValues=y.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:de}=__STORYBOOK_MODULE_ACTIONS__,ke={title:"ui-komponenter/frilans",component:u,parameters:{submitCallback:de("onSubmit")},args:{readOnly:!1},render:(r,{parameters:{submitCallback:a}})=>{const i=re({defaultValues:u.initialValues()});return e.jsx(ae,{formMethods:i,onSubmit:n=>a(u.transformValues(n)),children:e.jsxs(x,{gap:"10",children:[e.jsx(u,{...r}),e.jsx(ne,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},j={};var H,_,R;j.parameters={...j.parameters,docs:{...(H=j.parameters)==null?void 0:H.docs,source:{originalSource:"{}",...(R=(_=j.parameters)==null?void 0:_.docs)==null?void 0:R.source}}};const fe=["Default"];export{j as Default,fe as __namedExportsOrder,ke as default};
