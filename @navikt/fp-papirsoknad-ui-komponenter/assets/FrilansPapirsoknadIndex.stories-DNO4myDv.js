import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as I,d as _,$ as E,H as L,P as O,A as K,G as C,L as J,f as Q,V as S,a as U,e as W,m as Y,b as Z,N as ee,B as re}from"./nb_NO-DtoXCGNE.js";import{a as ae}from"./index-B-lxVbXh.js";import{u as X,d as w,P as N,a as ne,r as oe}from"./index.es-CZjkzcto.js";import{T as P}from"./TrueFalseInput-6DKNpODd.js";import{r as ie}from"./index-C4XKfyRp.js";import{p as T,D as B,H as z,a as te,e as M}from"./index.es-sIGWTmsS.js";import{M as m}from"./message-C5auBQb2.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";const i="frilans",v=(r,a)=>r(a),se=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,o)=>w(a,N).diff(w(o,N))),le=te(50),de=(r,a,o,n)=>()=>{const d=v(r,`${a}.fomDato`);return o.length>0&&o[0]&&d&&!w(o[0]).isSameOrBefore(w(d))?n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},G=({readOnly:r})=>{const a=X(),{control:o,getValues:n,watch:d,trigger:g,formState:{isSubmitted:c}}=I(),{fields:V,remove:A,append:x}=_({control:o,name:`${i}.oppdragPerioder`}),F=d(`${i}.perioder`),h=ie.useMemo(()=>se(F),[F]);return e.jsx(E,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:V,readOnly:r,append:x,remove:A,children:(t,p,s)=>{const l=`${i}.oppdragPerioder.${p}`;return e.jsxs(L,{gap:"4",paddingBlock:"2",align:"end",children:[e.jsx(O,{name:`${l}.fomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[T,de(n,l,h,a),()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?B(b)(f):null}],onChange:()=>c?g():void 0}),e.jsx(O,{name:`${l}.tomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[T,()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?z(f)(b):null}],onChange:()=>c?g():void 0}),e.jsx(K,{name:`${l}.oppdragsgiver`,validate:[le],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},t.id)}})};G.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const y=({readOnly:r})=>{const{watch:a}=I(),o=a(`${i}.harHattOppdragForFamilie`);return e.jsxs(e.Fragment,{children:[e.jsx(P,{name:`${i}.harHattOppdragForFamilie`,label:e.jsx(m,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),o&&e.jsxs(C,{children:[e.jsx(J,{size:"small",children:e.jsx(m,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(G,{readOnly:r})]})]})};y.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});y.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});y.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]}}}}],displayName:"FrilansOppdragForFamiliePanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const q=(r,a)=>r(a),D=({readOnly:r})=>{const a=X(),{control:o,getValues:n,formState:{isSubmitted:d},trigger:g}=I(),{fields:c,remove:V,append:A}=_({control:o,name:`${i}.perioder`});return e.jsx(E,{fields:c,bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:r,remove:V,append:A,children:(x,F,h)=>{const t=`${i}.perioder.${F}`;return e.jsxs(L,{gap:"4",paddingBlock:"2",children:[e.jsx(O,{name:`${t}.periodeFom`,label:F===0?a.formatMessage({id:"Registrering.Frilans.periodeFom"}):"",validate:[M,T,()=>{const p=q(n,`${t}.periodeFom`),s=q(n,`${t}.periodeTom`);return s&&p?B(s)(p):null}],onChange:()=>d?g():void 0}),e.jsx(O,{name:`${t}.periodeTom`,label:F===0?a.formatMessage({id:"Registrering.Frilans.periodeTom"}):"",validate:[M,T,()=>{const p=q(n,`${t}.periodeFom`),s=q(n,`${t}.periodeTom`);return s&&p?z(p)(s):null}],onChange:()=>d?g():void 0}),h&&e.jsx("div",{children:h()})]},x.id)}})};D.initialValues=()=>({perioder:[{periodeFom:"",periodeTom:""}]});D.__docgenInfo={description:`FrilansPerioderFieldArray
...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const pe=oe(Y),u=({readOnly:r})=>e.jsx(ne,{value:pe,children:e.jsx(k,{readOnly:r})});u.initialValues=k.initialValues;u.transformValues=k.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const je={title:"ui-komponenter/frilans",component:u,parameters:{submitCallback:ae("onSubmit")},args:{readOnly:!1},render:(r,{parameters:{submitCallback:a}})=>{const o=Z({defaultValues:u.initialValues()});return e.jsx(ee,{formMethods:o,onSubmit:n=>a(u.transformValues(n)),children:e.jsxs(S,{gap:"10",children:[e.jsx(u,{...r}),e.jsx(re,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},j={};var H,$,R;j.parameters={...j.parameters,docs:{...(H=j.parameters)==null?void 0:H.docs,source:{originalSource:"{}",...(R=($=j.parameters)==null?void 0:$.docs)==null?void 0:R.source}}};const Pe=["Default"];export{j as Default,Pe as __namedExportsOrder,je as default};
