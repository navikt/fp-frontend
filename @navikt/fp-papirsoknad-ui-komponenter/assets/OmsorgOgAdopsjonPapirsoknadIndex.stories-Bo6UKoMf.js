import{u as M,r as w,j as e,t as f,O as c,g as N,i as _,l as x,a as B,F as k,b as P,P as h,e as E}from"./iframe-CayaqC7Q.js";import{u as V,a as T,c as I,V as F,b as J,S as G,H as j,R as A,y as O,T as L,m as X,f as $,P as z,B as H}from"./nb_NO-CGAi3Ezg.js";import{M as v}from"./message-CJlc27gU.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DJpVPxS0.js";const t="omsorg",K="_barnInput_1jjt5_1",C={barnInput:K},U=10,Y=a=>a?_(1)(a):void 0,Q=a=>a?x(10)(a):void 0,D=(a,r)=>n=>{const m=[r].flat().filter(i=>i!==void 0).at(0);if(a===0&&m&&n)return P(n,m)},u=({readOnly:a=!0,familieHendelseType:r,isForeldrepengerFagsak:n,fodselsdatoer:o})=>{const{formatMessage:m}=M(),{control:i,watch:S}=V(),{fields:g,remove:q,append:R}=T({control:i,name:`${t}.foedselsDato`}),p=S(`${t}.antallBarn`)??0;return w.useEffect(()=>{if(g.length>Math.max(p,0))for(let s=g.length;s>p;s-=1)q(s-1);else if(g.length<Math.min(p,U))for(let s=g.length;s<p;s+=1)R({id:s,dato:void 0})},[p]),e.jsx(I,{children:e.jsxs(F,{gap:"space-16",children:[e.jsx(J,{size:"small",level:"3",children:e.jsx(v,{id:r==="ADPSJN"?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),n&&r==="ADPSJN"&&e.jsx(G,{name:`${t}.erEktefellesBarn`,control:i,legend:e.jsx(v,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[f],readOnly:a,children:e.jsxs(j,{gap:"space-16",children:[e.jsx(A,{value:!0,size:"small",children:e.jsx(v,{id:"Registrering.Adopsjon.Ja"})}),e.jsx(A,{value:!1,size:"small",children:e.jsx(v,{id:"Registrering.Adopsjon.Nei"})})]})}),e.jsx(O,{name:`${t}.omsorgsovertakelsesdato`,control:i,label:m({id:r==="ADPSJN"?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),readOnly:a,validate:r==="ADPSJN"?[f,c]:[c]}),e.jsx(j,{gap:"space-16",children:e.jsx(L,{name:`${t}.antallBarn`,control:i,label:m({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:a,className:C.barnInput,parse:s=>{const l=Number.parseInt(s.toString(),10);return Number.isNaN(l)?s:l},validate:[...r==="ADPSJN"?[f]:[],N,Y,Q]})}),g.map((s,l)=>e.jsx(B.Fragment,{children:e.jsx(O,{name:`${t}.foedselsDato.${l}.dato`,control:i,readOnly:a,validate:r==="ADPSJN"?[f,c,k,D(l,o)]:[c,k,D(l,o)],label:m({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:l+1})})},s.id))]})})};u.initialValues=()=>({[t]:{}});u.transformValues=({omsorg:a})=>({[t]:{...a,foedselsDato:a.foedselsDato&&a.foedselsDato.length>0?a.foedselsDato.map(r=>r.dato):void 0}});u.__docgenInfo={description:`OmsorgOgAdopsjonPanel
...
}`,...y.parameters?.docs?.source}}};const oe=["ForFodsel","ForAdopsjon"];export{y as ForAdopsjon,b as ForFodsel,oe as __namedExportsOrder,te as default};
