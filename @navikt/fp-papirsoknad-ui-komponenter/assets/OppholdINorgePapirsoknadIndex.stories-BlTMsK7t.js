import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{e as E,d as H,i as G,I as J,H as Q,j as W,c as w,A as V,S as X,V as f,a as Y,M as F,l as I,t as Z,P as ee,m as re,b as ne,$ as ae,B as oe}from"./nb_NO-C2r3kIQs.js";import{H as q,g as R,D as b,U as O,f as se,a as ie}from"./index.es-B4BPTzAT.js";import"./withRouter-DhSU4y_G.js";import{K as te,a as le}from"./kodeverkTyper-RnAavUTm.js";import{r as L,R as de}from"./index-DRjF_FHU.js";import"./aktivitetStatus-B1m96ipJ.js";import{T}from"./TrueFalseInput-D2cJnMwK.js";import{d as U}from"./dayjs.min-CnNqAF5I.js";import{L as pe}from"./landkoder-tJDPMx5C.js";import"./index-rX-Bn4lm.js";import"./v4-CQkTLCs1.js";const me={land:void 0,periodeFom:void 0,periodeTom:void 0},c=(n,r)=>n(r),x=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?se(i):void 0},ue=n=>n.filter(({kode:r})=>r!==pe.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),K=(n,r,o,i)=>()=>{const s=c(n,`${r}.${o}.periodeFom`),a=c(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?b(a)(s):O(s)(a)},j=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:u,getValues:t,trigger:g,formState:{isSubmitted:v}}=H(),{fields:h,remove:z,append:B}=G({control:u,name:a}),D=L.useMemo(()=>ue(i),[i]);return e.jsx(J,{fields:h,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:me,readOnly:o,remove:z,append:B,children:(N,l,A)=>e.jsx(de.Fragment,{children:e.jsxs(Q,{gap:"4",paddingBlock:"2",children:[e.jsx(W,{name:`${a}.${l}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:D,readOnly:o,validate:[q]}),e.jsx(w,{name:`${a}.${l}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[q,R,K(t,a,l,!0),()=>{const m=c(t,`${a}.${l}.periodeFom`);return n?b(U().format(V))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),e.jsx(w,{name:`${a}.${l}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[q,R,K(t,a,l,!1),()=>{const m=c(t,`${a}.${l}.periodeTom`);return n?b(U().format(V))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),A&&e.jsx("div",{children:A()})]},N.id)},N.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Ne={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:ie("onSubmit")},args:{readOnly:!1,alleKodeverk:le,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=ne({defaultValues:d.initialValues()});return e.jsx(ae,{formMethods:o,onSubmit:i=>r(d.transformValues(i)),children:e.jsxs(f,{gap:"10",children:[e.jsx(d,{...n}),e.jsx(oe,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},k={args:{erAdopsjon:!1}},y={args:{erAdopsjon:!0}};var M,S,$;k.parameters={...k.parameters,docs:{...(M=k.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(_=(P=y.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};const Ae=["ForFodsel","ForAdopsjon"];export{y as ForAdopsjon,k as ForFodsel,Ae as __namedExportsOrder,Ne as default};
