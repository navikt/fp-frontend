import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as E,f as D,$ as _,H as z,Y as Z,P as R,a as J,V as T,b as Q,Z as w,m as W,d as X,N as ee,B as re}from"./nb_NO-BeBGbCCx.js";import{a as ae}from"./index-B-lxVbXh.js";import"./withThemeDecorator-BuNaGT-U.js";import{r as ne,R as se}from"./index-C4XKfyRp.js";import{u as Y,d as K,P as U,a as te,r as ie}from"./index.es-CZjkzcto.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as le}from"./alleKodeverk-DO07GSZv.js";import{T as h}from"./TrueFalseInput-DxVXq0t0.js";import{e as F,p as M,D as c,H as O,O as oe}from"./index.es-sIGWTmsS.js";import{L as de}from"./landkoder-Bgpqk6-g.js";import{M as f}from"./message-C5auBQb2.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-B8xAIufp.js";import"./iframe-BukItUJR.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";const ue={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(a,r)=>a(r),N=(a,r)=>()=>{const i=a(r).filter(({periodeFom:t,periodeTom:n})=>t&&t!==""&&n&&n!=="").map(({periodeFom:t,periodeTom:n})=>[t,n]);return i.length>0?oe(i):void 0},pe=a=>a.filter(({kode:r})=>r!==de.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(a,r,s,i)=>()=>{const t=q(a,`${r}.${s}.periodeFom`),n=q(a,`${r}.${s}.periodeTom`);return!n||!t?null:i?c(n)(t):O(t)(n)},j=({erTidligereOpphold:a=!1,mottattDato:r,readOnly:s,countryCodes:i})=>{const t=Y(),n=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:k,getValues:l,trigger:g,formState:{isSubmitted:m}}=E(),{fields:A,remove:L,append:$}=D({control:k,name:n}),C=ne.useMemo(()=>pe(i),[i]);return e.jsx(_,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:ue,readOnly:s,remove:L,append:$,children:(b,o,V)=>e.jsx(se.Fragment,{children:e.jsxs(z,{gap:"4",paddingBlock:"2",children:[e.jsx(Z,{name:`${n}.${o}.land`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:C,readOnly:s,validate:[F]}),e.jsx(R,{name:`${n}.${o}.periodeFom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,M,P(l,n,o,!0),()=>{const p=q(l,`${n}.${o}.periodeFom`);return a?c(K().format(U))(p):r?O(r)(p):void 0},N(l,n)],onChange:()=>m?g():void 0}),e.jsx(R,{name:`${n}.${o}.periodeTom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,M,P(l,n,o,!1),()=>{const p=q(l,`${n}.${o}.periodeTom`);return a?c(K().format(U))(p):r?O(r)(p):void 0},N(l,n)],onChange:()=>m?g():void 0}),V&&e.jsx("div",{children:V()})]},b.id)},b.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ke=ie(W),d=({readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:i})=>e.jsx(te,{value:ke,children:e.jsx(u,{readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:i})});d.initialValues=u.initialValues;d.transformValues=u.transformValues;d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Pe={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:ae("onSubmit")},args:{readOnly:!1,alleKodeverk:le,mottattDato:"2022-05-30"},render:(a,{parameters:{submitCallback:r}})=>{const s=X({defaultValues:d.initialValues()});return e.jsx(ee,{formMethods:s,onSubmit:i=>r(d.transformValues(i)),children:e.jsxs(T,{gap:"10",children:[e.jsx(d,{...a}),e.jsx(re,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{erAdopsjon:!1}},v={args:{erAdopsjon:!0}};var S,I,B;y.parameters={...y.parameters,docs:{...(S=y.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
