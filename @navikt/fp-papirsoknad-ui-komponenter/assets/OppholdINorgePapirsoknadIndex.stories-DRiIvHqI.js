import{u as I,j as e,R as E,d as w,P as G}from"./iframe-BKAlD7kq.js";import{u as B,a as Y,$ as L,H as _,O as $,P as K,e as N,l as D,V as T,b as C,W as U,r as z,m as J,d as W,N as Q,B as X}from"./nb_NO-BBa2qQ2A.js";import{a as Z}from"./alleKodeverk-DO07GSZv.js";import{T as F}from"./TrueFalseInput-Dl_7nYBb.js";import{t as f,O as M,R as c,J as j,h as ee}from"./index.es-BwStEKym.js";import{L as re}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-CJeKdNGh.js";import"./index-ChRUIYyj.js";const ae={land:void 0,periodeFom:void 0,periodeTom:void 0},A=(a,r)=>a(r),S=(a,r)=>()=>{const l=a(r).filter(({periodeFom:t,periodeTom:n})=>t&&t!==""&&n&&n!=="").map(({periodeFom:t,periodeTom:n})=>[t,n]);return l.length>0?ee(l):void 0},ne=a=>a.filter(({kode:r})=>r!==re.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(a,r,s,l)=>()=>{const t=A(a,`${r}.${s}.periodeFom`),n=A(a,`${r}.${s}.periodeTom`);return!n||!t?null:l?c(n)(t):j(t)(n)},b=({erTidligereOpphold:a=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=I(),n=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:i,trigger:g,formState:{isSubmitted:m}}=B(),{fields:q,remove:h,append:x}=Y({control:o,name:n}),H=ne(l);return e.jsx(L,{fields:q,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:ae,readOnly:s,remove:h,append:x,children:(V,d,R)=>e.jsx(E.Fragment,{children:e.jsxs(_,{gap:"4",paddingBlock:"2",children:[e.jsx($,{name:`${n}.${d}.land`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:H,readOnly:s,validate:[f]}),e.jsx(K,{name:`${n}.${d}.periodeFom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[f,M,P(i,n,d,!0),()=>{const k=A(i,`${n}.${d}.periodeFom`);return a?c(w().format(N))(k):r?j(r)(k):void 0},S(i,n)],onChange:()=>m?g():void 0}),e.jsx(K,{name:`${n}.${d}.periodeTom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[f,M,P(i,n,d,!1),()=>{const k=A(i,`${n}.${d}.periodeTom`);return a?c(w().format(N))(k):r?j(r)(k):void 0},S(i,n)],onChange:()=>m?g():void 0}),R&&e.jsx("div",{children:R()})]},V.id)},V.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:a=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=I(),n=r.Landkoder.slice().sort((q,h)=>q.navn.localeCompare(h.navn)),{watch:o,control:i}=B(),g=!o("oppholdSisteTolvINorge",!0),m=!o("oppholdNesteTolvINorge",!0);return e.jsx(D,{children:e.jsxs(T,{gap:"4",children:[e.jsx(C,{size:"small",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(F,{name:"oppholdINorge",control:i,label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:a}),e.jsxs(T,{gap:"2",children:[e.jsx(F,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:a}),g&&e.jsx(U,{alignOffset:58,children:e.jsx(b,{erTidligereOpphold:!0,mottattDato:s,countryCodes:n,readOnly:a})})]}),e.jsxs(T,{gap:"2",children:[e.jsx(F,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:a}),m&&e.jsx(U,{alignOffset:58,children:e.jsx(b,{mottattDato:s,countryCodes:n,readOnly:a})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:a,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:a,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});p.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const se=z(J),u=({readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:l})=>e.jsx(G,{value:se,children:e.jsx(p,{readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:l})});u.initialValues=p.initialValues;u.transformValues=p.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
