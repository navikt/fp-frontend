import{j as e}from"./dayjs.min-D0F5fy79.js";import{d as U,e as K,i as C,p as H,W as z,c as X,L as x,P as N,y as R,S as G,H as J,M as W,n as Q,O as Z,t as ee,h as re,m as ne,a as $,b as ae,Y as se,B as te}from"./nb_NO-gL8CkKbM.js";import{K as _,a as F}from"./alleKodeverk-DLgIwMJI.js";import"./withRouter-DFPnh569.js";import{r as oe,R as le}from"./index-CTjT7uj6.js";import{r as P,b as T,I as ie,c as de}from"./index.es-F8_np8M9.js";import"./v4-CQkTLCs1.js";import"./index-CYM-y3Gt.js";const y={LONN_UNDER_UTDANNING:"LØNN_UNDER_UTDANNING",UTENLANDSK_ARBEIDSFORHOLD:"UTENLANDSK_ARBEIDSFORHOLD",FRILANSER:"FRILANSER",MILITÆR_ELLER_SIVILTJENESTE:"MILITÆR_ELLER_SIVILTJENESTE"},ue="_notLastRow_7c46s_1",me={notLastRow:ue},u="andreYtelser",j="PERIODER",E=(n,a)=>n(a),A=({readOnly:n,name:a})=>{const r=U(),{getValues:s,control:o,trigger:i,formState:{isSubmitted:l}}=K(),{fields:t,remove:b,append:B}=C({control:o,name:`${u}.${a}`});return e.jsx(H,{fields:t,bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:n,append:B,remove:b,children:(q,g,V)=>{const d=`${u}.${a}.${g}`;return e.jsxs("div",{children:[e.jsx("div",{className:g!==t.length-1?me.notLastRow:"",children:e.jsx(z,{children:e.jsxs(X,{children:[e.jsx(x,{children:e.jsx(N,{name:`${d}.periodeFom`,label:g===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[P,T,()=>{const p=E(s,`${d}.periodeFom`),c=E(s,`${d}.periodeTom`);return c&&p?ie(c)(p):null}],onChange:()=>l?i():void 0})}),e.jsx(x,{children:e.jsx(N,{name:`${d}.periodeTom`,label:g===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[P,T,()=>{const p=E(s,`${d}.periodeFom`),c=E(s,`${d}.periodeTom`);return c&&p?de(p)(c):null}],onChange:()=>l?i():void 0})}),V&&e.jsx(x,{children:V()})]})})}),e.jsx(R,{sixteenPx:!0})]},q.id)}})};A.transformValues=(n,a)=>n.map(r=>({ytelseType:a,periodeFom:r.periodeFom,periodeTom:r.periodeTom}));A.__docgenInfo={description:`RenderAndreYtelserPerioderFieldArray
...
}`,...(D=(M=f.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};const Ie=["Default","KunMiliterEllerSiviltjeneste"];export{k as Default,f as KunMiliterEllerSiviltjeneste,Ie as __namedExportsOrder,Ae as default};
