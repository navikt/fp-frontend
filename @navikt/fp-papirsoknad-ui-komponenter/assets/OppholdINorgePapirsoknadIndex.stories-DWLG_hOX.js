...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  fremtidigeOppholdUtenlands?: FormValuesFieldArray[];
}`,signature:{properties:[{key:"oppholdINorge",value:{name:"boolean",required:!1}},{key:"harTidligereOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"harFremtidigeOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"tidligereOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}},{key:"fremtidigeOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}}]}}}}],displayName:"OppholdINorgePapirsoknadIndex"};const Me={title:"papirsoknad/ui-komponenter/opphold-i-norge",component:O},Y=({erAdopsjon:a,submitCallback:n})=>{const t=me({defaultValues:O.buildInitialValues()});return e.createElement(ue,{formMethods:t,onSubmit:d=>n(O.transformValues(d))},e.createElement(O,{readOnly:!1,erAdopsjon:a,alleKodeverk:ce,mottattDato:"2022-05-30"}),e.createElement(p,{fourtyPx:!0}),e.createElement(ge,{size:"small",variant:"primary"},"Lagreknapp (Kun for test)"))},h=Y.bind({});h.args={erAdopsjon:!1,submitCallback:L("button-click")};const c=Y.bind({});c.args={erAdopsjon:!0,submitCallback:L("button-click")};var M,S,K;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`({
  erAdopsjon,
  submitCallback
}) => {
...
}`,...(K=(S=h.parameters)==null?void 0:S.docs)==null?void 0:K.source}}};var B,_,$;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`({
  erAdopsjon,
  submitCallback
}) => {
  const formMethods = useForm({
...
}`,...($=(_=c.parameters)==null?void 0:_.docs)==null?void 0:$.source}}};const Se=["ForFodsel","ForAdopsjon"];export{c as ForAdopsjon,h as ForFodsel,Se as __namedExportsOrder,Me as default};
