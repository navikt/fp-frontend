import{r as p,R as e}from"./index-DVXBtNgz.js";import{n as ye,e as q,f as N,C as K,h as s,g as i,T as M,i as w,q as Re,F as ee,M as re,c as I,d as S,j as C,p as F,E as L,x as Ee,b as ne,O as te,v as _,H as ae,B,l as fe,w as he,S as be,z as Ve,D as we,R as Ne,t as Te,P as Pe,m as Ae,a as Ke}from"./nb_NO-C9BsZesQ.js";import"./withRouter-ClqbeiGf.js";import{K as se,a as qe}from"./alleKodeverk-DbawmvgK.js";import{r as c,R as z,T as Me,b as x,_ as je,Y as _e,Z as ie,o as Fe}from"./index.es-DaiGF91N.js";import"./v4-CQkTLCs1.js";import"./tslib.es6-CMwweBXX.js";import"./index-Cbx7Fas8.js";var Ie=function(r,n){var a={};for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&n.indexOf(t)<0&&(a[t]=r[t]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,t=Object.getOwnPropertySymbols(r);o<t.length;o++)n.indexOf(t[o])<0&&Object.prototype.propertyIsEnumerable.call(r,t[o])&&(a[t[o]]=r[t[o]]);return a};const H=p.forwardRef((r,n)=>{var{as:a="a",className:t,underline:o=!0,variant:g="action",inlineText:l=!1}=r,d=Ie(r,["as","className","underline","variant","inlineText"]);return e.createElement(a,Object.assign({},d,{ref:n,className:ye("navds-link",t,`navds-link--${g}`,{"navds-link--remove-underline":!o,"navds-link--inline-text":l})}))}),P={FISKE:"FISKE",FRILANSER:"FRILANSER",DAGMAMMA:"DAGMAMMA",JORDBRUK_ELLER_SKOGBRUK:"JORDBRUK_SKOGBRUK",ANNEN:"ANNEN"},Se="_navnBredde_1kwjo_1",xe="_orgNrBredde_1kwjo_5",Oe="_landBredde_1kwjo_9",O={navnBredde:Se,orgNrBredde:xe,landBredde:Oe},Be=r=>r.map(({kode:n,navn:a})=>e.createElement("option",{value:n,key:n},a)),oe=({readOnly:r=!0,alleKodeverk:n})=>{const a=q(),t=n[se.LANDKODER].slice().sort((d,v)=>d.navn.localeCompare(v.navn)),{watch:o,getValues:g}=N(),l=o("virksomhetRegistrertINorge");return e.createElement(e.Fragment,null,e.createElement(K,{name:"navn",validate:[c],label:e.createElement(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.Name"}),className:O.navnBredde,readOnly:r}),e.createElement(i,{sixteenPx:!0}),e.createElement(M,{name:"virksomhetRegistrertINorge",label:e.createElement(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),validate:[c],isReadOnly:r,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Yes"}),value:"true"},{label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.No"}),value:"false"}]}),l&&e.createElement(e.Fragment,null,e.createElement(i,{eightPx:!0}),e.createElement("div",{className:O.orgNrBredde},e.createElement(w,null,e.createElement(K,{name:"organisasjonsnummer",readOnly:r,validate:[c,z,Me],label:e.createElement(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})}))),e.createElement(i,{sixteenPx:!0})),!l&&l!==void 0&&e.createElement(e.Fragment,null,e.createElement(i,{eightPx:!0}),e.createElement(w,{alignOffset:57},e.createElement(Re,{name:"landJobberFra",className:O.landBredde,selectValues:Be(t),validate:[c],label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.createElement(i,{sixteenPx:!0}),e.createElement(ee,null,e.createElement(re,null,e.createElement(I,null,e.createElement(S,{isReadOnly:r,validate:[c,x,je],name:"fom",label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})})),e.createElement(I,null,e.createElement(S,{isReadOnly:r,validate:[x,d=>{const v=g("fom");return v?_e(v,d):null}],name:"tom",label:a.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})))))))};oe.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
Viser registrerte virksomheter samt knapp for å legge til nye virksomheter.`,methods:[],displayName:"RegistrerVirksomhetPanel",props:{readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const ve=({readOnly:r=!0,alleKodeverk:n})=>{const a=q(),{watch:t}=N(),o=t(`${b}.harArbeidetIEgenVirksomhet`)||null;return e.createElement(Ne,null,e.createElement(ae,{size:"small"},e.createElement(s,{id:"Registrering.EgenVirksomhet.Title"})),e.createElement(i,{sixteenPx:!0}),e.createElement(M,{name:`${b}.harArbeidetIEgenVirksomhet`,validate:[c],isReadOnly:r,hideLegend:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"Registrering.EgenVirksomhet.No"}),value:"false"},{label:a.formatMessage({id:"Registrering.EgenVirksomhet.Yes"}),value:"true"}]}),o&&e.createElement(ue,{readOnly:r,alleKodeverk:n}))};ve.__docgenInfo={description:`EgenVirksomhetPanel
...
Søker må oppgi om hen har arbdeidet i egen virksomhet.`,methods:[],displayName:"EgenVirksomhetPanel",props:{alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const mr={title:"papirsoknad/ui-komponenter/virksomhet",component:pe},rr=({submitCallback:r})=>{const n=ne();return e.createElement(te,{formMethods:n,onSubmit:r},e.createElement(pe,{readOnly:!1,alleKodeverk:qe}),e.createElement(i,{fourtyPx:!0}),e.createElement(B,{size:"small",variant:"primary"},"Lagreknapp (Kun for test)"))},A=rr.bind({});A.args={submitCallback:Ke("button-click")};var Z,Q,W;A.parameters={...A.parameters,docs:{...(Z=A.parameters)==null?void 0:Z.docs,source:{originalSource:`({
  submitCallback
}) => {
