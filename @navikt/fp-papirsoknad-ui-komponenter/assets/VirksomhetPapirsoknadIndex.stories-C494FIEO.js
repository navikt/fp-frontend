...
RegnskapFormValues &
StartedEndretFormValues &
TypeNaringFormValues`,elements:[{name:"FormValues"},{name:"FormValues"},{name:"FormValues"},{name:"FormValues"},{name:"FormValues"}]},description:""}}};const Ye="_divider_1ed8l_1",Je="_fieldsList_1ed8l_7",Xe="_addCircleIcon_1ed8l_11",We="_imageText_1ed8l_12",Qe="_customLink_1ed8l_17",Ze="_removeButton_1ed8l_22",x={divider:Ye,fieldsList:Je,addCircleIcon:Xe,imageText:We,customLink:Qe,removeButton:Ze},f="egenVirksomhet",ce=({readOnly:r=!1,alleKodeverk:n})=>{var N,$,H,G;const a=K(),[s,o]=p.useState(),{control:g,setError:d,formState:l,clearErrors:v}=w(),{fields:k,remove:y,append:R,update:m}=he({control:g,name:`${f}.virksomheter`}),j=p.useCallback(u=>{o(u!==void 0?u:-1)},[o]),b=p.useCallback(()=>{o(void 0)},[o]),M=p.useCallback(u=>{const h={...u,landJobberFra:u.virksomhetRegistrertINorge?"NOR":u.landJobberFra,varigEndringGjeldendeFom:u.nyIArbeidslivetFom||u.varigEndringGjeldendeFom};s===-1?R(h):s!==void 0&&m(s,h),b()},[R,m,b,s]);return p.useEffect(()=>{k.length===0&&d(`${f}.notRegisteredInput`,{type:"custom",message:a.formatMessage({id:"Registrering.RegistrerVirksomhetPanel.ArrayMinLength"})}),k.length>0&&v(`${f}.notRegisteredInput`)},[k.length]),e.jsxs("div",{className:x.fieldsList,children:[k.length>0&&e.jsxs(de.Fragment,{children:[e.jsx(C,{size:"small",children:e.jsx(t,{id:"Registrering.RegistrerVirksomhetPanel.Name"})}),e.jsx("hr",{className:x.divider}),k.map((u,h)=>e.jsxs(re,{children:[e.jsxs(ne,{children:[e.jsx(F,{children:e.jsx(U,{className:x.customLink,onClick:()=>j(h),onKeyDown:()=>j(h),children:e.jsx(xe,{size:"small",children:u.navn})})}),e.jsx(F,{children:e.jsx(fe,{className:x.removeButton,onClick:()=>y(h),onKeyDown:()=>y(h)})})]}),e.jsx("hr",{className:x.divider}),e.jsx(i,{eightPx:!0})]},u.id))]},1),e.jsxs(U,{onClick:()=>j(),onKeyDown:u=>u.nativeEvent.code==="Space"?j():!1,children:[e.jsx(be,{className:x.addCircleIcon}),e.jsx(Ve,{className:x.imageText,children:e.jsx(t,{id:"Registrering.RegistrerVirksomhetPanel.Add"})})]}),l.isSubmitted&&(($=(N=l.errors[f])==null?void 0:N.notRegisteredInput)==null?void 0:$.message)&&e.jsx(L,{children:(G=(H=l.errors[f])==null?void 0:H.notRegisteredInput)==null?void 0:G.message}),s!==void 0&&e.jsx(ve,{showModal:!0,virksomhet:s!==-1&&k.length>s?k[s]:void 0,onSubmit:M,closeEvent:b,readOnly:r,alleKodeverk:n})]})};ce.__docgenInfo={description:`RegistrererVirksomhetPanel
...
}`,...(ee=(Z=P.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const gr=["Default"];export{P as Default,gr as __namedExportsOrder,kr as default};
