import{j as e,P as R,a as M,t as d,O as u,J as b,R as D,p as g,q as f,g as v,v as T,s as x,x as S,z as V,A as _,B as y,k as w,C as E,D as z}from"./iframe-BIul8Xbq.js";import{u as A,d as I,V as B,b as N,f as C,R as j,H as h,S as p,y as q,L as P,m as L,e as H,M as J,B as K}from"./nb_NO-hGOvtq3f.js";import{M as O}from"./message-DM5Lea-D.js";import{A as U}from"./Alert-Djqd_aYT.js";import"./preload-helper-D9Z9MdNV.js";import"./index-Dm3E-MWw.js";const r=M(L),Y=a=>t=>{const n=a("foedselsDato");return z(n,t)},G=a=>t=>{const n=a("termindato");return E(n,t)},i=({readOnly:a,erForeldrepenger:t=!1})=>{const{watch:n,getValues:l,control:s}=A(),F=n("erBarnetFodt");return e.jsx(R,{value:r,children:e.jsx(I,{children:e.jsxs(B,{gap:"space-16",children:[e.jsx(N,{size:"small",level:"3",children:r.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),e.jsxs(C,{name:"erBarnetFodt",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[d],isReadOnly:a,children:[e.jsx(j,{value:!0,size:"small",children:e.jsx(O,{id:"Registrering.TerminOgFodsel.ErFodt"})}),e.jsx(j,{value:!1,size:"small",children:e.jsx(O,{id:"Registrering.TerminOgFodsel.ErIkkeFodt"})})]}),F!==void 0&&e.jsxs(B,{gap:"space-16",children:[F===!1&&e.jsxs(e.Fragment,{children:[e.jsxs(h,{gap:"space-16",children:[e.jsx(p,{name:"termindato",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:a,fromDate:f().toDate(),toDate:g().toDate(),defaultMonth:new Date,validate:[d,u,b(f()),D(g())]}),e.jsx(q,{name:"antallBarn",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:a,parse:o=>{const m=parseInt(o.toString(),10);return isNaN(m)?o:m},validate:[d,v,T,x]})]}),e.jsx(p,{name:"terminbekreftelseDato",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.UtstedtDato"}),isReadOnly:a,fromDate:V().toDate(),toDate:S().toDate(),defaultMonth:new Date,validate:[u,G(l)]})]}),F===!0&&e.jsxs(e.Fragment,{children:[e.jsxs(h,{gap:"space-16",children:[e.jsx(p,{name:"foedselsDato",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:a,validate:[d,u,b(y()),w],fromDate:y().toDate(),toDate:_().toDate()}),e.jsx(q,{name:"antallBarn",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:a,parse:o=>{const m=parseInt(o.toString(),10);return Number.isNaN(m)?o:m},validate:[d,v,T,x]})]}),t&&e.jsx(U,{size:"small",variant:"info",children:e.jsx(P,{size:"small",children:r.formatMessage({id:"Registrering.TerminOgFodsel.RettTilPrematuruker"})})}),e.jsx(p,{name:"termindato",control:s,label:r.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:a,validate:[u,b(f()),D(g()),Y(l)],fromDate:f().toDate(),toDate:g().toDate(),defaultMonth:new Date})]})]})]})})})};i.initialValues=()=>({erBarnetFodt:void 0});i.transformValues=({antallBarn:a,erBarnetFodt:t,foedselsDato:n,termindato:l,terminbekreftelseDato:s})=>t?{erBarnetFodt:!0,termindato:l,foedselsDato:n,antallBarn:a}:{erBarnetFodt:!1,termindato:l,terminbekreftelseDato:s,antallBarnFraTerminbekreftelse:a};i.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
...
}`,...k.parameters?.docs?.source}}};const te=["ForeldrepengeSak","ErIkkeForeldrepengeSak"];export{k as ErIkkeForeldrepengeSak,c as ForeldrepengeSak,te as __namedExportsOrder,re as default};
