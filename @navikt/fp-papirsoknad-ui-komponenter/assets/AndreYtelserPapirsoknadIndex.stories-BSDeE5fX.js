import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{a as V,g as O,j as K,k as x,H as h,A,B as w,d as $,V as S,c as U,r as H,q as X,P as B,f as C,m as z,e as G,$ as J}from"./nb_NO-DWXx_5rD.js";import{e as T,O as _,D as Q,H as W,a as Z}from"./index.es-CEGBLAGy.js";import"./withPanelData-DZ9oxQJ3.js";import{r as M}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as ee,a as re}from"./alleKodeverk-Ga5AMxGN.js";import{S as ne}from"./Trash-CtsbknFa.js";import{M as te}from"./message-VCpe8OHV.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-jtooXM-a.js";import"./iframe-CIcA63BH.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var m=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(m||{});const y="andreYtelser",D="andreYtelserPerioder",L="andreYtelserTyper",b=({readOnly:e,name:t})=>{const n=V(),{getValues:a,control:k,trigger:o,formState:{isSubmitted:E}}=O(),{fields:v,remove:R,append:c}=K({control:k,name:t});return M.useEffect(()=>{v.length===0&&c({periodeFom:"",periodeTom:""})},[]),r.jsx(x,{fields:v,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:c,remove:R,children:(F,s)=>{const I=`${t}.${s}`;return r.jsxs(h,{gap:"2",children:[r.jsx(A,{name:`${I}.periodeFom`,label:s===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[T,_,()=>{const{periodeFom:l,periodeTom:u}=a(`${t}.${s}`);return u&&l?Q(u)(l):null}],onChange:()=>E?o():void 0}),r.jsx(A,{name:`${t}.${s}.periodeTom`,label:s===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[T,_,()=>{const{periodeFom:l,periodeTom:u}=a(`${t}.${s}`);return l&&u?W(l)(u):null}],onChange:()=>E?o():void 0}),!e&&s>0&&r.jsx("div",{children:r.jsx(w,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(ne,{}),onClick:()=>R(s)})})]},F.id)}})};b.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const ae=(e,t)=>t?e.filter(n=>n.kode===m.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==m.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==m.FRILANSER&&n.kode!==m.LONN_UNDER_UTDANNING),d=({readOnly:e,kunMiliterEllerSiviltjeneste:t=!1,alleKodeverk:n})=>{const a=n[ee.ARBEID_TYPE],k=M.useMemo(()=>ae(a,t),[t]);return r.jsx($,{children:r.jsxs(S,{gap:"4",children:[r.jsx(U,{size:"small",children:r.jsx(te,{id:"Registrering.AndreYtelser.Title"})}),r.jsx(H,{isReadOnly:e,name:`${y}.${L}`,checkboxes:k.map(o=>({label:o.navn,value:o.kode,element:r.jsx(X,{children:r.jsx(b,{name:`${y}.${D}.${o.kode}`,readOnly:e})})}))})]})})};d.initialValues=()=>({[y]:{[L]:[],[D]:{}}});d.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:t}})=>({[y]:e.flatMap(n=>t[n].map(a=>({ytelseType:n,...a})))});d.__docgenInfo={description:`AndreYtelserPanel
...
Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const qe={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:Z("onSubmit")},args:{readOnly:!1,alleKodeverk:re},render:(e,{parameters:{submitCallback:t}})=>{const n=G({defaultValues:i.initialValues()});return r.jsx(J,{formMethods:n,onSubmit:a=>t(i.transformValues(a)),children:r.jsxs(S,{gap:"10",children:[r.jsx(i,{...e}),r.jsx(w,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{kunMiliterEllerSiviltjeneste:!1}},g={args:{kunMiliterEllerSiviltjeneste:!0}};var N,Y,q;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: false
  }
}`,...(q=(Y=p.parameters)==null?void 0:Y.docs)==null?void 0:q.source}}};var P,f,j;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: true
  }
}`,...(j=(f=g.parameters)==null?void 0:f.docs)==null?void 0:j.source}}};const Pe=["Default","KunMiliterEllerSiviltjeneste"];export{p as Default,g as KunMiliterEllerSiviltjeneste,Pe as __namedExportsOrder,qe as default};
