...
Viser inputfelter for arbeidsgiver og organisasjonsnummer for registrering av arbeidsforhold.`,methods:[],displayName:"RenderInntektsgivendeArbeidFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const m=({readOnly:s,alleKodeverk:n})=>e.jsxs(_,{children:[e.jsx(F,{size:"small",children:e.jsx(u,{id:"Registrering.InntektsgivendeArbeid.ArbeidINorge.Title"})}),e.jsx(i,{eightPx:!0}),e.jsx(c,{children:e.jsx(u,{id:"Registrering.InntektsgivendeArbeid.ArbeidINorge.SkalIkkeRegistrereArbeidsforhold"})}),e.jsx(i,{sixteenPx:!0}),e.jsx(i,{sixteenPx:!0}),e.jsx(c,{children:e.jsx(u,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtlandet.Title"})}),e.jsx(i,{eightPx:!0}),e.jsx(f,{readOnly:s,alleKodeverk:n})]});m.buildInitialValues=()=>({[t]:[{}]});m.__docgenInfo={description:`InntektsgivendeArbeidPanel

Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:null}],displayName:"InntektsgivendeArbeidPanel"};const X=L(D),l=({readOnly:s,alleKodeverk:n})=>e.jsx($,{value:X,children:e.jsx(m,{readOnly:s,alleKodeverk:n})});l.buildInitialValues=()=>m.buildInitialValues();l.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:null}],displayName:"InntektsgivendeArbeidPapirsoknadIndex"};const me={title:"papirsoknad/ui-komponenter/inntektsgivende-arbeid",component:l},Z=({submitCallback:s})=>{const n=S({defaultValues:l.buildInitialValues()});return e.jsxs(O,{formMethods:n,onSubmit:s,children:[e.jsx(l,{readOnly:!1,alleKodeverk:z}),e.jsx(i,{fourtyPx:!0}),e.jsx(C,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},o=Z.bind({});o.args={submitCallback:E("button-click")};var y,x,I;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`({
  submitCallback
}) => {
