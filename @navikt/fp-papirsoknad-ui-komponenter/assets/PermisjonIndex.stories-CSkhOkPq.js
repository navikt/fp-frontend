...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const on={title:"ui-komponenter/permisjon",component:O,parameters:{submitCallback:br("onSubmit")},args:{readOnly:!1,alleKodeverk:qr},render:(e,{parameters:{submitCallback:r}})=>{const a=pr({defaultValues:O.initialValues()});return n.jsx(vr,{formMethods:a,onSubmit:t=>r(O.transformValues(t)),children:n.jsxs(L,{gap:"10",children:[n.jsx(O,{...e}),n.jsx(yr,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},_={args:{foreldreType:ne.MOR,erEndringssøknad:!1}},N={args:{foreldreType:ne.FAR,erEndringssøknad:!1}},I={args:{foreldreType:ne.MOR,erEndringssøknad:!0}};var De,he,Se;_.parameters={..._.parameters,docs:{...(De=_.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
...
}`,...(er=(Ze=I.parameters)==null?void 0:Ze.docs)==null?void 0:er.source}}};const dn=["SokerErMor","SokerErFar","ErEndringssøknad"];export{I as ErEndringssøknad,N as SokerErFar,_ as SokerErMor,dn as __namedExportsOrder,on as default};
