import{u as U,r as P,j as a,t as O,O as s,R as B,J as g,P as y,e as p}from"./iframe-C-F1-KFd.js";import{u as A,a as H,P as Y,H as J,y as G,c as w,V as S,b as q,j as c,C,U as j,m as b,d as h,e as f,B as Z}from"./nb_NO-DCcstzbV.js";import{a as W}from"./alleKodeverk-C9CgZbBn.js";import{M as X}from"./message-Da0NzITC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C2Kif7jS.js";const v="andreYtelser",F="andreYtelserPerioder",I="andreYtelserTyper",V=({readOnly:l,name:n})=>{const e=U(),{getValues:r,control:E,trigger:t,formState:{isSubmitted:L}}=A(),{fields:D,remove:M,append:K}=H({control:E,name:n});return P.useEffect(()=>{D.length===0&&K({periodeFom:"",periodeTom:""})},[]),a.jsx(Y,{fields:D,addButtonText:e.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:l,append:K,remove:M,children:(o,u,d)=>{const k=`${n}.${u}`;return a.jsxs(J,{gap:"space-8",align:"end",children:[a.jsx(G,{name:`${k}.periodeFom`,control:E,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[O,s,()=>{const{periodeFom:N,periodeTom:R}=r(`${n}.${u}`);return R&&N?B(R)(N):null}],onChange:()=>L?t():void 0}),a.jsx(G,{name:`${n}.${u}.periodeTom`,control:E,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[O,s,()=>{const{periodeFom:N,periodeTom:R}=r(`${n}.${u}`);return N&&R?g(N)(R):null}],onChange:()=>L?t():void 0}),a.jsx("div",{children:d})]},o.id)}})};V.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const m=({readOnly:l,kunMiliterEllerSiviltjeneste:n=!1,alleKodeverk:e})=>{const{control:r}=A(),E=$(e.ArbeidType,n);return a.jsx(w,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(q,{size:"small",level:"3",children:a.jsx(X,{id:"Registrering.AndreYtelser.Title"})}),a.jsx(c,{hideLegend:!0,name:`${v}.${I}`,control:r,isReadOnly:l,children:E.map(t=>a.jsx(x,{arbeidstype:t,readOnly:l},t.kode))})]})})};m.initialValues=()=>({[v]:{[I]:[],[F]:{}}});m.transformValues=({andreYtelser:{andreYtelserTyper:l,andreYtelserPerioder:n}})=>({[v]:l.flatMap(e=>n[e]?.map(r=>({ytelseType:e,...r}))).filter(e=>e!==void 0)});const x=({arbeidstype:l,readOnly:n})=>{const{watch:e}=A(),r=e(`${v}.${I}`),[E,t]=P.useState(r.includes(l.kode));return a.jsxs(S,{gap:"space-12",children:[a.jsx(C,{value:l.kode,onClick:()=>t(!E),disabled:n,children:l.navn}),E&&a.jsx(j,{children:a.jsx(V,{name:`${v}.${F}.${l.kode}`,readOnly:n})})]})},$=(l,n)=>n?l.filter(e=>e.kode==="MILITÆR_ELLER_SIVILTJENESTE"):l.filter(e=>e.kode!=="UTENLANDSK_ARBEIDSFORHOLD"&&e.kode!=="FRILANSER"&&e.kode!=="LØNN_UNDER_UTDANNING");m.__docgenInfo={description:`AndreYtelserPanel
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Q=p(b),i=({readOnly:l,alleKodeverk:n,kunMiliterEllerSiviltjeneste:e})=>a.jsx(y,{value:Q,children:a.jsx(m,{readOnly:l,alleKodeverk:n,kunMiliterEllerSiviltjeneste:e})});i.initialValues=m.initialValues;i.transformValues=m.transformValues;i.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [ANDRE_YTELSER_NAME_PREFIX]: {
    [ANDRE_YTELSER_TYPER_NAME]: string[];
    [ANDRE_YTELSER_PERIODER_NAME]: {
      [key: string]: Periode[];
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:z}=__STORYBOOK_MODULE_ACTIONS__,te={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:z("onSubmit")},args:{readOnly:!1,alleKodeverk:W},render:(l,{parameters:{submitCallback:n}})=>{const e=h({defaultValues:i.initialValues()});return a.jsx(f,{formMethods:e,onSubmit:r=>n(i.transformValues(r)),children:a.jsxs(S,{gap:"space-40",children:[a.jsx(i,{...l}),a.jsx(Z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},T={args:{kunMiliterEllerSiviltjeneste:!1}},_={args:{kunMiliterEllerSiviltjeneste:!0}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,..._.parameters?.docs?.source}}};const ie=["Default","KunMiliterEllerSiviltjeneste"];export{T as Default,_ as KunMiliterEllerSiviltjeneste,ie as __namedExportsOrder,te as default};
