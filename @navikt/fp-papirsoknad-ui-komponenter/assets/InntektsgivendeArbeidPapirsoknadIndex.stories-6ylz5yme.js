import{j as r}from"./index-Byyjg8XX.js";import{a as F,e as T,i as I,$ as K,A as j,d as k,Y as E,f as N,V as R,b as V,k as P,P as _,r as x,m as M,c as h,N as D,B as L}from"./nb_NO-DYUjll3t.js";import{b as S,p as v,a as B}from"./index.es-fv94KH-L.js";import"./withPanelData-D7VbEMQx.js";import"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as H,a as $}from"./alleKodeverk-BGvpDL3l.js";import{L as Y}from"./landkoder-tJDPMx5C.js";import{F as G}from"./FieldArrayRow-BxrQXH8L.js";import{M as p}from"./message-BrM6o7bT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";import"./v4-CtRu48qb.js";import"./entry-preview-D4L2kBVD.js";import"./iframe-kjiINqz8.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./Trash-C9VLp8MT.js";const i="arbeidsforhold",z=S(50),C=n=>n.filter(({kode:e})=>e!==Y.NORGE).map(({kode:e,navn:a})=>r.jsx("option",{value:e,children:a},e)),b=({alleKodeverk:n,readOnly:e})=>{const a=F(),{control:g}=T(),{fields:f,remove:m,append:q}=I({control:g,name:i}),w=n[H.LANDKODER].slice().sort((u,s)=>u.navn.localeCompare(s.navn));return r.jsx(K,{fields:f,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:m,append:q,children:(u,s)=>r.jsxs(G,{remove:m,index:s,readOnly:e,children:[r.jsx(j,{readOnly:e,name:`${i}.${s}.arbeidsgiver`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[z],maxLength:99}),r.jsx(k,{isReadOnly:e,name:`${i}.${s}.periodeFom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[v]}),r.jsx(k,{isReadOnly:e,name:`${i}.${s}.periodeTom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[v]}),r.jsx(E,{readOnly:e,name:`${i}.${s}.land`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:C(w),size:"small"})]},u.id)})};b.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ve={title:"ui-komponenter/inntektsgivende-arbeid",component:t,args:{readOnly:!1,alleKodeverk:$},parameters:{submitCallback:B("onSubmit")},render:(n,{parameters:{submitCallback:e}})=>{const a=h({defaultValues:t.initialValues()});return r.jsx(D,{formMethods:a,onSubmit:g=>e(t.transformValues(g)),children:r.jsxs(R,{gap:"10",children:[r.jsx(t,{...n}),r.jsx(L,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},d={};var y,c,A;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:"{}",...(A=(c=d.parameters)==null?void 0:c.docs)==null?void 0:A.source}}};const pe=["Default"];export{d as Default,pe as __namedExportsOrder,ve as default};
