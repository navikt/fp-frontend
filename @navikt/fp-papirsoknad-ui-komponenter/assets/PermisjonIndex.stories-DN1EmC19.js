...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ce=`${d}.${Ye}`,I=e=>`${ce}.${e}`,_e=e=>()=>{const a=(e(ce)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Q(a):void 0},Oe={periodeFom:"",periodeTom:"",overforingArsak:""},Xe=({selectValues:e,readOnly:r})=>{const a=S(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:m}}=f(),{fields:u,remove:k,append:R}=J({control:t,name:ce});return U.useEffect(()=>{u.length===0&&R(Oe)},[]),n.jsx(C,{fields:u,emptyPeriodTemplate:Oe,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:k,children:(E,o)=>n.jsxs(ee,{readOnly:r,remove:k,index:o,children:[n.jsx("div",{children:n.jsx(_,{name:`${I(o)}.overforingArsak`,label:a.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[v],readOnly:r})}),n.jsx(F,{isReadOnly:r,name:`${I(o)}.periodeFom`,validate:[v,T,()=>{const p=s(`${I(o)}.periodeFom`),l=s(`${I(o)}.periodeTom`);return l&&p?z(l)(p):null},_e(s)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>m?i():void 0}),n.jsx(F,{isReadOnly:r,name:`${I(o)}.periodeTom`,validate:[v,T,()=>{const p=s(`${I(o)}.periodeFom`),l=s(`${I(o)}.periodeTom`);return l&&p?W(p)(l):null},_e(s)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>m?i():void 0})]},E.id)})};Xe.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const we={periodeFom:"",periodeTom:"",arsakForUtsettelse:""},ze=`${d}.${le}`,M=e=>`${ze}.${e}`,Ne=e=>()=>{const a=(e(`${ze}`)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?Q(a):void 0},Ke=(e,r,a)=>()=>{const t=`${M(r)}`,s=e(`${t}.periodeFom`),i=e(`${t}.periodeTom`);return!i&&!s?null:a?z(i)(s):W(s)(i)},jr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),_r=e=>e.filter(({kode:r})=>Re.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),We=({utsettelseReasons:e,utsettelseKvoter:r,readOnly:a})=>{const t=S(),{control:s,getValues:i,trigger:m,formState:{isSubmitted:u}}=f(),{fields:k,remove:R,append:E}=J({control:s,name:`${d}.${le}`});U.useEffect(()=>{k.length===0&&E(we)},[]);const o=U.useCallback(()=>u?m():void 0,[u,m]);return n.jsx(C,{fields:k,emptyPeriodTemplate:we,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:a,append:E,remove:R,children:(p,l)=>n.jsxs(ee,{readOnly:a,remove:R,index:l,children:[n.jsx(_,{name:`${M(l)}.periodeForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Periode"}),selectValues:_r(r),validate:[v]}),n.jsx(F,{name:`${M(l)}.periodeFom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,T,Ke(i,l,!0),Ne(i)],onChange:o}),n.jsx(F,{name:`${M(l)}.periodeTom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,T,Ke(i,l,!1),Ne(i)],onChange:o}),n.jsx(_,{name:`${M(l)}.arsakForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Arsak"}),selectValues:jr(e),validate:[v],onChange:o}),n.jsx(_,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${M(l)}.erArbeidstaker`,selectValues:[n.jsx("option",{value:"true",children:t.formatMessage({id:"Registrering.Permisjon.ErArbeidstaker"})},"true"),n.jsx("option",{value:"false",children:t.formatMessage({id:"Registrering.Permisjon.ErIkkeArbeidstaker"})},"false")],validate:[g=>i(`${M(l)}.arsakForUtsettelse`)==="ARBEID"?v(g):void 0]})]},p.id)})};We.__docgenInfo={description:`RenderUtsettelsePeriodeFieldArray
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Or=ar(tr),D=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>n.jsx(nr,{value:Or,children:n.jsx(L,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t})});D.transformValues=L.transformValues;D.initialValues=L.initialValues;D.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Wr={title:"ui-komponenter/permisjon",component:D,parameters:{submitCallback:gr("onSubmit")},args:{readOnly:!1,alleKodeverk:mr},render:(e,{parameters:{submitCallback:r}})=>{const a=sr({defaultValues:D.initialValues()});return n.jsx(ir,{formMethods:a,onSubmit:t=>r(D.transformValues(t)),children:n.jsxs(V,{gap:"10",children:[n.jsx(D,{...e}),n.jsx(or,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},ne={args:{foreldreType:Z.MOR,erEndringssøknad:!1}},ae={args:{foreldreType:Z.FAR,erEndringssøknad:!1}},te={args:{foreldreType:Z.MOR,erEndringssøknad:!0}};var Ie,Me,De;ne.parameters={...ne.parameters,docs:{...(Ie=ne.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  args: {
