...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  fremtidigeOppholdUtenlands?: FormValuesFieldArray[];
}`,signature:{properties:[{key:"oppholdINorge",value:{name:"boolean",required:!1}},{key:"harTidligereOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"harFremtidigeOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"tidligereOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}},{key:"fremtidigeOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}}]}}}}],displayName:"OppholdINorgePapirsoknadIndex"};const Me={title:"papirsoknad/ui-komponenter/opphold-i-norge",component:O},Y=({erAdopsjon:a,submitCallback:n})=>{const l=pe({defaultValues:O.buildInitialValues()});return r.jsxs(me,{formMethods:l,onSubmit:d=>n(O.transformValues(d)),children:[r.jsx(O,{readOnly:!1,erAdopsjon:a,alleKodeverk:he,mottattDato:"2022-05-30"}),r.jsx(p,{fourtyPx:!0}),r.jsx(ue,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},h=Y.bind({});h.args={erAdopsjon:!1,submitCallback:L("button-click")};const f=Y.bind({});f.args={erAdopsjon:!0,submitCallback:L("button-click")};var M,K,$;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`({
  erAdopsjon,
  submitCallback
}) => {
...
}`,...($=(K=h.parameters)==null?void 0:K.docs)==null?void 0:$.source}}};var B,_,C;f.parameters={...f.parameters,docs:{...(B=f.parameters)==null?void 0:B.docs,source:{originalSource:`({
  erAdopsjon,
  submitCallback
}) => {
  const formMethods = useForm({
...
}`,...(C=(_=f.parameters)==null?void 0:_.docs)==null?void 0:C.source}}};const Ke=["ForFodsel","ForAdopsjon"];export{f as ForAdopsjon,h as ForFodsel,Ke as __namedExportsOrder,Me as default};
