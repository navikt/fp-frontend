import{j as n}from"./jsx-runtime-DR9Q75dM.js";import{e as U,d as A,i as J,I as C,j as F,c as q,w as T,M as y,F as ie,A as $e,V as S,L as X,S as Ze,a as er,E as rr,t as nr,P as ar,m as tr,b as ir,$ as sr,B as or}from"./nb_NO-C2r3kIQs.js";import{H as v,g as j,m as ke,s as xe,f as z,D as W,U as Q,d as dr,I as lr,z as mr,a as ur}from"./index.es-B4BPTzAT.js";import"./aktivitetStatus-B1m96ipJ.js";import{F as Z}from"./foreldreType-BrQrvOqY.js";import"./withRouter-DhSU4y_G.js";import{K as _,a as gr}from"./kodeverkTyper-RnAavUTm.js";import{r as D}from"./index-DRjF_FHU.js";import{d as se}from"./dayjs.min-CnNqAF5I.js";import{F as ee}from"./FieldArrayRow-CSiBEt6S.js";import{A as Ye}from"./Alert-CGU2vmR1.js";import"./index-rX-Bn4lm.js";import"./v4-CQkTLCs1.js";import"./Trash-DjA97YPt.js";import"./ExclamationmarkTriangleFill-BCoUAuAw.js";var O=(e=>(e.FISKER="FISKER",e.ARBEIDSTAKER="ARBEIDSTAKER",e.SELVSTENDIG_NAERINGSDRIVENDE="SELVSTENDIG_NÆRINGSDRIVENDE",e.KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NAERINGSDRIVENDE="KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NÆRINGSDRIVENDE",e.SJOMANN="SJØMANN",e.JORDBRUKER="JORDBRUKER",e.DAGPENGER="DAGPENGER",e.INAKTIV="INAKTIV",e.KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER="KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER",e.KOMBINASJON_ARBEIDSTAKER_OG_FISKER="KOMBINASJON_ARBEIDSTAKER_OG_FISKER",e.FRILANSER="FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER="KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER="KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER",e.DAGMAMMA="DAGMAMMA",e.ANNET="ANNET",e))(O||{}),Y=(e=>(e.INGEN="INGEN",e.UTTAK_MØDREKVOTE_ANNEN_FORELDER="UTTAK_MØDREKVOTE_ANNEN_FORELDER",e.UTTAK_FEDREKVOTE_ANNEN_FORELDER="UTTAK_FEDREKVOTE_ANNEN_FORELDER",e.UTTAK_FELLESP_ANNEN_FORELDER="UTTAK_FELLESP_ANNEN_FORELDER",e.UTTAK_FORELDREPENGER_ANNEN_FORELDER="UTTAK_FORELDREPENGER_ANNEN_FORELDER",e.UDEFINERT="-",e))(Y||{}),H=(e=>(e.INSTITUSJONSOPPHOLD_ANNEN_FORELDER="INSTITUSJONSOPPHOLD_ANNEN_FORELDER",e.SYKDOM_ANNEN_FORELDER="SYKDOM_ANNEN_FORELDER",e.ALENEOMSORG="ALENEOMSORG",e.IKKE_RETT_ANNEN_FORELDER="IKKE_RETT_ANNEN_FORELDER",e.UDEFINERT="-",e))(H||{}),P=(e=>(e.MODREKVOTE="MØDREKVOTE",e.FEDREKVOTE="FEDREKVOTE",e.FELLESPERIODE="FELLESPERIODE",e.FORELDREPENGER_FOR_FODSEL="FORELDREPENGER_FØR_FØDSEL",e.FORELDREPENGER="FORELDREPENGER",e.UDEFINERT="-",e))(P||{});const l="tidsromPermisjon",h="graderingPeriode",ve="oppholdPerioder",Be="overforingsperioder",de="utsettelsePeriode",B="permisjonsPerioder",ye=`${l}.${B}`,b=e=>`${ye}.${e}`,pr=xe(100),Re=[P.FELLESPERIODE,P.FEDREKVOTE,P.FORELDREPENGER_FOR_FODSEL,P.FORELDREPENGER,P.MODREKVOTE],kr=e=>e.filter(({kode:r})=>Re.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),vr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),He=[P.FEDREKVOTE,P.FORELDREPENGER_FOR_FODSEL,P.MODREKVOTE],re=(e,r)=>e?r:"",yr=e=>!!e&&se(e,$e).isBefore(se("2019-01-01")),fe=e=>()=>{const a=(e(ye)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return z(a)},Ae=(e,r,a)=>()=>{const t=e(`${b(r)}.periodeFom`),i=e(`${b(r)}.periodeTom`);return!i||!t?null:a?W(i)(t):Q(t)(i)},le=({sokerErMor:e,readOnly:r,alleKodeverk:a})=>{const t=U(),i=a[_.UTTAK_PERIODE_TYPE],s=a[_.MORS_AKTIVITET];s.filter(({kode:k})=>k==="-").length===0&&s.unshift({kode:"-",navn:"",kodeverk:""});const{control:g,getValues:m,trigger:u,watch:R,formState:{isSubmitted:c}}=A(),{fields:o,remove:p,append:d}=J({control:g,name:ye});return D.useEffect(()=>{o.length===0&&d({})},[]),n.jsx(C,{readOnly:r,fields:o,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyPeriodTemplate:{},append:d,remove:p,children:(k,E)=>{const N=E===0,V=R(b(E)),$=yr(V.periodeFom),Qe=He.some(x=>x===V.periodeType)||V.periodeType==="";return n.jsxs(ee,{readOnly:r,remove:p,index:E,children:[n.jsx("div",{children:n.jsx(F,{readOnly:r,name:`${b(E)}.periodeType`,label:re(N,t.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:kr(i),validate:[v]})}),n.jsx(q,{isReadOnly:r,name:`${b(E)}.periodeFom`,label:re(N,t.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[v,j,Ae(m,E,!0),fe(m)],onChange:()=>c?u():void 0}),n.jsx(q,{isReadOnly:r,name:`${b(E)}.periodeTom`,label:re(N,t.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[v,j,Ae(m,E,!1),fe(m)],onChange:()=>c?u():void 0}),!e&&n.jsx(F,{readOnly:r,disabled:Qe,name:`${b(E)}.morsAktivitet`,label:re(N,t.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:vr(s),hideValueOnDisable:!0}),n.jsx(T,{readOnly:r,name:`${b(E)}.flerbarnsdager`,label:n.jsx(y,{id:"Registrering.Permisjon.Flerbarnsdager"})}),n.jsx(T,{readOnly:r,name:`${b(E)}.harSamtidigUttak`,label:n.jsx(y,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),V.harSamtidigUttak&&n.jsx(ie,{name:`${b(E)}.samtidigUttaksprosent`,validate:[ke,pr],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:x=>Number.isNaN(x)?x:parseFloat(x.toString()).toFixed(2)}),$&&n.jsx(Ye,{size:"small",variant:"warning",children:n.jsx(y,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},k.id)}})};le.transformValues=e=>e.map(r=>He.some(a=>a===r.periodeType)?{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,flerbarnsdager:r.flerbarnsdager?r.flerbarnsdager:!1,harSamtidigUttak:r.harSamtidigUttak?r.harSamtidigUttak:!1,samtidigUttaksprosent:r.samtidigUttaksprosent}:{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,morsAktivitet:r.morsAktivitet,flerbarnsdager:r.flerbarnsdager?r.flerbarnsdager:!1,harSamtidigUttak:r.harSamtidigUttak?r.harSamtidigUttak:!1,samtidigUttaksprosent:r.samtidigUttaksprosent});le.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av perioder med permijon.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Rr=mr(9),oe=`${l}.${h}`,f=e=>`${oe}.${e}`,be=e=>()=>{const a=(e(`${oe}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?z(a):void 0},Te=(e,r,a)=>()=>{const t=e(`${f(r)}.periodeFom`),i=e(`${f(r)}.periodeTom`);return!i||!t?null:a?W(i)(t):Q(t)(i)},cr=(e,r)=>a=>e(`${f(r)}.arbeidskategoriType`)===O.ARBEIDSTAKER?v(a):void 0,Er=e=>{if(e)return e.length===11?lr(e):Rr(e)},qe={periodeFom:"",periodeTom:"",periodeForGradering:"",prosentandelArbeid:"",skalGraderes:!1},fr=[O.ARBEIDSTAKER,O.SELVSTENDIG_NAERINGSDRIVENDE,O.FRILANSER],je=xe(100),Ar=e=>e.filter(({kode:r})=>Re.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),br=e=>e.filter(({kode:r})=>fr.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Je=({graderingKvoter:e,readOnly:r,arbeidskategoriTyper:a})=>{const t=U(),{watch:i,control:s,getValues:g,trigger:m,formState:{isSubmitted:u}}=A(),{fields:R,remove:c,append:o}=J({control:s,name:`${oe}`}),p=i(`${oe}`)||[];return D.useEffect(()=>{R.length===0&&o(qe)},[]),n.jsx(C,{fields:R,emptyPeriodTemplate:qe,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,remove:c,append:o,children:(d,k)=>{const{harSamtidigUttak:E,periodeFom:N}=p[k],V=N&&se(N,$e).isBefore(se("2019-01-01"));return n.jsxs(ee,{readOnly:r,remove:c,index:k,children:[n.jsx(F,{name:`${f(k)}.periodeForGradering`,selectValues:Ar(e),label:t.formatMessage({id:"Registrering.Permisjon.Gradering.Periode"}),validate:[v]}),n.jsx(q,{label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),name:`${f(k)}.periodeFom`,validate:[v,j,Te(g,k,!0),be(g)],onChange:()=>u?m():void 0}),n.jsx(q,{label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),name:`${f(k)}.periodeTom`,validate:[v,j,Te(g,k,!1),be(g)],onChange:()=>u?m():void 0}),n.jsx(ie,{label:n.jsx(y,{id:"Registrering.Permisjon.Gradering.Prosentandel"}),name:`${f(k)}.prosentandelArbeid`,validate:[v,ke,je],normalizeOnBlur:$=>Number.isNaN($)?$:parseFloat($.toString()).toFixed(2)}),n.jsx(ie,{label:t.formatMessage({id:"Registrering.Permisjon.Orgnr"}),name:`${f(k)}.arbeidsgiverIdentifikator`,validate:[cr(g,k),dr,Er]}),n.jsx(F,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${f(k)}.arbeidskategoriType`,selectValues:br(a),validate:[v],onChange:()=>u?m():void 0}),n.jsx(T,{name:`${f(k)}.skalGraderes`,label:n.jsx(y,{id:"Registrering.Permisjon.Gradering.SkalGraderes"})}),n.jsx(T,{readOnly:r,name:`${f(k)}.flerbarnsdager`,label:n.jsx(y,{id:"Registrering.Permisjon.Flerbarnsdager"})}),n.jsx(T,{name:`${f(k)}.harSamtidigUttak`,label:n.jsx(y,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),E&&n.jsx(ie,{name:`${f(k)}.samtidigUttaksprosent`,validate:[v,ke,je],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"})}),V&&n.jsx(Ye,{size:"small",variant:"warning",children:n.jsx(y,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},d.id)}})};Je.__docgenInfo={description:`RenderGraderingPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const ce=`${l}.${ve}`,w=e=>`${ce}.${e}`,Pe=e=>()=>{const a=(e(`${ce}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?z(a):void 0},Fe={periodeFom:"",periodeTom:"",årsak:""},Tr=[Y.UTTAK_MØDREKVOTE_ANNEN_FORELDER,Y.UTTAK_FEDREKVOTE_ANNEN_FORELDER,Y.UTTAK_FELLESP_ANNEN_FORELDER,Y.UTTAK_FORELDREPENGER_ANNEN_FORELDER],qr=e=>e.filter(({kode:r})=>Tr.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Ce=({oppholdsReasons:e,readOnly:r})=>{const a=U(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=A(),{fields:m,remove:u,append:R}=J({control:t,name:`${ce}`});return D.useEffect(()=>{m.length===0&&R(Fe)},[]),n.jsx(C,{fields:m,emptyPeriodTemplate:Fe,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:u,children:(c,o)=>n.jsxs(ee,{readOnly:r,remove:u,index:o,children:[n.jsx(q,{name:`${w(o)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,j,()=>{const p=i(`${w(o)}.periodeFom`),d=i(`${w(o)}.periodeTom`);return d&&p?W(d)(p):null},Pe(i)],onChange:()=>g?s():void 0}),n.jsx(q,{name:`${w(o)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,j,()=>{const p=i(`${w(o)}.periodeFom`),d=i(`${w(o)}.periodeTom`);return d&&p?Q(p)(d):null},Pe(i)],onChange:()=>g?s():void 0}),n.jsx("div",{children:n.jsx(F,{name:`${w(o)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:qr(e),validate:[v]})})]},c.id)})};Ce.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av oppholdsperiode.`,methods:[],displayName:"RenderOppholdPeriodeFieldArray",props:{oppholdsReasons:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ue=({readOnly:e,alleKodeverk:r})=>{const a=r[_.OPPHOLD_ARSAK],{watch:t}=A(),i=t(`${l}.skalHaOpphold`)||!1;return n.jsxs(S,{gap:"2",children:[n.jsx(X,{children:n.jsx(y,{id:"Registrering.Permisjon.Opphold.Title"})}),n.jsx(T,{readOnly:e,name:`${l}.skalHaOpphold`,label:n.jsx(y,{id:"Registrering.Permisjon.Opphold.OppholdUttaket"})}),i&&n.jsx(Ce,{oppholdsReasons:a,readOnly:e})]})};ue.initialValues=()=>({[ve]:[],skalHaOpphold:!1});ue.__docgenInfo={description:`PermisjonOppholdPanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Ee=`${l}.${Be}`,I=e=>`${Ee}.${e}`,Oe=e=>()=>{const a=(e(Ee)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?z(a):void 0},_e={periodeFom:"",periodeTom:"",overforingArsak:""},Xe=({selectValues:e,readOnly:r})=>{const a=U(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=A(),{fields:m,remove:u,append:R}=J({control:t,name:Ee});return D.useEffect(()=>{m.length===0&&R(_e)},[]),n.jsx(C,{fields:m,emptyPeriodTemplate:_e,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:u,children:(c,o)=>n.jsxs(ee,{readOnly:r,remove:u,index:o,children:[n.jsx("div",{children:n.jsx(F,{name:`${I(o)}.overforingArsak`,label:a.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[v],readOnly:r})}),n.jsx(q,{isReadOnly:r,name:`${I(o)}.periodeFom`,validate:[v,j,()=>{const p=i(`${I(o)}.periodeFom`),d=i(`${I(o)}.periodeTom`);return d&&p?W(d)(p):null},Oe(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>g?s():void 0}),n.jsx(q,{isReadOnly:r,name:`${I(o)}.periodeTom`,validate:[v,j,()=>{const p=i(`${I(o)}.periodeFom`),d=i(`${I(o)}.periodeTom`);return d&&p?Q(p)(d):null},Oe(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>g?s():void 0})]},c.id)})};Xe.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray

Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const jr=(e,r,a)=>r===H.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):r===H.SYKDOM_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):a,Pr=(e,r,a,t)=>e.filter(({kode:i})=>a||i!==H.ALENEOMSORG&&i!==H.IKKE_RETT_ANNEN_FORELDER).map(({kode:i,navn:s})=>r?n.jsx("option",{value:i,children:s},i):n.jsx("option",{value:i,children:jr(t,i,s)},i)),ge=({foreldreType:e,alleKodeverk:r,readOnly:a,erEndringssøknad:t})=>{const i=U(),s=r[_.OVERFOERING_AARSAK_TYPE],g=Pr(s,e===Z.MOR,t,i),{watch:m}=A(),u=m(`${l}.skalOvertaKvote`)||!1;return n.jsxs(S,{gap:"2",children:[n.jsx(X,{children:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),n.jsx(T,{readOnly:a,name:`${l}.skalOvertaKvote`,label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),u&&n.jsx(Xe,{selectValues:g,readOnly:a})]})};ge.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});ge.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ne={periodeFom:"",periodeTom:"",arsakForUtsettelse:""},ze=`${l}.${de}`,M=e=>`${ze}.${e}`,we=e=>()=>{const a=(e(`${ze}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?z(a):void 0},Ie=(e,r,a)=>()=>{const t=`${M(r)}`,i=e(`${t}.periodeFom`),s=e(`${t}.periodeTom`);return!s&&!i?null:a?W(s)(i):Q(i)(s)},Fr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Or=e=>e.filter(({kode:r})=>Re.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),We=({utsettelseReasons:e,utsettelseKvoter:r,readOnly:a})=>{const t=U(),{control:i,getValues:s,trigger:g,formState:{isSubmitted:m}}=A(),{fields:u,remove:R,append:c}=J({control:i,name:`${l}.${de}`});D.useEffect(()=>{u.length===0&&c(Ne)},[]);const o=D.useCallback(()=>m?g():void 0,[m,g]);return n.jsx(C,{fields:u,emptyPeriodTemplate:Ne,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:a,append:c,remove:R,children:(p,d)=>n.jsxs(ee,{readOnly:a,remove:R,index:d,children:[n.jsx(F,{name:`${M(d)}.periodeForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Periode"}),selectValues:Or(r),validate:[v]}),n.jsx(q,{name:`${M(d)}.periodeFom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,j,Ie(s,d,!0),we(s)],onChange:o}),n.jsx(q,{name:`${M(d)}.periodeTom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,j,Ie(s,d,!1),we(s)],onChange:o}),n.jsx(F,{name:`${M(d)}.arsakForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Arsak"}),selectValues:Fr(e),validate:[v],onChange:o}),n.jsx(F,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${M(d)}.erArbeidstaker`,selectValues:[n.jsx("option",{value:"true",children:t.formatMessage({id:"Registrering.Permisjon.ErArbeidstaker"})},"true"),n.jsx("option",{value:"false",children:t.formatMessage({id:"Registrering.Permisjon.ErIkkeArbeidstaker"})},"false")],validate:[k=>s(`${M(d)}.arsakForUtsettelse`)==="ARBEID"?v(k):void 0]})]},p.id)})};We.__docgenInfo={description:`RenderUtsettelsePeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av utsettelseperiode.`,methods:[],displayName:"RenderUtsettelsePeriodeFieldArray",props:{utsettelseReasons:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const pe=({readOnly:e,alleKodeverk:r})=>{const a=r[_.UTSETTELSE_AARSAK_TYPE],t=r[_.UTTAK_PERIODE_TYPE],{watch:i}=A(),s=i(`${l}.skalUtsette`)||!1;return n.jsxs(S,{gap:"2",children:[n.jsx(X,{children:n.jsx(y,{id:"Registrering.Permisjon.Utsettelse.Title"})}),n.jsx(T,{readOnly:e,name:`${l}.skalUtsette`,label:n.jsx(y,{id:"Registrering.Permisjon.Utsettelse.UtsettUttaket"})}),s&&n.jsx(We,{utsettelseReasons:a,utsettelseKvoter:t,readOnly:e})]})};pe.initialValues=()=>({[de]:[],skalUtsette:!1});pe.__docgenInfo={description:`PermisjonUtsettelsePanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const _r=e=>{const r=e(`${l}.fulltUttak`)||!1,a=e(`${l}.skalGradere`)||!1,t=e(`${l}.skalUtsette`)||!1,i=e(`${l}.skalOvertaKvote`)||!1;return!r&&!a&&!t&&!i},L=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>{var c,o,p,d;const i=U(),{setError:s,clearErrors:g,getValues:m,formState:u}=A(),R=_r(m);return D.useEffect(()=>{R&&s(`${l}.notRegisteredInput`,{type:"custom",message:i.formatMessage({id:"PermisjonPanel.MinstEnPeriodeRequired"})}),R||g(`${l}.notRegisteredInput`)},[R]),n.jsx(Ze,{children:n.jsxs(S,{gap:"4",children:[n.jsx(er,{size:"small",children:n.jsx(y,{id:"Registrering.Permisjon.Title"})}),n.jsx(me,{foreldreType:e,readOnly:r,alleKodeverk:a}),n.jsx(ge,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t}),n.jsx(pe,{readOnly:r,alleKodeverk:a}),n.jsx(G,{readOnly:r,alleKodeverk:a}),n.jsx(ue,{readOnly:r,alleKodeverk:a}),u.isSubmitted&&((o=(c=u.errors[l])==null?void 0:c.notRegisteredInput)==null?void 0:o.message)&&n.jsx(rr,{children:(d=(p=u.errors[l])==null?void 0:p.notRegisteredInput)==null?void 0:d.message})]})})};L.transformValues=e=>{var s,g,m,u,R,c,o;const r=e[l],a=r,t=r[B];(s=e.tidsromPermisjon)!=null&&s.fulltUttak&&t&&(a[B]=le.transformValues(t));const i=r[h];return(g=e.tidsromPermisjon)!=null&&g.skalGradere&&i&&(a[h]=G.transformValues(r)),(m=e.tidsromPermisjon)!=null&&m.fulltUttak||(a[B]=void 0),(u=e.tidsromPermisjon)!=null&&u.skalGradere||(a[h]=void 0),(R=e.tidsromPermisjon)!=null&&R.skalUtsette||(a[de]=void 0),(c=e.tidsromPermisjon)!=null&&c.skalOvertaKvote||(a[Be]=void 0),(o=e.tidsromPermisjon)!=null&&o.skalHaOpphold||(a[ve]=void 0),{[l]:a}};L.initialValues=()=>({[l]:{...me.initialValues(),...ge.initialValues(),...pe.initialValues(),...G.initialValues(),...ue.initialValues()}});L.__docgenInfo={description:`PermisjonPanel
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Nr=nr(tr),K=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>n.jsx(ar,{value:Nr,children:n.jsx(L,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t})});K.transformValues=L.transformValues;K.initialValues=L.initialValues;K.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Hr={title:"ui-komponenter/permisjon",component:K,parameters:{submitCallback:ur("onSubmit")},args:{readOnly:!1,alleKodeverk:gr},render:(e,{parameters:{submitCallback:r}})=>{const a=ir({defaultValues:K.initialValues()});return n.jsx(sr,{formMethods:a,onSubmit:t=>r(K.transformValues(t)),children:n.jsxs(S,{gap:"10",children:[n.jsx(K,{...e}),n.jsx(or,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},ne={args:{foreldreType:Z.MOR,erEndringssøknad:!1}},ae={args:{foreldreType:Z.FAR,erEndringssøknad:!1}},te={args:{foreldreType:Z.MOR,erEndringssøknad:!0}};var Me,Ke,De;ne.parameters={...ne.parameters,docs:{...(Me=ne.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
...
}`,...(Le=(Ge=te.parameters)==null?void 0:Ge.docs)==null?void 0:Le.source}}};const Jr=["SokerErMor","SokerErFar","ErEndringssøknad"];export{te as ErEndringssøknad,ae as SokerErFar,ne as SokerErMor,Jr as __namedExportsOrder,Hr as default};
