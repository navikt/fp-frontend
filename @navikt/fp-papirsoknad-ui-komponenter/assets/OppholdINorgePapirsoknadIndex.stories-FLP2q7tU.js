import{u as E,j as e,c as H,t as F,O as w,R as c,d as K,b as N,J as j,h as G,P as Y,a as L}from"./iframe-b8YIwttN.js";import{u as I,a as _,N as D,H as $,M as C,y as U,d as z,V as T,b as J,c as M,m as Q,e as W,D as X,B as Z}from"./nb_NO-Xcu8FagV.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as f}from"./TrueFalseInput-B5WuneVS.js";import{L as re}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-DU0tYoke.js";import"./preload-helper-D9Z9MdNV.js";import"./index-DUqnE7tV.js";const ne={land:void 0,periodeFom:void 0,periodeTom:void 0},A=(n,r)=>n(r),S=(n,r)=>()=>{const l=n(r).filter(({periodeFom:t,periodeTom:a})=>t&&t!==""&&a&&a!=="").map(({periodeFom:t,periodeTom:a})=>[t,a]);return l.length>0?G(l):void 0},ae=n=>n.filter(({kode:r})=>r!==re.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(n,r,s,l)=>()=>{const t=A(n,`${r}.${s}.periodeFom`),a=A(n,`${r}.${s}.periodeTom`);return!a||!t?null:l?c(a)(t):j(t)(a)},V=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:i,trigger:m,formState:{isSubmitted:g}}=I(),{fields:q,remove:h,append:B}=_({control:o,name:a}),x=ae(l);return e.jsx(D,{fields:q,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:ne,readOnly:s,remove:h,append:B,children:(b,d,R)=>e.jsx(H.Fragment,{children:e.jsxs($,{gap:"space-16",paddingBlock:"2",children:[e.jsx(C,{name:`${a}.${d}.land`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:x,readOnly:s,validate:[F]}),e.jsx(U,{name:`${a}.${d}.periodeFom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,w,P(i,a,d,!0),()=>{const k=A(i,`${a}.${d}.periodeFom`);return n?c(K().format(N))(k):r?j(r)(k):void 0},S(i,a)],onChange:()=>g?m():void 0}),e.jsx(U,{name:`${a}.${d}.periodeTom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,w,P(i,a,d,!1),()=>{const k=A(i,`${a}.${d}.periodeTom`);return n?c(K().format(N))(k):r?j(r)(k):void 0},S(i,a)],onChange:()=>g?m():void 0}),R&&e.jsx("div",{children:R()})]},b.id)},b.id)})};V.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:n=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=E(),a=r.Landkoder.slice().sort((q,h)=>q.navn.localeCompare(h.navn)),{watch:o,control:i}=I(),m=!o("oppholdSisteTolvINorge",!0),g=!o("oppholdNesteTolvINorge",!0);return e.jsx(z,{children:e.jsxs(T,{gap:"space-16",children:[e.jsx(J,{size:"small",level:"3",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(f,{name:"oppholdINorge",control:i,label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),m&&e.jsx(M,{alignOffset:58,children:e.jsx(V,{erTidligereOpphold:!0,mottattDato:s,countryCodes:a,readOnly:n})})]}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),g&&e.jsx(M,{alignOffset:58,children:e.jsx(V,{mottattDato:s,countryCodes:a,readOnly:n})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});p.__docgenInfo={description:`OppholdINorgePanel
