import{j as r}from"./dayjs.min-D0F5fy79.js";import{g as E,h as z,l as Z,w as ee,U as re,b as p,s as ae,W as ne,e as oe,L as x,P as N,A as q,S as le,H as se,M as O,a as j,O as R,t as te,k as de,m as ie,c as L,d as pe,Y as me,B as ue}from"./nb_NO-CdUvm0lp.js";import"./withRouter-DFPnh569.js";import{K as ge,a as he}from"./alleKodeverk-DLgIwMJI.js";import{g as fe,r as H,R as ce}from"./index-CTjT7uj6.js";import{r as m,b as T,I as V,h as w,c as U,q as ye}from"./index.es-R_VB8V1y.js";import{l as Oe}from"./landkoder-T-1RG3zx.js";import"./v4-CQkTLCs1.js";import"./index-CYM-y3Gt.js";var W={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/(function(a){(function(){var n={}.hasOwnProperty;function l(){for(var e="",s=0;s<arguments.length;s++){var t=arguments[s];t&&(e=o(e,d.call(this,t)))}return e}function d(e){if(typeof e=="string"||typeof e=="number")return this&&this[e]||e;if(typeof e!="object")return"";if(Array.isArray(e))return l.apply(this,e);if(e.toString!==Object.prototype.toString&&!e.toString.toString().includes("[native code]"))return e.toString();var s="";for(var t in e)n.call(e,t)&&e[t]&&(s=o(s,this&&this[t]||t));return s}function o(e,s){return s?e?e+" "+s:e+s:e}a.exports?(l.default=l,a.exports=l):window.classNames=l})()})(W);var Fe=W.exports;const ve=fe(Fe),be="_datesRowWithRemoveButton_od5lu_1",ke="_selectBredde_od5lu_7",Y={datesRowWithRemoveButton:be,selectBredde:ke},xe=ve.bind(Y),je={land:"",periodeFom:"",periodeTom:""},v=(a,n)=>a(n),P=(a,n)=>()=>{const d=a(n).filter(({periodeFom:o,periodeTom:e})=>o&&o!==""&&e&&e!=="").map(({periodeFom:o,periodeTom:e})=>[o,e]);return d.length>0?ye(d):void 0},Ve=a=>a.filter(({kode:n})=>n!==Oe.NORGE).map(({kode:n,navn:l})=>r.jsx("option",{value:n,children:l},n)),S=(a,n,l,d)=>()=>{const o=v(a,`${n}.${l}.periodeFom`),e=v(a,`${n}.${l}.periodeTom`);return!e||!o?null:d?V(e)(o):U(o)(e)},A=({erTidligereOpphold:a,mottattDato:n,readOnly:l,countryCodes:d})=>{const o=E(),e=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:s,getValues:t,trigger:c,formState:{isSubmitted:y}}=z(),{fields:k,remove:G,append:J}=Z({control:s,name:e}),Q=H.useMemo(()=>Ve(d),[d]);return r.jsx(ee,{fields:k,titleText:o.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:o.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:je,createAddButtonInsteadOfImageLink:!0,readOnly:l,remove:G,append:J,children:(X,i,I)=>r.jsxs(ce.Fragment,{children:[i>0&&r.jsxs(r.Fragment,{children:[r.jsx(re,{}),r.jsx(p,{sixteenPx:!0})]}),r.jsx(ae,{name:`${e}.${i}.land`,label:o.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:Q,className:Y.selectBredde,readOnly:l,validate:[m]}),r.jsx(p,{sixteenPx:!0}),r.jsx(ne,{children:r.jsxs(oe,{className:xe({datesRowWithRemoveButton:i>0}),children:[r.jsx(x,{children:r.jsx(N,{name:`${e}.${i}.periodeFom`,label:o.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:l,validate:[m,T,S(t,e,i,!0),()=>{const g=v(t,`${e}.${i}.periodeFom`);return a?V(w().format(q))(g):n?U(n)(g):void 0},P(t,e)],onChange:()=>y?c():void 0})}),r.jsx(x,{children:r.jsx(N,{name:`${e}.${i}.periodeTom`,label:o.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:l,validate:[m,T,S(t,e,i,!1),()=>{const g=v(t,`${e}.${i}.periodeTom`);return a?V(w().format(q))(g):n?U(n)(g):void 0},P(t,e)],onChange:()=>y?c():void 0})}),I&&r.jsx(x,{children:I()})]})}),r.jsx(p,{sixteenPx:!0})]},X.id)})};A.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!0,tsType:{name:"boolean"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const u=({readOnly:a=!0,alleKodeverk:n,mottattDato:l,erAdopsjon:d})=>{const{formatMessage:o}=E(),e=H.useMemo(()=>n[ge.LANDKODER].slice().sort((y,k)=>y.navn.localeCompare(k.navn)),[n]),{watch:s}=z(),t=s("harTidligereOppholdUtenlands")||!1,c=s("harFremtidigeOppholdUtenlands")||!1;return r.jsxs(le,{children:[r.jsx(se,{size:"small",children:r.jsx(O,{id:"Registrering.Opphold"})}),r.jsx(p,{sixteenPx:!0}),r.jsx(j,{name:"oppholdINorge",label:r.jsx(O,{id:d?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),validate:[m],isReadOnly:a,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:o({id:"Registrering.Opphold.Yes"}),value:"true"},{label:o({id:"Registrering.Opphold.No"}),value:"false"}]}),r.jsx(p,{sixteenPx:!0}),r.jsx(j,{name:"harTidligereOppholdUtenlands",label:r.jsx(O,{id:"Registrering.OppholdSisteTolv"}),validate:[m],isReadOnly:a,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:o({id:"Registrering.Opphold.Yes"}),value:"false"},{label:o({id:"Registrering.Opphold.No"}),value:"true"}]}),t?r.jsxs(r.Fragment,{children:[r.jsx(p,{eightPx:!0}),r.jsx(R,{alignOffset:64,children:r.jsx(A,{erTidligereOpphold:!0,mottattDato:l,countryCodes:e,readOnly:a})})]}):null,r.jsx(p,{sixteenPx:!0}),r.jsx(j,{name:"harFremtidigeOppholdUtenlands",label:r.jsx(O,{id:"Registrering.OppholdNesteTolv"}),validate:[m],isReadOnly:a,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:o({id:"Registrering.Opphold.Yes"}),value:"false"},{label:o({id:"Registrering.Opphold.No"}),value:"true"}]}),c?r.jsxs(r.Fragment,{children:[r.jsx(p,{eightPx:!0}),r.jsx(R,{alignOffset:64,children:r.jsx(A,{erTidligereOpphold:!1,mottattDato:l,countryCodes:e,readOnly:a})})]}):null]})};u.buildInitialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});u.transformValues=a=>({...a,fremtidigeOppholdUtenlands:a.harFremtidigeOppholdUtenlands?a.fremtidigeOppholdUtenlands:void 0,tidligereOppholdUtenlands:a.harTidligereOppholdUtenlands?a.tidligereOppholdUtenlands:void 0});u.__docgenInfo={description:`OppholdINorgePanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  fremtidigeOppholdUtenlands?: FormValuesFieldArray[];
}`,signature:{properties:[{key:"oppholdINorge",value:{name:"boolean",required:!1}},{key:"harTidligereOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"harFremtidigeOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"tidligereOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}},{key:"fremtidigeOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}}]}}}}],displayName:"OppholdINorgePapirsoknadIndex"};const Me={title:"papirsoknad/ui-komponenter/opphold-i-norge",component:F},D=({erAdopsjon:a,submitCallback:n})=>{const l=pe({defaultValues:F.buildInitialValues()});return r.jsxs(me,{formMethods:l,onSubmit:d=>n(F.transformValues(d)),children:[r.jsx(F,{readOnly:!1,erAdopsjon:a,alleKodeverk:he,mottattDato:"2022-05-30"}),r.jsx(p,{fourtyPx:!0}),r.jsx(ue,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},h=D.bind({});h.args={erAdopsjon:!1,submitCallback:L("button-click")};const f=D.bind({});f.args={erAdopsjon:!0,submitCallback:L("button-click")};var M,K,$;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`({
  erAdopsjon,
  submitCallback
}) => {
