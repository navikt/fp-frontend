import{u as B,j as e,r as $,P as X,a as Q}from"./iframe-DDPNky5o.js";import{u as S,c as q,V as b,Y as W,H as Z,P as f,A as F,L as ee,C as D,f as re,B as c,k as ne,j as ae,l as te,a as se,E as ie,n as le,d as ue,b as ke,M as oe,m as de,e as ge,N as me}from"./nb_NO-Vj-gvTe9.js";import{a as ye}from"./alleKodeverk-DO07GSZv.js";import{e as u,p as w,S as ve,R as pe,c as I,d as Te,y as J}from"./index.es-D8T_aAqS.js";import{T as K}from"./TrueFalseInput-B55hg1G8.js";import{M as s}from"./message-CTH9AWjc.js";import{T as k,S as Ae}from"./Table-bkb8mX6_.js";import{S as qe}from"./Trash-Dm1Iq7bD.js";import"./index-DWzm94QN.js";var g=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(g||{});const T="egenVirksomhet",i=`${T}.virksomheter`,be={},Re=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),E=({index:r,readOnly:n,alleKodeverk:a})=>{const t=B(),l=a.Landkoder.slice().sort((o,d)=>o.navn.localeCompare(d.navn)),{getValues:m}=S();return e.jsx(K,{name:`${i}.${r}.virksomhetRegistrertINorge`,label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(q,{marginTop:8,children:e.jsx(F,{name:`${i}.${r}.organisasjonsnummer`,readOnly:n,validate:[u,I,Te],label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(q,{alignOffset:58,marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(W,{name:`${i}.${r}.landJobberFra`,className:be.landBredde,selectValues:Re(l),validate:[u],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(Z,{gap:"4",children:[e.jsx(f,{isReadOnly:n,validate:[u,w,ve],name:`${i}.${r}.fom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(f,{isReadOnly:n,validate:[w,o=>{const d=m(`${i}.${r}.fom`);return d?pe(d,o):null}],name:`${i}.${r}.tom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};E.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:l})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:l}:{landJobberFra:"NOR"}});E.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const Fe="_inntektBredde_1xgnj_1",Ve={inntektBredde:Fe},he=({readOnly:r,index:n})=>[{value:"harVarigEndring",label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.HarVarigEndring"}),element:e.jsx(q,{marginTop:8,children:e.jsx(f,{name:`${i}.${n}.varigEndringGjeldendeFom`,isReadOnly:r,validate:[w,u],label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})},{value:"erNyoppstartet",label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.ErNyoppstartet"})},{value:"erNyIArbeidslivet",label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.NyIArbeidslivet"}),element:e.jsx(q,{marginTop:8,children:e.jsx(f,{name:`${i}.${n}.nyIArbeidslivetFom`,isReadOnly:r,validate:[w,u],label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})}],O=({readOnly:r,index:n})=>e.jsx(K,{name:`${i}.${n}.varigEndretEllerStartetSisteFireAr`,label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.NewlyStartedOrChanged"}),readOnly:r,trueContent:e.jsx(q,{marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(ee,{size:"small",children:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.Reason"})}),e.jsx(D,{validate:[u],name:`${i}.${n}.varigEndretEllerStartetSisteFireArArsak`,checkboxes:he({readOnly:r,index:n})}),e.jsx(re,{name:`${i}.${n}.beskrivelseAvEndring`,label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.VirksomhetEndretBeskrivelse"}),validate:[J]}),e.jsx(F,{name:`${i}.${n}.inntekt`,label:e.jsx(s,{id:"Registrering.VirksomhetStartetPanel.Inntekt"}),readOnly:r,validate:[I,u],className:Ve.inntektBredde,parse:a=>{const t=parseInt(a.toString(),10);return Number.isNaN(t)?a:t}})]})})});O.transformValues=({varigEndretEllerStartetSisteFireAr:r,varigEndretEllerStartetSisteFireArArsak:n,varigEndringGjeldendeFom:a,nyIArbeidslivetFom:t,beskrivelseAvEndring:l,inntekt:m})=>{const o=n.includes("harVarigEndring"),d=n.includes("erNyoppstartet"),y=n.includes("erNyIArbeidslivet");return{varigEndretEllerStartetSisteFireAr:r,...r?{harVarigEndring:o,...o?{varigEndringGjeldendeFom:a}:{},erNyoppstartet:d,erNyIArbeidslivet:y,...y?{nyIArbeidslivetFom:t}:{},beskrivelseAvEndring:l,inntekt:m}:{}}};O.__docgenInfo={description:`VirksomhetStartetEndretPanel
...
papirsøknad dersom søknad gjelder foreldrepenger og saksbehandler skal legge til ny virksomhet for søker.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  beskrivelseAvEndring?: string;
  inntekt?: number;
}`,signature:{properties:[{key:"varigEndretEllerStartetSisteFireAr",value:{name:"boolean",required:!1}},{key:"varigEndretEllerStartetSisteFireArArsak",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"varigEndringGjeldendeFom",value:{name:"string",required:!1}},{key:"nyIArbeidslivetFom",value:{name:"string",required:!1}},{key:"beskrivelseAvEndring",value:{name:"string",required:!1}},{key:"inntekt",value:{name:"number",required:!1}}]},alias:"StartedEndretFormValues"}}],returns:null}],displayName:"VirksomhetStartetEndretPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const x={[g.DAGMAMMA]:1,[g.FISKE]:2,[g.JORDBRUK_ELLER_SKOGBRUK]:3,[g.ANNEN]:4},je=(r,n)=>r>n?1:r<n?-1:0,fe=r=>r.VirksomhetType.filter(n=>n.kode!==g.FRILANSER).sort((n,a)=>je(x[n.kode],x[a.kode])).map(n=>({value:n.kode,label:n.navn})),P=({readOnly:r,alleKodeverk:n,index:a})=>e.jsx(D,{label:e.jsx(s,{id:"Registrering.VirksomhetNaeringTypePanel.Title"}),name:`${i}.${a}.typeVirksomhet`,validate:[u],checkboxes:fe(n),isReadOnly:r});P.transformValues=({typeVirksomhet:r})=>({typeVirksomhet:{ANNEN:r.includes(g.ANNEN),FISKE:r.includes(g.FISKE),DAGMAMMA:r.includes(g.DAGMAMMA),JORDBRUK_SKOGBRUK:r.includes(g.JORDBRUK_ELLER_SKOGBRUK)}});P.__docgenInfo={description:`VirksomhetTypeNaringPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const A=({open:r,readOnly:n=!1,alleKodeverk:a,index:t,remove:l})=>{const{getFieldState:m,watch:o}=S(),{error:d}=m(`${i}.${t}`),y=o(`${i}.${t}.navn`),[v,V]=$.useState(r);return e.jsxs(k.Row,{shadeOnHover:!1,style:{backgroundColor:d&&!v?"var(--a-red-50)":"none"},children:[e.jsx(k.DataCell,{valign:"top",children:e.jsx(c,{type:"button",variant:"tertiary-neutral",onClick:()=>V(h=>!h),icon:v?e.jsx(Ae,{"aria-label":"Vis mindre"}):e.jsx(ne,{"aria-label":"Vis mer"})})}),e.jsxs(k.DataCell,{valign:"top",children:[e.jsx(ae,{hidden:v,paddingBlock:"3",children:e.jsx(te,{weight:"semibold",children:y})}),e.jsxs(b,{gap:"4",hidden:!v,children:[e.jsx(F,{name:`${i}.${t}.navn`,validate:[u],label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.Name"}),readOnly:n}),e.jsx(E,{readOnly:n,index:t,alleKodeverk:a}),e.jsx(P,{readOnly:n,index:t,alleKodeverk:a}),e.jsx(O,{readOnly:n,index:t}),e.jsx(M,{readOnly:n,index:t}),e.jsx(C,{readOnly:n,index:t})]})]}),e.jsx(k.DataCell,{valign:"top",align:"right",children:e.jsx(c,{type:"button",variant:"tertiary-neutral",onClick:l,onKeyDown:l,icon:e.jsx(qe,{"aria-label":"Slett rad"})})})]})};A.initialValues=()=>({varigEndretEllerStartetSisteFireArArsak:[],typeVirksomhet:[]});A.transformValues=r=>({navn:r.navn,...E.transformValues(r),...P.transformValues(r),...O.transformValues(r),...M.transformValues(r),familieEllerVennerTilknyttetNaringen:r.familieEllerVennerTilknyttetNaringen});A.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"intersection",raw:`IdFormValues &
RelasjonFormValues &
RegnskapFormValues &
StartedEndretFormValues &
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},remove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},open:{required:!0,tsType:{name:"boolean"},description:""}}};const N=({readOnly:r=!1,alleKodeverk:n})=>{var v,V,h,G,H;const a=B(),{control:t,formState:{errors:l}}=S(),{fields:m,remove:o,append:d}=se({control:t,name:`${T}.virksomheter`,rules:{required:a.formatMessage({id:"Registrering.RegistrerVirksomhetPanel.ArrayMinLength"})}}),y=()=>{d(A.initialValues())};return $.useEffect(()=>{m.length===0&&y()},[]),e.jsxs(e.Fragment,{children:[e.jsxs(k,{children:[e.jsx(k.Header,{children:e.jsxs(k.Row,{children:[e.jsx(k.HeaderCell,{style:{width:"48px"}}),e.jsx(k.HeaderCell,{children:e.jsx(s,{id:"Registrering.RegistrerVirksomhetPanel.Name"})}),e.jsx(k.HeaderCell,{style:{width:"48px"}})]})}),e.jsx(k.Body,{children:m.map((z,U)=>e.jsx(A,{index:U,open:U+1===m.length,remove:()=>o(U),alleKodeverk:n,readOnly:r},z.id))})]}),((h=(V=(v=l[T])==null?void 0:v.virksomheter)==null?void 0:V.root)==null?void 0:h.message)&&e.jsx(ie,{children:(H=(G=l[T])==null?void 0:G.virksomheter.root)==null?void 0:H.message}),e.jsx("div",{children:e.jsx(c,{size:"small",variant:"tertiary",type:"button",onClick:y,icon:e.jsx(le,{"aria-hidden":!0}),children:e.jsx(s,{id:"Registrering.RegistrerVirksomhetPanel.Add"})})})]})};N.transformValues=({egenVirksomhet:{harArbeidetIEgenVirksomhet:r,virksomheter:n}})=>({egenVirksomhet:{harArbeidetIEgenVirksomhet:r,virksomheter:r?n.map(a=>A.transformValues(a)):void 0}});N.__docgenInfo={description:`RegistrererVirksomhetPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const R=({readOnly:r=!0,alleKodeverk:n})=>{const a=B(),{watch:t}=S(),l=t(`${T}.harArbeidetIEgenVirksomhet`)||null;return e.jsx(ue,{children:e.jsxs(b,{gap:"4",children:[e.jsx(ke,{size:"small",children:e.jsx(s,{id:"Registrering.EgenVirksomhet.Title"})}),e.jsx(oe,{name:`${T}.harArbeidetIEgenVirksomhet`,validate:[u],isReadOnly:r,hideLegend:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"Registrering.EgenVirksomhet.No"}),value:"false"},{label:a.formatMessage({id:"Registrering.EgenVirksomhet.Yes"}),value:"true"}]}),l&&e.jsx(N,{readOnly:r,alleKodeverk:n})]})})};R.initialValues=()=>({[T]:{harArbeidetIEgenVirksomhet:void 0,virksomheter:[A.initialValues()]}});R.transformValues=N.transformValues;R.__docgenInfo={description:`EgenVirksomhetPanel
