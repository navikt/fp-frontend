import{u as B,r as H,j as a,d as z,t as _,O as P,f as ue,l as oe,x as Me,R as b,J as j,h as c,g as Ye,M as we,c as qe,P as be,e as je}from"./iframe-C-F1-KFd.js";import{u as K,a as C,P as f,w as V,y as F,f as G,T as Q,V as g,L as h,c as ce,b as Ce,E as fe,m as he,d as Ze,e as We,B as Xe}from"./nb_NO-DCcstzbV.js";import{a as xe}from"./alleKodeverk-C9CgZbBn.js";import{n as $e}from"./notEmpty-6aiiHJJi.js";import{F as Z}from"./FieldArrayRow-CBW3vlcT.js";import{M as A}from"./message-Da0NzITC.js";import{A as de}from"./Alert-Cf_I3JRj.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C2Kif7jS.js";const N="tidsromPermisjon",p="graderingPeriode",me="oppholdPerioder",ke="overforingsperioder",ae="utsettelsePeriode",q="permisjonsPerioder",Ne=`${N}.${q}`,s=l=>`${Ne}.${l}`,Qe=oe(100),Re=new Set(["FELLESPERIODE","FEDREKVOTE","FORELDREPENGER_FØR_FØDSEL","FORELDREPENGER","MØDREKVOTE"]),Ue=new Set(["FEDREKVOTE","FORELDREPENGER_FØR_FØDSEL","MØDREKVOTE"]),le=({sokerErMor:l,readOnly:e,alleKodeverk:n})=>{const r=B(),E=n.UttakPeriodeType,t=n.MorsAktivitet;t.filter(({kode:T})=>T==="-").length===0&&t.unshift({kode:"-",navn:"",kodeverk:""});const{control:i,getValues:R,trigger:S,watch:I,formState:{isSubmitted:L}}=K(),{fields:u,remove:v,append:m}=C({control:i,name:Ne});return H.useEffect(()=>{u.length===0&&m({})},[]),a.jsx(f,{readOnly:e,fields:u,addButtonText:r.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyTemplate:{periodeType:"-",periodeFom:"",periodeTom:""},append:m,remove:v,children:(T,D)=>{const o=D===0,y=I(s(D)),w=aa(y?.periodeFom),Je=Ue.has(y?.periodeType||"-")||y?.periodeType==="-";return a.jsxs(Z,{readOnly:e,remove:v,index:D,children:[a.jsx("div",{children:a.jsx(V,{name:`${s(D)}.periodeType`,control:i,readOnly:e,label:W(o,r.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:ze(E),validate:[_]})}),a.jsx(F,{isReadOnly:e,control:i,name:`${s(D)}.periodeFom`,label:W(o,r.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[_,P,Ae(R,D,!0),_e(R)],onChange:()=>L?S():void 0}),a.jsx(F,{isReadOnly:e,control:i,name:`${s(D)}.periodeTom`,label:W(o,r.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[_,P,Ae(R,D,!1),_e(R)],onChange:()=>L?S():void 0}),!l&&a.jsx(V,{name:`${s(D)}.morsAktivitet`,control:i,readOnly:e,disabled:Je,label:W(o,r.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:ea(t),hideValueOnDisable:!0}),a.jsx("div",{children:a.jsx(G,{name:`${s(D)}.flerbarnsdager`,control:i,readOnly:e,label:a.jsx(A,{id:"Registrering.Permisjon.Flerbarnsdager"})})}),a.jsx("div",{children:a.jsx(G,{name:`${s(D)}.harSamtidigUttak`,control:i,readOnly:e,label:a.jsx(A,{id:"Registrering.Permisjon.HarSamtidigUttak"})})}),y?.harSamtidigUttak&&a.jsx(Q,{name:`${s(D)}.samtidigUttaksprosent`,control:i,validate:[ue,Qe],label:r.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:ie=>Number.isNaN(ie)?ie:Number.parseFloat(ie.toString()).toFixed(2)}),w&&a.jsx(de,{size:"small",variant:"warning",children:a.jsx(A,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},T.id)}})};le.transformValues=l=>l.map(e=>Ue.has(e.periodeType)?{periodeType:e.periodeType,periodeFom:e.periodeFom,periodeTom:e.periodeTom,flerbarnsdager:e.flerbarnsdager??!1,harSamtidigUttak:e.harSamtidigUttak??!1,samtidigUttaksprosent:e.samtidigUttaksprosent}:{periodeType:e.periodeType,periodeFom:e.periodeFom,periodeTom:e.periodeTom,morsAktivitet:e.morsAktivitet,flerbarnsdager:e.flerbarnsdager??!1,harSamtidigUttak:e.harSamtidigUttak??!1,samtidigUttaksprosent:e.samtidigUttaksprosent});const ze=l=>l.filter(({kode:e})=>Re.has(e)).map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),ea=l=>l.map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),W=(l,e)=>l?e:"",aa=l=>!!l&&z(l,Me).isBefore(z("2019-01-01")),_e=l=>()=>{const n=(l(Ne)??[]).filter(({periodeFom:r,periodeTom:E})=>r!==""&&E!=="").map(({periodeFom:r,periodeTom:E})=>[r,E]);return c(n)},Ae=(l,e,n)=>()=>{const r=l(`${s(e)}.periodeFom`),E=l(`${s(e)}.periodeTom`);return!E||!r?null:n?b(E)(r):j(r)(E)};le.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
