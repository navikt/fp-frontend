import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as S,G as q,V as b,Y as X,H as Q,P as f,A as F,L as W,C as $,D as Z,B as c,j as ee,i as re,k as ne,d as ae,E as te,l as se,f as ie,a as le,M as ue,m as ke,b as oe,N as de}from"./nb_NO-DtoXCGNE.js";import{a as ge}from"./index-B-lxVbXh.js";import"./withThemeDecorator-DaQVtb-E.js";import{r as D}from"./index-C4XKfyRp.js";import{u as B,a as me,r as ye}from"./index.es-CZjkzcto.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as ve}from"./alleKodeverk-DO07GSZv.js";import{e as u,p as w,S as pe,R as Te,c as I,d as Ae,y as J}from"./index.es-sIGWTmsS.js";import{T as K}from"./TrueFalseInput-6DKNpODd.js";import{M as s}from"./message-C5auBQb2.js";import{T as k,S as qe}from"./Table-DYyhFzqi.js";import{S as be}from"./Trash-t9dVEelO.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-DiJfEpg_.js";import"./iframe-BvMVci2z.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var g=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(g||{});const T="egenVirksomhet",i=`${T}.virksomheter`,Re={},Fe=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),E=({index:r,readOnly:n,alleKodeverk:a})=>{const t=B(),l=a.Landkoder.slice().sort((o,d)=>o.navn.localeCompare(d.navn)),{getValues:m}=S();return e.jsx(K,{name:`${i}.${r}.virksomhetRegistrertINorge`,label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(q,{marginTop:8,children:e.jsx(F,{name:`${i}.${r}.organisasjonsnummer`,readOnly:n,validate:[u,I,Ae],label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(q,{alignOffset:58,marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(X,{name:`${i}.${r}.landJobberFra`,className:Re.landBredde,selectValues:Fe(l),validate:[u],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(Q,{gap:"4",children:[e.jsx(f,{isReadOnly:n,validate:[u,w,pe],name:`${i}.${r}.fom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(f,{isReadOnly:n,validate:[w,o=>{const d=m(`${i}.${r}.fom`);return d?Te(d,o):null}],name:`${i}.${r}.tom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};E.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:l})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:l}:{landJobberFra:"NOR"}});E.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
