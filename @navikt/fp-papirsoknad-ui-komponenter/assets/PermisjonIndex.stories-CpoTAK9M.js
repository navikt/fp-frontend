...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Ee=`${l}.${ve}`,I=e=>`${Ee}.${e}`,Pe=e=>()=>{const a=(e(`${Ee}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?z(a):void 0},Fe={periodeFom:"",periodeTom:"",årsak:""},Tr=[Y.UTTAK_MØDREKVOTE_ANNEN_FORELDER,Y.UTTAK_FEDREKVOTE_ANNEN_FORELDER,Y.UTTAK_FELLESP_ANNEN_FORELDER,Y.UTTAK_FORELDREPENGER_ANNEN_FORELDER],qr=e=>e.filter(({kode:r})=>Tr.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Ce=({oppholdsReasons:e,readOnly:r})=>{const a=V(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=A(),{fields:m,remove:p,append:R}=J({control:t,name:`${Ee}`});return U.useEffect(()=>{m.length===0&&R(Fe)},[]),n.jsx(C,{fields:m,emptyPeriodTemplate:Fe,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:p,children:(E,o)=>n.jsxs(ee,{readOnly:r,remove:p,index:o,children:[n.jsx(j,{name:`${I(o)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,P,()=>{const k=i(`${I(o)}.periodeFom`),d=i(`${I(o)}.periodeTom`);return d&&k?W(d)(k):null},Pe(i)],onChange:()=>g?s():void 0}),n.jsx(j,{name:`${I(o)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,P,()=>{const k=i(`${I(o)}.periodeFom`),d=i(`${I(o)}.periodeTom`);return d&&k?Q(k)(d):null},Pe(i)],onChange:()=>g?s():void 0}),n.jsx("div",{children:n.jsx(O,{name:`${I(o)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:qr(e),validate:[v]})})]},E.id)})};Ce.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const ce=`${l}.${Be}`,M=e=>`${ce}.${e}`,Oe=e=>()=>{const a=(e(ce)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?z(a):void 0},_e={periodeFom:"",periodeTom:"",overforingArsak:""},Xe=({selectValues:e,readOnly:r})=>{const a=V(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=A(),{fields:m,remove:p,append:R}=J({control:t,name:ce});return U.useEffect(()=>{m.length===0&&R(_e)},[]),n.jsx(C,{fields:m,emptyPeriodTemplate:_e,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:p,children:(E,o)=>n.jsxs(ee,{readOnly:r,remove:p,index:o,children:[n.jsx("div",{children:n.jsx(O,{name:`${M(o)}.overforingArsak`,label:a.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[v],readOnly:r})}),n.jsx(j,{isReadOnly:r,name:`${M(o)}.periodeFom`,validate:[v,P,()=>{const k=i(`${M(o)}.periodeFom`),d=i(`${M(o)}.periodeTom`);return d&&k?W(d)(k):null},Oe(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>g?s():void 0}),n.jsx(j,{isReadOnly:r,name:`${M(o)}.periodeTom`,validate:[v,P,()=>{const k=i(`${M(o)}.periodeFom`),d=i(`${M(o)}.periodeTom`);return d&&k?Q(k)(d):null},Oe(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>g?s():void 0})]},E.id)})};Xe.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray

Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const jr=(e,r,a)=>r===H.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):r===H.SYKDOM_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):a,Pr=(e,r,a,t)=>e.filter(({kode:i})=>a||i!==H.ALENEOMSORG&&i!==H.IKKE_RETT_ANNEN_FORELDER).map(({kode:i,navn:s})=>r?n.jsx("option",{value:i,children:s},i):n.jsx("option",{value:i,children:jr(t,i,s)},i)),ge=({foreldreType:e,alleKodeverk:r,readOnly:a,erEndringssøknad:t})=>{const i=V(),s=r[N.OVERFOERING_AARSAK_TYPE],g=Pr(s,e===Z.MOR,t,i),{watch:m}=A(),p=m(`${l}.skalOvertaKvote`)||!1;return n.jsxs(S,{gap:"2",children:[n.jsx(X,{children:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),n.jsx(q,{readOnly:a,name:`${l}.skalOvertaKvote`,label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),p&&n.jsx(Xe,{selectValues:g,readOnly:a})]})};ge.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});ge.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const _r=nr(tr),D=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>n.jsx(ar,{value:_r,children:n.jsx(L,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t})});D.transformValues=L.transformValues;D.initialValues=L.initialValues;D.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Br={title:"ui-komponenter/permisjon",component:D,parameters:{submitCallback:ur("onSubmit")},args:{readOnly:!1,alleKodeverk:gr},render:(e,{parameters:{submitCallback:r}})=>{const a=ir({defaultValues:D.initialValues()});return n.jsx(sr,{formMethods:a,onSubmit:t=>r(D.transformValues(t)),children:n.jsxs(S,{gap:"10",children:[n.jsx(D,{...e}),n.jsx(or,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},ne={args:{foreldreType:Z.MOR,erEndringssøknad:!1}},ae={args:{foreldreType:Z.FAR,erEndringssøknad:!1}},te={args:{foreldreType:Z.MOR,erEndringssøknad:!0}};var Me,Ke,De;ne.parameters={...ne.parameters,docs:{...(Me=ne.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
...
}`,...(Le=(Ge=te.parameters)==null?void 0:Ge.docs)==null?void 0:Le.source}}};const Hr=["SokerErMor","SokerErFar","ErEndringssøknad"];export{te as ErEndringssøknad,ae as SokerErFar,ne as SokerErMor,Hr as __namedExportsOrder,Br as default};
