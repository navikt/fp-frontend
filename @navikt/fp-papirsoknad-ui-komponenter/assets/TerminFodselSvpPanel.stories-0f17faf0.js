import{j as e}from"./jsx-runtime-d079401a.js";import{a as f}from"./chunk-AY7I2SME-c7b6cf8a.js";import{t as x,Q as j,H as F,G as p,o as b,s as v,D as t,j as o,m as y,u as h,F as S,B as _}from"./nb_NO-8eede04c.js";import{r as g,b as l,_ as P}from"./index.es-840a5222.js";import"./index-f1f2c4b1.js";import"./index-c74c9f7f.js";const r=x(y),n=({readOnly:s})=>e.jsxs(j,{children:[e.jsx(F,{size:"small",children:r.formatMessage({id:"TerminFodselSvpPanel.TerminOgFodsel"})}),e.jsx(p,{sixteenPx:!0}),e.jsx(b,{children:e.jsxs(v,{children:[e.jsx(t,{children:e.jsx(o,{name:"termindato",label:r.formatMessage({id:"TerminFodselSvpPanel.Termindato"}),isReadOnly:s,validate:[g,l]})}),e.jsx(t,{children:e.jsx(o,{name:"foedselsDato",label:r.formatMessage({id:"TerminFodselSvpPanel.Fodselsdato"}),isReadOnly:s,validate:[l,P]})})]})})]}),c=n;try{n.displayName="TerminFodselSvpPanel",n.__docgenInfo={description:"",displayName:"TerminFodselSvpPanel",props:{readOnly:{defaultValue:null,description:"",name:"readOnly",required:!0,type:{name:"boolean"}}}}}catch{}const C={title:"papirsoknad/ui-komponenter/termin-fodsel-svp",component:c},T=({submitCallback:s})=>{const u=h();return e.jsxs(S,{formMethods:u,onSubmit:s,children:[e.jsx(c,{readOnly:!1}),e.jsx(p,{fourtyPx:!0}),e.jsx(_,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},a=T.bind({});a.args={submitCallback:f("button-click")};var i,m,d;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`({
  submitCallback
}) => {
...
//# sourceMappingURL=TerminFodselSvpPanel.stories-0f17faf0.js.map
