import{u as R,j as r,o as K,O as m,P as b,a as j}from"./iframe-FJBm8SjC.js";import{u as V,a as w,N as O,f as h,y,M,d as E,V as p,b as c,g as f,m as P,e as N,D as S,B}from"./nb_NO-CvhI4kfv.js";import{a as U}from"./alleKodeverk-DO07GSZv.js";import{L as I}from"./landkoder-Bgpqk6-g.js";import{F as H}from"./FieldArrayRow-CkK0JwNl.js";import{M as v}from"./message-C2-6QhO2.js";import"./preload-helper-D9Z9MdNV.js";import"./index-BAjQ9tiR.js";import"./Trash-Cqfjr_4a.js";const l="arbeidsforhold",G=K(50),_=n=>n.filter(({kode:e})=>e!==I.NORGE).map(({kode:e,navn:a})=>r.jsx("option",{value:e,children:a},e)),T=({alleKodeverk:n,readOnly:e})=>{const a=R(),{control:t}=V(),{fields:A,remove:g,append:q}=w({control:t,name:l}),F=n.Landkoder.slice().sort((o,s)=>o.navn.localeCompare(s.navn));return r.jsx(O,{fields:A,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:g,append:q,children:(o,s)=>r.jsxs(H,{remove:g,index:s,readOnly:e,children:[r.jsx(h,{readOnly:e,control:t,name:`${l}.${s}.arbeidsgiver`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[G],maxLength:99}),r.jsx(y,{name:`${l}.${s}.periodeFom`,control:t,isReadOnly:e,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[m]}),r.jsx(y,{name:`${l}.${s}.periodeTom`,control:t,isReadOnly:e,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[m]}),r.jsx(M,{name:`${l}.${s}.land`,control:t,readOnly:e,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:_(F),size:"small"})]},o.id)})};T.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
