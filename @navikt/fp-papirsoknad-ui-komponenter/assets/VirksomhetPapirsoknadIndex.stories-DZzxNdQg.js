import{u as Y,j as e,t as T,O as y,F as c,H as Z,g as p,I as W,N as b,r as B,P as x,a as X}from"./iframe-CEXpT7hR.js";import{u as s,c as o,V as L,w as Q,H as $,T as U,k as G,L as z,j as h,C as H,O as ee,B as K,p as ae,o as le,q as ne,a as re,E as te,d as ie,b as ue,S as Ee,R as q,m as me,e as ve,f as Re}from"./nb_NO-BWbLkVCC.js";import{a as Ne}from"./alleKodeverk-DO07GSZv.js";import{T as O}from"./TrueFalseInput--E6PAVcz.js";import{M as t}from"./message-Fn81Dywe.js";import{T as N,S as Te,a as se,b as Ae}from"./Table-Bc9JI1Dn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DacWvyjk.js";const _="egenVirksomhet",u=`${_}.virksomheter`,Se={},_e=a=>a.map(({kode:l,navn:n})=>e.jsx("option",{value:l,children:n},l)),d=({index:a,readOnly:l,alleKodeverk:n})=>{const r=Y(),i=n.Landkoder.slice().sort((v,m)=>v.navn.localeCompare(m.navn)),{getValues:R,control:E}=s();return e.jsx(O,{name:`${u}.${a}.virksomhetRegistrertINorge`,control:E,label:e.jsx(t,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:l,trueContent:e.jsx(o,{children:e.jsx(G,{name:`${u}.${a}.organisasjonsnummer`,control:E,readOnly:l,validate:[T,p,W],label:e.jsx(t,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(o,{alignOffset:58,children:e.jsxs(L,{gap:"space-16",children:[e.jsx(Q,{name:`${u}.${a}.landJobberFra`,control:E,className:Se.landBredde,selectValues:_e(i),validate:[T],label:r.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs($,{gap:"space-16",children:[e.jsx(U,{name:`${u}.${a}.fom`,control:E,isReadOnly:l,validate:[T,y,c],label:r.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(U,{name:`${u}.${a}.tom`,control:E,isReadOnly:l,validate:[y,v=>{const m=R(`${u}.${a}.fom`);return m?Z(m,v):null}],label:r.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};d.transformValues=({virksomhetRegistrertINorge:a,organisasjonsnummer:l,landJobberFra:n,fom:r,tom:i})=>({virksomhetRegistrertINorge:a,organisasjonsnummer:a?l:void 0,...a===!1?{landJobberFra:n,fom:r,tom:i}:{landJobberFra:"NOR"}});d.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const g=({index:a,readOnly:l})=>{const{control:n}=s();return e.jsx(O,{name:`${u}.${a}.harRegnskapsforer`,control:n,label:e.jsx(t,{id:"Registrering.VirksomhetRegnskapPanel.Accountant"}),readOnly:l,trueContent:e.jsx(o,{children:e.jsxs(L,{gap:"space-16",children:[e.jsx(G,{name:`${u}.${a}.navnRegnskapsforer`,control:n,readOnly:l,validate:[T,b],label:e.jsx(t,{id:"Registrering.VirksomhetRegnskapPanel.AccountantName"})}),e.jsx(G,{name:`${u}.${a}.tlfRegnskapsforer`,control:n,readOnly:l,validate:[T,p],label:e.jsx(t,{id:"Registrering.VirksomhetRegnskapPanel.AccountantPhone"})})]})})})};g.transformValues=({harRegnskapsforer:a,navnRegnskapsforer:l,tlfRegnskapsforer:n})=>({harRegnskapsforer:a,...a?{navnRegnskapsforer:l}:{},...a?{tlfRegnskapsforer:n}:{}});g.__docgenInfo={description:`VirksomhetRegnskapPanel
...
| 'JORDBRUK_SKOGBRUK'
| 'ANNEN'
| '-'`,elements:[{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'FISKE'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'JORDBRUK_SKOGBRUK'"},{name:"literal",value:"'ANNEN'"},{name:"literal",value:"'-'"}]}],raw:"VirksomhetType[]",required:!0}}]}}],alias:"RegistrerVirksomhetFormValues"}}],returns:null}],displayName:"VirksomhetRegnskapPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const f=({readOnly:a,index:l})=>{const{control:n}=s();return e.jsx(O,{name:`${u}.${l}.familieEllerVennerTilknyttetNaringen`,control:n,label:e.jsx(t,{id:"Registrering.VirksomhetRelasjonPanel.Relation"}),readOnly:a,isHorizontal:!1,trueLabel:e.jsx(t,{id:"Registrering.VirksomhetRelasjonPanel.Yes"}),falseLabel:e.jsx(t,{id:"Registrering.VirksomhetRelasjonPanel.No"})})};f.__docgenInfo={description:`VirksomhetRelasjonPanel

Presentasjonskomponent. Komponenten vises som del av skjermbildet for registrering av
papirsøknad dersom søknad gjelder foreldrepenger og saksbehandler skal legge til ny virksomhet for
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const Ie="_inntektBredde_1xgnj_1",Le={inntektBredde:Ie},P=({readOnly:a,index:l})=>{const{control:n}=s();return e.jsx(O,{name:`${u}.${l}.varigEndretEllerStartetSisteFireAr`,control:n,label:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.NewlyStartedOrChanged"}),readOnly:a,trueContent:e.jsx(o,{children:e.jsxs(L,{gap:"space-16",children:[e.jsx(z,{size:"small",children:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.Reason"})}),e.jsxs(h,{name:`${u}.${l}.varigEndretEllerStartetSisteFireArArsak`,control:n,validate:[T],children:[e.jsx(w,{value:"harVarigEndring",label:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.HarVarigEndring"}),readOnly:a,index:l}),e.jsx(H,{value:"erNyoppstartet",readOnly:a,children:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.ErNyoppstartet"})}),e.jsx(w,{value:"erNyIArbeidslivet",label:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.NyIArbeidslivet"}),readOnly:a,index:l})]}),e.jsx(ee,{name:`${u}.${l}.beskrivelseAvEndring`,control:n,label:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.VirksomhetEndretBeskrivelse"}),validate:[b]}),e.jsx(G,{name:`${u}.${l}.inntekt`,control:n,label:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.Inntekt"}),readOnly:a,validate:[p,T],className:Le.inntektBredde,parse:r=>{const i=Number.parseInt(r.toString(),10);return Number.isNaN(i)?r:i}})]})})})};P.transformValues=({varigEndretEllerStartetSisteFireAr:a,varigEndretEllerStartetSisteFireArArsak:l,varigEndringGjeldendeFom:n,nyIArbeidslivetFom:r,beskrivelseAvEndring:i,inntekt:R})=>{const E=l.includes("harVarigEndring"),v=l.includes("erNyoppstartet"),m=l.includes("erNyIArbeidslivet");return{varigEndretEllerStartetSisteFireAr:a,...a?{harVarigEndring:E,...E?{varigEndringGjeldendeFom:n}:{},erNyoppstartet:v,erNyIArbeidslivet:m,...m?{nyIArbeidslivetFom:r}:{},beskrivelseAvEndring:i,inntekt:R}:{}}};const w=({value:a,label:l,readOnly:n,index:r})=>{const{watch:i,control:R}=s(),E=i(`${u}.${r}.varigEndretEllerStartetSisteFireArArsak`),[v,m]=B.useState(E.includes(a));return e.jsxs(L,{gap:"space-12",children:[e.jsx(H,{value:a,onClick:()=>m(!v),disabled:n,children:l}),v&&e.jsx(o,{children:e.jsx(U,{name:a==="harVarigEndring"?`${u}.${r}.varigEndringGjeldendeFom`:`${u}.${r}.nyIArbeidslivetFom`,control:R,isReadOnly:n,validate:[y,T],label:e.jsx(t,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})]})};P.__docgenInfo={description:`VirksomhetStartetEndretPanel
...
papirsøknad dersom søknad gjelder foreldrepenger og saksbehandler skal legge til ny virksomhet for søker.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  beskrivelseAvEndring?: string;
  inntekt?: number;
}`,signature:{properties:[{key:"varigEndretEllerStartetSisteFireAr",value:{name:"boolean",required:!1}},{key:"varigEndretEllerStartetSisteFireArArsak",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"varigEndringGjeldendeFom",value:{name:"string",required:!1}},{key:"nyIArbeidslivetFom",value:{name:"string",required:!1}},{key:"beskrivelseAvEndring",value:{name:"string",required:!1}},{key:"inntekt",value:{name:"number",required:!1}}]},alias:"StartedEndretFormValues"}}],returns:null}],displayName:"VirksomhetStartetEndretPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const J={FRILANSER:-1,DAGMAMMA:1,FISKE:2,JORDBRUK_SKOGBRUK:3,ANNEN:4,"-":5},F=({readOnly:a,alleKodeverk:l,index:n})=>{const{control:r}=s();return e.jsx(h,{name:`${u}.${n}.typeVirksomhet`,control:r,label:e.jsx(t,{id:"Registrering.VirksomhetNaeringTypePanel.Title"}),validate:[T],isReadOnly:a,children:De(l).map(i=>e.jsx(H,{value:i.kode,readOnly:a,children:i.navn},i.kode))})};F.transformValues=({typeVirksomhet:a})=>({typeVirksomhet:{ANNEN:a.includes("ANNEN"),FISKE:a.includes("FISKE"),DAGMAMMA:a.includes("DAGMAMMA"),JORDBRUK_SKOGBRUK:a.includes("JORDBRUK_SKOGBRUK")}});const De=a=>a.VirksomhetType.filter(l=>l.kode!=="FRILANSER").sort((l,n)=>oe(J[l.kode],J[n.kode])),oe=(a,l)=>a>l?1:a<l?-1:0;F.__docgenInfo={description:`VirksomhetTypeNaringPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const I=({open:a,readOnly:l=!1,alleKodeverk:n,index:r,remove:i})=>{const{getFieldState:R,watch:E,control:v}=s(),{error:m}=R(`${u}.${r}`),M=E(`${u}.${r}.navn`),[A,j]=B.useState(a);return e.jsxs(N.Row,{shadeOnHover:!1,style:{backgroundColor:m&&!A?"var(--ax-danger-100)":"none"},children:[e.jsx(N.DataCell,{valign:"top",children:e.jsx(K,{type:"button",variant:"tertiary-neutral",onClick:()=>j(C=>!C),icon:A?e.jsx(Te,{"aria-label":"Vis mindre"}):e.jsx(ae,{"aria-label":"Vis mer"})})}),e.jsxs(N.DataCell,{valign:"top",children:[e.jsx(le.New,{hidden:A,paddingBlock:"3",children:e.jsx(ne,{weight:"semibold",children:M})}),e.jsxs(L,{gap:"space-16",hidden:!A,children:[e.jsx(G,{name:`${u}.${r}.navn`,control:v,validate:[T],label:e.jsx(t,{id:"Registrering.VirksomhetIdentifikasjonPanel.Name"}),readOnly:l}),e.jsx(d,{readOnly:l,index:r,alleKodeverk:n}),e.jsx(F,{readOnly:l,index:r,alleKodeverk:n}),e.jsx(P,{readOnly:l,index:r}),e.jsx(g,{readOnly:l,index:r}),e.jsx(f,{readOnly:l,index:r})]})]}),e.jsx(N.DataCell,{valign:"top",align:"right",children:e.jsx(K,{type:"button",variant:"tertiary-neutral",onClick:i,onKeyDown:i,icon:e.jsx(se,{"aria-label":"Slett rad"})})})]})};I.initialValues=()=>({varigEndretEllerStartetSisteFireArArsak:[],typeVirksomhet:[]});I.transformValues=a=>({navn:a.navn,...d.transformValues(a),...F.transformValues(a),...P.transformValues(a),...g.transformValues(a),familieEllerVennerTilknyttetNaringen:a.familieEllerVennerTilknyttetNaringen});I.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"intersection",raw:`IdFormValues &
RelasjonFormValues &
RegnskapFormValues &
StartedEndretFormValues &
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},remove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},open:{required:!0,tsType:{name:"boolean"},description:""}}};const V=({readOnly:a=!1,alleKodeverk:l})=>{const n=Y(),{control:r,formState:{errors:i}}=s(),{fields:R,remove:E,append:v}=re({control:r,name:`${_}.virksomheter`,rules:{required:n.formatMessage({id:"Registrering.RegistrerVirksomhetPanel.ArrayMinLength"})}}),m=()=>{v(I.initialValues())};return B.useEffect(()=>{R.length===0&&m()},[]),e.jsxs(e.Fragment,{children:[e.jsxs(N,{children:[e.jsx(N.Header,{children:e.jsxs(N.Row,{children:[e.jsx(N.HeaderCell,{style:{width:"48px"}}),e.jsx(N.HeaderCell,{children:e.jsx(t,{id:"Registrering.RegistrerVirksomhetPanel.Name"})}),e.jsx(N.HeaderCell,{style:{width:"48px"}})]})}),e.jsx(N.Body,{children:R.map((M,A)=>e.jsx(I,{index:A,open:A+1===R.length,remove:()=>E(A),alleKodeverk:l,readOnly:a},M.id))})]}),i[_]?.virksomheter?.root?.message&&e.jsx(te,{children:i[_].virksomheter.root.message}),e.jsx("div",{children:e.jsx(K,{size:"small",variant:"tertiary",type:"button",onClick:m,icon:e.jsx(Ae,{"aria-hidden":!0}),children:e.jsx(t,{id:"Registrering.RegistrerVirksomhetPanel.Add"})})})]})};V.transformValues=({egenVirksomhet:{harArbeidetIEgenVirksomhet:a,virksomheter:l}})=>({egenVirksomhet:{harArbeidetIEgenVirksomhet:a,virksomheter:a?l.map(n=>I.transformValues(n)):void 0}});V.__docgenInfo={description:`RegistrererVirksomhetPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const D=({readOnly:a=!0,alleKodeverk:l})=>{const{watch:n,control:r}=s(),i=n(`${_}.harArbeidetIEgenVirksomhet`)||null;return e.jsx(ie,{children:e.jsxs(L,{gap:"space-16",children:[e.jsx(ue,{size:"small",level:"3",children:e.jsx(t,{id:"Registrering.EgenVirksomhet.Title"})}),e.jsxs(Ee,{name:`${_}.harArbeidetIEgenVirksomhet`,control:r,validate:[T],isReadOnly:a,hideLegend:!0,children:[e.jsx(q,{value:!1,size:"small",children:e.jsx(t,{id:"Registrering.EgenVirksomhet.No"})}),e.jsx(q,{value:!0,size:"small",children:e.jsx(t,{id:"Registrering.EgenVirksomhet.Yes"})})]}),i&&e.jsx(V,{readOnly:a,alleKodeverk:l})]})})};D.initialValues=()=>({[_]:{harArbeidetIEgenVirksomhet:void 0,virksomheter:[I.initialValues()]}});D.transformValues=V.transformValues;D.__docgenInfo={description:`EgenVirksomhetPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const{action:ke}=__STORYBOOK_MODULE_ACTIONS__,ye={title:"ui-komponenter/virksomhet",component:S,parameters:{submitCallback:ke("onSubmit")},args:{readOnly:!1,alleKodeverk:Ne},render:(a,{parameters:{submitCallback:l}})=>{const n=ve({defaultValues:S.initialValues()});return e.jsx(Re,{formMethods:n,onSubmit:r=>l(S.transformValues(r)),children:e.jsxs(L,{gap:"space-40",children:[e.jsx(S,{...a}),e.jsx(K,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},k={};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:"{}",...k.parameters?.docs?.source}}};const Ue=["Default"];export{k as Default,Ue as __namedExportsOrder,ye as default};
