import{u as M,j as e,O as q,R as x,J as R,o as B,d as j,x as I,t as N,P as C,e as X}from"./iframe-C-F1-KFd.js";import{u as T,a as _,P as H,H as $,y as P,T as z,V as O,U as E,L as U,c as J,b as K,D as Y,m as G,d as Q,e as W,B as Z}from"./nb_NO-DCcstzbV.js";import{T as h}from"./TrueFalseInput-DtUXdypK.js";import{M as d}from"./message-Da0NzITC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C2Kif7jS.js";const o="frilans",ee=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,n)=>j(a,I).diff(j(n,I))),re=B(50),ae=(r,a)=>n=>r.length>0&&r[0]&&n&&!j(r[0]).isSameOrBefore(j(n))?a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null,L=({readOnly:r})=>{const a=M(),{control:n,getValues:i,watch:f,trigger:F,formState:{isSubmitted:v}}=T(),{fields:D,remove:S,append:A}=_({control:n,name:`${o}.oppdragPerioder`}),s=f(`${o}.perioder`),V=ee(s);return e.jsx(H,{addButtonText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:D,readOnly:r,append:A,remove:S,emptyTemplate:{fomDato:"",tomDato:"",oppdragsgiver:""},children:(m,t,l)=>{const b=`${o}.oppdragPerioder.${t}`;return e.jsxs($,{gap:"space-8",align:"end",children:[e.jsx(P,{name:`${o}.oppdragPerioder.${t}.fomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),hideLabel:t>0,validate:[q,ae(V,a),()=>{const y=i(`${b}.fomDato`),k=i(`${b}.tomDato`);return k&&y?x(k)(y):null}],onChange:()=>v?F():void 0}),e.jsx(P,{name:`${o}.oppdragPerioder.${t}.tomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),hideLabel:t>0,validate:[q,()=>{const y=i(`${b}.fomDato`),k=i(`${b}.tomDato`);return k&&y?R(y)(k):null}],onChange:()=>v?F():void 0}),e.jsx(z,{name:`${o}.oppdragPerioder.${t}.oppdragsgiver`,control:n,validate:[re],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"}),hideLabel:t>0}),e.jsx("div",{children:l})]},m.id)}})};L.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray
...
Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const u=({readOnly:r})=>{const{watch:a,control:n}=T(),i=a(`${o}.harHattOppdragForFamilie`);return e.jsxs(O,{gap:"space-12",children:[e.jsx(h,{name:`${o}.harHattOppdragForFamilie`,control:n,label:e.jsx(d,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),i&&e.jsxs(E,{children:[e.jsx(U,{size:"small",children:e.jsx(d,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(L,{readOnly:r})]})]})};u.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});u.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]}}}}],displayName:"FrilansOppdragForFamiliePanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const w=({readOnly:r})=>{const a=M(),{control:n,getValues:i,formState:{isSubmitted:f},trigger:F}=T(),{fields:v,remove:D,append:S}=_({control:n,name:`${o}.perioder`});return e.jsx(H,{fields:v,addButtonText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:r,remove:D,append:S,children:(A,s,V)=>{const m=`${o}.perioder.${s}`;return e.jsxs($,{gap:"space-8",align:"end",children:[e.jsx(P,{name:`${o}.perioder.${s}.periodeFom`,control:n,label:a.formatMessage({id:"Registrering.Frilans.periodeFom"}),hideLabel:s>0,validate:[N,q,()=>{const t=i(`${m}.periodeFom`),l=i(`${m}.periodeTom`);return l&&t?x(l)(t):null}],onChange:()=>f?F():void 0}),e.jsx(P,{name:`${o}.perioder.${s}.periodeTom`,control:n,label:a.formatMessage({id:"Registrering.Frilans.periodeTom"}),hideLabel:s>0,validate:[N,q,()=>{const t=i(`${m}.periodeFom`),l=i(`${m}.periodeTom`);return l&&t?R(t)(l):null}],onChange:()=>f?F():void 0}),e.jsx("div",{children:V})]},A.id)}})};w.initialValues=()=>({perioder:[{periodeFom:"",periodeTom:""}]});w.__docgenInfo={description:`FrilansPerioderFieldArray
