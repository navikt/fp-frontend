import{u as B,j as e,c as w,t as O,O as d,R as o,d as V,b as M,J as F,h,P as c,a as f}from"./iframe-BaKRzsr5.js";import{u as y,a as C,P as b,H as j,w as Z,T as p,d as W,V as I,b as X,c as U,m as x,e as Q,f as $,B as z}from"./nb_NO-Ba4QRLEq.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as K}from"./TrueFalseInput-ARvLKk2r.js";import{M as G}from"./message-D63OQ_J3.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Wt1DB4Yy.js";const ae={land:void 0,periodeFom:void 0,periodeTom:void 0},L=(l,a)=>l(a),k=(l,a)=>()=>{const t=l(a).filter(({periodeFom:E,periodeTom:n})=>E&&E!==""&&n&&n!=="").map(({periodeFom:E,periodeTom:n})=>[E,n]);return t.length>0?h(t):void 0},le=l=>l.filter(({kode:a})=>a!=="NOR").map(({kode:a,navn:r})=>e.jsx("option",{value:a,children:r},a)),g=(l,a,r,t)=>()=>{const E=L(l,`${a}.${r}.periodeFom`),n=L(l,`${a}.${r}.periodeTom`);return!n||!E?null:t?o(n)(E):F(E)(n)},P=({erTidligereOpphold:l=!1,mottattDato:a,readOnly:r,countryCodes:t})=>{const E=B(),n=l?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:m,getValues:i,trigger:T,formState:{isSubmitted:_}}=y(),{fields:s,remove:D,append:H}=C({control:m,name:n}),J=le(t);return e.jsx(b,{fields:s,titleText:E.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:E.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ae,readOnly:r,remove:D,append:H,children:(Y,u,q)=>e.jsx(w.Fragment,{children:e.jsxs(j,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(Z,{name:`${n}.${u}.land`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:u>0,selectValues:J,readOnly:r,validate:[O]}),e.jsx(p,{name:`${n}.${u}.periodeFom`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:u>0,isReadOnly:r,validate:[O,d,g(i,n,u,!0),()=>{const v=L(i,`${n}.${u}.periodeFom`);return l?o(V().format(M))(v):a?F(a)(v):void 0},k(i,n)],onChange:()=>_?T():void 0}),e.jsx(p,{name:`${n}.${u}.periodeTom`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:u>0,isReadOnly:r,validate:[O,d,g(i,n,u,!1),()=>{const v=L(i,`${n}.${u}.periodeTom`);return l?o(V().format(M))(v):a?F(a)(v):void 0},k(i,n)],onChange:()=>_?T():void 0}),e.jsx("div",{children:q})]})},Y.id)})};P.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const R=({readOnly:l=!0,alleKodeverk:a,mottattDato:r,erAdopsjon:t})=>{const{formatMessage:E}=B(),n=a.Landkoder.slice().sort((s,D)=>s.navn.localeCompare(D.navn)),{watch:m,control:i}=y(),T=!m("oppholdSisteTolvINorge",!0),_=!m("oppholdNesteTolvINorge",!0);return e.jsx(W,{children:e.jsxs(I,{gap:"space-16",children:[e.jsx(X,{size:"small",level:"3",children:e.jsx(G,{id:"Registrering.Opphold"})}),e.jsx(K,{name:"oppholdINorge",control:i,label:E({id:t?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:l}),e.jsxs(I,{gap:"space-8",children:[e.jsx(K,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(G,{id:"Registrering.OppholdSisteTolv"}),readOnly:l}),T&&e.jsx(U,{alignOffset:58,children:e.jsx(P,{erTidligereOpphold:!0,mottattDato:r,countryCodes:n,readOnly:l})})]}),e.jsxs(I,{gap:"space-8",children:[e.jsx(K,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(G,{id:"Registrering.OppholdNesteTolv"}),readOnly:l}),_&&e.jsx(U,{alignOffset:58,children:e.jsx(P,{mottattDato:r,countryCodes:n,readOnly:l})})]})]})})};R.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});R.transformValues=({oppholdINorge:l,oppholdSisteTolvINorge:a,oppholdNesteTolvINorge:r,tidligereOppholdUtenlands:t,fremtidigeOppholdUtenlands:E})=>({oppholdINorge:l,harTidligereOppholdUtenlands:!a,harFremtidigeOppholdUtenlands:!r,tidligereOppholdUtenlands:a?void 0:t,fremtidigeOppholdUtenlands:r?void 0:E});R.__docgenInfo={description:`OppholdINorgePanel
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ne=f(x),N=({readOnly:l,erAdopsjon:a,alleKodeverk:r,mottattDato:t})=>e.jsx(c,{value:ne,children:e.jsx(R,{readOnly:l,erAdopsjon:a,alleKodeverk:r,mottattDato:t})});N.initialValues=R.initialValues;N.transformValues=R.transformValues;N.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:re}=__STORYBOOK_MODULE_ACTIONS__,ve={title:"ui-komponenter/opphold-i-norge",component:N,parameters:{submitCallback:re("onSubmit")},args:{readOnly:!1,alleKodeverk:ee,mottattDato:"2022-05-30"},render:(l,{parameters:{submitCallback:a}})=>{const r=Q({defaultValues:N.initialValues()});return e.jsx($,{formMethods:r,onSubmit:t=>a(N.transformValues(t)),children:e.jsxs(I,{gap:"space-40",children:[e.jsx(N,{...l}),e.jsx(z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},A={args:{erAdopsjon:!1}},S={args:{erAdopsjon:!0}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...S.parameters?.docs?.source}}};const Te=["ForFodsel","ForAdopsjon"];export{S as ForAdopsjon,A as ForFodsel,Te as __namedExportsOrder,ve as default};
