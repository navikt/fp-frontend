...
Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const we={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:ie("onSubmit")},args:{readOnly:!1,alleKodeverk:de},render:(e,{parameters:{submitCallback:t}})=>{const n=ne({defaultValues:i.initialValues()});return r.jsx(te,{formMethods:n,onSubmit:a=>t(i.transformValues(a)),children:r.jsxs(O,{gap:"10",children:[r.jsx(i,{...e}),r.jsx(I,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},o={args:{kunMiliterEllerSiviltjeneste:!1}},d={args:{kunMiliterEllerSiviltjeneste:!0}};var Y,q,w;o.parameters={...o.parameters,docs:{...(Y=o.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
...
}`,...(F=(L=d.parameters)==null?void 0:L.docs)==null?void 0:F.source}}};const Pe=["Default","KunMiliterEllerSiviltjeneste"];export{o as Default,d as KunMiliterEllerSiviltjeneste,Pe as __namedExportsOrder,we as default};
