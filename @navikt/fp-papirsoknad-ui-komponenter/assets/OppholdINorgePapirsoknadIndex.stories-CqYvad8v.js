import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as E,d as H,h as G,i as Y,H as Z,Z as J,G as w,A as V,M as Q,V as f,b as W,Y as I,P as X,n as ee,m as re,c as ne,e as ae,B as oe}from"./nb_NO-D2CHp70u.js";import{e as F,O as R,D as b,H as O,h as se,a as ie}from"./index.es-CX0AAq7K.js";import"./withPanelData-BS7KuzRy.js";import{r as L,R as te}from"./index-_2TAQcTa.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as le,a as de}from"./alleKodeverk-DQaoBXHm.js";import{T as q}from"./TrueFalseInput-gwqcs4h9.js";import{d as U}from"./dayjs.min-DkLNzaWO.js";import{L as pe}from"./landkoder-tJDPMx5C.js";import{M as T}from"./message-A4e32BMu.js";import"./index-BsrZSYsV.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CQwh6Daz.js";import"./v4-CtRu48qb.js";import"./entry-preview-C_d62Tpm.js";import"./iframe-B73NrYRj.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BwSyabb1.js";import"./index-CXQShRbs.js";const me={land:void 0,periodeFom:void 0,periodeTom:void 0},h=(n,r)=>n(r),x=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?se(i):void 0},ue=n=>n.filter(({kode:r})=>r!==pe.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),K=(n,r,o,i)=>()=>{const s=h(n,`${r}.${o}.periodeFom`),a=h(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?b(a)(s):O(s)(a)},j=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:u,getValues:t,trigger:g,formState:{isSubmitted:v}}=H(),{fields:c,remove:z,append:B}=G({control:u,name:a}),D=L.useMemo(()=>ue(i),[i]);return e.jsx(Y,{fields:c,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:me,readOnly:o,remove:z,append:B,children:(N,l,A)=>e.jsx(te.Fragment,{children:e.jsxs(Z,{gap:"4",paddingBlock:"2",children:[e.jsx(J,{name:`${a}.${l}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:D,readOnly:o,validate:[F]}),e.jsx(w,{name:`${a}.${l}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[F,R,K(t,a,l,!0),()=>{const m=h(t,`${a}.${l}.periodeFom`);return n?b(U().format(V))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),e.jsx(w,{name:`${a}.${l}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[F,R,K(t,a,l,!1),()=>{const m=h(t,`${a}.${l}.periodeTom`);return n?b(U().format(V))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),A&&e.jsx("div",{children:A()})]},N.id)},N.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ge=ee(re),d=({readOnly:n,erAdopsjon:r,alleKodeverk:o,mottattDato:i})=>e.jsx(X,{value:ge,children:e.jsx(p,{readOnly:n,erAdopsjon:r,alleKodeverk:o,mottattDato:i})});d.initialValues=p.initialValues;d.transformValues=p.transformValues;d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
