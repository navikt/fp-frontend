import{j as r}from"./index-Byyjg8XX.js";import{a as V,e as w,A as c,y as B,G as H,V as v,b as S,M as N,Y as I,P as x,r as _,f as G,m as L,c as Y,N as $,B as D}from"./nb_NO-DYUjll3t.js";import{e as k,I as C,F as X,M as z,a as J}from"./index.es-fv94KH-L.js";import"./withPanelData-BfBqLFCK.js";import{r as Q}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as W}from"./alleKodeverk-DO07GSZv.js";import{L as Z}from"./landkoder-Bgpqk6-g.js";import{T as g}from"./TrueFalseInput-Daw7nzYV.js";import{M as ee}from"./message-BrM6o7bT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";import"./v4-CtRu48qb.js";import"./entry-preview-DQIMTNBk.js";import"./iframe-CnTIffbJ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var d=(e=>(e.UKJENT_FORELDER="UKJENT_FORELDER",e.IKKE_NORSK_FNR="IKKE_NORSK_FNR",e))(d||{});const t="annenForelder",m="kanIkkeOppgiBegrunnelse",re="_inputBredde_138ho_1",f={inputBredde:re},ne=e=>e.filter(({kode:s})=>s!==Z.NORGE).map(({kode:s,navn:n})=>r.jsx("option",{value:s,children:n},s)),T=({readOnly:e=!0,alleKodeverk:s,fagsakPersonnummer:n})=>{const{formatMessage:a}=V(),{watch:l,trigger:o,formState:{isSubmitted:F}}=w(),q=l(`${t}.kanIkkeOppgiAnnenForelder`),R=l(`${t}.${m}`),b=s.Landkoder,E=Q.useMemo(()=>b.slice().sort((u,U)=>u.navn.localeCompare(U.navn)),[b]);return r.jsxs(r.Fragment,{children:[r.jsx(c,{name:`${t}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:u=>u&&u.toString().replace(/\s/g,""),readOnly:e,className:f.inputBredde,validate:q?[]:[k,C,X,z(n)],disabled:q}),r.jsx(B,{name:`${t}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:e,onChange:()=>F?o():void 0}),q===!0&&r.jsx(H,{children:r.jsxs(v,{gap:"4",children:[r.jsx(S,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),r.jsx(N,{name:`${t}.${m}.arsak`,hideLegend:!0,validate:[k],isReadOnly:e,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:d.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:d.IKKE_NORSK_FNR}]}),(R==null?void 0:R.arsak)===d.IKKE_NORSK_FNR&&r.jsxs(r.Fragment,{children:[r.jsx(I,{name:`${t}.${m}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:ne(E),validate:[k],className:f.inputBredde,readOnly:e}),r.jsx(c,{name:`${t}.${m}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[k],className:f.inputBredde,readOnly:e})]})]})})]})};T.transformValues=({foedselsnummer:e,kanIkkeOppgiAnnenForelder:s,kanIkkeOppgiBegrunnelse:{arsak:n,land:a,utenlandskFoedselsnummer:l}={}})=>s?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===d.IKKE_NORSK_FNR?{arsak:n,land:a,utenlandskFoedselsnummer:l}:{arsak:n}}:{foedselsnummer:e,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};T.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
...
}`,...(M=(K=y.parameters)==null?void 0:K.docs)==null?void 0:M.source}}};const ce=["SokerErMor","SokerErFar"];export{y as SokerErFar,p as SokerErMor,ce as __namedExportsOrder,be as default};
