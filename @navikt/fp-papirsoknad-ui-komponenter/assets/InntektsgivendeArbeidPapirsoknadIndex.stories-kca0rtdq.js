import{j as r}from"./index-Byyjg8XX.js";import{a as K,e as j,i as q,$ as f,A as V,d as g,Y as M,f as h,V as R,b as E,k as P,P as O,r as I,m as N,c as S,N as U,B as G}from"./nb_NO-DYUjll3t.js";import{b as B,p as v,a as x}from"./index.es-fv94KH-L.js";import"./withPanelData-CkwF9r8U.js";import"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as H}from"./alleKodeverk-DO07GSZv.js";import{L as _}from"./landkoder-tJDPMx5C.js";import{F as D}from"./FieldArrayRow-BxrQXH8L.js";import{M as p}from"./message-BrM6o7bT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";import"./v4-CtRu48qb.js";import"./entry-preview-w9Yyb_VL.js";import"./iframe-DamG_XGQ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./Trash-C9VLp8MT.js";const s="arbeidsforhold",L=B(50),Y=a=>a.filter(({kode:e})=>e!==_.NORGE).map(({kode:e,navn:n})=>r.jsx("option",{value:e,children:n},e)),w=({alleKodeverk:a,readOnly:e})=>{const n=K(),{control:u}=j(),{fields:b,remove:m,append:F}=q({control:u,name:s}),c=a.Landkoder.slice().sort((k,l)=>k.navn.localeCompare(l.navn));return r.jsx(f,{fields:b,bodyText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:m,append:F,children:(k,l)=>r.jsxs(D,{remove:m,index:l,readOnly:e,children:[r.jsx(V,{readOnly:e,name:`${s}.${l}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[L],maxLength:99}),r.jsx(g,{isReadOnly:e,name:`${s}.${l}.periodeFom`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[v]}),r.jsx(g,{isReadOnly:e,name:`${s}.${l}.periodeTom`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[v]}),r.jsx(M,{readOnly:e,name:`${s}.${l}.land`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:Y(c),size:"small"})]},k.id)})};w.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const i=({readOnly:a,alleKodeverk:e})=>r.jsx(h,{children:r.jsxs(R,{gap:"4",children:[r.jsx(E,{size:"small",children:r.jsx(p,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),r.jsx(P,{children:r.jsx(p,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),r.jsx(w,{readOnly:a,alleKodeverk:e})]})});i.initialValues=()=>({[s]:[]});const o=a=>a===void 0||a==="";i.transformValues=({arbeidsforhold:a})=>({arbeidsforhold:a==null?void 0:a.filter(e=>!(o(e.arbeidsgiver)&&o(e.land)&&o(e.periodeFom)&&o(e.periodeTom)))});i.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const $=I(N),t=({readOnly:a,alleKodeverk:e})=>r.jsx(O,{value:$,children:r.jsx(i,{readOnly:a,alleKodeverk:e})});t.initialValues=i.initialValues;t.transformValues=i.transformValues;t.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ge={title:"ui-komponenter/inntektsgivende-arbeid",component:t,args:{readOnly:!1,alleKodeverk:H},parameters:{submitCallback:x("onSubmit")},render:(a,{parameters:{submitCallback:e}})=>{const n=S({defaultValues:t.initialValues()});return r.jsx(U,{formMethods:n,onSubmit:u=>e(t.transformValues(u)),children:r.jsxs(R,{gap:"10",children:[r.jsx(t,{...a}),r.jsx(G,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},d={};var y,T,A;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:"{}",...(A=(T=d.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};const ve=["Default"];export{d as Default,ve as __namedExportsOrder,ge as default};
