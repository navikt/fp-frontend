import{u as _,r as P,j as r,t as F,O as j,R as V,J as b,P as h,a as Y}from"./iframe-CKnwH9Kg.js";import{u as v,a as f,$ as D,H as L,O as N,B as M,d as U,V as T,b as I,C as B,c as H,e as x,m as G,f as $,N as C}from"./nb_NO-DlU9eL94.js";import{a as X}from"./alleKodeverk-DO07GSZv.js";import{S as J}from"./Trash-ClSRbdE8.js";import{M as z}from"./message-BMq6D31B.js";import"./preload-helper-PPVm8Dsz.js";import"./index-5gXYbC8c.js";var g=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(g||{});const m="andreYtelser",S="andreYtelserPerioder",A="andreYtelserTyper",O=({readOnly:e,name:a})=>{const n=_(),{getValues:t,control:s,trigger:l,formState:{isSubmitted:E}}=v(),{fields:R,remove:q,append:c}=f({control:s,name:a});return P.useEffect(()=>{R.length===0&&c({periodeFom:"",periodeTom:""})},[]),r.jsx(D,{fields:R,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:c,remove:q,children:(w,i)=>{const K=`${a}.${i}`;return r.jsxs(L,{gap:"space-8",children:[r.jsx(N,{name:`${K}.periodeFom`,control:s,label:i===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[F,j,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${i}`);return o&&k?V(o)(k):null}],onChange:()=>E?l():void 0}),r.jsx(N,{name:`${a}.${i}.periodeTom`,control:s,label:i===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[F,j,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${i}`);return k&&o?b(k)(o):null}],onChange:()=>E?l():void 0}),!e&&i>0&&r.jsx("div",{children:r.jsx(M,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(J,{}),onClick:()=>q(i)})})]},w.id)}})};O.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const d=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:n})=>{const{control:t}=v(),s=Q(n.ArbeidType,a);return r.jsx(U,{children:r.jsxs(T,{gap:"space-16",children:[r.jsx(I,{size:"small",level:"3",children:r.jsx(z,{id:"Registrering.AndreYtelser.Title"})}),r.jsx(B,{name:`${m}.${A}`,control:t,isReadOnly:e,children:s.map(l=>r.jsx(W,{arbeidstype:l,readOnly:e},l.kode))})]})})};d.initialValues=()=>({[m]:{[A]:[],[S]:{}}});d.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[m]:e.flatMap(n=>a[n].map(t=>({ytelseType:n,...t})))});const W=({arbeidstype:e,readOnly:a})=>{const{watch:n}=v(),t=n(`${m}.${A}`),[s,l]=P.useState(t.includes(e.kode));return r.jsxs(T,{gap:"space-12",children:[r.jsx(H,{value:e.kode,onClick:()=>l(!s),disabled:a,children:e.navn}),s&&r.jsx(x,{children:r.jsx(O,{name:`${m}.${S}.${e.kode}`,readOnly:a})})]})},Q=(e,a)=>a?e.filter(n=>n.kode===g.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==g.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==g.FRILANSER&&n.kode!==g.LONN_UNDER_UTDANNING);d.__docgenInfo={description:`AndreYtelserPanel
...
}`,...p.parameters?.docs?.source}}};const de=["Default","KunMiliterEllerSiviltjeneste"];export{y as Default,p as KunMiliterEllerSiviltjeneste,de as __namedExportsOrder,ue as default};
