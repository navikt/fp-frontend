import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{e as K,f as V,$ as w,A as h,P as y,Y as M,a as c,V as q,b as O,g as f,m as P,d as S,N as U,B}from"./nb_NO-BeBGbCCx.js";import{a as I}from"./index-B-lxVbXh.js";import"./withThemeDecorator-BuNaGT-U.js";import"./index-C4XKfyRp.js";import{u as E,a as N,r as H}from"./index.es-CZjkzcto.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as G}from"./alleKodeverk-DO07GSZv.js";import{a as Y,p as m}from"./index.es-sIGWTmsS.js";import{L as x}from"./landkoder-Bgpqk6-g.js";import{F as D}from"./FieldArrayRow-BGRNoU-Y.js";import{M as p}from"./message-C5auBQb2.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-B8xAIufp.js";import"./iframe-BukItUJR.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./Trash-B36cipQP.js";const i="arbeidsforhold",L=Y(50),_=n=>n.filter(({kode:e})=>e!==x.NORGE).map(({kode:e,navn:a})=>r.jsx("option",{value:e,children:a},e)),F=({alleKodeverk:n,readOnly:e})=>{const a=E(),{control:d}=K(),{fields:R,remove:g,append:j}=V({control:d,name:i}),b=n.Landkoder.slice().sort((o,t)=>o.navn.localeCompare(t.navn));return r.jsx(w,{fields:R,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:g,append:j,children:(o,t)=>r.jsxs(D,{remove:g,index:t,readOnly:e,children:[r.jsx(h,{readOnly:e,name:`${i}.${t}.arbeidsgiver`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[L],maxLength:99}),r.jsx(y,{isReadOnly:e,name:`${i}.${t}.periodeFom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[m]}),r.jsx(y,{isReadOnly:e,name:`${i}.${t}.periodeTom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[m]}),r.jsx(M,{readOnly:e,name:`${i}.${t}.land`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:_(b),size:"small"})]},o.id)})};F.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const l=({readOnly:n,alleKodeverk:e})=>r.jsx(c,{children:r.jsxs(q,{gap:"4",children:[r.jsx(O,{size:"small",children:r.jsx(p,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),r.jsx(f,{children:r.jsx(p,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),r.jsx(F,{readOnly:n,alleKodeverk:e})]})});l.initialValues=()=>({[i]:[]});const u=n=>n===void 0||n==="";l.transformValues=({arbeidsforhold:n})=>({arbeidsforhold:n==null?void 0:n.filter(e=>!(u(e.arbeidsgiver)&&u(e.land)&&u(e.periodeFom)&&u(e.periodeTom)))});l.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const $=H(P),s=({readOnly:n,alleKodeverk:e})=>r.jsx(N,{value:$,children:r.jsx(l,{readOnly:n,alleKodeverk:e})});s.initialValues=l.initialValues;s.transformValues=l.transformValues;s.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const pe={title:"ui-komponenter/inntektsgivende-arbeid",component:s,args:{readOnly:!1,alleKodeverk:G},parameters:{submitCallback:I("onSubmit")},render:(n,{parameters:{submitCallback:e}})=>{const a=S({defaultValues:s.initialValues()});return r.jsx(U,{formMethods:a,onSubmit:d=>e(s.transformValues(d)),children:r.jsxs(q,{gap:"10",children:[r.jsx(s,{...n}),r.jsx(B,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},k={};var v,T,A;k.parameters={...k.parameters,docs:{...(v=k.parameters)==null?void 0:v.docs,source:{originalSource:"{}",...(A=(T=k.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};const ve=["Default"];export{k as Default,ve as __namedExportsOrder,pe as default};
