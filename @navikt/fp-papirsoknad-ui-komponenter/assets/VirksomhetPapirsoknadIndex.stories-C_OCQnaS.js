import{u as B,j as e,r as $,P as X,a as W}from"./iframe-Dfdzdszb.js";import{u as S,W as q,V as b,Y as Q,H as Z,P as f,A as F,L as ee,C as D,d as re,B as c,i as ne,h as ae,j as te,a as se,E as ie,k as le,l as ue,b as ke,M as oe,m as de,c as ge,N as me}from"./nb_NO-C13zMDco.js";import{a as ye}from"./alleKodeverk-DO07GSZv.js";import{e as u,p as w,S as ve,R as pe,c as I,d as Te,y as J}from"./index.es-DlyoGAZW.js";import{T as K}from"./TrueFalseInput-GrPpnSnW.js";import{M as s}from"./message-Gg6SeZY4.js";import{T as k,S as Ae}from"./Table-DxTL_Yuk.js";import{S as qe}from"./Trash-CeExkEwX.js";import"./index-Cdc2WXz5.js";var g=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(g||{});const T="egenVirksomhet",i=`${T}.virksomheter`,be={},Re=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),E=({index:r,readOnly:n,alleKodeverk:a})=>{const t=B(),l=a.Landkoder.slice().sort((o,d)=>o.navn.localeCompare(d.navn)),{getValues:m}=S();return e.jsx(K,{name:`${i}.${r}.virksomhetRegistrertINorge`,label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(q,{marginTop:8,children:e.jsx(F,{name:`${i}.${r}.organisasjonsnummer`,readOnly:n,validate:[u,I,Te],label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(q,{alignOffset:58,marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(Q,{name:`${i}.${r}.landJobberFra`,className:be.landBredde,selectValues:Re(l),validate:[u],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(Z,{gap:"4",children:[e.jsx(f,{isReadOnly:n,validate:[u,w,ve],name:`${i}.${r}.fom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(f,{isReadOnly:n,validate:[w,o=>{const d=m(`${i}.${r}.fom`);return d?pe(d,o):null}],name:`${i}.${r}.tom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};E.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:l})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:l}:{landJobberFra:"NOR"}});E.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
