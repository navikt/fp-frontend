import{j as r}from"./index-Byyjg8XX.js";import{a as f,e as L,i as U,$ as D,H as B,d as E,B as w,f as I,V as K,b as H,C as G,G as x,P as $,r as X,m as C,c as z,N as J}from"./nb_NO-DYUjll3t.js";import{e as q,p as F,D as Q,H as W,a as Z}from"./index.es-fv94KH-L.js";import"./withPanelData-BfBqLFCK.js";import{r as _}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{S as re}from"./Trash-C9VLp8MT.js";import{M as ne}from"./message-BrM6o7bT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";import"./v4-CtRu48qb.js";import"./entry-preview-DQIMTNBk.js";import"./iframe-CnTIffbJ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var o=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(o||{});const p="andreYtelser",O="andreYtelserPerioder",b="andreYtelserTyper",V=({readOnly:e,name:a})=>{const n=f(),{getValues:t,control:m,trigger:l,formState:{isSubmitted:v}}=L(),{fields:T,remove:A,append:R}=U({control:m,name:a});return _.useEffect(()=>{T.length===0&&R({periodeFom:"",periodeTom:""})},[]),r.jsx(D,{fields:T,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:R,remove:A,children:(Y,s)=>{const h=`${a}.${s}`;return r.jsxs(B,{gap:"2",children:[r.jsx(E,{name:`${h}.periodeFom`,label:s===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[q,F,()=>{const{periodeFom:d,periodeTom:k}=t(`${a}.${s}`);return k&&d?Q(k)(d):null}],onChange:()=>v?l():void 0}),r.jsx(E,{name:`${a}.${s}.periodeTom`,label:s===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[q,F,()=>{const{periodeFom:d,periodeTom:k}=t(`${a}.${s}`);return d&&k?W(d)(k):null}],onChange:()=>v?l():void 0}),!e&&s>0&&r.jsx("div",{children:r.jsx(w,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(re,{}),onClick:()=>A(s)})})]},Y.id)}})};V.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const ae=(e,a)=>a?e.filter(n=>n.kode===o.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==o.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==o.FRILANSER&&n.kode!==o.LONN_UNDER_UTDANNING),u=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:n})=>{const t=n.ArbeidType,m=_.useMemo(()=>ae(t,a),[a]);return r.jsx(I,{children:r.jsxs(K,{gap:"4",children:[r.jsx(H,{size:"small",children:r.jsx(ne,{id:"Registrering.AndreYtelser.Title"})}),r.jsx(G,{isReadOnly:e,name:`${p}.${b}`,checkboxes:m.map(l=>({label:l.navn,value:l.kode,element:r.jsx(x,{children:r.jsx(V,{name:`${p}.${O}.${l.kode}`,readOnly:e})})}))})]})})};u.initialValues=()=>({[p]:{[b]:[],[O]:{}}});u.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[p]:e.flatMap(n=>a[n].map(t=>({ytelseType:n,...t})))});u.__docgenInfo={description:`AndreYtelserPanel
...
}`,...(N=(S=y.parameters)==null?void 0:S.docs)==null?void 0:N.source}}};const je=["Default","KunMiliterEllerSiviltjeneste"];export{g as Default,y as KunMiliterEllerSiviltjeneste,je as __namedExportsOrder,ce as default};
