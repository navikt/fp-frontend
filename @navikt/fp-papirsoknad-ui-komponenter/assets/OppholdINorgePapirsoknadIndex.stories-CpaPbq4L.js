import{u as I,j as e,R as G,t as F,O as w,V as c,d as K,b as U,J as j,h as E,P as Y,a as L}from"./iframe-ChCszL4i.js";import{u as B,a as $,$ as _,H as C,O as D,P as M,l as z,V as T,b as J,W as N,m as W,d as Q,N as X,B as Z}from"./nb_NO-OoPiwMTG.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as f}from"./TrueFalseInput-BwBy8VzM.js";import{L as re}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-D6BptZK1.js";import"./index-DylFhEll.js";const ne={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(n,r)=>n(r),P=(n,r)=>()=>{const l=n(r).filter(({periodeFom:t,periodeTom:a})=>t&&t!==""&&a&&a!=="").map(({periodeFom:t,periodeTom:a})=>[t,a]);return l.length>0?E(l):void 0},ae=n=>n.filter(({kode:r})=>r!==re.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),S=(n,r,s,l)=>()=>{const t=q(n,`${r}.${s}.periodeFom`),a=q(n,`${r}.${s}.periodeTom`);return!a||!t?null:l?c(a)(t):j(t)(a)},b=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=I(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:i,trigger:g,formState:{isSubmitted:m}}=B(),{fields:A,remove:h,append:x}=$({control:o,name:a}),H=ae(l);return e.jsx(_,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:ne,readOnly:s,remove:h,append:x,children:(V,d,R)=>e.jsx(G.Fragment,{children:e.jsxs(C,{gap:"4",paddingBlock:"2",children:[e.jsx(D,{name:`${a}.${d}.land`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:H,readOnly:s,validate:[F]}),e.jsx(M,{name:`${a}.${d}.periodeFom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,w,S(i,a,d,!0),()=>{const k=q(i,`${a}.${d}.periodeFom`);return n?c(K().format(U))(k):r?j(r)(k):void 0},P(i,a)],onChange:()=>m?g():void 0}),e.jsx(M,{name:`${a}.${d}.periodeTom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,w,S(i,a,d,!1),()=>{const k=q(i,`${a}.${d}.periodeTom`);return n?c(K().format(U))(k):r?j(r)(k):void 0},P(i,a)],onChange:()=>m?g():void 0}),R&&e.jsx("div",{children:R()})]},V.id)},V.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:n=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=I(),a=r.Landkoder.slice().sort((A,h)=>A.navn.localeCompare(h.navn)),{watch:o,control:i}=B(),g=!o("oppholdSisteTolvINorge",!0),m=!o("oppholdNesteTolvINorge",!0);return e.jsx(z,{children:e.jsxs(T,{gap:"4",children:[e.jsx(J,{size:"small",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(f,{name:"oppholdINorge",control:i,label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(T,{gap:"2",children:[e.jsx(f,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),g&&e.jsx(N,{alignOffset:58,children:e.jsx(b,{erTidligereOpphold:!0,mottattDato:s,countryCodes:a,readOnly:n})})]}),e.jsxs(T,{gap:"2",children:[e.jsx(f,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),m&&e.jsx(N,{alignOffset:58,children:e.jsx(b,{mottattDato:s,countryCodes:a,readOnly:n})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});p.__docgenInfo={description:`OppholdINorgePanel
