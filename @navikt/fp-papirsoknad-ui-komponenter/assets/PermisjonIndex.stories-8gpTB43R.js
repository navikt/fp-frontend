...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const fe=`${l}.${ve}`,V=e=>`${fe}.${e}`,_e=e=>()=>{const a=(e(`${fe}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?re(a):void 0},Ne={periodeFom:"",periodeTom:"",årsak:""},Ir=[B.UTTAK_MØDREKVOTE_ANNEN_FORELDER,B.UTTAK_FEDREKVOTE_ANNEN_FORELDER,B.UTTAK_FELLESP_ANNEN_FORELDER,B.UTTAK_FORELDREPENGER_ANNEN_FORELDER],Ur=e=>e.filter(({kode:r})=>Ir.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),be=({oppholdsReasons:e,readOnly:r})=>{const a=G(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=q(),{fields:u,remove:k,append:R}=z({control:t,name:`${fe}`});return S.useEffect(()=>{u.length===0&&R(Ne)},[]),n.jsx(Z,{fields:u,emptyPeriodTemplate:Ne,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:k,children:(c,o)=>n.jsxs(ae,{readOnly:r,remove:k,index:o,children:[n.jsx(P,{name:`${V(o)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,F,()=>{const p=i(`${V(o)}.periodeFom`),d=i(`${V(o)}.periodeTom`);return d&&p?Q(d)(p):null},_e(i)],onChange:()=>g?s():void 0}),n.jsx(P,{name:`${V(o)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,F,()=>{const p=i(`${V(o)}.periodeFom`),d=i(`${V(o)}.periodeTom`);return d&&p?ee(p)(d):null},_e(i)],onChange:()=>g?s():void 0}),n.jsx("div",{children:n.jsx(w,{name:`${V(o)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:Ur(e),validate:[v]})})]},c.id)})};be.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const qe=`${l}.${tr}`,D=e=>`${qe}.${e}`,Ie=e=>()=>{const a=(e(qe)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?re(a):void 0},Ue={periodeFom:"",periodeTom:"",overforingArsak:""},Ae=({selectValues:e,readOnly:r})=>{const a=G(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=q(),{fields:u,remove:k,append:R}=z({control:t,name:qe});return S.useEffect(()=>{u.length===0&&R(Ue)},[]),n.jsx(Z,{fields:u,emptyPeriodTemplate:Ue,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:k,children:(c,o)=>n.jsxs(ae,{readOnly:r,remove:k,index:o,children:[n.jsx("div",{children:n.jsx(w,{name:`${D(o)}.overforingArsak`,label:a.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[v],readOnly:r})}),n.jsx(P,{isReadOnly:r,name:`${D(o)}.periodeFom`,validate:[v,F,()=>{const p=i(`${D(o)}.periodeFom`),d=i(`${D(o)}.periodeTom`);return d&&p?Q(d)(p):null},Ie(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>g?s():void 0}),n.jsx(P,{isReadOnly:r,name:`${D(o)}.periodeTom`,validate:[v,F,()=>{const p=i(`${D(o)}.periodeFom`),d=i(`${D(o)}.periodeTom`);return d&&p?ee(p)(d):null},Ie(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>g?s():void 0})]},c.id)})};Ae.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const hr=gr(kr),O=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>n.jsx(mr,{value:hr,children:n.jsx(x,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t})});O.transformValues=x.transformValues;O.initialValues=x.initialValues;O.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const sn={title:"ui-komponenter/permisjon",component:O,parameters:{submitCallback:br("onSubmit")},args:{readOnly:!1,alleKodeverk:qr},render:(e,{parameters:{submitCallback:r}})=>{const a=pr({defaultValues:O.initialValues()});return n.jsx(vr,{formMethods:a,onSubmit:t=>r(O.transformValues(t)),children:n.jsxs(L,{gap:"10",children:[n.jsx(O,{...e}),n.jsx(yr,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},_={args:{foreldreType:ne.MOR,erEndringssøknad:!1}},N={args:{foreldreType:ne.FAR,erEndringssøknad:!1}},I={args:{foreldreType:ne.MOR,erEndringssøknad:!0}};var De,he,Se;_.parameters={..._.parameters,docs:{...(De=_.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
...
}`,...(Xe=(Be=_.parameters)==null?void 0:Be.docs)==null?void 0:Xe.source}}};var Ce,ze,Ze;N.parameters={...N.parameters,docs:{...(Ce=N.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    foreldreType: ForeldreType.FAR,
    erEndringssøknad: false
  }
}`,...(Ze=(ze=N.parameters)==null?void 0:ze.docs)==null?void 0:Ze.source}}};var We,Qe,er;I.parameters={...I.parameters,docs:{...(We=I.parameters)==null?void 0:We.docs,source:{originalSource:`{
  args: {
    foreldreType: ForeldreType.MOR,
    erEndringssøknad: true
  }
}`,...(er=(Qe=I.parameters)==null?void 0:Qe.docs)==null?void 0:er.source}}};const on=["SokerErMor","SokerErFar","ErEndringssøknad"];export{I as ErEndringssøknad,N as SokerErFar,_ as SokerErMor,on as __namedExportsOrder,sn as default};
