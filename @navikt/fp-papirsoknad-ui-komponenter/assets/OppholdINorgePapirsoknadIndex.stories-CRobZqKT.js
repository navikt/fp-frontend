import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{i as G,f as Z,l as Y,r as ee,H as re,Z as ne,G as j,A as V,a as ae,V as f,b as oe,M as F,C as I,P as se,n as ie,m as le,c as te,e as de,B as pe}from"./nb_NO-CoA8CYxJ.js";import{e as b,O as U,D as N,H as O,h as me,a as ue}from"./index.es-BXKFxR2z.js";import"./withPanelData-BTrFZcnv.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as ge,a as ve}from"./alleKodeverk-BFmIlMu4.js";import{r as J,R as ke}from"./index-_2TAQcTa.js";import{T}from"./TrueFalseInput-Mp05nkOp.js";import{d as R}from"./dayjs.min-DkLNzaWO.js";import{L as ye}from"./landkoder-tJDPMx5C.js";import"./index-BsrZSYsV.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CQwh6Daz.js";import"./v4-CtRu48qb.js";import"./react-BuEdp26o.js";import"./iframe-SCldKH__.js";import"./chunk-XP5HYGXS-D5tuasO7.js";const fe={land:void 0,periodeFom:void 0,periodeTom:void 0},h=(n,r)=>n(r),K=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?me(i):void 0},he=n=>n.filter(({kode:r})=>r!==ye.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),M=(n,r,o,i)=>()=>{const s=h(n,`${r}.${o}.periodeFom`),a=h(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?N(a)(s):O(s)(a)},c=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=G(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:v,getValues:l,trigger:k,formState:{isSubmitted:y}}=Z(),{fields:q,remove:Q,append:W}=Y({control:v,name:a}),X=J.useMemo(()=>he(i),[i]);return e.jsx(ee,{fields:q,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:fe,readOnly:o,remove:Q,append:W,children:(w,m,A)=>e.jsx(ke.Fragment,{children:e.jsxs(re,{gap:"4",paddingBlock:"2",children:[e.jsx(ne,{name:`${a}.${m}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:X,readOnly:o,validate:[b]}),e.jsx(j,{name:`${a}.${m}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[b,U,M(l,a,m,!0),()=>{const g=h(l,`${a}.${m}.periodeFom`);return n?N(R().format(V))(g):r?O(r)(g):void 0},K(l,a)],onChange:()=>y?k():void 0}),e.jsx(j,{name:`${a}.${m}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[b,U,M(l,a,m,!1),()=>{const g=h(l,`${a}.${m}.periodeTom`);return n?N(R().format(V))(g):r?O(r)(g):void 0},K(l,a)],onChange:()=>y?k():void 0}),A&&e.jsx("div",{children:A()})]},w.id)},w.id)})};c.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const u=({readOnly:n=!0,alleKodeverk:r,mottattDato:o,erAdopsjon:i})=>{const{formatMessage:s}=G(),a=J.useMemo(()=>r[ge.LANDKODER].slice().sort((y,q)=>y.navn.localeCompare(q.navn)),[r]),{watch:v}=Z(),l=!v("oppholdSisteTolvINorge",!0),k=!v("oppholdNesteTolvINorge",!0);return e.jsx(ae,{children:e.jsxs(f,{gap:"4",children:[e.jsx(oe,{size:"small",children:e.jsx(F,{id:"Registrering.Opphold"})}),e.jsx(T,{name:"oppholdINorge",label:s({id:i?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(f,{gap:"2",children:[e.jsx(T,{name:"oppholdSisteTolvINorge",label:e.jsx(F,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),l&&e.jsx(I,{alignOffset:58,children:e.jsx(c,{erTidligereOpphold:!0,mottattDato:o,countryCodes:a,readOnly:n})})]}),e.jsxs(f,{gap:"2",children:[e.jsx(T,{name:"oppholdNesteTolvINorge",label:e.jsx(F,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),k&&e.jsx(I,{alignOffset:58,children:e.jsx(c,{mottattDato:o,countryCodes:a,readOnly:n})})]})]})})};u.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});u.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:o,tidligereOppholdUtenlands:i,fremtidigeOppholdUtenlands:s})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!o,tidligereOppholdUtenlands:r?void 0:i,fremtidigeOppholdUtenlands:o?void 0:s});u.__docgenInfo={description:`OppholdINorgePanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const $e={title:"ui-komponenter/opphold-i-norge",component:t,parameters:{submitCallback:ue("onSubmit")},args:{readOnly:!1,alleKodeverk:ve,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=te({defaultValues:t.initialValues()});return e.jsx(de,{formMethods:o,onSubmit:i=>r(t.transformValues(i)),children:e.jsxs(f,{gap:"10",children:[e.jsx(t,{...n}),e.jsx(pe,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},d={args:{erAdopsjon:!1}},p={args:{erAdopsjon:!0}};var x,S,$;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
}`,...($=(S=d.parameters)==null?void 0:S.docs)==null?void 0:$.source}}};var _,C,P;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    erAdopsjon: true
  }
}`,...(P=(C=p.parameters)==null?void 0:C.docs)==null?void 0:P.source}}};var E,D,H;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(B=(z=p.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};const _e=["ForFodsel","ForAdopsjon"];export{p as ForAdopsjon,d as ForFodsel,_e as __namedExportsOrder,$e as default};
