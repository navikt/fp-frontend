import{u as O,r as M,j as r,t as F,O as j,V,J as b,P as h,a as Y}from"./iframe-ChCszL4i.js";import{u as v,a as f,$ as L,H as U,P,B as S,l as D,V as T,b as I,C as B,c as H,W as x,m as G,d as $,N as C}from"./nb_NO-OoPiwMTG.js";import{a as X}from"./alleKodeverk-DO07GSZv.js";import{S as J}from"./Trash-C3zGaCca.js";import{M as z}from"./message-D6BptZK1.js";import"./index-DylFhEll.js";var g=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(g||{});const y="andreYtelser",N="andreYtelserPerioder",A="andreYtelserTyper",w=({readOnly:e,name:a})=>{const n=O(),{getValues:t,control:s,trigger:l,formState:{isSubmitted:R}}=v(),{fields:E,remove:q,append:c}=f({control:s,name:a});return M.useEffect(()=>{E.length===0&&c({periodeFom:"",periodeTom:""})},[]),r.jsx(L,{fields:E,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:c,remove:q,children:(_,i)=>{const K=`${a}.${i}`;return r.jsxs(U,{gap:"2",children:[r.jsx(P,{name:`${K}.periodeFom`,control:s,label:i===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[F,j,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${i}`);return o&&k?V(o)(k):null}],onChange:()=>R?l():void 0}),r.jsx(P,{name:`${a}.${i}.periodeTom`,control:s,label:i===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[F,j,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${i}`);return k&&o?b(k)(o):null}],onChange:()=>R?l():void 0}),!e&&i>0&&r.jsx("div",{children:r.jsx(S,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(J,{}),onClick:()=>q(i)})})]},_.id)}})};w.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const d=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:n})=>{const{control:t}=v(),s=Q(n.ArbeidType,a);return r.jsx(D,{children:r.jsxs(T,{gap:"4",children:[r.jsx(I,{size:"small",children:r.jsx(z,{id:"Registrering.AndreYtelser.Title"})}),r.jsx(B,{name:`${y}.${A}`,control:t,isReadOnly:e,children:s.map(l=>r.jsx(W,{arbeidstype:l,readOnly:e},l.kode))})]})})};d.initialValues=()=>({[y]:{[A]:[],[N]:{}}});d.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[y]:e.flatMap(n=>a[n].map(t=>({ytelseType:n,...t})))});const W=({arbeidstype:e,readOnly:a})=>{const{watch:n}=v(),t=n(`${y}.${A}`),[s,l]=M.useState(t.includes(e.kode));return r.jsxs(T,{gap:"2",children:[r.jsx(H,{value:e.kode,onClick:()=>l(!s),disabled:a,children:e.navn}),s&&r.jsx(x,{children:r.jsx(w,{name:`${y}.${N}.${e.kode}`,readOnly:a})})]})},Q=(e,a)=>a?e.filter(n=>n.kode===g.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==g.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==g.FRILANSER&&n.kode!==g.LONN_UNDER_UTDANNING);d.__docgenInfo={description:`AndreYtelserPanel
...
}`,...m.parameters?.docs?.source}}};const ue=["Default","KunMiliterEllerSiviltjeneste"];export{p as Default,m as KunMiliterEllerSiviltjeneste,ue as __namedExportsOrder,le as default};
