import{u as Y,j as e,R as C,t as F,O as w,V as c,d as K,b as U,J as j,h as D,P as z,a as J}from"./iframe-Cd5tSmbZ.js";import{u as L,a as W,$ as Q,H as X,Y as Z,P as M,l as ee,V as T,b as re,W as N,m as ne,d as ae,N as se,B as te}from"./nb_NO-B3SCrwpL.js";import{a as le}from"./alleKodeverk-DO07GSZv.js";import{T as f}from"./TrueFalseInput-DXH8e-aI.js";import{L as ie}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-Db7SWhej.js";import"./index-DNNPsnCD.js";const oe={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(n,r)=>n(r),P=(n,r)=>()=>{const l=n(r).filter(({periodeFom:t,periodeTom:a})=>t&&t!==""&&a&&a!=="").map(({periodeFom:t,periodeTom:a})=>[t,a]);return l.length>0?D(l):void 0},de=n=>n.filter(({kode:r})=>r!==ie.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),S=(n,r,s,l)=>()=>{const t=q(n,`${r}.${s}.periodeFom`),a=q(n,`${r}.${s}.periodeTom`);return!a||!t?null:l?c(a)(t):j(t)(a)},b=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=Y(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:i,trigger:g,formState:{isSubmitted:m}}=L(),{fields:A,remove:h,append:$}=W({control:o,name:a}),_=de(l);return e.jsx(Q,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:oe,readOnly:s,remove:h,append:$,children:(V,d,R)=>e.jsx(C.Fragment,{children:e.jsxs(X,{gap:"4",paddingBlock:"2",children:[e.jsx(Z,{name:`${a}.${d}.land`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:_,readOnly:s,validate:[F]}),e.jsx(M,{name:`${a}.${d}.periodeFom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,w,S(i,a,d,!0),()=>{const k=q(i,`${a}.${d}.periodeFom`);return n?c(K().format(U))(k):r?j(r)(k):void 0},P(i,a)],onChange:()=>m?g():void 0}),e.jsx(M,{name:`${a}.${d}.periodeTom`,control:o,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,w,S(i,a,d,!1),()=>{const k=q(i,`${a}.${d}.periodeTom`);return n?c(K().format(U))(k):r?j(r)(k):void 0},P(i,a)],onChange:()=>m?g():void 0}),R&&e.jsx("div",{children:R()})]},V.id)},V.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ue=J(ne),u=({readOnly:n,erAdopsjon:r,alleKodeverk:s,mottattDato:l})=>e.jsx(z,{value:ue,children:e.jsx(p,{readOnly:n,erAdopsjon:r,alleKodeverk:s,mottattDato:l})});u.initialValues=p.initialValues;u.transformValues=p.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:pe}=__STORYBOOK_MODULE_ACTIONS__,Ae={title:"ui-komponenter/opphold-i-norge",component:u,parameters:{submitCallback:pe("onSubmit")},args:{readOnly:!1,alleKodeverk:le,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const s=ae({defaultValues:u.initialValues()});return e.jsx(se,{formMethods:s,onSubmit:l=>r(u.transformValues(l)),children:e.jsxs(T,{gap:"10",children:[e.jsx(u,{...n}),e.jsx(te,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{erAdopsjon:!1}},v={args:{erAdopsjon:!0}};var I,B,x;y.parameters={...y.parameters,docs:{...(I=y.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(E=(G=v.parameters)==null?void 0:G.docs)==null?void 0:E.source}}};const he=["ForFodsel","ForAdopsjon"];export{v as ForAdopsjon,y as ForFodsel,he as __namedExportsOrder,Ae as default};
