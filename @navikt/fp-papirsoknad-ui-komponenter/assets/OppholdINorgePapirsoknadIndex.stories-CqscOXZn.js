import{u as k,j as e,a as q,t as O,O as P,R as G,d as V,x as d,J as o,h,P as w,e as f}from"./iframe-Cf0Wwlz0.js";import{u as g,a as c,M as C,H as b,w as j,T as M,c as Z,V as I,b as W,U as p,m as X,d as x,P as $,B as Q}from"./nb_NO-YMWondlV.js";import{a as z}from"./alleKodeverk-BnsD7hyO.js";import{T as K}from"./TrueFalseInput-Bc0vJw-Y.js";import{M as s}from"./message-DUS1bYdj.js";import"./preload-helper-PPVm8Dsz.js";import"./index-TQYH78_i.js";const ee={land:void 0,periodeFom:void 0,periodeTom:void 0},U=(l,a)=>()=>{const t=l(a).filter(E=>typeof E.periodeFom=="string"&&E.periodeFom!==""&&typeof E.periodeTom=="string"&&E.periodeTom!=="").map(({periodeFom:E,periodeTom:r})=>[E,r]);return t.length>0?h(t):void 0},ae=l=>l.filter(({kode:a})=>a!=="NOR").map(({kode:a,navn:n})=>e.jsx("option",{value:a,children:n},a)),B=(l,a,n)=>()=>!n||!a?null:l?G(n)(a):o(a)(n),F=({erTidligereOpphold:l=!1,mottattDato:a,readOnly:n,countryCodes:t})=>{const E=k(),r=l?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:N,getValues:i,trigger:v,formState:{isSubmitted:_}}=g(),{fields:L,remove:D,append:y}=c({control:N,name:r}),H=ae(t);return e.jsx(C,{fields:L,titleText:E.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:E.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ee,readOnly:n,remove:D,append:y,children:(J,u,Y)=>e.jsx(q.Fragment,{children:e.jsxs(b,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(j,{name:`${r}.${u}.land`,control:N,label:E.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:u>0,selectValues:H,readOnly:n,validate:[O]}),e.jsx(M,{name:`${r}.${u}.periodeFom`,control:N,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:u>0,readOnly:n,validate:[O,P,B(!0,i(`${r}.${u}.periodeFom`),i(`${r}.${u}.periodeTom`)),()=>{const T=i(`${r}.${u}.periodeFom`);return l?G(V().format(d))(T):a?o(a)(T):void 0},U(i,r)],onChange:()=>_?v():void 0}),e.jsx(M,{name:`${r}.${u}.periodeTom`,control:N,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:u>0,readOnly:n,validate:[O,P,B(!1,i(`${r}.${u}.periodeFom`),i(`${r}.${u}.periodeTom`)),()=>{const T=i(`${r}.${u}.periodeTom`);return l?G(V().format(d))(T):a?o(a)(T):void 0},U(i,r)],onChange:()=>_?v():void 0}),e.jsx("div",{children:Y})]})},J.id)})};F.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const R=({readOnly:l=!0,alleKodeverk:a,mottattDato:n,erAdopsjon:t})=>{const{formatMessage:E}=k(),r=a.Landkoder.slice().sort((L,D)=>L.navn.localeCompare(D.navn)),{watch:N,control:i}=g(),v=!N("oppholdSisteTolvINorge",!0),_=!N("oppholdNesteTolvINorge",!0);return e.jsx(Z,{children:e.jsxs(I,{gap:"space-16",children:[e.jsx(W,{size:"small",level:"3",children:e.jsx(s,{id:"Registrering.Opphold"})}),e.jsx(K,{name:"oppholdINorge",control:i,label:E({id:t?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:l}),e.jsxs(I,{gap:"space-8",children:[e.jsx(K,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(s,{id:"Registrering.OppholdSisteTolv"}),readOnly:l}),v&&e.jsx(p,{alignOffset:58,children:e.jsx(F,{erTidligereOpphold:!0,mottattDato:n,countryCodes:r,readOnly:l})})]}),e.jsxs(I,{gap:"space-8",children:[e.jsx(K,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(s,{id:"Registrering.OppholdNesteTolv"}),readOnly:l}),_&&e.jsx(p,{alignOffset:58,children:e.jsx(F,{mottattDato:n,countryCodes:r,readOnly:l})})]})]})})};R.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});R.transformValues=({oppholdINorge:l,oppholdSisteTolvINorge:a,oppholdNesteTolvINorge:n,tidligereOppholdUtenlands:t,fremtidigeOppholdUtenlands:E})=>({oppholdINorge:l,harTidligereOppholdUtenlands:!a,harFremtidigeOppholdUtenlands:!n,tidligereOppholdUtenlands:a?void 0:t,fremtidigeOppholdUtenlands:n?void 0:E});R.__docgenInfo={description:`OppholdINorgePanel
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const le=f(X),m=({readOnly:l,erAdopsjon:a,alleKodeverk:n,mottattDato:t})=>e.jsx(w,{value:le,children:e.jsx(R,{readOnly:l,erAdopsjon:a,alleKodeverk:n,mottattDato:t})});m.initialValues=R.initialValues;m.transformValues=R.transformValues;m.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:ne}=__STORYBOOK_MODULE_ACTIONS__,Re={title:"ui-komponenter/opphold-i-norge",component:m,parameters:{submitCallback:ne("onSubmit")},args:{readOnly:!1,alleKodeverk:z,mottattDato:"2022-05-30"},render:(l,{parameters:{submitCallback:a}})=>{const n=x({defaultValues:m.initialValues()});return e.jsx($,{formMethods:n,onSubmit:t=>a(m.transformValues(t)),children:e.jsxs(I,{gap:"space-40",children:[e.jsx(m,{...l}),e.jsx(Q,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},A={args:{erAdopsjon:!1}},S={args:{erAdopsjon:!0}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
