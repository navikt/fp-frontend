import{u as N,r as G,j as a,d as se,P as Le}from"./iframe-Bn-aqi4-.js";import{u as F,a as $,$ as J,O as c,P as E,w as j,A as te,e as he,V as U,L as C,l as Ye,b as xe,E as $e,r as Je,m as Ce,d as Xe,N as ze,B as We}from"./nb_NO-DFI16EvZ.js";import{F as X}from"./foreldreType-BrQrvOqY.js";import{a as Qe}from"./alleKodeverk-DO07GSZv.js";import{t as p,O as P,f as me,i as Me,R as z,J as W,h as Q,g as Ze,N as er,e as rr}from"./index.es-ZAp-KALQ.js";import{F as Z}from"./FieldArrayRow-CjQP43ue.js";import{M as y}from"./message-ium0Z45r.js";import{A as Ne}from"./Alert-Dy0QsIcF.js";import"./index-CnhIzrCe.js";import"./Trash-DOMlWAbm.js";var K=(e=>(e.FISKER="FISKER",e.ARBEIDSTAKER="ARBEIDSTAKER",e.SELVSTENDIG_NAERINGSDRIVENDE="SELVSTENDIG_NÆRINGSDRIVENDE",e.KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NAERINGSDRIVENDE="KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NÆRINGSDRIVENDE",e.SJOMANN="SJØMANN",e.JORDBRUKER="JORDBRUKER",e.DAGPENGER="DAGPENGER",e.INAKTIV="INAKTIV",e.KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER="KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER",e.KOMBINASJON_ARBEIDSTAKER_OG_FISKER="KOMBINASJON_ARBEIDSTAKER_OG_FISKER",e.FRILANSER="FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER="KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER="KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER",e.DAGMAMMA="DAGMAMMA",e.ANNET="ANNET",e))(K||{}),L=(e=>(e.INGEN="INGEN",e.UTTAK_MØDREKVOTE_ANNEN_FORELDER="UTTAK_MØDREKVOTE_ANNEN_FORELDER",e.UTTAK_FEDREKVOTE_ANNEN_FORELDER="UTTAK_FEDREKVOTE_ANNEN_FORELDER",e.UTTAK_FELLESP_ANNEN_FORELDER="UTTAK_FELLESP_ANNEN_FORELDER",e.UTTAK_FORELDREPENGER_ANNEN_FORELDER="UTTAK_FORELDREPENGER_ANNEN_FORELDER",e.UDEFINERT="-",e))(L||{}),x=(e=>(e.INSTITUSJONSOPPHOLD_ANNEN_FORELDER="INSTITUSJONSOPPHOLD_ANNEN_FORELDER",e.SYKDOM_ANNEN_FORELDER="SYKDOM_ANNEN_FORELDER",e.ALENEOMSORG="ALENEOMSORG",e.IKKE_RETT_ANNEN_FORELDER="IKKE_RETT_ANNEN_FORELDER",e.UDEFINERT="-",e))(x||{}),b=(e=>(e.MODREKVOTE="MØDREKVOTE",e.FEDREKVOTE="FEDREKVOTE",e.FELLESPERIODE="FELLESPERIODE",e.FORELDREPENGER_FOR_FODSEL="FORELDREPENGER_FØR_FØDSEL",e.FORELDREPENGER="FORELDREPENGER",e.UDEFINERT="-",e))(b||{});const ar=(e,r)=>{if(e==null)throw Error("Data er ikke oppgitt");return e},d="tidsromPermisjon",_="graderingPeriode",pe="oppholdPerioder",Ue="overforingsperioder",le="utsettelsePeriode",Y="permisjonsPerioder",ye=`${d}.${Y}`,O=e=>`${ye}.${e}`,nr=Me(100),ve=[b.FELLESPERIODE,b.FEDREKVOTE,b.FORELDREPENGER_FOR_FODSEL,b.FORELDREPENGER,b.MODREKVOTE],Se=[b.FEDREKVOTE,b.FORELDREPENGER_FOR_FODSEL,b.MODREKVOTE],ue=({sokerErMor:e,readOnly:r,alleKodeverk:n})=>{const t=N(),s=n.UttakPeriodeType,i=n.MorsAktivitet;i.filter(({kode:m})=>m==="-").length===0&&i.unshift({kode:"-",navn:"",kodeverk:""});const{control:l,getValues:k,trigger:v,watch:T,formState:{isSubmitted:A}}=F(),{fields:u,remove:g,append:o}=$({control:l,name:ye});return G.useEffect(()=>{u.length===0&&o({})},[]),a.jsx(J,{readOnly:r,fields:u,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyPeriodTemplate:{},append:o,remove:g,children:(m,q)=>{const f=q===0,S=T(O(q)),D=ir(S.periodeFom),He=Se.some(H=>H===S.periodeType)||S.periodeType==="";return a.jsxs(Z,{readOnly:r,remove:g,index:q,children:[a.jsx("div",{children:a.jsx(c,{name:`${O(q)}.periodeType`,control:l,readOnly:r,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:tr(s),validate:[p]})}),a.jsx(E,{isReadOnly:r,control:l,name:`${O(q)}.periodeFom`,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[p,P,Re(k,q,!0),qe(k)],onChange:()=>A?v():void 0}),a.jsx(E,{isReadOnly:r,control:l,name:`${O(q)}.periodeTom`,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[p,P,Re(k,q,!1),qe(k)],onChange:()=>A?v():void 0}),!e&&a.jsx(c,{name:`${O(q)}.morsAktivitet`,control:l,readOnly:r,disabled:He,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:sr(i),hideValueOnDisable:!0}),a.jsx(j,{name:`${O(q)}.flerbarnsdager`,control:l,readOnly:r,label:a.jsx(y,{id:"Registrering.Permisjon.Flerbarnsdager"})}),a.jsx(j,{name:`${O(q)}.harSamtidigUttak`,control:l,readOnly:r,label:a.jsx(y,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),S.harSamtidigUttak&&a.jsx(te,{name:`${O(q)}.samtidigUttaksprosent`,control:l,validate:[me,nr],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:H=>Number.isNaN(H)?H:parseFloat(H.toString()).toFixed(2)}),D&&a.jsx(Ne,{size:"small",variant:"warning",children:a.jsx(y,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},m.id)}})};ue.transformValues=e=>e.map(r=>Se.some(n=>n===r.periodeType)?{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,flerbarnsdager:r.flerbarnsdager??!1,harSamtidigUttak:r.harSamtidigUttak??!1,samtidigUttaksprosent:r.samtidigUttaksprosent}:{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,morsAktivitet:r.morsAktivitet,flerbarnsdager:r.flerbarnsdager??!1,harSamtidigUttak:r.harSamtidigUttak??!1,samtidigUttaksprosent:r.samtidigUttaksprosent});const tr=e=>e.filter(({kode:r})=>ve.some(n=>n===r)).map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r)),sr=e=>e.map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r)),ee=(e,r)=>e?r:"",ir=e=>!!e&&se(e,he).isBefore(se("2019-01-01")),qe=e=>()=>{const n=(e(ye)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return Q(n)},Re=(e,r,n)=>()=>{const t=e(`${O(r)}.periodeFom`),s=e(`${O(r)}.periodeTom`);return!s||!t?null:n?z(s)(t):W(t)(s)};ue.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const lr=rr(9),ie=`${d}.${_}`,Fe={periodeFom:"",periodeTom:"",periodeForGradering:"",prosentandelArbeid:"",skalGraderes:!1},ur=[K.ARBEIDSTAKER,K.SELVSTENDIG_NAERINGSDRIVENDE,K.FRILANSER],Oe=Me(100),_e=({graderingKvoter:e,readOnly:r,arbeidskategoriTyper:n})=>{const t=N(),{watch:s,control:i,getValues:l,trigger:k,formState:{isSubmitted:v}}=F(),{fields:T,remove:A,append:u}=$({control:i,name:`${ie}`}),g=s(`${ie}`)??[];return G.useEffect(()=>{T.length===0&&u(Fe)},[]),a.jsx(J,{fields:T,emptyPeriodTemplate:Fe,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,remove:A,append:u,children:(o,m)=>{const{harSamtidigUttak:q,periodeFom:f}=g[m],S=f&&se(f,he).isBefore(se("2019-01-01"));return a.jsxs(Z,{readOnly:r,remove:A,index:m,children:[a.jsx(c,{name:`${R(m)}.periodeForGradering`,control:i,selectValues:kr(e),label:t.formatMessage({id:"Registrering.Permisjon.Gradering.Periode"}),validate:[p]}),a.jsx(E,{name:`${R(m)}.periodeFom`,control:i,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,P,Ee(l,m,!0),je(l)],onChange:()=>v?k():void 0}),a.jsx(E,{name:`${R(m)}.periodeTom`,control:i,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,P,Ee(l,m,!1),je(l)],onChange:()=>v?k():void 0}),a.jsx(te,{name:`${R(m)}.prosentandelArbeid`,control:i,label:a.jsx(y,{id:"Registrering.Permisjon.Gradering.Prosentandel"}),validate:[p,me,Oe],normalizeOnBlur:D=>Number.isNaN(D)?D:parseFloat(D.toString()).toFixed(2)}),a.jsx(te,{name:`${R(m)}.arbeidsgiverIdentifikator`,control:i,label:t.formatMessage({id:"Registrering.Permisjon.Orgnr"}),validate:[or(l,m),Ze,dr]}),a.jsx(c,{name:`${R(m)}.arbeidskategoriType`,control:i,label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),selectValues:gr(n),validate:[p],onChange:()=>v?k():void 0}),a.jsx(j,{name:`${R(m)}.skalGraderes`,control:i,label:a.jsx(y,{id:"Registrering.Permisjon.Gradering.SkalGraderes"})}),a.jsx(j,{name:`${R(m)}.flerbarnsdager`,control:i,readOnly:r,label:a.jsx(y,{id:"Registrering.Permisjon.Flerbarnsdager"})}),a.jsx(j,{name:`${R(m)}.harSamtidigUttak`,control:i,label:a.jsx(y,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),q&&a.jsx(te,{name:`${R(m)}.samtidigUttaksprosent`,control:i,validate:[p,me,Oe],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"})}),S&&a.jsx(Ne,{size:"small",variant:"warning",children:a.jsx(y,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},o.id)}})},R=e=>`${ie}.${e}`,je=e=>()=>{const n=(e(`${ie}`)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return n.length>0?Q(n):void 0},Ee=(e,r,n)=>()=>{const t=e(`${R(r)}.periodeFom`),s=e(`${R(r)}.periodeTom`);return!s||!t?null:n?z(s)(t):W(t)(s)},or=(e,r)=>n=>e(`${R(r)}.arbeidskategoriType`)===K.ARBEIDSTAKER?p(n):void 0,dr=e=>{if(e)return e.length===11?er(e):lr(e)},kr=e=>e.filter(({kode:r})=>ve.some(n=>n===r)).map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r)),gr=e=>e.filter(({kode:r})=>ur.some(n=>n===r)).map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r));_e.__docgenInfo={description:`RenderGraderingPeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Te=`${d}.${pe}`,w=e=>`${Te}.${e}`,Pe=e=>()=>{const n=(e(`${Te}`)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return n.length>0?Q(n):void 0},be={periodeFom:"",periodeTom:"",årsak:""},mr=[L.UTTAK_MØDREKVOTE_ANNEN_FORELDER,L.UTTAK_FEDREKVOTE_ANNEN_FORELDER,L.UTTAK_FELLESP_ANNEN_FORELDER,L.UTTAK_FORELDREPENGER_ANNEN_FORELDER],pr=e=>e.filter(({kode:r})=>mr.some(n=>n===r)).map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r)),Ge=({oppholdsReasons:e,readOnly:r})=>{const n=N(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:l}}=F(),{fields:k,remove:v,append:T}=$({control:t,name:`${Te}`});return G.useEffect(()=>{k.length===0&&T(be)},[]),a.jsx(J,{fields:k,emptyPeriodTemplate:be,bodyText:n.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:T,remove:v,children:(A,u)=>a.jsxs(Z,{readOnly:r,remove:v,index:u,children:[a.jsx(E,{name:`${w(u)}.periodeFom`,control:t,label:n.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,P,()=>{const g=s(`${w(u)}.periodeFom`),o=s(`${w(u)}.periodeTom`);return o&&g?z(o)(g):null},Pe(s)],onChange:()=>l?i():void 0}),a.jsx(E,{name:`${w(u)}.periodeTom`,control:t,label:n.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,P,()=>{const g=s(`${w(u)}.periodeFom`),o=s(`${w(u)}.periodeTom`);return o&&g?W(g)(o):null},Pe(s)],onChange:()=>l?i():void 0}),a.jsx("div",{children:a.jsx(c,{name:`${w(u)}.årsak`,control:t,label:n.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:pr(e),validate:[p]})})]},A.id)})};Ge.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Ae=`${d}.${Ue}`,V=e=>`${Ae}.${e}`,ce=e=>()=>{const n=(e(Ae)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return n.length>0?Q(n):void 0},Ke={periodeFom:"",periodeTom:"",overforingArsak:""},Be=({selectValues:e,readOnly:r})=>{const n=N(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:l}}=F(),{fields:k,remove:v,append:T}=$({control:t,name:Ae});return G.useEffect(()=>{k.length===0&&T(Ke)},[]),a.jsx(J,{fields:k,emptyPeriodTemplate:Ke,bodyText:n.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:T,remove:v,children:(A,u)=>a.jsxs(Z,{readOnly:r,remove:v,index:u,children:[a.jsx("div",{children:a.jsx(c,{name:`${V(u)}.overforingArsak`,control:t,label:n.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[p],readOnly:r})}),a.jsx(E,{name:`${V(u)}.periodeFom`,control:t,isReadOnly:r,validate:[p,P,()=>{const g=s(`${V(u)}.periodeFom`),o=s(`${V(u)}.periodeTom`);return o&&g?z(o)(g):null},ce(s)],label:a.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>l?i():void 0}),a.jsx(E,{name:`${V(u)}.periodeTom`,control:t,isReadOnly:r,validate:[p,P,()=>{const g=s(`${V(u)}.periodeFom`),o=s(`${V(u)}.periodeTom`);return o&&g?W(g)(o):null},ce(s)],label:a.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>l?i():void 0})]},A.id)})};Be.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray

Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const yr=(e,r,n)=>r===x.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):r===x.SYKDOM_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):n,vr=(e,r,n,t)=>e.filter(({kode:s})=>n||s!==x.ALENEOMSORG&&s!==x.IKKE_RETT_ANNEN_FORELDER).map(({kode:s,navn:i})=>r?a.jsx("option",{value:s,children:i},s):a.jsx("option",{value:s,children:yr(t,s,i)},s)),ke=({foreldreType:e,alleKodeverk:r,readOnly:n,erEndringssøknad:t})=>{const s=N(),i=r.OverføringÅrsak,l=vr(i,e===X.MOR,t,s),{watch:k,control:v}=F(),T=k(`${d}.skalOvertaKvote`)||!1;return a.jsxs(U,{gap:"space-8",children:[a.jsx(C,{children:a.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),a.jsx(j,{name:`${d}.skalOvertaKvote`,control:v,readOnly:n,label:a.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),T&&a.jsx(Be,{selectValues:l,readOnly:n})]})};ke.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});ke.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const fe={periodeFom:"",periodeTom:"",arsakForUtsettelse:""},Ie=`${d}.${le}`,h=e=>`${Ie}.${e}`,we=e=>()=>{const n=(e(`${Ie}`)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return n.length>0?Q(n):void 0},Ve=(e,r,n)=>()=>{const t=`${h(r)}`,s=e(`${t}.periodeFom`),i=e(`${t}.periodeTom`);return!i&&!s?null:n?z(i)(s):W(s)(i)},Tr=e=>e.map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r)),Ar=e=>e.filter(({kode:r})=>ve.some(n=>n===r)).map(({kode:r,navn:n})=>a.jsx("option",{value:r,children:n},r)),De=({utsettelseReasons:e,utsettelseKvoter:r,readOnly:n})=>{const t=N(),{control:s,getValues:i,trigger:l,formState:{isSubmitted:k}}=F(),{fields:v,remove:T,append:A}=$({control:s,name:`${d}.${le}`});G.useEffect(()=>{v.length===0&&A(fe)},[]);const u=()=>k?l():void 0;return a.jsx(J,{fields:v,emptyPeriodTemplate:fe,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:n,append:A,remove:T,children:(g,o)=>a.jsxs(Z,{readOnly:n,remove:T,index:o,children:[a.jsx(c,{name:`${h(o)}.periodeForUtsettelse`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Periode"}),selectValues:Ar(r),validate:[p]}),a.jsx(E,{name:`${h(o)}.periodeFom`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,P,Ve(i,o,!0),we(i)],onChange:u}),a.jsx(E,{name:`${h(o)}.periodeTom`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,P,Ve(i,o,!1),we(i)],onChange:u}),a.jsx(c,{name:`${h(o)}.arsakForUtsettelse`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Arsak"}),selectValues:Tr(e),validate:[p],onChange:u}),a.jsx(c,{name:`${h(o)}.erArbeidstaker`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),selectValues:[a.jsx("option",{value:"true",children:t.formatMessage({id:"Registrering.Permisjon.ErArbeidstaker"})},"true"),a.jsx("option",{value:"false",children:t.formatMessage({id:"Registrering.Permisjon.ErIkkeArbeidstaker"})},"false")],validate:[m=>i(`${h(o)}.arsakForUtsettelse`)==="ARBEID"?p(m):void 0]})]},g.id)})};De.__docgenInfo={description:`RenderUtsettelsePeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const qr=Je(Ce),M=({foreldreType:e,readOnly:r,alleKodeverk:n,erEndringssøknad:t})=>a.jsx(Le,{value:qr,children:a.jsx(I,{readOnly:r,foreldreType:e,alleKodeverk:n,erEndringssøknad:t})});M.transformValues=I.transformValues;M.initialValues=I.initialValues;M.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
