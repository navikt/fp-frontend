import{u as g,j as e,a as w,t as O,O as P,R as G,d,x as V,J as o,h as Y,P as h,e as c}from"./iframe-C-F1-KFd.js";import{u as B,a as f,P as C,H as j,w as b,y as M,c as Z,V as I,b as W,U as k,m as X,d as x,e as $,B as Q}from"./nb_NO-DCcstzbV.js";import{a as z}from"./alleKodeverk-C9CgZbBn.js";import{T as D}from"./TrueFalseInput-DtUXdypK.js";import{M as K}from"./message-Da0NzITC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C2Kif7jS.js";const ee={land:void 0,periodeFom:void 0,periodeTom:void 0},p=(l,a)=>()=>{const t=l(a).filter(E=>typeof E.periodeFom=="string"&&E.periodeFom!==""&&typeof E.periodeTom=="string"&&E.periodeTom!=="").map(({periodeFom:E,periodeTom:r})=>[E,r]);return t.length>0?Y(t):void 0},ae=l=>l.filter(({kode:a})=>a!=="NOR").map(({kode:a,navn:n})=>e.jsx("option",{value:a,children:n},a)),U=(l,a,n)=>()=>!n||!a?null:l?G(n)(a):o(a)(n),F=({erTidligereOpphold:l=!1,mottattDato:a,readOnly:n,countryCodes:t})=>{const E=g(),r=l?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:m,getValues:i,trigger:T,formState:{isSubmitted:_}}=B(),{fields:s,remove:L,append:y}=f({control:m,name:r}),H=ae(t);return e.jsx(C,{fields:s,titleText:E.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:E.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ee,readOnly:n,remove:L,append:y,children:(J,u,q)=>e.jsx(w.Fragment,{children:e.jsxs(j,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(b,{name:`${r}.${u}.land`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:u>0,selectValues:H,readOnly:n,validate:[O]}),e.jsx(M,{name:`${r}.${u}.periodeFom`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:u>0,isReadOnly:n,validate:[O,P,U(!0,i(`${r}.${u}.periodeFom`),i(`${r}.${u}.periodeTom`)),()=>{const R=i(`${r}.${u}.periodeFom`);return l?G(d().format(V))(R):a?o(a)(R):void 0},p(i,r)],onChange:()=>_?T():void 0}),e.jsx(M,{name:`${r}.${u}.periodeTom`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:u>0,isReadOnly:n,validate:[O,P,U(!1,i(`${r}.${u}.periodeFom`),i(`${r}.${u}.periodeTom`)),()=>{const R=i(`${r}.${u}.periodeTom`);return l?G(d().format(V))(R):a?o(a)(R):void 0},p(i,r)],onChange:()=>_?T():void 0}),e.jsx("div",{children:q})]})},J.id)})};F.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const v=({readOnly:l=!0,alleKodeverk:a,mottattDato:n,erAdopsjon:t})=>{const{formatMessage:E}=g(),r=a.Landkoder.slice().sort((s,L)=>s.navn.localeCompare(L.navn)),{watch:m,control:i}=B(),T=!m("oppholdSisteTolvINorge",!0),_=!m("oppholdNesteTolvINorge",!0);return e.jsx(Z,{children:e.jsxs(I,{gap:"space-16",children:[e.jsx(W,{size:"small",level:"3",children:e.jsx(K,{id:"Registrering.Opphold"})}),e.jsx(D,{name:"oppholdINorge",control:i,label:E({id:t?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:l}),e.jsxs(I,{gap:"space-8",children:[e.jsx(D,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(K,{id:"Registrering.OppholdSisteTolv"}),readOnly:l}),T&&e.jsx(k,{alignOffset:58,children:e.jsx(F,{erTidligereOpphold:!0,mottattDato:n,countryCodes:r,readOnly:l})})]}),e.jsxs(I,{gap:"space-8",children:[e.jsx(D,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(K,{id:"Registrering.OppholdNesteTolv"}),readOnly:l}),_&&e.jsx(k,{alignOffset:58,children:e.jsx(F,{mottattDato:n,countryCodes:r,readOnly:l})})]})]})})};v.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});v.transformValues=({oppholdINorge:l,oppholdSisteTolvINorge:a,oppholdNesteTolvINorge:n,tidligereOppholdUtenlands:t,fremtidigeOppholdUtenlands:E})=>({oppholdINorge:l,harTidligereOppholdUtenlands:!a,harFremtidigeOppholdUtenlands:!n,tidligereOppholdUtenlands:a?void 0:t,fremtidigeOppholdUtenlands:n?void 0:E});v.__docgenInfo={description:`OppholdINorgePanel
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const le=c(X),N=({readOnly:l,erAdopsjon:a,alleKodeverk:n,mottattDato:t})=>e.jsx(h,{value:le,children:e.jsx(v,{readOnly:l,erAdopsjon:a,alleKodeverk:n,mottattDato:t})});N.initialValues=v.initialValues;N.transformValues=v.transformValues;N.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:ne}=__STORYBOOK_MODULE_ACTIONS__,ve={title:"ui-komponenter/opphold-i-norge",component:N,parameters:{submitCallback:ne("onSubmit")},args:{readOnly:!1,alleKodeverk:z,mottattDato:"2022-05-30"},render:(l,{parameters:{submitCallback:a}})=>{const n=x({defaultValues:N.initialValues()});return e.jsx($,{formMethods:n,onSubmit:t=>a(N.transformValues(t)),children:e.jsxs(I,{gap:"space-40",children:[e.jsx(N,{...l}),e.jsx(Q,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},A={args:{erAdopsjon:!1}},S={args:{erAdopsjon:!0}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
