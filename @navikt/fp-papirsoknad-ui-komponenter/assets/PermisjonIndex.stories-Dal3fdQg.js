import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{b as V,e as A,k as H,l as C,J as O,U as j,q,G as ie,j as $e,V as S,L as X,R as Ze,c as er,E as rr,P as nr,f as ar,m as tr,d as ir,K as sr,B as or}from"./nb_NO-OfRtrFwo.js";import{e as v,O as P,f as ke,i as xe,D as z,H as W,h as Q,g as dr,M as lr,X as mr,a as ur}from"./index.es-l01z5hqK.js";import"./aktivitetStatus-B1m96ipJ.js";import{F as Z}from"./foreldreType-BrQrvOqY.js";import"./withPanelData-B9CNyksI.js";import{r as U}from"./index-_2TAQcTa.js";import{K as N,a as gr}from"./alleKodeverk-Ga5AMxGN.js";import{d as se}from"./dayjs.min-DkLNzaWO.js";import{F as ee}from"./FieldArrayRow-2jvEBgle.js";import{M as y}from"./message-BF-PO83n.js";import{A as Ye}from"./Alert-OIczUyMU.js";import"./index-0bQSHhiP.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CQwh6Daz.js";import"./v4-CtRu48qb.js";import"./entry-preview-CTffOVML.js";import"./iframe-BpcumhwQ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BwSyabb1.js";import"./index-CXQShRbs.js";import"./Trash-C8LToiso.js";var _=(e=>(e.FISKER="FISKER",e.ARBEIDSTAKER="ARBEIDSTAKER",e.SELVSTENDIG_NAERINGSDRIVENDE="SELVSTENDIG_NÆRINGSDRIVENDE",e.KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NAERINGSDRIVENDE="KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NÆRINGSDRIVENDE",e.SJOMANN="SJØMANN",e.JORDBRUKER="JORDBRUKER",e.DAGPENGER="DAGPENGER",e.INAKTIV="INAKTIV",e.KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER="KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER",e.KOMBINASJON_ARBEIDSTAKER_OG_FISKER="KOMBINASJON_ARBEIDSTAKER_OG_FISKER",e.FRILANSER="FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER="KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER="KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER",e.DAGMAMMA="DAGMAMMA",e.ANNET="ANNET",e))(_||{}),Y=(e=>(e.INGEN="INGEN",e.UTTAK_MØDREKVOTE_ANNEN_FORELDER="UTTAK_MØDREKVOTE_ANNEN_FORELDER",e.UTTAK_FEDREKVOTE_ANNEN_FORELDER="UTTAK_FEDREKVOTE_ANNEN_FORELDER",e.UTTAK_FELLESP_ANNEN_FORELDER="UTTAK_FELLESP_ANNEN_FORELDER",e.UTTAK_FORELDREPENGER_ANNEN_FORELDER="UTTAK_FORELDREPENGER_ANNEN_FORELDER",e.UDEFINERT="-",e))(Y||{}),J=(e=>(e.INSTITUSJONSOPPHOLD_ANNEN_FORELDER="INSTITUSJONSOPPHOLD_ANNEN_FORELDER",e.SYKDOM_ANNEN_FORELDER="SYKDOM_ANNEN_FORELDER",e.ALENEOMSORG="ALENEOMSORG",e.IKKE_RETT_ANNEN_FORELDER="IKKE_RETT_ANNEN_FORELDER",e.UDEFINERT="-",e))(J||{}),F=(e=>(e.MODREKVOTE="MØDREKVOTE",e.FEDREKVOTE="FEDREKVOTE",e.FELLESPERIODE="FELLESPERIODE",e.FORELDREPENGER_FOR_FODSEL="FORELDREPENGER_FØR_FØDSEL",e.FORELDREPENGER="FORELDREPENGER",e.UDEFINERT="-",e))(F||{});const l="tidsromPermisjon",h="graderingPeriode",ve="oppholdPerioder",Be="overforingsperioder",de="utsettelsePeriode",B="permisjonsPerioder",ye=`${l}.${B}`,T=e=>`${ye}.${e}`,pr=xe(100),Re=[F.FELLESPERIODE,F.FEDREKVOTE,F.FORELDREPENGER_FOR_FODSEL,F.FORELDREPENGER,F.MODREKVOTE],kr=e=>e.filter(({kode:r})=>Re.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),vr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Je=[F.FEDREKVOTE,F.FORELDREPENGER_FOR_FODSEL,F.MODREKVOTE],re=(e,r)=>e?r:"",yr=e=>!!e&&se(e,$e).isBefore(se("2019-01-01")),fe=e=>()=>{const a=(e(ye)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return Q(a)},Ae=(e,r,a)=>()=>{const t=e(`${T(r)}.periodeFom`),i=e(`${T(r)}.periodeTom`);return!i||!t?null:a?z(i)(t):W(t)(i)},le=({sokerErMor:e,readOnly:r,alleKodeverk:a})=>{const t=V(),i=a[N.UTTAK_PERIODE_TYPE],s=a[N.MORS_AKTIVITET];s.filter(({kode:u})=>u==="-").length===0&&s.unshift({kode:"-",navn:"",kodeverk:""});const{control:g,getValues:m,trigger:p,watch:R,formState:{isSubmitted:E}}=A(),{fields:o,remove:k,append:d}=H({control:g,name:ye});return U.useEffect(()=>{o.length===0&&d({})},[]),n.jsx(C,{readOnly:r,fields:o,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyPeriodTemplate:{},append:d,remove:k,children:(u,c)=>{const b=c===0,w=R(T(c)),$=yr(w.periodeFom),Qe=Je.some(x=>x===w.periodeType)||w.periodeType==="";return n.jsxs(ee,{readOnly:r,remove:k,index:c,children:[n.jsx("div",{children:n.jsx(O,{readOnly:r,name:`${T(c)}.periodeType`,label:re(b,t.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:kr(i),validate:[v]})}),n.jsx(j,{isReadOnly:r,name:`${T(c)}.periodeFom`,label:re(b,t.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[v,P,Ae(m,c,!0),fe(m)],onChange:()=>E?p():void 0}),n.jsx(j,{isReadOnly:r,name:`${T(c)}.periodeTom`,label:re(b,t.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[v,P,Ae(m,c,!1),fe(m)],onChange:()=>E?p():void 0}),!e&&n.jsx(O,{readOnly:r,disabled:Qe,name:`${T(c)}.morsAktivitet`,label:re(b,t.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:vr(s),hideValueOnDisable:!0}),n.jsx(q,{readOnly:r,name:`${T(c)}.flerbarnsdager`,label:n.jsx(y,{id:"Registrering.Permisjon.Flerbarnsdager"})}),n.jsx(q,{readOnly:r,name:`${T(c)}.harSamtidigUttak`,label:n.jsx(y,{id:"Registrering.Permisjon.HarSamtidigUttak"})}),w.harSamtidigUttak&&n.jsx(ie,{name:`${T(c)}.samtidigUttaksprosent`,validate:[ke,pr],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:x=>Number.isNaN(x)?x:parseFloat(x.toString()).toFixed(2)}),$&&n.jsx(Ye,{size:"small",variant:"warning",children:n.jsx(y,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},u.id)}})};le.transformValues=e=>e.map(r=>Je.some(a=>a===r.periodeType)?{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,flerbarnsdager:r.flerbarnsdager?r.flerbarnsdager:!1,harSamtidigUttak:r.harSamtidigUttak?r.harSamtidigUttak:!1,samtidigUttaksprosent:r.samtidigUttaksprosent}:{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,morsAktivitet:r.morsAktivitet,flerbarnsdager:r.flerbarnsdager?r.flerbarnsdager:!1,harSamtidigUttak:r.harSamtidigUttak?r.harSamtidigUttak:!1,samtidigUttaksprosent:r.samtidigUttaksprosent});le.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"formValues",optional:!1,type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Ee=`${l}.${ve}`,I=e=>`${Ee}.${e}`,Pe=e=>()=>{const a=(e(`${Ee}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?Q(a):void 0},Fe={periodeFom:"",periodeTom:"",årsak:""},Tr=[Y.UTTAK_MØDREKVOTE_ANNEN_FORELDER,Y.UTTAK_FEDREKVOTE_ANNEN_FORELDER,Y.UTTAK_FELLESP_ANNEN_FORELDER,Y.UTTAK_FORELDREPENGER_ANNEN_FORELDER],qr=e=>e.filter(({kode:r})=>Tr.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Ce=({oppholdsReasons:e,readOnly:r})=>{const a=V(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=A(),{fields:m,remove:p,append:R}=H({control:t,name:`${Ee}`});return U.useEffect(()=>{m.length===0&&R(Fe)},[]),n.jsx(C,{fields:m,emptyPeriodTemplate:Fe,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:p,children:(E,o)=>n.jsxs(ee,{readOnly:r,remove:p,index:o,children:[n.jsx(j,{name:`${I(o)}.periodeFom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,P,()=>{const k=i(`${I(o)}.periodeFom`),d=i(`${I(o)}.periodeTom`);return d&&k?z(d)(k):null},Pe(i)],onChange:()=>g?s():void 0}),n.jsx(j,{name:`${I(o)}.periodeTom`,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,P,()=>{const k=i(`${I(o)}.periodeFom`),d=i(`${I(o)}.periodeTom`);return d&&k?W(k)(d):null},Pe(i)],onChange:()=>g?s():void 0}),n.jsx("div",{children:n.jsx(O,{name:`${I(o)}.årsak`,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:qr(e),validate:[v]})})]},E.id)})};Ce.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const ce=`${l}.${Be}`,K=e=>`${ce}.${e}`,Oe=e=>()=>{const a=(e(ce)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?Q(a):void 0},_e={periodeFom:"",periodeTom:"",overforingArsak:""},Xe=({selectValues:e,readOnly:r})=>{const a=V(),{control:t,getValues:i,trigger:s,formState:{isSubmitted:g}}=A(),{fields:m,remove:p,append:R}=H({control:t,name:ce});return U.useEffect(()=>{m.length===0&&R(_e)},[]),n.jsx(C,{fields:m,emptyPeriodTemplate:_e,bodyText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:R,remove:p,children:(E,o)=>n.jsxs(ee,{readOnly:r,remove:p,index:o,children:[n.jsx("div",{children:n.jsx(O,{name:`${K(o)}.overforingArsak`,label:a.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[v],readOnly:r})}),n.jsx(j,{isReadOnly:r,name:`${K(o)}.periodeFom`,validate:[v,P,()=>{const k=i(`${K(o)}.periodeFom`),d=i(`${K(o)}.periodeTom`);return d&&k?z(d)(k):null},Oe(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>g?s():void 0}),n.jsx(j,{isReadOnly:r,name:`${K(o)}.periodeTom`,validate:[v,P,()=>{const k=i(`${K(o)}.periodeFom`),d=i(`${K(o)}.periodeTom`);return d&&k?W(k)(d):null},Oe(i)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>g?s():void 0})]},E.id)})};Xe.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray

Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const jr=(e,r,a)=>r===J.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):r===J.SYKDOM_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):a,Pr=(e,r,a,t)=>e.filter(({kode:i})=>a||i!==J.ALENEOMSORG&&i!==J.IKKE_RETT_ANNEN_FORELDER).map(({kode:i,navn:s})=>r?n.jsx("option",{value:i,children:s},i):n.jsx("option",{value:i,children:jr(t,i,s)},i)),ge=({foreldreType:e,alleKodeverk:r,readOnly:a,erEndringssøknad:t})=>{const i=V(),s=r[N.OVERFOERING_AARSAK_TYPE],g=Pr(s,e===Z.MOR,t,i),{watch:m}=A(),p=m(`${l}.skalOvertaKvote`)||!1;return n.jsxs(S,{gap:"2",children:[n.jsx(X,{children:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),n.jsx(q,{readOnly:a,name:`${l}.skalOvertaKvote`,label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),p&&n.jsx(Xe,{selectValues:g,readOnly:a})]})};ge.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});ge.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ne={periodeFom:"",periodeTom:"",arsakForUtsettelse:""},ze=`${l}.${de}`,M=e=>`${ze}.${e}`,we=e=>()=>{const a=(e(`${ze}`)||[]).filter(({periodeFom:t,periodeTom:i})=>t!==""&&i!=="").map(({periodeFom:t,periodeTom:i})=>[t,i]);return a.length>0?Q(a):void 0},Ie=(e,r,a)=>()=>{const t=`${M(r)}`,i=e(`${t}.periodeFom`),s=e(`${t}.periodeTom`);return!s&&!i?null:a?z(s)(i):W(i)(s)},Fr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Or=e=>e.filter(({kode:r})=>Re.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),We=({utsettelseReasons:e,utsettelseKvoter:r,readOnly:a})=>{const t=V(),{control:i,getValues:s,trigger:g,formState:{isSubmitted:m}}=A(),{fields:p,remove:R,append:E}=H({control:i,name:`${l}.${de}`});U.useEffect(()=>{p.length===0&&E(Ne)},[]);const o=U.useCallback(()=>m?g():void 0,[m,g]);return n.jsx(C,{fields:p,emptyPeriodTemplate:Ne,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:a,append:E,remove:R,children:(k,d)=>n.jsxs(ee,{readOnly:a,remove:R,index:d,children:[n.jsx(O,{name:`${M(d)}.periodeForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Periode"}),selectValues:Or(r),validate:[v]}),n.jsx(j,{name:`${M(d)}.periodeFom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[v,P,Ie(s,d,!0),we(s)],onChange:o}),n.jsx(j,{name:`${M(d)}.periodeTom`,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[v,P,Ie(s,d,!1),we(s)],onChange:o}),n.jsx(O,{name:`${M(d)}.arsakForUtsettelse`,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Arsak"}),selectValues:Fr(e),validate:[v],onChange:o}),n.jsx(O,{label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),name:`${M(d)}.erArbeidstaker`,selectValues:[n.jsx("option",{value:"true",children:t.formatMessage({id:"Registrering.Permisjon.ErArbeidstaker"})},"true"),n.jsx("option",{value:"false",children:t.formatMessage({id:"Registrering.Permisjon.ErIkkeArbeidstaker"})},"false")],validate:[u=>s(`${M(d)}.arsakForUtsettelse`)==="ARBEID"?v(u):void 0]})]},k.id)})};We.__docgenInfo={description:`RenderUtsettelsePeriodeFieldArray
...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Qr={title:"ui-komponenter/permisjon",component:D,parameters:{submitCallback:ur("onSubmit")},args:{readOnly:!1,alleKodeverk:gr},render:(e,{parameters:{submitCallback:r}})=>{const a=ir({defaultValues:D.initialValues()});return n.jsx(sr,{formMethods:a,onSubmit:t=>r(D.transformValues(t)),children:n.jsxs(S,{gap:"10",children:[n.jsx(D,{...e}),n.jsx(or,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},ne={args:{foreldreType:Z.MOR,erEndringssøknad:!1}},ae={args:{foreldreType:Z.FAR,erEndringssøknad:!1}},te={args:{foreldreType:Z.MOR,erEndringssøknad:!0}};var Ke,Me,De;ne.parameters={...ne.parameters,docs:{...(Ke=ne.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
    foreldreType: ForeldreType.MOR,
    erEndringssøknad: false
  }
}`,...(De=(Me=ne.parameters)==null?void 0:Me.docs)==null?void 0:De.source}}};var Ue,Ve,Se;ae.parameters={...ae.parameters,docs:{...(Ue=ae.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
