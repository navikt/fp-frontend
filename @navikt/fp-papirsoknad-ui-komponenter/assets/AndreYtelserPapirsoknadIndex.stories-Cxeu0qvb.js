import{u as U,r as P,j as a,t as O,O as G,R as B,J as g,P as y,a as p}from"./iframe-BaKRzsr5.js";import{u as A,a as H,P as Y,H as J,T as s,d as w,V as S,b as q,j as c,C,c as j,m as b,e as h,f,B as Z}from"./nb_NO-Ba4QRLEq.js";import{a as W}from"./alleKodeverk-DO07GSZv.js";import{M as X}from"./message-D63OQ_J3.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Wt1DB4Yy.js";const T="andreYtelser",F="andreYtelserPerioder",I="andreYtelserTyper",V=({readOnly:l,name:n})=>{const e=U(),{getValues:r,control:E,trigger:t,formState:{isSubmitted:L}}=A(),{fields:D,remove:M,append:K}=H({control:E,name:n});return P.useEffect(()=>{D.length===0&&K({periodeFom:"",periodeTom:""})},[]),a.jsx(Y,{fields:D,addButtonText:e.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:l,append:K,remove:M,children:(o,u,d)=>{const k=`${n}.${u}`;return a.jsxs(J,{gap:"space-8",align:"end",children:[a.jsx(s,{name:`${k}.periodeFom`,control:E,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[O,G,()=>{const{periodeFom:m,periodeTom:R}=r(`${n}.${u}`);return R&&m?B(R)(m):null}],onChange:()=>L?t():void 0}),a.jsx(s,{name:`${n}.${u}.periodeTom`,control:E,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[O,G,()=>{const{periodeFom:m,periodeTom:R}=r(`${n}.${u}`);return m&&R?g(m)(R):null}],onChange:()=>L?t():void 0}),a.jsx("div",{children:d})]},o.id)}})};V.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const N=({readOnly:l,kunMiliterEllerSiviltjeneste:n=!1,alleKodeverk:e})=>{const{control:r}=A(),E=$(e.ArbeidType,n);return a.jsx(w,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(q,{size:"small",level:"3",children:a.jsx(X,{id:"Registrering.AndreYtelser.Title"})}),a.jsx(c,{name:`${T}.${I}`,control:r,isReadOnly:l,children:E.map(t=>a.jsx(x,{arbeidstype:t,readOnly:l},t.kode))})]})})};N.initialValues=()=>({[T]:{[I]:[],[F]:{}}});N.transformValues=({andreYtelser:{andreYtelserTyper:l,andreYtelserPerioder:n}})=>({[T]:l.flatMap(e=>n[e]?.map(r=>({ytelseType:e,...r}))).filter(e=>e!==void 0)});const x=({arbeidstype:l,readOnly:n})=>{const{watch:e}=A(),r=e(`${T}.${I}`),[E,t]=P.useState(r.includes(l.kode));return a.jsxs(S,{gap:"space-12",children:[a.jsx(C,{value:l.kode,onClick:()=>t(!E),disabled:n,children:l.navn}),E&&a.jsx(j,{children:a.jsx(V,{name:`${T}.${F}.${l.kode}`,readOnly:n})})]})},$=(l,n)=>n?l.filter(e=>e.kode==="MILITÆR_ELLER_SIVILTJENESTE"):l.filter(e=>e.kode!=="UTENLANDSK_ARBEIDSFORHOLD"&&e.kode!=="FRILANSER"&&e.kode!=="LØNN_UNDER_UTDANNING");N.__docgenInfo={description:`AndreYtelserPanel
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:z}=__STORYBOOK_MODULE_ACTIONS__,te={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:z("onSubmit")},args:{readOnly:!1,alleKodeverk:W},render:(l,{parameters:{submitCallback:n}})=>{const e=h({defaultValues:i.initialValues()});return a.jsx(f,{formMethods:e,onSubmit:r=>n(i.transformValues(r)),children:a.jsxs(S,{gap:"space-40",children:[a.jsx(i,{...l}),a.jsx(Z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},v={args:{kunMiliterEllerSiviltjeneste:!1}},_={args:{kunMiliterEllerSiviltjeneste:!0}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
