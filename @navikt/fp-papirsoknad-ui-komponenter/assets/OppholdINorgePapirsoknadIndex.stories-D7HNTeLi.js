import{u as B,j as e,c as Y,t as O,O as d,R as o,d as V,b as M,J as F,h,P as c,a as f}from"./iframe-Du-9xYjp.js";import{u as y,a as C,P as j,H as b,w as Z,T as k,d as W,V as I,b as X,c as p,m as x,e as Q,f as $,B as z}from"./nb_NO-DUHLuNeO.js";import{a as ee}from"./alleKodeverk-Cho4R_ly.js";import{T as K}from"./TrueFalseInput-Bv6OOPG2.js";import{M as G}from"./message-CyzzSaut.js";import"./preload-helper-PPVm8Dsz.js";import"./index-kC1veg76.js";const ae={land:void 0,periodeFom:void 0,periodeTom:void 0},s=(l,a)=>l(a),U=(l,a)=>()=>{const t=l(a).filter(({periodeFom:E,periodeTom:n})=>E&&E!==""&&n&&n!=="").map(({periodeFom:E,periodeTom:n})=>[E,n]);return t.length>0?h(t):void 0},le=l=>l.filter(({kode:a})=>a!=="NOR").map(({kode:a,navn:r})=>e.jsx("option",{value:a,children:r},a)),g=(l,a,r,t)=>()=>{const E=s(l,`${a}.${r}.periodeFom`),n=s(l,`${a}.${r}.periodeTom`);return!n||!E?null:t?o(n)(E):F(E)(n)},P=({erTidligereOpphold:l=!1,mottattDato:a,readOnly:r,countryCodes:t})=>{const E=B(),n=l?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:m,getValues:i,trigger:T,formState:{isSubmitted:_}}=y(),{fields:L,remove:D,append:H}=C({control:m,name:n}),J=le(t);return e.jsx(j,{fields:L,titleText:E.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:E.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ae,readOnly:r,remove:D,append:H,children:(q,u,w)=>e.jsx(Y.Fragment,{children:e.jsxs(b,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(Z,{name:`${n}.${u}.land`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:u>0,selectValues:J,readOnly:r,validate:[O]}),e.jsx(k,{name:`${n}.${u}.periodeFom`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:u>0,isReadOnly:r,validate:[O,d,g(i,n,u,!0),()=>{const R=s(i,`${n}.${u}.periodeFom`);return l?o(V().format(M))(R):a?F(a)(R):void 0},U(i,n)],onChange:()=>_?T():void 0}),e.jsx(k,{name:`${n}.${u}.periodeTom`,control:m,label:E.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:u>0,isReadOnly:r,validate:[O,d,g(i,n,u,!1),()=>{const R=s(i,`${n}.${u}.periodeTom`);return l?o(V().format(M))(R):a?F(a)(R):void 0},U(i,n)],onChange:()=>_?T():void 0}),e.jsx("div",{children:w})]})},q.id)})};P.__docgenInfo={description:`UtenlandsOppholdField
