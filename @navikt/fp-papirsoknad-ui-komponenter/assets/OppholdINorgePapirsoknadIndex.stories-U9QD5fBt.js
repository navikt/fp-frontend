import{j as r}from"./jsx-runtime-DR9Q75dM.js";import{H as u,g as q,D as V,U as A,f as J,a as Q}from"./index.es-DAgkteDm.js";import{d as C,e as E,f as X,I as Z,K as ee,y as p,n as re,W as ne,b as ae,L as b,P as x,A as w,S as se,H as te,M as y,k as j,O as T,t as oe,c as le,m as ie,a as de,$ as pe,V as me,B as ue}from"./nb_NO-ChUmxPha.js";import"./withRouter-DhSU4y_G.js";import{K as ge,a as ve}from"./alleKodeverk-D-QME5s7.js";import{g as ke,r as H,R as he}from"./index-DRjF_FHU.js";import{l as ye}from"./landkoder-T-1RG3zx.js";import{h as N}from"./moment-C5S46NFB.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-CnNqAF5I.js";import"./index-rX-Bn4lm.js";var z={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/(function(n){(function(){var s={}.hasOwnProperty;function t(){for(var e="",o=0;o<arguments.length;o++){var l=arguments[o];l&&(e=a(e,i.call(this,l)))}return e}function i(e){if(typeof e=="string"||typeof e=="number")return this&&this[e]||e;if(typeof e!="object")return"";if(Array.isArray(e))return t.apply(this,e);if(e.toString!==Object.prototype.toString&&!e.toString.toString().includes("[native code]"))return e.toString();var o="";for(var l in e)s.call(e,l)&&e[l]&&(o=a(o,this&&this[l]||l));return o}function a(e,o){return o?e?e+" "+o:e+o:e}n.exports?(t.default=t,n.exports=t):window.classNames=t})()})(z);var ce=z.exports;const fe=ke(ce),Oe="_datesRowWithRemoveButton_od5lu_1",Fe="_selectBredde_od5lu_7",W={datesRowWithRemoveButton:Oe,selectBredde:Fe},be=fe.bind(W),je={land:"",periodeFom:"",periodeTom:""},O=(n,s)=>n(s),I=(n,s)=>()=>{const i=n(s).filter(({periodeFom:a,periodeTom:e})=>a&&a!==""&&e&&e!=="").map(({periodeFom:a,periodeTom:e})=>[a,e]);return i.length>0?J(i):void 0},Ve=n=>n.filter(({kode:s})=>s!==ye.NORGE).map(({kode:s,navn:t})=>r.jsx("option",{value:s,children:t},s)),K=(n,s,t,i)=>()=>{const a=O(n,`${s}.${t}.periodeFom`),e=O(n,`${s}.${t}.periodeTom`);return!e||!a?null:i?V(e)(a):A(a)(e)},R=({erTidligereOpphold:n=!1,mottattDato:s,readOnly:t,countryCodes:i})=>{const a=C(),e=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:o,getValues:l,trigger:k,formState:{isSubmitted:h}}=E(),{fields:F,remove:L,append:D}=X({control:o,name:e}),Y=H.useMemo(()=>Ve(i),[i]);return r.jsx(Z,{fields:F,titleText:a.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:a.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:je,createAddButtonInsteadOfImageLink:!0,readOnly:t,remove:L,append:D,children:(G,d,U)=>r.jsxs(he.Fragment,{children:[d>0&&r.jsxs(r.Fragment,{children:[r.jsx(ee,{}),r.jsx(p,{sixteenPx:!0})]}),r.jsx(re,{name:`${e}.${d}.land`,label:a.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:Y,className:W.selectBredde,readOnly:t,validate:[u]}),r.jsx(p,{sixteenPx:!0}),r.jsx(ne,{children:r.jsxs(ae,{className:be({datesRowWithRemoveButton:d>0}),children:[r.jsx(b,{children:r.jsx(x,{name:`${e}.${d}.periodeFom`,label:a.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:t,validate:[u,q,K(l,e,d,!0),()=>{const v=O(l,`${e}.${d}.periodeFom`);return n?V(N().format(w))(v):s?A(s)(v):void 0},I(l,e)],onChange:()=>h?k():void 0})}),r.jsx(b,{children:r.jsx(x,{name:`${e}.${d}.periodeTom`,label:a.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:t,validate:[u,q,K(l,e,d,!1),()=>{const v=O(l,`${e}.${d}.periodeTom`);return n?V(N().format(w))(v):s?A(s)(v):void 0},I(l,e)],onChange:()=>h?k():void 0})}),U&&r.jsx(b,{children:U()})]})}),r.jsx(p,{sixteenPx:!0})]},G.id)})};R.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Ae=oe(ie),m=({readOnly:n,erAdopsjon:s,alleKodeverk:t,mottattDato:i})=>r.jsx(le,{value:Ae,children:r.jsx(g,{readOnly:n,erAdopsjon:s,alleKodeverk:t,mottattDato:i})});m.buildInitialValues=g.buildInitialValues;m.transformValues=g.transformValues;m.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  harTidligereOppholdUtenlands?: boolean;
  harFremtidigeOppholdUtenlands?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
}`,...(B=(_=f.parameters)==null?void 0:_.docs)==null?void 0:B.source}}};const $e=["ForFodsel","ForAdopsjon"];export{f as ForAdopsjon,c as ForFodsel,$e as __namedExportsOrder,Pe as default};
