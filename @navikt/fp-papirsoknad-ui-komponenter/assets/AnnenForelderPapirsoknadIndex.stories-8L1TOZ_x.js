import{u as P,j as e,t as v,k as U,M as B,y as g,P as p,e as y}from"./iframe-CZD3CeUR.js";import{u as V,T as G,V as N,f as H,U as J,b as o,S as Y,R as F,w as q,c as w,m as c,d as C,e as f,B as b}from"./nb_NO-BseRgCco.js";import{a as j}from"./alleKodeverk-BnsD7hyO.js";import{M as s}from"./message-CaE2zASC.js";import{T}from"./TrueFalseInput-C2yWu1di.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BlNekyvw.js";const E="annenForelder",_="kanIkkeOppgiBegrunnelse",h="_inputBredde_138ho_1",O={inputBredde:h},Z=a=>a.filter(({kode:n})=>n!=="NOR").map(({kode:n,navn:l})=>e.jsx("option",{value:n,children:l},n)),I=({readOnly:a=!0,alleKodeverk:n,fagsakPersonnummer:l})=>{const{formatMessage:r}=P(),{watch:i,control:t,trigger:R,formState:{isSubmitted:K}}=V(),D=i(`${E}.kanIkkeOppgiAnnenForelder`),M=i(`${E}.${_}`),k=n.Landkoder.slice().sort((m,d)=>m.navn.localeCompare(d.navn));return e.jsxs(e.Fragment,{children:[e.jsx(G,{name:`${E}.foedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:m=>m&&m.toString().replace(/\s/g,""),readOnly:a,className:O.inputBredde,validate:D?[]:[v,U,B,g(l)],disabled:D}),e.jsxs(N,{gap:"space-12",children:[e.jsx(H,{name:`${E}.kanIkkeOppgiAnnenForelder`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:a,onChange:()=>K?R():void 0}),D===!0&&e.jsx(J,{children:e.jsxs(N,{gap:"space-16",children:[e.jsx(o,{size:"small",level:"4",children:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsxs(Y,{name:`${E}.${_}.arsak`,control:t,hideLegend:!0,validate:[v],isReadOnly:a,children:[e.jsx(F,{value:"UKJENT_FORELDER",size:"small",children:e.jsx(s,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"})}),e.jsx(F,{value:"IKKE_NORSK_FNR",size:"small",children:e.jsx(s,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"})})]}),M?.arsak==="IKKE_NORSK_FNR"&&e.jsxs(e.Fragment,{children:[e.jsx(q,{name:`${E}.${_}.land`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:Z(k),validate:[v],className:O.inputBredde,readOnly:a}),e.jsx(G,{name:`${E}.${_}.utenlandskFoedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[v],className:O.inputBredde,readOnly:a})]})]})})]})]})};I.transformValues=({foedselsnummer:a,kanIkkeOppgiAnnenForelder:n,kanIkkeOppgiBegrunnelse:{arsak:l,land:r,utenlandskFoedselsnummer:i}={}})=>n?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:l==="IKKE_NORSK_FNR"?{arsak:l,land:r,utenlandskFoedselsnummer:i}:{arsak:l}}:{foedselsnummer:a,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};I.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
