import{u as R,j as r,P as K}from"./iframe-Bn-aqi4-.js";import{u as b,a as j,$ as V,A as w,P as y,O,l as h,V as p,b as M,D as c,r as f,m as P,d as N,N as S,B}from"./nb_NO-DFI16EvZ.js";import{a as E}from"./alleKodeverk-DO07GSZv.js";import{o as U,O as m}from"./index.es-ZAp-KALQ.js";import{L as I}from"./landkoder-Bgpqk6-g.js";import{F as H}from"./FieldArrayRow-CjQP43ue.js";import{M as v}from"./message-ium0Z45r.js";import"./index-CnhIzrCe.js";import"./Trash-DOMlWAbm.js";const l="arbeidsforhold",G=U(50),_=a=>a.filter(({kode:e})=>e!==I.NORGE).map(({kode:e,navn:n})=>r.jsx("option",{value:e,children:n},e)),T=({alleKodeverk:a,readOnly:e})=>{const n=R(),{control:s}=b(),{fields:A,remove:g,append:q}=j({control:s,name:l}),F=a.Landkoder.slice().sort((o,t)=>o.navn.localeCompare(t.navn));return r.jsx(V,{fields:A,bodyText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:g,append:q,children:(o,t)=>r.jsxs(H,{remove:g,index:t,readOnly:e,children:[r.jsx(w,{readOnly:e,control:s,name:`${l}.${t}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[G],maxLength:99}),r.jsx(y,{name:`${l}.${t}.periodeFom`,control:s,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[m]}),r.jsx(y,{name:`${l}.${t}.periodeTom`,control:s,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[m]}),r.jsx(O,{name:`${l}.${t}.land`,control:s,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:_(F),size:"small"})]},o.id)})};T.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const u=({readOnly:a,alleKodeverk:e})=>r.jsx(h,{children:r.jsxs(p,{gap:"space-16",children:[r.jsx(M,{size:"small",level:"3",children:r.jsx(v,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),r.jsx(c,{children:r.jsx(v,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),r.jsx(T,{readOnly:a,alleKodeverk:e})]})});u.initialValues=()=>({[l]:[]});const k=a=>a===void 0||a==="";u.transformValues=({arbeidsforhold:a})=>({arbeidsforhold:a?.filter(e=>!(k(e.arbeidsgiver)&&k(e.land)&&k(e.periodeFom)&&k(e.periodeTom)))});u.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const D=f(P),i=({readOnly:a,alleKodeverk:e})=>r.jsx(K,{value:D,children:r.jsx(u,{readOnly:a,alleKodeverk:e})});i.initialValues=u.initialValues;i.transformValues=u.transformValues;i.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
