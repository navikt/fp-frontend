import{u as I,j as e,r as G,P as Q,a as Z}from"./iframe-ClPPEwU7.js";import{u as v,W as F,V as b,Y as ee,H as re,P as U,A as h,L as ne,C as J,c as H,e as ae,B as w,j as te,i as se,k as ie,a as le,E as ue,n as ke,l as oe,b as de,M as ge,m as me,d as ye,N as ve}from"./nb_NO-DaoeTcZM.js";import{a as pe}from"./alleKodeverk-DO07GSZv.js";import{t as m,O as B,k as Te,T as Ae,g as x,m as qe,N as z}from"./index.es-DvTfRokj.js";import{T as S}from"./TrueFalseInput-ZL_joHqn.js";import{M as i}from"./message-CFCeB5Fe.js";import{T as g,S as be}from"./Table-DkP4UAJI.js";import{S as Re}from"./Trash-CLOGWdDu.js";import"./index-C_D4whvz.js";var y=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(y||{});const A="egenVirksomhet",l=`${A}.virksomheter`,Fe={},he=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),K=({index:r,readOnly:n,alleKodeverk:a})=>{const t=I(),s=a.Landkoder.slice().sort((d,k)=>d.navn.localeCompare(k.navn)),{getValues:o,control:u}=v();return e.jsx(S,{name:`${l}.${r}.virksomhetRegistrertINorge`,control:u,label:e.jsx(i,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(F,{marginTop:8,children:e.jsx(h,{name:`${l}.${r}.organisasjonsnummer`,control:u,readOnly:n,validate:[m,x,qe],label:e.jsx(i,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(F,{alignOffset:58,marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(ee,{name:`${l}.${r}.landJobberFra`,control:u,className:Fe.landBredde,selectValues:he(s),validate:[m],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(re,{gap:"4",children:[e.jsx(U,{name:`${l}.${r}.fom`,control:u,isReadOnly:n,validate:[m,B,Te],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(U,{name:`${l}.${r}.tom`,control:u,isReadOnly:n,validate:[B,d=>{const k=o(`${l}.${r}.fom`);return k?Ae(k,d):null}],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};K.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:s})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:s}:{landJobberFra:"NOR"}});K.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
