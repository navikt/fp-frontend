import{j as e}from"./jsx-runtime-CLpGMVip.js";import{j as Q,e as X,q as Z,t as ee,H as re,Q as ne,X as j,A as V,a as ae,V as f,b as oe,M as F,s as I,n as se,P as ie,m as te,c as le,r as de,B as pe}from"./nb_NO-Cv9pzysB.js";import{e as b,O as U,D as N,H as O,h as me,a as ue}from"./index.es-DGWo_lbb.js";import"./withPanelData-WjM-05fJ.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as ge,a as ke}from"./alleKodeverk-Ck9zwXaq.js";import{r as G,R as ye}from"./index-CYQpqK1Q.js";import{T}from"./TrueFalseInput-5Rnx-D1O.js";import{d as R}from"./dayjs.min-DPY8FYmS.js";import{L as ve}from"./landkoder-tJDPMx5C.js";import"./index-4Uuc9FQs.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CjktTq3Q.js";import"./v4-CtRu48qb.js";import"./react-D66Z11Sx.js";import"./iframe-BqckxrAP.js";import"./chunk-XP5HYGXS-DH4vAeCa.js";import"./fagsakYtelseType-DI8GXtVr.js";const fe={land:void 0,periodeFom:void 0,periodeTom:void 0},h=(n,r)=>n(r),K=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?me(i):void 0},he=n=>n.filter(({kode:r})=>r!==ve.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),M=(n,r,o,i)=>()=>{const s=h(n,`${r}.${o}.periodeFom`),a=h(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?N(a)(s):O(s)(a)},c=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=Q(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:k,getValues:t,trigger:y,formState:{isSubmitted:v}}=X(),{fields:q,remove:J,append:W}=Z({control:k,name:a}),Y=G.useMemo(()=>he(i),[i]);return e.jsx(ee,{fields:q,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:fe,readOnly:o,remove:J,append:W,children:(w,m,A)=>e.jsx(ye.Fragment,{children:e.jsxs(re,{gap:"4",paddingBlock:"2",children:[e.jsx(ne,{name:`${a}.${m}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:Y,readOnly:o,validate:[b]}),e.jsx(j,{name:`${a}.${m}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[b,U,M(t,a,m,!0),()=>{const g=h(t,`${a}.${m}.periodeFom`);return n?N(R().format(V))(g):r?O(r)(g):void 0},K(t,a)],onChange:()=>v?y():void 0}),e.jsx(j,{name:`${a}.${m}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[b,U,M(t,a,m,!1),()=>{const g=h(t,`${a}.${m}.periodeTom`);return n?N(R().format(V))(g):r?O(r)(g):void 0},K(t,a)],onChange:()=>v?y():void 0}),A&&e.jsx("div",{children:A()})]},w.id)},w.id)})};c.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ce=se(te),l=({readOnly:n,erAdopsjon:r,alleKodeverk:o,mottattDato:i})=>e.jsx(ie,{value:ce,children:e.jsx(u,{readOnly:n,erAdopsjon:r,alleKodeverk:o,mottattDato:i})});l.initialValues=u.initialValues;l.transformValues=u.transformValues;l.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};l.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const $e={title:"ui-komponenter/opphold-i-norge",component:l,parameters:{submitCallback:ue("onSubmit")},args:{readOnly:!1,alleKodeverk:ke,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=le({defaultValues:l.initialValues()});return e.jsx(de,{formMethods:o,onSubmit:i=>r(l.transformValues(i)),children:e.jsxs(f,{gap:"10",children:[e.jsx(l,{...n}),e.jsx(pe,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},d={args:{erAdopsjon:!1}},p={args:{erAdopsjon:!0}};var x,S,_;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(B=(z=p.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};const Pe=["ForFodsel","ForAdopsjon"];export{p as ForAdopsjon,d as ForFodsel,Pe as __namedExportsOrder,$e as default};
