import{u as O,j as a,o as G,O as T,P,a as s}from"./iframe-CIYu-6qK.js";import{u as F,a as V,P as M,k as U,T as _,w as B,d as o,V as S,b as d,D as k,m as g,e as y,f as p,B as H}from"./nb_NO-ke3ektvr.js";import{a as J}from"./alleKodeverk-DO07GSZv.js";import{F as Y}from"./FieldArrayRow-ItCJ7dvQ.js";import{M as A}from"./message-BFS4jEDK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-11JLzQg1.js";const i="arbeidsforhold",w=G(50),q=l=>l.filter(({kode:e})=>e!=="NOR").map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),I=({alleKodeverk:l,readOnly:e})=>{const n=O(),{control:E}=F(),{fields:L,remove:v,append:D}=V({control:E,name:i}),K=l.Landkoder.slice().sort((R,r)=>R.navn.localeCompare(r.navn));return a.jsx(M,{fields:L,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:v,append:D,children:(R,r)=>a.jsxs(Y,{remove:v,index:r,readOnly:e,children:[a.jsx(U,{readOnly:e,control:E,name:`${i}.${r}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[w],maxLength:99}),a.jsx(_,{name:`${i}.${r}.periodeFom`,control:E,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[T]}),a.jsx(_,{name:`${i}.${r}.periodeTom`,control:E,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[T]}),a.jsx(B,{name:`${i}.${r}.land`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:q(K),size:"small"})]},R.id)})};I.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
