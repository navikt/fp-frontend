import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{a as F,e as T,h as I,N as K,f as j,y as k,M as E,b as N,V as R,c as V,j as P,P as M,r as _,m as x,d as h,O as D,B as L}from"./nb_NO-CO8Lf0y6.js";import{b as S,p as v,a as B}from"./index.es-Y_pmkVsu.js";import"./withPanelData-DM7BI-dC.js";import"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as H,a as G}from"./alleKodeverk-BGvpDL3l.js";import{L as $}from"./landkoder-tJDPMx5C.js";import{F as Y}from"./FieldArrayRow-njFD2_AN.js";import{M as p}from"./message-CyGWbGQD.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-CsszHGEu.js";import"./iframe-bPWLNizW.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./Trash-J4Z5o5vt.js";const i="arbeidsforhold",O=S(50),z=n=>n.filter(({kode:e})=>e!==$.NORGE).map(({kode:e,navn:a})=>r.jsx("option",{value:e,children:a},e)),b=({alleKodeverk:n,readOnly:e})=>{const a=F(),{control:u}=T(),{fields:f,remove:m,append:q}=I({control:u,name:i}),w=n[H.LANDKODER].slice().sort((g,s)=>g.navn.localeCompare(s.navn));return r.jsx(K,{fields:f,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:m,append:q,children:(g,s)=>r.jsxs(Y,{remove:m,index:s,readOnly:e,children:[r.jsx(j,{readOnly:e,name:`${i}.${s}.arbeidsgiver`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[O],maxLength:99}),r.jsx(k,{isReadOnly:e,name:`${i}.${s}.periodeFom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[v]}),r.jsx(k,{isReadOnly:e,name:`${i}.${s}.periodeTom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[v]}),r.jsx(E,{readOnly:e,name:`${i}.${s}.land`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:z(w),size:"small"})]},g.id)})};b.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
