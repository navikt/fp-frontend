...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const fe={periodeFom:"",periodeTom:"",arsakForUtsettelse:""},Ie=`${d}.${le}`,M=e=>`${Ie}.${e}`,we=e=>()=>{const a=(e(`${Ie}`)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?C(a):void 0},Ve=(e,r,a)=>()=>{const t=`${M(r)}`,s=e(`${t}.periodeFom`),i=e(`${t}.periodeTom`);return!i&&!s?null:a?$(i)(s):J(s)(i)},Tr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Ar=e=>e.filter(({kode:r})=>ve.some(a=>a===r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),De=({utsettelseReasons:e,utsettelseKvoter:r,readOnly:a})=>{const t=N(),{control:s,getValues:i,trigger:l,formState:{isSubmitted:k}}=F(),{fields:v,remove:T,append:A}=X({control:s,name:`${d}.${le}`});G.useEffect(()=>{v.length===0&&A(fe)},[]);const u=()=>k?l():void 0;return n.jsx(z,{fields:v,emptyPeriodTemplate:fe,bodyText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:a,append:A,remove:T,children:(g,o)=>n.jsxs(Z,{readOnly:a,remove:T,index:o,children:[n.jsx(c,{name:`${M(o)}.periodeForUtsettelse`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Periode"}),selectValues:Ar(r),validate:[p]}),n.jsx(P,{name:`${M(o)}.periodeFom`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,j,Ve(i,o,!0),we(i)],onChange:u}),n.jsx(P,{name:`${M(o)}.periodeTom`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,j,Ve(i,o,!1),we(i)],onChange:u}),n.jsx(c,{name:`${M(o)}.arsakForUtsettelse`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.Utsettelse.Arsak"}),selectValues:Tr(e),validate:[p],onChange:u}),n.jsx(c,{name:`${M(o)}.erArbeidstaker`,control:s,label:t.formatMessage({id:"Registrering.Permisjon.ArbeidskategoriLabel"}),selectValues:[n.jsx("option",{value:"true",children:t.formatMessage({id:"Registrering.Permisjon.ErArbeidstaker"})},"true"),n.jsx("option",{value:"false",children:t.formatMessage({id:"Registrering.Permisjon.ErIkkeArbeidstaker"})},"false")],validate:[m=>i(`${M(o)}.arsakForUtsettelse`)==="ARBEID"?p(m):void 0]})]},g.id)})};De.__docgenInfo={description:`RenderUtsettelsePeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const qr=Je(We),h=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>n.jsx($e,{value:qr,children:n.jsx(I,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t})});h.transformValues=I.transformValues;h.initialValues=I.initialValues;h.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Rr}=__STORYBOOK_MODULE_ACTIONS__,Vr={title:"ui-komponenter/permisjon",component:h,parameters:{submitCallback:Rr("onSubmit")},args:{readOnly:!1,alleKodeverk:rr},render:(e,{parameters:{submitCallback:r}})=>{const a=Qe({defaultValues:h.initialValues()});return n.jsx(Ze,{formMethods:a,onSubmit:t=>r(h.transformValues(t)),children:n.jsxs(U,{gap:"space-40",children:[n.jsx(h,{...e}),n.jsx(er,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},re={args:{foreldreType:Q.MOR,erEndringssøknad:!1}},ne={args:{foreldreType:Q.FAR,erEndringssøknad:!1}},ae={args:{foreldreType:Q.MOR,erEndringssøknad:!0}};re.parameters={...re.parameters,docs:{...re.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...ae.parameters?.docs?.source}}};const Mr=["SokerErMor","SokerErFar","ErEndringssøknad"];export{ae as ErEndringssøknad,ne as SokerErFar,re as SokerErMor,Mr as __namedExportsOrder,Vr as default};
