import{j as e}from"./index-Byyjg8XX.js";import{a as E,e as Y,i as D,$ as _,H as z,Y as J,d as R,h as w,f as Q,V as T,b as W,G as K,P as X,r as Z,m as ee,c as re,N as ae,B as ne}from"./nb_NO-DYUjll3t.js";import{e as h,p as U,D as c,H as O,O as se,a as te}from"./index.es-fv94KH-L.js";import"./withPanelData-BfBqLFCK.js";import{r as ie,R as le}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as oe}from"./alleKodeverk-DO07GSZv.js";import{T as F}from"./TrueFalseInput-Daw7nzYV.js";import{d as M}from"./dayjs.min-DkLNzaWO.js";import{L as de}from"./landkoder-Bgpqk6-g.js";import{M as f}from"./message-BrM6o7bT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-DQIMTNBk.js";import"./iframe-CnTIffbJ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";const ue={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(a,r)=>a(r),N=(a,r)=>()=>{const i=a(r).filter(({periodeFom:t,periodeTom:n})=>t&&t!==""&&n&&n!=="").map(({periodeFom:t,periodeTom:n})=>[t,n]);return i.length>0?se(i):void 0},pe=a=>a.filter(({kode:r})=>r!==de.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(a,r,s,i)=>()=>{const t=q(a,`${r}.${s}.periodeFom`),n=q(a,`${r}.${s}.periodeTom`);return!n||!t?null:i?c(n)(t):O(t)(n)},j=({erTidligereOpphold:a=!1,mottattDato:r,readOnly:s,countryCodes:i})=>{const t=E(),n=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:k,getValues:l,trigger:g,formState:{isSubmitted:m}}=Y(),{fields:A,remove:L,append:$}=D({control:k,name:n}),C=ie.useMemo(()=>pe(i),[i]);return e.jsx(_,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:ue,readOnly:s,remove:L,append:$,children:(b,o,V)=>e.jsx(le.Fragment,{children:e.jsxs(z,{gap:"4",paddingBlock:"2",children:[e.jsx(J,{name:`${n}.${o}.land`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:C,readOnly:s,validate:[h]}),e.jsx(R,{name:`${n}.${o}.periodeFom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[h,U,P(l,n,o,!0),()=>{const p=q(l,`${n}.${o}.periodeFom`);return a?c(M().format(w))(p):r?O(r)(p):void 0},N(l,n)],onChange:()=>m?g():void 0}),e.jsx(R,{name:`${n}.${o}.periodeTom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[h,U,P(l,n,o,!1),()=>{const p=q(l,`${n}.${o}.periodeTom`);return a?c(M().format(w))(p):r?O(r)(p):void 0},N(l,n)],onChange:()=>m?g():void 0}),V&&e.jsx("div",{children:V()})]},b.id)},b.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const u=({readOnly:a=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:i})=>{const{formatMessage:t}=E(),n=r.Landkoder.slice().sort((m,A)=>m.navn.localeCompare(A.navn)),{watch:k}=Y(),l=!k("oppholdSisteTolvINorge",!0),g=!k("oppholdNesteTolvINorge",!0);return e.jsx(Q,{children:e.jsxs(T,{gap:"4",children:[e.jsx(W,{size:"small",children:e.jsx(f,{id:"Registrering.Opphold"})}),e.jsx(F,{name:"oppholdINorge",label:t({id:i?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:a}),e.jsxs(T,{gap:"2",children:[e.jsx(F,{name:"oppholdSisteTolvINorge",label:e.jsx(f,{id:"Registrering.OppholdSisteTolv"}),readOnly:a}),l&&e.jsx(K,{alignOffset:58,children:e.jsx(j,{erTidligereOpphold:!0,mottattDato:s,countryCodes:n,readOnly:a})})]}),e.jsxs(T,{gap:"2",children:[e.jsx(F,{name:"oppholdNesteTolvINorge",label:e.jsx(f,{id:"Registrering.OppholdNesteTolv"}),readOnly:a}),g&&e.jsx(K,{alignOffset:58,children:e.jsx(j,{mottattDato:s,countryCodes:n,readOnly:a})})]})]})})};u.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});u.transformValues=({oppholdINorge:a,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:i,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:a,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:i,fremtidigeOppholdUtenlands:s?void 0:t});u.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ke=Z(ee),d=({readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:i})=>e.jsx(X,{value:ke,children:e.jsx(u,{readOnly:a,erAdopsjon:r,alleKodeverk:s,mottattDato:i})});d.initialValues=u.initialValues;d.transformValues=u.transformValues;d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Me={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:te("onSubmit")},args:{readOnly:!1,alleKodeverk:oe,mottattDato:"2022-05-30"},render:(a,{parameters:{submitCallback:r}})=>{const s=re({defaultValues:d.initialValues()});return e.jsx(ae,{formMethods:s,onSubmit:i=>r(d.transformValues(i)),children:e.jsxs(T,{gap:"10",children:[e.jsx(d,{...a}),e.jsx(ne,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{erAdopsjon:!1}},v={args:{erAdopsjon:!0}};var S,I,B;y.parameters={...y.parameters,docs:{...(S=y.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(G=(H=v.parameters)==null?void 0:H.docs)==null?void 0:G.source}}};const Ne=["ForFodsel","ForAdopsjon"];export{v as ForAdopsjon,y as ForFodsel,Ne as __namedExportsOrder,Me as default};
