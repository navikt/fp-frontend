import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{a as N,d as I,X as j,U as T,j as _,V as v,b as S,J as x,Z as H,P as U,f as B,O as $,m as L,c as C,e as D,B as X}from"./nb_NO-F2oxspNt.js";import{e as m,F as J,M as z,y as G,a as Z}from"./index.es-DFaLKfmV.js";import"./withPanelData-CFwWFtpM.js";import{r as Q}from"./index-_2TAQcTa.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as W,a as Y}from"./alleKodeverk-Dm9joGL5.js";import{L as ee}from"./landkoder-tJDPMx5C.js";import{T as g}from"./TrueFalseInput-BcLtU-k_.js";import{M as re}from"./message-BYsGUOk8.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BsrZSYsV.js";import"./index-CQwh6Daz.js";import"./v4-CtRu48qb.js";import"./entry-preview-C03bE3rC.js";import"./iframe-C5Mzxw4X.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BwSyabb1.js";import"./index-CXQShRbs.js";var u=(e=>(e.UKJENT_FORELDER="UKJENT_FORELDER",e.IKKE_NORSK_FNR="IKKE_NORSK_FNR",e))(u||{});const t="annenForelder",k="kanIkkeOppgiBegrunnelse",ne="_inputBredde_138ho_1",A={inputBredde:ne},ae=e=>e.filter(({kode:s})=>s!==ee.NORGE).map(({kode:s,navn:n})=>r.jsx("option",{value:s,children:n},s)),f=({readOnly:e=!0,alleKodeverk:s,fagsakPersonnummer:n})=>{const{formatMessage:a}=N(),{watch:o,trigger:i,formState:{isSubmitted:F}}=I(),R=o(`${t}.kanIkkeOppgiAnnenForelder`),b=o(`${t}.${k}`),q=s[W.LANDKODER],K=Q.useMemo(()=>q.slice().sort((d,V)=>d.navn.localeCompare(V.navn)),[q]);return r.jsxs(r.Fragment,{children:[r.jsx(j,{name:`${t}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:d=>d&&d.toString().replace(/\s/g,""),readOnly:e,className:A.inputBredde,validate:R?[]:[m,J,z,G(n)],disabled:R}),r.jsx(T,{name:`${t}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:e,onChange:()=>F?i():void 0}),R===!0&&r.jsx(_,{children:r.jsxs(v,{gap:"4",children:[r.jsx(S,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),r.jsx(x,{name:`${t}.${k}.arsak`,hideLegend:!0,validate:[m],isReadOnly:e,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:u.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:u.IKKE_NORSK_FNR}]}),(b==null?void 0:b.arsak)===u.IKKE_NORSK_FNR&&r.jsxs(r.Fragment,{children:[r.jsx(H,{name:`${t}.${k}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:ae(K),validate:[m],className:A.inputBredde,readOnly:e}),r.jsx(j,{name:`${t}.${k}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[m],className:A.inputBredde,readOnly:e})]})]})})]})};f.transformValues=({foedselsnummer:e,kanIkkeOppgiAnnenForelder:s,kanIkkeOppgiBegrunnelse:{arsak:n,land:a,utenlandskFoedselsnummer:o}={}})=>s?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===u.IKKE_NORSK_FNR?{arsak:n,land:a,utenlandskFoedselsnummer:o}:{arsak:n}}:{foedselsnummer:e,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};f.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const Oe={title:"ui-komponenter/annen-forelder",component:l,args:{readOnly:!1,alleKodeverk:Y,fagsakPersonnummer:"07078518434"},parameters:{submitCallback:Z("onSubmit")},render:(e,{parameters:{submitCallback:s}})=>{const n=C({defaultValues:l.initialValues()});return r.jsx(D,{formMethods:n,onSubmit:a=>s(l.transformValues(a)),children:r.jsxs(v,{gap:"10",children:[r.jsx(l,{...e}),r.jsx(X,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{sokerErMor:!0}},y={args:{sokerErMor:!1}};var O,E,P;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    sokerErMor: true
  }
}`,...(P=(E=p.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};var h,w,M;y.parameters={...y.parameters,docs:{...(h=y.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    sokerErMor: false
  }
}`,...(M=(w=y.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};const Ee=["SokerErMor","SokerErFar"];export{y as SokerErFar,p as SokerErMor,Ee as __namedExportsOrder,Oe as default};
