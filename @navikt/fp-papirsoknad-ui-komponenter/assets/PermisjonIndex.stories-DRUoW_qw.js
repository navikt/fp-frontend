...
VirtuellFeilType`,elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Jr={title:"ui-komponenter/permisjon",component:D,parameters:{submitCallback:ur("onSubmit")},args:{readOnly:!1,alleKodeverk:gr},render:(e,{parameters:{submitCallback:r}})=>{const a=ir({defaultValues:D.initialValues()});return n.jsx(sr,{formMethods:a,onSubmit:t=>r(D.transformValues(t)),children:n.jsxs(S,{gap:"10",children:[n.jsx(D,{...e}),n.jsx(or,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},ne={args:{foreldreType:Z.MOR,erEndringssøknad:!1}},ae={args:{foreldreType:Z.FAR,erEndringssøknad:!1}},te={args:{foreldreType:Z.MOR,erEndringssøknad:!0}};var Me,Ke,De;ne.parameters={...ne.parameters,docs:{...(Me=ne.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  args: {
