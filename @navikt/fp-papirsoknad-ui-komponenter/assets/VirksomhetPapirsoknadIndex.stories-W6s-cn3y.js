import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as _,e as S,G as c,V as R,Y as Q,H as W,d as E,A as V,L as Z,C as B,D as ee,B as F,v as re,t as ne,w as ae,i as te,E as se,z as ie,f as le,b as oe,M as ge,P as me,r as ue,m as de,c as ke,N as ve}from"./nb_NO-Dc3pD_Wg.js";import{e as o,p as w,S as ye,R as pe,c as $,d as fe,y as D,a as be}from"./index.es-BK_-Kq7x.js";import"./withPanelData-DI7nI3HB.js";import{r as U}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as z,a as ce}from"./alleKodeverk-BGvpDL3l.js";import{T as N}from"./TrueFalseInput-CtveBiy6.js";import{M as s}from"./message-aT4EnmVo.js";import{T as g,S as Re}from"./Table-CRux4-b8.js";import{S as qe}from"./Trash-BpBk59Bj.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-C-x3yzBo.js";import"./iframe-L__j9gF5.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var d=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(d||{});const f="egenVirksomhet",i=`${f}.virksomheter`,Ve={},Ae=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),T=({index:r,readOnly:n,alleKodeverk:a})=>{const t=_(),l=a[z.LANDKODER].slice().sort((m,u)=>m.navn.localeCompare(u.navn)),{getValues:k}=S();return e.jsx(N,{name:`${i}.${r}.virksomhetRegistrertINorge`,label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(c,{marginTop:8,children:e.jsx(V,{name:`${i}.${r}.organisasjonsnummer`,readOnly:n,validate:[o,$,fe],label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(c,{alignOffset:58,marginTop:8,children:e.jsxs(R,{gap:"4",children:[e.jsx(Q,{name:`${i}.${r}.landJobberFra`,className:Ve.landBredde,selectValues:Ae(l),validate:[o],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(W,{gap:"4",children:[e.jsx(E,{isReadOnly:n,validate:[o,w,ye],name:`${i}.${r}.fom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(E,{isReadOnly:n,validate:[w,m=>{const u=k(`${i}.${r}.fom`);return u?pe(u,m):null}],name:`${i}.${r}.tom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};T.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:l})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:l}:{landJobberFra:"NOR"}});T.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const K=({index:r,readOnly:n})=>e.jsx(N,{name:`${i}.${r}.harRegnskapsforer`,label:e.jsx(s,{id:"Registrering.VirksomhetRegnskapPanel.Accountant"}),readOnly:n,trueContent:e.jsx(c,{marginTop:8,children:e.jsxs(R,{gap:"4",children:[e.jsx(V,{name:`${i}.${r}.navnRegnskapsforer`,readOnly:n,validate:[o,D],label:e.jsx(s,{id:"Registrering.VirksomhetRegnskapPanel.AccountantName"})}),e.jsx(V,{name:`${i}.${r}.tlfRegnskapsforer`,readOnly:n,validate:[o,$],label:e.jsx(s,{id:"Registrering.VirksomhetRegnskapPanel.AccountantPhone"})})]})})});K.transformValues=({harRegnskapsforer:r,navnRegnskapsforer:n,tlfRegnskapsforer:a})=>({harRegnskapsforer:r,...r?{navnRegnskapsforer:n}:{},...r?{tlfRegnskapsforer:a}:{}});K.__docgenInfo={description:`VirksomhetRegnskapPanel
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},remove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},open:{required:!0,tsType:{name:"boolean"},description:""}}};const x=({readOnly:r=!1,alleKodeverk:n})=>{var y,A,j,G,H;const a=_(),{control:t,formState:{errors:l}}=S(),{fields:k,remove:m,append:u}=te({control:t,name:`${f}.virksomheter`,rules:{required:a.formatMessage({id:"Registrering.RegistrerVirksomhetPanel.ArrayMinLength"})}}),v=()=>{u(b.initialValues())};return U.useEffect(()=>{k.length===0&&v()},[]),e.jsxs(e.Fragment,{children:[e.jsxs(g,{children:[e.jsx(g.Header,{children:e.jsxs(g.Row,{children:[e.jsx(g.HeaderCell,{style:{width:"48px"}}),e.jsx(g.HeaderCell,{children:e.jsx(s,{id:"Registrering.RegistrerVirksomhetPanel.Name"})}),e.jsx(g.HeaderCell,{style:{width:"48px"}})]})}),e.jsx(g.Body,{children:k.map((Y,M)=>e.jsx(b,{index:M,open:M+1===k.length,remove:()=>m(M),alleKodeverk:n,readOnly:r},Y.id))})]}),((j=(A=(y=l[f])==null?void 0:y.virksomheter)==null?void 0:A.root)==null?void 0:j.message)&&e.jsx(se,{children:(H=(G=l[f])==null?void 0:G.virksomheter.root)==null?void 0:H.message}),e.jsx("div",{children:e.jsx(F,{size:"small",variant:"tertiary",type:"button",onClick:v,icon:e.jsx(ie,{"aria-hidden":!0}),children:e.jsx(s,{id:"Registrering.RegistrerVirksomhetPanel.Add"})})})]})};x.transformValues=({egenVirksomhet:{harArbeidetIEgenVirksomhet:r,virksomheter:n}})=>({egenVirksomhet:{harArbeidetIEgenVirksomhet:r,virksomheter:r?n.map(a=>b.transformValues(a)):void 0}});x.__docgenInfo={description:`RegistrererVirksomhetPanel
