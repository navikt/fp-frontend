import{u as D,j as a,o as L,O as N,P as I,a as g}from"./iframe-B3mwpBdq.js";import{u as y,a as p,P as G,k as K,T as v,w as O,d as V,V as S,b as F,D as P,m as U,e as M,f as B,B as H}from"./nb_NO-914M1zyU.js";import{a as q}from"./alleKodeverk-DO07GSZv.js";import{L as w}from"./landkoder-Bgpqk6-g.js";import{F as Y}from"./FieldArrayRow-B1tvBJMw.js";import{M as A}from"./message-Bo9mlm5u.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ce-IuvG_.js";const i="arbeidsforhold",b=L(50),j=n=>n.filter(({kode:e})=>e!==w.NORGE).map(({kode:e,navn:l})=>a.jsx("option",{value:e,children:l},e)),_=({alleKodeverk:n,readOnly:e})=>{const l=D(),{control:r}=y(),{fields:k,remove:R,append:d}=p({control:r,name:i}),o=n.Landkoder.slice().sort((m,t)=>m.navn.localeCompare(t.navn));return a.jsx(G,{fields:k,addButtonText:l.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:R,append:d,children:(m,t)=>a.jsxs(Y,{remove:R,index:t,readOnly:e,children:[a.jsx(K,{readOnly:e,control:r,name:`${i}.${t}.arbeidsgiver`,label:l.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[b],maxLength:99}),a.jsx(v,{name:`${i}.${t}.periodeFom`,control:r,isReadOnly:e,label:l.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[N]}),a.jsx(v,{name:`${i}.${t}.periodeTom`,control:r,isReadOnly:e,label:l.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[N]}),a.jsx(O,{name:`${i}.${t}.land`,control:r,readOnly:e,label:l.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:j(o),size:"small"})]},m.id)})};_.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const u=({readOnly:n,alleKodeverk:e})=>a.jsx(V,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(F,{size:"small",level:"3",children:a.jsx(A,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),a.jsx(P,{children:a.jsx(A,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),a.jsx(_,{readOnly:n,alleKodeverk:e})]})});u.initialValues=()=>({[i]:[]});const T=n=>n===void 0||n==="";u.transformValues=({arbeidsforhold:n})=>({arbeidsforhold:n?.filter(e=>!(T(e.arbeidsgiver)&&T(e.land)&&T(e.periodeFom)&&T(e.periodeTom)))});u.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const c=g(U),E=({readOnly:n,alleKodeverk:e})=>a.jsx(I,{value:c,children:a.jsx(u,{readOnly:n,alleKodeverk:e})});E.initialValues=u.initialValues;E.transformValues=u.transformValues;E.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const{action:h}=__STORYBOOK_MODULE_ACTIONS__,X={title:"ui-komponenter/inntektsgivende-arbeid",component:E,args:{readOnly:!1,alleKodeverk:q},parameters:{submitCallback:h("onSubmit")},render:(n,{parameters:{submitCallback:e}})=>{const l=M({defaultValues:E.initialValues()});return a.jsx(B,{formMethods:l,onSubmit:r=>e(E.transformValues(r)),children:a.jsxs(S,{gap:"space-40",children:[a.jsx(E,{...n}),a.jsx(H,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},s={};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"{}",...s.parameters?.docs?.source}}};const Z=["Default"];export{s as Default,Z as __namedExportsOrder,X as default};
