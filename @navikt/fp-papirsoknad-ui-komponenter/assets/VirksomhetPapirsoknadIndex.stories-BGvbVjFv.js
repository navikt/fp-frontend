...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Ye={title:"ui-komponenter/virksomhet",component:p,parameters:{submitCallback:be("onSubmit")},args:{readOnly:!1,alleKodeverk:ce},render:(r,{parameters:{submitCallback:n}})=>{const a=ke({defaultValues:p.initialValues()});return e.jsx(ve,{formMethods:a,onSubmit:t=>n(p.transformValues(t)),children:e.jsxs(R,{gap:"10",children:[e.jsx(p,{...r}),e.jsx(F,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},h={};var O,J,C;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:"{}",...(C=(J=h.parameters)==null?void 0:J.docs)==null?void 0:C.source}}};const Qe=["Default"];export{h as Default,Qe as __namedExportsOrder,Ye as default};
