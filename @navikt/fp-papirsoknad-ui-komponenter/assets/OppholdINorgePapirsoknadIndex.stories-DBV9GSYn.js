import{u as B,j as e,c as x,t as F,O as V,R as c,d as R,b as w,J as j,h as G,P as Y,a as L}from"./iframe-DjD12CsA.js";import{u as S,a as _,P as $,H as D,w as C,T as K,d as z,V as T,b as J,c as N,m as Q,e as W,f as X,B as Z}from"./nb_NO-BhsWDL5U.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as f}from"./TrueFalseInput-D4hsAH7r.js";import{L as re}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-C1oWuVmp.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B3_lOHcj.js";const ae={land:void 0,periodeFom:void 0,periodeTom:void 0},A=(a,r)=>a(r),U=(a,r)=>()=>{const l=a(r).filter(({periodeFom:s,periodeTom:n})=>s&&s!==""&&n&&n!=="").map(({periodeFom:s,periodeTom:n})=>[s,n]);return l.length>0?G(l):void 0},ne=a=>a.filter(({kode:r})=>r!==re.NORGE).map(({kode:r,navn:t})=>e.jsx("option",{value:r,children:t},r)),M=(a,r,t,l)=>()=>{const s=A(a,`${r}.${t}.periodeFom`),n=A(a,`${r}.${t}.periodeTom`);return!n||!s?null:l?c(n)(s):j(s)(n)},b=({erTidligereOpphold:a=!1,mottattDato:r,readOnly:t,countryCodes:l})=>{const s=B(),n=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:d,getValues:i,trigger:m,formState:{isSubmitted:g}}=S(),{fields:q,remove:h,append:P}=_({control:d,name:n}),I=ne(l);return e.jsx($,{fields:q,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ae,readOnly:t,remove:h,append:P,children:(E,o,H)=>e.jsx(x.Fragment,{children:e.jsxs(D,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(C,{name:`${n}.${o}.land`,control:d,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:o>0,selectValues:I,readOnly:t,validate:[F]}),e.jsx(K,{name:`${n}.${o}.periodeFom`,control:d,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:o>0,isReadOnly:t,validate:[F,V,M(i,n,o,!0),()=>{const k=A(i,`${n}.${o}.periodeFom`);return a?c(R().format(w))(k):r?j(r)(k):void 0},U(i,n)],onChange:()=>g?m():void 0}),e.jsx(K,{name:`${n}.${o}.periodeTom`,control:d,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:o>0,isReadOnly:t,validate:[F,V,M(i,n,o,!1),()=>{const k=A(i,`${n}.${o}.periodeTom`);return a?c(R().format(w))(k):r?j(r)(k):void 0},U(i,n)],onChange:()=>g?m():void 0}),e.jsx("div",{children:H})]})},E.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:a=!0,alleKodeverk:r,mottattDato:t,erAdopsjon:l})=>{const{formatMessage:s}=B(),n=r.Landkoder.slice().sort((q,h)=>q.navn.localeCompare(h.navn)),{watch:d,control:i}=S(),m=!d("oppholdSisteTolvINorge",!0),g=!d("oppholdNesteTolvINorge",!0);return e.jsx(z,{children:e.jsxs(T,{gap:"space-16",children:[e.jsx(J,{size:"small",level:"3",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(f,{name:"oppholdINorge",control:i,label:s({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:a}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:a}),m&&e.jsx(N,{alignOffset:58,children:e.jsx(b,{erTidligereOpphold:!0,mottattDato:t,countryCodes:n,readOnly:a})})]}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:a}),g&&e.jsx(N,{alignOffset:58,children:e.jsx(b,{mottattDato:t,countryCodes:n,readOnly:a})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:a,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:t,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:s})=>({oppholdINorge:a,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!t,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:t?void 0:s});p.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const te=L(Q),u=({readOnly:a,erAdopsjon:r,alleKodeverk:t,mottattDato:l})=>e.jsx(Y,{value:te,children:e.jsx(p,{readOnly:a,erAdopsjon:r,alleKodeverk:t,mottattDato:l})});u.initialValues=p.initialValues;u.transformValues=p.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:se}=__STORYBOOK_MODULE_ACTIONS__,ge={title:"ui-komponenter/opphold-i-norge",component:u,parameters:{submitCallback:se("onSubmit")},args:{readOnly:!1,alleKodeverk:ee,mottattDato:"2022-05-30"},render:(a,{parameters:{submitCallback:r}})=>{const t=W({defaultValues:u.initialValues()});return e.jsx(X,{formMethods:t,onSubmit:l=>r(u.transformValues(l)),children:e.jsxs(T,{gap:"space-40",children:[e.jsx(u,{...a}),e.jsx(Z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{erAdopsjon:!1}},v={args:{erAdopsjon:!0}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...v.parameters?.docs?.source}}};const ye=["ForFodsel","ForAdopsjon"];export{v as ForAdopsjon,y as ForFodsel,ye as __namedExportsOrder,ge as default};
