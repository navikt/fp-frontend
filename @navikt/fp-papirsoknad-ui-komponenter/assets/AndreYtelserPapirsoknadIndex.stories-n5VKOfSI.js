import{u as _,r as P,j as r,P as V}from"./iframe-Bn-aqi4-.js";import{u as v,a as b,$ as h,H as Y,P as F,B as M,l as f,V as T,b as D,C as L,c as U,W as B,r as I,m as H,d as x,N as G}from"./nb_NO-DFI16EvZ.js";import{a as $}from"./alleKodeverk-DO07GSZv.js";import{t as j,O as N,R as C,J as X}from"./index.es-ZAp-KALQ.js";import{S as J}from"./Trash-DOMlWAbm.js";import{M as z}from"./message-ium0Z45r.js";import"./index-CnhIzrCe.js";var g=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(g||{});const y="andreYtelser",S="andreYtelserPerioder",A="andreYtelserTyper",K=({readOnly:e,name:a})=>{const n=_(),{getValues:t,control:s,trigger:l,formState:{isSubmitted:R}}=v(),{fields:E,remove:q,append:c}=b({control:s,name:a});return P.useEffect(()=>{E.length===0&&c({periodeFom:"",periodeTom:""})},[]),r.jsx(h,{fields:E,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:c,remove:q,children:(O,i)=>{const w=`${a}.${i}`;return r.jsxs(Y,{gap:"space-8",children:[r.jsx(F,{name:`${w}.periodeFom`,control:s,label:i===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[j,N,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${i}`);return o&&k?C(o)(k):null}],onChange:()=>R?l():void 0}),r.jsx(F,{name:`${a}.${i}.periodeTom`,control:s,label:i===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[j,N,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${i}`);return k&&o?X(k)(o):null}],onChange:()=>R?l():void 0}),!e&&i>0&&r.jsx("div",{children:r.jsx(M,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(J,{}),onClick:()=>q(i)})})]},O.id)}})};K.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const d=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:n})=>{const{control:t}=v(),s=Q(n.ArbeidType,a);return r.jsx(f,{children:r.jsxs(T,{gap:"space-16",children:[r.jsx(D,{size:"small",level:"3",children:r.jsx(z,{id:"Registrering.AndreYtelser.Title"})}),r.jsx(L,{name:`${y}.${A}`,control:t,isReadOnly:e,children:s.map(l=>r.jsx(W,{arbeidstype:l,readOnly:e},l.kode))})]})})};d.initialValues=()=>({[y]:{[A]:[],[S]:{}}});d.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[y]:e.flatMap(n=>a[n].map(t=>({ytelseType:n,...t})))});const W=({arbeidstype:e,readOnly:a})=>{const{watch:n}=v(),t=n(`${y}.${A}`),[s,l]=P.useState(t.includes(e.kode));return r.jsxs(T,{gap:"space-8",children:[r.jsx(U,{value:e.kode,onClick:()=>l(!s),disabled:a,children:e.navn}),s&&r.jsx(B,{children:r.jsx(K,{name:`${y}.${S}.${e.kode}`,readOnly:a})})]})},Q=(e,a)=>a?e.filter(n=>n.kode===g.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==g.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==g.FRILANSER&&n.kode!==g.LONN_UNDER_UTDANNING);d.__docgenInfo={description:`AndreYtelserPanel
