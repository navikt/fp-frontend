...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Me={title:"ui-komponenter/opphold-i-norge",component:t,parameters:{submitCallback:ue("onSubmit")},args:{readOnly:!1,alleKodeverk:ke,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=te({defaultValues:t.initialValues()});return e.jsx(de,{formMethods:o,onSubmit:i=>r(t.transformValues(i)),children:e.jsxs(f,{gap:"10",children:[e.jsx(t,{...n}),e.jsx(pe,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},d={args:{erAdopsjon:!1}},p={args:{erAdopsjon:!0}};var x,S,_;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(B=(z=p.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};const xe=["ForFodsel","ForAdopsjon"];export{p as ForAdopsjon,d as ForFodsel,xe as __namedExportsOrder,Me as default};
