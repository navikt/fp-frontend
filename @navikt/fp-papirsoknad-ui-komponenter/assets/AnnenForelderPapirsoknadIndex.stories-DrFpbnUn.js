import{j as r}from"./jsx-runtime-CLpGMVip.js";import{i as N,d as I,e as j,o as T,q as _,a as v,b as S,Z as x,Q as H,n as B,P as U,Y as $,M as L,m as C,c as D,r as X,B as z}from"./nb_NO-BWG5UGPU.js";import{e as m,F as J,M as G,y as Q,a as Y}from"./index.es-IwNBnKCa.js";import"./withRouter-D1jL7FRn.js";import{K as Z,a as W}from"./kodeverkTyper-DpbxgZaG.js";import{r as ee}from"./index-CYQpqK1Q.js";import"./aktivitetStatus-B1m96ipJ.js";import{L as re}from"./landkoder-tJDPMx5C.js";import{T as g}from"./TrueFalseInput-B56Dg9oO.js";import"./dayjs.min-DPY8FYmS.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-4Uuc9FQs.js";import"./index-CjktTq3Q.js";import"./v4-CtRu48qb.js";var u=(e=>(e.UKJENT_FORELDER="UKJENT_FORELDER",e.IKKE_NORSK_FNR="IKKE_NORSK_FNR",e))(u||{});const t="annenForelder",k="kanIkkeOppgiBegrunnelse",ne="_inputBredde_138ho_1",q={inputBredde:ne},ae=e=>e.filter(({kode:s})=>s!==re.NORGE).map(({kode:s,navn:n})=>r.jsx("option",{value:s,children:n},s)),f=({readOnly:e=!0,alleKodeverk:s,fagsakPersonnummer:n})=>{const{formatMessage:a}=N(),{watch:o,trigger:i,formState:{isSubmitted:F}}=I(),R=o(`${t}.kanIkkeOppgiAnnenForelder`),b=o(`${t}.${k}`),A=s[Z.LANDKODER],K=ee.useMemo(()=>A.slice().sort((d,V)=>d.navn.localeCompare(V.navn)),[A]);return r.jsxs(r.Fragment,{children:[r.jsx(j,{name:`${t}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:d=>d&&d.toString().replace(/\s/g,""),readOnly:e,className:q.inputBredde,validate:R?[]:[m,J,G,Q(n)],disabled:R}),r.jsx(T,{name:`${t}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:e,onChange:()=>F?i():void 0}),R===!0&&r.jsx(_,{children:r.jsxs(v,{gap:"4",children:[r.jsx(S,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),r.jsx(x,{name:`${t}.${k}.arsak`,hideLegend:!0,validate:[m],isReadOnly:e,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:u.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:u.IKKE_NORSK_FNR}]}),(b==null?void 0:b.arsak)===u.IKKE_NORSK_FNR&&r.jsxs(r.Fragment,{children:[r.jsx(H,{name:`${t}.${k}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:ae(K),validate:[m],className:q.inputBredde,readOnly:e}),r.jsx(j,{name:`${t}.${k}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[m],className:q.inputBredde,readOnly:e})]})]})})]})};f.transformValues=({foedselsnummer:e,kanIkkeOppgiAnnenForelder:s,kanIkkeOppgiBegrunnelse:{arsak:n,land:a,utenlandskFoedselsnummer:o}={}})=>s?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===u.IKKE_NORSK_FNR?{arsak:n,land:a,utenlandskFoedselsnummer:o}:{arsak:n}}:{foedselsnummer:e,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};f.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const Fe={title:"ui-komponenter/annen-forelder",component:l,args:{readOnly:!1,alleKodeverk:W,fagsakPersonnummer:"07078518434"},parameters:{submitCallback:Y("onSubmit")},render:(e,{parameters:{submitCallback:s}})=>{const n=D({defaultValues:l.initialValues()});return r.jsx(X,{formMethods:n,onSubmit:a=>s(l.transformValues(a)),children:r.jsxs(v,{gap:"10",children:[r.jsx(l,{...e}),r.jsx(z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{sokerErMor:!0}},y={args:{sokerErMor:!1}};var E,O,P;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    sokerErMor: true
  }
...
}`,...(M=(w=y.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};const Re=["SokerErMor","SokerErFar"];export{y as SokerErFar,p as SokerErMor,Re as __namedExportsOrder,Fe as default};
