import{u as _,r as w,j as a,R as B,P as N}from"./iframe-Bn-aqi4-.js";import{u as S,a as M,l as x,V as q,b as P,M as E,P as v,H as V,A as h,r as I,m as T,d as J,N as G,B as X}from"./nb_NO-DFI16EvZ.js";import{F as n}from"./familieHendelseType-CLnpSBng.js";import{t as y,O as c,g as $,l as H,i as L,k as O,a as z}from"./index.es-ZAp-KALQ.js";import{M as j}from"./message-ium0Z45r.js";import"./index-CnhIzrCe.js";const t="omsorg",K="_barnInput_1jjt5_1",C={barnInput:K},U=10,Y=e=>e?H(1)(e):void 0,Q=e=>e?L(10)(e):void 0,A=(e,r)=>o=>{if(e===0&&r&&o)return z(o,Array.isArray(r)?r[0]:r)},g=({readOnly:e=!0,familieHendelseType:r,isForeldrepengerFagsak:o,fodselsdatoer:d})=>{const{formatMessage:m}=_(),{control:u,watch:F}=S(),{fields:p,remove:D,append:R}=M({control:u,name:`${t}.foedselsDato`}),f=F(`${t}.antallBarn`)??0;return w.useEffect(()=>{if(p.length>Math.max(f,0))for(let s=p.length;s>f;s-=1)D(s-1);else if(p.length<Math.min(f,U))for(let s=p.length;s<f;s+=1)R({id:s,dato:void 0})},[f]),a.jsx(x,{children:a.jsxs(q,{gap:"space-16",children:[a.jsx(P,{size:"small",level:"3",children:a.jsx(j,{id:r===n.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),o&&r===n.ADOPSJON&&a.jsx(E,{name:`${t}.erEktefellesBarn`,control:u,label:a.jsx(j,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[y],isReadOnly:e,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:m({id:"Registrering.Adopsjon.Ja"}),value:"true"},{label:m({id:"Registrering.Adopsjon.Nei"}),value:"false"}]}),a.jsx(v,{name:`${t}.omsorgsovertakelsesdato`,control:u,label:m({id:r===n.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:e,validate:r===n.ADOPSJON?[y,c]:[c]}),a.jsxs(V,{gap:"space-16",children:[r===n.ADOPSJON&&a.jsx(v,{name:`${t}.ankomstdato`,control:u,label:m({id:"Registrering.Adopsjon.Ankomstdato"}),isReadOnly:e,validate:[c]}),a.jsx(h,{name:`${t}.antallBarn`,control:u,label:m({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:e,className:C.barnInput,parse:s=>{const i=parseInt(s.toString(),10);return Number.isNaN(i)?s:i},validate:[...r===n.ADOPSJON?[y]:[],$,Y,Q]})]}),p.map((s,i)=>a.jsx(B.Fragment,{children:a.jsx(v,{name:`${t}.foedselsDato.${i}.dato`,control:u,isReadOnly:e,validate:r===n.ADOPSJON?[y,c,O,A(i,d)]:[c,O,A(i,d)],label:m({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:i+1})})},s.id))]})})};g.initialValues=()=>({[t]:{}});g.transformValues=({omsorg:e})=>({[t]:{...e,foedselsDato:e.foedselsDato&&e.foedselsDato.length>0?e.foedselsDato.map(r=>r.dato):void 0}});g.__docgenInfo={description:`OmsorgOgAdopsjonPanel
