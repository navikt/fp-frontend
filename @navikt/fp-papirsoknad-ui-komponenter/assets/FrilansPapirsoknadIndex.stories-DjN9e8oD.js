import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as _,f as I,i as E,j as L,H as C,A as O,F as G,h as N,q as X,L as J,d as Q,V as S,c as U,D as W,P as Y,r as Z,m as ee,e as re,$ as ae,B as ne}from"./nb_NO-l0KIxcKg.js";import{O as w,D as B,H as z,o as oe,e as M,a as ie}from"./index.es-DkSIOkG0.js";import{T as P}from"./TrueFalseInput-BW8gVJXR.js";import{r as te}from"./index-C4XKfyRp.js";import{d as T}from"./dayjs.min-DkLNzaWO.js";import{M as m}from"./message-c8inkvcN.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";const i="frilans",b=(r,a)=>r(a),se=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,o)=>T(a,N).diff(T(o,N))),le=oe(50),de=(r,a,o,n)=>()=>{const d=b(r,`${a}.fomDato`);return o.length>0&&o[0]&&d&&!T(o[0]).isSameOrBefore(T(d))?n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},K=({readOnly:r})=>{const a=_(),{control:o,getValues:n,watch:d,trigger:g,formState:{isSubmitted:c}}=I(),{fields:V,remove:A,append:x}=E({control:o,name:`${i}.oppdragPerioder`}),F=d(`${i}.perioder`),h=te.useMemo(()=>se(F),[F]);return e.jsx(L,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:V,readOnly:r,append:x,remove:A,children:(t,p,s)=>{const l=`${i}.oppdragPerioder.${p}`;return e.jsxs(C,{gap:"4",paddingBlock:"2",align:"end",children:[e.jsx(O,{name:`${l}.fomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[w,de(n,l,h,a),()=>{const f=b(n,`${l}.fomDato`),v=b(n,`${l}.tomDato`);return v&&f?B(v)(f):null}],onChange:()=>c?g():void 0}),e.jsx(O,{name:`${l}.tomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[w,()=>{const f=b(n,`${l}.fomDato`),v=b(n,`${l}.tomDato`);return v&&f?z(f)(v):null}],onChange:()=>c?g():void 0}),e.jsx(G,{name:`${l}.oppdragsgiver`,validate:[le],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},t.id)}})};K.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const y=({readOnly:r})=>{const{watch:a}=I(),o=a(`${i}.harHattOppdragForFamilie`);return e.jsxs(e.Fragment,{children:[e.jsx(P,{name:`${i}.harHattOppdragForFamilie`,label:e.jsx(m,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),o&&e.jsxs(X,{children:[e.jsx(J,{size:"small",children:e.jsx(m,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(K,{readOnly:r})]})]})};y.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});y.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});y.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
