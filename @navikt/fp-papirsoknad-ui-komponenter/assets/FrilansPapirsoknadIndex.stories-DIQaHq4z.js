import{u as R,j as e,O as P,R as _,J as $,o as X,d as O,x as M,t as x,P as z,e as U}from"./iframe-JigLZSyW.js";import{u as D,a as H,P as E,H as L,y as T,T as J,V as w,U as B,L as K,c as Y,b as G,D as Q,m as W,d as Z,e as ee,B as re}from"./nb_NO-Bkbsqolb.js";import{T as j}from"./TrueFalseInput-DPtvJg_b.js";import{M as p}from"./message-B7N5HCv3.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CkJyxLsq.js";const o="frilans",b=(r,a)=>r(a),ae=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,n)=>O(a,M).diff(O(n,M))),ne=X(50),oe=(r,a,n,i)=>()=>{const s=b(r,`${a}.fomDato`);return n.length>0&&n[0]&&s&&!O(n[0]).isSameOrBefore(O(s))?i.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},C=({readOnly:r})=>{const a=R(),{control:n,getValues:i,watch:s,trigger:u,formState:{isSubmitted:c}}=D(),{fields:S,remove:A,append:I}=H({control:n,name:`${o}.oppdragPerioder`}),l=s(`${o}.perioder`),N=ae(l);return e.jsx(E,{addButtonText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:S,readOnly:r,append:I,remove:A,emptyTemplate:{fomDato:"",tomDato:"",oppdragsgiver:""},children:(g,t,d)=>{const k=`${o}.oppdragPerioder.${t}`;return e.jsxs(L,{gap:"space-8",align:"end",children:[e.jsx(T,{name:`${o}.oppdragPerioder.${t}.fomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),hideLabel:t>0,validate:[P,oe(i,k,N,a),()=>{const f=b(i,`${k}.fomDato`),v=b(i,`${k}.tomDato`);return v&&f?_(v)(f):null}],onChange:()=>c?u():void 0}),e.jsx(T,{name:`${o}.oppdragPerioder.${t}.tomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),hideLabel:t>0,validate:[P,()=>{const f=b(i,`${k}.fomDato`),v=b(i,`${k}.tomDato`);return v&&f?$(f)(v):null}],onChange:()=>c?u():void 0}),e.jsx(J,{name:`${o}.oppdragPerioder.${t}.oppdragsgiver`,control:n,validate:[ne],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"}),hideLabel:t>0}),e.jsx("div",{children:d})]},g.id)}})};C.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const F=({readOnly:r})=>{const{watch:a,control:n}=D(),i=a(`${o}.harHattOppdragForFamilie`);return e.jsxs(w,{gap:"space-12",children:[e.jsx(j,{name:`${o}.harHattOppdragForFamilie`,control:n,label:e.jsx(p,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),i&&e.jsxs(B,{children:[e.jsx(K,{size:"small",children:e.jsx(p,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(C,{readOnly:r})]})]})};F.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});F.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});F.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ie=U(W),m=({readOnly:r})=>e.jsx(z,{value:ie,children:e.jsx(y,{readOnly:r})});m.initialValues=y.initialValues;m.transformValues=y.transformValues;m.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
