...
}`,signature:{properties:[{key:"notRegisteredInput",value:{name:"boolean",required:!1}}]}}],required:!0}}]}}}}],displayName:"BehovForTilretteleggingPanel"};const pe={title:"papirsoknad/ui-komponenter/tilrettelegging-svp",component:y},de=({submitCallback:r})=>{const n=Q();return e.jsxs(U,{formMethods:n,onSubmit:r,children:[e.jsx(y,{readOnly:!1}),e.jsx(d,{fourtyPx:!0}),e.jsx(w,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},p=de.bind({});p.args={submitCallback:Y("button-click")};var S,R,P;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`({
  submitCallback
}) => {
...
}`,...(P=(R=p.parameters)==null?void 0:R.docs)==null?void 0:P.source}}};const he=["Default"];export{p as Default,he as __namedExportsOrder,pe as default};
