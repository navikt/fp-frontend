import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{H as F,g as w,D as b,U as O,f as G,a as J}from"./index.es-CiSAtsS3.js";import{e as E,d as H,i as Q,I as W,H as X,j as Y,c as V,A as I,S as Z,V as f,a as ee,M as q,l as R,t as re,P as ne,m as ae,b as oe,$ as se,B as ie}from"./nb_NO-Do_lz9uu.js";import"./withRouter-DhSU4y_G.js";import{K as te,a as le}from"./alleKodeverk-D-QME5s7.js";import{r as L,R as de}from"./index-DRjF_FHU.js";import"./aktivitetStatus-B1m96ipJ.js";import{L as pe}from"./landkoder-tJDPMx5C.js";import{d as U}from"./dayjs.min-CnNqAF5I.js";import{T}from"./TrueFalseInput-DPUk9p9R.js";import"./v4-CQkTLCs1.js";import"./index-rX-Bn4lm.js";const me={land:void 0,periodeFom:void 0,periodeTom:void 0},c=(n,r)=>n(r),x=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?G(i):void 0},ue=n=>n.filter(({kode:r})=>r!==pe.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),K=(n,r,o,i)=>()=>{const s=c(n,`${r}.${o}.periodeFom`),a=c(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?b(a)(s):O(s)(a)},j=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:u,getValues:t,trigger:g,formState:{isSubmitted:v}}=H(),{fields:h,remove:z,append:B}=Q({control:u,name:a}),D=L.useMemo(()=>ue(i),[i]);return e.jsx(W,{fields:h,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:me,readOnly:o,remove:z,append:B,children:(N,l,A)=>e.jsx(de.Fragment,{children:e.jsxs(X,{gap:"4",paddingBlock:"2",children:[e.jsx(Y,{name:`${a}.${l}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:D,readOnly:o,validate:[F]}),e.jsx(V,{name:`${a}.${l}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[F,w,K(t,a,l,!0),()=>{const m=c(t,`${a}.${l}.periodeFom`);return n?b(U().format(I))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),e.jsx(V,{name:`${a}.${l}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[F,w,K(t,a,l,!1),()=>{const m=c(t,`${a}.${l}.periodeTom`);return n?b(U().format(I))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),A&&e.jsx("div",{children:A()})]},N.id)},N.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:n=!0,alleKodeverk:r,mottattDato:o,erAdopsjon:i})=>{const{formatMessage:s}=E(),a=L.useMemo(()=>r[te.LANDKODER].slice().sort((v,h)=>v.navn.localeCompare(h.navn)),[r]),{watch:u}=H(),t=!u("oppholdSisteTolvINorge",!0),g=!u("oppholdNesteTolvINorge",!0);return e.jsx(Z,{children:e.jsxs(f,{gap:"4",children:[e.jsx(ee,{size:"small",children:e.jsx(q,{id:"Registrering.Opphold"})}),e.jsx(T,{name:"oppholdINorge",label:s({id:i?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(f,{gap:"2",children:[e.jsx(T,{name:"oppholdSisteTolvINorge",label:e.jsx(q,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),t&&e.jsx(R,{alignOffset:58,children:e.jsx(j,{erTidligereOpphold:!0,mottattDato:o,countryCodes:a,readOnly:n})})]}),e.jsxs(f,{gap:"2",children:[e.jsx(T,{name:"oppholdNesteTolvINorge",label:e.jsx(q,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),g&&e.jsx(R,{alignOffset:58,children:e.jsx(j,{mottattDato:o,countryCodes:a,readOnly:n})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:o,tidligereOppholdUtenlands:i,fremtidigeOppholdUtenlands:s})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!o,tidligereOppholdUtenlands:r?void 0:i,fremtidigeOppholdUtenlands:o?void 0:s});p.__docgenInfo={description:`OppholdINorgePanel
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ge=re(ae),d=({readOnly:n,erAdopsjon:r,alleKodeverk:o,mottattDato:i})=>e.jsx(ne,{value:ge,children:e.jsx(p,{readOnly:n,erAdopsjon:r,alleKodeverk:o,mottattDato:i})});d.initialValues=p.initialValues;d.transformValues=p.transformValues;d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Ne={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:J("onSubmit")},args:{readOnly:!1,alleKodeverk:le,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=oe({defaultValues:d.initialValues()});return e.jsx(se,{formMethods:o,onSubmit:i=>r(d.transformValues(i)),children:e.jsxs(f,{gap:"10",children:[e.jsx(d,{...n}),e.jsx(ie,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},k={args:{erAdopsjon:!1}},y={args:{erAdopsjon:!0}};var M,S,$;k.parameters={...k.parameters,docs:{...(M=k.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
