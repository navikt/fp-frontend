import{j as e}from"./jsx-runtime-DjgmBYnU.js";import{j as E,d as H,q as W,r as G,H as J,$ as Q,k as V,i as w,a as X,V as f,b as Y,M as F,s as I,n as Z,P as ee,m as re,c as ne,W as ae,B as oe}from"./nb_NO-CbRPWb2t.js";import{e as q,O as R,D as b,H as O,h as se,a as ie}from"./index.es-BYNffZI8.js";import{a as te}from"./alleKodeverk-BSex6Kn3.js";import{r as B,R as le}from"./index-D7mKeUb6.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as de}from"./kodeverkTyper-CavWL6Ds.js";import{T}from"./TrueFalseInput-CIbK-D8R.js";import{d as U}from"./dayjs.min-Boho2IT3.js";import{L as pe}from"./landkoder-tJDPMx5C.js";import"./index-DjXIRphR.js";import"./index-BdR6VAUc.js";import"./index-DCOq8Jev.js";import"./v4-CtRu48qb.js";const me={land:void 0,periodeFom:void 0,periodeTom:void 0},h=(n,r)=>n(r),x=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?se(i):void 0},ue=n=>n.filter(({kode:r})=>r!==pe.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),K=(n,r,o,i)=>()=>{const s=h(n,`${r}.${o}.periodeFom`),a=h(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?b(a)(s):O(s)(a)},j=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:u,getValues:t,trigger:g,formState:{isSubmitted:k}}=H(),{fields:c,remove:L,append:z}=W({control:u,name:a}),D=B.useMemo(()=>ue(i),[i]);return e.jsx(G,{fields:c,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:me,readOnly:o,remove:L,append:z,children:(N,l,A)=>e.jsx(le.Fragment,{children:e.jsxs(J,{gap:"4",paddingBlock:"2",children:[e.jsx(Q,{name:`${a}.${l}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:D,readOnly:o,validate:[q]}),e.jsx(V,{name:`${a}.${l}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[q,R,K(t,a,l,!0),()=>{const m=h(t,`${a}.${l}.periodeFom`);return n?b(U().format(w))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>k?g():void 0}),e.jsx(V,{name:`${a}.${l}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[q,R,K(t,a,l,!1),()=>{const m=h(t,`${a}.${l}.periodeTom`);return n?b(U().format(w))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>k?g():void 0}),A&&e.jsx("div",{children:A()})]},N.id)},N.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const Ve={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:ie("onSubmit")},args:{readOnly:!1,alleKodeverk:te,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=ne({defaultValues:d.initialValues()});return e.jsx(ae,{formMethods:o,onSubmit:i=>r(d.transformValues(i)),children:e.jsxs(f,{gap:"10",children:[e.jsx(d,{...n}),e.jsx(oe,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},v={args:{erAdopsjon:!1}},y={args:{erAdopsjon:!0}};var M,S,$;v.parameters={...v.parameters,docs:{...(M=v.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(_=(P=y.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};const we=["ForFodsel","ForAdopsjon"];export{y as ForAdopsjon,v as ForFodsel,we as __namedExportsOrder,Ve as default};
