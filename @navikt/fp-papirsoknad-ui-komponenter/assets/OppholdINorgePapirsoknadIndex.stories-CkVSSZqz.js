import{g as Z,r as C,R as e}from"./index-DVXBtNgz.js";import{e as z,f as H,l as ee,r as re,y as ae,g as p,q as ne,F as le,M as te,c as V,d as q,N as R,R as oe,H as se,h as F,T as U,i as T,t as de,P as ie,m as pe,a as L,b as me,O as ue,B as ge}from"./nb_NO-C9BsZesQ.js";import"./withRouter-ClqbeiGf.js";import{K as he,a as ce}from"./alleKodeverk-DbawmvgK.js";import{r as m,b as x,I as A,h as P,c as I,q as fe}from"./index.es-DaiGF91N.js";import{l as ye}from"./landkoder-T-1RG3zx.js";import"./v4-CQkTLCs1.js";import"./tslib.es6-CMwweBXX.js";import"./index-Cbx7Fas8.js";var W={exports:{}};/*!
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
  fremtidigeOppholdUtenlands?: FormValuesFieldArray[];
}`,signature:{properties:[{key:"oppholdINorge",value:{name:"boolean",required:!1}},{key:"harTidligereOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"harFremtidigeOppholdUtenlands",value:{name:"boolean",required:!1}},{key:"tidligereOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}},{key:"fremtidigeOppholdUtenlands",value:{name:"Array",elements:[{name:"FormValues"}],raw:"FormValuesFieldArray[]",required:!1}}]}}}}],displayName:"OppholdINorgePapirsoknadIndex"};const we={title:"papirsoknad/ui-komponenter/opphold-i-norge",component:O},Y=({erAdopsjon:a,submitCallback:n})=>{const t=me({defaultValues:O.buildInitialValues()});return e.createElement(ue,{formMethods:t,onSubmit:d=>n(O.transformValues(d))},e.createElement(O,{readOnly:!1,erAdopsjon:a,alleKodeverk:ce,mottattDato:"2022-05-30"}),e.createElement(p,{fourtyPx:!0}),e.createElement(ge,{size:"small",variant:"primary"},"Lagreknapp (Kun for test)"))},h=Y.bind({});h.args={erAdopsjon:!1,submitCallback:L("button-click")};const c=Y.bind({});c.args={erAdopsjon:!0,submitCallback:L("button-click")};var M,S,K;h.parameters={...h.parameters,docs:{...(M=h.parameters)==null?void 0:M.docs,source:{originalSource:`({
  erAdopsjon,
  submitCallback
}) => {
...
}`,...($=(_=c.parameters)==null?void 0:_.docs)==null?void 0:$.source}}};const Me=["ForFodsel","ForAdopsjon"];export{c as ForAdopsjon,h as ForFodsel,Me as __namedExportsOrder,we as default};
