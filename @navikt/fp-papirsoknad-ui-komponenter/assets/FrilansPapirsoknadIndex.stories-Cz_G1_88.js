import{u as $,j as e,d as O,P as X}from"./iframe-Bn-aqi4-.js";import{u as D,a as _,$ as H,H as R,P as T,A as z,e as M,W as E,L as J,l as K,V as N,b as W,D as U,r as Y,m as G,d as Q,N as Z,B as ee}from"./nb_NO-DFI16EvZ.js";import{T as P}from"./TrueFalseInput-DEHECCVV.js";import{O as w,R as L,J as C,o as re,t as x}from"./index.es-ZAp-KALQ.js";import{M as p}from"./message-ium0Z45r.js";import"./index-CnhIzrCe.js";const o="frilans",b=(r,a)=>r(a),ae=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,n)=>O(a,M).diff(O(n,M))),ne=re(50),oe=(r,a,n,i)=>()=>{const l=b(r,`${a}.fomDato`);return n.length>0&&n[0]&&l&&!O(n[0]).isSameOrBefore(O(l))?i.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},B=({readOnly:r})=>{const a=$(),{control:n,getValues:i,watch:l,trigger:u,formState:{isSubmitted:c}}=D(),{fields:A,remove:S,append:I}=_({control:n,name:`${o}.oppdragPerioder`}),d=l(`${o}.perioder`),h=ae(d);return e.jsx(H,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:A,readOnly:r,append:I,remove:S,children:(g,t,s)=>{const k=`${o}.oppdragPerioder.${t}`;return e.jsxs(R,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(T,{name:`${o}.oppdragPerioder.${t}.fomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[w,oe(i,k,h,a),()=>{const f=b(i,`${k}.fomDato`),v=b(i,`${k}.tomDato`);return v&&f?L(v)(f):null}],onChange:()=>c?u():void 0}),e.jsx(T,{name:`${o}.oppdragPerioder.${t}.tomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[w,()=>{const f=b(i,`${k}.fomDato`),v=b(i,`${k}.tomDato`);return v&&f?C(f)(v):null}],onChange:()=>c?u():void 0}),e.jsx(z,{name:`${o}.oppdragPerioder.${t}.oppdragsgiver`,control:n,validate:[ne],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},g.id)}})};B.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray
