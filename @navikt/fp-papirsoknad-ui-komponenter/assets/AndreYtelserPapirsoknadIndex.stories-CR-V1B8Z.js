import{u as B,r as P,j as a,t as O,O as G,R as k,J as y,P as p,e as g}from"./iframe-CayaqC7Q.js";import{u as A,a as H,C as Y,H as J,y as s,c as w,V as S,b as q,d as C,e as c,U as j,m as b,f as h,P as f,B as Z}from"./nb_NO-CGAi3Ezg.js";import{a as W}from"./alleKodeverk-BnsD7hyO.js";import{M as X}from"./message-CJlc27gU.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DJpVPxS0.js";const T="andreYtelser",F="andreYtelserPerioder",I="andreYtelserTyper",V=({readOnly:l,name:n})=>{const e=B(),{getValues:r,control:E,trigger:t,formState:{isSubmitted:L}}=A(),{fields:D,remove:M,append:K}=H({control:E,name:n});return P.useEffect(()=>{D.length===0&&K({periodeFom:"",periodeTom:""})},[]),a.jsx(Y,{fields:D,addButtonText:e.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:l,append:K,remove:M,children:(o,u,d)=>{const U=`${n}.${u}`;return a.jsxs(J,{gap:"space-8",align:"end",children:[a.jsx(s,{name:`${U}.periodeFom`,control:E,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[O,G,()=>{const{periodeFom:m,periodeTom:R}=r(`${n}.${u}`);return R&&m?k(R)(m):null}],onChange:()=>L?t():void 0}),a.jsx(s,{name:`${n}.${u}.periodeTom`,control:E,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[O,G,()=>{const{periodeFom:m,periodeTom:R}=r(`${n}.${u}`);return m&&R?y(m)(R):null}],onChange:()=>L?t():void 0}),a.jsx("div",{children:d})]},o.id)}})};V.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const N=({readOnly:l,kunMiliterEllerSiviltjeneste:n=!1,alleKodeverk:e})=>{const{control:r}=A(),E=$(e.ArbeidType,n);return a.jsx(w,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(q,{size:"small",level:"3",children:a.jsx(X,{id:"Registrering.AndreYtelser.Title"})}),a.jsx(C,{name:`${T}.${I}`,control:r,legend:"",hideLegend:!0,readOnly:l,children:E.map(t=>a.jsx(x,{arbeidstype:t,readOnly:l},t.kode))})]})})};N.initialValues=()=>({[T]:{[I]:[],[F]:{}}});N.transformValues=({andreYtelser:{andreYtelserTyper:l,andreYtelserPerioder:n}})=>({[T]:l.flatMap(e=>n[e]?.map(r=>({ytelseType:e,...r}))).filter(e=>e!==void 0)});const x=({arbeidstype:l,readOnly:n})=>{const{watch:e}=A(),r=e(`${T}.${I}`),[E,t]=P.useState(r.includes(l.kode));return a.jsxs(S,{gap:"space-12",children:[a.jsx(c,{value:l.kode,onClick:()=>t(!E),disabled:n,children:l.navn}),E&&a.jsx(j,{children:a.jsx(V,{name:`${T}.${F}.${l.kode}`,readOnly:n})})]})},$=(l,n)=>n?l.filter(e=>e.kode==="MILITÆR_ELLER_SIVILTJENESTE"):l.filter(e=>e.kode!=="UTENLANDSK_ARBEIDSFORHOLD"&&e.kode!=="FRILANSER"&&e.kode!=="LØNN_UNDER_UTDANNING");N.__docgenInfo={description:`AndreYtelserPanel
