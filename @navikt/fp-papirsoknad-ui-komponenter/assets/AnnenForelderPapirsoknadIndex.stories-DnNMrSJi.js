import{u as K,j as e,t as T,k as U,M as p,y,P as B,a as H}from"./iframe-CEXpT7hR.js";import{u as P,k as O,V as R,g as q,c as Y,b as F,S as w,R as G,w as J,d as c,m as b,e as f,f as C,B as j}from"./nb_NO-BWbLkVCC.js";import{a as h}from"./alleKodeverk-DO07GSZv.js";import{M as d}from"./message-Fn81Dywe.js";import{T as s}from"./TrueFalseInput--E6PAVcz.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DacWvyjk.js";var v=(a=>(a.UKJENT_FORELDER="UKJENT_FORELDER",a.IKKE_NORSK_FNR="IKKE_NORSK_FNR",a))(v||{});const t="annenForelder",A="kanIkkeOppgiBegrunnelse",Z="_inputBredde_138ho_1",k={inputBredde:Z},W=a=>a.filter(({kode:n})=>n!=="NOR").map(({kode:n,navn:l})=>e.jsx("option",{value:n,children:l},n)),L=({readOnly:a=!0,alleKodeverk:n,fagsakPersonnummer:l})=>{const{formatMessage:r}=K(),{watch:u,control:i,trigger:N,formState:{isSubmitted:o}}=P(),D=u(`${t}.kanIkkeOppgiAnnenForelder`),g=u(`${t}.${A}`),M=n.Landkoder.slice().sort((m,V)=>m.navn.localeCompare(V.navn));return e.jsxs(e.Fragment,{children:[e.jsx(O,{name:`${t}.foedselsnummer`,control:i,label:r({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:m=>m&&m.toString().replace(/\s/g,""),readOnly:a,className:k.inputBredde,validate:D?[]:[T,U,p,y(l)],disabled:D}),e.jsxs(R,{gap:"space-12",children:[e.jsx(q,{name:`${t}.kanIkkeOppgiAnnenForelder`,control:i,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:a,onChange:()=>o?N():void 0}),D===!0&&e.jsx(Y,{children:e.jsxs(R,{gap:"space-16",children:[e.jsx(F,{size:"small",level:"4",children:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsxs(w,{name:`${t}.${A}.arsak`,control:i,hideLegend:!0,validate:[T],isReadOnly:a,children:[e.jsx(G,{value:v.UKJENT_FORELDER,size:"small",children:e.jsx(d,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"})}),e.jsx(G,{value:v.IKKE_NORSK_FNR,size:"small",children:e.jsx(d,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"})})]}),g?.arsak===v.IKKE_NORSK_FNR&&e.jsxs(e.Fragment,{children:[e.jsx(J,{name:`${t}.${A}.land`,control:i,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:W(M),validate:[T],className:k.inputBredde,readOnly:a}),e.jsx(O,{name:`${t}.${A}.utenlandskFoedselsnummer`,control:i,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[T],className:k.inputBredde,readOnly:a})]})]})})]})]})};L.transformValues=({foedselsnummer:a,kanIkkeOppgiAnnenForelder:n,kanIkkeOppgiBegrunnelse:{arsak:l,land:r,utenlandskFoedselsnummer:u}={}})=>n?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:l===v.IKKE_NORSK_FNR?{arsak:l,land:r,utenlandskFoedselsnummer:u}:{arsak:l}}:{foedselsnummer:a,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};L.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""}}};const I=({readOnly:a,sokerErMor:n})=>{const l=K(),{watch:r,control:u}=P(),i=r(`${t}.sokerHarAleneomsorg`),N=r(`${t}.denAndreForelderenHarRettPaForeldrepenger`),o=r(`${t}.annenForelderRettEØS`);return e.jsxs(R,{gap:"space-16",children:[e.jsx(s,{name:`${t}.sokerHarAleneomsorg`,control:u,label:l.formatMessage({id:"Registrering.Permisjon.SøkerHarAleneomsorg"}),readOnly:a}),i===!1&&e.jsx(s,{name:`${t}.denAndreForelderenHarRettPaForeldrepenger`,control:u,label:l.formatMessage({id:"Registrering.Permisjon.HarRettPaForeldrepenger"}),readOnly:a}),i===!1&&N===!1&&e.jsx(s,{name:`${t}.annenForelderRettEØS`,control:u,label:l.formatMessage({id:"Registrering.Permisjon.AnnenForelderRettEØS"}),readOnly:a}),!n&&i===!1&&N===!1&&o===!1&&e.jsx(s,{name:`${t}.morMottarUføretrygd`,control:u,label:l.formatMessage({id:"Registrering.Permisjon.MorUføretrygd"}),readOnly:a})]})};I.transformValues=({sokerHarAleneomsorg:a,denAndreForelderenHarRettPaForeldrepenger:n,annenForelderRettEØS:l,morMottarUføretrygd:r})=>({sokerHarAleneomsorg:a,denAndreForelderenHarRettPaForeldrepenger:a===!1?n:void 0,annenForelderRettEØS:n===!1?l:void 0,morMottarUføretrygd:l===!1?r:void 0});I.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  sokerHarAleneomsorg,
  ...
  annenForelderRettEØS?: boolean;
  morMottarUføretrygd?: boolean;
}`,signature:{properties:[{key:"sokerHarAleneomsorg",value:{name:"boolean",required:!1}},{key:"denAndreForelderenHarRettPaForeldrepenger",value:{name:"boolean",required:!1}},{key:"annenForelderRettEØS",value:{name:"boolean",required:!1}},{key:"morMottarUføretrygd",value:{name:"boolean",required:!1}}]}}}}],displayName:"PermisjonRettigheterPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const x=H(b),E=({readOnly:a,alleKodeverk:n,fagsakPersonnummer:l,sokerErMor:r})=>e.jsx(B,{value:x,children:e.jsx(c,{children:e.jsxs(R,{gap:"space-16",children:[e.jsx(F,{size:"small",level:"3",children:e.jsx(d,{id:"Registrering.TheOtherParent.Title"})}),e.jsx(L,{readOnly:a,fagsakPersonnummer:l,alleKodeverk:n}),e.jsx(I,{readOnly:a,sokerErMor:r})]})})});E.initialValues=()=>({[t]:{}});E.transformValues=({annenForelder:a})=>({[t]:{...I.transformValues(a),...L.transformValues(a)}});E.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
}`,..._.parameters?.docs?.source}}};const ie=["SokerErMor","SokerErFar"];export{_ as SokerErFar,S as SokerErMor,ie as __namedExportsOrder,te as default};
