import{u as P,j as e,t as T,k as U,M as B,y as g,P as p,e as y}from"./iframe-BqnEFk-y.js";import{u as V,e as s,V as R,j as H,U as J,b as o,S as Y,R as F,w as q,c as w,m as c,d as C,P as f,B as b}from"./nb_NO-DISyZyHa.js";import{a as j}from"./alleKodeverk-BnsD7hyO.js";import{M as G}from"./message-CZv0OR3R.js";import{T as v}from"./TrueFalseInput-BtZ3wyeq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-_9OiTaIa.js";const E="annenForelder",_="kanIkkeOppgiBegrunnelse",h="_inputBredde_138ho_1",K={inputBredde:h},Z=a=>a.filter(({kode:n})=>n!=="NOR").map(({kode:n,navn:l})=>e.jsx("option",{value:n,children:l},n)),I=({readOnly:a=!0,alleKodeverk:n,fagsakPersonnummer:l})=>{const{formatMessage:r}=P(),{watch:i,control:t,trigger:m,formState:{isSubmitted:D}}=V(),O=i(`${E}.kanIkkeOppgiAnnenForelder`),M=i(`${E}.${_}`),d=n.Landkoder.slice().sort((N,k)=>N.navn.localeCompare(k.navn));return e.jsxs(e.Fragment,{children:[e.jsx(s,{name:`${E}.foedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:N=>N&&N.toString().replace(/\s/g,""),readOnly:a,className:K.inputBredde,validate:O?[]:[T,U,B,g(l)],disabled:O}),e.jsxs(R,{gap:"space-12",children:[e.jsx(H,{name:`${E}.kanIkkeOppgiAnnenForelder`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:a,onChange:()=>D?m():void 0}),O===!0&&e.jsx(J,{children:e.jsxs(R,{gap:"space-16",children:[e.jsx(o,{size:"small",level:"4",children:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsxs(Y,{name:`${E}.${_}.arsak`,control:t,legend:"",hideLegend:!0,validate:[T],readOnly:a,children:[e.jsx(F,{value:"UKJENT_FORELDER",size:"small",children:e.jsx(G,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"})}),e.jsx(F,{value:"IKKE_NORSK_FNR",size:"small",children:e.jsx(G,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"})})]}),M?.arsak==="IKKE_NORSK_FNR"&&e.jsxs(e.Fragment,{children:[e.jsx(q,{name:`${E}.${_}.land`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:Z(d),validate:[T],className:K.inputBredde,readOnly:a}),e.jsx(s,{name:`${E}.${_}.utenlandskFoedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[T],className:K.inputBredde,readOnly:a})]})]})})]})]})};I.transformValues=({foedselsnummer:a,kanIkkeOppgiAnnenForelder:n,kanIkkeOppgiBegrunnelse:{arsak:l,land:r,utenlandskFoedselsnummer:i}={}})=>n?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:l==="IKKE_NORSK_FNR"?{arsak:l,land:r,utenlandskFoedselsnummer:i}:{arsak:l}}:{foedselsnummer:a,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};I.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
  ...
  land?: string;
  utenlandskFoedselsnummer?: string;
}`,signature:{properties:[{key:"arsak",value:{name:"union",raw:"'UKJENT_FORELDER' | 'IKKE_NORSK_FNR'",elements:[{name:"literal",value:"'UKJENT_FORELDER'"},{name:"literal",value:"'IKKE_NORSK_FNR'"}],required:!1}},{key:"land",value:{name:"string",required:!1}},{key:"utenlandskFoedselsnummer",value:{name:"string",required:!1}}]},required:!1}}]},alias:"AnnenForelderSubFormValues"}}],returns:{type:{name:"signature",type:"object",raw:`{
  foedselsnummer?: string;
  kanIkkeOppgiAnnenForelder?: boolean;
  kanIkkeOppgiBegrunnelse?: {
    arsak?: KanIkkeOppgiAnnenForelderArsak;
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""}}};const L=({readOnly:a,sokerErMor:n})=>{const l=P(),{watch:r,control:i}=V(),t=r(`${E}.sokerHarAleneomsorg`),m=r(`${E}.denAndreForelderenHarRettPaForeldrepenger`),D=r(`${E}.annenForelderRettEØS`);return e.jsxs(R,{gap:"space-16",children:[e.jsx(v,{name:`${E}.sokerHarAleneomsorg`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.SøkerHarAleneomsorg"}),readOnly:a}),t===!1&&e.jsx(v,{name:`${E}.denAndreForelderenHarRettPaForeldrepenger`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.HarRettPaForeldrepenger"}),readOnly:a}),t===!1&&m===!1&&e.jsx(v,{name:`${E}.annenForelderRettEØS`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.AnnenForelderRettEØS"}),readOnly:a}),!n&&t===!1&&m===!1&&D===!1&&e.jsx(v,{name:`${E}.morMottarUføretrygd`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.MorUføretrygd"}),readOnly:a})]})};L.transformValues=({sokerHarAleneomsorg:a,denAndreForelderenHarRettPaForeldrepenger:n,annenForelderRettEØS:l,morMottarUføretrygd:r})=>({sokerHarAleneomsorg:a,denAndreForelderenHarRettPaForeldrepenger:a===!1?n:void 0,annenForelderRettEØS:n===!1?l:void 0,morMottarUføretrygd:l===!1?r:void 0});L.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  sokerHarAleneomsorg,
  ...
  annenForelderRettEØS?: boolean;
  morMottarUføretrygd?: boolean;
}`,signature:{properties:[{key:"sokerHarAleneomsorg",value:{name:"boolean",required:!1}},{key:"denAndreForelderenHarRettPaForeldrepenger",value:{name:"boolean",required:!1}},{key:"annenForelderRettEØS",value:{name:"boolean",required:!1}},{key:"morMottarUføretrygd",value:{name:"boolean",required:!1}}]}}}}],displayName:"PermisjonRettigheterPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const W=y(c),u=({readOnly:a,alleKodeverk:n,fagsakPersonnummer:l,sokerErMor:r})=>e.jsx(p,{value:W,children:e.jsx(w,{children:e.jsxs(R,{gap:"space-16",children:[e.jsx(o,{size:"small",level:"3",children:e.jsx(G,{id:"Registrering.TheOtherParent.Title"})}),e.jsx(I,{readOnly:a,fagsakPersonnummer:l,alleKodeverk:n}),e.jsx(L,{readOnly:a,sokerErMor:r})]})})});u.initialValues=()=>({[E]:{}});u.transformValues=({annenForelder:a})=>({[E]:{...L.transformValues(a),...I.transformValues(a)}});u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:x}=__STORYBOOK_MODULE_ACTIONS__,re={title:"ui-komponenter/annen-forelder",component:u,args:{readOnly:!1,alleKodeverk:j,fagsakPersonnummer:"07078518434"},parameters:{submitCallback:x("onSubmit")},render:(a,{parameters:{submitCallback:n}})=>{const l=C({defaultValues:u.initialValues()});return e.jsx(f,{formMethods:l,onSubmit:r=>n(u.transformValues(r)),children:e.jsxs(R,{gap:"space-40",children:[e.jsx(u,{...a}),e.jsx(b,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},A={args:{sokerErMor:!0}},S={args:{sokerErMor:!1}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    sokerErMor: true
  }
...
}`,...S.parameters?.docs?.source}}};const Ee=["SokerErMor","SokerErFar"];export{S as SokerErFar,A as SokerErMor,Ee as __namedExportsOrder,re as default};
