import{j as e}from"./index-Byyjg8XX.js";import{a as B,e as S,G as q,V as b,Y as X,H as Q,d as f,A as F,L as W,C as $,D as Z,B as c,v as ee,t as re,w as ne,i as ae,E as te,z as se,f as ie,b as le,M as ue,P as ke,r as oe,m as de,c as ge,N as me}from"./nb_NO-DYUjll3t.js";import{e as u,p as w,S as ye,R as ve,c as I,d as pe,y as D,a as Te}from"./index.es-fv94KH-L.js";import"./withPanelData-BfBqLFCK.js";import{r as J}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as Ae}from"./alleKodeverk-DO07GSZv.js";import{T as K}from"./TrueFalseInput-Daw7nzYV.js";import{M as s}from"./message-BrM6o7bT.js";import{T as k,S as qe}from"./Table-CZW3Z5KU.js";import{S as be}from"./Trash-C9VLp8MT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";import"./v4-CtRu48qb.js";import"./entry-preview-DQIMTNBk.js";import"./iframe-CnTIffbJ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var g=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(g||{});const T="egenVirksomhet",i=`${T}.virksomheter`,Re={},Fe=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),E=({index:r,readOnly:n,alleKodeverk:a})=>{const t=B(),l=a.Landkoder.slice().sort((o,d)=>o.navn.localeCompare(d.navn)),{getValues:m}=S();return e.jsx(K,{name:`${i}.${r}.virksomhetRegistrertINorge`,label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(q,{marginTop:8,children:e.jsx(F,{name:`${i}.${r}.organisasjonsnummer`,readOnly:n,validate:[u,I,pe],label:e.jsx(s,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(q,{alignOffset:58,marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(X,{name:`${i}.${r}.landJobberFra`,className:Re.landBredde,selectValues:Fe(l),validate:[u],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(Q,{gap:"4",children:[e.jsx(f,{isReadOnly:n,validate:[u,w,ye],name:`${i}.${r}.fom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(f,{isReadOnly:n,validate:[w,o=>{const d=m(`${i}.${r}.fom`);return d?ve(d,o):null}],name:`${i}.${r}.tom`,label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};E.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:l})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:l}:{landJobberFra:"NOR"}});E.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const ze={title:"ui-komponenter/virksomhet",component:p,parameters:{submitCallback:Te("onSubmit")},args:{readOnly:!1,alleKodeverk:Ae},render:(r,{parameters:{submitCallback:n}})=>{const a=ge({defaultValues:p.initialValues()});return e.jsx(me,{formMethods:a,onSubmit:t=>n(p.transformValues(t)),children:e.jsxs(b,{gap:"10",children:[e.jsx(p,{...r}),e.jsx(c,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},j={};var Y,L,_;j.parameters={...j.parameters,docs:{...(Y=j.parameters)==null?void 0:Y.docs,source:{originalSource:"{}",...(_=(L=j.parameters)==null?void 0:L.docs)==null?void 0:_.source}}};const Xe=["Default"];export{j as Default,Xe as __namedExportsOrder,ze as default};
