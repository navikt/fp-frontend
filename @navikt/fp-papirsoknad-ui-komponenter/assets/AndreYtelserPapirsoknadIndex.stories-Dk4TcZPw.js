import{j as r}from"./index-Byyjg8XX.js";import{a as L,e as D,i as h,$ as I,H as U,d as R,B as S,f as x,V as q,b as H,C as G,G as B,P as $,r as X,m as C,c as z,N as J}from"./nb_NO-DYUjll3t.js";import{e as c,p as w,D as Q,H as W,a as Z}from"./index.es-fv94KH-L.js";import"./withPanelData-CkwF9r8U.js";import{r as Y}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{S as re}from"./Trash-C9VLp8MT.js";import{M as ne}from"./message-BrM6o7bT.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./dayjs.min-DkLNzaWO.js";import"./v4-CtRu48qb.js";import"./entry-preview-w9Yyb_VL.js";import"./iframe-DamG_XGQ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var m=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(m||{});const v="andreYtelser",K="andreYtelserPerioder",b="andreYtelserTyper",f=({readOnly:e,name:a})=>{const n=L(),{getValues:t,control:p,trigger:i,formState:{isSubmitted:y}}=D(),{fields:T,remove:A,append:E}=h({control:p,name:a});return Y.useEffect(()=>{T.length===0&&E({periodeFom:"",periodeTom:""})},[]),r.jsx(I,{fields:T,bodyText:n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:e,append:E,remove:A,children:(O,l)=>{const V=`${a}.${l}`;return r.jsxs(U,{gap:"2",children:[r.jsx(R,{name:`${V}.periodeFom`,label:l===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[c,w,()=>{const{periodeFom:u,periodeTom:d}=t(`${a}.${l}`);return d&&u?Q(d)(u):null}],onChange:()=>y?i():void 0}),r.jsx(R,{name:`${a}.${l}.periodeTom`,label:l===0?n.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[c,w,()=>{const{periodeFom:u,periodeTom:d}=t(`${a}.${l}`);return u&&d?W(u)(d):null}],onChange:()=>y?i():void 0}),!e&&l>0&&r.jsx("div",{children:r.jsx(S,{size:"small",type:"button",variant:"tertiary-neutral",icon:r.jsx(re,{}),onClick:()=>A(l)})})]},O.id)}})};f.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const ae=(e,a)=>a?e.filter(n=>n.kode===m.MILITÆR_ELLER_SIVILTJENESTE):e.filter(n=>n.kode!==m.UTENLANDSK_ARBEIDSFORHOLD&&n.kode!==m.FRILANSER&&n.kode!==m.LONN_UNDER_UTDANNING),o=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:n})=>{const t=n.ArbeidType,p=Y.useMemo(()=>ae(t,a),[a]);return r.jsx(x,{children:r.jsxs(q,{gap:"4",children:[r.jsx(H,{size:"small",children:r.jsx(ne,{id:"Registrering.AndreYtelser.Title"})}),r.jsx(G,{isReadOnly:e,name:`${v}.${b}`,checkboxes:p.map(i=>({label:i.navn,value:i.kode,element:r.jsx(B,{children:r.jsx(f,{name:`${v}.${K}.${i.kode}`,readOnly:e})})}))})]})})};o.initialValues=()=>({[v]:{[b]:[],[K]:{}}});o.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[v]:e.flatMap(n=>a[n].map(t=>({ytelseType:n,...t})))});o.__docgenInfo={description:`AndreYtelserPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const Pe={title:"ui-komponenter/andre-ytelser",component:s,parameters:{submitCallback:Z("onSubmit")},args:{readOnly:!1,alleKodeverk:ee},render:(e,{parameters:{submitCallback:a}})=>{const n=z({defaultValues:s.initialValues()});return r.jsx(J,{formMethods:n,onSubmit:t=>a(s.transformValues(t)),children:r.jsxs(q,{gap:"10",children:[r.jsx(s,{...e}),r.jsx(S,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},k={args:{kunMiliterEllerSiviltjeneste:!1}},g={args:{kunMiliterEllerSiviltjeneste:!0}};var P,j,N;k.parameters={...k.parameters,docs:{...(P=k.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: false
  }
}`,...(N=(j=k.parameters)==null?void 0:j.docs)==null?void 0:N.source}}};var F,_,M;g.parameters={...g.parameters,docs:{...(F=g.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: true
  }
}`,...(M=(_=g.parameters)==null?void 0:_.docs)==null?void 0:M.source}}};const je=["Default","KunMiliterEllerSiviltjeneste"];export{k as Default,g as KunMiliterEllerSiviltjeneste,je as __namedExportsOrder,Pe as default};
