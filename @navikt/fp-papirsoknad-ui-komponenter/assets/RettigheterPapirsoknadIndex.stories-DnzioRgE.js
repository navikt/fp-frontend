var z=Object.defineProperty;var B=(e,r,a)=>r in e?z(e,r,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[r]=a;var c=(e,r,a)=>B(e,typeof r!="symbol"?r+"":r,a);import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{o as F,n as C,a as Q,V as q,b as U,J as W,m as X,c as Z,e as $,B as ee}from"./nb_NO-CoA8CYxJ.js";import"./aktivitetStatus-B1m96ipJ.js";import{F as p}from"./familieHendelseType-CLnpSBng.js";import{F as g}from"./foreldreType-BrQrvOqY.js";import"./index-_2TAQcTa.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BsrZSYsV.js";import"./index-CQwh6Daz.js";var E=(e=>(e.ENGANGSSTONAD="ES",e.FORELDREPENGER="FP",e.SVANGERSKAPSPENGER="SVP",e))(E||{});class u{constructor(r,a,m){c(this,"fagsakYtelseType");c(this,"familieHendelseType");c(this,"foreldreType");this.fagsakYtelseType=F(r),r===E.SVANGERSKAPSPENGER?this.familieHendelseType=p.FODSEL:this.familieHendelseType=F(a),this.foreldreType=F(m)}getFagsakYtelseType(){return this.fagsakYtelseType}getFamilieHendelseType(){return this.familieHendelseType}getForeldreType(){return this.foreldreType}}const R=C(X),d={ANNEN_FORELDER_DOED:"ANNEN_FORELDER_DOED",OVERTA_FORELDREANSVARET_ALENE:"OVERTA_FORELDREANSVARET_ALENE",MANN_ADOPTERER_ALENE:"MANN_ADOPTERER_ALENE",IKKE_RELEVANT:"IKKE_RELEVANT"},D=[{label:R.formatMessage({id:"Registrering.Rettigheter.AnnenForelderDoed"}),value:d.ANNEN_FORELDER_DOED},{label:R.formatMessage({id:"Registrering.Rettigheter.OvertaForeldreansvaretAlene"}),value:d.OVERTA_FORELDREANSVARET_ALENE},{label:R.formatMessage({id:"Registrering.Rettigheter.MannAdoptererAlene"}),value:d.MANN_ADOPTERER_ALENE},{label:R.formatMessage({id:"Registrering.Rettigheter.IkkeRelevant"}),value:d.IKKE_RELEVANT}],l=({readOnly:e,soknadData:r})=>{const m=r.getFamilieHendelseType()!==p.FODSEL&&r.getForeldreType()===g.FAR?D:D.filter(J=>J.value!==d.MANN_ADOPTERER_ALENE);return s.jsx(Q,{children:s.jsxs(q,{gap:"4",children:[s.jsx(U,{size:"small",children:R.formatMessage({id:"Registrering.Rettigheter.Title"})}),s.jsx(W,{name:"rettigheter",isReadOnly:e,radios:m})]})})};l.initialValues=()=>({rettigheter:void 0});l.transformValues=({rettigheter:e})=>e===d.IKKE_RELEVANT?{}:{rettigheter:e};l.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  rettigheter?: string;
...
}`,...(G=(M=t.parameters)==null?void 0:M.docs)==null?void 0:G.source}}};var b,v,H;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    soknadData: new SoknadData(FagsakYtelseType.FORELDREPENGER, FamilieHendelseType.FODSEL, ForeldreType.FAR)
  }
}`,...(H=(v=n.parameters)==null?void 0:v.docs)==null?void 0:H.source}}};var w,x,j;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    soknadData: new SoknadData(FagsakYtelseType.FORELDREPENGER, FamilieHendelseType.ADOPSJON, ForeldreType.MOR)
  }
}`,...(j=(x=o.parameters)==null?void 0:x.docs)==null?void 0:j.source}}};var K,I,Y;i.parameters={...i.parameters,docs:{...(K=i.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    soknadData: new SoknadData(FagsakYtelseType.FORELDREPENGER, FamilieHendelseType.ADOPSJON, ForeldreType.FAR)
  }
}`,...(Y=(I=i.parameters)==null?void 0:I.docs)==null?void 0:Y.source}}};const Re=["MorFødsel","FarFodsel","MorAdopterer","FarAdopterer"];export{i as FarAdopterer,n as FarFodsel,o as MorAdopterer,t as MorFødsel,Re as __namedExportsOrder,me as default};
