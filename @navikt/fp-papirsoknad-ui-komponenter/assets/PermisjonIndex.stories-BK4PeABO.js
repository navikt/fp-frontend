import{u as N,r as I,j as n,d as se,t as p,O as j,f as me,l as he,b as Me,R as $,J,h as C,g as Le,M as xe,m as Ye,P as $e,a as Je}from"./iframe-Bx4g1SCj.js";import{u as F,a as X,P as z,w as c,T as P,g as O,k as te,V as U,L as W,d as Ce,b as Xe,E as ze,m as We,e as Qe,f as Ze,B as er}from"./nb_NO-DNc6Mhwi.js";import{F as Q}from"./foreldreType-BrQrvOqY.js";import{a as rr}from"./alleKodeverk-DO07GSZv.js";import{F as Z}from"./FieldArrayRow-Bg8iNm0n.js";import{M as y}from"./message-CNHoxhRC.js";import{A as Ne}from"./Alert-CpC2N-Lz.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DUjrFvv2.js";var K=(e=>(e.FISKER="FISKER",e.ARBEIDSTAKER="ARBEIDSTAKER",e.SELVSTENDIG_NAERINGSDRIVENDE="SELVSTENDIG_NÆRINGSDRIVENDE",e.KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NAERINGSDRIVENDE="KOMBINASJON_ARBEIDSTAKER_OG_SELVSTENDIG_NÆRINGSDRIVENDE",e.SJOMANN="SJØMANN",e.JORDBRUKER="JORDBRUKER",e.DAGPENGER="DAGPENGER",e.INAKTIV="INAKTIV",e.KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER="KOMBINASJON_ARBEIDSTAKER_OG_JORDBRUKER",e.KOMBINASJON_ARBEIDSTAKER_OG_FISKER="KOMBINASJON_ARBEIDSTAKER_OG_FISKER",e.FRILANSER="FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER="KOMBINASJON_ARBEIDSTAKER_OG_FRILANSER",e.KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER="KOMBINASJON_ARBEIDSTAKER_OG_DAGPENGER",e.DAGMAMMA="DAGMAMMA",e.ANNET="ANNET",e))(K||{}),L=(e=>(e.INGEN="INGEN",e.UTTAK_MØDREKVOTE_ANNEN_FORELDER="UTTAK_MØDREKVOTE_ANNEN_FORELDER",e.UTTAK_FEDREKVOTE_ANNEN_FORELDER="UTTAK_FEDREKVOTE_ANNEN_FORELDER",e.UTTAK_FELLESP_ANNEN_FORELDER="UTTAK_FELLESP_ANNEN_FORELDER",e.UTTAK_FORELDREPENGER_ANNEN_FORELDER="UTTAK_FORELDREPENGER_ANNEN_FORELDER",e["-"]="-",e))(L||{}),Y=(e=>(e.INSTITUSJONSOPPHOLD_ANNEN_FORELDER="INSTITUSJONSOPPHOLD_ANNEN_FORELDER",e.SYKDOM_ANNEN_FORELDER="SYKDOM_ANNEN_FORELDER",e.ALENEOMSORG="ALENEOMSORG",e.IKKE_RETT_ANNEN_FORELDER="IKKE_RETT_ANNEN_FORELDER",e.UDEFINERT="-",e))(Y||{}),b=(e=>(e.MODREKVOTE="MØDREKVOTE",e.FEDREKVOTE="FEDREKVOTE",e.FELLESPERIODE="FELLESPERIODE",e.FORELDREPENGER_FOR_FODSEL="FORELDREPENGER_FØR_FØDSEL",e.FORELDREPENGER="FORELDREPENGER",e.UDEFINERT="-",e))(b||{});const nr=(e,r)=>{if(e==null)throw new Error("Data er ikke oppgitt");return e},d="tidsromPermisjon",_="graderingPeriode",pe="oppholdPerioder",Ue="overforingsperioder",le="utsettelsePeriode",x="permisjonsPerioder",ye=`${d}.${x}`,E=e=>`${ye}.${e}`,ar=he(100),ve=[b.FELLESPERIODE,b.FEDREKVOTE,b.FORELDREPENGER_FOR_FODSEL,b.FORELDREPENGER,b.MODREKVOTE],Se=[b.FEDREKVOTE,b.FORELDREPENGER_FOR_FODSEL,b.MODREKVOTE],ue=({sokerErMor:e,readOnly:r,alleKodeverk:a})=>{const t=N(),s=a.UttakPeriodeType,i=a.MorsAktivitet;i.filter(({kode:m})=>m==="-").length===0&&i.unshift({kode:"-",navn:"",kodeverk:""});const{control:l,getValues:k,trigger:v,watch:T,formState:{isSubmitted:A}}=F(),{fields:u,remove:g,append:o}=X({control:l,name:ye});return I.useEffect(()=>{u.length===0&&o({})},[]),n.jsx(z,{readOnly:r,fields:u,addButtonText:t.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),emptyTemplate:{periodeType:"",periodeFom:"",periodeTom:""},append:o,remove:g,children:(m,q)=>{const f=q===0,S=T(E(q)),D=ir(S.periodeFom),He=Se.some(H=>H===S.periodeType)||S.periodeType==="";return n.jsxs(Z,{readOnly:r,remove:g,index:q,children:[n.jsx("div",{children:n.jsx(c,{name:`${E(q)}.periodeType`,control:l,readOnly:r,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.periodeType"})),selectValues:tr(s),validate:[p]})}),n.jsx(P,{isReadOnly:r,control:l,name:`${E(q)}.periodeFom`,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.periodeFom"})),validate:[p,j,Re(k,q,!0),qe(k)],onChange:()=>A?v():void 0}),n.jsx(P,{isReadOnly:r,control:l,name:`${E(q)}.periodeTom`,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.periodeTom"})),validate:[p,j,Re(k,q,!1),qe(k)],onChange:()=>A?v():void 0}),!e&&n.jsx(c,{name:`${E(q)}.morsAktivitet`,control:l,readOnly:r,disabled:He,label:ee(f,t.formatMessage({id:"Registrering.Permisjon.Fellesperiode.morsAktivitet"})),selectValues:sr(i),hideValueOnDisable:!0}),n.jsx("div",{children:n.jsx(O,{name:`${E(q)}.flerbarnsdager`,control:l,readOnly:r,label:n.jsx(y,{id:"Registrering.Permisjon.Flerbarnsdager"})})}),n.jsx("div",{children:n.jsx(O,{name:`${E(q)}.harSamtidigUttak`,control:l,readOnly:r,label:n.jsx(y,{id:"Registrering.Permisjon.HarSamtidigUttak"})})}),S.harSamtidigUttak&&n.jsx(te,{name:`${E(q)}.samtidigUttaksprosent`,control:l,validate:[me,ar],label:t.formatMessage({id:"Registrering.Permisjon.SamtidigUttaksprosent"}),normalizeOnBlur:H=>Number.isNaN(H)?H:Number.parseFloat(H.toString()).toFixed(2)}),D&&n.jsx(Ne,{size:"small",variant:"warning",children:n.jsx(y,{id:"Registrering.Permisjon.PeriodeFomForTidlig"})})]},m.id)}})};ue.transformValues=e=>e.map(r=>Se.some(a=>a===r.periodeType)?{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,flerbarnsdager:r.flerbarnsdager??!1,harSamtidigUttak:r.harSamtidigUttak??!1,samtidigUttaksprosent:r.samtidigUttaksprosent}:{periodeType:r.periodeType,periodeFom:r.periodeFom,periodeTom:r.periodeTom,morsAktivitet:r.morsAktivitet,flerbarnsdager:r.flerbarnsdager??!1,harSamtidigUttak:r.harSamtidigUttak??!1,samtidigUttaksprosent:r.samtidigUttaksprosent});const tr=e=>e.filter(({kode:r})=>ve.includes(r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),sr=e=>e.map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),ee=(e,r)=>e?r:"",ir=e=>!!e&&se(e,Me).isBefore(se("2019-01-01")),qe=e=>()=>{const a=(e(ye)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return C(a)},Re=(e,r,a)=>()=>{const t=e(`${E(r)}.periodeFom`),s=e(`${E(r)}.periodeTom`);return!s||!t?null:a?$(s)(t):J(t)(s)};ue.__docgenInfo={description:`RenderPermisjonPeriodeFieldArray
...
Viser inputfelter for dato for bestemmelse av graderingperiode.`,methods:[],displayName:"RenderGraderingPeriodeFieldArray",props:{graderingKvoter:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Arbeidskategori'>[]"},description:""}}};const G=({readOnly:e,alleKodeverk:r})=>{const a=r.UttakPeriodeType,t=r.Arbeidskategori,{watch:s,control:i}=F(),l=s(`${d}.skalGradere`)||!1;return n.jsxs(U,{gap:"space-8",children:[n.jsx(W,{children:n.jsx(y,{id:"Registrering.Permisjon.Gradering.Title"})}),n.jsx(O,{name:`${d}.skalGradere`,control:i,readOnly:e,label:n.jsx(y,{id:"Registrering.Permisjon.Gradering.GraderUttaket"})}),l&&n.jsx(_e,{graderingKvoter:a,arbeidskategoriTyper:t,readOnly:e})]})};G.transformValues=e=>{const r=e[_];return r?r.map(a=>a.arbeidskategoriType?{...a,erArbeidstaker:a.arbeidskategoriType===K.ARBEIDSTAKER,erFrilanser:a.arbeidskategoriType===K.FRILANSER,erSelvstNæringsdrivende:a.arbeidskategoriType===K.SELVSTENDIG_NAERINGSDRIVENDE}:a):[]};G.initialValues=()=>({[_]:[],skalGradere:!1});G.__docgenInfo={description:`PermisjonGraderingPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Te=`${d}.${pe}`,w=e=>`${Te}.${e}`,Pe=e=>()=>{const a=(e(`${Te}`)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?C(a):void 0},be={periodeFom:"",periodeTom:"",årsak:""},mr=new Set([L.UTTAK_MØDREKVOTE_ANNEN_FORELDER,L.UTTAK_FEDREKVOTE_ANNEN_FORELDER,L.UTTAK_FELLESP_ANNEN_FORELDER,L.UTTAK_FORELDREPENGER_ANNEN_FORELDER]),pr=e=>e.filter(({kode:r})=>mr.has(r)).map(({kode:r,navn:a})=>n.jsx("option",{value:r,children:a},r)),Ie=({oppholdsReasons:e,readOnly:r})=>{const a=N(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:l}}=F(),{fields:k,remove:v,append:T}=X({control:t,name:`${Te}`});return I.useEffect(()=>{k.length===0&&T(be)},[]),n.jsx(z,{fields:k,emptyTemplate:be,addButtonText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:T,remove:v,children:(A,u)=>n.jsxs(Z,{readOnly:r,remove:v,index:u,children:[n.jsx(P,{name:`${w(u)}.periodeFom`,control:t,label:a.formatMessage({id:"Registrering.Permisjon.periodeFom"}),validate:[p,j,()=>{const g=s(`${w(u)}.periodeFom`),o=s(`${w(u)}.periodeTom`);return o&&g?$(o)(g):null},Pe(s)],onChange:()=>l?i():void 0}),n.jsx(P,{name:`${w(u)}.periodeTom`,control:t,label:a.formatMessage({id:"Registrering.Permisjon.periodeTom"}),validate:[p,j,()=>{const g=s(`${w(u)}.periodeFom`),o=s(`${w(u)}.periodeTom`);return o&&g?J(g)(o):null},Pe(s)],onChange:()=>l?i():void 0}),n.jsx("div",{children:n.jsx(c,{name:`${w(u)}.årsak`,control:t,label:a.formatMessage({id:"Registrering.Permisjon.Opphold.Arsak"}),selectValues:pr(e),validate:[p]})})]},A.id)})};Ie.__docgenInfo={description:`RenderOppholdPeriodeFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Ae=`${d}.${Ue}`,V=e=>`${Ae}.${e}`,ce=e=>()=>{const a=(e(Ae)??[]).filter(({periodeFom:t,periodeTom:s})=>t!==""&&s!=="").map(({periodeFom:t,periodeTom:s})=>[t,s]);return a.length>0?C(a):void 0},Ke={periodeFom:"",periodeTom:"",overforingArsak:""},Ge=({selectValues:e,readOnly:r})=>{const a=N(),{control:t,getValues:s,trigger:i,formState:{isSubmitted:l}}=F(),{fields:k,remove:v,append:T}=X({control:t,name:Ae});return I.useEffect(()=>{k.length===0&&T(Ke)},[]),n.jsx(z,{fields:k,emptyTemplate:Ke,addButtonText:a.formatMessage({id:"Registrering.Permisjon.nyPeriode"}),readOnly:r,append:T,remove:v,children:(A,u)=>n.jsxs(Z,{readOnly:r,remove:v,index:u,children:[n.jsx("div",{children:n.jsx(c,{name:`${V(u)}.overforingArsak`,control:t,label:a.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.AngiArsak"}),selectValues:e,validate:[p],readOnly:r})}),n.jsx(P,{name:`${V(u)}.periodeFom`,control:t,isReadOnly:r,validate:[p,j,()=>{const g=s(`${V(u)}.periodeFom`),o=s(`${V(u)}.periodeTom`);return o&&g?$(o)(g):null},ce(s)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.fomDato"}),onChange:()=>l?i():void 0}),n.jsx(P,{name:`${V(u)}.periodeTom`,control:t,isReadOnly:r,validate:[p,j,()=>{const g=s(`${V(u)}.periodeFom`),o=s(`${V(u)}.periodeTom`);return o&&g?J(g)(o):null},ce(s)],label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.tomDato"}),onChange:()=>l?i():void 0})]},A.id)})};Ge.__docgenInfo={description:`RenderOverforingAvKvoterFieldArray

Viser inputfelter for dato for bestemmelse av overføring.`,methods:[],displayName:"RenderOverforingAvKvoterFieldArray",props:{selectValues:{required:!0,tsType:{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const yr=(e,r,a)=>r===Y.INSTITUSJONSOPPHOLD_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErInnlagt"}):r===Y.SYKDOM_ANNEN_FORELDER?e.formatMessage({id:"Registrering.Permisjon.OverforingAvKvote.Arsak.MorErSyk"}):a,vr=(e,r,a,t)=>e.filter(({kode:s})=>a||s!==Y.ALENEOMSORG&&s!==Y.IKKE_RETT_ANNEN_FORELDER).map(({kode:s,navn:i})=>r?n.jsx("option",{value:s,children:i},s):n.jsx("option",{value:s,children:yr(t,s,i)},s)),ke=({foreldreType:e,alleKodeverk:r,readOnly:a,erEndringssøknad:t})=>{const s=N(),i=r.OverføringÅrsak,l=vr(i,e===Q.MOR,t,s),{watch:k,control:v}=F(),T=k(`${d}.skalOvertaKvote`)||!1;return n.jsxs(U,{gap:"space-8",children:[n.jsx(W,{children:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvoten"})}),n.jsx(O,{name:`${d}.skalOvertaKvote`,control:v,readOnly:a,label:n.jsx(y,{id:"Registrering.Permisjon.OverforingAvKvote.OvertaKvote"})}),T&&n.jsx(Ge,{selectValues:l,readOnly:a})]})};ke.initialValues=()=>({skalOvertaKvote:!1,overforingsperioder:[]});ke.__docgenInfo={description:`PermisjonOverforingAvKvoterPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const B=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>{const s=N(),{setError:i,clearErrors:l,formState:k,watch:v}=F(),[T,A,u,g]=v([`${d}.fulltUttak`,`${d}.skalGradere`,`${d}.skalUtsette`,`${d}.skalOvertaKvote`]);return I.useEffect(()=>{!T&&!A&&!u&&!g?i(`${d}.notRegisteredInput`,{type:"custom",message:s.formatMessage({id:"PermisjonPanel.MinstEnPeriodeRequired"})}):l(`${d}.notRegisteredInput`)},[T,A,u,g]),n.jsx(Ce,{children:n.jsxs(U,{gap:"space-16",children:[n.jsx(Xe,{size:"small",level:"3",children:n.jsx(y,{id:"Registrering.Permisjon.Title"})}),n.jsx(oe,{foreldreType:e,readOnly:r,alleKodeverk:a}),n.jsx(ke,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t}),n.jsx(ge,{readOnly:r,alleKodeverk:a}),n.jsx(G,{readOnly:r,alleKodeverk:a}),n.jsx(de,{readOnly:r,alleKodeverk:a}),k.isSubmitted&&k.errors[d]?.notRegisteredInput?.message&&n.jsx(ze,{children:k.errors[d].notRegisteredInput.message})]})})};B.transformValues=e=>{const r=nr(e[d]),a=r,t=r[x];e.tidsromPermisjon?.fulltUttak&&t&&(a[x]=ue.transformValues(t));const s=r[_];return e.tidsromPermisjon?.skalGradere&&s&&(a[_]=G.transformValues(r)),e.tidsromPermisjon?.fulltUttak||(a[x]=void 0),e.tidsromPermisjon?.skalGradere||(a[_]=void 0),e.tidsromPermisjon?.skalUtsette||(a[le]=void 0),e.tidsromPermisjon?.skalOvertaKvote||(a[Ue]=void 0),e.tidsromPermisjon?.skalHaOpphold||(a[pe]=void 0),{[d]:a}};B.initialValues=()=>({[d]:{...oe.initialValues(),...ke.initialValues(),...ge.initialValues(),...G.initialValues(),...de.initialValues()}});B.__docgenInfo={description:`PermisjonPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const qr=Je(We),M=({foreldreType:e,readOnly:r,alleKodeverk:a,erEndringssøknad:t})=>n.jsx($e,{value:qr,children:n.jsx(B,{readOnly:r,foreldreType:e,alleKodeverk:a,erEndringssøknad:t})});M.transformValues=B.transformValues;M.initialValues=B.initialValues;M.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:Rr}=__STORYBOOK_MODULE_ACTIONS__,wr={title:"ui-komponenter/permisjon",component:M,parameters:{submitCallback:Rr("onSubmit")},args:{readOnly:!1,alleKodeverk:rr},render:(e,{parameters:{submitCallback:r}})=>{const a=Qe({defaultValues:M.initialValues()});return n.jsx(Ze,{formMethods:a,onSubmit:t=>r(M.transformValues(t)),children:n.jsxs(U,{gap:"space-40",children:[n.jsx(M,{...e}),n.jsx(er,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},re={args:{foreldreType:Q.MOR,erEndringssøknad:!1}},ne={args:{foreldreType:Q.FAR,erEndringssøknad:!1}},ae={args:{foreldreType:Q.MOR,erEndringssøknad:!0}};re.parameters={...re.parameters,docs:{...re.parameters?.docs,source:{originalSource:`{
  args: {
