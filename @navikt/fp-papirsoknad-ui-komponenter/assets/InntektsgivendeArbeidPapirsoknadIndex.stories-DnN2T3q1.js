import{u as K,j as a,o as G,O as v,P,e as F}from"./iframe-BqnEFk-y.js";import{u as V,a as s,M,e as B,T as _,w as U,c as o,V as S,b as d,D as k,m as y,d as g,P as p,B as H}from"./nb_NO-DISyZyHa.js";import{a as J}from"./alleKodeverk-BnsD7hyO.js";import{F as Y}from"./FieldArrayRow-CJBBSDdh.js";import{M as A}from"./message-CZv0OR3R.js";import"./preload-helper-PPVm8Dsz.js";import"./index-_9OiTaIa.js";const i="arbeidsforhold",w=G(50),q=l=>l.filter(({kode:e})=>e!=="NOR").map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),I=({alleKodeverk:l,readOnly:e})=>{const n=K(),{control:E}=V(),{fields:L,remove:T,append:D}=s({control:E,name:i}),O=l.Landkoder.slice().sort((m,r)=>m.navn.localeCompare(r.navn));return a.jsx(M,{fields:L,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:T,append:D,children:(m,r)=>a.jsxs(Y,{remove:T,index:r,readOnly:e,children:[a.jsx(B,{readOnly:e,control:E,name:`${i}.${r}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[w],maxLength:99}),a.jsx(_,{name:`${i}.${r}.periodeFom`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[v]}),a.jsx(_,{name:`${i}.${r}.periodeTom`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[v]}),a.jsx(U,{name:`${i}.${r}.land`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:q(O),size:"small"})]},m.id)})};I.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
