import{j as e}from"./jsx-runtime-DjgmBYnU.js";import{j as _,d as I,q as E,r as L,H as B,k as O,e as K,i as M,M as m,s as C,L as G,a as J,V as S,b as Q,D as U,n as Y,P as Z,m as ee,c as re,W as ae,B as ne}from"./nb_NO-CbRPWb2t.js";import{O as w,D as X,H as z,l as ie,e as N,a as oe}from"./index.es-BYNffZI8.js";import{T as P}from"./TrueFalseInput-CIbK-D8R.js";import{r as te}from"./index-D7mKeUb6.js";import{d as T}from"./dayjs.min-Boho2IT3.js";import"./index-DjXIRphR.js";import"./index-BdR6VAUc.js";import"./index-DCOq8Jev.js";import"./v4-CtRu48qb.js";const o="frilans",v=(r,a)=>r(a),se=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,i)=>T(a,M).diff(T(i,M))),le=ie(50),de=(r,a,i,n)=>()=>{const d=v(r,`${a}.fomDato`);return i.length>0&&i[0]&&d&&!T(i[0]).isSameOrBefore(T(d))?n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},W=({readOnly:r})=>{const a=_(),{control:i,getValues:n,watch:d,trigger:g,formState:{isSubmitted:c}}=I(),{fields:V,remove:A,append:x}=E({control:i,name:`${o}.oppdragPerioder`}),F=d(`${o}.perioder`),h=te.useMemo(()=>se(F),[F]);return e.jsx(L,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:V,readOnly:r,append:x,remove:A,children:(t,p,s)=>{const l=`${o}.oppdragPerioder.${p}`;return e.jsxs(B,{gap:"4",paddingBlock:"2",align:"end",children:[e.jsx(O,{name:`${l}.fomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[w,de(n,l,h,a),()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?X(b)(f):null}],onChange:()=>c?g():void 0}),e.jsx(O,{name:`${l}.tomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[w,()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?z(f)(b):null}],onChange:()=>c?g():void 0}),e.jsx(K,{name:`${l}.oppdragsgiver`,validate:[le],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},t.id)}})};W.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const y=({readOnly:r})=>{const{watch:a}=I(),i=a(`${o}.harHattOppdragForFamilie`);return e.jsxs(e.Fragment,{children:[e.jsx(P,{name:`${o}.harHattOppdragForFamilie`,label:e.jsx(m,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),i&&e.jsxs(C,{children:[e.jsx(G,{size:"small",children:e.jsx(m,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(W,{readOnly:r})]})]})};y.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});y.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});y.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
