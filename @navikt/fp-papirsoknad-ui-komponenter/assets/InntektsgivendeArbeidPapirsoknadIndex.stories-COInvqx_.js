import{u as O,j as a,o as G,O as T,P,e as F}from"./iframe-CayaqC7Q.js";import{u as V,a as s,C as M,T as B,y as _,w as U,c as o,V as S,b as k,D as d,m as y,f as g,P as p,B as H}from"./nb_NO-CGAi3Ezg.js";import{a as J}from"./alleKodeverk-BnsD7hyO.js";import{F as Y}from"./FieldArrayRow-B0Or6Eqw.js";import{M as A}from"./message-CJlc27gU.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DJpVPxS0.js";const i="arbeidsforhold",w=G(50),q=l=>l.filter(({kode:e})=>e!=="NOR").map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),I=({alleKodeverk:l,readOnly:e})=>{const n=O(),{control:E}=V(),{fields:L,remove:v,append:D}=s({control:E,name:i}),K=l.Landkoder.slice().sort((R,r)=>R.navn.localeCompare(r.navn));return a.jsx(M,{fields:L,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:v,append:D,children:(R,r)=>a.jsxs(Y,{remove:v,index:r,readOnly:e,children:[a.jsx(B,{readOnly:e,control:E,name:`${i}.${r}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[w],maxLength:99}),a.jsx(_,{name:`${i}.${r}.periodeFom`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[T]}),a.jsx(_,{name:`${i}.${r}.periodeTom`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[T]}),a.jsx(U,{name:`${i}.${r}.land`,control:E,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:q(K),size:"small"})]},R.id)})};I.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
