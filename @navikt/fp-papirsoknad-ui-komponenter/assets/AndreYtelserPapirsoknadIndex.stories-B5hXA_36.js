...
Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const Pe={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:Z("onSubmit")},args:{readOnly:!1,alleKodeverk:re},render:(e,{parameters:{submitCallback:t}})=>{const n=z({defaultValues:i.initialValues()});return r.jsx(J,{formMethods:n,onSubmit:a=>t(i.transformValues(a)),children:r.jsxs(S,{gap:"10",children:[r.jsx(i,{...e}),r.jsx(j,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{kunMiliterEllerSiviltjeneste:!1}},g={args:{kunMiliterEllerSiviltjeneste:!0}};var N,Y,P;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: false
  }
}`,...(P=(Y=p.parameters)==null?void 0:Y.docs)==null?void 0:P.source}}};var q,w,f;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    kunMiliterEllerSiviltjeneste: true
  }
}`,...(f=(w=g.parameters)==null?void 0:w.docs)==null?void 0:f.source}}};const qe=["Default","KunMiliterEllerSiviltjeneste"];export{p as Default,g as KunMiliterEllerSiviltjeneste,qe as __namedExportsOrder,Pe as default};
