import{u as V,r as y,j as a,t as D,O as L,R as F,J as M,P as U,a as B}from"./iframe-B3mwpBdq.js";import{u as A,a as q,P as H,H as Y,T as g,d as w,V as S,b as c,j,C as b,c as h,m as f,e as J,f as x,B as $}from"./nb_NO-914M1zyU.js";import{a as C}from"./alleKodeverk-DO07GSZv.js";import{M as X}from"./message-Bo9mlm5u.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ce-IuvG_.js";const m="andreYtelser",I="andreYtelserPerioder",_="andreYtelserTyper",p=({readOnly:n,name:r})=>{const e=V(),{getValues:l,control:t,trigger:E,formState:{isSubmitted:d}}=A(),{fields:o,remove:G,append:k}=q({control:t,name:r});return y.useEffect(()=>{o.length===0&&k({periodeFom:"",periodeTom:""})},[]),a.jsx(H,{fields:o,addButtonText:e.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:n,append:k,remove:G,children:(O,u,K)=>{const P=`${r}.${u}`;return a.jsxs(Y,{gap:"space-8",align:"end",children:[a.jsx(g,{name:`${P}.periodeFom`,control:t,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[D,L,()=>{const{periodeFom:s,periodeTom:R}=l(`${r}.${u}`);return R&&s?F(R)(s):null}],onChange:()=>d?E():void 0}),a.jsx(g,{name:`${r}.${u}.periodeTom`,control:t,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[D,L,()=>{const{periodeFom:s,periodeTom:R}=l(`${r}.${u}`);return s&&R?M(s)(R):null}],onChange:()=>d?E():void 0}),a.jsx("div",{children:K})]},O.id)}})};p.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const T=({readOnly:n,kunMiliterEllerSiviltjeneste:r=!1,alleKodeverk:e})=>{const{control:l}=A(),t=W(e.ArbeidType,r);return a.jsx(w,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(c,{size:"small",level:"3",children:a.jsx(X,{id:"Registrering.AndreYtelser.Title"})}),a.jsx(j,{name:`${m}.${_}`,control:l,isReadOnly:n,children:t.map(E=>a.jsx(z,{arbeidstype:E,readOnly:n},E.kode))})]})})};T.initialValues=()=>({[m]:{[_]:[],[I]:{}}});T.transformValues=({andreYtelser:{andreYtelserTyper:n,andreYtelserPerioder:r}})=>({[m]:n.flatMap(e=>r[e]?.map(l=>({ytelseType:e,...l}))).filter(e=>e!==void 0)});const z=({arbeidstype:n,readOnly:r})=>{const{watch:e}=A(),l=e(`${m}.${_}`),[t,E]=y.useState(l.includes(n.kode));return a.jsxs(S,{gap:"space-12",children:[a.jsx(b,{value:n.kode,onClick:()=>E(!t),disabled:r,children:n.navn}),t&&a.jsx(h,{children:a.jsx(p,{name:`${m}.${I}.${n.kode}`,readOnly:r})})]})},W=(n,r)=>r?n.filter(e=>e.kode==="MILITÆR_ELLER_SIVILTJENESTE"):n.filter(e=>e.kode!=="UTENLANDSK_ARBEIDSFORHOLD"&&e.kode!=="FRILANSER"&&e.kode!=="LØNN_UNDER_UTDANNING");T.__docgenInfo={description:`AndreYtelserPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:Z}=__STORYBOOK_MODULE_ACTIONS__,Ee={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:Z("onSubmit")},args:{readOnly:!1,alleKodeverk:C},render:(n,{parameters:{submitCallback:r}})=>{const e=J({defaultValues:i.initialValues()});return a.jsx(x,{formMethods:e,onSubmit:l=>r(i.transformValues(l)),children:a.jsxs(S,{gap:"space-40",children:[a.jsx(i,{...n}),a.jsx($,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},N={args:{kunMiliterEllerSiviltjeneste:!1}},v={args:{kunMiliterEllerSiviltjeneste:!0}};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...v.parameters?.docs?.source}}};const ie=["Default","KunMiliterEllerSiviltjeneste"];export{N as Default,v as KunMiliterEllerSiviltjeneste,ie as __namedExportsOrder,Ee as default};
