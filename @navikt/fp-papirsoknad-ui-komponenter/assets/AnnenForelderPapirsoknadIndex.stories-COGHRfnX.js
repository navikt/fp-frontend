import{u as P,j as e,t as v,k as U,M as B,y as g,P as p,a as y}from"./iframe-BaKRzsr5.js";import{u as o,k as G,V as N,g as H,c as J,b as V,S as Y,R as F,w,d as q,m as c,e as C,f,B as b}from"./nb_NO-Ba4QRLEq.js";import{a as j}from"./alleKodeverk-DO07GSZv.js";import{M as s}from"./message-D63OQ_J3.js";import{T}from"./TrueFalseInput-ARvLKk2r.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Wt1DB4Yy.js";const E="annenForelder",_="kanIkkeOppgiBegrunnelse",h="_inputBredde_138ho_1",O={inputBredde:h},Z=a=>a.filter(({kode:n})=>n!=="NOR").map(({kode:n,navn:l})=>e.jsx("option",{value:n,children:l},n)),I=({readOnly:a=!0,alleKodeverk:n,fagsakPersonnummer:l})=>{const{formatMessage:r}=P(),{watch:i,control:t,trigger:R,formState:{isSubmitted:D}}=o(),K=i(`${E}.kanIkkeOppgiAnnenForelder`),M=i(`${E}.${_}`),k=n.Landkoder.slice().sort((m,d)=>m.navn.localeCompare(d.navn));return e.jsxs(e.Fragment,{children:[e.jsx(G,{name:`${E}.foedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:m=>m&&m.toString().replace(/\s/g,""),readOnly:a,className:O.inputBredde,validate:K?[]:[v,U,B,g(l)],disabled:K}),e.jsxs(N,{gap:"space-12",children:[e.jsx(H,{name:`${E}.kanIkkeOppgiAnnenForelder`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:a,onChange:()=>D?R():void 0}),K===!0&&e.jsx(J,{children:e.jsxs(N,{gap:"space-16",children:[e.jsx(V,{size:"small",level:"4",children:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsxs(Y,{name:`${E}.${_}.arsak`,control:t,hideLegend:!0,validate:[v],isReadOnly:a,children:[e.jsx(F,{value:"UKJENT_FORELDER",size:"small",children:e.jsx(s,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"})}),e.jsx(F,{value:"IKKE_NORSK_FNR",size:"small",children:e.jsx(s,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"})})]}),M?.arsak==="IKKE_NORSK_FNR"&&e.jsxs(e.Fragment,{children:[e.jsx(w,{name:`${E}.${_}.land`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:Z(k),validate:[v],className:O.inputBredde,readOnly:a}),e.jsx(G,{name:`${E}.${_}.utenlandskFoedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[v],className:O.inputBredde,readOnly:a})]})]})})]})]})};I.transformValues=({foedselsnummer:a,kanIkkeOppgiAnnenForelder:n,kanIkkeOppgiBegrunnelse:{arsak:l,land:r,utenlandskFoedselsnummer:i}={}})=>n?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:l==="IKKE_NORSK_FNR"?{arsak:l,land:r,utenlandskFoedselsnummer:i}:{arsak:l}}:{foedselsnummer:a,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};I.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""}}};const L=({readOnly:a,sokerErMor:n})=>{const l=P(),{watch:r,control:i}=o(),t=r(`${E}.sokerHarAleneomsorg`),R=r(`${E}.denAndreForelderenHarRettPaForeldrepenger`),D=r(`${E}.annenForelderRettEØS`);return e.jsxs(N,{gap:"space-16",children:[e.jsx(T,{name:`${E}.sokerHarAleneomsorg`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.SøkerHarAleneomsorg"}),readOnly:a}),t===!1&&e.jsx(T,{name:`${E}.denAndreForelderenHarRettPaForeldrepenger`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.HarRettPaForeldrepenger"}),readOnly:a}),t===!1&&R===!1&&e.jsx(T,{name:`${E}.annenForelderRettEØS`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.AnnenForelderRettEØS"}),readOnly:a}),!n&&t===!1&&R===!1&&D===!1&&e.jsx(T,{name:`${E}.morMottarUføretrygd`,control:i,label:l.formatMessage({id:"Registrering.Permisjon.MorUføretrygd"}),readOnly:a})]})};L.transformValues=({sokerHarAleneomsorg:a,denAndreForelderenHarRettPaForeldrepenger:n,annenForelderRettEØS:l,morMottarUføretrygd:r})=>({sokerHarAleneomsorg:a,denAndreForelderenHarRettPaForeldrepenger:a===!1?n:void 0,annenForelderRettEØS:n===!1?l:void 0,morMottarUføretrygd:l===!1?r:void 0});L.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  sokerHarAleneomsorg,
