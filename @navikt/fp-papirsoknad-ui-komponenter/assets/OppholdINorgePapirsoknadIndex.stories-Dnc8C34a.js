import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as L,f as C,i as G,N as J,H as Q,M as W,e as w,h as R,b as X,V as f,c as Y,G as V,P as Z,r as ee,m as re,d as ne,O as ae,B as oe}from"./nb_NO-Dgf0h_H8.js";import{e as F,O as I,D as b,H as j,h as se,a as te}from"./index.es-DvPLDgLx.js";import"./withPanelData-B8vePbRu.js";import{r as _,R as ie}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as le,a as de}from"./alleKodeverk-BGvpDL3l.js";import{T as q}from"./TrueFalseInput-t3sn4uT6.js";import{d as U}from"./dayjs.min-DkLNzaWO.js";import{L as pe}from"./landkoder-tJDPMx5C.js";import{M as T}from"./message-jrx8476M.js";import"./index-PUjTtqh4.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-CduBMtqG.js";import"./iframe-CZhFKDLd.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";const me={land:void 0,periodeFom:void 0,periodeTom:void 0},c=(n,r)=>n(r),K=(n,r)=>()=>{const t=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return t.length>0?se(t):void 0},ue=n=>n.filter(({kode:r})=>r!==pe.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),x=(n,r,o,t)=>()=>{const s=c(n,`${r}.${o}.periodeFom`),a=c(n,`${r}.${o}.periodeTom`);return!a||!s?null:t?b(a)(s):j(s)(a)},A=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:t})=>{const s=L(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:u,getValues:i,trigger:g,formState:{isSubmitted:v}}=C(),{fields:h,remove:z,append:B}=G({control:u,name:a}),D=_.useMemo(()=>ue(t),[t]);return e.jsx(J,{fields:h,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:me,readOnly:o,remove:z,append:B,children:(O,l,N)=>e.jsx(ie.Fragment,{children:e.jsxs(Q,{gap:"4",paddingBlock:"2",children:[e.jsx(W,{name:`${a}.${l}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:D,readOnly:o,validate:[F]}),e.jsx(w,{name:`${a}.${l}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[F,I,x(i,a,l,!0),()=>{const m=c(i,`${a}.${l}.periodeFom`);return n?b(U().format(R))(m):r?j(r)(m):void 0},K(i,a)],onChange:()=>v?g():void 0}),e.jsx(w,{name:`${a}.${l}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[F,I,x(i,a,l,!1),()=>{const m=c(i,`${a}.${l}.periodeTom`);return n?b(U().format(R))(m):r?j(r)(m):void 0},K(i,a)],onChange:()=>v?g():void 0}),N&&e.jsx("div",{children:N()})]},O.id)},O.id)})};A.__docgenInfo={description:`UtenlandsOppholdField
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const xe={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:te("onSubmit")},args:{readOnly:!1,alleKodeverk:de,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const o=ne({defaultValues:d.initialValues()});return e.jsx(ae,{formMethods:o,onSubmit:t=>r(d.transformValues(t)),children:e.jsxs(f,{gap:"10",children:[e.jsx(d,{...n}),e.jsx(oe,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},k={args:{erAdopsjon:!1}},y={args:{erAdopsjon:!0}};var P,M,S;k.parameters={...k.parameters,docs:{...(P=k.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
...
}`,...(H=(E=y.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};const Pe=["ForFodsel","ForAdopsjon"];export{y as ForAdopsjon,k as ForFodsel,Pe as __namedExportsOrder,xe as default};
