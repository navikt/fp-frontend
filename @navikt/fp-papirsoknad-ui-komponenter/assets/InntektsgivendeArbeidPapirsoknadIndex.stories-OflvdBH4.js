import{u as G,j as a,o as K,O as T,P as O,a as k}from"./iframe-CEXpT7hR.js";import{u as d,a as P,P as o,k as F,T as A,w as M,d as V,V as _,b as U,D as g,m as y,e as B,f as p,B as H}from"./nb_NO-BWbLkVCC.js";import{a as Y}from"./alleKodeverk-DO07GSZv.js";import{F as J}from"./FieldArrayRow-DG4O5Qob.js";import{M as S}from"./message-Fn81Dywe.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DacWvyjk.js";const E="arbeidsforhold",q=K(50),w=l=>l.filter(({kode:e})=>e!=="NOR").map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),s=({alleKodeverk:l,readOnly:e})=>{const n=G(),{control:r}=d(),{fields:L,remove:N,append:I}=P({control:r,name:E}),D=l.Landkoder.slice().sort((R,t)=>R.navn.localeCompare(t.navn));return a.jsx(o,{fields:L,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:N,append:I,children:(R,t)=>a.jsxs(J,{remove:N,index:t,readOnly:e,children:[a.jsx(F,{readOnly:e,control:r,name:`${E}.${t}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[q],maxLength:99}),a.jsx(A,{name:`${E}.${t}.periodeFom`,control:r,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[T]}),a.jsx(A,{name:`${E}.${t}.periodeTom`,control:r,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[T]}),a.jsx(M,{name:`${E}.${t}.land`,control:r,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:w(D),size:"small"})]},R.id)})};s.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const u=({readOnly:l,alleKodeverk:e})=>a.jsx(V,{children:a.jsxs(_,{gap:"space-16",children:[a.jsx(U,{size:"small",level:"3",children:a.jsx(S,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),a.jsx(g,{children:a.jsx(S,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),a.jsx(s,{readOnly:l,alleKodeverk:e})]})});u.initialValues=()=>({[E]:[]});const m=l=>l===void 0||l==="";u.transformValues=({arbeidsforhold:l})=>({arbeidsforhold:l?.filter(e=>!(m(e.arbeidsgiver)&&m(e.land)&&m(e.periodeFom)&&m(e.periodeTom)))});u.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const C=k(y),i=({readOnly:l,alleKodeverk:e})=>a.jsx(O,{value:C,children:a.jsx(u,{readOnly:l,alleKodeverk:e})});i.initialValues=u.initialValues;i.transformValues=u.transformValues;i.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
