import{j as r}from"./jsx-runtime-Cw0GR0a5.js";import{d as C,e as E,i as X,I as Z,K as ee,y as p,p as re,W as ae,c as ne,L as k,O as I,A as N,S as oe,H as le,M as F,k as x,f as q,t as se,P as te,m as de,a as z,b as ie,$ as pe,B as me}from"./nb_NO-ChFoZt4c.js";import"./withRouter-xu-IZtWb.js";import{K as ue,a as ge}from"./alleKodeverk-IAKI_QEc.js";import{g as he,r as L,R as fe}from"./index-CTjT7uj6.js";import{r as u,b as R,I as j,h as T,c as V,q as ce}from"./index.es-4qz0VVu1.js";import{l as ye}from"./landkoder-T-1RG3zx.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-DQZRloWl.js";import"./index-vZN_Bsf0.js";var H={exports:{}};/*!
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!0,tsType:{name:"boolean"},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const g=({readOnly:a=!0,alleKodeverk:n,mottattDato:l,erAdopsjon:d})=>{const{formatMessage:o}=C(),e=L.useMemo(()=>n[ue.LANDKODER].slice().sort((O,b)=>O.navn.localeCompare(b.navn)),[n]),{watch:s}=E(),t=s("harTidligereOppholdUtenlands")||!1,y=s("harFremtidigeOppholdUtenlands")||!1;return r.jsxs(oe,{children:[r.jsx(le,{size:"small",children:r.jsx(F,{id:"Registrering.Opphold"})}),r.jsx(p,{sixteenPx:!0}),r.jsx(x,{name:"oppholdINorge",label:r.jsx(F,{id:d?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),validate:[u],isReadOnly:a,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:o({id:"Registrering.Opphold.Yes"}),value:"true"},{label:o({id:"Registrering.Opphold.No"}),value:"false"}]}),r.jsx(p,{sixteenPx:!0}),r.jsx(x,{name:"harTidligereOppholdUtenlands",label:r.jsx(F,{id:"Registrering.OppholdSisteTolv"}),validate:[u],isReadOnly:a,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:o({id:"Registrering.Opphold.Yes"}),value:"false"},{label:o({id:"Registrering.Opphold.No"}),value:"true"}]}),t?r.jsxs(r.Fragment,{children:[r.jsx(p,{eightPx:!0}),r.jsx(q,{alignOffset:64,children:r.jsx(U,{erTidligereOpphold:!0,mottattDato:l,countryCodes:e,readOnly:a})})]}):null,r.jsx(p,{sixteenPx:!0}),r.jsx(x,{name:"harFremtidigeOppholdUtenlands",label:r.jsx(F,{id:"Registrering.OppholdNesteTolv"}),validate:[u],isReadOnly:a,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:o({id:"Registrering.Opphold.Yes"}),value:"false"},{label:o({id:"Registrering.Opphold.No"}),value:"true"}]}),y?r.jsxs(r.Fragment,{children:[r.jsx(p,{eightPx:!0}),r.jsx(q,{alignOffset:64,children:r.jsx(U,{erTidligereOpphold:!1,mottattDato:l,countryCodes:e,readOnly:a})})]}):null]})};g.buildInitialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});g.transformValues=a=>({...a,fremtidigeOppholdUtenlands:a.harFremtidigeOppholdUtenlands?a.fremtidigeOppholdUtenlands:void 0,tidligereOppholdUtenlands:a.harTidligereOppholdUtenlands?a.tidligereOppholdUtenlands:void 0});g.__docgenInfo={description:`OppholdINorgePanel
