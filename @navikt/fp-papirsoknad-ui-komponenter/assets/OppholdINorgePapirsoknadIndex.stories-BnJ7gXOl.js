import{u as E,j as e,R as C,d as R,b as w,P as D,a as z}from"./iframe-DDPNky5o.js";import{u as Y,a as J,$ as Q,H as W,Y as X,P as K,d as Z,V as T,b as ee,c as U,m as re,e as ne,N as ae,B as se}from"./nb_NO-Vj-gvTe9.js";import{a as te}from"./alleKodeverk-DO07GSZv.js";import{T as h}from"./TrueFalseInput-B55hg1G8.js";import{e as F,p as M,D as O,H as c,O as le}from"./index.es-D8T_aAqS.js";import{L as ie}from"./landkoder-Bgpqk6-g.js";import{M as f}from"./message-CTH9AWjc.js";import"./index-DWzm94QN.js";const oe={land:void 0,periodeFom:void 0,periodeTom:void 0},q=(n,r)=>n(r),N=(n,r)=>()=>{const l=n(r).filter(({periodeFom:t,periodeTom:a})=>t&&t!==""&&a&&a!=="").map(({periodeFom:t,periodeTom:a})=>[t,a]);return l.length>0?le(l):void 0},de=n=>n.filter(({kode:r})=>r!==ie.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),P=(n,r,s,l)=>()=>{const t=q(n,`${r}.${s}.periodeFom`),a=q(n,`${r}.${s}.periodeTom`);return!a||!t?null:l?O(a)(t):c(t)(a)},j=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:k,getValues:i,trigger:g,formState:{isSubmitted:m}}=Y(),{fields:A,remove:L,append:$}=J({control:k,name:a}),_=de(l);return e.jsx(Q,{fields:A,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:oe,readOnly:s,remove:L,append:$,children:(b,o,V)=>e.jsx(C.Fragment,{children:e.jsxs(W,{gap:"4",paddingBlock:"2",children:[e.jsx(X,{name:`${a}.${o}.land`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:_,readOnly:s,validate:[F]}),e.jsx(K,{name:`${a}.${o}.periodeFom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:s,validate:[F,M,P(i,a,o,!0),()=>{const p=q(i,`${a}.${o}.periodeFom`);return n?O(R().format(w))(p):r?c(r)(p):void 0},N(i,a)],onChange:()=>m?g():void 0}),e.jsx(K,{name:`${a}.${o}.periodeTom`,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:s,validate:[F,M,P(i,a,o,!1),()=>{const p=q(i,`${a}.${o}.periodeTom`);return n?O(R().format(w))(p):r?c(r)(p):void 0},N(i,a)],onChange:()=>m?g():void 0}),V&&e.jsx("div",{children:V()})]},b.id)},b.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const u=({readOnly:n=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=E(),a=r.Landkoder.slice().sort((m,A)=>m.navn.localeCompare(A.navn)),{watch:k}=Y(),i=!k("oppholdSisteTolvINorge",!0),g=!k("oppholdNesteTolvINorge",!0);return e.jsx(Z,{children:e.jsxs(T,{gap:"4",children:[e.jsx(ee,{size:"small",children:e.jsx(f,{id:"Registrering.Opphold"})}),e.jsx(h,{name:"oppholdINorge",label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(T,{gap:"2",children:[e.jsx(h,{name:"oppholdSisteTolvINorge",label:e.jsx(f,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),i&&e.jsx(U,{alignOffset:58,children:e.jsx(j,{erTidligereOpphold:!0,mottattDato:s,countryCodes:a,readOnly:n})})]}),e.jsxs(T,{gap:"2",children:[e.jsx(h,{name:"oppholdNesteTolvINorge",label:e.jsx(f,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),g&&e.jsx(U,{alignOffset:58,children:e.jsx(j,{mottattDato:s,countryCodes:a,readOnly:n})})]})]})})};u.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});u.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});u.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ue=z(re),d=({readOnly:n,erAdopsjon:r,alleKodeverk:s,mottattDato:l})=>e.jsx(D,{value:ue,children:e.jsx(u,{readOnly:n,erAdopsjon:r,alleKodeverk:s,mottattDato:l})});d.initialValues=u.initialValues;d.transformValues=u.transformValues;d.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:pe}=__STORYBOOK_MODULE_ACTIONS__,he={title:"ui-komponenter/opphold-i-norge",component:d,parameters:{submitCallback:pe("onSubmit")},args:{readOnly:!1,alleKodeverk:te,mottattDato:"2022-05-30"},render:(n,{parameters:{submitCallback:r}})=>{const s=ne({defaultValues:d.initialValues()});return e.jsx(ae,{formMethods:s,onSubmit:l=>r(d.transformValues(l)),children:e.jsxs(T,{gap:"10",children:[e.jsx(d,{...n}),e.jsx(se,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},y={args:{erAdopsjon:!1}},v={args:{erAdopsjon:!0}};var S,I,B;y.parameters={...y.parameters,docs:{...(S=y.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
}`,...(B=(I=y.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};var H,x,G;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    erAdopsjon: true
  }
}`,...(G=(x=v.parameters)==null?void 0:x.docs)==null?void 0:G.source}}};const Fe=["ForFodsel","ForAdopsjon"];export{v as ForAdopsjon,y as ForFodsel,Fe as __namedExportsOrder,he as default};
