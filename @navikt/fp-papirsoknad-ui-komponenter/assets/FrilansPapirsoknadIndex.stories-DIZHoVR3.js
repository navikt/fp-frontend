import{u as _,j as e,O,R as $,J as H,o as X,d as w,b as N,t as x,P as z,a as Y}from"./iframe-Ca20Zx4x.js";import{u as S,a as R,Y as E,H as L,S as T,y as J,V as D,c as C,L as K,d as U,b as G,D as Q,m as W,e as Z,M as ee,B as re}from"./nb_NO-CO5XUw6t.js";import{T as P}from"./TrueFalseInput-C9qLReXd.js";import{M as p}from"./message-enQCpoA9.js";import"./preload-helper-D9Z9MdNV.js";import"./index-COvPwJOq.js";const o="frilans",b=(r,a)=>r(a),ae=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,n)=>w(a,N).diff(w(n,N))),ne=X(50),oe=(r,a,n,i)=>()=>{const l=b(r,`${a}.fomDato`);return n.length>0&&n[0]&&l&&!w(n[0]).isSameOrBefore(w(l))?i.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},B=({readOnly:r})=>{const a=_(),{control:n,getValues:i,watch:l,trigger:u,formState:{isSubmitted:v}}=S(),{fields:A,remove:I,append:M}=R({control:n,name:`${o}.oppdragPerioder`}),d=l(`${o}.perioder`),h=ae(d);return e.jsx(E,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:A,readOnly:r,append:M,remove:I,children:(g,t,s)=>{const k=`${o}.oppdragPerioder.${t}`;return e.jsxs(L,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(T,{name:`${o}.oppdragPerioder.${t}.fomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[O,oe(i,k,h,a),()=>{const f=b(i,`${k}.fomDato`),c=b(i,`${k}.tomDato`);return c&&f?$(c)(f):null}],onChange:()=>v?u():void 0}),e.jsx(T,{name:`${o}.oppdragPerioder.${t}.tomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[O,()=>{const f=b(i,`${k}.fomDato`),c=b(i,`${k}.tomDato`);return c&&f?H(f)(c):null}],onChange:()=>v?u():void 0}),e.jsx(J,{name:`${o}.oppdragPerioder.${t}.oppdragsgiver`,control:n,validate:[ne],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},g.id)}})};B.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const F=({readOnly:r})=>{const{watch:a,control:n}=S(),i=a(`${o}.harHattOppdragForFamilie`);return e.jsxs(D,{gap:"space-12",children:[e.jsx(P,{name:`${o}.harHattOppdragForFamilie`,control:n,label:e.jsx(p,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),i&&e.jsxs(C,{children:[e.jsx(K,{size:"small",children:e.jsx(p,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(B,{readOnly:r})]})]})};F.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});F.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});F.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const ie=Y(W),m=({readOnly:r})=>e.jsx(z,{value:ie,children:e.jsx(y,{readOnly:r})});m.initialValues=y.initialValues;m.transformValues=y.transformValues;m.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
