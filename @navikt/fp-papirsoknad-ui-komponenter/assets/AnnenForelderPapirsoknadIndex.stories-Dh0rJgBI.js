import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{a as N,f as I,y as j,w as T,j as _,V as v,b as S,F as x,M as H,P as B,r as U,d as $,m as L,c as C,O as D,B as X}from"./nb_NO-vPpuGQpQ.js";import{e as m,F as z,M as J,y as G,a as Q}from"./index.es-BOVcuvFn.js";import"./withPanelData-BgGavbYW.js";import{r as W}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as Y,a as Z}from"./alleKodeverk-Dp2FRR0Y.js";import{L as ee}from"./landkoder-tJDPMx5C.js";import{T as g}from"./TrueFalseInput-DQAHJ-GN.js";import{M as re}from"./message-DjQpsOjD.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-D4oXW72N.js";import"./iframe-vbZ66HEZ.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var u=(e=>(e.UKJENT_FORELDER="UKJENT_FORELDER",e.IKKE_NORSK_FNR="IKKE_NORSK_FNR",e))(u||{});const t="annenForelder",k="kanIkkeOppgiBegrunnelse",ne="_inputBredde_138ho_1",A={inputBredde:ne},ae=e=>e.filter(({kode:s})=>s!==ee.NORGE).map(({kode:s,navn:n})=>r.jsx("option",{value:s,children:n},s)),f=({readOnly:e=!0,alleKodeverk:s,fagsakPersonnummer:n})=>{const{formatMessage:a}=N(),{watch:o,trigger:i,formState:{isSubmitted:F}}=I(),R=o(`${t}.kanIkkeOppgiAnnenForelder`),b=o(`${t}.${k}`),q=s[Y.LANDKODER],K=W.useMemo(()=>q.slice().sort((d,V)=>d.navn.localeCompare(V.navn)),[q]);return r.jsxs(r.Fragment,{children:[r.jsx(j,{name:`${t}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:d=>d&&d.toString().replace(/\s/g,""),readOnly:e,className:A.inputBredde,validate:R?[]:[m,z,J,G(n)],disabled:R}),r.jsx(T,{name:`${t}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:e,onChange:()=>F?i():void 0}),R===!0&&r.jsx(_,{children:r.jsxs(v,{gap:"4",children:[r.jsx(S,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),r.jsx(x,{name:`${t}.${k}.arsak`,hideLegend:!0,validate:[m],isReadOnly:e,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:u.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:u.IKKE_NORSK_FNR}]}),(b==null?void 0:b.arsak)===u.IKKE_NORSK_FNR&&r.jsxs(r.Fragment,{children:[r.jsx(H,{name:`${t}.${k}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:ae(K),validate:[m],className:A.inputBredde,readOnly:e}),r.jsx(j,{name:`${t}.${k}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[m],className:A.inputBredde,readOnly:e})]})]})})]})};f.transformValues=({foedselsnummer:e,kanIkkeOppgiAnnenForelder:s,kanIkkeOppgiBegrunnelse:{arsak:n,land:a,utenlandskFoedselsnummer:o}={}})=>s?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===u.IKKE_NORSK_FNR?{arsak:n,land:a,utenlandskFoedselsnummer:o}:{arsak:n}}:{foedselsnummer:e,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};f.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const Oe={title:"ui-komponenter/annen-forelder",component:l,args:{readOnly:!1,alleKodeverk:Z,fagsakPersonnummer:"07078518434"},parameters:{submitCallback:Q("onSubmit")},render:(e,{parameters:{submitCallback:s}})=>{const n=C({defaultValues:l.initialValues()});return r.jsx(D,{formMethods:n,onSubmit:a=>s(l.transformValues(a)),children:r.jsxs(v,{gap:"10",children:[r.jsx(l,{...e}),r.jsx(X,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{sokerErMor:!0}},y={args:{sokerErMor:!1}};var O,E,P;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    sokerErMor: true
  }
}`,...(P=(E=p.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};var w,h,M;y.parameters={...y.parameters,docs:{...(w=y.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    sokerErMor: false
  }
}`,...(M=(h=y.parameters)==null?void 0:h.docs)==null?void 0:M.source}}};const Ee=["SokerErMor","SokerErFar"];export{y as SokerErFar,p as SokerErMor,Ee as __namedExportsOrder,Oe as default};
