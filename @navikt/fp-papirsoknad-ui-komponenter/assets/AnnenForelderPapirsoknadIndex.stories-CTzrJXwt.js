import{u as P,j as e,t as v,k as U,M as B,y as g,P as p,a as y}from"./iframe-Du-9xYjp.js";import{u as o,k as G,V as N,g as H,c as J,b as V,S as Y,R as F,w,d as q,m as c,e as b,f as C,B as f}from"./nb_NO-DUHLuNeO.js";import{a as j}from"./alleKodeverk-Cho4R_ly.js";import{M as O}from"./message-CyzzSaut.js";import{T}from"./TrueFalseInput-Bv6OOPG2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-kC1veg76.js";const E="annenForelder",_="kanIkkeOppgiBegrunnelse",h="_inputBredde_138ho_1",D={inputBredde:h},Z=a=>a.filter(({kode:n})=>n!=="NOR").map(({kode:n,navn:l})=>e.jsx("option",{value:n,children:l},n)),I=({readOnly:a=!0,alleKodeverk:n,fagsakPersonnummer:l})=>{const{formatMessage:r}=P(),{watch:i,control:t,trigger:R,formState:{isSubmitted:L}}=o(),K=i(`${E}.kanIkkeOppgiAnnenForelder`),k=i(`${E}.${_}`),d=n.Landkoder.slice().sort((m,M)=>m.navn.localeCompare(M.navn));return e.jsxs(e.Fragment,{children:[e.jsx(G,{name:`${E}.foedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:m=>m&&m.toString().replace(/\s/g,""),readOnly:a,className:D.inputBredde,validate:K?[]:[v,U,B,g(l)],disabled:K}),e.jsxs(N,{gap:"space-12",children:[e.jsx(H,{name:`${E}.kanIkkeOppgiAnnenForelder`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:a,onChange:()=>L?R():void 0}),K===!0&&e.jsx(J,{children:e.jsxs(N,{gap:"space-16",children:[e.jsx(V,{size:"small",level:"4",children:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsxs(Y,{name:`${E}.${_}.arsak`,control:t,hideLegend:!0,validate:[v],isReadOnly:a,children:[e.jsx(F,{value:"UKJENT_FORELDER",size:"small",children:e.jsx(O,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"})}),e.jsx(F,{value:"IKKE_NORSK_FNR",size:"small",children:e.jsx(O,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"})})]}),k?.arsak==="IKKE_NORSK_FNR"&&e.jsxs(e.Fragment,{children:[e.jsx(w,{name:`${E}.${_}.land`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:Z(d),validate:[v],className:D.inputBredde,readOnly:a}),e.jsx(G,{name:`${E}.${_}.utenlandskFoedselsnummer`,control:t,label:r({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[v],className:D.inputBredde,readOnly:a})]})]})})]})]})};I.transformValues=({foedselsnummer:a,kanIkkeOppgiAnnenForelder:n,kanIkkeOppgiBegrunnelse:{arsak:l,land:r,utenlandskFoedselsnummer:i}={}})=>n?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:l==="IKKE_NORSK_FNR"?{arsak:l,land:r,utenlandskFoedselsnummer:i}:{arsak:l}}:{foedselsnummer:a,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};I.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
