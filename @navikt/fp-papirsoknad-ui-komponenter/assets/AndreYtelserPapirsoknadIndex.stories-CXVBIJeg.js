import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{d as q,e as D,i as U,I as C,W as H,c as z,L as b,O as V,y as I,S as X,H as G,M as J,w as W,f as Q,t as Z,P as ee,m as re,a as K,b as ne,$ as ae,B as se}from"./nb_NO-5hZsV4-L.js";import{K as _,a as F}from"./alleKodeverk-DJoTEotX.js";import"./withRouter-xu-IZtWb.js";import{r as te,R as oe}from"./index-CTjT7uj6.js";import{r as N,b as P,I as le,c as ie}from"./index.es-CbGsWAf8.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-DQZRloWl.js";import"./index-vZN_Bsf0.js";const E={LONN_UNDER_UTDANNING:"LØNN_UNDER_UTDANNING",UTENLANDSK_ARBEIDSFORHOLD:"UTENLANDSK_ARBEIDSFORHOLD",FRILANSER:"FRILANSER",MILITÆR_ELLER_SIVILTJENESTE:"MILITÆR_ELLER_SIVILTJENESTE"},de="_notLastRow_7c46s_1",ue={notLastRow:de},m="andreYtelser",j="PERIODER",v=(n,a)=>n(a),R=({readOnly:n,name:a})=>{const r=q(),{getValues:s,control:o,trigger:d,formState:{isSubmitted:l}}=D(),{fields:t,remove:A,append:O}=U({control:o,name:`${m}.${a}`});return e.jsx(C,{fields:t,bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:n,append:O,remove:A,children:(B,y,x)=>{const u=`${m}.${a}.${y}`;return e.jsxs("div",{children:[e.jsx("div",{className:y!==t.length-1?ue.notLastRow:"",children:e.jsx(H,{children:e.jsxs(z,{children:[e.jsx(b,{children:e.jsx(V,{name:`${u}.periodeFom`,label:y===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[N,P,()=>{const c=v(s,`${u}.periodeFom`),k=v(s,`${u}.periodeTom`);return k&&c?le(k)(c):null}],onChange:()=>l?d():void 0})}),e.jsx(b,{children:e.jsx(V,{name:`${u}.periodeTom`,label:y===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[N,P,()=>{const c=v(s,`${u}.periodeFom`),k=v(s,`${u}.periodeTom`);return k&&c?ie(c)(k):null}],onChange:()=>l?d():void 0})}),x&&e.jsx(b,{children:x()})]})})}),e.jsx(I,{sixteenPx:!0})]},B.id)}})};R.transformValues=(n,a)=>n.map(r=>({ytelseType:a,periodeFom:r.periodeFom,periodeTom:r.periodeTom}));R.__docgenInfo={description:`RenderAndreYtelserPerioderFieldArray
