import{u as $,j as e,O,R as _,J as H,o as X,d as T,b as M,t as x,P as z,a as J}from"./iframe-Cvu0XLKM.js";import{u as D,a as R,$ as E,H as L,P as w,A as K,W as C,L as W,l as U,V as N,b as Y,D as G,m as Q,d as Z,N as ee,B as re}from"./nb_NO-BEcvUEy0.js";import{T as P}from"./TrueFalseInput-DFiqSqZi.js";import{M as p}from"./message-DgZdv3_M.js";import"./index-lGl9NmSx.js";const o="frilans",v=(r,a)=>r(a),ae=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,n)=>T(a,M).diff(T(n,M))),ne=X(50),oe=(r,a,n,i)=>()=>{const l=v(r,`${a}.fomDato`);return n.length>0&&n[0]&&l&&!T(n[0]).isSameOrBefore(T(l))?i.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},B=({readOnly:r})=>{const a=$(),{control:n,getValues:i,watch:l,trigger:u,formState:{isSubmitted:c}}=D(),{fields:A,remove:S,append:I}=R({control:n,name:`${o}.oppdragPerioder`}),d=l(`${o}.perioder`),h=ae(d);return e.jsx(E,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:A,readOnly:r,append:I,remove:S,children:(g,t,s)=>{const k=`${o}.oppdragPerioder.${t}`;return e.jsxs(L,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(w,{name:`${o}.oppdragPerioder.${t}.fomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[O,oe(i,k,h,a),()=>{const f=v(i,`${k}.fomDato`),b=v(i,`${k}.tomDato`);return b&&f?_(b)(f):null}],onChange:()=>c?u():void 0}),e.jsx(w,{name:`${o}.oppdragPerioder.${t}.tomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[O,()=>{const f=v(i,`${k}.fomDato`),b=v(i,`${k}.tomDato`);return b&&f?H(f)(b):null}],onChange:()=>c?u():void 0}),e.jsx(K,{name:`${o}.oppdragPerioder.${t}.oppdragsgiver`,control:n,validate:[ne],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},g.id)}})};B.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray
