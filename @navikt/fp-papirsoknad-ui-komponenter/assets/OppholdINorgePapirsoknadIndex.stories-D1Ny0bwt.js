import{u as U,j as e,c as Y,t as d,O as k,R as G,d as g,b as P,J as K,h as J,P as c,a as f}from"./iframe-CEXpT7hR.js";import{u as B,a as C,P as b,H as j,w as Z,T as F,d as W,V as o,b as X,c as M,m as x,e as Q,f as $,B as z}from"./nb_NO-BWbLkVCC.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as D}from"./TrueFalseInput--E6PAVcz.js";import{M as O}from"./message-Fn81Dywe.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DacWvyjk.js";const ae={land:void 0,periodeFom:void 0,periodeTom:void 0},_=(l,a)=>l(a),V=(l,a)=>()=>{const i=l(a).filter(({periodeFom:t,periodeTom:n})=>t&&t!==""&&n&&n!=="").map(({periodeFom:t,periodeTom:n})=>[t,n]);return i.length>0?J(i):void 0},le=l=>l.filter(({kode:a})=>a!=="NOR").map(({kode:a,navn:r})=>e.jsx("option",{value:a,children:r},a)),y=(l,a,r,i)=>()=>{const t=_(l,`${a}.${r}.periodeFom`),n=_(l,`${a}.${r}.periodeTom`);return!n||!t?null:i?G(n)(t):K(t)(n)},p=({erTidligereOpphold:l=!1,mottattDato:a,readOnly:r,countryCodes:i})=>{const t=U(),n=l?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:m,getValues:u,trigger:T,formState:{isSubmitted:s}}=B(),{fields:I,remove:L,append:H}=C({control:m,name:n}),q=le(i);return e.jsx(b,{fields:I,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ae,readOnly:r,remove:L,append:H,children:(w,E,h)=>e.jsx(Y.Fragment,{children:e.jsxs(j,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(Z,{name:`${n}.${E}.land`,control:m,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:E>0,selectValues:q,readOnly:r,validate:[d]}),e.jsx(F,{name:`${n}.${E}.periodeFom`,control:m,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:E>0,isReadOnly:r,validate:[d,k,y(u,n,E,!0),()=>{const R=_(u,`${n}.${E}.periodeFom`);return l?G(g().format(P))(R):a?K(a)(R):void 0},V(u,n)],onChange:()=>s?T():void 0}),e.jsx(F,{name:`${n}.${E}.periodeTom`,control:m,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:E>0,isReadOnly:r,validate:[d,k,y(u,n,E,!1),()=>{const R=_(u,`${n}.${E}.periodeTom`);return l?G(g().format(P))(R):a?K(a)(R):void 0},V(u,n)],onChange:()=>s?T():void 0}),e.jsx("div",{children:h})]})},w.id)})};p.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const N=({readOnly:l=!0,alleKodeverk:a,mottattDato:r,erAdopsjon:i})=>{const{formatMessage:t}=U(),n=a.Landkoder.slice().sort((I,L)=>I.navn.localeCompare(L.navn)),{watch:m,control:u}=B(),T=!m("oppholdSisteTolvINorge",!0),s=!m("oppholdNesteTolvINorge",!0);return e.jsx(W,{children:e.jsxs(o,{gap:"space-16",children:[e.jsx(X,{size:"small",level:"3",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(D,{name:"oppholdINorge",control:u,label:t({id:i?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:l}),e.jsxs(o,{gap:"space-8",children:[e.jsx(D,{name:"oppholdSisteTolvINorge",control:u,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:l}),T&&e.jsx(M,{alignOffset:58,children:e.jsx(p,{erTidligereOpphold:!0,mottattDato:r,countryCodes:n,readOnly:l})})]}),e.jsxs(o,{gap:"space-8",children:[e.jsx(D,{name:"oppholdNesteTolvINorge",control:u,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:l}),s&&e.jsx(M,{alignOffset:58,children:e.jsx(p,{mottattDato:r,countryCodes:n,readOnly:l})})]})]})})};N.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});N.transformValues=({oppholdINorge:l,oppholdSisteTolvINorge:a,oppholdNesteTolvINorge:r,tidligereOppholdUtenlands:i,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:l,harTidligereOppholdUtenlands:!a,harFremtidigeOppholdUtenlands:!r,tidligereOppholdUtenlands:a?void 0:i,fremtidigeOppholdUtenlands:r?void 0:t});N.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const ne=f(x),v=({readOnly:l,erAdopsjon:a,alleKodeverk:r,mottattDato:i})=>e.jsx(c,{value:ne,children:e.jsx(N,{readOnly:l,erAdopsjon:a,alleKodeverk:r,mottattDato:i})});v.initialValues=N.initialValues;v.transformValues=N.transformValues;v.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const{action:re}=__STORYBOOK_MODULE_ACTIONS__,Re={title:"ui-komponenter/opphold-i-norge",component:v,parameters:{submitCallback:re("onSubmit")},args:{readOnly:!1,alleKodeverk:ee,mottattDato:"2022-05-30"},render:(l,{parameters:{submitCallback:a}})=>{const r=Q({defaultValues:v.initialValues()});return e.jsx($,{formMethods:r,onSubmit:i=>a(v.transformValues(i)),children:e.jsxs(o,{gap:"space-40",children:[e.jsx(v,{...l}),e.jsx(z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},A={args:{erAdopsjon:!1}},S={args:{erAdopsjon:!0}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    erAdopsjon: false
  }
