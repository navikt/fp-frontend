...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"RettigheterPanel",props:{soknadData:{required:!0,tsType:{name:"SoknadData"},description:""},readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const I=S(v),u=({readOnly:r,soknadData:e})=>a.jsx(P,{value:I,children:a.jsx(D,{readOnly:r,soknadData:e})});u.__docgenInfo={description:"",methods:[],displayName:"RettigheterPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""}}};class N{constructor(e,t,o){i(this,"fagsakYtelseType");i(this,"familieHendelseType");i(this,"foreldreType");this.fagsakYtelseType=m(e),e===E.SVANGERSKAPSPENGER?this.familieHendelseType=d.FODSEL:this.familieHendelseType=m(t),this.foreldreType=m(o)}getFagsakYtelseType(){return this.fagsakYtelseType}getFamilieHendelseType(){return this.familieHendelseType}getForeldreType(){return this.foreldreType}}const Q={title:"papirsoknad/ui-komponenter/rettigheter",component:u},T=({submitCallback:r,soknadData:e})=>{const t=M();return a.jsxs(j,{formMethods:t,onSubmit:r,children:[a.jsx(u,{readOnly:!1,soknadData:e}),a.jsx(h,{fourtyPx:!0}),a.jsx(V,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},s=T.bind({});s.args={soknadData:new N(E.FORELDREPENGER,d.FODSEL,p.MOR),submitCallback:y("button-click")};const n=T.bind({});n.args={soknadData:new N(E.FORELDREPENGER,d.ADOPSJON,p.FAR),submitCallback:y("button-click")};var c,R,g;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`({
  submitCallback,
  soknadData
}) => {
...
}`,...(g=(R=s.parameters)==null?void 0:R.docs)==null?void 0:g.source}}};var f,A,k;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`({
  submitCallback,
  soknadData
}) => {
  const formMethods = useForm();
...
}`,...(k=(A=n.parameters)==null?void 0:A.docs)==null?void 0:k.source}}};const U=["Default","FarAdopterer"];export{s as Default,n as FarAdopterer,U as __namedExportsOrder,Q as default};
