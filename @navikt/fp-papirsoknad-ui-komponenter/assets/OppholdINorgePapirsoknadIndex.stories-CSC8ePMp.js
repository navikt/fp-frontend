import{u as S,j as e,c as x,t as F,O as V,R as c,d as R,b as w,J as j,h as G,P as Y,a as L}from"./iframe-CImQOabI.js";import{u as P,a as _,P as $,H as D,w as C,T as K,d as z,V as T,b as J,c as N,m as Q,e as W,f as X,B as Z}from"./nb_NO-Mb_cv-p5.js";import{a as ee}from"./alleKodeverk-DO07GSZv.js";import{T as f}from"./TrueFalseInput-D0YkeCfv.js";import{L as re}from"./landkoder-Bgpqk6-g.js";import{M as O}from"./message-I2uSwDa4.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DHOes-c7.js";const ne={land:void 0,periodeFom:void 0,periodeTom:void 0},A=(n,r)=>n(r),U=(n,r)=>()=>{const l=n(r).filter(({periodeFom:t,periodeTom:a})=>t&&t!==""&&a&&a!=="").map(({periodeFom:t,periodeTom:a})=>[t,a]);return l.length>0?G(l):void 0},ae=n=>n.filter(({kode:r})=>r!==re.NORGE).map(({kode:r,navn:s})=>e.jsx("option",{value:r,children:s},r)),M=(n,r,s,l)=>()=>{const t=A(n,`${r}.${s}.periodeFom`),a=A(n,`${r}.${s}.periodeTom`);return!a||!t?null:l?c(a)(t):j(t)(a)},b=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:s,countryCodes:l})=>{const t=S(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:d,getValues:i,trigger:m,formState:{isSubmitted:g}}=P(),{fields:q,remove:h,append:I}=_({control:d,name:a}),E=ae(l);return e.jsx($,{fields:q,titleText:t.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),addButtonText:t.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyTemplate:ne,readOnly:s,remove:h,append:I,children:(B,o,H)=>e.jsx(x.Fragment,{children:e.jsxs(D,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(C,{name:`${a}.${o}.land`,control:d,label:t.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),hideLabel:o>0,selectValues:E,readOnly:s,validate:[F]}),e.jsx(K,{name:`${a}.${o}.periodeFom`,control:d,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),hideLabel:o>0,isReadOnly:s,validate:[F,V,M(i,a,o,!0),()=>{const k=A(i,`${a}.${o}.periodeFom`);return n?c(R().format(w))(k):r?j(r)(k):void 0},U(i,a)],onChange:()=>g?m():void 0}),e.jsx(K,{name:`${a}.${o}.periodeTom`,control:d,label:t.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),hideLabel:o>0,isReadOnly:s,validate:[F,V,M(i,a,o,!1),()=>{const k=A(i,`${a}.${o}.periodeTom`);return n?c(R().format(w))(k):r?j(r)(k):void 0},U(i,a)],onChange:()=>g?m():void 0}),e.jsx("div",{children:H})]})},B.id)})};b.__docgenInfo={description:`UtenlandsOppholdField
...
Komponenten har inputfelter og må derfor rendres som etterkommer av form-komponent.`,methods:[],displayName:"UtenlandsOppholdField",props:{erTidligereOpphold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},mottattDato:{required:!1,tsType:{name:"string"},description:""},countryCodes:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'Landkoder'>[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const p=({readOnly:n=!0,alleKodeverk:r,mottattDato:s,erAdopsjon:l})=>{const{formatMessage:t}=S(),a=r.Landkoder.slice().sort((q,h)=>q.navn.localeCompare(h.navn)),{watch:d,control:i}=P(),m=!d("oppholdSisteTolvINorge",!0),g=!d("oppholdNesteTolvINorge",!0);return e.jsx(z,{children:e.jsxs(T,{gap:"space-16",children:[e.jsx(J,{size:"small",level:"3",children:e.jsx(O,{id:"Registrering.Opphold"})}),e.jsx(f,{name:"oppholdINorge",control:i,label:t({id:l?"Registrering.OppholdVedAdopsjon":"Registrering.OppholdVedFodsel"}),readOnly:n}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdSisteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdSisteTolv"}),readOnly:n}),m&&e.jsx(N,{alignOffset:58,children:e.jsx(b,{erTidligereOpphold:!0,mottattDato:s,countryCodes:a,readOnly:n})})]}),e.jsxs(T,{gap:"space-8",children:[e.jsx(f,{name:"oppholdNesteTolvINorge",control:i,label:e.jsx(O,{id:"Registrering.OppholdNesteTolv"}),readOnly:n}),g&&e.jsx(N,{alignOffset:58,children:e.jsx(b,{mottattDato:s,countryCodes:a,readOnly:n})})]})]})})};p.initialValues=()=>({tidligereOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}],fremtidigeOppholdUtenlands:[{periodeFom:void 0,periodeTom:void 0}]});p.transformValues=({oppholdINorge:n,oppholdSisteTolvINorge:r,oppholdNesteTolvINorge:s,tidligereOppholdUtenlands:l,fremtidigeOppholdUtenlands:t})=>({oppholdINorge:n,harTidligereOppholdUtenlands:!r,harFremtidigeOppholdUtenlands:!s,tidligereOppholdUtenlands:r?void 0:l,fremtidigeOppholdUtenlands:s?void 0:t});p.__docgenInfo={description:`OppholdINorgePanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const se=L(Q),u=({readOnly:n,erAdopsjon:r,alleKodeverk:s,mottattDato:l})=>e.jsx(Y,{value:se,children:e.jsx(p,{readOnly:n,erAdopsjon:r,alleKodeverk:s,mottattDato:l})});u.initialValues=p.initialValues;u.transformValues=p.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
