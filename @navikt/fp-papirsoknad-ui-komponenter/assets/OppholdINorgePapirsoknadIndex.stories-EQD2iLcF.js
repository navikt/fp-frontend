import{j as r}from"./jsx-runtime-DR9Q75dM.js";import{e as C,f as E,g as X,I as Z,K as ee,y as p,p as re,W as ae,c as ne,L as k,P as I,A as N,S as oe,H as le,M as F,k as V,O as R,t as se,d as te,m as de,a as z,b as ie,$ as pe,B as me}from"./nb_NO-D_TgqB1W.js";import"./withRouter-DhSU4y_G.js";import{K as ue,a as ge}from"./alleKodeverk-D-QME5s7.js";import{g as he,r as L,R as fe}from"./index-DRjF_FHU.js";import{V as u,w as q,T as x,E as j,U as ce}from"./index.es-D_GpvDOR.js";import{l as ye}from"./landkoder-T-1RG3zx.js";import{h as T}from"./moment-C5S46NFB.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-CnNqAF5I.js";import"./index-rX-Bn4lm.js";var H={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/(function(a){(function(){var n={}.hasOwnProperty;function l(){for(var e="",s=0;s<arguments.length;s++){var t=arguments[s];t&&(e=o(e,d.call(this,t)))}return e}function d(e){if(typeof e=="string"||typeof e=="number")return this&&this[e]||e;if(typeof e!="object")return"";if(Array.isArray(e))return l.apply(this,e);if(e.toString!==Object.prototype.toString&&!e.toString.toString().includes("[native code]"))return e.toString();var s="";for(var t in e)n.call(e,t)&&e[t]&&(s=o(s,this&&this[t]||t));return s}function o(e,s){return s?e?e+" "+s:e+s:e}a.exports?(l.default=l,a.exports=l):window.classNames=l})()})(H);var Oe=H.exports;const Fe=he(Oe),ve="_datesRowWithRemoveButton_od5lu_1",be="_selectBredde_od5lu_7",W={datesRowWithRemoveButton:ve,selectBredde:be},ke=Fe.bind(W),Ve={land:"",periodeFom:"",periodeTom:""},v=(a,n)=>a(n),w=(a,n)=>()=>{const d=a(n).filter(({periodeFom:o,periodeTom:e})=>o&&o!==""&&e&&e!=="").map(({periodeFom:o,periodeTom:e})=>[o,e]);return d.length>0?ce(d):void 0},xe=a=>a.filter(({kode:n})=>n!==ye.NORGE).map(({kode:n,navn:l})=>r.jsx("option",{value:n,children:l},n)),P=(a,n,l,d)=>()=>{const o=v(a,`${n}.${l}.periodeFom`),e=v(a,`${n}.${l}.periodeTom`);return!e||!o?null:d?x(e)(o):j(o)(e)},U=({erTidligereOpphold:a,mottattDato:n,readOnly:l,countryCodes:d})=>{const o=C(),e=a?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:s,getValues:t,trigger:y,formState:{isSubmitted:O}}=E(),{fields:b,remove:Y,append:G}=X({control:s,name:e}),J=L.useMemo(()=>xe(d),[d]);return r.jsx(Z,{fields:b,titleText:o.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:o.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:Ve,createAddButtonInsteadOfImageLink:!0,readOnly:l,remove:Y,append:G,children:(Q,i,A)=>r.jsxs(fe.Fragment,{children:[i>0&&r.jsxs(r.Fragment,{children:[r.jsx(ee,{}),r.jsx(p,{sixteenPx:!0})]}),r.jsx(re,{name:`${e}.${i}.land`,label:o.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:J,className:W.selectBredde,readOnly:l,validate:[u]}),r.jsx(p,{sixteenPx:!0}),r.jsx(ae,{children:r.jsxs(ne,{className:ke({datesRowWithRemoveButton:i>0}),children:[r.jsx(k,{children:r.jsx(I,{name:`${e}.${i}.periodeFom`,label:o.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:l,validate:[u,q,P(t,e,i,!0),()=>{const h=v(t,`${e}.${i}.periodeFom`);return a?x(T().format(N))(h):n?j(n)(h):void 0},w(t,e)],onChange:()=>O?y():void 0})}),r.jsx(k,{children:r.jsx(I,{name:`${e}.${i}.periodeTom`,label:o.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:l,validate:[u,q,P(t,e,i,!1),()=>{const h=v(t,`${e}.${i}.periodeTom`);return a?x(T().format(N))(h):n?j(n)(h):void 0},w(t,e)],onChange:()=>O?y():void 0})}),A&&r.jsx(k,{children:A()})]})}),r.jsx(p,{sixteenPx:!0})]},Q.id)})};U.__docgenInfo={description:`UtenlandsOppholdField
