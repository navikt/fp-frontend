import{u as d,r as s,j as a,t as K,O as G,R as k,J as y,P as p,e as g}from"./iframe-Cf0Wwlz0.js";import{u as A,a as H,M as Y,H as J,T as P,c as w,V as S,b as q,y as C,C as c,U as j,m as b,d as h,P as f,B as Z}from"./nb_NO-YMWondlV.js";import{a as W}from"./alleKodeverk-BnsD7hyO.js";import{M as X}from"./message-DUS1bYdj.js";import"./preload-helper-PPVm8Dsz.js";import"./index-TQYH78_i.js";const T="andreYtelser",F="andreYtelserPerioder",I="andreYtelserTyper",V=({readOnly:l,name:n})=>{const e=d(),{getValues:E,control:r,trigger:t,formState:{isSubmitted:L}}=A(),{fields:D,remove:M,append:O}=H({control:r,name:n});return s.useEffect(()=>{D.length===0&&O({periodeFom:"",periodeTom:""})},[]),a.jsx(Y,{fields:D,addButtonText:e.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:l,append:O,remove:M,children:(o,u,U)=>{const B=`${n}.${u}`;return a.jsxs(J,{gap:"space-8",align:"end",children:[a.jsx(P,{name:`${B}.periodeFom`,control:r,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[K,G,()=>{const{periodeFom:R,periodeTom:m}=E(`${n}.${u}`);return m&&R?k(m)(R):null}],onChange:()=>L?t():void 0}),a.jsx(P,{name:`${n}.${u}.periodeTom`,control:r,label:e.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[K,G,()=>{const{periodeFom:R,periodeTom:m}=E(`${n}.${u}`);return R&&m?y(R)(m):null}],onChange:()=>L?t():void 0}),a.jsx("div",{children:U})]},o.id)}})};V.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const N=({readOnly:l,kunMiliterEllerSiviltjeneste:n=!1,alleKodeverk:e})=>{const{control:E}=A(),r=$(e.ArbeidType,n);return a.jsx(w,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(q,{size:"small",level:"3",children:a.jsx(X,{id:"Registrering.AndreYtelser.Title"})}),a.jsx(C,{name:`${T}.${I}`,control:E,legend:"",hideLegend:!0,readOnly:l,children:r.map(t=>a.jsx(x,{arbeidstype:t,readOnly:l},t.kode))})]})})};N.initialValues=()=>({[T]:{[I]:[],[F]:{}}});N.transformValues=({andreYtelser:{andreYtelserTyper:l,andreYtelserPerioder:n}})=>({[T]:l.flatMap(e=>n[e]?.map(E=>({ytelseType:e,...E}))).filter(e=>e!==void 0)});const x=({arbeidstype:l,readOnly:n})=>{const{watch:e}=A(),E=e(`${T}.${I}`),[r,t]=s.useState(E.includes(l.kode));return a.jsxs(S,{gap:"space-12",children:[a.jsx(c,{value:l.kode,onClick:()=>t(!r),disabled:n,children:l.navn}),r&&a.jsx(j,{children:a.jsx(V,{name:`${T}.${F}.${l.kode}`,readOnly:n})})]})},$=(l,n)=>n?l.filter(e=>e.kode==="MILITÆR_ELLER_SIVILTJENESTE"):l.filter(e=>e.kode!=="UTENLANDSK_ARBEIDSFORHOLD"&&e.kode!=="FRILANSER"&&e.kode!=="LØNN_UNDER_UTDANNING");N.__docgenInfo={description:`AndreYtelserPanel
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},kunMiliterEllerSiviltjeneste:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:z}=__STORYBOOK_MODULE_ACTIONS__,te={title:"ui-komponenter/andre-ytelser",component:i,parameters:{submitCallback:z("onSubmit")},args:{readOnly:!1,alleKodeverk:W},render:(l,{parameters:{submitCallback:n}})=>{const e=h({defaultValues:i.initialValues()});return a.jsx(f,{formMethods:e,onSubmit:E=>n(i.transformValues(E)),children:a.jsxs(S,{gap:"space-40",children:[a.jsx(i,{...l}),a.jsx(Z,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},v={args:{kunMiliterEllerSiviltjeneste:!1}},_={args:{kunMiliterEllerSiviltjeneste:!0}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,..._.parameters?.docs?.source}}};const ie=["Default","KunMiliterEllerSiviltjeneste"];export{v as Default,_ as KunMiliterEllerSiviltjeneste,ie as __namedExportsOrder,te as default};
