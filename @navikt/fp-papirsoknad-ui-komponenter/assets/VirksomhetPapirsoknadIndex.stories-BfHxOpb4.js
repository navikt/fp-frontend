import{u as I,j as e,t as m,O as U,k as Q,T as Z,g as G,K as ee,N as J,r as H,P as re,a as ne}from"./iframe-Cd5tSmbZ.js";import{u as v,W as F,V as b,Y as ae,H as te,P as B,A as h,L as se,C as z,c as x,e as ie,B as w,j as le,i as ue,k as ke,a as oe,E as de,n as ge,l as me,b as ye,M as ve,m as pe,d as Te,N as Ae}from"./nb_NO-B3SCrwpL.js";import{a as qe}from"./alleKodeverk-DO07GSZv.js";import{T as S}from"./TrueFalseInput-DXH8e-aI.js";import{M as i}from"./message-Db7SWhej.js";import{T as g,S as be}from"./Table-CwllxkdU.js";import{S as Re}from"./Trash-BvXErG3-.js";import"./index-DNNPsnCD.js";var y=(r=>(r.FISKE="FISKE",r.FRILANSER="FRILANSER",r.DAGMAMMA="DAGMAMMA",r.JORDBRUK_ELLER_SKOGBRUK="JORDBRUK_SKOGBRUK",r.ANNEN="ANNEN",r))(y||{});const A="egenVirksomhet",l=`${A}.virksomheter`,Fe={},he=r=>r.map(({kode:n,navn:a})=>e.jsx("option",{value:n,children:a},n)),K=({index:r,readOnly:n,alleKodeverk:a})=>{const t=I(),s=a.Landkoder.slice().sort((d,k)=>d.navn.localeCompare(k.navn)),{getValues:o,control:u}=v();return e.jsx(S,{name:`${l}.${r}.virksomhetRegistrertINorge`,control:u,label:e.jsx(i,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:n,trueContent:e.jsx(F,{marginTop:8,children:e.jsx(h,{name:`${l}.${r}.organisasjonsnummer`,control:u,readOnly:n,validate:[m,G,ee],label:e.jsx(i,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(F,{alignOffset:58,marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(ae,{name:`${l}.${r}.landJobberFra`,control:u,className:Fe.landBredde,selectValues:he(s),validate:[m],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(te,{gap:"4",children:[e.jsx(B,{name:`${l}.${r}.fom`,control:u,isReadOnly:n,validate:[m,U,Q],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(B,{name:`${l}.${r}.tom`,control:u,isReadOnly:n,validate:[U,d=>{const k=o(`${l}.${r}.fom`);return k?Z(k,d):null}],label:t.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};K.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:n,landJobberFra:a,fom:t,tom:s})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?n:void 0,...r===!1?{landJobberFra:a,fom:t,tom:s}:{landJobberFra:"NOR"}});K.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
søker.`,methods:[],displayName:"VirksomhetRelasjonPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const Ve="_inntektBredde_1xgnj_1",je={inntektBredde:Ve},M=({readOnly:r,index:n})=>{const{control:a}=v();return e.jsx(S,{name:`${l}.${n}.varigEndretEllerStartetSisteFireAr`,control:a,label:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.NewlyStartedOrChanged"}),readOnly:r,trueContent:e.jsx(F,{marginTop:8,children:e.jsxs(b,{gap:"4",children:[e.jsx(se,{size:"small",children:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.Reason"})}),e.jsxs(z,{name:`${l}.${n}.varigEndretEllerStartetSisteFireArArsak`,control:a,validate:[m],children:[e.jsx(L,{value:"harVarigEndring",label:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.HarVarigEndring"}),readOnly:r,index:n}),e.jsx(x,{value:"erNyoppstartet",readOnly:r,children:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.ErNyoppstartet"})}),e.jsx(L,{value:"erNyIArbeidslivet",label:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.NyIArbeidslivet"}),readOnly:r,index:n})]}),e.jsx(ie,{name:`${l}.${n}.beskrivelseAvEndring`,control:a,label:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.VirksomhetEndretBeskrivelse"}),validate:[J]}),e.jsx(h,{name:`${l}.${n}.inntekt`,control:a,label:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.Inntekt"}),readOnly:r,validate:[G,m],className:je.inntektBredde,parse:t=>{const s=parseInt(t.toString(),10);return Number.isNaN(s)?t:s}})]})})})};M.transformValues=({varigEndretEllerStartetSisteFireAr:r,varigEndretEllerStartetSisteFireArArsak:n,varigEndringGjeldendeFom:a,nyIArbeidslivetFom:t,beskrivelseAvEndring:s,inntekt:o})=>{const u=n.includes("harVarigEndring"),d=n.includes("erNyoppstartet"),k=n.includes("erNyIArbeidslivet");return{varigEndretEllerStartetSisteFireAr:r,...r?{harVarigEndring:u,...u?{varigEndringGjeldendeFom:a}:{},erNyoppstartet:d,erNyIArbeidslivet:k,...k?{nyIArbeidslivetFom:t}:{},beskrivelseAvEndring:s,inntekt:o}:{}}};const L=({value:r,label:n,readOnly:a,index:t})=>{const{watch:s,control:o}=v(),u=s(`${l}.${t}.varigEndretEllerStartetSisteFireArArsak`),[d,k]=H.useState(u.includes(r));return e.jsxs(b,{gap:"2",children:[e.jsx(x,{value:r,onClick:()=>k(!d),disabled:a,children:n}),d&&e.jsx(F,{marginTop:8,children:e.jsx(B,{name:r==="harVarigEndring"?`${l}.${t}.varigEndringGjeldendeFom`:`${l}.${t}.nyIArbeidslivetFom`,control:o,isReadOnly:a,validate:[U,m],label:e.jsx(i,{id:"Registrering.VirksomhetStartetPanel.GjeldendeFom"})})})]})};M.__docgenInfo={description:`VirksomhetStartetEndretPanel
...
papirsøknad dersom søknad gjelder foreldrepenger og saksbehandler skal legge til ny virksomhet for søker.`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  beskrivelseAvEndring?: string;
  inntekt?: number;
}`,signature:{properties:[{key:"varigEndretEllerStartetSisteFireAr",value:{name:"boolean",required:!1}},{key:"varigEndretEllerStartetSisteFireArArsak",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"varigEndringGjeldendeFom",value:{name:"string",required:!1}},{key:"nyIArbeidslivetFom",value:{name:"string",required:!1}},{key:"beskrivelseAvEndring",value:{name:"string",required:!1}},{key:"inntekt",value:{name:"number",required:!1}}]},alias:"StartedEndretFormValues"}}],returns:null}],displayName:"VirksomhetStartetEndretPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const _={[y.DAGMAMMA]:1,[y.FISKE]:2,[y.JORDBRUK_ELLER_SKOGBRUK]:3,[y.ANNEN]:4},P=({readOnly:r,alleKodeverk:n,index:a})=>{const{control:t}=v();return e.jsx(z,{name:`${l}.${a}.typeVirksomhet`,control:t,label:e.jsx(i,{id:"Registrering.VirksomhetNaeringTypePanel.Title"}),validate:[m],isReadOnly:r,children:fe(n).map(s=>e.jsx(x,{value:s.kode,readOnly:r,children:s.navn},s.kode))})};P.transformValues=({typeVirksomhet:r})=>({typeVirksomhet:{ANNEN:r.includes(y.ANNEN),FISKE:r.includes(y.FISKE),DAGMAMMA:r.includes(y.DAGMAMMA),JORDBRUK_SKOGBRUK:r.includes(y.JORDBRUK_ELLER_SKOGBRUK)}});const fe=r=>r.VirksomhetType.filter(n=>n.kode!==y.FRILANSER).sort((n,a)=>ce(_[n.kode],_[a.kode])),ce=(r,n)=>r>n?1:r<n?-1:0;P.__docgenInfo={description:`VirksomhetTypeNaringPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},index:{required:!0,tsType:{name:"number"},description:""}}};const q=({open:r,readOnly:n=!1,alleKodeverk:a,index:t,remove:s})=>{const{getFieldState:o,watch:u,control:d}=v(),{error:k}=o(`${l}.${t}`),V=u(`${l}.${t}.navn`),[p,j]=H.useState(r);return e.jsxs(g.Row,{shadeOnHover:!1,style:{backgroundColor:k&&!p?"var(--a-red-50)":"none"},children:[e.jsx(g.DataCell,{valign:"top",children:e.jsx(w,{type:"button",variant:"tertiary-neutral",onClick:()=>j(f=>!f),icon:p?e.jsx(be,{"aria-label":"Vis mindre"}):e.jsx(le,{"aria-label":"Vis mer"})})}),e.jsxs(g.DataCell,{valign:"top",children:[e.jsx(ue,{hidden:p,paddingBlock:"3",children:e.jsx(ke,{weight:"semibold",children:V})}),e.jsxs(b,{gap:"4",hidden:!p,children:[e.jsx(h,{name:`${l}.${t}.navn`,control:d,validate:[m],label:e.jsx(i,{id:"Registrering.VirksomhetIdentifikasjonPanel.Name"}),readOnly:n}),e.jsx(K,{readOnly:n,index:t,alleKodeverk:a}),e.jsx(P,{readOnly:n,index:t,alleKodeverk:a}),e.jsx(M,{readOnly:n,index:t}),e.jsx(E,{readOnly:n,index:t}),e.jsx(X,{readOnly:n,index:t})]})]}),e.jsx(g.DataCell,{valign:"top",align:"right",children:e.jsx(w,{type:"button",variant:"tertiary-neutral",onClick:s,onKeyDown:s,icon:e.jsx(Re,{"aria-label":"Slett rad"})})})]})};q.initialValues=()=>({varigEndretEllerStartetSisteFireArArsak:[],typeVirksomhet:[]});q.transformValues=r=>({navn:r.navn,...K.transformValues(r),...P.transformValues(r),...M.transformValues(r),...E.transformValues(r),familieEllerVennerTilknyttetNaringen:r.familieEllerVennerTilknyttetNaringen});q.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"intersection",raw:`IdFormValues &
RelasjonFormValues &
RegnskapFormValues &
StartedEndretFormValues &
TypeNaringFormValues`,elements:[{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const R=({readOnly:r=!0,alleKodeverk:n})=>{const a=I(),{watch:t,control:s}=v(),o=t(`${A}.harArbeidetIEgenVirksomhet`)||null;return e.jsx(me,{children:e.jsxs(b,{gap:"4",children:[e.jsx(ye,{size:"small",children:e.jsx(i,{id:"Registrering.EgenVirksomhet.Title"})}),e.jsx(ve,{name:`${A}.harArbeidetIEgenVirksomhet`,control:s,validate:[m],isReadOnly:r,hideLegend:!0,isTrueOrFalseSelection:!0,radios:[{label:a.formatMessage({id:"Registrering.EgenVirksomhet.No"}),value:"false"},{label:a.formatMessage({id:"Registrering.EgenVirksomhet.Yes"}),value:"true"}]}),o&&e.jsx(O,{readOnly:r,alleKodeverk:n})]})})};R.initialValues=()=>({[A]:{harArbeidetIEgenVirksomhet:void 0,virksomheter:[q.initialValues()]}});R.transformValues=O.transformValues;R.__docgenInfo={description:`EgenVirksomhetPanel
