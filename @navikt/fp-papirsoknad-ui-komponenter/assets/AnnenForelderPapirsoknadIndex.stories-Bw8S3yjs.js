import{u as q,j as e,t as g,k as D,M as c,y as f,P as b,a as j}from"./iframe-ChRMKlYL.js";import{u as O,k as I,V as d,g as G,c as _,b as K,S as M,R as P,w as U,d as h,m as w,e as H,f as x,B as Y}from"./nb_NO-DzlJc8N2.js";import{a as $}from"./alleKodeverk-DO07GSZv.js";import{L as C}from"./landkoder-Bgpqk6-g.js";import{M as S}from"./message-CEOORhkt.js";import{T as v}from"./TrueFalseInput-BXPB_G2q.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Roa-T-pX.js";var k=(r=>(r.UKJENT_FORELDER="UKJENT_FORELDER",r.IKKE_NORSK_FNR="IKKE_NORSK_FNR",r))(k||{});const t="annenForelder",p="kanIkkeOppgiBegrunnelse",J="_inputBredde_138ho_1",N={inputBredde:J},z=r=>r.filter(({kode:a})=>a!==C.NORGE).map(({kode:a,navn:n})=>e.jsx("option",{value:a,children:n},a)),R=({readOnly:r=!0,alleKodeverk:a,fagsakPersonnummer:n})=>{const{formatMessage:l}=q(),{watch:i,control:s,trigger:m,formState:{isSubmitted:A}}=O(),F=i(`${t}.kanIkkeOppgiAnnenForelder`),L=i(`${t}.${p}`),B=a.Landkoder.slice().sort((o,V)=>o.navn.localeCompare(V.navn));return e.jsxs(e.Fragment,{children:[e.jsx(I,{name:`${t}.foedselsnummer`,control:s,label:l({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:o=>o&&o.toString().replace(/\s/g,""),readOnly:r,className:N.inputBredde,validate:F?[]:[g,D,c,f(n)],disabled:F}),e.jsxs(d,{gap:"space-12",children:[e.jsx(G,{name:`${t}.kanIkkeOppgiAnnenForelder`,control:s,label:l({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:r,onChange:()=>A?m():void 0}),F===!0&&e.jsx(_,{children:e.jsxs(d,{gap:"space-16",children:[e.jsx(K,{size:"small",level:"4",children:l({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsxs(M,{name:`${t}.${p}.arsak`,control:s,hideLegend:!0,validate:[g],isReadOnly:r,children:[e.jsx(P,{value:k.UKJENT_FORELDER,size:"small",children:e.jsx(S,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"})}),e.jsx(P,{value:k.IKKE_NORSK_FNR,size:"small",children:e.jsx(S,{id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"})})]}),L?.arsak===k.IKKE_NORSK_FNR&&e.jsxs(e.Fragment,{children:[e.jsx(U,{name:`${t}.${p}.land`,control:s,label:l({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:z(B),validate:[g],className:N.inputBredde,readOnly:r}),e.jsx(I,{name:`${t}.${p}.utenlandskFoedselsnummer`,control:s,label:l({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[g],className:N.inputBredde,readOnly:r})]})]})})]})]})};R.transformValues=({foedselsnummer:r,kanIkkeOppgiAnnenForelder:a,kanIkkeOppgiBegrunnelse:{arsak:n,land:l,utenlandskFoedselsnummer:i}={}})=>a?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===k.IKKE_NORSK_FNR?{arsak:n,land:l,utenlandskFoedselsnummer:i}:{arsak:n}}:{foedselsnummer:r,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};R.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""}}};const T=({readOnly:r,sokerErMor:a})=>{const n=q(),{watch:l,control:i}=O(),s=l(`${t}.sokerHarAleneomsorg`),m=l(`${t}.denAndreForelderenHarRettPaForeldrepenger`),A=l(`${t}.annenForelderRettEØS`);return e.jsxs(d,{gap:"space-16",children:[e.jsx(v,{name:`${t}.sokerHarAleneomsorg`,control:i,label:n.formatMessage({id:"Registrering.Permisjon.SøkerHarAleneomsorg"}),readOnly:r}),s===!1&&e.jsx(v,{name:`${t}.denAndreForelderenHarRettPaForeldrepenger`,control:i,label:n.formatMessage({id:"Registrering.Permisjon.HarRettPaForeldrepenger"}),readOnly:r}),s===!1&&m===!1&&e.jsx(v,{name:`${t}.annenForelderRettEØS`,control:i,label:n.formatMessage({id:"Registrering.Permisjon.AnnenForelderRettEØS"}),readOnly:r}),!a&&s===!1&&m===!1&&A===!1&&e.jsx(v,{name:`${t}.morMottarUføretrygd`,control:i,label:n.formatMessage({id:"Registrering.Permisjon.MorUføretrygd"}),readOnly:r})]})};T.transformValues=({sokerHarAleneomsorg:r,denAndreForelderenHarRettPaForeldrepenger:a,annenForelderRettEØS:n,morMottarUføretrygd:l})=>({sokerHarAleneomsorg:r,denAndreForelderenHarRettPaForeldrepenger:r===!1?a:void 0,annenForelderRettEØS:a===!1?n:void 0,morMottarUføretrygd:n===!1?l:void 0});T.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  sokerHarAleneomsorg,
  ...
  annenForelderRettEØS?: boolean;
  morMottarUføretrygd?: boolean;
}`,signature:{properties:[{key:"sokerHarAleneomsorg",value:{name:"boolean",required:!1}},{key:"denAndreForelderenHarRettPaForeldrepenger",value:{name:"boolean",required:!1}},{key:"annenForelderRettEØS",value:{name:"boolean",required:!1}},{key:"morMottarUføretrygd",value:{name:"boolean",required:!1}}]}}}}],displayName:"PermisjonRettigheterPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const X=j(w),u=({readOnly:r,alleKodeverk:a,fagsakPersonnummer:n,sokerErMor:l})=>e.jsx(b,{value:X,children:e.jsx(h,{children:e.jsxs(d,{gap:"space-16",children:[e.jsx(K,{size:"small",level:"3",children:e.jsx(S,{id:"Registrering.TheOtherParent.Title"})}),e.jsx(R,{readOnly:r,fagsakPersonnummer:n,alleKodeverk:a}),e.jsx(T,{readOnly:r,sokerErMor:l})]})})});u.initialValues=()=>({[t]:{}});u.transformValues=({annenForelder:r})=>({[t]:{...T.transformValues(r),...R.transformValues(r)}});u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
}`,...E.parameters?.docs?.source}}};const ue=["SokerErMor","SokerErFar"];export{E as SokerErFar,y as SokerErMor,ue as __namedExportsOrder,ie as default};
