import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a as E,d as H,h as G,r as Z,H as J,Z as Q,G as w,A as V,R as W,V as f,b as X,i as I,P as Y,n as ee,m as re,c as ne,e as ae,B as oe}from"./nb_NO-DYUfQJzL.js";import{e as F,O as R,D as b,H as O,h as se,a as ie}from"./index.es-BjB7-P5Y.js";import"./withPanelData-BgYkU6zx.js";import{r as L,R as te}from"./index-_2TAQcTa.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as le,a as de}from"./alleKodeverk-CRR-a6x7.js";import{T as q}from"./TrueFalseInput-mwMO-bU6.js";import{d as U}from"./dayjs.min-DkLNzaWO.js";import{L as pe}from"./landkoder-tJDPMx5C.js";import{M as T}from"./message-BmiyU24h.js";import"./index-BsrZSYsV.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CQwh6Daz.js";import"./v4-CtRu48qb.js";import"./entry-preview-CvWxNtra.js";import"./iframe-B4wlmSpy.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BwSyabb1.js";import"./index-CXQShRbs.js";const me={land:void 0,periodeFom:void 0,periodeTom:void 0},h=(n,r)=>n(r),x=(n,r)=>()=>{const i=n(r).filter(({periodeFom:s,periodeTom:a})=>s&&s!==""&&a&&a!=="").map(({periodeFom:s,periodeTom:a})=>[s,a]);return i.length>0?se(i):void 0},ue=n=>n.filter(({kode:r})=>r!==pe.NORGE).map(({kode:r,navn:o})=>e.jsx("option",{value:r,children:o},r)),K=(n,r,o,i)=>()=>{const s=h(n,`${r}.${o}.periodeFom`),a=h(n,`${r}.${o}.periodeTom`);return!a||!s?null:i?b(a)(s):O(s)(a)},j=({erTidligereOpphold:n=!1,mottattDato:r,readOnly:o,countryCodes:i})=>{const s=E(),a=n?"tidligereOppholdUtenlands":"fremtidigeOppholdUtenlands",{control:u,getValues:t,trigger:g,formState:{isSubmitted:v}}=H(),{fields:c,remove:z,append:B}=G({control:u,name:a}),D=L.useMemo(()=>ue(i),[i]);return e.jsx(Z,{fields:c,titleText:s.formatMessage({id:"Registrering.RegistreringOpphold.AngiOpphold"}),bodyText:s.formatMessage({id:"Registrering.RegistreringOpphold.Add"}),emptyPeriodTemplate:me,readOnly:o,remove:z,append:B,children:(N,l,A)=>e.jsx(te.Fragment,{children:e.jsxs(J,{gap:"4",paddingBlock:"2",children:[e.jsx(Q,{name:`${a}.${l}.land`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.Country"}),selectValues:D,readOnly:o,validate:[F]}),e.jsx(w,{name:`${a}.${l}.periodeFom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeFom"}),isReadOnly:o,validate:[F,R,K(t,a,l,!0),()=>{const m=h(t,`${a}.${l}.periodeFom`);return n?b(U().format(V))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),e.jsx(w,{name:`${a}.${l}.periodeTom`,label:s.formatMessage({id:"Registrering.RegistreringOpphold.periodeTom"}),isReadOnly:o,validate:[F,R,K(t,a,l,!1),()=>{const m=h(t,`${a}.${l}.periodeTom`);return n?b(U().format(V))(m):r?O(r)(m):void 0},x(t,a)],onChange:()=>v?g():void 0}),A&&e.jsx("div",{children:A()})]},N.id)},N.id)})};j.__docgenInfo={description:`UtenlandsOppholdField
