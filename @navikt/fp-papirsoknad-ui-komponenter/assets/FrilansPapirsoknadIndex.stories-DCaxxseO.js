import{u as $,j as e,O,R as _,J as H,o as X,d as w,b as M,t as x,P as z,a as J}from"./iframe-CwOPQQ6O.js";import{u as V,a as R,$ as E,H as L,O as T,P as K,V as D,e as C,L as U,d as Y,b as G,D as Q,m as W,f as Z,N as ee,B as re}from"./nb_NO-D_zGkR9w.js";import{T as P}from"./TrueFalseInput-B-EXjsEb.js";import{M as p}from"./message-B_MGKR_L.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CbIUUOPH.js";const o="frilans",c=(r,a)=>r(a),ae=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,n)=>w(a,M).diff(w(n,M))),ne=X(50),oe=(r,a,n,i)=>()=>{const l=c(r,`${a}.fomDato`);return n.length>0&&n[0]&&l&&!w(n[0]).isSameOrBefore(w(l))?i.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},B=({readOnly:r})=>{const a=$(),{control:n,getValues:i,watch:l,trigger:u,formState:{isSubmitted:v}}=V(),{fields:A,remove:I,append:N}=R({control:n,name:`${o}.oppdragPerioder`}),d=l(`${o}.perioder`),h=ae(d);return e.jsx(E,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:A,readOnly:r,append:N,remove:I,children:(g,t,s)=>{const k=`${o}.oppdragPerioder.${t}`;return e.jsxs(L,{gap:"space-16",paddingBlock:"2",align:"end",children:[e.jsx(T,{name:`${o}.oppdragPerioder.${t}.fomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[O,oe(i,k,h,a),()=>{const f=c(i,`${k}.fomDato`),b=c(i,`${k}.tomDato`);return b&&f?_(b)(f):null}],onChange:()=>v?u():void 0}),e.jsx(T,{name:`${o}.oppdragPerioder.${t}.tomDato`,control:n,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[O,()=>{const f=c(i,`${k}.fomDato`),b=c(i,`${k}.tomDato`);return b&&f?H(f)(b):null}],onChange:()=>v?u():void 0}),e.jsx(K,{name:`${o}.oppdragPerioder.${t}.oppdragsgiver`,control:n,validate:[ne],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},g.id)}})};B.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray
