import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{a as F,f as T,h as I,$ as K,A as j,e as k,Y as E,b as N,V as R,c as V,i as P,P as _,r as x,m as M,d as h,N as D,B as L}from"./nb_NO-CeJ5uFhL.js";import{b as S,p as v,a as B}from"./index.es-DNHabqwj.js";import"./withPanelData-B5CSGQi7.js";import"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as H,a as $}from"./alleKodeverk-BGvpDL3l.js";import{L as Y}from"./landkoder-tJDPMx5C.js";import{F as G}from"./FieldArrayRow-Ame59EM-.js";import{M as p}from"./message-BshPDgZM.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-VuTQqIyX.js";import"./iframe-D0B5-XJT.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";import"./Trash-BoxRWajp.js";const i="arbeidsforhold",z=S(50),C=n=>n.filter(({kode:e})=>e!==Y.NORGE).map(({kode:e,navn:a})=>r.jsx("option",{value:e,children:a},e)),b=({alleKodeverk:n,readOnly:e})=>{const a=F(),{control:u}=T(),{fields:f,remove:m,append:q}=I({control:u,name:i}),w=n[H.LANDKODER].slice().sort((g,s)=>g.navn.localeCompare(s.navn));return r.jsx(K,{fields:f,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyPeriodTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:m,append:q,children:(g,s)=>r.jsxs(G,{remove:m,index:s,readOnly:e,children:[r.jsx(j,{readOnly:e,name:`${i}.${s}.arbeidsgiver`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[z],maxLength:99}),r.jsx(k,{isReadOnly:e,name:`${i}.${s}.periodeFom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[v]}),r.jsx(k,{isReadOnly:e,name:`${i}.${s}.periodeTom`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[v]}),r.jsx(E,{readOnly:e,name:`${i}.${s}.land`,label:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:C(w),size:"small"})]},g.id)})};b.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
