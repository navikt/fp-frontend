import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{a as M,e as I,f as P,w as x,G as V,V as y,c as N,F as _,M as H,P as B,r as L,b as U,m as $,d as C,O as D,B as X}from"./nb_NO-CO8Lf0y6.js";import{e as m,I as z,F as G,M as J,a as Q}from"./index.es-Y_pmkVsu.js";import"./withPanelData-DM7BI-dC.js";import{r as W}from"./index-C4XKfyRp.js";import"./aktivitetStatus-B1m96ipJ.js";import{K as Y,a as Z}from"./alleKodeverk-BGvpDL3l.js";import{L as ee}from"./landkoder-tJDPMx5C.js";import{T as g}from"./TrueFalseInput-ahmheniT.js";import{M as re}from"./message-CyGWbGQD.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";import"./entry-preview-CsszHGEu.js";import"./iframe-bPWLNizW.js";import"./chunk-XP5HYGXS-BpfKkqn7.js";import"./entry-preview-docs-BX9G6PXb.js";import"./index-CXQShRbs.js";var u=(e=>(e.UKJENT_FORELDER="UKJENT_FORELDER",e.IKKE_NORSK_FNR="IKKE_NORSK_FNR",e))(u||{});const t="annenForelder",k="kanIkkeOppgiBegrunnelse",ne="_inputBredde_138ho_1",A={inputBredde:ne},ae=e=>e.filter(({kode:s})=>s!==ee.NORGE).map(({kode:s,navn:n})=>r.jsx("option",{value:s,children:n},s)),F=({readOnly:e=!0,alleKodeverk:s,fagsakPersonnummer:n})=>{const{formatMessage:a}=M(),{watch:o,trigger:i,formState:{isSubmitted:f}}=I(),R=o(`${t}.kanIkkeOppgiAnnenForelder`),b=o(`${t}.${k}`),q=s[Y.LANDKODER],S=W.useMemo(()=>q.slice().sort((d,T)=>d.navn.localeCompare(T.navn)),[q]);return r.jsxs(r.Fragment,{children:[r.jsx(P,{name:`${t}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:d=>d&&d.toString().replace(/\s/g,""),readOnly:e,className:A.inputBredde,validate:R?[]:[m,z,G,J(n)],disabled:R}),r.jsx(x,{name:`${t}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:e,onChange:()=>f?i():void 0}),R===!0&&r.jsx(V,{children:r.jsxs(y,{gap:"4",children:[r.jsx(N,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),r.jsx(_,{name:`${t}.${k}.arsak`,hideLegend:!0,validate:[m],isReadOnly:e,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:u.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:u.IKKE_NORSK_FNR}]}),(b==null?void 0:b.arsak)===u.IKKE_NORSK_FNR&&r.jsxs(r.Fragment,{children:[r.jsx(H,{name:`${t}.${k}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:ae(S),validate:[m],className:A.inputBredde,readOnly:e}),r.jsx(P,{name:`${t}.${k}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[m],className:A.inputBredde,readOnly:e})]})]})})]})};F.transformValues=({foedselsnummer:e,kanIkkeOppgiAnnenForelder:s,kanIkkeOppgiBegrunnelse:{arsak:n,land:a,utenlandskFoedselsnummer:o}={}})=>s?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===u.IKKE_NORSK_FNR?{arsak:n,land:a,utenlandskFoedselsnummer:o}:{arsak:n}}:{foedselsnummer:e,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};F.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
...
>`},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const je={title:"ui-komponenter/annen-forelder",component:l,args:{readOnly:!1,alleKodeverk:Z,fagsakPersonnummer:"07078518434"},parameters:{submitCallback:Q("onSubmit")},render:(e,{parameters:{submitCallback:s}})=>{const n=C({defaultValues:l.initialValues()});return r.jsx(D,{formMethods:n,onSubmit:a=>s(l.transformValues(a)),children:r.jsxs(y,{gap:"10",children:[r.jsx(l,{...e}),r.jsx(X,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{sokerErMor:!0}},v={args:{sokerErMor:!1}};var j,E,w;p.parameters={...p.parameters,docs:{...(j=p.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    sokerErMor: true
  }
}`,...(w=(E=p.parameters)==null?void 0:E.docs)==null?void 0:w.source}}};var O,K,h;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    sokerErMor: false
  }
}`,...(h=(K=v.parameters)==null?void 0:K.docs)==null?void 0:h.source}}};const Ee=["SokerErMor","SokerErFar"];export{v as SokerErFar,p as SokerErMor,Ee as __namedExportsOrder,je as default};
