import{u as O,j as a,o as G,O as T,P as s,e as P}from"./iframe-C-F1-KFd.js";import{u as F,a as V,P as M,T as k,y as _,w as o,c as d,V as S,b as U,D as B,m as g,d as y,e as p,B as H}from"./nb_NO-DCcstzbV.js";import{a as J}from"./alleKodeverk-C9CgZbBn.js";import{F as Y}from"./FieldArrayRow-CBW3vlcT.js";import{M as A}from"./message-Da0NzITC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C2Kif7jS.js";const i="arbeidsforhold",w=G(50),q=l=>l.filter(({kode:e})=>e!=="NOR").map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),I=({alleKodeverk:l,readOnly:e})=>{const n=O(),{control:r}=F(),{fields:L,remove:R,append:D}=V({control:r,name:i}),K=l.Landkoder.slice().sort((v,E)=>v.navn.localeCompare(E.navn));return a.jsx(M,{fields:L,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:R,append:D,children:(v,E)=>a.jsxs(Y,{remove:R,index:E,readOnly:e,children:[a.jsx(k,{readOnly:e,control:r,name:`${i}.${E}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[w],maxLength:99}),a.jsx(_,{name:`${i}.${E}.periodeFom`,control:r,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[T]}),a.jsx(_,{name:`${i}.${E}.periodeTom`,control:r,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[T]}),a.jsx(o,{name:`${i}.${E}.land`,control:r,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:q(K),size:"small"})]},v.id)})};I.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
