import{u as V,r as B,j as r,P as H,a as N}from"./iframe-Cm0JmO_C.js";import{u as S,A as c,y as I,c as _,V as v,b as w,M as x,Y as G,d as L,m as Y,e as $,N as D,B as C}from"./nb_NO-VNyzhOy5.js";import{a as X}from"./alleKodeverk-DO07GSZv.js";import{e as k,I as z,F as J,M as Q}from"./index.es-huFxRk9k.js";import{L as W}from"./landkoder-Bgpqk6-g.js";import{T as g}from"./TrueFalseInput-C_vW5n_R.js";import{M as Z}from"./message-DzccQiQe.js";import"./index-fBLuJmba.js";var d=(e=>(e.UKJENT_FORELDER="UKJENT_FORELDER",e.IKKE_NORSK_FNR="IKKE_NORSK_FNR",e))(d||{});const t="annenForelder",m="kanIkkeOppgiBegrunnelse",ee="_inputBredde_138ho_1",f={inputBredde:ee},re=e=>e.filter(({kode:s})=>s!==W.NORGE).map(({kode:s,navn:n})=>r.jsx("option",{value:s,children:n},s)),T=({readOnly:e=!0,alleKodeverk:s,fagsakPersonnummer:n})=>{const{formatMessage:a}=V(),{watch:l,trigger:u,formState:{isSubmitted:F}}=S(),q=l(`${t}.kanIkkeOppgiAnnenForelder`),R=l(`${t}.${m}`),b=s.Landkoder,E=B.useMemo(()=>b.slice().sort((o,U)=>o.navn.localeCompare(U.navn)),[b]);return r.jsxs(r.Fragment,{children:[r.jsx(c,{name:`${t}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:o=>o&&o.toString().replace(/\s/g,""),readOnly:e,className:f.inputBredde,validate:q?[]:[k,z,J,Q(n)],disabled:q}),r.jsx(I,{name:`${t}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:e,onChange:()=>F?u():void 0}),q===!0&&r.jsx(_,{children:r.jsxs(v,{gap:"4",children:[r.jsx(w,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),r.jsx(x,{name:`${t}.${m}.arsak`,hideLegend:!0,validate:[k],isReadOnly:e,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:d.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:d.IKKE_NORSK_FNR}]}),(R==null?void 0:R.arsak)===d.IKKE_NORSK_FNR&&r.jsxs(r.Fragment,{children:[r.jsx(G,{name:`${t}.${m}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:re(E),validate:[k],className:f.inputBredde,readOnly:e}),r.jsx(c,{name:`${t}.${m}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[k],className:f.inputBredde,readOnly:e})]})]})})]})};T.transformValues=({foedselsnummer:e,kanIkkeOppgiAnnenForelder:s,kanIkkeOppgiBegrunnelse:{arsak:n,land:a,utenlandskFoedselsnummer:l}={}})=>s?{foedselsnummer:void 0,kanIkkeOppgiAnnenForelder:!0,kanIkkeOppgiBegrunnelse:n===d.IKKE_NORSK_FNR?{arsak:n,land:a,utenlandskFoedselsnummer:l}:{arsak:n}}:{foedselsnummer:e,kanIkkeOppgiAnnenForelder:!1,kanIkkeOppgiBegrunnelse:void 0};T.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:`{
  foedselsnummer,
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""},sokerErMor:{required:!0,tsType:{name:"boolean"},description:""}}};const{action:ae}=__STORYBOOK_MODULE_ACTIONS__,ge={title:"ui-komponenter/annen-forelder",component:i,args:{readOnly:!1,alleKodeverk:X,fagsakPersonnummer:"07078518434"},parameters:{submitCallback:ae("onSubmit")},render:(e,{parameters:{submitCallback:s}})=>{const n=$({defaultValues:i.initialValues()});return r.jsx(D,{formMethods:n,onSubmit:a=>s(i.transformValues(a)),children:r.jsxs(v,{gap:"10",children:[r.jsx(i,{...e}),r.jsx(C,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},p={args:{sokerErMor:!0}},y={args:{sokerErMor:!1}};var j,O,P;p.parameters={...p.parameters,docs:{...(j=p.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    sokerErMor: true
  }
...
}`,...(M=(K=y.parameters)==null?void 0:K.docs)==null?void 0:M.source}}};const me=["SokerErMor","SokerErFar"];export{y as SokerErFar,p as SokerErMor,me as __namedExportsOrder,ge as default};
