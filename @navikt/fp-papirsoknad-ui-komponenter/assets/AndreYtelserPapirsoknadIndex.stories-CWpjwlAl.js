import{u as _,r as N,j as n,t as F,O as c,R as V,J as b,P as Y,a as h}from"./iframe-DjD12CsA.js";import{u as v,a as B,P as f,H as L,T as j,d as D,V as T,b as U,j as I,C as H,c as x,m as G,e as $,f as C,B as X}from"./nb_NO-BhsWDL5U.js";import{a as J}from"./alleKodeverk-DO07GSZv.js";import{M as z}from"./message-C1oWuVmp.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B3_lOHcj.js";var g=(e=>(e.LONN_UNDER_UTDANNING="LØNN_UNDER_UTDANNING",e.UTENLANDSK_ARBEIDSFORHOLD="UTENLANDSK_ARBEIDSFORHOLD",e.FRILANSER="FRILANSER",e.MILITÆR_ELLER_SIVILTJENESTE="MILITÆR_ELLER_SIVILTJENESTE",e))(g||{});const m="andreYtelser",P="andreYtelserPerioder",A="andreYtelserTyper",M=({readOnly:e,name:a})=>{const r=_(),{getValues:t,control:s,trigger:i,formState:{isSubmitted:E}}=v(),{fields:R,remove:S,append:q}=B({control:s,name:a});return N.useEffect(()=>{R.length===0&&q({periodeFom:"",periodeTom:""})},[]),n.jsx(f,{fields:R,addButtonText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),emptyTemplate:{periodeFom:"",periodeTom:""},readOnly:e,append:q,remove:S,children:(w,u,O)=>{const K=`${a}.${u}`;return n.jsxs(L,{gap:"space-8",align:"end",children:[n.jsx(j,{name:`${K}.periodeFom`,control:s,label:r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}),hideLabel:u>0,validate:[F,c,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${u}`);return o&&k?V(o)(k):null}],onChange:()=>E?i():void 0}),n.jsx(j,{name:`${a}.${u}.periodeTom`,control:s,label:r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}),hideLabel:u>0,validate:[F,c,()=>{const{periodeFom:k,periodeTom:o}=t(`${a}.${u}`);return k&&o?b(k)(o):null}],onChange:()=>E?i():void 0}),n.jsx("div",{children:O})]},w.id)}})};M.__docgenInfo={description:"",methods:[],displayName:"RenderAndreYtelserPerioderFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},name:{required:!0,tsType:{name:"literal",value:"`${typeof ANDRE_YTELSER_NAME_PREFIX}.${typeof ANDRE_YTELSER_PERIODER_NAME}.${string}`"},description:""}}};const d=({readOnly:e,kunMiliterEllerSiviltjeneste:a=!1,alleKodeverk:r})=>{const{control:t}=v(),s=Q(r.ArbeidType,a);return n.jsx(D,{children:n.jsxs(T,{gap:"space-16",children:[n.jsx(U,{size:"small",level:"3",children:n.jsx(z,{id:"Registrering.AndreYtelser.Title"})}),n.jsx(I,{name:`${m}.${A}`,control:t,isReadOnly:e,children:s.map(i=>n.jsx(W,{arbeidstype:i,readOnly:e},i.kode))})]})})};d.initialValues=()=>({[m]:{[A]:[],[P]:{}}});d.transformValues=({andreYtelser:{andreYtelserTyper:e,andreYtelserPerioder:a}})=>({[m]:e.flatMap(r=>a[r]?.map(t=>({ytelseType:r,...t}))).filter(r=>r!==void 0)});const W=({arbeidstype:e,readOnly:a})=>{const{watch:r}=v(),t=r(`${m}.${A}`),[s,i]=N.useState(t.includes(e.kode));return n.jsxs(T,{gap:"space-12",children:[n.jsx(H,{value:e.kode,onClick:()=>i(!s),disabled:a,children:e.navn}),s&&n.jsx(x,{children:n.jsx(M,{name:`${m}.${P}.${e.kode}`,readOnly:a})})]})},Q=(e,a)=>a?e.filter(r=>r.kode===g.MILITÆR_ELLER_SIVILTJENESTE):e.filter(r=>r.kode!==g.UTENLANDSK_ARBEIDSFORHOLD&&r.kode!==g.FRILANSER&&r.kode!==g.LONN_UNDER_UTDANNING);d.__docgenInfo={description:`AndreYtelserPanel
