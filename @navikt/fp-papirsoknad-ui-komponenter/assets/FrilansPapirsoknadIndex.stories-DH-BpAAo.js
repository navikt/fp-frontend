import{u as $,j as e,d as O,b as N,P as U,a as Y}from"./iframe-CPU-3r13.js";import{u as I,a as E,$ as L,H as C,P as T,A as G,c as B,L as J,d as Q,V as x,b as W,D as Z,m as ee,e as re,N as ae,B as ne}from"./nb_NO-hiT1xduR.js";import{T as P}from"./TrueFalseInput-CZEHxqe4.js";import{p as w,D as X,H as z,a as ie,e as M}from"./index.es-BQ00orad.js";import{M as m}from"./message-Dh32RqQv.js";import"./index-cfeu8LEu.js";const o="frilans",v=(r,a)=>r(a),oe=(r=[])=>r.map(a=>a.periodeFom).filter(a=>a&&a!=="").sort((a,i)=>O(a,N).diff(O(i,N))),te=ie(50),se=(r,a,i,n)=>()=>{const d=v(r,`${a}.fomDato`);return i.length>0&&i[0]&&d&&!O(i[0]).isSameOrBefore(O(d))?n.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.BeforeFomValidation"}):null},K=({readOnly:r})=>{const a=$(),{control:i,getValues:n,watch:d,trigger:g,formState:{isSubmitted:c}}=I(),{fields:V,remove:A,append:S}=E({control:i,name:`${o}.oppdragPerioder`}),k=d(`${o}.perioder`),h=oe(k);return e.jsx(L,{bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),fields:V,readOnly:r,append:S,remove:A,children:(t,p,s)=>{const l=`${o}.oppdragPerioder.${p}`;return e.jsxs(C,{gap:"4",paddingBlock:"2",align:"end",children:[e.jsx(T,{name:`${l}.fomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeFom"}),validate:[w,se(n,l,h,a),()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?X(b)(f):null}],onChange:()=>c?g():void 0}),e.jsx(T,{name:`${l}.tomDato`,label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.periodeTom"}),validate:[w,()=>{const f=v(n,`${l}.fomDato`),b=v(n,`${l}.tomDato`);return b&&f?z(f)(b):null}],onChange:()=>c?g():void 0}),e.jsx(G,{name:`${l}.oppdragsgiver`,validate:[te],label:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.Oppdragsgiver"})}),s&&e.jsx("div",{children:s()})]},t.id)}})};K.__docgenInfo={description:`FrilansOppdragForFamilieFieldArray

Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const F=({readOnly:r})=>{const{watch:a}=I(),i=a(`${o}.harHattOppdragForFamilie`);return e.jsxs(e.Fragment,{children:[e.jsx(P,{name:`${o}.harHattOppdragForFamilie`,label:e.jsx(m,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),i&&e.jsxs(B,{children:[e.jsx(J,{size:"small",children:e.jsx(m,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(K,{readOnly:r})]})]})};F.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});F.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});F.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const le=Y(ee),u=({readOnly:r})=>e.jsx(U,{value:le,children:e.jsx(y,{readOnly:r})});u.initialValues=y.initialValues;u.transformValues=y.transformValues;u.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
