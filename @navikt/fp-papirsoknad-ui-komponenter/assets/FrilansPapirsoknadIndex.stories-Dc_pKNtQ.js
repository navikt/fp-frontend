...
Viser inputfelter for fra og til dato for frilansperioder.`,methods:[],displayName:"FrilansOppdragForFamilieFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const F=({readOnly:r})=>{const{watch:a}=V(),o=a(`${i}.harHattOppdragForFamilie`);return e.jsxs(e.Fragment,{children:[e.jsx(w,{name:`${i}.harHattOppdragForFamilie`,label:e.jsx(g,{id:"Registrering.FrilansOppdrag.HarHattOppdragForFamilie"}),readOnly:r}),o&&e.jsxs(K,{children:[e.jsx(U,{size:"small",children:e.jsx(g,{id:"Registrering.FrilansOppdrag.OppgiPeriode"})}),e.jsx(M,{readOnly:r})]})]})};F.initialValues=()=>({oppdragPerioder:[{fomDato:"",tomDato:"",oppdragsgiver:""}]});F.transformValues=({harHattOppdragForFamilie:r,oppdragPerioder:a})=>({harHattOppdragForFamilie:r,oppdragPerioder:r?a:void 0});F.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]}}}}],displayName:"FrilansOppdragForFamiliePanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const j=(r,a)=>r(a),c=({readOnly:r})=>{const a=C(),{control:o,getValues:n,formState:{isSubmitted:m},trigger:k}=V(),{fields:h,remove:A,append:I}=B({control:o,name:`${i}.perioder`});return e.jsx(z,{fields:h,bodyText:a.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:r,remove:A,append:I,children:(S,f,P)=>{const t=`${i}.perioder.${f}`;return e.jsxs(Y,{gap:"4",paddingBlock:"2",children:[e.jsx(O,{name:`${t}.periodeFom`,label:f===0?a.formatMessage({id:"Registrering.Frilans.periodeFom"}):"",validate:[x,T,()=>{const u=j(n,`${t}.periodeFom`),s=j(n,`${t}.periodeTom`);return s&&u?G(s)(u):null}],onChange:()=>m?k():void 0}),e.jsx(O,{name:`${t}.periodeTom`,label:f===0?a.formatMessage({id:"Registrering.Frilans.periodeTom"}):"",validate:[x,T,()=>{const u=j(n,`${t}.periodeFom`),s=j(n,`${t}.periodeTom`);return s&&u?J(u)(s):null}],onChange:()=>m?k():void 0}),P&&e.jsx("div",{children:P()})]},S.id)}})};c.initialValues=()=>({perioder:[{periodeFom:"",periodeTom:""}]});c.__docgenInfo={description:`FrilansPerioderFieldArray
