import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{d as A,e as F,S as b,H as h,M as q,y as i,f,w as _,O as E,k as M,q as I,t as S,h as V,m as $,a as C,b as L,$ as D,B}from"./nb_NO-D9vmGK8I.js";import"./withRouter-DhSU4y_G.js";import{K as U,a as z}from"./alleKodeverk-DJoTEotX.js";import{r as J}from"./index-DRjF_FHU.js";import{l as G}from"./landkoder-T-1RG3zx.js";import{r as l,W as H,U as W,V as X}from"./index.es-CORgtn2F.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-DN4LN79F.js";import"./index-rX-Bn4lm.js";const p={UKJENT_FORELDER:"UKJENT_FORELDER",IKKE_NORSK_FNR:"IKKE_NORSK_FNR"},Q="_inputBredde_138ho_1",v={inputBredde:Q},s="annenForelder",m="kanIkkeOppgiBegrunnelse",Y=r=>r.filter(({kode:n})=>n!==G.NORGE).map(({kode:n,navn:o})=>e.jsx("option",{value:n,children:o},n)),P=({readOnly:r=!0,permisjonRettigheterPanel:n,alleKodeverk:o,fagsakPersonnummer:u})=>{const{formatMessage:a}=A(),{watch:y,trigger:O,formState:{isSubmitted:T}}=F(),k=y(`${s}.kanIkkeOppgiAnnenForelder`),g=y(`${s}.${m}`),R=o[U.LANDKODER],N=J.useMemo(()=>R.slice().sort((t,w)=>t.navn.localeCompare(w.navn)),[R]);return e.jsxs(b,{children:[e.jsx(h,{size:"small",children:e.jsx(q,{id:"Registrering.TheOtherParent.Title"})}),e.jsx(i,{sixteenPx:!0}),e.jsx(f,{name:`${s}.foedselsnummer`,label:a({id:"Registrering.TheOtherParent.Fodselsnummer"}),parse:t=>t&&t.toString().replace(/\s/g,""),readOnly:r,className:v.inputBredde,validate:k?[]:[l,H,W,t=>t===u?X():null],disabled:k}),e.jsx(i,{sixteenPx:!0}),e.jsx(_,{name:`${s}.kanIkkeOppgiAnnenForelder`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent"}),readOnly:r,onChange:()=>T?O():void 0}),k===!0&&e.jsxs(e.Fragment,{children:[e.jsx(i,{eightPx:!0}),e.jsxs(E,{children:[e.jsx(h,{size:"small",children:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.Title"})}),e.jsx(M,{name:`${s}.${m}.arsak`,hideLegend:!0,validate:[l],isReadOnly:r,radios:[{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.1"}),value:p.UKJENT_FORELDER},{label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Reason.2"}),value:p.IKKE_NORSK_FNR}]}),(g==null?void 0:g.arsak)===p.IKKE_NORSK_FNR&&e.jsxs(e.Fragment,{children:[e.jsx(i,{sixteenPx:!0}),e.jsx(I,{name:`${s}.${m}.land`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.Land"}),selectValues:Y(N),validate:[l],className:v.inputBredde,readOnly:r}),e.jsx(i,{sixteenPx:!0}),e.jsx(f,{name:`${s}.${m}.utenlandskFoedselsnummer`,label:a({id:"Registrering.TheOtherParent.CannotSpecifyOtherParent.UtenlandsFodselsnummer"}),validate:[l],className:v.inputBredde,readOnly:r})]})]})]}),e.jsx(i,{sixteenPx:!0}),n]})};P.__docgenInfo={description:"",methods:[],displayName:"AnnenForelderPanel",props:{readOnly:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},permisjonRettigheterPanel:{required:!1,tsType:{name:"ReactNode"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""},permisjonRettigheterPanel:{required:!1,tsType:{name:"ReactNode"},description:""},fagsakPersonnummer:{required:!0,tsType:{name:"string"},description:""}}};const ue={title:"papirsoknad/ui-komponenter/annen-forelder",component:c},ee=({submitCallback:r})=>{const n=L();return e.jsxs(D,{formMethods:n,onSubmit:r,children:[e.jsx(c,{readOnly:!1,alleKodeverk:z,permisjonRettigheterPanel:e.jsx("div",{children:"Dummy for panel Permisjon-rettigheter"}),fagsakPersonnummer:"07078518434"}),e.jsx(i,{fourtyPx:!0}),e.jsx(B,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})},d=ee.bind({});d.args={submitCallback:C("button-click")};var x,j,K;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`({
  submitCallback
}) => {
