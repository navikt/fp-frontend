import{u as O,j as a,o as G,O as T,P as s,e as P}from"./iframe-C7Uf29fy.js";import{u as F,a as V,P as M,T as k,y as _,w as o,c as d,V as S,b as U,D as B,m as g,d as y,e as p,B as H}from"./nb_NO-qpdlIGct.js";import{a as J}from"./alleKodeverk-C9CgZbBn.js";import{F as Y}from"./FieldArrayRow-BTwCg2oL.js";import{M as A}from"./message-uXFzsY2n.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CqN738t4.js";const i="arbeidsforhold",w=G(50),q=l=>l.filter(({kode:e})=>e!=="NOR").map(({kode:e,navn:n})=>a.jsx("option",{value:e,children:n},e)),I=({alleKodeverk:l,readOnly:e})=>{const n=O(),{control:r}=F(),{fields:L,remove:R,append:D}=V({control:r,name:i}),K=l.Landkoder.slice().sort((v,E)=>v.navn.localeCompare(E.navn));return a.jsx(M,{fields:L,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:R,append:D,children:(v,E)=>a.jsxs(Y,{remove:R,index:E,readOnly:e,children:[a.jsx(k,{readOnly:e,control:r,name:`${i}.${E}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[w],maxLength:99}),a.jsx(_,{name:`${i}.${E}.periodeFom`,control:r,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[T]}),a.jsx(_,{name:`${i}.${E}.periodeTom`,control:r,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[T]}),a.jsx(o,{name:`${i}.${E}.land`,control:r,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:q(K),size:"small"})]},v.id)})};I.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""}}};const u=({readOnly:l,alleKodeverk:e})=>a.jsx(d,{children:a.jsxs(S,{gap:"space-16",children:[a.jsx(U,{size:"small",level:"3",children:a.jsx(A,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.Title"})}),a.jsx(B,{children:a.jsx(A,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtland.SkalIkkeRegistrereArbeidsforhold"})}),a.jsx(I,{readOnly:l,alleKodeverk:e})]})});u.initialValues=()=>({[i]:[]});const m=l=>l===void 0||l==="";u.transformValues=({arbeidsforhold:l})=>({arbeidsforhold:l?.filter(e=>!(m(e.arbeidsgiver)&&m(e.land)&&m(e.periodeFom)&&m(e.periodeTom)))});u.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""}}};const C=P(g),t=({readOnly:l,alleKodeverk:e})=>a.jsx(s,{value:C,children:a.jsx(u,{readOnly:l,alleKodeverk:e})});t.initialValues=u.initialValues;t.transformValues=u.transformValues;t.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}]},description:""}}};const{action:b}=__STORYBOOK_MODULE_ACTIONS__,x={title:"ui-komponenter/inntektsgivende-arbeid",component:t,args:{readOnly:!1,alleKodeverk:J},parameters:{submitCallback:b("onSubmit")},render:(l,{parameters:{submitCallback:e}})=>{const n=y({defaultValues:t.initialValues()});return a.jsx(p,{formMethods:n,onSubmit:r=>e(t.transformValues(r)),children:a.jsxs(S,{gap:"space-40",children:[a.jsx(t,{...l}),a.jsx(H,{size:"small",variant:"primary",children:"Lagreknapp (Kun for test)"})]})})}},N={};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:"{}",...N.parameters?.docs?.source}}};const Q=["Default"];export{N as Default,Q as __namedExportsOrder,x as default};
