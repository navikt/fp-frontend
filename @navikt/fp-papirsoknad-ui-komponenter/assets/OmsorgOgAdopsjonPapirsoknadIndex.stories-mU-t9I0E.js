import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{a as V,f as _,h as P,b as h,V as S,c as E,M as I,e as k,H as T,A as J,P as G,r as X,m as $,d as H,N as L,B as z}from"./nb_NO-CeJ5uFhL.js";import{e as c,p as f,c as K,o as C,l as Q,S as v,V as U,a as W}from"./index.es-DNHabqwj.js";import"./aktivitetStatus-B1m96ipJ.js";import{F as n}from"./familieHendelseType-CLnpSBng.js";import{r as Y,R as Z}from"./index-C4XKfyRp.js";import{M as j}from"./message-BshPDgZM.js";import"./dayjs.min-DkLNzaWO.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-PUjTtqh4.js";import"./index-DTjSd7F1.js";import"./v4-CtRu48qb.js";const t="omsorg",ee="_barnInput_1jjt5_1",re={barnInput:ee},ae=10,se=e=>e?C(1)(e):void 0,ne=e=>e?Q(10)(e):void 0,O=(e,r)=>o=>{if(e===0&&r&&o)return U(o,Array.isArray(r)?r[0]:r)},u=({readOnly:e=!0,familieHendelseType:r,isForeldrepengerFagsak:o,fodselsdatoer:d})=>{const{formatMessage:m}=V(),{control:B,watch:N}=_(),{fields:g,remove:M,append:x}=P({control:B,name:`${t}.foedselsDato`}),p=N(`${t}.antallBarn`)??0;return Y.useEffect(()=>{if(g.length>Math.max(p,0))for(let s=g.length;s>p;s-=1)M(s-1);else if(g.length<Math.min(p,ae))for(let s=g.length;s<p;s+=1)x({id:s,dato:void 0})},[p]),a.jsx(h,{children:a.jsxs(S,{gap:"4",children:[a.jsx(E,{size:"small",children:a.jsx(j,{id:r===n.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),o&&r===n.ADOPSJON&&a.jsx(I,{name:`${t}.erEktefellesBarn`,label:a.jsx(j,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[c],isReadOnly:e,isTrueOrFalseSelection:!0,isHorizontal:!0,radios:[{label:m({id:"Registrering.Adopsjon.Ja"}),value:"true"},{label:m({id:"Registrering.Adopsjon.Nei"}),value:"false"}]}),a.jsx(k,{name:`${t}.omsorgsovertakelsesdato`,label:m({id:r===n.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:e,validate:r===n.ADOPSJON?[c,f]:[f]}),a.jsxs(T,{gap:"4",children:[r===n.ADOPSJON&&a.jsx(k,{name:`${t}.ankomstdato`,label:m({id:"Registrering.Adopsjon.Ankomstdato"}),isReadOnly:e,validate:[f]}),a.jsx(J,{name:`${t}.antallBarn`,label:m({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:e,className:re.barnInput,parse:s=>{const i=parseInt(s.toString(),10);return Number.isNaN(i)?s:i},validate:[...r===n.ADOPSJON?[c]:[],K,se,ne]})]}),g.map((s,i)=>a.jsx(Z.Fragment,{children:a.jsx(k,{name:`${t}.foedselsDato.${i}.dato`,isReadOnly:e,validate:r===n.ADOPSJON?[c,f,v,O(i,d)]:[f,v,O(i,d)],label:m({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:i+1})})},s.id))]})})};u.initialValues=()=>({[t]:{}});u.transformValues=({omsorg:e})=>({[t]:{...e,foedselsDato:e.foedselsDato&&e.foedselsDato.length>0?e.foedselsDato.map(r=>r.dato):void 0}});u.__docgenInfo={description:`OmsorgOgAdopsjonPanel
