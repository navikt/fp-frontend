import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{e as q,f as D,g as U,I as C,W as H,c as z,L as V,P as x,y as R,S as X,H as G,M as J,w as W,O as Q,t as Z,d as ee,m as re,a as K,b as ne,$ as ae,B as se}from"./nb_NO-D_TgqB1W.js";import{K as F,a as b}from"./alleKodeverk-D-QME5s7.js";import"./withRouter-DhSU4y_G.js";import{r as te,R as oe}from"./index-DRjF_FHU.js";import{V as N,w as P,T as le,E as ie}from"./index.es-D_GpvDOR.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-CnNqAF5I.js";import"./index-rX-Bn4lm.js";const y={LONN_UNDER_UTDANNING:"LØNN_UNDER_UTDANNING",UTENLANDSK_ARBEIDSFORHOLD:"UTENLANDSK_ARBEIDSFORHOLD",FRILANSER:"FRILANSER",MILITÆR_ELLER_SIVILTJENESTE:"MILITÆR_ELLER_SIVILTJENESTE"},de="_notLastRow_7c46s_1",ue={notLastRow:de},m="andreYtelser",_="PERIODER",v=(n,a)=>n(a),I=({readOnly:n,name:a})=>{const r=q(),{getValues:s,control:o,trigger:d,formState:{isSubmitted:l}}=D(),{fields:t,remove:A,append:O}=U({control:o,name:`${m}.${a}`});return e.jsx(C,{fields:t,bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:n,append:O,remove:A,children:(B,E,j)=>{const u=`${m}.${a}.${E}`;return e.jsxs("div",{children:[e.jsx("div",{className:E!==t.length-1?ue.notLastRow:"",children:e.jsx(H,{children:e.jsxs(z,{children:[e.jsx(V,{children:e.jsx(x,{name:`${u}.periodeFom`,label:E===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[N,P,()=>{const c=v(s,`${u}.periodeFom`),k=v(s,`${u}.periodeTom`);return k&&c?le(k)(c):null}],onChange:()=>l?d():void 0})}),e.jsx(V,{children:e.jsx(x,{name:`${u}.periodeTom`,label:E===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[N,P,()=>{const c=v(s,`${u}.periodeFom`),k=v(s,`${u}.periodeTom`);return k&&c?ie(c)(k):null}],onChange:()=>l?d():void 0})}),j&&e.jsx(V,{children:j()})]})})}),e.jsx(R,{sixteenPx:!0})]},B.id)}})};I.transformValues=(n,a)=>n.map(r=>({ytelseType:a,periodeFom:r.periodeFom,periodeTom:r.periodeTom}));I.__docgenInfo={description:`RenderAndreYtelserPerioderFieldArray
