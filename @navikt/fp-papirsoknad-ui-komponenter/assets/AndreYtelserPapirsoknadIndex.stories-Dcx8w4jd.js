import{R as e,r as U}from"./index-Dl6G-zuu.js";import{h as C,i as w,l as H,q as z,W as X,e as G,L as F,f as P,b as I,S as J,H as W,M as Q,T as Z,O as ee,t as re,k as ne,m as te,a as x,c as ae,d as se,B as le}from"./nb_NO-FpxXeSMP.js";import{K as V,a as _}from"./alleKodeverk-DbawmvgK.js";import"./withRouter-BioXz9vk.js";import{r as S,b as Y,I as oe,c as ie}from"./index.es-BOP7ekyo.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-D5dJDnOJ.js";import"./index-Dmr9vlPS.js";const g={LONN_UNDER_UTDANNING:"LØNN_UNDER_UTDANNING",UTENLANDSK_ARBEIDSFORHOLD:"UTENLANDSK_ARBEIDSFORHOLD",FRILANSER:"FRILANSER",MILITÆR_ELLER_SIVILTJENESTE:"MILITÆR_ELLER_SIVILTJENESTE"},de="_notLastRow_7c46s_1",me={notLastRow:de},m="andreYtelser",N="PERIODER",y=(n,t)=>n(t),R=({readOnly:n,name:t})=>{const r=C(),{getValues:a,control:l,trigger:i,formState:{isSubmitted:o}}=w(),{fields:s,remove:b,append:B}=H({control:l,name:`${m}.${t}`});return e.createElement(z,{fields:s,bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:n,append:B,remove:b},(q,f,T)=>{const d=`${m}.${t}.${f}`;return e.createElement("div",{key:q.id},e.createElement("div",{className:f!==s.length-1?me.notLastRow:""},e.createElement(X,null,e.createElement(G,null,e.createElement(F,null,e.createElement(P,{name:`${d}.periodeFom`,label:f===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[S,Y,()=>{const p=y(a,`${d}.periodeFom`),c=y(a,`${d}.periodeTom`);return c&&p?oe(c)(p):null}],onChange:()=>o?i():void 0})),e.createElement(F,null,e.createElement(P,{name:`${d}.periodeTom`,label:f===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[S,Y,()=>{const p=y(a,`${d}.periodeFom`),c=y(a,`${d}.periodeTom`);return c&&p?ie(p)(c):null}],onChange:()=>o?i():void 0})),T&&e.createElement(F,null,T())))),e.createElement(I,{sixteenPx:!0}))})};R.transformValues=(n,t)=>n.map(r=>({ytelseType:t,periodeFom:r.periodeFom,periodeTom:r.periodeTom}));R.__docgenInfo={description:`RenderAndreYtelserPerioderFieldArray
...
Viser inputfelter for fra og til dato for perioder for andre ytelser`,methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  periodeFom: string;
  periodeTom: string;
}`,signature:{properties:[{key:"periodeFom",value:{name:"string",required:!0}},{key:"periodeTom",value:{name:"string",required:!0}}]}}],raw:"FormValues[]"}},{name:"ytelseType",optional:!1,type:{name:"string"}}],returns:{type:{name:"any"}}}],displayName:"RenderAndreYtelserPerioderFieldArray"};const j=(n,t)=>t?n.filter(r=>r.kode===g.MILITÆR_ELLER_SIVILTJENESTE):n.filter(r=>r.kode!==g.UTENLANDSK_ARBEIDSFORHOLD&&r.kode!==g.FRILANSER&&r.kode!==g.LONN_UNDER_UTDANNING),u=({readOnly:n,kunMiliterEllerSiviltjeneste:t=!1,alleKodeverk:r})=>{const{watch:a}=w(),l=a(m),i=r[V.ARBEID_TYPE],o=U.useMemo(()=>j(i,t),[t]);return e.createElement(J,null,e.createElement(W,{size:"small"},e.createElement(Q,{id:"Registrering.AndreYtelser.Title"})),e.createElement(I,{sixteenPx:!0}),o.map(s=>{const b=`${s.kode}_${N}`;return e.createElement(e.Fragment,{key:s.kode},e.createElement(Z,{key:s.kode,name:`${m}.${s.kode}`,label:s.navn,readOnly:n}),l&&l[s.kode]&&e.createElement(e.Fragment,null,e.createElement(I,{eightPx:!0}),e.createElement(ee,null,e.createElement(R,{name:b,readOnly:n}))))}))};u.buildInitialValues=n=>{const t={};return j(n).forEach(r=>{const a=`${r.kode}_${N}`;t[a]=[{}]}),{[m]:t}};u.transformValues=(n,t)=>{const r=n[m],a=[];return t.filter(l=>r&&r[l.kode]).forEach(l=>{const i=`${l.kode}_${N}`,o=r?r[i]:void 0;o&&R.transformValues(o,l.kode).forEach(s=>a.push(s))}),a};u.__docgenInfo={description:`AndreYtelserPanel
...
}`,...(h=($=E.parameters)==null?void 0:$.docs)==null?void 0:h.source}}};const Re=["Default","KunMiliterEllerSiviltjeneste"];export{k as Default,E as KunMiliterEllerSiviltjeneste,Re as __namedExportsOrder,Ie as default};
