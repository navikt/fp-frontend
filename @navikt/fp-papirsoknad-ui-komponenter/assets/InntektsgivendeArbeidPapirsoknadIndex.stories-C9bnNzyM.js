import{u as N,j as r,o as I,O as o,P as S,a as F}from"./iframe-XpiojukZ.js";import{u as K,a as L,P as q,k as P,T as g,w as D,d as B,V as E,b as V,D as O,m as G,e as _,f as M,B as w}from"./nb_NO-CkCIHybU.js";import{a as j}from"./alleKodeverk-DO07GSZv.js";import{L as b}from"./landkoder-Bgpqk6-g.js";import{F as U}from"./FieldArrayRow-CLAezeEk.js";import{M as y}from"./message-OUcHQrCx.js";import"./preload-helper-PPVm8Dsz.js";import"./index-AnHLdE_1.js";const s="arbeidsforhold",H=I(50),c=a=>a.filter(({kode:e})=>e!==b.NORGE).map(({kode:e,navn:n})=>r.jsx("option",{value:e,children:n},e)),T=({alleKodeverk:a,readOnly:e})=>{const n=N(),{control:l}=K(),{fields:p,remove:v,append:R}=L({control:l,name:s}),A=a.Landkoder.slice().sort((m,t)=>m.navn.localeCompare(t.navn));return r.jsx(q,{fields:p,addButtonText:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:e,emptyTemplate:{arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},remove:v,append:R,children:(m,t)=>r.jsxs(U,{remove:v,index:t,readOnly:e,children:[r.jsx(P,{readOnly:e,control:l,name:`${s}.${t}.arbeidsgiver`,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}),validate:[H],maxLength:99}),r.jsx(g,{name:`${s}.${t}.periodeFom`,control:l,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}),validate:[o]}),r.jsx(g,{name:`${s}.${t}.periodeTom`,control:l,isReadOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}),validate:[o]}),r.jsx(D,{name:`${s}.${t}.land`,control:l,readOnly:e,label:n.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}),selectValues:c(A),size:"small"})]},m.id)})};T.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
