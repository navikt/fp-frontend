import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{g as y,n as q,a as I}from"./index.es-8Fll0b49.js";import{d as K,e as h,f as N,I as M,W as V,b as L,L as d,F as P,P as c,n as _,y as i,S as O,H as F,M as u,D as R,t as E,c as $,m as D,a as S,$ as C,V as z,B}from"./nb_NO-gSijKUYs.js";import"./withRouter-DhSU4y_G.js";import{K as H,a as G}from"./alleKodeverk-D-QME5s7.js";import"./aktivitetStatus-B1m96ipJ.js";import{L as W}from"./landkoder-tJDPMx5C.js";import"./index-DRjF_FHU.js";import"./v4-CQkTLCs1.js";import"./dayjs.min-CnNqAF5I.js";import"./index-rX-Bn4lm.js";const U="_notLastRow_uwn16_1",Y={notLastRow:U},J=q(50),t="arbeidsforhold",Q={arbeidsgiver:"",periodeFom:"",periodeTom:"",land:""},X=s=>s.filter(({kode:r})=>r!==W.NORGE).map(({kode:r,navn:a})=>e.jsx("option",{value:r,children:a},r)),w=({alleKodeverk:s,readOnly:r})=>{const a=K(),{control:m}=h(),{fields:v,remove:x,append:f}=N({control:m,name:t}),T=s[H.LANDKODER].slice().sort((g,n)=>g.navn.localeCompare(n.navn));return e.jsx(M,{fields:v,emptyPeriodTemplate:Q,bodyText:a.formatMessage({id:"Registrering.InntektsgivendeArbeid.LeggTilArbeidsforhold"}),readOnly:r,remove:x,append:f,children:(g,n,p)=>e.jsxs("div",{className:n!==v.length-1?Y.notLastRow:"",children:[e.jsx(V,{children:e.jsxs(L,{children:[e.jsx(d,{children:e.jsx(P,{readOnly:r,name:`${t}.${n}.arbeidsgiver`,label:n===0?a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Arbeidsgiver"}):"",validate:[J],maxLength:99})}),e.jsx(d,{children:e.jsx(c,{isReadOnly:r,name:`${t}.${n}.periodeFom`,label:n===0?a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeFom"}):"",validate:[y]})}),e.jsx(d,{children:e.jsx(c,{isReadOnly:r,name:`${t}.${n}.periodeTom`,label:n===0?a.formatMessage({id:"Registrering.InntektsgivendeArbeid.periodeTom"}):"",validate:[y]})}),e.jsx(d,{children:e.jsx(_,{readOnly:r,name:`${t}.${n}.land`,label:n===0?a.formatMessage({id:"Registrering.InntektsgivendeArbeid.Land"}):"",selectValues:X(T)})}),p&&e.jsx(d,{children:p()})]})}),e.jsx(i,{twentyPx:!0})]},g.id)})};w.__docgenInfo={description:`RenderInntektsgivendeArbeidFieldArray
...
Viser inputfelter for arbeidsgiver og organisasjonsnummer for registrering av arbeidsforhold.`,methods:[],displayName:"RenderInntektsgivendeArbeidFieldArray",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const k=({readOnly:s,alleKodeverk:r})=>e.jsxs(O,{children:[e.jsx(F,{size:"small",children:e.jsx(u,{id:"Registrering.InntektsgivendeArbeid.ArbeidINorge.Title"})}),e.jsx(i,{eightPx:!0}),e.jsx(R,{children:e.jsx(u,{id:"Registrering.InntektsgivendeArbeid.ArbeidINorge.SkalIkkeRegistrereArbeidsforhold"})}),e.jsx(i,{sixteenPx:!0}),e.jsx(i,{sixteenPx:!0}),e.jsx(R,{children:e.jsx(u,{id:"Registrering.InntektsgivendeArbeid.ArbeidIUtlandet.Title"})}),e.jsx(i,{eightPx:!0}),e.jsx(w,{readOnly:s,alleKodeverk:r})]});k.buildInitialValues=()=>({[t]:[{}]});k.__docgenInfo={description:`InntektsgivendeArbeidPanel
...
Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.`,methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:null}],displayName:"InntektsgivendeArbeidPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Z=E(D),o=({readOnly:s,alleKodeverk:r})=>e.jsx($,{value:Z,children:e.jsx(k,{readOnly:s,alleKodeverk:r})});o.buildInitialValues=()=>k.buildInitialValues();o.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[],returns:null}],displayName:"InntektsgivendeArbeidPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},alleKodeverk:{required:!0,tsType:{name:"intersection",raw:"Omit<T, keyof R> & R",elements:[{name:"Omit",elements:[{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
}`,signature:{properties:[{key:"kode",value:{name:"string",required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"kodeverk",value:{name:"string",required:!0}}]}}],raw:`Readonly<{
