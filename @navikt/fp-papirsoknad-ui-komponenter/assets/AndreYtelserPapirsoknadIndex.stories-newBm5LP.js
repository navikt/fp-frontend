import{R as e,r as U}from"./index-OjgoNOWw.js";import{e as C,f as w,l as H,r as z,F as X,M as G,c as F,d as T,g as R,R as J,H as Q,h as W,q as Z,i as ee,t as re,P as ne,m as te,a as x,b as ae,O as se,B as le}from"./nb_NO-oCapN-Td.js";import{K as V,a as _}from"./alleKodeverk-auwb120F.js";import"./withRouter-0tVlBzVB.js";import{r as S,b as Y,I as oe,c as ie}from"./index.es-ynu9s7Vi.js";import"./v4-yQnnJER4.js";import"./index-mQqIOHEI.js";const g={LONN_UNDER_UTDANNING:"LØNN_UNDER_UTDANNING",UTENLANDSK_ARBEIDSFORHOLD:"UTENLANDSK_ARBEIDSFORHOLD",FRILANSER:"FRILANSER",MILITÆR_ELLER_SIVILTJENESTE:"MILITÆR_ELLER_SIVILTJENESTE"},de="_notLastRow_7c46s_1",me={notLastRow:de},m="andreYtelser",N="PERIODER",y=(n,t)=>n(t),I=({readOnly:n,name:t})=>{const r=C(),{getValues:a,control:l,trigger:i,formState:{isSubmitted:o}}=w(),{fields:s,remove:b,append:O}=H({control:l,name:`${m}.${t}`});return e.createElement(z,{fields:s,bodyText:r.formatMessage({id:"Registrering.FrilansOppdrag.FieldArray.NyPeriode"}),readOnly:n,append:O,remove:b},(q,f,P)=>{const d=`${m}.${t}.${f}`;return e.createElement("div",{key:q.id},e.createElement("div",{className:f!==s.length-1?me.notLastRow:""},e.createElement(X,null,e.createElement(G,null,e.createElement(F,null,e.createElement(T,{name:`${d}.periodeFom`,label:f===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeFom"}):"",validate:[S,Y,()=>{const p=y(a,`${d}.periodeFom`),c=y(a,`${d}.periodeTom`);return c&&p?oe(c)(p):null}],onChange:()=>o?i():void 0})),e.createElement(F,null,e.createElement(T,{name:`${d}.periodeTom`,label:f===0?r.formatMessage({id:"Registrering.AndreYtelser.periodeTom"}):"",validate:[S,Y,()=>{const p=y(a,`${d}.periodeFom`),c=y(a,`${d}.periodeTom`);return c&&p?ie(p)(c):null}],onChange:()=>o?i():void 0})),P&&e.createElement(F,null,P())))),e.createElement(R,{sixteenPx:!0}))})};I.transformValues=(n,t)=>n.map(r=>({ytelseType:t,periodeFom:r.periodeFom,periodeTom:r.periodeTom}));I.__docgenInfo={description:`RenderAndreYtelserPerioderFieldArray
...
}`,...(h=($=E.parameters)==null?void 0:$.docs)==null?void 0:h.source}}};const Re=["Default","KunMiliterEllerSiviltjeneste"];export{k as Default,E as KunMiliterEllerSiviltjeneste,Re as __namedExportsOrder,ve as default};
