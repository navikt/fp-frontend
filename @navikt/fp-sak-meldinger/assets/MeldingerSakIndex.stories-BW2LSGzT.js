...
Readonly<{
  ...
  kontrollResultat: Risikoklassifisering;
  ugunstAksjonspunkt: boolean;
}>`}]},description:""}}};const di=e=>U.jsx("div",{style:{width:"600px",margin:"50px",padding:"20px",backgroundColor:"white"},children:U.jsx(e,{})}),gi=[{kode:ae.INNHENTE_OPPLYSNINGER,navn:"Innhent dokumentasjon",tilgjengelig:!0},{kode:ae.VARSEL_OM_REVURDERING,navn:"Revurderingsdokumentasjon",tilgjengelig:!0}],ci=[{kode:ce.BARN_IKKE_REGISTRERT_FOLKEREGISTER,navn:"Barn ikke registrert i folkeregisteret",kodeverk:"UGUNST"},{kode:ce.ANNET,navn:"Annet",kodeverk:"UGUNST"}],_i={title:"sak/sak-meldinger",component:$r,decorators:[di],args:{kanVeilede:!1,revurderingVarslingArsak:ci,behandling:{brevmaler:gi,sprakkode:"NO"},previewCallback:gn("button-click"),submitCallback:gn("button-click"),setMeldingFormData:gn("button-click")}},Ze={args:{fagsakYtelseType:Ae.FORELDREPENGER,brukerManglerAdresse:!1}},Je={args:{fagsakYtelseType:Ae.SVANGERSKAPSPENGER,brukerManglerAdresse:!1}},Qe={args:{fagsakYtelseType:Ae.FORELDREPENGER,brukerManglerAdresse:!0}};var sr,ir,lr;Ze.parameters={...Ze.parameters,docs:{...(sr=Ze.parameters)==null?void 0:sr.docs,source:{originalSource:`{
  args: {
