 ...
 */var zn;function ra(){if(zn)return Ie;zn=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(r,a,s){var o=null;if(s!==void 0&&(o=""+s),a.key!==void 0&&(o=""+a.key),"key"in a){s={};for(var d in a)d!=="key"&&(s[d]=a[d])}else s=a;return a=s.ref,{$$typeof:e,type:r,key:o,ref:a!==void 0?a:null,props:s}}return Ie.Fragment=t,Ie.jsx=n,Ie.jsxs=n,Ie}var Wn;function ta(){return Wn||(Wn=1,Yn.exports=ra()),Yn.exports}var Le=ta();const aa=({children:e})=>!e||Array.isArray(e)&&e.length===0?null:Le.jsx(Ct,{variant:"warning",size:"small",children:Le.jsx(hn,{gap:"2",children:_.Children.map(e,t=>Le.jsx(Ge,{size:"small",children:t},st(t)?t.key:t))})}),rn={"HelpText.Aksjonspunkt":"Aksjonspunkt","HelpText.Aksjonspunkt.BehandletAksjonspunkt":"Behandlet aksjonspunkt: ","DataFetchPendingModal.LosningenJobberMedBehandlingen":"Løsningen jobber med behandlingen...","Behandling.EditedField":"Saksbehandler har endret feltets verdi","OkAvbrytModal.Ok":"OK","OkAvbrytModal.Avbryt":"Avbryt","OverstyringKnapp.Overstyring":"Overstyr","OverstyringKnapp.HarOverstyrt":"Har overstyrt","PeriodFieldArray.LeggTilPeriode":"Legg til periode","ExpandableTableRow.Apne":"Åpne rad","ExpandableTableRow.Lukke":"Lukk rad","Calendar.Day.0":"søndag","Calendar.Day.1":"mandag","Calendar.Day.2":"tirsdag","Calendar.Day.3":"onsdag","Calendar.Day.4":"torsdag","Calendar.Day.5":"fredag","Calendar.Day.6":"lørdag","Calendar.Day.Short.0":"søn","Calendar.Day.Short.1":"man","Calendar.Day.Short.2":"tir","Calendar.Day.Short.3":"ons","Calendar.Day.Short.4":"tor","Calendar.Day.Short.5":"fre","Calendar.Day.Short.6":"lør","Calendar.Month.0":"Januar","Calendar.Month.1":"Februar","Calendar.Month.2":"Mars","Calendar.Month.3":"April","Calendar.Month.4":"Mai","Calendar.Month.5":"Juni","Calendar.Month.6":"Juli","Calendar.Month.7":"August","Calendar.Month.8":"September","Calendar.Month.9":"Oktober","Calendar.Month.10":"November","Calendar.Month.11":"Desember","UtvidbarTekst.VisMer":"Vis mer","UtvidbarTekst.VisMindre":"Vis mindre"};be(rn);var Jn={exports:{}};/*!
...
har ikke en registrert adresse.`,methods:[],displayName:"UkjentAdresseMeldingIndex"};const js="_bredde_jav4h_9",ir={bredde:js},Os=Ur(4e3),xs=Ur(1e4),qs=As(3),Is=e=>e===ae.INNHENTE_OPPLYSNINGER||e===ae.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",Fs=(e,t)=>e===ae.INNHENTE_OPPLYSNINGER||e===ae.FRITEKST||e===ae.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===ae.VARSEL_OM_TILBAKEKREVING||e===ae.TBK_INNHENTE_OPPLYSNINGER||e===ae.VARSEL_OM_REVURDERING&&t===fe.ANNET,Bs=(e,t)=>t===Se.ENGANGSSTONAD?e.filter(n=>n.kode===fe.BARN_IKKE_REGISTRERT_FOLKEREGISTER||n.kode===fe.ANNET):t===Se.SVANGERSKAPSPENGER?e.filter(n=>n.kode!==fe.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&n.kode!==fe.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Ds=e=>{var n;const t={brevmalkode:((n=e.brevmaler[0])==null?void 0:n.kode)??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...t,brevmalkode:ae.VARSEL_OM_REVURDERING}:{...t}},Ls=e=>{const t=e;return e.brevmalkode===ae.VARSEL_OM_REVURDERING&&t.arsakskode!==fe.ANNET&&(t.fritekst=" "),t},$r=({behandling:e,forhåndsvisBrev:t,submitCallback:n,revurderingVarslingArsak:r,fagsakYtelseType:a,kanVeilede:s,meldingFormData:o,setMeldingFormData:d,brukerManglerAdresse:h})=>{const S=lt(),m=jt({defaultValues:o??Ds(e)}),w=m.watch("brevmalkode"),E=m.watch("fritekst"),j=m.watch("arsakskode"),q=Bs(r,a);if(!e.språkkode)return null;const{formState:I}=m,v=b=>{w&&E?t({brevmalkode:w,fritekst:E,arsakskode:j}):E||m.setError("fritekst",{type:"manual",message:S.formatMessage({id:"Messages.FritekstRequired"})}),b.preventDefault()},y=it(e.språkkode),f=w===ae.VARSEL_OM_REVURDERING;return U.jsx(Ia,{formMethods:m,onSubmit:b=>n(Ls(b)),setDataOnUnmount:d,children:U.jsxs(hn,{gap:"4",children:[U.jsx(tr,{name:"brevmalkode",label:S.formatMessage({id:"Messages.Template"}),validate:[fn],selectValues:e.brevmaler.map(b=>U.jsx("option",{value:b.kode,disabled:!b.tilgjengelig,children:b.navn},b.kode)),className:ir.bredde}),f&&U.jsx(tr,{name:"arsakskode",label:S.formatMessage({id:"Messages.Årsak"}),validate:[fn],selectValues:q.map(b=>U.jsx("option",{value:b.kode,children:b.navn},b.kode)),className:ir.bredde}),Fs(w,j)&&U.jsx(qa,{name:"fritekst",label:S.formatMessage({id:Is(w)}),validate:[fn,f?xs:Os,qs,Ns],maxLength:f?1e4:4e3,badges:[{type:"info",titleText:y}],parse:ot}),h&&U.jsx(Hr,{}),U.jsxs(Ar,{justify:"space-between",children:[(!f||f&&j!==void 0)&&U.jsx(Yt,{href:"#",onClick:v,onKeyDown:b=>b.key==="Enter"?v(b):null,children:U.jsx(cn,{id:"Messages.Preview"})}),U.jsx(hr,{size:"small",variant:"primary",loading:I.isSubmitting,disabled:I.isSubmitting||s,onClick:Rs,children:U.jsx(cn,{id:"Messages.Submit"})})]})]})})};$r.__docgenInfo={description:`Messages
