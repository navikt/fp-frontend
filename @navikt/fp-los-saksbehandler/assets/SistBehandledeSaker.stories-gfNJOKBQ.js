import{j as s}from"./jsx-runtime-CUEGZZF9.js";import{a as u,b as k,r as A}from"./fplosSaksbehandlerRestApi-_SSph0Id.js";import{g,m as h}from"./nb_NO-krMYD0qI.js";import{S as i}from"./SistBehandledeSaker-XCmyAdKs.js";import"./index-DogsOklH.js";import"./useGlobalStateRestApiData-n3nAw5-C.js";import"./index-MroJ3egt.js";const E=g(h),P={title:"los/saksbehandler/saksstotte/SistBehandledeSaker",component:i,decorators:[E]},c=({behandledeOppgaver:m})=>{const l=[{key:u.BEHANDLEDE_OPPGAVER.name,data:m}];return s(k,{data:l,requestApi:A,children:s(i,{åpneFagsak:()=>{}})})},e=c.bind({});e.args={behandledeOppgaver:[{id:1,personnummer:"334342323",navn:"Espen Utvikler"}]};const a=c.bind({});var t,n,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`({
  behandledeOppgaver
}) => {
  const data = [{
