import{r as l,R as e}from"./index-DVXBtNgz.js";import{H as D,e as G,j as T,t as M,P as Y,m as z,d as m,N as g}from"./nb_NO-OtGB-zeg.js";import{Y as i,z as A,b as f}from"./index.es-BkMxg3KK.js";import{c as y,a as r,r as P,R as c,b as J}from"./fplosSaksbehandlerRestApi-B5-o2O8e.js";import{R as $,a as R}from"./useRestApiRunner-ChU66ucg.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as I}from"./SakslisteVelgerForm-DKdvSJxu.js";import{F as Z}from"./FagsakSearchIndex-B5i0J6cS.js";import{O as ee}from"./OppgaveErReservertAvAnnenModal-CWJfzJAI.js";import{O as ne}from"./OppgaverTabell-C8z49w7J.js";import{S as te}from"./SistBehandledeSaker-CSz-jg25.js";import{N as re}from"./NyeOgFerdigstilteOppgaverForIdagPanel-1rI-J-JB.js";import{N as ae}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-BL2TLtt2.js";import{D as se}from"./DriftsmeldingPanel-BfmGiPsN.js";import"./tslib.es6-CMwweBXX.js";import"./index-Cbx7Fas8.js";import"./kodeverkTyper-DJMuX7JX.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-DSB_N1ns.js";import"./PersonInfo-DMEP4Hr2.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-CiKyIFDW.js";import"./index.es-DKmDWNMo.js";import"./ExclamationmarkTriangleFill-BI5yeruA.js";import"./FagsakList-Cza8hzoG.js";import"./useLosKodeverk-BPn0-cQV.js";import"./ChevronRight-Dd-3nQCu.js";import"./BehandlingPollingTimoutModal-Dunyskcu.js";import"./OppgaveHandlingerMenu-BOPzWj_h.js";import"./FlyttReservasjonModal-B1lxaZFw.js";import"./OpphevReservasjonModal-A0LhUqK6.js";import"./OppgaveReservasjonForlengetModal-CsGMW3fB.js";import"./Panel-B02zeD3J.js";const ie=()=>{const n=l.useContext($),t=l.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=l.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:t,removeErrorMessages:a}},le=n=>{const t=window.localStorage.getItem(n);return t!=="undefined"&&t!==null?t:void 0},de=(n,t)=>{window.localStorage.setItem(n,t)},oe=n=>{window.localStorage.removeItem(n)},K=({reserverOppgave:n,sakslister:t,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(r.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.createElement(e.Fragment,null,e.createElement(D,{size:"small"},e.createElement(G,{id:"SakslistePanel.StartBehandling"})),e.createElement(T,{sixteenPx:!0}),e.createElement(W,{sakslister:t,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:le,setValueInLocalStorage:de,removeValueFromLocalStorage:oe}),e.createElement(T,{twentyPx:!0}),s&&e.createElement(ne,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s}))};K.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
