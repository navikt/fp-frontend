...
\`\`\`html
 <MerkePanel erDod={false} diskresjonskode="SPSF"  />
\`\`\``,methods:[],displayName:"MerkePanel",props:{erDød:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},diskresjonskode:{required:!1,tsType:{name:"string"},description:""}}};const R="_kvinneIcon_4m9mx_1",K="_MannIcon_4m9mx_7",c={kvinneIcon:R,MannIcon:K},v=({person:e})=>{const a=k(),{kjønn:r,dødsdato:n,diskresjonskode:s,fødselsdato:i,navn:y,fødselsnummer:j}=e,I=_().diff(i,"years");return t.jsxs(P,{gap:"4",children:[r===p.KVINNE&&t.jsx(q,{className:c.kvinneIcon,title:a.formatMessage({id:"Person.ImageText"})}),r===p.MANN&&t.jsx(S,{className:c.MannIcon,title:a.formatMessage({id:"Person.ImageText"})}),t.jsxs(M,{gap:"1",children:[t.jsxs(x,{size:"small",children:[y," ",t.jsx(u,{erDød:!!n,alder:I,dødsdato:n})]}),t.jsx(E,{children:j})]}),t.jsx(f,{erDød:!!n,diskresjonskode:s})]})};v.__docgenInfo={description:"",methods:[],displayName:"PersonInfo",props:{person:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  navn: string;
  kjønn: Kjønnkode;
