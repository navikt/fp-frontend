...
\`\`\``,methods:[],displayName:"MerkePanel",props:{erDod:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},diskresjonskode:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}}}};const q="_kvinneIcon_4m9mx_1",x="_MannIcon_4m9mx_7",g={kvinneIcon:q,MannIcon:x},I=({person:e})=>{const l=E(),{kjønn:t,dødsdato:n,diskresjonskode:a,fødselsdato:s,navn:k,fødselsnummer:y}=e,P=M().diff(s,"years");return r.createElement(_,null,r.createElement(b,null,r.createElement(m,null,t===p.KVINNE&&r.createElement(R,{className:g.kvinneIcon,title:l.formatMessage({id:"Person.ImageText"})}),t===p.MANN&&r.createElement(D,{className:g.MannIcon,title:l.formatMessage({id:"Person.ImageText"})})),r.createElement(m,null,r.createElement(h,{size:"small"},k," ",r.createElement(c,{erDod:!!n,alder:P,dodsdato:n})),r.createElement(j,null,y)),r.createElement(m,null,r.createElement(f,{erDod:!!n,diskresjonskode:a}))))},L=I;I.__docgenInfo={description:`PersonInfo
...
\`\`\``,methods:[],displayName:"PersonInfo",props:{person:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  dødsdato?: string;
  diskresjonskode?: string;
}>`},description:""}}};export{u as D,L as P};
