import{j as e,d as g}from"./dayjs.min-DKYhEbg2.js";import{f as D,d as G,j as T,t as M,P as Y,m as z,A as m}from"./nb_NO-DY6WQH50.js";import{Y as i,z as A,b as f}from"./index.es-BkMxg3KK.js";import{c as y,a as t,r as P,R as h,b as J}from"./fplosSaksbehandlerRestApi-CWRPAkFP.js";import{r as d}from"./index-BBkUAzwr.js";import{R as $,a as R}from"./useRestApiRunner-DyfIg1tq.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as I}from"./SakslisteVelgerForm-CsYxNpIL.js";import{F as Z}from"./FagsakSearchIndex-B-5BDt0B.js";import{O as ee}from"./OppgaveErReservertAvAnnenModal-DkGl0QTv.js";import{O as ne}from"./OppgaverTabell-ysBDq0pd.js";import{S as re}from"./SistBehandledeSaker-BjRVfOd3.js";import{N as te}from"./NyeOgFerdigstilteOppgaverForIdagPanel-DoPoEXnc.js";import{N as ae}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-Du0o_iVR.js";import{D as se}from"./DriftsmeldingPanel-W4-RuWU8.js";import"./index-BfZ0jBbx.js";import"./kodeverkTyper-DJMuX7JX.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-BEFku_Kf.js";import"./PersonInfo-CxVZBcGz.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-DIiuZVIg.js";import"./index.es-BU-7Ku74.js";import"./ExclamationmarkTriangleFill-D_H37nIb.js";import"./FagsakList-DB_MAJFQ.js";import"./useLosKodeverk-DwnXc9KF.js";import"./ChevronRight-Bo7ctSmw.js";import"./BehandlingPollingTimoutModal-BEbkuscW.js";import"./OppgaveHandlingerMenu-BOXS2D05.js";import"./FlyttReservasjonModal-D-CseH1C.js";import"./OpphevReservasjonModal-DNaw7Kf1.js";import"./OppgaveReservasjonForlengetModal-CnTd4QL0.js";import"./Panel-B8w0mR9w.js";const ie=()=>{const n=d.useContext($),r=d.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=d.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:r,removeErrorMessages:a}},de=n=>{const r=window.localStorage.getItem(n);return r!=="undefined"&&r!==null?r:void 0},le=(n,r)=>{window.localStorage.setItem(n,r)},oe=n=>{window.localStorage.removeItem(n)},K=({reserverOppgave:n,sakslister:r,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(t.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.jsxs(e.Fragment,{children:[e.jsx(D,{size:"small",children:e.jsx(G,{id:"SakslistePanel.StartBehandling"})}),e.jsx(T,{sixteenPx:!0}),e.jsx(W,{sakslister:r,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:de,setValueInLocalStorage:le,removeValueFromLocalStorage:oe}),e.jsx(T,{twentyPx:!0}),s&&e.jsx(ne,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s})]})};K.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
