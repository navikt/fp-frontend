import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as a}from"./nb_NO-PJw1SMOb.js";import{S as v}from"./SøkForm-BHKKr6Nh.js";import{P as k}from"./PersonInfo-a3WN6mHd.js";import{S as p}from"./SøkResultat-_StdyQTy.js";import{V as y}from"./VStack-DQS0cWsb.js";import"./index-C4XKfyRp.js";import{M as i}from"./message-DXlD9FOu.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:g,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>n.jsxs(y,{gap:"4",children:[n.jsx(v,{onSubmit:t,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(k,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(p,{åpneFagsak:g,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
