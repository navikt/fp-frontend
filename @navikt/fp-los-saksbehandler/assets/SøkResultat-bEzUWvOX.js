import{j as e,r as f,d as y,b as T}from"./iframe-C1nA0uJj.js";import{H as b}from"./index.es-BNCrfEq9.js";import{u as o}from"./useLosKodeverk-D792-3CQ.js";import{T as n}from"./Table-DLQ_cduH.js";import{M as i}from"./message-C68V_5Jb.js";import{S as j}from"./ChevronRight-ij5d9pMO.js";var u=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(u||{});const R=(r,a)=>{if(r.status===u.AVSLUTTET&&a.status!==u.AVSLUTTET)return 1;if(r.status!==u.AVSLUTTET&&a.status===u.AVSLUTTET)return-1;const l=r.endret??r.opprettet,d=a.endret??a.opprettet;return y(l,T).diff(y(d,T))},x=({fagsaker:r,fagsakOppgaver:a,åpneFagsak:l,selectOppgaveCallback:d})=>{const h=o("FagsakStatus"),m=o("FagsakYtelseType"),q=o("BehandlingType"),c=[...r].sort(R);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:c.map(t=>{const v=h.find(s=>s.kode===t.status),p=m.find(s=>s.kode===t.fagsakYtelseType),k=a.filter(s=>s.saksnummer===t.saksnummer).map(s=>e.jsxs(n.Row,{onMouseDown:()=>d(s),onKeyDown:()=>d(s),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:m.find(g=>g.kode===s.fagsakYtelseType)?.navn}),e.jsx(n.DataCell,{children:q.find(g=>g.kode===s.behandlingstype)?.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(b,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(j,{})})]},s.id));return e.jsxs(f.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>l(t.saksnummer),onKeyDown:()=>l(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(b,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(j,{})})]}),k.length>0&&k]},t.saksnummer)})})]})};x.__docgenInfo={description:`FagsakList
...
Formaterer fagsak-søkeresultatet for visning i tabell. Sortering av fagsakene blir håndtert her.`,methods:[],displayName:"SøkResultat",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  behandlingId: string;
  andreKriterier: AndreKriterierType[];
}>`},name:"oppgave"}],return:{name:"void"}}},description:""}}};export{u as F,x as S};
