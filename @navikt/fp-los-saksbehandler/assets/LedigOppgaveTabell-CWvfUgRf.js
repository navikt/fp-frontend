import{u as B,r as d,j as e}from"./iframe-BVcRJGzc.js";import"./FlyttReservasjonModal-D3ilA9KH.js";import{B as S}from"./BehandlingPollingTimoutModal-CcK3PdFN.js";import{G as x}from"./index.es-DFzNGyCV.js";import{T as w,C as O,S as N,O as E}from"./OppgaveLabels-DPvi2Tgz.js";import{T as i}from"./Table-DhotFuBY.js";import{H as T,V as y}from"./VStack-1ft0JNw9.js";import{B as h,L as I}from"./nb_NO-Cya3_SoH.js";import{S as L}from"./Checkmark-CxdDsreu.js";import{u as _}from"./useMutation-DB69isbj.js";import{b as K,c as D}from"./fplosSaksbehandlerApi-DrPTghV4.js";import{M as o}from"./Loader-LcxfTbh8.js";var C=(n=>(n.PENDING="PENDING",n.COMPLETE="COMPLETE",n.DELAYED="DELAYED",n.CANCELLED="CANCELLED",n.HALTED="HALTED",n))(C||{});const M="_image_lxw0f_1",P="_fadeIn_lxw0f_9",k={image:M,fadeIn:P},f=({oppgave:n,reserverOppgave:t,erNyBehandling:l})=>{const r=B(),a=d.useRef(null),u=(s,g)=>{a.current?.contains(s.target)||g&&t(g)};return e.jsxs(i.Row,{onMouseDown:s=>u(s,n),onKeyDown:s=>u(s,n),className:l?k.fadeIn:void 0,children:[e.jsx(i.DataCell,{children:n.navn??"<navn>"}),e.jsx(i.DataCell,{children:e.jsxs(T,{align:"center",ref:a,wrap:!1,children:[e.jsx(h,{children:n.saksnummer}),e.jsx(w,{content:r.formatMessage({id:"LedigOppgaveRad.Saksnr"}),children:e.jsx(O,{activeIcon:e.jsx(L,{className:k.image,"aria-hidden":!0}),copyText:n.saksnummer,icon:e.jsx(N,{"aria-hidden":!0,className:k.image})})})]})}),e.jsx(i.DataCell,{children:e.jsx(E,{oppgave:n})}),e.jsx(i.DataCell,{children:n.opprettetTidspunkt&&e.jsx(x,{dateString:n.opprettetTidspunkt})})]},n.id)};f.__docgenInfo={description:"",methods:[],displayName:"LedigOppgaveRad",props:{oppgave:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
