import{j as e,r as x,d as b,b as j}from"./iframe-D5gt21PO.js";import{H as h}from"./index.es-CoA4ZD_x.js";import{u as o}from"./useLosKodeverk-BmFhK4EY.js";import{T as n}from"./Table-XorNTw9V.js";import{M as i}from"./message-BycedRya.js";import{S as q}from"./ChevronRight-WVSEFdZ5.js";var u=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(u||{});const A=(r,a)=>{if(r.status===u.AVSLUTTET&&a.status!==u.AVSLUTTET)return 1;if(r.status!==u.AVSLUTTET&&a.status===u.AVSLUTTET)return-1;const l=r.endret??r.opprettet,d=a.endret??a.opprettet;return b(l,j).diff(b(d,j))},S=({fagsaker:r,fagsakOppgaver:a,åpneFagsak:l,selectOppgaveCallback:d})=>{const c=o("FagsakStatus"),m=o("FagsakYtelseType"),f=o("BehandlingType"),R=[...r].sort(A);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:R.map(t=>{const v=c.find(s=>s.kode===t.status),p=m.find(s=>s.kode===t.fagsakYtelseType),k=a.filter(s=>s.saksnummer===t.saksnummer).map(s=>{var y,T;return e.jsxs(n.Row,{onMouseDown:()=>d(s),onKeyDown:()=>d(s),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:(y=m.find(g=>g.kode===s.fagsakYtelseType))==null?void 0:y.navn}),e.jsx(n.DataCell,{children:(T=f.find(g=>g.kode===s.behandlingstype))==null?void 0:T.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(h,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(q,{})})]},s.id)});return e.jsxs(x.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>l(t.saksnummer),onKeyDown:()=>l(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(h,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(q,{})})]}),k.length>0&&k]},t.saksnummer)})})]})};S.__docgenInfo={description:`FagsakList
