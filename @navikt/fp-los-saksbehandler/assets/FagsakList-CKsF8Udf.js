import{j as e,d as b}from"./dayjs.min-ZUODdiE-.js";import{r as T}from"./index-uubelm5h.js";import{k as E,y as h,l as r,$ as q,A as c}from"./nb_NO-aGCfMFDj.js";import{I as u,v as d}from"./index.es-BkMxg3KK.js";import{g as v}from"./kodeverkUtils-RGNAgZhp.js";import{u as f}from"./useLosKodeverk-CTExDMTH.js";import{c as I,R as L}from"./fplosSaksbehandlerRestApi-C88bg1W5.js";import{S as j}from"./ChevronRight-BVDKmTYK.js";const Y="_table_o6uje_1",K={table:Y},B=["FagsakList.Saksnummer","FagsakList.Stonadstype","FagsakList.Behandlingstype","FagsakList.Status","FagsakList.BarnFodt","EMPTY_1"],S=(i,s)=>()=>s(i),A=i=>(s,t)=>{t&&i(t)},U=(i=[])=>i.concat().sort((s,t)=>{if(s.status===d.AVSLUTTET&&t.status!==d.AVSLUTTET)return 1;if(s.status!==d.AVSLUTTET&&t.status===d.AVSLUTTET)return-1;const g=s.endret?s.endret:s.opprettet,l=t.endret?t.endret:t.opprettet;return b(g,c).diff(b(l,c))}),R=({fagsaker:i,fagsakOppgaver:s,åpneFagsak:t,selectOppgaveCallback:g})=>{const l=f(u.FAGSAK_STATUS),F=f(u.FAGSAK_YTELSE),o=I.useGlobalStateRestApiData(L.KODEVERK_LOS),w=T.useMemo(()=>U(i),[i]);return e.jsx(E,{headerTextCodes:B,classNameTable:K.table,children:w.map(a=>{const k=l.find(n=>n.kode===a.status),p=F.find(n=>n.kode===a.fagsakYtelseType),y=s.filter(n=>n.saksnummer.toString()===a.saksnummer),m=y.map((n,x)=>e.jsxs(h,{id:n.id,onMouseDown:S(n,g),onKeyDown:S(n,g),isDashedBottomBorder:y.length>x+1,children:[e.jsx(r,{}),e.jsx(r,{children:v(o,u.FAGSAK_YTELSE,n.fagsakYtelseType)}),e.jsx(r,{children:v(o,u.BEHANDLING_TYPE,n.behandlingstype)}),e.jsx(r,{children:n.behandlingStatus?v(o,u.BEHANDLING_STATUS,n.behandlingStatus):""}),e.jsx(r,{children:a.barnFødt?e.jsx(q,{dateString:a.barnFødt}):null}),e.jsx(r,{children:e.jsx(j,{})})]},`oppgave${n.id}`));return e.jsxs(T.Fragment,{children:[e.jsxs(h,{id:a.saksnummer,onMouseDown:A(t),onKeyDown:A(t),isDashedBottomBorder:m.length>0,children:[e.jsx(r,{children:a.saksnummer}),e.jsx(r,{children:p?p.navn:""}),e.jsx(r,{}),e.jsx(r,{children:k?k.navn:""}),e.jsx(r,{children:a.barnFødt?e.jsx(q,{dateString:a.barnFødt}):null}),e.jsx(r,{children:e.jsx(j,{})})]}),m.length>0&&m]},`fagsak${a.saksnummer}`)})})},C=R;R.__docgenInfo={description:`FagsakList
...
Presentasjonskomponent. Formaterer fagsak-søkeresultatet for visning i tabell. Sortering av fagsakene blir håndtert her.`,methods:[],displayName:"FagsakList",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erTilSaksbehandling: boolean;
  behandlingId: string;
}>`},name:"oppgave"}],return:{name:"void"}}},description:""}}};export{C as F};
