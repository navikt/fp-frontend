import{g as O,r as U,s as P,l as G,d as V,h as a,L as s,H as r}from"./fplosSaksbehandlerApi-bDEMoisP.js";import{L as q,A as j}from"./LedigOppgaveTabell-B2xIQoeY.js";import{j as e,r as E,P as w,e as F,w as M}from"./iframe-FHusWhXg.js";import"./FlyttReservasjonModal-rppp-6Sj.js";import{a as x}from"./alleKodeverkLos-JR0SOFbV.js";import{u as p}from"./useQuery-CkNNG0T0.js";import{Z as Y}from"./index.es-D-No7bk3.js";import{u as y}from"./useMutation-FCyebI87.js";import{O as C}from"./OppgaveErReservertAvAnnenModal-IRWKIWnr.js";import{R as H}from"./ReservertOppgaveTabell-CpRGETvf.js";import{S as J}from"./SakslisteVelgerForm-BOczwcfv.js";import{V as _}from"./VStack-IrdgVemv.js";import{D as Q}from"./DriftsmeldingPanel-BwRpiZ4p.js";import{F as Z}from"./FagsakSøkIndex-BGbEbaRz.js";import{S as z}from"./SistBehandledeSaker-DboXxzmZ.js";import{m as W}from"./nb_NO-DyXQqJfF.js";import"./BehandlingPollingTimoutModal-CWDs2jNU.js";import"./Modal-DyPCRWrt.js";import"./floating-ui.react-CszcVAZV.js";import"./Loader-B5b3277y.js";import"./composeEventHandlers-C1c8aMmq.js";import"./index-BOr9xCvS.js";import"./ChevronDown-C-QCVTfa.js";import"./ExclamationmarkTriangleFill-D6Ax06qJ.js";import"./OppgaveLabels-ClrPKQgA.js";import"./Checkmark-BcjwY8VW.js";import"./useLosKodeverk-CDYNCpzd.js";import"./Tag-CclJAQl6.js";import"./Table-B8DGsauB.js";import"./Tooltip-CsclIVM2.js";import"./Portal-Bzzdoe31.js";import"./preload-helper-PPVm8Dsz.js";import"./index.es-Bh-bsHNz.js";import"./OppgaveHandlingerMenu-BIxIAp8p.js";import"./OppgaveReservasjonForlengetModal-Hyxf7ndQ.js";import"./NotatModal-BhQ-eWsY.js";import"./ChevronRight-DMWBSDUn.js";import"./HourglassTopFilled-DeVld3oe.js";import"./PersonHeadset-CveZALRN.js";import"./FagsakSøk-BaVizPfS.js";import"./SøkForm-DYHXldN0.js";import"./PersonInfo-DiZQGoOw.js";import"./Kjonnkode-DjBoP8-t.js";import"./SøkResultat-CzZLlrLk.js";const X=n=>{const t=globalThis.localStorage.getItem(n);return t!=="undefined"&&t!==null?t:void 0},$=(n,t)=>{globalThis.localStorage.setItem(n,t)},ee=n=>{globalThis.localStorage.removeItem(n)},I=({reserverOppgave:n,sakslister:t,setValgtSakslisteId:u,valgtSakslisteId:m,brukernavn:d})=>{const{mutate:o,data:i}=y({mutationFn:O});return e.jsxs(_,{gap:"space-32",children:[e.jsx(J,{sakslister:t,setValgtSakslisteId:u,fetchAntallOppgaver:o,getValueFromLocalStorage:X,setValueInLocalStorage:$,removeValueFromLocalStorage:ee}),!!m&&e.jsx(q,{reserverOppgave:n,antallOppgaver:i,valgtSakslisteId:m}),e.jsx(H,{reserverOppgave:n,brukernavn:d})]})};I.__docgenInfo={description:"",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
