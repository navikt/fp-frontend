import{j as e}from"./iframe-BgqHI6_D.js";import{S as E}from"./SøkForm-CKrmpj_x.js";import{P as d}from"./PersonInfo-CNcS-bZP.js";import{S as R}from"./SøkResultat-DD-nE3Ao.js";import{V as o}from"./VStack-D-GBvM_X.js";import{B as l}from"./nb_NO-DNaahZtR.js";import{M as i}from"./Loader-DOoSrnUO.js";const p=(n,r)=>n.length>1||n.length===1&&r.filter(a=>a.saksnummer===n.at(0)?.saksnummer).length>1,k=({fagsaker:n,fagsakOppgaver:r,searchFagsakCallback:a,selectOppgaveCallback:s,searchResultReceived:t,åpneFagsak:u,searchStarted:m,searchResultAccessDenied:v,resetSearch:T,kanSaksbehandle:g})=>e.jsxs(o,{gap:"space-16",children:[e.jsx(E,{onSubmit:a,searchStarted:m,searchResultAccessDenied:v,resetSearch:T,kanSaksbehandle:g}),t&&n.length===0&&e.jsx(l,{children:e.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),t&&p(n,r)&&e.jsxs(e.Fragment,{children:[e.jsx(d,{person:n[0].person}),e.jsx(l,{size:"small",children:e.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),e.jsx(R,{åpneFagsak:u,selectOppgaveCallback:s,fagsaker:n,fagsakOppgaver:r})]})]});k.__docgenInfo={description:`FagsakSøk
