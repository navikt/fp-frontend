import{r as b,R as e}from"./index-DogsOklH.js";import{k as I,x as c,l as r,C as T,d as q,N as f}from"./nb_NO-NgrW6B2a.js";import{I as u,v as g}from"./index.es-V78UKnai.js";import{g as k}from"./kodeverkUtils-d7epiQ_o.js";import{u as h}from"./useLosKodeverk-5u2qWEa5.js";import{c as L,R as Y}from"./fplosSaksbehandlerRestApi-GEsMItNL.js";import{C as S}from"./ChevronRight-_QnLl86z.js";const K="_table_o6uje_1",B={table:K},U=["FagsakList.Saksnummer","FagsakList.Stonadstype","FagsakList.Behandlingstype","FagsakList.Status","FagsakList.BarnFodt","EMPTY_1"],E=(i,s)=>()=>s(i),A=i=>(s,t)=>{t&&i(t)},N=(i=[])=>i.concat().sort((s,t)=>{if(s.status===g.AVSLUTTET&&t.status!==g.AVSLUTTET)return 1;if(s.status!==g.AVSLUTTET&&t.status===g.AVSLUTTET)return-1;const l=s.endret?s.endret:s.opprettet,d=t.endret?t.endret:t.opprettet;return q(l,f).diff(q(d,f))}),R=({fagsaker:i,fagsakOppgaver:s,åpneFagsak:t,selectOppgaveCallback:l})=>{const d=h(u.FAGSAK_STATUS),F=h(u.FAGSAK_YTELSE),o=L.useGlobalStateRestApiData(Y.KODEVERK_LOS),j=b.useMemo(()=>N(i),[i]);return e.createElement(I,{headerTextCodes:U,classNameTable:B.table},j.map(a=>{const v=d.find(n=>n.kode===a.status),p=F.find(n=>n.kode===a.fagsakYtelseType),y=s.filter(n=>n.saksnummer.toString()===a.saksnummer),m=y.map((n,w)=>e.createElement(c,{key:`oppgave${n.id}`,id:n.id,onMouseDown:E(n,l),onKeyDown:E(n,l),isDashedBottomBorder:y.length>w+1},e.createElement(r,null),e.createElement(r,null,k(o,u.FAGSAK_YTELSE,n.fagsakYtelseType)),e.createElement(r,null,k(o,u.BEHANDLING_TYPE,n.behandlingstype)),e.createElement(r,null,n.behandlingStatus?k(o,u.BEHANDLING_STATUS,n.behandlingStatus):""),e.createElement(r,null,a.barnFødt?e.createElement(T,{dateString:a.barnFødt}):null),e.createElement(r,null,e.createElement(S,null))));return e.createElement(b.Fragment,{key:`fagsak${a.saksnummer}`},e.createElement(c,{id:a.saksnummer,onMouseDown:A(t),onKeyDown:A(t),isDashedBottomBorder:m.length>0},e.createElement(r,null,a.saksnummer),e.createElement(r,null,p?p.navn:""),e.createElement(r,null),e.createElement(r,null,v?v.navn:""),e.createElement(r,null,a.barnFødt?e.createElement(T,{dateString:a.barnFødt}):null),e.createElement(r,null,e.createElement(S,null))),m.length>0&&m)}))},V=R;R.__docgenInfo={description:`FagsakList
