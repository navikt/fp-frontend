import{j as n}from"./iframe-CPFa3gmr.js";import{S as o}from"./SøkForm-OmRzBsKI.js";import{P as p}from"./PersonInfo-BMaHLBHK.js";import{S as k}from"./SøkResultat-oR8Ybtug.js";import{V as y}from"./VStack-Bb4vw2vW.js";import{B as s}from"./nb_NO-C12JtpDU.js";import{M as i}from"./Loader-CB5uaQ93.js";const T=(e,r)=>e?e.length>1||e.length===1&&r.filter(a=>a.saksnummer===e[0].saksnummer).length>1:!1,b=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:a,selectOppgaveCallback:l,searchResultReceived:t,åpneFagsak:u,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:v})=>n.jsxs(y,{gap:"space-16",children:[n.jsx(o,{onSubmit:a,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:v}),t&&e&&e.length===0&&n.jsx(s,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),t&&T(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(p,{person:e[0].person}),n.jsx(s,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(k,{åpneFagsak:u,selectOppgaveCallback:l,fagsaker:e,fagsakOppgaver:r})]})]});b.__docgenInfo={description:`FagsakSøk
...
| '-'`,elements:[{name:"literal",value:"'BT-002'"},{name:"literal",value:"'BT-003'"},{name:"literal",value:"'BT-004'"},{name:"literal",value:"'BT-008'"},{name:"literal",value:"'BT-006'"},{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"},{name:"literal",value:"'-'"}],required:!0}},{key:"opprettetTidspunkt",value:{name:"string",required:!0}},{key:"behandlingsfrist",value:{name:"string",required:!0}},{key:"fagsakYtelseType",value:{name:"string",required:!0}},{key:"erTilSaksbehandling",value:{name:"boolean",required:!0}},{key:"behandlingId",value:{name:"string",required:!0}},{key:"andreKriterier",value:{name:"Array",elements:[{name:"AndreKriterierType"}],raw:"AndreKriterierType[]",required:!0}},{key:"oppgaveBehandlingStatus",value:{name:"OppgaveBehandlingStatus",required:!0}}]}}],raw:`Readonly<{
  ...
  feilmelding?: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!1}}]}},description:""},resetSearch:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},kanSaksbehandle:{required:!0,tsType:{name:"boolean"},description:""}}};export{b as F};
