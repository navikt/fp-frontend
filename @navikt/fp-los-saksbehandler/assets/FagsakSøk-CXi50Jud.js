import{j as n}from"./jsx-runtime-D_zvdyIk.js";import"./withThemeDecorator-C00hjHgE.js";import{S as p}from"./SøkForm-DxUAtgyM.js";import{P as k}from"./PersonInfo-BHeVWUcK.js";import{S as v}from"./SøkResultat-COBM1Yex.js";import{V as y}from"./VStack-DZLO_5xl.js";import"./index-C4XKfyRp.js";import{B as a}from"./nb_NO-B34Cc-GC.js";import{M as i}from"./message-OO6pWzcv.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:g,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>n.jsxs(y,{gap:"4",children:[n.jsx(p,{onSubmit:t,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(k,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(v,{åpneFagsak:g,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
