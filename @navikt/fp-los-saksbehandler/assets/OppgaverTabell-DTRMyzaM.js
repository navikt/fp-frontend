...
Tooltip-content: ${u}`);const pe=y?O?{"aria-describedby":G}:{title:u}:{"aria-label":u};return g.createElement(g.Fragment,null,g.createElement(Me,Object.assign({ref:$.setReference},de(),pe,{"aria-keyshortcuts":f?f.join("+"):void 0}),r),g.createElement(Ee,{rootElement:I,asChild:!0},O&&g.createElement("div",Object.assign({},ge(Object.assign(Object.assign({},T),{ref:ve,style:{position:ue,top:B??0,left:x??0,visibility:oe?"hidden":"visible"},role:"tooltip",id:G,className:j("navds-tooltip","navds-detail navds-detail--small",n)})),{"data-side":Y}),u,f&&g.createElement("span",{className:"navds-tooltip__keys","aria-hidden":!0},f.map(E=>g.createElement(be,{as:"kbd",key:E,className:"navds-tooltip__key"},E))),t&&g.createElement("div",{ref:E=>{w.current=E},className:"navds-tooltip__arrow",style:{left:z!=null?`${z}px`:"",top:F!=null?`${F}px`:"",right:"",bottom:"",[{top:"bottom",right:"left",bottom:"top",left:"right"}[Y]]:"-3.5px"}}))))}),cn="_isUnderBehandling_97n84_1",yn="_image_97n84_5",A={isUnderBehandling:cn,image:yn},bn=e=>{const{flyttetReservasjon:a}=e;if(!a)return;const r=Te(a.tidspunkt);return s.jsxs(_,{gap:"2",children:[s.jsxs(_,{gap:"1",children:[s.jsx(N,{size:"small",children:s.jsx(R,{id:"OppgaverTabell.OverfortReservasjonHeader"})}),s.jsx(S,{size:"small",children:s.jsx(R,{id:"OppgaverTabell.OverfortReservasjonBody",values:{dato:r==null?void 0:r.date,tid:r==null?void 0:r.time,uid:a.uid,navn:a.navn}})})]}),s.jsxs(_,{gap:"1",children:[s.jsx(N,{size:"small",children:s.jsx(R,{id:"OppgaverTabell.OverfortReservasjonBegrunnelse"})}),s.jsx(S,{size:"small",children:a.begrunnelse})]})]})},fn=({oppgave:e})=>{const a=l.useRef(null),[r,n]=l.useState(!1);return s.jsxs(s.Fragment,{children:[s.jsx(J,{ref:a,onClick:()=>n(!r),"aria-expanded":r,icon:s.jsx(en,{className:A.image,"aria-hidden":!0}),variant:"tertiary-neutral"}),s.jsx(V,{open:r,onClose:()=>n(!1),anchorEl:a.current,children:s.jsx(V.Content,{children:bn(e.status)})})]})},H=({oppgave:e,reserverOppgave:a})=>{var u;const r=fe(),n=Oe(Re.BEHANDLING_TYPE),[t,i]=l.useState(!0),v=l.useRef(null),m=l.useRef(null),d=l.useRef(null),o=(p,c)=>{var T,O,k;const f=(T=v.current)==null?void 0:T.contains(p.target),h=(O=m.current)==null?void 0:O.contains(p.target),y=(k=d.current)==null?void 0:k.contains(p.target);f||h||y||c&&a(c)};return s.jsxs(b.Row,{onMouseDown:t?p=>o(p,e):void 0,onKeyDown:t?p=>o(p,e):void 0,className:e.underBehandling?A.isUnderBehandling:void 0,children:[s.jsx(b.DataCell,{children:e.navn?`${e.navn} ${e.personnummer}`:"<navn>"}),s.jsx(b.DataCell,{children:s.jsxs(W,{gap:"1",align:"center",ref:d,children:[s.jsx(S,{children:e.saksnummer}),s.jsx(mn,{content:r.formatMessage({id:"OppgaverTabell.Saksnr"}),children:s.jsx(on,{activeIcon:s.jsx(re,{className:A.image,"aria-hidden":!0}),copyText:e.saksnummer.toString(),icon:s.jsx(te,{"aria-hidden":!0,className:A.image})})})]})}),s.jsx(b.DataCell,{children:(u=n.find(p=>p.kode===e.behandlingstype))==null?void 0:u.navn}),s.jsx(b.DataCell,{children:e.opprettetTidspunkt&&s.jsx(K,{dateString:e.opprettetTidspunkt})}),s.jsx(b.DataCell,{children:e.behandlingsfrist&&s.jsx(K,{dateString:e.behandlingsfrist})}),s.jsx(b.DataCell,{children:e.reservertTilTidspunkt&&s.jsx(he,{dateTimeString:e.reservertTilTidspunkt,separator:"kl"})}),s.jsx(b.DataCell,{children:e.status.flyttetReservasjon&&s.jsx("div",{ref:m,children:s.jsx(fn,{oppgave:e})})}),s.jsx(b.DataCell,{children:e.underBehandling&&s.jsx("div",{ref:v,children:s.jsx(je,{oppgave:e,setEnableTableEvents:i})})})]},e.id)};H.__docgenInfo={description:"",methods:[],displayName:"OppgaveRad",props:{oppgave:{required:!0,tsType:{name:"intersection",raw:`Oppgave & {
  ...
  erTilSaksbehandling: boolean;
  behandlingId: string;
}>`},name:"oppgave"}],return:{name:"void"}}},description:""}}};H.__docgenInfo={description:"",methods:[],displayName:"OppgaveRad",props:{oppgave:{required:!0,tsType:{name:"intersection",raw:`Oppgave & {
  underBehandling: boolean;
  reservertTilTidspunkt: string | undefined;
}`,elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
