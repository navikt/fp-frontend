import{j as e}from"./jsx-runtime-9c4ae004.js";import{f as P,H as v,F as a,a as c,p as l,d as x,o as k,s as I,D as d,K as h,n as y}from"./nb_NO-f3f50ba4.js";import{_ as D}from"./index.es-9f4223fb.js";import{H as M}from"./Heading-73495d18.js";const E=""+new URL("kvinne-c1935c66.svg",import.meta.url).href,F=""+new URL("mann-ee245563.svg",import.meta.url).href,N="_displayInline_1qq68_1",S={displayInline:N},m=({erDod:n,alder:s,dodsdato:r})=>n?e.jsx(P,{size:"small",className:S.displayInline,children:r?e.jsx(v,{dateString:r}):e.jsx(a,{id:"Person.ManglerDodsdato"})}):e.jsx("span",{children:e.jsx(a,{id:"Person.Age",values:{age:s}})});m.defaultProps={dodsdato:""};try{Aldervisning.displayName="Aldervisning",Aldervisning.__docgenInfo={description:`AlderVisning
...
\`\`\``,displayName:"Merkepanel",props:{erDod:{defaultValue:{value:"false"},description:"",name:"erDod",required:!1,type:{name:"boolean"}},diskresjonskode:{defaultValue:{value:""},description:"",name:"diskresjonskode",required:!1,type:{name:"string"}}}}}catch{}const K="_icon_af53y_1",A="_infoPlaceholder_af53y_7",R={icon:K,infoPlaceholder:A},t=({person:n})=>{const s=c(),{kjønn:r,dødsdato:i,diskresjonskode:f,fødselsdato:p,navn:g,fødselsnummer:_}=n,j=x().diff(p,"years");return e.jsx(k,{children:e.jsxs(I,{children:[e.jsx(d,{children:e.jsx(h,{className:R.icon,src:r===D.KVINNE?E:F,alt:s.formatMessage({id:"Person.ImageText"})})}),e.jsxs(d,{children:[e.jsxs(M,{size:"small",children:[g," ",e.jsx(m,{erDod:!!i,alder:j,dodsdato:i})]}),e.jsx(y,{size:"small",children:_})]}),e.jsx(d,{children:e.jsx(u,{erDod:!!i,diskresjonskode:f})})]})})},O=t;try{t.displayName="PersonInfo",t.__docgenInfo={description:`PersonInfo
...
//# sourceMappingURL=PersonInfo-078362cd.js.map
