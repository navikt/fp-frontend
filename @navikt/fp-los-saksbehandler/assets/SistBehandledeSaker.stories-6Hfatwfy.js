import{R as t}from"./index-DogsOklH.js";import{a as u,b as k,r as A}from"./fplosSaksbehandlerRestApi-GEsMItNL.js";import"./useRestApiRunner-gYXVz7Mj.js";import{g,m as E}from"./nb_NO-NgrW6B2a.js";import{S as i}from"./SistBehandledeSaker-V-0XMb_U.js";import"./index-MroJ3egt.js";const h=g(E),O={title:"los/saksbehandler/saksstotte/SistBehandledeSaker",component:i,decorators:[h]},c=({behandledeOppgaver:m})=>{const l=[{key:u.BEHANDLEDE_OPPGAVER.name,data:m}];return t.createElement(k,{data:l,requestApi:A},t.createElement(i,{åpneFagsak:()=>{}}))},e=c.bind({});e.args={behandledeOppgaver:[{id:1,personnummer:"334342323",navn:"Espen Utvikler"}]};const a=c.bind({});var s,n,r;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`({
  behandledeOppgaver
}) => {
  const data = [{
