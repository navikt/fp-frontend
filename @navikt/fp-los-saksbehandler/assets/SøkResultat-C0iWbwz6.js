import{j as e,r as A,d as k,b as T}from"./iframe-5lhSOGrr.js";import{G as b}from"./index.es-gp8aEAFv.js";import{a as m}from"./useLosKodeverk-Dv-QgmM3.js";import{T as n}from"./Table-DV4fh-f5.js";import{M as i}from"./Loader-d_TIvXJd.js";import{S as h}from"./ChevronRight-CLqgaGtV.js";var l=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(l||{});const R=(r,s)=>{if(r.status===l.AVSLUTTET&&s.status!==l.AVSLUTTET)return 1;if(r.status!==l.AVSLUTTET&&s.status===l.AVSLUTTET)return-1;const u=r.endret??r.opprettet,d=s.endret??s.opprettet;return k(u,T).diff(k(d,T))},S=({fagsaker:r,fagsakOppgaver:s,åpneFagsak:u,selectOppgaveCallback:d})=>{const q=m("FagsakStatus"),o=m("FagsakYtelseType"),j=m("BehandlingType"),c=[...r].sort(R);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:c.map(t=>{const v=q.find(a=>a.kode===t.status),p=o.find(a=>a.kode===t.fagsakYtelseType),y=s.filter(a=>a.saksnummer===t.saksnummer).map(a=>e.jsxs(n.Row,{onMouseDown:()=>d(a),onKeyDown:()=>d(a),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:o.find(g=>g.kode===a.fagsakYtelseType)?.navn}),e.jsx(n.DataCell,{children:j.find(g=>g.kode===a.behandlingstype)?.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(b,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(h,{})})]},a.id));return e.jsxs(A.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>u(t.saksnummer),onKeyDown:()=>u(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(b,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(h,{})})]}),y.length>0&&y]},t.saksnummer)})})]})};S.__docgenInfo={description:`FagsakList
