import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as x}from"./withThemeDecorator-CqS9VlII.js";import"./FlyttReservasjonModal-Bpv5h4gW.js";import{B as w}from"./BehandlingPollingTimoutModal-BbSAjMed.js";import{r as g}from"./index-C4XKfyRp.js";import{X as B}from"./index.es-DgE6OmkC.js";import{T as O,C as N,S as I,a as L,O as S}from"./OppgaveLabels-DAhYORj4.js";import{T as i}from"./Table-Cp76KVzX.js";import{H as f,V as b}from"./VStack-aGt2RIjI.js";import{B as h,L as E}from"./nb_NO-DeRyi5eh.js";import{u as _}from"./useMutation-CXb5RRSK.js";import{d as K,e as D}from"./fplosSaksbehandlerApi-4oezgadX.js";import{M as o}from"./message-CKqu3ctF.js";var C=(n=>(n.PENDING="PENDING",n.COMPLETE="COMPLETE",n.DELAYED="DELAYED",n.CANCELLED="CANCELLED",n.HALTED="HALTED",n))(C||{});const M="_image_1ni5b_1",P="_fadeIn_1ni5b_9",c={image:M,fadeIn:P},q=({oppgave:n,reserverOppgave:t,erNyBehandling:l})=>{const r=x(),s=g.useRef(null),u=(a,d)=>{var p;(p=s.current)!=null&&p.contains(a.target)||d&&t(d)};return e.jsxs(i.Row,{onMouseDown:a=>u(a,n),onKeyDown:a=>u(a,n),className:l?c.fadeIn:void 0,children:[e.jsx(i.DataCell,{children:n.navn??"<navn>"}),e.jsx(i.DataCell,{children:e.jsxs(f,{align:"center",ref:s,wrap:!1,children:[e.jsx(h,{children:n.saksnummer}),e.jsx(O,{content:r.formatMessage({id:"LedigOppgaveRad.Saksnr"}),children:e.jsx(N,{activeIcon:e.jsx(L,{className:c.image,"aria-hidden":!0}),copyText:n.saksnummer,icon:e.jsx(I,{"aria-hidden":!0,className:c.image})})})]})}),e.jsx(i.DataCell,{children:e.jsx(S,{oppgave:n})}),e.jsx(i.DataCell,{children:n.opprettetTidspunkt&&e.jsx(B,{dateString:n.opprettetTidspunkt})})]},n.id)};q.__docgenInfo={description:"",methods:[],displayName:"LedigOppgaveRad",props:{oppgave:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
