import{j as e}from"./iframe-DYQXSugv.js";import{S as o}from"./SøkForm-Bs8Uhbtb.js";import{P as p}from"./PersonInfo-DKeiIMY9.js";import{S as k}from"./SøkResultat-DgosvXdX.js";import{V as y}from"./VStack-0FyVDDRJ.js";import{B as s}from"./nb_NO-BkdgpR3F.js";import{M as i}from"./Loader-Bxok6rQJ.js";const T=(n,r)=>n.length>1||n.length===1&&r.filter(a=>a.saksnummer===n.at(0)?.saksnummer).length>1,b=({fagsaker:n,fagsakOppgaver:r,searchFagsakCallback:a,selectOppgaveCallback:l,searchResultReceived:t,åpneFagsak:u,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:v})=>e.jsxs(y,{gap:"space-16",children:[e.jsx(o,{onSubmit:a,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:v}),t&&n.length===0&&e.jsx(s,{children:e.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),t&&T(n,r)&&e.jsxs(e.Fragment,{children:[e.jsx(p,{person:n[0].person}),e.jsx(s,{size:"small",children:e.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),e.jsx(k,{åpneFagsak:u,selectOppgaveCallback:l,fagsaker:n,fagsakOppgaver:r})]})]});b.__docgenInfo={description:`FagsakSøk
