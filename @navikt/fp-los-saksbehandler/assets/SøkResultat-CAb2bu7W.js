import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as S}from"./index-_2TAQcTa.js";import"./nb_NO-B1ADYeqq.js";import{J as q}from"./index.es-eOtxRmci.js";import{G as c}from"./index.es-Dtj0Vyte.js";import{d as h}from"./dayjs.min-DkLNzaWO.js";import{u as o,K as m}from"./useLosKodeverk-yhC5P_f2.js";import{T as n}from"./Table-CYhy5MtV.js";import{M as i}from"./message-Cjo054bf.js";import{S as j}from"./ChevronRight-BEtaqnQI.js";var u=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(u||{});const A=(r,a)=>{if(r.status===u.AVSLUTTET&&a.status!==u.AVSLUTTET)return 1;if(r.status!==u.AVSLUTTET&&a.status===u.AVSLUTTET)return-1;const l=r.endret?r.endret:r.opprettet,d=a.endret?a.endret:a.opprettet;return h(l,c).diff(h(d,c))},w=({fagsaker:r,fagsakOppgaver:a,åpneFagsak:l,selectOppgaveCallback:d})=>{const f=o(m.FAGSAK_STATUS),v=o(m.FAGSAK_YTELSE),R=o(m.BEHANDLING_TYPE),x=[...r].sort(A);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:x.map(t=>{const p=f.find(s=>s.kode===t.status),k=v.find(s=>s.kode===t.fagsakYtelseType),y=a.filter(s=>s.saksnummer.toString()===t.saksnummer).map(s=>{var b,T;return e.jsxs(n.Row,{onMouseDown:()=>d(s),onKeyDown:()=>d(s),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:(b=v.find(g=>g.kode===s.fagsakYtelseType))==null?void 0:b.navn}),e.jsx(n.DataCell,{children:(T=R.find(g=>g.kode===s.behandlingstype))==null?void 0:T.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(q,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(j,{})})]},s.id)});return e.jsxs(S.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>l(t.saksnummer),onKeyDown:()=>l(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:k?k.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(q,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(j,{})})]}),y.length>0&&y]},t.saksnummer)})})]})};w.__docgenInfo={description:`FagsakList
