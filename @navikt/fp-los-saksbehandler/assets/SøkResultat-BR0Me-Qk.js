import{j as e,r as f,d as y,b as T}from"./iframe-BVcRJGzc.js";import{G as b}from"./index.es-DFzNGyCV.js";import{a as o}from"./useLosKodeverk-rEeTqbzN.js";import{T as n}from"./Table-DhotFuBY.js";import{M as i}from"./Loader-LcxfTbh8.js";import{S as h}from"./ChevronRight-T4X1eBRU.js";var l=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(l||{});const R=(r,s)=>{if(r.status===l.AVSLUTTET&&s.status!==l.AVSLUTTET)return 1;if(r.status!==l.AVSLUTTET&&s.status===l.AVSLUTTET)return-1;const u=r.endret??r.opprettet,d=s.endret??s.opprettet;return y(u,T).diff(y(d,T))},A=({fagsaker:r,fagsakOppgaver:s,åpneFagsak:u,selectOppgaveCallback:d})=>{const j=o("FagsakStatus"),m=o("FagsakYtelseType"),q=o("BehandlingType"),c=[...r].sort(R);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:c.map(t=>{const v=j.find(a=>a.kode===t.status),p=m.find(a=>a.kode===t.fagsakYtelseType),k=s.filter(a=>a.saksnummer===t.saksnummer).map(a=>e.jsxs(n.Row,{onMouseDown:()=>d(a),onKeyDown:()=>d(a),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:m.find(g=>g.kode===a.fagsakYtelseType)?.navn}),e.jsx(n.DataCell,{children:q.find(g=>g.kode===a.behandlingstype)?.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(b,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(h,{})})]},a.id));return e.jsxs(f.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>u(t.saksnummer),onKeyDown:()=>u(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(b,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(h,{})})]}),k.length>0&&k]},t.saksnummer)})})]})};A.__docgenInfo={description:`FagsakList
...
| '-'`,elements:[{name:"literal",value:"'EKTE'"},{name:"literal",value:"'BARN'"},{name:"literal",value:"'FARA'"},{name:"literal",value:"'MORA'"},{name:"literal",value:"'REPA'"},{name:"literal",value:"'MMOR'"},{name:"literal",value:"'ANPA'"},{name:"literal",value:"'-'"}],required:!0}},{key:"aktørId",value:{name:"string",required:!0}},{key:"person",value:{name:"signature",type:"object",raw:`{
  ...
  andreKriterier: AndreKriterierType[];
  oppgaveBehandlingStatus: OppgaveBehandlingStatus;
}>`},name:"oppgave"}],return:{name:"void"}}},description:""}}};export{l as F,A as S};
