import{j as e,d as g}from"./dayjs.min-ZUODdiE-.js";import{f as D,d as G,j as T,t as M,P as Y,m as z,A as m}from"./nb_NO-B_7A7S6o.js";import{Y as i,z as A,b as f}from"./index.es-BkMxg3KK.js";import{c as y,a as t,r as P,R as h,b as J}from"./fplosSaksbehandlerRestApi-CfSge_jd.js";import{r as d}from"./index-uubelm5h.js";import{R as $,a as R}from"./useRestApiRunner-CYj01yVu.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as I}from"./SakslisteVelgerForm-ChT54Eck.js";import{F as Z}from"./FagsakSearchIndex-CGc8oFFj.js";import{O as ee}from"./OppgaveErReservertAvAnnenModal-CMKGu3Xa.js";import{O as ne}from"./OppgaverTabell-clAuC_54.js";import{S as re}from"./SistBehandledeSaker-e0yZggur.js";import{N as te}from"./NyeOgFerdigstilteOppgaverForIdagPanel-obeWLv32.js";import{N as ae}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-VqgtoRXQ.js";import{D as se}from"./DriftsmeldingPanel-Dpp1AcM1.js";import"./index-BdzLX9oW.js";import"./kodeverkTyper-DrNSceCt.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-BVi89Q_E.js";import"./PersonInfo-CYMGU-hu.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-etoIysv6.js";import"./index.es-BvDzu6yI.js";import"./ExclamationmarkTriangleFill-z3dnEoYM.js";import"./FagsakList-B5tZ_iOT.js";import"./useLosKodeverk-CsByXCPe.js";import"./ChevronRight-DJhap-rA.js";import"./BehandlingPollingTimoutModal-Cb6nCsgG.js";import"./OppgaveHandlingerMenu-D_iflBIq.js";import"./FlyttReservasjonModal-w0plWOoe.js";import"./OpphevReservasjonModal-qJEnlm-d.js";import"./OppgaveReservasjonForlengetModal-DJjimqXZ.js";import"./Panel-DB1YB0B1.js";const ie=()=>{const n=d.useContext($),r=d.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=d.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:r,removeErrorMessages:a}},de=n=>{const r=window.localStorage.getItem(n);return r!=="undefined"&&r!==null?r:void 0},le=(n,r)=>{window.localStorage.setItem(n,r)},oe=n=>{window.localStorage.removeItem(n)},K=({reserverOppgave:n,sakslister:r,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(t.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.jsxs(e.Fragment,{children:[e.jsx(D,{size:"small",children:e.jsx(G,{id:"SakslistePanel.StartBehandling"})}),e.jsx(T,{sixteenPx:!0}),e.jsx(W,{sakslister:r,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:de,setValueInLocalStorage:le,removeValueFromLocalStorage:oe}),e.jsx(T,{twentyPx:!0}),s&&e.jsx(ne,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s})]})};K.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
