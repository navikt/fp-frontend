import{j as s}from"./jsx-runtime-9c4ae004.js";import{R as u,k,r as h}from"./fplosSaksbehandlerRestApi-b0e8d207.js";import{B as A,m as g}from"./nb_NO-f3f50ba4.js";import{S as i}from"./SistBehandledeSaker-0ac19a3d.js";import"./index-1b03fe98.js";import"./index.es-76bb323d.js";import"./index-6fd5a17b.js";import"./Heading-73495d18.js";const E=A(g),D={title:"los/saksbehandler/saksstotte/SistBehandledeSaker",component:i,decorators:[E]},m=({behandledeOppgaver:c})=>{const l=[{key:u.BEHANDLEDE_OPPGAVER.name,data:c}];return s.jsx(k,{data:l,requestApi:h,children:s.jsx(i,{åpneFagsak:()=>{}})})},e=m.bind({});e.args={behandledeOppgaver:[{id:1,personnummer:"334342323",navn:"Espen Utvikler"}]};const a=m.bind({});var n,t,r;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`({
  behandledeOppgaver
}) => {
  const data = [{
...
//# sourceMappingURL=SistBehandledeSaker.stories-b5209518.js.map
