import{j as n}from"./iframe-BVcRJGzc.js";import{S as v}from"./SøkForm-BukhpJ5f.js";import{P as p}from"./PersonInfo-Dv9k6TJ1.js";import{S as k}from"./SøkResultat-BR0Me-Qk.js";import{V as y}from"./VStack-1ft0JNw9.js";import{B as s}from"./nb_NO-Cya3_SoH.js";import{M as i}from"./Loader-LcxfTbh8.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(a=>a.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:a,selectOppgaveCallback:u,searchResultReceived:t,åpneFagsak:l,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>n.jsxs(y,{gap:"space-16",children:[n.jsx(v,{onSubmit:a,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),t&&e&&e.length===0&&n.jsx(s,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),t&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(p,{person:e[0].person}),n.jsx(s,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(k,{åpneFagsak:l,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
