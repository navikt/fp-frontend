import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{d as g}from"./dayjs.min-BsYQKNhR.js";import{h as G,f as P,y as T,t as H,P as M,m as Y,A as m}from"./nb_NO-CL2CZkR1.js";import{Y as i,z as A,b as I}from"./index.es-BkMxg3KK.js";import{c as y,a as t,r as K,R as h,b as z}from"./fplosSaksbehandlerRestApi-BSvuza2H.js";import{r as d}from"./index-uubelm5h.js";import{R as J,a as R}from"./useRestApiRunner-BRG0l7Io.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as N}from"./SakslisteVelgerForm-BpGP1ORj.js";import{F as Z}from"./FagsakSearchIndex-DJraxFqu.js";import{O as $}from"./OppgaveErReservertAvAnnenModal-BUbhhoZO.js";import{O as ee}from"./OppgaverTabell-Dcmpu-XH.js";import{S as ne}from"./SistBehandledeSaker-DbZHij3J.js";import{N as re}from"./NyeOgFerdigstilteOppgaverForIdagPanel-CXaf7SOG.js";import{N as te}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-BQ3UMwmC.js";import{D as ae}from"./DriftsmeldingPanel-CiS5R02s.js";import"./index-C4_kIme7.js";import"./kodeverkTyper-CavWL6Ds.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-DHDHUMOk.js";import"./PersonInfo-YB3VcCMD.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-BVbgyczg.js";import"./index.es-CnsD3zS2.js";import"./ExclamationmarkTriangleFill-DDN7e5f8.js";import"./FagsakList-YoG5PWah.js";import"./useLosKodeverk-C11e9c1N.js";import"./ChevronRight-C8p0tVJq.js";import"./BehandlingPollingTimoutModal-CAy7GXy6.js";import"./OppgaveHandlingerMenu-Cko3u9SK.js";import"./FlyttReservasjonModal-C_HvnKhO.js";import"./OpphevReservasjonModal-CpODFLij.js";import"./OppgaveReservasjonForlengetModal-2nsXgy5p.js";import"./Panel-0EKIkdMG.js";const se=()=>{const n=d.useContext(J),r=d.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=d.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:r,removeErrorMessages:a}},ie=n=>{const r=window.localStorage.getItem(n);return r!=="undefined"&&r!==null?r:void 0},de=(n,r)=>{window.localStorage.setItem(n,r)},le=n=>{window.localStorage.removeItem(n)},F=({reserverOppgave:n,sakslister:r,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(t.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.jsxs(e.Fragment,{children:[e.jsx(G,{size:"small",children:e.jsx(P,{id:"SakslistePanel.StartBehandling"})}),e.jsx(T,{sixteenPx:!0}),e.jsx(W,{sakslister:r,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:ie,setValueInLocalStorage:de,removeValueFromLocalStorage:le}),e.jsx(T,{twentyPx:!0}),s&&e.jsx(ee,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s})]})};F.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
