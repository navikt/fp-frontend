import{j as n}from"./iframe-Cwe0bwJ9.js";import{S as p}from"./SøkForm-BB4enquc.js";import{P as k}from"./PersonInfo-B_dTKAwB.js";import{S as v}from"./SøkResultat-6YAt4nuC.js";import{V as y}from"./VStack-Bf-ul0Dz.js";import{B as a}from"./nb_NO-bfncGwUh.js";import{M as i}from"./message-BnxX8ymA.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:l,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>n.jsxs(y,{gap:"4",children:[n.jsx(p,{onSubmit:t,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(k,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(v,{åpneFagsak:l,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
