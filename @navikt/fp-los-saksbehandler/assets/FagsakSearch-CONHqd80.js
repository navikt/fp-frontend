import{j as e}from"./dayjs.min-ZUODdiE-.js";import{i as a,d as i,j as p}from"./nb_NO-aGCfMFDj.js";import{P as k}from"./PersonInfo-BlRhvpkc.js";import{S as y}from"./SearchForm-hr88MO8X.js";import{F as b}from"./FagsakList-CKsF8Udf.js";const q="_label_1bfwx_1",h={label:q},f=(n,r)=>n?n.length>1||n.length===1&&r.filter(t=>t.saksnummer.toString()===n[0].saksnummer).length>1:!1,u=({fagsaker:n,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:g,searchResultReceived:s,åpneFagsak:l,searchStarted:d,searchResultAccessDenied:o,resetSearch:m,kanSaksbehandle:v})=>e.jsxs(e.Fragment,{children:[e.jsx(y,{onSubmit:t,searchStarted:d,searchResultAccessDenied:o,resetSearch:m,kanSaksbehandle:v}),s&&n&&n.length===0&&e.jsx(a,{size:"small",className:h.label,children:e.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&f(n,r)&&e.jsxs(e.Fragment,{children:[e.jsx(k,{person:n[0].person}),e.jsx(p,{sixteenPx:!0}),e.jsx(a,{size:"small",children:e.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),e.jsx(b,{åpneFagsak:l,selectOppgaveCallback:g,fagsaker:n,fagsakOppgaver:r})]})]}),w=u;u.__docgenInfo={description:`FagsakSearch
