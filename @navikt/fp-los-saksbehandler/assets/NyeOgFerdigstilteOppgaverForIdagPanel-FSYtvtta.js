import{j as g}from"./jsx-runtime-QvZ8i92b.js";import{r as c}from"./index-uubelm5h.js";import{d as u}from"./dayjs.min-BsYQKNhR.js";import{d as v,H as F,M as O,A as f}from"./nb_NO-3Rkd6eZ_.js";import{Y as t,I as k}from"./index.es-BkMxg3KK.js";import{u as h}from"./useLosKodeverk-CyolKziq.js";import{R as I}from"./FlyttReservasjonModal-DiGw4qlu.js";import{V as T}from"./VStack-XUoC8Lli.js";const o=[t.TILBAKEKREVING_REVURDERING,t.TILBAKEKREVING,t.DOKUMENTINNSYN,t.KLAGE,t.REVURDERING,t.FORSTEGANGSSOKNAD],m=({height:a,nyeOgFerdigstilteOppgaver:r,behandlingTyper:i})=>{const s=v(),y=o.map(n=>{if(n===t.FORSTEGANGSSOKNAD)return s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Førstegangsbehandling"});const e=i.find(d=>d.kode===n);return e?e.navn:""}),l=s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Ferdigstilte"}),p=s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Nye"}),N=o.map(n=>{const e=r.find(d=>d.behandlingType===n);return e?e.antallFerdigstilte:0}),b=o.map(n=>{const e=r.find(d=>d.behandlingType===n);return e?e.antallNye:0});return g.jsx(I,{height:a,option:{tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},legend:{data:[l,p],top:"bottom"},grid:{top:"5%",left:"3%",right:"4%",bottom:"12%",containLabel:!0},xAxis:{type:"value",boundaryGap:[0,.01]},yAxis:{type:"category",data:y},series:[{name:l,type:"bar",data:N},{name:p,type:"bar",data:b}],color:["#38a161","#337c9b"]}})};m.__docgenInfo={description:"",methods:[],displayName:"NyeOgFerdigstilteOppgaverForIdagGraf",props:{height:{required:!0,tsType:{name:"number"},description:""},behandlingTyper:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  antallFerdigstilte: number;
  dato: string;
}>`}],raw:"NyeOgFerdigstilteOppgaver[]"},description:""}}};const R=(a=[])=>{const r=u();return a.filter(i=>r.isSame(u(i.dato,f),"day"))},E=({height:a,nyeOgFerdigstilteOppgaver:r})=>{const i=h(k.BEHANDLING_TYPE),s=c.useMemo(()=>R(r),[r]);return g.jsxs(T,{gap:"1",children:[g.jsx(F,{size:"xsmall",children:g.jsx(O,{id:"NyeOgFerdigstilteOppgaverForIdagPanel.IDag"})}),g.jsx(m,{height:a,nyeOgFerdigstilteOppgaver:s,behandlingTyper:i})]})};E.__docgenInfo={description:"",methods:[],displayName:"NyeOgFerdigstilteOppgaverForIdagPanel",props:{height:{required:!0,tsType:{name:"number"},description:""},nyeOgFerdigstilteOppgaver:{required:!1,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  behandlingType: string;
  antallNye: number;
  antallFerdigstilte: number;
  dato: string;
