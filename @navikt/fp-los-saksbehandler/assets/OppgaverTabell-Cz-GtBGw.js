...
Tooltip-content: ${l}`);const de=O?b?{"aria-describedby":L}:{title:l}:{"aria-label":l};return u.createElement(u.Fragment,null,u.createElement(He,Object.assign({ref:F.setReference},le(),de,{"aria-keyshortcuts":k?k.join("+"):void 0}),t),u.createElement(xe,{rootElement:S,asChild:!0},b&&u.createElement("div",Object.assign({},oe(Object.assign(Object.assign({},x),{ref:ue,style:{position:se,top:I??0,left:w??0,visibility:ie?"hidden":"visible"},role:"tooltip",id:L,className:q("navds-tooltip","navds-detail navds-detail--small",e)})),{"data-side":K}),l,k&&u.createElement("span",{className:"navds-tooltip__keys","aria-hidden":!0},k.map(_=>u.createElement(ve,{as:"kbd",key:_,className:"navds-tooltip__key"},_))),r&&u.createElement("div",{ref:_=>{f.current=_},className:"navds-tooltip__arrow",style:{left:M!=null?`${M}px`:"",top:$!=null?`${$}px`:"",right:"",bottom:"",[{top:"bottom",right:"left",bottom:"top",left:"right"}[K]]:"-3.5px"}}))))}),rn="_isUnderBehandling_97n84_1",an="_image_97n84_5",N={isUnderBehandling:rn,image:an},sn=n=>{const{flyttetReservasjon:a}=n;if(!a)return;const t=Oe(a.tidspunkt);return s.jsxs(P,{gap:"2",children:[s.jsxs(P,{gap:"1",children:[s.jsx(C,{size:"small",children:s.jsx(T,{id:"OppgaverTabell.OverfortReservasjonHeader"})}),s.jsx(E,{size:"small",children:s.jsx(T,{id:"OppgaverTabell.OverfortReservasjonBody",values:{dato:t==null?void 0:t.date,tid:t==null?void 0:t.time,uid:a.uid,navn:a.navn}})})]}),s.jsxs(P,{gap:"1",children:[s.jsx(C,{size:"small",children:s.jsx(T,{id:"OppgaverTabell.OverfortReservasjonBegrunnelse"})}),s.jsx(E,{size:"small",children:a.begrunnelse})]})]})},ln=({oppgave:n})=>{const a=o.useRef(null),[t,e]=o.useState(!1);return s.jsxs(s.Fragment,{children:[s.jsx(W,{ref:a,onClick:()=>e(!t),"aria-expanded":t,icon:s.jsx(Fe,{className:N.image,"aria-hidden":!0}),variant:"tertiary-neutral"}),s.jsx(G,{open:t,onClose:()=>e(!1),anchorEl:a.current,children:s.jsx(G.Content,{children:sn(n.status)})})]})},ae=({oppgave:n,reserverOppgave:a,hentReserverteOppgaver:t})=>{const e=fe(),r=D.useGlobalStateRestApiData(ye.KODEVERK_LOS),[i,d]=o.useState(!0),m=o.useRef(null),c=o.useRef(null),g=o.useRef(null),l=(p,h)=>{var x,b,j;const k=(x=m.current)==null?void 0:x.contains(p.target),v=(b=c.current)==null?void 0:b.contains(p.target),O=(j=g.current)==null?void 0:j.contains(p.target);k||v||O||h&&a(h)};return s.jsxs(y.Row,{onMouseDown:i?p=>l(p,n):void 0,onKeyDown:i?p=>l(p,n):void 0,className:n.underBehandling?N.isUnderBehandling:void 0,children:[s.jsx(y.DataCell,{children:n.navn?`${n.navn} ${n.personnummer}`:"<navn>"}),s.jsx(y.DataCell,{children:s.jsxs(Q,{gap:"1",align:"center",ref:g,children:[s.jsx(E,{children:n.saksnummer}),s.jsx(tn,{content:e.formatMessage({id:"OppgaverTabell.Saksnr"}),children:s.jsx(Je,{activeIcon:s.jsx(ee,{className:N.image,"aria-hidden":!0}),copyText:n.saksnummer.toString(),icon:s.jsx(ne,{"aria-hidden":!0,className:N.image})})})]})}),s.jsx(y.DataCell,{children:ke(r,he.BEHANDLING_TYPE,n.behandlingstype)}),s.jsx(y.DataCell,{children:n.opprettetTidspunkt&&s.jsx(V,{dateString:n.opprettetTidspunkt})}),s.jsx(y.DataCell,{children:n.behandlingsfrist&&s.jsx(V,{dateString:n.behandlingsfrist})}),s.jsx(y.DataCell,{children:n.reservertTilTidspunkt&&s.jsx(je,{dateTimeString:n.reservertTilTidspunkt,separator:"kl"})}),s.jsx(y.DataCell,{children:n.status.flyttetReservasjon&&s.jsx("div",{ref:c,children:s.jsx(ln,{oppgave:n})})}),s.jsx(y.DataCell,{children:n.underBehandling&&s.jsx("div",{ref:m,children:s.jsx(Te,{oppgave:n,hentReserverteOppgaver:t,setEnableTableEvents:d})})})]},n.id)};ae.__docgenInfo={description:"",methods:[],displayName:"OppgaveRad",props:{oppgave:{required:!0,tsType:{name:"intersection",raw:`Oppgave & {
  ...
  erTilSaksbehandling: boolean;
  behandlingId: string;
}>`},name:"oppgave"}],return:{name:"void"}}},description:""},hentReserverteOppgaver:{required:!0,tsType:{name:"signature",type:"function",raw:"(params?: void, keepData?: boolean) => void",signature:{arguments:[{type:{name:"void"},name:"params"},{type:{name:"boolean"},name:"keepData"}],return:{name:"void"}}},description:""}}};const on="_grayout_kabbl_1",un="_headerPadding_kabbl_5",dn="_tabell_kabbl_9",z={grayout:on,headerPadding:un,tabell:dn},Z=[],X=(n,a,t)=>t==="reservertTilTidspunkt"&&n.underBehandling&&!a.underBehandling||!n.underBehandling&&a.underBehandling?1:a[t]===void 0||n[t]===void 0||a[t]<n[t]?-1:a[t]>n[t]?1:0,gn=n=>(a,t)=>n?n.direction==="ascending"?X(t,a,n.orderBy):X(a,t,n.orderBy):1,cn=(n,a)=>{const t=n.filter(r=>!a.some(i=>i.id===r.id)).map(r=>({...r,underBehandling:!0,reservertTilTidspunkt:r.status.reservertTilTidspunkt})),e=a.map(r=>({...r,underBehandling:!1,reservertTilTidspunkt:void 0}));return t.concat(e.slice(0,3))},pn=({reserverOppgave:n,antallOppgaver:a=0,valgtSakslisteId:t,doPolling:e=!0})=>{const[r,i]=o.useState(1),d=15,{startRequest:m,data:c=Z}=D.useRestApiRunner(A.RESERVERTE_OPPGAVER),{startRequest:g,data:l=Z,error:p}=D.useRestApiRunner(A.OPPGAVER_TIL_BEHANDLING),h=(f,R,S)=>{m(void 0,!0),g(S?{sakslisteId:R,oppgaveIder:S}:{sakslisteId:R},f).then(w=>!w||typeof w=="string"||!e?Promise.resolve():h(!0,R,w.map(I=>I.id).join(","))).catch(w=>console.log(w))};o.useEffect(()=>{U.cancelRequest(A.OPPGAVER_TIL_BEHANDLING.name),h(!1,t)},[t]),o.useEffect(()=>()=>{U.cancelRequest(A.OPPGAVER_TIL_BEHANDLING.name)},[]);const k=cn(c,l),[v,O]=o.useState({orderBy:"reservertTilTidspunkt",direction:"ascending"}),x=f=>{O(v&&f===v.orderBy&&v.direction==="descending"?void 0:{orderBy:f,direction:v&&f===v.orderBy&&v.direction==="ascending"?"descending":"ascending"})},b=k.slice().sort(gn(v)),j=b.length>d?b.slice((r-1)*d,r*d):b;return s.jsxs("div",{className:z.tabell,children:[p instanceof pe&&s.jsx(be,{}),s.jsxs(P,{gap:"2",className:z.headerPadding,children:[s.jsxs(Q,{gap:"2",children:[s.jsx(C,{size:"small",children:s.jsx(T,{id:"OppgaverTabell.DineNesteSaker"})}),s.jsx(E,{size:"small",className:z.grayout,children:s.jsx(T,{id:"OppgaverTabell.DineNesteSakerAntall",values:{totaltAntall:a,reservertAntall:c.length}})})]}),k.length===0&&s.jsx(E,{size:"small",children:s.jsx(T,{id:"OppgaverTabell.IngenOppgaver",values:{i:f=>s.jsx("i",{children:f})}})})]}),k.length>0&&s.jsxs(P,{gap:"4",children:[s.jsxs(y,{size:"small",sort:v,onSortChange:f=>x(f),children:[s.jsx(y.Header,{children:s.jsxs(y.Row,{children:[s.jsx(y.ColumnHeader,{sortKey:"navn",sortable:!0,children:s.jsx(T,{id:"OppgaverTabell.Soker"})}),s.jsx(y.ColumnHeader,{sortKey:"saksnummer",sortable:!0,children:s.jsx(T,{id:"OppgaverTabell.Sak"})}),s.jsx(y.ColumnHeader,{sortKey:"behandlingstype",sortable:!0,children:s.jsx(T,{id:"OppgaverTabell.Behandlingstype"})}),s.jsx(y.ColumnHeader,{sortKey:"opprettetTidspunkt",sortable:!0,children:s.jsx(T,{id:"OppgaverTabell.BehandlingOpprettet"})}),s.jsx(y.ColumnHeader,{sortKey:"behandlingsfrist",sortable:!0,children:s.jsx(T,{id:"OppgaverTabell.FristForBehandling"})}),s.jsx(y.ColumnHeader,{sortKey:"reservertTilTidspunkt",sortable:!0,children:s.jsx(T,{id:"OppgaverTabell.ReservertTilTidspunkt"})}),s.jsx(y.ColumnHeader,{}),s.jsx(y.ColumnHeader,{})]})}),s.jsx(y.Body,{children:j.map(f=>s.jsx(ae,{oppgave:f,hentReserverteOppgaver:m,reserverOppgave:n},f.id))})]}),b.length>d&&s.jsx(re,{page:r,onPageChange:i,count:Math.ceil(b.length/d),size:"small",prevNextTexts:!0})]})]})};pn.__docgenInfo={description:"",methods:[],displayName:"OppgaverTabell",props:{reserverOppgave:{required:!0,tsType:{name:"signature",type:"function",raw:"(oppgave: Oppgave) => void",signature:{arguments:[{type:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
  status: OppgaveStatus;
  saksnummer: number;
  personnummer: string;
  ...
  erTilSaksbehandling: boolean;
  behandlingId: string;
}>`},name:"oppgave"}],return:{name:"void"}}},description:""},antallOppgaver:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}},valgtSakslisteId:{required:!0,tsType:{name:"number"},description:""},doPolling:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};export{pn as O};
