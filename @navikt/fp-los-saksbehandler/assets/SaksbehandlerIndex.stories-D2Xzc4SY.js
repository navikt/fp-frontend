import{r as l,R as e}from"./index-BBkUAzwr.js";import{H as D,e as G,j as T,t as M,P as Y,m as z,d as m,N as g}from"./nb_NO-B_pArjwH.js";import{Y as i,z as A,b as f}from"./index.es-BkMxg3KK.js";import{c as y,a as r,r as P,R as c,b as J}from"./fplosSaksbehandlerRestApi-yC5FIIxZ.js";import{R as $,a as R}from"./useRestApiRunner-CnLmgk-1.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as I}from"./SakslisteVelgerForm-5QNkplWn.js";import{F as Z}from"./FagsakSearchIndex-B3wfYX1X.js";import{O as ee}from"./OppgaveErReservertAvAnnenModal-CHp0DMMr.js";import{O as ne}from"./OppgaverTabell-DAmyml5H.js";import{S as te}from"./SistBehandledeSaker-CdCfQJGn.js";import{N as re}from"./NyeOgFerdigstilteOppgaverForIdagPanel-B-9lwFTm.js";import{N as ae}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-B4AAxdXq.js";import{D as se}from"./DriftsmeldingPanel-WmF6Rax7.js";import"./index-PqR-_bA4.js";import"./kodeverkTyper-DJMuX7JX.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-BSLl5atE.js";import"./PersonInfo-B3ookySz.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-Bw756egH.js";import"./index.es-CfFtEmZa.js";import"./ExclamationmarkTriangleFill-C-Zq1oqM.js";import"./FagsakList-C_ep2xA6.js";import"./useLosKodeverk-Bu585ykK.js";import"./ChevronRight-CZo5iNVk.js";import"./BehandlingPollingTimoutModal-ChgN_7AN.js";import"./OppgaveHandlingerMenu--u7nHXf4.js";import"./FlyttReservasjonModal-I1TRHe3e.js";import"./OpphevReservasjonModal-Bjlyw_x-.js";import"./OppgaveReservasjonForlengetModal-Kt1kf9sb.js";import"./Panel-CN0EaMQM.js";const ie=()=>{const n=l.useContext($),t=l.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=l.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:t,removeErrorMessages:a}},le=n=>{const t=window.localStorage.getItem(n);return t!=="undefined"&&t!==null?t:void 0},de=(n,t)=>{window.localStorage.setItem(n,t)},oe=n=>{window.localStorage.removeItem(n)},K=({reserverOppgave:n,sakslister:t,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(r.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.createElement(e.Fragment,null,e.createElement(D,{size:"small"},e.createElement(G,{id:"SakslistePanel.StartBehandling"})),e.createElement(T,{sixteenPx:!0}),e.createElement(W,{sakslister:t,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:le,setValueInLocalStorage:de,removeValueFromLocalStorage:oe}),e.createElement(T,{twentyPx:!0}),s&&e.createElement(ne,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s}))};K.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
