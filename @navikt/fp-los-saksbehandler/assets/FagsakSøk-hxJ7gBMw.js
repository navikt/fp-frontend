import{j as n}from"./iframe-BwsLYjPf.js";import{S as v}from"./SøkForm-Dc-OI0xJ.js";import{P as k}from"./PersonInfo-CpqPjJBS.js";import{S as p}from"./SøkResultat-Bu-3vqbM.js";import{V as y}from"./VStack-BUJevhxp.js";import{B as a}from"./nb_NO-pbSJoPLE.js";import{M as i}from"./Loader-B04EuSy-.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:l,searchStarted:g,searchResultAccessDenied:d,resetSearch:o,kanSaksbehandle:m})=>n.jsxs(y,{gap:"space-16",children:[n.jsx(v,{onSubmit:t,searchStarted:g,searchResultAccessDenied:d,resetSearch:o,kanSaksbehandle:m}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(k,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(p,{åpneFagsak:l,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
