import{g as w,r as L,s as G,l as V,d as x,h as t,L as s,H as r}from"./fplosSaksbehandlerApi-DVMPShiN.js";import{j as e,r as v,P as F,a as U,w as C,B as k}from"./iframe-DcWfvX4E.js";import{S as Y,K as H}from"./SakslisteVelgerForm-BuanfKl2.js";import{A as S}from"./andreKriterierType-Cg0VWsVP.js";import{O as m}from"./oppgaveBehandlingStatus-GzK3dLyM.js";import{L as M,A as Q}from"./LedigOppgaveTabell-DvGwkoqI.js";import"./FlyttReservasjonModal-cyJRfFZ_.js";import{a as J}from"./alleKodeverkLos-JR0SOFbV.js";import{u as c}from"./useQuery-CPaP-Sxu.js";import{Q as z}from"./index.es-CK71UUG6.js";import{u as A}from"./useMutation-CD_UXkzb.js";import{O as W}from"./OppgaveErReservertAvAnnenModal-B4680afr.js";import{R as X}from"./ReservertOppgaveTabell-mSo1T2Cm.js";import{V as R}from"./VStack-qlvPq9uV.js";import{D as Z}from"./DriftsmeldingPanel-m5xsI92l.js";import{F as $}from"./FagsakSøkIndex-BtEdXWU6.js";import{S as ee}from"./SistBehandledeSaker-D8D-TR2X.js";import{m as ne}from"./nb_NO-B5yokG7b.js";import"./preload-helper-PPVm8Dsz.js";import"./index.es-CrSE2Vo3.js";import"./Modal-CkgRguxl.js";import"./floating-ui.react-BQhJV-NN.js";import"./Loader-BgAJ8TXJ.js";import"./composeEventHandlers-rXV8Rneo.js";import"./index-BUjOf9FY.js";import"./ChevronDown-V1IO0Cne.js";import"./Tag-KNyf_X-k.js";import"./useLosKodeverk-CpQ04YyY.js";import"./PersonHeadset-BUAQkDzL.js";import"./BehandlingPollingTimoutModal-BUFNnVUn.js";import"./ExclamationmarkTriangleFill-VQXYKzUw.js";import"./OppgaveLabels-BXpomtxi.js";import"./Checkmark-DpKxb_EB.js";import"./Table-q8fDV-xz.js";import"./Tooltip-CTOelyQE.js";import"./Portal-z6xuPYI8.js";import"./OppgaveHandlingerMenu-CWCa2vlw.js";import"./OppgaveReservasjonForlengetModal-B8P8VduC.js";import"./NotatModal-BUprM4E2.js";import"./ChevronRight-R_S6dg_e.js";import"./HourglassTopFilled-BbYFEgP6.js";import"./FagsakSøk-DgDB7lf4.js";import"./SøkForm-BAlHpl2M.js";import"./PersonInfo-C7ohnkLE.js";import"./Kjonnkode-DjBoP8-t.js";import"./SøkResultat-4funf4Yr.js";const re=n=>{const a=globalThis.localStorage.getItem(n);return a!=="undefined"&&a!==null?a:void 0},te=(n,a)=>{globalThis.localStorage.setItem(n,a)},ae=n=>{globalThis.localStorage.removeItem(n)},I=({reserverOppgave:n,sakslister:a,setValgtSakslisteId:o,valgtSakslisteId:d,brukernavn:g})=>{const{mutate:l,data:i}=A({mutationFn:w});return e.jsxs(R,{gap:"space-32",children:[e.jsx(Y,{sakslister:a,setValgtSakslisteId:o,fetchAntallOppgaver:l,getValueFromLocalStorage:re,setValueInLocalStorage:te,removeValueFromLocalStorage:ae}),!!d&&e.jsx(M,{reserverOppgave:n,antallOppgaver:i,valgtSakslisteId:d}),e.jsx(X,{reserverOppgave:n,brukernavn:g})]})};I.__docgenInfo={description:"",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
...
| '-'`,elements:[{name:"literal",value:"'BT-002'"},{name:"literal",value:"'BT-003'"},{name:"literal",value:"'BT-004'"},{name:"literal",value:"'BT-008'"},{name:"literal",value:"'BT-006'"},{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"},{name:"literal",value:"'-'"}],required:!0}},{key:"opprettetTidspunkt",value:{name:"string",required:!0}},{key:"behandlingsfrist",value:{name:"string",required:!0}},{key:"fagsakYtelseType",value:{name:"string",required:!0}},{key:"erTilSaksbehandling",value:{name:"boolean",required:!0}},{key:"behandlingId",value:{name:"string",required:!0}},{key:"andreKriterier",value:{name:"Array",elements:[{name:"AndreKriterierType"}],raw:"AndreKriterierType[]",required:!0}},{key:"oppgaveBehandlingStatus",value:{name:"OppgaveBehandlingStatus",required:!0}}]}}],raw:`Readonly<{
  ...
  kanVeilede: boolean;
  navn: string;
}`,signature:{properties:[{key:"brukernavn",value:{name:"string",required:!0}},{key:"funksjonellTid",value:{name:"string",required:!1}},{key:"kanBehandleKode6",value:{name:"boolean",required:!0}},{key:"kanOppgavestyre",value:{name:"boolean",required:!0}},{key:"kanOverstyre",value:{name:"boolean",required:!0}},{key:"kanSaksbehandle",value:{name:"boolean",required:!0}},{key:"kanVeilede",value:{name:"boolean",required:!0}},{key:"navn",value:{name:"string",required:!0}}]}},description:""}}};const de=U(ne),_=n=>e.jsx(F,{value:de,children:e.jsx(j,{...n})});_.__docgenInfo={description:"",methods:[],displayName:"SaksbehandlerIndex",props:{setLosErIkkeTilgjengelig:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},åpneFagsak:{required:!0,tsType:{name:"signature",type:"function",raw:"(saksnummer: string, behandlingUuid?: string) => void",signature:{arguments:[{type:{name:"string"},name:"saksnummer"},{type:{name:"string"},name:"behandlingUuid"}],return:{name:"void"}}},description:""},navAnsatt:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  brukernavn: string;
  funksjonellTid?: string;
  kanBehandleKode6: boolean;
  kanOppgavestyre: boolean;
