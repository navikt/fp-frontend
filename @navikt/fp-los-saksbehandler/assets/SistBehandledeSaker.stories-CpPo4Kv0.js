import{j as s}from"./dayjs.min-DKYhEbg2.js";import{a as u,b as k,r as A}from"./fplosSaksbehandlerRestApi-CWRPAkFP.js";import"./index-BBkUAzwr.js";import"./useRestApiRunner-DyfIg1tq.js";import{g,m as h}from"./nb_NO-DY6WQH50.js";import{S as i}from"./SistBehandledeSaker-BjRVfOd3.js";import"./index-BfZ0jBbx.js";const E=g(h),P={title:"los/saksbehandler/saksstotte/SistBehandledeSaker",component:i,decorators:[E]},c=({behandledeOppgaver:m})=>{const l=[{key:u.BEHANDLEDE_OPPGAVER.name,data:m}];return s.jsx(k,{data:l,requestApi:A,children:s.jsx(i,{åpneFagsak:()=>{}})})},e=c.bind({});e.args={behandledeOppgaver:[{id:1,personnummer:"334342323",navn:"Espen Utvikler"}]};const a=c.bind({});var t,n,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`({
  behandledeOppgaver
}) => {
  const data = [{
