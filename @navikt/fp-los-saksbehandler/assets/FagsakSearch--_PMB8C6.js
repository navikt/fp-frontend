import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{j as a,f as i,y as v}from"./nb_NO-DpQ9LvOA.js";import{P as p}from"./PersonInfo-UJCdb5Sl.js";import{S as k}from"./SearchForm-CnPQ6NWM.js";import{F as y}from"./FagsakList-CnLQtZfv.js";const b="_label_1bfwx_1",q={label:b},f=(n,r)=>n?n.length>1||n.length===1&&r.filter(t=>t.saksnummer.toString()===n[0].saksnummer).length>1:!1,h=({fagsaker:n,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:g,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>e.jsxs(e.Fragment,{children:[e.jsx(k,{onSubmit:t,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),s&&n&&n.length===0&&e.jsx(a,{size:"small",className:q.label,children:e.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&f(n,r)&&e.jsxs(e.Fragment,{children:[e.jsx(p,{person:n[0].person}),e.jsx(v,{sixteenPx:!0}),e.jsx(a,{size:"small",children:e.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),e.jsx(y,{åpneFagsak:g,selectOppgaveCallback:u,fagsaker:n,fagsakOppgaver:r})]})]});h.__docgenInfo={description:`FagsakSearch
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSearch",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilmelding?: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!1}}]}},description:""},resetSearch:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},kanSaksbehandle:{required:!0,tsType:{name:"boolean"},description:""}}};export{h as F};
