import{j as n}from"./iframe-DvFVpOsn.js";import{S as v}from"./SøkForm-_fwS_qZd.js";import{P as k}from"./PersonInfo-BiLGqfDh.js";import{S as p}from"./SøkResultat-C8LQalyR.js";import{V as y}from"./VStack-BGXEyZTt.js";import{B as a}from"./nb_NO-DeYUK85K.js";import{M as i}from"./message-Zvy95iev.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:l,searchStarted:g,searchResultAccessDenied:d,resetSearch:o,kanSaksbehandle:m})=>n.jsxs(y,{gap:"4",children:[n.jsx(v,{onSubmit:t,searchStarted:g,searchResultAccessDenied:d,resetSearch:o,kanSaksbehandle:m}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(k,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(p,{åpneFagsak:l,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
