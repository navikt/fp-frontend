import{j as e,r as _,i as R,x as o}from"./iframe-DJ2vgJiB.js";import{J as p}from"./index.es-DB0BfbQF.js";import{u as d}from"./useLosKodeverk-B9hmq-WL.js";import{T as n}from"./Table-BtfQLmoP.js";import{M as s}from"./Loader-Cyiz0UUT.js";import{S}from"./ChevronRight-DuVb1vob.js";const N=(t,l)=>{if(t.status==="AVSLU"&&l.status!=="AVSLU")return 1;if(t.status!=="AVSLU"&&l.status==="AVSLU")return-1;const i=t.endret??t.opprettet,u=l.endret??l.opprettet;return R(i,o).diff(R(u,o))},B=({fagsaker:t,fagsakOppgaver:l,åpneFagsak:i,selectOppgaveCallback:u})=>{const k=d("FagsakStatus"),T=d("FagsakYtelseType"),A=d("BehandlingType"),y=[...t].sort(N);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:y.map(r=>{const v=k.find(a=>a.kode===r.status),g=T.find(a=>a.kode===r.fagsakYtelseType),E=l.filter(a=>a.saksnummer===r.saksnummer).map(a=>e.jsxs(n.Row,{onMouseDown:()=>u(a),onKeyDown:()=>u(a),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:T.find(m=>m.kode===a.fagsakYtelseType)?.navn}),e.jsx(n.DataCell,{children:A.find(m=>m.kode===a.behandlingstype)?.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:r.barnFødt?e.jsx(p,{dateString:r.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(S,{})})]},a.id));return e.jsxs(_.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>i(r.saksnummer),onKeyDown:()=>i(r.saksnummer),children:[e.jsx(n.DataCell,{children:r.saksnummer}),e.jsx(n.DataCell,{children:g?g.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:r.barnFødt?e.jsx(p,{dateString:r.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(S,{})})]}),E.length>0&&E]},r.saksnummer)})})]})};B.__docgenInfo={description:`FagsakList
