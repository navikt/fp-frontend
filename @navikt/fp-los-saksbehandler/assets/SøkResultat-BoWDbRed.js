import{j as e,r as B,k as y,m as T}from"./iframe-ByxoPEP3.js";import{G as b}from"./index.es-DDS_sI15.js";import{u as m}from"./useLosKodeverk--bP2D4R1.js";import{T as n}from"./Table-exm8YT0j.js";import{M as i}from"./Loader-Bq9jJYrN.js";import{S as h}from"./ChevronRight-BZZQU8ll.js";var l=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(l||{});const f=(r,s)=>{if(r.status===l.AVSLUTTET&&s.status!==l.AVSLUTTET)return 1;if(r.status!==l.AVSLUTTET&&s.status===l.AVSLUTTET)return-1;const u=r.endret??r.opprettet,d=s.endret??s.opprettet;return y(u,T).diff(y(d,T))},R=({fagsaker:r,fagsakOppgaver:s,åpneFagsak:u,selectOppgaveCallback:d})=>{const j=m("FagsakStatus"),o=m("FagsakYtelseType"),q=m("BehandlingType"),c=[...r].sort(f);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:c.map(a=>{const v=j.find(t=>t.kode===a.status),p=o.find(t=>t.kode===a.fagsakYtelseType),k=s.filter(t=>t.saksnummer===a.saksnummer).map(t=>e.jsxs(n.Row,{onMouseDown:()=>d(t),onKeyDown:()=>d(t),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:o.find(g=>g.kode===t.fagsakYtelseType)?.navn}),e.jsx(n.DataCell,{children:q.find(g=>g.kode===t.behandlingstype)?.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:a.barnFødt?e.jsx(b,{dateString:a.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(h,{})})]},t.id));return e.jsxs(B.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>u(a.saksnummer),onKeyDown:()=>u(a.saksnummer),children:[e.jsx(n.DataCell,{children:a.saksnummer}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:a.barnFødt?e.jsx(b,{dateString:a.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(h,{})})]}),k.length>0&&k]},a.saksnummer)})})]})};R.__docgenInfo={description:`FagsakList
