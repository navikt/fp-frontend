import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as x}from"./index-C4XKfyRp.js";import{P as T}from"./nb_NO-Bq-cqQdA.js";import{X as h}from"./index.es-0pw154gs.js";import{d as q}from"./dayjs.min-DkLNzaWO.js";import{u as o}from"./useLosKodeverk-nfR2XL0C.js";import{T as n}from"./Table-Bb4hpPxP.js";import{M as i}from"./message-Ds_Wgjgk.js";import{S as c}from"./ChevronRight-CCzUZ_BN.js";var u=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(u||{});const A=(r,a)=>{if(r.status===u.AVSLUTTET&&a.status!==u.AVSLUTTET)return 1;if(r.status!==u.AVSLUTTET&&a.status===u.AVSLUTTET)return-1;const l=r.endret??r.opprettet,d=a.endret??a.opprettet;return q(l,T).diff(q(d,T))},S=({fagsaker:r,fagsakOppgaver:a,åpneFagsak:l,selectOppgaveCallback:d})=>{const j=o("FagsakStatus"),m=o("FagsakYtelseType"),f=o("BehandlingType"),R=[...r].sort(A);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:R.map(t=>{const p=j.find(s=>s.kode===t.status),v=m.find(s=>s.kode===t.fagsakYtelseType),k=a.filter(s=>s.saksnummer===t.saksnummer).map(s=>{var y,b;return e.jsxs(n.Row,{onMouseDown:()=>d(s),onKeyDown:()=>d(s),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:(y=m.find(g=>g.kode===s.fagsakYtelseType))==null?void 0:y.navn}),e.jsx(n.DataCell,{children:(b=f.find(g=>g.kode===s.behandlingstype))==null?void 0:b.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(h,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(c,{})})]},s.id)});return e.jsxs(x.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>l(t.saksnummer),onKeyDown:()=>l(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(h,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(c,{})})]}),k.length>0&&k]},t.saksnummer)})})]})};S.__docgenInfo={description:`FagsakList
