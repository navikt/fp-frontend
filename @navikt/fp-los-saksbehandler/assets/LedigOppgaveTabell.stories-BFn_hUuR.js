import{w as R,j as p,F as h,B as O}from"./iframe-BVTG5DQn.js";import{X as P}from"./index.es-p2I_thuD.js";import{u as L}from"./useQuery-Cl684nyt.js";import{a as e,L as s,H as t,l as N}from"./fplosSaksbehandlerApi-CHpAHwIy.js";import{A}from"./andreKriterierType-Cg0VWsVP.js";import{L as l,A as d}from"./LedigOppgaveTabell-B6Xx7P4s.js";import"./FlyttReservasjonModal-sDuo19S1.js";import{g as I}from"./withIntl-TNySBBmS.js";import{a as c}from"./alleKodeverkLos-DeeW-5p1.js";import{m as G}from"./nb_NO-Cd-arOzM.js";import"./Loader-BR3iPa-G.js";import"./BehandlingPollingTimoutModal-CaRoaBy2.js";import"./Modal-CuZXMraw.js";import"./index-8H-CvFi6.js";import"./composeEventHandlers-DeH74NdU.js";import"./VStack-D8YIQLAv.js";import"./ExclamationmarkTriangleFill-ClMNiODH.js";import"./message-DbQbEmJn.js";import"./OppgaveLabels-S7fFL3Zc.js";import"./Portal-BvRXXLfG.js";import"./ChevronDown-B9aWN_JB.js";import"./useLosKodeverk-D68DYBN3.js";import"./Tag-CkjPnsoN.js";import"./Table-C6t0e6fP.js";import"./ArrowsUpDown-9cl8bpIm.js";import"./useMutation-CMM1t-yj.js";import"./index.es-CSoebvA5.js";const{action:_}=__STORYBOOK_MODULE_ACTIONS__,v=I(G),S=[{id:1,reservasjonStatus:{erReservert:!1,flyttetReservasjon:{tidspunkt:"2019-02-02",uid:"23423",navn:"Espen Utvikler",begrunnelse:"Flyttet fordi..."}},saksnummer:"345325",personnummer:"1212",navn:"Espen Utvikler",system:"SAK",behandlingstype:O.FORSTEGANGSSOKNAD,opprettetTidspunkt:"2019-01-01",behandlingsfrist:"2019-01-01",fagsakYtelseType:h.FORELDREPENGER,erTilSaksbehandling:!0,behandlingId:"1",andreKriterier:[A.REVURDERING_INNTEKTSMELDING]}],st={title:"behandlingskoer/LedigOppgaveTabell",component:l,decorators:[v,R],args:{valgtSakslisteId:1,reserverOppgave:_("button-click")},render:n=>L(N()).data?p.jsx(l,{...n}):p.jsx(P,{})},o={parameters:{msw:{handlers:[e.get(s.KODEVERK_LOS,()=>t.json(c)),e.get(s.FORLENG_OPPGAVERESERVASJON,()=>new t(null,{status:200})),e.get(s.OPPGAVER_TIL_BEHANDLING,n=>n.request.url.includes("oppgaveIder")?new t(null,{status:202,headers:{location:"https://www.test.com/api/status"}}):new t(null,{status:202,headers:{location:"https://www.test.com/api/result"}})),e.get("https://www.test.com/api/status",()=>t.json({status:d.PENDING,pollIntervalMillis:1e8})),e.get("https://www.test.com/api/result",()=>t.json(S))]}},args:{antallOppgaver:4}},r={parameters:{msw:{handlers:[e.get(s.KODEVERK_LOS,()=>t.json(c)),e.get(s.FORLENG_OPPGAVERESERVASJON,()=>new t(null,{status:200})),e.get(s.RESERVERTE_OPPGAVER,()=>t.json([])),e.get(s.OPPGAVER_TIL_BEHANDLING,n=>n.request.url.includes("oppgaveIder")?new t(null,{status:202,headers:{location:"https://www.test.com/api/status"}}):new t(null,{status:202,headers:{location:"https://www.test.com/api/result"}})),e.get("https://www.test.com/api/status",()=>t.json({status:d.PENDING,pollIntervalMillis:1e8})),e.get("https://www.test.com/api/result",()=>t.json([]))]}}};var i,u,m;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`{
  parameters: {
    msw: {
...
}`,...(E=(g=r.parameters)==null?void 0:g.docs)==null?void 0:E.source}}};const nt=["Default","TomOppgaveTabell"];export{o as Default,r as TomOppgaveTabell,nt as __namedExportsOrder,st as default};
