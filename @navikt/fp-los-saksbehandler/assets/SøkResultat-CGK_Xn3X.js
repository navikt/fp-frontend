import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{r as R}from"./index-uubelm5h.js";import{d as y}from"./dayjs.min-BsYQKNhR.js";import{A as b}from"./index.es-CFhBXnTn.js";import{D as c}from"./index.es-CyZwGGZm.js";import{I as u,v as d}from"./index.es-BkMxg3KK.js";import{g as m}from"./kodeverkUtils-RGNAgZhp.js";import{u as h}from"./useLosKodeverk-B4Dg8QK6.js";import{c as A,R as x}from"./fplosSaksbehandlerRestApi-Boc9PVCn.js";import"./nb_NO-wYRVVd4K.js";import{T as n}from"./Table-DOY-4ux1.js";import{M as g}from"./Loader-Dh3casaz.js";import{S as T}from"./ChevronRight-BaeGl9EW.js";const q=t=>(a,i)=>{i&&t(i)},w=(t,a)=>{if(t.status===d.AVSLUTTET&&a.status!==d.AVSLUTTET)return 1;if(t.status!==d.AVSLUTTET&&a.status===d.AVSLUTTET)return-1;const i=t.endret?t.endret:t.opprettet,l=a.endret?a.endret:a.opprettet;return y(i,b).diff(y(l,b))},F=({fagsaker:t,fagsakOppgaver:a,åpneFagsak:i,selectOppgaveCallback:l})=>{const f=h(u.FAGSAK_STATUS),j=h(u.FAGSAK_YTELSE),o=A.useGlobalStateRestApiData(x.KODEVERK_LOS),S=[...t].sort(w);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:S.map(s=>{const v=f.find(r=>r.kode===s.status),p=j.find(r=>r.kode===s.fagsakYtelseType),k=a.filter(r=>r.saksnummer.toString()===s.saksnummer).map(r=>e.jsxs(n.Row,{onMouseDown:()=>l(r),onKeyDown:()=>l(r),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:m(o,u.FAGSAK_YTELSE,r.fagsakYtelseType)}),e.jsx(n.DataCell,{children:m(o,u.BEHANDLING_TYPE,r.behandlingstype)}),e.jsx(n.DataCell,{children:r.behandlingStatus?m(o,u.BEHANDLING_STATUS,r.behandlingStatus):""}),e.jsx(n.DataCell,{children:s.barnFødt?e.jsx(c,{dateString:s.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(T,{})})]},r.id));return e.jsxs(R.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:q(i),onKeyDown:q(i),children:[e.jsx(n.DataCell,{children:s.saksnummer}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{children:s.barnFødt?e.jsx(c,{dateString:s.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(T,{})})]}),k.length>0&&k]},s.saksnummer)})})]})};F.__docgenInfo={description:`FagsakList
