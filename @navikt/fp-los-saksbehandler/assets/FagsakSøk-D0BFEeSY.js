import{j as n}from"./iframe-Clb27KdX.js";import{S as p}from"./SøkForm-CEG-TK3q.js";import{P as v}from"./PersonInfo-Ceegb7SV.js";import{S as k}from"./SøkResultat-CYt6Cu6r.js";import{V as y}from"./VStack-Bo-6G3rc.js";import{B as a}from"./nb_NO--W7a-9g9.js";import{M as i}from"./Loader-Ch4zzPxw.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:g,searchStarted:l,searchResultAccessDenied:d,resetSearch:o,kanSaksbehandle:m})=>n.jsxs(y,{gap:"space-16",children:[n.jsx(p,{onSubmit:t,searchStarted:l,searchResultAccessDenied:d,resetSearch:o,kanSaksbehandle:m}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(v,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(k,{åpneFagsak:g,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
