import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{d as g}from"./dayjs.min-BsYQKNhR.js";import{h as G,f as P,y as T,t as H,P as M,m as Y,A as m}from"./nb_NO-xkhVygkw.js";import{Y as i,z as A,b as I}from"./index.es-BkMxg3KK.js";import{c as y,a as t,r as K,R as h,b as z}from"./fplosSaksbehandlerRestApi-k6FJgIaY.js";import{r as d}from"./index-uubelm5h.js";import{R as J,a as R}from"./useRestApiRunner-BRG0l7Io.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as N}from"./SakslisteVelgerForm-C66cgfBj.js";import{F as Z}from"./FagsakSearchIndex-Cj733LsR.js";import{O as $}from"./OppgaveErReservertAvAnnenModal-BZr_NC5y.js";import{O as ee}from"./OppgaverTabell-CgY2Ruuf.js";import{S as ne}from"./SistBehandledeSaker-CtCTnXwR.js";import{N as re}from"./NyeOgFerdigstilteOppgaverForIdagPanel-rVxXICDC.js";import{N as te}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-BmS4qfkg.js";import{D as ae}from"./DriftsmeldingPanel-BN0rkFRB.js";import"./index-CfOt2XX2.js";import"./kodeverkTyper-bpjtq0Dy.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-pkF1pY8a.js";import"./PersonInfo-BWnHB2fD.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-CmOp4Gyh.js";import"./index.es-piEouRKe.js";import"./ExclamationmarkTriangleFill-DNfb4-O8.js";import"./FagsakList-BnBn46ZC.js";import"./useLosKodeverk-CmeFTe1t.js";import"./ChevronRight-BHm86yJS.js";import"./BehandlingPollingTimoutModal-q0w00m3N.js";import"./OppgaveHandlingerMenu-lXDSoug8.js";import"./FlyttReservasjonModal-DqxJOMIy.js";import"./OpphevReservasjonModal-DD51Z-e3.js";import"./OppgaveReservasjonForlengetModal-CxtfDG5W.js";import"./Panel-BL8nTGsO.js";const se=()=>{const n=d.useContext(J),r=d.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=d.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:r,removeErrorMessages:a}},ie=n=>{const r=window.localStorage.getItem(n);return r!=="undefined"&&r!==null?r:void 0},de=(n,r)=>{window.localStorage.setItem(n,r)},le=n=>{window.localStorage.removeItem(n)},F=({reserverOppgave:n,sakslister:r,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(t.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.jsxs(e.Fragment,{children:[e.jsx(G,{size:"small",children:e.jsx(P,{id:"SakslistePanel.StartBehandling"})}),e.jsx(T,{sixteenPx:!0}),e.jsx(W,{sakslister:r,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:ie,setValueInLocalStorage:de,removeValueFromLocalStorage:le}),e.jsx(T,{twentyPx:!0}),s&&e.jsx(ee,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s})]})};F.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
