import{j as s}from"./jsx-runtime-QvZ8i92b.js";import{a as u,b as k,r as A}from"./fplosSaksbehandlerRestApi-B2_NijuJ.js";import"./index-uubelm5h.js";import"./useRestApiRunner-BRG0l7Io.js";import{m as g}from"./nb_NO-CRYAQhiY.js";import{g as h}from"./withIntl-cmAdHa59.js";import{S as i}from"./SistBehandledeSaker-DzusmVW_.js";import"./dayjs.min-BsYQKNhR.js";import"./index-CfOt2XX2.js";const E=h(g),x={title:"los/saksbehandler/saksstotte/SistBehandledeSaker",component:i,decorators:[E]},m=({behandledeOppgaver:c})=>{const l=[{key:u.BEHANDLEDE_OPPGAVER.name,data:c}];return s.jsx(k,{data:l,requestApi:A,children:s.jsx(i,{åpneFagsak:()=>{}})})},e=m.bind({});e.args={behandledeOppgaver:[{id:1,personnummer:"334342323",navn:"Espen Utvikler"}]};const a=m.bind({});var t,r,n;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`({
  behandledeOppgaver
}) => {
  const data = [{
