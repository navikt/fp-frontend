import{u as A,r as d,j as e}from"./iframe-DjvIQ3VO.js";import"./FlyttReservasjonModal-M4Re-cai.js";import{B as S}from"./BehandlingPollingTimoutModal-jM8fUeJK.js";import{G as x}from"./index.es-Briw5zBJ.js";import{T as w,C as O,S as N,O as E}from"./OppgaveLabels-Kh99kX4P.js";import{T as i}from"./Table-C_hy6jQm.js";import{H as h,V as y}from"./VStack-BUujH98t.js";import{B as c,L as I}from"./nb_NO-BAlqZDvd.js";import{S as L}from"./Checkmark-B0dh_7cj.js";import{u as _}from"./useMutation-YE1qPa_0.js";import{a as K,b as D}from"./fplosSaksbehandlerApi-B3Yz8Ws0.js";import{M as o}from"./Loader-DkZSySMT.js";var C=(n=>(n.PENDING="PENDING",n.COMPLETE="COMPLETE",n.DELAYED="DELAYED",n.CANCELLED="CANCELLED",n.HALTED="HALTED",n))(C||{});const M="_image_lxw0f_1",P="_fadeIn_lxw0f_9",k={image:M,fadeIn:P},B=({oppgave:n,reserverOppgave:t,erNyBehandling:u})=>{const r=A(),a=d.useRef(null),l=(s,g)=>{a.current?.contains(s.target)||g&&t(g)};return e.jsxs(i.Row,{onMouseDown:s=>l(s,n),onKeyDown:s=>l(s,n),className:u?k.fadeIn:void 0,children:[e.jsx(i.DataCell,{children:n.navn??"<navn>"}),e.jsx(i.DataCell,{children:e.jsxs(h,{align:"center",ref:a,wrap:!1,children:[e.jsx(c,{children:n.saksnummer}),e.jsx(w,{content:r.formatMessage({id:"LedigOppgaveRad.Saksnr"}),children:e.jsx(O,{activeIcon:e.jsx(L,{className:k.image,"aria-hidden":!0}),copyText:n.saksnummer,icon:e.jsx(N,{"aria-hidden":!0,className:k.image})})})]})}),e.jsx(i.DataCell,{children:e.jsx(E,{oppgave:n})}),e.jsx(i.DataCell,{children:n.opprettetTidspunkt&&e.jsx(x,{dateString:n.opprettetTidspunkt})})]},n.id)};B.__docgenInfo={description:"",methods:[],displayName:"LedigOppgaveRad",props:{oppgave:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
