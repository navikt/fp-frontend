import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{c as a}from"./nb_NO-DWNE31-V.js";import{S as v}from"./SøkForm-CZWhALke.js";import{P as p}from"./PersonInfo-1CW4tXVs.js";import{S as k}from"./SøkResultat-DeoMJhyz.js";import{V as y}from"./VStack-ChXOQS5S.js";import"./index-_2TAQcTa.js";import{M as i}from"./Loader-BEUEYYSz.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer.toString()===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:s,åpneFagsak:g,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>n.jsxs(y,{gap:"4",children:[n.jsx(v,{onSubmit:t,searchStarted:l,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(p,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(k,{åpneFagsak:g,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
