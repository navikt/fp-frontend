import{j as e,d as g}from"./dayjs.min-ZUODdiE-.js";import{f as D,d as G,j as T,t as M,P as Y,m as z,A as m}from"./nb_NO-aGCfMFDj.js";import{Y as i,z as A,b as f}from"./index.es-BkMxg3KK.js";import{c as y,a as t,r as P,R as h,b as J}from"./fplosSaksbehandlerRestApi-C88bg1W5.js";import{r as d}from"./index-uubelm5h.js";import{R as $,a as R}from"./useRestApiRunner-CYj01yVu.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as I}from"./SakslisteVelgerForm-DAgitFuO.js";import{F as Z}from"./FagsakSearchIndex-BgNwuk3Y.js";import{O as ee}from"./OppgaveErReservertAvAnnenModal-D6QHsCK1.js";import{O as ne}from"./OppgaverTabell-Cry3K2p7.js";import{S as re}from"./SistBehandledeSaker-feVLC69k.js";import{N as te}from"./NyeOgFerdigstilteOppgaverForIdagPanel-B4rQ75ji.js";import{N as ae}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-DYnVPDs6.js";import{D as se}from"./DriftsmeldingPanel-CqGkFyGu.js";import"./index-BdzLX9oW.js";import"./kodeverkTyper-DrNSceCt.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-CONHqd80.js";import"./PersonInfo-BlRhvpkc.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-hr88MO8X.js";import"./index.es-DRvRrcn7.js";import"./ExclamationmarkTriangleFill-zYpHxstq.js";import"./FagsakList-CKsF8Udf.js";import"./useLosKodeverk-CTExDMTH.js";import"./ChevronRight-BVDKmTYK.js";import"./BehandlingPollingTimoutModal-OUxg9RWU.js";import"./OppgaveHandlingerMenu-B4e18DS5.js";import"./FlyttReservasjonModal-CAsSdAVK.js";import"./OpphevReservasjonModal-DDiUNKeI.js";import"./OppgaveReservasjonForlengetModal-CmgM6iqi.js";import"./Panel-CnGSQ_k3.js";const ie=()=>{const n=d.useContext($),r=d.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=d.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:r,removeErrorMessages:a}},de=n=>{const r=window.localStorage.getItem(n);return r!=="undefined"&&r!==null?r:void 0},le=(n,r)=>{window.localStorage.setItem(n,r)},oe=n=>{window.localStorage.removeItem(n)},K=({reserverOppgave:n,sakslister:r,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(t.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.jsxs(e.Fragment,{children:[e.jsx(D,{size:"small",children:e.jsx(G,{id:"SakslistePanel.StartBehandling"})}),e.jsx(T,{sixteenPx:!0}),e.jsx(W,{sakslister:r,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:de,setValueInLocalStorage:le,removeValueFromLocalStorage:oe}),e.jsx(T,{twentyPx:!0}),s&&e.jsx(ne,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s})]})};K.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
