...
\`\`\``,methods:[],displayName:"MerkePanel",props:{erDod:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},diskresjonskode:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}}}};const q="_kvinneIcon_4m9mx_1",A="_MannIcon_4m9mx_7",g={kvinneIcon:q,MannIcon:A},I=({person:e})=>{const a=j(),{kjønn:r,dødsdato:n,diskresjonskode:s,fødselsdato:l,navn:k,fødselsnummer:y}=e,h=x().diff(l,"years");return t.jsx(w,{children:t.jsxs(M,{children:[t.jsxs(f,{children:[r===p.KVINNE&&t.jsx(N,{className:g.kvinneIcon,title:a.formatMessage({id:"Person.ImageText"})}),r===p.MANN&&t.jsx(S,{className:g.MannIcon,title:a.formatMessage({id:"Person.ImageText"})})]}),t.jsxs(f,{children:[t.jsxs(O,{size:"small",children:[k," ",t.jsx(u,{erDod:!!n,alder:h,dodsdato:n})]}),t.jsx(_,{children:y})]}),t.jsx(f,{children:t.jsx(c,{erDod:!!n,diskresjonskode:s})})]})})},B=I;I.__docgenInfo={description:`PersonInfo
...
\`\`\``,methods:[],displayName:"PersonInfo",props:{person:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  dødsdato?: string;
  diskresjonskode?: string;
}>`},description:""}}};export{m as D,B as P};
