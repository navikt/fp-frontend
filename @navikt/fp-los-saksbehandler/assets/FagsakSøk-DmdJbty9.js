import{j as n}from"./iframe-B9KoQGM0.js";import{S as v}from"./SøkForm-D0wtwrXY.js";import{P as p}from"./PersonInfo-BA9TaJqk.js";import{S as k}from"./SøkResultat-BddqEGvf.js";import{V as y}from"./VStack-C4xViOeb.js";import{B as s}from"./nb_NO-C3IQ5_sL.js";import{M as i}from"./Loader-C2bZBRPU.js";const b=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer===e[0].saksnummer).length>1:!1,q=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:u,searchResultReceived:a,åpneFagsak:l,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o})=>n.jsxs(y,{gap:"space-16",children:[n.jsx(v,{onSubmit:t,searchStarted:g,searchResultAccessDenied:d,resetSearch:m,kanSaksbehandle:o}),a&&e&&e.length===0&&n.jsx(s,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),a&&b(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(p,{person:e[0].person}),n.jsx(s,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(k,{åpneFagsak:l,selectOppgaveCallback:u,fagsaker:e,fagsakOppgaver:r})]})]});q.__docgenInfo={description:`FagsakSøk
