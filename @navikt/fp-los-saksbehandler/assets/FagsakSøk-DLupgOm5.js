import{j as n}from"./jsx-runtime-DR9Q75dM.js";import{B as a}from"./nb_NO-h-VtBlNV.js";import{S as k}from"./SøkForm-CQsNx3fw.js";import{P as p}from"./PersonInfo-BxH6V8rn.js";import{S as y}from"./SøkResultat-BZeiQR4g.js";import{V as b}from"./VStack-Br3SWiEm.js";import"./index-DRjF_FHU.js";import{M as i}from"./i18n.context-CjWL2J0U.js";const q=(e,r)=>e?e.length>1||e.length===1&&r.filter(t=>t.saksnummer.toString()===e[0].saksnummer).length>1:!1,u=({fagsaker:e,fagsakOppgaver:r,searchFagsakCallback:t,selectOppgaveCallback:g,searchResultReceived:s,åpneFagsak:d,searchStarted:l,searchResultAccessDenied:m,resetSearch:o,kanSaksbehandle:v})=>n.jsxs(b,{gap:"4",children:[n.jsx(k,{onSubmit:t,searchStarted:l,searchResultAccessDenied:m,resetSearch:o,kanSaksbehandle:v}),s&&e&&e.length===0&&n.jsx(a,{children:n.jsx(i,{id:"FagsakSearch.ZeroSearchResults"})}),s&&q(e,r)&&n.jsxs(n.Fragment,{children:[n.jsx(p,{person:e[0].person}),n.jsx(a,{size:"small",children:n.jsx(i,{id:"FagsakSearch.FlereSakerEllerBehandlinger"})}),n.jsx(y,{åpneFagsak:d,selectOppgaveCallback:g,fagsaker:e,fagsakOppgaver:r})]})]});u.__docgenInfo={description:`FagsakSøk
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSøk",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilmelding?: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!1}}]}},description:""},resetSearch:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},kanSaksbehandle:{required:!0,tsType:{name:"boolean"},description:""}}};u.__docgenInfo={description:`FagsakSøk
...
Er søkeresultat mottatt vises enten trefflisten og relatert person, eller en tekst som viser ingen resultater.`,methods:[],displayName:"FagsakSøk",props:{fagsaker:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilmelding?: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!1}}]}},description:""},resetSearch:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},kanSaksbehandle:{required:!0,tsType:{name:"boolean"},description:""}}};export{u as F};
