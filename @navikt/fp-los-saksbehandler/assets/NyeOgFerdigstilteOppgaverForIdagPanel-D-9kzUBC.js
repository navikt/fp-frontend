import{j as g}from"./jsx-runtime-D_zvdyIk.js";import{r as N}from"./index-C4XKfyRp.js";import{c as v,B as n,d as u,P as F}from"./withThemeDecorator-z4QW1Ff7.js";import{u as O}from"./useLosKodeverk-BxoCJ-MK.js";import{R as f}from"./FlyttReservasjonModal-CAo0DYe1.js";import{V as k}from"./VStack-CMLmUAd_.js";import{H as h}from"./nb_NO-C3_hJm02.js";import{M as T}from"./message-BKRiN860.js";const o=[n.TILBAKEKREVING_REVURDERING,n.TILBAKEKREVING,n.DOKUMENTINNSYN,n.KLAGE,n.REVURDERING,n.FORSTEGANGSSOKNAD],m=({height:a,nyeOgFerdigstilteOppgaver:r,behandlingTyper:i})=>{const s=v(),y=o.map(t=>{if(t===n.FORSTEGANGSSOKNAD)return s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Førstegangsbehandling"});const e=i.find(d=>d.kode===t);return e?e.navn:""}),l=s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Ferdigstilte"}),p=s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Nye"}),b=o.map(t=>{const e=r.find(d=>d.behandlingType===t);return e?e.antallFerdigstilte:0}),c=o.map(t=>{const e=r.find(d=>d.behandlingType===t);return e?e.antallNye:0});return g.jsx(f,{height:a,option:{tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},legend:{data:[l,p],top:"bottom"},grid:{top:"5%",left:"3%",right:"4%",bottom:"12%",containLabel:!0},xAxis:{type:"value",boundaryGap:[0,.01]},yAxis:{type:"category",data:y},series:[{name:l,type:"bar",data:b},{name:p,type:"bar",data:c}],color:["#38a161","#337c9b"]}})};m.__docgenInfo={description:"",methods:[],displayName:"NyeOgFerdigstilteOppgaverForIdagGraf",props:{height:{required:!0,tsType:{name:"number"},description:""},behandlingTyper:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
