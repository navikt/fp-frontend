import{j as g}from"./jsx-runtime-CLpGMVip.js";import{r as F}from"./index-CYQpqK1Q.js";import{B as n,h as c,H as k}from"./nb_NO-BYGbsT6l.js";import{A as O}from"./index.es-Oir7ntzC.js";import{d as m}from"./dayjs.min-DPY8FYmS.js";import{u as h,K as T}from"./useLosKodeverk-oiZakLeg.js";import{R as f}from"./FlyttReservasjonModal-CYQ14skS.js";import{V as q}from"./VStack-Sghrg9mH.js";import{M as I}from"./i18n.hooks-DZJ3QBwu.js";const l=[n.TILBAKEKREVING_REVURDERING,n.TILBAKEKREVING,n.DOKUMENTINNSYN,n.KLAGE,n.REVURDERING,n.FORSTEGANGSSOKNAD],o=({height:a,nyeOgFerdigstilteOppgaver:r,behandlingTyper:i})=>{const s=c(),v=l.map(t=>{if(t===n.FORSTEGANGSSOKNAD)return s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Førstegangsbehandling"});const e=i.find(d=>d.kode===t);return e?e.navn:""}),p=s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Ferdigstilte"}),u=s.formatMessage({id:"NyeOgFerdigstilteOppgaverForIdagGraf.Nye"}),b=l.map(t=>{const e=r.find(d=>d.behandlingType===t);return e?e.antallFerdigstilte:0}),N=l.map(t=>{const e=r.find(d=>d.behandlingType===t);return e?e.antallNye:0});return g.jsx(f,{height:a,option:{tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},legend:{data:[p,u],top:"bottom"},grid:{top:"5%",left:"3%",right:"4%",bottom:"12%",containLabel:!0},xAxis:{type:"value",boundaryGap:[0,.01]},yAxis:{type:"category",data:v},series:[{name:p,type:"bar",data:b},{name:u,type:"bar",data:N}],color:["#38a161","#337c9b"]}})};o.__docgenInfo={description:"",methods:[],displayName:"NyeOgFerdigstilteOppgaverForIdagGraf",props:{height:{required:!0,tsType:{name:"number"},description:""},behandlingTyper:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
