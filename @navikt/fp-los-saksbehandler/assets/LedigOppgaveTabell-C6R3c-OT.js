import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{f as x,d as h,L as w}from"./nb_NO-Bb9ahodp.js";import"./FlyttReservasjonModal-D6z5Ybfx.js";import{B}from"./BehandlingPollingTimoutModal-03tqQDNN.js";import{r as g}from"./index-C4XKfyRp.js";import{X as O}from"./index.es-BQChBZK5.js";import{T as N,C as I,S as L,a as S,O as E}from"./OppgaveLabels-PkfAVjAL.js";import{T as i}from"./Table-DHj7x4o5.js";import{H as f,V as b}from"./VStack-C0zrd7Fd.js";import{u as _}from"./useMutation-DJMtwEtE.js";import{d as K,e as D}from"./fplosSaksbehandlerApi-4oezgadX.js";import{M as o}from"./message-Sp_E-lKi.js";var C=(n=>(n.PENDING="PENDING",n.COMPLETE="COMPLETE",n.DELAYED="DELAYED",n.CANCELLED="CANCELLED",n.HALTED="HALTED",n))(C||{});const M="_image_1ni5b_1",P="_fadeIn_1ni5b_9",c={image:M,fadeIn:P},q=({oppgave:n,reserverOppgave:t,erNyBehandling:l})=>{const r=x(),s=g.useRef(null),u=(a,d)=>{var p;(p=s.current)!=null&&p.contains(a.target)||d&&t(d)};return e.jsxs(i.Row,{onMouseDown:a=>u(a,n),onKeyDown:a=>u(a,n),className:l?c.fadeIn:void 0,children:[e.jsx(i.DataCell,{children:n.navn??"<navn>"}),e.jsx(i.DataCell,{children:e.jsxs(f,{align:"center",ref:s,wrap:!1,children:[e.jsx(h,{children:n.saksnummer}),e.jsx(N,{content:r.formatMessage({id:"LedigOppgaveRad.Saksnr"}),children:e.jsx(I,{activeIcon:e.jsx(S,{className:c.image,"aria-hidden":!0}),copyText:n.saksnummer,icon:e.jsx(L,{"aria-hidden":!0,className:c.image})})})]})}),e.jsx(i.DataCell,{children:e.jsx(E,{oppgave:n})}),e.jsx(i.DataCell,{children:n.opprettetTidspunkt&&e.jsx(O,{dateString:n.opprettetTidspunkt})})]},n.id)};q.__docgenInfo={description:"",methods:[],displayName:"LedigOppgaveRad",props:{oppgave:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
