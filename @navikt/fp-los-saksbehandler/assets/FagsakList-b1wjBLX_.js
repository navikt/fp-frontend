import{r as b,R as e}from"./index-BBkUAzwr.js";import{d as T}from"./dayjs.min-DXWWvErk.js";import{l as I,y as c,n as r,$ as q,A as f}from"./nb_NO-Bv_fr8-1.js";import{I as u,v as g}from"./index.es-BkMxg3KK.js";import{g as v}from"./kodeverkUtils-RGNAgZhp.js";import{u as h}from"./useLosKodeverk-C914sOfX.js";import{c as L,R as Y}from"./fplosSaksbehandlerRestApi-A_nzAW8M.js";import{S}from"./ChevronRight-Bcnu1h_4.js";const K="_table_o6uje_1",B={table:K},U=["FagsakList.Saksnummer","FagsakList.Stonadstype","FagsakList.Behandlingstype","FagsakList.Status","FagsakList.BarnFodt","EMPTY_1"],A=(i,s)=>()=>s(i),E=i=>(s,t)=>{t&&i(t)},_=(i=[])=>i.concat().sort((s,t)=>{if(s.status===g.AVSLUTTET&&t.status!==g.AVSLUTTET)return 1;if(s.status!==g.AVSLUTTET&&t.status===g.AVSLUTTET)return-1;const l=s.endret?s.endret:s.opprettet,d=t.endret?t.endret:t.opprettet;return T(l,f).diff(T(d,f))}),R=({fagsaker:i,fagsakOppgaver:s,åpneFagsak:t,selectOppgaveCallback:l})=>{const d=h(u.FAGSAK_STATUS),F=h(u.FAGSAK_YTELSE),o=L.useGlobalStateRestApiData(Y.KODEVERK_LOS),j=b.useMemo(()=>_(i),[i]);return e.createElement(I,{headerTextCodes:U,classNameTable:B.table},j.map(a=>{const k=d.find(n=>n.kode===a.status),p=F.find(n=>n.kode===a.fagsakYtelseType),y=s.filter(n=>n.saksnummer.toString()===a.saksnummer),m=y.map((n,w)=>e.createElement(c,{key:`oppgave${n.id}`,id:n.id,onMouseDown:A(n,l),onKeyDown:A(n,l),isDashedBottomBorder:y.length>w+1},e.createElement(r,null),e.createElement(r,null,v(o,u.FAGSAK_YTELSE,n.fagsakYtelseType)),e.createElement(r,null,v(o,u.BEHANDLING_TYPE,n.behandlingstype)),e.createElement(r,null,n.behandlingStatus?v(o,u.BEHANDLING_STATUS,n.behandlingStatus):""),e.createElement(r,null,a.barnFødt?e.createElement(q,{dateString:a.barnFødt}):null),e.createElement(r,null,e.createElement(S,null))));return e.createElement(b.Fragment,{key:`fagsak${a.saksnummer}`},e.createElement(c,{id:a.saksnummer,onMouseDown:E(t),onKeyDown:E(t),isDashedBottomBorder:m.length>0},e.createElement(r,null,a.saksnummer),e.createElement(r,null,p?p.navn:""),e.createElement(r,null),e.createElement(r,null,k?k.navn:""),e.createElement(r,null,a.barnFødt?e.createElement(q,{dateString:a.barnFødt}):null),e.createElement(r,null,e.createElement(S,null))),m.length>0&&m)}))},H=R;R.__docgenInfo={description:`FagsakList
