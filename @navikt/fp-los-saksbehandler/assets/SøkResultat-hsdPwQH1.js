import{j as e,r as x,d as b,b as q}from"./iframe-B1D1pV9u.js";import{q as h}from"./index.es-egtfdZEU.js";import{u as o}from"./useLosKodeverk-Bk_0y3gv.js";import{T as n}from"./Table-DPLZ9NnD.js";import{M as i}from"./message-174L90AR.js";import{S as c}from"./ChevronRight-CdniEDmD.js";var u=(r=>(r.OPPRETTET="OPPR",r.UNDER_BEHANDLING="UBEH",r.LOPENDE="LOP",r.AVSLUTTET="AVSLU",r))(u||{});const A=(r,a)=>{if(r.status===u.AVSLUTTET&&a.status!==u.AVSLUTTET)return 1;if(r.status!==u.AVSLUTTET&&a.status===u.AVSLUTTET)return-1;const l=r.endret??r.opprettet,d=a.endret??a.opprettet;return b(l,q).diff(b(d,q))},w=({fagsaker:r,fagsakOppgaver:a,åpneFagsak:l,selectOppgaveCallback:d})=>{const j=o("FagsakStatus"),m=o("FagsakYtelseType"),f=o("BehandlingType"),R=[...r].sort(A);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:R.map(t=>{const p=j.find(s=>s.kode===t.status),k=m.find(s=>s.kode===t.fagsakYtelseType),v=a.filter(s=>s.saksnummer===t.saksnummer).map(s=>{var y,T;return e.jsxs(n.Row,{onMouseDown:()=>d(s),onKeyDown:()=>d(s),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:(y=m.find(g=>g.kode===s.fagsakYtelseType))==null?void 0:y.navn}),e.jsx(n.DataCell,{children:(T=f.find(g=>g.kode===s.behandlingstype))==null?void 0:T.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(h,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(c,{})})]},s.id)});return e.jsxs(x.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>l(t.saksnummer),onKeyDown:()=>l(t.saksnummer),children:[e.jsx(n.DataCell,{children:t.saksnummer}),e.jsx(n.DataCell,{children:k?k.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:p?p.navn:""}),e.jsx(n.DataCell,{children:t.barnFødt?e.jsx(h,{dateString:t.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(c,{})})]}),v.length>0&&v]},t.saksnummer)})})]})};w.__docgenInfo={description:`FagsakList
