import{r as l,R as e}from"./index-DVXBtNgz.js";import{H as D,e as G,j as T,t as M,P as Y,m as z,d as m,N as g}from"./nb_NO-CXyD09lO.js";import{Y as i,z as A,b as f}from"./index.es-BkMxg3KK.js";import{c as y,a as r,r as P,R as c,b as J}from"./fplosSaksbehandlerRestApi-_JpbzVtX.js";import{R as $,a as R}from"./useRestApiRunner-B4tj0W_o.js";import{a as Q}from"./alleKodeverkLos-BJud6Q-i.js";import{S as W,K as X,A as I}from"./SakslisteVelgerForm-Bc_aslIg.js";import{F as Z}from"./FagsakSearchIndex-BMVzjJo0.js";import{O as ee}from"./OppgaveErReservertAvAnnenModal-C6B9pdnj.js";import{O as ne}from"./OppgaverTabell-Bz41vxV6.js";import{S as te}from"./SistBehandledeSaker-DAgyc2ay.js";import{N as re}from"./NyeOgFerdigstilteOppgaverForIdagPanel-BLUjEavY.js";import{N as ae}from"./NyeOgFerdigstilteOppgaverForSisteSyvPanel-DSAk4beb.js";import{D as se}from"./DriftsmeldingPanel-6K4nSgFh.js";import"./tslib.es6-CMwweBXX.js";import"./index-Cbx7Fas8.js";import"./kodeverkTyper-DJMuX7JX.js";import"./kodeverkUtils-RGNAgZhp.js";import"./FagsakSearch-CeVq9Ysq.js";import"./PersonInfo-YCNcln23.js";import"./Kjonnkode-C-fkzSiP.js";import"./SearchForm-DfFZ4V4A.js";import"./index.es-BjxD05A9.js";import"./ExclamationmarkTriangleFill-Bd-fcg-X.js";import"./FagsakList-CKq2G0kk.js";import"./useLosKodeverk-BF3zTobk.js";import"./ChevronRight-DxjcbTmQ.js";import"./BehandlingPollingTimoutModal-CYlP1Kaw.js";import"./OppgaveHandlingerMenu-CtANVEM7.js";import"./FlyttReservasjonModal-Blfeh4kU.js";import"./OpphevReservasjonModal-DMKbBQEd.js";import"./OppgaveReservasjonForlengetModal-Dy4OC-MJ.js";import"./Panel-Bn4iqatL.js";const ie=()=>{const n=l.useContext($),t=l.useCallback(s=>{n&&n({type:"add",data:s})},[]),a=l.useCallback(()=>{n&&n({type:"remove"})},[]);return{addErrorMessage:t,removeErrorMessages:a}},le=n=>{const t=window.localStorage.getItem(n);return t!=="undefined"&&t!==null?t:void 0},de=(n,t)=>{window.localStorage.setItem(n,t)},oe=n=>{window.localStorage.removeItem(n)},K=({reserverOppgave:n,sakslister:t,setValgtSakslisteId:a,valgtSakslisteId:s})=>{const{startRequest:o,data:k}=y.useRestApiRunner(r.BEHANDLINGSKO_OPPGAVE_ANTALL);return e.createElement(e.Fragment,null,e.createElement(D,{size:"small"},e.createElement(G,{id:"SakslistePanel.StartBehandling"})),e.createElement(T,{sixteenPx:!0}),e.createElement(W,{sakslister:t,setValgtSakslisteId:a,fetchAntallOppgaver:o,getValueFromLocalStorage:le,setValueInLocalStorage:de,removeValueFromLocalStorage:oe}),e.createElement(T,{twentyPx:!0}),s&&e.createElement(ne,{reserverOppgave:n,antallOppgaver:k,valgtSakslisteId:s}))};K.__docgenInfo={description:"SakslistePanel",methods:[],displayName:"SakslistePanel",props:{valgtSakslisteId:{required:!1,tsType:{name:"number"},description:""},setValgtSakslisteId:{required:!0,tsType:{name:"signature",type:"function",raw:"(sakslisteId: number) => void",signature:{arguments:[{type:{name:"number"},name:"sakslisteId"}],return:{name:"void"}}},description:""},sakslister:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  sakslisteId: number;
  navn: string;
