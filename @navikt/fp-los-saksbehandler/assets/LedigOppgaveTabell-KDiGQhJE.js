import{u as x,r as g,j as e}from"./iframe-B3LllOyS.js";import"./FlyttReservasjonModal-7oYJA89T.js";import{B as w}from"./BehandlingPollingTimoutModal-CRe8zaz-.js";import{H as B}from"./index.es-B_bcqdk4.js";import{T as N,C as E,S as I,a as L,O as S}from"./OppgaveLabels-CWKDwVBw.js";import{T as i}from"./Table-bB41s0gD.js";import{H as h,V as y}from"./VStack-oiDHnFzs.js";import{B as b,L as O}from"./nb_NO-iOLOzDYk.js";import{u as _}from"./useMutation-DdKf8rz8.js";import{b as K,c as D}from"./fplosSaksbehandlerApi-Dsddu5UX.js";import{M as o}from"./Loader-BniX8TTA.js";var C=(n=>(n.PENDING="PENDING",n.COMPLETE="COMPLETE",n.DELAYED="DELAYED",n.CANCELLED="CANCELLED",n.HALTED="HALTED",n))(C||{});const M="_image_lxw0f_1",H="_fadeIn_lxw0f_9",k={image:M,fadeIn:H},f=({oppgave:n,reserverOppgave:t,erNyBehandling:l})=>{const r=x(),s=g.useRef(null),u=(a,d)=>{s.current?.contains(a.target)||d&&t(d)};return e.jsxs(i.Row,{onMouseDown:a=>u(a,n),onKeyDown:a=>u(a,n),className:l?k.fadeIn:void 0,children:[e.jsx(i.DataCell,{children:n.navn??"<navn>"}),e.jsx(i.DataCell,{children:e.jsxs(h,{align:"center",ref:s,wrap:!1,children:[e.jsx(b,{children:n.saksnummer}),e.jsx(N,{content:r.formatMessage({id:"LedigOppgaveRad.Saksnr"}),children:e.jsx(E,{activeIcon:e.jsx(L,{className:k.image,"aria-hidden":!0}),copyText:n.saksnummer,icon:e.jsx(I,{"aria-hidden":!0,className:k.image})})})]})}),e.jsx(i.DataCell,{children:e.jsx(S,{oppgave:n})}),e.jsx(i.DataCell,{children:n.opprettetTidspunkt&&e.jsx(B,{dateString:n.opprettetTidspunkt})})]},n.id)};f.__docgenInfo={description:"",methods:[],displayName:"LedigOppgaveRad",props:{oppgave:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  id: number;
