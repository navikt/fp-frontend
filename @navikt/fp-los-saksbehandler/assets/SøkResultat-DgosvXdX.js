import{j as e,r as c,k,m as y}from"./iframe-DYQXSugv.js";import{G as T}from"./index.es-C8XlgDNo.js";import{u as g}from"./useLosKodeverk-CqoPwSmx.js";import{T as n}from"./Table-BZkjQVPB.js";import{M as i}from"./Loader-Bxok6rQJ.js";import{S as b}from"./ChevronRight-BoXsa9sa.js";const f=(t,s)=>{if(t.status==="AVSLU"&&s.status!=="AVSLU")return 1;if(t.status!=="AVSLU"&&s.status==="AVSLU")return-1;const l=t.endret??t.opprettet,u=s.endret??s.opprettet;return k(l,y).diff(k(u,y))},B=({fagsaker:t,fagsakOppgaver:s,åpneFagsak:l,selectOppgaveCallback:u})=>{const h=g("FagsakStatus"),o=g("FagsakYtelseType"),j=g("BehandlingType"),q=[...t].sort(f);return e.jsxs(n,{children:[e.jsx(n.Header,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Saksnummer"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Behandlingstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Stonadstype"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.Status"})}),e.jsx(n.HeaderCell,{scope:"col",children:e.jsx(i,{id:"FagsakList.BarnFodt"})}),e.jsx(n.HeaderCell,{scope:"col"})]})}),e.jsx(n.Body,{children:q.map(r=>{const m=h.find(a=>a.kode===r.status),v=o.find(a=>a.kode===r.fagsakYtelseType),p=s.filter(a=>a.saksnummer===r.saksnummer).map(a=>e.jsxs(n.Row,{onMouseDown:()=>u(a),onKeyDown:()=>u(a),children:[e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:o.find(d=>d.kode===a.fagsakYtelseType)?.navn}),e.jsx(n.DataCell,{children:j.find(d=>d.kode===a.behandlingstype)?.navn}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:r.barnFødt?e.jsx(T,{dateString:r.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(b,{})})]},a.id));return e.jsxs(c.Fragment,{children:[e.jsxs(n.Row,{onMouseDown:()=>l(r.saksnummer),onKeyDown:()=>l(r.saksnummer),children:[e.jsx(n.DataCell,{children:r.saksnummer}),e.jsx(n.DataCell,{children:v?v.navn:""}),e.jsx(n.DataCell,{}),e.jsx(n.DataCell,{children:m?m.navn:""}),e.jsx(n.DataCell,{children:r.barnFødt?e.jsx(T,{dateString:r.barnFødt}):null}),e.jsx(n.DataCell,{children:e.jsx(b,{})})]}),p.length>0&&p]},r.saksnummer)})})]})};B.__docgenInfo={description:`FagsakList
