...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const Of="_helpTextImage_vrhwa_1",_f="_varsel_vrhwa_17",Sf="_bold_vrhwa_23",Lt={helpTextImage:Of,varsel:_f,bold:Sf},Oa=Mi(3),_a=Fi(1500),pr="IKKE_SEND",Tf=e=>{const{videreBehandling:t,varseltekst:r,begrunnelse:n}=e;return t!=null&&t.endsWith(pr)?{kode:oe.VURDER_FEILUTBETALING,begrunnelse:n,videreBehandling:We.TILBAKEKR_OPPRETT}:{kode:oe.VURDER_FEILUTBETALING,begrunnelse:n,videreBehandling:t,varseltekst:r}},xf=(e,t)=>!e||!t?void 0:{videreBehandling:!t.varseltekst&&t.videreBehandling===We.TILBAKEKR_OPPRETT?t.videreBehandling+pr:t.videreBehandling,varseltekst:t.varseltekst,begrunnelse:e.begrunnelse??""},Ki=({readOnly:e,språkkode:t,previewCallback:r,aksjonspunkt:n,fagsak:a})=>{const i=Wt(),{watch:l}=yn(),s=l("varseltekst"),o=a.fagsakYtelseType===Zi.FORELDREPENGER,u=d=>{r({mottaker:"",fritekst:s??" "}),d.preventDefault()};return!n||n.definisjon!==oe.VURDER_FEILUTBETALING?null:j.jsxs(Ge,{gap:"10",align:"start",children:[j.jsx(Kt,{name:"begrunnelse",label:i.formatMessage({id:"Simulering.vurdering"}),validate:[Jn,Oa,_a,Ut],maxLength:1500,readOnly:e}),j.jsx(nc,{name:"videreBehandling",label:j.jsx(ae,{id:"Simulering.videreBehandling"}),validate:[Jn],isReadOnly:e,radios:[{value:We.TILBAKEKR_OPPRETT,label:j.jsx(ae,{id:"Simulering.gjennomfør"}),element:j.jsx("div",{className:Lt.varsel,children:j.jsx(Od,{alignOffset:20,children:j.jsxs(Ge,{gap:"4",children:[j.jsxs(nn,{gap:"2",children:[j.jsx(ye,{size:"small",className:Lt.bold,children:j.jsx(ae,{id:"Simulering.varseltekst"})}),j.jsx(pi,{content:o?i.formatMessage({id:"Simulering.HjelpetekstForeldrepenger"}):i.formatMessage({id:"Simulering.HjelpetekstEngangsstonad"}),children:j.jsx(Il,{className:Lt.helpTextImage})})]}),j.jsx(Kt,{name:"varseltekst",label:i.formatMessage({id:"Simulering.fritekst"}),validate:[Jn,Oa,_a,Ut],maxLength:1500,readOnly:e,parse:el,badges:[{type:"info",titleText:Qi(t)}]}),!e&&j.jsx(mu,{href:"#",onClick:u,children:j.jsx(ae,{id:"Messages.PreviewText"})})]})})})},{value:`${We.TILBAKEKR_OPPRETT}${pr}`,label:j.jsx(ae,{id:"Simulering.OpprettMenIkkeSendVarsel"})},{value:We.TILBAKEKR_IGNORER,label:j.jsx(ae,{id:"Simulering.avvent"})}]})]})};Ki.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevSøkerForm",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
