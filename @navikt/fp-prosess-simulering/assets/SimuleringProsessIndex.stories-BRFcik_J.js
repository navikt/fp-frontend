...
Readonly<{
  ...
  endretAv?: string;
  endretTidspunkt?: string;
}>`},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},previewCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(mottaker: string, fritekst: string) => Promise<any>",signature:{arguments:[{type:{name:"string"},name:"mottaker"},{type:{name:"string"},name:"fritekst"}],return:{name:"Promise",elements:[{name:"any"}],raw:"Promise<any>"}}},description:""}}};const dg="_readMore_mcbzv_1",ug={readMore:dg},kg=ji(3),Eg=Ui(1500),gg=e=>({kode:re.KONTROLLER_STOR_ETTERBETALING_SØKER,begrunnelse:e.begrunnelseEtterbetaling}),vg=e=>{if(!(!e||e.definisjon!==re.KONTROLLER_STOR_ETTERBETALING_SØKER))return{begrunnelseEtterbetaling:e.begrunnelse}},Hi=({readOnly:e,aksjonspunkt:r})=>{const t=bn();return!r||r.definisjon!==re.KONTROLLER_STOR_ETTERBETALING_SØKER?null:S.jsxs(zn,{gap:"4",children:[S.jsx(fs,{header:S.jsx(Z,{id:"Simulering.Etterbetaling.ReadMoreTittel"}),className:ug.readMore,children:S.jsx(Z,{id:"Simulering.Etterbetaling.ReadMoreInnhold"})}),S.jsx(Lr,{name:"begrunnelseEtterbetaling",label:t.formatMessage({id:"Simulering.Etterbetaling.Vurdering"}),validate:[wn,kg,Eg,Dr],maxLength:1500,size:"medium",readOnly:e})]})};Hi.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevSøkerForm",props:{aksjonspunkt:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
...
Readonly<{
  ...
  lovReferanse?: string;
  overstyrbar: boolean;
}>`}],raw:"Vilkar[]"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"any"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: any) => void",signature:{arguments:[{type:{name:"any"},name:"data"}],return:{name:"void"}}},description:""}}};const pg={saksnummer:"123",fagsakYtelseType:da.FORELDREPENGER},_g={uuid:"1",versjon:1,sprakkode:"NO"},Sg={123:{erPrivatPerson:!1,identifikator:"123",navn:"test"}},Ng={simuleringResultat:{periode:{fom:"2019-01-01",tom:"2019-03-31"},sumEtterbetaling:0,sumFeilutbetaling:-49863,sumInntrekk:-10899,ingenPerioderMedAvvik:!1,perioderPerMottaker:[{mottakerType:qn.ARBG,mottakerIdentifikator:"123",mottakerNummer:"test",resultatPerFagområde:[{fagOmrådeKode:"FP",rader:[{feltnavn:"nyttBeløp",resultaterPerMåned:[{periode:{fom:"2019-01-01",tom:"2019-01-31"},beløp:52619}]},{feltnavn:"tidligereUtbetalt",resultaterPerMåned:[{periode:{fom:"2019-01-01",tom:"2019-01-31"},beløp:61795}]},{feltnavn:"differanse",resultaterPerMåned:[{periode:{fom:"2019-01-01",tom:"2019-01-31"},beløp:-9176}]}]}],resultatOgMotregningRader:[{feltnavn:"inntrekkNesteMåned",resultaterPerMåned:[{periode:{fom:"2019-01-01",tom:"2019-01-31"},beløp:0}]},{feltnavn:"resultat",resultaterPerMåned:[{periode:{fom:"2019-01-01",tom:"2019-01-31"},beløp:-26486}]}],nesteUtbPeriode:{fom:"2019-10-01",tom:"2019-10-31"}}]},slåttAvInntrekk:!1},Ig={title:"prosess/prosess-simulering",component:Zr},ar=({aksjonspunkter:e,submitCallback:r,tilbakekrevingvalg:t,isAksjonspunktOpen:n})=>S.jsx(Zr,{behandling:_g,alleKodeverk:TE,submitCallback:r,isReadOnly:!1,isAksjonspunktOpen:n,readOnlySubmitButton:!1,status:"",vilkar:[],alleMerknaderFraBeslutter:{},setFormData:()=>{},fagsak:pg,aksjonspunkter:e,arbeidsgiverOpplysningerPerId:Sg,simuleringResultat:Ng,tilbakekrevingvalg:t,previewFptilbakeCallback:Sn("button-click")}),mn=ar.bind({});mn.args={aksjonspunkter:[{definisjon:re.VURDER_FEILUTBETALING,begrunnelse:void 0}],isAksjonspunktOpen:!0,submitCallback:Sn("button-click")};const Rn=ar.bind({});Rn.args={aksjonspunkter:[{definisjon:re.KONTROLLER_STOR_ETTERBETALING_SØKER,begrunnelse:void 0}],isAksjonspunktOpen:!0,submitCallback:Sn("button-click")};const fn=ar.bind({});fn.args={aksjonspunkter:[{definisjon:re.VURDER_FEILUTBETALING,begrunnelse:void 0},{definisjon:re.KONTROLLER_STOR_ETTERBETALING_SØKER,begrunnelse:void 0}],isAksjonspunktOpen:!0,submitCallback:Sn("button-click")};const An=ar.bind({});An.args={aksjonspunkter:[],isAksjonspunktOpen:!1,submitCallback:Sn("button-click"),tilbakekrevingvalg:{videreBehandling:we.TILBAKEKR_OPPDATER,varseltekst:"varsel-eksempel"}};var Wt,Zt,Xt;mn.parameters={...mn.parameters,docs:{...(Wt=mn.parameters)==null?void 0:Wt.docs,source:{originalSource:`({
  aksjonspunkter,
  submitCallback,
  tilbakekrevingvalg,
  isAksjonspunktOpen
  ...
  tilbakekrevingvalg,
  isAksjonspunktOpen
}) => <SimuleringProsessIndex behandling={behandling} alleKodeverk={alleKodeverk as any} submitCallback={submitCallback} isReadOnly={false} isAksjonspunktOpen={isAksjonspunktOpen} readOnlySubmitButton={false} status="" vilkar={[]} alleMerknaderFraBeslutter={{}} setFormData={() => undefined} fagsak={fagsak} aksjonspunkter={aksjonspunkter} arbeidsgiverOpplysningerPerId={arbeidsgiverOpplysningerPerId} simuleringResultat={simuleringResultat} tilbakekrevingvalg={tilbakekrevingvalg} previewFptilbakeCallback={action('button-click') as (data: any) => Promise<any>} />`,...(sa=(oa=An.parameters)==null?void 0:oa.docs)==null?void 0:sa.source}}};const Lg=["AksjonspunktVurderFeilutbetaling","AksjonspunktKontrollerEtterbetaling","AksjonspunktVurderFeilutbetalingOgEtterbetaling","SimuleringspanelUtenAksjonspunkt"];export{Rn as AksjonspunktKontrollerEtterbetaling,mn as AksjonspunktVurderFeilutbetaling,fn as AksjonspunktVurderFeilutbetalingOgEtterbetaling,An as SimuleringspanelUtenAksjonspunkt,Lg as __namedExportsOrder,Ig as default};
