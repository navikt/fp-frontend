...
>`},description:""},arbeidsgiverIdent:{required:!0,tsType:{name:"string"},description:""}}};const Af=({inntektsmelding:e,behandling:i,alleBehandlinger:r,alleKodeverk:a})=>{const l=mt(),o=e.tilknyttedeBehandlingIder.includes(i.uuid),d=r.filter(p=>e.tilknyttedeBehandlingIder.includes(p.uuid)),g=(()=>{const p=d.length;return o&&p>1?L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.behandling.bruktIDenneOgFlere"}):o?L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.behandling.bruktKunIDenne"}):p===0?L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.behandling.ikkeBruktINoen"}):L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.behandling.bruktIAndre"})})(),c=[...d].sort((p,k)=>new Date(p.opprettet).getTime()-new Date(k.opprettet).getTime());return L.jsxs(Xn,{tittel:l.formatMessage({id:"InntektsmeldingFaktaPanel.behandling.heading"}),children:[g,L.jsx(ml,{children:c.map(p=>L.jsx(ml.Item,{children:L.jsxs(hi,{gap:"space-4",children:[L.jsx("span",{children:a.BehandlingType.find(({kode:k})=>k===p.type)?.navn}),L.jsxs("span",{children:[L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.behandling.opprettet"})," ",L.jsx(oi,{dateTimeString:p.opprettet,separator:"kl"})]}),p.avsluttet?L.jsxs("span",{children:[L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.behandling.avsluttet"})," ",L.jsx(oi,{dateTimeString:p.avsluttet,separator:"kl"})]}):null]})},p.uuid))})]})};Af.__docgenInfo={description:"",methods:[],displayName:"BehandlingsOversikt",props:{inntektsmelding:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  inntektPrMnd: number;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  innsendingsårsak: keyof typeof InntektsmeldingInnsendingsårsak;
  tilknyttedeBehandlingIder: string[];
}>`},description:""}}};const nc=({inntektsmelding:e,fagsak:i,arbeidsgiverOpplysninger:r})=>{const a=`IM ${r.navn} - ${Ug(e.motattDato)}`;return L.jsx(Cl,{type:"button",onClick:()=>{Wb(i.saksnummer,e.journalpostId,e.dokumentId,a)},variant:"secondary",size:"small",icon:L.jsx(o0,{}),children:L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.modal.trigger"})})};nc.__docgenInfo={description:"",methods:[],displayName:"LastNedPdfKnapp",props:{fagsak:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  saksnummer: string;
  fagsakYtelseType: FagsakYtelseType;
  relasjonsRolleType: RelasjonsRolleType;
  status: FagsakStatus;
...
>`},description:""}}};const tc=({inntektsmelding:e})=>{const i=mt();if(e.refusjonsperioder.length===0)return L.jsx(Xn,{tittel:i.formatMessage({id:"InntektsmeldingFaktaPanel.refusjon.heading"}),children:e.refusjonPrMnd?L.jsx(lr,{beløp:e.refusjonPrMnd}):L.jsx(Ne,{tagName:"span",id:"InntektsmeldingFaktaPanel.refusjon.ingen"})});const r=[...e.refusjonsperioder].sort((a,l)=>new Date(a.fom).getTime()-new Date(l.fom).getTime());return L.jsxs(Xn,{tittel:i.formatMessage({id:"InntektsmeldingFaktaPanel.refusjon.heading"}),children:[L.jsx("span",{children:"Krever refusjon"}),L.jsx(lr,{beløp:e.refusjonPrMnd??0}),L.jsx("span",{children:"Endringer i perioden:"}),L.jsx("ul",{children:r.map(a=>L.jsx("li",{children:L.jsx(Ne,{id:"InntektsmeldingFaktaPanel.refusjon.endring.periode",values:{kroner:L.jsx(lr,{beløp:a.refusjonsbeløp.verdi}),fom:L.jsx(Wr,{dateString:a.fom})}})},a.indexKey))})]})};tc.__docgenInfo={description:"",methods:[],displayName:"Refusjon",props:{inntektsmelding:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  inntektPrMnd: number;
  refusjonPrMnd?: number;
  arbeidsgiverIdent: string;
  eksternArbeidsforholdId?: string | null;
