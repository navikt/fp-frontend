...
`:`;
`)+V+`return __p
}`;var me=Dd(function(){return ce(E,te+"return "+V).apply(a,T)});if(me.source=V,bs(me))throw me;return me}function Rh(n){return _e(n).toLowerCase()}function _h(n){return _e(n).toUpperCase()}function Nh(n,r,o){if(n=_e(n),n&&(o||r===a))return Vl(n);if(!n||!(r=Rn(r)))return n;var u=Un(n),k=Un(r),E=Hl(u,k),T=Ul(u,k)+1;return Ir(u,E,T).join("")}function Sh(n,r,o){if(n=_e(n),n&&(o||r===a))return n.slice(0,Yl(n)+1);if(!n||!(r=Rn(r)))return n;var u=Un(n),k=Ul(u,Un(r))+1;return Ir(u,0,k).join("")}function Ih(n,r,o){if(n=_e(n),n&&(o||r===a))return n.replace(bi,"");if(!n||!(r=Rn(r)))return n;var u=Un(n),k=Hl(u,Un(r));return Ir(u,k).join("")}function Oh(n,r){var o=W,u=x;if(Ge(r)){var k="separator"in r?r.separator:k;o="length"in r?ve(r.length):o,u="omission"in r?Rn(r.omission):u}n=_e(n);var E=n.length;if(Zr(n)){var T=Un(n);E=T.length}if(o>=E)return n;var h=o-Qr(u);if(h<1)return u;var _=T?Ir(T,0,h).join(""):n.slice(0,h);if(k===a)return _+u;if(T&&(h+=_.length-h),As(k)){if(n.slice(h).search(k)){var M,w=_;for(k.global||(k=Mi(k.source,_e(ul.exec(k))+"g")),k.lastIndex=0;M=k.exec(w);)var V=M.index;_=_.slice(0,V===a?h:V)}}else if(n.indexOf(Rn(k),h)!=h){var X=_.lastIndexOf(k);X>-1&&(_=_.slice(0,X))}return _+u}function Kh(n){return n=_e(n),n&&Gv.test(n)?n.replace(sl,af):n}var Lh=st(function(n,r,o){return n+(o?" ":"")+r.toUpperCase()}),_s=Pu("toUpperCase");function Ld(n,r,o){return n=_e(n),r=o?a:r,r===a?Qm(n)?lf(n):xm(n):n.match(r)||[]}var Dd=fe(function(n,r){try{return An(n,a,r)}catch(o){return bs(o)?o:new ge(o)}}),Dh=kr(function(n,r){return Kn(r,function(o){o=Zn(o),dr(n,o,Ts(n[o],n))}),n});function Ph(n){var r=n==null?0:n.length,o=oe();return n=r?Me(n,function(u){if(typeof u[1]!="function")throw new Ln(d);return[o(u[0]),u[1]]}):[],fe(function(u){for(var k=-1;++k<r;){var E=n[k];if(An(E[0],this,u))return An(E[1],this,u)}})}function Fh(n){return iE(Pn(n,y))}function Ns(n){return function(){return n}}function jh(n,r){return n==null||n!==n?r:n}var qh=ju(),Bh=ju(!0);function yn(n){return n}function Ss(n){return gu(typeof n=="function"?n:Pn(n,y))}function Mh(n){return vu(Pn(n,y))}function wh(n,r){return mu(n,Pn(r,y))}var Gh=fe(function(n,r){return function(o){return qt(o,n,r)}}),Vh=fe(function(n,r){return function(o){return qt(n,o,r)}});function Is(n,r,o){var u=Xe(r),k=La(r,u);o==null&&!(Ge(r)&&(k.length||!u.length))&&(o=r,r=n,n=this,k=La(r,Xe(r)));var E=!(Ge(o)&&"chain"in o)||!!o.chain,T=mr(n);return Kn(k,function(h){var _=r[h];n[h]=_,T&&(n.prototype[h]=function(){var M=this.__chain__;if(E||M){var w=n(this.__wrapped__),V=w.__actions__=fn(this.__actions__);return V.push({func:_,args:arguments,thisArg:n}),w.__chain__=M,w}return _.apply(n,Ar([this.value()],arguments))})}),n}function Hh(){return en._===this&&(en._=mf),this}function Os(){}function Uh(n){return n=ve(n),fe(function(r){return fu(r,n)})}var xh=ss(Me),Yh=ss(ql),Ch=ss(Li);function Pd(n){return vs(n)?Di(Zn(n)):AE(n)}function $h(n){return function(r){return n==null?a:wr(n,r)}}var Jh=Bu(),Wh=Bu(!0);function Ks(){return[]}function Ls(){return!1}function zh(){return{}}function Xh(){return""}function Zh(){return!0}function Qh(n,r){if(n=ve(n),n<1||n>G)return[];var o=le,u=an(n,le);r=oe(r),n-=le;for(var k=ji(u,r);++o<n;)r(o);return k}function eb(n){return ke(n)?Me(n,Zn):_n(n)?[n]:fn(Qu(_e(n)))}function nb(n){var r=++kf;return _e(n)+r}var rb=Ba(function(n,r){return n+r},0),tb=os("ceil"),ab=Ba(function(n,r){return n/r},1),ib=os("floor");function sb(n){return n&&n.length?Ka(n,yn,Ci):a}function ob(n,r){return n&&n.length?Ka(n,oe(r,2),Ci):a}function lb(n){return wl(n,yn)}function ub(n,r){return wl(n,oe(r,2))}function db(n){return n&&n.length?Ka(n,yn,zi):a}function gb(n,r){return n&&n.length?Ka(n,oe(r,2),zi):a}var kb=Ba(function(n,r){return n*r},1),vb=os("round"),mb=Ba(function(n,r){return n-r},0);function fb(n){return n&&n.length?Fi(n,yn):0}function Eb(n,r){return n&&n.length?Fi(n,oe(r,2)):0}return m.after=My,m.ary=dd,m.assign=_T,m.assignIn=Rd,m.assignInWith=za,m.assignWith=NT,m.at=ST,m.before=gd,m.bind=Ts,m.bindAll=Dh,m.bindKey=kd,m.castArray=zy,m.chain=od,m.chunk=ip,m.compact=sp,m.concat=op,m.cond=Ph,m.conforms=Fh,m.constant=Ns,m.countBy=fy,m.create=IT,m.curry=vd,m.curryRight=md,m.debounce=fd,m.defaults=OT,m.defaultsDeep=KT,m.defer=wy,m.delay=Gy,m.difference=lp,m.differenceBy=up,m.differenceWith=dp,m.drop=gp,m.dropRight=kp,m.dropRightWhile=vp,m.dropWhile=mp,m.fill=fp,m.filter=py,m.flatMap=hy,m.flatMapDeep=by,m.flatMapDepth=Ay,m.flatten=td,m.flattenDeep=Ep,m.flattenDepth=pp,m.flip=Vy,m.flow=qh,m.flowRight=Bh,m.fromPairs=yp,m.functions=BT,m.functionsIn=MT,m.groupBy=cy,m.initial=hp,m.intersection=bp,m.intersectionBy=Ap,m.intersectionWith=cp,m.invert=GT,m.invertBy=VT,m.invokeMap=_y,m.iteratee=Ss,m.keyBy=Ny,m.keys=Xe,m.keysIn=pn,m.map=xa,m.mapKeys=UT,m.mapValues=xT,m.matches=Mh,m.matchesProperty=wh,m.memoize=Ca,m.merge=YT,m.mergeWith=_d,m.method=Gh,m.methodOf=Vh,m.mixin=Is,m.negate=$a,m.nthArg=Uh,m.omit=CT,m.omitBy=$T,m.once=Hy,m.orderBy=Sy,m.over=xh,m.overArgs=Uy,m.overEvery=Yh,m.overSome=Ch,m.partial=hs,m.partialRight=Ed,m.partition=Iy,m.pick=JT,m.pickBy=Nd,m.property=Pd,m.propertyOf=$h,m.pull=Sp,m.pullAll=id,m.pullAllBy=Ip,m.pullAllWith=Op,m.pullAt=Kp,m.range=Jh,m.rangeRight=Wh,m.rearg=xy,m.reject=Ly,m.remove=Lp,m.rest=Yy,m.reverse=ps,m.sampleSize=Py,m.set=zT,m.setWith=XT,m.shuffle=Fy,m.slice=Dp,m.sortBy=By,m.sortedUniq=wp,m.sortedUniqBy=Gp,m.split=hh,m.spread=Cy,m.tail=Vp,m.take=Hp,m.takeRight=Up,m.takeRightWhile=xp,m.takeWhile=Yp,m.tap=sy,m.throttle=$y,m.thru=Ua,m.toArray=bd,m.toPairs=Sd,m.toPairsIn=Id,m.toPath=eb,m.toPlainObject=cd,m.transform=ZT,m.unary=Jy,m.union=Cp,m.unionBy=$p,m.unionWith=Jp,m.uniq=Wp,m.uniqBy=zp,m.uniqWith=Xp,m.unset=QT,m.unzip=ys,m.unzipWith=sd,m.update=eh,m.updateWith=nh,m.values=ut,m.valuesIn=rh,m.without=Zp,m.words=Ld,m.wrap=Wy,m.xor=Qp,m.xorBy=ey,m.xorWith=ny,m.zip=ry,m.zipObject=ty,m.zipObjectDeep=ay,m.zipWith=iy,m.entries=Sd,m.entriesIn=Id,m.extend=Rd,m.extendWith=za,Is(m,m),m.add=rb,m.attempt=Dd,m.camelCase=sh,m.capitalize=Od,m.ceil=tb,m.clamp=th,m.clone=Xy,m.cloneDeep=Qy,m.cloneDeepWith=eT,m.cloneWith=Zy,m.conformsTo=nT,m.deburr=Kd,m.defaultTo=jh,m.divide=ab,m.endsWith=oh,m.eq=Yn,m.escape=lh,m.escapeRegExp=uh,m.every=Ey,m.find=yy,m.findIndex=nd,m.findKey=LT,m.findLast=Ty,m.findLastIndex=rd,m.findLastKey=DT,m.floor=ib,m.forEach=ld,m.forEachRight=ud,m.forIn=PT,m.forInRight=FT,m.forOwn=jT,m.forOwnRight=qT,m.get=cs,m.gt=rT,m.gte=tT,m.has=wT,m.hasIn=Rs,m.head=ad,m.identity=yn,m.includes=Ry,m.indexOf=Tp,m.inRange=ah,m.invoke=HT,m.isArguments=Hr,m.isArray=ke,m.isArrayBuffer=aT,m.isArrayLike=En,m.isArrayLikeObject=Ye,m.isBoolean=iT,m.isBuffer=Or,m.isDate=sT,m.isElement=oT,m.isEmpty=lT,m.isEqual=uT,m.isEqualWith=dT,m.isError=bs,m.isFinite=gT,m.isFunction=mr,m.isInteger=pd,m.isLength=Ja,m.isMap=yd,m.isMatch=kT,m.isMatchWith=vT,m.isNaN=mT,m.isNative=fT,m.isNil=pT,m.isNull=ET,m.isNumber=Td,m.isObject=Ge,m.isObjectLike=He,m.isPlainObject=Ht,m.isRegExp=As,m.isSafeInteger=yT,m.isSet=hd,m.isString=Wa,m.isSymbol=_n,m.isTypedArray=lt,m.isUndefined=TT,m.isWeakMap=hT,m.isWeakSet=bT,m.join=Rp,m.kebabCase=dh,m.last=jn,m.lastIndexOf=_p,m.lowerCase=gh,m.lowerFirst=kh,m.lt=AT,m.lte=cT,m.max=sb,m.maxBy=ob,m.mean=lb,m.meanBy=ub,m.min=db,m.minBy=gb,m.stubArray=Ks,m.stubFalse=Ls,m.stubObject=zh,m.stubString=Xh,m.stubTrue=Zh,m.multiply=kb,m.nth=Np,m.noConflict=Hh,m.noop=Os,m.now=Ya,m.pad=vh,m.padEnd=mh,m.padStart=fh,m.parseInt=Eh,m.random=ih,m.reduce=Oy,m.reduceRight=Ky,m.repeat=ph,m.replace=yh,m.result=WT,m.round=vb,m.runInContext=R,m.sample=Dy,m.size=jy,m.snakeCase=Th,m.some=qy,m.sortedIndex=Pp,m.sortedIndexBy=Fp,m.sortedIndexOf=jp,m.sortedLastIndex=qp,m.sortedLastIndexBy=Bp,m.sortedLastIndexOf=Mp,m.startCase=bh,m.startsWith=Ah,m.subtract=mb,m.sum=fb,m.sumBy=Eb,m.template=ch,m.times=Qh,m.toFinite=fr,m.toInteger=ve,m.toLength=Ad,m.toLower=Rh,m.toNumber=qn,m.toSafeInteger=RT,m.toString=_e,m.toUpper=_h,m.trim=Nh,m.trimEnd=Sh,m.trimStart=Ih,m.truncate=Oh,m.unescape=Kh,m.uniqueId=nb,m.upperCase=Lh,m.upperFirst=_s,m.each=ld,m.eachRight=ud,m.first=ad,Is(m,function(){var n={};return zn(m,function(r,o){Oe.call(m.prototype,o)||(n[o]=r)}),n}(),{chain:!1}),m.VERSION=t,Kn(["bind","bindKey","curry","curryRight","partial","partialRight"],function(n){m[n].placeholder=m}),Kn(["drop","take"],function(n,r){pe.prototype[n]=function(o){o=o===a?1:ze(ve(o),0);var u=this.__filtered__&&!r?new pe(this):this.clone();return u.__filtered__?u.__takeCount__=an(o,u.__takeCount__):u.__views__.push({size:an(o,le),type:n+(u.__dir__<0?"Right":"")}),u},pe.prototype[n+"Right"]=function(o){return this.reverse()[n](o).reverse()}}),Kn(["filter","map","takeWhile"],function(n,r){var o=r+1,u=o==C||o==Y;pe.prototype[n]=function(k){var E=this.clone();return E.__iteratees__.push({iteratee:oe(k,3),type:o}),E.__filtered__=E.__filtered__||u,E}}),Kn(["head","last"],function(n,r){var o="take"+(r?"Right":"");pe.prototype[n]=function(){return this[o](1).value()[0]}}),Kn(["initial","tail"],function(n,r){var o="drop"+(r?"":"Right");pe.prototype[n]=function(){return this.__filtered__?new pe(this):this[o](1)}}),pe.prototype.compact=function(){return this.filter(yn)},pe.prototype.find=function(n){return this.filter(n).head()},pe.prototype.findLast=function(n){return this.reverse().find(n)},pe.prototype.invokeMap=fe(function(n,r){return typeof n=="function"?new pe(this):this.map(function(o){return qt(o,n,r)})}),pe.prototype.reject=function(n){return this.filter($a(oe(n)))},pe.prototype.slice=function(n,r){n=ve(n);var o=this;return o.__filtered__&&(n>0||r<0)?new pe(o):(n<0?o=o.takeRight(-n):n&&(o=o.drop(n)),r!==a&&(r=ve(r),o=r<0?o.dropRight(-r):o.take(r-n)),o)},pe.prototype.takeRightWhile=function(n){return this.reverse().takeWhile(n).reverse()},pe.prototype.toArray=function(){return this.take(le)},zn(pe.prototype,function(n,r){var o=/^(?:filter|find|map|reject)|While$/.test(r),u=/^(?:head|last)$/.test(r),k=m[u?"take"+(r=="last"?"Right":""):r],E=u||/^find/.test(r);k&&(m.prototype[r]=function(){var T=this.__wrapped__,h=u?[1]:arguments,_=T instanceof pe,M=h[0],w=_||ke(T),V=function(Ee){var ye=k.apply(m,Ar([Ee],h));return u&&X?ye[0]:ye};w&&o&&typeof M=="function"&&M.length!=1&&(_=w=!1);var X=this.__chain__,te=!!this.__actions__.length,ue=E&&!X,me=_&&!te;if(!E&&w){T=me?T:new pe(this);var de=n.apply(T,h);return de.__actions__.push({func:Ua,args:[V],thisArg:a}),new Dn(de,X)}return ue&&me?n.apply(this,h):(de=this.thru(V),ue?u?de.value()[0]:de.value():de)})}),Kn(["pop","push","shift","sort","splice","unshift"],function(n){var r=fa[n],o=/^(?:push|sort|unshift)$/.test(n)?"tap":"thru",u=/^(?:pop|shift)$/.test(n);m.prototype[n]=function(){var k=arguments;if(u&&!this.__chain__){var E=this.value();return r.apply(ke(E)?E:[],k)}return this[o](function(T){return r.apply(ke(T)?T:[],k)})}}),zn(pe.prototype,function(n,r){var o=m[r];if(o){var u=o.name+"";Oe.call(tt,u)||(tt[u]=[]),tt[u].push({name:r,func:o})}}),tt[qa(a,D).name]=[{name:"wrapper",func:a}],pe.prototype.clone=Kf,pe.prototype.reverse=Lf,pe.prototype.value=Df,m.prototype.at=oy,m.prototype.chain=ly,m.prototype.commit=uy,m.prototype.next=dy,m.prototype.plant=ky,m.prototype.reverse=vy,m.prototype.toJSON=m.prototype.valueOf=m.prototype.value=my,m.prototype.first=m.prototype.head,Ot&&(m.prototype[Ot]=gy),m},et=uf();Fr?((Fr.exports=et)._=et,Si._=et):en._=et}).call(ES)}(Wt,Wt.exports)),Wt.exports}pS();vn(aa);const Co=F.forwardRef((e,i)=>q.jsx(gt,{gap:"2",style:{display:"flex"},...e,ref:i}));Co.displayName="FaktaGruppe";Co.__docgenInfo={description:"",methods:[],displayName:"FaktaGruppe"};Co.__docgenInfo={description:"",methods:[],displayName:"FaktaGruppe"};var Vs={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/var Ig;function yS(){return Ig||(Ig=1,function(e){(function(){var i={}.hasOwnProperty;function a(){for(var l="",d=0;d<arguments.length;d++){var g=arguments[d];g&&(l=s(l,t.call(this,g)))}return l}function t(l){if(typeof l=="string"||typeof l=="number")return this&&this[l]||l;if(typeof l!="object")return"";if(Array.isArray(l))return a.apply(this,l);if(l.toString!==Object.prototype.toString&&!l.toString.toString().includes("[native code]"))return l.toString();var d="";for(var g in l)i.call(l,g)&&l[g]&&(d=s(d,this&&this[g]||g));return d}function s(l,d){return d?l?l+" "+d:l+d:l}e.exports?(a.default=a,e.exports=a):window.classNames=a})()}(Vs)),Vs.exports}var TS=yS();const hS=pb(TS),bS="_boks_c3bfh_1",AS="_harBorderLeft_c3bfh_8",cS="_harBorderTop_c3bfh_12",RS={boks:bS,harBorderLeft:AS,harBorderTop:cS};hS.bind(RS);var Hs={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
...
}`,...(ik=(ak=Tr.parameters)==null?void 0:ak.docs)==null?void 0:ik.source}}};var sk,ok,lk;Kr.parameters={...Kr.parameters,docs:{...(sk=Kr.parameters)==null?void 0:sk.docs,source:{originalSource:`{
  args: {
    ...InntektsmeldingDefault.args,
    inntektsmeldinger: []
  }
}`,...(lk=(ok=Kr.parameters)==null?void 0:ok.docs)==null?void 0:lk.source}}};var uk,dk,gk;Tr.parameters={...Tr.parameters,docs:{...(uk=Tr.parameters)==null?void 0:uk.docs,source:{originalSource:`{
  args: {
    alleKodeverk: alleKodeverk as any,
    fagsak: {
      saksnummer: '123',
...
}`,...(mk=(vk=Kr.parameters)==null?void 0:vk.docs)==null?void 0:mk.source}}};const $K=["InntektsmeldingDefault","IngenInntektsmeldinger"];export{Kr as IngenInntektsmeldinger,Tr as InntektsmeldingDefault,$K as __namedExportsOrder,CK as default};
