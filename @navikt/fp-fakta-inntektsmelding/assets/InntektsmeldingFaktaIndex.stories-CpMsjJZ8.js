...
Readonly<{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<VilkarType, KodeverkMedNavn[]>",required:!0}}]}}]},description:""}}};const Kb="Dato må være før eller lik {limit}",Db="Dato må være etter eller lik {limit}",Pb="Perioder kan ikke overlappe i tid",Fb="Perioder kan ikke overlappe i tid (uttak, utsettelse, gradering, overforing, opphold)",Mb="Dato må være lik {value}",jb="Dato må skrives slik: dd.mm.åååå",Gb="Periode må skrives slik: dd.mm.åååå - dd.mm.åååå",Bb="Tallet kan ikke inneholde mer enn to desimaler",Vb="Tallet kan ikke ha desimaler",wb="Feltet kan kun inneholde tall",Hb="Ugyldig fødselsnummer",Ub="Feltet må være et fødselsnummer (11 siffer)",qb="Ugyldig organisasjonsnummer.",xb="Ugyldig organisasjonsnummer eller fødselsnummer",Yb="Startdato må være før eller lik sluttdato",Cb="Periode er utenfor opptjeningsperioden",$b="Ugyldig saksnummer eller fødselsnummer",Jb="Feltet inneholder ugyldige tegn: {text}",Wb="Feltet inneholder en ugyldig verdi: {value}",zb="Feltet kan ikke inneholde mellomrom",Zb="Feltet må fylles ut",Xb="Du kan skrive maksimalt {length} tegn",Qb="Du må skrive minst {length} tegn",eN="Du kan skrive maksimalt {length} tegn eller et fødselsnummer (11 siffer)",nN="Feltet må være mindre eller lik {length}",rN="Feltet må være større eller lik {length}",tN="Fødselsnummer til den andre forelderen kan ikke være det samme som søker",aN={DateNotBeforeOrEqual:Kb,DateNotAfterOrEqual:Db,DateRangesOverlapping:Pb,DateRangesOverlappingPeriodTypes:Fb,DatesNotEqual:Mb,InvalidDate:jb,InvalidDatesInPeriod:Gb,InvalidDecimal:Bb,InvalidInteger:Vb,InvalidNumber:wb,InvalidFodselsnr:Hb,InvalidFodselsnrFormat:Ub,InvalidOrgnr:qb,InvalidOrgnrOrFodselsnr:xb,InvalidPeriod:Yb,InvalidPeriodRange:Cb,InvalidSaksnrOrFodselsnrFormat:$b,InvalidText:Jb,InvalidValue:Wb,IllegalWhiteSpace:zb,IsRequired:Zb,MaxLength:Xb,MinLength:Qb,MaxLengthOrFodselsnr:eN,MaxValue:nN,MinValue:rN,SammeFodselsnrSomSoker:tN};mn(aN);var kk=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function vk(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ek={exports:{}};(function(e,i){(function(t,a){e.exports=a()})(kk,function(){return function(t,a){a.prototype.isSameOrAfter=function(s,l){return this.isSame(s,l)||this.isAfter(s,l)}}})})(Ek);var iN=Ek.exports;const sN=vk(iN);var fk={exports:{}};(function(e,i){(function(t,a){e.exports=a()})(kk,function(){return function(t,a){a.prototype.isSameOrBefore=function(s,l){return this.isSame(s,l)||this.isBefore(s,l)}}})})(fk);var oN=fk.exports;const lN=vk(oN);Nr.extend(sN);Nr.extend(lN);var uN=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function dN(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ht={};/**
 * @license React
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
