import{r,j as _}from"./iframe-D_b5tSRA.js";import{c as T}from"./index.es-fMmada3k.js";import{A}from"./index-Bg4Mzsp1.js";import{S}from"./SettPaVentModalIndex-B2V28n7H.js";import{e as I}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as L}from"./behandlingApi-DSvcTBW7.js";const D=({behandling:e,kodeverk:E,opneSokeside:t,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=r.useState(!a&&e.behandlingPåVent),m=()=>n(!1),v=L(e),{mutate:N}=T({mutationFn:l=>v.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>t()});r.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const R=e.aksjonspunkt.filter(I).some(l=>l.definisjon===A.AUTO_MANUELT_SATT_PÅ_VENT);return _.jsx(S,{submitCallback:N,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:R,ventearsaker:E.Venteårsak,erTilbakekreving:i,showModal:u})};D.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"union",raw:"BehandlingFpSak | BehandlingFpTilbake",elements:[{name:"signature",type:"object",raw:`{
