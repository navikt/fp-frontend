import{r,j as E}from"./iframe-BcF5WgZP.js";import{c as o}from"./index.es-Cn9xryLu.js";import{e as T,A as g}from"./index-Dgppw5sE.js";import{S as y}from"./SettPaVentModalIndex-yfmd68Wo.js";import{u as p}from"./behandlingApi-Dt41MPWK.js";const _=({behandling:e,kodeverk:t,opneSokeside:i,erTilbakekreving:u=!1,skalIkkeViseModal:a=!1})=>{const[s,l]=r.useState(!a&&e.behandlingPåVent),v=()=>l(!1),m=p(e),{mutate:k}=o({mutationFn:n=>m.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>i()});r.useEffect(()=>{a||l(e.behandlingPåVent)},[e.versjon,a]);const d=e.aksjonspunkt.filter(T).some(n=>n.definisjon===g.AUTO_MANUELT_SATT_PÅ_VENT);return E.jsx(y,{submitCallback:k,cancelEvent:v,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:d,ventearsaker:t.Venteårsak,erTilbakekreving:u,showModal:s})};_.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id?: number;
  uuid: string;
  versjon: number;
