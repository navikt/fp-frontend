import{r as v,l as A,j as s,bB as D,bC as L,bb as O}from"./iframe-Cy7YGFMJ.js";import{Q as P}from"./index.es-BPXwr0EW.js";import{u as y}from"./fagsakApi-Db5PW8qW.js";import{V}from"./BehandlingMenuIndex-C0E2fQqk.js";import{A as G}from"./index-BX0ezW6_.js";import{u as F,c as b}from"./behandlingApi-C6_M3zH4.js";import{B as T}from"./FagsakIndex-CGpp5rvg.js";import{Y as M}from"./index.es-C_sAl0p2.js";import{H as B}from"./VStack-DI9-fY4c.js";import{S as f}from"./ExclamationmarkTriangleFill-BPXgiFnR.js";import{e as R}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-DZ3lk-mf.js";const j=n=>{const[r,e]=v.useState([]),t=l=>{e(i=>{const a=[...i],E=a.findIndex(u=>u.id===l.id);return E>=0?a.splice(E,1,l):a.push(l),a}),n?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",H="_sideMenu_4o186_19",d={container:w,content:h,sideMenu:H},c=({valgtFaktaSteg:n,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=A(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=v.use(T),{faktaPanelMenyData:a,settFaktaPanelMenyData:E}=j(e),u=a.length>0;return s.jsxs(B,{className:d.container,wrap:!1,children:[u&&s.jsx("div",{className:d.sideMenu,"data-testid":"fakta-meny",children:s.jsx(M,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(m=>({label:m.tekst,active:m.erAktiv,icon:m.harÅpentAksjonspunkt?s.jsx(f,{color:"var(--ax-warning-700)"}):void 0})),onClick:m=>{i(r,a[m].id)}})}),s.jsx("div",{className:d.content,children:s.jsx(J,{valgtFaktaSteg:n,settFaktaPanelMenyData:E,faktaPanelMenyData:a,children:t})})]})},k=v.createContext({}),J=n=>{const{children:r,...e}=n,t=v.useMemo(()=>e,[e]);return s.jsx(k.Provider,{value:t,children:r})};c.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",C=(n,r,e,t)=>{const{valgtFaktaSteg:l,settFaktaPanelMenyData:i}=v.use(k),a=e&&(l===n||t&&l===Y);return v.useEffect(()=>{i({id:n,tekst:r,erAktiv:a,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,a,t]),e&&a},S=({standardPanelProps:n,skalPanelVisesIMeny:r,faktaPanelKode:e,faktaPanelMenyTekst:t,children:l})=>{const{behandling:i,fagsak:a,alleKodeverk:E}=v.use(T),u=C(e,t,r,n.harÅpentAksjonspunkt);return s.jsx(D,{behandling:i,children:u?s.jsx(L,{behandling:i,fagsak:a,alleKodeverk:E,aksjonspunkterForPanel:n.aksjonspunkterForPanel,harÅpentAksjonspunkt:n.harÅpentAksjonspunkt,submitCallback:n.submitCallback,isReadOnly:n.isReadOnly,alleMerknaderFraBeslutter:n.alleMerknaderFraBeslutter,isSubmittable:n.isSubmittable,children:l}):null})};S.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const N="default",g="default",x=(n=[],r=[])=>{const{behandling:e,rettigheter:t,fagsak:l,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:a,oppdaterProsessStegOgFaktaPanelIUrl:E,alleKodeverk:u}=v.use(T),{aksjonspunkt:m}=e,o=m.filter(_=>n.includes(_.definisjon)),K=q(e,[],t,!1),p=U(e.status,o),I=Z(l,e,E,i,a,r);return{behandling:e,isSubmittable:!o.some(R)||o.some(_=>_.kanLoses),harÅpentAksjonspunkt:o.some(_=>R(_)&&_.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:o,isReadOnly:K,alleMerknaderFraBeslutter:p,submitCallback:I}},Z=(n,r,e,t,l,i)=>a=>{const u=(Array.isArray(a)?a:[a]).map(o=>({"@type":o.kode,...o})),m={saksnummer:n.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return l({...m,overstyrteAksjonspunktDtoer:u}).then(()=>{e(g,N),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...m,bekreftedeAksjonspunktDtoer:u}).then(()=>{e(g,N),globalThis.scrollTo({top:0,behavior:"smooth"})})},W=[G.AVKLAR_VERGE],X=()=>{const n=A(),r=x(W),{behandling:e}=v.use(T),t=F(e),l=b(e,"VERGE"),{data:i,isFetching:a}=y(t.vergeOptions(e,l));return s.jsx(S,{standardPanelProps:r,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:a?s.jsx(P,{}):s.jsx(V,{verge:i,alleKodeverk:r.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{S as F,X as V,c as a,x as u};
