import{j as e,l as g,P as v,b as p,L as y}from"./iframe-B0rs5mSc.js";import{Q as f}from"./index.es-CnwXS7-r.js";import{u as q,l as _}from"./fagsakApi-DNzcm8DU.js";import{V as c}from"./VisittkortSakIndex-CVo1v5jv.js";import{V as j,a as N,B as A}from"./VStack-D6SAjkvB.js";import{M as o}from"./message-53Aw4P6w.js";import{E as w}from"./IngenBehandlingValgtPanel-CbnuVFFb.js";import{u as R}from"./useTrackRouteParam-CUlP9iNG.js";import{p as E}from"./paths-BymUWMa5.js";import{u as d}from"./useKodeverk-DUqnEMjI.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
