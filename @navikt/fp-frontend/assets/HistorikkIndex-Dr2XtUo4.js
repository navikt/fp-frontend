...
| 'FAKTA_OM_UTTAK_DOKUMENTASJON'
| 'FAKTA_UTTAK'
| 'FAKTA_UTTAK_EØS'`,elements:[{name:"literal",value:"'ANKE_MERKNADER'"},{name:"literal",value:"'ANKE_VURDERING'"},{name:"literal",value:"'BEREGNING_ENGANGSSTOENAD'"},{name:"literal",value:"'BEREGNING_FORELDREPENGER'"},{name:"literal",value:"'BESTEBEREGNING'"},{name:"literal",value:"'FAKTA_FOR_OMSORG'"},{name:"literal",value:"'FAKTA_FOR_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_ADOPSJON'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON'"},{name:"literal",value:"'FAKTA_OM_BEREGNING'"},{name:"literal",value:"'FAKTA_OM_FOEDSEL'"},{name:"literal",value:"'FAKTA_OM_OMSORGSOVERTAKELSE'"},{name:"literal",value:"'FAKTA_OM_FORDELING'"},{name:"literal",value:"'FAKTA_OM_MEDLEMSKAP'"},{name:"literal",value:"'FAKTA_OM_OMSORG_OG_FORELDREANSVAR'"},{name:"literal",value:"'FAKTA_OM_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_SIMULERING'"},{name:"literal",value:"'FAKTA_OM_UTTAK'"},{name:"literal",value:"'FAKTA_OM_AKTIVITETSKRAV'"},{name:"literal",value:"'FAKTA_OMSORG_OG_RETT'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'FORMKRAV_KLAGE_KA'"},{name:"literal",value:"'FORMKRAV_KLAGE_NFP'"},{name:"literal",value:"'KLAGE_BEH_NFP'"},{name:"literal",value:"'KLAGE_BEH_NK'"},{name:"literal",value:"'KONTROLL_AV_SAKSOPPLYSNINGER'"},{name:"literal",value:"'OPPLYSNINGSPLIKT'"},{name:"literal",value:"'PUNKT_FOR_ADOPSJON'"},{name:"literal",value:"'PUNKT_FOR_FOEDSEL'"},{name:"literal",value:"'PUNKT_FOR_FORELDREANSVAR'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP_LØPENDE'"},{name:"literal",value:"'PUNKT_FOR_OMSORG'"},{name:"literal",value:"'PUNKT_FOR_OPPTJENING'"},{name:"literal",value:"'PUNKT_FOR_SVANGERSKAPSPENGER'"},{name:"literal",value:"'PUNKT_FOR_SVP_INNGANG'"},{name:"literal",value:"'SOEKNADSFRIST'"},{name:"literal",value:"'TILKJENT_YTELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'UTLAND'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'VURDER_FARESIGNALER'"},{name:"literal",value:"'FAKTA_OM_UTTAK_DOKUMENTASJON'"},{name:"literal",value:"'FAKTA_UTTAK'"},{name:"literal",value:"'FAKTA_UTTAK_EØS'"}]},name:"skjermlenkeKode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const me={ARBEIDSGIVER:"info-moderate",BESL:"success-moderate",VL:"neutral-moderate",SBH:"meta-purple-moderate",SOKER:"warning-moderate","-":"info-moderate"},H=({behandlingLocation:e,createLocationForSkjermlenke:E,alleKodeverk:l,historikkInnslag:{aktør:a,opprettetTidspunkt:n,tittel:t,linjer:N,dokumenter:u,skjermlenke:A},saksnummer:v})=>{const m=P(),L=`${l.HistorikkAktør.find(_=>_.kode===a.type)?.navn??""} ${a.ident??""}`,D=q(n,{separator:"kl",month:"long",day:"numeric"}),G=N.length>3,[S,F]=R.useState(G),T=N.slice(0,S?3:N.length);return r.jsxs(K,{"data-testid":"historikkinnslag",wrap:!1,gap:"space-20",justify:"end",align:"center",children:[r.jsx(s.New,{padding:"4",background:me[a.type],children:r.jsxs(U,{gap:"space-8",children:[r.jsxs(K,{gap:"space-8",children:[r.jsx(o,{weight:"semibold",children:L}),r.jsx(o,{children:D})]}),t&&r.jsx(V,{size:"medium",children:t}),A&&r.jsx(p,{skjermlenke:A,behandlingLocation:e,alleKodeverk:l,createLocationForSkjermlenke:E}),N.length>0&&r.jsxs("div",{children:[T.map((_,k)=>_.type==="TEKST"?r.jsx(C,{size:"medium",children:ue(_.tekst??"")},`${_.tekst}-${k}`):r.jsx("br",{},`${_.type}-${k}`)),G&&r.jsx(x,{variant:"tertiary",size:"small",onClick:()=>F(!S),children:S?m.formatMessage({id:"Historikkinnslag.VisMer"}):m.formatMessage({id:"Historikkinnslag.VisMindre"})})]}),u&&r.jsx("div",{children:u.map(_=>r.jsx(y,{dokumentLenke:_,saksnummer:v},`${_.journalpostId}.${_.dokumentId}`))})]})}),r.jsx(s.New,{children:r.jsx(g,{aktørType:a.type})})]})};H.__docgenInfo={description:"",methods:[],displayName:"HistorikkInnslag",props:{behandlingLocation:{required:!1,tsType:{name:"Location"},description:""},createLocationForSkjermlenke:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  behandlingLocation: Location,
...
| 'FAKTA_OM_UTTAK_DOKUMENTASJON'
| 'FAKTA_UTTAK'
| 'FAKTA_UTTAK_EØS'`,elements:[{name:"literal",value:"'ANKE_MERKNADER'"},{name:"literal",value:"'ANKE_VURDERING'"},{name:"literal",value:"'BEREGNING_ENGANGSSTOENAD'"},{name:"literal",value:"'BEREGNING_FORELDREPENGER'"},{name:"literal",value:"'BESTEBEREGNING'"},{name:"literal",value:"'FAKTA_FOR_OMSORG'"},{name:"literal",value:"'FAKTA_FOR_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_ADOPSJON'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_INNTEKTSMELDING'"},{name:"literal",value:"'FAKTA_OM_ARBEIDSFORHOLD_PERMISJON'"},{name:"literal",value:"'FAKTA_OM_BEREGNING'"},{name:"literal",value:"'FAKTA_OM_FOEDSEL'"},{name:"literal",value:"'FAKTA_OM_OMSORGSOVERTAKELSE'"},{name:"literal",value:"'FAKTA_OM_FORDELING'"},{name:"literal",value:"'FAKTA_OM_MEDLEMSKAP'"},{name:"literal",value:"'FAKTA_OM_OMSORG_OG_FORELDREANSVAR'"},{name:"literal",value:"'FAKTA_OM_OPPTJENING'"},{name:"literal",value:"'FAKTA_OM_SIMULERING'"},{name:"literal",value:"'FAKTA_OM_UTTAK'"},{name:"literal",value:"'FAKTA_OM_AKTIVITETSKRAV'"},{name:"literal",value:"'FAKTA_OMSORG_OG_RETT'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'FORMKRAV_KLAGE_KA'"},{name:"literal",value:"'FORMKRAV_KLAGE_NFP'"},{name:"literal",value:"'KLAGE_BEH_NFP'"},{name:"literal",value:"'KLAGE_BEH_NK'"},{name:"literal",value:"'KONTROLL_AV_SAKSOPPLYSNINGER'"},{name:"literal",value:"'OPPLYSNINGSPLIKT'"},{name:"literal",value:"'PUNKT_FOR_ADOPSJON'"},{name:"literal",value:"'PUNKT_FOR_FOEDSEL'"},{name:"literal",value:"'PUNKT_FOR_FORELDREANSVAR'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP'"},{name:"literal",value:"'PUNKT_FOR_MEDLEMSKAP_LØPENDE'"},{name:"literal",value:"'PUNKT_FOR_OMSORG'"},{name:"literal",value:"'PUNKT_FOR_OPPTJENING'"},{name:"literal",value:"'PUNKT_FOR_SVANGERSKAPSPENGER'"},{name:"literal",value:"'PUNKT_FOR_SVP_INNGANG'"},{name:"literal",value:"'SOEKNADSFRIST'"},{name:"literal",value:"'TILKJENT_YTELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'UTLAND'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'VURDER_FARESIGNALER'"},{name:"literal",value:"'FAKTA_OM_UTTAK_DOKUMENTASJON'"},{name:"literal",value:"'FAKTA_UTTAK'"},{name:"literal",value:"'FAKTA_UTTAK_EØS'"}]},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""},utvidEllerMinskBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};const Ke={"History.FiltrerPaBehandling":"Filtrer på behandling","History.Historikk":"Historikk","BubbleText.LukkeTekstfelt":"Lukke tekstfelt","BubbleText.ApneTekstfelt":"Åpne tekstfelt","BehandlingSupportIndex.Utvid":"Utvid","BehandlingSupportIndex.Minsk":"Minsk","Historikkinnslag.Soker":"Søker","Historikkinnslag.Saksbehandler":"Saksbehandler","Historikkinnslag.Beslutter":"Beslutter","Historikkinnslag.Vedtakslosninger":"Vedtaksløsningen","Historikkinnslag.Arbeidsgiver":"Arbeidsgiver","Historikkinnslag.VisMer":"Vis mer...","Historikkinnslag.VisMindre":"Vis mindre"},Ie=h(Ke),J=({historikkFpSak:e=[],historikkFpTilbake:E=[],alleKodeverkFpTilbake:l,alleKodeverkFpSak:a,saksnummer:n,getBehandlingLocation:t,createLocationForSkjermlenke:N,valgtBehandlingUuid:u,utvidEllerMinskBehandlingDetaljerKnapp:A})=>r.jsx(c,{value:Ie,children:r.jsx(w,{valgtBehandlingUuid:u,historikkFpSak:e,historikkFpTilbake:E,alleKodeverkFpTilbake:l,alleKodeverkFpSak:a,saksnummer:n,getBehandlingLocation:t,createLocationForSkjermlenke:N,utvidEllerMinskBehandlingDetaljerKnapp:A})});J.__docgenInfo={description:"",methods:[],displayName:"HistorikkSakIndex",props:{historikkFpSak:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aktør: tjenester_behandling_historikk_HistorikkinnslagDto_HistorikkAktørDto;
  behandlingUuid?: string;
  dokumenter?: Array<tjenester_behandling_historikk_HistorikkInnslagDokumentLinkDto>;
  linjer: Array<tjenester_behandling_historikk_HistorikkinnslagDto_Linje>;
