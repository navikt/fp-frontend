import{r as o,l as k,j as s,bB as D,bC as L,bb as y}from"./iframe-rD8zg52_.js";import{Z as O}from"./index.es-DlEriay5.js";import{u as P}from"./fagsakApi-Bx8RfCZF.js";import{V}from"./BehandlingMenuIndex-UNTF233_.js";import{A as G}from"./index-CmjXpMKr.js";import{u as F,c as b}from"./behandlingApi-ByTyxyTV.js";import{B as d}from"./FagsakIndex-C6NGg6p5.js";import{G as f}from"./index.es-BkZ71gcI.js";import{H as B}from"./VStack-5bHGVEH1.js";import{S as M}from"./ExclamationmarkTriangleFill-UakbUfU7.js";import{e as g}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-wez0zu6n.js";const j=a=>{const[r,e]=o.useState([]),t=l=>{e(i=>{const n=[...i],E=n.findIndex(u=>u.id===l.id);return E>=0?n.splice(E,1,l):n.push(l),n}),a?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",c="_sideMenu_4o186_19",T={container:w,content:h,sideMenu:c},H=({valgtFaktaSteg:a,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=k(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=o.use(d),{faktaPanelMenyData:n,settFaktaPanelMenyData:E}=j(e),u=n.length>0;return s.jsxs(B,{className:T.container,wrap:!1,children:[u&&s.jsx("div",{className:T.sideMenu,"data-testid":"fakta-meny",children:s.jsx(f,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(m=>({label:m.tekst,active:m.erAktiv,icon:m.harÅpentAksjonspunkt?s.jsx(M,{color:"var(--ax-warning-700)"}):void 0})),onClick:m=>{i(r,n[m].id)}})}),s.jsx("div",{className:T.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:E,faktaPanelMenyData:n,children:t})})]})},A=o.createContext({}),J=a=>{const{children:r,...e}=a,t=o.useMemo(()=>e,[e]);return s.jsx(A.Provider,{value:t,children:r})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
