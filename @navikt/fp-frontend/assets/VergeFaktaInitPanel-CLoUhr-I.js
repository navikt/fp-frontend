import{r as d,l as A,j as s,bF as S,bG as I,bf as D}from"./iframe-B4ZFYPfq.js";import{Q as L}from"./index.es-BNyvTOyR.js";import{u as V}from"./fagsakApi-BD5C8DgZ.js";import{V as O}from"./BehandlingMenuIndex-YUiF-rBL.js";import{e as p,A as f}from"./index-Ietk-X9T.js";import{u as q,c as P}from"./behandlingApi-PQZgo1vt.js";import{B as v}from"./FagsakIndex-B2LFUOpc.js";import{Y as F}from"./index.es-DBDFK4Gr.js";import{H as G}from"./VStack-C4tHG1Qj.js";import{S as j}from"./ExclamationmarkTriangleFill-CvsKjZjw.js";import{e as w,g as B}from"./useStandardProsessPanelProps-BFP1GD3Z.js";const h=a=>{const[l,e]=d.useState([]),t=n=>{e(i=>{const r=[...i],m=r.findIndex(u=>u.id===n.id);return m>=0?r.splice(m,1,n):r.push(n),r}),a?.(n.harÅpentAksjonspunkt?{urlCode:n.id,text:n.tekst}:void 0)};return{faktaPanelMenyData:l.filter(n=>n.skalVisesIMeny),settFaktaPanelMenyData:t}},M="_container_4o186_1",c="_content_4o186_6",U="_sideMenu_4o186_19",E={container:M,content:c,sideMenu:U},H=({valgtFaktaSteg:a,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const n=A(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(v),{faktaPanelMenyData:r,settFaktaPanelMenyData:m}=h(e),u=r.length>0;return s.jsxs(G,{className:E.container,wrap:!1,children:[u&&s.jsx("div",{className:E.sideMenu,"data-testid":"fakta-meny",children:s.jsx(F,{heading:n.formatMessage({id:"FaktaMeny.FaktaOm"}),links:r.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harÅpentAksjonspunkt?s.jsx(j,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(l,r[o].id)}})}),s.jsx("div",{className:E.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:r,children:t})})]})},R=d.createContext({}),J=a=>{const{children:l,...e}=a,t=d.useMemo(()=>e,[e]);return s.jsx(R.Provider,{value:t,children:l})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",x=(a,l,e,t)=>{const{valgtFaktaSteg:n,settFaktaPanelMenyData:i}=d.use(R),r=e&&(n===a||t&&n===Y);return d.useEffect(()=>{i({id:a,tekst:l,erAktiv:r,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,r,t]),e&&r},y=({standardPanelProps:a,skalPanelVisesIMeny:l,faktaPanelKode:e,faktaPanelMenyTekst:t,children:n})=>{const{behandling:i,fagsak:r,alleKodeverk:m}=d.use(v),u=x(e,t,l,a.harÅpentAksjonspunkt);return s.jsx(S,{behandling:i,children:u?s.jsx(I,{behandling:i,fagsak:r,alleKodeverk:m,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpentAksjonspunkt:a.harÅpentAksjonspunkt,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,isSubmittable:a.isSubmittable,children:n}):null})};y.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
>`,elements:[{name:"signature",type:"object",raw:`{
  ...
  begrunnelse: string | null;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"uttakPeriodeType",value:{name:"union",raw:"foreldrepenger_behandlingslager_behandling_ytelsefordeling_periode_UttakPeriodeType | null",elements:[{name:"union",raw:`| 'FELLESPERIODE'
| 'MØDREKVOTE'
| 'FEDREKVOTE'
| 'FORELDREPENGER'
| 'FORELDREPENGER_FØR_FØDSEL'
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}},{key:"utsettelseÅrsak",value:{name:"union",raw:"foreldrepenger_behandlingslager_behandling_ytelsefordeling_årsak_UtsettelseÅrsak | null",elements:[{name:"union",raw:`| 'ARBEID'
| 'LOVBESTEMT_FERIE'
| 'SYKDOM'
...
| 'SELVSTENDIG_NÆRINGSDRIVENDE'
| 'FRILANS'
| 'ANNET'`,elements:[{name:"literal",value:"'ORDINÆRT_ARBEID'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'ANNET'"}],required:!0}}]}},{name:"null"}],required:!1}},{key:"samtidigUttaksprosent",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!0}},{key:"flerbarnsdager",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"morsAktivitet",value:{name:"union",raw:"foreldrepenger_behandlingslager_behandling_ytelsefordeling_MorsAktivitet | null",elements:[{name:"union",raw:`| '-'
| 'ARBEID'
| 'UTDANNING'
| 'KVALPROG'
| 'INTROPROG'
...
| 'ARBEID_OG_UTDANNING'
| 'UFØRE'
| 'IKKE_OPPGITT'`,elements:[{name:"literal",value:"'-'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'KVALPROG'"},{name:"literal",value:"'INTROPROG'"},{name:"literal",value:"'TRENGER_HJELP'"},{name:"literal",value:"'INNLAGT'"},{name:"literal",value:"'ARBEID_OG_UTDANNING'"},{name:"literal",value:"'UFØRE'"},{name:"literal",value:"'IKKE_OPPGITT'"}]},{name:"null"}],required:!0}},{key:"periodeKilde",value:{name:"union",raw:`| 'SØKNAD'
| 'TIDLIGERE_VEDTAK'
| 'ANDRE_NAV_VEDTAK'
| 'SAKSBEHANDLER'`,elements:[{name:"literal",value:"'SØKNAD'"},{name:"literal",value:"'TIDLIGERE_VEDTAK'"},{name:"literal",value:"'ANDRE_NAV_VEDTAK'"},{name:"literal",value:"'SAKSBEHANDLER'"}],required:!0}},{key:"begrunnelse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}}],raw:"KontrollerFaktaPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]},{name:"intersection",raw:`{
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpentAksjonspunkt: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const T="default",_="default",C=(a=[],l=[])=>{const{behandling:e,rettigheter:t,fagsak:n,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:r,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=d.use(v),{aksjonspunkt:o}=e,g=o.filter(k=>a.includes(k.definisjon)),N=w(e,[],t,!1),b=B(e.status,g),K=Q(n,e,m,i,r,l);return{behandling:e,isSubmittable:!g.some(p)||g.some(k=>k.kanLoses),harÅpentAksjonspunkt:g.some(k=>p(k)&&k.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:g,isReadOnly:N,alleMerknaderFraBeslutter:b,submitCallback:K}},Q=(a,l,e,t,n,i)=>r=>{const u=(Array.isArray(r)?r:[r]).map(g=>({"@type":g.kode,...g})),o={saksnummer:a.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(u&&n&&i){if(u.length===0)throw Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return n({...o,overstyrteAksjonspunktDtoer:u}).then(()=>e(_,T))}return t({...o,bekreftedeAksjonspunktDtoer:u}).then(()=>e(_,T))},z=[f.AVKLAR_VERGE],W=()=>{const a=A(),l=C(z),{behandling:e}=d.use(v),t=q(e),n=P(e,"VERGE"),{data:i,isFetching:r}=V(t.vergeOptions(e,n));return s.jsx(y,{standardPanelProps:l,faktaPanelKode:D.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:n,children:r?s.jsx(L,{}):s.jsx(O,{verge:i,alleKodeverk:l.alleKodeverk})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{y as F,W as V,H as a,C as u};
