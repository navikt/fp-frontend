...
| 'FODSL'
| 'TERM'
| '-'`,elements:[{name:"literal",value:"'ADPSJN'"},{name:"literal",value:"'OMSRGO'"},{name:"literal",value:"'FODSL'"},{name:"literal",value:"'TERM'"},{name:"literal",value:"'-'"}],required:!0}}]}},description:""}}};const N=({familiehendelse:n})=>{const{hendelseType:t,hendelseDato:a,antallBarn:r}=n,s=t==="ADPSJN",l=r===1?"VisittkortBarnInfoOmsorgPanel.Foreldreansvar":"VisittkortBarnInfoOmsorgPanel.ForeldreansvarAntallBarn",d=r===1?"VisittkortBarnInfoOmsorgPanel.Adopsjon":"VisittkortBarnInfoOmsorgPanel.AdopsjonAntallBarn";return e.jsx(F,{children:e.jsx(i,{id:s?d:l,values:{antall:r,dato:a?v(a):"-"}})})};N.__docgenInfo={description:"",methods:[],displayName:"VisittkortBarnInfoOmsorgPanel",props:{familiehendelse:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  antallBarn: number;
  dødfødsel: boolean;
  hendelseDato?: string;
  hendelseType: foreldrepenger_behandlingslager_behandling_familiehendelse_FamilieHendelseType;
...
| 'FODSL'
| 'TERM'
| '-'`,elements:[{name:"literal",value:"'ADPSJN'"},{name:"literal",value:"'OMSRGO'"},{name:"literal",value:"'FODSL'"},{name:"literal",value:"'TERM'"},{name:"literal",value:"'-'"}],required:!0}}]}},description:""}}};const I=({familiehendelse:n})=>{const t=p(),a=e.jsx(E,{title:t.formatMessage({id:"VisittkortBarnInfoPanel.Barnevogn"}),height:24,width:24,color:"white",style:{backgroundColor:"var(--ax-neutral-500)",borderRadius:"50%",padding:"2px"}}),r=n.hendelseType==="FODSL"||n.hendelseType==="TERM";return e.jsxs(O,{icon:a,children:[r&&e.jsx(B,{familiehendelse:n}),!r&&e.jsx(N,{familiehendelse:n})]})};I.__docgenInfo={description:"",methods:[],displayName:"VisittkortBarnInfoPanel",props:{familiehendelse:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  antallBarn: number;
  dødfødsel: boolean;
  hendelseDato?: string;
  hendelseType: foreldrepenger_behandlingslager_behandling_familiehendelse_FamilieHendelseType;
...
}`,signature:{properties:[{key:"aktørId",value:{name:"string",required:!1}},{key:"diskresjonskode",value:{name:"string",required:!1}},{key:"dodsdato",value:{name:"string",required:!1}},{key:"dødsdato",value:{name:"string",required:!1}},{key:"fødselsdato",value:{name:"string",required:!0}},{key:"fødselsnummer",value:{name:"string",required:!0}},{key:"kjønn",value:{name:"union",raw:"'K' | 'M' | '-'",elements:[{name:"literal",value:"'K'"},{name:"literal",value:"'M'"},{name:"literal",value:"'-'"}],required:!0}},{key:"navn",value:{name:"string",required:!0}},{key:"språkkode",value:{name:"union",raw:"'NB' | 'NN' | 'EN' | '-'",elements:[{name:"literal",value:"'NB'"},{name:"literal",value:"'NN'"},{name:"literal",value:"'EN'"},{name:"literal",value:"'-'"}],required:!0}}]}},description:""},harVergeIÅpenBehandling:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const K="_container_15his_1",T={container:K},h=n=>n===b.KVINNE?j.female:n===b.MANN?j.male:j.unknown,_=({erMor:n,bruker:t,annenPart:a,familiehendelse:r,lenkeTilAnnenPart:s,harVergeIÅpenBehandling:l,erTilbakekreving:d})=>{const q=p();if(d&&l)return e.jsx("div",{className:T.container,children:e.jsx(y,{name:t.navn,fodselsnummer:t.fødselsnummer,gender:h(t.kjønn),renderLabelContent:()=>e.jsx(f,{fagsakPerson:t,harVergeIÅpenBehandling:l})})});const m=n||!a?t:a,o=!n&&a?t:a;return e.jsx("div",{className:T.container,children:e.jsxs(M,{wrap:!1,align:"center",children:[m.aktørId?e.jsx(y,{name:m.navn,fodselsnummer:m.fødselsnummer,gender:h(m.kjønn),url:s,renderLabelContent:()=>e.jsx(f,{fagsakPerson:m,harVergeIÅpenBehandling:l}),isActive:n}):e.jsx(V,{namePlaceholder:q.formatMessage({id:"VisittkortPanel.Ukjent"})}),o&&(o.aktørId?e.jsx(y,{name:o.navn,fodselsnummer:o.fødselsnummer,gender:h(o.kjønn),url:s,renderLabelContent:()=>e.jsx(f,{fagsakPerson:o}),isActive:!n}):e.jsx(V,{namePlaceholder:q.formatMessage({id:"VisittkortPanel.Ukjent"})})),r&&e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsx(I,{familiehendelse:r})]})]})})};_.__docgenInfo={description:"",methods:[],displayName:"VisittkortPanel",props:{erMor:{required:!0,tsType:{name:"boolean"},description:""},bruker:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
  diskresjonskode?: string;
  dodsdato?: string;
  dødsdato?: string;
