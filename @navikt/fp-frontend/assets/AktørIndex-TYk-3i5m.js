import{j as e,h as g,P as v,b as p,L as y}from"./iframe-WfxGlWqG.js";import{Q as f}from"./index.es-BVEzCIom.js";import{u as q,r as _}from"./fagsakApi-DdXPvdls.js";import{V as c}from"./VisittkortSakIndex-T88wC3lm.js";import{V as w,a as j,B as N}from"./VStack-BZttg7w0.js";import{M as m}from"./message-JchhC8i4.js";import{E as A}from"./IngenBehandlingValgtPanel-CQvxumaJ.js";import{u as R}from"./useTrackRouteParam-4vf-S3VM.js";import{p as E}from"./paths-BHyr1HaB.js";import{u as d}from"./useKodeverk-DGPrvpl6.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person,familiehendelse:null}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(j,{size:"small",level:"2",children:e.jsx(m,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
