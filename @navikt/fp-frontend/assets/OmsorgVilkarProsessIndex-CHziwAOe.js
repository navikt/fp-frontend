...
| 'IKKE_VURDERT'`,elements:[{name:"literal",value:"'DOKUMENTERT'"},{name:"literal",value:"'IKKE_DOKUMENTERT'"},{name:"literal",value:"'IKKE_VURDERT'"}],required:!0}},{key:"termin",value:{name:"signature",type:"object",raw:`{
  ...
  kilde: tjenester_behandling_fødsel_dto_Kilde;
  utstedtdato: string;
}`,signature:{properties:[{key:"kilde",value:{name:"union",raw:"'SAKSBEHANDLER' | 'SØKNAD' | 'FOLKEREGISTER'",elements:[{name:"literal",value:"'SAKSBEHANDLER'"},{name:"literal",value:"'SØKNAD'"},{name:"literal",value:"'FOLKEREGISTER'"}],required:!0}},{key:"utstedtdato",value:{name:"string",required:!0}}]},required:!1}}]}},description:""}}};const{SJEKK_TERMINBEKREFTELSE:vr,SJEKK_MANGLENDE_FØDSEL:gr,OVERSTYRING_AV_FAKTA_OM_FØDSEL:Sr}=_,ga=({fødsel:a,terminbekreftelseDokument:n})=>{const{aksjonspunkterForPanel:r}=F(),l=r.find(i=>i.definisjon===vr),t=r.find(i=>i.definisjon===gr),s=r.find(i=>i.definisjon===Sr);return e.jsxs(R,{gap:"space-16",children:[(!(l||t)||s)&&e.jsx(va,{gjeldende:a.gjeldende}),e.jsxs(me,{children:[l?.status==="OPPR"&&e.jsx(u,{id:"FodselInfoPanel.SjekkTerminbekreftelse"}),t?.status==="OPPR"&&e.jsx(u,{id:"FodselInfoPanel.SjekkManglendeFødsel"})]}),e.jsx(Ea,{gjeldende:a.gjeldende}),e.jsxs(ra,{columns:2,gap:"space-16",children:[e.jsx(oa,{søknad:a.søknad,terminbekreftelseDokument:n}),e.jsx(Qe,{barna:a.register.barn})]}),l&&e.jsx(da,{fødsel:a,aksjonspunkt:l}),t&&e.jsx(ma,{fødsel:a,aksjonspunkt:t})]})};ga.__docgenInfo={description:"",methods:[],displayName:"FodselInfoPanel",props:{fødsel:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  gjeldende: tjenester_behandling_fødsel_dto_FødselDto_Gjeldende;
  register: tjenester_behandling_fødsel_dto_FødselDto_Register;
  søknad: tjenester_behandling_fødsel_dto_FødselDto_Søknad;
}`,signature:{properties:[{key:"gjeldende",value:{name:"signature",type:"object",raw:`{
...
| 'SKIL'
| 'SKPA'
| 'UGIF'`,elements:[{name:"literal",value:"'ENKE'"},{name:"literal",value:"'GIFT'"},{name:"literal",value:"'GJPA'"},{name:"literal",value:"'GLAD'"},{name:"literal",value:"'NULL'"},{name:"literal",value:"'REPA'"},{name:"literal",value:"'SAMB'"},{name:"literal",value:"'SEPA'"},{name:"literal",value:"'SEPR'"},{name:"literal",value:"'SKIL'"},{name:"literal",value:"'SKPA'"},{name:"literal",value:"'UGIF'"}],required:!0}}]},required:!0}}]}},description:""}}};const br="_erEndretIcon_t7o2k_1",Ka={erEndretIcon:br},ee=({første:a,andre:n})=>{const r=T();return a===n?null:e.jsx(un,{className:Ka.erEndretIcon,"aria-label":r.formatMessage({id:"Label.ErEndret"}),width:20,height:20})},Pe=({fødselsdato:a})=>Gr(a)?e.jsx(Vn,{variant:"warning",size:"small",className:Ka.erEndretIcon,icon:e.jsx(aa,{color:"var(--ax-warning-700)"}),children:e.jsx(u,{id:"FaktaSammenligning.Over15År"})}):null,Gr=a=>G(a).add(15,"year").isBefore(G());ee.__docgenInfo={description:"",methods:[],displayName:"ErEndretMarkering",props:{første:{required:!0,tsType:{name:"union",raw:"string | number | boolean | undefined",elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"undefined"}]},description:""},andre:{required:!0,tsType:{name:"union",raw:"string | number | boolean | undefined",elements:[{name:"string"},{name:"number"},{name:"boolean"},{name:"undefined"}]},description:""}}};Pe.__docgenInfo={description:"",methods:[],displayName:"Over15Markering",props:{fødselsdato:{required:!0,tsType:{name:"string"},description:""}}};const Oa=({omsorgsovertakelse:{søknad:a,gjeldende:n,kildeGjeldende:r}})=>{const l=T(),{alleKodeverk:t}=F(),s=a.barn.length>=n.barn.length?a.barn:n.barn,i=r!=="SØKNAD";return e.jsx(L,{label:l.formatMessage({id:"FaktaSammenligning.Tittel"}),children:e.jsxs(g,{children:[e.jsx(g.Header,{children:e.jsxs(g.Row,{children:[e.jsx(g.HeaderCell,{}),e.jsx(g.HeaderCell,{children:e.jsx(u,{id:"FaktaSammenligning.FraSøknaden"})}),i&&e.jsx(g.HeaderCell,{children:e.jsx(u,{id:"FaktaSammenligning.FraSaksbehandler"})})]})}),e.jsxs(g.Body,{children:[e.jsxs(g.Row,{shadeOnHover:!1,children:[e.jsx(g.HeaderCell,{scope:"row",children:e.jsx(u,{id:"Label.Omsorgsovertakelsesdato"})}),e.jsx(g.DataCell,{children:a.omsorgsovertakelseDato?e.jsx(I,{dateString:a.omsorgsovertakelseDato}):"-"}),i&&e.jsxs(g.DataCell,{children:[n.omsorgsovertakelseDato?e.jsx(I,{dateString:n.omsorgsovertakelseDato}):"-",e.jsx(ee,{første:a.omsorgsovertakelseDato,andre:n.omsorgsovertakelseDato})]})]}),(a.ankomstNorgeDato||n.ankomstNorgeDato)&&e.jsxs(g.Row,{shadeOnHover:!1,children:[e.jsx(g.HeaderCell,{scope:"row",children:e.jsx(u,{id:"Label.Ankomstdato"})}),e.jsx(g.DataCell,{children:a.ankomstNorgeDato?e.jsx(I,{dateString:a.ankomstNorgeDato}):"-"}),i&&e.jsxs(g.DataCell,{children:[n.ankomstNorgeDato?e.jsx(I,{dateString:n.ankomstNorgeDato}):"-",e.jsx(ee,{første:a.ankomstNorgeDato,andre:n.ankomstNorgeDato})]})]}),e.jsxs(g.Row,{shadeOnHover:!1,children:[e.jsx(g.HeaderCell,{scope:"row",children:e.jsx(u,{id:"Label.AntallBarn"})}),e.jsx(g.DataCell,{children:a.antallBarn}),i&&e.jsxs(g.DataCell,{children:[n.antallBarn,e.jsx(ee,{første:a.antallBarn,andre:n.antallBarn})]})]}),s.map((m,d)=>{const o=a.barn.at(d)?.fødselsdato,v=n.barn.at(d)?.fødselsdato;return e.jsxs(g.Row,{shadeOnHover:!1,children:[e.jsx(g.HeaderCell,{scope:"row",children:s.length===1?e.jsx(u,{id:"Label.Fødselsdato"}):e.jsx(u,{id:"Label.FødselsdatoNummerert",values:{nummer:d+1}})}),e.jsx(g.DataCell,{children:o?e.jsxs(f,{gap:"space-12",children:[e.jsx(I,{dateString:o}),e.jsx(Pe,{fødselsdato:o})]}):"-"}),i&&e.jsxs(g.DataCell,{children:[v?e.jsx(I,{dateString:v}):"-",e.jsx(ee,{første:o,andre:v})]})]},m.barnNummer)}),a.erEktefellesBarn!==void 0&&e.jsxs(g.Row,{shadeOnHover:!1,children:[e.jsx(g.HeaderCell,{scope:"row",children:e.jsx(u,{id:"Label.ErEktefellesBarn"})}),e.jsx(g.DataCell,{children:a.erEktefellesBarn?e.jsx(u,{id:"Label.Ja"}):e.jsx(u,{id:"Label.Nei"})}),i&&e.jsxs(g.DataCell,{children:[n.erEktefellesBarn?e.jsx(u,{id:"Label.Ja"}):e.jsx(u,{id:"Label.Nei"}),e.jsx(ee,{første:a.erEktefellesBarn,andre:n.erEktefellesBarn})]})]}),e.jsxs(g.Row,{shadeOnHover:!1,children:[e.jsx(g.HeaderCell,{scope:"row",children:e.jsx(u,{id:"Label.Delvilkår"})}),e.jsx(g.DataCell,{children:t.OmsorgsovertakelseVilkårType.find(m=>m.kode===a.delvilkår)?.navn}),i&&e.jsxs(g.DataCell,{children:[t.OmsorgsovertakelseVilkårType.find(m=>m.kode===n.delvilkår)?.navn,e.jsx(ee,{første:a.delvilkår,andre:n.delvilkår})]})]})]})]})})};Oa.__docgenInfo={description:"",methods:[],displayName:"FaktaSammenligning",props:{omsorgsovertakelse:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
| 'FP_VK_8F'
| 'FP_VK_16S'
| '-'`,elements:[{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_8F'"},{name:"literal",value:"'FP_VK_16S'"},{name:"literal",value:"'-'"}],required:!1}},{key:"erEktefellesBarn",value:{name:"boolean",required:!1}},{key:"omsorgsovertakelseDato",value:{name:"string",required:!1}}]},required:!0}}]}},description:""}}};const Br={"OmsorgsovertakelseFaktaIndex.AksjonspunktTekst":"Kontroller opplysningene om omsorgsovertakelse","FaktaFraFReg.Tittel":"Opplysninger fra Folkeregisteret","FaktaFraFReg.IngenBarn":"Det er ikke registrert noen fødselshendelse i Folkeregisteret","FaktaFraSøknad.Tittel":"Opplysninger oppgitt i søknaden","FaktaSammenligning.Tittel":"Sammenligning av opplysninger","FaktaSammenligning.FraSøknaden":"Opplysninger fra søknaden","FaktaSammenligning.FraSaksbehandler":"Opplysninger bekreftet av saksbehandler","FaktaSammenligning.Over15År":"Over 15 år","Label.Barn":"Barn","Label.NummerertBarn":"Barn {nummer}","Label.Fødselsdato":"Fødselsdato","Label.FødselsdatoNummerert":"Fødselsdato for barn {nummer}","Label.Dødsdato":"Dødsdato","Label.AntallBarn":"Antall barn","Label.Omsorgsovertakelsesdato":"Omsorgsovertakelsesdato","Label.Ankomstdato":"Ankomstdato","Label.ErEktefellesBarn":"Er det ektefelles barn?","Label.Ja":"Ja","Label.Nei":"Nei","Label.Delvilkår":"Delvilkår","Label.ErEndret":"Er endret av saksbehandler","VurderOmsorgsovertakelseVilkåretForm.Tittel":"Vurder opplysningene om omsorgsovertakelse","VurderOmsorgsovertakelseVilkåretForm.EktefellesBarn.Label":"Er det ektefelles barn?","VurderOmsorgsovertakelseVilkåretForm.HvilkeBarnSkalBrukes":"Hvilke barn skal med i vurderingen?","VurderOmsorgsovertakelseVilkåretForm.BarnRad":"Barn {nummer} født {fødseldato}","VurderOmsorgsovertakelseVilkåretForm.VilkårLabel":"Velg vilkår som skal anvendes","VurderOmsorgsovertakelseVilkåretForm.VilkårLabel.ReadOnly":"Vilkår","VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering":"Er vilkåret oppfylt?","VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering.Oppfylt":"Oppfylt","VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering.IkkeOppfylt":"Ikke oppfylt","VurderOmsorgsovertakelseVilkåretForm.VelgAvslagsårsak":"Velg en avslagsårsak","VurderOmsorgsovertakelseVilkåretForm.AvslagsarsakLabel":"Velg en avslagsårsak","VurderOmsorgsovertakelseVilkåretForm.AvslagsarsakLabel.ReadOnly":"Avslagsårsak"},hr=C(Br),Ia=({omsorgsovertakelse:a})=>{const{harÅpentAksjonspunkt:n,aksjonspunkterForPanel:r}=F();return e.jsx(Y,{value:hr,children:e.jsxs(R,{gap:"space-16",children:[n&&e.jsx(me,{children:e.jsx(u,{id:"OmsorgsovertakelseFaktaIndex.AksjonspunktTekst"})}),e.jsx(Oa,{omsorgsovertakelse:a}),e.jsx(Qe,{barna:a.register.barn}),r.some(l=>l.definisjon===_.VURDER_OMSORGSOVERTAKELSEVILKÅRET)&&e.jsx(Fa,{omsorgsovertakelse:a})]})})};Ia.__docgenInfo={description:"",methods:[],displayName:"OmsorgsovertakelseFaktaIndex",props:{omsorgsovertakelse:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktuelleDelvilkårAvslagsårsaker: {
    [key: string]: Array<foreldrepenger_behandlingslager_behandling_vilkår_Avslagsårsak>;
  };
  gjeldende: tjenester_behandling_fødsel_dto_OmsorgsovertakelseDto_Omsorgsovertakelse;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Vilkar[]"},description:""}}};const sl=new Set(["1002","1003","1032"]),Ga=({status:a,ytelseTypeKode:n,vilkår:r})=>{const l=T(),{behandling:t,isSubmittable:s,alleKodeverk:i,aksjonspunkterForPanel:m,submitCallback:d,harÅpentAksjonspunkt:o,isReadOnly:v,alleMerknaderFraBeslutter:N}=F(),A=m.some(J=>N[J.definisjon]?.notAccepted),D=ul(m,a,t.behandlingsresultat),{mellomlagretFormData:E,setMellomlagretFormData:S}=X(),k=c({defaultValues:E??D}),p=dl(n==="FP",i.Avslagsårsak.FP_VK_1),P=o?void 0:a==="OPPFYLT";return e.jsx(B,{formMethods:k,onSubmit:J=>d(ml(J,m)),setDataOnUnmount:S,children:e.jsx(Re,{title:l.formatMessage({id:"FodselVilkarForm.Fodsel"}),harÅpentAksjonspunkt:o,isSubmittable:s,isReadOnly:v,lovReferanse:r[0]?.lovReferanse??void 0,originalErVilkårOk:P,erIkkeGodkjentAvBeslutter:A,isDirty:k.formState.isDirty,isSubmitting:k.formState.isSubmitting,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(x,{size:"small",children:e.jsx(u,{id:"FodselVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(q,{avslagsårsaker:p,isReadOnly:v,customVilkårOppfyltText:e.jsx(u,{id:"FodselVilkarForm.Oppfylt"}),customVilkårIkkeOppfyltText:e.jsx(u,{id:"FodselVilkarForm.IkkeOppfylt",values:{b:Se}})}),e.jsx(j,{useAllWidth:!0,readOnly:v})]})})})},ul=(a,n,r)=>({...q.buildInitialValues(a,n,r),...j.buildInitialValues(a)}),ml=(a,n)=>({...q.transformValues(a),...j.transformValues(a),kode:oe(n[0]?.definisjon,_.AVKLAR_OM_SØKER_HAR_MOTTATT_STØTTE)}),dl=(a,n)=>a?n.filter(r=>!sl.has(r.kode)):n;Ga.__docgenInfo={description:`FodselVilkarForm
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Vilkar[]"},description:""}}};const fa=({status:a})=>{const n=T(),{behandling:r,alleKodeverk:l,aksjonspunkterForPanel:t,submitCallback:s,isReadOnly:i,alleMerknaderFraBeslutter:m,harÅpentAksjonspunkt:d,isSubmittable:o}=F(),v=t.some(p=>m[p.definisjon]?.notAccepted),N=vl(t,a,r.behandlingsresultat),{mellomlagretFormData:A,setMellomlagretFormData:D}=X(),E=c({defaultValues:A??N}),S=l.Avslagsårsak.FP_VK_5,k=d?void 0:a==="OPPFYLT";return e.jsx(B,{formMethods:E,onSubmit:p=>s(gl(p,t)),setDataOnUnmount:D,children:e.jsx(Re,{title:n.formatMessage({id:"ErOmsorgVilkaarOppfyltForm.Omsorg"}),harÅpentAksjonspunkt:o,isSubmittable:o,isReadOnly:i,originalErVilkårOk:k,erIkkeGodkjentAvBeslutter:v,isDirty:E.formState.isDirty,isSubmitting:E.formState.isSubmitting,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(x,{size:"small",children:e.jsx(u,{id:"ErOmsorgVilkaarOppfyltForm.VilkaretOppfylt"})}),e.jsx(q,{avslagsårsaker:S,isReadOnly:i,customVilkårOppfyltText:e.jsx(u,{id:"ErOmsorgVilkaarOppfyltForm.Oppfylt"}),customVilkårIkkeOppfyltText:e.jsx(u,{id:"ErOmsorgVilkaarOppfyltForm.IkkeOppfylt",values:{b:Se}})}),e.jsx(j,{readOnly:i})]})})})},vl=(a,n,r)=>({...q.buildInitialValues(a,n,r),...j.buildInitialValues(a)}),gl=(a,n)=>n.map(r=>({...q.transformValues(a),...j.transformValues(a),kode:oe(r.definisjon,_.MANUELL_VURDERING_AV_OMSORGSVILKÅRET,_.AVKLAR_OM_SØKER_HAR_MOTTATT_STØTTE)}));fa.__docgenInfo={description:`ErOmsorgVilkaarOppfyltForm

Setter opp aksjonspunkter for avklaring av omsorgsvilkåret.`,methods:[],displayName:"ErOmsorgVilkaarOppfyltForm",props:{status:{required:!0,tsType:{name:"string"},description:""}}};const Sl={"ErOmsorgVilkaarOppfyltForm.Omsorg":"Omsorg","ErOmsorgVilkaarOppfyltForm.Anvendes":"Vilkår som anvendes","ErOmsorgVilkaarOppfyltForm.VilkaretOppfylt":"Far rett til engangsstønad","ErOmsorgVilkaarOppfyltForm.Oppfylt":"Far har rett til engangsstønad, vilkåret er oppfylt","ErOmsorgVilkaarOppfyltForm.IkkeOppfylt":"Far har ikke rett til engangsstønad, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},Nl=C(Sl),Tl=a=>e.jsx(Y,{value:Nl,children:e.jsx(fa,{...a})});Tl.__docgenInfo={description:"",methods:[],displayName:"OmsorgVilkarProsessIndex",props:{status:{required:!0,tsType:{name:"string"},description:""}}};export{il as A,_l as F,Tl as O,$r as V,al as a,Vr as b,Cn as c,Ur as d,Rr as e};
