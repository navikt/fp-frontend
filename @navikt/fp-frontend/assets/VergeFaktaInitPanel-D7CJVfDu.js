import{r as o,l as g,j as s,bB as D,bC as L,bb as O}from"./iframe-td2jCF7S.js";import{Q as y}from"./index.es-BapN4HGT.js";import{u as P}from"./fagsakApi-psCeTJkR.js";import{V as G}from"./BehandlingMenuIndex-hzD3_XQg.js";import{A as V}from"./index-BfBxHZRq.js";import{u as F,c as b}from"./behandlingApi-BvXLdmZI.js";import{B as T}from"./FagsakIndex-iXfcPer8.js";import{Y as M}from"./index.es-DCb6FDe8.js";import{H as B}from"./VStack-BGjulevR.js";import{S as f}from"./ExclamationmarkTriangleFill-XSQO7cZU.js";import{e as d}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-DkX4W00F.js";const j=a=>{const[r,e]=o.useState([]),t=l=>{e(i=>{const n=[...i],m=n.findIndex(u=>u.id===l.id);return m>=0?n.splice(m,1,l):n.push(l),n}),a?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",H="_sideMenu_4o186_19",R={container:w,content:h,sideMenu:H},c=({valgtFaktaSteg:a,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=g(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=o.use(T),{faktaPanelMenyData:n,settFaktaPanelMenyData:m}=j(e),u=n.length>0;return s.jsxs(B,{className:R.container,wrap:!1,children:[u&&s.jsx("div",{className:R.sideMenu,"data-testid":"fakta-meny",children:s.jsx(M,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(E=>({label:E.tekst,active:E.erAktiv,icon:E.harÅpentAksjonspunkt?s.jsx(f,{color:"var(--ax-warning-700)"}):void 0})),onClick:E=>{i(r,n[E].id)}})}),s.jsx("div",{className:R.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:n,children:t})})]})},k=o.createContext({}),J=a=>{const{children:r,...e}=a,t=o.useMemo(()=>e,[e]);return s.jsx(k.Provider,{value:t,children:r})};c.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",C=(a,r,e,t)=>{const{valgtFaktaSteg:l,settFaktaPanelMenyData:i}=o.use(k),n=e&&(l===a||t&&l===Y);return o.useEffect(()=>{i({id:a,tekst:r,erAktiv:n,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,n,t]),e&&n},S=({standardPanelProps:a,skalPanelVisesIMeny:r,faktaPanelKode:e,faktaPanelMenyTekst:t,children:l})=>{const{behandling:i,fagsak:n,alleKodeverk:m}=o.use(T),u=C(e,t,r,a.harÅpentAksjonspunkt);return s.jsx(D,{behandling:i,children:u?s.jsx(L,{behandling:i,fagsak:n,alleKodeverk:m,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpentAksjonspunkt:a.harÅpentAksjonspunkt,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,isSubmittable:a.isSubmittable,children:l}):null})};S.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]},required:!0}},{key:"alleKodeverk",value:{name:"intersection",raw:`KodeverkMedSammeVerditype & {
...
| 'FORELDREPENGER'
| 'FORELDREPENGER_FØR_FØDSEL'
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!1}},{key:"UttakUtsettelseType",value:{name:"union",raw:`| 'ARBEID'
| 'FERIE'
| 'SYKDOM_SKADE'
| 'SØKER_INNLAGT'
| 'BARN_INNLAGT'
...
| 'FORELDREPENGER'
| 'FORELDREPENGER_FØR_FØDSEL'
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!1}}]}}],raw:"KontrollerFaktaPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]},{name:"intersection",raw:`{
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const N="default",A="default",x=(a=[],r=[])=>{const{behandling:e,rettigheter:t,fagsak:l,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=o.use(T),{aksjonspunkt:E}=e,v=E.filter(_=>a.includes(_.definisjon)),I=q(e,[],t,!1),p=U(e.status,v),K=Z(l,e,m,i,n,r);return{behandling:e,isSubmittable:!v.some(d)||v.some(_=>_.kanLoses),harÅpentAksjonspunkt:v.some(_=>d(_)&&_.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:v,isReadOnly:I,alleMerknaderFraBeslutter:p,submitCallback:K}},Z=(a,r,e,t,l,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(v=>({"@type":v.kode,...v})),E={saksnummer:a.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return l({...E,overstyrteAksjonspunktDtoer:u}).then(()=>e(A,N))}return t({...E,bekreftedeAksjonspunktDtoer:u}).then(()=>e(A,N))},W=[V.AVKLAR_VERGE],X=()=>{const a=g(),r=x(W),{behandling:e}=o.use(T),t=F(e),l=b(e,"VERGE"),{data:i,isFetching:n}=P(t.vergeOptions(e,l));return s.jsx(S,{standardPanelProps:r,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:n?s.jsx(y,{}):s.jsx(G,{verge:i,alleKodeverk:r.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{S as F,X as V,c as a,x as u};
