...
| 'UTGAAR'`,elements:[{name:"literal",value:"'MOTTATT'"},{name:"literal",value:"'JOURNALFOERT'"},{name:"literal",value:"'FEILREGISTRERT'"},{name:"literal",value:"'EKSPEDERT'"},{name:"literal",value:"'FERDIGSTILT'"},{name:"literal",value:"'UTGAAR'"}],required:!1}},{key:"eksisterendeSaksnummer",value:{name:"string",required:!1}},{key:"journalførendeEnhet",value:{name:"string",required:!1}},{key:"kanOppretteSak",value:{name:"boolean",required:!0}},{key:"avsender",value:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}},{key:"utbetalingsgrad",value:{name:"number",required:!0}}]}}],raw:"Array<tjenester_infotrygd_InfotrygdVedtakDto_Utbetaling>",required:!1}}]}}],raw:"Array<tjenester_infotrygd_InfotrygdVedtakDto_Vedtak>",required:!0}}]}}],raw:"Array<tjenester_infotrygd_InfotrygdVedtakDto_VedtakKjede>",required:!0}}]}},description:""}}};const qt="_content_11o11_1",At={content:qt},Ot=({headerHeight:n,navAnsatt:r})=>{const a=C(),{søkInfotrygd:t}=Fn(),{addErrorMessage:i,removeErrorMessages:d}=Tn(),[o,g]=y.useState(!0),u=()=>{g(!1)};y.useEffect(()=>{o||i({type:Wn.GENERAL_ERROR,message:a.formatMessage({id:"Los.IkkeTilgjengelig"})})},[o]);const k=_n(),p=(T,_)=>{k(ir(T,_))},m=En();y.useEffect(()=>{m.pathname==="/"&&d()},[m]);const{mutate:v,isPending:h,isSuccess:f,data:x}=V({mutationFn:T=>t(T.searchString)});return e.jsx("div",{className:At.content,style:{margin:`${n}px auto 0`},children:e.jsxs(qn,{children:[e.jsx(w,{path:"/",element:o?e.jsx(Yn,{setLosErIkkeTilgjengelig:u,åpneFagsak:p,navAnsatt:me(r)}):e.jsx(nr,{})}),e.jsx(w,{path:rr,element:e.jsx(mn,{navAnsatt:r})}),e.jsx(w,{path:tr,element:e.jsx(jn,{søkInfotrygdVedtak:v,isPending:h,isSuccess:f,infotrygdVedtak:x})}),e.jsx(w,{path:ar,element:e.jsx(Zn,{children:e.jsx(er,{})})}),e.jsx(w,{path:sr,element:e.jsx(Xn,{})}),e.jsx(w,{path:"*",element:e.jsx(Jn,{renderSomLenke:T=>e.jsx(An,{to:"/",children:T})})})]})})};Ot.__docgenInfo={description:`Home
...
Wrapper for sideinnholdet som vises under header.`,methods:[],displayName:"Home",props:{headerHeight:{required:!0,tsType:{name:"number"},description:""},navAnsatt:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  kanVeilede: boolean;
  navn: string;
}`,signature:{properties:[{key:"brukernavn",value:{name:"string",required:!0}},{key:"funksjonellTid",value:{name:"string",required:!1}},{key:"kanBehandleKode6",value:{name:"boolean",required:!0}},{key:"kanOppgavestyre",value:{name:"boolean",required:!0}},{key:"kanOverstyre",value:{name:"boolean",required:!0}},{key:"kanSaksbehandle",value:{name:"boolean",required:!0}},{key:"kanVeilede",value:{name:"boolean",required:!0}},{key:"navn",value:{name:"string",required:!0}}]}},description:""}}};export{Ot as H};
