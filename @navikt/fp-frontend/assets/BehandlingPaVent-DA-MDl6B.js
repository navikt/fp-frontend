import{r,j as T}from"./iframe-99QkHxNs.js";import{c as d}from"./index.es-J4JZl0hn.js";import{e as R,A as o}from"./index-CeZmOR9h.js";import{S as g}from"./SettPaVentModalIndex-Cz8O9Rlf.js";import{u as N}from"./behandlingApi-D0oUD_9c.js";const y=({behandling:e,kodeverk:t,opneSokeside:i,erTilbakekreving:u=!1,skalIkkeViseModal:a=!1})=>{const[E,l]=r.useState(!a&&e.behandlingPåVent),s=()=>l(!1),v=N(e),{mutate:m}=d({mutationFn:n=>v.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>i()});r.useEffect(()=>{a||l(e.behandlingPåVent)},[e.versjon,a]);const k=e.aksjonspunkt.filter(R).some(n=>n.definisjon===o.AUTO_MANUELT_SATT_PÅ_VENT);return T.jsx(g,{submitCallback:m,cancelEvent:s,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:k,ventearsaker:t.Venteårsak,erTilbakekreving:u,showModal:E})};y.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
