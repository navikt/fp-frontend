...
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}],required:!1}}]}},{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaresignalVurdering'>[]"},description:""}}};const la=({fagsakData:e,behandling:l,setBehandling:r})=>{const a=e.getFagsak(),{selected:n=!1}=Le({paramName:"risiko",parse:N=>N==="true",isQueryParam:!0}),u=H(),i=w(),m=()=>{u(F(i)(!n))},{kodeverkOptions:s}=M(),{data:o}=S(s()),g=e.getBehandling(l?.uuid);return l&&g?t.jsx(ra,{isRiskPanelOpen:n,fagsak:a,toggleRiskPanel:m,behandlingAppKontekst:g,behandling:l,setBehandling:r}):t.jsx(D,{risikoklassifisering:a.kontrollResultat,isPanelOpen:n,readOnly:!0,toggleRiskPanel:m,faresignalVurderinger:L(o).FaresignalVurdering})},ra=({fagsak:e,behandling:l,behandlingAppKontekst:r,setBehandling:a,toggleRiskPanel:n,isRiskPanelOpen:u})=>{const{behandlingPåVent:i,status:m,type:s,risikoAksjonspunkt:o,kontrollResultat:g}=r,{kodeverkOptions:N}=M(),K=S(Ee()),{data:R}=S(N()),h=L(K.data).innloggetBruker,ee=Je(h,e.status,m,s),ae=ta(h,ee,i),c=H(),O=w();E.useEffect(()=>{o&&ye(o)&&!u&&c(F(O)(!0)),o&&o.status==="UTFO"&&c(F(O)(!1))},[!!o,l.uuid,l.versjon]);const{lagreAksjonspunkter:ne}=Fe(l,a),le=B=>{ne({behandlingUuid:l.uuid,behandlingVersjon:l.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":B.kode,...B}]})};return t.jsx(D,{aksjonspunkt:o??void 0,risikoklassifisering:g??void 0,isPanelOpen:u,readOnly:ae,submitAksjonspunkt:le,toggleRiskPanel:n,faresignalVurderinger:L(R).FaresignalVurdering})},ta=(e,l,r)=>{if(r)return!0;const{kanSaksbehandle:a}=e;return!a||!l.writeAccess.isEnabled};la.__docgenInfo={description:`RisikoklassifiseringIndex
