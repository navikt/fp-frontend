import{j as e,h as g,P as v,b as p,L as y}from"./iframe-COWcMfOT.js";import{Q as f}from"./index.es-qrXVeoeA.js";import{u as q,r as _}from"./fagsakApi-DAk1XkWL.js";import{V as c}from"./VisittkortSakIndex-BXv0hzJu.js";import{V as j,a as N,B as A}from"./VStack-HZp7Js_x.js";import{M as o}from"./message-BKit4tKI.js";import{E as w}from"./IngenBehandlingValgtPanel-DjAF0_Fx.js";import{u as R}from"./useTrackRouteParam-JhJ16GS2.js";import{p as E}from"./paths-Dz2OPx6r.js";import{u as d}from"./useKodeverk-E8CIZ8VG.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
