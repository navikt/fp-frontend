...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const H="_container_tt7dx_1",x="_advarselIcon_tt7dx_6",v={container:H,advarselIcon:x},I=(r,a)=>!!(r||a===void 0||a.length<1),A=({searchStarted:r,searchResultAccessDenied:a,searchFagsakCallback:s})=>{const n=R(),t=M({defaultValues:{searchString:""}}),i=t.watch("searchString");return e.jsx(b,{formMethods:t,onSubmit:s,className:v.container,children:e.jsxs(E,{gap:"space-8",children:[e.jsx(g,{size:"small",children:e.jsx(k,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(y,{gap:"space-8",align:"end",children:[e.jsx(f,{name:"searchString",control:t.control,label:n.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[h]}),e.jsx(N,{variant:"primary",size:"small",loading:r,disabled:I(r,i),children:e.jsx(k,{id:"Search.Search"})})]}),a&&e.jsxs(y,{gap:"space-8",align:"end",children:[e.jsx(B,{className:v.advarselIcon}),e.jsx(g,{size:"small",children:e.jsx(k,{id:a.feilmelding})})]})]})})};A.__docgenInfo={description:`SearchForm
