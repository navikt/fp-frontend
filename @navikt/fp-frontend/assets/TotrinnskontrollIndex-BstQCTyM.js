...
| '-'
| 'ANNET'
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<VurderÅrsakFpTilbake>",required:!0}}]}}],raw:"Array<TotrinnskontrollAksjonspunkterDtoFpTilbake>",required:!0}}]}}],raw:"Array<TotrinnskontrollSkjermlenkeContextDtoFpTilbake>",required:!0}},{key:"type",value:{name:"union",raw:"'BT-007' | 'BT-009'",elements:[{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"}],required:!0}},{key:"uuid",value:{name:"string",required:!0}},{key:"venteÅrsakKode",value:{name:"string",required:!1}},{key:"versjon",value:{name:"number",required:!0}}]}}]},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Ma=({fagsakData:e,valgtBehandlingUuid:a,beslutterFormData:l,setBeslutterFormData:i,toggleVisUtvidetBehandlingDetaljerKnapp:t})=>{const E=U(),[m,o]=b.useState(!1),[A,_]=b.useState(!1),s=e.getFagsak(),v=q(e.getBehandling(a)),R=Le(v),T=ke(),k=Se(),g=Ke(Ie()),{brukernavn:D,kanVeilede:K}=q(g.data).innloggetBruker,I=He(v.type),{mutate:N}=H({mutationFn:L=>R.lagreTotrinnsaksjonspunkt(L)}),{mutate:S}=H({mutationFn:()=>R.forhåndsvisMelding({behandlingUuid:v.uuid}),onSuccess:L=>{ge(L)}}),F=L=>{const _e={behandlingUuid:v.uuid,behandlingVersjon:v.versjon,bekreftedeAksjonspunktDtoer:[L.fatterVedtakAksjonspunktDto]};_(L.erAlleAksjonspunktGodkjent),o(!0),N(_e)},h=v.status==="FVED";return n.jsxs(n.Fragment,{children:[n.jsx(we,{tekst:E.formatMessage({id:h?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),toggleVisUtvidetBehandlingDetaljerKnapp:t,children:n.jsx(Ee,{behandling:v,location:T,readOnly:D===v.ansvarligSaksbehandler||K,onSubmit:F,forhandsvisVedtaksbrev:S,fagsakYtelseType:s.fagsakYtelseType,alleKodeverk:I,createLocationForSkjermlenke:je,beslutterFormData:l,setBeslutterFormData:i})}),m&&n.jsx(Te,{behandling:v,pushLocation:k,allAksjonspunktApproved:A})]})};Ma.__docgenInfo={description:`TotrinnskontrollIndex
