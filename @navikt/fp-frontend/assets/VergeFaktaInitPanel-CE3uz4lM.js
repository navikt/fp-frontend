import{r as o,l as k,j as s,bB as D,bC as L,bb as O}from"./iframe-vns38nQ9.js";import{Z as y}from"./index.es-COAnx7UI.js";import{u as P}from"./fagsakApi-Brqf5bi6.js";import{V}from"./BehandlingMenuIndex-CxJQCUXE.js";import{A as F}from"./index-CBQUTesg.js";import{u as G,c as b}from"./behandlingApi-BpKv1Wv4.js";import{B as T}from"./FagsakIndex-CTdUN742.js";import{G as B}from"./index.es-DGwJMw-j.js";import{H as f}from"./VStack-DBfcnXus.js";import{S as M}from"./ExclamationmarkTriangleFill-B-QcNkph.js";import{e as R}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-CCd80bI5.js";const j=a=>{const[r,e]=o.useState([]),t=l=>{e(i=>{const n=[...i],m=n.findIndex(u=>u.id===l.id);return m>=0?n.splice(m,1,l):n.push(l),n}),a?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",c="_sideMenu_4o186_19",d={container:w,content:h,sideMenu:c},H=({valgtFaktaSteg:a,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=k(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=o.use(T),{faktaPanelMenyData:n,settFaktaPanelMenyData:m}=j(e),u=n.length>0;return s.jsxs(f,{className:d.container,wrap:!1,children:[u&&s.jsx("div",{className:d.sideMenu,"data-testid":"fakta-meny",children:s.jsx(B,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(E=>({label:E.tekst,active:E.erAktiv,icon:E.harÅpentAksjonspunkt?s.jsx(M,{color:"var(--ax-warning-700)"}):void 0})),onClick:E=>{i(r,n[E].id)}})}),s.jsx("div",{className:d.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:n,children:t})})]})},A=o.createContext({}),J=a=>{const{children:r,...e}=a,t=o.useMemo(()=>e,[e]);return s.jsx(A.Provider,{value:t,children:r})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
...
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"AnnenforelderUttakEøsPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const g="default",N="default",x=(a=[],r=[])=>{const{behandling:e,rettigheter:t,fagsak:l,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=o.use(T),{aksjonspunkt:E}=e,v=E.filter(_=>a.includes(_.definisjon)),p=q(e,[],t,!1),K=U(e.status,v),I=Z(l,e,m,i,n,r);return{behandling:e,isSubmittable:!v.some(R)||v.some(_=>_.kanLoses),harÅpentAksjonspunkt:v.some(_=>R(_)&&_.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:v,isReadOnly:p,alleMerknaderFraBeslutter:K,submitCallback:I}},Z=(a,r,e,t,l,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(v=>({"@type":v.kode,...v})),E={saksnummer:a.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0]?.kode??""))return l({...E,overstyrteAksjonspunktDtoer:u}).then(()=>{e(N,g),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...E,bekreftedeAksjonspunktDtoer:u}).then(()=>{e(N,g),globalThis.scrollTo({top:0,behavior:"smooth"})})},W=[F.AVKLAR_VERGE],X=()=>{const a=k(),r=x(W),{behandling:e}=o.use(T),t=G(e),l=b(e,"VERGE"),{data:i,isFetching:n}=P(t.vergeOptions(e,l));return s.jsx(S,{standardPanelProps:r,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:n?s.jsx(y,{}):s.jsx(V,{verge:i,alleKodeverk:r.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{S as F,X as V,H as a,x as u};
