import{r as E,j as T}from"./iframe-BDJaHhvt.js";import{c as _}from"./index.es-_tW5E1cA.js";import{A}from"./index-CSgtm4wd.js";import{S}from"./SettPaVentModalIndex-CoStbPAs.js";import{e as I}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as L}from"./behandlingApi-o109khtn.js";const D=({behandling:e,kodeverk:r,opneSokeside:t,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=E.useState(!a&&e.behandlingPåVent),N=()=>n(!1),m=L(e),{mutate:v}=_({mutationFn:l=>m.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>t()});E.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const R=e.aksjonspunkt.filter(I).some(l=>l.definisjon===A.AUTO_MANUELT_SATT_PÅ_VENT);return T.jsx(S,{submitCallback:v,cancelEvent:N,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:R,ventearsaker:r.Venteårsak,erTilbakekreving:i,showModal:u})};D.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
