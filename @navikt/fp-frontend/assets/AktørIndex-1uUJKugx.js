import{j as e,l as g,P as v,b as p,L as y}from"./iframe-MaBMuCwf.js";import{Q as f}from"./index.es-DkmZy4wJ.js";import{u as q,g as _}from"./fagsakApi-BSUxAMVn.js";import{V as c}from"./VisittkortSakIndex-DubQD_ay.js";import{V as j,a as N,B as A}from"./VStack-DM1id9RI.js";import{M as o}from"./message-Cp8kE35n.js";import{E as w}from"./IngenBehandlingValgtPanel-CU1h4mrg.js";import{u as R}from"./useTrackRouteParam-B7EAKQJV.js";import{p as E}from"./paths-CmbuVXC0.js";import{u as d}from"./useKodeverk-CQ-086MU.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
