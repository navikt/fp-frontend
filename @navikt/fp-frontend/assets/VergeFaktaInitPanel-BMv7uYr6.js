import{r as v,l as A,j as m,bA as O,bB as y,ba as L}from"./iframe-BT_of8Lu.js";import{Z as P}from"./index.es-DJVnH0rx.js";import{u as V}from"./fagsakApi-DnthERuS.js";import{V as F}from"./BehandlingMenuIndex-DgYaZBwV.js";import{A as G}from"./index-CdTfFLZ6.js";import{u as b,c as M}from"./behandlingApi-DBX66kvv.js";import{u as d}from"./FagsakIndex-ybOIc5FU.js";import{G as f}from"./index.es-Cri2FzTn.js";import{H as B}from"./VStack-BZgEV5zh.js";import{S as q}from"./ExclamationmarkTriangleFill-mpeC6sBN.js";import{e as g}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as U,g as j}from"./useStandardProsessPanelProps-DCsHTrJV.js";const w=e=>{const[n,r]=v.useState([]),t=l=>{r(u=>{const a=[...u],o=a.findIndex(i=>i.id===l.id);return o>=0?a.splice(o,1,l):a.push(l),a}),e?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:n.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},c="_container_4o186_1",h="_content_4o186_6",H="_sideMenu_4o186_19",T={container:c,content:h,sideMenu:H},J=({valgtFaktaSteg:e,valgtProsessSteg:n,setFaktaPanelMedÅpentApInfo:r,children:t})=>{const l=A(),{oppdaterProsessStegOgFaktaPanelIUrl:u}=d(),{faktaPanelMenyData:a,settFaktaPanelMenyData:o}=w(r),i=a.length>0;return m.jsxs(B,{className:T.container,wrap:!1,children:[i&&m.jsx("div",{className:T.sideMenu,"data-testid":"fakta-meny",children:m.jsx(f,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:a.map(E=>({label:E.tekst,active:E.erAktiv,icon:E.harÅpentAksjonspunkt?m.jsx(q,{color:"var(--ax-warning-700)"}):void 0})),onClick:E=>{u(n,a[E].id)}})}),m.jsx("div",{className:T.content,children:m.jsx(Y,{valgtFaktaSteg:e,settFaktaPanelMenyData:o,faktaPanelMenyData:a,children:t})})]})},N=v.createContext({}),Y=e=>{const{children:n,...r}=e,t=v.useMemo(()=>r,[r]);return m.jsx(N.Provider,{value:t,children:n})};J.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const C="default",x=(e,n,r,t)=>{const{valgtFaktaSteg:l,settFaktaPanelMenyData:u}=v.use(N),a=r&&(l===e||t&&l===C);return v.useEffect(()=>{u({id:e,tekst:n,erAktiv:a,harÅpentAksjonspunkt:t,skalVisesIMeny:r})},[r,a,t]),r&&a},p=({standardPanelProps:e,skalPanelVisesIMeny:n,faktaPanelKode:r,faktaPanelMenyTekst:t,children:l})=>{const{behandling:u,fagsak:a,alleKodeverk:o}=d(),i=x(r,t,n,e.harÅpentAksjonspunkt);return m.jsx(O,{behandling:u,children:i?m.jsx(y,{behandling:u,fagsak:a,alleKodeverk:o,alleMerknaderFraBeslutter:e.alleMerknaderFraBeslutter,aksjonspunkterForPanel:e.aksjonspunkterForPanel,vilkårForPanel:e.vilkårForPanel,harÅpentAksjonspunkt:e.harÅpentAksjonspunkt,isReadOnly:e.isReadOnly,isSubmittable:e.isSubmittable,submitCallback:e.submitCallback,children:l}):null})};p.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  behandling: T;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Vilkar[]",required:!0}},{key:"isReadOnly",value:{name:"boolean",required:!0}},{key:"isSubmittable",value:{name:"boolean",required:!0}},{key:"harÅpentAksjonspunkt",value:{name:"boolean",required:!0}},{key:"submitCallback",value:{name:"signature",type:"function",raw:"(aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>",signature:{arguments:[{type:{name:"union",raw:"FaktaAksjonspunkt | FaktaAksjonspunkt[]",elements:[{name:"union",raw:`| AvklarVergeAp
...
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"AnnenforelderUttakEøsPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpentAksjonspunkt: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const R="default",k="default",Z=(e=[])=>{const{behandling:n,rettigheter:r,fagsak:t,lagreAksjonspunkter:l,lagreOverstyrteAksjonspunkter:u,oppdaterProsessStegOgFaktaPanelIUrl:a,alleKodeverk:o}=d(),i=n.aksjonspunkt.filter(s=>e.includes(s.definisjon)),E=e.filter(s=>s.startsWith("6")),_=new Set(i.flatMap(s=>"vilkarType"in s&&s.vilkarType?[s.vilkarType]:[])),S="vilkår"in n?n.vilkår.filter(s=>_.has(s.vilkarType)):[],K=U(n,[],r,!1),I=j(n.status,i),D=W(t,n,a,l,u,E);return{behandling:n,isSubmittable:!i.some(g)||i.some(s=>s.kanLoses),harÅpentAksjonspunkt:i.some(s=>g(s)&&s.kanLoses),alleKodeverk:o,aksjonspunkterForPanel:i,vilkårForPanel:S,isReadOnly:K,alleMerknaderFraBeslutter:I,submitCallback:D}},W=(e,n,r,t,l,u)=>a=>{const i=(Array.isArray(a)?a:[a]).map(_=>({"@type":_.kode,..._})),E={saksnummer:e.saksnummer,behandlingUuid:n.uuid,behandlingVersjon:n.versjon};if(u.length>0){if(i.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(u.includes(i[0]?.kode??""))return l({...E,overstyrteAksjonspunktDtoer:i}).then(()=>{r(k,R),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...E,bekreftedeAksjonspunktDtoer:i}).then(()=>{r(k,R),globalThis.scrollTo({top:0,behavior:"smooth"})})},X=[G.AVKLAR_VERGE],Q=()=>{const e=A(),n=Z(X),{behandling:r}=d(),t=b(r),l=M(r,"VERGE"),{data:u,isFetching:a}=V(t.vergeOptions(r,l));return m.jsx(p,{standardPanelProps:n,faktaPanelKode:L.VERGE,faktaPanelMenyTekst:e.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:a?m.jsx(P,{}):m.jsx(F,{verge:u,alleKodeverk:n.alleKodeverk})})};Q.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{p as F,Q as V,J as a,Z as u};
