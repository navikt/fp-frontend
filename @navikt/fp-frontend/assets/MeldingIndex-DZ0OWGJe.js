import{l as y,K as le,j as n,t as V,O as re,F as H,v as te,x as ie,P as c,b as Y,r as h,n as ue,S as O,B as I}from"./iframe-BHB30hG9.js";import{n as f,s as x,u as Ee,t as se,d as me}from"./fagsakApi-DbUTM8s2.js";import{u as oe,C as _e,w as q,O as ve,c as p}from"./index.es-CTP8X5A_.js";import{D as i}from"./dokumentMalType-B-Xou3xH.js";import{V as de}from"./venteArsakType-BJdSFL9e.js";import{U as Te}from"./UkjentAdresseMeldingIndex-DB-EqbMs.js";import{V as J,H as F,b as C,M as U,L as ge}from"./VStack-BNpz-CEI.js";import{L as Ne}from"./Link-DjwDbqdy.js";import{M as k}from"./message-C4wCMMEg.js";import{S as Re}from"./CheckmarkCircleFill-C6zXFgJL.js";import{u as w}from"./useKodeverk-CoSXFD_a.js";import{S as ke}from"./SupportHeader-C1gwuIJ7.js";import{S as Ae}from"./SettPaVentReadOnlyModal-BGvP-7Vm.js";import{A as Se}from"./index.es-BU_EG_YN.js";var g=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(g||{});const Le="_bredde_jav4h_9",M={bredde:Le},Ie=H(4e3),Ke=H(1e4),De=te(3),z=({behandling:e,forhåndsvisBrev:a,submitCallback:t,revurderingVarslingArsak:s,fagsakYtelseType:m,kanVeilede:l,meldingFormData:u,setMeldingFormData:N,brukerManglerAdresse:R})=>{const o=y(),_=oe({defaultValues:u??Fe(e)}),v=_.watch("brevmalkode"),A=_.watch("fritekst"),E=_.watch("arsakskode"),K=pe(s,m);if(!e.språkkode)return null;const{formState:S,control:d}=_,L=r=>{v&&a({brevmalkode:v,fritekst:A,arsakskode:E}),r.preventDefault()},D=le(e.språkkode),T=v===i.VARSEL_OM_REVURDERING;return n.jsx(_e,{formMethods:_,onSubmit:r=>t(ye(r)),setDataOnUnmount:N,children:n.jsxs(J,{gap:"space-16",children:[n.jsx(q,{name:"brevmalkode",control:d,label:o.formatMessage({id:"Messages.Template"}),validate:[V],selectValues:e.brevmaler.map(r=>n.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:M.bredde}),T&&n.jsx(q,{name:"arsakskode",control:d,label:o.formatMessage({id:"Messages.Årsak"}),validate:[V],selectValues:K.map(r=>n.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:M.bredde}),Ve(v,E)&&n.jsx(ve,{name:"fritekst",control:d,label:o.formatMessage({id:be(v)}),validate:[V,T?Ke:Ie,De,ie],maxLength:T?1e4:4e3,badges:[{type:"info",titleText:D}],parse:re}),R&&n.jsx(Te,{}),n.jsxs(F,{justify:"space-between",children:[(!T||T&&E!==void 0)&&n.jsx(Ne,{href:"#",onClick:L,onKeyDown:r=>r.key==="Enter"?L(r):null,children:n.jsx(k,{id:"Messages.Preview"})}),n.jsx(C,{size:"small",variant:"primary",loading:S.isSubmitting,disabled:S.isSubmitting||l,children:n.jsx(k,{id:"Messages.Submit"})})]})]})})},be=e=>e===i.INNHENTE_OPPLYSNINGER||e===i.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",Ve=(e,a)=>e===i.INNHENTE_OPPLYSNINGER||e===i.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===i.VARSEL_OM_TILBAKEKREVING||e===i.TBK_INNHENTE_OPPLYSNINGER||e===i.VARSEL_OM_REVURDERING&&a===g.ANNET,pe=(e,a)=>a==="ES"?e.filter(t=>t.kode===g.BARN_IKKE_REGISTRERT_FOLKEREGISTER||t.kode===g.ANNET):a==="SVP"?e.filter(t=>t.kode!==g.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&t.kode!==g.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Fe=e=>{const a={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...a,brevmalkode:i.VARSEL_OM_REVURDERING}:{...a}},ye=e=>{const a=e;return e.brevmalkode===i.VARSEL_OM_REVURDERING&&a.arsakskode!==g.ANNET&&(a.fritekst=" "),a};z.__docgenInfo={description:`Messages
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""}}};const Pe="_image_v04s1_1",Be="_modal_v04s1_8",j={image:Pe,modal:Be},W=({showModal:e,closeEvent:a})=>{const t=y();return n.jsx(U,{className:j.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:a,children:n.jsx(U.Body,{children:n.jsxs(F,{justify:"space-between",align:"center",children:[n.jsxs(F,{gap:"space-8",align:"center",children:[n.jsx(Re,{className:j.image,title:t.formatMessage({id:"MessagesModal.description"})}),n.jsx(ge,{size:"small",children:n.jsx(k,{id:"MessagesModal.text"})})]}),n.jsx(C,{size:"small",variant:"primary",onClick:a,autoFocus:!0,type:"button",children:n.jsx(k,{id:"MessagesModal.OK"})})]})})})};W.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const he=Y(Q),X=e=>n.jsx(c,{value:he,children:n.jsx(W,{...e})});X.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Oe=e=>e.behandlingPåVent?e.fristBehandlingPåVent:null,fe=({fagsakData:e,valgtBehandlingUuid:a,meldingFormData:t,setMeldingFormData:s,hentOgSettBehandling:m,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const u=y(),[N,R]=h.useState(!1),[o,_]=h.useState(!1),v=ue(),A=e.getFagsak(),E=f(e.getBehandling(a)),K=x(E),S=Ee(me()),{innloggetBruker:{kanVeilede:d}}=f(S.data),L=w("Venteårsak")||[],D=w("RevurderingVarslingÅrsak"),{mutateAsync:T,status:r}=p({mutationFn:b=>K.sendMelding(b)}),Z=qe(_,T,m,R,s,E),ee=()=>{v("/")},ne=we(E),ae=()=>(_(!1),m()),G=r==="success",P=E.behandlingTillatteOperasjoner,B=!d&&e.getAlleBehandlinger().some(b=>!b.avsluttet)&&P?.behandlingKanSendeMelding;return n.jsxs(n.Fragment,{children:[o&&n.jsx(X,{showModal:G&&o,closeEvent:ae}),n.jsx(ke,{tekst:u.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:n.jsxs(J,{gap:"space-16",children:[!B&&n.jsx(Se,{variant:"info",children:n.jsx(k,{id:Ue(d,P?.behandlingKanSendeMelding)})}),B&&n.jsx($,{submitCallback:Z,behandling:E,forhåndsvisBrev:ne,revurderingVarslingArsak:D,fagsakYtelseType:A.fagsakYtelseType,kanVeilede:d,meldingFormData:t,setMeldingFormData:s,brukerManglerAdresse:A.brukerManglerAdresse})]})}),G&&N&&n.jsx(Ae,{lukkCallback:ee,ventearsak:de.AVV_DOK,ventearsaker:L,frist:Oe(E)})]})},qe=(e,a,t,s,m,l)=>u=>{const N=u.brevmalkode===i.INNHENTE_OPPLYSNINGER||u.brevmalkode===i.VARSEL_OM_REVURDERING||u.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,R=I.TILBAKEKREVING===l.type||I.TILBAKEKREVING_REVURDERING===l.type;e(!N);const o=R?{behandlingUuid:l.uuid,fritekst:u.fritekst,brevmalkode:u.brevmalkode}:{behandlingUuid:l.uuid,brevmalkode:u.brevmalkode,fritekst:u.fritekst,arsakskode:u.arsakskode};return a(o).then(()=>{m(),N?s(!0):t()})},Ue=(e,a)=>a?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",we=e=>{const a=x(e),{mutate:t}=p({mutationFn:l=>a.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:l.brevmalkode,fritekst:l.fritekst||" ",arsakskode:l.arsakskode}),onSuccess:l=>{O(l)}}),{mutate:s}=p({mutationFn:l=>se(e.uuid,l.brevmalkode,l.fritekst??" "),onSuccess:l=>{O(l)}}),m=I.TILBAKEKREVING===e.type||I.TILBAKEKREVING_REVURDERING===e.type;return l=>{m?s(l):t(l)}};fe.__docgenInfo={description:`MeldingIndex
