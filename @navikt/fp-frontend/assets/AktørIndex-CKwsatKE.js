import{j as e,h as g,P as v,b as p,L as y}from"./iframe-Dib9oDYq.js";import{Q as f}from"./index.es-C-UFLwjX.js";import{u as q,r as _}from"./fagsakApi-Bsb5j5cT.js";import{V as c}from"./VisittkortSakIndex-D0sMAFJZ.js";import{V as w,a as j,B as N}from"./VStack-o4SaHOuu.js";import{M as m}from"./message-DwMTNKVi.js";import{E as A}from"./IngenBehandlingValgtPanel-XqHvQGEq.js";import{u as R}from"./useTrackRouteParam-nXlpQVzd.js";import{p as E}from"./paths-CBPr6ehe.js";import{u as d}from"./useKodeverk-CSSR9Xn-.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person,familiehendelse:null}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(j,{size:"small",level:"2",children:e.jsx(m,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
