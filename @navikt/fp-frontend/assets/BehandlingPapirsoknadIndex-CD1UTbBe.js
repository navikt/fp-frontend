...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const se=P(M),ct=r=>n=>{const a=r("foedselsDato");return Bn(a,n)},_t=r=>n=>{const a=r("termindato");return Na(a,n)},ye=({readOnly:r,erForeldrepenger:n=!1})=>{const{watch:a,getValues:t,control:s}=A(),i=a("erBarnetFodt");return e.jsx(ee,{value:se,children:e.jsx(U,{children:e.jsxs(T,{gap:"space-16",children:[e.jsx(h,{size:"small",level:"3",children:se.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),e.jsxs(Q,{name:"erBarnetFodt",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[m],isReadOnly:r,children:[e.jsx(j,{value:!0,size:"small",children:e.jsx(d,{id:"Registrering.TerminOgFodsel.ErFodt"})}),e.jsx(j,{value:!1,size:"small",children:e.jsx(d,{id:"Registrering.TerminOgFodsel.ErIkkeFodt"})})]}),i!==void 0&&e.jsxs(T,{gap:"space-16",children:[i===!1&&e.jsxs(e.Fragment,{children:[e.jsxs(G,{gap:"space-16",children:[e.jsx(q,{name:"termindato",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:r,fromDate:Se().toDate(),toDate:Oe().toDate(),defaultMonth:new Date,validate:[m,F,B(Se()),z(Oe())]}),e.jsx(w,{name:"antallBarn",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:r,parse:l=>{const u=parseInt(l.toString(),10);return isNaN(u)?l:u},validate:[m,he,dn,kn]})]}),e.jsx(q,{name:"terminbekreftelseDato",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.UtstedtDato"}),isReadOnly:r,fromDate:Va().toDate(),toDate:fa().toDate(),defaultMonth:new Date,validate:[F,_t(t)]})]}),i===!0&&e.jsxs(e.Fragment,{children:[e.jsxs(G,{gap:"space-16",children:[e.jsx(q,{name:"foedselsDato",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:r,validate:[m,F,B(Fr()),we],fromDate:Fr().toDate(),toDate:In().toDate()}),e.jsx(w,{name:"antallBarn",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:r,parse:l=>{const u=parseInt(l.toString(),10);return Number.isNaN(u)?l:u},validate:[m,he,dn,kn]})]}),n&&e.jsx(Kr,{size:"small",variant:"info",children:e.jsx(Re,{size:"small",children:se.formatMessage({id:"Registrering.TerminOgFodsel.RettTilPrematuruker"})})}),e.jsx(q,{name:"termindato",control:s,label:se.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:r,validate:[F,B(Se()),z(Oe()),ct(t)],fromDate:Se().toDate(),toDate:Oe().toDate(),defaultMonth:new Date})]})]})]})})})};ye.initialValues=()=>({erBarnetFodt:void 0});ye.transformValues=({antallBarn:r,erBarnetFodt:n,foedselsDato:a,termindato:t,terminbekreftelseDato:s})=>n?{erBarnetFodt:!0,termindato:t,foedselsDato:a,antallBarn:r}:{erBarnetFodt:!1,termindato:t,terminbekreftelseDato:s,antallBarnFraTerminbekreftelse:r};ye.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
