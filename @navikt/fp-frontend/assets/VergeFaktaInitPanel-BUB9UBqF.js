import{r as o,l as A,j as s,bB as D,bC as L,bb as O}from"./iframe-CJgyfo9_.js";import{Q as y}from"./index.es-BFCB1ROu.js";import{u as P}from"./fagsakApi-NMkvHp61.js";import{V as G}from"./BehandlingMenuIndex-fG3kc8yD.js";import{A as V}from"./index-Bc_7YYJb.js";import{u as F,c as b}from"./behandlingApi-OP-ZgTAJ.js";import{B as T}from"./FagsakIndex-B3Y-vz5_.js";import{Y as M}from"./index.es-DT3hmkJu.js";import{H as B}from"./VStack-BQ5ULrV2.js";import{S as f}from"./ExclamationmarkTriangleFill-C0w41j-T.js";import{e as R}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-BqHvReY0.js";const j=a=>{const[r,e]=o.useState([]),t=l=>{e(i=>{const n=[...i],m=n.findIndex(u=>u.id===l.id);return m>=0?n.splice(m,1,l):n.push(l),n}),a?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",H="_sideMenu_4o186_19",d={container:w,content:h,sideMenu:H},c=({valgtFaktaSteg:a,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=A(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=o.use(T),{faktaPanelMenyData:n,settFaktaPanelMenyData:m}=j(e),u=n.length>0;return s.jsxs(B,{className:d.container,wrap:!1,children:[u&&s.jsx("div",{className:d.sideMenu,"data-testid":"fakta-meny",children:s.jsx(M,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(E=>({label:E.tekst,active:E.erAktiv,icon:E.harÅpentAksjonspunkt?s.jsx(f,{color:"var(--ax-warning-700)"}):void 0})),onClick:E=>{i(r,n[E].id)}})}),s.jsx("div",{className:d.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:n,children:t})})]})},k=o.createContext({}),J=a=>{const{children:r,...e}=a,t=o.useMemo(()=>e,[e]);return s.jsx(k.Provider,{value:t,children:r})};c.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
...
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0},{name:"literal",value:"'-'"}]},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  lovHjemmel: string;
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}}]}}]}],raw:"LineærAvslagsårsakKodeverk[]",required:!0}}]}}],required:!0}},{key:"alleMerknaderFraBeslutter",value:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]},required:!0}},{key:"aksjonspunkterForPanel",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aksjonspunktType: foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktType;
  begrunnelse?: string;
  besluttersBegrunnelse?: string;
  definisjon: foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktDefinisjon;
