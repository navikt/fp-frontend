import{r as E,o as A,j as s,bF as b,bG as I,bf as K}from"./iframe-Bi6mcpW9.js";import{Q as L}from"./index.es-BEu-da46.js";import{u as O}from"./fagsakApi-DR2mcDTG.js";import{V}from"./BehandlingMenuIndex-DksaajpZ.js";import{A as G}from"./index-PgzdEw57.js";import{u as f,c as P}from"./behandlingApi-D-BAjjYw.js";import{B as v}from"./FagsakIndex-CJf6sfPH.js";import{Y as F}from"./index.es-C8TQlJ-i.js";import{H as q}from"./VStack-BAxRV9hT.js";import{S as B}from"./ExclamationmarkTriangleFill-DNO7kqE6.js";import{e as T}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as j,g as w}from"./useStandardProsessPanelProps-UW9m-GJc.js";const M=a=>{const[l,e]=E.useState([]),t=r=>{e(i=>{const n=[...i],m=n.findIndex(u=>u.id===r.id);return m>=0?n.splice(m,1,r):n.push(r),n}),a?.(r.harÅpentAksjonspunkt?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:l.filter(r=>r.skalVisesIMeny),settFaktaPanelMenyData:t}},h="_container_4o186_1",U="_content_4o186_6",c="_sideMenu_4o186_19",k={container:h,content:U,sideMenu:c},H=({valgtFaktaSteg:a,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const r=A(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=E.use(v),{faktaPanelMenyData:n,settFaktaPanelMenyData:m}=M(e),u=n.length>0;return s.jsxs(q,{className:k.container,wrap:!1,children:[u&&s.jsx("div",{className:k.sideMenu,"data-testid":"fakta-meny",children:s.jsx(F,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harÅpentAksjonspunkt?s.jsx(B,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(l,n[o].id)}})}),s.jsx("div",{className:k.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:n,children:t})})]})},p=E.createContext({}),J=a=>{const{children:l,...e}=a,t=E.useMemo(()=>e,[e]);return s.jsx(p.Provider,{value:t,children:l})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",x=(a,l,e,t)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:i}=E.use(p),n=e&&(r===a||t&&r===Y);return E.useEffect(()=>{i({id:a,tekst:l,erAktiv:n,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,n,t]),e&&n},N=({standardPanelProps:a,skalPanelVisesIMeny:l,faktaPanelKode:e,faktaPanelMenyTekst:t,children:r})=>{const{behandling:i,fagsak:n,alleKodeverk:m}=E.use(v),u=x(e,t,l,a.harÅpentAksjonspunkt);return s.jsx(b,{behandling:i,children:u?s.jsx(I,{behandling:i,fagsak:n,alleKodeverk:m,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpentAksjonspunkt:a.harÅpentAksjonspunkt,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,isSubmittable:a.isSubmittable,children:r}):null})};N.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const _="default",R="default",C=(a=[],l=[])=>{const{behandling:e,rettigheter:t,fagsak:r,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=E.use(v),{aksjonspunkt:o}=e,d=o.filter(g=>a.includes(g.definisjon)),y=j(e,[],t,!1),S=w(e.status,d),D=Q(r,e,m,i,n,l);return{behandling:e,isSubmittable:!d.some(T)||d.some(g=>g.kanLoses),harÅpentAksjonspunkt:d.some(g=>T(g)&&g.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:d,isReadOnly:y,alleMerknaderFraBeslutter:S,submitCallback:D}},Q=(a,l,e,t,r,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(d=>({"@type":d.kode,...d})),o={saksnummer:a.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return r({...o,overstyrteAksjonspunktDtoer:u}).then(()=>e(R,_))}return t({...o,bekreftedeAksjonspunktDtoer:u}).then(()=>e(R,_))},z=[G.AVKLAR_VERGE],W=()=>{const a=A(),l=C(z),{behandling:e}=E.use(v),t=f(e),r=P(e,"VERGE"),{data:i,isFetching:n}=O(t.vergeOptions(e,r));return s.jsx(N,{standardPanelProps:l,faktaPanelKode:K.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:r,children:n?s.jsx(L,{}):s.jsx(V,{verge:i,alleKodeverk:l.alleKodeverk})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{N as F,W as V,H as a,C as u};
