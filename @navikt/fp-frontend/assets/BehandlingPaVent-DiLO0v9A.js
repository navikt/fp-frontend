import{r,j as N}from"./iframe-Bi6mcpW9.js";import{c as s}from"./index.es-CrVP4_UL.js";import{A as _}from"./index-PgzdEw57.js";import{S as A}from"./SettPaVentModalIndex-Dfcfm_Hv.js";import{e as S}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as k}from"./behandlingApi-D-BAjjYw.js";const L=({behandling:e,kodeverk:E,opneSokeside:t,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=r.useState(!a&&e.behandlingPåVent),T=()=>n(!1),v=k(e),{mutate:m}=s({mutationFn:l=>v.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>t()});r.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const R=e.aksjonspunkt.filter(S).some(l=>l.definisjon===_.AUTO_MANUELT_SATT_PÅ_VENT);return N.jsx(A,{submitCallback:m,cancelEvent:T,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:R,ventearsaker:E.Venteårsak,erTilbakekreving:i,showModal:u})};L.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
