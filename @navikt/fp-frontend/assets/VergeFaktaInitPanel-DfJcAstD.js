...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const N="default",g="default",x=(a=[],r=[])=>{const{behandling:e,rettigheter:t,fagsak:l,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=o.use(T),{aksjonspunkt:E}=e,v=E.filter(_=>a.includes(_.definisjon)),I=q(e,[],t,!1),p=U(e.status,v),K=Z(l,e,m,i,n,r);return{behandling:e,isSubmittable:!v.some(R)||v.some(_=>_.kanLoses),harÅpentAksjonspunkt:v.some(_=>R(_)&&_.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:v,isReadOnly:I,alleMerknaderFraBeslutter:p,submitCallback:K}},Z=(a,r,e,t,l,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(v=>({"@type":v.kode,...v})),E={saksnummer:a.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return l({...E,overstyrteAksjonspunktDtoer:u}).then(()=>{e(g,N),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...E,bekreftedeAksjonspunktDtoer:u}).then(()=>{e(g,N),globalThis.scrollTo({top:0,behavior:"smooth"})})},W=[V.AVKLAR_VERGE],X=()=>{const a=A(),r=x(W),{behandling:e}=o.use(T),t=F(e),l=b(e,"VERGE"),{data:i,isFetching:n}=P(t.vergeOptions(e,l));return s.jsx(S,{standardPanelProps:r,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:n?s.jsx(y,{}):s.jsx(G,{verge:i,alleKodeverk:r.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{S as F,X as V,c as a,x as u};
