import{r,j as d}from"./iframe-D6H4IsMQ.js";import{c as o}from"./index.es-C-JUc-Pm.js";import{e as T,A as g}from"./index-DrFRX5YY.js";import{S as y}from"./SettPaVentModalIndex-BhnUxMYE.js";import{u as _}from"./behandlingApi-B-OSZQFD.js";const p=({behandling:e,kodeverk:t,opneSokeside:u,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[s,l]=r.useState(!a&&e.behandlingPåVent),m=()=>l(!1),v=_(e),{mutate:k}=o({mutationFn:n=>v.oppdaterPåVent({...n,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>u()});r.useEffect(()=>{a||l(e.behandlingPåVent)},[e.versjon,a]);const E=e.aksjonspunkt.filter(T).some(n=>n.definisjon===g.AUTO_MANUELT_SATT_PÅ_VENT);return d.jsx(y,{submitCallback:k,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:E,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:s})};p.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
