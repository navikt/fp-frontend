import{j as e,h as g,P as v,b as p,L as y}from"./iframe-D6H4IsMQ.js";import{Q as f}from"./index.es-BWI-GEJ5.js";import{u as q,r as _}from"./fagsakApi-BjBZtPLm.js";import{V as c}from"./VisittkortSakIndex-BHmnreXV.js";import{V as w,a as j,B as N}from"./VStack-C7T5SLU5.js";import{M as m}from"./message-CwUY0uBZ.js";import{E as A}from"./IngenBehandlingValgtPanel-a7_t7gL-.js";import{u as R}from"./useTrackRouteParam-Of9lqKYk.js";import{p as E}from"./paths-DoSY-kk6.js";import{u as d}from"./useKodeverk-dKW8sybE.js";const o=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person,familiehendelse:null}),e.jsx(w,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const u=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,i=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${u} (${a.saksnummer}) ${i}`,a.saksnummer)},a.saksnummer)}):e.jsx(j,{size:"small",level:"2",children:e.jsx(m,{id:"AktoerGrid.IngenFagsaker"})})})]});o.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId: string | null;
