...
}`,signature:{properties:[{key:"aktivitetType",value:{name:"string",required:!0}},{key:"erEndring",value:{name:"boolean",required:!0}},{key:"godkjent",value:{name:"boolean",required:!0}},{key:"arbeidsgiverReferanse",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"arbeidsgiverNavn",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"orgnr",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}},{key:"privatpersonFødselsdato",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!0}}]}},description:""}}};const ln=e=>e?.fastsattVarigEndringNaering?a.jsx(u,{id:"ToTrinnsForm.Beregning.VarigEndring"}):a.jsx(u,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),W=e=>e.uttakPerioder?e.uttakPerioder.map(n=>{const l=J(n.fom),i=J(n.tom);let t;return n.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":n.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":n.erEndret&&(e.aksjonspunktKode===r.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===r.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":n.erEndret&&e.aksjonspunktKode===r.OVERSTYRING_AV_UTTAKPERIODER||n.erEndret&&e.aksjonspunktKode===r.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":n.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",a.jsx(u,{id:t,values:{a:l,b:i}},t)}):[],rn=e=>e.opptjeningAktiviteter?e.opptjeningAktiviteter.map(n=>a.jsx(Ee,{aktivitet:n},n.aktivitetType)):[],tn=e=>{const n=Xe[e.aksjonspunktKode];return n?[a.jsx(u,{id:n},n)]:[]},un=e=>{const n=Ze[e.aksjonspunktKode];return n?[a.jsx(u,{id:n},n)]:[]},En=e=>{const n=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[a.jsx(u,{id:n},n)]},sn=(e,n)=>n?.faktaOmBeregningTilfeller?n.faktaOmBeregningTilfeller.flatMap(l=>{const i=e.find(t=>t.kode===l);return i?[a.jsx("div",{children:i.navn},i.navn)]:[]}):[],on=e=>{let n="";switch(e?.type){case b.KLAGE_YTELSESVEDTAK_STADFESTET:n="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case b.KLAGE_YTELSESVEDTAK_OPPHEVET:n="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case b.KLAGE_AVVIST:n="ToTrinnsForm.Klage.Avvist";break;case b.HJEMSENDE_UTEN_OPPHEVE:n="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case b.KLAGE_DELVIS_MEDHOLD:n="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case b.KLAGE_OMGJORT_UGUNST:n="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case b.KLAGE_MEDHOLD:n="ToTrinnsForm.Klage.OmgjortTilGunst";break}return a.jsx(u,{id:n})},mn=(e,n)=>e===h.FATTER_VEDTAK?[on(n)]:[],vn=()=>a.jsx(u,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),_n=()=>a.jsx(u,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),Tn=e=>e.aksjonspunktKode===r.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===r.VURDERING_AV_FORMKRAV_KLAGE_NFP,se=(e,n,l,i,t,E)=>t.aksjonspunktKode===r.VURDER_PERIODER_MED_OPPTJENING?rn(t):t.aksjonspunktKode===r.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[ln(t.beregningDto)]:t.aksjonspunktKode===r.VURDER_FAKTA_FOR_ATFL_SN?sn(l,t.beregningDto):qe(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0||fe(t.aksjonspunktKode)&&t.uttakPerioder&&t.uttakPerioder.length>0?W(t):t.aksjonspunktKode===r.AVKLAR_ANNEN_FORELDER_RETT?[vn()]:t.aksjonspunktKode===r.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?En(e):t.aksjonspunktKode===r.OVERSTYRING_AV_RETT_OG_OMSORG?[_n()]:Tn(t)?mn(n,E):i?un(t):tn(t),dn=Le(3),kn=pe(2e3),N="aksjonspunktGodkjenning",gn=(e,n)=>!e(`${N}.${n}.feilFakta`)&&!e(`${N}.${n}.feilLov`)&&!e(`${N}.${n}.feilSkjønn`)&&!e(`${N}.${n}.feilUtredning`)&&!e(`${N}.${n}.feilSaksflyt`)&&!e(`${N}.${n}.feilBegrunnelse`),oe=({index:e,totrinnskontrollSkjermlenkeContext:n,readOnly:l})=>{const{watch:i,getValues:t,control:E}=te(),T=i("aksjonspunktGodkjenning"),{aksjonspunktKode:d,totrinnskontrollGodkjent:k}=T[e],m=n.find(o=>o.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===d)),v=m?.totrinnskontrollAksjonspunkter.find(o=>o.aksjonspunktKode===d),s=!k&&gn(t,e)?Ae():void 0,g=Pe(`${N}.${e}.faktagruppe`,s);return!m||!v?null:a.jsxs(G,{gap:"space-12",children:[a.jsx(Be,{name:`${N}.${e}.totrinnskontrollGodkjent`,control:E,isReadOnly:l,hideLegend:!0,children:a.jsxs(P,{gap:"space-16",children:[a.jsx(C,{value:!0,size:"small",children:a.jsx(u,{id:"ApprovalField.Godkjent"})}),a.jsx(C,{value:!1,size:"small",children:a.jsx(u,{id:"ApprovalField.Vurder"})})]})}),k===!1&&a.jsx(we,{alignOffset:k?1:110,children:a.jsxs(G,{gap:"space-8",children:[a.jsx(ie,{size:"small",children:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),a.jsx(U,{size:"small",children:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),a.jsxs(G,{gap:"space-16",children:[a.jsx(G,{gap:"space-4",children:a.jsxs(P,{justify:"space-between",style:{width:"300px"},children:[a.jsxs(G,{gap:"space-4",children:[a.jsx(B,{name:`${N}.${e}.feilFakta`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilSkjønn`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilLov`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:l})]}),a.jsxs(G,{gap:"space-4",children:[a.jsx(B,{name:`${N}.${e}.feilUtredning`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilSaksflyt`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilBegrunnelse`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:l})]})]})}),g&&a.jsx(ce,{size:"small",children:g}),a.jsx(Oe,{name:`${N}.${e}.besluttersBegrunnelse`,control:E,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[Se,dn,kn,Ke],readOnly:l})]})]})})]})};oe.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"erSlettet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erEndret",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"erLagtTil",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}}],raw:"Array<foreldrepenger_domene_uttak_UttakPeriodeEndringDto>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Nn="_aksjonspunktTextContainer_1pwmv_5",Rn="_lenke_1pwmv_10",Q={aksjonspunktTextContainer:Nn,lenke:Rn},An="aksjonspunktGodkjenning",me=({behandling:e,totrinnskontrollSkjermlenkeContext:n,readOnly:l,erForeldrepengerFagsak:i,erTilbakekreving:t,skjemalenkeTyper:E,faktaOmBeregningTilfeller:T,lagLenke:d})=>{const{control:k,watch:m}=te(),{fields:v}=je({control:k,name:An}),s=m("aksjonspunktGodkjenning");return a.jsx(G,{gap:"space-24",children:v.map((g,o)=>{const{aksjonspunktKode:A}=s[o],L=n.find(S=>S.totrinnskontrollAksjonspunkter.some(D=>D.aksjonspunktKode===A)),y=L?.totrinnskontrollAksjonspunkter.find(S=>S.aksjonspunktKode===A);if(!L||!y)return null;const K=se(i,e.status,T,t,y,e.behandlingsresultat),I=E.find(S=>S.kode===L.skjermlenkeType),_=d(L.skjermlenkeType);return a.jsxs("div",{children:[_&&I&&a.jsx(ne,{to:_,onClick:()=>window.scroll(0,0),className:Q.lenke,children:I.navn}),K.map((S,D)=>a.jsx("div",{className:Q.aksjonspunktTextContainer,children:a.jsx(U,{size:"small",children:S})},A.concat("_".concat(D.toString())))),a.jsx(oe,{index:o,totrinnskontrollSkjermlenkeContext:n,readOnly:l})]},g.id)})})};me.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const X=(e=[])=>e.every(n=>n.totrinnskontrollGodkjent),Z=(e=[])=>e.every(n=>n.totrinnskontrollGodkjent!==void 0&&n.totrinnskontrollGodkjent!==null),Sn=(e,n)=>{if(!n)return!0;const{konsekvenserForYtelsen:l}=n;return!Array.isArray(l)||l.length!==1?!0:!e.some(i=>i===l[0])},Ln=e=>e.reduce((n,l)=>l===R.FEIL_FAKTA?{...n,feilFakta:!0}:l===R.FEIL_LOV?{...n,feilLov:!0}:l===R.FEIL_REGEL?{...n,feilSkjønn:!0}:l===R.SKJØNN?{...n,feilSkjønn:!0}:l===R.UTREDNING?{...n,feilUtredning:!0}:l===R.SAKSFLYT||l===R.ANNET?{...n,feilSaksflyt:!0}:l===R.BEGRUNNELSE?{...n,feilBegrunnelse:!0}:{},{}),pn=e=>({aksjonspunktGodkjenning:e.map(n=>n.totrinnskontrollAksjonspunkter).flat().map(n=>({aksjonspunktKode:n.aksjonspunktKode,totrinnskontrollGodkjent:n.totrinnskontrollGodkjent,besluttersBegrunnelse:ae(n.besluttersBegrunnelse??void 0),...Ln(n.vurderPaNyttArsaker?n.vurderPaNyttArsaker:[])}))}),ve=({behandling:e,onSubmit:n,forhandsvisVedtaksbrev:l,readOnly:i,erBehandlingEtterKlage:t,erForeldrepengerFagsak:E,skjemalenkeTyper:T,erTilbakekreving:d,totrinnskontrollSkjermlenkeContext:k,faktaOmBeregningTilfeller:m,lagLenke:v,beslutterFormData:s,setBeslutterFormData:g})=>{const o=e&&e.type===F.KLAGE,A=e&&e.type===F.ANKE,L=Sn([M.ENDRING_I_FORDELING_AV_YTELSEN,M.INGEN_ENDRING],e.behandlingsresultat),y=pn(k),K=he({defaultValues:s||y}),I=K.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?a.jsx(Ue,{formMethods:K,onSubmit:n,setDataOnUnmount:g,children:a.jsxs(G,{gap:"space-24",children:[!i&&a.jsx(Me,{children:a.jsx(u,{id:"HelpText.ToTrinnsKontroll"})}),a.jsx(me,{behandling:e,erForeldrepengerFagsak:E,erTilbakekreving:d,readOnly:i,totrinnskontrollSkjermlenkeContext:k,skjemalenkeTyper:T,faktaOmBeregningTilfeller:m,lagLenke:v}),a.jsxs(P,{gap:"space-16",style:{marginBottom:"50px"},children:[a.jsx(w,{variant:"primary",size:"small",disabled:!X(I)||!Z(I)||K.formState.isSubmitting,loading:K.formState.isSubmitting,children:a.jsx(u,{id:"ToTrinnsForm.Godkjenn"})}),a.jsx(w,{variant:"primary",size:"small",disabled:X(I)||!Z(I)||K.formState.isSubmitting,loading:K.formState.isSubmitting,children:a.jsx(u,{id:"ToTrinnsForm.SendTilbake"})}),!o&&!t&&!A&&!d&&L&&a.jsx(Ye,{href:"#",onClick:l,children:a.jsx(u,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};ve.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}},{key:"uttakPerioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Kn="_approvalItem_xqu47_1",In="_approvalItemContainer_xqu47_7",yn="_aksjonspunktTextContainer_xqu47_11",Dn="_resultatFraGodkjenningTextContainer_xqu47_16",Fn="_lenke_xqu47_20",bn="_checkmarkIcon_xqu47_24",Vn="_xmark_xqu47_30",V={approvalItem:Kn,approvalItemContainer:In,aksjonspunktTextContainer:yn,resultatFraGodkjenningTextContainer:Dn,lenke:Fn,checkmarkIcon:bn,xmark:Vn},Gn=({vurderPaNyttArsaker:e,vurderArsaker:n})=>a.jsx("div",{className:V.approvalItem,children:e?.map(l=>a.jsxs(P,{gap:"space-8",children:[a.jsx(Qe,{className:V.xmark}),a.jsx("div",{children:n.find(i=>l===i.kode)?.navn})]},l))}),_e=({behandling:e,totrinnskontrollSkjermlenkeContext:n,erForeldrepengerFagsak:l,erTilbakekreving:i,skjemalenkeTyper:t,vurderArsaker:E,faktaOmBeregningTilfeller:T,lagLenke:d})=>{const k=H();return a.jsxs(a.Fragment,{children:[a.jsx("div",{className:V.resultatFraGodkjenningTextContainer,children:a.jsx(u,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Ie}})}),n.map(m=>{const v=m.totrinnskontrollAksjonspunkter,s=t.find(g=>g.kode===m.skjermlenkeType);if(v.length>0){const g=d(m.skjermlenkeType);return a.jsxs(j.Fragment,{children:[g&&s&&a.jsx(ne,{to:g,onClick:()=>window.scroll(0,0),className:V.lenke,children:s.navn}),v.map(o=>{const A=se(l,e.status,T,i,o,e.behandlingsresultat);return a.jsxs("div",{className:V.approvalItemContainer,children:[A.map((L,y)=>a.jsx("div",{className:V.aksjonspunktTextContainer,children:a.jsx(U,{size:"small",children:L})},o.aksjonspunktKode.concat("_".concat(y.toString())))),a.jsx("div",{className:V.approvalItem,children:o.totrinnskontrollGodkjent?a.jsxs(P,{gap:"space-8",children:[a.jsx(Je,{title:k.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:V.checkmarkIcon}),a.jsx(u,{id:"ToTrinnsForm.Godkjent"})]}):a.jsx(Gn,{vurderPaNyttArsaker:o?.vurderPaNyttArsaker,vurderArsaker:E})}),a.jsx("pre",{className:V.approvalItem,children:ae(o.besluttersBegrunnelse??void 0)})]},o.aksjonspunktKode)})]},m.skjermlenkeType)}return null})]})};_e.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
>[]`}}]}}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ApData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const hn="_image_1t1ka_1",Un="_modal_1t1ka_9",ee={image:hn,modal:Un},qn=(e,n,l,i)=>e===F.TILBAKEKREVING?"FatterVedtakApprovalModal.Tilbakekreving":e===F.TILBAKEKREVING_REVURDERING?"FatterVedtakApprovalModal.TilbakekrevingRevurdering":e===F.KLAGE?"FatterVedtakApprovalModal.ModalDescriptionKlage":e===F.ANKE?"FatterVedtakApprovalModal.ModalDescriptionAnke":i?"FatterVedtakApprovalModal.UendretUtfall":n&&n.type===b.AVSLATT?"FatterVedtakApprovalModal.IkkeInnvilget":l?"FatterVedtakApprovalModal.OpphortVedtak":"FatterVedtakApprovalModal.InnvilgetVedtak",fn=(e,n)=>n===F.KLAGE?"FatterVedtakApprovalModal.ModalDescriptionKlage":n===F.ANKE?"FatterVedtakApprovalModal.ModalDescriptionAnke":e?"FatterVedtakApprovalModal.ModalDescriptionOpphort":"FatterVedtakApprovalModal.ModalDescriptionApproval",c=e=>e===h.FATTER_VEDTAK,wn=(e,n,l,i,t,E)=>e?c(n)?qn(l,i,t,E):"":"FatterVedtakApprovalModal.VedtakReturneresTilSaksbehandler",Mn=e=>c(e)?"FatterVedtakApprovalModal.Innvilget":"",Hn=(e,n,l)=>c(e)?fn(l,n):"FatterVedtakApprovalModal.ModalDescription",ke=({closeEvent:e,allAksjonspunktApproved:n,behandlingStatusKode:l,behandlingTypeKode:i,behandlingsresultat:t,harSammeResultatSomOriginalBehandling:E})=>{const T=H(),d=!!t&&t.type===b.OPPHOR,k=wn(n,l,i,t,d,E),m=Mn(l),v=Hn(l,i,d);return a.jsx(z,{className:ee.modal,open:!0,"aria-label":T.formatMessage({id:v}),onClose:e,children:a.jsx(z.Body,{children:a.jsxs(P,{justify:"space-between",align:"center",wrap:!1,children:[a.jsxs(P,{gap:"space-8",children:[a.jsx(xe,{className:ee.image,title:T.formatMessage({id:m})}),a.jsxs(G,{gap:"space-4",children:[a.jsx(ie,{size:"small",children:a.jsx(u,{id:k})}),a.jsx(U,{size:"small",children:a.jsx(u,{id:"FatterVedtakApprovalModal.GoToSearchPage"})})]})]}),a.jsx(w,{size:"small",variant:"primary",onClick:e,autoFocus:!0,type:"button",children:a.jsx(u,{id:"FatterVedtakApprovalModal.Ok"})})]})})})};ke.__docgenInfo={description:`FatterVedtakApprovalModal
...
| 'BT-007'
| 'BT-009'
| '-'`,elements:[{name:"literal",value:"'BT-002'"},{name:"literal",value:"'BT-003'"},{name:"literal",value:"'BT-004'"},{name:"literal",value:"'BT-008'"},{name:"literal",value:"'BT-006'"},{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"},{name:"literal",value:"'-'"}]},description:""},harSammeResultatSomOriginalBehandling:{required:!1,tsType:{name:"boolean"},description:""}}};const cn=re(Te),ge=({behandling:e,closeEvent:n,allAksjonspunktApproved:l})=>a.jsx(le,{value:cn,children:a.jsx(ke,{closeEvent:n,allAksjonspunktApproved:l,behandlingsresultat:e.behandlingsresultat??void 0,behandlingStatusKode:e.status,behandlingTypeKode:e.type,harSammeResultatSomOriginalBehandling:e.behandlingsresultat?.erRevurderingMedUendretUtfall||!1})});ge.__docgenInfo={description:"",methods:[],displayName:"FatterVedtakTotrinnskontrollModalSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Ne=({behandling:e,pushLocation:n,allAksjonspunktApproved:l})=>a.jsx(ge,{behandling:e,closeEvent:()=>{n("/")},allAksjonspunktApproved:l});Ne.__docgenInfo={description:"",methods:[],displayName:"BeslutterModalIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: number | null;
  uuid: string;
  versjon: number;
  type: foreldrepenger_behandlingslager_behandling_BehandlingType;
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}]},{name:"null"}],required:!0}}]}},{name:"null"}],required:!0}},{key:"ugunstAksjonspunkt",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}},{key:"behandlingKoet",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!0}}]}},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Yn=({fagsakData:e,valgtBehandlingUuid:n,beslutterFormData:l,setBeslutterFormData:i,toggleVisUtvidetBehandlingDetaljerKnapp:t})=>{const E=H(),[T,d]=f.useState(!1),[k,m]=f.useState(!1),v=e.getFagsak(),s=x(e.getBehandling(n)),g=be(s),o=ye(),A=De(),L=Ve(Ge()),{brukernavn:y,kanVeilede:K}=x(L.data).innloggetBruker,I=$e(s.type),{mutate:_}=$({mutationFn:p=>g.lagreTotrinnsaksjonspunkt(p)}),{mutate:S}=$({mutationFn:()=>g.forhåndsvisMelding({behandlingUuid:s.uuid}),onSuccess:p=>{Fe(p)}});if(!s.totrinnskontrollÅrsaker)return null;const D=p=>{const Re={behandlingUuid:s.uuid,behandlingVersjon:s.versjon,bekreftedeAksjonspunktDtoer:[p.fatterVedtakAksjonspunktDto]};m(p.erAlleAksjonspunktGodkjent),d(!0),_(Re)},Y=s.status===h.FATTER_VEDTAK;return a.jsxs(a.Fragment,{children:[a.jsx(ze,{tekst:E.formatMessage({id:Y?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),toggleVisUtvidetBehandlingDetaljerKnapp:t,children:a.jsx(de,{behandling:s,location:o,readOnly:y===s.ansvarligSaksbehandler||K,onSubmit:D,forhandsvisVedtaksbrev:S,fagsakYtelseType:v.fagsakYtelseType,alleKodeverk:I,createLocationForSkjermlenke:Ce,beslutterFormData:l,setBeslutterFormData:i})}),T&&a.jsx(Ne,{behandling:s,pushLocation:A,allAksjonspunktApproved:k})]})};Yn.__docgenInfo={description:`TotrinnskontrollIndex
...
Ansvarlig for att rita opp vilkår og aksjonspunkter med toTrinnskontroll`,methods:[],displayName:"TotrinnskontrollIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},beslutterFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{M as K,Qe as S,Yn as T};
