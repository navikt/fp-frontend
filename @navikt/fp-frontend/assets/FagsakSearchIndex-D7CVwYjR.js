import{j as e,o as k,Y as K,P as O,b as d,q as o}from"./iframe-MaBMuCwf.js";import{a as P,u as g,n as F}from"./fagsakApi-BSUxAMVn.js";import{u as M,C as V,k as U,c as y}from"./index.es-DFKHAP4K.js";import{T as i}from"./Table-BvNNXYAb.js";import{M as m}from"./message-Cp8kE35n.js";import{V as B,B as N,H as S,b as p}from"./VStack-DM1id9RI.js";import{S as H}from"./ExclamationmarkTriangleFill-CKE6YLjb.js";import{p as q}from"./paths-CmbuVXC0.js";import{a as Y}from"./index-QQVU0Fus.js";const _=({fagsaker:a,selectFagsakCallback:l,alleKodeverk:t})=>e.jsxs(i,{children:[e.jsx(i.Header,{children:e.jsxs(i.Row,{children:[e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Saksnummer"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Sakstype"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Status"})})]})}),e.jsx(i.Body,{children:a.map(n=>e.jsxs(i.Row,{onMouseDown:()=>l(n.saksnummer),onKeyDown:()=>l(n.saksnummer),children:[e.jsx(i.DataCell,{children:n.saksnummer}),e.jsx(i.DataCell,{children:t.FagsakYtelseType.find(r=>r.kode===n.fagsakYtelseType)?.navn??""}),e.jsx(i.DataCell,{children:t.FagsakStatus.find(r=>r.kode===n.status)?.navn??""})]},n.saksnummer))})]});_.__docgenInfo={description:`FagsakList
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const w="_container_tt7dx_1",J="_advarselIcon_tt7dx_6",A={container:w,advarselIcon:J},c=(a,l)=>!!(a||l===void 0||l.length<1),L=({searchStarted:a,searchResultAccessDenied:l,searchFagsakCallback:t})=>{const n=k(),r=M({defaultValues:{searchString:""}}),u=r.watch("searchString");return e.jsx(V,{formMethods:r,onSubmit:t,className:A.container,children:e.jsxs(B,{gap:"space-8",children:[e.jsx(N,{size:"small",children:e.jsx(m,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(S,{gap:"space-8",align:"end",children:[e.jsx(U,{name:"searchString",control:r.control,label:n.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[K]}),e.jsx(p,{variant:"primary",size:"small",loading:a,disabled:c(a,u),children:e.jsx(m,{id:"Search.Search"})})]}),l&&e.jsxs(S,{gap:"space-8",align:"end",children:[e.jsx(H,{className:A.advarselIcon}),e.jsx(N,{size:"small",children:e.jsx(m,{id:l.feilmelding})})]})]})})};L.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const C="_container_gwama_1",j="_label_gwama_9",s={container:C,label:j},I=({fagsaker:a,searchFagsakCallback:l,searchResultReceived:t,selectFagsakCallback:n,searchStarted:r,searchResultAccessDenied:u,alleKodeverk:v})=>e.jsxs("div",{className:s.container,children:[e.jsx(L,{searchFagsakCallback:l,searchStarted:r,searchResultAccessDenied:u}),t&&a.length===0&&e.jsx(N,{size:"small",className:s.label,children:e.jsx(m,{id:"FagsakSearch.ZeroSearchResults"})}),t&&a.length>1&&e.jsx(_,{fagsaker:a,selectFagsakCallback:n,alleKodeverk:v})]});I.__docgenInfo={description:`FagsakSearch
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const h={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},b=d(h),D=({fagsaker:a=[],searchFagsakCallback:l,searchResultReceived:t,selectFagsakCallback:n,searchStarted:r=!1,searchResultAccessDenied:u,alleKodeverk:v})=>e.jsx(O,{value:b,children:e.jsx(I,{fagsaker:a,searchFagsakCallback:l,searchResultReceived:t,selectFagsakCallback:n,searchStarted:r,searchResultAccessDenied:u,alleKodeverk:v})});D.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aktørId: string;
  barnFødt: string;
  endret?: string;
  fagsakYtelseType: foreldrepenger_behandlingslager_fagsak_FagsakYtelseType;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const f=()=>{const{kodeverkOptions:a,søkFagsak:l}=P(),{data:t}=g(a()),n=o(),r=E=>{E&&n(q(E))},{mutate:u,data:v=[],status:T,error:R}=y({mutationFn:E=>l(E.searchString),onSuccess:E=>{E.length===1&&r(E[0]?.saksnummer)}}),G=R&&R instanceof Y&&R.response.status===403&&"data"in R.response?R.response.data:void 0;return e.jsx(D,{fagsaker:v,searchFagsakCallback:u,searchResultReceived:T==="success",selectFagsakCallback:r,searchStarted:T==="pending",searchResultAccessDenied:G,alleKodeverk:F(t)})};f.__docgenInfo={description:`FagsakSearchIndex
