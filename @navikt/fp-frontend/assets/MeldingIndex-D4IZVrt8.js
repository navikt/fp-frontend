import{l as L,F as ee,j as a,t as V,G as ae,C as q,v as ne,x as le,P as H,b as j,r as y,n as re,I as b}from"./iframe-Cy7YGFMJ.js";import{n as p,g as c,u as te,h as ie,c as ue}from"./fagsakApi-Db5PW8qW.js";import{u as Ee,C as me,w as B,O as ve,c as O}from"./index.es-VUJZOykG.js";import{U as se}from"./UkjentAdresseMeldingIndex-BOVhkFZR.js";import{V as w,H as F,b as Y,M,L as Ne}from"./VStack-DI9-fY4c.js";import{L as oe}from"./Link-CGGWh9Mo.js";import{M as d}from"./message-DkdrPTGv.js";import{S as Te}from"./CheckmarkCircleFill-BMh4e7kx.js";import{u as f}from"./useKodeverk-io4pYnnJ.js";import{S as _e}from"./SupportHeader-1Lwe4RAr.js";import{S as Re}from"./SettPaVentReadOnlyModal-BtRW4jCB.js";import{A as de}from"./index.es-BPXwr0EW.js";const Ae="_bredde_jav4h_9",U={bredde:Ae},Ke=q(4e3),ge=q(1e4),Se=ne(3),J=({behandling:e,forhåndsvisBrev:n,submitCallback:t,revurderingVarslingArsak:E,fagsakYtelseType:m,kanVeilede:l,meldingFormData:i,setMeldingFormData:T,brukerManglerAdresse:R})=>{const v=L(),s=Ee({defaultValues:i??Oe(e)}),N=s.watch("brevmalkode"),A=s.watch("fritekst"),u=s.watch("arsakskode"),S=Ve(E,m),{formState:K,control:o}=s,g=r=>{N&&n({brevmalkode:N,fritekst:A,arsakskode:u}),r.preventDefault()},I=ee(e.språkkode),_=N==="VARREV";return a.jsx(me,{formMethods:s,onSubmit:r=>t(Fe(r)),setDataOnUnmount:T,children:a.jsxs(w,{gap:"space-16",children:[a.jsx(B,{name:"brevmalkode",control:o,label:v.formatMessage({id:"Messages.Template"}),validate:[V],selectValues:e.brevmaler.map(r=>a.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:U.bredde}),_&&a.jsx(B,{name:"arsakskode",control:o,label:v.formatMessage({id:"Messages.Årsak"}),validate:[V],selectValues:S.map(r=>a.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:U.bredde}),ke(N,u)&&a.jsx(ve,{name:"fritekst",control:o,label:v.formatMessage({id:Ie(N)}),validate:[V,_?ge:Ke,Se,le],maxLength:_?1e4:4e3,badges:[{type:"info",titleText:I}],parse:ae}),R&&a.jsx(se,{}),a.jsxs(F,{justify:"space-between",children:[(!_||u!==void 0)&&a.jsx(oe,{href:"#",onClick:g,onKeyDown:r=>r.key==="Enter"?g(r):null,children:a.jsx(d,{id:"Messages.Preview"})}),a.jsx(Y,{size:"small",variant:"primary",loading:K.isSubmitting,disabled:K.isSubmitting||l,children:a.jsx(d,{id:"Messages.Submit"})})]})]})})},Ie=e=>e==="INNOPP"||e==="INNHEN"?"Messages.DocumentList":"Messages.Fritekst",ke=(e,n)=>e==="INNOPP"||e==="KORRIGVARS"||e==="VARS"||e==="INNHEN"||e==="VARREV"&&n==="ANNET",Ve=(e,n)=>n==="ES"?e.filter(t=>t.kode==="BARNIKKEREG"||t.kode==="ANNET"):n==="SVP"?e.filter(t=>t.kode!=="BARNIKKEREG"&&t.kode!=="AKTIVITET"):e,Oe=e=>{const n={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...n,brevmalkode:"VARREV"}:{...n}},Fe=e=>{const n=e;return e.brevmalkode==="VARREV"&&n.arsakskode!=="ANNET"&&(n.fritekst=" "),n};J.__docgenInfo={description:`Messages
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""}}};const De="_image_v04s1_1",Ge="_modal_v04s1_8",h={image:De,modal:Ge},z=({showModal:e,closeEvent:n})=>{const t=L();return a.jsx(M,{className:h.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:n,children:a.jsx(M.Body,{children:a.jsxs(F,{justify:"space-between",align:"center",children:[a.jsxs(F,{gap:"space-8",align:"center",children:[a.jsx(Te,{className:h.image,title:t.formatMessage({id:"MessagesModal.description"})}),a.jsx(Ne,{size:"small",children:a.jsx(d,{id:"MessagesModal.text"})})]}),a.jsx(Y,{size:"small",variant:"primary",onClick:n,autoFocus:!0,type:"button",children:a.jsx(d,{id:"MessagesModal.OK"})})]})})})};z.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Pe=j(x),Q=e=>a.jsx(H,{value:Pe,children:a.jsx(z,{...e})});Q.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const ye=e=>e.behandlingPåVent?e.fristBehandlingPåVent:void 0,be=({fagsakData:e,valgtBehandlingUuid:n,meldingFormData:t,setMeldingFormData:E,hentOgSettBehandling:m,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const i=L(),[T,R]=y.useState(!1),[v,s]=y.useState(!1),N=re(),A=e.getFagsak(),u=p(e.getBehandling(n)),S=c(u),K=te(ue()),{innloggetBruker:{kanVeilede:o}}=p(K.data),g=f("Venteårsak"),I=f("RevurderingVarslingÅrsak"),{mutateAsync:_,status:r}=O({mutationFn:k=>S.sendMelding(k)}),$=pe(s,_,m,R,E,u),W=()=>{N("/")},X=Me(u),Z=()=>(s(!1),m()),D=r==="success",G=u.behandlingTillatteOperasjoner,P=!o&&e.getAlleBehandlinger().some(k=>!k.avsluttet)&&G?.behandlingKanSendeMelding;return a.jsxs(a.Fragment,{children:[v&&a.jsx(Q,{showModal:D&&v,closeEvent:Z}),a.jsx(_e,{tekst:i.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:a.jsxs(w,{gap:"space-16",children:[!P&&a.jsx(de,{variant:"info",children:a.jsx(d,{id:Be(o,G?.behandlingKanSendeMelding)})}),P&&a.jsx(C,{submitCallback:$,behandling:u,forhåndsvisBrev:X,revurderingVarslingArsak:I,fagsakYtelseType:A.fagsakYtelseType,kanVeilede:o,meldingFormData:t,setMeldingFormData:E,brukerManglerAdresse:A.brukerManglerAdresse})]})}),D&&T&&a.jsx(Re,{lukkCallback:W,ventearsak:"AVV_DOK",ventearsaker:g,frist:ye(u)})]})},pe=(e,n,t,E,m,l)=>i=>{const T=i.brevmalkode==="INNOPP"||i.brevmalkode==="VARREV"||i.brevmalkode==="ELYSIM",R=l.type==="BT-007"||l.type==="BT-009";e(!T);const v=R?{behandlingUuid:l.uuid,fritekst:i.fritekst,brevmalkode:i.brevmalkode}:{behandlingUuid:l.uuid,brevmalkode:i.brevmalkode,fritekst:i.fritekst,arsakskode:i.arsakskode};return n(v).then(()=>{m(),T?E(!0):t()})},Be=(e,n)=>n?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Me=e=>{const n=c(e),{mutate:t}=O({mutationFn:l=>n.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:l.brevmalkode,fritekst:l.fritekst||" ",arsakskode:l.arsakskode}),onSuccess:l=>{b(l)}}),{mutate:E}=O({mutationFn:l=>ie(e.uuid,l.brevmalkode,l.fritekst??" "),onSuccess:l=>{b(l)}}),m=e.type==="BT-007"||e.type==="BT-009";return l=>{m?E(l):t(l)}};be.__docgenInfo={description:`MeldingIndex
