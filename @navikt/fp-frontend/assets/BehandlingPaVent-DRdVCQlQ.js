import{r,j as T}from"./iframe-BAq1qRCa.js";import{c as _}from"./index.es-C411DjXz.js";import{A}from"./index-D5xXlOeG.js";import{S}from"./SettPaVentModalIndex-6U7RqpAr.js";import{e as I}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as L}from"./behandlingApi-BMuLda0t.js";const D=({behandling:e,kodeverk:E,opneSokeside:t,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=r.useState(!a&&e.behandlingPåVent),m=()=>n(!1),N=L(e),{mutate:v}=_({mutationFn:l=>N.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>t()});r.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const R=e.aksjonspunkt.filter(I).some(l=>l.definisjon===A.AUTO_MANUELT_SATT_PÅ_VENT);return T.jsx(S,{submitCallback:v,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:R,ventearsaker:E.Venteårsak,erTilbakekreving:i,showModal:u})};D.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
