import{j as e,h as g,P as v,b as p,L as y}from"./iframe-CJgyfo9_.js";import{Q as f}from"./index.es-BFCB1ROu.js";import{u as q,f as _}from"./fagsakApi-NMkvHp61.js";import{V as c}from"./VisittkortSakIndex-CaG09V2C.js";import{V as j,a as N,B as A}from"./VStack-BQ5ULrV2.js";import{M as o}from"./message-CCWpKOrj.js";import{E as w}from"./IngenBehandlingValgtPanel-Yi9doiJ5.js";import{u as R}from"./useTrackRouteParam-tb3JUEew.js";import{p as E}from"./paths-C0_J2Xea.js";import{u as d}from"./useKodeverk-Dtnufv23.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
