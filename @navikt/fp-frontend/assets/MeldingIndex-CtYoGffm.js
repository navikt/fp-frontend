import{l as O,G as ee,j as a,t as V,H as ae,C as q,q as ne,N as le,P as H,e as j,r as y,m as re,I as b}from"./iframe-Bjvmf2qi.js";import{n as p,g as w,u as te,h as ie,c as ue}from"./fagsakApi--DZ1Llm-.js";import{u as Ee,P as me,w as B,O as se,d as L}from"./index.es-BTcmkRoI.js";import{U as ve}from"./UkjentAdresseMeldingIndex-CSe8GnGP.js";import{V as c,H as F,b as J,M,L as oe}from"./VStack-ReWzM-bs.js";import{L as Te}from"./Link-LhaT3Zgt.js";import{M as A}from"./message-Cj7-Y_zt.js";import{S as Ne}from"./CheckmarkCircleFill-BdfSHRbZ.js";import{u as h}from"./useKodeverk-DnIfr8LO.js";import{S as de}from"./SupportHeader-DPT_MyUg.js";import{S as Re}from"./SettPaVentReadOnlyModal-BDfOd6Nm.js";import{A as Ae}from"./index.es-4JtuKZ5y.js";const _e="_bredde_jav4h_9",f={bredde:_e},ke=q(4e3),ge=q(1e4),Ke=ne(3),Y=({behandling:e,forhåndsvisBrev:n,submitCallback:t,revurderingVarslingArsak:E,fagsakYtelseType:m,kanVeilede:l,meldingFormData:i,setMeldingFormData:N,brukerManglerAdresse:R})=>{const s=O(),v=Ee({defaultValues:i??Le(e)}),o=v.watch("brevmalkode"),_=v.watch("fritekst"),u=v.watch("arsakskode"),K=Ve(E,m),{formState:k,control:T}=v,g=r=>{o&&n({brevmalkode:o,fritekst:_,arsakskode:u}),r.preventDefault()},I=ee(e.språkkode),d=o==="VARREV";return a.jsx(me,{formMethods:v,onSubmit:r=>t(Fe(r)),setDataOnUnmount:N,children:a.jsxs(c,{gap:"space-16",children:[a.jsx(B,{name:"brevmalkode",control:T,label:s.formatMessage({id:"Messages.Template"}),validate:[V],selectValues:e.brevmaler.map(r=>a.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:f.bredde}),d&&a.jsx(B,{name:"arsakskode",control:T,label:s.formatMessage({id:"Messages.Årsak"}),validate:[V],selectValues:K.map(r=>a.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:f.bredde}),Se(o,u)&&a.jsx(se,{name:"fritekst",control:T,label:s.formatMessage({id:Ie(o)}),validate:[V,d?ge:ke,Ke,le],maxLength:d?1e4:4e3,badges:[{type:"info",titleText:I}],parse:ae}),R&&a.jsx(ve,{}),a.jsxs(F,{justify:"space-between",children:[(!d||u!==void 0)&&a.jsx(Te,{href:"#",onClick:g,onKeyDown:r=>r.key==="Enter"?g(r):null,children:a.jsx(A,{id:"Messages.Preview"})}),a.jsx(J,{size:"small",variant:"primary",loading:k.isSubmitting,disabled:k.isSubmitting||l,children:a.jsx(A,{id:"Messages.Submit"})})]})]})})},Ie=e=>e==="INNOPP"||e==="INNHEN"?"Messages.DocumentList":"Messages.Fritekst",Se=(e,n)=>e==="INNOPP"||e==="KORRIGVARS"||e==="VARS"||e==="INNHEN"||e==="VARREV"&&n==="ANNET",Ve=(e,n)=>n==="ES"?e.filter(t=>t.kode==="BARNIKKEREG"||t.kode==="ANNET"):n==="SVP"?e.filter(t=>t.kode!=="BARNIKKEREG"&&t.kode!=="AKTIVITET"):e,Le=e=>{const n={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return"ugunstAksjonspunkt"in e&&e.ugunstAksjonspunkt?{...n,brevmalkode:"VARREV"}:{...n}},Fe=e=>{const n=e;return e.brevmalkode==="VARREV"&&n.arsakskode!=="ANNET"&&(n.fritekst=" "),n};Y.__docgenInfo={description:`Messages
