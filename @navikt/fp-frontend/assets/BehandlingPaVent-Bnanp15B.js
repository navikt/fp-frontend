import{r as E,j as T}from"./iframe-BNz9Gz6N.js";import{d as _}from"./index.es-DYX0J9Hu.js";import{A}from"./index-Df7nniOG.js";import{S}from"./SettPaVentModalIndex-Da_lHgZ2.js";import{e as I}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as L}from"./behandlingApi-DXqNXU3f.js";const D=({behandling:e,kodeverk:r,opneSokeside:t,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=E.useState(!a&&e.behandlingPåVent),N=()=>n(!1),m=L(e),{mutate:v}=_({mutationFn:l=>m.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>t()});E.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const R=e.aksjonspunkt.filter(I).some(l=>l.definisjon===A.AUTO_MANUELT_SATT_PÅ_VENT);return T.jsx(S,{submitCallback:v,cancelEvent:N,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:R,ventearsaker:r.Venteårsak,erTilbakekreving:i,showModal:u})};D.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"union",raw:"BehandlingFpSak | BehandlingFpTilbake",elements:[{name:"signature",type:"object",raw:`{
