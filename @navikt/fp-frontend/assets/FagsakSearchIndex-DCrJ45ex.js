import{j as e,o as S,Z as F,P as q,b as P,q as I}from"./iframe-DxBGhe85.js";import{a as K,u as L,n as B}from"./fagsakApi-Cr69pJmQ.js";import{u as O,C as D,k as c,c as V}from"./index.es-DVY-DUkI.js";import{T as s}from"./Table-DmABViTv.js";import{M as k}from"./message-CMqikXS5.js";import{V as _,B as v,H as g,b as G}from"./VStack-CgP3hDag.js";import{S as j}from"./ExclamationmarkTriangleFill-DhGA7rwZ.js";import{p as h}from"./paths-tfiuOHgF.js";import{a as w}from"./index-BSz0lxou.js";const E=({fagsaker:a,selectFagsakCallback:r,alleKodeverk:t})=>e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(k,{id:"FagsakList.Saksnummer"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(k,{id:"FagsakList.Sakstype"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(k,{id:"FagsakList.Status"})})]})}),e.jsx(s.Body,{children:a.map(n=>e.jsxs(s.Row,{onMouseDown:()=>r(n.saksnummer),onKeyDown:()=>r(n.saksnummer),children:[e.jsx(s.DataCell,{children:n.saksnummer}),e.jsx(s.DataCell,{children:t.FagsakYtelseType.find(l=>l.kode===n.fagsakYtelseType)?.navn??""}),e.jsx(s.DataCell,{children:t.FagsakStatus.find(l=>l.kode===n.status)?.navn??""})]},n.saksnummer))})]});E.__docgenInfo={description:`FagsakList
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const M="_container_tt7dx_1",U="_advarselIcon_tt7dx_6",y={container:M,advarselIcon:U},f=(a,r)=>!!(a||r===void 0||r.length<1),T=({searchStarted:a,searchResultAccessDenied:r,searchFagsakCallback:t})=>{const n=S(),l=O({defaultValues:{searchString:""}}),i=l.watch("searchString");return e.jsx(D,{formMethods:l,onSubmit:t,className:y.container,children:e.jsxs(_,{gap:"space-8",children:[e.jsx(v,{size:"small",children:e.jsx(k,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(g,{gap:"space-8",align:"end",children:[e.jsx(c,{name:"searchString",control:l.control,label:n.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[F]}),e.jsx(G,{variant:"primary",size:"small",loading:a,disabled:f(a,i),children:e.jsx(k,{id:"Search.Search"})})]}),r&&e.jsxs(g,{gap:"space-8",align:"end",children:[e.jsx(j,{className:y.advarselIcon}),e.jsx(v,{size:"small",children:e.jsx(k,{id:r.feilmelding})})]})]})})};T.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const H="_container_gwama_1",b="_label_gwama_9",p={container:H,label:b},R=({fagsaker:a,searchFagsakCallback:r,searchResultReceived:t,selectFagsakCallback:n,searchStarted:l,searchResultAccessDenied:i,alleKodeverk:d})=>e.jsxs("div",{className:p.container,children:[e.jsx(T,{searchFagsakCallback:r,searchStarted:l,searchResultAccessDenied:i}),t&&a.length===0&&e.jsx(v,{size:"small",className:p.label,children:e.jsx(k,{id:"FagsakSearch.ZeroSearchResults"})}),t&&a.length>1&&e.jsx(E,{fagsaker:a,selectFagsakCallback:n,alleKodeverk:d})]});R.__docgenInfo={description:`FagsakSearch
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Y={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},x=P(Y),A=({fagsaker:a=[],searchFagsakCallback:r,searchResultReceived:t,selectFagsakCallback:n,searchStarted:l=!1,searchResultAccessDenied:i,alleKodeverk:d})=>e.jsx(q,{value:x,children:e.jsx(R,{fagsaker:a,searchFagsakCallback:r,searchResultReceived:t,selectFagsakCallback:n,searchStarted:l,searchResultAccessDenied:i,alleKodeverk:d})});A.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aktørId: string;
  barnFødt: string;
  endret?: string;
  fagsakYtelseType: foreldrepenger_behandlingslager_fagsak_FagsakYtelseType;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const C=()=>{const{kodeverkOptions:a,søkFagsak:r}=K(),{data:t}=L(a()),n=I(),l=u=>{u&&n(h(u))},{mutate:i,data:d=[],status:o,error:m}=V({mutationFn:u=>r(u.searchString),onSuccess:u=>{u.length===1&&l(u[0]?.saksnummer)}}),N=m&&m instanceof w&&m.response.status===403&&"data"in m.response?m.response.data:void 0;return e.jsx(A,{fagsaker:d,searchFagsakCallback:i,searchResultReceived:o==="success",selectFagsakCallback:l,searchStarted:o==="pending",searchResultAccessDenied:N,alleKodeverk:B(t)})};C.__docgenInfo={description:`FagsakSearchIndex
