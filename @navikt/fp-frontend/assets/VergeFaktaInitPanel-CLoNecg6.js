import{r as v,l as A,j as s,bA as I,bB as D,ba as O}from"./iframe-CATwZ9H1.js";import{Z as L}from"./index.es-DbVcImu2.js";import{u as y}from"./fagsakApi-BbPOB7xa.js";import{V as P}from"./BehandlingMenuIndex-Dqcg6-zu.js";import{A as V}from"./index-GSdOhVlN.js";import{u as F,c as G}from"./behandlingApi-DnyY4nfh.js";import{u as d}from"./FagsakIndex-fdz0LGO0.js";import{G as b}from"./index.es-CuudOWhY.js";import{H as M}from"./VStack-BlQMLbO0.js";import{S as f}from"./ExclamationmarkTriangleFill-BG0YUmUO.js";import{e as T}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as B,g as q}from"./useStandardProsessPanelProps-CBubtgwO.js";const U=e=>{const[l,a]=v.useState([]),t=r=>{a(u=>{const n=[...u],E=n.findIndex(i=>i.id===r.id);return E>=0?n.splice(E,1,r):n.push(r),n}),e?.(r.harÅpentAksjonspunkt?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:l.filter(r=>r.skalVisesIMeny),settFaktaPanelMenyData:t}},j="_container_4o186_1",w="_content_4o186_6",c="_sideMenu_4o186_19",g={container:j,content:w,sideMenu:c},h=({valgtFaktaSteg:e,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:a,children:t})=>{const r=A(),{oppdaterProsessStegOgFaktaPanelIUrl:u}=d(),{faktaPanelMenyData:n,settFaktaPanelMenyData:E}=U(a),i=n.length>0;return s.jsxs(M,{className:g.container,wrap:!1,children:[i&&s.jsx("div",{className:g.sideMenu,"data-testid":"fakta-meny",children:s.jsx(b,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(m=>({label:m.tekst,active:m.erAktiv,icon:m.harÅpentAksjonspunkt?s.jsx(f,{color:"var(--ax-warning-700)"}):void 0})),onClick:m=>{u(l,n[m].id)}})}),s.jsx("div",{className:g.content,children:s.jsx(H,{valgtFaktaSteg:e,settFaktaPanelMenyData:E,faktaPanelMenyData:n,children:t})})]})},N=v.createContext({}),H=e=>{const{children:l,...a}=e,t=v.useMemo(()=>a,[a]);return s.jsx(N.Provider,{value:t,children:l})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",Y=(e,l,a,t)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:u}=v.use(N),n=a&&(r===e||t&&r===J);return v.useEffect(()=>{u({id:e,tekst:l,erAktiv:n,harÅpentAksjonspunkt:t,skalVisesIMeny:a})},[a,n,t]),a&&n},p=({standardPanelProps:e,skalPanelVisesIMeny:l,faktaPanelKode:a,faktaPanelMenyTekst:t,children:r})=>{const{behandling:u,fagsak:n,alleKodeverk:E}=d(),i=Y(a,t,l,e.harÅpentAksjonspunkt);return s.jsx(I,{behandling:u,children:i?s.jsx(D,{behandling:u,fagsak:n,alleKodeverk:E,alleMerknaderFraBeslutter:e.alleMerknaderFraBeslutter,aksjonspunkterForPanel:e.aksjonspunkterForPanel,harÅpentAksjonspunkt:e.harÅpentAksjonspunkt,isReadOnly:e.isReadOnly,isSubmittable:e.isSubmittable,submitCallback:e.submitCallback,children:r}):null})};p.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  behandling: T;
...
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"AnnenforelderUttakEøsPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpentAksjonspunkt: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const R="default",k="default",C=(e=[])=>{const{behandling:l,rettigheter:a,fagsak:t,lagreAksjonspunkter:r,lagreOverstyrteAksjonspunkter:u,oppdaterProsessStegOgFaktaPanelIUrl:n,alleKodeverk:E}=d(),i=l.aksjonspunkt.filter(o=>e.includes(o.definisjon)),m=e.filter(o=>o.startsWith("6")),_=B(l,[],a,!1),S=q(l.status,i),K=x(t,l,n,r,u,m);return{behandling:l,isSubmittable:!i.some(T)||i.some(o=>o.kanLoses),harÅpentAksjonspunkt:i.some(o=>T(o)&&o.kanLoses),alleKodeverk:E,aksjonspunkterForPanel:i,isReadOnly:_,alleMerknaderFraBeslutter:S,submitCallback:K}},x=(e,l,a,t,r,u)=>n=>{const i=(Array.isArray(n)?n:[n]).map(_=>({"@type":_.kode,..._})),m={saksnummer:e.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(u.length>0){if(i.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(u.includes(i[0]?.kode??""))return r({...m,overstyrteAksjonspunktDtoer:i}).then(()=>{a(k,R),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...m,bekreftedeAksjonspunktDtoer:i}).then(()=>{a(k,R),globalThis.scrollTo({top:0,behavior:"smooth"})})},Z=[V.AVKLAR_VERGE],W=()=>{const e=A(),l=C(Z),{behandling:a}=d(),t=F(a),r=G(a,"VERGE"),{data:u,isFetching:n}=y(t.vergeOptions(a,r));return s.jsx(p,{standardPanelProps:l,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:e.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:r,children:n?s.jsx(L,{}):s.jsx(P,{verge:u,alleKodeverk:l.alleKodeverk})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{p as F,W as V,h as a,C as u};
