...
| '-'`,elements:[{name:"literal",value:"'ADPSJN'"},{name:"literal",value:"'OMSRGO'"},{name:"literal",value:"'FODSL'"},{name:"literal",value:"'TERM'"},{name:"literal",value:"'-'"}],required:!1}}]}}],raw:`Readonly<{
  ...
  dokumenter?: JournalDokument[];
  fagsaker?: JournalFagsak[];
}>`},description:""},harHentetFerdigJournalpost:{required:!0,tsType:{name:"boolean"},description:""},antallOppgaver:{required:!1,tsType:{name:"number"},description:""}}};const P=Mn.extend({retry:0,timeout:15e3,hooks:{beforeRequest:[n=>{const r=`CallId_${Date.now()}_${Math.floor(Math.random()*1e9)}`;n.headers.set("Nav-Callid",r)}]}}),D=n=>n,O={ALLE_JOURNAL_OPPGAVER:D("/fpfordel/api/journalfoering/oppgaver"),HENT_JOURNALPOST_DETALJER:D("/fpfordel/api/journalfoering/oppgave/detaljer"),FERDIGSTILL_JOURNALFØRING:D("/fpfordel/api/sak/ferdigstill"),KNYTT_JOURNALPOST_TIL_ANNEN_SAK:D("/fpfordel/api/sak/knyttTilAnnenSak"),OPPDATER_MED_BRUKER:D("/fpfordel/api/journalfoering/bruker/oppdater"),HENT_BRUKER:D("/fpfordel/api/journalfoering/bruker/hent"),RESERVER_OPPGAVE:D("/fpfordel/api/journalfoering/oppgave/reserver"),FLYTT_OPPGAVE_TIL_GOSYS:D("/fpfordel/api/journalfoering/oppgave/tilgosys")},Ue=n=>Bn({queryKey:[O.ALLE_JOURNAL_OPPGAVER,n],queryFn:()=>P.get(O.ALLE_JOURNAL_OPPGAVER,{searchParams:{ident:n??""}}).json(),enabled:n!==void 0,staleTime:1/0}),fr=n=>P.get(O.HENT_JOURNALPOST_DETALJER,{searchParams:{journalpostId:n}}).json(),jr=n=>P.post(O.FERDIGSTILL_JOURNALFØRING,{json:n}).json(),hr=n=>P.post(O.KNYTT_JOURNALPOST_TIL_ANNEN_SAK,{json:n}).json(),br=n=>P.post(O.OPPDATER_MED_BRUKER,{json:n}).json(),xr=n=>P.post(O.HENT_BRUKER,{json:{fødselsnummer:n}}).json(),Sr=n=>P.post(O.RESERVER_OPPGAVE,{json:n}).json(),Ir=n=>P.post(O.FLYTT_OPPGAVE_TIL_GOSYS,{json:{journalpostId:n}}).json(),_r=new Set(["FEILREGISTRERT","JOURNALFOERT","EKSPEDERT","FERDIGSTILT"]),z=n=>!!n&&_r.has(n),Tr="_ikon_8fc4d_1",Er="_ikonKol_8fc4d_7",$={ikon:Tr,ikonKol:Er},qr=n=>{const r=n.avsender.id;return r&&r.length===9?e.jsx(Hn,{className:$.ikon}):e.jsx(ge,{className:$.ikon})},ie=({navn:n,id:r,ikon:a,title:t})=>e.jsxs(j,{gap:"space-8",children:[t&&e.jsx(I,{size:"small",level:"4",children:t}),e.jsxs(b,{gap:"space-16",children:[e.jsx("div",{className:$.ikonKol,children:a}),e.jsxs("div",{children:[e.jsx(q,{children:n}),e.jsxs(b,{gap:"space-4",align:"center",children:[e.jsx(q,{children:r}),e.jsx(Ve,{copyText:r,variant:"action",size:"small"})]})]})]})]}),Ge=({journalpost:n,hentForhåndsvisningAvSøker:r,skalKunneEndreSøker:a,brukerTilForhåndsvisning:t,knyttSøkerTilJournalpost:i,lasterBruker:d})=>{const o=C(),[g,u]=y.useState(void 0),[k,p]=y.useState(void 0),m=()=>{k&&i({journalpostId:n.journalpostId,fødselsnummer:k})},v=f=>{f?Ie(f)?(p(f),u(void 0),r(f)):u(o.formatMessage({id:"ValgtOppgave.Søk.BrukerFeil"},{fødselsnummer:f})):u(void 0)},h=f=>{if(f.key==="Enter"){const x=f.currentTarget.value;v(x)}};return e.jsxs(j,{gap:"space-16",children:[a&&e.jsxs(j,{gap:"space-8",children:[e.jsx(I,{size:"small",level:"4",children:e.jsx(s,{id:"ValgtOppgave.Søker"})}),e.jsx(W,{variant:"warning",size:"small",children:e.jsx(s,{id:"ValgtOppgave.Søk.Bruker"})}),e.jsx(ee,{label:o.formatMessage({id:"ValgtOppgave.Søk.FinnBruker"}),onKeyDown:h,onSearchClick:v,hideLabel:!1,children:e.jsx(ee.Button,{type:"button",loading:d})}),g&&e.jsx(Kn,{children:g}),t&&e.jsxs(j,{gap:"space-16",children:[e.jsx(ie,{navn:t.navn,id:t.fødselsnummer,ikon:e.jsx(ge,{className:$.ikon})}),e.jsx(E,{type:"button",onClick:m,children:e.jsx(s,{id:"ValgtOppgave.Søk.KnyttTil"})})]})]}),n.bruker?.navn&&e.jsx(ie,{navn:n.bruker.navn,id:n.bruker.fnr,ikon:e.jsx(ge,{className:$.ikon}),title:e.jsx(s,{id:"ValgtOppgave.Søker"})}),n.avsender.navn&&e.jsx(ie,{navn:n.avsender.navn,id:n.avsender.id,ikon:qr(n),title:e.jsx(s,{id:"ValgtOppgave.Avsender"})})]})};Ge.__docgenInfo={description:"BrukerAvsenderPanel - Inneholder detaljer om bruker og avsender",methods:[],displayName:"BrukerAvsenderPanel",props:{journalpost:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  journalpostId: string;
  tittel?: string;
  kanal?: JournalKanal;
  bruker: JournalBruker | null;
...
| '-'`,elements:[{name:"literal",value:"'ADPSJN'"},{name:"literal",value:"'OMSRGO'"},{name:"literal",value:"'FODSL'"},{name:"literal",value:"'TERM'"},{name:"literal",value:"'-'"}],required:!1}}]}}],raw:`Readonly<{
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}},{key:"utbetalingsgrad",value:{name:"number",required:!0}}]}}],raw:"Array<tjenester_infotrygd_InfotrygdVedtakDto_Utbetaling>",required:!1}}]}}],raw:"Array<tjenester_infotrygd_InfotrygdVedtakDto_Vedtak>",required:!0}}]}}],raw:"Array<tjenester_infotrygd_InfotrygdVedtakDto_VedtakKjede>",required:!0}}]}},description:""}}};const Tt="_content_11o11_1",Et={content:Tt},qt=({headerHeight:n,navAnsatt:r})=>{const a=C(),{søkInfotrygd:t}=Nn(),{addErrorMessage:i,removeErrorMessages:d}=On(),[o,g]=y.useState(!0),u=()=>{g(!1)};y.useEffect(()=>{o||i({type:Rn.GENERAL_ERROR,message:a.formatMessage({id:"Los.IkkeTilgjengelig"})})},[o]);const k=Sn(),p=(_,T)=>{k(ar(_,T))},m=In();y.useEffect(()=>{m.pathname==="/"&&d()},[m]);const{mutate:v,isPending:h,isSuccess:f,data:x}=V({mutationFn:_=>t(_.searchString)});return e.jsx("div",{className:Et.content,style:{margin:`${n}px auto 0`},children:e.jsxs(_n,{children:[e.jsx(w,{path:"/",element:o?e.jsx($n,{setLosErIkkeTilgjengelig:u,åpneFagsak:p,navAnsatt:ue(r)}):e.jsx(Xn,{})}),e.jsx(w,{path:er,element:e.jsx(un,{navAnsatt:r})}),e.jsx(w,{path:nr,element:e.jsx(yn,{søkInfotrygdVedtak:v,isPending:h,isSuccess:f,infotrygdVedtak:x})}),e.jsx(w,{path:rr,element:e.jsx(Qn,{children:e.jsx(Wn,{})})}),e.jsx(w,{path:tr,element:e.jsx(Zn,{})}),e.jsx(w,{path:"*",element:e.jsx(Pn,{renderSomLenke:_=>e.jsx(Tn,{to:"/",children:_})})})]})})};qt.__docgenInfo={description:`Home
