import{r as o,l as k,j as s,bB as D,bC as L,bb as O}from"./iframe-Xksnnj6k.js";import{Z as y}from"./index.es-CUVc35Qo.js";import{u as P}from"./fagsakApi-DfxwXqpg.js";import{V}from"./BehandlingMenuIndex-BhRglpfU.js";import{A as G}from"./index-DCMYimu4.js";import{u as F,c as b}from"./behandlingApi-CynmyRb-.js";import{B as d}from"./FagsakIndex-BUHRNcCE.js";import{G as M}from"./index.es-DBDFfLOj.js";import{H as f}from"./VStack-CLLk2YE-.js";import{S as B}from"./ExclamationmarkTriangleFill-Bod7M64j.js";import{e as R}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-D0xJ3dtN.js";const j=a=>{const[r,e]=o.useState([]),t=l=>{e(i=>{const n=[...i],E=n.findIndex(u=>u.id===l.id);return E>=0?n.splice(E,1,l):n.push(l),n}),a?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",c="_sideMenu_4o186_19",T={container:w,content:h,sideMenu:c},H=({valgtFaktaSteg:a,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=k(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=o.use(d),{faktaPanelMenyData:n,settFaktaPanelMenyData:E}=j(e),u=n.length>0;return s.jsxs(f,{className:T.container,wrap:!1,children:[u&&s.jsx("div",{className:T.sideMenu,"data-testid":"fakta-meny",children:s.jsx(M,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(m=>({label:m.tekst,active:m.erAktiv,icon:m.harÅpentAksjonspunkt?s.jsx(B,{color:"var(--ax-warning-700)"}):void 0})),onClick:m=>{i(r,n[m].id)}})}),s.jsx("div",{className:T.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:E,faktaPanelMenyData:n,children:t})})]})},A=o.createContext({}),J=a=>{const{children:r,...e}=a,t=o.useMemo(()=>e,[e]);return s.jsx(A.Provider,{value:t,children:r})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",C=(a,r,e,t)=>{const{valgtFaktaSteg:l,settFaktaPanelMenyData:i}=o.use(A),n=e&&(l===a||t&&l===Y);return o.useEffect(()=>{i({id:a,tekst:r,erAktiv:n,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,n,t]),e&&n},S=({standardPanelProps:a,skalPanelVisesIMeny:r,faktaPanelKode:e,faktaPanelMenyTekst:t,children:l})=>{const{behandling:i,fagsak:n,alleKodeverk:E}=o.use(d),u=C(e,t,r,a.harÅpentAksjonspunkt);return s.jsx(D,{behandling:i,children:u?s.jsx(L,{behandling:i,fagsak:n,alleKodeverk:E,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpentAksjonspunkt:a.harÅpentAksjonspunkt,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,isSubmittable:a.isSubmittable,children:l}):null})};S.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'FP_VK_8F'
| 'FP_VK_16S'
| '-'`,elements:[{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_8F'"},{name:"literal",value:"'FP_VK_16S'"},{name:"literal",value:"'-'"}],required:!0}},{key:"omsorgsovertakelseDato",value:{name:"string",required:!0}},{key:"fødselsdatoer",value:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ fødselsdato: string; barnNummer: number }",signature:{properties:[{key:"fødselsdato",value:{name:"string",required:!0}},{key:"barnNummer",value:{name:"number",required:!0}}]}}],raw:"{ fødselsdato: string; barnNummer: number }[]",required:!0}},{key:"ektefellesBarn",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]},{name:"intersection",raw:`{
  avslagskode?: string;
...
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"AnnenforelderUttakEøsPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const g="default",N="default",x=(a=[],r=[])=>{const{behandling:e,rettigheter:t,fagsak:l,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:E,alleKodeverk:u}=o.use(d),{aksjonspunkt:m}=e,v=m.filter(_=>a.includes(_.definisjon)),p=q(e,[],t,!1),K=U(e.status,v),I=Z(l,e,E,i,n,r);return{behandling:e,isSubmittable:!v.some(R)||v.some(_=>_.kanLoses),harÅpentAksjonspunkt:v.some(_=>R(_)&&_.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:v,isReadOnly:p,alleMerknaderFraBeslutter:K,submitCallback:I}},Z=(a,r,e,t,l,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(v=>({"@type":v.kode,...v})),m={saksnummer:a.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0]?.kode??""))return l({...m,overstyrteAksjonspunktDtoer:u}).then(()=>{e(N,g),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...m,bekreftedeAksjonspunktDtoer:u}).then(()=>{e(N,g),globalThis.scrollTo({top:0,behavior:"smooth"})})},W=[G.AVKLAR_VERGE],X=()=>{const a=k(),r=x(W),{behandling:e}=o.use(d),t=F(e),l=b(e,"VERGE"),{data:i,isFetching:n}=P(t.vergeOptions(e,l));return s.jsx(S,{standardPanelProps:r,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:n?s.jsx(y,{}):s.jsx(V,{verge:i,alleKodeverk:r.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{S as F,X as V,H as a,x as u};
