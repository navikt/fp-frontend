import{j as e,F as q,bz as I,G as L,y as G,A as j,e as E,S as x,x as A,a8 as B}from"./iframe-uo23hhUw.js";import{b as F,O as h,S as U,R,w as M}from"./index.es-DzaI5eYi.js";import{e as w}from"./aksjonspunktUtils-Bp6ewLMR.js";import{b as P,V as N,H as o,B as g,a as H,D as Y,L as y}from"./VStack-w7oG0Q_c.js";import{S as J}from"./Checkmark-BHXb7cID.js";import{S as z}from"./TotrinnskontrollIndex-BKpz1wT8.js";import{S as $,H as O,b as C}from"./index.es-D-3EU2Xj.js";import{S as X}from"./CheckmarkCircleFill-M8yM0hhM.js";import{S as W}from"./ExclamationmarkTriangleFill-Bn-bo9YH.js";const Q="_begrunnelseTextField_hw8s7_6",Z={begrunnelseTextField:Q},k={"OverstyringPanel.AutomatiskVurdering":"Manuell overstyring av automatisk vurdering","OverstyringPanel.Vilkar":"Begrunnelse","OverstyringPanel.Endret":"Endret av saksbehandler","OverstyringPanel.Unntakstilfeller":"Overstyring skal kun gjøres i unntakstilfeller","OverstyringPanel.ConfirmInformation":"Bekreft overstyring","OverstyringPanel.Avbryt":"Avbryt","ProsessPanelTemplate.ErOppfylt":"Vilkåret er oppfylt","ProsessPanelTemplate.ErIkkeOppfylt":"Vilkåret er avslått","ProsessPanelTemplate.IkkeBehandlet":"Ikke behandlet","VilkarResultPicker.Arsak":"Avslagsårsak","VilkarResultPicker.OpphorFom":"Dato for opphør av medlemskapet","VilkarResultPicker.MedlemFom":"Innflyttingsdato","ProsessStegBegrunnelseTextField.ExplanationRequired":"Vurdering","ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"Begrunnelse","ProsessStegBegrunnelseTextField.BegrunnVurdering":"Begrunn vurderingen din","SubmitButton.ConfirmInformation":"Bekreft og fortsett"},ee=E(k),ae=L(3),le=G(2e3),ne=a=>a?"ProsessStegBegrunnelseTextField.ExplanationRequiredReadOnly":"ProsessStegBegrunnelseTextField.ExplanationRequired",re=a=>n=>n!==void 0||a,b=({readOnly:a,text:n,useAllWidth:l=!1,notRequired:r=!1})=>{const{formState:{isDirty:u},control:t}=F(),s=r?()=>!1:re(u);return e.jsx("div",{className:l?"":Z.begrunnelseTextField,children:e.jsx(h,{name:"begrunnelse",control:t,label:n??ee.formatMessage({id:ne(a)}),validate:[I(s),ae,le,j],maxLength:2e3,readOnly:a,parse:q})})},te=a=>a.at(0)?.begrunnelse??"";b.buildInitialValues=a=>({begrunnelse:x(te(a))});b.transformValues=a=>({begrunnelse:a.begrunnelse});b.__docgenInfo={description:`ProsessStegBegrunnelseTextField
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!1}}]}}],raw:"Aksjonspunkt[]"}}],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  begrunnelse?: string;
}`,signature:{properties:[{key:"begrunnelse",value:{name:"string",required:!1}}]},alias:"FormValues"}}],returns:{type:{name:"signature",type:"object",raw:"{ begrunnelse: string | undefined }",signature:{properties:[{key:"begrunnelse",value:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}],required:!0}}]}}}}],displayName:"ProsessStegBegrunnelseTextField",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},text:{required:!1,tsType:{name:"string"},description:""},useAllWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},notRequired:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const ie=E(k),ue=(a,n,l,r)=>!l&&!n||a?!0:r===void 0?!l:!l&&r||r,D=({isReadOnly:a,isSubmittable:n,isSubmitting:l,isDirty:r,text:u,onClick:t,hasEmptyRequiredFields:s})=>a?null:e.jsx("div",{children:e.jsx(P,{size:"small",variant:"primary",loading:l,disabled:ue(l,n,r,s),onClick:t,type:t?"button":"submit",children:u??ie.formatMessage({id:"SubmitButton.ConfirmInformation"})})});D.__docgenInfo={description:"",methods:[],displayName:"ProsessStegSubmitButton",props:{isReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmittable:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},text:{required:!1,tsType:{name:"string"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent"},name:"event"}],return:{name:"void"}}},description:""},hasEmptyRequiredFields:{required:!1,tsType:{name:"boolean"},description:""}}};const se="_godkjentImage_bo2wj_1",me="_avslattImage_bo2wj_7",ve="_selectBredde_bo2wj_13",c={godkjentImage:se,avslattImage:me,selectBredde:ve},oe=E(k),f=({vilkår:a,customVilkårIkkeOppfyltText:n,customVilkårOppfyltText:l,isReadOnly:r,skalKunneInnvilge:u=!0,validatorsForRadioOptions:t})=>{const{getValues:s,watch:_,control:m}=F(),i=_("erVilkarOk"),d=t?t.concat(A):[A],{alleKodeverk:V}=B(),p=_e(V,a);return e.jsxs(N,{gap:"space-16",paddingInline:"4",children:[r&&i!==void 0&&e.jsxs(o,{gap:"space-8",children:[i&&e.jsxs(e.Fragment,{children:[e.jsx(J,{className:c.godkjentImage}),e.jsx(g,{size:"small",children:l})]}),!i&&e.jsxs(e.Fragment,{children:[e.jsx(z,{className:c.avslattImage}),e.jsx(g,{size:"small",children:n})]})]}),(!r||i===void 0)&&e.jsxs(U,{name:"erVilkarOk",control:m,legend:"",hideLegend:!0,validate:d,readOnly:r,children:[e.jsx(R,{value:!0,size:"small",disabled:!u,children:l}),e.jsx(R,{value:!1,size:"small",children:n})]}),i!==void 0&&!i&&p&&e.jsx(M,{name:"avslagskode",control:m,label:oe.formatMessage({id:"VilkarResultPicker.Arsak"}),selectValues:p,readOnly:r,className:c.selectBredde,validate:[I(de(i,s("avslagskode")))]})]})};f.buildInitialValues=(a,n,l)=>{const r=a.some(w)?void 0:n==="OPPFYLT";return{erVilkarOk:r,avslagskode:r===!1&&l?.avslagsarsak?l.avslagsarsak:void 0}};f.transformValues=a=>a.erVilkarOk?{erVilkarOk:!0}:{erVilkarOk:!1,avslagskode:a.avslagskode};const _e=(a,n)=>{if(n)return a.LineærAvslagsårsak.filter(l=>n.aktuelleAvslagsårsaker.includes(l.kode)).toSorted((l,r)=>l.navn.localeCompare(r.navn)).map(l=>e.jsx("option",{value:l.kode,children:l.navn},l.kode))},de=(a,n)=>()=>a===!1&&!n;f.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"aksjonspunkter",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aksjonspunktType: foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktType;
  begrunnelse?: string;
  besluttersBegrunnelse?: string;
  definisjon: foreldrepenger_behandlingslager_behandling_aksjonspunkt_AksjonspunktDefinisjon;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"undefined"}]},description:""},customVilkårIkkeOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},customVilkårOppfyltText:{required:!0,tsType:{name:"union",raw:"string | ReactElement",elements:[{name:"string"},{name:"ReactElement"}]},description:""},isReadOnly:{required:!0,tsType:{name:"boolean"},description:""},skalKunneInnvilge:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},validatorsForRadioOptions:{required:!1,tsType:{name:"Array",elements:[{name:"unknown"}],raw:"((value: string | number | boolean) => string | null | undefined)[]"},description:""}}};const ge="_vilkar_1ciy8_1",Ee="_aksjonspunktMargin_1ciy8_5",ke="_godkjentImage_1ciy8_10",pe="_avslattImage_1ciy8_16",T={vilkar:ge,aksjonspunktMargin:Ee,godkjentImage:ke,avslattImage:pe},K=E(k),Te=({lovReferanse:a,title:n,originalErVilkårOk:l,harÅpentAksjonspunkt:r,isSubmittable:u,isReadOnly:t,rendreFakta:s,isDirty:_,erIkkeGodkjentAvBeslutter:m,isSubmitting:i,children:d})=>e.jsxs(N,{gap:"space-16",children:[e.jsxs(o,{gap:"space-8",children:[l!==void 0&&e.jsxs(e.Fragment,{children:[l&&e.jsx(X,{className:T.godkjentImage}),!l&&e.jsx($,{className:T.avslattImage})]}),e.jsx(H,{size:"small",level:"3",children:n}),a&&e.jsx(Y,{className:T.vilkar,children:a})]}),e.jsxs(o,{gap:"space-8",children:[l&&e.jsx(y,{size:"small",children:K.formatMessage({id:"ProsessPanelTemplate.ErOppfylt"})}),l===!1&&e.jsx(y,{size:"small",children:K.formatMessage({id:"ProsessPanelTemplate.ErIkkeOppfylt"})}),!r&&l===void 0&&e.jsx(g,{size:"small",children:K.formatMessage({id:"ProsessPanelTemplate.IkkeBehandlet"})})]}),e.jsx(O,{className:T.aksjonspunktMargin,erAksjonspunktApent:r,erIkkeGodkjentAvBeslutter:m,children:e.jsxs(N,{gap:"space-16",children:[e.jsx("div",{children:d}),e.jsx(D,{isReadOnly:t,isSubmittable:u,isDirty:_,isSubmitting:i})]})}),s?.()]});Te.__docgenInfo={description:"",methods:[],displayName:"ProsessPanelTemplate",props:{title:{required:!0,tsType:{name:"string"},description:""},lovReferanse:{required:!1,tsType:{name:"string"},description:""},harÅpentAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},isSubmittable:{required:!0,tsType:{name:"boolean"},description:""},originalErVilkårOk:{required:!1,tsType:{name:"boolean"},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},rendreFakta:{required:!1,tsType:{name:"signature",type:"function",raw:"() => ReactNode",signature:{arguments:[],return:{name:"ReactNode"}}},description:""},isReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isDirty:{required:!1,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Ne="_aksjonspunktMargin_15w18_1",Ve="_exclamationmarkIcon_15w18_6",S={aksjonspunktMargin:Ne,exclamationmarkIcon:Ve},v=E(k),ce=L(3),Ke=G(1500),Ae=a=>n=>n!==void 0||a?A(n):void 0,Pe=({erOverstyrt:a,isSolvable:n,erVilkårOk:l,hasAksjonspunkt:r,overrideReadOnly:u,isSubmitting:t,isPristine:s,toggleAv:_,erIkkeGodkjentAvBeslutter:m,children:i})=>{const{formState:{isDirty:d},control:V}=F(),p=Ae(d);return e.jsx(O,{className:S.aksjonspunktMargin,erAksjonspunktApent:a,erIkkeGodkjentAvBeslutter:m,children:e.jsxs(N,{gap:"space-16",children:[e.jsx(y,{size:"medium",children:v.formatMessage({id:"OverstyringPanel.AutomatiskVurdering"})}),e.jsx("div",{children:i}),(a||r)&&e.jsx(h,{name:"begrunnelse",control:V,label:v.formatMessage({id:"OverstyringPanel.Vilkar"}),validate:[p,ce,Ke,j],maxLength:1500,readOnly:u||!a}),!a&&l!==void 0&&e.jsxs(o,{gap:"space-8",children:[e.jsx(C,{}),e.jsx(g,{size:"small",children:v.formatMessage({id:"OverstyringPanel.Endret"})})]}),a&&e.jsxs(e.Fragment,{children:[e.jsxs(o,{gap:"space-8",children:[e.jsx(W,{className:S.exclamationmarkIcon}),e.jsx(g,{size:"small",children:v.formatMessage({id:"OverstyringPanel.Unntakstilfeller"})})]}),e.jsxs(o,{gap:"space-8",children:[!u&&e.jsx(P,{size:"small",variant:"primary",loading:t,disabled:t||!n||s,children:v.formatMessage({id:"OverstyringPanel.ConfirmInformation"})}),e.jsx(P,{size:"small",variant:"secondary",loading:t,disabled:t,onClick:_,type:"button",children:v.formatMessage({id:"OverstyringPanel.Avbryt"})})]})]})]})})};Pe.__docgenInfo={description:"",methods:[],displayName:"OverstyringPanel",props:{erOverstyrt:{required:!0,tsType:{name:"boolean"},description:""},isSolvable:{required:!0,tsType:{name:"boolean"},description:""},erVilkårOk:{required:!1,tsType:{name:"boolean"},description:""},hasAksjonspunkt:{required:!0,tsType:{name:"boolean"},description:""},overrideReadOnly:{required:!0,tsType:{name:"boolean"},description:""},isSubmitting:{required:!0,tsType:{name:"boolean"},description:""},isPristine:{required:!0,tsType:{name:"boolean"},description:""},toggleAv:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},erIkkeGodkjentAvBeslutter:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""}}};export{Pe as O,b as P,f as V,D as a,Te as b};
