...
Viser inputfelter for fra og til dato for frilansperioder`,methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  ...
  tomDato: string;
  oppdragsgiver: string;
}`,signature:{properties:[{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"string",required:!0}},{key:"oppdragsgiver",value:{name:"string",required:!0}}]}}],raw:"OppdragPeriode[]",required:!1}}]},required:!0}}]}}}}],displayName:"FrilansPanel",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const xn=O(b),de=({readOnly:r})=>e.jsx(ee,{value:xn,children:e.jsx(Me,{readOnly:r})});de.initialValues=Me.initialValues;de.transformValues=Me.transformValues;de.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [FRILANS_NAME_PREFIX]: FrilansSubFormValues;
}`,signature:{properties:[{key:"frilans",value:{name:"signature",type:"object",raw:`{
  harSokerPeriodeMedFrilans?: boolean;
  perioder?: {
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Cn=O(b),me=({readOnly:r,alleKodeverk:a})=>e.jsx(ee,{value:Cn,children:e.jsx(Ue,{readOnly:r,alleKodeverk:a})});me.initialValues=Ue.initialValues;me.transformValues=Ue.transformValues;me.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  [INNTEKTSGIVENDE_ARBEID_FIELD_ARRAY_NAME]?: InnerFormValue[];
}`,signature:{properties:[{key:"arbeidsforhold",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  arbeidsgiver?: string;
  periodeFom?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  mottattDato?: string;
}`,signature:{properties:[{key:"mottattDato",value:{name:"string",required:!1}}]},alias:"MottattDatoFormValues"}}],returns:null}],displayName:"MottattDatoPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const pe="omsorg",Qn="_barnInput_1jjt5_1",el={barnInput:Qn},rl=10,al=r=>r?Nn(1)(r):void 0,nl=r=>r?Lr(10)(r):void 0,ga=(r,a)=>n=>{const t=[a].flat().filter(i=>i!==void 0).at(0);if(r===0&&t&&n)return Fn(n,t)},He=({readOnly:r=!0,familieHendelseType:a,isForeldrepengerFagsak:n,fodselsdatoer:l})=>{const{formatMessage:t}=q(),{control:i,watch:s}=T(),{fields:u,remove:o,append:g}=X({control:i,name:`${pe}.foedselsDato`}),v=s(`${pe}.antallBarn`)??0;return V.useEffect(()=>{if(u.length>Math.max(v,0))for(let m=u.length;m>v;m-=1)o(m-1);else if(u.length<Math.min(v,rl))for(let m=u.length;m<v;m+=1)g({id:m,dato:void 0})},[v]),e.jsx(c,{children:e.jsxs(y,{gap:"space-16",children:[e.jsx(P,{size:"small",level:"3",children:e.jsx(d,{id:a===j.ADOPSJON?"Registrering.Adopsjon.Title":"Registrering.Adopsjon.OmsorgTitle"})}),n&&a===j.ADOPSJON&&e.jsx(Q,{name:`${pe}.erEktefellesBarn`,control:i,label:e.jsx(d,{id:"Registrering.Adopsjon.GjelderEktefellesBarn"}),validate:[k],isReadOnly:r,children:e.jsxs(U,{gap:"space-16",children:[e.jsx(I,{value:!0,size:"small",children:e.jsx(d,{id:"Registrering.Adopsjon.Ja"})}),e.jsx(I,{value:!1,size:"small",children:e.jsx(d,{id:"Registrering.Adopsjon.Nei"})})]})}),e.jsx(N,{name:`${pe}.omsorgsovertakelsesdato`,control:i,label:t({id:a===j.ADOPSJON?"Registrering.Adopsjon.DatoForOvertakelsenStebarn":"Registrering.Adopsjon.DatoForOvertakelsen"}),isReadOnly:r,validate:a===j.ADOPSJON?[k,F]:[F]}),e.jsx(U,{gap:"space-16",children:e.jsx(G,{name:`${pe}.antallBarn`,control:i,label:t({id:"Registrering.Adopsjon.AntallBarn"}),readOnly:r,className:el.barnInput,parse:m=>{const E=Number.parseInt(m.toString(),10);return Number.isNaN(E)?m:E},validate:[...a===j.ADOPSJON?[k]:[],Pe,al,nl]})}),u.map((m,E)=>e.jsx(ba.Fragment,{children:e.jsx(N,{name:`${pe}.foedselsDato.${E}.dato`,control:i,isReadOnly:r,validate:a===j.ADOPSJON?[k,F,be,ga(E,l)]:[F,be,ga(E,l)],label:t({id:"Registrering.Adopsjon.FodselsdatoBarnN"},{n:E+1})})},m.id))]})})};He.initialValues=()=>({[pe]:{}});He.transformValues=({omsorg:r})=>({[pe]:{...r,foedselsDato:r.foedselsDato&&r.foedselsDato.length>0?r.foedselsDato.map(a=>a.dato):void 0}});He.__docgenInfo={description:`OmsorgOgAdopsjonPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},mottattDato:{required:!1,tsType:{name:"string"},description:""}}};const sl=O(b),x=({readOnly:r,erAdopsjon:a,alleKodeverk:n,mottattDato:l})=>e.jsx(ee,{value:sl,children:e.jsx(Ye,{readOnly:r,erAdopsjon:a,alleKodeverk:n,mottattDato:l})});x.initialValues=Ye.initialValues;x.transformValues=Ye.transformValues;x.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  oppholdINorge?: boolean;
  oppholdSisteTolvINorge?: boolean;
  oppholdNesteTolvINorge?: boolean;
  tidligereOppholdUtenlands?: FormValuesFieldArray[];
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  rettigheter?: string;
}`,signature:{properties:[{key:"rettigheter",value:{name:"string",required:!1}}]},alias:"RettigheterFormValues"}}],returns:null}],displayName:"RettigheterPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""},soknadData:{required:!0,tsType:{name:"SoknadData"},description:""}}};const Tr=O(b),zr={BOKMAL:"NB",NYNORSK:"NN",ENGELSK:"EN"},$=({readOnly:r})=>{const{control:a}=T();return e.jsx(c,{children:e.jsxs(y,{gap:"space-16",children:[e.jsx(P,{size:"small",level:"3",children:Tr.formatMessage({id:"Registrering.Sprak"})}),e.jsxs(Q,{name:"språkkode",control:a,validate:[k],isReadOnly:r,children:[e.jsx(I,{value:zr.BOKMAL,size:"small",children:Tr.formatMessage({id:"Registrering.Sprak.Bokmal"})}),e.jsx(I,{value:zr.NYNORSK,size:"small",children:Tr.formatMessage({id:"Registrering.Sprak.Nynorsk"})}),e.jsx(I,{value:zr.ENGELSK,size:"small",children:Tr.formatMessage({id:"Registrering.Sprak.Engelsk"})})]})]})})};$.initialValues=()=>({språkkode:void 0});$.transformValues=({språkkode:r})=>({språkkode:r});$.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  språkkode?: string;
  ...
  språkkode?: string;
}`,signature:{properties:[{key:"språkkode",value:{name:"string",required:!1}}]},alias:"SprakFormValues"}}],returns:null}],displayName:"SprakPapirsoknadIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Ie="egenVirksomhet",L=`${Ie}.virksomheter`,ol={},dl=r=>r.map(({kode:a,navn:n})=>e.jsx("option",{value:a,children:n},a)),jr=({index:r,readOnly:a,alleKodeverk:n})=>{const l=q(),t=n.Landkoder.slice().sort((u,o)=>u.navn.localeCompare(o.navn)),{getValues:i,control:s}=T();return e.jsx(_,{name:`${L}.${r}.virksomhetRegistrertINorge`,control:s,label:e.jsx(d,{id:"Registrering.VirksomhetIdentifikasjonPanel.RegisteredInNorway"}),readOnly:a,trueContent:e.jsx(J,{children:e.jsx(G,{name:`${L}.${r}.organisasjonsnummer`,control:s,readOnly:a,validate:[k,Pe,In],label:e.jsx(d,{id:"Registrering.VirksomhetIdentifikasjonPanel.OrganizationNumber"})})}),falseContent:e.jsx(J,{alignOffset:58,children:e.jsxs(y,{gap:"space-16",children:[e.jsx(C,{name:`${L}.${r}.landJobberFra`,control:s,className:ol.landBredde,selectValues:dl(t),validate:[k],label:l.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.Country"})}),e.jsxs(U,{gap:"space-16",children:[e.jsx(N,{name:`${L}.${r}.fom`,control:s,isReadOnly:a,validate:[k,F,be],label:l.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeFom"})}),e.jsx(N,{name:`${L}.${r}.tom`,control:s,isReadOnly:a,validate:[F,u=>{const o=i(`${L}.${r}.fom`);return o?Sn(o,u):null}],label:l.formatMessage({id:"Registrering.VirksomhetIdentifikasjonPanel.periodeTom"})})]})]})})})};jr.transformValues=({virksomhetRegistrertINorge:r,organisasjonsnummer:a,landJobberFra:n,fom:l,tom:t})=>({virksomhetRegistrertINorge:r,organisasjonsnummer:r?a:void 0,...r===!1?{landJobberFra:n,fom:l,tom:t}:{landJobberFra:"NOR"}});jr.__docgenInfo={description:`VirksomhetIdentifikasjonPanel
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Xr=O(b),$e=({readOnly:r})=>{const{control:a}=T();return e.jsx(c,{children:e.jsxs(y,{gap:"space-16",children:[e.jsx(P,{size:"small",level:"3",children:Xr.formatMessage({id:"Registrering.Dekningsgrad.Title"})}),e.jsx(Q,{name:"dekningsgrad",control:a,validate:[k],isReadOnly:r,children:e.jsxs(U,{gap:"space-16",children:[e.jsx(I,{value:"80_PROSENT",size:"small",children:Xr.formatMessage({id:"Registrering.Dekningsgrad.prosent.80"})}),e.jsx(I,{value:"100_PROSENT",size:"small",children:Xr.formatMessage({id:"Registrering.Dekningsgrad.prosent.100"})})]})})]})})};$e.initialValues=()=>({dekningsgrad:void 0});$e.transformValues=({dekningsgrad:r})=>({dekningsgrad:r});$e.__docgenInfo={description:"Komponenten vises som del av skjermbildet for registrering av papirsøknad dersom søknad gjelder foreldrepenger.",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  dekningsgrad?: string;
  ...
  dekningsgrad?: string;
}`,signature:{properties:[{key:"dekningsgrad",value:{name:"string",required:!1}}]},alias:"FormValues"}}],returns:null}],displayName:"DekningsgradIndex",props:{readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Ra=O(b),ge=({readOnly:r,annenForelderInformertRequired:a=!1})=>{const{control:n}=T();return e.jsx(c,{children:e.jsxs(y,{gap:"space-16",children:[e.jsx(P,{size:"small",level:"3",children:Ra.formatMessage({id:"Registrering.TheOtherParent.Confirmation"})}),e.jsx(_,{name:"annenForelderInformert",control:n,label:Ra.formatMessage({id:"Registrering.TheOtherParent.OtherParentKnowPeriods"}),isRequired:a,readOnly:r})]})})};ge.initialValues=()=>({annenForelderInformert:void 0});ge.tranformValues=({annenForelderInformert:r})=>({annenForelderInformert:r});ge.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const Ol=O(b),ve=({foreldreType:r,readOnly:a,alleKodeverk:n,erEndringssøknad:l})=>e.jsx(ee,{value:Ol,children:e.jsx(Ce,{readOnly:a,foreldreType:r,alleKodeverk:n,erEndringssøknad:l})});ve.transformValues=Ce.transformValues;ve.initialValues=Ce.initialValues;ve.__docgenInfo={description:"",methods:[{name:"transformValues",docblock:null,modifiers:["static"],params:[{name:"values",optional:!1,type:{name:"signature",type:"object",raw:`{
  [TIDSROM_PERMISJON_FORM_NAME_PREFIX]?: TidsromPermisjon;
}`,signature:{properties:[{key:"tidsromPermisjon",value:{name:"intersection",raw:`FromValuesFulltUttak &
FormValuesUtsettelse &
FormValuesOpphold &
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},erEndringssøknad:{required:!0,tsType:{name:"boolean"},description:""}}};const ie=O(b),Bl=r=>a=>{const n=r("foedselsDato");return fa(n,a)},Gl=r=>a=>{const n=r("termindato");return Ln(n,a)},Ee=({readOnly:r,erForeldrepenger:a=!1})=>{const{watch:n,getValues:l,control:t}=T(),i=n("erBarnetFodt");return e.jsx(ee,{value:ie,children:e.jsx(c,{children:e.jsxs(y,{gap:"space-16",children:[e.jsx(P,{size:"small",level:"3",children:ie.formatMessage({id:"Registrering.TerminOgFodsel.Tittel"})}),e.jsxs(Q,{name:"erBarnetFodt",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.ErBarnetFodt"}),validate:[k],isReadOnly:r,children:[e.jsx(I,{value:!0,size:"small",children:e.jsx(d,{id:"Registrering.TerminOgFodsel.ErFodt"})}),e.jsx(I,{value:!1,size:"small",children:e.jsx(d,{id:"Registrering.TerminOgFodsel.ErIkkeFodt"})})]}),i!==void 0&&e.jsxs(y,{gap:"space-16",children:[i===!1&&e.jsxs(e.Fragment,{children:[e.jsxs(U,{gap:"space-16",children:[e.jsx(N,{name:"termindato",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:r,fromDate:Ve().toDate(),toDate:_e().toDate(),defaultMonth:new Date,validate:[k,F,h(Ve()),z(_e())]}),e.jsx(G,{name:"antallBarn",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:r,parse:s=>{const u=Number.parseInt(s.toString(),10);return Number.isNaN(u)?s:u},validate:[k,Pe,oa,da]})]}),e.jsx(N,{name:"terminbekreftelseDato",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.UtstedtDato"}),isReadOnly:r,fromDate:qn().toDate(),toDate:Kn().toDate(),defaultMonth:new Date,validate:[F,Gl(l)]})]}),i===!0&&e.jsxs(e.Fragment,{children:[e.jsxs(U,{gap:"space-16",children:[e.jsx(N,{name:"foedselsDato",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.Fodselsdato"}),isReadOnly:r,validate:[k,F,h(Fr()),be],fromDate:Fr().toDate(),toDate:ja().toDate()}),e.jsx(G,{name:"antallBarn",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.AntallBarn"}),readOnly:r,parse:s=>{const u=Number.parseInt(s.toString(),10);return Number.isNaN(u)?s:u},validate:[k,Pe,oa,da]})]}),a&&e.jsx(Dr,{size:"small",variant:"info",children:e.jsx(Re,{size:"small",children:ie.formatMessage({id:"Registrering.TerminOgFodsel.RettTilPrematuruker"})})}),e.jsx(N,{name:"termindato",control:t,label:ie.formatMessage({id:"Registrering.TerminOgFodsel.Termindato"}),isReadOnly:r,validate:[F,h(Ve()),z(_e()),Bl(l)],fromDate:Ve().toDate(),toDate:_e().toDate(),defaultMonth:new Date})]})]})]})})})};Ee.initialValues=()=>({erBarnetFodt:void 0});Ee.transformValues=({antallBarn:r,erBarnetFodt:a,foedselsDato:n,termindato:l,terminbekreftelseDato:t})=>a?{erBarnetFodt:!0,termindato:l,foedselsDato:n,antallBarn:r}:{erBarnetFodt:!1,termindato:l,terminbekreftelseDato:t,antallBarnFraTerminbekreftelse:r};Ee.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[],returns:{type:{name:"signature",type:"object",raw:`{
  termindato?: string;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const xl=()=>({...Y.initialValues(),...ve.initialValues(),...ge.initialValues(),...H.initialValues()}),$l=r=>({...Y.transformValues(r),...ve.transformValues(r),...ge.tranformValues(r),...H.transformValues(r)}),on=({readOnly:r,soknadData:a,alleKodeverk:n,onSubmit:l,onSubmitUfullstendigsoknad:t})=>{const i=or({defaultValues:xl()});return e.jsxs(dr,{formMethods:i,onSubmit:s=>l($l(s)),children:[e.jsxs(Or,{columns:{sm:1,md:2},gap:"space-16",children:[e.jsx(Y,{readOnly:r}),e.jsx(ge,{annenForelderInformertRequired:!0,readOnly:r})]}),e.jsx(ve,{foreldreType:a.getForeldreType(),readOnly:r,alleKodeverk:n,erEndringssøknad:!0}),e.jsx(H,{readOnly:r,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!0})]})};on.__docgenInfo={description:`ForeldrepengerEndringssøknadForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: ForeldrepengerEndringssøknadValues) => Promise<void>",signature:{arguments:[{type:{name:"ReturnType",elements:[{name:"transformValues"}],raw:"ReturnType<typeof transformValues>"},name:"values"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},onSubmitUfullstendigsoknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""}}};const Jl=()=>({...Y.initialValues(),...x.initialValues(),...me.initialValues(),...ke.initialValues(),...de.initialValues(),...oe.initialValues(),...$e.initialValues(),...Ee.initialValues(),...ne.initialValues(),...ae.initialValues(),...he.initialValues(),...ve.initialValues(),...ge.initialValues(),...$.initialValues(),...H.initialValues()}),Cl=r=>({...Y.transformValues(r),...x.transformValues(r),...me.transformValues(r),...ke.transformValues(r),...de.transformValues(r),...oe.transformValues(r),...$e.transformValues(r),...Ee.transformValues(r),...ne.transformValues(r),...ae.transformValues(r),...he.transformValues(r),...ve.transformValues(r),...ge.tranformValues(r),...$.transformValues(r),...H.transformValues(r)}),dn=({readOnly:r,soknadData:a,alleKodeverk:n,onSubmit:l,onSubmitUfullstendigsoknad:t,fagsakPersonnummer:i})=>{const s=or({defaultValues:Jl()}),u=s.watch("annenForelder.sokerHarAleneomsorg"),o=s.watch("annenForelder.denAndreForelderenHarRettPaForeldrepenger"),g=!u&&o!==!1,v=s.watch("foedselsDato"),m=s.watch("mottattDato");return e.jsxs(dr,{formMethods:s,onSubmit:E=>l(Cl(E)),children:[e.jsxs(Or,{columns:{sm:1,md:2},gap:"space-16",children:[e.jsx(Y,{readOnly:r}),e.jsx(x,{readOnly:r,erAdopsjon:a.getFamilieHendelseType()===j.ADOPSJON,alleKodeverk:n,mottattDato:m}),e.jsx(me,{readOnly:r,alleKodeverk:n}),e.jsx(ke,{readOnly:r,alleKodeverk:n}),e.jsx(de,{readOnly:r}),e.jsx(oe,{readOnly:r,alleKodeverk:n}),e.jsx($e,{readOnly:r}),a.getFamilieHendelseType()===j.FODSEL&&e.jsx(Ee,{readOnly:r,erForeldrepenger:!0}),e.jsx(ne,{readOnly:r,soknadData:a}),e.jsx(ae,{readOnly:r,familieHendelseType:a.getFamilieHendelseType(),fodselsdato:v,isForeldrepengerFagsak:!0}),e.jsx(he,{readOnly:r,alleKodeverk:n,fagsakPersonnummer:i,sokerErMor:a.getForeldreType()===Ke.MOR}),e.jsx(ve,{foreldreType:a.getForeldreType(),readOnly:r,alleKodeverk:n,erEndringssøknad:!1}),e.jsx(ge,{annenForelderInformertRequired:g,readOnly:r}),e.jsx($,{readOnly:r})]}),e.jsx(H,{readOnly:r,onSubmitUfullstendigsoknad:t,submitting:s.formState.isSubmitting,erEndringssøknad:!1})]})};dn.__docgenInfo={description:`ForeldrepengerForm
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const Xl=()=>({...Y.initialValues(),...x.initialValues(),...me.initialValues(),...ke.initialValues(),...de.initialValues(),...oe.initialValues(),...ze.initialValues(),...Xe.initialValues(),...$.initialValues(),...H.initialValues()}),Wl=r=>({...Y.transformValues(r),...x.transformValues(r),...me.transformValues(r),...ke.transformValues(r),...de.transformValues(r),...oe.transformValues(r),...ze.transformValues(r),...Xe.transformValues(r),...$.transformValues(r),...H.transformValues(r)}),gn=({readOnly:r,soknadData:a,alleKodeverk:n,onSubmit:l,onSubmitUfullstendigsoknad:t})=>{const i=or({defaultValues:Xl()}),s=i.watch("mottattDato");return e.jsxs(dr,{formMethods:i,onSubmit:u=>l(Wl(u)),children:[e.jsxs(Or,{columns:{sm:1,md:2},gap:"space-16",children:[e.jsx(Y,{readOnly:r}),e.jsx(x,{readOnly:r,alleKodeverk:n,erAdopsjon:a.getFamilieHendelseType()!==j.ADOPSJON,mottattDato:s}),e.jsx(me,{readOnly:r,alleKodeverk:n}),e.jsx(ke,{readOnly:r,alleKodeverk:n}),e.jsx(de,{readOnly:r}),e.jsx(oe,{readOnly:r,kunMiliterEllerSiviltjeneste:!0,alleKodeverk:n}),e.jsx(ze,{readOnly:r}),e.jsx(Xe,{readOnly:r}),e.jsx($,{readOnly:r})]}),e.jsx(H,{readOnly:r,onSubmitUfullstendigsoknad:t,submitting:i.formState.isSubmitting,erEndringssøknad:!1})]})};gn.__docgenInfo={description:`SvangerskapspengerForm
