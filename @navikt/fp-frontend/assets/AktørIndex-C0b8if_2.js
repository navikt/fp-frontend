import{j as e,h as g,P as v,e as p,L as y}from"./iframe-BKuqQsvk.js";import{Z as f}from"./index.es-BqxAsg7D.js";import{u as q,f as _}from"./fagsakApi-pCr-3kL5.js";import{V as c}from"./VisittkortSakIndex-C1L3xbJw.js";import{V as j,a as N,B as A}from"./VStack-DtJqj3GS.js";import{M as o}from"./message-gTMBmfiC.js";import{E as w}from"./IngenBehandlingValgtPanel-DSBpuPzn.js";import{u as R}from"./useTrackRouteParam-Ck_NFmdu.js";import{p as E}from"./paths-8Li4ESkQ.js";import{u as d}from"./useKodeverk-BQ8SXXFW.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
