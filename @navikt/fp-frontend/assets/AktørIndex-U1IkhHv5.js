import{j as e,h as g,P as v,e as p,L as y}from"./iframe-IrsYaoYT.js";import{Z as f}from"./index.es-CQX5W6HT.js";import{u as q,f as _}from"./fagsakApi-qaBj9I5C.js";import{V as c}from"./VisittkortSakIndex-DhOdpoQz.js";import{V as j,a as N,B as A}from"./VStack-DvSDRMD4.js";import{M as o}from"./message-BI6-wz5o.js";import{E as w}from"./IngenBehandlingValgtPanel-BpNNxzvH.js";import{u as R}from"./useTrackRouteParam-CACuNq2h.js";import{p as E}from"./paths-BLsuJCX_.js";import{u as d}from"./useKodeverk-CtQi83YP.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
