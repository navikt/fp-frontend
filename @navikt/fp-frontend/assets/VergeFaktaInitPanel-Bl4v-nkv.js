import{r as o,o as A,j as s,bE as D,bF as L,be as O}from"./iframe-8iIUOOAF.js";import{Q as y}from"./index.es-wJ0C3p8N.js";import{u as P}from"./fagsakApi-BVpt4nuz.js";import{V as G}from"./BehandlingMenuIndex-CDb4Jick.js";import{A as V}from"./index-lXCVe7fJ.js";import{u as F,c as b}from"./behandlingApi-ro-8EBh_.js";import{B as T}from"./FagsakIndex-Iu2Smdjw.js";import{Y as M}from"./index.es-DLpe9JIx.js";import{H as B}from"./VStack-dRjle75L.js";import{S as f}from"./ExclamationmarkTriangleFill-CC7COgjP.js";import{e as d}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as q,g as U}from"./useStandardProsessPanelProps-DyolpvCm.js";const j=a=>{const[r,e]=o.useState([]),t=l=>{e(i=>{const n=[...i],m=n.findIndex(u=>u.id===l.id);return m>=0?n.splice(m,1,l):n.push(l),n}),a?.(l.harÅpentAksjonspunkt?{urlCode:l.id,text:l.tekst}:void 0)};return{faktaPanelMenyData:r.filter(l=>l.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",H="_sideMenu_4o186_19",R={container:w,content:h,sideMenu:H},c=({valgtFaktaSteg:a,valgtProsessSteg:r,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const l=A(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=o.use(T),{faktaPanelMenyData:n,settFaktaPanelMenyData:m}=j(e),u=n.length>0;return s.jsxs(B,{className:R.container,wrap:!1,children:[u&&s.jsx("div",{className:R.sideMenu,"data-testid":"fakta-meny",children:s.jsx(M,{heading:l.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(E=>({label:E.tekst,active:E.erAktiv,icon:E.harÅpentAksjonspunkt?s.jsx(f,{color:"var(--ax-warning-700)"}):void 0})),onClick:E=>{i(r,n[E].id)}})}),s.jsx("div",{className:R.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:m,faktaPanelMenyData:n,children:t})})]})},k=o.createContext({}),J=a=>{const{children:r,...e}=a,t=o.useMemo(()=>e,[e]);return s.jsx(k.Provider,{value:t,children:r})};c.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const N="default",g="default",x=(a=[],r=[])=>{const{behandling:e,rettigheter:t,fagsak:l,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=o.use(T),{aksjonspunkt:E}=e,v=E.filter(_=>a.includes(_.definisjon)),I=q(e,[],t,!1),K=U(e.status,v),p=Z(l,e,m,i,n,r);return{behandling:e,isSubmittable:!v.some(d)||v.some(_=>_.kanLoses),harÅpentAksjonspunkt:v.some(_=>d(_)&&_.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:v,isReadOnly:I,alleMerknaderFraBeslutter:K,submitCallback:p}},Z=(a,r,e,t,l,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(v=>({"@type":v.kode,...v})),E={saksnummer:a.saksnummer,behandlingUuid:r.uuid,behandlingVersjon:r.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return l({...E,overstyrteAksjonspunktDtoer:u}).then(()=>e(g,N))}return t({...E,bekreftedeAksjonspunktDtoer:u}).then(()=>e(g,N))},W=[V.AVKLAR_VERGE],X=()=>{const a=A(),r=x(W),{behandling:e}=o.use(T),t=F(e),l=b(e,"VERGE"),{data:i,isFetching:n}=P(t.vergeOptions(e,l));return s.jsx(S,{standardPanelProps:r,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:l,children:n?s.jsx(y,{}):s.jsx(G,{verge:i,alleKodeverk:r.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{S as F,X as V,c as a,x as u};
