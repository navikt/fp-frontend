import{r as v,l as A,j as s,bA as I,bB as D,ba as O}from"./iframe-v6QuEoBp.js";import{Z as L}from"./index.es-BMFkl3cY.js";import{u as y}from"./fagsakApi-C4cmYKfh.js";import{V as P}from"./BehandlingMenuIndex-8WqYiAAp.js";import{A as V}from"./index-gCKkwwus.js";import{u as F,c as G}from"./behandlingApi-C28X0ABn.js";import{u as d}from"./FagsakIndex-BCmBBw34.js";import{G as b}from"./index.es-ChmfTySV.js";import{H as M}from"./VStack-inxICc8J.js";import{S as f}from"./ExclamationmarkTriangleFill-rH8lW4vT.js";import{e as g}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as B,g as q}from"./useStandardProsessPanelProps-C5Kz4qNr.js";const U=n=>{const[l,a]=v.useState([]),t=r=>{a(u=>{const e=[...u],o=e.findIndex(i=>i.id===r.id);return o>=0?e.splice(o,1,r):e.push(r),e}),n?.(r.harÅpentAksjonspunkt?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:l.filter(r=>r.skalVisesIMeny),settFaktaPanelMenyData:t}},j="_container_4o186_1",w="_content_4o186_6",c="_sideMenu_4o186_19",T={container:j,content:w,sideMenu:c},h=({valgtFaktaSteg:n,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:a,children:t})=>{const r=A(),{oppdaterProsessStegOgFaktaPanelIUrl:u}=d(),{faktaPanelMenyData:e,settFaktaPanelMenyData:o}=U(a),i=e.length>0;return s.jsxs(M,{className:T.container,wrap:!1,children:[i&&s.jsx("div",{className:T.sideMenu,"data-testid":"fakta-meny",children:s.jsx(b,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:e.map(m=>({label:m.tekst,active:m.erAktiv,icon:m.harÅpentAksjonspunkt?s.jsx(f,{color:"var(--ax-warning-700)"}):void 0})),onClick:m=>{u(l,e[m].id)}})}),s.jsx("div",{className:T.content,children:s.jsx(H,{valgtFaktaSteg:n,settFaktaPanelMenyData:o,faktaPanelMenyData:e,children:t})})]})},N=v.createContext({}),H=n=>{const{children:l,...a}=n,t=v.useMemo(()=>a,[a]);return s.jsx(N.Provider,{value:t,children:l})};h.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const J="default",Y=(n,l,a,t)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:u}=v.use(N),e=a&&(r===n||t&&r===J);return v.useEffect(()=>{u({id:n,tekst:l,erAktiv:e,harÅpentAksjonspunkt:t,skalVisesIMeny:a})},[a,e,t]),a&&e},p=({standardPanelProps:n,skalPanelVisesIMeny:l,faktaPanelKode:a,faktaPanelMenyTekst:t,children:r})=>{const{behandling:u,fagsak:e,alleKodeverk:o}=d(),i=Y(a,t,l,n.harÅpentAksjonspunkt);return s.jsx(I,{behandling:u,children:i?s.jsx(D,{behandling:u,fagsak:e,alleKodeverk:o,alleMerknaderFraBeslutter:n.alleMerknaderFraBeslutter,aksjonspunkterForPanel:n.aksjonspunkterForPanel,harÅpentAksjonspunkt:n.harÅpentAksjonspunkt,isReadOnly:n.isReadOnly,isSubmittable:n.isSubmittable,submitCallback:n.submitCallback,children:r}):null})};p.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  behandling: T;
...
| '-'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"AnnenforelderUttakEøsPeriode[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  harÅpentAksjonspunkt: boolean;
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const R="default",k="default",C=(n=[])=>{const{behandling:l,rettigheter:a,fagsak:t,lagreAksjonspunkter:r,lagreOverstyrteAksjonspunkter:u,oppdaterProsessStegOgFaktaPanelIUrl:e,alleKodeverk:o}=d(),i=l.aksjonspunkt.filter(E=>n.includes(E.definisjon)),m=i.filter(E=>E.aksjonspunktType==="OVST").map(E=>E.definisjon),_=B(l,[],a,!1),S=q(l.status,i),K=x(t,l,e,r,u,m);return{behandling:l,isSubmittable:!i.some(g)||i.some(E=>E.kanLoses),harÅpentAksjonspunkt:i.some(E=>g(E)&&E.kanLoses),alleKodeverk:o,aksjonspunkterForPanel:i,isReadOnly:_,alleMerknaderFraBeslutter:S,submitCallback:K}},x=(n,l,a,t,r,u)=>e=>{const i=(Array.isArray(e)?e:[e]).map(_=>({"@type":_.kode,..._})),m={saksnummer:n.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(u){if(i.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(u.includes(i[0]?.kode??""))return r({...m,overstyrteAksjonspunktDtoer:i}).then(()=>{a(k,R),globalThis.scrollTo({top:0,behavior:"smooth"})})}return t({...m,bekreftedeAksjonspunktDtoer:i}).then(()=>{a(k,R),globalThis.scrollTo({top:0,behavior:"smooth"})})},Z=[V.AVKLAR_VERGE],W=()=>{const n=A(),l=C(Z),{behandling:a}=d(),t=F(a),r=G(a,"VERGE"),{data:u,isFetching:e}=y(t.vergeOptions(a,r));return s.jsx(p,{standardPanelProps:l,faktaPanelKode:O.VERGE,faktaPanelMenyTekst:n.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:r,children:e?s.jsx(L,{}):s.jsx(P,{verge:u,alleKodeverk:l.alleKodeverk})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{p as F,W as V,h as a,C as u};
