...
| 'IKKE_VURDERT'`,elements:[{name:"literal",value:"'DOKUMENTERT'"},{name:"literal",value:"'IKKE_DOKUMENTERT'"},{name:"literal",value:"'IKKE_VURDERT'"}],required:!0}},{key:"termin",value:{name:"signature",type:"object",raw:`{
  ...
  kanOverstyres: boolean;
  kilde: FaktaKilde;
}`,signature:{properties:[{key:"fødselsdato",value:{name:"string",required:!0}},{key:"dødsdato",value:{name:"string",required:!1}},{key:"kanOverstyres",value:{name:"boolean",required:!0}},{key:"kilde",value:{name:"union",raw:"'SØKNAD' | 'FOLKEREGISTER' | 'MEDL' | 'SAKSBEHANDLER'",elements:[{name:"literal",value:"'SØKNAD'"},{name:"literal",value:"'FOLKEREGISTER'"},{name:"literal",value:"'MEDL'"},{name:"literal",value:"'SAKSBEHANDLER'"}],required:!0}}]}}],raw:"FieldArrayRow[]",required:!0}}]}}],alias:"ErBarnFødtFormValues"}}],returns:null}],displayName:"ErBarnFødt",props:{isReadOnly:{required:!0,tsType:{name:"boolean"},description:""},finnesBarnIFReg:{required:!0,tsType:{name:"boolean"},description:""},antallBarnISøknad:{required:!0,tsType:{name:"number"},description:""}}};const Ue=[M,$e(We()),Ua(ze())],B=({isReadOnly:a,isRequired:n=!0})=>{const r=T(),{control:l}=C();return e.jsx(U,{control:l,name:"termindato",size:"medium",label:r.formatMessage({id:"Label.Termindato"}),validate:n?[K,...Ue]:Ue,fromDate:We().toDate(),toDate:ze().toDate(),defaultMonth:new Date,isReadOnly:a})};B.initialValues=a=>({termindato:a.termin?.termindato??"",termindatoKilde:a.termin?.kilde??"SØKNAD"});B.transformValues=a=>({termindato:a.termindato||null});B.__docgenInfo={description:"",methods:[{name:"initialValues",docblock:null,modifiers:["static"],params:[{name:"gjeldende",optional:!1,type:{name:"signature",type:"object",raw:`{
  antallBarn: tjenester_behandling_fødsel_dto_FødselDto_Gjeldende_AntallBarn;
  barn: Array<tjenester_behandling_fødsel_dto_FødselDto_Gjeldende_GjeldendeBarn>;
  fødselDokumetasjonStatus: tjenester_behandling_fødsel_dto_FødselDto_Gjeldende_FødselDokumetasjonStatus;
  termin?: tjenester_behandling_fødsel_dto_FødselDto_Gjeldende_Termin;
...
| 'FP_VK_8F'
| 'FP_VK_16S'
| '-'`,elements:[{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_8F'"},{name:"literal",value:"'FP_VK_16S'"},{name:"literal",value:"'-'"}],required:!1}},{key:"erEktefellesBarn",value:{name:"boolean",required:!1}},{key:"omsorgsovertakelseDato",value:{name:"string",required:!1}}]},required:!0}}]}},description:""}}};const Oa=({omsorgsovertakelse:a})=>{const n=T(),{aksjonspunkterForPanel:r,alleMerknaderFraBeslutter:l,submitCallback:t,isReadOnly:s,isSubmittable:i,alleKodeverk:m}=F(),o=Br(a),d=q({defaultValues:jr(a,r,o)}),_=d.watch("delvilkår"),N=d.watch("vilkårUtfallType"),R=d.watch("begrunnelse"),D=ee.useMemo(()=>_?(a.aktuelleDelvilkårAvslagsårsaker[_]??[]).map(E=>m.LineærAvslagsårsak.find(g=>g.kode===E)).sort(xe):[],[_]);return e.jsx(L,{label:n.formatMessage({id:"VurderOmsorgsovertakelseVilkåretForm.Tittel"}),merknaderFraBeslutter:l[v.VURDER_OMSORGSOVERTAKELSEVILKÅRET],children:e.jsx(c,{formMethods:d,onSubmit:E=>t(qr(E,o)),children:e.jsxs(k,{gap:"space-20",children:[e.jsx(U,{name:"omsorgsovertakelseDato",size:"small",control:d.control,label:e.jsx(u,{id:"Label.Omsorgsovertakelsesdato"}),validate:[K,M],isReadOnly:s,isEdited:_e(a.søknad.omsorgsovertakelseDato,a.gjeldende.omsorgsovertakelseDato)}),e.jsxs(W,{name:"ektefellesBarn",control:d.control,label:e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.EktefellesBarn.Label"}),validate:[K],isReadOnly:s,children:[e.jsx(y,{value:!0,children:e.jsx(u,{id:"Label.Ja"})}),e.jsx(y,{value:!1,children:e.jsx(u,{id:"Label.Nei"})})]}),e.jsx(Sn,{isReadOnly:s,control:d.control,name:"barnSomSkalVurderes",label:e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.BarnSomSkalVurderes.Tittel"}),validate:[E=>E.length>0?void 0:n.formatMessage({id:"VurderOmsorgsovertakelseVilkåretForm.BarnSomSkalVurderes.Required"})],children:o.map(({fødselsdato:E,barnNummer:g})=>e.jsxs(bn,{value:g,readOnly:s,children:[e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.BarnSomSkalVurderes.Rad",values:{nummer:g,fødseldato:Ke(E)}}),e.jsx(Pe,{fødselsdato:E})]},g))}),e.jsx(W,{name:"delvilkår",control:d.control,validate:[K],label:s?e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.Delvilkår.ReadOnlyLabel"}):e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.Delvilkår.Label"}),isReadOnly:s,size:"small",children:Object.keys(a.aktuelleDelvilkårAvslagsårsaker).map(E=>m.OmsorgsovertakelseVilkårType.find(g=>g.kode===E)).sort(xe).map(E=>e.jsx(y,{size:"small",value:E?.kode,children:E?.navn},E?.kode))}),e.jsxs(W,{name:"vilkårUtfallType",control:d.control,validate:[K],label:s?e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering.ReadOnlyLabel"}):e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering.Label"}),isReadOnly:s,size:"small",children:[e.jsx(y,{size:"small",value:"OPPFYLT",children:e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering.Oppfylt"})}),e.jsx(y,{size:"small",value:"IKKE_OPPFYLT",children:e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.VilkårVurdering.IkkeOppfylt"})})]}),_&&N==="IKKE_OPPFYLT"&&e.jsx(gn,{name:"avslagskode",control:d.control,label:s?e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.Avslagsarsak.ReadOnlyLabel"}):e.jsx(u,{id:"VurderOmsorgsovertakelseVilkåretForm.Avslagsarsak.Label"}),selectValues:D.map(E=>e.jsx("option",{value:E?.kode,children:E?.navn},E?.kode)),readOnly:s,validate:[K],size:"small"}),e.jsx(O,{control:d.control,isSubmittable:i,size:"small",isReadOnly:s,hasBegrunnelse:!!R}),e.jsx(le,{isSubmittable:i,isSubmitting:d.formState.isSubmitting,isDirty:d.formState.isDirty,isReadOnly:s})]})})})},jr=(a,n,r)=>{const{gjeldende:l,saksbehandlerVurdering:{vilkårUtfallType:t,avslagsårsak:s}={}}=a;return{delvilkår:l.delvilkår,omsorgsovertakelseDato:l.omsorgsovertakelseDato,vilkårUtfallType:t==="OPPFYLT"||t==="IKKE_OPPFYLT"?t:void 0,avslagskode:s,barnSomSkalVurderes:r.filter(i=>i.skalBrukes).map(i=>i.barnNummer),ektefellesBarn:cr(l),...O.initialValues(n)}},qr=(a,n)=>({omsorgsovertakelseDato:H(a.omsorgsovertakelseDato),delvilkår:H(a.delvilkår),avslagskode:a.vilkårUtfallType==="IKKE_OPPFYLT"?a.avslagskode:void 0,ektefellesBarn:H(a.ektefellesBarn),barn:n.filter(r=>a.barnSomSkalVurderes.includes(r.barnNummer)).map(({barnNummer:r,fødselsdato:l})=>({barnNummer:r,fødselsdato:l})),kode:v.VURDER_OMSORGSOVERTAKELSEVILKÅRET,...O.transformValues(a)}),xe=(a,n)=>a?n?a.navn.localeCompare(n.navn):-1:1,cr=a=>{if(a.erEktefellesBarn===void 0){if(a.delvilkår==="FP_VK_16")return!1;if(a.delvilkår==="FP_VK_16S")return!0}return a.erEktefellesBarn},Br=a=>a.søknad.barn.map(n=>{const r=a.gjeldende.barn.find(l=>l.barnNummer===n.barnNummer);return{fødselsdato:r?.fødselsdato??n.fødselsdato,barnNummer:n.barnNummer,skalBrukes:!!r}});Oa.__docgenInfo={description:"",methods:[],displayName:"VurderOmsorgsovertakelseVilkåretForm",props:{omsorgsovertakelse:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktuelleDelvilkårAvslagsårsaker: {
    [key: string]: Array<foreldrepenger_behandlingslager_behandling_vilkår_Avslagsårsak>;
  };
  gjeldende: tjenester_behandling_fødsel_dto_OmsorgsovertakelseDto_Omsorgsovertakelse;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Vilkar[]"},description:""},ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""}}};const El={"FodselVilkarForm.Fodsel":"Fødsel","FodselVilkarForm.TidligereUtbetaltStonad":"Tidligere utbetalte foreldrepenger eller engangsstønad","FodselVilkarForm.Oppfylt":"Er utbetalt for et annet barn, vilkåret er oppfylt","FodselVilkarForm.IkkeOppfylt":"Er utbetalt for dette barnet, vilkåret er <b>ikke</b> oppfylt","ShowVilkarStatus.Check":"Informasjonen er utfylt"},_l=Y(El),vl=a=>e.jsx(J,{value:_l,children:e.jsx(ba,{...a})});vl.__docgenInfo={description:"",methods:[],displayName:"FodselVilkarProsessIndex",props:{ytelseTypeKode:{required:!0,tsType:{name:"string"},description:""},status:{required:!0,tsType:{name:"string"},description:""},vilkår:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avslagKode?: string;
  evaluering?: string;
  input?: string;
  lovReferanse?: string;
