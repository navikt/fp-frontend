import{j as e,l as g,P as v,b as p,L as y}from"./iframe-CMzPoObE.js";import{Q as f}from"./index.es-Hi99Ep8F.js";import{u as q,f as _}from"./fagsakApi-B8itA9jL.js";import{V as c}from"./VisittkortSakIndex-DkU9NYSD.js";import{V as j,a as N,B as A}from"./VStack-BOeSKnhy.js";import{M as o}from"./message-D0JXGJu6.js";import{E as w}from"./IngenBehandlingValgtPanel-BCAEQu3k.js";import{u as R}from"./useTrackRouteParam-D0EHoWYL.js";import{p as E}from"./paths-cz6MvGb8.js";import{u as d}from"./useKodeverk-zBOIC8q-.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
