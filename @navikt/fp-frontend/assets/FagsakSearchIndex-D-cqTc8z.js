import{j as e,l as O,W as G,P,e as F,m as V}from"./iframe-qRHtqp7Q.js";import{a as M,u as k,n as d}from"./fagsakApi-BvQRcxi3.js";import{u as o,C as U,T as B,c as g}from"./index.es-ibjRWTgb.js";import{T as t}from"./Table-DczlITYN.js";import{M as m}from"./message-bFiyVeFK.js";import{V as y,B as R,H as _,b as p}from"./VStack-dHHPLtpX.js";import{S as H}from"./ExclamationmarkTriangleFill-B_ZjGDND.js";import{p as J}from"./paths-kQgp8oMi.js";import{a as Y}from"./index-3WEybj0W.js";const I=({fagsaker:a,selectFagsakCallback:l,alleKodeverk:E})=>e.jsxs(t,{children:[e.jsx(t.Header,{children:e.jsxs(t.Row,{children:[e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Saksnummer"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Sakstype"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Status"})})]})}),e.jsx(t.Body,{children:a.map(n=>e.jsxs(t.Row,{onMouseDown:()=>l(n.saksnummer),onKeyDown:()=>l(n.saksnummer),children:[e.jsx(t.DataCell,{children:n.saksnummer}),e.jsx(t.DataCell,{children:E.FagsakYtelseType.find(r=>r.kode===n.fagsakYtelseType)?.navn??""}),e.jsx(t.DataCell,{children:E.FagsakStatus.find(r=>r.kode===n.status)?.navn??""})]},n.saksnummer))})]});I.__docgenInfo={description:`FagsakList
