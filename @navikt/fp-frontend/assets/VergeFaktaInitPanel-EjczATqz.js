import{r as d,o as R,j as s,bG as K,bH as I,bg as D}from"./iframe-99QkHxNs.js";import{Q as f}from"./index.es-BKtVa7i8.js";import{u as L}from"./fagsakApi-DEmUsNbW.js";import{V as O}from"./BehandlingMenuIndex-C8Fm4vZq.js";import{e as p,A as V}from"./index-CeZmOR9h.js";import{u as P,c as q}from"./behandlingApi-D0oUD_9c.js";import{B as E}from"./FagsakIndex-D0lx0Zya.js";import{Y as F}from"./index.es-e4CvwBJY.js";import{H as G}from"./VStack-TV2iDI3H.js";import{S as j}from"./ExclamationmarkTriangleFill-Cz_Lh6tM.js";import{e as B,g as w}from"./useStandardProsessPanelProps-BhpNfwCy.js";const h=r=>{const[l,e]=d.useState([]),t=a=>{e(i=>{const n=[...i],m=n.findIndex(u=>u.id===a.id);return m>=0?n.splice(m,1,a):n.push(a),n}),r?.(a.harÅpentAksjonspunkt?{urlCode:a.id,text:a.tekst}:void 0)};return{faktaPanelMenyData:l.filter(a=>a.skalVisesIMeny),settFaktaPanelMenyData:t}},M="_container_4o186_1",c="_content_4o186_6",U="_sideMenu_4o186_19",v={container:M,content:c,sideMenu:U},H=({valgtFaktaSteg:r,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const a=R(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=d.use(E),{faktaPanelMenyData:n,settFaktaPanelMenyData:m}=h(e),u=n.length>0;return s.jsxs(G,{className:v.container,wrap:!1,children:[u&&s.jsx("div",{className:v.sideMenu,"data-testid":"fakta-meny",children:s.jsx(F,{heading:a.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(o=>({label:o.tekst,active:o.erAktiv,icon:o.harÅpentAksjonspunkt?s.jsx(j,{color:"var(--ax-warning-700)"}):void 0})),onClick:o=>{i(l,n[o].id)}})}),s.jsx("div",{className:v.content,children:s.jsx(J,{valgtFaktaSteg:r,settFaktaPanelMenyData:m,faktaPanelMenyData:n,children:t})})]})},A=d.createContext({}),J=r=>{const{children:l,...e}=r,t=d.useMemo(()=>e,[e]);return s.jsx(A.Provider,{value:t,children:l})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",x=(r,l,e,t)=>{const{valgtFaktaSteg:a,settFaktaPanelMenyData:i}=d.use(A),n=e&&(a===r||t&&a===Y);return d.useEffect(()=>{i({id:r,tekst:l,erAktiv:n,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,n,t]),e&&n},y=({standardPanelProps:r,skalPanelVisesIMeny:l,faktaPanelKode:e,faktaPanelMenyTekst:t,children:a})=>{const{behandling:i,fagsak:n,alleKodeverk:m}=d.use(E),u=x(e,t,l,r.harÅpentAksjonspunkt);return s.jsx(K,{behandling:i,children:u?s.jsx(I,{behandling:i,fagsak:n,alleKodeverk:m,aksjonspunkterForPanel:r.aksjonspunkterForPanel,harÅpentAksjonspunkt:r.harÅpentAksjonspunkt,submitCallback:r.submitCallback,isReadOnly:r.isReadOnly,alleMerknaderFraBeslutter:r.alleMerknaderFraBeslutter,isSubmittable:r.isSubmittable,children:a}):null})};y.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const T="default",_="default",C=(r=[],l=[])=>{const{behandling:e,rettigheter:t,fagsak:a,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:m,alleKodeverk:u}=d.use(E),{aksjonspunkt:o}=e,g=o.filter(k=>r.includes(k.definisjon)),N=B(e,[],t,!1),b=w(e.status,g),S=Q(a,e,m,i,n,l);return{behandling:e,isSubmittable:!g.some(p)||g.some(k=>k.kanLoses),harÅpentAksjonspunkt:g.some(k=>p(k)&&k.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:g,isReadOnly:N,alleMerknaderFraBeslutter:b,submitCallback:S}},Q=(r,l,e,t,a,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(g=>({"@type":g.kode,...g})),o={saksnummer:r.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return a({...o,overstyrteAksjonspunktDtoer:u}).then(()=>e(_,T))}return t({...o,bekreftedeAksjonspunktDtoer:u}).then(()=>e(_,T))},z=[V.AVKLAR_VERGE],W=()=>{const r=R(),l=C(z),{behandling:e}=d.use(E),t=P(e),a=q(e,"VERGE"),{data:i,isFetching:n}=L(t.vergeOptions(e,a));return s.jsx(y,{standardPanelProps:l,faktaPanelKode:D.VERGE,faktaPanelMenyTekst:r.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:a,children:n?s.jsx(f,{}):s.jsx(O,{verge:i,alleKodeverk:l.alleKodeverk})})};W.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{y as F,W as V,H as a,C as u};
