import{r,j as o}from"./iframe-CBy73in6.js";const a={errors:[]},E=r.createContext(a),u=r.createContext(void 0),T=({children:e,initialState:s})=>{const[n,t]=r.useReducer((p,i)=>{switch(i.type){case"add":return{errors:p.errors.concat(i.data)};case"remove":return a;default:throw new Error("Action type doesn't exist")}},s||a);return o.jsx(E.Provider,{value:n,children:o.jsx(u.Provider,{value:t,children:e})})},d=()=>{const e=r.useContext(u);return{addErrorMessage:t=>{e&&e({type:"add",data:t})},removeErrorMessages:()=>{e&&e({type:"remove"})}}},g=()=>r.useContext(E).errors;T.__docgenInfo={description:"Tilbyr kontekst for lagring av feilmeldinger.",methods:[],displayName:"RestApiErrorProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},initialState:{required:!1,tsType:{name:"signature",type:"object",raw:"{ errors: FpError[] }",signature:{properties:[{key:"errors",value:{name:"Array",elements:[{name:"union",raw:`| GeneralError
| PollingTimeoutError
...
| PollingDelayedError`,elements:[{name:"signature",type:"object",raw:`{
  ...
  message: string;
  eta: string;
}`,signature:{properties:[{key:"type",value:{name:"ErrorType.POLLING_HALTED_OR_DELAYED",required:!0}},{key:"status",value:{name:"literal",value:"'DELAYED'",required:!0}},{key:"message",value:{name:"string",required:!0}},{key:"eta",value:{name:"string",required:!0}}]}}]}],raw:"FpError[]",required:!0}}]}},description:""}}};var y=(e=>(e.GENERAL_ERROR="GENERAL_ERROR",e.POLLING_TIMEOUT="POLLING_TIMEOUT",e.POLLING_HALTED_OR_DELAYED="POLLING_HALTED_OR_DELAYED",e.REQUEST_GATEWAY_TIMEOUT_OR_NOT_FOUND="REQUEST_GATEWAY_TIMEOUT_OR_NOT_FOUND",e.REQUEST_FORBIDDEN="REQUEST_FORBIDDEN",e.REQUEST_UNAUTHORIZED="REQUEST_UNAUTHORIZED",e))(y||{});export{y as E,T as R,g as a,d as u};
