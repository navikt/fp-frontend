import{j as e,l as g,P as v,b as p,L as y}from"./iframe-8iIUOOAF.js";import{Q as f}from"./index.es-wJ0C3p8N.js";import{u as q,f as _}from"./fagsakApi-BVpt4nuz.js";import{V as c}from"./VisittkortSakIndex-DN4eFr6Q.js";import{V as j,a as N,B as A}from"./VStack-dRjle75L.js";import{M as o}from"./message-BehtrRhz.js";import{E as w}from"./IngenBehandlingValgtPanel-DlJFXcNE.js";import{u as R}from"./useTrackRouteParam-C79sG6zD.js";import{p as E}from"./paths-CNt8hj8O.js";import{u as d}from"./useKodeverk-B15IGDz4.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
