import{w as T,j as a,M as R,R as u,a as h}from"./iframe-BAq1qRCa.js";import{Q as K}from"./index.es-CtvHaGuh.js";import{u as c,a as j,F as s,i,w as f,n as H,b as F,c as _}from"./fagsakApi-D7raqkgY.js";import{h as e,H as t,c as O}from"./index-D5xXlOeG.js";import{a as k}from"./alleKodeverk-Cho4R_ly.js";import{K as N}from"./Kjonnkode-DjBoP8-t.js";import{i as g}from"./initFetchFptilbake-CspdHVpU.js";import{A as d}from"./AktørIndex-Cn8nKe0U.js";import"./preload-helper-PPVm8Dsz.js";import"./VStack-ChDQ1_Jn.js";import"./index-p4Qo3XZS.js";import"./CheckmarkCircleFill-BPInZ8E2.js";import"./ExclamationmarkTriangleFill-DiJO5YlX.js";import"./VisittkortSakIndex-CppiXbYU.js";import"./index.es-IxEga_gq.js";import"./index-BcRQNEjs.js";import"./Link-ChhuCTN7.js";import"./Checkmark-O3TgC1FL.js";import"./Popover-ButC7TKy.js";import"./message-ASb7Xw1D.js";import"./Spacer-CuTk4BBD.js";import"./IngenBehandlingValgtPanel-a-H2I5QB.js";import"./useTrackRouteParam-BVYjJNpI.js";import"./paths-Jr8wrycM.js";import"./useKodeverk-CPX2XrMH.js";const I=l=>O(f(H(i.links.find(m=>m.rel===l)).href)),p={navn:"Espen Utvikler",fødselsnummer:"11111111111",kjønn:N.MANN,fødselsdato:"2000-01-02",aktørId:"22222222",språkkode:"-"},A={fagsaker:[{saksnummer:"123",fagsakYtelseType:"FP",status:"OPPR",aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p,relasjonsRolleType:"-"},{saksnummer:"252523",fagsakYtelseType:"ES",status:"LOP",aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p,relasjonsRolleType:"-"}],person:p},te={title:"app/AktørIndex",decorators:[T],component:d,parameters:{layout:"fullscreen"},render:()=>{const{status:l}=c(_()),{kodeverkOptions:m}=j(),{data:E}=c(m(l==="success"));return E?a.jsx(R,{initialEntries:["/fagsak/352011079"],children:a.jsx(u,{children:a.jsx(h,{element:a.jsx(d,{}),path:"/fagsak/:aktoerId"})})}):a.jsx(K,{})}},r={parameters:{msw:{handlers:[e.get(s.INIT_FETCH,()=>t.json(i)),e.get(s.INIT_FETCH_FPTILBAKE,()=>t.json(g)),e.get(I(F.KODEVERK),()=>t.json(k)),e.get(s.AKTOER_INFO,()=>t.json(A))]}}},n={parameters:{msw:{handlers:[e.get(s.INIT_FETCH,()=>t.json(i)),e.get(s.INIT_FETCH_FPTILBAKE,()=>t.json(g)),e.get(I(F.KODEVERK),()=>t.json(k)),e.get(s.AKTOER_INFO,()=>t.json({fagsaker:[],person:{...p,aktørId:void 0}}))]}}},o={parameters:{msw:{handlers:[e.get(s.INIT_FETCH,()=>t.json(i)),e.get(s.INIT_FETCH_FPTILBAKE,()=>t.json(g)),e.get(I(F.KODEVERK),()=>t.json(k)),e.get(s.AKTOER_INFO,()=>new t(null,{status:500}))]}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
