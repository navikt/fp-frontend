import{j as e,h as g,P as v,e as p,L as y}from"./iframe-ynvR1aa-.js";import{Z as f}from"./index.es-C6I7PSSH.js";import{u as q,f as _}from"./fagsakApi-CSmaGqZM.js";import{V as c}from"./VisittkortSakIndex-vhqHnQIS.js";import{V as j,a as N,B as A}from"./VStack-BpFLoSDH.js";import{M as o}from"./message-BBlFJ2An.js";import{E as w}from"./IngenBehandlingValgtPanel-AK7PSoJR.js";import{u as R}from"./useTrackRouteParam-C3b1w6dO.js";import{p as E}from"./paths-_Yndq9xs.js";import{u as d}from"./useKodeverk-CHZoG03r.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
