import{j as e,l as G,W as s,P,e as F,m as V}from"./iframe-CHIIULkI.js";import{a as M,u as k,n as B}from"./fagsakApi-DxgThHha.js";import{u as U,C as d,T as o,c as g}from"./index.es-DrNusAD1.js";import{T as t}from"./Table-D7gG_Gno.js";import{M as m}from"./message-BRQWuEAL.js";import{V as y,B as v,H as _,b as p}from"./VStack-fkaPRoOA.js";import{S as H}from"./ExclamationmarkTriangleFill-D6PXb7Li.js";import{p as J}from"./paths-BAKMLxMj.js";import{a as Y}from"./index-DYPpl1h6.js";const I=({fagsaker:a,selectFagsakCallback:l,alleKodeverk:E})=>e.jsxs(t,{children:[e.jsx(t.Header,{children:e.jsxs(t.Row,{children:[e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Saksnummer"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Sakstype"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(m,{id:"FagsakList.Status"})})]})}),e.jsx(t.Body,{children:a.map(n=>e.jsxs(t.Row,{onMouseDown:()=>l(n.saksnummer),onKeyDown:()=>l(n.saksnummer),children:[e.jsx(t.DataCell,{children:n.saksnummer}),e.jsx(t.DataCell,{children:E.FagsakYtelseType.find(r=>r.kode===n.fagsakYtelseType)?.navn??""}),e.jsx(t.DataCell,{children:E.FagsakStatus.find(r=>r.kode===n.status)?.navn??""})]},n.saksnummer))})]});I.__docgenInfo={description:`FagsakList
