import{j as e,o as D,Z as L,P as I,b as y,q as p}from"./iframe-Bi6mcpW9.js";import{a as G,u as O,n as K}from"./fagsakApi-DR2mcDTG.js";import{u as F,C as P,k as V,c as U}from"./index.es-CrVP4_UL.js";import{T as i}from"./Table-Da4C8slu.js";import{M as s}from"./message-kKNzudLU.js";import{V as M,B as v,H as N,b as B}from"./VStack-BAxRV9hT.js";import{S as q}from"./ExclamationmarkTriangleFill-DNO7kqE6.js";import{p as H}from"./paths-ByC-F2CS.js";import{a as c}from"./index-PgzdEw57.js";const A=({fagsaker:a,selectFagsakCallback:n,alleKodeverk:t})=>e.jsxs(i,{children:[e.jsx(i.Header,{children:e.jsxs(i.Row,{children:[e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Saksnummer"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Sakstype"})}),e.jsx(i.HeaderCell,{scope:"col",children:e.jsx(s,{id:"FagsakList.Status"})})]})}),e.jsx(i.Body,{children:a.map(l=>e.jsxs(i.Row,{onMouseDown:()=>n(l.saksnummer),onKeyDown:()=>n(l.saksnummer),children:[e.jsx(i.DataCell,{children:l.saksnummer}),e.jsx(i.DataCell,{children:t.FagsakYtelseType.find(r=>r.kode===l.fagsakYtelseType)?.navn??""}),e.jsx(i.DataCell,{children:t.FagsakStatus.find(r=>r.kode===l.status)?.navn??""})]},l.saksnummer))})]});A.__docgenInfo={description:`FagsakList
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const w="_container_tt7dx_1",h="_advarselIcon_tt7dx_6",k={container:w,advarselIcon:h},j=(a,n)=>!!(a||n===void 0||n.length<1),d=({searchStarted:a,searchResultAccessDenied:n,searchFagsakCallback:t})=>{const l=D(),r=F({defaultValues:{searchString:""}}),E=r.watch("searchString");return e.jsx(P,{formMethods:r,onSubmit:t,className:k.container,children:e.jsxs(M,{gap:"space-8",children:[e.jsx(v,{size:"small",children:e.jsx(s,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(N,{gap:"space-8",align:"end",children:[e.jsx(V,{name:"searchString",control:r.control,label:l.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[L]}),e.jsx(B,{variant:"primary",size:"small",loading:a,disabled:j(a,E),children:e.jsx(s,{id:"Search.Search"})})]}),n&&e.jsxs(N,{gap:"space-8",align:"end",children:[e.jsx(q,{className:k.advarselIcon}),e.jsx(v,{size:"small",children:e.jsx(s,{id:n.feilmelding})})]})]})})};d.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const Y="_container_gwama_1",f="_label_gwama_9",S={container:Y,label:f},_=({fagsaker:a,searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:l,searchStarted:r,searchResultAccessDenied:E,alleKodeverk:T})=>e.jsxs("div",{className:S.container,children:[e.jsx(d,{searchFagsakCallback:n,searchStarted:r,searchResultAccessDenied:E}),t&&a.length===0&&e.jsx(v,{size:"small",className:S.label,children:e.jsx(s,{id:"FagsakSearch.ZeroSearchResults"})}),t&&a.length>1&&e.jsx(A,{fagsaker:a,selectFagsakCallback:l,alleKodeverk:T})]});_.__docgenInfo={description:`FagsakSearch
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const b={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},J=y(b),o=({fagsaker:a=[],searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:l,searchStarted:r=!1,searchResultAccessDenied:E,alleKodeverk:T})=>e.jsx(I,{value:J,children:e.jsx(_,{fagsaker:a,searchFagsakCallback:n,searchResultReceived:t,selectFagsakCallback:l,searchStarted:r,searchResultAccessDenied:E,alleKodeverk:T})});o.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aktørId: string;
  barnFødt: string;
  endret?: string;
  fagsakYtelseType: foreldrepenger_behandlingslager_fagsak_FagsakYtelseType;
...
>[]`}}]}},{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"lovHjemmel",value:{name:"string",required:!0}},{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const x=()=>{const{kodeverkOptions:a,søkFagsak:n}=G(),{data:t}=O(a()),l=p(),r=u=>{u&&l(H(u))},{mutate:E,data:T=[],status:R,error:m}=U({mutationFn:u=>n(u.searchString),onSuccess:u=>{u.length===1&&r(u[0]?.saksnummer)}}),g=m&&m instanceof c&&m.response.status===403&&"data"in m.response?m.response.data:void 0;return e.jsx(o,{fagsaker:T,searchFagsakCallback:E,searchResultReceived:R==="success",selectFagsakCallback:r,searchStarted:R==="pending",searchResultAccessDenied:g,alleKodeverk:K(t)})};x.__docgenInfo={description:`FagsakSearchIndex

Har ansvar for å vise søkeskjermbildet og å håndtere fagsaksøket
mot server og lagringen av resultatet i klientens state.`,methods:[],displayName:"FagsakSearchIndex"};export{x as F};
