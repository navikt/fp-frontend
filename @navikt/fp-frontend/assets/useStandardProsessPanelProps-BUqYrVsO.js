import{r as N,j as _,bn as p,bA as V,bB as F}from"./iframe-CTSH3I4W.js";import{u as d}from"./FagsakIndex-D4wlveE_.js";import{B as y,P as G}from"./BehandlingHenlagtPanel-vnLGzSXw.js";import{k as P,M as A}from"./index.es-_zTC2q-o.js";import{e as b}from"./aksjonspunktUtils-Bp6ewLMR.js";const B=()=>{const[e,r]=N.useState([]),n=a=>{r(E=>{const l=[...E],t=l.findIndex(i=>i.id===a.id);return t>=0?l.splice(t,1,a):l.push(a),l})};return{prosessPanelMenyData:e.filter(a=>a.skalVisesIMeny),settProsessPanelMenyData:n}},M="_container_142tr_1",U="_meny_142tr_9",f="_stepArrowContainer_142tr_16",g={container:M,meny:U,stepArrowContainer:f},q=({valgtProsessSteg:e,valgtFaktaSteg:r,children:n})=>{const{oppdaterProsessStegOgFaktaPanelIUrl:a,behandling:E}=d(),{prosessPanelMenyData:l,settProsessPanelMenyData:t}=B(),i=m=>{const u=l[m],o=u?.erAktiv?void 0:u?.id;a(o,r)},s=l.map(m=>{const u=w(m.status,m.harÅpentAksjonspunkt);return{label:m.tekst,isActive:m.erAktiv,type:u}});return _.jsxs("div",{className:g.container,children:[_.jsx("div",{className:g.meny,"data-testid":"prosess-meny",children:_.jsx(P,{steps:s,onClick:i,stepArrowContainerStyle:g.stepArrowContainer})}),_.jsx(j,{valgtProsessSteg:e,settProsessPanelMenyData:t,prosessPanelMenyData:l,children:n}),E.behandlingHenlagt&&_.jsx(y,{valgtProsessSteg:e,settProsessPanelMenyData:t})]})},K=N.createContext({}),j=e=>{const{children:r,...n}=e,a=N.useMemo(()=>n,[n]);return _.jsx(K.Provider,{value:a,children:r})},w=(e,r)=>r?A.warning:e==="OPPFYLT"?A.success:e==="IKKE_OPPFYLT"?A.danger:A.default;q.__docgenInfo={description:"",methods:[],displayName:"ProsessMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},children:{required:!0,tsType:{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"},description:""}}};const h=(e,r)=>e!=="UTRED"?{}:r.reduce((n,a)=>({...n,[a.definisjon]:{notAccepted:a.toTrinnsBehandling&&a.toTrinnsBehandlingGodkjent===!1}}),{}),H=e=>e.taskStatus?.readOnly??!1,c=(e,r,n,a)=>{const{behandlingPåVent:E}=e,l=a||H(e),t=r.some(i=>!i.overstyrbar);return!n.writeAccess.isEnabled||E||l||t},Y="default",J=(e,r,n,a,E,l)=>{const{valgtProsessSteg:t,settProsessPanelMenyData:i}=N.use(K),s=n&&(t===e||l&&t===Y);return N.useEffect(()=>{i({id:e,tekst:r,erAktiv:s,harÅpentAksjonspunkt:a,status:E,skalVisesIMeny:n})},[n,s,a,E]),n&&s},C=e=>_.jsx(I,{...e,harÅpentAksjonspunkt:e.standardPanelProps.harÅpentAksjonspunkt}),Z=e=>{const{erOverstyrt:r}=p(),n=r||e.standardPanelProps.harÅpentAksjonspunkt;return _.jsx(I,{...e,harÅpentAksjonspunkt:n})},I=({overstyrtStatus:e,skalMarkeresSomAktiv:r,skalPanelVisesIMeny:n,prosessPanelKode:a,prosessPanelMenyTekst:E,standardPanelProps:l,harÅpentAksjonspunkt:t,children:i})=>{const{behandling:s,fagsak:m,alleKodeverk:u}=d(),o=e??l.status,R=!!r&&!s.behandlingHenlagt,v=J(a,E,n,t,o,R||t),k=v&&(t||o!=="IKKE_VURDERT");return _.jsx(V,{behandling:s,children:_.jsx(G,{erPanelValgt:v,harÅpentAksjonspunkt:l.harÅpentAksjonspunkt,status:o,children:k?_.jsx(F,{fagsak:m,behandling:s,alleKodeverk:u,alleMerknaderFraBeslutter:l.alleMerknaderFraBeslutter,aksjonspunkterForPanel:l.aksjonspunkterForPanel,harÅpentAksjonspunkt:l.harÅpentAksjonspunkt,isReadOnly:l.isReadOnly,isSubmittable:l.isSubmittable,submitCallback:l.submitCallback,children:i}):null})})};C.__docgenInfo={description:"",methods:[],displayName:"ProsessDefaultInitPanel",props:{skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},overstyrtStatus:{required:!1,tsType:{name:"union",raw:`| 'OPPFYLT'
| 'IKKE_OPPFYLT'
| 'IKKE_VURDERT'
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Vilkar[]",required:!0}},{key:"status",value:{name:"union",raw:`| 'OPPFYLT'
| 'IKKE_OPPFYLT'
| 'IKKE_VURDERT'
| '-'`,elements:[{name:"literal",value:"'OPPFYLT'"},{name:"literal",value:"'IKKE_OPPFYLT'"},{name:"literal",value:"'IKKE_VURDERT'"},{name:"literal",value:"'-'"}],required:!0}},{key:"isReadOnly",value:{name:"boolean",required:!0}},{key:"isSubmittable",value:{name:"boolean",required:!0}},{key:"harÅpentAksjonspunkt",value:{name:"boolean",required:!0}},{key:"submitCallback",value:{name:"signature",type:"function",raw:"(aksjonspunkterSomSkalLagres: ProsessAksjonspunkt | ProsessAksjonspunkt[]) => Promise<void>",signature:{arguments:[{type:{name:"union",raw:"ProsessAksjonspunkt | ProsessAksjonspunkt[]",elements:[{name:"union",raw:`| BekreftSvangerskapspengervilkarAp
| SoknadsfristAp
...
| '-'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'FERIE'"},{name:"literal",value:"'SYKDOM_SKADE'"},{name:"literal",value:"'SØKER_INNLAGT'"},{name:"literal",value:"'BARN_INNLAGT'"},{name:"literal",value:"'HV_OVELSE'"},{name:"literal",value:"'NAV_TILTAK'"},{name:"literal",value:"'FRI'"},{name:"literal",value:"'-'"}],required:!1}}]}}],raw:"PeriodeSoker[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}],raw:"ProsessAksjonspunkt[]"}]},name:"aksjonspunkterSomSkalLagres"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}},required:!0}}]}},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};Z.__docgenInfo={description:"",methods:[],displayName:"ProsessDefaultInitOverstyringPanel",props:{skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},overstyrtStatus:{required:!1,tsType:{name:"union",raw:`| 'OPPFYLT'
| 'IKKE_OPPFYLT'
| 'IKKE_VURDERT'
| '-'`,elements:[{name:"literal",value:"'OPPFYLT'"},{name:"literal",value:"'IKKE_OPPFYLT'"},{name:"literal",value:"'IKKE_VURDERT'"},{name:"literal",value:"'-'"}]},description:""},prosessPanelKode:{required:!0,tsType:{name:"ProsessStegCode"},description:""},prosessPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},skalMarkeresSomAktiv:{required:!1,tsType:{name:"boolean"},description:""},standardPanelProps:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  behandling: T;
...
| '-'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'FERIE'"},{name:"literal",value:"'SYKDOM_SKADE'"},{name:"literal",value:"'SØKER_INNLAGT'"},{name:"literal",value:"'BARN_INNLAGT'"},{name:"literal",value:"'HV_OVELSE'"},{name:"literal",value:"'NAV_TILTAK'"},{name:"literal",value:"'FRI'"},{name:"literal",value:"'-'"}],required:!1}}]}}],raw:"PeriodeSoker[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]}],raw:"ProsessAksjonspunkt[]"}]},name:"aksjonspunkterSomSkalLagres"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}},required:!0}}]}},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const W="default",X="default",re=(e=[],r=[],n)=>{const{behandling:a,rettigheter:E,fagsak:l,lagreAksjonspunkter:t,lagreOverstyrteAksjonspunkter:i,alleKodeverk:s,oppdaterProsessStegOgFaktaPanelIUrl:m}=d(),u=a.aksjonspunkt.filter(T=>e.includes(T.definisjon)),R=("vilkår"in a?a.vilkår:[]).filter(T=>r.includes(T.vilkarType)),v=c(a,R,E,!1),k=h(a.status,u),L=u.some(T=>T.status==="OPPR"&&T.kanLoses),S=Q(R,u),D=u.some(T=>T.kanLoses)&&S!=="OPPFYLT",O=x(n||(()=>()=>{m(X,W),globalThis.scrollTo({top:0,behavior:"smooth"})}),l,a,u,t,i);return{fagsak:l,behandling:a,alleKodeverk:s,alleMerknaderFraBeslutter:k,aksjonspunkterForPanel:u,vilkårForPanel:R,isReadOnly:v,isSubmittable:D,harÅpentAksjonspunkt:L,submitCallback:O,status:S}},x=(e,r,n,a,E,l)=>t=>{const i=Array.isArray(t)?t:[t],s=i.map(v=>({"@type":v.kode,...v})),m={saksnummer:r.saksnummer,behandlingUuid:n.uuid,behandlingVersjon:n.versjon},u=e(i),o=a.filter(v=>i.some(k=>k.kode===v.definisjon)),R=o.some(v=>v.aksjonspunktType==="OVST"||v.aksjonspunktType==="SAOV");if(i.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");return o.length===0||R?l({...m,overstyrteAksjonspunktDtoer:s}).then(u):E({...m,bekreftedeAksjonspunktDtoer:s}).then(u)},Q=(e,r)=>e.length>0?e.some(n=>n.vilkarStatus==="IKKE_VURDERT")?"IKKE_VURDERT":e.some(n=>n.vilkarStatus!=="OPPFYLT")?"IKKE_OPPFYLT":"OPPFYLT":r.length>0?r.some(b)?"IKKE_VURDERT":"OPPFYLT":"IKKE_VURDERT";export{C as P,q as a,Z as b,K as c,J as d,c as e,h as g,re as u};
