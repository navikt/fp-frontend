import{o as p,S as ne,j as a,x as y,U as le,I as c,z as re,A as te,P as H,b as w,r as f,q as ie,V as B}from"./iframe-CXy1SQYV.js";import{n as h,r as Y,u as ue,s as se,d as Ee}from"./fagsakApi-BeLiGKxN.js";import{u as me,C as ve,w as O,O as oe,c as b}from"./index.es-CdljjSKN.js";import{D as i}from"./dokumentMalType-B-Xou3xH.js";import{V as _e}from"./venteArsakType-BJdSFL9e.js";import{U as de}from"./UkjentAdresseMeldingIndex-3P_KqsXP.js";import{V as x,H as V,b as J,M as q,L as Te}from"./VStack-DcF40O_v.js";import{L as ge}from"./Link-BPDsJfE7.js";import{M as k}from"./message-CYj9KsSt.js";import{S as Ne}from"./CheckmarkCircleFill-Com79Hyx.js";import{u as M}from"./useKodeverk-CDxyb-iT.js";import{S as Re}from"./SupportHeader-DlM6M3eU.js";import{S as ke}from"./SettPaVentReadOnlyModal-D-NhUl2W.js";import{A as Ae}from"./index.es-s-MPZQXJ.js";var T=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(T||{});const Se="_bredde_jav4h_9",U={bredde:Se},Ie=c(4e3),Ke=c(1e4),Le=re(3),C=({behandling:e,forhåndsvisBrev:n,submitCallback:t,revurderingVarslingArsak:E,fagsakYtelseType:m,kanVeilede:l,meldingFormData:u,setMeldingFormData:g,brukerManglerAdresse:R})=>{const v=p(),o=me({defaultValues:u??Ve(e)}),_=o.watch("brevmalkode"),A=o.watch("fritekst"),s=o.watch("arsakskode"),K=be(E,m),{formState:S,control:d}=o,I=r=>{_&&n({brevmalkode:_,fritekst:A,arsakskode:s}),r.preventDefault()},L=ne(e.språkkode),N=_===i.VARSEL_OM_REVURDERING;return a.jsx(ve,{formMethods:o,onSubmit:r=>t(pe(r)),setDataOnUnmount:g,children:a.jsxs(x,{gap:"space-16",children:[a.jsx(O,{name:"brevmalkode",control:d,label:v.formatMessage({id:"Messages.Template"}),validate:[y],selectValues:e.brevmaler.map(r=>a.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:U.bredde}),N&&a.jsx(O,{name:"arsakskode",control:d,label:v.formatMessage({id:"Messages.Årsak"}),validate:[y],selectValues:K.map(r=>a.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:U.bredde}),ye(_,s)&&a.jsx(oe,{name:"fritekst",control:d,label:v.formatMessage({id:De(_)}),validate:[y,N?Ke:Ie,Le,te],maxLength:N?1e4:4e3,badges:[{type:"info",titleText:L}],parse:le}),R&&a.jsx(de,{}),a.jsxs(V,{justify:"space-between",children:[(!N||s!==void 0)&&a.jsx(ge,{href:"#",onClick:I,onKeyDown:r=>r.key==="Enter"?I(r):null,children:a.jsx(k,{id:"Messages.Preview"})}),a.jsx(J,{size:"small",variant:"primary",loading:S.isSubmitting,disabled:S.isSubmitting||l,children:a.jsx(k,{id:"Messages.Submit"})})]})]})})},De=e=>e===i.INNHENTE_OPPLYSNINGER||e===i.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",ye=(e,n)=>e===i.INNHENTE_OPPLYSNINGER||e===i.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===i.VARSEL_OM_TILBAKEKREVING||e===i.TBK_INNHENTE_OPPLYSNINGER||e===i.VARSEL_OM_REVURDERING&&n===T.ANNET,be=(e,n)=>n==="ES"?e.filter(t=>t.kode===T.BARN_IKKE_REGISTRERT_FOLKEREGISTER||t.kode===T.ANNET):n==="SVP"?e.filter(t=>t.kode!==T.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&t.kode!==T.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,Ve=e=>{const n={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...n,brevmalkode:i.VARSEL_OM_REVURDERING}:{...n}},pe=e=>{const n=e;return e.brevmalkode===i.VARSEL_OM_REVURDERING&&n.arsakskode!==T.ANNET&&(n.fritekst=" "),n};C.__docgenInfo={description:`Messages
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""}}};const Ge="_image_v04s1_1",Pe="_modal_v04s1_8",j={image:Ge,modal:Pe},$=({showModal:e,closeEvent:n})=>{const t=p();return a.jsx(q,{className:j.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:n,children:a.jsx(q.Body,{children:a.jsxs(V,{justify:"space-between",align:"center",children:[a.jsxs(V,{gap:"space-8",align:"center",children:[a.jsx(Ne,{className:j.image,title:t.formatMessage({id:"MessagesModal.description"})}),a.jsx(Te,{size:"small",children:a.jsx(k,{id:"MessagesModal.text"})})]}),a.jsx(J,{size:"small",variant:"primary",onClick:n,autoFocus:!0,type:"button",children:a.jsx(k,{id:"MessagesModal.OK"})})]})})})};$.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const fe=w(z),W=e=>a.jsx(H,{value:fe,children:a.jsx($,{...e})});W.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Be=e=>e.behandlingPåVent?e.fristBehandlingPåVent:void 0,he=({fagsakData:e,valgtBehandlingUuid:n,meldingFormData:t,setMeldingFormData:E,hentOgSettBehandling:m,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const u=p(),[g,R]=f.useState(!1),[v,o]=f.useState(!1),_=ie(),A=e.getFagsak(),s=h(e.getBehandling(n)),K=Y(s),S=ue(Ee()),{innloggetBruker:{kanVeilede:d}}=h(S.data),I=M("Venteårsak"),L=M("RevurderingVarslingÅrsak"),{mutateAsync:N,status:r}=b({mutationFn:D=>K.sendMelding(D)}),X=Oe(o,N,m,R,E,s),Z=()=>{_("/")},ee=Me(s),ae=()=>(o(!1),m()),F=r==="success",G=s.behandlingTillatteOperasjoner,P=!d&&e.getAlleBehandlinger().some(D=>!D.avsluttet)&&G?.behandlingKanSendeMelding;return a.jsxs(a.Fragment,{children:[v&&a.jsx(W,{showModal:F&&v,closeEvent:ae}),a.jsx(Re,{tekst:u.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:a.jsxs(x,{gap:"space-16",children:[!P&&a.jsx(Ae,{variant:"info",children:a.jsx(k,{id:qe(d,G?.behandlingKanSendeMelding)})}),P&&a.jsx(Q,{submitCallback:X,behandling:s,forhåndsvisBrev:ee,revurderingVarslingArsak:L,fagsakYtelseType:A.fagsakYtelseType,kanVeilede:d,meldingFormData:t,setMeldingFormData:E,brukerManglerAdresse:A.brukerManglerAdresse})]})}),F&&g&&a.jsx(ke,{lukkCallback:Z,ventearsak:_e.AVV_DOK,ventearsaker:I,frist:Be(s)})]})},Oe=(e,n,t,E,m,l)=>u=>{const g=u.brevmalkode===i.INNHENTE_OPPLYSNINGER||u.brevmalkode===i.VARSEL_OM_REVURDERING||u.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,R=l.type==="BT-007"||l.type==="BT-009";e(!g);const v=R?{behandlingUuid:l.uuid,fritekst:u.fritekst,brevmalkode:u.brevmalkode}:{behandlingUuid:l.uuid,brevmalkode:u.brevmalkode,fritekst:u.fritekst,arsakskode:u.arsakskode};return n(v).then(()=>{m(),g?E(!0):t()})},qe=(e,n)=>n?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Me=e=>{const n=Y(e),{mutate:t}=b({mutationFn:l=>n.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:l.brevmalkode,fritekst:l.fritekst||" ",arsakskode:l.arsakskode}),onSuccess:l=>{B(l)}}),{mutate:E}=b({mutationFn:l=>se(e.uuid,l.brevmalkode,l.fritekst??" "),onSuccess:l=>{B(l)}}),m=e.type==="BT-007"||e.type==="BT-009";return l=>{m?E(l):t(l)}};he.__docgenInfo={description:`MeldingIndex
...
Har ansvar for å hente mottakere og brevmaler fra serveren.`,methods:[],displayName:"MeldingIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},meldingFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  fritekst?: string;
  arsakskode?: string;
}`,signature:{properties:[{key:"brevmalkode",value:{name:"string",required:!1}},{key:"fritekst",value:{name:"string",required:!1}},{key:"arsakskode",value:{name:"string",required:!1}}]}},name:"data"}],return:{name:"void"}}},description:""},hentOgSettBehandling:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{he as M,T as R};
