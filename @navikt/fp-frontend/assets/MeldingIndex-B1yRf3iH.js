import{l as F,G as ee,j as a,t as k,H as ae,C as q,q as le,N as ne,P as H,e as j,r as y,m as re,I as b}from"./iframe-qRHtqp7Q.js";import{n as p,g as c,u as te,h as ie,c as ue}from"./fagsakApi-BvQRcxi3.js";import{u as Ee,C as me,w as B,O as ve,c as O}from"./index.es-ibjRWTgb.js";import{U as se}from"./UkjentAdresseMeldingIndex-C_it3gu_.js";import{V as J,H as L,b as w,M,L as Ne}from"./VStack-dHHPLtpX.js";import{L as Te}from"./Link-DxRWQEOg.js";import{M as d}from"./message-bFiyVeFK.js";import{S as oe}from"./CheckmarkCircleFill-C2EU5DHE.js";import{u as f}from"./useKodeverk-DbQbrXP4.js";import{S as _e}from"./SupportHeader-p_ETp3CZ.js";import{S as Re}from"./SettPaVentReadOnlyModal-DAPU3Z1I.js";import{A as de}from"./index.es-NJUZ_7pt.js";const Ae="_bredde_jav4h_9",U={bredde:Ae},Ke=q(4e3),ge=q(1e4),Se=le(3),Y=({behandling:e,forhåndsvisBrev:l,submitCallback:t,revurderingVarslingArsak:E,fagsakYtelseType:m,kanVeilede:n,meldingFormData:i,setMeldingFormData:o,brukerManglerAdresse:R})=>{const v=F(),s=Ee({defaultValues:i??Oe(e)}),N=s.watch("brevmalkode"),A=s.watch("fritekst"),u=s.watch("arsakskode"),S=ke(E,m),{formState:K,control:T}=s,g=r=>{N&&l({brevmalkode:N,fritekst:A,arsakskode:u}),r.preventDefault()},I=ee(e.språkkode),_=N==="VARREV";return a.jsx(me,{formMethods:s,onSubmit:r=>t(Le(r)),setDataOnUnmount:o,children:a.jsxs(J,{gap:"space-16",children:[a.jsx(B,{name:"brevmalkode",control:T,label:v.formatMessage({id:"Messages.Template"}),validate:[k],selectValues:e.brevmaler.map(r=>a.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:U.bredde}),_&&a.jsx(B,{name:"arsakskode",control:T,label:v.formatMessage({id:"Messages.Årsak"}),validate:[k],selectValues:S.map(r=>a.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:U.bredde}),Ve(N,u)&&a.jsx(ve,{name:"fritekst",control:T,label:v.formatMessage({id:Ie(N)}),validate:[k,_?ge:Ke,Se,ne],maxLength:_?1e4:4e3,badges:[{type:"info",titleText:I}],parse:ae}),R&&a.jsx(se,{}),a.jsxs(L,{justify:"space-between",children:[(!_||u!==void 0)&&a.jsx(Te,{href:"#",onClick:g,onKeyDown:r=>r.key==="Enter"?g(r):null,children:a.jsx(d,{id:"Messages.Preview"})}),a.jsx(w,{size:"small",variant:"primary",loading:K.isSubmitting,disabled:K.isSubmitting||n,children:a.jsx(d,{id:"Messages.Submit"})})]})]})})},Ie=e=>e==="INNOPP"||e==="INNHEN"?"Messages.DocumentList":"Messages.Fritekst",Ve=(e,l)=>e==="INNOPP"||e==="KORRIGVARS"||e==="VARS"||e==="INNHEN"||e==="VARREV"&&l==="ANNET",ke=(e,l)=>l==="ES"?e.filter(t=>t.kode==="BARNIKKEREG"||t.kode==="ANNET"):l==="SVP"?e.filter(t=>t.kode!=="BARNIKKEREG"&&t.kode!=="AKTIVITET"):e,Oe=e=>{const l={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...l,brevmalkode:"VARREV"}:{...l}},Le=e=>{const l=e;return e.brevmalkode==="VARREV"&&l.arsakskode!=="ANNET"&&(l.fritekst=" "),l};Y.__docgenInfo={description:`Messages
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_6'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""}}};const De="_image_v04s1_1",Pe="_modal_v04s1_8",h={image:De,modal:Pe},z=({showModal:e,closeEvent:l})=>{const t=F();return a.jsx(M,{className:h.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:l,children:a.jsx(M.Body,{children:a.jsxs(L,{justify:"space-between",align:"center",children:[a.jsxs(L,{gap:"space-8",align:"center",children:[a.jsx(oe,{className:h.image,title:t.formatMessage({id:"MessagesModal.description"})}),a.jsx(Ne,{size:"small",children:a.jsx(d,{id:"MessagesModal.text"})})]}),a.jsx(w,{size:"small",variant:"primary",onClick:l,autoFocus:!0,type:"button",children:a.jsx(d,{id:"MessagesModal.OK"})})]})})})};z.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Ge=j(x),Q=e=>a.jsx(H,{value:Ge,children:a.jsx(z,{...e})});Q.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const ye=e=>e.behandlingPåVent?e.fristBehandlingPåVent:void 0,be=({fagsakData:e,valgtBehandlingUuid:l,meldingFormData:t,setMeldingFormData:E,hentOgSettBehandling:m,toggleVisUtvidetBehandlingDetaljerKnapp:n})=>{const i=F(),[o,R]=y.useState(!1),[v,s]=y.useState(!1),N=re(),A=e.getFagsak(),u=p(e.getBehandling(l)),S=c(u),K=te(ue()),{innloggetBruker:{kanVeilede:T}}=p(K.data),g=f("Venteårsak"),I=f("RevurderingVarslingÅrsak"),{mutateAsync:_,status:r}=O({mutationFn:V=>S.sendMelding(V)}),$=pe(s,_,m,R,E,u),W=()=>{N("/")},X=Me(u),Z=()=>(s(!1),m()),D=r==="success",P=u.behandlingTillatteOperasjoner,G=!T&&e.getAlleBehandlinger().some(V=>!V.avsluttet)&&P?.behandlingKanSendeMelding;return a.jsxs(a.Fragment,{children:[v&&a.jsx(Q,{showModal:D&&v,closeEvent:Z}),a.jsx(_e,{tekst:i.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:n,children:a.jsxs(J,{gap:"space-16",children:[!G&&a.jsx(de,{variant:"info",children:a.jsx(d,{id:Be(T,P?.behandlingKanSendeMelding)})}),G&&a.jsx(C,{submitCallback:$,behandling:u,forhåndsvisBrev:X,revurderingVarslingArsak:I,fagsakYtelseType:A.fagsakYtelseType,kanVeilede:T,meldingFormData:t,setMeldingFormData:E,brukerManglerAdresse:A.brukerManglerAdresse})]})}),D&&o&&a.jsx(Re,{lukkCallback:W,ventearsak:"AVV_DOK",ventearsaker:g,frist:ye(u)})]})},pe=(e,l,t,E,m,n)=>i=>{const o=i.brevmalkode==="INNOPP"||i.brevmalkode==="VARREV"||i.brevmalkode==="ELYSIM",R=n.type==="BT-007"||n.type==="BT-009";e(!o);const v=R?{behandlingUuid:n.uuid,fritekst:i.fritekst,brevmalkode:i.brevmalkode}:{behandlingUuid:n.uuid,brevmalkode:i.brevmalkode,fritekst:i.fritekst,arsakskode:i.arsakskode};return l(v).then(()=>{m(),o?E(!0):t()})},Be=(e,l)=>l?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Me=e=>{const l=c(e),{mutate:t}=O({mutationFn:n=>l.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:n.brevmalkode,fritekst:n.fritekst||" ",arsakskode:n.arsakskode}),onSuccess:n=>{b(n)}}),{mutate:E}=O({mutationFn:n=>ie(e.uuid,n.brevmalkode,n.fritekst??" "),onSuccess:n=>{b(n)}}),m=e.type==="BT-007"||e.type==="BT-009";return n=>{m?E(n):t(n)}};be.__docgenInfo={description:`MeldingIndex
