...
}`,signature:{properties:[{key:"aktivitetType",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!1}},{key:"arbeidsgiverReferanse",value:{name:"string",required:!1}},{key:"erEndring",value:{name:"boolean",required:!0}},{key:"godkjent",value:{name:"boolean",required:!0}},{key:"orgnr",value:{name:"string",required:!1}},{key:"privatpersonFødselsdato",value:{name:"string",required:!1}}]}},description:""}}};const ln=e=>e?.fastsattVarigEndringNaering?a.jsx(u,{id:"ToTrinnsForm.Beregning.VarigEndring"}):a.jsx(u,{id:"ToTrinnsForm.Beregning.IkkeVarigEndring"}),W=e=>e.uttakPerioder.map(n=>{const l=J(n.fom),i=J(n.tom);let t;return n.erSlettet?t="ToTrinnsForm.AvklarUttak.PeriodeSlettet":n.erLagtTil?t="ToTrinnsForm.AvklarUttak.PeriodeLagtTil":n.erEndret&&(e.aksjonspunktKode===r.FASTSETT_UTTAKPERIODER||e.aksjonspunktKode===r.TILKNYTTET_STORTINGET)?t="ToTrinnsForm.ManueltFastsattUttak.PeriodeEndret":n.erEndret&&e.aksjonspunktKode===r.OVERSTYRING_AV_UTTAKPERIODER||n.erEndret&&e.aksjonspunktKode===r.OVERSTYR_FAKTA_UTTAK?t="ToTrinnsForm.OverstyrUttak.PeriodeEndret":n.erEndret?t="ToTrinnsForm.AvklarUttak.PeriodeEndret":t="ToTrinnsForm.AvklarUttak.PeriodeAvklart",a.jsx(u,{id:t,values:{a:l,b:i}},t)}),rn=e=>e.opptjeningAktiviteter.map(n=>a.jsx(se,{aktivitet:n},n.aktivitetType)),tn=e=>{const n=Xe[e.aksjonspunktKode];return n&&typeof n=="string"?[a.jsx(u,{id:n},n)]:[]},un=e=>{const n=Ze[e.aksjonspunktKode];return n&&typeof n=="string"?[a.jsx(u,{id:n},n)]:[]},sn=e=>{const n=e?"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddFP":"ToTrinnsForm.Foreldreansvar.VurderVilkarForeldreansvarAndreLeddES";return[a.jsx(u,{id:n},n)]},En=(e,n)=>n?.faktaOmBeregningTilfeller?n.faktaOmBeregningTilfeller.flatMap(l=>{const i=e.find(t=>t.kode===l);return i?[a.jsx("div",{children:i.navn},i.navn)]:[]}):[],on=e=>{let n="";switch(e?.type){case V.KLAGE_YTELSESVEDTAK_STADFESTET:n="ToTrinnsForm.Klage.StadfesteYtelsesVedtak";break;case V.KLAGE_YTELSESVEDTAK_OPPHEVET:n="ToTrinnsForm.Klage.OppheveYtelsesVedtak";break;case V.KLAGE_AVVIST:n="ToTrinnsForm.Klage.Avvist";break;case V.HJEMSENDE_UTEN_OPPHEVE:n="ToTrinnsForm.Klage.HjemsendUtenOpphev";break;case V.KLAGE_DELVIS_MEDHOLD:n="ToTrinnsForm.Klage.DelvisOmgjortTilGunst";break;case V.KLAGE_OMGJORT_UGUNST:n="ToTrinnsForm.Klage.OmgjortTilUgunst";break;case V.KLAGE_MEDHOLD:n="ToTrinnsForm.Klage.OmgjortTilGunst";break}return a.jsx(u,{id:n})},mn=(e,n)=>e===j.FATTER_VEDTAK?[on(n)]:[],vn=()=>a.jsx(u,{id:"ToTrinnsForm.AvklarUttak.AnnenForelderHarRett"}),dn=()=>a.jsx(u,{id:"ToTrinnsForm.AvklarUttak.OverstyrtRettOgOmsorg"}),Tn=e=>e.aksjonspunktKode===r.BEHANDLE_KLAGE_NFP||e.aksjonspunktKode===r.VURDERING_AV_FORMKRAV_KLAGE_NFP,Ee=(e,n,l,i,t,s)=>t.aksjonspunktKode===r.VURDER_PERIODER_MED_OPPTJENING?rn(t):t.aksjonspunktKode===r.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE?[ln(t.beregningDto)]:t.aksjonspunktKode===r.VURDER_FAKTA_FOR_ATFL_SN?En(l,t.beregningDto):he(t.aksjonspunktKode)&&t.uttakPerioder.length>0||Ue(t.aksjonspunktKode)&&t.uttakPerioder.length>0?W(t):t.aksjonspunktKode===r.AVKLAR_ANNEN_FORELDER_RETT?[vn()]:t.aksjonspunktKode===r.MANUELL_VURDERING_AV_FORELDREANSVARSVILKARET_2_LEDD?sn(e):t.aksjonspunktKode===r.OVERSTYRING_AV_RETT_OG_OMSORG?[dn()]:Tn(t)?mn(n,s):i?un(t):tn(t),_n=pe(3),kn=ye(2e3),N="aksjonspunktGodkjenning",gn=(e,n)=>!e(`${N}.${n}.feilFakta`)&&!e(`${N}.${n}.feilLov`)&&!e(`${N}.${n}.feilSkjønn`)&&!e(`${N}.${n}.feilUtredning`)&&!e(`${N}.${n}.feilSaksflyt`)&&!e(`${N}.${n}.feilBegrunnelse`),oe=({index:e,totrinnskontrollSkjermlenkeContext:n,readOnly:l})=>{const{watch:i,getValues:t,control:s}=te(),T=i("aksjonspunktGodkjenning"),{aksjonspunktKode:_,totrinnskontrollGodkjent:g}=T[e],m=n.find(o=>o.totrinnskontrollAksjonspunkter.some(A=>A.aksjonspunktKode===_)),v=m?.totrinnskontrollAksjonspunkter.find(o=>o.aksjonspunktKode===_),E=!g&&gn(t,e)?Ae():void 0,k=Pe(`${N}.${e}.faktagruppe`,E);return!m||!v?null:a.jsxs(G,{gap:"space-12",children:[a.jsx(Be,{name:`${N}.${e}.totrinnskontrollGodkjent`,control:s,isReadOnly:l,hideLegend:!0,children:a.jsxs(P,{gap:"space-16",children:[a.jsx(C,{value:!0,size:"small",children:a.jsx(u,{id:"ApprovalField.Godkjent"})}),a.jsx(C,{value:!1,size:"small",children:a.jsx(u,{id:"ApprovalField.Vurder"})})]})}),g===!1&&a.jsx(Me,{alignOffset:110,children:a.jsxs(G,{gap:"space-8",children:[a.jsx(ie,{size:"small",children:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Arsak"})}),a.jsx(q,{size:"small",children:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Forklaring"})}),a.jsxs(G,{gap:"space-16",children:[a.jsx(G,{gap:"space-4",children:a.jsxs(P,{justify:"space-between",style:{width:"300px"},children:[a.jsxs(G,{gap:"space-4",children:[a.jsx(B,{name:`${N}.${e}.feilFakta`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Fakta"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilSkjønn`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Skjønn"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilLov`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Lovanvendelse"}),readOnly:l})]}),a.jsxs(G,{gap:"space-4",children:[a.jsx(B,{name:`${N}.${e}.feilUtredning`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Utredning"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilSaksflyt`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Saksflyt"}),readOnly:l}),a.jsx(B,{name:`${N}.${e}.feilBegrunnelse`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),readOnly:l})]})]})}),k&&a.jsx(we,{size:"small",children:k}),a.jsx(fe,{name:`${N}.${e}.besluttersBegrunnelse`,control:s,label:a.jsx(u,{id:"AksjonspunktGodkjenningArsakPanel.Begrunnelse"}),validate:[Se,_n,kn,Ke],readOnly:l})]})]})})]})};oe.__docgenInfo={description:"",methods:[],displayName:"GodkjenningPanel",props:{index:{required:!0,tsType:{name:"number"},description:""},totrinnskontrollSkjermlenkeContext:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| '-'
| 'ANNET'
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const Nn="_aksjonspunktTextContainer_1pwmv_5",Rn="_lenke_1pwmv_10",Q={aksjonspunktTextContainer:Nn,lenke:Rn},An="aksjonspunktGodkjenning",me=({behandling:e,totrinnskontrollSkjermlenkeContext:n,readOnly:l,erForeldrepengerFagsak:i,erTilbakekreving:t,skjemalenkeTyper:s,faktaOmBeregningTilfeller:T,lagLenke:_})=>{const{control:g,watch:m}=te(),{fields:v}=Oe({control:g,name:An}),E=m("aksjonspunktGodkjenning");return a.jsx(G,{gap:"space-24",children:v.map((k,o)=>{const{aksjonspunktKode:A}=E[o],p=n.find(S=>S.totrinnskontrollAksjonspunkter.some(D=>D.aksjonspunktKode===A)),I=p?.totrinnskontrollAksjonspunkter.find(S=>S.aksjonspunktKode===A);if(!p||!I)return null;const K=Ee(i,e.status,T,t,I,e.behandlingsresultat),L=s.find(S=>S.kode===p.skjermlenkeType),d=_(p.skjermlenkeType);return a.jsxs("div",{children:[d&&L&&a.jsx(ne,{to:d,onClick:()=>globalThis.scroll(0,0),className:Q.lenke,children:L.navn}),K.map((S,D)=>a.jsx("div",{className:Q.aksjonspunktTextContainer,children:a.jsx(q,{size:"small",children:S})},A.concat("_".concat(D.toString())))),a.jsx(oe,{index:o,totrinnskontrollSkjermlenkeContext:n,readOnly:l})]},k.id)})})};me.__docgenInfo={description:"",methods:[],displayName:"AksjonspunktGodkjenningFieldArray",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},erForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},erTilbakekreving:{required:!0,tsType:{name:"boolean"},description:""},skjemalenkeTyper:{required:!0,tsType:{name:"union",raw:"KodeverkMedNavn<'SkjermlenkeType'>[] | KodeverkMedNavnTilbakekreving<'SkjermlenkeType'>[]",elements:[{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaktaOmBeregningTilfelle'>[]"},description:""},lagLenke:{required:!0,tsType:{name:"signature",type:"function",raw:"(skjermlenkeCode: SkjermlenkeType) => Location | undefined",signature:{arguments:[{type:{name:"SkjermlenkeType"},name:"skjermlenkeCode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const X=(e=[])=>e.every(n=>n.totrinnskontrollGodkjent),Z=(e=[])=>e.every(n=>n.totrinnskontrollGodkjent!==void 0),Sn=(e,n)=>{if(!n)return!0;const{konsekvenserForYtelsen:l}=n;return!Array.isArray(l)||l.length!==1?!0:!e.some(i=>i===l[0])},pn=e=>e.reduce((n,l)=>l===R.FEIL_FAKTA?{...n,feilFakta:!0}:l===R.FEIL_LOV?{...n,feilLov:!0}:l===R.FEIL_REGEL?{...n,feilSkjønn:!0}:l===R.SKJØNN?{...n,feilSkjønn:!0}:l===R.UTREDNING?{...n,feilUtredning:!0}:l===R.SAKSFLYT||l===R.ANNET?{...n,feilSaksflyt:!0}:l===R.BEGRUNNELSE?{...n,feilBegrunnelse:!0}:{},{}),yn=e=>({aksjonspunktGodkjenning:e.map(n=>n.totrinnskontrollAksjonspunkter).flat().map(n=>({aksjonspunktKode:n.aksjonspunktKode,totrinnskontrollGodkjent:n.totrinnskontrollGodkjent,besluttersBegrunnelse:ae(n.besluttersBegrunnelse??void 0),...pn(n.vurderPaNyttArsaker)}))}),ve=({behandling:e,onSubmit:n,forhandsvisVedtaksbrev:l,readOnly:i,erBehandlingEtterKlage:t,erForeldrepengerFagsak:s,skjemalenkeTyper:T,erTilbakekreving:_,totrinnskontrollSkjermlenkeContext:g,faktaOmBeregningTilfeller:m,lagLenke:v,beslutterFormData:E,setBeslutterFormData:k})=>{const o=e.type===F.KLAGE,A=e.type===F.ANKE,p=Sn([H.ENDRING_I_FORDELING_AV_YTELSEN,H.INGEN_ENDRING],e.behandlingsresultat),I=yn(g),K=je({defaultValues:E||I}),L=K.watch("aksjonspunktGodkjenning");return e.toTrinnsBehandling?a.jsx(qe,{formMethods:K,onSubmit:n,setDataOnUnmount:k,children:a.jsxs(G,{gap:"space-24",children:[!i&&a.jsx(He,{children:a.jsx(u,{id:"HelpText.ToTrinnsKontroll"})}),a.jsx(me,{behandling:e,erForeldrepengerFagsak:s,erTilbakekreving:_,readOnly:i,totrinnskontrollSkjermlenkeContext:g,skjemalenkeTyper:T,faktaOmBeregningTilfeller:m,lagLenke:v}),a.jsxs(P,{gap:"space-16",style:{marginBottom:"50px"},children:[a.jsx(M,{variant:"primary",size:"small",disabled:!X(L)||!Z(L)||K.formState.isSubmitting,loading:K.formState.isSubmitting,children:a.jsx(u,{id:"ToTrinnsForm.Godkjenn"})}),a.jsx(M,{variant:"primary",size:"small",disabled:X(L)||!Z(L)||K.formState.isSubmitting,loading:K.formState.isSubmitting,children:a.jsx(u,{id:"ToTrinnsForm.SendTilbake"})}),!o&&!t&&!A&&!_&&p&&a.jsx(Ye,{href:"#",onClick:l,children:a.jsx(u,{id:"ToTrinnsForm.ForhandvisBrev"})})]})]})}):null};ve.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollBeslutterForm",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
...
| 'FEIL_REGEL'`,elements:[{name:"literal",value:"'FEIL_FAKTA'"},{name:"literal",value:"'FEIL_LOV'"},{name:"literal",value:"'SKJØNN'"},{name:"literal",value:"'UTREDNING'"},{name:"literal",value:"'SAKSFLYT'"},{name:"literal",value:"'BEGRUNNELSE'"},{name:"literal",value:"'-'"},{name:"literal",value:"'ANNET'"},{name:"literal",value:"'FEIL_REGEL'"}]}],raw:"Array<foreldrepenger_behandlingslager_behandling_aksjonspunkt_VurderÅrsak>",required:!0}}]}}],raw:"Array<tjenester_behandling_vedtak_dto_TotrinnskontrollAksjonspunkterDto>",required:!0}}]}}],raw:"TotrinnskontrollSkjermlenkeContext[]"},description:""},forhandsvisVedtaksbrev:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},erTilbakekreving:{required:!0,tsType:{name:"boolean"},description:""},erForeldrepengerFagsak:{required:!0,tsType:{name:"boolean"},description:""},skjemalenkeTyper:{required:!0,tsType:{name:"union",raw:"KodeverkMedNavn<'SkjermlenkeType'>[] | KodeverkMedNavnTilbakekreving<'SkjermlenkeType'>[]",elements:[{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const Kn="_approvalItem_xqu47_1",Ln="_approvalItemContainer_xqu47_7",In="_aksjonspunktTextContainer_xqu47_11",Dn="_resultatFraGodkjenningTextContainer_xqu47_16",Fn="_lenke_xqu47_20",Vn="_checkmarkIcon_xqu47_24",bn="_xmark_xqu47_30",b={approvalItem:Kn,approvalItemContainer:Ln,aksjonspunktTextContainer:In,resultatFraGodkjenningTextContainer:Dn,lenke:Fn,checkmarkIcon:Vn,xmark:bn},Gn=({vurderPaNyttArsaker:e,vurderArsaker:n})=>a.jsx("div",{className:b.approvalItem,children:e.map(l=>a.jsxs(P,{gap:"space-8",children:[a.jsx(Qe,{className:b.xmark}),a.jsx("div",{children:n.find(i=>l===i.kode)?.navn})]},l))}),de=({behandling:e,totrinnskontrollSkjermlenkeContext:n,erForeldrepengerFagsak:l,erTilbakekreving:i,skjemalenkeTyper:t,vurderArsaker:s,faktaOmBeregningTilfeller:T,lagLenke:_})=>{const g=c();return a.jsxs(a.Fragment,{children:[a.jsx("div",{className:b.resultatFraGodkjenningTextContainer,children:a.jsx(u,{id:"ToTrinnsForm.LøstAksjonspunkt",values:{b:Le}})}),n.map(m=>{const v=m.totrinnskontrollAksjonspunkter,E=t.find(k=>k.kode===m.skjermlenkeType);if(v.length>0){const k=_(m.skjermlenkeType);return a.jsxs(O.Fragment,{children:[k&&E&&a.jsx(ne,{to:k,onClick:()=>globalThis.scroll(0,0),className:b.lenke,children:E.navn}),v.map(o=>{const A=Ee(l,e.status,T,i,o,e.behandlingsresultat);return a.jsxs("div",{className:b.approvalItemContainer,children:[A.map((p,I)=>a.jsx("div",{className:b.aksjonspunktTextContainer,children:a.jsx(q,{size:"small",children:p})},o.aksjonspunktKode.concat("_".concat(I.toString())))),a.jsx("div",{className:b.approvalItem,children:o.totrinnskontrollGodkjent?a.jsxs(P,{gap:"space-8",children:[a.jsx(Je,{title:g.formatMessage({id:"ToTrinnsForm.Godkjent"}),className:b.checkmarkIcon}),a.jsx(u,{id:"ToTrinnsForm.Godkjent"})]}):a.jsx(Gn,{vurderPaNyttArsaker:o.vurderPaNyttArsaker,vurderArsaker:s})}),a.jsx("pre",{className:b.approvalItem,children:ae(o.besluttersBegrunnelse??void 0)})]},o.aksjonspunktKode)})]},m.skjermlenkeType)}return null})]})};de.__docgenInfo={description:"",methods:[],displayName:"TotrinnskontrollSaksbehandlerPanel",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
...
>[]`}}]}}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: ApData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""}}};const jn="_image_1t1ka_1",qn="_modal_1t1ka_9",ee={image:jn,modal:qn},hn=(e,n,l,i)=>e===F.TILBAKEKREVING?"FatterVedtakApprovalModal.Tilbakekreving":e===F.TILBAKEKREVING_REVURDERING?"FatterVedtakApprovalModal.TilbakekrevingRevurdering":e===F.KLAGE?"FatterVedtakApprovalModal.ModalDescriptionKlage":e===F.ANKE?"FatterVedtakApprovalModal.ModalDescriptionAnke":i?"FatterVedtakApprovalModal.UendretUtfall":n&&n.type===V.AVSLATT?"FatterVedtakApprovalModal.IkkeInnvilget":l?"FatterVedtakApprovalModal.OpphortVedtak":"FatterVedtakApprovalModal.InnvilgetVedtak",Un=(e,n)=>n===F.KLAGE?"FatterVedtakApprovalModal.ModalDescriptionKlage":n===F.ANKE?"FatterVedtakApprovalModal.ModalDescriptionAnke":e?"FatterVedtakApprovalModal.ModalDescriptionOpphort":"FatterVedtakApprovalModal.ModalDescriptionApproval",w=e=>e===j.FATTER_VEDTAK,Mn=(e,n,l,i,t,s)=>e?w(n)?hn(l,i,t,s):"":"FatterVedtakApprovalModal.VedtakReturneresTilSaksbehandler",Hn=e=>w(e)?"FatterVedtakApprovalModal.Innvilget":"",cn=(e,n,l)=>w(e)?Un(l,n):"FatterVedtakApprovalModal.ModalDescription",ke=({closeEvent:e,allAksjonspunktApproved:n,behandlingStatusKode:l,behandlingTypeKode:i,behandlingsresultat:t,harSammeResultatSomOriginalBehandling:s})=>{const T=c(),_=!!t&&t.type===V.OPPHOR,g=Mn(n,l,i,t,_,s),m=Hn(l),v=cn(l,i,_);return a.jsx(z,{className:ee.modal,open:!0,"aria-label":T.formatMessage({id:v}),onClose:e,children:a.jsx(z.Body,{children:a.jsxs(P,{justify:"space-between",align:"center",wrap:!1,children:[a.jsxs(P,{gap:"space-8",children:[a.jsx(xe,{className:ee.image,title:T.formatMessage({id:m})}),a.jsxs(G,{gap:"space-4",children:[a.jsx(ie,{size:"small",children:a.jsx(u,{id:g})}),a.jsx(q,{size:"small",children:a.jsx(u,{id:"FatterVedtakApprovalModal.GoToSearchPage"})})]})]}),a.jsx(M,{size:"small",variant:"primary",onClick:e,autoFocus:!0,type:"button",children:a.jsx(u,{id:"FatterVedtakApprovalModal.Ok"})})]})})})};ke.__docgenInfo={description:`FatterVedtakApprovalModal
...
| 'BT-007'
| 'BT-009'
| '-'`,elements:[{name:"literal",value:"'BT-002'"},{name:"literal",value:"'BT-003'"},{name:"literal",value:"'BT-004'"},{name:"literal",value:"'BT-008'"},{name:"literal",value:"'BT-006'"},{name:"literal",value:"'BT-007'"},{name:"literal",value:"'BT-009'"},{name:"literal",value:"'-'"}]},description:""},harSammeResultatSomOriginalBehandling:{required:!1,tsType:{name:"boolean"},description:""}}};const wn=re(Te),ge=({behandling:e,closeEvent:n,allAksjonspunktApproved:l})=>a.jsx(le,{value:wn,children:a.jsx(ke,{closeEvent:n,allAksjonspunktApproved:l,behandlingsresultat:e.behandlingsresultat??void 0,behandlingStatusKode:e.status,behandlingTypeKode:e.type,harSammeResultatSomOriginalBehandling:e.behandlingsresultat?.erRevurderingMedUendretUtfall||!1})});ge.__docgenInfo={description:"",methods:[],displayName:"FatterVedtakTotrinnskontrollModalSakIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Ne=({behandling:e,pushLocation:n,allAksjonspunktApproved:l})=>a.jsx(ge,{behandling:e,closeEvent:()=>{n("/")},allAksjonspunktApproved:l});Ne.__docgenInfo={description:"",methods:[],displayName:"BeslutterModalIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ansvarligSaksbehandler?: string;
  avsluttet?: string;
  behandlendeEnhetId: string;
  behandlendeEnhetNavn: string;
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""},pushLocation:{required:!0,tsType:{name:"signature",type:"function",raw:"(location: string) => void",signature:{arguments:[{type:{name:"string"},name:"location"}],return:{name:"void"}}},description:""},allAksjonspunktApproved:{required:!0,tsType:{name:"boolean"},description:""}}};const Yn=({fagsakData:e,valgtBehandlingUuid:n,beslutterFormData:l,setBeslutterFormData:i,toggleVisUtvidetBehandlingDetaljerKnapp:t})=>{const s=c(),[T,_]=U.useState(!1),[g,m]=U.useState(!1),v=e.getFagsak(),E=x(e.getBehandling(n)),k=Ve(E),o=Ie(),A=De(),p=be(Ge()),{brukernavn:I,kanVeilede:K}=x(p.data).innloggetBruker,L=$e(E.type),{mutate:d}=$({mutationFn:y=>k.lagreTotrinnsaksjonspunkt(y)}),{mutate:S}=$({mutationFn:()=>k.forhåndsvisMelding({behandlingUuid:E.uuid}),onSuccess:y=>{Fe(y)}}),D=y=>{const Re={behandlingUuid:E.uuid,behandlingVersjon:E.versjon,bekreftedeAksjonspunktDtoer:[y.fatterVedtakAksjonspunktDto]};m(y.erAlleAksjonspunktGodkjent),_(!0),d(Re)},Y=E.status===j.FATTER_VEDTAK;return a.jsxs(a.Fragment,{children:[a.jsx(ze,{tekst:s.formatMessage({id:Y?"TotrinnskontrollIndex.Godkjenning":"TotrinnskontrollIndex.FraBeslutter"}),toggleVisUtvidetBehandlingDetaljerKnapp:t,children:a.jsx(_e,{behandling:E,location:o,readOnly:I===E.ansvarligSaksbehandler||K,onSubmit:D,forhandsvisVedtaksbrev:S,fagsakYtelseType:v.fagsakYtelseType,alleKodeverk:L,createLocationForSkjermlenke:Ce,beslutterFormData:l,setBeslutterFormData:i})}),T&&a.jsx(Ne,{behandling:E,pushLocation:A,allAksjonspunktApproved:g})]})};Yn.__docgenInfo={description:`TotrinnskontrollIndex
...
Ansvarlig for att rita opp vilkår og aksjonspunkter med toTrinnskontroll`,methods:[],displayName:"TotrinnskontrollIndex",props:{fagsakData:{required:!0,tsType:{name:"FagsakData"},description:""},valgtBehandlingUuid:{required:!0,tsType:{name:"string"},description:""},beslutterFormData:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  feilSaksflyt?: boolean;
  feilBegrunnelse?: boolean;
}`,signature:{properties:[{key:"aksjonspunktKode",value:{name:"string",required:!0}},{key:"totrinnskontrollGodkjent",value:{name:"boolean",required:!1}},{key:"besluttersBegrunnelse",value:{name:"string",required:!1}},{key:"feilFakta",value:{name:"boolean",required:!1}},{key:"feilLov",value:{name:"boolean",required:!1}},{key:"feilSkjønn",value:{name:"boolean",required:!1}},{key:"feilUtredning",value:{name:"boolean",required:!1}},{key:"feilSaksflyt",value:{name:"boolean",required:!1}},{key:"feilBegrunnelse",value:{name:"boolean",required:!1}}]}}],raw:"AksjonspunktGodkjenningData[]",required:!0}}]}},name:"data"}],return:{name:"void"}}},description:""},toggleVisUtvidetBehandlingDetaljerKnapp:{required:!0,tsType:{name:"ReactElement"},description:""}}};export{H as K,Qe as S,Yn as T};
