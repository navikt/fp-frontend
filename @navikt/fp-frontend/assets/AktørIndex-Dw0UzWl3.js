import{j as e,h as g,P as v,b as p,L as y}from"./iframe-Cy7YGFMJ.js";import{Q as f}from"./index.es-BPXwr0EW.js";import{u as q,f as _}from"./fagsakApi-Db5PW8qW.js";import{V as c}from"./VisittkortSakIndex-CJwECi5J.js";import{V as j,a as N,B as A}from"./VStack-DI9-fY4c.js";import{M as o}from"./message-DkdrPTGv.js";import{E as w}from"./IngenBehandlingValgtPanel-r9z9iDvd.js";import{u as R}from"./useTrackRouteParam-tr9hfAP7.js";import{p as E}from"./paths-DjI85RLH.js";import{u as d}from"./useKodeverk-io4pYnnJ.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
