import{j as e,l as G,K as s,P,e as F,m as V}from"./iframe-uo23hhUw.js";import{a as M,u as B,n as U}from"./fagsakApi-wAcDzVJA.js";import{a as k,P as d,e as o,u as g}from"./index.es-DzaI5eYi.js";import{T as t}from"./Table-buDrbCHT.js";import{M as N}from"./message-C0fi6WDp.js";import{V as y,B as T,H as _,b as p}from"./VStack-w7oG0Q_c.js";import{S as H}from"./ExclamationmarkTriangleFill-Bn-bo9YH.js";import{p as J}from"./paths-C6m9xCiB.js";import{a as Y}from"./index-EyZdPxRY.js";const I=({fagsaker:a,selectFagsakCallback:l,alleKodeverk:r})=>e.jsxs(t,{children:[e.jsx(t.Header,{children:e.jsxs(t.Row,{children:[e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(N,{id:"FagsakList.Saksnummer"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(N,{id:"FagsakList.Sakstype"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(N,{id:"FagsakList.Status"})})]})}),e.jsx(t.Body,{children:a.map(n=>e.jsxs(t.Row,{onMouseDown:()=>l(n.saksnummer),onKeyDown:()=>l(n.saksnummer),children:[e.jsx(t.DataCell,{children:n.saksnummer}),e.jsx(t.DataCell,{children:r.FagsakYtelseType.find(E=>E.kode===n.fagsakYtelseType)?.navn??""}),e.jsx(t.DataCell,{children:r.FagsakStatus.find(E=>E.kode===n.status)?.navn??""})]},n.saksnummer))})]});I.__docgenInfo={description:`FagsakList
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const q="_container_tt7dx_1",w="_advarselIcon_tt7dx_6",A={container:q,advarselIcon:w},c=(a,l)=>!!(a||l===void 0||l.length<1),L=({searchStarted:a,searchResultAccessDenied:l,searchFagsakCallback:r})=>{const n=G(),E=k({defaultValues:{searchString:""}}),i=E.watch("searchString");return e.jsx(d,{formMethods:E,onSubmit:r,className:A.container,children:e.jsxs(y,{gap:"space-8",children:[e.jsx(T,{size:"small",children:e.jsx(N,{id:"Search.SearchFagsakOrPerson"})}),e.jsxs(_,{gap:"space-8",align:"end",children:[e.jsx(o,{name:"searchString",control:E.control,label:n.formatMessage({id:"Search.SaksnummerOrPersonId"}),validate:[s]}),e.jsx(p,{variant:"primary",size:"small",loading:a,disabled:c(a,i),children:e.jsx(N,{id:"Search.Search"})})]}),l&&e.jsxs(_,{gap:"space-8",align:"end",children:[e.jsx(H,{className:A.advarselIcon}),e.jsx(T,{size:"small",children:e.jsx(N,{id:l.feilmelding})})]})]})})};L.__docgenInfo={description:`SearchForm
...
Definerer søkefelt og tilhørende søkeknapp.`,methods:[],displayName:"SearchForm",props:{searchStarted:{required:!0,tsType:{name:"boolean"},description:""},searchResultAccessDenied:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  feilmelding: string;
}`,signature:{properties:[{key:"feilmelding",value:{name:"string",required:!0}}]}},description:""},searchFagsakCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: { searchString: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ searchString: string }",signature:{properties:[{key:"searchString",value:{name:"string",required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""}}};const C="_container_gwama_1",h="_label_gwama_9",S={container:C,label:h},D=({fagsaker:a,searchFagsakCallback:l,searchResultReceived:r,selectFagsakCallback:n,searchStarted:E,searchResultAccessDenied:i,alleKodeverk:R})=>e.jsxs("div",{className:S.container,children:[e.jsx(L,{searchFagsakCallback:l,searchStarted:E,searchResultAccessDenied:i}),r&&a.length===0&&e.jsx(T,{size:"small",className:S.label,children:e.jsx(N,{id:"FagsakSearch.ZeroSearchResults"})}),r&&a.length>1&&e.jsx(I,{fagsaker:a,selectFagsakCallback:n,alleKodeverk:R})]});D.__docgenInfo={description:`FagsakSearch
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const j={"Search.SearchFagsakOrPerson":"Søk på sak eller person","Search.SaksnummerOrPersonId":"Saksnummer eller fødselsnummer/D-nummer","Search.Search":"Søk","FagsakList.Saksnummer":"Saksnummer","FagsakList.Sakstype":"Sakstype","FagsakList.Status":"Status","FagsakSearch.ZeroSearchResults":"Søket ga ingen treff","Person.Age":"{age} år","Person.Man":"Mann","Person.Woman":"Kvinne","Person.ImageText":"Personinformasjon","ValidationMessage.InvalidSaksnummerOrFodselsnummerFormat":"Ugyldig saksnummer eller fødselsnummer","FagsakSokSakIndex.HarIkkeAdgang":"Har ikke adgang"},f=F(j),O=({fagsaker:a=[],searchFagsakCallback:l,searchResultReceived:r,selectFagsakCallback:n,searchStarted:E=!1,searchResultAccessDenied:i,alleKodeverk:R})=>e.jsx(P,{value:f,children:e.jsx(D,{fagsaker:a,searchFagsakCallback:l,searchResultReceived:r,selectFagsakCallback:n,searchStarted:E,searchResultAccessDenied:i,alleKodeverk:R})});O.__docgenInfo={description:"",methods:[],displayName:"FagsakSokSakIndex",props:{fagsaker:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  aktørId: string;
  barnFødt: string;
  endret?: string;
  fagsakYtelseType: foreldrepenger_behandlingslager_fagsak_FagsakYtelseType;
...
| '-'`,elements:[{name:"literal",value:"'ARBEIDSTAKER'"},{name:"literal",value:"'FRILANSER'"},{name:"literal",value:"'SELVSTENDIG_NÆRINGSDRIVENDE'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'ARBEIDSAVKLARINGSPENGER'"},{name:"literal",value:"'SJØMANN'"},{name:"literal",value:"'DAGMAMMA'"},{name:"literal",value:"'JORDBRUKER'"},{name:"literal",value:"'FISKER'"},{name:"literal",value:"'ARBEIDSTAKER_UTEN_FERIEPENGER'"},{name:"literal",value:"'-'"}],required:!0}}]}},{name:"literal",value:"'PeriodeResultatÅrsak'"}],raw:"Exclude<KodeverkType, 'PeriodeResultatÅrsak'>",required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  valgbarForKonto: string[];
  synligForRolle: string[];
}`,signature:{properties:[{key:"sortering",value:{name:"string",required:!0}},{key:"utfallType",value:{name:"string",required:!0}},{key:"gyldigForLovendringer",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"uttakTyper",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"valgbarForKonto",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"synligForRolle",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]}}]}],raw:"PeriodeResultatÅrsakKodeverk[]",required:!0}}]}}]},description:""}}};const b=()=>{const{kodeverkOptions:a,søkFagsak:l}=M(),{data:r}=B(a()),n=V(),E=u=>{u&&n(J(u))},{mutate:i,data:R=[],status:v,error:m}=g({mutationFn:u=>l(u.searchString),onSuccess:u=>{u.length===1&&E(u[0]?.saksnummer)}}),K=m&&m instanceof Y&&m.response.status===403&&"data"in m.response?m.response.data:void 0;return e.jsx(O,{fagsaker:R,searchFagsakCallback:i,searchResultReceived:v==="success",selectFagsakCallback:E,searchStarted:v==="pending",searchResultAccessDenied:K,alleKodeverk:U(r)})};b.__docgenInfo={description:`FagsakSearchIndex

Har ansvar for å vise søkeskjermbildet og å håndtere fagsaksøket
mot server og lagringen av resultatet i klientens state.`,methods:[],displayName:"FagsakSearchIndex"};export{b as F};
