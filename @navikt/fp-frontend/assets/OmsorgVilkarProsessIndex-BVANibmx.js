...
| 'FP_VK_8'
| 'FP_VK_33'
| '-'`,elements:[{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'-'"}],required:!0}}]}},description:""}}};const Ta=({søknad:a,adopsjon:n,harForeldreansvarAP:r})=>{const l=T(),{aksjonspunkterForPanel:t,alleMerknaderFraBeslutter:s,submitCallback:i,isReadOnly:E,isSubmittable:d}=I(),o=B({defaultValues:gr(n,t)}),_=o.watch("begrunnelse");return e.jsx(P,{label:l.formatMessage({id:r?"AksjonspunktForm.Tittel.Foreldreansvar":"AksjonspunktForm.Tittel.Omsorgsovertakelse"}),merknaderFraBeslutter:s[m.AVKLAR_VILKÅR_FOR_OMSORGSOVERTAKELSE],children:e.jsx(M,{formMethods:o,onSubmit:S=>i(Dr(S,t[0])),children:e.jsxs(D,{gap:"space-16",children:[e.jsx(w,{name:"omsorgsovertakelseDato",size:"medium",control:o.control,label:e.jsx(u,{id:"AksjonspunktForm.Omsorgsovertakelsesdato"}),validate:[K,U],isReadOnly:E,isEdited:ge(Rr(a),n.omsorgsovertakelseDato)}),r?e.jsx(w,{name:"foreldreansvarDato",size:"medium",control:o.control,label:e.jsx(u,{id:"AksjonspunktForm.Foreldreansvarsdato"}),validate:[K,U],isReadOnly:E}):e.jsx(Ne,{adopsjon:n}),e.jsx(O,{control:o.control,isSubmittable:d,size:"medium",isReadOnly:E,hasBegrunnelse:!!_}),e.jsx(se,{isSubmittable:d,isSubmitting:o.formState.isSubmitting,isDirty:o.formState.isDirty,isReadOnly:E})]})})})},gr=(a,n)=>({...Ne.initialValues(a.omsorgsovertakelseVilkårType),omsorgsovertakelseDato:a.omsorgsovertakelseDato,foreldreansvarDato:a.foreldreansvarDato,...O.initialValues(n)}),Dr=(a,n)=>n.definisjon===m.AVKLAR_VILKÅR_FOR_FORELDREANSVAR?{omsorgsovertakelseDato:ee(a.omsorgsovertakelseDato),foreldreansvarDato:ee(a.foreldreansvarDato),kode:m.AVKLAR_VILKÅR_FOR_FORELDREANSVAR,...O.transformValues(a)}:{omsorgsovertakelseDato:ee(a.omsorgsovertakelseDato),vilkarType:ee(a.vilkarType),kode:m.AVKLAR_VILKÅR_FOR_OMSORGSOVERTAKELSE,...O.transformValues(a)},Rr=a=>{if(ea(a))return a.omsorgsovertakelseDato??void 0};Ta.__docgenInfo={description:"",methods:[],displayName:"OmsorgOgForeldreansvarForm",props:{søknad:{required:!0,tsType:{name:"union",raw:"SøknadAdopsjon | SøknadFødsel",elements:[{name:"intersection",raw:`{
  soknadType: 'ST-002';
} & tjenester_behandling_søknad_SoknadAdopsjonDto`,elements:[{name:"signature",type:"object",raw:`{
  soknadType: 'ST-002';
}`,signature:{properties:[{key:"soknadType",value:{name:"literal",value:"'ST-002'",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Vilkar[]"},description:""}}};const Jr=new Set(["1002","1003","1032"]),Oa=({status:a,ytelseTypeKode:n,vilkår:r})=>{const l=T(),{behandling:t,isSubmittable:s,alleKodeverk:i,aksjonspunkterForPanel:E,submitCallback:d,harÅpentAksjonspunkt:o,isReadOnly:_,alleMerknaderFraBeslutter:S}=I(),A=E.some(h=>S[h.definisjon]?.notAccepted),g=Hr(E,a,t.behandlingsresultat),{mellomlagretFormData:v,setMellomlagretFormData:N}=C(),R=B({defaultValues:v??g}),k=Yr(n==="FP",i.Avslagsårsak.FP_VK_1),L=o?void 0:a==="OPPFYLT";return e.jsx(M,{formMethods:R,onSubmit:h=>d(xr(h,E)),setDataOnUnmount:N,children:e.jsx(ve,{title:l.formatMessage({id:"FodselVilkarForm.Fodsel"}),harÅpentAksjonspunkt:o,isSubmittable:s,isReadOnly:_,lovReferanse:r[0]?.lovReferanse??void 0,originalErVilkårOk:L,erIkkeGodkjentAvBeslutter:A,isDirty:R.formState.isDirty,isSubmitting:R.formState.isSubmitting,children:e.jsxs(D,{gap:"space-16",children:[e.jsx(H,{size:"small",children:e.jsx(u,{id:"FodselVilkarForm.TidligereUtbetaltStonad"})}),e.jsx(V,{avslagsårsaker:k,isReadOnly:_,customVilkårOppfyltText:e.jsx(u,{id:"FodselVilkarForm.Oppfylt"}),customVilkårIkkeOppfyltText:e.jsx(u,{id:"FodselVilkarForm.IkkeOppfylt",values:{b:oe}})}),e.jsx(b,{useAllWidth:!0,readOnly:_})]})})})},Hr=(a,n,r)=>({...V.buildInitialValues(a,n,r),...b.buildInitialValues(a)}),xr=(a,n)=>({...V.transformValues(a),...b.transformValues(a),kode:ue(n[0]?.definisjon,m.AVKLAR_OM_SØKER_HAR_MOTTATT_STØTTE)}),Yr=(a,n)=>a?n.filter(r=>!Jr.has(r.kode)):n;Oa.__docgenInfo={description:`FodselVilkarForm
