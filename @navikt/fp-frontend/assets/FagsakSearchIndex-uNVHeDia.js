import{j as e,l as s,V as G,P,b as F,n as V}from"./iframe-BfvOrglC.js";import{a as M,u as k,n as d}from"./fagsakApi-DQlWStPV.js";import{u as o,C as U,k as B,c as g}from"./index.es-GFu3qkvp.js";import{T as t}from"./Table-DmS_ucLq.js";import{M as N}from"./message-HqEOeJZQ.js";import{V as y,B as v,H as _,b as p}from"./VStack-CVrqKrBs.js";import{S as H}from"./ExclamationmarkTriangleFill-BmGL7j2y.js";import{p as J}from"./paths-UX_RvXQv.js";import{a as Y}from"./index-CqEVzQxv.js";const I=({fagsaker:a,selectFagsakCallback:l,alleKodeverk:E})=>e.jsxs(t,{children:[e.jsx(t.Header,{children:e.jsxs(t.Row,{children:[e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(N,{id:"FagsakList.Saksnummer"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(N,{id:"FagsakList.Sakstype"})}),e.jsx(t.HeaderCell,{scope:"col",children:e.jsx(N,{id:"FagsakList.Status"})})]})}),e.jsx(t.Body,{children:a.map(n=>e.jsxs(t.Row,{onMouseDown:()=>l(n.saksnummer),onKeyDown:()=>l(n.saksnummer),children:[e.jsx(t.DataCell,{children:n.saksnummer}),e.jsx(t.DataCell,{children:E.FagsakYtelseType.find(r=>r.kode===n.fagsakYtelseType)?.navn??""}),e.jsx(t.DataCell,{children:E.FagsakStatus.find(r=>r.kode===n.status)?.navn??""})]},n.saksnummer))})]});I.__docgenInfo={description:`FagsakList
