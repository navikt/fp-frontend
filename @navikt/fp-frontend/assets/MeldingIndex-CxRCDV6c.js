import{l as F,K as le,j as a,t as V,O as re,F as H,v as te,x as ie,P as w,b as Y,r as B,n as ue,S as h,B as K}from"./iframe-COWcMfOT.js";import{n as O,s as x,u as se,t as Ee,d as me}from"./fagsakApi-DAk1XkWL.js";import{u as ve,C as oe,w as q,O as _e,c as b}from"./index.es-DFGV27RQ.js";import{D as i}from"./dokumentMalType-B-Xou3xH.js";import{V as de}from"./venteArsakType-BJdSFL9e.js";import{U as Te}from"./UkjentAdresseMeldingIndex-BoRCWbgB.js";import{V as J,H as p,b as C,M,L as ge}from"./VStack-HZp7Js_x.js";import{L as Ne}from"./Link-D2-e80Hd.js";import{M as k}from"./message-BKit4tKI.js";import{S as Re}from"./CheckmarkCircleFill-FT94EAm9.js";import{u as U}from"./useKodeverk-E8CIZ8VG.js";import{S as ke}from"./SupportHeader-DO-CAooM.js";import{S as Ae}from"./SettPaVentReadOnlyModal-D3f26D_r.js";import{A as Se}from"./index.es-qrXVeoeA.js";var T=(e=>(e.BARN_IKKE_REGISTRERT_FOLKEREGISTER="BARNIKKEREG",e.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT="AKTIVITET",e.ANNET="ANNET",e))(T||{});const Ie="_bredde_jav4h_9",j={bredde:Ie},Ke=H(4e3),Le=H(1e4),De=te(3),z=({behandling:e,forhåndsvisBrev:n,submitCallback:t,revurderingVarslingArsak:E,fagsakYtelseType:m,kanVeilede:l,meldingFormData:u,setMeldingFormData:g,brukerManglerAdresse:R})=>{const v=F(),o=ve({defaultValues:u??pe(e)}),_=o.watch("brevmalkode"),A=o.watch("fritekst"),s=o.watch("arsakskode"),L=be(E,m),{formState:S,control:d}=o,I=r=>{_&&n({brevmalkode:_,fritekst:A,arsakskode:s}),r.preventDefault()},D=le(e.språkkode),N=_===i.VARSEL_OM_REVURDERING;return a.jsx(oe,{formMethods:o,onSubmit:r=>t(Fe(r)),setDataOnUnmount:g,children:a.jsxs(J,{gap:"space-16",children:[a.jsx(q,{name:"brevmalkode",control:d,label:v.formatMessage({id:"Messages.Template"}),validate:[V],selectValues:e.brevmaler.map(r=>a.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:j.bredde}),N&&a.jsx(q,{name:"arsakskode",control:d,label:v.formatMessage({id:"Messages.Årsak"}),validate:[V],selectValues:L.map(r=>a.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:j.bredde}),Ve(_,s)&&a.jsx(_e,{name:"fritekst",control:d,label:v.formatMessage({id:ye(_)}),validate:[V,N?Le:Ke,De,ie],maxLength:N?1e4:4e3,badges:[{type:"info",titleText:D}],parse:re}),R&&a.jsx(Te,{}),a.jsxs(p,{justify:"space-between",children:[(!N||s!==void 0)&&a.jsx(Ne,{href:"#",onClick:I,onKeyDown:r=>r.key==="Enter"?I(r):null,children:a.jsx(k,{id:"Messages.Preview"})}),a.jsx(C,{size:"small",variant:"primary",loading:S.isSubmitting,disabled:S.isSubmitting||l,children:a.jsx(k,{id:"Messages.Submit"})})]})]})})},ye=e=>e===i.INNHENTE_OPPLYSNINGER||e===i.TBK_INNHENTE_OPPLYSNINGER?"Messages.DocumentList":"Messages.Fritekst",Ve=(e,n)=>e===i.INNHENTE_OPPLYSNINGER||e===i.KORRIGERT_VARSEL_OM_TILBAKEKREVING||e===i.VARSEL_OM_TILBAKEKREVING||e===i.TBK_INNHENTE_OPPLYSNINGER||e===i.VARSEL_OM_REVURDERING&&n===T.ANNET,be=(e,n)=>n==="ES"?e.filter(t=>t.kode===T.BARN_IKKE_REGISTRERT_FOLKEREGISTER||t.kode===T.ANNET):n==="SVP"?e.filter(t=>t.kode!==T.BARN_IKKE_REGISTRERT_FOLKEREGISTER&&t.kode!==T.MORS_AKTIVITETSKRAV_ER_IKKE_OPPFYLT):e,pe=e=>{const n={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...n,brevmalkode:i.VARSEL_OM_REVURDERING}:{...n}},Fe=e=>{const n=e;return e.brevmalkode===i.VARSEL_OM_REVURDERING&&n.arsakskode!==T.ANNET&&(n.fritekst=" "),n};z.__docgenInfo={description:`Messages
...
| 'AVSLAG_ANNET'
| 'INGEN_INNVIRKNING'
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}],required:!1}}]},required:!1}},{key:"ugunstAksjonspunkt",value:{name:"boolean",required:!1}},{key:"behandlingKoet",value:{name:"boolean",required:!1}}]}},description:""}}};const Pe="_image_v04s1_1",fe="_modal_v04s1_8",c={image:Pe,modal:fe},W=({showModal:e,closeEvent:n})=>{const t=F();return a.jsx(M,{className:c.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:n,children:a.jsx(M.Body,{children:a.jsxs(p,{justify:"space-between",align:"center",children:[a.jsxs(p,{gap:"space-8",align:"center",children:[a.jsx(Re,{className:c.image,title:t.formatMessage({id:"MessagesModal.description"})}),a.jsx(ge,{size:"small",children:a.jsx(k,{id:"MessagesModal.text"})})]}),a.jsx(C,{size:"small",variant:"primary",onClick:n,autoFocus:!0,type:"button",children:a.jsx(k,{id:"MessagesModal.OK"})})]})})})};W.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Be=Y(Q),X=e=>a.jsx(w,{value:Be,children:a.jsx(W,{...e})});X.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const he=e=>e.behandlingPåVent?e.fristBehandlingPåVent:void 0,Oe=({fagsakData:e,valgtBehandlingUuid:n,meldingFormData:t,setMeldingFormData:E,hentOgSettBehandling:m,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const u=F(),[g,R]=B.useState(!1),[v,o]=B.useState(!1),_=ue(),A=e.getFagsak(),s=O(e.getBehandling(n)),L=x(s),S=se(me()),{innloggetBruker:{kanVeilede:d}}=O(S.data),I=U("Venteårsak"),D=U("RevurderingVarslingÅrsak"),{mutateAsync:N,status:r}=b({mutationFn:y=>L.sendMelding(y)}),Z=qe(o,N,m,R,E,s),ee=()=>{_("/")},ae=Ue(s),ne=()=>(o(!1),m()),G=r==="success",P=s.behandlingTillatteOperasjoner,f=!d&&e.getAlleBehandlinger().some(y=>!y.avsluttet)&&P?.behandlingKanSendeMelding;return a.jsxs(a.Fragment,{children:[v&&a.jsx(X,{showModal:G&&v,closeEvent:ne}),a.jsx(ke,{tekst:u.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:a.jsxs(J,{gap:"space-16",children:[!f&&a.jsx(Se,{variant:"info",children:a.jsx(k,{id:Me(d,P?.behandlingKanSendeMelding)})}),f&&a.jsx($,{submitCallback:Z,behandling:s,forhåndsvisBrev:ae,revurderingVarslingArsak:D,fagsakYtelseType:A.fagsakYtelseType,kanVeilede:d,meldingFormData:t,setMeldingFormData:E,brukerManglerAdresse:A.brukerManglerAdresse})]})}),G&&g&&a.jsx(Ae,{lukkCallback:ee,ventearsak:de.AVV_DOK,ventearsaker:I,frist:he(s)})]})},qe=(e,n,t,E,m,l)=>u=>{const g=u.brevmalkode===i.INNHENTE_OPPLYSNINGER||u.brevmalkode===i.VARSEL_OM_REVURDERING||u.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,R=K.TILBAKEKREVING===l.type||K.TILBAKEKREVING_REVURDERING===l.type;e(!g);const v=R?{behandlingUuid:l.uuid,fritekst:u.fritekst,brevmalkode:u.brevmalkode}:{behandlingUuid:l.uuid,brevmalkode:u.brevmalkode,fritekst:u.fritekst,arsakskode:u.arsakskode};return n(v).then(()=>{m(),g?E(!0):t()})},Me=(e,n)=>n?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Ue=e=>{const n=x(e),{mutate:t}=b({mutationFn:l=>n.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:l.brevmalkode,fritekst:l.fritekst||" ",arsakskode:l.arsakskode}),onSuccess:l=>{h(l)}}),{mutate:E}=b({mutationFn:l=>Ee(e.uuid,l.brevmalkode,l.fritekst??" "),onSuccess:l=>{h(l)}}),m=K.TILBAKEKREVING===e.type||K.TILBAKEKREVING_REVURDERING===e.type;return l=>{m?E(l):t(l)}};Oe.__docgenInfo={description:`MeldingIndex
