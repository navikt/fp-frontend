import{j as e,h as g,P as v,e as p,L as y}from"./iframe-CTSH3I4W.js";import{Z as f}from"./index.es--1Y6geLs.js";import{u as q,f as _}from"./fagsakApi-C43YB9as.js";import{V as c}from"./VisittkortSakIndex-CEcTG4Lh.js";import{V as j,a as N,B as A}from"./VStack-3BZyzeod.js";import{M as o}from"./message-CCmBVA0p.js";import{E as w}from"./IngenBehandlingValgtPanel-SGAtTRwf.js";import{u as R}from"./useTrackRouteParam-ckcdnsMm.js";import{p as E}from"./paths-CFZCO7zB.js";import{u as d}from"./useKodeverk-CBwVHelD.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
