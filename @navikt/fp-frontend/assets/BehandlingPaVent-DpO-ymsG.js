import{r,j as T}from"./iframe-MaBMuCwf.js";import{c as A}from"./index.es-DFKHAP4K.js";import{A as _}from"./index-QQVU0Fus.js";import{S}from"./SettPaVentModalIndex-DKFg4ECx.js";import{e as L}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as I}from"./behandlingApi-CAre6Byb.js";const s=({behandling:e,kodeverk:t,opneSokeside:E,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=r.useState(!a&&e.behandlingPåVent),m=()=>n(!1),v=I(e),{mutate:N}=A({mutationFn:l=>v.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>E()});r.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const R=e.aksjonspunkt.filter(L).some(l=>l.definisjon===_.AUTO_MANUELT_SATT_PÅ_VENT);return T.jsx(S,{submitCallback:N,cancelEvent:m,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:R,ventearsaker:t.Venteårsak,erTilbakekreving:i,showModal:u})};s.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
