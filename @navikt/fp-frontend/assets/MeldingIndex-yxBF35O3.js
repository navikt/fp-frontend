...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""}}};const Pe="_image_v04s1_1",fe="_modal_v04s1_8",c={image:Pe,modal:fe},W=({showModal:e,closeEvent:n})=>{const t=F();return a.jsx(U,{className:c.modal,open:e,"aria-label":t.formatMessage({id:"MessagesModal.description"}),onClose:n,children:a.jsx(U.Body,{children:a.jsxs(p,{justify:"space-between",align:"center",children:[a.jsxs(p,{gap:"space-8",align:"center",children:[a.jsx(Re,{className:c.image,title:t.formatMessage({id:"MessagesModal.description"})}),a.jsx(ge,{size:"small",children:a.jsx(k,{id:"MessagesModal.text"})})]}),a.jsx(C,{size:"small",variant:"primary",onClick:n,autoFocus:!0,type:"button",children:a.jsx(k,{id:"MessagesModal.OK"})})]})})})};W.__docgenInfo={description:`MessagesModal

Denne modalen vises etter at et brev har blitt bestilt.
Ved å trykke på knapp blir fritekst-feltet tømt.`,methods:[],displayName:"MessagesModal",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Be=Y(Q),X=e=>a.jsx(w,{value:Be,children:a.jsx(W,{...e})});X.__docgenInfo={description:"",methods:[],displayName:"MessagesModalSakIndex",props:{showModal:{required:!0,tsType:{name:"boolean"},description:""},closeEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const he=e=>e.behandlingPåVent?e.fristBehandlingPåVent:void 0,Oe=({fagsakData:e,valgtBehandlingUuid:n,meldingFormData:t,setMeldingFormData:E,hentOgSettBehandling:m,toggleVisUtvidetBehandlingDetaljerKnapp:l})=>{const u=F(),[g,R]=B.useState(!1),[v,o]=B.useState(!1),_=ue(),A=e.getFagsak(),s=O(e.getBehandling(n)),L=x(s),S=se(me()),{innloggetBruker:{kanVeilede:d}}=O(S.data),I=M("Venteårsak"),D=M("RevurderingVarslingÅrsak"),{mutateAsync:N,status:r}=b({mutationFn:y=>L.sendMelding(y)}),Z=qe(o,N,m,R,E,s),ee=()=>{_("/")},ae=Me(s),ne=()=>(o(!1),m()),G=r==="success",P=s.behandlingTillatteOperasjoner,f=!d&&e.getAlleBehandlinger().some(y=>!y.avsluttet)&&P?.behandlingKanSendeMelding;return a.jsxs(a.Fragment,{children:[v&&a.jsx(X,{showModal:G&&v,closeEvent:ne}),a.jsx(ke,{tekst:u.formatMessage({id:"MeldingIndex.Meldinger"}),toggleVisUtvidetBehandlingDetaljerKnapp:l,children:a.jsxs(J,{gap:"space-16",children:[!f&&a.jsx(Se,{variant:"info",children:a.jsx(k,{id:Ue(d,P?.behandlingKanSendeMelding)})}),f&&a.jsx($,{submitCallback:Z,behandling:s,forhåndsvisBrev:ae,revurderingVarslingArsak:D,fagsakYtelseType:A.fagsakYtelseType,kanVeilede:d,meldingFormData:t,setMeldingFormData:E,brukerManglerAdresse:A.brukerManglerAdresse})]})}),G&&g&&a.jsx(Ae,{lukkCallback:ee,ventearsak:de.AVV_DOK,ventearsaker:I,frist:he(s)})]})},qe=(e,n,t,E,m,l)=>u=>{const g=u.brevmalkode===i.INNHENTE_OPPLYSNINGER||u.brevmalkode===i.VARSEL_OM_REVURDERING||u.brevmalkode===i.ETTERLYS_INNTEKTSMELDING,R=K.TILBAKEKREVING===l.type||K.TILBAKEKREVING_REVURDERING===l.type;e(!g);const v=R?{behandlingUuid:l.uuid,fritekst:u.fritekst,brevmalkode:u.brevmalkode}:{behandlingUuid:l.uuid,brevmalkode:u.brevmalkode,fritekst:u.fritekst,arsakskode:u.arsakskode};return n(v).then(()=>{m(),g?E(!0):t()})},Ue=(e,n)=>n?e?"MeldingIndex.IkkeTilgjengeligVeileder":"MeldingIndex.IkkeTilgjengeligAvsluttet":"MeldingIndex.IkkeTilgjengeligPaVent",Me=e=>{const n=x(e),{mutate:t}=b({mutationFn:l=>n.forhåndsvisMelding({behandlingUuid:e.uuid,dokumentMal:l.brevmalkode,fritekst:l.fritekst||" ",arsakskode:l.arsakskode}),onSuccess:l=>{h(l)}}),{mutate:E}=b({mutationFn:l=>Ee(e.uuid,l.brevmalkode,l.fritekst??" "),onSuccess:l=>{h(l)}}),m=K.TILBAKEKREVING===e.type||K.TILBAKEKREVING_REVURDERING===e.type;return l=>{m?E(l):t(l)}};Oe.__docgenInfo={description:`MeldingIndex
