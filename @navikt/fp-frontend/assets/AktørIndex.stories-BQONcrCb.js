import{w as T,j as a,M as R,R as u,a as h}from"./iframe-CJgyfo9_.js";import{Q as K}from"./index.es-BFCB1ROu.js";import{u as c,a as j,F as s,i,w as f,n as H,b as F,c as _}from"./fagsakApi-NMkvHp61.js";import{h as e,H as t,c as O}from"./index-Bc_7YYJb.js";import{a as k}from"./alleKodeverk-Cho4R_ly.js";import{K as N}from"./Kjonnkode-DjBoP8-t.js";import{i as g}from"./initFetchFptilbake-CspdHVpU.js";import{A as d}from"./AktørIndex-CrKpgaco.js";import"./preload-helper-PPVm8Dsz.js";import"./VStack-BQ5ULrV2.js";import"./index-Bi5iAhEH.js";import"./CheckmarkCircleFill-Dz7ZLlKU.js";import"./ExclamationmarkTriangleFill-C0w41j-T.js";import"./VisittkortSakIndex-CaG09V2C.js";import"./index.es-DT3hmkJu.js";import"./index-ByoCOVHi.js";import"./Link-BKEtH6E1.js";import"./Checkmark-noJFsHQ0.js";import"./Popover-GIHL659I.js";import"./message-CCWpKOrj.js";import"./Spacer-C4FqrBkx.js";import"./IngenBehandlingValgtPanel-Yi9doiJ5.js";import"./useTrackRouteParam-tb3JUEew.js";import"./paths-C0_J2Xea.js";import"./useKodeverk-Dtnufv23.js";const I=l=>O(f(H(i.links.find(m=>m.rel===l)).href)),p={navn:"Espen Utvikler",fødselsnummer:"11111111111",kjønn:N.MANN,fødselsdato:"2000-01-02",aktørId:"22222222",språkkode:"-"},A={fagsaker:[{saksnummer:"123",fagsakYtelseType:"FP",status:"OPPR",aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p,relasjonsRolleType:"-"},{saksnummer:"252523",fagsakYtelseType:"ES",status:"LOP",aktørId:"1345345",barnFødt:"2024-01-03",opprettet:"2024-01-03",person:p,relasjonsRolleType:"-"}],person:p},te={title:"app/AktørIndex",decorators:[T],component:d,parameters:{layout:"fullscreen"},render:()=>{const{status:l}=c(_()),{kodeverkOptions:m}=j(),{data:E}=c(m(l==="success"));return E?a.jsx(R,{initialEntries:["/fagsak/352011079"],children:a.jsx(u,{children:a.jsx(h,{element:a.jsx(d,{}),path:"/fagsak/:aktoerId"})})}):a.jsx(K,{})}},r={parameters:{msw:{handlers:[e.get(s.INIT_FETCH,()=>t.json(i)),e.get(s.INIT_FETCH_FPTILBAKE,()=>t.json(g)),e.get(I(F.KODEVERK),()=>t.json(k)),e.get(s.AKTOER_INFO,()=>t.json(A))]}}},n={parameters:{msw:{handlers:[e.get(s.INIT_FETCH,()=>t.json(i)),e.get(s.INIT_FETCH_FPTILBAKE,()=>t.json(g)),e.get(I(F.KODEVERK),()=>t.json(k)),e.get(s.AKTOER_INFO,()=>t.json({fagsaker:[],person:{...p,aktørId:void 0}}))]}}},o={parameters:{msw:{handlers:[e.get(s.INIT_FETCH,()=>t.json(i)),e.get(s.INIT_FETCH_FPTILBAKE,()=>t.json(g)),e.get(I(F.KODEVERK),()=>t.json(k)),e.get(s.AKTOER_INFO,()=>new t(null,{status:500}))]}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
