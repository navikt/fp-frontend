import{o as F,K as ee,j as a,x as V,O as ae,F as q,z as ne,A as le,P as H,b as j,r as y,q as re,S as b}from"./iframe-8iIUOOAF.js";import{n as p,g as c,u as te,h as ie,c as ue}from"./fagsakApi-BVpt4nuz.js";import{u as Ee,C as me,w as B,O as ve,c as O}from"./index.es-C-dWChta.js";import{U as se}from"./UkjentAdresseMeldingIndex-DG1unold.js";import{V as w,H as L,b as Y,M,L as Ne}from"./VStack-dRjle75L.js";import{L as oe}from"./Link-BTbzvoDi.js";import{M as d}from"./message-BehtrRhz.js";import{S as Te}from"./CheckmarkCircleFill-DV4NWRE2.js";import{u as f}from"./useKodeverk-B15IGDz4.js";import{S as _e}from"./SupportHeader-B8-ljaDT.js";import{S as Re}from"./SettPaVentReadOnlyModal-BkvJ9vjR.js";import{A as de}from"./index.es-wJ0C3p8N.js";const Ae="_bredde_jav4h_9",U={bredde:Ae},Ke=q(4e3),ge=q(1e4),Se=ne(3),J=({behandling:e,forhåndsvisBrev:n,submitCallback:t,revurderingVarslingArsak:E,fagsakYtelseType:m,kanVeilede:l,meldingFormData:i,setMeldingFormData:T,brukerManglerAdresse:R})=>{const v=F(),s=Ee({defaultValues:i??Oe(e)}),N=s.watch("brevmalkode"),A=s.watch("fritekst"),u=s.watch("arsakskode"),S=Ve(E,m),{formState:K,control:o}=s,g=r=>{N&&n({brevmalkode:N,fritekst:A,arsakskode:u}),r.preventDefault()},I=ee(e.språkkode),_=N==="VARREV";return a.jsx(me,{formMethods:s,onSubmit:r=>t(Le(r)),setDataOnUnmount:T,children:a.jsxs(w,{gap:"space-16",children:[a.jsx(B,{name:"brevmalkode",control:o,label:v.formatMessage({id:"Messages.Template"}),validate:[V],selectValues:e.brevmaler.map(r=>a.jsx("option",{value:r.kode,disabled:!r.tilgjengelig,children:r.navn},r.kode)),className:U.bredde}),_&&a.jsx(B,{name:"arsakskode",control:o,label:v.formatMessage({id:"Messages.Årsak"}),validate:[V],selectValues:S.map(r=>a.jsx("option",{value:r.kode,children:r.navn},r.kode)),className:U.bredde}),ke(N,u)&&a.jsx(ve,{name:"fritekst",control:o,label:v.formatMessage({id:Ie(N)}),validate:[V,_?ge:Ke,Se,le],maxLength:_?1e4:4e3,badges:[{type:"info",titleText:I}],parse:ae}),R&&a.jsx(se,{}),a.jsxs(L,{justify:"space-between",children:[(!_||u!==void 0)&&a.jsx(oe,{href:"#",onClick:g,onKeyDown:r=>r.key==="Enter"?g(r):null,children:a.jsx(d,{id:"Messages.Preview"})}),a.jsx(Y,{size:"small",variant:"primary",loading:K.isSubmitting,disabled:K.isSubmitting||l,children:a.jsx(d,{id:"Messages.Submit"})})]})]})})},Ie=e=>e==="INNOPP"||e==="INNHEN"?"Messages.DocumentList":"Messages.Fritekst",ke=(e,n)=>e==="INNOPP"||e==="KORRIGVARS"||e==="VARS"||e==="INNHEN"||e==="VARREV"&&n==="ANNET",Ve=(e,n)=>n==="ES"?e.filter(t=>t.kode==="BARNIKKEREG"||t.kode==="ANNET"):n==="SVP"?e.filter(t=>t.kode!=="BARNIKKEREG"&&t.kode!=="AKTIVITET"):e,Oe=e=>{const n={brevmalkode:e.brevmaler[0]?.kode??void 0,fritekst:""};return e.ugunstAksjonspunkt?{...n,brevmalkode:"VARREV"}:{...n}},Le=e=>{const n=e;return e.brevmalkode==="VARREV"&&n.arsakskode!=="ANNET"&&(n.fritekst=" "),n};J.__docgenInfo={description:`Messages
