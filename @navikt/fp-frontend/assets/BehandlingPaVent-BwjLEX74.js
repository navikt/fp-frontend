import{r as E,j as T}from"./iframe-td2jCF7S.js";import{c as _}from"./index.es-5-OebRMu.js";import{A}from"./index-BfBxHZRq.js";import{S}from"./SettPaVentModalIndex-BoRMNtP5.js";import{e as I}from"./aksjonspunktUtils-Bp6ewLMR.js";import{u as L}from"./behandlingApi-BvXLdmZI.js";const D=({behandling:e,kodeverk:r,opneSokeside:t,erTilbakekreving:i=!1,skalIkkeViseModal:a=!1})=>{const[u,n]=E.useState(!a&&e.behandlingPåVent),N=()=>n(!1),m=L(e),{mutate:R}=_({mutationFn:l=>m.oppdaterPåVent({...l,behandlingUuid:e.uuid,behandlingVersjon:e.versjon}),onSuccess:()=>t()});E.useEffect(()=>{a||n(e.behandlingPåVent)},[e.versjon,a]);const v=e.aksjonspunkt.filter(I).some(l=>l.definisjon===A.AUTO_MANUELT_SATT_PÅ_VENT);return T.jsx(S,{submitCallback:R,cancelEvent:N,frist:e.fristBehandlingPåVent,ventearsak:e.venteÅrsakKode,hasManualPaVent:v,ventearsaker:r.Venteårsak,erTilbakekreving:i,showModal:u})};D.__docgenInfo={description:"",methods:[],displayName:"BehandlingPaVent",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
| 'FP_VK_41'
| 'SVP_VK_1'
| '-'`,elements:[{name:"literal",value:"'FP_VK_1'"},{name:"literal",value:"'FP_VK_11'"},{name:"literal",value:"'FP_VK_16'"},{name:"literal",value:"'FP_VK_2'"},{name:"literal",value:"'FP_VK_2_F'"},{name:"literal",value:"'FP_VK_2_L'"},{name:"literal",value:"'FP_VK_3'"},{name:"literal",value:"'FP_VK_4'"},{name:"literal",value:"'FP_VK_5'"},{name:"literal",value:"'FP_VK_8'"},{name:"literal",value:"'FP_VK_33'"},{name:"literal",value:"'FP_VK_34'"},{name:"literal",value:"'FP_VK_21'"},{name:"literal",value:"'FP_VK_23'"},{name:"literal",value:"'FP_VK_41'"},{name:"literal",value:"'SVP_VK_1'"},{name:"literal",value:"'-'"}],required:!0}}]}}],raw:"Array<tjenester_behandling_vilkår_VilkårDto>",required:!0}}]}},description:""},kodeverk:{required:!0,tsType:{name:"union",raw:"AlleKodeverk | AlleKodeverkTilbakekreving",elements:[{name:"intersection",raw:`KodeverkMedSammeVerditype & {
