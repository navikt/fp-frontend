...
| '-'`,elements:[{name:"literal",value:"'INNVIRKNING'"},{name:"literal",value:"'INNVILGET_REDUSERT'"},{name:"literal",value:"'INNVILGET_UENDRET'"},{name:"literal",value:"'AVSLAG_FARESIGNAL'"},{name:"literal",value:"'AVSLAG_ANNET'"},{name:"literal",value:"'INGEN_INNVIRKNING'"},{name:"literal",value:"'-'"}],required:!1}}]}},{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<'FaresignalVurdering'>[]"},description:""}}};const ra=({fagsakData:e,behandling:l,setBehandling:r})=>{const a=e.getFagsak(),{selected:n=!1}=Fe({paramName:"risiko",parse:N=>N==="true",isQueryParam:!0}),u=H(),i=M(),s=()=>{u(S(i)(!n))},{kodeverkOptions:m}=Y(),{data:o}=V(m()),_=e.getBehandling(l?.uuid);return l&&_&&!j(_)&&!j(l)?t.jsx(ta,{isRiskPanelOpen:n,fagsak:a,toggleRiskPanel:s,behandlingAppKontekst:_,behandling:l,setBehandling:r}):t.jsx(D,{risikoklassifisering:a.kontrollResultat,isPanelOpen:n,readOnly:!0,toggleRiskPanel:s,faresignalVurderinger:y(o).FaresignalVurdering})},ta=({fagsak:e,behandling:l,behandlingAppKontekst:r,setBehandling:a,toggleRiskPanel:n,isRiskPanelOpen:u})=>{const{behandlingPåVent:i,status:s,type:m,risikoAksjonspunkt:o,kontrollResultat:_}=r,{kodeverkOptions:N}=Y(),p=V(oe()),{data:k}=V(N()),h=y(p.data).innloggetBruker,ae=ze(h,e.status,s,m),ne=ia(h,ae,i),c=H(),B=M();E.useEffect(()=>{o&&Se(o)&&!u&&c(S(B)(!0)),o&&o.status==="UTFO"&&c(S(B)(!1))},[!!o,l.uuid,l.versjon]);const{lagreAksjonspunkter:le}=be(l,a),re=O=>{le({behandlingUuid:l.uuid,behandlingVersjon:l.versjon,saksnummer:e.saksnummer,bekreftedeAksjonspunktDtoer:[{"@type":O.kode,...O}]})};return t.jsx(D,{aksjonspunkt:o??void 0,risikoklassifisering:_??void 0,isPanelOpen:u,readOnly:ne,submitAksjonspunkt:re,toggleRiskPanel:n,faresignalVurderinger:y(k).FaresignalVurdering})},ia=(e,l,r)=>{if(r)return!0;const{kanSaksbehandle:a}=e;return!a||!l.writeAccess.isEnabled};ra.__docgenInfo={description:`RisikoklassifiseringIndex
