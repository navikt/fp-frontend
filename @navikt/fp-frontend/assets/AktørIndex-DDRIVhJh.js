import{j as e,h as g,P as v,e as p,L as y}from"./iframe-C4gkjsQB.js";import{Z as f}from"./index.es-C9OQSZcE.js";import{u as q,f as _}from"./fagsakApi-8qYcJY1f.js";import{V as c}from"./VisittkortSakIndex-BNZuKvtz.js";import{V as j,a as N,B as A}from"./VStack-DXNAIFGc.js";import{M as o}from"./message-BsiD8Be3.js";import{E as w}from"./IngenBehandlingValgtPanel-WlVFFtUE.js";import{u as R}from"./useTrackRouteParam-DzR1YflF.js";import{p as E}from"./paths-CMAxk4hW.js";import{u as d}from"./useKodeverk-DMglb4At.js";const k=({aktorInfo:n,fagsakStatuser:r,fagsakYtelseTyper:t,renderSomLenke:l})=>e.jsxs(e.Fragment,{children:[e.jsx(c,{bruker:n.person}),e.jsx(j,{gap:"space-16",align:"center",margin:"5",children:n.fagsaker.length?n.fagsaker.map(a=>{const i=t.find(s=>s.kode===a.fagsakYtelseType)?.navn,u=r.find(s=>s.kode===a.status)?.navn;return e.jsx(g.Fragment,{children:l(void 0,`${i} (${a.saksnummer}) ${u}`,a.saksnummer)},a.saksnummer)}):e.jsx(N,{size:"small",level:"2",children:e.jsx(o,{id:"AktoerGrid.IngenFagsaker"})})})]});k.__docgenInfo={description:"",methods:[],displayName:"AktørGrid",props:{aktorInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  aktørId?: string;
