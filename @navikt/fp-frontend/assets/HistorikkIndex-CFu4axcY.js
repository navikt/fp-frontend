...
| 'VEDTAK'
| 'FAKTA_OM_VERGE'
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}]}]},name:"skjermlenkeKode"}],return:{name:"union",raw:"Location | undefined",elements:[{name:"Location"},{name:"undefined"}]}}},description:""}}};const Ae={ARBEIDSGIVER:"info-moderate",BESL:"success-moderate",VL:"neutral-moderate",SBH:"meta-purple-moderate",SOKER:"warning-moderate","-":"info-moderate"},H=({behandlingLocation:e,createLocationForSkjermlenke:r,alleKodeverk:l,historikkInnslag:{aktør:a,opprettetTidspunkt:n,tittel:t,linjer:_,dokumenter:N,skjermlenke:m},saksnummer:v})=>{const A=P(),I=`${l.HistorikkAktør.find(u=>u.kode===a.type)?.navn??""} ${a.ident??""}`,F=c(n,{separator:"kl",month:"long",day:"numeric"}),s=_.length>3,[K,G]=R.useState(s),T=_.slice(0,K?3:_.length);return E.jsxs(S,{"data-testid":"historikkinnslag",wrap:!1,gap:"space-20",justify:"end",align:"center",children:[E.jsx(D.New,{padding:"4",background:Ae[a.type],children:E.jsxs(U,{gap:"space-8",children:[E.jsxs(S,{gap:"space-8",children:[E.jsx(d,{weight:"semibold",children:I}),E.jsx(d,{children:F})]}),t&&E.jsx(k,{size:"medium",children:t}),m&&E.jsx(p,{skjermlenke:m,behandlingLocation:e,alleKodeverk:l,createLocationForSkjermlenke:r}),_.length>0&&E.jsxs("div",{children:[T.map((u,V)=>u.type==="TEKST"?E.jsx(C,{size:"medium",children:Ne(u.tekst??"")},`${u.tekst}-${V}`):E.jsx("br",{},`${u.type}-${V}`)),s&&E.jsx(x,{variant:"tertiary",size:"small",onClick:()=>G(!K),children:K?A.formatMessage({id:"Historikkinnslag.VisMer"}):A.formatMessage({id:"Historikkinnslag.VisMindre"})})]}),N&&E.jsx("div",{children:N.map(u=>E.jsx(y,{dokumentLenke:u,saksnummer:v},`${u.journalpostId}.${u.dokumentId}`))})]})}),E.jsx(D.New,{children:E.jsx(g,{aktørType:a.type})})]})};H.__docgenInfo={description:"",methods:[],displayName:"HistorikkInnslag",props:{behandlingLocation:{required:!1,tsType:{name:"Location"},description:""},createLocationForSkjermlenke:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  behandlingLocation: Location,
...
| '-'`,elements:[{name:"literal",value:"'FAKTA_OM_FEILUTBETALING'"},{name:"literal",value:"'TILBAKEKREVING'"},{name:"literal",value:"'FORELDELSE'"},{name:"literal",value:"'VEDTAK'"},{name:"literal",value:"'FAKTA_OM_VERGE'"},{name:"literal",value:"'-'"}],required:!1}},{key:"opprettetTidspunkt",value:{name:"string",required:!0}},{key:"dokumenter",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  tekst?: string;
  type: TypeFpTilbake;
}`,signature:{properties:[{key:"tekst",value:{name:"string",required:!1}},{key:"type",value:{name:"union",raw:"'TEKST' | 'LINJESKIFT'",elements:[{name:"literal",value:"'TEKST'"},{name:"literal",value:"'LINJESKIFT'"}],required:!0}}]}}],raw:"Array<LinjeFpTilbake>",required:!0}}]}}]},description:""},saksnummer:{required:!0,tsType:{name:"string"},description:""}}};const ve="_circle_wfn61_1",Ke="_overflow_wfn61_10",B={circle:ve,overflow:Ke},w=({valgtBehandlingUuid:e,historikkFpSak:r,historikkFpTilbake:l,alleKodeverkFpSak:a,alleKodeverkFpTilbake:n,saksnummer:t,getBehandlingLocation:_,createLocationForSkjermlenke:N,utvidEllerMinskBehandlingDetaljerKnapp:m})=>{const v=P(),[A,L]=R.useState(!1),I=Re(r,l),F=e&&A?I.filter(T=>T.behandlingUuid===e):I,[s,K]=R.useState(),G=()=>K(0);return R.useEffect(()=>(globalThis.addEventListener("scroll",G),()=>{globalThis.removeEventListener("scroll",G)}),[]),E.jsxs(E.Fragment,{children:[E.jsx(D.New,{background:"neutral-moderate",borderColor:"neutral-subtleA",borderWidth:"0 0 2 0",padding:"5",children:E.jsxs(S,{justify:"space-between",children:[E.jsxs(S,{gap:"space-4",align:"center",children:[E.jsx(W,{size:"small",level:"3",children:v.formatMessage({id:"History.Historikk"})}),m]}),E.jsxs(S,{gap:"space-32",children:[e&&E.jsx(z,{size:"small",onChange:()=>L(!A),children:v.formatMessage({id:"History.FiltrerPaBehandling"})}),E.jsx("div",{className:B.circle,children:F.length})]})]})}),E.jsx("div",{style:{height:`calc(100vh - ${s}px)`},className:B.overflow,ref:T=>{T&&K(T.getBoundingClientRect().top)},children:E.jsx(U,{gap:"space-8",padding:"4",children:F.map(T=>{const u=T.erTilbakekreving?n:a;return u?E.jsx(H,{saksnummer:t,historikkInnslag:T,createLocationForSkjermlenke:N,alleKodeverk:u,behandlingLocation:T.behandlingUuid?_(T.behandlingUuid):void 0},T.opprettetTidspunkt):null})})})]})};w.__docgenInfo={description:`Historikk
