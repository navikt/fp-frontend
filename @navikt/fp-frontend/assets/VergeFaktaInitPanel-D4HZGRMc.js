import{r as E,o as N,j as s,bE as D,bF as L,be as K}from"./iframe-MaBMuCwf.js";import{Q as O}from"./index.es-DkmZy4wJ.js";import{u as b}from"./fagsakApi-BSUxAMVn.js";import{V as G}from"./BehandlingMenuIndex-BN0l22Tg.js";import{A as P}from"./index-QQVU0Fus.js";import{u as V,c as F}from"./behandlingApi-CAre6Byb.js";import{B as g}from"./FagsakIndex-Bh2pFg76.js";import{Y as f}from"./index.es-Dmp0AsY9.js";import{H as B}from"./VStack-DM1id9RI.js";import{S as q}from"./ExclamationmarkTriangleFill-CKE6YLjb.js";import{e as T}from"./aksjonspunktUtils-Bp6ewLMR.js";import{e as M,g as j}from"./useStandardProsessPanelProps-Blv9pRVQ.js";const U=a=>{const[l,e]=E.useState([]),t=r=>{e(i=>{const n=[...i],o=n.findIndex(u=>u.id===r.id);return o>=0?n.splice(o,1,r):n.push(r),n}),a?.(r.harÅpentAksjonspunkt?{urlCode:r.id,text:r.tekst}:void 0)};return{faktaPanelMenyData:l.filter(r=>r.skalVisesIMeny),settFaktaPanelMenyData:t}},w="_container_4o186_1",h="_content_4o186_6",c="_sideMenu_4o186_19",k={container:w,content:h,sideMenu:c},H=({valgtFaktaSteg:a,valgtProsessSteg:l,setFaktaPanelMedÅpentApInfo:e,children:t})=>{const r=N(),{oppdaterProsessStegOgFaktaPanelIUrl:i}=E.use(g),{faktaPanelMenyData:n,settFaktaPanelMenyData:o}=U(e),u=n.length>0;return s.jsxs(B,{className:k.container,wrap:!1,children:[u&&s.jsx("div",{className:k.sideMenu,"data-testid":"fakta-meny",children:s.jsx(f,{heading:r.formatMessage({id:"FaktaMeny.FaktaOm"}),links:n.map(m=>({label:m.tekst,active:m.erAktiv,icon:m.harÅpentAksjonspunkt?s.jsx(q,{color:"var(--ax-warning-700)"}):void 0})),onClick:m=>{i(l,n[m].id)}})}),s.jsx("div",{className:k.content,children:s.jsx(J,{valgtFaktaSteg:a,settFaktaPanelMenyData:o,faktaPanelMenyData:n,children:t})})]})},A=E.createContext({}),J=a=>{const{children:l,...e}=a,t=E.useMemo(()=>e,[e]);return s.jsx(A.Provider,{value:t,children:l})};H.__docgenInfo={description:"",methods:[],displayName:"FaktaMeny",props:{valgtProsessSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},valgtFaktaSteg:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},setFaktaPanelMedÅpentApInfo:{required:!1,tsType:{name:"signature",type:"function",raw:"(faktaPanelMedÅpentApInfo?: FaktaPanelMedÅpentApInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  urlCode: string;
  text: string;
}`,signature:{properties:[{key:"urlCode",value:{name:"string",required:!0}},{key:"text",value:{name:"string",required:!0}}]}},name:"faktaPanelMedÅpentApInfo"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""}}};const Y="default",C=(a,l,e,t)=>{const{valgtFaktaSteg:r,settFaktaPanelMenyData:i}=E.use(A),n=e&&(r===a||t&&r===Y);return E.useEffect(()=>{i({id:a,tekst:l,erAktiv:n,harÅpentAksjonspunkt:t,skalVisesIMeny:e})},[e,n,t]),e&&n},p=({standardPanelProps:a,skalPanelVisesIMeny:l,faktaPanelKode:e,faktaPanelMenyTekst:t,children:r})=>{const{behandling:i,fagsak:n,alleKodeverk:o}=E.use(g),u=C(e,t,l,a.harÅpentAksjonspunkt);return s.jsx(D,{behandling:i,children:u?s.jsx(L,{behandling:i,fagsak:n,alleKodeverk:o,aksjonspunkterForPanel:a.aksjonspunkterForPanel,harÅpentAksjonspunkt:a.harÅpentAksjonspunkt,submitCallback:a.submitCallback,isReadOnly:a.isReadOnly,alleMerknaderFraBeslutter:a.alleMerknaderFraBeslutter,isSubmittable:a.isSubmittable,children:r}):null})};p.__docgenInfo={description:"",methods:[],displayName:"FaktaDefaultInitPanel",props:{standardPanelProps:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| 'BARE_FAR_RETT_MOR_UFØR'`,elements:[{name:"literal",value:"'ALENEOMSORG'"},{name:"literal",value:"'BEGGE_RETT'"},{name:"literal",value:"'BEGGE_RETT_EØS'"},{name:"literal",value:"'BARE_MOR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT'"},{name:"literal",value:"'BARE_FAR_RETT_MOR_UFØR'"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  submitCallback: (aksjonspunkterSomSkalLagres: FaktaAksjonspunkt | FaktaAksjonspunkt[]) => Promise<void>;
}>`},description:""},skalPanelVisesIMeny:{required:!0,tsType:{name:"boolean"},description:""},faktaPanelKode:{required:!0,tsType:{name:"FaktaPanelCode"},description:""},faktaPanelMenyTekst:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactElement"},description:""}}};const R="default",_="default",x=(a=[],l=[])=>{const{behandling:e,rettigheter:t,fagsak:r,lagreAksjonspunkter:i,lagreOverstyrteAksjonspunkter:n,oppdaterProsessStegOgFaktaPanelIUrl:o,alleKodeverk:u}=E.use(g),{aksjonspunkt:m}=e,v=m.filter(d=>a.includes(d.definisjon)),S=M(e,[],t,!1),I=j(e.status,v),y=Z(r,e,o,i,n,l);return{behandling:e,isSubmittable:!v.some(T)||v.some(d=>d.kanLoses),harÅpentAksjonspunkt:v.some(d=>T(d)&&d.kanLoses),alleKodeverk:u,aksjonspunkterForPanel:v,isReadOnly:S,alleMerknaderFraBeslutter:I,submitCallback:y}},Z=(a,l,e,t,r,i)=>n=>{const u=(Array.isArray(n)?n:[n]).map(v=>({"@type":v.kode,...v})),m={saksnummer:a.saksnummer,behandlingUuid:l.uuid,behandlingVersjon:l.versjon};if(i){if(u.length===0)throw new Error("Det har oppstått en teknisk feil ved lagring av aksjonspunkter. Meld feilen i Porten.");if(i.includes(u[0].kode))return r({...m,overstyrteAksjonspunktDtoer:u}).then(()=>e(_,R))}return t({...m,bekreftedeAksjonspunktDtoer:u}).then(()=>e(_,R))},W=[P.AVKLAR_VERGE],X=()=>{const a=N(),l=x(W),{behandling:e}=E.use(g),t=V(e),r=F(e,"VERGE"),{data:i,isFetching:n}=b(t.vergeOptions(e,r));return s.jsx(p,{standardPanelProps:l,faktaPanelKode:K.VERGE,faktaPanelMenyTekst:a.formatMessage({id:"FaktaInitPanel.Title.Verge"}),skalPanelVisesIMeny:r,children:n?s.jsx(O,{}):s.jsx(G,{verge:i,alleKodeverk:l.alleKodeverk})})};X.__docgenInfo={description:"",methods:[],displayName:"VergeFaktaInitPanel"};export{p as F,X as V,H as a,x as u};
