 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jg;function LP(){if(Jg)return _a;Jg=1;var e=Symbol.for("react.transitional.element"),i=Symbol.for("react.fragment");function r(t,s,l){var u=null;if(l!==void 0&&(u=""+l),s.key!==void 0&&(u=""+s.key),"key"in s){l={};for(var f in s)f!=="key"&&(l[f]=s[f])}else l=s;return s=l.ref,{$$typeof:e,type:t,key:u,ref:s!==void 0?s:null,props:l}}return _a.Fragment=i,_a.jsx=r,_a.jsxs=r,_a}var Qg;function jP(){return Qg||(Qg=1,Zg.exports=LP()),Zg.exports}jP();gs(cs);E.createContext({});var Al={exports:{}},DP=Al.exports,ec;function CP(){return ec||(ec=1,function(e,i){(function(r,t){e.exports=t()})(DP,function(){var r={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},t=/(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,s=/\d/,l=/\d\d/,u=/\d\d?/,f=/\d*[^-_:/,()\s\d]+/,c={},m=function(A){return(A=+A)+(A>68?1900:2e3)},v=function(A){return function(R){this[A]=+R}},p=[/[+-]\d\d:?(\d\d)?|Z/,function(A){(this.zone||(this.zone={})).offset=function(R){if(!R||R==="Z")return 0;var S=R.match(/([+-]|\d\d)/g),P=60*S[1]+(+S[2]||0);return P===0?0:S[0]==="+"?-P:P}(A)}],y=function(A){var R=c[A];return R&&(R.indexOf?R:R.s.concat(R.f))},k=function(A,R){var S,P=c.meridiem;if(P){for(var D=1;D<=24;D+=1)if(A.indexOf(P(D,0,R))>-1){S=D>12;break}}else S=A===(R?"pm":"PM");return S},x={A:[f,function(A){this.afternoon=k(A,!1)}],a:[f,function(A){this.afternoon=k(A,!0)}],Q:[s,function(A){this.month=3*(A-1)+1}],S:[s,function(A){this.milliseconds=100*+A}],SS:[l,function(A){this.milliseconds=10*+A}],SSS:[/\d{3}/,function(A){this.milliseconds=+A}],s:[u,v("seconds")],ss:[u,v("seconds")],m:[u,v("minutes")],mm:[u,v("minutes")],H:[u,v("hours")],h:[u,v("hours")],HH:[u,v("hours")],hh:[u,v("hours")],D:[u,v("day")],DD:[l,v("day")],Do:[f,function(A){var R=c.ordinal,S=A.match(/\d+/);if(this.day=S[0],R)for(var P=1;P<=31;P+=1)R(P).replace(/\[|\]/g,"")===A&&(this.day=P)}],w:[u,v("week")],ww:[l,v("week")],M:[u,v("month")],MM:[l,v("month")],MMM:[f,function(A){var R=y("months"),S=(y("monthsShort")||R.map(function(P){return P.slice(0,3)})).indexOf(A)+1;if(S<1)throw new Error;this.month=S%12||S}],MMMM:[f,function(A){var R=y("months").indexOf(A)+1;if(R<1)throw new Error;this.month=R%12||R}],Y:[/[+-]?\d+/,v("year")],YY:[l,function(A){this.year=m(A)}],YYYY:[/\d{4}/,v("year")],Z:p,ZZ:p};function _(A){var R,S;R=A,S=c&&c.formats;for(var P=(A=R.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(ne,ee,G){var F=G&&G.toUpperCase();return ee||S[G]||r[G]||S[F].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(L,X,re){return X||re.slice(1)})})).match(t),D=P.length,I=0;I<D;I+=1){var H=P[I],j=x[H],C=j&&j[0],K=j&&j[1];P[I]=K?{regex:C,parser:K}:H.replace(/^\[|\]$/g,"")}return function(ne){for(var ee={},G=0,F=0;G<D;G+=1){var L=P[G];if(typeof L=="string")F+=L.length;else{var X=L.regex,re=L.parser,Z=ne.slice(F),W=X.exec(Z)[0];re.call(ee,W),ne=ne.replace(W,"")}}return function(J){var de=J.afternoon;if(de!==void 0){var le=J.hours;de?le<12&&(J.hours+=12):le===12&&(J.hours=0),delete J.afternoon}}(ee),ee}}return function(A,R,S){S.p.customParseFormat=!0,A&&A.parseTwoDigitYear&&(m=A.parseTwoDigitYear);var P=R.prototype,D=P.parse;P.parse=function(I){var H=I.date,j=I.utc,C=I.args;this.$u=j;var K=C[1];if(typeof K=="string"){var ne=C[2]===!0,ee=C[3]===!0,G=ne||ee,F=C[2];ee&&(F=C[2]),c=this.$locale(),!ne&&F&&(c=S.Ls[F]),this.$d=function(Z,W,J,de){try{if(["x","X"].indexOf(W)>-1)return new Date((W==="X"?1e3:1)*Z);var le=_(W)(Z),ve=le.year,Ae=le.month,An=le.day,Ye=le.hours,Ve=le.minutes,He=le.seconds,Ee=le.milliseconds,Ne=le.zone,nn=le.week,Xe=new Date,Ze=An||(ve||Ae?1:Xe.getDate()),Pn=ve||Xe.getFullYear(),Ge=0;ve&&!Ae||(Ge=Ae>0?Ae-1:Xe.getMonth());var on,sr=Ye||0,un=Ve||0,or=He||0,$n=Ee||0;return Ne?new Date(Date.UTC(Pn,Ge,Ze,sr,un,or,$n+60*Ne.offset*1e3)):J?new Date(Date.UTC(Pn,Ge,Ze,sr,un,or,$n)):(on=new Date(Pn,Ge,Ze,sr,un,or,$n),nn&&(on=de(on).week(nn).toDate()),on)}catch{return new Date("")}}(H,K,j,S),this.init(),F&&F!==!0&&(this.$L=this.locale(F).$L),G&&H!=this.format(K)&&(this.$d=new Date("")),c={}}else if(K instanceof Array)for(var L=K.length,X=1;X<=L;X+=1){C[1]=K[X-1];var re=S.apply(this,C);if(re.isValid()){this.$d=re.$d,this.$L=re.$L,this.init();break}X===L&&(this.$d=new Date(""))}else D.call(this,I)}}})}(Al)),Al.exports}var VP=CP();const HP=jw(VP);Hr.extend(HP);vr(La);const Em=({aksjonspunkt:e,readOnly:i,submittable:r,submitCallback:t})=>{const[s,l]=E.useState(!1),{mellomlagretFormData:u,setMellomlagretFormData:f}=hA(),c=sw({defaultValues:u??GP(e)}),m=c.watch("begrunnelse");return ie.jsxs(At,{gap:"space-16",children:[e.status===Sa.OPPRETTET&&ie.jsx(fE,{children:[ie.jsx(Mn,{id:"BesteberegningProsessPanel.Aksjonspunkt.HelpTextKontroll"},"BesteberegningAksjonspunktTekst")]}),ie.jsx(_w,{formMethods:c,onSubmit:v=>t(UP(v)),setDataOnUnmount:f,children:ie.jsxs(At,{gap:"space-16",children:[ie.jsx(dw,{name:"besteberegningErKorrektValg",control:c.control,label:ie.jsx(Mn,{id:"BesteberegningProsessPanel.Aksjonspunkt.Radiotekst"}),readOnly:i,onChange:()=>l(!s)}),ie.jsx(ja,{control:c.control,isSubmittable:r,isReadOnly:i,hasBegrunnelse:!!m,hasVurderingText:!0}),ie.jsx(Zc,{isSubmittable:r&&s,isSubmitting:c.formState.isSubmitting,isDirty:c.formState.isDirty,isReadOnly:i})]})})]})},GP=e=>{const i=e.status===Sa.UTFORT;return{...ja.initialValues(e),besteberegningErKorrektValg:i?!0:void 0}},UP=e=>({kode:bt.MANUELL_KONTROLL_AV_BESTEBEREGNING,begrunnelse:e.begrunnelse,besteberegningErKorrekt:!!e.besteberegningErKorrektValg});Em.__docgenInfo={description:`KontrollerBesteberegningPanel
...
Formkomponent. Lar saksbehandler vurdere om den automatiske besteberegningen er korrekt utført.`,methods:[],displayName:"KontrollerBesteberegningPanel",props:{aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  begrunnelse?: string;
}`,signature:{properties:[{key:"kode",value:{name:"unknown",required:!0}},{key:"begrunnelse",value:{name:"string",required:!1}}]}}]},name:"data"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},submittable:{required:!0,tsType:{name:"boolean"},description:""}}};const wm=({beregningsgrunnlag:e,arbeidsgiverOpplysninger:i,submittable:r})=>{const{alleKodeverk:t,aksjonspunkterForPanel:s,submitCallback:l,isReadOnly:u}=bA(),{ytelsesspesifiktGrunnlag:f,beregningsgrunnlagPeriode:c}=e,m=f?.besteberegninggrunnlag;if(!m)return null;const v=c[0],p=s.find(y=>y.definisjon===bt.KONTROLLER_AUTOMATISK_BESTEBEREGNING||y.definisjon===bt.MANUELL_KONTROLL_AV_BESTEBEREGNING);return ie.jsxs(At,{gap:"space-16",children:[!!p&&ie.jsx(Em,{aksjonspunkt:p,submitCallback:l,submittable:r,readOnly:u}),ie.jsx(tg,{children:ie.jsx(Fc,{periode:v,besteMåneder:m.besteMåneder})}),ie.jsx(tg,{children:ie.jsx(Lc,{besteMåneder:m.besteMåneder,arbeidsgiverOpplysninger:i,alleKodeverk:t})})]})};wm.__docgenInfo={description:`BesteberegningPanel
